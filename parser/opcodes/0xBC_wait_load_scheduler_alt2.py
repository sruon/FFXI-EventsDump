...
class WaitLoadSchedulerAlt2Opcode(SchedulerBase):
    opcode = 0xBC
    name = "WAIT_LOAD_SCHEDULER_ALT2"
    ...
    def get_legible_representation(self, raw_bytes: bytes, args=None, context=None):
        ...
        return f"{self.name}: Wait for scheduler {scheduler_display} with entities [{entity1_str}, {entity2_str}], work={work_str}"
