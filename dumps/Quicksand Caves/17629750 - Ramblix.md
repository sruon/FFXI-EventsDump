...
- **7402**: What story would you like to be told? [On second thought, maybe later./The Chains That Bind Us(pt.1)./The Chains That Bind Us(pt.2)./Raebrimm's Rebirth(pt.1)/Raebrimm's Rebirth(pt.2)./Uran-Mafran of the Maelstrom(pt.1)./Uran-Mafran of the Maelstrom(pt.2).]
- **7403**: 
- **7404**: 
- **7405**: 
...
0010: 36 02 0D 01 03 00 00 00  80 02 02 10 01 80 01 28  6..............(
...
```
  ...
  4: 0x000B [0x4A] LocalPlayer looks at Ramblix (ID: 17629750/0x010D0236)
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7402*, default_option=0*, option_flags=Work_Zone[2])
    → "What story would you like to be told? [On second thought, maybe later./The Chains That Bind Us(pt.1)./The Chains That Bind Us(pt.2)./Raebrimm's Rebirth(pt.1)/Raebrimm's Rebirth(pt.2)./Uran-Mafran of the Maelstrom(pt.1)./Uran-Mafran of the Maelstrom(pt.2).]"
