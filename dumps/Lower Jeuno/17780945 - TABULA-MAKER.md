...
- **9788**: One spiffy Maze Tabula for you, comin' right up! So do ya wants an original or a copy? (Original=0, Copy=1)
- **9789**: So ya wants [an original/a copy], right? [That's what I said./No, you idiot.]
- **9790**: Enter the pattern number for your desired tabula. (0-31)
- **9791**: So you want pattern number $0? [You betcha./Ehhhhh...no.]
- **9792**: Now choose a theme for your maze. (0-64)
- **9793**: You really want theme number $0? [Damn straight./Changed my mind.]
...
```
  ...
  1: 0x0006 [0x1D] PRINT_EVENT_MESSAGE(message_id=9788*)
...
SUBROUTINE_0031:
 12: 0x0031 [0x24] CREATE_DIALOG(message_id=9789*, default_option=1*, option_flags=0*)
...
SUBROUTINE_004F:
 19: 0x004F [0x1D] PRINT_EVENT_MESSAGE(message_id=9790*)
...
SUBROUTINE_007A:
 30: 0x007A [0x24] CREATE_DIALOG(message_id=9791*, default_option=1*, option_flags=0*)
...
SUBROUTINE_0098:
 37: 0x0098 [0x1D] PRINT_EVENT_MESSAGE(message_id=9792*)
...
SUBROUTINE_00C3:
 48: 0x00C3 [0x24] CREATE_DIALOG(message_id=9793*, default_option=1*, option_flags=0*)
