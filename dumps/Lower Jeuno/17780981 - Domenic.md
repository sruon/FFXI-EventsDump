...
- **10265**: Hm? I got no business with the likes of you. Now get outta here.
- **10266**: Psst, you. Yeah, you. I got a special deal for ya.
- **10267**: For a nominal fee, I can warp ya to some outta-the-way battlefield entrances. No questions asked. Mind ya, I don't do this for just anyone, so ya'd better appreciate it.
- **10268**: As for gettin' back, you're on yer own. I ain't runnin' a charity here, after all.
- **10269**: Where ya headin' today? [Nowhere./Ghelsba Outpost./Horlais Peak./Waughroon Shrine./Balga's Dais./Qu'Bia Arena.]
- **10270**: [/Ghelsba Outpost/Horlais Peak/Waughroon Shrine/Balga's Dais/Qu'Bia Arena], ya say? That'll run ya $1 gil. Whaddaya say?
- **10271**: Whaddaya say? (Current gil: $0) [Pay and teleport./On second thought...]
- **10272**: Alright, now we just gotta put this blindfold on ya. A businessman's gotta protect his trade secrets, after all...
- **10273**: ...Then whaddaya wastin' my time for? Get lost!
...
```
  ...
  2: 0x000B [0x1D] PRINT_EVENT_MESSAGE(message_id=10266*)
    → "Psst, you. Yeah, you. I got a special deal for ya."
  3: 0x000E [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x000F [0x1D] PRINT_EVENT_MESSAGE(message_id=10267*)
  ...
  6: 0x0013 [0x1D] PRINT_EVENT_MESSAGE(message_id=10268*)
 ...
 10: 0x0022 [0x24] CREATE_DIALOG(message_id=10269*, default_option=0*, option_flags=0*)
 ...
 37: 0x00A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=10273*)
...
SUBROUTINE_00B0:
 ...
 46: 0x00BF [0x1D] PRINT_EVENT_MESSAGE(message_id=10270*)
 ...
 48: 0x00C3 [0x24] CREATE_DIALOG(message_id=10271*, default_option=1*, option_flags=0*)
 ...
 57: 0x00E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=10272*)
...
```
  ...
  1: 0x0102 [0x1D] PRINT_EVENT_MESSAGE(message_id=10265*)
