...
| [65535.21](#event-6553521) | 0x012A       |     31 |              9 |
| [65535.22](#event-6553522) | 0x0149       |     14 |              4 |
| [10021](#event-10021)      | 0x0157       |      3 |              2 |
| [65535.23](#event-6553523) | 0x015A       |      5 |              3 |
| [65535.24](#event-6553524) | 0x015F       |     19 |              5 |
| [65535.25](#event-6553525) | 0x0172       |     19 |              5 |
| [65535.26](#event-6553526) | 0x0185       |      5 |              3 |
| [65535.27](#event-6553527) | 0x018A       |      5 |              3 |
| [65535.28](#event-6553528) | 0x018F       |     19 |              5 |
| [65535.29](#event-6553529) | 0x01A2       |     17 |              5 |
| [65535.30](#event-6553530) | 0x01B3       |      9 |              5 |
...
| [65535.35](#event-6553535) | 0x01D0       |      9 |              5 |
| [10022](#event-10022)      | 0x01D9       |      3 |              2 |
| [65535.36](#event-6553536) | 0x01DC       |     19 |              5 |
| [65535.37](#event-6553537) | 0x01EF       |      5 |              3 |
| [65535.38](#event-6553538) | 0x01F4       |     12 |              4 |
| [65535.39](#event-6553539) | 0x0200       |     12 |              4 |
...
- **7936**: Well, ladies and gentlemen, are we all here? Allow me to introduce myself. I am Vauderame.
- **7938**: Firstly, I wonder if you have heard of the group known as Atarefaunet's band?
- **7944**: It would seem the veterans among you are well-versed in thieving history.
- **7945**: During the Great War, the leader of the band, Atarefaunet, was killed by a traitor and the rest of the members scattered to the winds.
- **7946**: However, the Tenshodo has managed to divine the current whereabouts of the remaining members.
- **7947**: The task I have called you here for today is to deliver a $3 to each of the thieves of Atarefaunet's band.
- **7949**: No, of course not. What could thieves of twenty years ago accomplish now?
- **7952**: ...That is the main point of the message in the $3.
- **7953**: However, it is not certain that they will just meekly sign the papers. My job is to make certain these brigands follow the will of the Tenshodo.
- **7954**: And that is where you come in. Use your knowledge and talents to get those signatures and bring them back here to me.
- **7955**: I will now hand each of you a sealed envelope. Seek out the member whose name is revealed therein.
- **7956**: Lastly, it is against thieving etiquette to sneak a look at the members assigned to people other than yourself. As I'm sure you are aware, too much knowledge is a dangerous thing in this business...
- **7957**: Now, please come to me one at a time to receive your envelope.
- **7958**: You are the adventurer thief <Player>?
- **7959**: Since you are an adventurer, I will give you the member who requires the most muscle to deal with. Go and meet with the Galka staying at the inn located in the town of Selbina.
- **7962**: It appears the Galka gave you some trouble, as I expected. Your face tells of trying times.
- **7964**: Ah, Nanaa Mihgo, that makes everyone.
- **7966**: I thank you all for flawlessly completing the task I set.
- **7967**: As a reward, I will give each of you a weapon designed specifically for thieves. Please come to me one at a time.
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0140:                             32 07 80 1F 00 08 80           2......
0150: 09 80 0A 80 1F 01 00                              .......         
```
...
```
  ...
  1: 0x014C [0x1F] MOVE_ENTITY: EventEntity moves to X=24.034*, Z=2.032*, Y=-0.101*
...
```
  0: 0x015A [0x1D] PRINT_EVENT_MESSAGE(message_id=7936*)
...
```
  ...
  1: 0x0166 [0x1D] PRINT_EVENT_MESSAGE(message_id=7938*)
...
```
  ...
  1: 0x0179 [0x1D] PRINT_EVENT_MESSAGE(message_id=7944*)
...
```
  0: 0x0185 [0x1D] PRINT_EVENT_MESSAGE(message_id=7945*)
...
```
  0: 0x018A [0x1D] PRINT_EVENT_MESSAGE(message_id=7946*)
...
```
  ...
  1: 0x0196 [0x1D] PRINT_EVENT_MESSAGE(message_id=7947*)
...
```
  ...
  2: 0x01AE [0x1D] PRINT_EVENT_MESSAGE(message_id=7949*)
...
```
  0: 0x01B3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7952*)
    → "...That is the main point of the message in the $3."
  1: 0x01B6 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x01B7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7953*)
...
```
  0: 0x01BC [0x1D] PRINT_EVENT_MESSAGE(message_id=7954*)
...
```
  0: 0x01C1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7955*)
...
```
  0: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7956*)
...
```
  0: 0x01CB [0x1D] PRINT_EVENT_MESSAGE(message_id=7957*)
...
```
  0: 0x01D0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7958*)
    → "You are the adventurer thief <Player>?"
  1: 0x01D3 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x01D4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7959*)
...
```
  ...
  1: 0x01E3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7962*)
...
```
  0: 0x01EF [0x1D] PRINT_EVENT_MESSAGE(message_id=7964*)
...
```
  ...
  1: 0x01FB [0x1D] PRINT_EVENT_MESSAGE(message_id=7966*)
...
```
  0: 0x0200 [0x1D] PRINT_EVENT_MESSAGE(message_id=7967*)
