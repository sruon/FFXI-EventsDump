...
509: 0x0872 [0x1D] PRINT_EVENT_MESSAGE(message_id=6521*)
    → "$5 include $8 for $3 gil."
...
514: 0x0883 [0x1D] PRINT_EVENT_MESSAGE(message_id=6533*)
    → "$6 is an older map that was often used to depict $8. It costs $3 gil."
...
520: 0x089F [0x1D] PRINT_EVENT_MESSAGE(message_id=6521*)
    → "$5 include $8 for $3 gil."
...
525: 0x08B0 [0x1D] PRINT_EVENT_MESSAGE(message_id=6533*)
    → "$6 is an older map that was often used to depict $8. It costs $3 gil."
