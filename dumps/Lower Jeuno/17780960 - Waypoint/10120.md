...
SUBROUTINE_0022:
 ...
 19: 0x0063 [0x45] LOAD_SCHEDULED_TASK(work_offset1=561*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ad01", work_offset2=0*)
 20: 0x0074 [0x1A] CALL_SUBROUTINE(address=0x01B0)
 21: 0x0077 [0xCD] LOAD_SCHEDULED_TASK_ALT4(work_offset=140*, entity1=EventEntity, entity2=EventEntity, action="s000", work_offset2=0*)
 ...
 25: 0x009D [0x45] LOAD_SCHEDULED_TASK(work_offset1=561*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ad03", work_offset2=0*)
 26: 0x00AE [0x1C] WAIT(60* ticks)
 27: 0x00B1 [0xCD] LOAD_SCHEDULED_TASK_ALT4(work_offset=140*, entity1=EventEntity, entity2=LocalPlayer, action="main", work_offset2=0*)
 ...
 32: 0x00DD [0x45] LOAD_SCHEDULED_TASK(work_offset1=561*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ad04", work_offset2=0*)
 33: 0x00EE [0xCD] LOAD_SCHEDULED_TASK_ALT4(work_offset=140*, entity1=EventEntity, entity2=EventEntity, action="stp0", work_offset2=0*)
 ...
 40: 0x011D [0x45] LOAD_SCHEDULED_TASK(work_offset1=561*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="0blf", work_offset2=0*)
 41: 0x012E [0xCD] LOAD_SCHEDULED_TASK_ALT4(work_offset=140*, entity1=EventEntity, entity2=LocalPlayer, action="a128", work_offset2=0*)
...
SUBROUTINE_0159:
 ...
 51: 0x015B [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
 52: 0x016C [0x21] END_EVENT
 53: 0x016D [0x00] END_REQSTACK()

 54: 0x01B0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 55: 0x01C1 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 56: 0x01D0 [0x1B] RETURN

SUBROUTINE_01D1:
 57: 0x01D1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 58: 0x01E2 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 59: 0x01F1 [0x1B] RETURN

SUBROUTINE_01F2:
 60: 0x01F2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="whi1", work_offset2=0*)
 61: 0x0203 [0x55] WAIT_LOAD_SCHEDULER(work_offset=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="whi1")
 62: 0x0212 [0x1B] RETURN

SUBROUTINE_0213:
 63: 0x0213 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="who1", work_offset2=0*)
 64: 0x0224 [0x55] WAIT_LOAD_SCHEDULER(work_offset=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="who1")
