...
- **9866**: Me called Duplidoc. Mazes, mazes everywhere. I see them all. Ya want something from me?
- **9867**: What do you want? [Never mind!/View copiable mazes./Register your Maze Tabula./Tell me more.]
- **9868**: New maze opens up, I visit. Never miss one. You want to see the mazes I've seen? I make you copy...for price.
- **9869**: My copies good as real thing. Maybe better. But I make too many, Goldagrik yell at me. Say bad for business. So you can only use copy five times max, okay?
- **9870**: Or maybe you a maze maker yourself? You give me maze, I copy. I give to others. Good times for all.
- **9871**: One catch. You want copy, you give me Moblin Marbles. New kid with no marbles? You go away. There better mazes for me to look at.
- **9872**: One more thing. I only copy maze I can remember. Popular maze, fun maze, I remember long time. So build good one.
- **9873**: Examine a list? [No thanks./View Hall of Fame Tabulae./View Maze Tabulae by theme.]
- **9874**: View mazes of which theme? [Cancel./MMM Sanitization Team Alpha./MMM Sanitization Team Beta./MMM Sanitization Team Gamma./MMM Materialization Team./MMM Actualization Team./MMM Appropriation Team./MMM Liquidation Team./MMM Aquatic Depopulation Team./MMM Revitalization Team.]
...
- **9881**: You trade me Maze Tabula, okay?
- **9882**: You register this maze. Okay?
- **9883**: Proceed with registration? [Register./Cancel.]
- **9884**: Confirming registration data...
...
```
  ...
  3: 0x0010 [0x1D] PRINT_EVENT_MESSAGE(message_id=9866*)
  ...
  7: 0x001F [0x24] CREATE_DIALOG(message_id=9867*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0049:
 ...
 16: 0x0051 [0x24] CREATE_DIALOG(message_id=9873*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0168:
 63: 0x0168 [0x24] CREATE_DIALOG(message_id=9877*, default_option=0*, option_flags=ExtData[1]->WorkLocal[6])
...
109: 0x027F [0x1D] PRINT_EVENT_MESSAGE(message_id=9878*)
...
112: 0x0285 [0x24] CREATE_DIALOG(message_id=9879*, default_option=1*, option_flags=0*)
...
146: 0x0344 [0x24] CREATE_DIALOG(message_id=9874*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
164: 0x0392 [0x1D] PRINT_EVENT_MESSAGE(message_id=9881*)
...
168: 0x03A1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9868*)
...
170: 0x03A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=9869*)
...
172: 0x03A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=9870*)
...
174: 0x03AD [0x1D] PRINT_EVENT_MESSAGE(message_id=9871*)
...
176: 0x03B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9872*)
