...
| [20018](#event-20018)    | 0x0001       |      8 |              2 |
| [20019](#event-20019)    | 0x0009       |      8 |              2 |
...
- **9878**: Nothing registered for that yet. You come back later.
- **9879**: Here's the list. You like one, you choose.
- **9880**: Which will you copy? [%0 (Popularity: $4)./%1 (Popularity: $5)./%2 (Popularity: $6)./%3 (Popularity: $7)./View next list./View previous list./Cancel.]
- **9881**: You want copy of this maze, you pay $8 gil. Deal?
- **9882**: Really copy this maze? [Make it so./Cancel.]
- **9889**: This theme, you already have maze registered. You switch? I warn you, old maze go bye-bye.
- **9890**: Okay to overwrite maze? [Yes./No.]
- **9891**: This cost you $8 Moblin Marbles. Deal?
- **9892**: Register this maze? ($7 marbles left). [Register./Cancel.]
- **9894**: You don't have enough Moblin Marbles for this transaction.
- **9900**: An error occurred when trying to retrieve Maze Tabula data.
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0000:    27 0A D8 50 0F 01 03  00                        '..P....       
```

#### Opcodes

```
  0: 0x0001 [0x27] REQ_SET(priority=0x0A, entity_id=Duplidoc (ID: 17780952/0x010F50D8), tag_num=0x03)
...
```
  0: 0x0009 [0x27] REQ_SET(priority=0x0A, entity_id=Duplidoc (ID: 17780952/0x010F50D8), tag_num=0x04)
...
SUBROUTINE_00D8:
 35: 0x00D8 [0x24] CREATE_DIALOG(message_id=9880*, default_option=0*, option_flags=ExtData[1]->WorkLocal[1])
...
SUBROUTINE_019B:
 ...
 79: 0x01DF [0x1D] PRINT_EVENT_MESSAGE(message_id=9881*)
 ...
 82: 0x01E5 [0x24] CREATE_DIALOG(message_id=9882*, default_option=1*, option_flags=0*)
...
```
  ...
  8: 0x02B8 [0x1D] PRINT_EVENT_MESSAGE(message_id=9889*)
 ...
 11: 0x02BE [0x24] CREATE_DIALOG(message_id=9890*, default_option=1*, option_flags=0*)
...
SUBROUTINE_02DC:
 ...
 18: 0x02E4 [0x1D] PRINT_EVENT_MESSAGE(message_id=9891*)
    → "This cost you $8 Moblin Marbles. Deal?"
 19: 0x02E7 [0x23] WAIT_FOR_DIALOG_INTERACTION
 20: 0x02E8 [0x24] CREATE_DIALOG(message_id=9892*, default_option=1*, option_flags=0*)
