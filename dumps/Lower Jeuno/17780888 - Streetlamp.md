...
- **7270**: Light the lamp? [Yes./No.]
- **7275**: The lamp is already lit.
- **7276**: The lamp is lit.
- **7277**: You examine the lamp. It seems that it must be lit manually.
- **7278**: It is too early to light it. You must wait until nine o'clock.
- **7279**: You have failed to light all the lamps in time.
...
```
  ...
  6: 0x0019 [0x24] CREATE_DIALOG(message_id=7270*, default_option=0*, option_flags=0*)
