...
| [20056](#event-20056)    | 0x0070       |      6 |              2 |
| [20065](#event-20065)    | 0x0076       |      6 |              2 |
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0040:                                      7A 05 07 51              z..Q
0050: 0F 01 02 00 00 01 80 01  6F 00 B6 00 01 80 62 06  ........o.....b.
...
```
  0: 0x004C [0x7A] VM_CONTROL: Reset copy state for Treasure Coffer (ID: 17780999/0x010F5107)
