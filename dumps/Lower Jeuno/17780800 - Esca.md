...
| [10021](#event-10021)      | 0x00D7       |      3 |              2 |
| [65535.16](#event-6553516) | 0x00DA       |     19 |              5 |
| [10022](#event-10022)      | 0x00ED       |      1 |              1 |
...
```
  0: 0x00D7 [0x22] ENTITY_HIDE_FLAG(enabled=0x00)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
00D0:                                29 08 40 50 0F 01            ).@P..
00E0: 01 1D 01 80 23 29 08 40  50 0F 01 02 00           ....#).@P....   
```

#### Opcodes

```
  0: 0x00DA [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Esca (ID: 17780800/0x010F5040), tag_num=0x01)
  1: 0x00E1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7942*)
    → "The Scarlet what?"
  2: 0x00E4 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x00E5 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Esca (ID: 17780800/0x010F5040), tag_num=0x02)
