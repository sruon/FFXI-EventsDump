...
02B0: 02 1D 2A 80 23 5E 69 64  6C 30 1E 07 51 0F 01 6F  ..*.#^idl0..Q..o
02C0: 70 5B 2B 80 F8 FF FF 7F  F8 FF FF 7F 68 61 70 30  p[+.........hap0
02D0: 1D 2C 80 23 02 04 00 03  80 00 EB 02 03 03 10 02  .,.#............
02E0: 00 29 80 07 51 0F 01 01  1C 2D 80 2C 07 51 0F 01  .)..Q....-.,.Q..
02F0: 07 51 0F 01 6F 70 65 6E  1C 2D 80 50 07 51 0F 01  .Q..open.-.P.Q..
0300: 07 51 0F 01 6F 70 65 6E  5B 2B 80 F8 FF FF 7F F8  .Q..open[+......
0310: FF FF 7F 68 61 70 31 2C  07 51 0F 01 07 51 0F 01  ...hap1,.Q...Q..
...
0400: 80 B4 04 1E 07 51 0F 01  6F 70 5B 2B 80 F8 FF FF  .....Q..op[+....
0410: 7F F8 FF FF 7F 68 61 70  30 1D 2C 80 23 02 04 00  .....hap0.,.#...
0420: 03 80 00 34 04 03 03 10  02 00 29 80 07 51 0F 01  ...4......)..Q..
0430: 01 1C 2D 80 2C 07 51 0F  01 07 51 0F 01 6F 70 65  ..-.,.Q...Q..ope
0440: 6E 1C 2D 80 50 07 51 0F  01 07 51 0F 01 6F 70 65  n.-.P.Q...Q..ope
0450: 6E 5B 2B 80 F8 FF FF 7F  F8 FF FF 7F 68 61 70 31  n[+.........hap1
0460: 2C 07 51 0F 01 07 51 0F  01 63 6C 6F 73 1E F0 FF  ,.Q...Q..clos...
...
```
  ...
  4: 0x01EE [0x1D] PRINT_EVENT_MESSAGE(message_id=10878*)
  ...
  6: 0x01F2 [0x1D] PRINT_EVENT_MESSAGE(message_id=10879*)
  ...
  8: 0x01F6 [0x1D] PRINT_EVENT_MESSAGE(message_id=10880*)
 ...
 10: 0x01FA [0x1D] PRINT_EVENT_MESSAGE(message_id=10881*)
 ...
 12: 0x01FE [0x1D] PRINT_EVENT_MESSAGE(message_id=10883*)
 ...
 14: 0x0202 [0x1D] PRINT_EVENT_MESSAGE(message_id=10884*)
 ...
 16: 0x0206 [0x1D] PRINT_EVENT_MESSAGE(message_id=10877*)
...
# Dead code (unreachable instructions):
     0x0216 [0x1D] PRINT_EVENT_MESSAGE(message_id=10866*)
    → "Bah-dah-bah-dahm dah-daaahm! \u007F6\u0001\u0007Ya open da chest. Dat's it. And da kicker be dat I'm da one doin' da openin'.\u0007Ya just gets tah stand dere gawkin' in astonishmament. Easy gig, no?\u007F1\u0000\u0007"
     ...
     0x021A [0x1D] PRINT_EVENT_MESSAGE(message_id=10867*)
    → "Oh yeah, 'fore I forget.\u0007What good's a chest if ya ain't gots da key? Well, da key to dis chest is da fine art o' waitin'.\u007F1\u0000\u0007"
     ...
     0x021E [0x1D] PRINT_EVENT_MESSAGE(message_id=10870*)
    → "Also, I calls da amount o' time ya's waited yer circa...circama...circamadamian...ugh, yer \u00072daily tally.\u00073\u0007It ain't just da name dat's catchy, though. Da higher yer tally, da gooder yer goods get! Can't get much good--er, simpler dan dat.\u007F1\u0000\u0007"
     ...
     0x0222 [0x1D] PRINT_EVENT_MESSAGE(message_id=10871*)
    → "Finally, ya opens da chest.\u0007Oooh, I can barely contain m'self thinkin' o' all da riches I--er, ya could have!\u007F1\u0000\u0007"
     ...
     0x0226 [0x1D] PRINT_EVENT_MESSAGE(message_id=10872*)
    → "Oh, dat's right!\u0007Heyheyhey, got any items ya won't be needin'? If so, fork 'em over 'n yer daily tally'll increase!\u0007Mebbe not by much, but dat's better'n nothin', am I right?\u007F1\u0000\u0007"
     ...
     0x022A [0x1D] PRINT_EVENT_MESSAGE(message_id=10873*)
    → "And dere's no better feelin' dan takin' trash and turnin' it into treasure. It's pramactically a new kind o' alchemy!\u0007But don't go gung ho 'n overfills da thing 'til its hinges break. Myst'ry boxes don't grow on goobbues, y'know.\u007F1\u0000\u0007"
     ...
     0x022E [0x1D] PRINT_EVENT_MESSAGE(message_id=10874*)
    → "Plus, I'll be here tah stops ya if I sees ya stuffin' whole Gobbiebags worth o' possessions in dere, so don't worry yer oversized noggin' over and over over it.\u0007Whats was I sayin' again? Ugh, never mind.\u007F1\u0000\u0007"
     ...
     0x0232 [0x1D] PRINT_EVENT_MESSAGE(message_id=10875*)
    → "Sadly, howsever, anodda myst'ry 'bout dis chest is dat it won't takes just any ol' bauble.\u0007It has da taste o' a picky peiste--it feasts upon nothin' but da rarest and unique-est o' artifacts.\u007F1\u0000\u0007"
     ...
     0x0236 [0x1D] PRINT_EVENT_MESSAGE(message_id=10876*)
    → "Lastly, since we don't knows where da items go once inside, ya ain't gettin' nothin' back datcha put in.\u0007Ya reap whatcha sow, and da weather ain't always condusimasive to a good harvest, am I right? My condolemances in advance for any losses ya mights incur from da myst'ry box's fickle nature.\u007F1\u0000\u0007"
     ...
     0x023A [0x1D] PRINT_EVENT_MESSAGE(message_id=10882*)
    → "Oh ho, I's forgettin' tah explain somethin' to ya. See dese \u00072special dials\u00073? Dey're super primo, but I still no know wut's gonna be in dere.\u007F1\u0000\u0007"
     ...
     0x023E [0x1D] PRINT_EVENT_MESSAGE(message_id=10883*)
    → "So I's not be takin' no responsibility if somethin' weird 'n wacky comes out. Got it? Ya open it, ya keep it.\u007F1\u0000\u0007"
     0x0241 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0242 [0x1D] PRINT_EVENT_MESSAGE(message_id=10884*)
    → "'N openin' 'em requires some kinda secret technique. Maybe it'll succeed, maybe tha box'll break. 'Sif I know. But ya can only try 'em once a day.\u007F1\u0000\u0007"
     0x0245 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0246 [0x1D] PRINT_EVENT_MESSAGE(message_id=10877*)
    → "Dat all make 'nough sense tah ya? Just say da woid when ya wanna use my services. I's more'n happy tah help.\u007F1\u0000\u0007"
     ...
     0x026A [0x1D] PRINT_EVENT_MESSAGE(message_id=10891*)
    → "Yer goin' wit' dial 
\u0001, huh? Lessee what myst'ries await!\u0000\u0007"
     ...
     0x02B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=10912*)
    → "So ya be wantin' the \u000C\u0000[special/Adoulin/pictlogica/Wanted/campaign] dial?\u0007M'kay, get yerself all steeled up, 'cause here we go! 'Member, no complaints!\u0000\u0007"
     ...
     0x02BA [0x1E] EventEntity looks at Treasure Coffer (ID: 17780999/0x010F5107) and starts talking
     ...
     0x02D0 [0x1D] PRINT_EVENT_MESSAGE(message_id=10892*)
    → "Dis box is full o' myst'ries,\u0001t\u0007Dat span da realm's his'try,\u0001t\u0007So whatcha gonna get from da chest...o'...uh, fortunery?\u0001t\u0000\u0007"
     ...
     0x02E1 [0x29] REQ_SET_WAIT(priority=0x80, entity_id=Treasure Coffer (ID: 17780999/0x010F5107), tag_num=0x01)
     0x02E8 [0x1C] WAIT(90* ticks)
     0x02EB [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "open" with entities [Treasure Coffer (ID: 17780999/0x010F5107), Treasure Coffer (ID: 17780999/0x010F5107)]
     0x02F8 [0x1C] WAIT(90* ticks)
     0x02FB [0x50] END_SCHEDULER_TASK: End scheduler "op" with entities [0x5107, 0x5107], work=[271, 271]
     0x0308 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "hap1" with entities [EventEntity, EventEntity], work=216*
     0x0317 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "clos" with entities [Treasure Coffer (ID: 17780999/0x010F5107), Treasure Coffer (ID: 17780999/0x010F5107)]
     ...
     0x033A [0x1D] PRINT_EVENT_MESSAGE(message_id=10893*)
...
\u0001, huh? \u007F6\u0002\u0007Whatchu tryin' ta pull!? Yer daily tally's too low.\u007F1\u0000\u0007"
    ...
    → "So ya be wantin' the special dial?\u007F6\u0002\u0007Whoawhoawhoa! Get yer grubby hands offa that! Ya don't have enough daily tally, and I's not 'bout tah let ya cheat me!\u007F1\u0000\u0007"
     ...
     0x03F4 [0x1D] PRINT_EVENT_MESSAGE(message_id=10913*)
    → "So ya be wantin' the \u000C\u0000[special/Adoulin/pictlogica/Wanted] dial?\u007F6\u0001\u0007Whoawhoawhoa! Get yer grubby hands offa that! I's already opened one fer ya today! Haul that keister outta here and come back t'morrow.\u007F1\u0000\u0007"
     ...
     0x0403 [0x1E] EventEntity looks at Treasure Coffer (ID: 17780999/0x010F5107) and starts talking
     ...
     0x0419 [0x1D] PRINT_EVENT_MESSAGE(message_id=10892*)
    → "Dis box is full o' myst'ries,\u0001t\u0007Dat span da realm's his'try,\u0001t\u0007So whatcha gonna get from da chest...o'...uh, fortunery?\u0001t\u0000\u0007"
     ...
     0x042A [0x29] REQ_SET_WAIT(priority=0x80, entity_id=Treasure Coffer (ID: 17780999/0x010F5107), tag_num=0x01)
     0x0431 [0x1C] WAIT(90* ticks)
     0x0434 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "open" with entities [Treasure Coffer (ID: 17780999/0x010F5107), Treasure Coffer (ID: 17780999/0x010F5107)]
     0x0441 [0x1C] WAIT(90* ticks)
     0x0444 [0x50] END_SCHEDULER_TASK: End scheduler "op" with entities [0x5107, 0x5107], work=[271, 271]
     0x0451 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "hap1" with entities [EventEntity, EventEntity], work=216*
     0x0460 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "clos" with entities [Treasure Coffer (ID: 17780999/0x010F5107), Treasure Coffer (ID: 17780999/0x010F5107)]
     ...
     0x0483 [0x1D] PRINT_EVENT_MESSAGE(message_id=10893*)
    → "Oooh, looks at what popped out! I hopes it makes yer adventures dat much more adventumarous!\u0000\u0007"
