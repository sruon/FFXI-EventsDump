...
|---------|-------------|-------------|
|       0 | 0x771F      |       30495 |
|       1 | 0xFFFFD2E7  |  4294955751 |
|       2 | 0xFFFFFF91  |  4294967185 |
|       3 | 0x0159      |         345 |
|       4 | 0x000D      |          13 |
|       5 | 0x80F8      |       33016 |
|       6 | 0xFFFFCDA8  |  4294954408 |
|       7 | 0x8957      |       35159 |
|       8 | 0xFFFFCC3F  |  4294954047 |
|       9 | 0xFFFFFF9D  |  4294967197 |
|      10 | 0x553D      |       21821 |
|      11 | 0xFFFFE6BF  |  4294960831 |
...
```
  ...
  1: 0x0043 [0x1F] MOVE_ENTITY: EventEntity moves to X=33.016*, Z=-12.888*, Y=-0.111*
  2: 0x004B [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x004D [0x1F] MOVE_ENTITY: EventEntity moves to X=21.821*, Z=-6.465*, Y=-0.111*
