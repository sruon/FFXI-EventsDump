...
- **7129**: <Mumble, mumble> Those fools...how d-d-dare they suspect me--the foremost authority on the research of mystical artifacts--of theft!?
- **7130**: ...!? That w-w-weapon which you bear--it's the very object I've been searching for! Ahee hee hee...
- **7131**: Listen to me. Immense p-p-power is hidden within your $8.
- **7132**: There's a trick to unlocking that power--a t-t-trick which I happen to know. Ahee hee hee...
- **7133**: Surely, you're interested in tapping into that power? It'll cost you not a single g-g-gil--I just need to be permitted to examine it, that's all.
- **7134**: Let him examine your weapon? [More power? Gimme, gimme!/He's got shifty eyes...]
- **7135**: ... You're no different from those fools who suspect me! G-g-get out of my sight!
- **7136**: Yes, yes, trust is good for the soul. Now, if you'll allow me, hee hee hee...
- **7137**: The deed is done. The rest is up to you to wield it as you have thus far.
- **7138**: An invisible, mystical energy resides within your weapon. I would explain the n-n-nature of this energy in more detail, but I fear it is beyond the comprehension of a layperson.
- **7142**: Note, though, that I have merely awakened your weapon from its long s-s-slumber. You must, through usage, accumulate said energy to the point of saturation.
- **7143**: With that accomplished, a m-m-most extraordinary evolution will take place.
- **7144**: When that happens, bring the weapon to me. I promise it'll be a profitable v-v-venture for you...and yours truly, too. Ahee hee hee...
- **7145**: When you sense a ch-ch-change has occurred within your weapon, bring it to me. I promise you won't regret it.
- **7146**: Hmm... I sense only a mote of energy p-p-present. You still have a long way to go, it seems.
- **7147**: Aaah, yes... I can feel a marked increase in energy compared to when I first held it. Keep up the good w-w-work, hee hee hee...
- **7148**: Goodness g-g-gracious me! The energy within is threatening to b-b-burst forth! It won't be long now, hee hee hee...
- **7149**: You've done it! Energy is overflowing as though the floodg-g-gates have burst open!
- **7150**: Using the surplus energy from the $8, I will imbue a new power within you. This might sting a little, hee hee hee!
- **7151**: Each step brings me closer to being reinstated to my post in the Imperial Court. Ahee hee hee...
...
```
  ...
  3: 0x000F [0x1D] PRINT_EVENT_MESSAGE(message_id=7129*)
...
101: 0x0243 [0x1D] PRINT_EVENT_MESSAGE(message_id=7130*)
...
103: 0x0247 [0x1D] PRINT_EVENT_MESSAGE(message_id=7131*)
    → "Listen to me. Immense p-p-power is hidden within your $8."
104: 0x024A [0x23] WAIT_FOR_DIALOG_INTERACTION
105: 0x024B [0x1D] PRINT_EVENT_MESSAGE(message_id=7132*)
...
110: 0x027A [0x1D] PRINT_EVENT_MESSAGE(message_id=7133*)
...
114: 0x029A [0x24] CREATE_DIALOG(message_id=7134*, default_option=0*, option_flags=0*)
...
118: 0x02B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7136*)
...
134: 0x034F [0x1D] PRINT_EVENT_MESSAGE(message_id=7137*)
...
139: 0x037E [0x1D] PRINT_EVENT_MESSAGE(message_id=7138*)
...
151: 0x041A [0x1D] PRINT_EVENT_MESSAGE(message_id=7142*)
...
163: 0x0459 [0x1D] PRINT_EVENT_MESSAGE(message_id=7135*)
...
```
  ...
  6: 0x04C5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7145*)
...
102: 0x0703 [0x1D] PRINT_EVENT_MESSAGE(message_id=7149*)
...
107: 0x071E [0x1D] PRINT_EVENT_MESSAGE(message_id=7150*)
...
123: 0x07B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7151*)
...
```
  ...
  3: 0x0836 [0x1D] PRINT_EVENT_MESSAGE(message_id=7151*)
    → "Each step brings me closer to being reinstated to my post in the Imperial Court. Ahee hee hee..."
...
```
  ...
  6: 0x085B [0x1D] PRINT_EVENT_MESSAGE(message_id=7135*)
    → "... You're no different from those fools who suspect me! G-g-get out of my sight!"
...
```
  ...
  6: 0x0880 [0x1D] PRINT_EVENT_MESSAGE(message_id=7146*)
...
```
  ...
  6: 0x08A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7147*)
...
```
  ...
  6: 0x08CA [0x1D] PRINT_EVENT_MESSAGE(message_id=7148*)
