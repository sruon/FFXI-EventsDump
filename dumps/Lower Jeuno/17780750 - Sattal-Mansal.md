...
| [11](#event-11)          | 0x0001       |     43 |              9 |
| [86](#event-86)          | 0x002C       |     12 |              3 |
| [65535.1](#event-655351) | 0x0038       |     16 |              5 |
| [65535.2](#event-655352) | 0x0048       |     36 |              4 |
| [22](#event-22)          | 0x006C       |     24 |              5 |
| [65535.3](#event-655353) | 0x0084       |     49 |             11 |
| [95](#event-95)          | 0x00B5       |     40 |             12 |
| [90](#event-90)          | 0x00DD       |     36 |             10 |
| [93](#event-93)          | 0x0101       |     75 |             21 |
| [94](#event-94)          | 0x014C       |     36 |             10 |
| [88](#event-88)          | 0x0170       |     36 |             10 |
| [87](#event-87)          | 0x0194       |     40 |             12 |
| [20](#event-20)          | 0x01BC       |     20 |              3 |
| [65535.4](#event-655354) | 0x01D0       |     28 |              8 |
| [65535.5](#event-655355) | 0x01EC       |      9 |              3 |
| [89](#event-89)          | 0x01F5       |     83 |             22 |
| [96](#event-96)          | 0x0248       |     45 |             15 |
| [91](#event-91)          | 0x0275       |     56 |             13 |
| [92](#event-92)          | 0x02AD       |     56 |             13 |
| [65535.6](#event-655356) | 0x02E5       |     16 |              2 |
| [65535.7](#event-655357) | 0x02F5       |     16 |              2 |
| [65535.8](#event-655358) | 0x0305       |     16 |              2 |
| [10061](#event-10061)    | 0x0315       |     40 |             12 |
| [10062](#event-10062)    | 0x033D       |      1 |              1 |
| [10063](#event-10063)    | 0x033E       |      1 |              1 |
| [10064](#event-10064)    | 0x033F       |      1 |              1 |
| [10065](#event-10065)    | 0x0340       |      1 |              1 |
| [10066](#event-10066)    | 0x0341       |      1 |              1 |
| [10067](#event-10067)    | 0x0342       |      1 |              1 |
| [10068](#event-10068)    | 0x0343       |      1 |              1 |
| [10069](#event-10069)    | 0x0344       |      1 |              1 |
| [10070](#event-10070)    | 0x0345       |      1 |              1 |
| [10071](#event-10071)    | 0x0346       |      1 |              1 |
| [10072](#event-10072)    | 0x0347       |      1 |              1 |
| [10125](#event-10125)    | 0x0348       |      1 |              1 |
...
- **7711**: Our boss looks all hairy-scary, but he caves in to his sister Verena all the time.
- **7712**: Verena's a really nice girl. We all think she's super-duper swell.
- **7713**: But don't you lay a single-wingle finger on her. People who do... Well, they have a tendency to be found dead, floating off the pier. So please, keep that in mind.
- **7714**: Wait, so all you got from Aldo was $6? Kinda stingy-winjy of him, don't you think?
- **7715**: There's a place in Beadeaux where you need $6 and $6 just to get in. If you want, we can try to hook you up.
- **7716**: Tell you what. I'll trade you $6 for $5, and I'll let you have $6 if you find me $7.
- **7717**: Okey-dokey, here you go.
- **7719**: Okey-dokey, here you go.
- **7721**: I'm shocked... I'm stunned... I can't believe that Lady-wady Verena is missing. If I had the time, I'd be out there searching...
- **7722**: If anything happened to her, what would I do!?
- **7723**: That cutie-wootie Lion was here the other day talking to the boss. A lucky man, he is...
- **7724**: Lady-wady Verena is back, but she's not doing that good... What did she do to deserve this!?
- **7725**: What happened in Delkfutt's Tower!? You can tell me, we're buddy-wuddies!
- **7726**: Tell him about what happened? [Yes./No.]
- **7727**: No, wait... Maybe it's better that I don't know. I'll just pray for Lady-wady Verena's recovery, and ask her myself.
- **7728**: You mean, it was that bad...? Okay, just forget that I asked.
- **7729**: Lady-wady Verena's bak in tip-top shape? That's great! Maybe I should go in and see how she's doing... But what if she's forgotten who I was!?
- **7730**: The boss told me to get his equipment ready-steady. But, when I asked him where he was going, he told me to mind my own busy-business!
- **7731**: This is great! This is stupendous! I have a feeling that everything will finally-winally go back to being the way it was!
- **7732**: But I'm still kinda worried about Verena... She's growing up so fast!
- **8698**: That blue-haired girl was taken to Monberaux's after the attack. I'm pretty sure she'll be all right, though. Doctor M. is the best medic in town.
- **9520**: What's going on? The boss is walking around like he's seen the Gates of Paradise, or something.
- **9521**: He always gets like that when you're around. I don't get it, you don't look that special to me. It's starting to give me the heebie-jeebies...
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=8698*)
...
```
  ...
  4: 0x00CB [0x1D] PRINT_EVENT_MESSAGE(message_id=7721*)
  ...
  6: 0x00CF [0x1D] PRINT_EVENT_MESSAGE(message_id=7722*)
...
```
  ...
  4: 0x00F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7723*)
...
```
  ...
  4: 0x0117 [0x1D] PRINT_EVENT_MESSAGE(message_id=7724*)
  ...
  6: 0x011B [0x1D] PRINT_EVENT_MESSAGE(message_id=7725*)
  ...
  9: 0x0124 [0x24] CREATE_DIALOG(message_id=7726*, default_option=1*, option_flags=0*)
    → "Tell him about what happened? [Yes./No.]"
 10: 0x012B [0x25] WAIT_DIALOG_SELECT()
 11: 0x012C [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x013B
 12: 0x0134 [0x1D] PRINT_EVENT_MESSAGE(message_id=7727*)
 ...
 16: 0x0143 [0x1D] PRINT_EVENT_MESSAGE(message_id=7728*)
...
```
  ...
  4: 0x0162 [0x1D] PRINT_EVENT_MESSAGE(message_id=7729*)
...
```
  ...
  4: 0x0186 [0x1D] PRINT_EVENT_MESSAGE(message_id=7730*)
...
```
  ...
  4: 0x01AA [0x1D] PRINT_EVENT_MESSAGE(message_id=7731*)
  ...
  6: 0x01AE [0x1D] PRINT_EVENT_MESSAGE(message_id=7732*)
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
01E0:                                      1C 19 80 1E              ....
01F0: 07 50 0F 01 00                                    .P...           
```

#### Opcodes

```
  0: 0x01EC [0x1C] WAIT(60* ticks)
  1: 0x01EF [0x1E] EventEntity looks at Aldo (ID: 17780743/0x010F5007) and starts talking
...
```
 ...
 16: 0x023A [0x1D] PRINT_EVENT_MESSAGE(message_id=7716*)
...
```
  ...
  5: 0x025F [0x1D] PRINT_EVENT_MESSAGE(message_id=7711*)
...
```
  ...
  6: 0x028E [0x1D] PRINT_EVENT_MESSAGE(message_id=7717*)
...
```
  ...
  6: 0x02C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7719*)
    → "Okey-dokey, here you go."
...
```
  0: 0x02E5 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "zit0" with entities [EventEntity, EventEntity], work=40*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
02F0:                66 00 80  F8 FF FF 7F F8 FF FF 7F       f..........
0300: 74 6C 6B 30 00                                    tlk0.           
```

#### Opcodes

```
  0: 0x02F5 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk0" with entities [EventEntity, EventEntity], work=40*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0300:                66 00 80  F8 FF FF 7F F8 FF FF 7F       f..........
0310: 74 6C 6B 31 00                                    tlk1.           
```

#### Opcodes

```
  0: 0x0305 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk1" with entities [EventEntity, EventEntity], work=40*
...
```
  ...
  4: 0x032B [0x1D] PRINT_EVENT_MESSAGE(message_id=9520*)
  ...
  6: 0x032F [0x1D] PRINT_EVENT_MESSAGE(message_id=9521*)
