...
- **7707**: Our boss looks all hairy-scary, but he caves in to his sister Verena all the time.
- **7708**: Verena's a really nice girl. We all think she's super-duper swell.
- **7709**: But don't you lay a single-wingle finger on her. People who do... Well, they have a tendency to be found dead, floating off the pier. So please, keep that in mind.
- **7710**: Wait, so all you got from Aldo was $6? Kinda stingy-winjy of him, don't you think?
- **7711**: There's a place in Beadeaux where you need $6 and $6 just to get in. If you want, we can try to hook you up.
- **7712**: Tell you what. I'll trade you $6 for $5, and I'll let you have $6 if you find me $7.
- **7713**: Okey-dokey, here you go.
- **7715**: Okey-dokey, here you go.
- **7717**: I'm shocked... I'm stunned... I can't believe that Lady-wady Verena is missing. If I had the time, I'd be out there searching...
- **7718**: If anything happened to her, what would I do!?
- **7719**: That cutie-wootie Lion was here the other day talking to the boss. A lucky man, he is...
- **7720**: Lady-wady Verena is back, but she's not doing that good... What did she do to deserve this!?
- **7721**: What happened in Delkfutt's Tower!? You can tell me, we're buddy-wuddies!
- **7722**: Tell him about what happened? [Yes./No.]
- **7723**: No, wait... Maybe it's better that I don't know. I'll just pray for Lady-wady Verena's recovery, and ask her myself.
- **7724**: You mean, it was that bad...? Okay, just forget that I asked.
- **7725**: Lady-wady Verena's bak in tip-top shape? That's great! Maybe I should go in and see how she's doing... But what if she's forgotten who I was!?
- **7726**: The boss told me to get his equipment ready-steady. But, when I asked him where he was going, he told me to mind my own busy-business!
- **7727**: This is great! This is stupendous! I have a feeling that everything will finally-winally go back to being the way it was!
- **7728**: But I'm still kinda worried about Verena... She's growing up so fast!
- **8694**: That blue-haired girl was taken to Monberaux's after the attack. I'm pretty sure she'll be all right, though. Doctor M. is the best medic in town.
- **9516**: What's going on? The boss is walking around like he's seen the Gates of Paradise, or something.
- **9517**: He always gets like that when you're around. I don't get it, you don't look that special to me. It's starting to give me the heebie-jeebies...
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=8694*)
...
```
  ...
  4: 0x00CB [0x1D] PRINT_EVENT_MESSAGE(message_id=7717*)
  ...
  6: 0x00CF [0x1D] PRINT_EVENT_MESSAGE(message_id=7718*)
...
```
  ...
  4: 0x00F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7719*)
...
```
  ...
  4: 0x0117 [0x1D] PRINT_EVENT_MESSAGE(message_id=7720*)
  ...
  6: 0x011B [0x1D] PRINT_EVENT_MESSAGE(message_id=7721*)
  ...
  9: 0x0124 [0x24] CREATE_DIALOG(message_id=7722*, default_option=1*, option_flags=0*)
    → "Tell him about what happened? [Yes./No.]"
 10: 0x012B [0x25] WAIT_DIALOG_SELECT()
 11: 0x012C [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x013B
 12: 0x0134 [0x1D] PRINT_EVENT_MESSAGE(message_id=7723*)
 ...
 16: 0x0143 [0x1D] PRINT_EVENT_MESSAGE(message_id=7724*)
...
```
  ...
  4: 0x0162 [0x1D] PRINT_EVENT_MESSAGE(message_id=7725*)
...
```
  ...
  4: 0x0186 [0x1D] PRINT_EVENT_MESSAGE(message_id=7726*)
...
```
  ...
  4: 0x01AA [0x1D] PRINT_EVENT_MESSAGE(message_id=7727*)
  ...
  6: 0x01AE [0x1D] PRINT_EVENT_MESSAGE(message_id=7728*)
...
```
 ...
 16: 0x023A [0x1D] PRINT_EVENT_MESSAGE(message_id=7712*)
...
```
  ...
  5: 0x025F [0x1D] PRINT_EVENT_MESSAGE(message_id=7707*)
...
```
  ...
  6: 0x028E [0x1D] PRINT_EVENT_MESSAGE(message_id=7713*)
...
```
  ...
  6: 0x02C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7715*)
    → "Okey-dokey, here you go."
...
```
  ...
  4: 0x032B [0x1D] PRINT_EVENT_MESSAGE(message_id=9516*)
  ...
  6: 0x032F [0x1D] PRINT_EVENT_MESSAGE(message_id=9517*)
