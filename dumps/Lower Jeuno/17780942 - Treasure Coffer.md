...
SUBROUTINE_0024:
 ...
 10: 0x0025 [0x24] CREATE_DIALOG(message_id=9931*, default_option=0*, option_flags=ExtData[1]->WorkLocal[12])
...
SUBROUTINE_0090:
 ...
 51: 0x00E5 [0x24] CREATE_DIALOG(message_id=9930*, default_option=ExtData[1]->WorkLocal[10], option_flags=ExtData[1]->WorkLocal[6])
...
111: 0x021D [0x24] CREATE_DIALOG(message_id=9930*, default_option=ExtData[1]->WorkLocal[10], option_flags=ExtData[1]->WorkLocal[7])
    → "Which key will you use? [None of them./6 (Level $7)./$6 (Level $8)./$6 (Level $9)./$6 (Level $10)./$6 (Level $11)./$6 (Level $12)./$6 (Scenario completed).]"
...
162: 0x0321 [0x24] CREATE_DIALOG(message_id=9930*, default_option=ExtData[1]->WorkLocal[10], option_flags=ExtData[1]->WorkLocal[8])
    → "Which key will you use? [None of them./6 (Level $7)./$6 (Level $8)./$6 (Level $9)./$6 (Level $10)./$6 (Level $11)./$6 (Level $12)./$6 (Scenario completed).]"
...
246: 0x04DE [0x24] CREATE_DIALOG(message_id=9933*, default_option=0*, option_flags=0*)
...
288: 0x059F [0x24] CREATE_DIALOG(message_id=9934*, default_option=1*, option_flags=0*)
...
306: 0x05EA [0x24] CREATE_DIALOG(message_id=9937*, default_option=1*, option_flags=0*)
...
SUBROUTINE_0651:
329: 0x0651 [0x24] CREATE_DIALOG(message_id=9939*, default_option=0*, option_flags=0*)
...
388: 0x077C [0x24] CREATE_DIALOG(message_id=9933*, default_option=0*, option_flags=0*)
    → "Obtain which item? [Cancel./$0./$1./$2.]"
...
SUBROUTINE_0803:
417: 0x0803 [0x24] CREATE_DIALOG(message_id=9941*, default_option=0*, option_flags=0*)
...
476: 0x092E [0x24] CREATE_DIALOG(message_id=9933*, default_option=0*, option_flags=0*)
    → "Obtain which item? [Cancel./$0./$1./$2.]"
...
SUBROUTINE_09B5:
505: 0x09B5 [0x24] CREATE_DIALOG(message_id=9942*, default_option=0*, option_flags=0*)
