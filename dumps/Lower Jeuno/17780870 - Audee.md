...
- **6724**: If you wish to ride a chocobo, you must possess $6 and have a high enough job level.
- **6725**: You can rent a chocobo for $0 gil. I see you currently have $1 gil.
- **6726**: You can rent a chocobo, but because your level is so low, you won't be able to ride for very long. Also, equipment that extends your riding time will have no effect.
- **6727**: If you still want one, it will cost you $0 gil. I see you currently have $1 gil.
- **6728**: Do you wish to rent a chocobo? [Yes, I do./No, thank you.]
- **6729**: You don't have enough gil.
...
```
 ...
 10: 0x0043 [0x1D] PRINT_EVENT_MESSAGE(message_id=6725*)
 ...
 13: 0x004A [0x1D] PRINT_EVENT_MESSAGE(message_id=6726*)
 ...
 15: 0x004E [0x1D] PRINT_EVENT_MESSAGE(message_id=6727*)
    → "If you still want one, it will cost you $0 gil. I see you currently have $1 gil."
 16: 0x0051 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_0052:
 17: 0x0052 [0x24] CREATE_DIALOG(message_id=6728*, default_option=1*, option_flags=0*)
...
SUBROUTINE_006A:
 ...
 44: 0x0108 [0x1D] PRINT_EVENT_MESSAGE(message_id=6729*)
...
```
  ...
  2: 0x0127 [0x1D] PRINT_EVENT_MESSAGE(message_id=6724*)
