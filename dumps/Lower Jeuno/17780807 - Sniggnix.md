...
- **7968**: Hey, we don't trust you people none, but we can always smell a profit!
- **7969**: Hey, daredevil... You lookin' for Pauluart? He comes here lots.
- **7970**: Let's roll some dice. Loser gets to see Pauluart and get killed.
- **7971**: Roll the dice? [Let's do it./Just a minute.]
- **7972**: You roll the die and get a $2!
- **7973**: Sniggnix rolls the die and gets a $3!
- **7974**: Here's your chance. Go to Dangruf Wadi and find Dangruf brothers. They have $1.
- **7975**: Uh-oh.
- **7976**: That ain't good.
- **7977**: You got $1. If you have that die, you win against Pauluart.
- **7978**: If you lose, say, "Smaller number wins."
- **7979**: Wait outside. I go get Pauluart and come back.
- **7988**: You roll the die and get a $2!
- **7990**: Pauluart rolls the die and gets 789!
- **7992**: Yell out? [The smaller number wins!]
- **7997**: You rolled lower number, right? This die, also called "Sinner's Die." When you roll that die, they tell the weight of your sins.
- **7998**: Pauluart's sins, far greater than yours. He has no right to judge your guilt.
...
```
  ...
  5: 0x001F [0x24] CREATE_DIALOG(message_id=7971*, default_option=0*, option_flags=0*)
  ...
  9: 0x0034 [0x48] [System] [7972*]:
    → "You roll the die and get a $2!"
 10: 0x0037 [0x48] [System] [7973*]:
 ...
 14: 0x004C [0x1D] PRINT_EVENT_MESSAGE(message_id=7976*)
    → "That ain't good."
...
SUBROUTINE_0055:
 ...
 20: 0x0065 [0x1D] PRINT_EVENT_MESSAGE(message_id=7975*)
    → "Uh-oh."
...
```
  0: 0x0070 [0x1D] PRINT_EVENT_MESSAGE(message_id=7969*)
    → "Hey, daredevil... You lookin' for Pauluart? He comes here lots."
  1: 0x0073 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0074 [0x1D] PRINT_EVENT_MESSAGE(message_id=7970*)
...
```
  0: 0x0079 [0x1D] PRINT_EVENT_MESSAGE(message_id=7974*)
...
```
  ...
  3: 0x0085 [0x1D] PRINT_EVENT_MESSAGE(message_id=7974*)
    → "Here's your chance. Go to Dangruf Wadi and find Dangruf brothers. They have $1."
...
106: 0x0459 [0x24] CREATE_DIALOG(message_id=7992*, default_option=0*, option_flags=0*)
...
135: 0x0543 [0x2B] Pauluart (ID: 17780808/0x010F5048) [7996*]:
...
```
  0: 0x05A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7977*)
    → "You got $1. If you have that die, you win against Pauluart."
  1: 0x05A6 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x05A7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7978*)
...
```
  0: 0x05AC [0x1D] PRINT_EVENT_MESSAGE(message_id=7979*)
...
```
  ...
  3: 0x05B8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7997*)
  ...
  5: 0x05BC [0x1D] PRINT_EVENT_MESSAGE(message_id=7998*)
