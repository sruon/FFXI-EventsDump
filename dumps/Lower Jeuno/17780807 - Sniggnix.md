...
- **7970**: Hey, we don't trust you people none, but we can always smell a profit!
- **7971**: Hey, daredevil... You lookin' for Pauluart? He comes here lots.
- **7972**: Let's roll some dice. Loser gets to see Pauluart and get killed.
- **7973**: Roll the dice? [Let's do it./Just a minute.]
- **7974**: You roll the die and get a $2!
- **7975**: Sniggnix rolls the die and gets a $3!
- **7976**: Here's your chance. Go to Dangruf Wadi and find Dangruf brothers. They have $1.
- **7977**: Uh-oh.
- **7978**: That ain't good.
- **7979**: You got $1. If you have that die, you win against Pauluart.
- **7980**: If you lose, say, "Smaller number wins."
- **7981**: Wait outside. I go get Pauluart and come back.
- **7990**: You roll the die and get a $2!
- **7992**: Pauluart rolls the die and gets 789!
- **7994**: Yell out? [The smaller number wins!]
- **7999**: You rolled lower number, right? This die, also called "Sinner's Die." When you roll that die, they tell the weight of your sins.
- **8000**: Pauluart's sins, far greater than yours. He has no right to judge your guilt.
...
```
  ...
  3: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=7970*)
...
```
  ...
  5: 0x001F [0x24] CREATE_DIALOG(message_id=7973*, default_option=0*, option_flags=0*)
  ...
  9: 0x0034 [0x48] [System] [7974*]:
    → "You roll the die and get a $2!"
 10: 0x0037 [0x48] [System] [7975*]:
 ...
 14: 0x004C [0x1D] PRINT_EVENT_MESSAGE(message_id=7978*)
    → "That ain't good."
...
SUBROUTINE_0055:
 ...
 20: 0x0065 [0x1D] PRINT_EVENT_MESSAGE(message_id=7977*)
    → "Uh-oh."
...
```
  0: 0x0070 [0x1D] PRINT_EVENT_MESSAGE(message_id=7971*)
    → "Hey, daredevil... You lookin' for Pauluart? He comes here lots."
  1: 0x0073 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0074 [0x1D] PRINT_EVENT_MESSAGE(message_id=7972*)
...
```
  0: 0x0079 [0x1D] PRINT_EVENT_MESSAGE(message_id=7976*)
...
```
  ...
  3: 0x0085 [0x1D] PRINT_EVENT_MESSAGE(message_id=7976*)
    → "Here's your chance. Go to Dangruf Wadi and find Dangruf brothers. They have $1."
...
106: 0x0459 [0x24] CREATE_DIALOG(message_id=7994*, default_option=0*, option_flags=0*)
...
135: 0x0543 [0x2B] Pauluart (ID: 17780808/0x010F5048) [7998*]:
...
```
  0: 0x05A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7979*)
    → "You got $1. If you have that die, you win against Pauluart."
  1: 0x05A6 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x05A7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7980*)
...
```
  0: 0x05AC [0x1D] PRINT_EVENT_MESSAGE(message_id=7981*)
...
```
  ...
  3: 0x05B8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7999*)
  ...
  5: 0x05BC [0x1D] PRINT_EVENT_MESSAGE(message_id=8000*)
