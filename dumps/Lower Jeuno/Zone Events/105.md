...
SUBROUTINE_23F9:
 ...
 10: 0x23FB [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 11: 0x240C [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 12: 0x241B [0x02] IF !(ExtData[1]->WorkLocal[0] == 1*) GOTO 0x243B
 13: 0x2423 [0x47] UPDATE_PLAYER_POS(40.216*, -17.911*, -0.099*, yaw=37.4°*)
 14: 0x242D [0x47] WAIT_PLAYER_POS_UPDATE
 15: 0x242F [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=36.718*, z=-15.856*, y=-0.111*, direction=18.7°*
 16: 0x2438 [0x01] GOTO 0x245B

SUBROUTINE_243B:
 17: 0x243B [0x02] IF !(ExtData[1]->WorkLocal[0] == 2*) GOTO 0x245B
 18: 0x2443 [0x47] UPDATE_PLAYER_POS(36.191*, -15.618*, -0.111*, yaw=204.8°*)
 19: 0x244D [0x47] WAIT_PLAYER_POS_UPDATE
 20: 0x244F [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=39.514*, z=-17.421*, y=-0.099*, direction=202.7°*
 21: 0x2458 [0x01] GOTO 0x245B

SUBROUTINE_245B:
 22: 0x245B [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 23: 0x246C [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
...
SUBROUTINE_24AF:
 ...
 35: 0x24B6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 36: 0x24C7 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 37: 0x24D6 [0x46] CAMERA_CONTROL: Restore default settings
 38: 0x24D8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 39: 0x24E9 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
