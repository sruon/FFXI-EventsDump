...
SUBROUTINE_0049:
 ...
 18: 0x0051 [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cl00", work_offset2=0*)
 19: 0x0062 [0x01] GOTO 0x0199

SUBROUTINE_0065:
 20: 0x0065 [0x02] IF !(ExtData[1]->WorkLocal[1] == 1*) GOTO 0x0081
 21: 0x006D [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cl01", work_offset2=0*)
 22: 0x007E [0x01] GOTO 0x0199

SUBROUTINE_0081:
 23: 0x0081 [0x02] IF !(ExtData[1]->WorkLocal[1] == 2*) GOTO 0x009D
 24: 0x0089 [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cl02", work_offset2=0*)
 25: 0x009A [0x01] GOTO 0x0199

SUBROUTINE_009D:
 26: 0x009D [0x02] IF !(ExtData[1]->WorkLocal[1] == 3*) GOTO 0x00B9
 27: 0x00A5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cl03", work_offset2=0*)
 28: 0x00B6 [0x01] GOTO 0x0199

SUBROUTINE_00B9:
 29: 0x00B9 [0x02] IF !(ExtData[1]->WorkLocal[1] == 4*) GOTO 0x00D5
 30: 0x00C1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cl04", work_offset2=0*)
 31: 0x00D2 [0x01] GOTO 0x0199

SUBROUTINE_00D5:
 32: 0x00D5 [0x02] IF !(ExtData[1]->WorkLocal[1] == 5*) GOTO 0x00F1
 33: 0x00DD [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cl05", work_offset2=0*)
 34: 0x00EE [0x01] GOTO 0x0199

SUBROUTINE_00F1:
 35: 0x00F1 [0x02] IF !(ExtData[1]->WorkLocal[1] == 6*) GOTO 0x010D
 36: 0x00F9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cl06", work_offset2=0*)
 37: 0x010A [0x01] GOTO 0x0199

SUBROUTINE_010D:
 38: 0x010D [0x02] IF !(ExtData[1]->WorkLocal[1] == 7*) GOTO 0x0129
 39: 0x0115 [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cl07", work_offset2=0*)
 40: 0x0126 [0x01] GOTO 0x0199

SUBROUTINE_0129:
 41: 0x0129 [0x02] IF !(ExtData[1]->WorkLocal[1] == 8*) GOTO 0x0145
 42: 0x0131 [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cl08", work_offset2=0*)
 43: 0x0142 [0x01] GOTO 0x0199

SUBROUTINE_0145:
 44: 0x0145 [0x02] IF !(ExtData[1]->WorkLocal[1] == 9*) GOTO 0x0161
 45: 0x014D [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cl09", work_offset2=0*)
 46: 0x015E [0x01] GOTO 0x0199

SUBROUTINE_0161:
 47: 0x0161 [0x02] IF !(ExtData[1]->WorkLocal[1] == 10*) GOTO 0x017D
 48: 0x0169 [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cl10", work_offset2=0*)
 49: 0x017A [0x01] GOTO 0x0199

SUBROUTINE_017D:
 50: 0x017D [0x02] IF !(ExtData[1]->WorkLocal[1] == 11*) GOTO 0x0199
 51: 0x0185 [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cl11", work_offset2=0*)
 52: 0x0196 [0x01] GOTO 0x0199

SUBROUTINE_0199:
 53: 0x0199 [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="selt", work_offset2=0*)
...
SUBROUTINE_01C5:
 ...
 64: 0x01CD [0x48] [System] [7276*]:
    → "It is too early to light it. You must wait until nine o'clock.\u007F1\u0000\u0007"
...
SUBROUTINE_01D4:
 ...
 68: 0x01DC [0x48] [System] [7277*]:
    → "You have failed to light all the lamps in time.\u007F1\u0000\u0007"
...
SUBROUTINE_01F2:
 ...
 76: 0x01FA [0x48] [System] [7275*]:
    → "You examine the lamp. It seems that it must be lit manually.\u007F1\u0000\u0007"
