...
SUBROUTINE_0024:
 ...
 10: 0x0025 [0x24] CREATE_DIALOG(message_id=9926*, default_option=0*, option_flags=0x0C)
...
SUBROUTINE_0062:
 ...
 25: 0x006D [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x01, bit_index_work_offset=0x8006, condition_work_offset=0x8002)
 26: 0x0074 [0x01] GOTO 0x008C

SUBROUTINE_0077:
 27: 0x0077 [0x02] IF !(Work_Zone[0] == 5*) GOTO 0x008C
 28: 0x007F [0x1A] CALL_SUBROUTINE(address=0x0194)
 29: 0x0082 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x01, bit_index_work_offset=0x8008, condition_work_offset=0x8002)
...
SUBROUTINE_009F:
 ...
 51: 0x00E5 [0x24] CREATE_DIALOG(message_id=9925*, default_option=0x000A, option_flags=0x06)
...
SUBROUTINE_0194:
 84: 0x0194 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "open" for entities [EventEntity, EventEntity]
...
SUBROUTINE_01AA:
 ...
 89: 0x01B2 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "clos" for entities [EventEntity, EventEntity]
...
111: 0x021D [0x24] CREATE_DIALOG(message_id=9925*, default_option=0x000A, option_flags=0x07)
    → "Which key will you use?\u0007\u000BNone of them.\u0007\u007F\u0000\u0001\u0001\u00056\u0002\u0000\u0000\u0000 (Level 
\u0007).\u0007\u007F\u0000\u0001\u0001\u00056\u0002\u0001\u0000\u0000 (Level 
\u0008).\u0007\u007F\u0000\u0001\u0001\u00056\u0002\u0002\u0000\u0000 (Level 
	).\u0007\u007F\u0000\u0001\u0001\u00056\u0002\u0003\u0000\u0000 (Level 
...
162: 0x0321 [0x24] CREATE_DIALOG(message_id=9925*, default_option=0x000A, option_flags=0x08)
    → "Which key will you use?\u0007\u000BNone of them.\u0007\u007F\u0000\u0001\u0001\u00056\u0002\u0000\u0000\u0000 (Level 
\u0007).\u0007\u007F\u0000\u0001\u0001\u00056\u0002\u0001\u0000\u0000 (Level 
\u0008).\u0007\u007F\u0000\u0001\u0001\u00056\u0002\u0002\u0000\u0000 (Level 
	).\u0007\u007F\u0000\u0001\u0001\u00056\u0002\u0003\u0000\u0000 (Level 
...
220: 0x045A [0x41] GET_BIT_WORK_RANGE(start_bit=11*, end_bit=15*, source=ExtData[1]->WorkLocal[1], result=ExtData[1]->WorkLocal[5])
...
234: 0x04A3 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x01, bit_index_work_offset=0x8037, condition_work_offset=0x8002)
...
363: 0x06FF [0x41] GET_BIT_WORK_RANGE(start_bit=11*, end_bit=15*, source=ExtData[1]->WorkLocal[1], result=ExtData[1]->WorkLocal[5])
...
451: 0x08B1 [0x41] GET_BIT_WORK_RANGE(start_bit=11*, end_bit=15*, source=ExtData[1]->WorkLocal[1], result=ExtData[1]->WorkLocal[5])
