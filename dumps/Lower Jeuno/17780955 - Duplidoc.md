...
| [20024](#event-20024)    | 0x0001       |      8 |              2 |
| [20025](#event-20025)    | 0x0009       |      8 |              2 |
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0000:    27 0A DB 50 0F 01 03  00                        '..P....       
```

#### Opcodes

```
  0: 0x0001 [0x27] REQ_SET(priority=0x0A, entity_id=Duplidoc (ID: 17780955/0x010F50DB), tag_num=0x03)
...
```
  0: 0x0009 [0x27] REQ_SET(priority=0x0A, entity_id=Duplidoc (ID: 17780955/0x010F50DB), tag_num=0x04)
