...
- **9767**: You are about to order a maze with your specified settings. Proceed? (You have accumulated $8 C.C. [point/points].)
- **9768**: Order this maze? [Yes./No.]
- **9769**: This transaction will require $6 gil. [Proceed./Cancel.]
- **9770**: Now entering the maze.
- **9771**: You have canceled your maze order.
- **9776**: Your request for entry is being considered...
- **9781**: You lack the gil necessary to order this maze.
...
```
 ...
 11: 0x0042 [0x24] CREATE_DIALOG(message_id=9768*, default_option=1*, option_flags=0*)
 ...
 15: 0x0057 [0x24] CREATE_DIALOG(message_id=9769*, default_option=1*, option_flags=0*)
