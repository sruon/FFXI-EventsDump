...
```
  ...
  4: 0x064E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  5: 0x065F [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 10: 0x067C [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=EventEntity, entity2=EventEntity, scheduler_id="cm6a", work_offset2=0*)
 11: 0x068D [0x55] WAIT_LOAD_SCHEDULER(work_offset=145*, entity1=EventEntity, entity2=EventEntity, scheduler_id="cm6a")
 ...
 15: 0x06AC [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 16: 0x06BD [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 ...
 21: 0x06E4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=EventEntity, entity2=EventEntity, scheduler_id="cm6b", work_offset2=0*)
 ...
 25: 0x0706 [0x55] WAIT_LOAD_SCHEDULER(work_offset=145*, entity1=EventEntity, entity2=EventEntity, scheduler_id="cm6b")
 ...
 37: 0x074C [0x45] LOAD_SCHEDULED_TASK(work_offset1=145*, entity1=EventEntity, entity2=EventEntity, scheduler_id="cm6c", work_offset2=0*)
 38: 0x075D [0x55] WAIT_LOAD_SCHEDULER(work_offset=145*, entity1=EventEntity, entity2=EventEntity, scheduler_id="cm6c")
 39: 0x076C [0x29] REQ_SET_WAIT(priority=0x06, entity_id=Domingart (ID: 17780752/0x010F5010), tag_num=0x0F)
 40: 0x0773 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
 41: 0x0784 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2", work_offset2=0*)
 42: 0x0795 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2")
 ...
 49: 0x07B8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
