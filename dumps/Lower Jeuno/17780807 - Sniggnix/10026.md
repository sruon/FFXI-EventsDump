...
```
  ...
  3: 0x0095 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 15: 0x00D5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s053", work_offset2=0*)
 16: 0x00E6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 ...
 19: 0x0105 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 27: 0x0140 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s056", work_offset2=0*)
 28: 0x0151 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 29: 0x0162 [0x55] WAIT_LOAD_SCHEDULER(work_offset=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s056")
 ...
 32: 0x0181 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s054", work_offset2=0*)
 33: 0x0192 [0x29] REQ_SET_WAIT(priority=0x0B, entity_id=Pauluart (ID: 17780808/0x010F5048), tag_num=0x19)
 34: 0x0199 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 41: 0x01D2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s055", work_offset2=0*)
 42: 0x01E3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 ...
 46: 0x020D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
 47: 0x021E [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s058", work_offset2=0*)
 ...
 51: 0x0248 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s164", work_offset2=0*)
 52: 0x0259 [0x01] GOTO 0x026D

SUBROUTINE_025C:
 53: 0x025C [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s057", work_offset2=0*)
 ...
 60: 0x028F [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s059", work_offset2=0*)
 ...
 65: 0x02B4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
 66: 0x02C5 [0x52] END_LOAD_SCHEDULER: End scheduler "s059" with entities [LocalPlayer, LocalPlayer], work=15*
 67: 0x02D4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s062", work_offset2=0*)
 ...
 70: 0x02FB [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
...
\u0002!\u0000\u0007"
 ...
 76: 0x0323 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 77: 0x0334 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s061", work_offset2=0*)
 78: 0x0345 [0x29] REQ_SET_WAIT(priority=0x0B, entity_id=Pauluart (ID: 17780808/0x010F5048), tag_num=0x20)
 79: 0x034C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 80: 0x035D [0x1C] WAIT(60* ticks)
 81: 0x0360 [0x48] [System] [7986*]:
    → "\u001FyPauluart rolls the die and gets 789!\u0000\u0007"
 82: 0x0363 [0x1C] WAIT(120* ticks)
 83: 0x0366 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 84: 0x0377 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s165", work_offset2=0*)
 ...
 88: 0x039A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 95: 0x03DC [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blon", work_offset2=0*)
 96: 0x03ED [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s060", work_offset2=0*)
 97: 0x03FE [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
...
100: 0x0419 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
101: 0x042A [0x1C] WAIT(60* ticks)
102: 0x042D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blof", work_offset2=0*)
...
118: 0x0496 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s063", work_offset2=0*)
119: 0x04A7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
...
123: 0x04D5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s058", work_offset2=0*)
...
130: 0x0506 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
131: 0x0517 [0x1C] WAIT(60* ticks)
132: 0x051A [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s064", work_offset2=0*)
133: 0x052B [0x27] REQ_SET(priority=0x0B, entity_id=Pauluart (ID: 17780808/0x010F5048), tag_num=0x17)
134: 0x0532 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
...
140: 0x0556 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
...
148: 0x058E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
