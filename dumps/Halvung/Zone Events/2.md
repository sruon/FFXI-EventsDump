...
```
  ...
  3: 0x0007 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  4: 0x0018 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 10: 0x003F [0x45] LOAD_SCHEDULED_TASK(work_offset1=253*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s071", work_offset2=0*)
 11: 0x0050 [0x1C] WAIT(60* ticks)
 12: 0x0053 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 13: 0x0064 [0x1C] WAIT(60* ticks)
 14: 0x0067 [0x48] [System] [7909*]:
    → "First scene.\u007F1\u0000\u0007"
 15: 0x006A [0x23] WAIT_FOR_DIALOG_INTERACTION
 16: 0x006B [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 17: 0x007C [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 18: 0x008B [0x52] END_LOAD_SCHEDULER: End scheduler "s071" with entities [EventEntity, EventEntity], work=253*
 19: 0x009A [0x45] LOAD_SCHEDULED_TASK(work_offset1=253*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s072", work_offset2=0*)
 20: 0x00AB [0x1C] WAIT(60* ticks)
 21: 0x00AE [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 22: 0x00BF [0x1C] WAIT(60* ticks)
 23: 0x00C2 [0x48] [System] [7910*]:
    → "Second scene.\u007F1\u0000\u0007"
 24: 0x00C5 [0x23] WAIT_FOR_DIALOG_INTERACTION
 25: 0x00C6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 26: 0x00D7 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 27: 0x00E6 [0x52] END_LOAD_SCHEDULER: End scheduler "s072" with entities [EventEntity, EventEntity], work=253*
 28: 0x00F5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=253*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s073", work_offset2=0*)
 29: 0x0106 [0x1C] WAIT(60* ticks)
 30: 0x0109 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
...
SUBROUTINE_0134:
 ...
 39: 0x013C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 40: 0x014D [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 41: 0x015C [0x52] END_LOAD_SCHEDULER: End scheduler "s073" with entities [EventEntity, EventEntity], work=253*
 42: 0x016B [0x45] LOAD_SCHEDULED_TASK(work_offset1=253*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s071", work_offset2=0*)
 43: 0x017C [0x1C] WAIT(60* ticks)
 44: 0x017F [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 45: 0x0190 [0x1C] WAIT(120* ticks)
 46: 0x0193 [0x45] LOAD_SCHEDULED_TASK(work_offset1=254*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s047", work_offset2=0*)
...
SUBROUTINE_01B7:
 ...
 53: 0x01BF [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 54: 0x01D0 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 55: 0x01DF [0x52] END_LOAD_SCHEDULER: End scheduler "s073" with entities [EventEntity, EventEntity], work=253*
 56: 0x01EE [0x45] LOAD_SCHEDULED_TASK(work_offset1=253*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s072", work_offset2=0*)
 57: 0x01FF [0x1C] WAIT(60* ticks)
 58: 0x0202 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 59: 0x0213 [0x1C] WAIT(120* ticks)
 60: 0x0216 [0x45] LOAD_SCHEDULED_TASK(work_offset1=254*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s047", work_offset2=0*)
...
SUBROUTINE_023A:
 ...
 68: 0x0245 [0x45] LOAD_SCHEDULED_TASK(work_offset1=254*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s047", work_offset2=0*)
...
SUBROUTINE_0269:
 74: 0x0269 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 75: 0x027A [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
...
SUBROUTINE_02B9:
 ...
 82: 0x02BE [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
