...
- **7453**: Enter the battlefield? [Enter./Decline.]
- **7454**: Leave the battlefield? [Run away./Stay.]
- **7456**: You cannot enter the battlefield at present. Please wait a little longer.
- **7464**: You are cleared to enter the battlefield, but you cannot while party members are engaged in combat.
- **7503**: You do not meet the requirements to enter the battlefield. Access is denied.
- **7792**: Skip the event? [Yes./No.]
- **7812**: Only $3 [member/members] have clearance to enter the battlefield. This room has reached its maximum capacity.
- **7912**: Which battlefield will you enter? [None./Halvung Invasion././././././././././././././././././././././././././././././]
- **7914**: You rap on the gate using the pattern you see on the two musical scores. After a time, you hear the creaking sound of a heavy bar being lifted on the other side of the gate...
- **7915**: The pictographs on the $3 and $3 fade away without a trace...
- **7916**: Choose a picture to take.
- **7917**: First scene.
- **7918**: Second scene.
- **7919**: Third scene.
- **7920**: Which picture will you take? [Show me again./First scene./Second scene./Third scene.]
- **7921**: <Player> records the first scene.
- **7922**: <Player> records the second scene.
- **7923**: <Player> records the third scene.
- **7924**: <Player> takes in the surrounding scenery. ...The view is breathtaking.
- **7925**: <Player> thinks back on Balakaf's words. ...Perhaps this is not the best time to record a picture.
...
```
 ...
 32: 0x011D [0x48] [System] [7919*]:
    → "Third scene."
 33: 0x0120 [0x23] WAIT_FOR_DIALOG_INTERACTION
 34: 0x0121 [0x24] CREATE_DIALOG(message_id=7920*, default_option=0*, option_flags=0*)
...
```
 ...
 13: 0x0398 [0x24] CREATE_DIALOG(message_id=7912*, default_option=0*, option_flags=ExtData[1]->WorkLocal[9])
...
SUBROUTINE_0728:
 ...
 68: 0x0738 [0x24] CREATE_DIALOG(message_id=7792*, default_option=1*, option_flags=0*)
...
SUBROUTINE_0BA9:
 ...
 29: 0x0BB7 [0x24] CREATE_DIALOG(message_id=7792*, default_option=1*, option_flags=0*)
    → "Skip the event? [Yes./No.]"
...
```
# Dead code (unreachable instructions):
     0x0EA4 [0x24] CREATE_DIALOG(message_id=7453*, default_option=1*, option_flags=0*)
    ...
    → "The pictographs on the $3 and $3 fade away without a trace..."
     ...
     0x1017 [0x1B] RETURN
     0x1018 [0x24] CREATE_DIALOG(message_id=7454*, default_option=1*, option_flags=0*)
