...
- **7391**: Use the $3? [Yes./No.]
- **7395**: You rap on the gate using the same pattern you saw in the pictographs. You hear the creaking sound of a bar lifting on the other side of the gate.
...
```
  ...
  3: 0x000A [0x24] CREATE_DIALOG(message_id=7391*, default_option=1*, option_flags=0*)
    → "Use the $3? [Yes./No.]"
