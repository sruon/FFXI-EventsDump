...
| [65535.32](#event-6553532) | 0x01CE       |     25 |              7 |
| [65535.33](#event-6553533) | 0x01E7       |     15 |              5 |
| [65535.34](#event-6553534) | 0x01F6       |     10 |              2 |
| [65535.35](#event-6553535) | 0x0200       |     15 |              5 |
| [65535.36](#event-6553536) | 0x020F       |     15 |              5 |
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
01F0:                   37 10  80 11 80 12 80 13 80 00        7.........
```

#### Opcodes

```
  0: 0x01F6 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=185.210*, z=-380.128*, y=1.901*, direction=142.8°*
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0200:                                               32                 2
0210: 09 80 1F 00 05 80 06 80  07 80 1F 01 6F 00        ............o.  
```
...
```
  ...
  1: 0x0212 [0x1F] MOVE_ENTITY: EventEntity moves to X=187.675*, Z=-374.834*, Y=1.667*
