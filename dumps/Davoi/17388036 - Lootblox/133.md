...
SUBROUTINE_01CF:
 27: 0x01CF [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x01DD
 28: 0x01D7 [0x01] GOTO 0x04E1

SUBROUTINE_01DD:
 29: 0x01DD [0x02] IF !(Work_Zone[0] == 2*) GOTO 0x01EB
 30: 0x01E5 [0x01] GOTO 0x051B

SUBROUTINE_01EB:
 31: 0x01EB [0x02] IF !(Work_Zone[0] == 3*) GOTO 0x020C
 32: 0x01F3 [0x5B] LOAD_EXT_SCHEDULER(work_offset=215*, entity1=Lootblox (ID: 17388036/0x01095204), entity2=Lootblox (ID: 17388036/0x01095204), action="tlk0")
 33: 0x0202 [0x1D] PRINT_EVENT_MESSAGE(message_id=7614*)
    → "Old currencies?\u0007I was telling ya about how the three nations all used to have different types of money. What, you forgot already?\u007F1\u0000\u0007"
 34: 0x0205 [0x23] WAIT_FOR_DIALOG_INTERACTION
 35: 0x0206 [0x1A] CALL_SUBROUTINE(address=0x06B0)
 36: 0x0209 [0x01] GOTO 0x021F

SUBROUTINE_020C:
 37: 0x020C [0x02] IF !(Work_Zone[0] == 4*) GOTO 0x021F
 38: 0x0214 [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[7]
 39: 0x0219 [0x1A] CALL_SUBROUTINE(address=0x0385)
 40: 0x021C [0x01] GOTO 0x021F

SUBROUTINE_021F:
 41: 0x021F [0x01] GOTO 0x0187

SUBROUTINE_0222:
 42: 0x0222 [0x21] END_EVENT
 43: 0x0223 [0x00] END_REQSTACK()
```
