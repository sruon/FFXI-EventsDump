...
0020: FF 7F F0 FF FF 7F 64 76  30 34 02 80 27 01 F0 FF  ......dv04..'...
0030: FF 7F 07 45 01 80 F0 FF  FF 7F F0 FF FF 7F 66 64  ...E..........fd
...
0080: 80 1C 08 80 73 09 80 DB  51 09 01 F0 FF FF 7F 01  ....s...Q.......
...
```
  ...
  5: 0x001B [0x45] LOAD_SCHEDULED_TASK(work_offset1=94*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="dv04", work_offset2=0*)
  6: 0x002C [0x27] REQ_SET(priority=0x01, entity_id=LocalPlayer, tag_num=0x07)
...
SUBROUTINE_0074:
 ...
 20: 0x0084 [0x73] Screaming Pond (ID: 17387995/0x010951DB) casts magic 257* on LocalPlayer
 21: 0x008F [0x01] GOTO 0x0092

SUBROUTINE_0092:
 22: 0x0092 [0x1C] WAIT(240* ticks)
 23: 0x0095 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 24: 0x00A6 [0x1C] WAIT(60* ticks)
 25: 0x00A9 [0x46] CAMERA_CONTROL: Restore default settings
 26: 0x00AB [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
