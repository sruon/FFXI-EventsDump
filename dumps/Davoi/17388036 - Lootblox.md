...
- **7566**: They're not worth a whole lot, but ya done good to collect $1 $0 . Here's $2 for yer trouble.
- **7568**: Here ya go, kid. $2 in exchange for ya $1 $0 .
- **7570**: Now you're just showing off, bringing me $1 $0 . Here's your $2. Now scram, kid.
- **7572**: I got no interest in dealing with the likes of you. Don'tcha got a home to go to?
- **7585**: $5, ya say? Ya got my jaw dropping, kid. Where did ya hear about things like that?
- **7586**: Did ya know that some items have their own soul? After passing through the hands of hundreds of people, not to mention the paws of us beastmen, some items are transformed through contact with all those thoughts and feelings.
- **7587**: These transformed items have the ability to focus mysterious powers. Us Goblins often come across this weird phenenom...phemomeno...stuff in our travels.
- **7588**: Ya know, if ya really want $6, I could sell one to ya for the right price.
- **7589**: But let me tell ya, kid. Only us Gobs can tell if an item is souled. Not even other beastmen--and definitely not you people--can tell the difference between normal junk and priceless artifacts.
- **7590**: Makes me laugh to see you mugs throwing away those items like they was garbage. A souled item is worth a fortune, and ya ain't gonna get one cheap.
- **7591**: $3 gil, and not a single gil less! Ya got a problem with that, kid?
- **7592**: So if ya want one, stop dawdlin' around already and hand me over some money.
- **7593**: What's that ya got there? $0!? Ya got unusual tastes for a person.
- **7594**: Got no clue what ya been doin' with it, but I bet ya gots no use for it anymore. What say I lighten your load in exchange for, say, $1 gil?
- **7595**: So whaddaya waitin' for? Hand that $0 right over and let's make a deal.
- **7604**: I got a deal for ya, kid. Did ya know that before the Great War, the three nations all had their own currencies?
- **7605**: After that little fracas, everyone started using gil as the standard coin, and the other types of money just faded out of existence. Even if you was to find any nowadays, they only have value to Goblin collectors like me.
- **7606**: You're looking a bit confused there, kid. Let me show ya what I'm talking about.
- **7607**: This one's the least valuable of the lot. It was used as a part of the San d'Orian currency years ago. I know I told ya about the nations all having different currencies, but these San d'Orian coins are the only ones I'm interested in.
- **7608**: If ya bring me these coins, I'll exchange them for something from my secret stash of treasure. Ya won't be getting anything for just one of them, so make sure ya collect a bagful, okay?
- **7609**: Let me explain the deal. Bring me $1 $0 , and I'll give ya one $2. Where're ya going? Let me finish, will ya?
- **7610**: Once ya got $1 $0 , ya can trade them for one $2. Or, ya can decide to exchange them for something from my treasure stash. Each item's gonna cost ya a different amount, so choose carefully.
- **7613**: What is it, kid? Ya got something to ask me?
- **7614**: What do you want to ask about? [Nothing./Hourglasses./Maps./Old currencies./Trading $1.]
- **7616**: Old currencies? I was telling ya about how the three nations all used to have different types of money. What, you forgot already?
- **7618**: Ya really like your junk, huh? That's what this stuff looks like to most people, and ya just spent a fortune on it. You're my kinda people, kid.
- **7619**: By the way, I don't give out receipts, and I don't take back items I already sold. I don't know what ya mean to do with the $0 and I don't much care, so take it and skedaddle.
- **7620**: By the way, I don't give out receipts, and I don't take back items I already sold. I don't know what ya mean to do with the $3 and I don't much care, so take it and skedaddle.
- **7622**: So you wanna make a deal here? Should be a good one for the both o' us.
- **7624**: Here's the list of stuff ya can trade your $0 for.
- **7626**: This is $0. Ya want one, you're gonna have to bring me $2 $0$0 .
- **7627**: What do you want to ask about? [Nothing./Hourglasses.]
- **7630**: Which item will you look at? [View next page./$1: $0 [coin/coins]./$3: $2 [coin/coins]./$5: $4 [coin/coins]./$7: $6 [coin/coins]./Nothing.]
- **7631**: Which item will you look at? [View previous page./$1: $0 [coin/coins]./$3: $2 [coin/coins]./$5: $4 [coin/coins]./Nothing.]
- **7726**: Ya can also exchange a $0 for $2 $0$0 . Gonna take ya a while to find, kid. Hope you're patient.
- **7728**: Here's ya $2 $0$0 , and I get ta pocket the $0.
- **7880**: Us Gobs, we can get anywhere with our noses and our smarts. But yeah, I got what you're lookin' for. For the right price, that is.
- **7881**: Buy a map? (Current gil: $11). [Not now./Dynamis - San d'Oria ($1)./Dynamis - Bastok ($2)./Dynamis - Windurst ($3)./Dynamis - Jeuno ($4)./Dynamis - Beaucedine ($5)./Dynamis - Xarcabard ($6)./Dynamis - Valkurm ($7)./Dynamis - Buburimu ($8)./Dynamis - Qufim ($9)./Dynamis - Tavnazia ($10).]
- **7882**: Buy $6? [Deal!/No deal.]
...
```
  ...
  2: 0x0015 [0x1D] PRINT_EVENT_MESSAGE(message_id=7572*)
...
```
  ...
  3: 0x0030 [0x1D] PRINT_EVENT_MESSAGE(message_id=7585*)
  ...
  6: 0x0043 [0x1D] PRINT_EVENT_MESSAGE(message_id=7586*)
  ...
  8: 0x0047 [0x1D] PRINT_EVENT_MESSAGE(message_id=7587*)
 ...
 15: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=7590*)
 ...
 25: 0x0076 [0x1D] PRINT_EVENT_MESSAGE(message_id=7595*)
...
```
 ...
 10: 0x00B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7604*)
 ...
 12: 0x00B8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7605*)
 ...
 14: 0x00BC [0x1D] PRINT_EVENT_MESSAGE(message_id=7606*)
 ...
 19: 0x00D7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7607*)
 ...
 24: 0x00FA [0x1D] PRINT_EVENT_MESSAGE(message_id=7608*)
 ...
 30: 0x011C [0x1D] PRINT_EVENT_MESSAGE(message_id=7609*)
 ...
 35: 0x012F [0x1D] PRINT_EVENT_MESSAGE(message_id=7610*)
 ...
 41: 0x014B [0x1D] PRINT_EVENT_MESSAGE(message_id=7726*)
...
```
 ...
 10: 0x0183 [0x1D] PRINT_EVENT_MESSAGE(message_id=7613*)
...
SUBROUTINE_01A5:
 ...
 23: 0x01B9 [0x24] CREATE_DIALOG(message_id=7614*, default_option=0*, option_flags=ExtData[1]->WorkLocal[15])
...
```
  ...
  3: 0x0239 [0x1D] PRINT_EVENT_MESSAGE(message_id=7618*)
  ...
  5: 0x023D [0x1D] PRINT_EVENT_MESSAGE(message_id=7619*)
...
```
  ...
  3: 0x0274 [0x1D] PRINT_EVENT_MESSAGE(message_id=7618*)
    → "Ya really like your junk, huh? That's what this stuff looks like to most people, and ya just spent a fortune on it. You're my kinda people, kid."
  4: 0x0277 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0278 [0x1D] PRINT_EVENT_MESSAGE(message_id=7620*)
...
```
  ...
  3: 0x02AF [0x1D] PRINT_EVENT_MESSAGE(message_id=7622*)
...
```
  ...
  8: 0x02F5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7566*)
...
```
  ...
  8: 0x033B [0x1D] PRINT_EVENT_MESSAGE(message_id=7568*)
...
```
  ...
  2: 0x0363 [0x1D] PRINT_EVENT_MESSAGE(message_id=7570*)
...
# Dead code (unreachable instructions):
     ...
     0x0394 [0x1D] PRINT_EVENT_MESSAGE(message_id=7624*)
    → "Here's the list of stuff ya can trade your $0 for."
     ...
     0x03A6 [0x24] CREATE_DIALOG(message_id=7630*, default_option=0*, option_flags=0*)
    → "Which item will you look at? [View next page./$1: $0 [coin/coins]./$3: $2 [coin/coins]./$5: $4 [coin/coins]./$7: $6 [coin/coins]./Nothing.]"
     ...
     0x042F [0x24] CREATE_DIALOG(message_id=7631*, default_option=0*, option_flags=0*)
    → "Which item will you look at? [View previous page./$1: $0 [coin/coins]./$3: $2 [coin/coins]./$5: $4 [coin/coins]./Nothing.]"
     ...
     0x04B8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7626*)
    → "This is $0. Ya want one, you're gonna have to bring me $2 $0$0 ."
     ...
     0x04EA [0x24] CREATE_DIALOG(message_id=7627*, default_option=0*, option_flags=0*)
    → "What do you want to ask about? [Nothing./Hourglasses.]"
     ...
     0x0524 [0x1D] PRINT_EVENT_MESSAGE(message_id=7880*)
    → "Us Gobs, we can get anywhere with our noses and our smarts. But yeah, I got what you're lookin' for. For the right price, that is."
     ...
     0x0564 [0x24] CREATE_DIALOG(message_id=7881*, default_option=0*, option_flags=Work_Zone[2])
    → "Buy a map? (Current gil: $11). [Not now./Dynamis - San d'Oria ($1)./Dynamis - Bastok ($2)./Dynamis - Windurst ($3)./Dynamis - Jeuno ($4)./Dynamis - Beaucedine ($5)./Dynamis - Xarcabard ($6)./Dynamis - Valkurm ($7)./Dynamis - Buburimu ($8)./Dynamis - Qufim ($9)./Dynamis - Tavnazia ($10).]"
     ...
     0x061A [0x24] CREATE_DIALOG(message_id=7882*, default_option=0*, option_flags=0*)
    → "Buy $6? [Deal!/No deal.]"
     ...
     0x0673 [0x1D] PRINT_EVENT_MESSAGE(message_id=7586*)
    → "Did ya know that some items have their own soul? After passing through the hands of hundreds of people, not to mention the paws of us beastmen, some items are transformed through contact with all those thoughts and feelings."
     0x0676 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0677 [0x1D] PRINT_EVENT_MESSAGE(message_id=7587*)
    → "These transformed items have the ability to focus mysterious powers. Us Goblins often come across this weird phenenom...phemomeno...stuff in our travels."
     ...
     0x068A [0x1D] PRINT_EVENT_MESSAGE(message_id=7588*)
    → "Ya know, if ya really want $6, I could sell one to ya for the right price."
     0x068D [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x068E [0x1D] PRINT_EVENT_MESSAGE(message_id=7589*)
    → "But let me tell ya, kid. Only us Gobs can tell if an item is souled. Not even other beastmen--and definitely not you people--can tell the difference between normal junk and priceless artifacts."
     0x0691 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0692 [0x1D] PRINT_EVENT_MESSAGE(message_id=7590*)
    → "Makes me laugh to see you mugs throwing away those items like they was garbage. A souled item is worth a fortune, and ya ain't gonna get one cheap."
     0x0695 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0696 [0x1D] PRINT_EVENT_MESSAGE(message_id=7591*)
    → "$3 gil, and not a single gil less! Ya got a problem with that, kid?"
     0x0699 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x069A [0x1D] PRINT_EVENT_MESSAGE(message_id=7592*)
    → "So if ya want one, stop dawdlin' around already and hand me over some money."
     0x069D [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x069E [0x1D] PRINT_EVENT_MESSAGE(message_id=7593*)
    → "What's that ya got there? $0!? Ya got unusual tastes for a person."
     0x06A1 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x06A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7594*)
    → "Got no clue what ya been doin' with it, but I bet ya gots no use for it anymore. What say I lighten your load in exchange for, say, $1 gil?"
     0x06A5 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x06A6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7595*)
    → "So whaddaya waitin' for? Hand that $0 right over and let's make a deal."
     0x06A9 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x06AA [0x5E] EventEntity goes idle (kills current action) (animation: "idl0")
     0x06AF [0x1B] RETURN
     0x06B0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7605*)
    → "After that little fracas, everyone started using gil as the standard coin, and the other types of money just faded out of existence. Even if you was to find any nowadays, they only have value to Goblin collectors like me."
     0x06B3 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x06B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7606*)
    → "You're looking a bit confused there, kid. Let me show ya what I'm talking about."
     ...
     0x06CF [0x1D] PRINT_EVENT_MESSAGE(message_id=7607*)
    → "This one's the least valuable of the lot. It was used as a part of the San d'Orian currency years ago. I know I told ya about the nations all having different currencies, but these San d'Orian coins are the only ones I'm interested in."
     ...
     0x06F2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7608*)
    → "If ya bring me these coins, I'll exchange them for something from my secret stash of treasure. Ya won't be getting anything for just one of them, so make sure ya collect a bagful, okay?"
     ...
     0x0714 [0x1D] PRINT_EVENT_MESSAGE(message_id=7609*)
    → "Let me explain the deal. Bring me $1 $0 , and I'll give ya one $2. Where're ya going? Let me finish, will ya?"
     ...
     0x0727 [0x1D] PRINT_EVENT_MESSAGE(message_id=7610*)
    → "Once ya got $1 $0 , ya can trade them for one $2. Or, ya can decide to exchange them for something from my treasure stash. Each item's gonna cost ya a different amount, so choose carefully."
     ...
     0x0743 [0x1D] PRINT_EVENT_MESSAGE(message_id=7726*)
    → "Ya can also exchange a $0 for $2 $0$0 . Gonna take ya a while to find, kid. Hope you're patient."
...
```
  ...
  5: 0x075C [0x1D] PRINT_EVENT_MESSAGE(message_id=7728*)
