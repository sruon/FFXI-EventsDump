...
| [116](#event-116)          | 0x0120       |      1 |              1 |
| [65535.20](#event-6553520) | 0x0121       |     10 |              2 |
| [65535.21](#event-6553521) | 0x012B       |     14 |              4 |
| [65535.22](#event-6553522) | 0x0139       |     14 |              4 |
| [65535.23](#event-6553523) | 0x0147       |      5 |              3 |
| [65535.24](#event-6553524) | 0x014C       |      5 |              3 |
| [65535.25](#event-6553525) | 0x0151       |      5 |              3 |
...
|       2 | 0x0015      |          21 |
|       3 | 0x3623D     |      221757 |
|       4 | 0xFFFF2720  |  4294911776 |
|       5 | 0x09D5      |        2517 |
|       6 | 0x0B92      |        2962 |
|       7 | 0x000D      |          13 |
|       8 | 0x36028     |      221224 |
|       9 | 0xFFFF2C89  |  4294913161 |
|      10 | 0x086C      |        2156 |
|      11 | 0x35DA6     |      220582 |
...
- **7510**: I see... It was just a waste of time.
- **7512**: Well, no matter. The fact is, there is someone else who is looking for the sword. And, either they have got to it first or...
- **7515**: ...nuisance...
...
```
  0: 0x0121 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=221.757*, z=-55.520*, y=2.517*, direction=260.3°*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0120:                                   32 07 80 1F 00             2....
0130: 08 80 09 80 0A 80 1F 01  00                       .........       
```
...
```
  ...
  1: 0x012E [0x1F] MOVE_ENTITY: EventEntity moves to X=221.224*, Z=-54.135*, Y=2.156*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0130:                             32 07 80 1F 00 0B 80           2......
0140: 0C 80 0D 80 1F 01 00                              .......         
```
...
```
  ...
  1: 0x013C [0x1F] MOVE_ENTITY: EventEntity moves to X=220.582*, Z=-48.445*, Y=0.835*
...
```
  0: 0x0147 [0x1D] PRINT_EVENT_MESSAGE(message_id=7510*)
...
```
  0: 0x014C [0x1D] PRINT_EVENT_MESSAGE(message_id=7512*)
...
```
  0: 0x0151 [0x1D] PRINT_EVENT_MESSAGE(message_id=7515*)
    → "...nuisance..."
