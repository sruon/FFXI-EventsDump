...
- **7475**: You work the pulley.
- **7476**: Dipping the letter into the water, you see words appear.
- **7477**: "Captain Exoroche: I, Chusarlaud, am no longer worthy to be a Royal Knight, for I have sold our secrets to the Orcs.
- **7478**: I spent my reward on medicine for my mother, but it was all in vain. Her death taught me the error of my ways, and I tried repeatedly to redeem myself.
- **7479**: But my partner Vilbert threatened to expose my treachery if I did not continue! Alas, he had me in the palm of his hand!
- **7480**: I had to take action! I decided to send this letter upon the close of today's training. I expect no forgiveness, but I must put a stop to this madness.
- **7481**: I have caused pain to my mother, and I have betrayed my kind captain. There is no other way!"
- **7482**: The letter ends abruptly.
- **7483**: Read the letter again? [Yes./No.]
...
```
 ...
 13: 0x0058 [0x24] CREATE_DIALOG(message_id=7483*, default_option=1*, option_flags=0*)
...
```
  0: 0x00B0 [0x24] CREATE_DIALOG(message_id=7483*, default_option=1*, option_flags=0*)
    → "Read the letter again? [Yes./No.]"
