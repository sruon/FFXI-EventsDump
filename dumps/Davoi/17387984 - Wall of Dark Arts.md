...
- **7369**: The Orc barrier seals it shut.
- **7372**: Enter the cave? [Yes./No.]
- **7373**: Leave the cave? [Yes./No.]
...
```
  ...
  2: 0x0014 [0x24] CREATE_DIALOG(message_id=7372*, default_option=0*, option_flags=0*)
...
SUBROUTINE_002E:
  ...
  8: 0x0031 [0x24] CREATE_DIALOG(message_id=7373*, default_option=0*, option_flags=0*)
...
```
  ...
  2: 0x0060 [0x48] [System] [7369*]:
    → "The Orc barrier seals it shut."
  3: 0x0063 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0064 [0x01] GOTO 0x0081
  5: 0x0067 [0x24] CREATE_DIALOG(message_id=7373*, default_option=0*, option_flags=0*)
    → "Leave the cave? [Yes./No.]"
