...
- **7386**: I am Bernal, of the Royal Knights of San d'Oria.
- **7387**: The mage in this tower has trapped the Orc lord inside a cave to the south. Now we just wait for reinforcements.
- **7388**: Actually, my friend Quemaricond left for the homeland quite some time ago. I do hope the message made it through.
- **7389**: Incidentally...
- **7390**: Have you business at the tower?
- **7391**: You've finished what you came here to do?
- **7392**: I cannot leave my post, but I pray for your success. Pick your fights wisely, and be not afraid to run if your enemy outnumbers you.
- **7397**: Enter the tower? [Yes./No.]
- **7398**: Leave the tower? [Yes./No.]
...
```
  ...
  2: 0x003B [0x1D] PRINT_EVENT_MESSAGE(message_id=7386*)
    → "I am Bernal, of the Royal Knights of San d'Oria."
  3: 0x003E [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x003F [0x1D] PRINT_EVENT_MESSAGE(message_id=7387*)
  ...
  6: 0x0043 [0x1D] PRINT_EVENT_MESSAGE(message_id=7388*)
...
```
  ...
  6: 0x007A [0x1D] PRINT_EVENT_MESSAGE(message_id=7392*)
  ...
  8: 0x007E [0x1D] PRINT_EVENT_MESSAGE(message_id=7389*)
    → "Incidentally..."
...
```
  ...
  2: 0x009F [0x1D] PRINT_EVENT_MESSAGE(message_id=7390*)
  ...
  5: 0x00B2 [0x24] CREATE_DIALOG(message_id=7397*, default_option=0*, option_flags=0*)
...
```
  ...
  2: 0x011D [0x1D] PRINT_EVENT_MESSAGE(message_id=7391*)
  ...
  5: 0x0130 [0x24] CREATE_DIALOG(message_id=7398*, default_option=0*, option_flags=0*)
