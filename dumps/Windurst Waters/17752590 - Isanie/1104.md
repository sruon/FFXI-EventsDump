...
0AA0: 07 10 00 80 03 08 10 1D  80 02 07 10 00 80 00 B8  ................
...
SUBROUTINE_01BD:
  3: 0x01BD [0x24] CREATE_DIALOG(message_id=17332*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0C1C:
 ...
 35: 0x0C4E [0x24] CREATE_DIALOG(message_id=17333*, default_option=0*, option_flags=0*)
...
# Dead code (unreachable instructions):
     ...
     0x007E [0x1D] PRINT_EVENT_MESSAGE(message_id=17301*)
    → "Here we sell items from the various guildmasters and also exchange crafter points for your convenience.\u007F1\u0000\u0007"
     ...
     0x00F0 [0x24] CREATE_DIALOG(message_id=17303*, default_option=ExtData[1]->WorkLocal[42], option_flags=ExtData[1]->WorkLocal[5])
    → "What would you like to do?\u0007\u000BPurchase a crafting kit.\u0007Exchange crafter points.\u0007.\u0007Special materials.\u0007Check the deliverable items.\u0007Ask about the delivery process.\u0007Never mind.\u007F1\u0000\u0007"
     ...
     0x016B [0x1D] PRINT_EVENT_MESSAGE(message_id=17315*)
    → "This is where you can deliver the crafting sets that the guildmasters have created.\u007F1\u0000\u0007"
     ...
     0x016F [0x1D] PRINT_EVENT_MESSAGE(message_id=17316*)
    → "By delivering items, you can earn crafter points that can be exchanged for special ingredients.\u007F1\u0000\u0007"
     ...
     0x0173 [0x1D] PRINT_EVENT_MESSAGE(message_id=17317*)
    → "Crafting sets can be made by using special crystals known as analysis crystals, crystals which that enable you to set the quality level.\u007F1\u0000\u0007"
     ...
     0x0177 [0x1D] PRINT_EVENT_MESSAGE(message_id=17319*)
    → "Analysis crystals can be obtained from the person in charge of accepting deliveries in exchange for guild points.\u007F1\u0000\u0007"
     ...
     0x017B [0x1D] PRINT_EVENT_MESSAGE(message_id=17320*)
    → "Analysis crystals cannot be used to create items other than the ones in the crafting sets.\u007F1\u0000\u0007"
     ...
     0x017F [0x1D] PRINT_EVENT_MESSAGE(message_id=17321*)
    → "Please note that you can't use \u0001\u0005%\u0002\u0001\u0000\u0000 in place of \u0001\u0005%\u0002\u0000\u0000\u0000.\u007F1\u0000\u0007"
     0x0182 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0183 [0x1D] PRINT_EVENT_MESSAGE(message_id=17322*)
    → "The ingredients required to make a crafting set can be checked by referring to the deliverable items list.\u007F1\u0000\u0007"
     ...
     0x0187 [0x1D] PRINT_EVENT_MESSAGE(message_id=17318*)
...
\u0002 guild point\u007F\u0012\u0002[/s].\u007F1\u0000\u0007"
    ...
    → "Crafting sets delivered here will be sold as crafting kits until the next day at 10:00 a.m. (Vana'diel time).\u007F1\u0000\u0007"
     ...
     0x0197 [0x1D] PRINT_EVENT_MESSAGE(message_id=17326*)
    → "It helps the junior members of the guild, so keep on making those deliveries.\u007F1\u0000\u0007"
     ...
     0x01B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=17301*)
    → "Here we sell items from the various guildmasters and also exchange crafter points for your convenience.\u007F1\u0000\u0007"
     0x01B7 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x01B8 [0x1D] PRINT_EVENT_MESSAGE(message_id=17302*)
...
# Dead code (unreachable instructions):
     ...
     0x05AC [0x1D] PRINT_EVENT_MESSAGE(message_id=17306*)
    → "You want to purchase \u0001\u0005%\u0002\u001F\u0000\u0000? It will cost 
! gil for 
  of them.\u007F1\u0000\u0007"
     0x05AF [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x05B0 [0x24] CREATE_DIALOG(message_id=17307*, default_option=1*, option_flags=0*)
    → "Are you sure about this?\u0007\u000BYes, I'm sure.\u0007On second thought...\u007F1\u0000\u0007"
     ...
     0x069A [0x24] CREATE_DIALOG(message_id=17309*, default_option=ExtData[1]->WorkLocal[46], option_flags=ExtData[1]->WorkLocal[7])
    → "Which item? (
\u001E crafter points)\u0007\u000B\u007F\u0000\u0001\u0001\u0005#\u0002\u0000\u0000\u0000 (
...
\u0013 CP).\u0007I changed my mind.\u007F1\u0000\u0007"
     ...
     0x082A [0x1D] PRINT_EVENT_MESSAGE(message_id=17310*)
    → "Do you want to purchase the \u0001\u0005#\u0002\u0014\u0000\u0000 for 
\u0015 crafter points?\u007F1\u0000\u0007"
     0x082D [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x082E [0x24] CREATE_DIALOG(message_id=17311*, default_option=1*, option_flags=0*)
    → "Do you want to make the trade?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
     ...
     0x08F2 [0x1B] RETURN
     0x08F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=17313*)
    → "These are the items that we are taking deliveries of. Simply select an item whenever you want to check the recipe.\u007F1\u0000\u0007"
     ...
     0x0927 [0x24] CREATE_DIALOG(message_id=17314*, default_option=ExtData[1]->WorkLocal[48], option_flags=0*)
    → "Deliverable Items\u0007\u000B\u007F\u0000\u0001\u0001\u0005#\u0002\u0000\u0000\u0000.\u0007\u007F\u0000\u0001\u0001\u0005#\u0002\u0001\u0000\u0000.\u0007\u007F\u0000\u0001\u0001\u0005#\u0002\u0002\u0000\u0000.\u0007\u007F\u0000\u0001\u0001\u0005#\u0002\u0003\u0000\u0000.\u0007\u007F\u0000\u0001\u0001\u0005#\u0002\u0004\u0000\u0000.\u0007\u007F\u0000\u0001\u0001\u0005#\u0002\u0005\u0000\u0000.\u0007\u007F\u0000\u0001\u0001\u0005#\u0002\u0006\u0000\u0000.\u0007\u007F\u0000\u0001\u0001\u0005#\u0002\u0007\u0000\u0000.\u0007\u007F\u0000\u0001\u0001\u0005#\u0002\u0008\u0000\u0000.\u0007I'm finished here.\u007F1\u0000\u0007"
     ...
     0x0AA4 [0x03] Work_Zone[8] = 8*
     0x0AA9 [0x02] IF !(Work_Zone[7] == 0*) GOTO 0x0AB8
     0x0AB1 [0x48] [System] [7190*]:
...
\u0007 x \u0001	)\u0002\u0007\u0000\u0000\u0002\u0003\u0000\u0000\u007F1\u0000\u0007"
     ...
     0x0B94 [0x1D] PRINT_EVENT_MESSAGE(message_id=17331*)
    → "My apologies, but our stock is limited and I cannot sell you any more at this time.\u007F1\u0000\u0007"
     ...
     0x0B98 [0x1B] RETURN
     0x0B99 [0x1D] PRINT_EVENT_MESSAGE(message_id=17329*)
    → "We now have available \u0001\u0005%\u0002\u0000\u0000\u0000 for the low cost of 
\u0001 gil per.\u007F1\u0000\u0007"
     0x0B9C [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0B9D [0x1D] PRINT_EVENT_MESSAGE(message_id=17330*)
...
\u0002.\u0000\u0007"
     ...
     0x0BD0 [0x1D] PRINT_EVENT_MESSAGE(message_id=17306*)
    → "You want to purchase \u0001\u0005%\u0002\u001F\u0000\u0000? It will cost 
! gil for 
  of them.\u007F1\u0000\u0007"
     0x0BD3 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0BD4 [0x24] CREATE_DIALOG(message_id=17307*, default_option=1*, option_flags=0*)
    → "Are you sure about this?\u0007\u000BYes, I'm sure.\u0007On second thought...\u007F1\u0000\u0007"
