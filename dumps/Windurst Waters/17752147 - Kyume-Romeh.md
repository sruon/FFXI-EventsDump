...
| [604](#event-604)          | 0x0481       |     33 |             12 |
| [939](#event-939)          | 0x04A2       |     52 |             12 |
| [393](#event-393)          | 0x04D6       |     37 |             14 |
| [60](#event-60)            | 0x04FB       |     33 |             12 |
| [668](#event-668)          | 0x051C       |     83 |             22 |
| [669](#event-669)          | 0x056F       |     33 |             12 |
| [638](#event-638)          | 0x0590       |      1 |              1 |
| [873](#event-873)          | 0x0591       |      9 |              3 |
| [878](#event-878)          | 0x059A       |     29 |             10 |
| [874](#event-874)          | 0x05B7       |     15 |              4 |
| [65535.71](#event-6553571) | 0x05C6       |     10 |              2 |
| [65535.72](#event-6553572) | 0x05D0       |     22 |              8 |
| [65535.73](#event-6553573) | 0x05E6       |     15 |              5 |
| [65535.74](#event-6553574) | 0x05F5       |     10 |              2 |
| [65535.75](#event-6553575) | 0x05FF       |     24 |             10 |
| [65535.76](#event-6553576) | 0x0617       |     24 |              6 |
| [891](#event-891)          | 0x062F       |     65 |             18 |
...
- **7405**: Munch-munch...gloomph...bellllch! That is an intriguing hat you have there!
- **7406**: Hey, that could make a great story! Thanks, that's my scoop of the day!
- **8241**: Munch-munch...chew-chew... What's that? You have a question you want to ask me, the walking library?
- **8242**: Oh, that's easy-weasy. Orn, the Hume gentleman you're referring to, is a traveler who's staying in the hostelry room right above us.
- **8243**: You disturbed my custard, cake, and jelly for such a trifling matter? Munch-munch...chew-chew...
- **8880**: Munch-munch...chew-chew... What's that? You have a question you want to ask me, the man on the spot?
- **8881**: I'm the ace reporter for the "Magic Paradise Weekly." Why, I don't even have to move a finger. All the news just comes to me. Munch-munch...chew-chew...
- **9093**: Munch-munch...chew-chew... What's that? You have a question you want to ask me, the man on the spot?
- **9094**: ...? Naiko-Paneiko? <choke>-<gasp>-<burp>!
- **9095**: Don't ever mention my editor's name while I'm enjoying my steak! I have a beef with him!
- **9096**: I'm busy eating here. If you can handle it, I'll give you my scoop. So bowl outta here or we'll both be in the soup!
- **9097**: Don't cheese me off by mentioning my editor's name while I'm enjoying fondue!
- **9098**: I've forked over my scoop to you, so take it back to him. Come on... Chop chop! Act like a whisk and beat it!
- **10499**: ...And that's when they took off towards the south part of Windurst Waters. Munch-munch...chew-chew...
- **10543**: Munch-munch...chew-chew... I was able to find out all sorts of juicy details from that article.
- **10544**: But I'll have to skip lunch to investigate justaru how authentic this story really is...munch-munch...
- **10545**: If you're looking for those three Tarutaru, they headed for the air travel agency. If I recall, there's a reporter around that area who works for the same boss as the man on the spot...chew-chew...
- **12288**: <Player>'s badge flashes brightly.
- **12297**: Munch-munch...chew-chew... What's that? Something about "Aht Urhgan"? I heard that the beastmen there are crazy-wazy! Rumor has it that they even attack the towns sometimes!
- **12298**: If I could just go there on a business trip, I'd have enough scoops to last the rest of my life! Then again, if the rumors are true, that might not be very long!
...
```
  ...
  3: 0x0488 [0x1D] PRINT_EVENT_MESSAGE(message_id=8880*)
  ...
  6: 0x0493 [0x1D] PRINT_EVENT_MESSAGE(message_id=8881*)
...
```
  ...
  4: 0x04AE [0x1D] PRINT_EVENT_MESSAGE(message_id=12297*)
  ...
  7: 0x04C1 [0x1D] PRINT_EVENT_MESSAGE(message_id=12298*)
...
```
  ...
  3: 0x04DD [0x1D] PRINT_EVENT_MESSAGE(message_id=8241*)
  ...
  6: 0x04E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=8242*)
  ...
  8: 0x04EC [0x1D] PRINT_EVENT_MESSAGE(message_id=8243*)
...
```
  ...
  3: 0x0502 [0x1D] PRINT_EVENT_MESSAGE(message_id=7405*)
  ...
  6: 0x050D [0x1D] PRINT_EVENT_MESSAGE(message_id=7406*)
...
```
  ...
  3: 0x0523 [0x1D] PRINT_EVENT_MESSAGE(message_id=9093*)
    → "Munch-munch...chew-chew... What's that? You have a question you want to ask me, the man on the spot?"
  ...
  6: 0x052E [0x1D] PRINT_EVENT_MESSAGE(message_id=9094*)
 ...
 12: 0x054E [0x1D] PRINT_EVENT_MESSAGE(message_id=9095*)
 ...
 16: 0x0560 [0x1D] PRINT_EVENT_MESSAGE(message_id=9096*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0590:    94 01 F8 FF FF 7F A4  01 00                     .........      
```

#### Opcodes

```
  0: 0x0591 [0x94] EventEntity->Render.Flags3 ^= 0x01
  1: 0x0597 [0xA4] EventEntity->Flags3.unknown_3_2 = 1
...
```
  ...
  4: 0x05A8 [0x1D] PRINT_EVENT_MESSAGE(message_id=10499*)
...
```
  ...
  4: 0x063D [0x1D] PRINT_EVENT_MESSAGE(message_id=10543*)
  ...
  8: 0x064F [0x1D] PRINT_EVENT_MESSAGE(message_id=10544*)
 ...
 12: 0x0661 [0x1D] PRINT_EVENT_MESSAGE(message_id=10545*)
