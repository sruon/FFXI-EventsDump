...
```
  ...
  4: 0x003E [0x1D] PRINT_EVENT_MESSAGE(message_id=8861*)
    → "Huh... So this is the biological laborrratory that is rrrun by the Rhinostery, eh? Doesn't seem so exciting, rrreally...\u007F1\u0000\u0007"
  5: 0x0041 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0042 [0x1D] PRINT_EVENT_MESSAGE(message_id=8862*)
    → "I hearrrd that they carry out some weirrrd experiments herrre. Do you know anything about that?\u007F1\u0000\u0007"
