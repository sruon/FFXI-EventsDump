...
- **8315**: Oh, so you want to know a little about magic, huh?
- **8316**: Well, you've come to the right place. We can teach you the basics...
- **8317**: Listen to their explanation? [Decline./Accept.]
- **8318**: Well then, let us explain... There are basically two types of magic...white and black.
- **8319**: White magic is predominately used for healing. It is what white mages specialize in. White magic includes healing spells such as Cure, and Poisona, which removes poison status...
- **8320**: High-level white mages can use Raise to revive fallen comrades.
- **8321**: Then there's black magic...
- **8331**: Calm down, guys... Cool it!
- **8332**: So, how about it? Do you understand more about magic now? We're currently studying the basics here at the School of Magic.
- **8333**: Actually, there is one more type of magic that is forbidden now, but I guess that doesn't concern an adventurer such as yourself. Anyway, good luck with your magic studies. Bye-bye.
...
```
 ...
 13: 0x00B0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8315*)
 ...
 31: 0x0104 [0x1D] PRINT_EVENT_MESSAGE(message_id=8316*)
 ...
 34: 0x010F [0x24] CREATE_DIALOG(message_id=8317*, default_option=0*, option_flags=0*)
 ...
 43: 0x014C [0x1D] PRINT_EVENT_MESSAGE(message_id=8318*)
 ...
 47: 0x015E [0x1D] PRINT_EVENT_MESSAGE(message_id=8319*)
 ...
 49: 0x0162 [0x1D] PRINT_EVENT_MESSAGE(message_id=8320*)
 ...
 52: 0x016D [0x1D] PRINT_EVENT_MESSAGE(message_id=8321*)
...
```
  ...
  1: 0x0257 [0x1D] PRINT_EVENT_MESSAGE(message_id=8331*)
  ...
  9: 0x0279 [0x1D] PRINT_EVENT_MESSAGE(message_id=8332*)
 ...
 11: 0x027D [0x1D] PRINT_EVENT_MESSAGE(message_id=8333*)
