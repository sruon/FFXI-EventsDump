...
| [566](#event-566)        | 0x0030       |     33 |             12 |
| [4862](#event-4862)      | 0x0051       |      5 |              3 |
| [4863](#event-4863)      | 0x0056       |      5 |              3 |
| [4864](#event-4864)      | 0x005B       |      5 |              3 |
| [4888](#event-4888)      | 0x0060       |      5 |              3 |
| [4889](#event-4889)      | 0x0065       |    913 |            284 |
...
- **8810**: Ew! An indescribable smell occasionally comes wafting across from that building over yonder-wonder.
- **8811**: That's the Culinarians' Guild, isn't it? What in Vana'diel are they cooking-wooking in there?
...
```
  ...
  4: 0x003E [0x1D] PRINT_EVENT_MESSAGE(message_id=8810*)
    → "Ew! An indescribable smell occasionally comes wafting across from that building over yonder-wonder."
  5: 0x0041 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0042 [0x1D] PRINT_EVENT_MESSAGE(message_id=8811*)
    → "That's the Culinarians' Guild, isn't it? What in Vana'diel are they cooking-wooking in there?"
