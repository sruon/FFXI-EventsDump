...
```
  ...
  4: 0x003E [0x1D] PRINT_EVENT_MESSAGE(message_id=8843*)
    → "In the School of Magic, there is an advanced class for the smarty-warties and a beginners class for the mediocre students.\u007F1\u0000\u0007"
  5: 0x0041 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0042 [0x1D] PRINT_EVENT_MESSAGE(message_id=8844*)
    → "What's that!? You think you can enter the advanced class, huh? Well, the last year had a Mithra pass the grade, so maybe even you could give it a try...?\u007F1\u0000\u0007"
