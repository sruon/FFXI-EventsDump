...
- **15437**: Kupo ho ho! Merry Starlight! As with past celebrations, we've prepared a veritable mountain of presents for everyone, kupo.
- **15438**: For this year's Starlight Celebration, we moogles have set ourselves a challenge: breaking the all-Vana'diel present-distribution record! But we couldn't possibly dream of succeeding at such an ambitious undertaking just by ourselves, kupo.
- **15439**: We could really do with some adventurer-offered assistance. Would you be interested in lending a hand in this noble endeavor, in the spirit of giving, kupo?
- **15440**: Help the moogles? [Sign me up!/I'm a little busy, sorry.]
- **15441**: We understand... But we'll be waiting right here if it turns out you can spare some time after all, kupo!
- **15442**: You've made this little moogle very happy, kupo! Now then, let's not waste any time. We'd like you to deliver these presents here.
- **15443**: The recipients are Kayeel-Payeel, Kenapa-Keppa, Honoi-Gomoi, and Angelica. Four people in total, kupo.
- **15444**: Report back to us after you've completed your task, kupo.
- **15445**: Also, we don't mind you working in a group if you feel lonesome doing the deliveries on your own. Just form a party and have everyone come talk to us.
- **15446**: And I have to warn you, presents can't be taken to other areas, kupo. Be careful, okay?
- **15447**: Happy delivering, kupo!
- **15448**: We want you to deliver the presents to Kayeel-Payeel, Kenapa-Keppa, Honoi-Gomoi, and Angelica. Four people in total, kupo.
- **15449**: You've yet to deliver presents to [Kayeel-Payeel,/Kenapa-Keppa,/Honoi-Gomoi,/Angelica,] [Kayeel-Payeel,/Kenapa-Keppa,/Honoi-Gomoi,/Angelica,] and [Kayeel-Payeel,/Kenapa-Keppa,/Honoi-Gomoi,/Angelica,] kupo.
- **15450**: You've yet to deliver presents to [Kayeel-Payeel,/Kenapa-Keppa,/Honoi-Gomoi,/Angelica,] and [Kayeel-Payeel,/Kenapa-Keppa,/Honoi-Gomoi,/Angelica,] kupo.
- **15451**: You've yet to deliver a present to [Kayeel-Payeel,/Kenapa-Keppa,/Honoi-Gomoi,/Angelica,] kupo.
- **15452**: Wow, you've delivered every single present! Thank you so much, kupo!
- **15453**: Here's a little something for your kindness.
- **15454**: You want to help us again? That's very kind of you, but we need more time to put together a new set of presents, kupo. Would you mind coming back tomorrow?
...
```
  ...
  2: 0x000B [0x1D] PRINT_EVENT_MESSAGE(message_id=15437*)
  ...
  4: 0x000F [0x1D] PRINT_EVENT_MESSAGE(message_id=15438*)
  ...
  6: 0x0013 [0x1D] PRINT_EVENT_MESSAGE(message_id=15439*)
  ...
  8: 0x0017 [0x24] CREATE_DIALOG(message_id=15440*, default_option=0*, option_flags=0*)
 ...
 13: 0x002D [0x1D] PRINT_EVENT_MESSAGE(message_id=15442*)
 ...
 15: 0x0031 [0x1D] PRINT_EVENT_MESSAGE(message_id=15443*)
 ...
 17: 0x0035 [0x1D] PRINT_EVENT_MESSAGE(message_id=15444*)
    → "Report back to us after you've completed your task, kupo."
 18: 0x0038 [0x23] WAIT_FOR_DIALOG_INTERACTION
 19: 0x0039 [0x1D] PRINT_EVENT_MESSAGE(message_id=15445*)
 ...
 21: 0x003D [0x1D] PRINT_EVENT_MESSAGE(message_id=15446*)
 ...
 23: 0x0041 [0x1D] PRINT_EVENT_MESSAGE(message_id=15447*)
 ...
 27: 0x0050 [0x1D] PRINT_EVENT_MESSAGE(message_id=15441*)
...
SUBROUTINE_00AD:
 ...
 19: 0x00BB [0x1D] PRINT_EVENT_MESSAGE(message_id=15451*)
 ...
 23: 0x00CA [0x1D] PRINT_EVENT_MESSAGE(message_id=15450*)
 ...
 27: 0x00D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=15449*)
 ...
 31: 0x00E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=15448*)
...
```
  ...
  1: 0x0106 [0x1D] PRINT_EVENT_MESSAGE(message_id=15454*)
