...
- **8330**: Hold on there! Aren't the two of you forgetting a particularly important kind of magic? Magic isn't just about attacking things and healing people. Listen, and let me explain...
- **8331**: Do you know about enhancement magic? Spells such as Enfire and Phalanx can be cast on weapons and armor, adding a temporary magical aura to them.
- **8332**: To use such enhancement spells, you have to study both black and white magic.
- **8333**: That's why red mages are the best! Not only can you use both kinds of magic, but you can cast it on your weapons and stuff! Red mages always come in handy!
- **8366**: It's true that you can only improve magic with plenty of practice. But the first step is to study a multitude of difficult books.
- **8367**: In order to read such tricky books, you have to have a sense of magic in the first place. It's kinda hard to explain, but it's like an ingrained feeling you just have.
...
```
  ...
  4: 0x00B0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8366*)
  ...
  6: 0x00B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=8367*)
...
```
  ...
  1: 0x00CB [0x1D] PRINT_EVENT_MESSAGE(message_id=8330*)
  ...
  3: 0x00CF [0x1D] PRINT_EVENT_MESSAGE(message_id=8331*)
  ...
  5: 0x00D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=8332*)
  ...
  9: 0x00E5 [0x1D] PRINT_EVENT_MESSAGE(message_id=8333*)
