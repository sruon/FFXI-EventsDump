...
```
  ...
  2: 0x0560 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [EventEntity, EventEntity], work=[200*, 0*]
 ...
 13: 0x059C [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s037" with entities [EventEntity, EventEntity], work=[138*, 0*]
 14: 0x05AD [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi1" with entities [EventEntity, EventEntity], work=[200*, 0*]
 ...
 26: 0x0605 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s039" with entities [EventEntity, EventEntity], work=[138*, 0*]
 27: 0x0616 [0x4B] UPDATE_ENTITY_YAW(entity=Tosuka-Porika (ID: 17752080/0x010EE010), yaw=5.5°*)
 ...
 31: 0x063B [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s082" with entities [EventEntity, EventEntity], work=[138*, 0*]
 32: 0x064C [0x01] GOTO 0x0660
 33: 0x064F [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s038" with entities [EventEntity, EventEntity], work=[138*, 0*]
...
SUBROUTINE_0660:
 ...
 38: 0x0676 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s040" with entities [EventEntity, EventEntity], work=[138*, 0*]
 ...
 42: 0x06A6 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [EventEntity, EventEntity], work=[200*, 0*]
 ...
 59: 0x0732 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [EventEntity, EventEntity], work=[200*, 0*]
 ...
 62: 0x0755 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s041" with entities [EventEntity, EventEntity], work=[138*, 0*]
 63: 0x0766 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi1" with entities [EventEntity, EventEntity], work=[200*, 0*]
 64: 0x0777 [0x4B] UPDATE_ENTITY_YAW(entity=Tosuka-Porika (ID: 17752080/0x010EE010), yaw=5.5°*)
 ...
 80: 0x07E5 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s082" with entities [EventEntity, EventEntity], work=[138*, 0*]
 81: 0x07F6 [0x01] GOTO 0x080A
 82: 0x07F9 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s038" with entities [EventEntity, EventEntity], work=[138*, 0*]
...
SUBROUTINE_080A:
 ...
 89: 0x082C [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [EventEntity, EventEntity], work=[200*, 0*]
 ...
 96: 0x0852 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi1" with entities [EventEntity, EventEntity], work=[200*, 0*]
