...
- **9853**: Er, I'm s-sorry.
- **9857**: How can you say that!? Diss-a-sem-bull means to take something apart, doesn't it?
- **9858**: Joker will die if we do that!
- **9862**: I can't diss-a-sem-bull Joker, I just can't!
- **9863**: What am I going to do...?
...
```
  0: 0x0268 [0x1D] PRINT_EVENT_MESSAGE(message_id=9853*)
    → "Er, I'm s-sorry."
...
```
  0: 0x026D [0x1D] PRINT_EVENT_MESSAGE(message_id=9857*)
...
```
  0: 0x0272 [0x1D] PRINT_EVENT_MESSAGE(message_id=9858*)
...
```
  0: 0x0277 [0x1D] PRINT_EVENT_MESSAGE(message_id=9862*)
...
```
  0: 0x027C [0x1D] PRINT_EVENT_MESSAGE(message_id=9863*)
