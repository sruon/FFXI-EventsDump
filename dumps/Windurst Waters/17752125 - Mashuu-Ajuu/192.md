...
```
  ...
  4: 0x0085 [0x1D] PRINT_EVENT_MESSAGE(message_id=7757*)
    → "I heard you're gonna do the prep work for our skills test.\u007F1\u0000\u0007"
  5: 0x0088 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0089 [0x1D] PRINT_EVENT_MESSAGE(message_id=7758*)
    → "Well, don't expect us to suck up to you. There are other candidates for test supervisor too, ya know.\u007F1\u0000\u0007"
