...
SUBROUTINE_0066:
 ...
 38: 0x008C [0x24] CREATE_DIALOG(message_id=6908*, default_option=ExtData[1]->WorkLocal[9], option_flags=ExtData[1]->WorkLocal[6])
...
SUBROUTINE_0119:
 ...
 70: 0x0127 [0x24] CREATE_DIALOG(message_id=6909*, default_option=ExtData[1]->WorkLocal[1], option_flags=ExtData[1]->WorkLocal[6])
...
114: 0x0206 [0x24] CREATE_DIALOG(message_id=6913*, default_option=1*, option_flags=0*)
...
132: 0x0257 [0x24] CREATE_DIALOG(message_id=6910*, default_option=ExtData[1]->WorkLocal[1], option_flags=ExtData[1]->WorkLocal[6])
...
151: 0x02C2 [0x24] CREATE_DIALOG(message_id=6913*, default_option=1*, option_flags=0*)
    → "Select this song? [Yes, this sounds splendid!/No, I've changed my tune.]"
...
169: 0x0313 [0x24] CREATE_DIALOG(message_id=6911*, default_option=ExtData[1]->WorkLocal[1], option_flags=ExtData[1]->WorkLocal[6])
...
188: 0x037E [0x24] CREATE_DIALOG(message_id=6913*, default_option=1*, option_flags=0*)
    → "Select this song? [Yes, this sounds splendid!/No, I've changed my tune.]"
...
206: 0x03CF [0x24] CREATE_DIALOG(message_id=6912*, default_option=ExtData[1]->WorkLocal[1], option_flags=ExtData[1]->WorkLocal[6])
...
225: 0x043A [0x24] CREATE_DIALOG(message_id=6913*, default_option=1*, option_flags=0*)
    → "Select this song? [Yes, this sounds splendid!/No, I've changed my tune.]"
