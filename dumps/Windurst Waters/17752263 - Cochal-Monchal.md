...
- **9592**: Phooey, Dewey! I'm sooo confused. This goes over...no, that goes...no, this needs to be...no...
- **9593**: What? No... Here from Bastok, are we? Yes? How may I help? No...assist, yes, assist.
- **9594**: Really? No... You say you're looking for $3? Yes...yes, I remember that one, I do.
- **9595**: It turned up the last time, or was it the first...no...the last time I cleaned out the old book vault. That text was filled with lots of important-looking blacksmithing techniques.
- **9596**: One look, and I knew this book didn't belong here in Windurst, I mean...not here in this library...I mean.
- **9597**: So, I decided to take it to Bastok and see if I could shed any light on the mystery surrounding the text...and that's when I was attacked by a band of rogues...Yagudo rogues, they were.
- **9598**: If we ever want to see it again, we'll have to travel to Giddeus and get it back from that thief, Vaa Huja the Erudite, ourselves.
- **9599**: Well, I didn't exactly mean "ourselves." You're the adventurer, aren't you...yes?
- **9600**: That thief, Vaa Huja the Erudite, is probably using $6 to line his birdcage as we speak!
- **9601**: We must do something...yes, something quickly!
- **9602**: Well, I'm happy to see that we were successful in retrieving $3... Yes, very happy.
- **9603**: Oh, yes, and when you take that back to Bastok, could you ask them if there are any other books they can donate? If they don't have any, a generous donation of gil would work just as well.
...
```
  ...
  4: 0x0098 [0x1D] PRINT_EVENT_MESSAGE(message_id=9592*)
...
```
  ...
  5: 0x00B6 [0x1D] PRINT_EVENT_MESSAGE(message_id=9593*)
 ...
 13: 0x00F4 [0x1D] PRINT_EVENT_MESSAGE(message_id=9594*)
 ...
 16: 0x00FF [0x1D] PRINT_EVENT_MESSAGE(message_id=9595*)
 ...
 19: 0x010A [0x1D] PRINT_EVENT_MESSAGE(message_id=9596*)
 ...
 22: 0x0115 [0x1D] PRINT_EVENT_MESSAGE(message_id=9597*)
 ...
 26: 0x0127 [0x1D] PRINT_EVENT_MESSAGE(message_id=9598*)
 ...
 30: 0x0139 [0x1D] PRINT_EVENT_MESSAGE(message_id=9599*)
...
```
  ...
  4: 0x0156 [0x1D] PRINT_EVENT_MESSAGE(message_id=9600*)
  ...
  6: 0x015A [0x1D] PRINT_EVENT_MESSAGE(message_id=9601*)
