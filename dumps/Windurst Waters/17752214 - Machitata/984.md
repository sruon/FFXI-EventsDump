...
SUBROUTINE_0045:
 ...
 15: 0x004D [0x24] CREATE_DIALOG(message_id=15060*, default_option=0*, option_flags=0x02)
 ...
 22: 0x006C [0x1D] PRINT_EVENT_MESSAGE(message_id=15053*)
    → "A Mog House is a personal apartment that we've provided for your convenience.\u007F1\u0000\u0007"
 23: 0x006F [0x23] WAIT_FOR_DIALOG_INTERACTION
 24: 0x0070 [0x1D] PRINT_EVENT_MESSAGE(message_id=15054*)
    → "Within your Mog House, you can carry out such activities as storing items, changing jobs, and healing HP and MP.\u007F1\u0000\u0007"
 25: 0x0073 [0x23] WAIT_FOR_DIALOG_INTERACTION
 26: 0x0074 [0x1D] PRINT_EVENT_MESSAGE(message_id=15055*)
    → "You are completely free to use the room as you see fit. Why, you can even arrange it to suit your own bad tastes.\u0001t\u007F1\u0000\u0007"
 ...
 34: 0x009A [0x24] CREATE_DIALOG(message_id=15061*, default_option=0*, option_flags=0x01)
...
SUBROUTINE_00B1:
 ...
 44: 0x00C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=15059*)
    → "Come along then! Don't lag behind!\u0001t\u007F1\u0000\u0007"
