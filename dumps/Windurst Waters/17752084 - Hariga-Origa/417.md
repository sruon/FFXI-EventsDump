...
```
  ...
  3: 0x0309 [0x50] END_SCHEDULER_TASK(first_entity=0xFFF8, first_param=32767, second_entity=0xFFF8, second_param=32767, action_id="sh", third_param=12385)
 ...
 12: 0x0336 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 13: 0x0347 [0x1C] WAIT(100* ticks)
 14: 0x034A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 15: 0x035B [0x29] REQ_SET_WAIT(priority=0x0B, entity_id=Hariga-Origa (ID: 17752084/0x010EE014), tag_num=0x21)
 16: 0x0362 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "sha0" for entities [EventEntity, EventEntity]
 17: 0x036F [0x29] REQ_SET_WAIT(priority=0x0B, entity_id=Hariga-Origa (ID: 17752084/0x010EE014), tag_num=0x22)
 18: 0x0376 [0x50] END_SCHEDULER_TASK(first_entity=0xFFF8, first_param=32767, second_entity=0xFFF8, second_param=32767, action_id="sh", third_param=12385)
 ...
 25: 0x039F [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 26: 0x03B0 [0x1C] WAIT(60* ticks)
 27: 0x03B3 [0x5F] MULTI_HANDLER_COMPLEX(mode=0x00 - Toggle Render.Flags0 bit 29)
 28: 0x03B5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 29: 0x03C6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
