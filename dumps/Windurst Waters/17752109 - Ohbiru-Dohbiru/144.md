...
```
  ...
  4: 0x0156 [0x1D] PRINT_EVENT_MESSAGE(message_id=7612*)
    → "At first there was just one altar for offerings in Giddeus. So we only needed to take one bag of food.\u007F1\u0000\u0007"
  5: 0x0159 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x015A [0x1D] PRINT_EVENT_MESSAGE(message_id=7613*)
    → "Then one day, those sneaky Yagudo decided to build another altar. They are so greedy.\u007F1\u0000\u0007"
