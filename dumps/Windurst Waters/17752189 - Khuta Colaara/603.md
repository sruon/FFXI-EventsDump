...
```
  ...
  4: 0x00A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=8876*)
    → "Oh, wow!\u0007When did you rrreceive official rrrecognition as an adventurrrerrr?\u007F1\u0000\u0007"
  5: 0x00AC [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x00AD [0x1D] PRINT_EVENT_MESSAGE(message_id=8877*)
    → "Why, only the otherrr day you werrre a novice adventurrrerrr like me. Imprrressive!\u007F1\u0000\u0007"
