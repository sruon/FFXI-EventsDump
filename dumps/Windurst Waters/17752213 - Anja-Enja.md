...
- **7955**: Hiya! Are you lost or something? If you're in trouble, Anja-Enja's here to helpy-welpy!
- **7956**: Well, if you ever need help, feel free to ask one of us guards.
- **7957**: Helping out people in need is the calling of us guards in Windurst Waters's "North Winds" troupey-woupey.
- **7958**: Ask for help on...? [Nothing right now./Where are we?/How to leave town./Where's the residential area?]
- **7959**: This is the Windurst Waters district. Just north of here are the Optistery, the Aurastery, and a general goods store. South of here are the Rhinostery and the hatter's.
- **7962**: The quickest way to leave town from here is Odin's Gate, which takes you out to West Sarutabaruta. Head north and pass through the archway of the Optistery's Library of Magic.
- **7963**: Then go over the bridge until you get to the northern gatehouse. (That's where we guards of Windurst Waters meet, you know?) Head through the gate and you'll find yourself outside in West Sarutabaruta.
- **7964**: Windurst's residential area is northeast of here. To get there, first head north and cross the bridge to the east that leads to the Aurastery and Windurst Walls.
- **7965**: On the way, you'll come across a Cardian automaton guard. Turn right when you see him and you'll easily find your way there.
- **7966**: You know about the residential area's Mog Houses, rightaru? If not, just ask the guards at the entrance to the residential area for information.
...
```
  ...
  4: 0x003C [0x1D] PRINT_EVENT_MESSAGE(message_id=7955*)
  ...
  6: 0x0040 [0x24] CREATE_DIALOG(message_id=7958*, default_option=0*, option_flags=0*)
...
```
  0: 0x00B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7959*)
...
```
  0: 0x00BC [0x1D] PRINT_EVENT_MESSAGE(message_id=7962*)
  ...
  2: 0x00C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7963*)
...
```
  0: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7964*)
  ...
  2: 0x00CC [0x1D] PRINT_EVENT_MESSAGE(message_id=7965*)
  ...
  5: 0x00D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7966*)
