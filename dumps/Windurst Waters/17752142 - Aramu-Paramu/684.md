...
```
  ...
  4: 0x00E3 [0x1D] PRINT_EVENT_MESSAGE(message_id=8948*)
    → "Each and every one of us have their own problems. But such is the spice of life...\u007F1\u0000\u0007"
  5: 0x00E6 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x00E7 [0x1D] PRINT_EVENT_MESSAGE(message_id=8949*)
    → "Welcome to the restaurant that resounds with its own sound! Welcome to the Timbre Timbers Tavern!\u007F1\u0000\u0007"
