...
- **8167**: There's a thick book with a title you can't make out.
- **8168**: Have a quick look inside. [No way!/Take a peek.]
- **8169**: Wow! You received 300,000 gil!
- **8170**: ...or so you thought for a second there.
...
```
  0: 0x0001 [0x48] [System] [8167*]:
    → "There's a thick book with a title you can't make out."
  1: 0x0004 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=8168*, default_option=0*, option_flags=0*)
