...
- **8831**: Among the guards of Windurst are the automatons who speaky-weaky in the words of the stars.
- **8832**: They are the Cardians, magical puppet-like dolly-wollys that are made at the Manustery.
- **12292**: <Player>'s badge flashes brightly.
- **12299**: Among the guards of Windurst are the automatons who speaky-weaky in the words of the stars.
- **12300**: I heardy-weardy that there are automatons in Aht Urhgan too, but they can't do what ours can! Talk about boring-woring!
...
```
  ...
  5: 0x0044 [0x1D] PRINT_EVENT_MESSAGE(message_id=8831*)
  ...
  7: 0x0048 [0x1D] PRINT_EVENT_MESSAGE(message_id=8832*)
...
```
  ...
  7: 0x006F [0x1D] PRINT_EVENT_MESSAGE(message_id=12299*)
    → "Among the guards of Windurst are the automatons who speaky-weaky in the words of the stars."
  8: 0x0072 [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x0073 [0x1D] PRINT_EVENT_MESSAGE(message_id=12300*)
