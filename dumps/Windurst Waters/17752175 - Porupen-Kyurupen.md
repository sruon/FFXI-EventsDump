...
- **8823**: Want to learn how to use a little magic? You should stop by the School of Magic, which is run by the Aurastery. It's across the bridge here and up to your left.
- **8824**: Oh... It's probably quicker to ask the students than the teachers. The educatees there are more eager scholars than the educators.
