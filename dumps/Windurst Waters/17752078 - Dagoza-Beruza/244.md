...
```
  ...
  4: 0x0336 [0x1D] PRINT_EVENT_MESSAGE(message_id=7864*)
    → "As soon as I heard the sudden convocation of the five ministries, I had a bad feeling about it.\u007F1\u0000\u0007"
  5: 0x0339 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x033A [0x1D] PRINT_EVENT_MESSAGE(message_id=7865*)
    → "After the last incident in the Horutoto Ruins, I knew there was something scary-wary going down.\u007F1\u0000\u0007"
