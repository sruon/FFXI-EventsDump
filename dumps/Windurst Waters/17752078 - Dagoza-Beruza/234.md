...
```
  ...
  4: 0x02F4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7843*)
    → "Hmm... Heavens Tower is in turmoil over something big.\u007F1\u0000\u0007"
  5: 0x02F7 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x02F8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7844*)
    → "My little sister is a lady-in-waiting, so I want to ask her about a lot of this stuff. But that would just be putting her on the spot.\u007F1\u0000\u0007"
