...
- **14923**: You there. I suppose you've heard the gossip flying around town--the talk of part-time ghosts?
- **14924**: Have you heard? [Yes, I've heard./Part-time ghosts!?]
- **14925**: Then we may move on to more important matters.
- **14926**: We haven't been able to locate enough volunteers to participate in this year's festivities, and are searching for adventurers who would be willing to aid us.
- **14927**: All you will be required to do is dress up in one of these frightening costumes and wander about the city with the other specters.
- **14928**: <Sigh>... Then allow me to explain.
- **14929**: A memorial is currently being held in honor of a long-lost coven of witches known as the Dark Lilies.
- **14930**: During the memorial, volunteers dressed up as the witches and spirits walk a course about the city in honor of the deceased.
- **14931**: However, while we have filled all the spots for the witches, we are quite short on people willing to play the part of the monsters who follow the Lilies.
- **14932**: Would you be willing to lend a hand, fine [sir/lady]?
- **14933**: Will you help? [Of course./Not a ghost of a chance.]
- **14934**: Ah... How droll. Please speak with me again if you change your mind.
- **14935**: Most excellent. There is one thing you must be aware of, however.
- **14936**: The witches have the most important role in this memorial service. You are to tread only in their wake. If it is found that you have stepped ahead of one of the Lilies, you will be asked to return your costume and leave the procession.
- **14937**: Though, we are a forgiving organization, and if you wish to participate once again, either speak with me or simply put on another costume and your request shall be granted.
- **14938**: Ah yes, and one more thing. There are two citizens playing the parts of the witches Guwanana and Bikho Ronpotteh.
- **14939**: You are to follow the fair Mithran maid dressed as Bikho. Remember this, as you will not receive any compensation in the event you join the wrong group.
- **14940**: Ah, welcome back, adventurer. You have done well. The Dark Lilies would be pleased.
- **14941**: Please take this as a token of our appreciation.
- **14942**: It is a hat modeled after those worn by the Dark Lilies. Perhaps you might wear it during the season's festivities.
- **14943**: Oh, and should you wish to aid us again, we would welcome your help. Many thanks, <Player>.
- **14944**: What has befallen you? Do you wish to give up?
- **14945**: Give up? [I'm done./Not yet.]
- **14946**: A pity. Please speak with me again if you change your mind.
- **14947**: You are to follow the young maiden dressed as Guwanana. Remember this, as you will not receive any compensation in the event you join the wrong group.
- **14993**: I shall let you know when there is another opening.
...
```
  ...
  2: 0x000B [0x1D] PRINT_EVENT_MESSAGE(message_id=14923*)
 ...
 11: 0x0027 [0x1D] PRINT_EVENT_MESSAGE(message_id=14927*)
 ...
 15: 0x0036 [0x1D] PRINT_EVENT_MESSAGE(message_id=14928*)
    → "<Sigh>... Then allow me to explain."
 16: 0x0039 [0x23] WAIT_FOR_DIALOG_INTERACTION
 17: 0x003A [0x1D] PRINT_EVENT_MESSAGE(message_id=14929*)
 ...
 19: 0x003E [0x1D] PRINT_EVENT_MESSAGE(message_id=14930*)
 ...
 21: 0x0042 [0x1D] PRINT_EVENT_MESSAGE(message_id=14931*)
...
SUBROUTINE_0049:
 24: 0x0049 [0x1D] PRINT_EVENT_MESSAGE(message_id=14932*)
    → "Would you be willing to lend a hand, fine [sir/lady]?"
 25: 0x004C [0x23] WAIT_FOR_DIALOG_INTERACTION
 26: 0x004D [0x24] CREATE_DIALOG(message_id=14933*, default_option=0*, option_flags=0*)
 ...
 34: 0x0066 [0x1D] PRINT_EVENT_MESSAGE(message_id=14937*)
 ...
 36: 0x006A [0x1D] PRINT_EVENT_MESSAGE(message_id=14938*)
 ...
 38: 0x006E [0x1D] PRINT_EVENT_MESSAGE(message_id=14939*)
 ...
 43: 0x0082 [0x1D] PRINT_EVENT_MESSAGE(message_id=14934*)
...
```
 ...
 13: 0x00C7 [0x1D] PRINT_EVENT_MESSAGE(message_id=14942*)
 ...
 15: 0x00CB [0x1D] PRINT_EVENT_MESSAGE(message_id=14943*)
...
```
  ...
  2: 0x0112 [0x1D] PRINT_EVENT_MESSAGE(message_id=14923*)
    → "You there. I suppose you've heard the gossip flying around town--the talk of part-time ghosts?"
  3: 0x0115 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0116 [0x24] CREATE_DIALOG(message_id=14924*, default_option=0*, option_flags=0*)
    → "Have you heard? [Yes, I've heard./Part-time ghosts!?]"
  5: 0x011D [0x25] WAIT_DIALOG_SELECT()
  6: 0x011E [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0135
  7: 0x0126 [0x1D] PRINT_EVENT_MESSAGE(message_id=14925*)
    → "Then we may move on to more important matters."
  8: 0x0129 [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x012A [0x1D] PRINT_EVENT_MESSAGE(message_id=14926*)
    → "We haven't been able to locate enough volunteers to participate in this year's festivities, and are searching for adventurers who would be willing to aid us."
 10: 0x012D [0x23] WAIT_FOR_DIALOG_INTERACTION
 11: 0x012E [0x1D] PRINT_EVENT_MESSAGE(message_id=14927*)
    → "All you will be required to do is dress up in one of these frightening costumes and wander about the city with the other specters."
 12: 0x0131 [0x23] WAIT_FOR_DIALOG_INTERACTION
 13: 0x0132 [0x01] GOTO 0x0150
 14: 0x0135 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x0150
 15: 0x013D [0x1D] PRINT_EVENT_MESSAGE(message_id=14928*)
    → "<Sigh>... Then allow me to explain."
 16: 0x0140 [0x23] WAIT_FOR_DIALOG_INTERACTION
 17: 0x0141 [0x1D] PRINT_EVENT_MESSAGE(message_id=14929*)
    → "A memorial is currently being held in honor of a long-lost coven of witches known as the Dark Lilies."
 18: 0x0144 [0x23] WAIT_FOR_DIALOG_INTERACTION
 19: 0x0145 [0x1D] PRINT_EVENT_MESSAGE(message_id=14930*)
    → "During the memorial, volunteers dressed up as the witches and spirits walk a course about the city in honor of the deceased."
 20: 0x0148 [0x23] WAIT_FOR_DIALOG_INTERACTION
 21: 0x0149 [0x1D] PRINT_EVENT_MESSAGE(message_id=14931*)
    → "However, while we have filled all the spots for the witches, we are quite short on people willing to play the part of the monsters who follow the Lilies."
 22: 0x014C [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x014D [0x01] GOTO 0x0150

SUBROUTINE_0150:
 24: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=14932*)
    → "Would you be willing to lend a hand, fine [sir/lady]?"
 25: 0x0153 [0x23] WAIT_FOR_DIALOG_INTERACTION
 26: 0x0154 [0x24] CREATE_DIALOG(message_id=14933*, default_option=0*, option_flags=0*)
    → "Will you help? [Of course./Not a ghost of a chance.]"
 27: 0x015B [0x25] WAIT_DIALOG_SELECT()
 28: 0x015C [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0181
 29: 0x0164 [0x42] SET_CLI_EVENT_CANCEL_DATA()
 30: 0x0165 [0x1D] PRINT_EVENT_MESSAGE(message_id=14935*)
    → "Most excellent. There is one thing you must be aware of, however."
 31: 0x0168 [0x23] WAIT_FOR_DIALOG_INTERACTION
 32: 0x0169 [0x1D] PRINT_EVENT_MESSAGE(message_id=14936*)
    → "The witches have the most important role in this memorial service. You are to tread only in their wake. If it is found that you have stepped ahead of one of the Lilies, you will be asked to return your costume and leave the procession."
 33: 0x016C [0x23] WAIT_FOR_DIALOG_INTERACTION
 34: 0x016D [0x1D] PRINT_EVENT_MESSAGE(message_id=14937*)
    → "Though, we are a forgiving organization, and if you wish to participate once again, either speak with me or simply put on another costume and your request shall be granted."
 35: 0x0170 [0x23] WAIT_FOR_DIALOG_INTERACTION
 36: 0x0171 [0x1D] PRINT_EVENT_MESSAGE(message_id=14938*)
    → "Ah yes, and one more thing. There are two citizens playing the parts of the witches Guwanana and Bikho Ronpotteh."
 37: 0x0174 [0x23] WAIT_FOR_DIALOG_INTERACTION
 38: 0x0175 [0x1D] PRINT_EVENT_MESSAGE(message_id=14947*)
 ...
 43: 0x0189 [0x1D] PRINT_EVENT_MESSAGE(message_id=14934*)
    → "Ah... How droll. Please speak with me again if you change your mind."
...
```
  ...
  1: 0x0197 [0x1D] PRINT_EVENT_MESSAGE(message_id=14993*)
