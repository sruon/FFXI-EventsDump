...
```
  ...
  4: 0x005B [0x1D] PRINT_EVENT_MESSAGE(message_id=7974*)
    → "The three telescopes found here are hundreds of years old and have become rather antiquated.\u007F1\u0000\u0007"
  5: 0x005E [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x005F [0x1D] PRINT_EVENT_MESSAGE(message_id=7975*)
    → "Many a time there's been talk of rebuilding them, but we've not been able to do it yet.\u007F1\u0000\u0007"
