...
- **8169**: You hear a strange sound... It appears to be coming from this book.
- **8170**: Check out what's inside? [No way!/Take a peek.]
- **8171**: .........You simply can't open it!
...
```
  0: 0x0001 [0x48] [System] [8169*]:
    → "You hear a strange sound... It appears to be coming from this book."
  1: 0x0004 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=8170*, default_option=0*, option_flags=0*)
