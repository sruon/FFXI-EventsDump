...
```
  ...
  4: 0x0196 [0x1D] PRINT_EVENT_MESSAGE(message_id=7507*)
    → "This is the north gatehouse of Windurst. If you're in need of a map of Windurst, head south to the Port District.\u007F1\u0000\u0007"
  5: 0x0199 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x019A [0x1D] PRINT_EVENT_MESSAGE(message_id=7508*)
    → "I heard a Mithra lady-wady was selling magic maps near the shops along the wharves there.\u007F1\u0000\u0007"
