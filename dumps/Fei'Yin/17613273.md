...
| [65535.7](#event-655357) | 0x0045       |     25 |              3 |
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0040:                B4 00 00  00 4D 61 77 6C 27 67 6F       ....Mawl'go
0050: 66 61 75 72 00 00 00 00  00 B5 00 00 00 00        faur..........  
```

#### Opcodes

```
  0: 0x0045 [0xB4] UI_WINDOW_STRING_HANDLER(case=0x00 - Copy string from opcode, work_offset=ExtData[1]->WorkLocal[0], string="Mawl'gofaur")
