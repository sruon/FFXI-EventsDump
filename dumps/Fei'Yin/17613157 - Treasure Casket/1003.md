...
```
 ...
 52: 0x0131 [0x01] GOTO 0x01B2
 53: 0x0134 [0x02] IF !(Work_Zone[0] == 3*) GOTO 0x0149
 54: 0x013C [0x03] ExtData[1]->WorkLocal[12] = ExtData[1]->WorkLocal[2]
 55: 0x0141 [0x03] ExtData[1]->WorkLocal[9] = 3*
 56: 0x0146 [0x01] GOTO 0x01B2
 57: 0x0149 [0x02] IF !(Work_Zone[0] == 4*) GOTO 0x015E
 58: 0x0151 [0x03] ExtData[1]->WorkLocal[12] = ExtData[1]->WorkLocal[3]
 59: 0x0156 [0x03] ExtData[1]->WorkLocal[9] = 4*
 60: 0x015B [0x01] GOTO 0x01B2
 61: 0x015E [0x02] IF !(Work_Zone[0] == 5*) GOTO 0x0173
 62: 0x0166 [0x03] ExtData[1]->WorkLocal[12] = ExtData[1]->WorkLocal[4]
 63: 0x016B [0x03] ExtData[1]->WorkLocal[9] = 5*
 64: 0x0170 [0x01] GOTO 0x01B2
 65: 0x0173 [0x02] IF !(Work_Zone[0] == 6*) GOTO 0x0188
 66: 0x017B [0x03] ExtData[1]->WorkLocal[12] = ExtData[1]->WorkLocal[5]
 67: 0x0180 [0x03] ExtData[1]->WorkLocal[9] = 6*
 68: 0x0185 [0x01] GOTO 0x01B2
 69: 0x0188 [0x02] IF !(Work_Zone[0] == 7*) GOTO 0x019D
 70: 0x0190 [0x03] ExtData[1]->WorkLocal[12] = ExtData[1]->WorkLocal[6]
 71: 0x0195 [0x03] ExtData[1]->WorkLocal[9] = 7*
 72: 0x019A [0x01] GOTO 0x01B2
 73: 0x019D [0x02] IF !(Work_Zone[0] == 8*) GOTO 0x01B2
 74: 0x01A5 [0x03] ExtData[1]->WorkLocal[12] = ExtData[1]->WorkLocal[7]
 75: 0x01AA [0x03] ExtData[1]->WorkLocal[9] = 8*
 76: 0x01AF [0x01] GOTO 0x01B2
 77: 0x01B2 [0x02] IF !(ExtData[1]->WorkLocal[9] <= 0*) GOTO 0x0206
 78: 0x01BA [0x02] IF !(ExtData[1]->WorkLocal[12] <= 0*) GOTO 0x0206
 79: 0x01C2 [0x93] DISPLAY_ITEM_INFO(item_id=ExtData[1]->WorkLocal[12])
 80: 0x01C5 [0x48] [System] [7548*]:
    → "Obtain this item?\u007F1\u0000\u0007"
 81: 0x01C8 [0x23] WAIT_FOR_DIALOG_INTERACTION
 82: 0x01C9 [0x93] DISPLAY_ITEM_INFO(item_id=0*)
 83: 0x01CC [0x24] CREATE_DIALOG(message_id=7524*, default_option=1*, option_flags=0*)
    → "Obtain this item?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
 84: 0x01D3 [0x25] WAIT_DIALOG_SELECT()
 85: 0x01D4 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x01E4
 86: 0x01DC [0x03] ExtData[1]->WorkLocal[10] = 1*
 87: 0x01E1 [0x01] GOTO 0x01F4

SUBROUTINE_01E4:
 88: 0x01E4 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x01F4
 89: 0x01EC [0x03] ExtData[1]->WorkLocal[10] = 2*
 90: 0x01F1 [0x01] GOTO 0x01F4
 91: 0x01F4 [0x40] SET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, target=Work_Zone[1], source=ExtData[1]->WorkLocal[9])
 92: 0x01FD [0x40] SET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, target=Work_Zone[1], source=ExtData[1]->WorkLocal[10])
 93: 0x0206 [0x42] SET_CLI_EVENT_CANCEL_DATA()
 94: 0x0207 [0x21] END_EVENT

SUBROUTINE_0208:
 95: 0x0208 [0x00] END_REQSTACK()
```
