...
```
  ...
  5: 0x0013 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "shit" for entities [LocalPlayer, LocalPlayer]
  6: 0x0020 [0x53] WAIT_SCHEDULER_TASK(entity1=LocalPlayer, entity2=LocalPlayer, action_id="shit")
  7: 0x002D [0x1C] WAIT(30* ticks)
  8: 0x0030 [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "main" with entities [EventEntity, EventEntity], work=[3*, 0*]
  9: 0x0041 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="main")
 10: 0x004E [0x1C] WAIT(60* ticks)
 11: 0x0051 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "res0" for entities [LocalPlayer, LocalPlayer]
 12: 0x005E [0x53] WAIT_SCHEDULER_TASK(entity1=LocalPlayer, entity2=LocalPlayer, action_id="res0")
 ...
 16: 0x0074 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "res2" for entities [LocalPlayer, LocalPlayer]
 17: 0x0081 [0x53] WAIT_SCHEDULER_TASK(entity1=LocalPlayer, entity2=LocalPlayer, action_id="res2")
