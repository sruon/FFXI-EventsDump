...
| [65535.8](#event-655358) | 0x005E       |     25 |              3 |
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0050:                                            B4 00                ..
0060: 00 00 4B 61 72 65 68 27  61 79 6F 6C 6C 69 6F 00  ..Kareh'ayollio.
...
```
  0: 0x005E [0xB4] UI_WINDOW_STRING_HANDLER(case=0x00 - Copy string from opcode, work_offset=ExtData[1]->WorkLocal[0], string="Kareh'ayollio")
