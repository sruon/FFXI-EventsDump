...
- **7827**: DEBUG: Whaddaya want? [All NPCs released!/All areas./Block A./Block B./Block C./Sky general down!/Flame general down!/Spring general down!/Stone general down!/Gale general down!/Saved all the prisoners!]
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=7827*, default_option=0*, option_flags=0*)
