...
- **7706**: <Player>, is it? This should please you...
- **7707**: You are a mercenary, are you?
- **7708**: Hmph, filthy money-grubbers. Those who are controlled by money are eventually betrayed by it.
- **7709**: Damn those spineless Imperial soldiers! How could they let the Astral Candescence slip out right under their very noses!?
- **7710**: ...Hm? You! Yes, you! What do you think you're staring at, anyway? Go get the Astral Candescence back, and now!
- **7711**: Ugh, you again. I have no patience for the mercenary mentality.
- **7712**: But you do show some skill in battle. I'll give you that much, <Player>...
...
0060: 6F 70 6E F6 01 03 01 01  80 99 F6 01 03 01 1D 02  opn.............
...
```
  ...
  8: 0x0062 [0x6E] Gadalar (ID: 16974326/0x010301F6) uses emote 0*
  9: 0x0069 [0x99] Wait for Gadalar (ID: 16974326/0x010301F6) animation to complete
 10: 0x006E [0x1D] PRINT_EVENT_MESSAGE(message_id=7706*)
...
0090: 6E F6 01 03 01 06 80 99  F6 01 03 01 1D 07 80 23  n..............#
00A0: 99 F6 01 03 01 1C 08 80  21 00                    ........!.      
```
...
```
  ...
  4: 0x008C [0x1D] PRINT_EVENT_MESSAGE(message_id=7707*)
    → "You are a mercenary, are you?"
  5: 0x008F [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0090 [0x6E] Gadalar (ID: 16974326/0x010301F6) uses emote 22*
  7: 0x0097 [0x99] Wait for Gadalar (ID: 16974326/0x010301F6) animation to complete
  8: 0x009C [0x1D] PRINT_EVENT_MESSAGE(message_id=7708*)
 ...
 10: 0x00A0 [0x99] Wait for Gadalar (ID: 16974326/0x010301F6) animation to complete
...
00B0: 7F 6F 70 6E F6 01 03 01  09 80 99 F6 01 03 01 1D  .opn............
00C0: 0A 80 23 99 F6 01 03 01  1C 08 80 6E F6 01 03 01  ..#........n....
00D0: 0B 80 99 F6 01 03 01 1D  0C 80 23 99 F6 01 03 01  ..........#.....
00E0: 1C 08 80 21 00                                    ...!.           
```
...
```
  ...
  4: 0x00B3 [0x6E] Gadalar (ID: 16974326/0x010301F6) uses emote 25*
  5: 0x00BA [0x99] Wait for Gadalar (ID: 16974326/0x010301F6) animation to complete
  6: 0x00BF [0x1D] PRINT_EVENT_MESSAGE(message_id=7709*)
  ...
  8: 0x00C3 [0x99] Wait for Gadalar (ID: 16974326/0x010301F6) animation to complete
  9: 0x00C8 [0x1C] WAIT(30* ticks)
 10: 0x00CB [0x6E] Gadalar (ID: 16974326/0x010301F6) uses emote 34*
 11: 0x00D2 [0x99] Wait for Gadalar (ID: 16974326/0x010301F6) animation to complete
 12: 0x00D7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7710*)
 ...
 14: 0x00DB [0x99] Wait for Gadalar (ID: 16974326/0x010301F6) animation to complete
...
0100: 6F 70 1D 14 80 23 6E F6  01 03 01 01 80 99 F6 01  op...#n.........
0110: 03 01 1D 15 80 23 99 F6  01 03 01 1C 08 80 21 00  .....#........!.
```
...
```
  ...
  4: 0x0102 [0x1D] PRINT_EVENT_MESSAGE(message_id=7711*)
    → "Ugh, you again. I have no patience for the mercenary mentality."
  5: 0x0105 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0106 [0x6E] Gadalar (ID: 16974326/0x010301F6) uses emote 0*
  7: 0x010D [0x99] Wait for Gadalar (ID: 16974326/0x010301F6) animation to complete
  8: 0x0112 [0x1D] PRINT_EVENT_MESSAGE(message_id=7712*)
    → "But you do show some skill in battle. I'll give you that much, <Player>..."
  9: 0x0115 [0x23] WAIT_FOR_DIALOG_INTERACTION
 10: 0x0116 [0x99] Wait for Gadalar (ID: 16974326/0x010301F6) animation to complete
