...
| [11](#event-11)          | 0x002C       |      7 |              2 |
| [65535.5](#event-655355) | 0x0033       |     10 |              2 |
| [65535.6](#event-655356) | 0x003D       |     15 |              5 |
...
```
  0: 0x0033 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-112.506*, z=66.673*, y=1.999*, direction=178.1°*
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0030:                                         32 06 80               2..
0040: 1F 00 07 80 08 80 04 80  1F 01 6F 00              ..........o.    
```
...
```
  ...
  1: 0x0040 [0x1F] MOVE_ENTITY: EventEntity moves to X=-106.844*, Z=66.381*, Y=1.999*
