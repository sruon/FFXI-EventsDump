...
```
  0: 0x002D [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-113.294*, z=68.902*, y=1.999*, direction=355.4°*
...
0070: FF FF 7F 73 72 64 30 00                           ...srd0.        
```

#### Opcodes

```
  0: 0x0068 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "srd0" with entities [EventEntity, EventEntity], work=827*
