...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0070:                   6C 0D  02 03 01 00 80 01 80 00        l.........
```

#### Opcodes

```
  0: 0x0076 [0x6C] FADE_ENTITY_COLOR(entity_id=Unnamed NPC (ID: 16974349/0x0103020D), end_alpha=128*, fade_time=90*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0080: 6C 0B 02 03 01 00 80 02  80 00                    l.........      
```

#### Opcodes

```
  0: 0x0080 [0x6C] FADE_ENTITY_COLOR(entity_id=Unnamed NPC (ID: 16974347/0x0103020B), end_alpha=128*, fade_time=60*)
...
```
  0: 0x008A [0x6C] FADE_ENTITY_COLOR(entity_id=Unnamed NPC (ID: 16974354/0x01030212), end_alpha=128*, fade_time=60*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0090:             6C 1D 02 03  01 00 80 02 80 00            l.........  
```

#### Opcodes

```
  0: 0x0094 [0x6C] FADE_ENTITY_COLOR(entity_id=Unnamed NPC (ID: 16974365/0x0103021D), end_alpha=128*, fade_time=60*)
...
```
  0: 0x009E [0x6C] FADE_ENTITY_COLOR(entity_id=Zazarg (ID: 16974374/0x01030226), end_alpha=128*, fade_time=60*)
