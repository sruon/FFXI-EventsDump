...
```
  0: 0x002D [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-72.072*, z=108.952*, y=1.999*, direction=88.2°*
...
```
  0: 0x0037 [0x32] ExtData[1]->MainSpeed = 12* * 0.1
  1: 0x003A [0x1F] MOVE_ENTITY: EventEntity moves to X=-72.209*, Z=106.898*, Y=1.999*
