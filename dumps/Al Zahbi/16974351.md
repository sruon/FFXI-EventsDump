...
| [65535.7](#event-655357) | 0x0079       |     10 |              2 |
| [65535.8](#event-655358) | 0x0083       |     15 |              5 |
...
```
  0: 0x002F [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-106.000*, z=64.825*, y=1.999*, direction=358.7°*
...
```
  0: 0x0079 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=125.839*, z=120.000*, y=3.000*, direction=358.9°*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0080:          32 11 80 1F 00  12 80 0E 80 13 80 1F 01     2............
0090: 6F 00                                             o.              
```
...
```
  ...
  1: 0x0086 [0x1F] MOVE_ENTITY: EventEntity moves to X=133.345*, Z=120.000*, Y=2.999*
