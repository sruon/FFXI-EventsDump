...
```
  0: 0x002D [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-115.532*, z=68.848*, y=1.999*, direction=0.7°*
...
```
  ...
  1: 0x003A [0x1F] MOVE_ENTITY: EventEntity moves to X=-110.250*, Z=68.985*, Y=1.999*
