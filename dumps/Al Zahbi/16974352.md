...
```
  0: 0x002F [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-106.000*, z=71.879*, y=1.999*, direction=2.0°*
...
```
  0: 0x0039 [0x1C] WAIT(12* ticks)
  1: 0x003C [0x32] ExtData[1]->MainSpeed = 11* * 0.1
  2: 0x003F [0x1F] MOVE_ENTITY: EventEntity moves to X=-103.000*, Z=71.841*, Y=1.999*
