...
```
  ...
  3: 0x000E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="moj0")
 ...
 15: 0x003D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="wai0")
 16: 0x004C [0x1D] PRINT_EVENT_MESSAGE(message_id=7981*)
    → "R-really!?\u0007Y-you're very b-brave!\u0000\u0007"
 17: 0x004F [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="wai0")
 18: 0x005C [0x1D] PRINT_EVENT_MESSAGE(message_id=7982*)
    → "P-probably best if you c-close your eyes...\u0000\u0007"
 19: 0x005F [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=43*, entity1=EventEntity, entity2=EventEntity, action="cabk")
 ...
 23: 0x0081 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=43*, entity1=EventEntity, entity2=EventEntity, action="spef")
 24: 0x0090 [0x1C] WAIT(300* ticks)
 25: 0x0093 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=42*, entity1=EventEntity, entity2=EventEntity, action="bik0")
 26: 0x00A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7983*)
    → "Oops...\u0000\u0007"
 27: 0x00A5 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="bik0")
 28: 0x00B2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
...
SUBROUTINE_00CB:
 ...
 33: 0x00D3 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="gkr0")
 34: 0x00E2 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="gkr0")
 ...
 37: 0x00F3 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="gkr1")
 38: 0x0102 [0x01] GOTO 0x0105

SUBROUTINE_0105:
 39: 0x0105 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=34*, entity1=EventEntity, entity2=EventEntity, action="tlb1")
