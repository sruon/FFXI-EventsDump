...
|       0 | 0x0000      |           0 |
|       1 | 0x0001      |           1 |
|       2 | 0xFFFE40E8  |  4294852840 |
|       3 | 0x10728     |       67368 |
|       4 | 0x07CF      |        1999 |
|       5 | 0x0FFB      |        4091 |
|       6 | 0x000B      |          11 |
|       7 | 0xFFFE4FFD  |  4294856701 |
|       8 | 0x10662     |       67170 |
...
```
  0: 0x002D [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-114.456*, z=67.368*, y=1.999*, direction=359.5°*
...
```
  ...
  1: 0x003A [0x1F] MOVE_ENTITY: EventEntity moves to X=-110.595*, Z=67.170*, Y=1.999*
