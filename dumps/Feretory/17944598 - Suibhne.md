...
- **7385**: What do you wish to do? [Aim for higher heights./Engage in friendly banter./Nothing.]
- **7386**: Prithee shed thy corporeal shackles and drift closer to the true essence of a monipulator?
- **7387**: Shed your shackles? [Yes, get them off me!/No, they feel fine!]
- **7388**: On to question number $0, then!
- **7389**: Which one of us roams $8?
- **7390**: Who is there? [What was the question again?/Aengus./Maccus./Suibhne./Teyrnon.]
- **7391**: Verily!
- **7392**: Avaunt! Thy wrong answer doth put me in ill humor. Returnest on the morrow when my disappointment in thee hath abated.
- **7393**: Thou hast obtained a perfect score! In recognition of thine achievement, allow me to impart this symbol of spiritual enlightenment upon thee.
- **7395**: Ah, the $1 $0 for which I asked. Very well, then...
- **7397**: Ho? Thou covetest our species for thy arsenal? Pshhh. Mayhap some day.
...
```
 ...
 26: 0x0085 [0x24] CREATE_DIALOG(message_id=7385*, default_option=0*, option_flags=ExtData[1]->WorkLocal[7])
 ...
 29: 0x0095 [0x1D] PRINT_EVENT_MESSAGE(message_id=7386*)
 ...
 31: 0x0099 [0x24] CREATE_DIALOG(message_id=7387*, default_option=1*, option_flags=0*)
 ...
 38: 0x00BA [0x1D] PRINT_EVENT_MESSAGE(message_id=7388*)
...
SUBROUTINE_00EE:
 49: 0x00EE [0x1D] PRINT_EVENT_MESSAGE(message_id=7389*)
    → "Which one of us roams $8?"
 50: 0x00F1 [0x23] WAIT_FOR_DIALOG_INTERACTION
 51: 0x00F2 [0x24] CREATE_DIALOG(message_id=7390*, default_option=0*, option_flags=0*)
...
124: 0x02AB [0x1D] PRINT_EVENT_MESSAGE(message_id=7391*)
    → "Verily!"
...
137: 0x02E5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7392*)
...
148: 0x0327 [0x1D] PRINT_EVENT_MESSAGE(message_id=7393*)
...
159: 0x0350 [0x1D] PRINT_EVENT_MESSAGE(message_id=7397*)
...
```
  ...
  8: 0x0395 [0x1D] PRINT_EVENT_MESSAGE(message_id=7395*)
