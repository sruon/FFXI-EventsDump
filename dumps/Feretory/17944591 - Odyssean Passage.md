...
- **7324**: Images of various locales flutter through your mind upon peering into the haze.
- **7325**: What will you do? [Stalk prey as a monipulator./Participate in Domination./Leave Monstrosity's clutches./Quit.]
- **7326**: Proceed to $8?
- **7327**: Endeavor to $8 fitted with the shackles of being level $1?
- **7328**: The celestial defenders of justice shall strip you of any instincts that exceed the cost limit should you continue.
- **7329**: Proceed? [Yes./No.]
- **7330**: Stop participating in Monstrosity?
- **7331**: Stop participating? [Yes./No.]
- **7332**: $8LG1I7iH Where in $8? [Point One./Point Two./Point Three./Point Four./Point Five./Nowhere.]
...
```
 ...
 13: 0x003F [0x24] CREATE_DIALOG(message_id=7325*, default_option=0*, option_flags=ExtData[1]->WorkLocal[8])
 ...
 39: 0x00C0 [0x48] [System] [7326*]:
    → "Proceed to $8?"
 40: 0x00C3 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_00C4:
 41: 0x00C4 [0x24] CREATE_DIALOG(message_id=7329*, default_option=0*, option_flags=0*)
    → "Proceed? [Yes./No.]"
 ...
 47: 0x00E6 [0x24] CREATE_DIALOG(message_id=7332*, default_option=0*, option_flags=0*)
...
SUBROUTINE_01A9:
 ...
 83: 0x01C2 [0x48] [System] [7330*]:
    → "Stop participating in Monstrosity?"
 84: 0x01C5 [0x23] WAIT_FOR_DIALOG_INTERACTION
 85: 0x01C6 [0x24] CREATE_DIALOG(message_id=7331*, default_option=0*, option_flags=0*)
