...
```
  ...
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=7336*, default_option=1*, option_flags=0*)
...
```
  ...
  2: 0x00BA [0x24] CREATE_DIALOG(message_id=7337*, default_option=1*, option_flags=0*)
