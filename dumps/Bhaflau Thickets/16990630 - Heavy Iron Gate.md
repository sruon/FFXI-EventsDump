...
00F0: FF FF 7F 7A 35 32 63 02  80 29 01 F0 FF FF 7F 09  ...z52c..)......
...
```
  ...
  2: 0x00BA [0x24] CREATE_DIALOG(message_id=7339*, default_option=1*, option_flags=0*)
 ...
 12: 0x00E8 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "z52c" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
