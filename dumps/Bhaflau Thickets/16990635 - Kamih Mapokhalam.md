...
- **7348**: This tunnel leads to the Alzadaal Undersea Ruins.
- **7349**: Now that the investigation of the Aht Urhgan Archaelogical Research Institute has drawn to a close, the ruins have been opened to the public.
- **7350**: However we cannot guarantee your safety--you would be wise to stay aware of your surroundings.
- **7351**: The fee for entering the ruins comes to $1 $0 .
- **7352**: Very well. You may proceed.
- **7353**: Heading outside? Please be aware that you will be required to pay a fee if you wish to reenter the ruins.
- **7354**: Leave the ruins? [Yes, I'm done here./Not just yet.]
- **7356**: If you need a map of the ruins, you can purchase one for $1 $0 .
- **7357**: Here is your $3. Keep it in a safe place.
- **7358**: You already possess a map of the ruins. I only have a limited number of copies, so please use the one you have.
...
```
  ...
  4: 0x000A [0x1D] PRINT_EVENT_MESSAGE(message_id=7348*)
    → "This tunnel leads to the Alzadaal Undersea Ruins."
  5: 0x000D [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x000E [0x1D] PRINT_EVENT_MESSAGE(message_id=7349*)
  ...
  8: 0x0012 [0x1D] PRINT_EVENT_MESSAGE(message_id=7350*)
 ...
 12: 0x0020 [0x1D] PRINT_EVENT_MESSAGE(message_id=7351*)
 ...
 16: 0x002E [0x1D] PRINT_EVENT_MESSAGE(message_id=7356*)
...
0080: 80 1C 0C 80 1D 0F 80 1C  0C 80 29 01 AB 41 03 01  ..........)..A..
0090: 04 29 01 AB 41 03 01 05  29 01 A9 41 03 01 01 1C  .)..A...)..A....
00A0: 0C 80 27 01 F0 FF FF 7F  0E 1C 10 80 45 0A 80 F0  ..'.........E...
00B0: FF FF 7F F0 FF FF 7F 66  64 6F 31 0B 80 1C 0C 80  .......fdo1.....
00C0: 03 01 10 04 80 29 01 A9  41 03 01 02 46 00 20 00  .....)..A...F. .
00D0: 21 00                                             !.              
```
...
```
 ...
 14: 0x0084 [0x1D] PRINT_EVENT_MESSAGE(message_id=7352*)
 ...
 17: 0x0091 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Kamih Mapokhalam (ID: 16990635/0x010341AB), tag_num=0x05)
 18: 0x0098 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Door_1g3 (ID: 16990633/0x010341A9), tag_num=0x01)
 ...
 25: 0x00C5 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Door_1g3 (ID: 16990633/0x010341A9), tag_num=0x02)
...
0140: 80 29 01 AB 41 03 01 04  29 01 AB 41 03 01 05 29  .)..A...)..A...)
0150: 01 A9 41 03 01 01 1C 0C  80 27 01 F0 FF FF 7F 10  ..A......'......
0160: 1C 13 80 29 01 AB 41 03  01 06 29 01 AB 41 03 01  ...)..A...)..A..
0170: 07 45 0A 80 F0 FF FF 7F  F0 FF FF 7F 66 64 6F 31  .E..........fdo1
0180: 0B 80 1C 0C 80 03 01 10  04 80 29 01 A9 41 03 01  ..........)..A..
...
```
  ...
  5: 0x00DC [0x1D] PRINT_EVENT_MESSAGE(message_id=7353*)
  ...
  7: 0x00E0 [0x24] CREATE_DIALOG(message_id=7354*, default_option=1*, option_flags=0*)
 ...
 22: 0x0141 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Kamih Mapokhalam (ID: 16990635/0x010341AB), tag_num=0x04)
 23: 0x0148 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Kamih Mapokhalam (ID: 16990635/0x010341AB), tag_num=0x05)
 24: 0x014F [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Door_1g3 (ID: 16990633/0x010341A9), tag_num=0x01)
 ...
 28: 0x0163 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Kamih Mapokhalam (ID: 16990635/0x010341AB), tag_num=0x06)
 29: 0x016A [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Kamih Mapokhalam (ID: 16990635/0x010341AB), tag_num=0x07)
 ...
 33: 0x018A [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Door_1g3 (ID: 16990633/0x010341A9), tag_num=0x02)
...
01F0: 70 6E AB 41 03 01 0B 80  99 AB 41 03 01 03 02 10  pn.A......A.....
...
```
 ...
 10: 0x0202 [0x1D] PRINT_EVENT_MESSAGE(message_id=7357*)
...
0210: 7F 6F 70 6E AB 41 03 01  20 80 99 AB 41 03 01 1D  .opn.A.. ...A...
0220: 21 80 23 21 00                                    !.#!.           
```
...
```
  ...
  6: 0x021F [0x1D] PRINT_EVENT_MESSAGE(message_id=7358*)
