...
- **7352**: This tunnel leads to the Alzadaal Undersea Ruins.
- **7353**: Now that the investigation of the Aht Urhgan Archaelogical Research Institute has drawn to a close, the ruins have been opened to the public.
- **7354**: However we cannot guarantee your safety--you would be wise to stay aware of your surroundings.
- **7355**: The fee for entering the ruins comes to $1 $0 .
- **7356**: Very well. You may proceed.
- **7357**: Heading outside? Please be aware that you will be required to pay a fee if you wish to reenter the ruins.
- **7358**: Leave the ruins? [Yes, I'm done here./Not just yet.]
- **7360**: If you need a map of the ruins, you can purchase one for $1 $0 .
- **7361**: Here is your $3. Keep it in a safe place.
- **7362**: You already possess a map of the ruins. I only have a limited number of copies, so please use the one you have.
...
```
  ...
  4: 0x000A [0x1D] PRINT_EVENT_MESSAGE(message_id=7352*)
    → "This tunnel leads to the Alzadaal Undersea Ruins."
  5: 0x000D [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x000E [0x1D] PRINT_EVENT_MESSAGE(message_id=7353*)
  ...
  8: 0x0012 [0x1D] PRINT_EVENT_MESSAGE(message_id=7354*)
 ...
 12: 0x0020 [0x1D] PRINT_EVENT_MESSAGE(message_id=7355*)
 ...
 16: 0x002E [0x1D] PRINT_EVENT_MESSAGE(message_id=7360*)
...
```
 ...
 14: 0x0084 [0x1D] PRINT_EVENT_MESSAGE(message_id=7356*)
...
```
  ...
  5: 0x00DC [0x1D] PRINT_EVENT_MESSAGE(message_id=7357*)
  ...
  7: 0x00E0 [0x24] CREATE_DIALOG(message_id=7358*, default_option=1*, option_flags=0*)
...
```
 ...
 10: 0x0202 [0x1D] PRINT_EVENT_MESSAGE(message_id=7361*)
...
```
  ...
  6: 0x021F [0x1D] PRINT_EVENT_MESSAGE(message_id=7362*)
