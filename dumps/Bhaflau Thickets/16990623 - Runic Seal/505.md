...
SUBROUTINE_01DD:
 ...
 79: 0x01E5 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2pb2")
 80: 0x01F2 [0x1C] WAIT(540* ticks)
 81: 0x01F5 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x03)
 82: 0x01FC [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="who1", work_offset2=0*)
 83: 0x020D [0x1C] WAIT(60* ticks)
 84: 0x0210 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2pbk")
 85: 0x021D [0x1C] WAIT(30* ticks)
 86: 0x0220 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2pb1")
 87: 0x022D [0x1C] WAIT(30* ticks)
 88: 0x0230 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="whi1", work_offset2=0*)
