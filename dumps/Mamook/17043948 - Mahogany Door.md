...
- **7494**: Use the $3? [Yes./No.]
- **7496**: You ring the red bell and hear the dull sound of something being unlocked...
...
0040: 80 F0 FF FF 7F F0 FF FF  7F 7A 36 35 61 03 80 29  .........z65a..)
0050: 01 F0 FF FF 7F 04 29 01  F0 FF FF 7F 02 45 06 80  ......)......E..
0060: F0 FF FF 7F F0 FF FF 7F  66 64 69 31 03 80 1C 07  ........fdi1....
0070: 80 4C 1C 07 80 27 01 F0  FF FF 7F 03 1C 05 80 45  .L...'.........E
...
```
  ...
  2: 0x0005 [0x03] Work_Zone[2] = 799*
  3: 0x000A [0x24] CREATE_DIALOG(message_id=7494*, default_option=1*, option_flags=0*)
    → "Use the $3? [Yes./No.]"
 ...
 10: 0x0021 [0x48] [System] [7496*]:
    → "You ring the red bell and hear the dull sound of something being unlocked..."
 ...
 15: 0x003E [0x45] LOAD_SCHEDULED_TASK: Load scheduler "z65a" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
 16: 0x004F [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x04)
 17: 0x0056 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x02)
 ...
 22: 0x0075 [0x27] REQ_SET(priority=0x01, entity_id=LocalPlayer, tag_num=0x03)
