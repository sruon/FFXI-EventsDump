...
- **8145**: Exit? (You cannot reenter here.) [Yes./Not now.]
...
```
  ...
  2: 0x0004 [0x24] CREATE_DIALOG(message_id=8145*, default_option=1*, option_flags=0*)
