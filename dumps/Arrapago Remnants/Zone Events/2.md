...
```
  ...
  2: 0x0533 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[2], result=ExtData[1]->WorkLocal[2])
  3: 0x053C [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[2], result=ExtData[1]->WorkLocal[3])
  4: 0x0545 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[3], result=ExtData[1]->WorkLocal[4])
  5: 0x054E [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[3], result=ExtData[1]->WorkLocal[5])
  6: 0x0557 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[4], result=ExtData[1]->WorkLocal[6])
  7: 0x0560 [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[4], result=ExtData[1]->WorkLocal[7])
  8: 0x0569 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[5], result=ExtData[1]->WorkLocal[8])
  9: 0x0572 [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[5], result=ExtData[1]->WorkLocal[9])
 10: 0x057B [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[6], result=ExtData[1]->WorkLocal[10])
 11: 0x0584 [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[6], result=ExtData[1]->WorkLocal[11])
 12: 0x058D [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[7], result=ExtData[1]->WorkLocal[12])
 13: 0x0596 [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[7], result=ExtData[1]->WorkLocal[13])
 14: 0x059F [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[8], result=ExtData[1]->WorkLocal[14])
 15: 0x05A8 [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[8], result=ExtData[1]->WorkLocal[15])
 16: 0x05B1 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[9], result=ExtData[1]->WorkLocal[16])
 17: 0x05BA [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[9], result=ExtData[1]->WorkLocal[17])
 ...
 35: 0x0618 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x00, bit_index_work_offset=0x8001, condition_work_offset=0x800B)
 36: 0x061F [0x02] IF !(ExtData[1]->WorkLocal[3] <= 0*) GOTO 0x062E
 37: 0x0627 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x00, bit_index_work_offset=0x800B, condition_work_offset=0x800B)
 38: 0x062E [0x02] IF !(ExtData[1]->WorkLocal[5] <= 0*) GOTO 0x063D
 39: 0x0636 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x00, bit_index_work_offset=0x8024, condition_work_offset=0x800B)
 40: 0x063D [0x02] IF !(ExtData[1]->WorkLocal[7] <= 0*) GOTO 0x064C
 41: 0x0645 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x00, bit_index_work_offset=0x8025, condition_work_offset=0x800B)
 42: 0x064C [0x02] IF !(ExtData[1]->WorkLocal[9] <= 0*) GOTO 0x065B
 43: 0x0654 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x00, bit_index_work_offset=0x8026, condition_work_offset=0x800B)
 44: 0x065B [0x02] IF !(ExtData[1]->WorkLocal[11] <= 0*) GOTO 0x066A
 45: 0x0663 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x00, bit_index_work_offset=0x8027, condition_work_offset=0x800B)
 46: 0x066A [0x02] IF !(ExtData[1]->WorkLocal[13] <= 0*) GOTO 0x0679
 47: 0x0672 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x00, bit_index_work_offset=0x8028, condition_work_offset=0x800B)
 48: 0x0679 [0x02] IF !(ExtData[1]->WorkLocal[15] <= 0*) GOTO 0x0688
 49: 0x0681 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x00, bit_index_work_offset=0x8029, condition_work_offset=0x800B)
 50: 0x0688 [0x02] IF !(ExtData[1]->WorkLocal[17] <= 0*) GOTO 0x0697
 51: 0x0690 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x00, bit_index_work_offset=0x802A, condition_work_offset=0x800B)
 52: 0x0697 [0x03] ExtData[1]->WorkLocal[1] = 4294967295*
 53: 0x069C [0x0F] ExtData[1]->WorkLocal[1] ^= ExtData[1]->WorkLocal[0]
 54: 0x06A1 [0x24] CREATE_DIALOG(message_id=7247*, default_option=0*, option_flags=0x01)
