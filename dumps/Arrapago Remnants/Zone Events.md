...
- **7478**: Use the device? [Yes./No.]
- **7480**: Open the door? [Yes./No.]
...
```
  ...
  1: 0x0175 [0x24] CREATE_DIALOG(message_id=7478*, default_option=1*, option_flags=0*)
...
```
  ...
  1: 0x01BD [0x24] CREATE_DIALOG(message_id=7478*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0205 [0x24] CREATE_DIALOG(message_id=7478*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x024D [0x24] CREATE_DIALOG(message_id=7478*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0295 [0x24] CREATE_DIALOG(message_id=7478*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x02DD [0x24] CREATE_DIALOG(message_id=7478*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0325 [0x24] CREATE_DIALOG(message_id=7478*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x036D [0x24] CREATE_DIALOG(message_id=7478*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x03B5 [0x24] CREATE_DIALOG(message_id=7478*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x03FD [0x24] CREATE_DIALOG(message_id=7478*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0445 [0x24] CREATE_DIALOG(message_id=7478*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0494 [0x24] CREATE_DIALOG(message_id=7478*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x04C2 [0x24] CREATE_DIALOG(message_id=7478*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0511 [0x24] CREATE_DIALOG(message_id=7480*, default_option=1*, option_flags=0*)
...
```
 ...
 54: 0x06A1 [0x24] CREATE_DIALOG(message_id=7250*, default_option=0*, option_flags=ExtData[1]->WorkLocal[1])
