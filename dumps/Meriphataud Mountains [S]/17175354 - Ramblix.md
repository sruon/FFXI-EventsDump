...
- **7862**: Oh my Gob! You're one of those adventurerurers, aren't ya? You got nothin' on me, [man./lady.] I was just mindin' my own businesesess, lookin' for junk an' stuff.
- **7863**: Hey, watch out. You don't wanna fight me. I'll turn you into meat jerky! Wait, how about you and me be friends instead? Sound good?
- **7864**: I travel all over the world and hear lots of differererent stories. I even hear your stories. I can tell you one, if you want.
- **7865**: Now, listen close...
- **7866**: Oh... Well, if that's the case, I'm outta here.
- **7872**: What story would you like to be told? [Not a one, thanks./What have you got?]
- **7873**: What story would you like to be told? [None, really./Babban Ny Mheillea./Manifest Destiny./At Journey's End(pt.1)./At Journey's End(pt.2)./At Journey's End(pt.3)./At Journey's End(pt.4).]
- **7874**: 
- **7875**: 
- **7876**: 
...
0010: 3A 13 06 01 03 00 00 00  80 02 02 10 01 80 01 28  :..............(
...
```
  ...
  4: 0x000B [0x4A] LocalPlayer looks at Ramblix (ID: 17175354/0x0106133A)
 ...
 15: 0x005A [0x1D] PRINT_EVENT_MESSAGE(message_id=7862*)
 ...
 17: 0x005E [0x1D] PRINT_EVENT_MESSAGE(message_id=7863*)
 ...
 19: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=7864*)
 ...
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=7872*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
    → "What story would you like to be told? [Not a one, thanks./What have you got?]"
 30: 0x0099 [0x25] WAIT_DIALOG_SELECT()
 31: 0x009A [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x00DE

SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7873*, default_option=0*, option_flags=Work_Zone[2])
    → "What story would you like to be told? [None, really./Babban Ny Mheillea./Manifest Destiny./At Journey's End(pt.1)./At Journey's End(pt.2)./At Journey's End(pt.3)./At Journey's End(pt.4).]"
 ...
 37: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7866*)
...
SUBROUTINE_00E6:
 43: 0x00E6 [0x24] CREATE_DIALOG(message_id=7874*, default_option=0*, option_flags=Work_Zone[3])
    → ""
 ...
 48: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7866*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_012A:
 54: 0x012A [0x24] CREATE_DIALOG(message_id=7875*, default_option=0*, option_flags=Work_Zone[4])
    → ""
 ...
 59: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=7866*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_016E:
 65: 0x016E [0x24] CREATE_DIALOG(message_id=7876*, default_option=0*, option_flags=Work_Zone[5])
    → ""
 ...
 70: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=7866*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01A7:
 ...
 77: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7866*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01C6:
 81: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7865*)
    → "Now, listen close..."
