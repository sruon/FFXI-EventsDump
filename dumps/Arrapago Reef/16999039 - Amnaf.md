...
```
  0: 0x0045 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-457.118*, z=-410.066*, y=-2.999*, direction=263.7°*
...
```
  ...
  1: 0x0052 [0x1F] MOVE_ENTITY: EventEntity moves to X=-457.091*, Z=-405.532*, Y=-3.000*
