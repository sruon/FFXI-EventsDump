...
SUBROUTINE_0092:
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=8042*, default_option=0*, option_flags=0x00)
 ...
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=8043*, default_option=0*, option_flags=0x1002)
...
SUBROUTINE_00DE:
 ...
 45: 0x00E6 [0x24] CREATE_DIALOG(message_id=8044*, default_option=0*, option_flags=0x1003)
 ...
 50: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=8036*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_0122:
 ...
 58: 0x012A [0x24] CREATE_DIALOG(message_id=8045*, default_option=0*, option_flags=0x1004)
 ...
 63: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=8036*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_0166:
 ...
 71: 0x016E [0x24] CREATE_DIALOG(message_id=8046*, default_option=0*, option_flags=0x1005)
    → "What story would you like to be told?\u0007\u000BOn second thought, maybe later.\u007F1\u0000\u0007"
 ...
 76: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=8036*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_01AA:
 ...
 85: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8036*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_01C6:
 89: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=8035*)
    → "Now, listen close...\u007F1\u0000\u0007"
