...
```
 ...
 13: 0x003D [0x45] LOAD_SCHEDULED_TASK: Load scheduler "z54c" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
 ...
 21: 0x00A5 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "z54d" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
