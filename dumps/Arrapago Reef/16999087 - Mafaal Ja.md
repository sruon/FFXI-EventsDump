...
| [65535.14](#event-6553514) | 0x00CE       |     15 |              5 |
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
00C0:                                            32 03                2.
00D0: 80 1F 00 04 80 05 80 06  80 1F 01 6F 00           ...........o.   
```
...
```
  ...
  1: 0x00D1 [0x1F] MOVE_ENTITY: EventEntity moves to X=-588.892*, Z=292.726*, Y=-4.704*
