...
SUBROUTINE_0071:
 22: 0x0071 [0x24] CREATE_DIALOG(message_id=0x00000002, default_option=1*, option_flags=0x1003)
...
SUBROUTINE_0190:
 ...
 85: 0x0198 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2pb2")
 86: 0x01A5 [0x1C] WAIT(540* ticks)
 87: 0x01A8 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x03)
 88: 0x01AF [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="who1", work_offset2=0*)
 89: 0x01C0 [0x1C] WAIT(60* ticks)
 90: 0x01C3 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2pbk")
 91: 0x01D0 [0x1C] WAIT(30* ticks)
 92: 0x01D3 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2pb1")
 93: 0x01E0 [0x1C] WAIT(30* ticks)
 94: 0x01E3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="whi1", work_offset2=0*)
 95: 0x01F4 [0x01] GOTO 0x0279

SUBROUTINE_01F7:
 96: 0x01F7 [0x02] IF !(6* == 6*) GOTO 0x0279
 97: 0x01FF [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 98: 0x0210 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 99: 0x021F [0x38] SET_CLIENT_EVENT_MODE(mode=18*)
100: 0x0222 [0x4E] SET_ENTITY_HIDE_FLAG: Hide LocalPlayer
101: 0x0228 [0x45] LOAD_SCHEDULED_TASK(work_offset1=35*, entity1=EventEntity, entity2=EventEntity, scheduler_id="sash", work_offset2=0*)
...
104: 0x0247 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
105: 0x0258 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
106: 0x0267 [0x55] WAIT_LOAD_SCHEDULER(work_offset=35*, entity1=EventEntity, entity2=EventEntity, scheduler_id="sash")
