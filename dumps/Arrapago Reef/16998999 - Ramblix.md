...
- **8036**: Oh my Gob! You're one of those adventurerurers, aren't ya? You got nothin' on me, [man./lady.] I was just mindin' my own businesesess, lookin' for junk an' stuff.
- **8037**: Hey, watch out. You don't wanna fight me. I'll turn you into meat jerky! Wait, how about you and me be friends instead? Sound good?
- **8038**: I travel all over the world and hear lots of differererent stories. I even hear your stories. I can tell you one, if you want.
- **8039**: Now, listen close...
- **8040**: Oh... Well, if that's the case, I'm outta here.
- **8046**: Do you want to hear a story? [No, thank you./Let's hear one./Let's hear one(2).]
- **8047**: What story would you like to be told? [On second thought, maybe later./Get the Picture./Immortal Sentries./Luck of the Draw./The Die Is Cast(pt.1)./The Die Is Cast(pt.2)./No Strings Attached./Equipped for All Occasions(pt.1)./Equipped for All Occasions(pt.2)./Beginnings./The Black Coffin(pt.1)./The Black Coffin(pt.2)./The Black Coffin(pt.3)./Ghosts of the Past./Navigating the Unfriendly Seas(pt.1)./Navigating the Unfriendly Seas(pt.2)./Against All Odds(pt.1)./Against All Odds(pt.2)./Against All Odds(pt.3)./Breaking the Bonds of Fate(pt.1)./Breaking the Bonds of Fate(pt.2)./Prevalence of Pirates./Shades of Vengeance./Legacy of the Lost(pt.1)./Legacy of the Lost(pt.2).]
- **8048**: What story would you like to be told? [On second thought, maybe later./The Seagull Phratrie(pt.1)./The Seagull Phratrie(pt.2)./The Seagull Phratrie(pt.3)./The Seagull Phratrie(pt.4)./The Sea Sage(pt.1)./The Sea Sage(pt.2)./The Sea Sage(pt.3)./The Sea Sage(pt.4).]
- **8049**: What story would you like to be told? [On second thought, maybe later.]
- **8050**: What story would you like to be told? [On second thought, maybe later.]
...
```
 ...
 15: 0x005A [0x1D] PRINT_EVENT_MESSAGE(message_id=8036*)
 ...
 17: 0x005E [0x1D] PRINT_EVENT_MESSAGE(message_id=8037*)
 ...
 19: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=8038*)
 ...
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=8046*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=8047*, default_option=0*, option_flags=Work_Zone[2])
 ...
 37: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=8040*)
...
SUBROUTINE_00E6:
 43: 0x00E6 [0x24] CREATE_DIALOG(message_id=8048*, default_option=0*, option_flags=Work_Zone[3])
 ...
 48: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=8040*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_012A:
 54: 0x012A [0x24] CREATE_DIALOG(message_id=8049*, default_option=0*, option_flags=Work_Zone[4])
 ...
 59: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=8040*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_016E:
 65: 0x016E [0x24] CREATE_DIALOG(message_id=8050*, default_option=0*, option_flags=Work_Zone[5])
    → "What story would you like to be told? [On second thought, maybe later.]"
 ...
 70: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=8040*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01A7:
 ...
 77: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8040*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01C6:
 81: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=8039*)
    → "Now, listen close..."
