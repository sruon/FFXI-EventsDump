...
| [65535.34](#event-6553534) | 0x01FC       |      1 |              1 |
| [65535.35](#event-6553535) | 0x01FD       |      5 |              3 |
| [65535.36](#event-6553536) | 0x0202       |      5 |              3 |
| [65535.37](#event-6553537) | 0x0207       |      5 |              3 |
| [65535.38](#event-6553538) | 0x020C       |     16 |              3 |
| [65535.39](#event-6553539) | 0x021C       |     10 |              2 |
| [65535.40](#event-6553540) | 0x0226       |     14 |              4 |
| [65535.41](#event-6553541) | 0x0234       |     14 |              4 |
| [65535.42](#event-6553542) | 0x0242       |     29 |              3 |
...
- **7720**: I vas only pretending-vending to be under your control, Uran-Mafran. The only vay a non-vizard like myself could triumph against you vas to get in under your guard.
- **7726**: I have no more desire to vield magical power.
- **7744**: ...Uran-Mafran... I von't give up either. I vill stop you...
...
```
  0: 0x01FD [0x1D] PRINT_EVENT_MESSAGE(message_id=7720*)
...
```
  0: 0x0202 [0x1D] PRINT_EVENT_MESSAGE(message_id=7726*)
...
```
  0: 0x0207 [0x1D] PRINT_EVENT_MESSAGE(message_id=7744*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0220:                   32 00  80 1F 00 10 80 11 80 12        2.........
0230: 80 1F 01 00                                       ....            
```
...
```
  ...
  1: 0x0229 [0x1F] MOVE_ENTITY: EventEntity moves to X=22.866*, Z=31.438*, Y=-18.198*
