...
- **7724**: I vas only pretending-vending to be under your control, Uran-Mafran. The only vay a non-vizard like myself could triumph against you vas to get in under your guard.
- **7730**: I have no more desire to vield magical power.
- **7748**: ...Uran-Mafran... I von't give up either. I vill stop you...
...
```
  0: 0x01FD [0x1D] PRINT_EVENT_MESSAGE(message_id=7724*)
...
```
  0: 0x0202 [0x1D] PRINT_EVENT_MESSAGE(message_id=7730*)
...
```
  0: 0x0207 [0x1D] PRINT_EVENT_MESSAGE(message_id=7748*)
