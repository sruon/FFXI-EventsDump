...
- **7688**: 6... A single fragment of light. The way in which it shines suggests that it is resonating with something...
- **7689**: Do you remove the $3? [Yes./No.]
- **7703**: You place $0 on the monument as an offering.
- **7704**: ...tha...nk...you...
- **7705**: Something is lying on the ground.
...
```
  ...
  3: 0x000E [0x24] CREATE_DIALOG(message_id=7689*, default_option=0*, option_flags=0*)
...
```
  ...
  1: 0x0031 [0x48] [System] [7688*]:
    → "6... A single fragment of light. The way in which it shines suggests that it is resonating with something..."
  2: 0x0034 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0035 [0x24] CREATE_DIALOG(message_id=7689*, default_option=0*, option_flags=0*)
    → "Do you remove the $3? [Yes./No.]"
