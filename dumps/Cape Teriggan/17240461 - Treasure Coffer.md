...
- **8037**: Obtain this item? [Yes./No.]
- **8038**: Obtain this item?
...
```
  ...
  7: 0x0024 [0x48] [System] [8038*]:
    → "Obtain this item?"
  8: 0x0027 [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x0028 [0x93] DISPLAY_ITEM_INFO(item_id=0*)
 10: 0x002B [0x24] CREATE_DIALOG(message_id=8037*, default_option=1*, option_flags=0*)
