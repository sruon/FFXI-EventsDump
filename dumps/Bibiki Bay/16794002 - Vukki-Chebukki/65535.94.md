...
```
  0: 0x0662 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "okir" with entities [EventEntity, EventEntity], work=430*
  1: 0x0671 [0x1C] WAIT(20* ticks)
  2: 0x0674 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "se13" with entities [LocalPlayer, LocalPlayer], work=[86*, 0*]
  3: 0x0685 [0x1C] WAIT(10* ticks)
  4: 0x0688 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "se14" with entities [LocalPlayer, LocalPlayer], work=[86*, 0*]
  5: 0x0699 [0x1C] WAIT(30* ticks)
  6: 0x069C [0x45] LOAD_SCHEDULED_TASK: Load scheduler "se15" with entities [LocalPlayer, LocalPlayer], work=[86*, 0*]
  7: 0x06AD [0x1C] WAIT(20* ticks)
  8: 0x06B0 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "se16" with entities [LocalPlayer, LocalPlayer], work=[86*, 0*]
