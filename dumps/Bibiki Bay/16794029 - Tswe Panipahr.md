...
- **7477**: Welcome to Sunset Docks!
- **7478**: Enjoy a sightseeing tour of Bibiki Bay, an initiative of the Fishermen's Guild!
- **7479**: How may I help you?
- **7480**: What do you want to do? [Nothing in particular./Buy a ticket./Ask about the tours.]
- **7483**: Thank you, [sir/ma'am]! Have a wonderrrful trip!
- **7484**: I'm sorry, [sir/ma'am]. You don't have enough gil to purrrchase a ticket.
- **7486**: Which tour do you wish to have explained?
- **7487**: Choose a tour: [Dhalmel Rock tour./Maliyakaleya Reef tour./Purgonorgo Isle tour.]
- **7488**: The Dhalmel Rrrock tour takes a gentle, southerly course along the western coastline.
- **7489**: You can see the majestic pillars of rrrock towering above the surf, and watch the waves crrrash against Washboard Wake while enjoying the refrrreshing sea breeze.
- **7490**: The manaclipper turns to pass through the legs of Dhalmel Rrrock before making its way back to Sunset Docks. This is the most rrrelaxing of the tours.
- **7491**: This tour takes you on an easterly course past the menacing Seawolf Swirrrl as it rounds the cape of Mhaura.
- **7492**: The stunning Maliyakaleya Reef is the highlight of the trip, home to a menagerrrie of colorful sea life to tempt your fishing line.
- **7493**: After passing through the rrreef, the manaclipper makes its way back to Sunset Docks to complete this brrreathtakingly beautiful tour.
- **7494**: The manaclipper leaves here from Sunset Docks on a southeasterly course.
- **7495**: This tour provides a safe and pleasant rrride to the tropical paradise of Purgonorgo Isle.
- **7496**: Manaclippers arrive rrregularly to ferry passengers back to Sunset Docks, so there's no need to worry about time. Sit back, rrrelax, and enjoy a long, lazy stay on this beautiful island.
- **7497**: Is there anything else I can help you with?
- **7504**: Tickets for the manaclipper are $2 gil. Multi-tickets, which allow you to rrride ten times, can be purrrchased for a mere $5 gil.
- **7505**: Which would you like? [6 ($2 gil)./$6 ($5 gil)./Nothing today.]
- **7506**: You cannot buy morrre than one $3. Use the one you have now to ride the next ship.
- **7507**: Your $3 is valid for $4 more [trip/trips].
- **7508**: You do not need to purrrchase a new ticket at this time.
- **7509**: If you want, you can purrrchase a new one for $5 gil.
- **7510**: Purrrchase a new multi-ticket? [Yes ($5 gil)./No.]
...
```
  ...
  5: 0x000E [0x1D] PRINT_EVENT_MESSAGE(message_id=7479*)
    → "How may I help you?"
  6: 0x0011 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0012 [0x24] CREATE_DIALOG(message_id=7480*, default_option=0*, option_flags=0*)
 ...
 10: 0x0022 [0x1D] PRINT_EVENT_MESSAGE(message_id=7504*)
 ...
 12: 0x0026 [0x24] CREATE_DIALOG(message_id=7505*, default_option=2*, option_flags=0*)
 ...
 19: 0x0042 [0x1D] PRINT_EVENT_MESSAGE(message_id=7506*)
 ...
 24: 0x0054 [0x1D] PRINT_EVENT_MESSAGE(message_id=7484*)
 ...
 28: 0x005E [0x1D] PRINT_EVENT_MESSAGE(message_id=7483*)
...
SUBROUTINE_0067:
 ...
 39: 0x0088 [0x1D] PRINT_EVENT_MESSAGE(message_id=7507*)
 ...
 42: 0x0094 [0x1D] PRINT_EVENT_MESSAGE(message_id=7509*)
    → "If you want, you can purrrchase a new one for $5 gil."
 43: 0x0097 [0x23] WAIT_FOR_DIALOG_INTERACTION
 44: 0x0098 [0x24] CREATE_DIALOG(message_id=7510*, default_option=1*, option_flags=0*)
 ...
 48: 0x00B0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7484*)
    → "I'm sorry, [sir/ma'am]. You don't have enough gil to purrrchase a ticket."
 49: 0x00B3 [0x23] WAIT_FOR_DIALOG_INTERACTION
 50: 0x00B4 [0x06] Work_Zone[1] = 0
 51: 0x00B7 [0x01] GOTO 0x00C3
 52: 0x00BA [0x1D] PRINT_EVENT_MESSAGE(message_id=7483*)
    → "Thank you, [sir/ma'am]! Have a wonderrrful trip!"
...
SUBROUTINE_00D4:
 ...
 60: 0x00D7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7508*)
...
SUBROUTINE_00DE:
 ...
 65: 0x00E9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7484*)
    → "I'm sorry, [sir/ma'am]. You don't have enough gil to purrrchase a ticket."
 66: 0x00EC [0x23] WAIT_FOR_DIALOG_INTERACTION
 67: 0x00ED [0x06] Work_Zone[1] = 0
 68: 0x00F0 [0x01] GOTO 0x00FC
 69: 0x00F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7483*)
    → "Thank you, [sir/ma'am]! Have a wonderrrful trip!"
...
SUBROUTINE_010D:
 ...
 78: 0x0118 [0x1D] PRINT_EVENT_MESSAGE(message_id=7486*)
    → "Which tour do you wish to have explained?"
 79: 0x011B [0x23] WAIT_FOR_DIALOG_INTERACTION
 80: 0x011C [0x24] CREATE_DIALOG(message_id=7487*, default_option=0*, option_flags=0*)
 ...
 83: 0x012C [0x1D] PRINT_EVENT_MESSAGE(message_id=7488*)
 ...
 85: 0x0130 [0x1D] PRINT_EVENT_MESSAGE(message_id=7489*)
 ...
 87: 0x0134 [0x1D] PRINT_EVENT_MESSAGE(message_id=7490*)
 ...
 89: 0x0138 [0x1D] PRINT_EVENT_MESSAGE(message_id=7497*)
