...
- **7519**: Earn a fortune working on a lazy trrropical island.t
- **7520**: ...Or at least that's what the brrrochure said.
- **7521**: All I do is lug heavy boxes around all day, and get ignored by tourrrists.
- **7522**: Goldmane? I've never heard that name, but there's a blonde Elvaan who's always hanging arrround the boat on the west side of the island.
- **7523**: You know, a Hume girl and her moogle friend just asked me the same question. Must be some new tourrrist attrrraction...
...
```
  ...
  4: 0x00CD [0x1D] PRINT_EVENT_MESSAGE(message_id=7519*)
    → "Earn a fortune working on a lazy trrropical island.t"
  5: 0x00D0 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x00D1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7520*)
 ...
 10: 0x00E3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7521*)
...
```
  ...
  4: 0x0100 [0x1D] PRINT_EVENT_MESSAGE(message_id=7522*)
  ...
  6: 0x0104 [0x1D] PRINT_EVENT_MESSAGE(message_id=7523*)
