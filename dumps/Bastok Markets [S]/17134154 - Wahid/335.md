...
```
 ...
 10: 0x003A [0x45] LOAD_SCHEDULED_TASK(work_offset1=456*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="wh23", work_offset2=0*)
 11: 0x004B [0x27] REQ_SET(priority=0x0F, entity_id=LocalPlayer, tag_num=0x03)
 12: 0x0052 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 13: 0x0063 [0x1E] EventEntity looks at LocalPlayer and starts talking
 14: 0x0068 [0x55] WAIT_LOAD_SCHEDULER(work_offset=456*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="wh23")
 15: 0x0077 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 ...
 19: 0x0099 [0x45] LOAD_SCHEDULED_TASK(work_offset1=456*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="wh24", work_offset2=0*)
 ...
 22: 0x00AE [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="ten1")
 23: 0x00BD [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 29: 0x00DF [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 30: 0x00EE [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="thk2")
 31: 0x00FB [0x52] END_LOAD_SCHEDULER: End scheduler "wh24" with entities [LocalPlayer, LocalPlayer], work=456*
 32: 0x010A [0x45] LOAD_SCHEDULED_TASK(work_offset1=456*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="wh19", work_offset2=0*)
 ...
 43: 0x0153 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
 44: 0x0164 [0x45] LOAD_SCHEDULED_TASK(work_offset1=456*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="wh20", work_offset2=0*)
 45: 0x0175 [0x7B] Wahid (ID: 17134154/0x0105724A) stops talking
 46: 0x017A [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 49: 0x018D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="ten0")
 50: 0x019C [0x52] END_LOAD_SCHEDULER: End scheduler "wh20" with entities [LocalPlayer, LocalPlayer], work=456*
 51: 0x01AB [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
 52: 0x01BC [0x45] LOAD_SCHEDULED_TASK(work_offset1=456*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="wh21", work_offset2=0*)
 ...
 59: 0x01F1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=456*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="wh22", work_offset2=0*)
 60: 0x0202 [0x79] Wahid (ID: 17134154/0x0105724A) looks at LocalPlayer (Basic look)
 61: 0x020C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 ...
 64: 0x021F [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="ten1")
 65: 0x022E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 ...
 69: 0x0253 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
