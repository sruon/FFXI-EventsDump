...
- **10893**: What the hell are you looking at?
- **10894**: I don't have time to entertain the likes of you. Get out of my face.
- **10895**: I go where I want, when I want. No one can take that from me. Not you, not some president, not anyone.
- **10896**: Hold on... You haven't happened to hear anything about an Ensetsu, have you? His family's supposed to be living here in Bastok.
- **10897**: Ah, never mind. Forget you heard anything from me.
- **10898**: What the hell is this? Do I look like a goldsmith? Get that thing out of my face!
- **10899**: Hah! You think you can buy my loyalty with a single throwing star!?
- **10900**: Hmph... I might consider helping out [your kingdom/your republic/your federation], but I won't be making you any guarantees.
- **10901**: Hmph... I'll consider remaining with [your kingdom/your republic/your federation], but I won't make you any guarantees.
...
```
  ...
  8: 0x0025 [0x1D] PRINT_EVENT_MESSAGE(message_id=10893*)
 ...
 14: 0x0044 [0x1D] PRINT_EVENT_MESSAGE(message_id=10893*)
    → "What the hell are you looking at?"
 ...
 19: 0x0058 [0x1D] PRINT_EVENT_MESSAGE(message_id=10895*)
 ...
 24: 0x006C [0x1D] PRINT_EVENT_MESSAGE(message_id=10895*)
    → "I go where I want, when I want. No one can take that from me. Not you, not some president, not anyone."
 25: 0x006F [0x23] WAIT_FOR_DIALOG_INTERACTION
 26: 0x0070 [0x1D] PRINT_EVENT_MESSAGE(message_id=10896*)
 ...
 28: 0x0074 [0x1D] PRINT_EVENT_MESSAGE(message_id=10897*)
 ...
 33: 0x0088 [0x1D] PRINT_EVENT_MESSAGE(message_id=10895*)
    → "I go where I want, when I want. No one can take that from me. Not you, not some president, not anyone."
...
SUBROUTINE_008F:
 ...
 37: 0x0092 [0x1D] PRINT_EVENT_MESSAGE(message_id=10894*)
...
SUBROUTINE_0096:
 ...
 42: 0x00A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10893*)
    → "What the hell are you looking at?"
 ...
 46: 0x00B8 [0x1D] PRINT_EVENT_MESSAGE(message_id=10898*)
 ...
 55: 0x00E7 [0x1D] PRINT_EVENT_MESSAGE(message_id=10900*)
 ...
 58: 0x00EE [0x1D] PRINT_EVENT_MESSAGE(message_id=10899*)
...
SUBROUTINE_00F2:
 ...
 64: 0x010A [0x1D] PRINT_EVENT_MESSAGE(message_id=10901*)
 ...
 67: 0x0111 [0x1D] PRINT_EVENT_MESSAGE(message_id=10899*)
    → "Hah! You think you can buy my loyalty with a single throwing star!?"
 68: 0x0114 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_0115:
 69: 0x0115 [0x1D] PRINT_EVENT_MESSAGE(message_id=10896*)
    → "Hold on... You haven't happened to hear anything about an Ensetsu, have you? His family's supposed to be living here in Bastok."
 70: 0x0118 [0x23] WAIT_FOR_DIALOG_INTERACTION
 71: 0x0119 [0x1D] PRINT_EVENT_MESSAGE(message_id=10897*)
    → "Ah, never mind. Forget you heard anything from me."
 ...
 77: 0x0135 [0x1D] PRINT_EVENT_MESSAGE(message_id=10900*)
    → "Hmph... I might consider helping out [your kingdom/your republic/your federation], but I won't be making you any guarantees."
 78: 0x0138 [0x23] WAIT_FOR_DIALOG_INTERACTION
 79: 0x0139 [0x01] GOTO 0x0140
 80: 0x013C [0x1D] PRINT_EVENT_MESSAGE(message_id=10899*)
    → "Hah! You think you can buy my loyalty with a single throwing star!?"
...
SUBROUTINE_0146:
 ...
 85: 0x0149 [0x1D] PRINT_EVENT_MESSAGE(message_id=10893*)
    → "What the hell are you looking at?"
