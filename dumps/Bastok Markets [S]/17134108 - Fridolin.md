...
- **12024**: Looking to join the Fighting Fourth? Speak to Centurion Adelbrecht. He'll assist you.
- **12027**: Give 'em hell, <Player>!
- **12030**: I see you're working for another nation.
- **12033**: If you're looking to join the Fighting Fourth, speak to Centurion Adelbrecht. He'll assist you.
- **12036**: Though if you want to rejoin the fourth, I think something can be worked out. You have some Allied Notes, don't you?
- **12038**: Please note that upon changing allegiance, you will be required to return the two most prestigious campaign medals you possess. There is no penalty if you have yet to earn any medals.
- **12040**: Exchange $2 Allied [Note/Notes] to transfer from [/the Knights of the Iron Ram/the Fourth Division/the Cobra Unit] to [/the Knights of the Iron Ram/the Fourth Division/the Cobra Unit]? You currently possess $3 [Allied Note/Allied Notes].
- **12041**: Proceed with the transaction? [Yes./No.]
- **12042**: Are you absolutely sure? [Yes./No.]
...
```
  ...
  3: 0x000E [0x1D] PRINT_EVENT_MESSAGE(message_id=12027*)
    → "Give 'em hell, <Player>!"
...
```
  ...
  3: 0x001F [0x1D] PRINT_EVENT_MESSAGE(message_id=12024*)
...
```
  ...
  3: 0x0030 [0x1D] PRINT_EVENT_MESSAGE(message_id=12030*)
    → "I see you're working for another nation."
  4: 0x0033 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0034 [0x1D] PRINT_EVENT_MESSAGE(message_id=12033*)
...
```
  ...
  4: 0x0046 [0x1D] PRINT_EVENT_MESSAGE(message_id=12030*)
    → "I see you're working for another nation."
  5: 0x0049 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x004A [0x1D] PRINT_EVENT_MESSAGE(message_id=12036*)
 ...
 15: 0x0061 [0x24] CREATE_DIALOG(message_id=12041*, default_option=1*, option_flags=0*)
...
SUBROUTINE_007C:
 20: 0x007C [0x24] CREATE_DIALOG(message_id=12042*, default_option=1*, option_flags=0*)
