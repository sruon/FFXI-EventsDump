...
```
 ...
 22: 0x0064 [0x1D] PRINT_EVENT_MESSAGE(message_id=12837*)
    → "I apologize for my frankness, but I am on duty.\u0007If your query is in regards to anything other than Campaign Ops, please direct it elsewhere.\u007F1\u0000\u0007"
 23: 0x0067 [0x23] WAIT_FOR_DIALOG_INTERACTION
 24: 0x0068 [0x7B] Mariette (ID: 17134158/0x0105724E) stops talking
 25: 0x006D [0x4B] UPDATE_ENTITY_YAW(entity=Mariette (ID: 17134158/0x0105724E), yaw=15.29°*)
...
SUBROUTINE_0078:
 ...
 30: 0x0080 [0x1D] PRINT_EVENT_MESSAGE(message_id=12827*)
    → "You there, soldier. You've been sent up from the scouts division, yes?\u0007Well, let's not waste any time. Here, take this.\u007F1\u0000\u0007"
 31: 0x0083 [0x23] WAIT_FOR_DIALOG_INTERACTION
 32: 0x0084 [0x24] CREATE_DIALOG(message_id=12829*, default_option=0*, option_flags=0*)
    → "Do you know what that \u001E\u0005fiendtrapper\u001E\u0001 is for?\u0007\u000B A fiend what?\u0007I'm good, thanks.\u007F1\u0000\u0007"
 ...
 35: 0x0094 [0x1D] PRINT_EVENT_MESSAGE(message_id=12830*)
    → "Essentially, it's just a miniature recording device currently in the early stages of experimental use by the scouts division.\u007F1\u0000 \u0007"
 36: 0x0097 [0x23] WAIT_FOR_DIALOG_INTERACTION
 37: 0x0098 [0x1D] PRINT_EVENT_MESSAGE(message_id=12831*)
    → "When used in conjuction with a scout's \u001E\u0005blank fiend plate\u001E\u0001, it allows for the automatic and hassle-free storage of surveillance data.\u007F1\u0000\u0007"
 38: 0x009B [0x23] WAIT_FOR_DIALOG_INTERACTION
 39: 0x009C [0x1D] PRINT_EVENT_MESSAGE(message_id=12832*)
    → "That about covers it. Your mission, should you choose to accept it, is to take this \u001E\u0005fiendtrapper\u001E\u0001 and go and get the goods on those darn Quadav!\u007F1\u0000\u0007"
 ...
 43: 0x00AB [0x1D] PRINT_EVENT_MESSAGE(message_id=12833*)
    → "I expected no less from an knowledgable scout such as yourself.\u0007Your mission, should you choose to accept it, is to take this device and find out what those Quadav are up to!\u007F1\u0000\u0007"
...
SUBROUTINE_00B2:
 ...
 49: 0x00C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=12835*)
    → "What is it? Were you able to capture some helpful footage of the enemy?\u0007In times such as these, surveillance can be the difference between victory or defeat.\u007F1\u0000\u0007"
 ...
 54: 0x00D6 [0x1D] PRINT_EVENT_MESSAGE(message_id=12836*)
    → "Since I have confirmed your findings, it is now on you to proceed directly to Hieronymus with that intel and report the particulars.\u007F1\u0000\u0007"
