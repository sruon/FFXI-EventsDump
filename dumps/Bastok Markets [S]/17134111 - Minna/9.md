...
```
  ...
  3: 0x000C [0x1D] PRINT_EVENT_MESSAGE(message_id=12076*)
    → "Through this tunnel lie the Fourth Division barracks. While far from luxurious, the rooms provide troops with a place to store their belongings, receive packages, and rest up before missions.\u007F1\u0000\u0007"
