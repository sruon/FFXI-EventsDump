...
```
 ...
 15: 0x0038 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 16: 0x0049 [0x1C] WAIT(60* ticks)
 17: 0x004C [0x38] SET_CLIENT_EVENT_MODE(mode=19*)
 18: 0x004F [0x4B] UPDATE_ENTITY_YAW(entity=EventEntity, yaw=6.78°*)
 19: 0x0056 [0x45] LOAD_SCHEDULED_TASK(work_offset1=217*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z87a", work_offset2=0*)
 20: 0x0067 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x05)
 21: 0x006E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 ...
 27: 0x0096 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
