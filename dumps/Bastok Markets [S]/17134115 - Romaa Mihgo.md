...
| [359](#event-359)          | 0x0077       |      1 |              1 |
| [360](#event-360)          | 0x0078       |      1 |              1 |
...
```
  ...
  1: 0x0048 [0x1F] MOVE_ENTITY: EventEntity moves to X=-6.028*, Z=38.489*, Y=-1.000*
...
```
  ...
  1: 0x0057 [0x1F] MOVE_ENTITY: EventEntity moves to X=-4.873*, Z=40.752*, Y=-1.000*
...
```
  ...
  1: 0x006B [0x1F] MOVE_ENTITY: EventEntity moves to X=-4.350*, Z=34.757*, Y=-0.999*
