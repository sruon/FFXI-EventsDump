...
- **12833**: You there, soldier. You've been sent up from the scouts division, yes? Well, let's not waste any time. Here, take this.
- **12835**: Do you know what that fiendtrapper is for? [ A fiend what?/I'm good, thanks.]
- **12836**: Essentially, it's just a miniature recording device currently in the early stages of experimental use by the scouts division.
- **12837**: When used in conjuction with a scout's blank fiend plate, it allows for the automatic and hassle-free storage of surveillance data.
- **12838**: That about covers it. Your mission, should you choose to accept it, is to take this fiendtrapper and go and get the goods on those darn Quadav!
- **12839**: I expected no less from an knowledgable scout such as yourself. Your mission, should you choose to accept it, is to take this device and find out what those Quadav are up to!
- **12841**: What is it? Were you able to capture some helpful footage of the enemy? In times such as these, surveillance can be the difference between victory or defeat.
- **12842**: Since I have confirmed your findings, it is now on you to proceed directly to Hieronymus with that intel and report the particulars.
- **12843**: I apologize for my frankness, but I am on duty. If your query is in regards to anything other than Campaign Ops, please direct it elsewhere.
...
```
 ...
 22: 0x0064 [0x1D] PRINT_EVENT_MESSAGE(message_id=12843*)
...
SUBROUTINE_0078:
 ...
 30: 0x0080 [0x1D] PRINT_EVENT_MESSAGE(message_id=12833*)
 ...
 32: 0x0084 [0x24] CREATE_DIALOG(message_id=12835*, default_option=0*, option_flags=0*)
 ...
 35: 0x0094 [0x1D] PRINT_EVENT_MESSAGE(message_id=12836*)
 ...
 37: 0x0098 [0x1D] PRINT_EVENT_MESSAGE(message_id=12837*)
 ...
 39: 0x009C [0x1D] PRINT_EVENT_MESSAGE(message_id=12838*)
 ...
 43: 0x00AB [0x1D] PRINT_EVENT_MESSAGE(message_id=12839*)
...
SUBROUTINE_00B2:
 ...
 49: 0x00C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=12841*)
 ...
 54: 0x00D6 [0x1D] PRINT_EVENT_MESSAGE(message_id=12842*)
