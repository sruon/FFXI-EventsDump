...
- **10844**: The minstrel of melodies is my name, For a mere $6 gil I'll recall your past. Your stories of love, anger, triumph, and shame, The river of memories runs deep and vast.
- **10845**: The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last.
- **10847**: Which memory will you have recalled? [Nothing./Wings of the Goddess Missions./Bastok Quests 1./Bastok Quests 2./Other Quests.]
- **10848**: Which memory will you have recalled? [Nothing./Affairs of State./Borne by the Wind.]
- **10849**: Which memory will you have recalled? [Nothing./Too Many Chefs./A Proper Burial(pt.1)./A Proper Burial(pt.2)./A Proper Burial(pt.3)./A Proper Burial(pt.4)./A Proper Burial(pt.5)./The Fighting Fourth(pt.1)./The Fighting Fourth(pt.2)./Better Part of Valor(pt.1)./Better Part of Valor(pt.2)./Fires of Discontent(pt.1)./Fires of Discontent(pt.2)./Fires of Discontent(pt.3)./Fires of Discontent(pt.4)./Fires of Discontent(pt.5)./Fires of Discontent(pt.6)./Light in the Darkness(pt.1)./Light in the Darkness(pt.2)./Light in the Darkness(pt.3)./Light in the Darkness(pt.4)./Light in the Darkness(pt.5)./Burden of Suspicion(pt.1)./Burden of Suspicion(pt.2)./Burden of Suspicion(pt.3)./Hammering Hearts(pt.1)./Hammering Hearts(pt.2)./Storm on the Horizon(pt.1)./Storm on the Horizon(pt.2).]
- **10850**: Which memory will you have recalled? [Nothing./Fire in the Hole(pt.1)./Fire in the Hole(pt.2)./Fire in the Hole(pt.3)./Fire in the Hole(pt.4)./Fire in the Hole(pt.5)./Fire in the Hole(pt.6)./Quelling the Storm(pt.1)./Quelling the Storm(pt.2)./Quelling the Storm(pt.3)./Quelling the Storm(pt.4)./Quelling the Storm(pt.5)./Quelling the Storm(pt.6)./Honor Under Fire(pt.1)./Honor Under Fire(pt.2)./Beneath the Mask(pt.1)./Beneath the Mask(pt.2)./Beneath the Mask(pt.3)./What Price Loyalty(pt.1)./What Price Loyalty(pt.2)./What Price Loyalty(pt.3)./A Jeweler's Lament(pt.1)./A Jeweler's Lament(pt.2)./A Jeweler's Lament(pt.3)./A Jeweler's Lament(pt.4)./A Jeweler's Lament(pt.5)./A Jeweler's Lament(pt.6)./The Truth Lies Hid./Bonds of Mythril(pt.1)./Bonds of Mythril(pt.2).]
- **10851**: Which memory will you have recalled? [Nothing./On Sabbatical./Scholar Attire(pt.1)./Scholar Attire(pt.2)./Scholar Attire(pt.3)./Scholar Attire(pt.4)./Her Memories: Azure Footfalls(pt.1)./Her Memories: Azure Footfalls(pt.2)./Her Memories: Azure Footfalls(pt.3)./Drafted by the Duchy./Battle on a New Front./Trust (Klara).]
...
```
  ...
  3: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=10845*)
 ...
 21: 0x0088 [0x1D] PRINT_EVENT_MESSAGE(message_id=10845*)
    → "The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last."
 22: 0x008B [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x008C [0x21] END_EVENT
 24: 0x008D [0x00] END_REQSTACK()
 25: 0x008E [0x1D] PRINT_EVENT_MESSAGE(message_id=10844*)
 ...
 39: 0x00D4 [0x24] CREATE_DIALOG(message_id=10847*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00E4:
 42: 0x00E4 [0x24] CREATE_DIALOG(message_id=10848*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_0113:
 50: 0x0113 [0x24] CREATE_DIALOG(message_id=10849*, default_option=0*, option_flags=Work_Zone[3])
...
SUBROUTINE_0142:
 58: 0x0142 [0x24] CREATE_DIALOG(message_id=10850*, default_option=0*, option_flags=Work_Zone[4])
...
SUBROUTINE_0171:
 66: 0x0171 [0x24] CREATE_DIALOG(message_id=10851*, default_option=0*, option_flags=Work_Zone[5])
...
SUBROUTINE_01A0:
 74: 0x01A0 [0x24] CREATE_DIALOG(message_id=10852*, default_option=0*, option_flags=Work_Zone[6])
...
SUBROUTINE_01CF:
 82: 0x01CF [0x24] CREATE_DIALOG(message_id=10853*, default_option=0*, option_flags=Work_Zone[7])
    → "Which memory will you have recalled? [Nothing.]"
