...
```
  ...
  3: 0x0018 [0x1D] PRINT_EVENT_MESSAGE(message_id=12339*)
    → "The Metalworks have been placed under the jurisdiction of the military in order to develop and produce arms for the war.\u0007Neither townspeople nor low-ranking soldiers are permitted to enter.\u007F1\u0000\u0007"
