...
- **10836**: Port Bastok is strictly off-limits to all but authorized personnel.
- **10837**: However, if you wish to travel to North Gustaberg, you may use the Republic's supply causeway.
- **10838**: Cross the bridge? [Yes./No.]
...
```
  ...
  8: 0x0021 [0x24] CREATE_DIALOG(message_id=10838*, default_option=1*, option_flags=0*)
