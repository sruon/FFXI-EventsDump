...
- **12315**: An enormous comet is visible in the night sky as of late.
- **12316**: I'm not quite sure why, but whenever I see a comet like that, it just puts a flutter in my chest.
...
```
  ...
  3: 0x0035 [0x1D] PRINT_EVENT_MESSAGE(message_id=12316*)
