...
- **7409**: What story would you like to be told? [On second thought, maybe later./Get the Picture./Immortal Sentries./Rock Bottom(pt.1)./Rock Bottom(pt.2)./Rock Bottom(pt.3)./Beginnings./Embers of His Past(pt.1)./Embers of His Past(pt.2)./Embers of His Past(pt.3)./Embers of His Past(pt.4)./Waking the Colossus(pt.1)./Waking the Colossus(pt.2)./Waking the Colossus(pt.3)./Divine Interference(pt.1)./Divine Interference(pt.2)./Ghatsad's Quandary(pt.1)./Ghatsad's Quandary(pt.2).]
- **7410**: 
- **7411**: 
- **7412**: 
