...
- **7338**: Use the device? [Yes./No.]
- **7340**: Attuning yourself to this runic portal will open a path to the Chamber of Passage.
- **7343**: <Player> has attuned [himself/herself] to the runic portal, and opened a path from the Halvung staging point to the Chamber of Passage.
...
```
  ...
  3: 0x0131 [0x24] CREATE_DIALOG(message_id=7338*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
