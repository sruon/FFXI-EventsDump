...
- **7344**: <Player> has attuned [himself/herself] to the runic portal, and opened a path from the Halvung staging point to the Chamber of Passage.
...
```
  ...
  3: 0x0131 [0x24] CREATE_DIALOG(message_id=7339*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
