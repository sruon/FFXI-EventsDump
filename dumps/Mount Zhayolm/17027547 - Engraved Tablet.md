...
- **7567**: Sprinkle some salt on the tablet? [Yes./No.]
- **7568**: The stone tablet quickly absorbs the salt and begins giving off a metallic grating sound...
- **7569**: The salt grains patter against the stone tablet and scatter all over the ground. You could have sworn hearing the tinkling sound of a bell...
...
```
  ...
  1: 0x0058 [0x24] CREATE_DIALOG(message_id=7567*, default_option=1*, option_flags=0*)
    → "Sprinkle some salt on the tablet? [Yes./No.]"
  2: 0x005F [0x25] WAIT_DIALOG_SELECT()
  3: 0x0060 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x006F
  4: 0x0068 [0x48] [System] [7569*]:
