...
| [12](#event-12)       | 0x0001       |     85 |             23 |
| [14](#event-14)       | 0x0056       |     40 |             12 |
...
|       5 | 0x18FB      |        6395 |
|       6 | 0x4DA94     |      318100 |
|       7 | 0xFFF71230  |  4294382128 |
|       8 | 0xFFFFC75C  |  4294952796 |
|       9 | 0x0400      |        1024 |
|      10 | 0x1D8D      |        7565 |
...
- **7563**: Sprinkle some salt on the tablet? [Yes./No.]
- **7564**: The stone tablet quickly absorbs the salt and begins giving off a metallic grating sound...
- **7565**: The salt grains patter against the stone tablet and scatter all over the ground. You could have sworn hearing the tinkling sound of a bell...
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=7563*, default_option=1*, option_flags=0*)
...
```
  ...
  1: 0x0058 [0x24] CREATE_DIALOG(message_id=7563*, default_option=1*, option_flags=0*)
    → "Sprinkle some salt on the tablet? [Yes./No.]"
  2: 0x005F [0x25] WAIT_DIALOG_SELECT()
  3: 0x0060 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x006F
  4: 0x0068 [0x48] [System] [7565*]:
