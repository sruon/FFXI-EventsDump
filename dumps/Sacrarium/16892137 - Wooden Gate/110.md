...
```
  ...
  9: 0x0024 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 10: 0x0035 [0x1C] WAIT(60* ticks)
 11: 0x0038 [0x38] SET_CLIENT_EVENT_MODE(mode=18*)
 12: 0x003B [0x45] LOAD_SCHEDULED_TASK(work_offset1=160*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="28en", work_offset2=0*)
 ...
 15: 0x005A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 ...
 23: 0x0080 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 ...
 26: 0x00A3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
