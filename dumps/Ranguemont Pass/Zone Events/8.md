...
```
  ...
  3: 0x00E5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  4: 0x00F6 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 10: 0x011C [0x45] LOAD_SCHEDULED_TASK(work_offset1=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="t007", work_offset2=0*)
 11: 0x012D [0x55] WAIT_LOAD_SCHEDULER(work_offset=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="t007")
 12: 0x013C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 13: 0x014D [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 ...
 25: 0x018E [0x45] LOAD_SCHEDULED_TASK(work_offset1=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="t00b", work_offset2=0*)
 26: 0x019F [0x2A] GET_REQ_LEVEL(level=3, entity_id=Mertaire (ID: 17457348/0x010A60C4))
 27: 0x01A5 [0x55] WAIT_LOAD_SCHEDULER(work_offset=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="t00b")
 ...
 40: 0x01F7 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "shit" for entities [Mertaire (ID: 17457348/0x010A60C4), Mertaire (ID: 17457348/0x010A60C4)]
 41: 0x0204 [0x1C] WAIT(30* ticks)
 42: 0x0207 [0x4A] LocalPlayer looks at Waters of Oblivion (ID: 17457347/0x010A60C3)
 43: 0x0210 [0x45] LOAD_SCHEDULED_TASK(work_offset1=208*, entity1=Mertaire (ID: 17457348/0x010A60C4), entity2=Mertaire (ID: 17457348/0x010A60C4), scheduler_id="t011", work_offset2=0*)
 44: 0x0221 [0x55] WAIT_LOAD_SCHEDULER(work_offset=208*, entity1=Mertaire (ID: 17457348/0x010A60C4), entity2=Mertaire (ID: 17457348/0x010A60C4), scheduler_id="t011")
 45: 0x0230 [0x1C] WAIT(10* ticks)
 46: 0x0233 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
 47: 0x0244 [0x1C] WAIT(5* ticks)
 48: 0x0247 [0x45] LOAD_SCHEDULED_TASK(work_offset1=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="t008", work_offset2=0*)
 49: 0x0258 [0x55] WAIT_LOAD_SCHEDULER(work_offset=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="t008")
 ...
 53: 0x0278 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Mertaire (ID: 17457348/0x010A60C4), entity2=Mertaire (ID: 17457348/0x010A60C4), action="sha0")
 54: 0x0287 [0x06] ExtData[1]->WorkLocal[2] = 0
 55: 0x028A [0x02] IF !(ExtData[1]->WorkLocal[2] > 200*) GOTO 0x02AE
 56: 0x0292 [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "main" with entities [Waters of Oblivion (ID: 17457347/0x010A60C3), Waters of Oblivion (ID: 17457347/0x010A60C3)], work=[3*, 0*]
...
SUBROUTINE_02AE:
 ...
 62: 0x02B7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="t010", work_offset2=0*)
 63: 0x02C8 [0x55] WAIT_LOAD_SCHEDULER(work_offset=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="t010")
 ...
 68: 0x02E9 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Mertaire (ID: 17457348/0x010A60C4), entity2=Mertaire (ID: 17457348/0x010A60C4), action="sha1")
 69: 0x02F8 [0x53] WAIT_SCHEDULER_TASK(entity1=Mertaire (ID: 17457348/0x010A60C4), entity2=Mertaire (ID: 17457348/0x010A60C4), action_id="sha1")
 ...
 73: 0x0310 [0x45] LOAD_SCHEDULED_TASK(work_offset1=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="t00c", work_offset2=0*)
 74: 0x0321 [0x55] WAIT_LOAD_SCHEDULER(work_offset=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="t00c")
 ...
 78: 0x033F [0x45] LOAD_SCHEDULED_TASK(work_offset1=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="t00d", work_offset2=0*)
 ...
 83: 0x0360 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=Mertaire (ID: 17457348/0x010A60C4), entity2=Mertaire (ID: 17457348/0x010A60C4), action="pas0")
 84: 0x036F [0x53] WAIT_SCHEDULER_TASK(entity1=Mertaire (ID: 17457348/0x010A60C4), entity2=Mertaire (ID: 17457348/0x010A60C4), action_id="pas0")
 85: 0x037C [0x55] WAIT_LOAD_SCHEDULER(work_offset=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="t00d")
 86: 0x038B [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2", work_offset2=0*)
 87: 0x039C [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2")
 88: 0x03AB [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
 ...
 92: 0x03C6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
