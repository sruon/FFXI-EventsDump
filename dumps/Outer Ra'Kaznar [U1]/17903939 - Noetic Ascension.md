...
- **7360**: What shall you do? [Nothing./Have benefits bestowed upon you./Check active benefits.]
- **7361**: Which benefit? [None./Bayld+./Obsidian Fragments+./Attack+./Defense+./Magic Attack+./Magic Defense+./Map Obtainment./HP & MP Recovery+./TP3000+./HP+./MP+./Movement Speed+./Fenestral Boons.]
- **7362**: Which benefit? [None./Bayld+./Obsidian Fragments+./Attack+./Defense+./Magic Attack+./Magic Defense+./Map Obtainment./HP & MP Recovery+./TP3000+./HP+./MP+./Movement Speed+./Defensive Measures.]
- **7363**: Receive the effect of [Bayld+/Obsidian Fragments+/Attack+/Defense+/Magic Attack+/Magic Defense+/Map Obtainment/HP & MP Recovery+/TP3000+/HP+/MP+/Movement Speed+]? [Yes./No.]
- **7365**: You are currently blessed with the following powers... [$25/$26] Attack+ [$25/$26] Defense+ [$25/$26] Magic Attack+
- **7366**: [$25/$26] Magic Defense+
- **7367**: [$25/$26] Magic Defense+ [$25/$1638747/$26] MP+
- **7368**: [$25/$26] Magic Defense+ [$25/$1638747/$26] MP+ [$25/$26] Movement Speed+
- **7380**: Which benefit? [None. Go back./Stockade Cons. 1./Stockade Cons. 2./Cantonment Rest./Stockade Const. 3./Stockade Const. 4./Decreased Defending Time.]
- **7381**: The amount of time you have to meet your goals, the interval between which foes spawn, and the time it takes them to arrive at cantonments will all be decreased.
- **7382**: Receive the effect of [Stockade Cons. 1/Stockade Cons. 2/Cantonment Rest./Stockade Cons. 3/Stockade Cons. 4/Dec. Def. Time]? [Yes./No.]
- **7388**: Which benefit? [None. Go back./Fragments+ (Weak)./Fragments+ (Medium)./Fragments+ (Strong)./Fragments+ (Very Strong)./Fragments+ (Colossal).]
- **7389**: An inexplicable force possesses the recipient that allows them to obtain fenestral fragments.
- **7390**: Receive the effect of [Fragments+ (Weak)/Fragments+ (Medium)/Fragments+ (Strong)/Frag.+ (Very Strong)/Frag.+ (Colossal)]? [Yes./No.]
...
```
  ...
  6: 0x0020 [0x24] CREATE_DIALOG(message_id=7360*, default_option=0*, option_flags=ExtData[1]->WorkLocal[2])
...
119: 0x025A [0x24] CREATE_DIALOG(message_id=7362*, default_option=0*, option_flags=ExtData[1]->WorkLocal[6])
...
126: 0x027B [0x24] CREATE_DIALOG(message_id=7362*, default_option=0*, option_flags=ExtData[1]->WorkLocal[6])
    → "Which benefit? [None./Bayld+./Obsidian Fragments+./Attack+./Defense+./Magic Attack+./Magic Defense+./Map Obtainment./HP & MP Recovery+./TP3000+./HP+./MP+./Movement Speed+./Defensive Measures.]"
...
132: 0x0299 [0x24] CREATE_DIALOG(message_id=7380*, default_option=0*, option_flags=ExtData[1]->WorkLocal[9])
...
141: 0x02C2 [0x24] CREATE_DIALOG(message_id=7361*, default_option=0*, option_flags=ExtData[1]->WorkLocal[6])
...
147: 0x02E0 [0x24] CREATE_DIALOG(message_id=7388*, default_option=0*, option_flags=ExtData[1]->WorkLocal[9])
...
161: 0x0326 [0x24] CREATE_DIALOG(message_id=7363*, default_option=1*, option_flags=0*)
...
178: 0x0370 [0x24] CREATE_DIALOG(message_id=7382*, default_option=1*, option_flags=0*)
...
194: 0x03B2 [0x24] CREATE_DIALOG(message_id=7390*, default_option=1*, option_flags=0*)
