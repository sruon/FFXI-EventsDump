...
```
 ...
 16: 0x02E7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=631*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s000", work_offset2=0*)
 17: 0x02F8 [0x1C] WAIT(15* ticks)
 18: 0x02FB [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 19: 0x030C [0x5B] LOAD_EXT_SCHEDULER(work_offset=3476*, entity1=Morimar (ID: 17928226/0x01119022), entity2=Morimar (ID: 17928226/0x01119022), action="tlk0")
 ...
 30: 0x0346 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
 31: 0x0357 [0x21] END_EVENT
 32: 0x0358 [0x00] END_REQSTACK()

 33: 0x03BC [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 34: 0x03CD [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
