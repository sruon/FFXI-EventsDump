...
0080: 29 08 10 90 11 01 07 29  08 10 90 11 01 08 20 00  )......)...... .
0090: 21 00                                             !.              
```
...
```
  ...
  3: 0x0080 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Meandering Leafkin (ID: 17928208/0x01119010), tag_num=0x07)
  4: 0x0087 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Meandering Leafkin (ID: 17928208/0x01119010), tag_num=0x08)
