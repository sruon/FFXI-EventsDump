...
- **7710**: Would you like to hear a story? [No, thank you./Let's hear one./Let's hear one(2).]
- **7711**: Which story would you like to be told? [On second thought, maybe later./Leafallia(pt.1)./Leafallia(pt.2)./Rosulatia's Promise./The Lightsland(pt.1)./The Lightsland(pt.2)./The Light of Dawn Comes.../Cries from the Deep./Heroes, Unite!/Yggdrasil Beckons./The Key to the Turris./Blood for Blood./The Light Within./Vagary(pt.1)./Vagary(pt.2)./Vagary(pt.3)./Vagary(pt.4)./Vagary(pt.5)./Vagary(pt.6)./Vagary(pt.7)./Vagary(pt.8)./Vagary(pt.9)./Vagary(pt.10)./Vagary(pt.11)./The Silent Forest(pt.1)./The Silent Forest(pt.2)./The Silent Forest(pt.3)./Winds of Eternity(pt.1)./Winds of Eternity(pt.2)./Phantasmic Heroes(pt.1)./Phantasmic Heroes(pt.2)./Phantasmic Heroes(pt.3).]
- **7712**: Which story would you like to be told? [On second thought, maybe later./The Prime Weapons(pt.1)./The Prime Weapons(pt.2)./The Prime Weapons(pt.3).]
- **7713**: 
- **7714**: 
