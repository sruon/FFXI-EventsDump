...
- **8045**: Hm? Oh, hello. And...goodbye.
- **8046**: Hm?
- **8047**: How do you respond? [Hm?/Hello!]
- **8048**: Hmmm??? Ugh. Why do you not understand how to give a simple greeting?
- **8049**: How do you respond? [Hmmm???/Hello!]
- **8050**: You really are denser than Selbina butter. And with that...goodbye.
- **8051**: Oh. Hello there.
- **8052**: I always did appreciate someone who knows how to properly greet others.
- **8053**: You're one of the good ones--that much I can tell. Now, if you would, please listen to my request.
- **8054**: I'm looking for a special powder--a hodgepodge of different minerals and assorted residue that I've taken to calling "gallimaufry." But it's quite difficult to come by on my own.
- **8055**: So my request is simple--I'd like you to gather gallimaufry for me.
- **8056**: I assume that your answer would be "yes" either way...
- **8057**: But let me sweeten the pot.
- **8058**: Will you help? [Fish for more info./Not interested.]
- **8059**: Ah, yes. My eyes are discerning as ever.
- **8060**: First, let me provide you with $6. Now, here's what I need you to do.
- **8061**: I need you to take the $3 and head to the diaphanous transposer in northwestern Kamihr Drifts (F-6). From there, you can teleport to Outer Ra'Kaznar.
- **8062**: That's where you can find all the gallimaufry I need.
- **8063**: This Outer Ra'Kaznar is a little different from the one you may be used to, so take care.
- **8064**: As soon as you enter Outer Ra'Kaznar, your $3 will lose its potency and transform into $6.
- **8065**: Fear not. The $3 will turn back into $6 if you approach the diaphanous transposer after 20 hours (Earth time) have elapsed.
- **8066**: Be aware that only a total of six people can teleport into Outer Ra'Kaznar at any given time.
- **8067**: Any more, and you will likely get stuck in the walls or something.
- **8068**: That's all you need to know. Good luck!
- **8069**: Need a refresher? The diaphanous transposer is in Kamihr Drifts (F-6).
- **8070**: I knew I could count on you. Oh, happy day!
- **8071**: I've taken the liberty of preparing a list of items I'll give you in exchange for gallimaufry.
- **8072**: You wouldn't happen to have any Empyrean armor, would you?
- **8073**: I've pulled some strings with a blacksmith friend of mine, and if you bring me the proper materials I'm sure she'll lend a hand. Take a look at my list for the details.
- **8074**: Oh, I know, I know. You're sick of waiting for your $3 to regenerate. And I'm sick of waiting for more gallimaufry.
- **8075**: So I figured "Hey, if I make another $3, then we can both be happy!"
- **8076**: But nothing is ever so easy, is it? No matter how much blood, sweat, and tears I poured into the process, I couldn't get it to come together properly.
- **8077**: But the next day, once my tears were dry, I went back and collected the residual energies from the $3...
- **8078**: And who woulda thunk it--the process was a success after all! The $3 turned back into $6! This time, the tears I shed were of joy.
- **8079**: So here you are! A brand new $3!
- **8080**: Care to browse my special list?
- **8081**: What do you do? [View the list./Ask about Outer Ra'Kaznar./Ask about $5./Ask about $5./Ask about temporary items/Ask about $5./Leave for now.]
- **8083**: To reforge empyrean armor to 119[+2/+3], I'll need the 119[+1/+2] version of the empyrean armor piece, $1, and $2 gallimaufry. Would you like to see what the end result will look like?
...
- **8086**: It'll take a little while to reforge your $0. Jeuno wasn't built in a day...but this armor will be, so come back tomorrow.
- **8087**: My contact is hard at work. You'll need to come back a little bit later.
- **8088**: The equipment you ordered is ready! Here you are!
- **8089**: $0? It'll run you $1 gallimaufry.
- **8090**: Are you sure? ($0 gall.) [Yes./Hang on...]
- **8091**: Your $3 will regenerate in $0 [hour/minute][/s].
- **8092**: Do you want to use the $3?
- **8093**: Use it? [Yes, please./No, thank you.]
- **8094**: You don't need to use the $3. Just head to the diaphanous transposer.
- **8095**: You can't use the $3 for another $1 second[/s] (Earth time).
- **8101**: Here are the temporary items you currently possess.
...
```
  ...
  2: 0x0009 [0x1D] PRINT_EVENT_MESSAGE(message_id=8046*)
    → "Hm?"
  3: 0x000C [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x000D [0x24] CREATE_DIALOG(message_id=8047*, default_option=0*, option_flags=0*)
  ...
  8: 0x002C [0x1D] PRINT_EVENT_MESSAGE(message_id=8048*)
 ...
 13: 0x0059 [0x24] CREATE_DIALOG(message_id=8049*, default_option=0*, option_flags=0*)
 ...
 17: 0x0078 [0x1D] PRINT_EVENT_MESSAGE(message_id=8050*)
...
SUBROUTINE_0096:
 ...
 31: 0x00B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=8054*)
 ...
 42: 0x00EA [0x24] CREATE_DIALOG(message_id=8058*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0104:
 ...
 51: 0x011D [0x1D] PRINT_EVENT_MESSAGE(message_id=8059*)
    → "Ah, yes. My eyes are discerning as ever."
 52: 0x0120 [0x23] WAIT_FOR_DIALOG_INTERACTION
 53: 0x0121 [0x1D] PRINT_EVENT_MESSAGE(message_id=8060*)
 ...
 59: 0x015D [0x1D] PRINT_EVENT_MESSAGE(message_id=8061*)
 ...
 61: 0x0161 [0x1D] PRINT_EVENT_MESSAGE(message_id=8062*)
    → "That's where you can find all the gallimaufry I need."
 62: 0x0164 [0x23] WAIT_FOR_DIALOG_INTERACTION
 63: 0x0165 [0x1D] PRINT_EVENT_MESSAGE(message_id=8063*)
 ...
 65: 0x0169 [0x1D] PRINT_EVENT_MESSAGE(message_id=8064*)
 ...
 67: 0x016D [0x1D] PRINT_EVENT_MESSAGE(message_id=8065*)
 ...
 69: 0x0171 [0x1D] PRINT_EVENT_MESSAGE(message_id=8066*)
...
```
  ...
  3: 0x01C4 [0x1D] PRINT_EVENT_MESSAGE(message_id=8070*)
    → "I knew I could count on you. Oh, happy day!"
  4: 0x01C7 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x01C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=8071*)
  ...
  7: 0x01CC [0x1D] PRINT_EVENT_MESSAGE(message_id=8072*)
    → "You wouldn't happen to have any Empyrean armor, would you?"
  8: 0x01CF [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x01D0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8073*)
 ...
 12: 0x01D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=8074*)
 ...
 20: 0x01EF [0x1D] PRINT_EVENT_MESSAGE(message_id=8077*)
 ...
 24: 0x01FD [0x1D] PRINT_EVENT_MESSAGE(message_id=8078*)
 ...
 27: 0x0206 [0x1D] PRINT_EVENT_MESSAGE(message_id=8079*)
...
```
  ...
  3: 0x024C [0x1D] PRINT_EVENT_MESSAGE(message_id=8080*)
...
SUBROUTINE_02E9:
 ...
 34: 0x02F8 [0x24] CREATE_DIALOG(message_id=8081*, default_option=ExtData[1]->WorkLocal[5], option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_04D2:
 ...
 88: 0x051F [0x1D] PRINT_EVENT_MESSAGE(message_id=8083*)
...
SUBROUTINE_053B:
 94: 0x053B [0x24] CREATE_DIALOG(message_id=8084*, default_option=ExtData[1]->WorkLocal[8], option_flags=ExtData[1]->WorkLocal[3])
    → "View which? [Boii Armor./Bhikku Attire./Ebers Attire./Wicce Attire./Lethargy Armor./Skulker's Attire./Chevalier's Armor./Heathen's Armor./Nukumi Armor./Fili Attire./Amini Attire./Kasuga Armor./Hattori Garb./Peltast's Armor./Beckoner's Attire./Hashishin Attire./Chasseur's Attire./Karagoz Attire./Maculele Attire./Arbatel Attire./Azimuth Attire./Erilaz Attire./Back.]"
...
122: 0x063B [0x1D] PRINT_EVENT_MESSAGE(message_id=8061*)
    → "I need you to take the $3 and head to the diaphanous transposer in northwestern Kamihr Drifts (F-6). From there, you can teleport to Outer Ra'Kaznar."
123: 0x063E [0x23] WAIT_FOR_DIALOG_INTERACTION
124: 0x063F [0x1D] PRINT_EVENT_MESSAGE(message_id=8062*)
    → "That's where you can find all the gallimaufry I need."
125: 0x0642 [0x23] WAIT_FOR_DIALOG_INTERACTION
126: 0x0643 [0x1D] PRINT_EVENT_MESSAGE(message_id=8063*)
    → "This Outer Ra'Kaznar is a little different from the one you may be used to, so take care."
127: 0x0646 [0x23] WAIT_FOR_DIALOG_INTERACTION
128: 0x0647 [0x1D] PRINT_EVENT_MESSAGE(message_id=8064*)
    → "As soon as you enter Outer Ra'Kaznar, your $3 will lose its potency and transform into $6."
129: 0x064A [0x23] WAIT_FOR_DIALOG_INTERACTION
130: 0x064B [0x1D] PRINT_EVENT_MESSAGE(message_id=8065*)
    → "Fear not. The $3 will turn back into $6 if you approach the diaphanous transposer after 20 hours (Earth time) have elapsed."
131: 0x064E [0x23] WAIT_FOR_DIALOG_INTERACTION
132: 0x064F [0x1D] PRINT_EVENT_MESSAGE(message_id=8066*)
    → "Be aware that only a total of six people can teleport into Outer Ra'Kaznar at any given time."
...
142: 0x0748 [0x1D] PRINT_EVENT_MESSAGE(message_id=8095*)
...
154: 0x078C [0x1D] PRINT_EVENT_MESSAGE(message_id=8101*)
...
```
  ...
  3: 0x09C1 [0x1D] PRINT_EVENT_MESSAGE(message_id=8045*)
...
```
  ...
  3: 0x0A07 [0x1D] PRINT_EVENT_MESSAGE(message_id=8069*)
...
```
  ...
  3: 0x0A4D [0x1D] PRINT_EVENT_MESSAGE(message_id=8086*)
...
```
  ...
  3: 0x0A93 [0x1D] PRINT_EVENT_MESSAGE(message_id=8088*)
...
```
  ...
  3: 0x0AD9 [0x1D] PRINT_EVENT_MESSAGE(message_id=8087*)
...
```
  ...
  3: 0x0B1F [0x1D] PRINT_EVENT_MESSAGE(message_id=8087*)
    → "My contact is hard at work. You'll need to come back a little bit later."
