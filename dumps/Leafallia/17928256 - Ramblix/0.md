...
0010: 40 90 11 01 03 00 00 00  80 02 02 10 01 80 01 28  @..............(
...
```
  ...
  4: 0x000B [0x4A] LocalPlayer looks at Ramblix (ID: 17928256/0x01119040)
 ...
 15: 0x005A [0x1D] PRINT_EVENT_MESSAGE(message_id=7698*)
 ...
 17: 0x005E [0x1D] PRINT_EVENT_MESSAGE(message_id=7699*)
 ...
 19: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=7700*)
 ...
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=7708*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
    → "Would you like to hear a story?\u0007\u000BNo, thank you.\u0007Let's hear one.\u0007Let's hear one(2).\u007F1\u0000\u0007"
 30: 0x0099 [0x25] WAIT_DIALOG_SELECT()
 31: 0x009A [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x00DE

SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7709*, default_option=0*, option_flags=Work_Zone[2])
    → "Which story would you like to be told?\u0007\u000BOn second thought, maybe later.\u0007Leafallia(pt.1).\u0007Leafallia(pt.2).\u0007Rosulatia's Promise.\u0007The Lightsland(pt.1).\u0007The Lightsland(pt.2).\u0007The Light of Dawn Comes...\u0007Cries from the Deep.\u0007Heroes, Unite!\u0007Yggdrasil Beckons.\u0007The Key to the Turris.\u0007Blood for Blood.\u0007The Light Within.\u0007Vagary(pt.1).\u0007Vagary(pt.2).\u0007Vagary(pt.3).\u0007Vagary(pt.4).\u0007Vagary(pt.5).\u0007Vagary(pt.6).\u0007Vagary(pt.7).\u0007Vagary(pt.8).\u0007Vagary(pt.9).\u0007Vagary(pt.10).\u0007Vagary(pt.11).\u0007The Silent Forest(pt.1).\u0007The Silent Forest(pt.2).\u0007The Silent Forest(pt.3).\u0007Winds of Eternity(pt.1).\u0007Winds of Eternity(pt.2).\u0007Phantasmic Heroes(pt.1).\u0007Phantasmic Heroes(pt.2).\u0007Phantasmic Heroes(pt.3).\u007F1\u0000\u0007"
 ...
 37: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7702*)
...
SUBROUTINE_00E6:
 43: 0x00E6 [0x24] CREATE_DIALOG(message_id=7710*, default_option=0*, option_flags=Work_Zone[3])
    → "Which story would you like to be told?\u0007\u000BOn second thought, maybe later.\u0007The Prime Weapons(pt.1).\u0007The Prime Weapons(pt.2).\u0007The Prime Weapons(pt.3).\u007F1\u0000\u0007"
 ...
 48: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7702*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_012A:
 54: 0x012A [0x24] CREATE_DIALOG(message_id=7711*, default_option=0*, option_flags=Work_Zone[4])
    → "\u007F1\u0000\u0007"
 ...
 59: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=7702*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_016E:
 65: 0x016E [0x24] CREATE_DIALOG(message_id=7712*, default_option=0*, option_flags=Work_Zone[5])
    → "\u007F1\u0000\u0007"
 ...
 70: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=7702*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_01A7:
 ...
 77: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7702*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_01C6:
 81: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7701*)
    → "Now, listen close...\u007F1\u0000\u0007"
