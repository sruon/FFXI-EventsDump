...
0080: 29 08 13 90 11 01 01 29  08 13 90 11 01 02 29 08  )......)......).
0090: 13 90 11 01 03 20 00 21  00                       ..... .!.       
```
...
```
  ...
  3: 0x0080 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Meandering Leafkin (ID: 17928211/0x01119013), tag_num=0x01)
  4: 0x0087 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Meandering Leafkin (ID: 17928211/0x01119013), tag_num=0x02)
  5: 0x008E [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Meandering Leafkin (ID: 17928211/0x01119013), tag_num=0x03)
