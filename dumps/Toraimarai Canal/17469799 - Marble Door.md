...
- **7456**: The door is sealed shut by some magical force.
- **7457**: A dreadful voice intones: "This door is guarded by the Four Servants."
- **7459**: Leave the Animastery? [Yes./No.]
...
```
  ...
  2: 0x00E5 [0x24] CREATE_DIALOG(message_id=7459*, default_option=1*, option_flags=0*)
