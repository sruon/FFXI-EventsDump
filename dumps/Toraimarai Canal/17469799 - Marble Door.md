...
- **7454**: The door is sealed shut by some magical force.
- **7455**: A dreadful voice intones: "This door is guarded by the Four Servants."
- **7457**: Leave the Animastery? [Yes./No.]
...
```
  ...
  2: 0x00E5 [0x24] CREATE_DIALOG(message_id=7457*, default_option=1*, option_flags=0*)
