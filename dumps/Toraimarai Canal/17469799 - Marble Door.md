...
- **7455**: The door is sealed shut by some magical force.
- **7456**: A dreadful voice intones: "This door is guarded by the Four Servants."
- **7458**: Leave the Animastery? [Yes./No.]
...
```
  ...
  2: 0x00E5 [0x24] CREATE_DIALOG(message_id=7458*, default_option=1*, option_flags=0*)
