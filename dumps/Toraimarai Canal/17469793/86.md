...
```
 ...
 46: 0x013E [0x24] CREATE_DIALOG(message_id=6402*, default_option=0*, option_flags=0x0B)
...
SUBROUTINE_0164:
 ...
 63: 0x0198 [0x07] ExtData[1]->WorkLocal[13] += 257*
 64: 0x019D [0x03] ExtData[1]->WorkLocal[14] = Work_Zone[2]
 65: 0x01A2 [0x07] ExtData[1]->WorkLocal[14] += 2305*
 66: 0x01A7 [0x03] ExtData[1]->WorkLocal[15] = Work_Zone[2]
 67: 0x01AC [0x07] ExtData[1]->WorkLocal[15] += 4353*
 ...
 72: 0x01C3 [0x48] [System] [ExtData[1]->WorkLocal[13]]:
    → "The magic stagnation is beginning to take physical shape...\u007F1\u0000\u0007"
 73: 0x01C6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 74: 0x01C7 [0x48] [System] [ExtData[1]->WorkLocal[15]]:
    → "The magic doll is responding.\u007F1\u0000\u0007"
