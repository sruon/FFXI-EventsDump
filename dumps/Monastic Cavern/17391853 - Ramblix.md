...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7338*, default_option=0*, option_flags=Work_Zone[2])
    → "What story would you like to be told? [On second thought, maybe later./The Circle of Time./An Understanding Overlord?(pt.1)./An Understanding Overlord?(pt.2)./An Understanding Overlord?(pt.3)./An Understanding Overlord?(pt.4)./An Understanding Overlord?(pt.5)./An Understanding Overlord?(pt.6)./Magicite(pt.1)./Magicite(pt.2).]"
