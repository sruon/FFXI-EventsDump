...
- **10120**: <Sigh>... To see such vistas of peace and prosperity restored to my homeland once more...
- **10121**: Greetings, friend of Abyssea. [/Ivan/Ernst/Kierron/Cyril/Willis/Vincent] is my name. My superior officer [/Gilburt/Erich/Jerrett/Adrian/Fabricius/Fabien] and I have been dispatched here to provide logistical support to allies of our cause.
- **10122**: As you endeavor to restore light to our ravaged world, so too will we endeavor to aid you in every possible way.
- **10123**: How might I assist you this day?
- **10124**: What would you like to ask about? [My current cruor balance./Resistance outpost status./Teleporting to a cavernous maw./Nothing right now.]
- **10125**: The figures in my logbook tell me you have $0 cruor to your name.
- **10129**: You wish to teleport to a cavernous maw? In that case, please tell me your precise destination.
- **10130**: Go to which area's gateway? [Abyssea - La Theine./Abyssea - Konschtat./Abyssea - Tahrongi./Abyssea - Vunkerl./Abyssea - Misareaux./Abyssea - Attohwa./Abyssea - Altepa./Abyssea - Uleguerand./Abyssea - Grauberg./I've changed my mind.]
- **10131**: $1 cruor is required for transport to the gateway to Abyssea - [La Theine/Konschtat/Tahrongi/Attohwa/Misareaux/Vunkerl/Altepa/Uleguerand/Grauberg].
- **10132**: Ah, it seems you have insufficient cruor to make that journey.
- **10133**: Will you proceed? (Cruor balance: $2) [Make it so./Make it no.]
- **10172**: Very well, friend. Should you ever find yourself in need of assistance, do not hesitate to return.
...
```
 ...
 17: 0x005E [0x1D] PRINT_EVENT_MESSAGE(message_id=10120*)
 ...
 25: 0x0089 [0x1D] PRINT_EVENT_MESSAGE(message_id=10121*)
 ...
 27: 0x008D [0x1D] PRINT_EVENT_MESSAGE(message_id=10122*)
 ...
 30: 0x0098 [0x1D] PRINT_EVENT_MESSAGE(message_id=10123*)
...
SUBROUTINE_00AB:
 33: 0x00AB [0x24] CREATE_DIALOG(message_id=10124*, default_option=0*, option_flags=ExtData[1]->WorkLocal[2])
 ...
 38: 0x00CF [0x1D] PRINT_EVENT_MESSAGE(message_id=10125*)
...
SUBROUTINE_0234:
 ...
 44: 0x0248 [0x1D] PRINT_EVENT_MESSAGE(message_id=10131*)
 ...
 50: 0x025F [0x1D] PRINT_EVENT_MESSAGE(message_id=10132*)
 ...
 58: 0x0297 [0x24] CREATE_DIALOG(message_id=10133*, default_option=1*, option_flags=0*)
...
SUBROUTINE_02DB:
 ...
 67: 0x02F5 [0x1D] PRINT_EVENT_MESSAGE(message_id=10172*)
