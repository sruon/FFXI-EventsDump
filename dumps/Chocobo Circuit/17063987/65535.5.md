...
```
  ...
  9: 0x0194 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1030, bit_index_work_offset=0x8008, condition_work_offset=0x8006)
...
SUBROUTINE_023F:
 ...
 46: 0x025B [0x41] GET_BIT_WORK_RANGE(start_bit=12*, end_bit=15*, source=ExtData[1]->WorkLocal[15], result=ExtData[1]->WorkLocal[13])
...
SUBROUTINE_027B:
 ...
 56: 0x0292 [0x41] GET_BIT_WORK_RANGE(start_bit=12*, end_bit=15*, source=ExtData[1]->WorkLocal[16], result=ExtData[1]->WorkLocal[14])
