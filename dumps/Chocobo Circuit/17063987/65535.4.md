...
```
  ...
  5: 0x006B [0x41] GET_BIT_WORK_RANGE(start_bit=12*, end_bit=15*, source=Work_Zone[38], result=ExtData[1]->WorkLocal[13])
...
SUBROUTINE_008B:
 ...
 13: 0x0096 [0x41] GET_BIT_WORK_RANGE(start_bit=12*, end_bit=15*, source=Work_Zone[39], result=ExtData[1]->WorkLocal[14])
