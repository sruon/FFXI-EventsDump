...
- **9691**: H-hey, were you eavesdropping? Don't even thinky-wink about bettaruing on "ID$3:$0-$1". You'll reduce my winnings!
- **9692**: I'm gonna getaru myself $0 when I win!
- **9695**: Whootaru, there it is! I am the champion! No timey-wime for losers! $0 comin' my way!
- **9696**: <Sniffle...sob...> Th-that's not how it's supposed to end...
...
```
  ...
  1: 0x000B [0x1D] PRINT_EVENT_MESSAGE(message_id=9691*)
  ...
  4: 0x0014 [0x1D] PRINT_EVENT_MESSAGE(message_id=9692*)
...
```
  ...
  1: 0x0024 [0x1D] PRINT_EVENT_MESSAGE(message_id=9695*)
...
```
  ...
  1: 0x0034 [0x1D] PRINT_EVENT_MESSAGE(message_id=9696*)
