...
SUBROUTINE_0129:
100: 0x0129 [0x01] GOTO 0x0030

SUBROUTINE_012C:
101: 0x012C [0x01] GOTO 0x0043

SUBROUTINE_012F:
102: 0x012F [0x01] GOTO 0x0152

SUBROUTINE_0132:
103: 0x0132 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x014B
104: 0x013A [0x03] Work_Zone[3] = ExtData[1]->WorkLocal[29]
105: 0x013F [0x1D] PRINT_EVENT_MESSAGE(message_id=8918*)
    → "Congratulations, \u0008!\u0007You are now an official member of the CRA's \u000C\u0000[San d'Oria/Bastok/Windurst] racing team.\u007F1\u0000\u0007"
106: 0x0142 [0x23] WAIT_FOR_DIALOG_INTERACTION
107: 0x0143 [0x03] Work_Zone[1] = 1*
108: 0x0148 [0x01] GOTO 0x0152

SUBROUTINE_014B:
109: 0x014B [0x1D] PRINT_EVENT_MESSAGE(message_id=8919*)
    → "I see.\u0007Please come back if you ever change your mind!\u007F1\u0000\u0007"
110: 0x014E [0x23] WAIT_FOR_DIALOG_INTERACTION
111: 0x014F [0x06] Work_Zone[1] = 0
112: 0x0152 [0x21] END_EVENT
113: 0x0153 [0x00] END_REQSTACK()
```
