...
SUBROUTINE_0877:
 15: 0x0877 [0x48] [System] [9041*]:
    → "One moment please while entries are confirmed with CRA headquarters.\u0000\u0007"
 16: 0x087A [0x06] ExtData[1]->WorkLocal[48] = 0
 17: 0x087D [0x03] Work_Zone[9] = 4294967292*
 18: 0x0882 [0x02] IF !(ExtData[1]->WorkLocal[48] > 30*) GOTO 0x08BE
 19: 0x088A [0x1C] WAIT(60* ticks)
 20: 0x088D [0x03] Work_Zone[1] = 5*
 21: 0x0892 [0x43] SEND_EVENT_UPDATE: Send pending tag to server (packet 0x005B)
 22: 0x0894 [0x43] SEND_EVENT_UPDATE: Check pending flag (skip if not pending)
 23: 0x0896 [0x02] IF !(Work_Zone[9] == 4294967292*) GOTO 0x08A1
 24: 0x089E [0x0B] ExtData[1]->WorkLocal[48]++
 25: 0x08A1 [0x02] IF !(Work_Zone[9] == 4294967290*) GOTO 0x08AE
 26: 0x08A9 [0x03] ExtData[1]->WorkLocal[48] = 31*
 27: 0x08AE [0x02] IF !(Work_Zone[9] == 4294967291*) GOTO 0x08BB
 28: 0x08B6 [0x03] ExtData[1]->WorkLocal[48] = 31*
 29: 0x08BB [0x01] GOTO 0x0882
 30: 0x08BE [0x1B] RETURN

SUBROUTINE_08BF:
 31: 0x08BF [0x46] CAMERA_CONTROL: Disable user control
 32: 0x08C1 [0x2F] Unnamed NPC (ID: 17064058/0x0104607A)->Render.Flags0 &= ~0x80000 // Bit 19
 33: 0x08C7 [0x2F] Unnamed NPC (ID: 17063948/0x0104600C)->Render.Flags0 &= ~0x80000 // Bit 19
 34: 0x08CD [0x2F] Unnamed NPC (ID: 17063949/0x0104600D)->Render.Flags0 &= ~0x80000 // Bit 19
 35: 0x08D3 [0x2F] Unnamed NPC (ID: 17063950/0x0104600E)->Render.Flags0 &= ~0x80000 // Bit 19
 36: 0x08D9 [0x2F] Unnamed NPC (ID: 17063951/0x0104600F)->Render.Flags0 &= ~0x80000 // Bit 19
 37: 0x08DF [0x2F] cameraA (ID: 17063972/0x01046024)->Render.Flags0 &= ~0x80000 // Bit 19
 38: 0x08E5 [0x2F] cameraB (ID: 17063973/0x01046025)->Render.Flags0 &= ~0x80000 // Bit 19
 39: 0x08EB [0x4E] SET_ENTITY_HIDE_FLAG: Show cameraA (ID: 17063972/0x01046024)
 40: 0x08F1 [0x4E] SET_ENTITY_HIDE_FLAG: Show cameraB (ID: 17063973/0x01046025)
 41: 0x08F7 [0x29] REQ_SET_WAIT(priority=0x80, entity_id=Unnamed NPC (ID: 17063948/0x0104600C), tag_num=0x07)
 42: 0x08FE [0x29] REQ_SET_WAIT(priority=0x80, entity_id=Unnamed NPC (ID: 17063949/0x0104600D), tag_num=0x07)
 43: 0x0905 [0x29] REQ_SET_WAIT(priority=0x80, entity_id=Unnamed NPC (ID: 17063950/0x0104600E), tag_num=0x07)
 44: 0x090C [0x03] Work_Zone[32] = ExtData[1]->WorkLocal[25]
 45: 0x0911 [0x03] Work_Zone[35] = ExtData[1]->WorkLocal[50]
 46: 0x0916 [0x03] Work_Zone[33] = ExtData[1]->WorkLocal[30]
 47: 0x091B [0x03] Work_Zone[34] = ExtData[1]->WorkLocal[31]
 48: 0x0920 [0x03] Work_Zone[36] = ExtData[1]->WorkLocal[33]
 49: 0x0925 [0x27] REQ_SET(priority=0x80, entity_id=Unnamed NPC (ID: 17064058/0x0104607A), tag_num=0x02)
 50: 0x092C [0x2A] GET_REQ_LEVEL(level=128, entity_id=Unnamed NPC (ID: 17064058/0x0104607A))
 51: 0x0932 [0x1B] RETURN
```
