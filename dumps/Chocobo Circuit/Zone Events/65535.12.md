...
SUBROUTINE_06B5:
 ...
 42: 0x06F1 [0x03] ExtData[1]->WorkLocal[14] = 0*
 43: 0x06F6 [0x02] IF !(ExtData[1]->WorkLocal[11] >= 32*) GOTO 0x0728
 44: 0x06FE [0xBF] CHOCOBO_RACING_PARAMETER_GETTER(param_type=0x40)
 45: 0x0700 [0x03] 0x0B80 = 0x1200
 46: 0x0705 [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 323026966/0x13410016))
 47: 0x070A [0x00] END_REQSTACK()

 48: 0x0728 [0x03] ExtData[1]->WorkLocal[15] = 0*
 49: 0x072D [0x08] ExtData[1]->WorkLocal[15] -= ExtData[1]->WorkLocal[14]
 50: 0x0732 [0x9D] ExtData[1]->WorkLocal[11] = Work_Zone[0*][ExtData[1]->WorkLocal[14]] // Via remapped space
 51: 0x073A [0x07] ExtData[1]->WorkLocal[15] += ExtData[1]->WorkLocal[14]
 52: 0x073F [0x9D] ExtData[1]->WorkLocal[11] = Work_Zone[0*][ExtData[1]->WorkLocal[13]] // Via remapped space
 53: 0x0747 [0x14] ExtData[1]->WorkLocal[15] *= 1000*
 54: 0x074C [0x15] ExtData[1]->WorkLocal[15] /= ExtData[1]->WorkLocal[13]
 55: 0x0751 [0x03] ExtData[1]->WorkLocal[13] = ExtData[1]->WorkLocal[15]
 56: 0x0756 [0x03] ExtData[1]->WorkLocal[14] = ExtData[1]->WorkLocal[11]
 57: 0x075B [0x14] ExtData[1]->WorkLocal[14] *= 8*
 58: 0x0760 [0x07] ExtData[1]->WorkLocal[14] += ExtData[1]->WorkLocal[18]
 59: 0x0765 [0x9D] ExtData[1]->WorkLocal[14] = Work_Zone[1*][ExtData[1]->WorkLocal[14]] // Via remapped space
 60: 0x076D [0x14] ExtData[1]->WorkLocal[13] *= ExtData[1]->WorkLocal[14]
 61: 0x0772 [0x03] ExtData[1]->WorkLocal[8] = ExtData[1]->WorkLocal[13]
 62: 0x0777 [0x15] ExtData[1]->WorkLocal[8] /= 1000*
 63: 0x077C [0x32] ExtData[1]->MainSpeed = ExtData[1]->WorkLocal[8] * 0.1
 64: 0x077F [0x03] ExtData[1]->WorkLocal[9] = ExtData[1]->WorkLocal[23]
 65: 0x0784 [0x03] ExtData[1]->WorkLocal[10] = ExtData[1]->WorkLocal[24]
 66: 0x0789 [0x1B] RETURN
```

## Data or dead code:

```
# Data Section: 0x06D4 (29 bytes)
     0x06D4: 14 00 15 00 0E 00 03 0D 00 08 80 08 0D 00 0E 00
     0x06E4: 07 09 00 0D 00 03 0E 00 0D 00 01 F6 06
# Data Section: 0x070B (29 bytes)
     0x070B: 14 00 16 00 0F 00 03 0D 00 08 80 08 0D 00 0F 00
     0x071B: 07 0A 00 0D 00 03 0F 00 0D 00 01 2D 07
# Data Section: 0x078A (48 bytes)
     0x078A: 13 80 1D 80 1C 80 11 80 22 80 20 80 08 80 15 80
     0x079A: 03 80 12 80 13 80 1D 80 1C 80 11 80 22 80 20 80
     0x07AA: 03 80 12 80 13 80 1D 80 1C 80 11 80 22 80 20 80
```