...
1D70: 06 80 06 80 10 80 DF 80  EE 80 22 80 EF 80 A8 80  ..........".....
...
848: 0x1325 [0xC3] COPY_STRING_TO_ARRAY(array_index=0x8006, string_value=0x103C, additional_value=0x1040)
...
922: 0x14BF [0xC3] COPY_STRING_TO_ARRAY(array_index=0x8006, string_value=0x103C, additional_value=0x1040)
...
SUBROUTINE_1685:
961: 0x1685 [0x02] IF !(2* == 0*) GOTO 0x16E3
...
972: 0x16E3 [0x02] IF !(2* == 1*) GOTO 0x1741
...
983: 0x1741 [0x02] IF !(2* == 2*) GOTO 0x179F
...
1223: 0x1C92 [0x02] IF !(0x0610 >= 0x1A80) GOTO 0x1D05
...
1228: 0x1CA6 [0x1D] PRINT_EVENT_MESSAGE(message_id=9028*)
...
# Data Section: 0x1CAE (88 bytes)
     ...
     0x1CEE: 0B 80 0B 80 0B 80 06 80 06 80 06 80 06 80 06 80
     0x1CFE: 00 80 27 80 27 80 26 80
...
# Dead code (unreachable instructions):
     ...
     0x1E9D [0x81] SET_ENTITY_BLINKING(blink_flag=0x2F, entity=Unknown NPC (ID: 109062016/0x06802780))
     0x1EA3 [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 2147909638/0x80068006))
     0x1EA8 [0x06] 0x0680 = 0
     0x1EAB [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 2148237323/0x800B800B))
     0x1EB0 [0x22] ENTITY_HIDE_FLAG(enabled=0x81)
     ...
     0x1EBF [0x81] SET_ENTITY_BLINKING(blink_flag=0x2A, entity=Unknown NPC (ID: 192940929/0x0B800B81))
     0x1EC5 [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 2148237323/0x800B800B))
     0x1ECA [0x0B] 0x0B80++
     0x1ECD [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 2148237323/0x800B800B))
     0x1ED2 [0x0B] 0x0B80++
     0x1ED5 [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 2148237323/0x800B800B))
     0x1EDA [0x0B] 0x0B80++
     0x1EDD [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 2148237323/0x800B800B))
     0x1EE2 [0x0B] 0x2B80++
     0x1EE5 [0x81] SET_ENTITY_BLINKING(blink_flag=0x2C, entity=Unknown NPC (ID: 780217729/0x2E812D81))
