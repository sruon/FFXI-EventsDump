...
- **9488**: Here you can check the latest stats for the next race.
- **9489**: Preparations for the next race are currently underway. Please wait just a bit longer.
...
```
  ...
  4: 0x0012 [0x1D] PRINT_EVENT_MESSAGE(message_id=9489*)
 ...
 15: 0x003F [0x1D] PRINT_EVENT_MESSAGE(message_id=9488*)
...
SUBROUTINE_004D:
 19: 0x004D [0x24] CREATE_DIALOG(message_id=9448*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_0065:
 ...
 25: 0x006D [0x24] CREATE_DIALOG(message_id=9010*, default_option=0*, option_flags=0*)
 ...
 57: 0x011A [0x1D] PRINT_EVENT_MESSAGE(message_id=9452*)
...
176: 0x046B [0x1D] PRINT_EVENT_MESSAGE(message_id=9494*)
...
182: 0x0487 [0x1D] PRINT_EVENT_MESSAGE(message_id=9452*)
    → "The weather forecast for today's race calls for [-/clear skies/cloudy skies/-/a heat wave/-/rain/-/sandstorms/-/wind/-/snow/-/thunderstorms/-/Auroras/-/dark skies/-]."
