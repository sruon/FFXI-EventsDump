...
SUBROUTINE_025F:
 74: 0x025F [0x03] ExtData[1]->WorkLocal[3] = 1*
 75: 0x0264 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [EventEntity, EventEntity], work=[200*, 0*]
 76: 0x0275 [0x55] WAIT_LOAD_SCHEDULER: Wait for scheduler "fdo1" with entities [EventEntity, EventEntity], work=200*
 77: 0x0284 [0x03] Work_Zone[1] = 0*
 78: 0x0289 [0x40] SET_BIT_WORK_RANGE(start_bit=3*, end_bit=6*, target=Work_Zone[1], source=ExtData[1]->WorkLocal[2])
 79: 0x0292 [0x43] SEND_EVENT_UPDATE: Send pending tag to server (packet 0x005B)
 80: 0x0294 [0x43] SEND_EVENT_UPDATE: Check pending flag (skip if not pending)
 81: 0x0296 [0x46] CAMERA_CONTROL: Disable user control
 82: 0x0298 [0x38] SET_CLIENT_EVENT_MODE(mode=27*)
 83: 0x029B [0x4E] SET_ENTITY_HIDE_FLAG: Hide LocalPlayer
 84: 0x02A1 [0x2F] Unnamed NPC (ID: 17063975/0x01046027)->Render.Flags0 &= ~0x80000 // Bit 19
 85: 0x02A7 [0x4E] SET_ENTITY_HIDE_FLAG: Show Unnamed NPC (ID: 17063975/0x01046027)
 86: 0x02AD [0x03] ExtData[1]->WorkLocal[8] = Work_Zone[3]
 87: 0x02B2 [0x03] ExtData[1]->WorkLocal[9] = Work_Zone[4]
 88: 0x02B7 [0x03] ExtData[1]->WorkLocal[10] = Work_Zone[5]
 89: 0x02BC [0x03] ExtData[1]->WorkLocal[11] = Work_Zone[6]
 90: 0x02C1 [0x03] ExtData[1]->WorkLocal[12] = Work_Zone[7]
 91: 0x02C6 [0x03] ExtData[1]->WorkLocal[13] = Work_Zone[8]
 92: 0x02CB [0x03] Work_Zone[2] = 0*
 93: 0x02D0 [0x41] Work_Zone[3] = ExtData[1]->WorkLocal[12] (bits 25*-27*)
 94: 0x02D9 [0x3E] IF !(ExtData[1]->WorkLocal[11] bit 16*) GOTO 0x02E8
 95: 0x02E0 [0x03] Work_Zone[4] = 1*
 96: 0x02E5 [0x01] GOTO 0x02EB
 97: 0x02E8 [0x06] Work_Zone[4] = 0
 98: 0x02EB [0x3E] IF !(ExtData[1]->WorkLocal[11] bit 0*) GOTO 0x02FA
 99: 0x02F2 [0x03] Work_Zone[5] = 1*
100: 0x02F7 [0x01] GOTO 0x02FD
101: 0x02FA [0x06] Work_Zone[5] = 0
102: 0x02FD [0x3E] IF !(ExtData[1]->WorkLocal[11] bit 8*) GOTO 0x030C
103: 0x0304 [0x03] Work_Zone[6] = 1*
104: 0x0309 [0x01] GOTO 0x030F
105: 0x030C [0x06] Work_Zone[6] = 0
106: 0x030F [0x27] REQ_SET(priority=0x05, entity_id=Unnamed NPC (ID: 17063975/0x01046027), tag_num=0x06)
107: 0x0316 [0x2A] GET_REQ_LEVEL(level=5, entity_id=Unnamed NPC (ID: 17063975/0x01046027))
108: 0x031C [0x41] Work_Zone[4] = ExtData[1]->WorkLocal[12] (bits 24*-24*)
109: 0x0325 [0x41] Work_Zone[5] = ExtData[1]->WorkLocal[12] (bits 17*-19*)
110: 0x032E [0xBA] SET_ENTITY_POSITION(entity_id=Unnamed NPC (ID: 17063975/0x01046027), pos_x=-52.464*, pos_z=-80.352*, pos_y=0.000*, direction=184.2°*)
111: 0x033B [0x80] LOAD_WAIT(entity=Unnamed NPC (ID: 17063975/0x01046027))
112: 0x0340 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s038" with entities [EventEntity, EventEntity], work=[288*, 0*]
113: 0x0351 [0x1C] WAIT(15* ticks)
114: 0x0354 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi2" with entities [EventEntity, EventEntity], work=[200*, 0*]
115: 0x0365 [0x55] WAIT_LOAD_SCHEDULER: Wait for scheduler "fdi2" with entities [EventEntity, EventEntity], work=200*
116: 0x0374 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "nak0" with entities [Unnamed NPC (ID: 17063975/0x01046027), Unnamed NPC (ID: 17063975/0x01046027)], work=223*
117: 0x0383 [0x1C] WAIT(35* ticks)
118: 0x0386 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "nak2" with entities [Unnamed NPC (ID: 17063975/0x01046027), Unnamed NPC (ID: 17063975/0x01046027)], work=[144*, 0*]
119: 0x0397 [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[2]
120: 0x039C [0x07] Work_Zone[2] += 1*
121: 0x03A1 [0x48] [System] [9437*]:
    → "Entry No. 
\u0000 \u0001` \u001C\u0001 \u0001`\u007F1\u0000\u0007"
122: 0x03A4 [0x23] WAIT_FOR_DIALOG_INTERACTION
123: 0x03A5 [0x03] Work_Zone[3] = ExtData[1]->WorkLocal[8]
124: 0x03AA [0x9D] Work_Zone[5] = 0x06BA[ExtData[1]->WorkLocal[10]] // Read WORD
125: 0x03B2 [0x03] Work_Zone[6] = ExtData[1]->WorkLocal[9]
126: 0x03B7 [0x02] IF !(Work_Zone[5] == 0*) GOTO 0x03C6
127: 0x03BF [0x48] [System] [9439*]:
...
129: 0x03C3 [0x01] GOTO 0x03CA
130: 0x03C6 [0x48] [System] [9438*]:
    → "Affiliation: \u000C\u0001[None/San d'Oria/Bastok/Windurst]\u0007Gender: \u000C\u0002[Male/Female]\u0007Orders: \u000C\u0004[Sprint/Keep Pace/Final Spurt]\u0007Equipment: \u007F\u0000\u0001\u0001\u0005#\u0002\u0003\u0000\u0000\u007F1\u0000\u0007"
131: 0x03C9 [0x23] WAIT_FOR_DIALOG_INTERACTION
132: 0x03CA [0x41] Work_Zone[2] = ExtData[1]->WorkLocal[11] (bits 0*-7*)
133: 0x03D3 [0x15] Work_Zone[2] /= 32*
134: 0x03D8 [0x41] Work_Zone[3] = ExtData[1]->WorkLocal[11] (bits 8*-15*)
135: 0x03E1 [0x15] Work_Zone[3] /= 32*
136: 0x03E6 [0x41] Work_Zone[4] = ExtData[1]->WorkLocal[11] (bits 16*-23*)
137: 0x03EF [0x15] Work_Zone[4] /= 32*
138: 0x03F4 [0x41] Work_Zone[5] = ExtData[1]->WorkLocal[11] (bits 24*-31*)
139: 0x03FD [0x15] Work_Zone[5] /= 32*
140: 0x0402 [0x48] [System] [9002*]:
...
142: 0x0406 [0x41] Work_Zone[2] = ExtData[1]->WorkLocal[12] (bits 20*-23*)
143: 0x040F [0x41] Work_Zone[3] = ExtData[1]->WorkLocal[12] (bits 9*-12*)
144: 0x0418 [0x41] Work_Zone[4] = ExtData[1]->WorkLocal[12] (bits 13*-16*)
145: 0x0421 [0x48] [System] [9003*]:
...
146: 0x0424 [0x23] WAIT_FOR_DIALOG_INTERACTION
147: 0x0425 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "nak0" with entities [Unnamed NPC (ID: 17063975/0x01046027), Unnamed NPC (ID: 17063975/0x01046027)], work=223*
148: 0x0434 [0x1C] WAIT(35* ticks)
149: 0x0437 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "nak2" with entities [Unnamed NPC (ID: 17063975/0x01046027), Unnamed NPC (ID: 17063975/0x01046027)], work=[144*, 0*]
150: 0x0448 [0x1C] WAIT(120* ticks)
151: 0x044B [0x06] ExtData[1]->WorkLocal[1] = 0
152: 0x044E [0x01] GOTO 0x0065
153: 0x0451 [0x01] GOTO 0x04B8
154: 0x0454 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x0491
155: 0x045C [0x03] Work_Zone[1] = 4*
156: 0x0461 [0x43] SEND_EVENT_UPDATE: Send pending tag to server (packet 0x005B)
157: 0x0463 [0x43] SEND_EVENT_UPDATE: Check pending flag (skip if not pending)
158: 0x0465 [0xB4] UI_WINDOW_STRING_HANDLER(case=0x11 - Open chocobo racing card window, work_offset1=Work_Zone[9], work_offset2=Work_Zone[7])
159: 0x046B [0x1D] PRINT_EVENT_MESSAGE(message_id=9482*)
    → "The following is a list of the chocobos entered in the race.\u007F1\u0000\u0007"
160: 0x046E [0x23] WAIT_FOR_DIALOG_INTERACTION
161: 0x046F [0xB4] UI_WINDOW_STRING_HANDLER(case=0x12 - Close chocobo racing card window, work_offset1=0*, work_offset2=0*)
162: 0x0475 [0x02] IF !(ExtData[1]->WorkLocal[13] == 0*) GOTO 0x0482
163: 0x047D [0x03] ExtData[1]->WorkLocal[13] = 1*
164: 0x0482 [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[13]
165: 0x0487 [0x1D] PRINT_EVENT_MESSAGE(message_id=9440*)
    → "The weather forecast for today's race calls for \u000C\u0000[-/clear skies/cloudy skies/-/a heat wave/-/rain/-/sandstorms/-/wind/-/snow/-/thunderstorms/-/Auroras/-/dark skies/-].\u007F1\u0000\u0007"
166: 0x048A [0x23] WAIT_FOR_DIALOG_INTERACTION
167: 0x048B [0x01] GOTO 0x004D

SUBROUTINE_04B8:
168: 0x04B8 [0x21] END_EVENT
169: 0x04B9 [0x00] END_REQSTACK()
```
...
\u0000 aquan-type creature\u007F\u0012\u0000[/s].\u0007Weather/Day: \u000C\u0005[o\u001F/o /o!/o"/o#/o$/o%/o&/o\u001Fo!o#o%/o o"o$o&/o\u001Fo o!o"o#o$o%o&].\u0007Equipment: Target item must be equipped.\u007F1\u0000\u0007"
     ...
     0x0630 [0x4B] UPDATE_ENTITY_YAW(entity=Unknown NPC (ID: 1300253824/0x4D804C80), yaw=110.39°)
     ...
     0x0658 [0x41] 0x5680 = 0x5580 (bits 21632-17024)
