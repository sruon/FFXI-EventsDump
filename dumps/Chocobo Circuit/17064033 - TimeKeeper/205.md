...
165: 0x02ED [0x06] Work_Zone[2] = 0
166: 0x02F0 [0x02] IF !(1* == 1*) GOTO 0x0335
167: 0x02F8 [0x24] CREATE_DIALOG(message_id=9056*, default_option=0*, option_flags=0*)
    → "Enter #\u0001F
\u0000\u0007\u000B\u0002O.\u0007\u0002P.\u0007\u0002Q.\u0007\u0002R.\u0007\u0002S.\u0007\u0002T.\u0007\u0002U.\u0007\u0002V.\u0007\u0002W.\u0007\u0002X.\u0007Cancel.\u0007Confirm.\u007F1\u0000\u0007"
168: 0x02FF [0x25] WAIT_DIALOG_SELECT()
169: 0x0300 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x030B
170: 0x0308 [0x01] GOTO 0x030B
171: 0x030B [0x02] IF !(Work_Zone[0] > 9*) GOTO 0x0320
172: 0x0335 [0x1B] RETURN
```

## Data or dead code:

```
# Data Section: 0x02DD (16 bytes)
     0x02DD: 22 80 23 80 24 80 25 80 26 80 27 80 28 80 29 80
# Dead code (unreachable instructions):
     0x0313 [0x14] Work_Zone[2] *= 10*
# Dead code (unreachable instructions):
     0x0318 [0x07] Work_Zone[2] += Work_Zone[0]
# Dead code (unreachable instructions):
     0x031D [0x01] GOTO 0x0332
# Dead code (unreachable instructions):
     0x0320 [0x02] IF !(Work_Zone[0] == 10*) GOTO 0x0331
# Dead code (unreachable instructions):
     0x0328 [0x03] Work_Zone[2] = 4294967295*
# Dead code (unreachable instructions):
     0x032D [0x1B] RETURN
# Dead code (unreachable instructions):
     0x032E [0x01] GOTO 0x0332
# Dead code (unreachable instructions):
     0x0331 [0x1B] RETURN
# Dead code (unreachable instructions):
     0x0332 [0x01] GOTO 0x02F0
```