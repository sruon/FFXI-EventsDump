...
```
  0: 0x0005 [0x41] ExtData[1]->WorkLocal[0] = Work_Zone[67] (bits 16*-31*)
...
```
  0: 0x0025 [0x9D] 0* = Work_Zone[9*][ExtData[1]->WorkLocal[3]] // Via remapped space
  1: 0x002D [0x9D] 1* = Work_Zone[9*][ExtData[1]->WorkLocal[4]] // Via remapped space
  2: 0x0035 [0x9D] 2* = Work_Zone[9*][ExtData[1]->WorkLocal[5]] // Via remapped space
  3: 0x003D [0x9D] 3* = Work_Zone[9*][ExtData[1]->WorkLocal[6]] // Via remapped space
...
```
  ...
  9: 0x0194 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=Work_Zone[48], bit_index_work_offset=7*, condition_work_offset=1*)
...
SUBROUTINE_01EE:
 ...
 29: 0x0202 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=Work_Zone[48], bit_index_work_offset=15*, condition_work_offset=1*)
...
SUBROUTINE_023F:
 ...
 46: 0x025B [0x41] ExtData[1]->WorkLocal[13] = ExtData[1]->WorkLocal[15] (bits 28*-31*)
...
SUBROUTINE_0280:
 ...
 56: 0x0292 [0x41] ExtData[1]->WorkLocal[14] = ExtData[1]->WorkLocal[16] (bits 28*-31*)
