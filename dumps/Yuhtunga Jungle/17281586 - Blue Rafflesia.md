...
- **7680**: A large flower is blooming. You can see something inside it...
- **7681**: Look inside the flower? [Yes./No.]
...
```
  0: 0x0001 [0x48] [System] [7680*]:
    → "A large flower is blooming. You can see something inside it..."
  1: 0x0004 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=7681*, default_option=0*, option_flags=0*)
...
```
  0: 0x003F [0x48] [System] [7680*]:
    → "A large flower is blooming. You can see something inside it..."
  1: 0x0042 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0043 [0x24] CREATE_DIALOG(message_id=7681*, default_option=0*, option_flags=0*)
    → "Look inside the flower? [Yes./No.]"
