...
| [21](#event-21)       | 0x0001       |     62 |             15 |
| [24](#event-24)       | 0x003F       |     62 |             15 |
...
- **7681**: A large flower is blooming. You can see something inside it...
- **7682**: Look inside the flower? [Yes./No.]
...
```
  0: 0x0001 [0x48] [System] [7681*]:
    → "A large flower is blooming. You can see something inside it..."
  1: 0x0004 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=7682*, default_option=0*, option_flags=0*)
...
```
  0: 0x003F [0x48] [System] [7681*]:
    → "A large flower is blooming. You can see something inside it..."
  1: 0x0042 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0043 [0x24] CREATE_DIALOG(message_id=7682*, default_option=0*, option_flags=0*)
    → "Look inside the flower? [Yes./No.]"
  ...
  7: 0x0059 [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "raf1" with entities [EventEntity, EventEntity]
