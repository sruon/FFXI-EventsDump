...
```
  0: 0x0010 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=453.368*, z=258.964*, y=19.120*, direction=167.9°*
...
```
  ...
  1: 0x001D [0x1F] MOVE_ENTITY: EventEntity moves to X=436.765*, Z=259.551*, Y=20.300*
  2: 0x0025 [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x0027 [0x33] EventEntity->Render.Flags0 |= 0x200000 // Bit 21 (flag=0x01)
  4: 0x0029 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=414.558*, z=244.759*, y=18.342*, direction=157.9°*
