...
- **7670**: This is the Firebloom Tree.
- **7671**: Cut off a vine? [Yes./No.]
- **7674**: This is the most blessed spot on the tree.
- **7675**: Cut off a piece of wood? [Yes./No.]
...
```
  ...
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=7671*, default_option=0*, option_flags=0*)
...
```
  0: 0x0032 [0x48] [System] [7674*]:
    → "This is the most blessed spot on the tree."
  1: 0x0035 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0036 [0x24] CREATE_DIALOG(message_id=7675*, default_option=0*, option_flags=0*)
