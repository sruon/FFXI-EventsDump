...
- **7905**: These are the supplies you are to deliver to the stronghold in this area.
- **7906**: The supply unit carrying rations and munitions to our stronghold in this area was attacked en route, and forced to abandon the cargo. You are to locate the supplies and deliver them to their final destination.
- **7907**: Some of the items are raw and will spoil if not delivered immediately. You must hurry.
- **7908**: Some of the items are very delicate and will be destroyed if you are not careful. Avoid all confrontation with the enemy.
- **7909**: Now move out.
- **7910**: What are you waiting for, <Player>!? Move out!
- **7911**: This is an Allied Checkpoint Garrison.
- **7915**: Alright, <Player>. The reinforcements are ready to be escorted to the stronghold in this area.
- **7916**: Welcome, <Player>. The troops you are to guide to the stronghold haven't arrived yet. Please wait a little longer.
- **7935**: About time you showed up, soldier. This here's the shipment of materials you'll be transporting.
- **7936**: I suspect you've already been briefed, but this is some volatile, dangerous stuff. But you signed up for this mission, so we're counting on you to deliver it to the stronghold before its power dissipates.
- **7937**: You'd best deliver that to the stronghold while it still packs some oomph.
...
```
  ...
  2: 0x0004 [0x1D] PRINT_EVENT_MESSAGE(message_id=7906*)
...
```
  ...
  9: 0x002D [0x1D] PRINT_EVENT_MESSAGE(message_id=7911*)
 ...
 17: 0x0046 [0x1D] PRINT_EVENT_MESSAGE(message_id=7910*)
 ...
 25: 0x005F [0x1D] PRINT_EVENT_MESSAGE(message_id=7916*)
 ...
 34: 0x007F [0x1D] PRINT_EVENT_MESSAGE(message_id=7906*)
    → "The supply unit carrying rations and munitions to our stronghold in this area was attacked en route, and forced to abandon the cargo. You are to locate the supplies and deliver them to their final destination."
 35: 0x0082 [0x23] WAIT_FOR_DIALOG_INTERACTION
 36: 0x0083 [0x01] GOTO 0x008A
 37: 0x0086 [0x1D] PRINT_EVENT_MESSAGE(message_id=7905*)
...
SUBROUTINE_008A:
 ...
 40: 0x0091 [0x1D] PRINT_EVENT_MESSAGE(message_id=7907*)
 ...
 43: 0x009C [0x1D] PRINT_EVENT_MESSAGE(message_id=7908*)
 ...
 45: 0x00A0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7909*)
    → "Now move out."
 ...
 53: 0x00BB [0x1D] PRINT_EVENT_MESSAGE(message_id=7915*)
 ...
 62: 0x00D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7935*)
 ...
 64: 0x00DD [0x1D] PRINT_EVENT_MESSAGE(message_id=7936*)
 ...
 66: 0x00E1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7909*)
    → "Now move out."
 ...
 75: 0x00FF [0x1D] PRINT_EVENT_MESSAGE(message_id=7937*)
...
```
  ...
  2: 0x0110 [0x1D] PRINT_EVENT_MESSAGE(message_id=7908*)
    → "Some of the items are very delicate and will be destroyed if you are not careful. Avoid all confrontation with the enemy."
...
```
  ...
  2: 0x011B [0x1D] PRINT_EVENT_MESSAGE(message_id=7907*)
    → "Some of the items are raw and will spoil if not delivered immediately. You must hurry."
...
```
  ...
  2: 0x0126 [0x1D] PRINT_EVENT_MESSAGE(message_id=7909*)
    → "Now move out."
