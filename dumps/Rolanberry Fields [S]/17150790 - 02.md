...
```
  ...
  1: 0x0005 [0x1F] MOVE_ENTITY: EventEntity moves to X=-364.391*, Z=-81.758*, Y=0.693*
...
```
  ...
  1: 0x0014 [0x1F] MOVE_ENTITY: EventEntity moves to X=-284.391*, Z=-98.758*, Y=0.693*
...
```
  0: 0x0020 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-364.391*, z=-81.758*, y=0.693*, direction=334.2°*
