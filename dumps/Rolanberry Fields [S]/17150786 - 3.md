...
|---------|-------------|-------------|
|       0 | 0x0028      |          40 |
|       1 | 0xFFFA77E1  |  4294604769 |
|       2 | 0xFFFEC792  |  4294887314 |
|       3 | 0x029C      |         668 |
|       4 | 0xFFFBB061  |  4294684769 |
|       5 | 0xFFFE852A  |  4294870314 |
|       6 | 0x0EDB      |        3803 |
...
```
  ...
  1: 0x0005 [0x1F] MOVE_ENTITY: EventEntity moves to X=-362.527*, Z=-79.982*, Y=0.668*
...
```
  ...
  1: 0x0014 [0x1F] MOVE_ENTITY: EventEntity moves to X=-282.527*, Z=-96.982*, Y=0.668*
...
```
  0: 0x0020 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-362.527*, z=-79.982*, y=0.668*, direction=334.2°*
