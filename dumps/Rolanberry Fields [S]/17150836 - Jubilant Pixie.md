...
- **8016**: By my troth, what a thrilling battle! When thou landed the felling blow, a shiver ran down my wings! As promised, here is thy reward.
- **8017**: Dost thou find this enchantment to thy liking?
- **8018**: Accept the item? [Accept./Refuse. ($0 times remaining)]
- **8019**: Splendid! May it serve thee well.
- **8021**: Ah, 'tis unfortunate. Sadly, my folk are not well-versed in the penchants of adventurers these days...
- **8022**: In that event, we shall prepare thy weapon to be enchanted anew. May thou be once more triumphant in battle anon!
- **8023**: What's this? 'Twould appear that thy weapon can endure no further enchantments.
- **8024**: Though it may fall short of thy expectations, pray accept it.
- **8025**: Otherwise, we shall have no choice but to dispose of it.
- **8026**: Many thanks for thine assistance!
- **8027**: Pray accept this $0 as but a humble token of our gratitude.
...
0010: 02 80 03 80 02 10 02 00  41 00 80 04 80 02 10 09  ........A.......
0020: 00 03 03 00 05 80 08 03  00 09 00 03 05 00 03 10  ................
...
0090: 01 93 01 02 02 00 05 80  80 A3 00 03 04 00 0F 80  ................
00A0: 01 93 01 02 02 00 03 80  80 B3 00 03 04 00 10 80  ................
00B0: 01 93 01 02 02 00 00 80  80 C3 00 03 04 00 11 80  ................
00C0: 01 93 01 02 02 00 12 80  80 D3 00 03 04 00 13 80  ................
00D0: 01 93 01 02 02 00 04 80  80 E3 00 03 04 00 14 80  ................
...
```
 ...
 15: 0x004F [0x1D] PRINT_EVENT_MESSAGE(message_id=8016*)
...
SUBROUTINE_0193:
 ...
 78: 0x019D [0x1D] PRINT_EVENT_MESSAGE(message_id=8017*)
...
SUBROUTINE_01A4:
 ...
 82: 0x01A9 [0x24] CREATE_DIALOG(message_id=8018*, default_option=0*, option_flags=0*)
 ...
 90: 0x01CF [0x1D] PRINT_EVENT_MESSAGE(message_id=8019*)
...
105: 0x0222 [0x1D] PRINT_EVENT_MESSAGE(message_id=8021*)
...
107: 0x0226 [0x1D] PRINT_EVENT_MESSAGE(message_id=8022*)
...
```
  ...
  6: 0x0260 [0x1D] PRINT_EVENT_MESSAGE(message_id=8026*)
  ...
  9: 0x0269 [0x1D] PRINT_EVENT_MESSAGE(message_id=8027*)
