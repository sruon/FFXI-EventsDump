...
```
  ...
  1: 0x0005 [0x1F] MOVE_ENTITY: EventEntity moves to X=-360.346*, Z=-77.556*, Y=0.651*
...
```
  0: 0x0020 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-360.346*, z=-77.556*, y=0.651*, direction=326.4°*
