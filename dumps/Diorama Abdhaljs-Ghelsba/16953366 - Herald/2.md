...
SUBROUTINE_0209:
 66: 0x0209 [0x02] IF !(Work_Zone[9] == 4*) GOTO 0x0218
 67: 0x0211 [0x1D] PRINT_EVENT_MESSAGE(message_id=7821*)
    → "The minimum level requirement is currently set at 
\u0000.\u0007I'm sorry, but your entry is denied.\u007F1\u0000\u0007"
 68: 0x0214 [0x23] WAIT_FOR_DIALOG_INTERACTION
 69: 0x0215 [0x01] GOTO 0x0227

SUBROUTINE_0218:
 70: 0x0218 [0x02] IF !(Work_Zone[9] == 5*) GOTO 0x0227
 71: 0x0220 [0x1D] PRINT_EVENT_MESSAGE(message_id=7814*)
    → "You are already a\u000C\u0001[ / temporary ]member of the \u000C\u0000[Wyverns/Griffons].\u007F1\u0000\u0007"
 72: 0x0223 [0x23] WAIT_FOR_DIALOG_INTERACTION
 73: 0x0224 [0x01] GOTO 0x0227

SUBROUTINE_0227:
 74: 0x0227 [0x21] END_EVENT
 75: 0x0228 [0x00] END_REQSTACK()
```
