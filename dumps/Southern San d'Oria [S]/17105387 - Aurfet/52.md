...
```
  ...
  3: 0x0010 [0x1D] PRINT_EVENT_MESSAGE(message_id=12129*)
    → "I still don't understand why our nation must lower itself to allying with such a shady lot.\u0007I've heard that the Ru'Lude Summit had its fair share of complications. Not exactly all smiles and handshakes, if you know what I mean.\u007F1\u0000\u0007"
