...
- **11121**: The minstrel of melodies is my name, For a mere $6 gil I'll recall your past. Your stories of love, anger, triumph, and shame, The river of memories runs deep and vast.
- **11122**: The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last.
- **11124**: Which memory will you have recalled? [Nothing./Wings of the Goddess Missions./San d'Oria Quests 1./San d'Oria Quests 2./San d'Oria Quests 3./Other Quests./Rhapsodies of Vana'diel.]
- **11125**: Which memory will you have recalled? [Nothing./The Queen of the Dance(pt.1)./The Queen of the Dance(pt.2)./The Queen of the Dance(pt.3)./While the Cat Is Away(pt.1)./While the Cat Is Away(pt.2)./While the Cat Is Away(pt.3)./Dancers in Distress(pt.1)./Dancers in Distress(pt.2)./Affairs of State./Sandswept Memories./Northland Exposure./Proof of Valor(pt.1)./Proof of Valor(pt.2)./Proof of Valor(pt.3)./Proof of Valor(pt.4)./Proof of Valor(pt.5)./Proof of Valor(pt.6)./Proof of Valor(pt.7)./Proof of Valor(pt.8)./A Sanguinary Prelude./Fate in Haze./The Scent of Battle(pt.1)./The Scent of Battle(pt.2)./The Scent of Battle(pt.3)./By the Fading Light./Fork in the Road./A Token of Troth.]
- **11126**: Which memory will you have recalled? [Nothing./Steamed Rams(pt.1)./Steamed Rams(pt.2)./Steamed Rams(pt.3)./Steamed Rams(pt.4)./Steamed Rams(pt.5)./Gifts of the Griffon(pt.1)./Gifts of the Griffon(pt.2)./Gifts of the Griffon(pt.3)./Gifts of the Griffon(pt.4)./Gifts of the Griffon(pt.5)./Gifts of the Griffon(pt.6)./Claws of the Griffon./Boy and the Beast(pt.1)./Boy and the Beast(pt.2)./Wrath of the Griffon(pt.1)./Wrath of the Griffon(pt.2)./Beans Ahoy!(pt.1)./Beans Ahoy!(pt.2)./Beans Ahoy!(pt.3)./Beans Ahoy!(pt.4).]
- **11127**: Which memory will you have recalled? [Nothing./Perils of the Griffon(pt.1)./Perils of the Griffon(pt.2)./Perils of the Griffon(pt.3)./Perils of the Griffon(pt.4)./Perils of the Griffon(pt.5)./In a Haze of Glory(pt.1)./In a Haze of Glory(pt.2)./The Price of Valor(pt.1)./The Price of Valor(pt.2)./Bonds That Never Die(pt.1)./Bonds That Never Die(pt.2)./Songbirds in a Snowstorm(pt.1)./Songbirds in a Snowstorm(pt.2)./Son and Father(pt.1)./Son and Father(pt.2)./Son and Father(pt.3)./Son and Father(pt.4)./Chasing Shadows.]
- **11128**: Which memory will you have recalled? [Nothing./Beast from the East(pt.1)./Beast from the East(pt.2)./Beast from the East(pt.3)./Beast from the East(pt.4)./Beast from the East(pt.5)./Beast from the East(pt.6)./Beast from the East(pt.7)./Beast from the East(pt.8)./Beast from the East(pt.9).]
- **11129**: Which memory will you have recalled? [Nothing./Downward Helix./Knot Quite There(pt.1)./Knot Quite There(pt.2)./The Long March North(pt.1)/The Long March North(pt.2)/Her Memories: Carnelian Footfalls(pt.1)./Her Memories: Carnelian Footfalls(pt.2)./Her Memories: Carnelian Footfalls(pt.3)./Her Memories: Of Malign Maladies./Drafted by the Duchy./Battle on a New Front./Trust (Young Excenmille).]
- **11130**: Which memory will you have recalled? [Nothing./Sacrifice(pt.1)./Sacrifice(pt.2)./Sacrifice(pt.3)./Delkfutt the Great(pt.1)./Delkfutt the Great(pt.2).]
