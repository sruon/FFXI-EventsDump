...
```
  ...
  2: 0x0012 [0x1D] PRINT_EVENT_MESSAGE(message_id=10959*)
    → "The Young Griffons sent you?\u0007Ah, I see. A gesture of support from one knightly order to another.\u0007The Temple Knights must strive to meet their high expectations!\u007F1\u0000\u0007"
