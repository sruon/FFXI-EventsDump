...
```
  ...
  3: 0x0010 [0x1D] PRINT_EVENT_MESSAGE(message_id=12127*)
    → "There are rumors that the Beastman Confederate numbers some 100,000 in total, but I find that hard to believe.\u0007The valor of the small Royal Knight contingent dispatched against the Orcish Hosts at Norvallen must not be overshadowed.\u007F1\u0000\u0007"
