...
- **12168**: Beyond this gateway lie the Iron Ram barracks. Here knights oil their blades before returning to the battlefield.
...
```
  ...
  3: 0x000C [0x1D] PRINT_EVENT_MESSAGE(message_id=12168*)
