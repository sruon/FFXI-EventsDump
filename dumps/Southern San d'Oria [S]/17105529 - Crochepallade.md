...
- **13035**: So you're the new scout, eh? Well, here then. Take this.
- **13037**: Are you familiar with fiendtrappers? [Fiend what now?/I practically invented them.]
- **13038**: Hmph...some scout you are. <Sigh>... The device I just issued you is called a fiendtrapper. Together with a blank fiend plate, it forms the latest in portable recording technology available to our army.
- **13039**: Calm down and listen, now. When you use the fiendtrapper, the data will be recorded to the blank fiend plate inside. Quite a marvelous invention, really.
- **13040**: Got it? Even you must have understood that explanation. Your orders are to take that device and gather enemy intel on those damnable Orcs!
- **13041**: A know-it-all, huh? Suit yourself. How about going and getting your hands on some enemy surveillance, then?
- **13043**: Quit wasting your time! I don't see any Orcs 'round here what needs spying on! Now get on with it!
- **13044**: Why do you insist on bothering me? Go and report to Rasdinice immediately!
- **13045**: What do you want? Some of us are busy. Do you know what busy means? Or do you require an explanation for that, too?
...
```
 ...
 22: 0x0064 [0x1D] PRINT_EVENT_MESSAGE(message_id=13045*)
...
SUBROUTINE_0078:
 ...
 30: 0x0080 [0x1D] PRINT_EVENT_MESSAGE(message_id=13035*)
    → "So you're the new scout, eh? Well, here then. Take this."
 31: 0x0083 [0x23] WAIT_FOR_DIALOG_INTERACTION
 32: 0x0084 [0x24] CREATE_DIALOG(message_id=13037*, default_option=0*, option_flags=0*)
 ...
 35: 0x0094 [0x1D] PRINT_EVENT_MESSAGE(message_id=13038*)
 ...
 37: 0x0098 [0x1D] PRINT_EVENT_MESSAGE(message_id=13039*)
 ...
 39: 0x009C [0x1D] PRINT_EVENT_MESSAGE(message_id=13040*)
 ...
 43: 0x00AB [0x1D] PRINT_EVENT_MESSAGE(message_id=13041*)
...
SUBROUTINE_00B2:
 ...
 49: 0x00C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=13043*)
 ...
 54: 0x00D6 [0x1D] PRINT_EVENT_MESSAGE(message_id=13044*)
