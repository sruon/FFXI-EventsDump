...
```
  ...
  3: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=11122*)
...
\u0006 gil I'd recall your past.\u0007But I find that you're lacking in cash or in fame,\u0007So until that time, my kind offer will last.\u007F1\u0000\u0007"
 ...
 21: 0x0088 [0x1D] PRINT_EVENT_MESSAGE(message_id=11122*)
    → "The minstrel of melodies is my name,\u0007For a mere 
\u0006 gil I'd recall your past.\u0007But I find that you're lacking in cash or in fame,\u0007So until that time, my kind offer will last.\u007F1\u0000\u0007"
 22: 0x008B [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x008C [0x21] END_EVENT
 24: 0x008D [0x00] END_REQSTACK()
 25: 0x008E [0x1D] PRINT_EVENT_MESSAGE(message_id=11121*)
    → "The minstrel of melodies is my name,\u0007For a mere 
\u0006 gil I'll recall your past.\u0007Your stories of love, anger, triumph, and shame,\u0007The river of memories runs deep and vast.\u007F1\u0000\u0007"
 ...
 39: 0x00D4 [0x24] CREATE_DIALOG(message_id=11124*, default_option=0*, option_flags=0x00)
    → "Which memory will you have recalled?\u0007\u000BNothing.\u0007Wings of the Goddess Missions.\u0007San d'Oria Quests 1.\u0007San d'Oria Quests 2.\u0007San d'Oria Quests 3.\u0007Other Quests.\u0007Rhapsodies of Vana'diel.\u007F1\u0000\u0007"
 40: 0x00DB [0x25] WAIT_DIALOG_SELECT()
 41: 0x00DC [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x010B

SUBROUTINE_00E4:
 42: 0x00E4 [0x24] CREATE_DIALOG(message_id=11125*, default_option=0*, option_flags=0x1002)
    → "Which memory will you have recalled?\u0007\u000BNothing.\u0007The Queen of the Dance(pt.1).\u0007The Queen of the Dance(pt.2).\u0007The Queen of the Dance(pt.3).\u0007While the Cat Is Away(pt.1).\u0007While the Cat Is Away(pt.2).\u0007While the Cat Is Away(pt.3).\u0007Dancers in Distress(pt.1).\u0007Dancers in Distress(pt.2).\u0007Affairs of State.\u0007Sandswept Memories.\u0007Northland Exposure.\u0007Proof of Valor(pt.1).\u0007Proof of Valor(pt.2).\u0007Proof of Valor(pt.3).\u0007Proof of Valor(pt.4).\u0007Proof of Valor(pt.5).\u0007Proof of Valor(pt.6).\u0007Proof of Valor(pt.7).\u0007Proof of Valor(pt.8).\u0007A Sanguinary Prelude.\u0007Fate in Haze.\u0007The Scent of Battle(pt.1).\u0007The Scent of Battle(pt.2).\u0007The Scent of Battle(pt.3).\u0007By the Fading Light.\u0007Fork in the Road.\u0007A Token of Troth.\u007F1\u0000\u0007"
...
SUBROUTINE_0113:
 50: 0x0113 [0x24] CREATE_DIALOG(message_id=11126*, default_option=0*, option_flags=0x1003)
    → "Which memory will you have recalled?\u0007\u000BNothing.\u0007Steamed Rams(pt.1).\u0007Steamed Rams(pt.2).\u0007Steamed Rams(pt.3).\u0007Steamed Rams(pt.4).\u0007Steamed Rams(pt.5).\u0007Gifts of the Griffon(pt.1).\u0007Gifts of the Griffon(pt.2).\u0007Gifts of the Griffon(pt.3).\u0007Gifts of the Griffon(pt.4).\u0007Gifts of the Griffon(pt.5).\u0007Gifts of the Griffon(pt.6).\u0007Claws of the Griffon.\u0007Boy and the Beast(pt.1).\u0007Boy and the Beast(pt.2).\u0007Wrath of the Griffon(pt.1).\u0007Wrath of the Griffon(pt.2).\u0007Beans Ahoy!(pt.1).\u0007Beans Ahoy!(pt.2).\u0007Beans Ahoy!(pt.3).\u0007Beans Ahoy!(pt.4).\u007F1\u0000\u0007"
...
SUBROUTINE_0142:
 58: 0x0142 [0x24] CREATE_DIALOG(message_id=11127*, default_option=0*, option_flags=0x1004)
    → "Which memory will you have recalled?\u0007\u000BNothing.\u0007Perils of the Griffon(pt.1).\u0007Perils of the Griffon(pt.2).\u0007Perils of the Griffon(pt.3).\u0007Perils of the Griffon(pt.4).\u0007Perils of the Griffon(pt.5).\u0007In a Haze of Glory(pt.1).\u0007In a Haze of Glory(pt.2).\u0007The Price of Valor(pt.1).\u0007The Price of Valor(pt.2).\u0007Bonds That Never Die(pt.1).\u0007Bonds That Never Die(pt.2).\u0007Songbirds in a Snowstorm(pt.1).\u0007Songbirds in a Snowstorm(pt.2).\u0007Son and Father(pt.1).\u0007Son and Father(pt.2).\u0007Son and Father(pt.3).\u0007Son and Father(pt.4).\u0007Chasing Shadows.\u007F1\u0000\u0007"
...
SUBROUTINE_0171:
 66: 0x0171 [0x24] CREATE_DIALOG(message_id=11128*, default_option=0*, option_flags=0x1005)
    → "Which memory will you have recalled?\u0007\u000BNothing.\u0007Beast from the East(pt.1).\u0007Beast from the East(pt.2).\u0007Beast from the East(pt.3).\u0007Beast from the East(pt.4).\u0007Beast from the East(pt.5).\u0007Beast from the East(pt.6).\u0007Beast from the East(pt.7).\u0007Beast from the East(pt.8).\u0007Beast from the East(pt.9).\u007F1\u0000\u0007"
...
SUBROUTINE_01A0:
 74: 0x01A0 [0x24] CREATE_DIALOG(message_id=11129*, default_option=0*, option_flags=0x1006)
    → "Which memory will you have recalled?\u0007\u000BNothing.\u0007Downward Helix.\u0007Knot Quite There(pt.1).\u0007Knot Quite There(pt.2).\u0007The Long March North(pt.1)\u0007The Long March North(pt.2)\u0007Her Memories: Carnelian Footfalls(pt.1).\u0007Her Memories: Carnelian Footfalls(pt.2).\u0007Her Memories: Carnelian Footfalls(pt.3).\u0007Her Memories: Of Malign Maladies.\u0007Drafted by the Duchy.\u0007Battle on a New Front.\u0007Trust (Young Excenmille).\u007F1\u0000\u0007"
...
SUBROUTINE_01CF:
 82: 0x01CF [0x24] CREATE_DIALOG(message_id=11130*, default_option=0*, option_flags=0x1007)
    → "Which memory will you have recalled?\u0007\u000BNothing.\u0007Sacrifice(pt.1).\u0007Sacrifice(pt.2).\u0007Sacrifice(pt.3).\u0007Delkfutt the Great(pt.1).\u0007Delkfutt the Great(pt.2).\u007F1\u0000\u0007"
