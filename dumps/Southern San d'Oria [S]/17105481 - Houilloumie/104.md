...
```
  ...
  6: 0x0048 [0x1D] PRINT_EVENT_MESSAGE(message_id=12149*)
    → "If you seek to regain admission to the Knights of the Iron Ram, you must first sever ties with your nation of allegiance...and that will require Allied Notes.\u007F1\u0000\u0007"
