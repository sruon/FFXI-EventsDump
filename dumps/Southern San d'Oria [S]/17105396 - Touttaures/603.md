...
```
  ...
  2: 0x0015 [0x1D] PRINT_EVENT_MESSAGE(message_id=12103*)
    → "Out of nowhere, an enormous worm rose up from the belly of the earth itself.\u0007With its huge mouth it effortlessly swallowed up a number of nearby soldiers, who were helpless to react.\u007F1\u0000\u0007"
