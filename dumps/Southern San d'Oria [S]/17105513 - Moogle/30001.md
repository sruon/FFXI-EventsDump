...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
08A0:                   1E F0  FF FF 7F 6F 70 29 0B 69        .....op).i
08B0: 02 05 01 30 29 0B 69 02  05 01 31 20 00 21 00     ...0).i...1 .!. 
```
...
```
  ...
  3: 0x08AD [0x29] REQ_SET_WAIT(priority=0x0B, entity_id=Moogle (ID: 17105513/0x01050269), tag_num=0x30)
  4: 0x08B4 [0x29] REQ_SET_WAIT(priority=0x0B, entity_id=Moogle (ID: 17105513/0x01050269), tag_num=0x31)
