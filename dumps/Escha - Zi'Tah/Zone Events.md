...
- **7457**: Light begins to shimmer and twist as you pass your hand over it.
- **7458**: The blinding light obscures your vision of the world beyond.
- **7459**: Your pinches of escha silt trigger a faint reaction in the light, granting a small glimpse of what lies beyond.
- **7461**: Traverse the light? ($0 silt) [Let's do it. ($1 silt)/Do not go into the light!]
- **7462**: You do not have enough escha silt.
- **7463**: What do you do? [Nothing for now./Use escha silt./Teleport using $0./Teleport using $6.]
- **7464**: Traverse the light? [Let's do this./No, wait!]
- **7618**: Which temporary item will you obtain? [None of them./$0/$1/$2/$3/$4/$5/$6@/$7/Destroy treasure chest.]
- **7619**: Which item will you obtain? [None of them./$0/$1/$2/$3/$4/$5/$6/$7/Destroy treasure chest.]
- **7620**: This treasure chest has been fitted with a unique combination lock that randomly generates numbers from 1\`99. Opening it requires you to guess whether the next number is greater or less than the previous.
- **7621**: Previous: $0 ($1 tr[y/ies] left) [Do nothing./Twist number dial up./Twist number dial down.]
- **7625**: The chest will be lost. Proceed? [Yes, destroy./No, cancel.]
- **7627**: What will you do? [Do nothing./Attempt to unlock it./Destroy the chest.]
- **7717**: Obtain this item? [Yes./No.]
- **7723**: The chest is locked.
- **7741**: Obtain this item?
...
SUBROUTINE_01A7:
 ...
 99: 0x01B2 [0x24] CREATE_DIALOG(message_id=7463*, default_option=ExtData[1]->WorkLocal[12], option_flags=ExtData[1]->WorkLocal[11])
...
183: 0x0353 [0x24] CREATE_DIALOG(message_id=7461*, default_option=1*, option_flags=0*)
...
233: 0x044C [0x24] CREATE_DIALOG(message_id=7464*, default_option=1*, option_flags=0*)
...
283: 0x0545 [0x24] CREATE_DIALOG(message_id=7464*, default_option=1*, option_flags=0*)
    → "Traverse the light? [Let's do this./No, wait!]"
...
```
  0: 0x1080 [0x24] CREATE_DIALOG(message_id=7464*, default_option=1*, option_flags=0*)
    → "Traverse the light? [Let's do this./No, wait!]"
...
```
  ...
  6: 0x1131 [0x48] [System] [7723*]:
    → "The chest is locked."
  7: 0x1134 [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x1135 [0x48] [System] [7620*]:
 ...
 18: 0x1162 [0x24] CREATE_DIALOG(message_id=7627*, default_option=ExtData[1]->WorkLocal[12], option_flags=ExtData[1]->WorkLocal[11])
...
SUBROUTINE_11B7:
 ...
 42: 0x11C9 [0x24] CREATE_DIALOG(message_id=7621*, default_option=ExtData[1]->WorkLocal[39], option_flags=ExtData[1]->WorkLocal[41])
...
SUBROUTINE_1246:
 70: 0x1246 [0x24] CREATE_DIALOG(message_id=7625*, default_option=1*, option_flags=0*)
...
SUBROUTINE_135E:
 ...
 94: 0x1361 [0x24] CREATE_DIALOG(message_id=7619*, default_option=ExtData[1]->WorkLocal[12], option_flags=ExtData[1]->WorkLocal[11])
...
107: 0x13A4 [0x48] [System] [7741*]:
    → "Obtain this item?"
108: 0x13A7 [0x23] WAIT_FOR_DIALOG_INTERACTION
109: 0x13A8 [0x93] DISPLAY_ITEM_INFO(item_id=0*)
110: 0x13AB [0x24] CREATE_DIALOG(message_id=7717*, default_option=1*, option_flags=0*)
...
# Dead code (unreachable instructions):
     ...
     0x12C0 [0x24] CREATE_DIALOG(message_id=7618*, default_option=ExtData[1]->WorkLocal[12], option_flags=ExtData[1]->WorkLocal[11])
    → "Which temporary item will you obtain? [None of them./$0/$1/$2/$3/$4/$5/$6@/$7/Destroy treasure chest.]"
     ...
     0x1303 [0x48] [System] [7741*]:
    → "Obtain this item?"
     0x1306 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x1307 [0x93] DISPLAY_ITEM_INFO(item_id=0*)
     0x130A [0x24] CREATE_DIALOG(message_id=7717*, default_option=1*, option_flags=0*)
    → "Obtain this item? [Yes./No.]"
