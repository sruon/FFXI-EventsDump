# 17957435 - Undulating Confluence
...
- **7043**: Jump into the vortex? [Off we go!/Not just yet.]
...
```
  ...
  3: 0x0010 [0x24] CREATE_DIALOG(message_id=7043*, default_option=1*, option_flags=0*)
