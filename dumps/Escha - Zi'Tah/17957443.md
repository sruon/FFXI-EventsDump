...
| [9206](#event-9206)   | 0x0001       |   1186 |            161 |
...
- **7687**: Proffer which item? [None of these./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./Previous page./Next page.]
- **7688**: Commence battle? [Yes./No.]
...
```
 ...
 10: 0x0028 [0x24] CREATE_DIALOG(message_id=7687*, default_option=ExtData[1]->WorkLocal[2], option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00A4:
 ...
 47: 0x00E5 [0x24] CREATE_DIALOG(message_id=7688*, default_option=1*, option_flags=0*)
