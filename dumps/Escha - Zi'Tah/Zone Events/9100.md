...
```
  ...
  7: 0x0025 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=0*, source=ExtData[1]->WorkLocal[8], result=ExtData[1]->WorkLocal[2])
  8: 0x002E [0x41] GET_BIT_WORK_RANGE(start_bit=1*, end_bit=2*, source=ExtData[1]->WorkLocal[8], result=ExtData[1]->WorkLocal[10])
 ...
 16: 0x0054 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=7*, source=ExtData[1]->WorkLocal[0], result=ExtData[1]->WorkLocal[36])
 17: 0x005D [0x01] GOTO 0x0088

SUBROUTINE_0060:
 18: 0x0060 [0x02] IF !(ExtData[1]->WorkLocal[6] == 289*) GOTO 0x0074
 19: 0x0068 [0x41] GET_BIT_WORK_RANGE(start_bit=8*, end_bit=22*, source=ExtData[1]->WorkLocal[0], result=ExtData[1]->WorkLocal[36])
 20: 0x0071 [0x01] GOTO 0x0088

SUBROUTINE_0074:
 21: 0x0074 [0x02] IF !(ExtData[1]->WorkLocal[6] == 291*) GOTO 0x0088
 22: 0x007C [0x41] GET_BIT_WORK_RANGE(start_bit=23*, end_bit=31*, source=ExtData[1]->WorkLocal[0], result=ExtData[1]->WorkLocal[36])
...
327: 0x0628 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=7*, source=ExtData[1]->WorkLocal[0], result=ExtData[1]->WorkLocal[36])
328: 0x0631 [0x01] GOTO 0x065C

SUBROUTINE_0634:
329: 0x0634 [0x02] IF !(ExtData[1]->WorkLocal[6] == 289*) GOTO 0x0648
330: 0x063C [0x41] GET_BIT_WORK_RANGE(start_bit=8*, end_bit=22*, source=ExtData[1]->WorkLocal[0], result=ExtData[1]->WorkLocal[36])
331: 0x0645 [0x01] GOTO 0x065C

SUBROUTINE_0648:
332: 0x0648 [0x02] IF !(ExtData[1]->WorkLocal[6] == 291*) GOTO 0x065C
333: 0x0650 [0x41] GET_BIT_WORK_RANGE(start_bit=23*, end_bit=31*, source=ExtData[1]->WorkLocal[0], result=ExtData[1]->WorkLocal[36])
...
SUBROUTINE_092F:
449: 0x092F [0xD0] LOAD_SCHEDULED_TASK_ALT5(work_offset=125*, entity1=EventEntity, entity2=EventEntity, action="main", work_offset2=0*)
450: 0x0940 [0x1C] WAIT(200* ticks)
451: 0x0943 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
452: 0x0954 [0x1C] WAIT(60* ticks)
453: 0x0957 [0x1B] RETURN

SUBROUTINE_0958:
454: 0x0958 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
455: 0x0969 [0xD0] LOAD_SCHEDULED_TASK_ALT5(work_offset=126*, entity1=EventEntity, entity2=EventEntity, action="main", work_offset2=0*)
456: 0x097A [0x1C] WAIT(180* ticks)
457: 0x097D [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
458: 0x098C [0x1B] RETURN

SUBROUTINE_098D:
459: 0x098D [0xD0] LOAD_SCHEDULED_TASK_ALT5(work_offset=168*, entity1=EventEntity, entity2=EventEntity, action="main", work_offset2=0*)
460: 0x099E [0x1C] WAIT(160* ticks)
461: 0x09A1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
462: 0x09B2 [0x1C] WAIT(60* ticks)
463: 0x09B5 [0x1B] RETURN

SUBROUTINE_09B6:
464: 0x09B6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
465: 0x09C7 [0xD0] LOAD_SCHEDULED_TASK_ALT5(work_offset=169*, entity1=EventEntity, entity2=EventEntity, action="main", work_offset2=0*)
466: 0x09D8 [0x1C] WAIT(160* ticks)
467: 0x09DB [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
...
```
# Data Section: 0x0ACB (1280 bytes)
     ...
     0x0E4B: 00 80 00 80 00 80 00 80 00 80 00 80 00 80 00 80
     0x0E5B: 00 80 00 80 00 80 00 80 00 80 00 80 00 80 00 80
     0x0E6B: 00 80 00 80 00 80 00 80 00 80 00 80 00 80 00 80
     0x0E7B: 00 80 00 80 00 80 00 80 00 80 00 80 00 80 00 80
     0x0E8B: 5A 80 92 80 93 80 94 80 95 80 96 80 97 80 00 80
     0x0E9B: 98 80 99 80 9A 80 9B 80 9C 80 9D 80 9E 80 9F 80
     0x0EAB: 61 80 A0 80 A1 80 00 80 00 80 00 80 00 80 00 80
     0x0EBB: 00 80 00 80 00 80 00 80 00 80 00 80 00 80 00 80
     0x0ECB: 00 80 00 80 00 80 00 80 00 80 00 80 00 80 00 80
     0x0EDB: A2 80 A3 80 A4 80 A5 80 A6 80 A7 80 A8 80 A9 80
     0x0EEB: AA 80 AB 80 A6 80 AC 80 AD 80 A3 80 AE 80 AF 80
     0x0EFB: B0 80 B1 80 B2 80 00 80 00 80 00 80 00 80 00 80
     0x0F0B: 00 80 00 80 00 80 00 80 00 80 00 80 00 80 00 80
     0x0F1B: 00 80 00 80 00 80 00 80 00 80 00 80 00 80 00 80
     0x0F2B: 7E 80 B3 80 B4 80 B5 80 B3 80 B4 80 AD 80 B3 80
     0x0F3B: B6 80 B7 80 B3 80 B6 80 B5 80 B3 80 87 80 B8 80
     0x0F4B: 8F 80 90 80 B9 80 00 80 00 80 00 80 00 80 00 80
     0x0F5B: 00 80 00 80 00 80 00 80 00 80 00 80 00 80 00 80
     0x0F6B: 00 80 00 80 00 80 00 80 00 80 00 80 00 80 00 80
     0x0F7B: 00 80 00 80 00 80 00 80 00 80 00 80 00 80 00 80
     0x0F8B: 00 80 00 80 00 80 00 80 00 80 00 80 00 80 00 80
     0x0F9B: 00 80 00 80 00 80 00 80 00 80 00 80 00 80 00 80
     0x0FAB: 00 80 00 80 00 80 00 80 00 80 00 80 00 80 00 80
     0x0FBB: 00 80 00 80 00 80 00 80 00 80 00 80 00 80 00 80
```