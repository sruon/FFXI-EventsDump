...
- **7813**: I am offering a prayer for those poor souls whose lives have been prematurely extinguished. And you...you are bound for the battlefield, are you not? My thoughts are with you also.
- **7814**: Your presence evokes long-forgotten memories within and reminds me of the hopes and dreams that were my driving force in youth. Insignificant though my powers may be, perhaps the time has come to return to the fray and do my part for the greater good.
- **7815**: You have my gratitude. May you find favor with the Goddess.
...
```
  ...
  9: 0x0023 [0x1D] PRINT_EVENT_MESSAGE(message_id=7813*)
 ...
 13: 0x0032 [0x1D] PRINT_EVENT_MESSAGE(message_id=7813*)
    → "I am offering a prayer for those poor souls whose lives have been prematurely extinguished. And you...you are bound for the battlefield, are you not? My thoughts are with you also."
 ...
 18: 0x0049 [0x1D] PRINT_EVENT_MESSAGE(message_id=7813*)
    → "I am offering a prayer for those poor souls whose lives have been prematurely extinguished. And you...you are bound for the battlefield, are you not? My thoughts are with you also."
 ...
 23: 0x0060 [0x1D] PRINT_EVENT_MESSAGE(message_id=7814*)
 ...
 26: 0x0067 [0x1D] PRINT_EVENT_MESSAGE(message_id=7813*)
    → "I am offering a prayer for those poor souls whose lives have been prematurely extinguished. And you...you are bound for the battlefield, are you not? My thoughts are with you also."
...
SUBROUTINE_006B:
 ...
 31: 0x007E [0x1D] PRINT_EVENT_MESSAGE(message_id=7814*)
    → "Your presence evokes long-forgotten memories within and reminds me of the hopes and dreams that were my driving force in youth. Insignificant though my powers may be, perhaps the time has come to return to the fray and do my part for the greater good."
 32: 0x0081 [0x23] WAIT_FOR_DIALOG_INTERACTION
 33: 0x0082 [0x01] GOTO 0x0089
 34: 0x0085 [0x1D] PRINT_EVENT_MESSAGE(message_id=7813*)
    → "I am offering a prayer for those poor souls whose lives have been prematurely extinguished. And you...you are bound for the battlefield, are you not? My thoughts are with you also."
...
SUBROUTINE_0089:
 ...
 39: 0x009C [0x1D] PRINT_EVENT_MESSAGE(message_id=7814*)
    → "Your presence evokes long-forgotten memories within and reminds me of the hopes and dreams that were my driving force in youth. Insignificant though my powers may be, perhaps the time has come to return to the fray and do my part for the greater good."
 40: 0x009F [0x23] WAIT_FOR_DIALOG_INTERACTION
 41: 0x00A0 [0x01] GOTO 0x00A7
 42: 0x00A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7813*)
    → "I am offering a prayer for those poor souls whose lives have been prematurely extinguished. And you...you are bound for the battlefield, are you not? My thoughts are with you also."
...
SUBROUTINE_00AA:
 ...
 48: 0x00BD [0x1D] PRINT_EVENT_MESSAGE(message_id=7813*)
    → "I am offering a prayer for those poor souls whose lives have been prematurely extinguished. And you...you are bound for the battlefield, are you not? My thoughts are with you also."
 ...
 53: 0x00D4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7815*)
 ...
 56: 0x00DB [0x1D] PRINT_EVENT_MESSAGE(message_id=7813*)
    → "I am offering a prayer for those poor souls whose lives have been prematurely extinguished. And you...you are bound for the battlefield, are you not? My thoughts are with you also."
...
SUBROUTINE_00DF:
 ...
 61: 0x00F2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7815*)
    → "You have my gratitude. May you find favor with the Goddess."
 62: 0x00F5 [0x23] WAIT_FOR_DIALOG_INTERACTION
 63: 0x00F6 [0x01] GOTO 0x00FD
 64: 0x00F9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7813*)
    → "I am offering a prayer for those poor souls whose lives have been prematurely extinguished. And you...you are bound for the battlefield, are you not? My thoughts are with you also."
...
SUBROUTINE_00FD:
 ...
 69: 0x0110 [0x1D] PRINT_EVENT_MESSAGE(message_id=7815*)
    → "You have my gratitude. May you find favor with the Goddess."
 70: 0x0113 [0x23] WAIT_FOR_DIALOG_INTERACTION
 71: 0x0114 [0x01] GOTO 0x011B
 72: 0x0117 [0x1D] PRINT_EVENT_MESSAGE(message_id=7813*)
    → "I am offering a prayer for those poor souls whose lives have been prematurely extinguished. And you...you are bound for the battlefield, are you not? My thoughts are with you also."
