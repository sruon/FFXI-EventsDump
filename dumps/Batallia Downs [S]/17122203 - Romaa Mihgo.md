...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0040:                             6E 9B 43 05 01 03 80           n.C....
0050: 99 9B 43 05 01 00                                 ..C...          
```

#### Opcodes

```
  0: 0x0049 [0x6E] Romaa Mihgo (ID: 17122203/0x0105439B) uses emote 43*
  1: 0x0050 [0x99] Wait for Romaa Mihgo (ID: 17122203/0x0105439B) animation to complete
