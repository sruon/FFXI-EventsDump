...
```
  ...
  2: 0x032A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  3: 0x033B [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 20: 0x03A3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=289*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s137", work_offset2=0*)
 21: 0x03B4 [0x1C] WAIT(15* ticks)
 22: 0x03B7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 23: 0x03C8 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1")
 24: 0x03D7 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Thorben (ID: 17122137/0x01054359), entity2=Thorben (ID: 17122137/0x01054359), action="tlk0")
 ...
 27: 0x03EE [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Thorben (ID: 17122137/0x01054359), entity2=Thorben (ID: 17122137/0x01054359), action="tlk1")
 28: 0x03FD [0x52] END_LOAD_SCHEDULER: End scheduler "s137" with entities [EventEntity, EventEntity], work=289*
 29: 0x040C [0x45] LOAD_SCHEDULED_TASK(work_offset1=289*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s138", work_offset2=0*)
 ...
 38: 0x044F [0x45] LOAD_SCHEDULED_TASK(work_offset1=289*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s139", work_offset2=0*)
 ...
 47: 0x0493 [0x45] LOAD_SCHEDULED_TASK(work_offset1=289*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s140", work_offset2=0*)
 48: 0x04A4 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Bernhard (ID: 17122138/0x0105435A), entity2=Bernhard (ID: 17122138/0x0105435A), action="tlk0")
 ...
 51: 0x04BB [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Bernhard (ID: 17122138/0x0105435A), entity2=Bernhard (ID: 17122138/0x0105435A), action="tlk1")
 52: 0x04CA [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Thorben (ID: 17122137/0x01054359), entity2=Thorben (ID: 17122137/0x01054359), action="tlk0")
 ...
 55: 0x04E1 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Thorben (ID: 17122137/0x01054359), entity2=Thorben (ID: 17122137/0x01054359), action="tlk1")
 56: 0x04F0 [0x52] END_LOAD_SCHEDULER: End scheduler "s140" with entities [EventEntity, EventEntity], work=289*
 57: 0x04FF [0x45] LOAD_SCHEDULED_TASK(work_offset1=289*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s141", work_offset2=0*)
 58: 0x0510 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Bernhard (ID: 17122138/0x0105435A), entity2=Bernhard (ID: 17122138/0x0105435A), action="tlk0")
 ...
 61: 0x0527 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Bernhard (ID: 17122138/0x0105435A), entity2=Bernhard (ID: 17122138/0x0105435A), action="tlk1")
 ...
 67: 0x0559 [0x45] LOAD_SCHEDULED_TASK(work_offset1=289*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s142", work_offset2=0*)
 ...
 72: 0x0587 [0x45] LOAD_SCHEDULED_TASK(work_offset1=289*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s143", work_offset2=0*)
 73: 0x0598 [0x01] GOTO 0x065F

SUBROUTINE_059B:
 74: 0x059B [0x02] IF !(LocalPlayer->Race == 2*) GOTO 0x05B7
 75: 0x05A3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=289*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s143", work_offset2=0*)
 76: 0x05B4 [0x01] GOTO 0x065F

SUBROUTINE_05B7:
 77: 0x05B7 [0x02] IF !(LocalPlayer->Race == 3*) GOTO 0x05D3
 78: 0x05BF [0x45] LOAD_SCHEDULED_TASK(work_offset1=289*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s148", work_offset2=0*)
 79: 0x05D0 [0x01] GOTO 0x065F

SUBROUTINE_05D3:
 80: 0x05D3 [0x02] IF !(LocalPlayer->Race == 4*) GOTO 0x05EF
 81: 0x05DB [0x45] LOAD_SCHEDULED_TASK(work_offset1=289*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s148", work_offset2=0*)
 82: 0x05EC [0x01] GOTO 0x065F

SUBROUTINE_05EF:
 83: 0x05EF [0x02] IF !(LocalPlayer->Race == 5*) GOTO 0x060B
 84: 0x05F7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=289*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s146", work_offset2=0*)
 85: 0x0608 [0x01] GOTO 0x065F

SUBROUTINE_060B:
 86: 0x060B [0x02] IF !(LocalPlayer->Race == 6*) GOTO 0x0627
 87: 0x0613 [0x45] LOAD_SCHEDULED_TASK(work_offset1=289*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s146", work_offset2=0*)
 88: 0x0624 [0x01] GOTO 0x065F

SUBROUTINE_0627:
 89: 0x0627 [0x02] IF !(LocalPlayer->Race == 7*) GOTO 0x0643
 90: 0x062F [0x45] LOAD_SCHEDULED_TASK(work_offset1=289*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s145", work_offset2=0*)
 91: 0x0640 [0x01] GOTO 0x065F

SUBROUTINE_0643:
 92: 0x0643 [0x02] IF !(LocalPlayer->Race == 8*) GOTO 0x065F
 93: 0x064B [0x45] LOAD_SCHEDULED_TASK(work_offset1=289*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s147", work_offset2=0*)
...
102: 0x06B0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=289*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s144", work_offset2=0*)
...
108: 0x06DA [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
109: 0x06EB [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
110: 0x06FA [0x52] END_LOAD_SCHEDULER: End scheduler "s144" with entities [EventEntity, EventEntity], work=289*
111: 0x0709 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
...
117: 0x0728 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
