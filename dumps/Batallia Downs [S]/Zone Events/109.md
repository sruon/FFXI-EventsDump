...
```
  ...
  1: 0x073C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  2: 0x074D [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 14: 0x079F [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s012", work_offset2=0*)
 15: 0x07B0 [0x1C] WAIT(15* ticks)
 16: 0x07B3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 17: 0x07C4 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1")
 ...
 23: 0x07F6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s023", work_offset2=0*)
 24: 0x0807 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Romualdo (ID: 17122127/0x0105434F), entity2=Romualdo (ID: 17122127/0x0105434F), action="tlk0")
 ...
 28: 0x082D [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s024", work_offset2=0*)
 ...
 33: 0x084E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Romualdo (ID: 17122127/0x0105434F), entity2=Romualdo (ID: 17122127/0x0105434F), action="tlk1")
 34: 0x085D [0x52] END_LOAD_SCHEDULER: End scheduler "s024" with entities [EventEntity, EventEntity], work=331*
 35: 0x086C [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s029", work_offset2=0*)
 36: 0x087D [0x53] WAIT_SCHEDULER_TASK(entity1=Romualdo (ID: 17122127/0x0105434F), entity2=Romualdo (ID: 17122127/0x0105434F), action_id="tlk1")
 ...
 41: 0x089E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 42: 0x08AF [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 46: 0x08D2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
