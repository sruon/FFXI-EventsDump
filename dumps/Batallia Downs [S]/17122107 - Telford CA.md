...
SUBROUTINE_0019:
  ...
  9: 0x002F [0x1D] PRINT_EVENT_MESSAGE(message_id=7206*)
...
SUBROUTINE_00F5:
 ...
 51: 0x0155 [0x24] CREATE_DIALOG(message_id=7210*, default_option=0*, option_flags=ExtData[1]->WorkLocal[2])
 ...
 63: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=7216*)
...
SUBROUTINE_0198:
 ...
 66: 0x019B [0x1D] PRINT_EVENT_MESSAGE(message_id=7256*)
...
SUBROUTINE_019F:
 ...
 73: 0x01B8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7256*)
    → "I am sorry, <Player>, but your campaign medal has expired. I cannot issue tags to anyone not authorized by the Allied Forces. Return to your nation's capital and speak with a Campaign Evaluation Official."
...
SUBROUTINE_0205:
 ...
 94: 0x0206 [0x1D] PRINT_EVENT_MESSAGE(message_id=7213*)
...
SUBROUTINE_0210:
 ...
 99: 0x0211 [0x1D] PRINT_EVENT_MESSAGE(message_id=7215*)
...
405: 0x096D [0x1D] PRINT_EVENT_MESSAGE(message_id=7245*)
...
422: 0x09BA [0x24] CREATE_DIALOG(message_id=7246*, default_option=0*, option_flags=ExtData[1]->WorkLocal[16])
...
491: 0x0B1B [0x24] CREATE_DIALOG(message_id=7247*, default_option=0*, option_flags=ExtData[1]->WorkLocal[12])
...
552: 0x0C63 [0x1D] PRINT_EVENT_MESSAGE(message_id=7248*)
...
555: 0x0C6A [0x24] CREATE_DIALOG(message_id=7249*, default_option=1*, option_flags=0*)
...
583: 0x0D10 [0x24] CREATE_DIALOG(message_id=7263*, default_option=1*, option_flags=0*)
...
592: 0x0D3B [0x24] CREATE_DIALOG(message_id=7694*, default_option=0*, option_flags=0*)
...
600: 0x0D68 [0x1D] PRINT_EVENT_MESSAGE(message_id=7695*)
...
603: 0x0D71 [0x24] CREATE_DIALOG(message_id=7264*, default_option=1*, option_flags=0*)
...
615: 0x0DB1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7695*)
    → "Your steadfast efforts have earned you a claim to share in your union's spoils of war. By [transferring to another union/resigning from your union], you will relinquish this right. It is not my place to question your decision, but I suggest you pay the matter due heed."
616: 0x0DB4 [0x23] WAIT_FOR_DIALOG_INTERACTION
617: 0x0DB5 [0x03] Work_Zone[2] = 1*
618: 0x0DBA [0x24] CREATE_DIALOG(message_id=7264*, default_option=1*, option_flags=0*)
    → "[Transfer/Resign] from your current union? [Yes./No.]"
...
645: 0x0E5E [0x1D] PRINT_EVENT_MESSAGE(message_id=7701*)
...
649: 0x0E6A [0x24] CREATE_DIALOG(message_id=7697*, default_option=0*, option_flags=ExtData[1]->WorkLocal[36])
...
674: 0x0EE8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7231*)
...
683: 0x0F11 [0x1D] PRINT_EVENT_MESSAGE(message_id=7231*)
    → "I will require a teleportation fee of $0 Allied Note[/s]. I see you currently possess $2."
684: 0x0F14 [0x23] WAIT_FOR_DIALOG_INTERACTION
685: 0x0F15 [0x48] [System] [7201*]:
    → "I am sorry. You do not have enough Allied Notes."
...
691: 0x0F32 [0x1D] PRINT_EVENT_MESSAGE(message_id=7231*)
    → "I will require a teleportation fee of $0 Allied Note[/s]. I see you currently possess $2."
692: 0x0F35 [0x23] WAIT_FOR_DIALOG_INTERACTION
693: 0x0F36 [0x48] [System] [7201*]:
    → "I am sorry. You do not have enough Allied Notes."
694: 0x0F39 [0x23] WAIT_FOR_DIALOG_INTERACTION
695: 0x0F3A [0x1B] RETURN

SUBROUTINE_0F43:
696: 0x0F43 [0x1D] PRINT_EVENT_MESSAGE(message_id=7231*)
    → "I will require a teleportation fee of $0 Allied Note[/s]. I see you currently possess $2."
697: 0x0F46 [0x23] WAIT_FOR_DIALOG_INTERACTION
698: 0x0F47 [0x24] CREATE_DIALOG(message_id=7232*, default_option=1*, option_flags=0*)
...
704: 0x0F60 [0x1D] PRINT_EVENT_MESSAGE(message_id=7233*)
...
715: 0x0F9A [0x24] CREATE_DIALOG(message_id=7211*, default_option=0*, option_flags=ExtData[1]->WorkLocal[2])
