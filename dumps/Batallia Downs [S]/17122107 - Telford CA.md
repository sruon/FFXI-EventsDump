...
SUBROUTINE_0019:
  ...
  9: 0x002F [0x1D] PRINT_EVENT_MESSAGE(message_id=7207*)
...
SUBROUTINE_00F5:
 ...
 51: 0x0155 [0x24] CREATE_DIALOG(message_id=7211*, default_option=0*, option_flags=ExtData[1]->WorkLocal[2])
 ...
 63: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=7217*)
...
SUBROUTINE_0198:
 ...
 66: 0x019B [0x1D] PRINT_EVENT_MESSAGE(message_id=7257*)
...
SUBROUTINE_019F:
 ...
 73: 0x01B8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7257*)
    → "I am sorry, <Player>, but your campaign medal has expired. I cannot issue tags to anyone not authorized by the Allied Forces. Return to your nation's capital and speak with a Campaign Evaluation Official."
...
SUBROUTINE_0205:
 ...
 94: 0x0206 [0x1D] PRINT_EVENT_MESSAGE(message_id=7214*)
...
SUBROUTINE_0210:
 ...
 99: 0x0211 [0x1D] PRINT_EVENT_MESSAGE(message_id=7216*)
...
405: 0x096D [0x1D] PRINT_EVENT_MESSAGE(message_id=7246*)
...
422: 0x09BA [0x24] CREATE_DIALOG(message_id=7247*, default_option=0*, option_flags=ExtData[1]->WorkLocal[16])
...
491: 0x0B1B [0x24] CREATE_DIALOG(message_id=7248*, default_option=0*, option_flags=ExtData[1]->WorkLocal[12])
...
552: 0x0C63 [0x1D] PRINT_EVENT_MESSAGE(message_id=7249*)
...
555: 0x0C6A [0x24] CREATE_DIALOG(message_id=7250*, default_option=1*, option_flags=0*)
...
583: 0x0D10 [0x24] CREATE_DIALOG(message_id=7264*, default_option=1*, option_flags=0*)
...
603: 0x0D71 [0x24] CREATE_DIALOG(message_id=7265*, default_option=1*, option_flags=0*)
...
618: 0x0DBA [0x24] CREATE_DIALOG(message_id=7265*, default_option=1*, option_flags=0*)
    → "[Transfer/Resign] from your current union? [Yes./No.]"
...
674: 0x0EE8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7232*)
...
683: 0x0F11 [0x1D] PRINT_EVENT_MESSAGE(message_id=7232*)
    → "I will require a teleportation fee of $0 Allied Note[/s]. I see you currently possess $2."
684: 0x0F14 [0x23] WAIT_FOR_DIALOG_INTERACTION
685: 0x0F15 [0x48] [System] [7202*]:
    → "I am sorry. You do not have enough Allied Notes."
...
691: 0x0F32 [0x1D] PRINT_EVENT_MESSAGE(message_id=7232*)
    → "I will require a teleportation fee of $0 Allied Note[/s]. I see you currently possess $2."
692: 0x0F35 [0x23] WAIT_FOR_DIALOG_INTERACTION
693: 0x0F36 [0x48] [System] [7202*]:
    → "I am sorry. You do not have enough Allied Notes."
694: 0x0F39 [0x23] WAIT_FOR_DIALOG_INTERACTION
695: 0x0F3A [0x1B] RETURN

SUBROUTINE_0F43:
696: 0x0F43 [0x1D] PRINT_EVENT_MESSAGE(message_id=7232*)
    → "I will require a teleportation fee of $0 Allied Note[/s]. I see you currently possess $2."
697: 0x0F46 [0x23] WAIT_FOR_DIALOG_INTERACTION
698: 0x0F47 [0x24] CREATE_DIALOG(message_id=7233*, default_option=1*, option_flags=0*)
...
704: 0x0F60 [0x1D] PRINT_EVENT_MESSAGE(message_id=7234*)
...
715: 0x0F9A [0x24] CREATE_DIALOG(message_id=7212*, default_option=0*, option_flags=ExtData[1]->WorkLocal[2])
