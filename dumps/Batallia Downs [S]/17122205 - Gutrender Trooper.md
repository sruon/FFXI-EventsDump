...
```
  ...
  1: 0x004C [0x1F] MOVE_ENTITY: EventEntity moves to X=434.165*, Z=542.030*, Y=1.476*
...
```
  0: 0x0057 [0x32] ExtData[1]->MainSpeed = 39* * 0.1
  1: 0x005A [0x1F] MOVE_ENTITY: EventEntity moves to X=-149.351*, Z=-143.477*, Y=19.758*
...
```
  ...
  1: 0x0073 [0x1F] MOVE_ENTITY: EventEntity moves to X=-102.052*, Z=-164.293*, Y=0.000*
  2: 0x007B [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x007D [0x1F] MOVE_ENTITY: EventEntity moves to X=-85.527*, Z=-138.206*, Y=0.000*
