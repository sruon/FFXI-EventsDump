...
```
  ...
  3: 0x000B [0x1D] PRINT_EVENT_MESSAGE(message_id=7415*)
    → "I hears that if you wants to talk to one of them crazy Anticans livin' 'round here, you gots to use some strange instrument. Now if I could gets my hands on one of them tasty pieces...\u007F1\u0000\u0007"
