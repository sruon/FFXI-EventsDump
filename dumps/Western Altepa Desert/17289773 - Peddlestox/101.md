...
```
  ...
  3: 0x0021 [0x1D] PRINT_EVENT_MESSAGE(message_id=7420*)
    → "What'sa that you gots there? Hmmm...\u0007It looks likea one of those creepy-crawly Anticans' goods.\u007F1\u0000\u0007"
 ...
 15: 0x0059 [0x8B] SET_EVENT_MARK: Add/update map marker on map 125* at (4.1, 4.1), index=0*, name=(no name)
