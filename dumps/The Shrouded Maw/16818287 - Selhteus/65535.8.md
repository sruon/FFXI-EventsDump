...
```
  ...
  4: 0x0065 [0x45] LOAD_SCHEDULED_TASK(work_offset1=152*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k004", work_offset2=0*)
  5: 0x0076 [0x9F] LOAD_SCHEDULED_TASK_ALT: Load scheduler "kill" with entities [EventEntity, EventEntity], work=[62*, 0*]
  6: 0x0087 [0x45] LOAD_SCHEDULED_TASK(work_offset1=152*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s005", work_offset2=0*)
