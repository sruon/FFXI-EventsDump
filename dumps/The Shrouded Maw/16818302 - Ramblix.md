...
- **7679**: Oh my Gob! You're one of those adventurerurers, aren't ya? You got nothin' on me, [man./lady.] I was just mindin' my own businesesess, lookin' for junk an' stuff.
- **7680**: Hey, watch out. You don't wanna fight me. I'll turn you into meat jerky! Wait, how about you and me be friends instead? Sound good?
- **7681**: I travel all over the world and hear lots of differererent stories. I even hear your stories. I can tell you one, if you want.
- **7682**: Now, listen close...
- **7683**: Oh... Well, if that's the case, I'm outta here.
- **7689**: Do you want to hear a story? [No, thank you./Let's hear one.]
- **7690**: What story would you like to be told? [On second thought, maybe later./Darkness Named(pt.1)./Darkness Named(pt.2)./Darkness Named(pt.3)./Waking Dreams(pt.1)./Waking Dreams(pt.2)./Waking Dreams(pt.3)./Waking Dreams(pt.4)./Waking Dreams(pt.5)./Waking Dreams(pt.6)./Waking Dreams(pt.7)./Waking Dreams(pt.8)./Waking Dreams(pt.9)./Rhapsodies of Vana'diel.]
- **7691**: 
- **7692**: 
- **7693**: 
