...
```
  ...
  1: 0x0360 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=149*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
  2: 0x036F [0x01] GOTO 0x0428

SUBROUTINE_0372:
  3: 0x0372 [0x02] IF !(Entity->Race == 2*) GOTO 0x038C
  4: 0x037A [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=159*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
  5: 0x0389 [0x01] GOTO 0x0428

SUBROUTINE_038C:
  6: 0x038C [0x02] IF !(Entity->Race == 3*) GOTO 0x03A6
  7: 0x0394 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=169*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
  8: 0x03A3 [0x01] GOTO 0x0428

SUBROUTINE_03A6:
  9: 0x03A6 [0x02] IF !(Entity->Race == 4*) GOTO 0x03C0
 10: 0x03AE [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=179*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 11: 0x03BD [0x01] GOTO 0x0428

SUBROUTINE_03C0:
 12: 0x03C0 [0x02] IF !(Entity->Race == 5*) GOTO 0x03DA
 13: 0x03C8 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=189*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 14: 0x03D7 [0x01] GOTO 0x0428

SUBROUTINE_03DA:
 15: 0x03DA [0x02] IF !(Entity->Race == 6*) GOTO 0x03F4
 16: 0x03E2 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=189*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 17: 0x03F1 [0x01] GOTO 0x0428

SUBROUTINE_03F4:
 18: 0x03F4 [0x02] IF !(Entity->Race == 7*) GOTO 0x040E
 19: 0x03FC [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=199*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 20: 0x040B [0x01] GOTO 0x0428

SUBROUTINE_040E:
 21: 0x040E [0x02] IF !(Entity->Race == 8*) GOTO 0x0428
 22: 0x0416 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=209*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 23: 0x0425 [0x01] GOTO 0x0428

SUBROUTINE_0428:
 24: 0x0428 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
