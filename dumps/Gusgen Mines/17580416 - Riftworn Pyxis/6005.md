...
SUBROUTINE_01E3:
 82: 0x01E3 [0x24] CREATE_DIALOG(message_id=7581*, default_option=0*, option_flags=ExtData[1]->WorkLocal[5])
...
SUBROUTINE_0325:
143: 0x0325 [0x24] CREATE_DIALOG(message_id=7582*, default_option=1*, option_flags=ExtData[1]->WorkLocal[14])
...
171: 0x03A7 [0x24] CREATE_DIALOG(message_id=7582*, default_option=1*, option_flags=0*)
    → "Obtain the \u0001\u0005#\u0002\u0000\u0000\u0000?\u0007\u000BYes.\u0007No.\u0007Obtain as pulse cell.\u007F1\u0000\u0007"
...
186: 0x03F8 [0x24] CREATE_DIALOG(message_id=7553*, default_option=1*, option_flags=0*)
