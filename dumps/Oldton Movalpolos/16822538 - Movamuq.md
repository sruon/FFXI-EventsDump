...
| [65535.10](#event-6553510) | 0x0071       |     15 |              5 |
| [65535.11](#event-6553511) | 0x0080       |     10 |              2 |
...
```
  0: 0x0045 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-280.225*, z=-100.715*, y=0.124*, direction=200.1°*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0070:    32 07 80 1F 00 12 80  13 80 10 80 1F 01 6F 00   2............o.
```
...
```
  ...
  1: 0x0074 [0x1F] MOVE_ENTITY: EventEntity moves to X=-474.709*, Z=36.070*, Y=121.062*
...
```
  0: 0x0080 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-470.119*, z=32.323*, y=121.999*, direction=89.2°*
