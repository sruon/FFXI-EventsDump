...
```
  0: 0x0045 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-261.714*, z=-46.439*, y=7.999*, direction=308.4°*
...
```
  ...
  1: 0x0052 [0x1F] MOVE_ENTITY: EventEntity moves to X=-259.665*, Z=-31.628*, Y=7.999*
