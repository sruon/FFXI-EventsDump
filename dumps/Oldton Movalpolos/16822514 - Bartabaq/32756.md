...
```
 ...
 10: 0x0033 [0x1D] PRINT_EVENT_MESSAGE(message_id=7310*)
    → "Welkome to my vorder shop! Trade me all your junk ekwipment ov yourz and I might just give you some konkwest pointz!\u007F1\u0000\u0007"
 ...
 13: 0x003C [0x1D] PRINT_EVENT_MESSAGE(message_id=7311*)
    → "And vy popular demand, I now aksept \u0001\u0005%\u0002\u0000\u0000\u0000 az well. Trade me vig onez and you'll earn not only konkwest pointz but good, hard gil to voot!\u007F1\u0000\u0007"
 ...
 21: 0x0063 [0x1D] PRINT_EVENT_MESSAGE(message_id=7312*)
    → "Your nation iz strong in this region. We Movlinz like strong peoplez! I'll sell you my treazurez.\u007F1\u0000\u0007"
...
SUBROUTINE_006A:
 ...
 25: 0x0072 [0x1D] PRINT_EVENT_MESSAGE(message_id=7313*)
    → "Your nation iz friendz with other strong nationz. We Movlinz like strong peoplez! I'll sell you my treazurez.\u007F1\u0000\u0007"
...
SUBROUTINE_0081:
 ...
 38: 0x00A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7314*)
    → "Going away? I kan teleport you to your home nation for 
\u0001 gil or 
...
SUBROUTINE_00ED:
 55: 0x00ED [0x1D] PRINT_EVENT_MESSAGE(message_id=7316*)
    → "Wait! You have no money! Movlinz hate poor, smelly adventurers! Go on! Get out!\u007F1\u0000\u0007"
...
SUBROUTINE_0131:
 71: 0x0131 [0x1D] PRINT_EVENT_MESSAGE(message_id=7317*)
    → "Wait! You have no points! Movlinz hate wimpy, wussy adventurers! Go on! Get out!\u007F1\u0000\u0007"
...
SUBROUTINE_014C:
 78: 0x014C [0x02] IF !(ExtData[1]->WorkLocal[0] == 1*) GOTO 0x015A
 79: 0x0154 [0x01] GOTO 0x0089

SUBROUTINE_015A:
 80: 0x015A [0x02] IF !(ExtData[1]->WorkLocal[0] == 3*) GOTO 0x0169
 81: 0x0162 [0x1D] PRINT_EVENT_MESSAGE(message_id=7318*)
    → "Your nation iz weak! Movlinz hate weak peoplez!\u0007Vut we love weak peoplez ekwipment. You kan trade if you want.\u007F1\u0000\u0007"
 82: 0x0165 [0x23] WAIT_FOR_DIALOG_INTERACTION
 83: 0x0166 [0x01] GOTO 0x0169

SUBROUTINE_0169:
 84: 0x0169 [0x21] END_EVENT
 85: 0x016A [0x00] END_REQSTACK()
```
