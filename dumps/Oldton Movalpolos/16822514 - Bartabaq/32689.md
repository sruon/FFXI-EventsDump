...
SUBROUTINE_01E2:
 ...
 35: 0x0205 [0x1D] PRINT_EVENT_MESSAGE(message_id=7315*)
    → "Ah, you have kollected all mog tabletz! Today iz your lucky day! I kan teleport you to your home nation for free!\u007F1\u0000\u0007"
...
SUBROUTINE_024F:
 54: 0x024F [0x02] IF !(ExtData[1]->WorkLocal[0] == 1*) GOTO 0x025D
 55: 0x0257 [0x01] GOTO 0x01EA

SUBROUTINE_025D:
 56: 0x025D [0x02] IF !(ExtData[1]->WorkLocal[0] == 3*) GOTO 0x026C
 57: 0x0265 [0x1D] PRINT_EVENT_MESSAGE(message_id=7318*)
    → "Your nation iz weak! Movlinz hate weak peoplez!\u0007Vut we love weak peoplez ekwipment. You kan trade if you want.\u007F1\u0000\u0007"
 58: 0x0268 [0x23] WAIT_FOR_DIALOG_INTERACTION
 59: 0x0269 [0x01] GOTO 0x026C

SUBROUTINE_026C:
 60: 0x026C [0x21] END_EVENT
 61: 0x026D [0x00] END_REQSTACK()
```
