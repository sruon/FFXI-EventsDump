...
```
 ...
 11: 0x003D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 20: 0x005C [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
 ...
 25: 0x007E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 36: 0x00A1 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
...
SUBROUTINE_016A:
 ...
 81: 0x0182 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
...
SUBROUTINE_019A:
 86: 0x019A [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x01BF
 87: 0x01A2 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 88: 0x01B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=6886*)
    → "Okay, whatever. But you'll never make the big time with that attitude. Prudes like you should stick to sellin' \u0001\u0005%\u0002\u0005\u0000\u0000 to make ends meet.\u007F1\u0000\u0007"
 89: 0x01B4 [0x23] WAIT_FOR_DIALOG_INTERACTION
 90: 0x01B5 [0x03] Work_Zone[1] = 1073741824*
 91: 0x01BA [0x21] END_EVENT
 92: 0x01BB [0x00] END_REQSTACK()

SUBROUTINE_01BF:
 93: 0x01BF [0x01] GOTO 0x01E7

SUBROUTINE_01C2:
 94: 0x01C2 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x01E7
 95: 0x01CA [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 96: 0x01D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=6880*)
    → "Aw, give me the cold shoulder, will you? Well, you'll change your mind sooner or later, heheh.\u007F1\u0000\u0007"
 97: 0x01DC [0x23] WAIT_FOR_DIALOG_INTERACTION
 98: 0x01DD [0x03] Work_Zone[1] = 1073741824*
 99: 0x01E2 [0x21] END_EVENT
100: 0x01E3 [0x00] END_REQSTACK()

SUBROUTINE_01E7:
101: 0x01E7 [0x00] END_REQSTACK()
```
