...
SUBROUTINE_014F:
  ...
  4: 0x0150 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  5: 0x0161 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 15: 0x01A0 [0xBA] SET_ENTITY_POSITION(entity_id=References[17760271], pos_x=-61.687*, pos_z=-5.567*, pos_y=-11.287*, direction=256.2°*)
 ...
 23: 0x01DA [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s037", work_offset2=0*)
 24: 0x01EB [0x1C] WAIT(15* ticks)
 25: 0x01EE [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 26: 0x01FF [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=33*, entity1=Naillina (ID: 17793040/0x010F8010), entity2=Naillina (ID: 17793040/0x010F8010), action="tlb0")
 27: 0x020E [0x2B] Naillina (ID: 17793040/0x010F8010) [7991*]:
    → "Ah, you must be \u0008.\u007F1\u0000\u0007"
 28: 0x0215 [0x23] WAIT_FOR_DIALOG_INTERACTION
 29: 0x0216 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=33*, entity1=Naillina (ID: 17793040/0x010F8010), entity2=Naillina (ID: 17793040/0x010F8010), action="tlb1")
 ...
 34: 0x0243 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s038", work_offset2=0*)
 35: 0x0254 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=Naillina (ID: 17793040/0x010F8010), entity2=Naillina (ID: 17793040/0x010F8010), action="tlk0")
 ...
 38: 0x026B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=Naillina (ID: 17793040/0x010F8010), entity2=Naillina (ID: 17793040/0x010F8010), action="tlk1")
 ...
 42: 0x0293 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s039", work_offset2=0*)
 ...
 48: 0x02CA [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s040", work_offset2=0*)
 49: 0x02DB [0x5B] LOAD_EXT_SCHEDULER(work_offset=60*, entity1=Abelard (ID: 17793039/0x010F800F), entity2=Abelard (ID: 17793039/0x010F800F), action="tlk0")
 ...
 54: 0x02FA [0x5B] LOAD_EXT_SCHEDULER(work_offset=60*, entity1=Abelard (ID: 17793039/0x010F800F), entity2=Abelard (ID: 17793039/0x010F800F), action="tlk1")
 55: 0x0309 [0x52] END_LOAD_SCHEDULER: End scheduler "s040" with entities [EventEntity, EventEntity], work=760*
 56: 0x0318 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s041", work_offset2=0*)
 ...
 59: 0x0331 [0x5B] LOAD_EXT_SCHEDULER(work_offset=60*, entity1=Abelard (ID: 17793039/0x010F800F), entity2=Abelard (ID: 17793039/0x010F800F), action="tlb0")
 ...
 65: 0x0355 [0x5B] LOAD_EXT_SCHEDULER(work_offset=60*, entity1=Abelard (ID: 17793039/0x010F800F), entity2=Abelard (ID: 17793039/0x010F800F), action="tlb1")
 66: 0x0364 [0x52] END_LOAD_SCHEDULER: End scheduler "s041" with entities [EventEntity, EventEntity], work=760*
 67: 0x0373 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s042", work_offset2=0*)
 68: 0x0384 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=33*, entity1=Naillina (ID: 17793040/0x010F8010), entity2=Naillina (ID: 17793040/0x010F8010), action="tlb0")
 ...
 71: 0x039B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=33*, entity1=Naillina (ID: 17793040/0x010F8010), entity2=Naillina (ID: 17793040/0x010F8010), action="tlb1")
 72: 0x03AA [0x52] END_LOAD_SCHEDULER: End scheduler "s042" with entities [EventEntity, EventEntity], work=760*
 73: 0x03B9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s043", work_offset2=0*)
 74: 0x03CA [0x5B] LOAD_EXT_SCHEDULER(work_offset=60*, entity1=Abelard (ID: 17793039/0x010F800F), entity2=Abelard (ID: 17793039/0x010F800F), action="tlk0")
 ...
 81: 0x03FD [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s044", work_offset2=0*)
 ...
 84: 0x0416 [0x5B] LOAD_EXT_SCHEDULER(work_offset=60*, entity1=Abelard (ID: 17793039/0x010F800F), entity2=Abelard (ID: 17793039/0x010F800F), action="tlk1")
 85: 0x0425 [0x52] END_LOAD_SCHEDULER: End scheduler "s044" with entities [EventEntity, EventEntity], work=760*
 86: 0x0434 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s045", work_offset2=0*)
 87: 0x0445 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=Naillina (ID: 17793040/0x010F8010), entity2=Naillina (ID: 17793040/0x010F8010), action="tlk0")
 88: 0x0454 [0x2B] Naillina (ID: 17793040/0x010F8010) [8003*]:
    → "Best of luck!\u007F1\u0000\u0007"
 89: 0x045B [0x23] WAIT_FOR_DIALOG_INTERACTION
 90: 0x045C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 91: 0x046D [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 94: 0x048D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi2", work_offset2=0*)
