...
```
  ...
  3: 0x0028 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  4: 0x0039 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 16: 0x007F [0x45] LOAD_SCHEDULED_TASK(work_offset1=148*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="se09", work_offset2=0*)
 17: 0x0090 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 18: 0x00A1 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 ...
 21: 0x00B2 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=10*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 25: 0x00CC [0x45] LOAD_SCHEDULED_TASK(work_offset1=148*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="se08", work_offset2=0*)
 ...
 35: 0x0106 [0x5B] LOAD_EXT_SCHEDULER(work_offset=2569*, entity1=Mathilde's Son (ID: 17793052/0x010F801C), entity2=Mathilde's Son (ID: 17793052/0x010F801C), action="tla0")
 36: 0x0115 [0x1C] WAIT(30* ticks)
 37: 0x0118 [0x01] GOTO 0x012A

SUBROUTINE_011B:
 38: 0x011B [0x5B] LOAD_EXT_SCHEDULER(work_offset=75*, entity1=Mathilde's Son (ID: 17793052/0x010F801C), entity2=Mathilde's Son (ID: 17793052/0x010F801C), action="pas0")
 ...
 44: 0x013C [0x5B] LOAD_EXT_SCHEDULER(work_offset=2569*, entity1=Mathilde's Son (ID: 17793052/0x010F801C), entity2=Mathilde's Son (ID: 17793052/0x010F801C), action="tla1")
 45: 0x014B [0x01] GOTO 0x015B

SUBROUTINE_014E:
 46: 0x014E [0x53] WAIT_SCHEDULER_TASK(entity1=Mathilde's Son (ID: 17793052/0x010F801C), entity2=Mathilde's Son (ID: 17793052/0x010F801C), action_id="pas0")
 47: 0x015B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=11*, entity1=EventEntity, entity2=EventEntity, action="aig0")
 ...
 50: 0x016E [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="aig0")
 51: 0x017B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=11*, entity1=EventEntity, entity2=EventEntity, action="aig1")
 52: 0x018A [0x02] IF !(ExtData[1]->WorkLocal[0] == 1*) GOTO 0x01A4
 53: 0x0192 [0x5B] LOAD_EXT_SCHEDULER(work_offset=2569*, entity1=Mathilde's Son (ID: 17793052/0x010F801C), entity2=Mathilde's Son (ID: 17793052/0x010F801C), action="yes0")
 54: 0x01A1 [0x01] GOTO 0x01B3

SUBROUTINE_01A4:
 55: 0x01A4 [0x5B] LOAD_EXT_SCHEDULER(work_offset=75*, entity1=Mathilde's Son (ID: 17793052/0x010F801C), entity2=Mathilde's Son (ID: 17793052/0x010F801C), action="tlk0")
 ...
 59: 0x01C3 [0x53] WAIT_SCHEDULER_TASK(entity1=Mathilde's Son (ID: 17793052/0x010F801C), entity2=Mathilde's Son (ID: 17793052/0x010F801C), action_id="yes0")
 60: 0x01D0 [0x01] GOTO 0x01E0

SUBROUTINE_01D3:
 61: 0x01D3 [0x53] WAIT_SCHEDULER_TASK(entity1=Mathilde's Son (ID: 17793052/0x010F801C), entity2=Mathilde's Son (ID: 17793052/0x010F801C), action_id="tlk0")
 62: 0x01E0 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="aig1")
 63: 0x01ED [0x1D] PRINT_EVENT_MESSAGE(message_id=6966*)
    → "Take care!\u007F1\u0000\u0007"
 64: 0x01F0 [0x23] WAIT_FOR_DIALOG_INTERACTION
 65: 0x01F1 [0x55] WAIT_LOAD_SCHEDULER(work_offset=148*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="se08")
...
SUBROUTINE_0212:
 ...
 70: 0x0219 [0x55] WAIT_LOAD_SCHEDULER(work_offset=148*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="se10")
 71: 0x0228 [0x45] LOAD_SCHEDULED_TASK(work_offset1=148*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="se09", work_offset2=0*)
 72: 0x0239 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=10*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 75: 0x024C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 76: 0x025D [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 82: 0x0285 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 83: 0x0296 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
