...
```
 ...
 23: 0x0083 [0xBA] SET_ENTITY_POSITION(entity_id=References[17760380], pos_x=-61.041*, pos_z=0.693*, pos_y=-11.459*, direction=313.6°*)
 24: 0x0090 [0xBA] SET_ENTITY_POSITION(entity_id=References[17760381], pos_x=-62.238*, pos_z=-0.524*, pos_y=-11.359*, direction=315.1°*)
 25: 0x009D [0xBA] SET_ENTITY_POSITION(entity_id=LocalPlayer, pos_x=17.989*, pos_z=83.259*, pos_y=-14.558*, direction=95.1°*)
 26: 0x00AA [0xBA] SET_ENTITY_POSITION(entity_id=References[17760378], pos_x=21.427*, pos_z=72.360*, pos_y=-14.558*, direction=242.0°*)
 ...
 34: 0x00DE [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s033", work_offset2=0*)
 35: 0x00EF [0x1C] WAIT(15* ticks)
 36: 0x00F2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 ...
 40: 0x011C [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s034", work_offset2=0*)
 ...
 44: 0x013C [0xBA] SET_ENTITY_POSITION(entity_id=References[17760380], pos_x=-30.346*, pos_z=-9.467*, pos_y=-2.558*, direction=49.4°*)
 45: 0x0149 [0xBA] SET_ENTITY_POSITION(entity_id=References[17760381], pos_x=-31.605*, pos_z=-7.680*, pos_y=-2.558*, direction=51.1°*)
 ...
 53: 0x0183 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s035", work_offset2=0*)
 ...
 58: 0x01B0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s036", work_offset2=0*)
 ...
 63: 0x01D7 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Esteban (ID: 17793146/0x010F807A), entity2=Esteban (ID: 17793146/0x010F807A), action="tlk0")
...
SUBROUTINE_01F1:
 ...
 68: 0x01F7 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Esteban (ID: 17793146/0x010F807A), entity2=Esteban (ID: 17793146/0x010F807A), action="thk1")
 ...
 71: 0x020E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Esteban (ID: 17793146/0x010F807A), entity2=Esteban (ID: 17793146/0x010F807A), action="thk2")
 ...
 74: 0x0225 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 75: 0x0236 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 78: 0x0256 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi2", work_offset2=0*)
