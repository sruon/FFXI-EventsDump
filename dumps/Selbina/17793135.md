...
- **7694**: Fish Ranking Menu: Currently [contesting the rules for the next ranking/preparing to accept entries/accepting entries/preparing to release results/presenting ranking results to the public/not accepting entries/closed]. [Check rules./Change control mode: Currently [automatic/semi-automatic/manual]./Debug level: Currently level $5./Change step: Currently [contesting the rules for the next ranking/preparing to accept entries/accepting entries/preparing to release results/presenting ranking results to the public/not accepting entries/closed]./Set rules for next ranking./Display time remaining until next step./Move to next step./Time setting: Current speed: [Standard/Debug 1/Debug 2]./Close menu.]
- **7695**: Choose control mode. (Currently [automatic/semi-automatic/manual]) [[$26/ / ]AutomaticiDefaultj/[ /$26/ ]Semi-automatic (Stop at "contesting," then automatic)/[ / /$26]Manual (Stop advancement)]
- **7696**: Displayed rules go into effect... [This time./Next time.]
- **7697**: Select one... [Contesting rules./Preparing to accept entries./Accepting entries./Preparing to release results./Announcing ranking results./Not accepting entries (set rules here)./Closed (stopped completely).]
- **7704**: Choose the first rule. [Largest fish wins./Smallest fish wins.]
- **7705**: Choose the second rule. [Size./Weight./Size and weight.]
- **7707**: Set debug level. [[$26/ / ]Level 0 (None)/[ /$26/ ]Level 1 (Displays)/[ / /$26]Level 2 (Bypass board default errors)]
- **7711**: Time settings... (Effective beginning next step) [[$26/ / ]StandardiAF2$T$T/DF15$P15*j/[ /$26/ ]Step confirmation speediAF30 seconds/DF30 secondsj/[ / /$26]QA Debug speediAF30 minutes/DF15 minutesj]
...
SUBROUTINE_0044:
 13: 0x0044 [0x24] CREATE_DIALOG(message_id=7694*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
    → "Fish Ranking Menu: Currently [contesting the rules for the next ranking/preparing to accept entries/accepting entries/preparing to release results/presenting ranking results to the public/not accepting entries/closed]. [Check rules./Change control mode: Currently [automatic/semi-automatic/manual]./Debug level: Currently level $5./Change step: Currently [contesting the rules for the next ranking/preparing to accept entries/accepting entries/preparing to release results/presenting ranking results to the public/not accepting entries/closed]./Set rules for next ranking./Display time remaining until next step./Move to next step./Time setting: Current speed: [Standard/Debug 1/Debug 2]./Close menu.]"
 14: 0x004B [0x25] WAIT_DIALOG_SELECT()
 15: 0x004C [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0078
 16: 0x0054 [0x24] CREATE_DIALOG(message_id=7696*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0071:
 ...
 26: 0x0080 [0x24] CREATE_DIALOG(message_id=7695*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00C4:
 ...
 45: 0x00CF [0x24] CREATE_DIALOG(message_id=7707*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00FC:
 ...
 74: 0x014F [0x24] CREATE_DIALOG(message_id=7711*, default_option=0*, option_flags=0*)
...
SUBROUTINE_019B:
 95: 0x019B [0x24] CREATE_DIALOG(message_id=7697*, default_option=0*, option_flags=1*)
...
SUBROUTINE_0384:
203: 0x0384 [0x24] CREATE_DIALOG(message_id=7704*, default_option=0*, option_flags=0*)
...
SUBROUTINE_03AB:
212: 0x03AB [0x24] CREATE_DIALOG(message_id=7705*, default_option=0*, option_flags=0*)
