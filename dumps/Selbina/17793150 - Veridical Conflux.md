...
- **8044**: Select a difficulty. [Back./Very difficult. (Level: ???)/Difficult. (Level: $10)/Normal. (Level: $11)/Easy. (Level: $12)/Very easy. (Level: $13)]
- **8045**: [Apply to proceed/Proceed]? [Definitely!/Not yet.]
- **8056**: You will be able to call forth up to $4 alter ego[/s] given the current number of players in your party.
- **8064**: You are currently number $3 in line to be drawn into this nightmare.
- **8065**: You are currently number $3 in line, with $2 in front of you.
- **8066**: Prepare yourselves! The battlefield is almost ready!
- **8067**: Your number: $3. (Auto-transport: [off/on]) [Remove your name./Toggle auto-transport./Close dialogue.]
- **8079**: Attempt which? (Auto-transport: [off/on]) [None./$26A Stygian Pact./$26Champion of the Dawn./$26Divine Interference./$26Maiden of the Dusk././././././././././././Toggle auto-transport.]
- **8080**: Only party members present with you in this area will be transported to [/$26A Stygian Pact/$26Champion of the Dawn/$26Divine Interference/$26Maiden of the Dusk][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8081**: Entering [/$26A Stygian Pact/$26Champion of the Dawn/$26Divine Interference/$26Maiden of the Dusk][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8082**: You have chosen not to [apply to/enter] [/$26A Stygian Pact/$26Champion of the Dawn/$26Divine Interference/$26Maiden of the Dusk][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8085**: Applying to enter [/$26A Stygian Pact/$26Champion of the Dawn/$26Divine Interference/$26Maiden of the Dusk][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy]. You will be unable to participate if you add any more party members. Are you sure?
- **8086**: You are currently applying to enter [/$26A Stygian Pact/$26Champion of the Dawn/$26Divine Interference/$26Maiden of the Dusk][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8087**: Debug menu. [Check information./View applicants./Applicant parameters./Change maximum limit./Clear applications./Automatically create./Close dialogue.]
- **8096**: Designate a value between $0 and $1.
- **8107**: $)$P13.$P106$P10, $P13.$lF$0 [1"/%<$P15{/$~_i/$m$P14F/$3$43308646i]
...
```
 ...
 12: 0x003A [0x24] CREATE_DIALOG(message_id=8079*, default_option=0*, option_flags=ExtData[1]->WorkLocal[7])
...
SUBROUTINE_00A4:
 ...
 40: 0x00D4 [0x24] CREATE_DIALOG(message_id=8044*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0144:
 ...
 69: 0x015F [0x24] CREATE_DIALOG(message_id=8045*, default_option=0*, option_flags=0*)
...
SUBROUTINE_01D0:
 ...
 16: 0x01F1 [0x24] CREATE_DIALOG(message_id=8067*, default_option=1*, option_flags=0*)
...
```
  ...
  6: 0x0234 [0x24] CREATE_DIALOG(message_id=8045*, default_option=0*, option_flags=0*)
    → "[Apply to proceed/Proceed]? [Definitely!/Not yet.]"
...
```
  ...
  3: 0x028D [0x24] CREATE_DIALOG(message_id=8087*, default_option=0*, option_flags=0*)
 ...
 44: 0x0346 [0x24] CREATE_DIALOG(message_id=8107*, default_option=0*, option_flags=0*)
