...
266: 0x0805 [0x24] CREATE_DIALOG(message_id=7874*, default_option=0*, option_flags=0x00)
...
276: 0x082B [0x8B] SET_EVENT_MARK: Add/update map marker on map 249* at (-39.3*, 70.1*), index=ExtData[1]->WorkLocal[9], name=(no name)
...
296: 0x0C7F [0x24] CREATE_DIALOG(message_id=7875*, default_option=0*, option_flags=0x01)
...
306: 0x0CA5 [0x8B] SET_EVENT_MARK: Add/update map marker on map 248* at (-10.0*, -6.2*), index=ExtData[1]->WorkLocal[10], name=(no name)
