...
```
  ...
  2: 0x015A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  3: 0x016B [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
  4: 0x017A [0x46] CAMERA_CONTROL: Disable user control
  5: 0x017C [0x38] SET_CLIENT_EVENT_MODE(mode=3*)
  6: 0x017F [0x45] LOAD_SCHEDULED_TASK(work_offset1=148*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="se00", work_offset2=0*)
 ...
 10: 0x01A1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 11: 0x01B2 [0x55] WAIT_LOAD_SCHEDULER(work_offset=148*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="se00")
 12: 0x01C1 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 ...
 16: 0x01E4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=148*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="se01", work_offset2=0*)
 17: 0x01F5 [0x55] WAIT_LOAD_SCHEDULER(work_offset=148*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="se01")
 18: 0x0204 [0x1D] PRINT_EVENT_MESSAGE(message_id=6843*)
    → "We're thankful enough you're safe. We apologize we couldn't help you.\u007F1\u0000\u0007"
 19: 0x0207 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=60*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 27: 0x0235 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
 ...
 32: 0x024E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=60*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 44: 0x028E [0x53] WAIT_SCHEDULER_TASK(entity1=Thunder Hawk (ID: 17793026/0x010F8002), entity2=Thunder Hawk (ID: 17793026/0x010F8002), action_id="tlk0")
 45: 0x029B [0x29] REQ_SET_WAIT(priority=0x80, entity_id=Serafin (ID: 17793027/0x010F8003), tag_num=0x03)
 46: 0x02A2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo0", work_offset2=0*)
 47: 0x02B3 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo0")
 ...
 51: 0x02D2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi0", work_offset2=0*)
 52: 0x02E3 [0x03] Work_Zone[1] = 71*
 53: 0x02E8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
