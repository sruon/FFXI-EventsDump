...
```
  ...
  4: 0x002F [0x45] LOAD_SCHEDULED_TASK(work_offset1=148*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="se10", work_offset2=0*)
 ...
 14: 0x006D [0x5B] LOAD_EXT_SCHEDULER(work_offset=75*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 17: 0x0080 [0x5B] LOAD_EXT_SCHEDULER(work_offset=60*, entity1=Ramona (ID: 17793050/0x010F801A), entity2=Ramona (ID: 17793050/0x010F801A), action="tlk0")
 ...
 20: 0x0097 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
 ...
 23: 0x00AE [0x39] SET_ENTITY_DIRECTION(direction=0.0°)
