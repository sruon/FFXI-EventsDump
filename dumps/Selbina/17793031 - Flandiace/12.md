...
```
 ...
 11: 0x0031 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 14: 0x0044 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 15: 0x0055 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 16: 0x0064 [0x46] CAMERA_CONTROL: Disable user control
 17: 0x0066 [0x1C] WAIT(60* ticks)
 18: 0x0069 [0x45] LOAD_SCHEDULED_TASK(work_offset1=148*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="se02", work_offset2=0*)
 19: 0x007A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 20: 0x008B [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 ...
 23: 0x009E [0x55] WAIT_LOAD_SCHEDULER(work_offset=148*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="se02")
 24: 0x00AD [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 25: 0x00BE [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 26: 0x00CD [0x1C] WAIT(60* ticks)
 27: 0x00D0 [0x46] CAMERA_CONTROL: Restore default settings
 28: 0x00D2 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 29: 0x00E1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 30: 0x00F2 [0x01] GOTO 0x0117

SUBROUTINE_00F5:
 31: 0x00F5 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x0117
 32: 0x00FD [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
