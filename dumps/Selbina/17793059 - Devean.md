...
- **6882**: Hey [mister/lady], I know a quick and easy way to make money, but you can't handle it yet.
- **6883**: Hey [mister/lady], you got some spare time? I know the road to easy money! Want to give it a try?
- **6884**: Interested? [Yeah, so far./No way.]
- **6885**: Aw, give me the cold shoulder, will you? Well, you'll change your mind sooner or later, heheh.
- **6886**: That's the spirit! You've just got to prove yourself, that's all. Find some loot I hid in Davoi, bring it to me, and you win.
- **6887**: But that's not all, [big shot/sweetheart]. You'll get cold, hard cash! You can pick how much time you think you'll need to do the job.
- **6888**: You'll have pockets full o' gil if you bring it back before the time's up. If not...well, then you don't get jack! Simple, ain't it?
- **6889**: You want more spending money, right? Come on, give it a try! You can't afford not to!
- **6890**: Give it a try? [I'm game./I'll pass, thanks.]
- **6891**: Okay, whatever. But you'll never make the big time with that attitude. Prudes like you should stick to sellin' $5 to make ends meet.
- **6892**: That's the spirit! Life's nothin' but a game of chance, right? Here's the rules.
- **6893**: You gotta bring me $1, hidden inside an urn in Davoi. And I ain't tellin' ya which one.
- **6894**: But here's a hint: It's in an urn all by itself, not one that's bunched up with others. Eh, you'll figure it out once you get there.
- **6895**: Bets start at 100 gil! It goes 100, 250, 500, and the big 1000. Then choose a deadline of 24, 36, 48, 60, or 72 hours.
- **6896**: And, the shorter the time, the bigger the payoff. You'll get triple if you make it back in 24 hours, but 72 only yields one and one-fifth.
- **6897**: I'll bet... [100 gil."50 gil./500 gil./1000 gil./5000 gil./I'll pass.]
- **6898**: I'll be back in [24 hours for triple payout."6 hours for 2.5 times payout./48 hours for double payout./60 hours for 1.5 times payout./72 hours for 1.2 times payout./Cancel]
- **6899**: So, you're betting me $2 gil that you'll be back here in $3 hours to hand me $1. So what are you waitin' for? Get movin'!
- **6900**: The clock's tickin'! I told you, comb Davoi for $0 in an urn somewhere. You got $1 hours left. Hey, I can chat all day if you want...
- **6901**: Look what we got here! You made it in time! Congrats, the money's yours! Don't spend it all in one place.
- **6902**: Aw, too bad, hehe! You're late, [pal/sweetheart], so the money's mine. Of course, you can always give it another shot.
- **7088**: Sorry, you ran out of time. If you have $0 you can give it to me, or you can toss it and speak to me again.
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=6883*)
  ...
  8: 0x002D [0x24] CREATE_DIALOG(message_id=6884*, default_option=0*, option_flags=0*)
 ...
 12: 0x004C [0x1D] PRINT_EVENT_MESSAGE(message_id=6886*)
 ...
 14: 0x0050 [0x1D] PRINT_EVENT_MESSAGE(message_id=6887*)
 ...
 16: 0x0054 [0x1D] PRINT_EVENT_MESSAGE(message_id=6888*)
 ...
 18: 0x0058 [0x1D] PRINT_EVENT_MESSAGE(message_id=6889*)
 ...
 22: 0x006E [0x24] CREATE_DIALOG(message_id=6890*, default_option=0*, option_flags=0*)
 ...
 30: 0x0095 [0x1D] PRINT_EVENT_MESSAGE(message_id=6894*)
 ...
 32: 0x0099 [0x1D] PRINT_EVENT_MESSAGE(message_id=6895*)
 ...
 34: 0x009D [0x1D] PRINT_EVENT_MESSAGE(message_id=6896*)
 ...
 39: 0x00B4 [0x24] CREATE_DIALOG(message_id=6897*, default_option=0*, option_flags=16*)
...
SUBROUTINE_010F:
 57: 0x010F [0x24] CREATE_DIALOG(message_id=6898*, default_option=0*, option_flags=0*)
...
SUBROUTINE_016A:
 ...
 82: 0x0191 [0x1D] PRINT_EVENT_MESSAGE(message_id=6899*)
...
SUBROUTINE_01A2:
 ...
 87: 0x01B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=6891*)
...
SUBROUTINE_01BF:
 ...
 95: 0x01D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=6885*)
...
```
  ...
  4: 0x01FE [0x1D] PRINT_EVENT_MESSAGE(message_id=6900*)
...
```
  ...
  6: 0x021D [0x1D] PRINT_EVENT_MESSAGE(message_id=6901*)
...
```
  ...
  6: 0x0252 [0x1D] PRINT_EVENT_MESSAGE(message_id=6902*)
...
```
  ...
  5: 0x0275 [0x1D] PRINT_EVENT_MESSAGE(message_id=7088*)
...
```
  ...
  4: 0x0291 [0x1D] PRINT_EVENT_MESSAGE(message_id=6882*)
