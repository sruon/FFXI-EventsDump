...
SUBROUTINE_0144:
 31: 0x0144 [0x03] Work_Zone[6] = ExtData[1]->WorkLocal[11]
 32: 0x0149 [0x48] [System] [8050*]:
    → "You will be able to call forth up to 
\u0004 alter ego\u007F\u0012\u0004[/s] given the current number of players in your party.\u007F1\u0000\u0007"
 33: 0x014C [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[1]
 34: 0x0151 [0x03] Work_Zone[4] = ExtData[1]->WorkLocal[3]
 35: 0x0156 [0x48] [System] [8079*]:
 ...
 36: 0x0159 [0x23] WAIT_FOR_DIALOG_INTERACTION
 37: 0x015A [0x03] Work_Zone[3] = 0*
 38: 0x015F [0x24] CREATE_DIALOG(message_id=8039*, default_option=0*, option_flags=0*)
    → "\u000C\u0001[Apply to proceed/Proceed]?\u0007\u000BDefinitely!\u0007Not yet.\u007F1\u0000\u0007"
 39: 0x0166 [0x25] WAIT_DIALOG_SELECT()
 40: 0x0167 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0198
 41: 0x016F [0x03] Work_Zone[1] = 0*
 42: 0x0174 [0x40] SET_BIT_WORK_RANGE(start_bit=0*, end_bit=11*, target=Work_Zone[1], source=ExtData[1]->WorkLocal[1])
 43: 0x017D [0x40] SET_BIT_WORK_RANGE(start_bit=14*, end_bit=16*, target=Work_Zone[1], source=ExtData[1]->WorkLocal[3])
 44: 0x0186 [0x43] SEND_EVENT_UPDATE: Send pending tag to server (packet 0x005B)
 45: 0x0188 [0x43] SEND_EVENT_UPDATE: Check pending flag (skip if not pending)
 46: 0x018A [0x02] IF !(Work_Zone[9] == 0*) GOTO 0x0195
 47: 0x0192 [0x01] GOTO 0x0144
 48: 0x0195 [0x01] GOTO 0x01B1
 49: 0x0198 [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[1]
 50: 0x019D [0x03] Work_Zone[3] = 0*
 51: 0x01A2 [0x03] Work_Zone[4] = ExtData[1]->WorkLocal[3]
 52: 0x01A7 [0x48] [System] [8076*]:
 ...
 53: 0x01AA [0x03] Work_Zone[1] = 1073741824*
 54: 0x01AF [0x21] END_EVENT
 55: 0x01B0 [0x00] END_REQSTACK()
 56: 0x01B1 [0x21] END_EVENT
 57: 0x01B2 [0x00] END_REQSTACK()
```
