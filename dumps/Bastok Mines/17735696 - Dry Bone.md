...
- **10556**: What's the matter? Are you lost?
- **10557**: Ask for directions? [Ask./Don't ask.]
- **10558**: Where do you want to go?
- **10559**: Which area would you like to ask about? [The South Gate and the residential area./The Markets and the Mines./The mining town and Alchemists' Guild./Uh, never mind.]
- **10561**: See that big building south from here, on the left?
- **10562**: That's the auction house. You can buy other people's items or sell items yourself there.
- **10563**: You can send items to your friends there as well. Just talk to the Galkan deliveryman on post.
- **10564**: If you keep going south, you'll find the South Gate.
- **10565**: Go through it to go to South Gustaberg. If you are a Bastoker, you can also receive missions from the guard at the gatehouse.
- **10566**: If you go left from the South Gate toward the east, you'll come across another building.
- **10567**: That's where you'll find the Chocobo Stables. You can rent chocobos there to help you on those long trips.
- **10568**: If you go further east, you'll come to the entrance to the residential area. Go on inside if you want to drop off items in your room.
- **10569**: If you are not from Bastok, however, you'll need to get a Rent-a-Room first.
- **10570**: Go through the arch west of here.
- **10571**: You will see a road sloping down on your right. Walk down that road to go to the Markets district.
- **10572**: If you go straight west, you'll be able to see the entrance to the mines.
- **10573**: Inside the mines you will find miners, of course--but also monsters. You should be careful.
- **10574**: To the north of this fork there are two arches, one big and one small.
- **10575**: The big arch leads to the lower level of the mining town, while the small one leads to its surface level.
- **10576**: If you walk through the small arch to the surface level, you'll find an inn to your left.
- **10577**: Across from the inn is the armory.
- **10578**: If you go further down the road, you'll come across a goods shop and the back exit of the mining town.
- **10579**: Go through the exit and you'll be behind the auction house.
- **10580**: You'll also find stairs off to the side, midway down the mining town street. Those connect the surface and lower levels.
- **10581**: At the far end of the lower level, to the east, is where you'll find the Alchemists' Guild.
- **10582**: That's about it. I can explain it to you again, but it might be better for you to just go to those places yourself and talk to the people there.
...
```
  ...
  1: 0x0007 [0x1D] PRINT_EVENT_MESSAGE(message_id=10556*)
    → "What's the matter? Are you lost?"
  2: 0x000A [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x000B [0x24] CREATE_DIALOG(message_id=10557*, default_option=0*, option_flags=0*)
    → "Ask for directions? [Ask./Don't ask.]"
  4: 0x0012 [0x25] WAIT_DIALOG_SELECT()
  5: 0x0013 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x037D
  6: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=10558*)
    → "Where do you want to go?"
  7: 0x001E [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x001F [0x24] CREATE_DIALOG(message_id=10559*, default_option=0*, option_flags=0*)
 ...
 21: 0x0077 [0x1D] PRINT_EVENT_MESSAGE(message_id=10561*)
    → "See that big building south from here, on the left?"
 22: 0x007A [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x007B [0x1D] PRINT_EVENT_MESSAGE(message_id=10562*)
 ...
 27: 0x009F [0x1D] PRINT_EVENT_MESSAGE(message_id=10563*)
 ...
 32: 0x00C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=10564*)
    → "If you keep going south, you'll find the South Gate."
 33: 0x00C9 [0x23] WAIT_FOR_DIALOG_INTERACTION
 34: 0x00CA [0x1D] PRINT_EVENT_MESSAGE(message_id=10565*)
 ...
 39: 0x00F1 [0x1D] PRINT_EVENT_MESSAGE(message_id=10566*)
 ...
 41: 0x00F5 [0x1D] PRINT_EVENT_MESSAGE(message_id=10567*)
 ...
 46: 0x011C [0x1D] PRINT_EVENT_MESSAGE(message_id=10568*)
 ...
 48: 0x0120 [0x1D] PRINT_EVENT_MESSAGE(message_id=10569*)
 ...
 56: 0x015D [0x1D] PRINT_EVENT_MESSAGE(message_id=10582*)
 ...
 69: 0x01AE [0x1D] PRINT_EVENT_MESSAGE(message_id=10570*)
    → "Go through the arch west of here."
 70: 0x01B1 [0x23] WAIT_FOR_DIALOG_INTERACTION
 71: 0x01B2 [0x1D] PRINT_EVENT_MESSAGE(message_id=10571*)
 ...
 86: 0x021A [0x1D] PRINT_EVENT_MESSAGE(message_id=10582*)
    → "That's about it. I can explain it to you again, but it might be better for you to just go to those places yourself and talk to the people there."
...
106: 0x0296 [0x1D] PRINT_EVENT_MESSAGE(message_id=10576*)
...
111: 0x02BD [0x1D] PRINT_EVENT_MESSAGE(message_id=10577*)
...
116: 0x02E4 [0x1D] PRINT_EVENT_MESSAGE(message_id=10578*)
...
118: 0x02E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=10579*)
...
123: 0x030F [0x1D] PRINT_EVENT_MESSAGE(message_id=10580*)
...
128: 0x0336 [0x1D] PRINT_EVENT_MESSAGE(message_id=10581*)
...
136: 0x0373 [0x1D] PRINT_EVENT_MESSAGE(message_id=10582*)
    → "That's about it. I can explain it to you again, but it might be better for you to just go to those places yourself and talk to the people there."
