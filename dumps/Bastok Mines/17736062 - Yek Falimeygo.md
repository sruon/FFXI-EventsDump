...
- **16505**: Here we sell items from the various guildmasters and also exchange crafter points for your convenience.
- **16506**: Sorry, we don't allow amateur craftsmen to take advantage of our services.
- **16507**: What would you like to do? [Purchase a crafting kit./Exchange crafter points././Special materials./Check the deliverable items./Ask about the delivery process./Never mind.]
- **16510**: You want to purchase $31? It will cost $! gil for $ of them.
- **16511**: Are you sure about this? [Yes, I'm sure./On second thought...]
- **16513**: Which item? ($30 crafter points) [# ($10 CP)./$1 ($11 CP)./$2 ($12 CP)./$3 ($13 CP)./$4 ($14 CP)./$5 ($15 CP)./$6 ($16 CP)./$7 ($17 CP)./$8 ($18 CP)./$9 ($19 CP)./I changed my mind.]
- **16514**: Do you want to purchase the $20 for $21 crafter points?
- **16515**: Do you want to make the trade? [Yes./No.]
- **16517**: These are the items that we are taking deliveries of. Simply select an item whenever you want to check the recipe.
- **16518**: Deliverable Items [#./$1./$2./$3./$4./$5./$6./$7./$8./I'm finished here.]
- **16519**: This is where you can deliver the crafting sets that the guildmasters have created.
- **16520**: By delivering items, you can earn crafter points that can be exchanged for special ingredients.
- **16521**: Crafting sets can be made by using special crystals known as analysis crystals, crystals which that enable you to set the quality level.
- **16522**: The higher the quality level of the crafting set created, the more crafter points you'll earn, so try to make the highest quality sets you can manage.
- **16523**: Analysis crystals can be obtained from the person in charge of accepting deliveries in exchange for guild points.
- **16524**: Analysis crystals cannot be used to create items other than the ones in the crafting sets.
- **16525**: Please note that you can't use $1 in place of $0.
- **16526**: The ingredients required to make a crafting set can be checked by referring to the deliverable items list.
- **16527**: At the present time, you can receive up to a maximum of $2 guild point[/s].
- **16528**: Any points beyond that from making deliveries will be lost, so keep that in mind.
- **16529**: Crafting sets delivered here will be sold as crafting kits until the next day at 10:00 a.m. (Vana'diel time).
- **16530**: It helps the junior members of the guild, so keep on making those deliveries.
- **16533**: We now have available $0 for the low cost of $1 gil per.
- **16534**: I am willing to part with up to $2.
- **16535**: My apologies, but our stock is limited and I cannot sell you any more at this time.
- **16536**: What do you want to do? [Obtain a kit./Check the scheduled quantity./Ship the item./Nothing.]
- **16537**: Which do you want? [#./$1./$2./$3./$4./$5./$6./$7./$8./Exit.]
- **16538**: What is the quality? (1-1000)
...
SUBROUTINE_01BD:
  3: 0x01BD [0x24] CREATE_DIALOG(message_id=16536*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0C1C:
 ...
 35: 0x0C4E [0x24] CREATE_DIALOG(message_id=16537*, default_option=0*, option_flags=0*)
...
# Dead code (unreachable instructions):
     ...
     0x007E [0x1D] PRINT_EVENT_MESSAGE(message_id=16505*)
    → "Here we sell items from the various guildmasters and also exchange crafter points for your convenience."
     ...
     0x00F0 [0x24] CREATE_DIALOG(message_id=16507*, default_option=ExtData[1]->WorkLocal[42], option_flags=ExtData[1]->WorkLocal[5])
    → "What would you like to do? [Purchase a crafting kit./Exchange crafter points././Special materials./Check the deliverable items./Ask about the delivery process./Never mind.]"
     ...
     0x016B [0x1D] PRINT_EVENT_MESSAGE(message_id=16519*)
    → "This is where you can deliver the crafting sets that the guildmasters have created."
     ...
     0x016F [0x1D] PRINT_EVENT_MESSAGE(message_id=16520*)
    → "By delivering items, you can earn crafter points that can be exchanged for special ingredients."
     ...
     0x0173 [0x1D] PRINT_EVENT_MESSAGE(message_id=16521*)
    → "Crafting sets can be made by using special crystals known as analysis crystals, crystals which that enable you to set the quality level."
     ...
     0x0177 [0x1D] PRINT_EVENT_MESSAGE(message_id=16523*)
    → "Analysis crystals can be obtained from the person in charge of accepting deliveries in exchange for guild points."
     ...
     0x017B [0x1D] PRINT_EVENT_MESSAGE(message_id=16524*)
    → "Analysis crystals cannot be used to create items other than the ones in the crafting sets."
     ...
     0x017F [0x1D] PRINT_EVENT_MESSAGE(message_id=16525*)
    → "Please note that you can't use $1 in place of $0."
     0x0182 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0183 [0x1D] PRINT_EVENT_MESSAGE(message_id=16526*)
    → "The ingredients required to make a crafting set can be checked by referring to the deliverable items list."
     ...
     0x0187 [0x1D] PRINT_EVENT_MESSAGE(message_id=16522*)
    ...
    → "Crafting sets delivered here will be sold as crafting kits until the next day at 10:00 a.m. (Vana'diel time)."
     ...
     0x0197 [0x1D] PRINT_EVENT_MESSAGE(message_id=16530*)
    → "It helps the junior members of the guild, so keep on making those deliveries."
     ...
     0x01B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=16505*)
    → "Here we sell items from the various guildmasters and also exchange crafter points for your convenience."
     0x01B7 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x01B8 [0x1D] PRINT_EVENT_MESSAGE(message_id=16506*)
...
# Dead code (unreachable instructions):
     ...
     0x05AC [0x1D] PRINT_EVENT_MESSAGE(message_id=16510*)
    → "You want to purchase $31? It will cost $! gil for $ of them."
     0x05AF [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x05B0 [0x24] CREATE_DIALOG(message_id=16511*, default_option=1*, option_flags=0*)
    → "Are you sure about this? [Yes, I'm sure./On second thought...]"
     ...
     0x069A [0x24] CREATE_DIALOG(message_id=16513*, default_option=ExtData[1]->WorkLocal[46], option_flags=ExtData[1]->WorkLocal[7])
    → "Which item? ($30 crafter points) [# ($10 CP)./$1 ($11 CP)./$2 ($12 CP)./$3 ($13 CP)./$4 ($14 CP)./$5 ($15 CP)./$6 ($16 CP)./$7 ($17 CP)./$8 ($18 CP)./$9 ($19 CP)./I changed my mind.]"
     ...
     0x082A [0x1D] PRINT_EVENT_MESSAGE(message_id=16514*)
    → "Do you want to purchase the $20 for $21 crafter points?"
     0x082D [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x082E [0x24] CREATE_DIALOG(message_id=16515*, default_option=1*, option_flags=0*)
    → "Do you want to make the trade? [Yes./No.]"
     ...
     0x08F2 [0x1B] RETURN
     0x08F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=16517*)
    → "These are the items that we are taking deliveries of. Simply select an item whenever you want to check the recipe."
     ...
     0x0927 [0x24] CREATE_DIALOG(message_id=16518*, default_option=ExtData[1]->WorkLocal[48], option_flags=0*)
    ...
    → "I am willing to part with up to $2."
     ...
     0x0BD0 [0x1D] PRINT_EVENT_MESSAGE(message_id=16510*)
    → "You want to purchase $31? It will cost $! gil for $ of them."
     0x0BD3 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0BD4 [0x24] CREATE_DIALOG(message_id=16511*, default_option=1*, option_flags=0*)
    → "Are you sure about this? [Yes, I'm sure./On second thought...]"
