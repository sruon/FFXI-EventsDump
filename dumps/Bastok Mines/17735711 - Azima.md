...
- **7094**: Image support: $0 gil. [Accept./Decline.]
...
- **7163**: Would ya speak up, [sonny/missy]? I can't hear ya with all that racket.
- **7164**: I've already helped ya. Try learning some respect for your elders, [sonny/missy].
- **7165**: Me cataracts may be acting up, but I can see you're trying to pull a fast one, [sonny/missy].
- **7166**: <Cough!> Oh, now maybe I can pay for me operation! Close your eyes and don't peek...
- **7167**: Hmm. A young [lad/lass] like you might want to try $0. You'll need...
- **7168**: If ya ever need me, I'll be right here, [sonny/missy]. Unless I'm on me death bed. Heh-heh-heh <Cough!> <Cough!> heh...
- **7200**: Our young Abd-al-Raziq has ordered in a pile of research journals from his homeland. There're alchemical processes in there that even I've never seen.
- **7201**: Maybe you can teach an old bird new tricks! Heh-heh-heh <Cough!> <Cough!> heh...
- **14109**: Ask if this person is the chick's owner? [Yes./No.]
- **14220**: Eh? Ya say ya've got my chocobo? Is that so?
- **14221**: I'm not sure I heard that right. Could ya speak up, or am I imagining things again?
- **14222**: Ohhh, bless your soul. A young [lad/lass] like you might just be able to use this... Let me tell you a little story, [sonny/missy]...
- **14234**: Eh? Ya say ya've got my chocobo?
...
```
  ...
  3: 0x0012 [0x1D] PRINT_EVENT_MESSAGE(message_id=7200*)
  ...
  5: 0x0016 [0x1D] PRINT_EVENT_MESSAGE(message_id=7201*)
...
SUBROUTINE_0021:
 10: 0x0021 [0x24] CREATE_DIALOG(message_id=7093*, default_option=2*, option_flags=0*)
 ...
 14: 0x0039 [0x1D] PRINT_EVENT_MESSAGE(message_id=7164*)
 ...
 17: 0x0040 [0x24] CREATE_DIALOG(message_id=7094*, default_option=1*, option_flags=0*)
 ...
 21: 0x0058 [0x1D] PRINT_EVENT_MESSAGE(message_id=7166*)
 ...
 29: 0x008A [0x1D] PRINT_EVENT_MESSAGE(message_id=7165*)
...
SUBROUTINE_009C:
 ...
 40: 0x00BB [0x1D] PRINT_EVENT_MESSAGE(message_id=7167*)
...
105: 0x01BD [0x1D] PRINT_EVENT_MESSAGE(message_id=7163*)
...
```
  ...
  4: 0x01E5 [0x24] CREATE_DIALOG(message_id=7093*, default_option=2*, option_flags=0*)
    → "Request...? [[Advanced synthesis/Synthesis/Synthesis] image support./Information on synthesis materials./Nothing.]"
  5: 0x01EC [0x25] WAIT_DIALOG_SELECT()
  6: 0x01ED [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x025A
  7: 0x01F5 [0x02] IF !(Work_Zone[7] == 0*) GOTO 0x0204
  8: 0x01FD [0x1D] PRINT_EVENT_MESSAGE(message_id=7164*)
    → "I've already helped ya. Try learning some respect for your elders, [sonny/missy]."
  9: 0x0200 [0x23] WAIT_FOR_DIALOG_INTERACTION
 10: 0x0201 [0x01] GOTO 0x0257
 11: 0x0204 [0x24] CREATE_DIALOG(message_id=7094*, default_option=1*, option_flags=0*)
    → "Image support: $0 gil. [Accept./Decline.]"
 ...
 15: 0x021C [0x1D] PRINT_EVENT_MESSAGE(message_id=7166*)
    → "<Cough!> Oh, now maybe I can pay for me operation! Close your eyes and don't peek..."
 ...
 23: 0x0250 [0x1D] PRINT_EVENT_MESSAGE(message_id=7165*)
    → "Me cataracts may be acting up, but I can see you're trying to pull a fast one, [sonny/missy]."
...
SUBROUTINE_0257:
 ...
 32: 0x0276 [0x1D] PRINT_EVENT_MESSAGE(message_id=7167*)
    → "Hmm. A young [lad/lass] like you might want to try $0. You'll need..."
...
SUBROUTINE_036A:
 ...
 95: 0x036D [0x1D] PRINT_EVENT_MESSAGE(message_id=7200*)
    → "Our young Abd-al-Raziq has ordered in a pile of research journals from his homeland. There're alchemical processes in there that even I've never seen."
 96: 0x0370 [0x23] WAIT_FOR_DIALOG_INTERACTION
 97: 0x0371 [0x1D] PRINT_EVENT_MESSAGE(message_id=7201*)
    → "Maybe you can teach an old bird new tricks! Heh-heh-heh <Cough!> <Cough!> heh..."
...
101: 0x037F [0x1D] PRINT_EVENT_MESSAGE(message_id=7163*)
    → "Would ya speak up, [sonny/missy]? I can't hear ya with all that racket."
102: 0x0382 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_0383:
103: 0x0383 [0x24] CREATE_DIALOG(message_id=14109*, default_option=1*, option_flags=0*)
...
119: 0x03B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=14222*)
