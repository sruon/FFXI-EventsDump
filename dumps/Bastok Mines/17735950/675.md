...
SUBROUTINE_03CF:
 ...
 42: 0x03D4 [0x24] CREATE_DIALOG(message_id=17051*, default_option=ExtData[1]->WorkLocal[5], option_flags=0*)
    → "Do which? (
...
SUBROUTINE_0423:
 57: 0x0423 [0x24] CREATE_DIALOG(message_id=17052*, default_option=ExtData[1]->WorkLocal[6], option_flags=0*)
...
143: 0x0679 [0x24] CREATE_DIALOG(message_id=17056*, default_option=1*, option_flags=0*)
    → "Reset rewards? (
' gil).\u0007\u000BYes (
& gil).\u0007No.\u007F1\u0000\u0007"
...
SUBROUTINE_092B:
235: 0x092B [0x24] CREATE_DIALOG(message_id=17063*, default_option=ExtData[1]->WorkLocal[6], option_flags=0*)
...
SUBROUTINE_09D6:
265: 0x09D6 [0x24] CREATE_DIALOG(message_id=17065*, default_option=ExtData[1]->WorkLocal[6], option_flags=0*)
