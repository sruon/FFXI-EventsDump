...
- **6781**: If you wish to ride a chocobo, you must possess $6 and have a high enough job level.
- **6782**: You can rent a chocobo for $0 gil. I see you currently have $1 gil.
...
- **6784**: If you still want one, it will cost you $0 gil. I see you currently have $1 gil.
...
```
  ...
  4: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=6787*)
  ...
  6: 0x001F [0x1D] PRINT_EVENT_MESSAGE(message_id=6788*)
  ...
  8: 0x0023 [0x24] CREATE_DIALOG(message_id=6789*, default_option=0*, option_flags=0*)
...
SUBROUTINE_004F:
 ...
 22: 0x0084 [0x1D] PRINT_EVENT_MESSAGE(message_id=6782*)
 ...
 25: 0x008B [0x1D] PRINT_EVENT_MESSAGE(message_id=6783*)
 ...
 27: 0x008F [0x1D] PRINT_EVENT_MESSAGE(message_id=6784*)
    → "If you still want one, it will cost you $0 gil. I see you currently have $1 gil."
 28: 0x0092 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_0093:
 29: 0x0093 [0x24] CREATE_DIALOG(message_id=6785*, default_option=1*, option_flags=0*)
...
SUBROUTINE_00AB:
 ...
 56: 0x0149 [0x1D] PRINT_EVENT_MESSAGE(message_id=6786*)
...
```
  ...
  2: 0x0168 [0x1D] PRINT_EVENT_MESSAGE(message_id=6781*)
