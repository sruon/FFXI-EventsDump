...
SUBROUTINE_04E6:
 79: 0x04E6 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk0" with entities [EventEntity, EventEntity], work=209*
...
```
# Dead code (unreachable instructions):
     0x04F6 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk1" with entities [EventEntity, EventEntity], work=209*
     0x0505 [0x1B] RETURN
