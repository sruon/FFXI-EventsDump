...
- **16723**: Enter [D. San d'Oria/D. Bastok/D. Windurst/D. Jeuno] (Shared)? [No thanks./Enter. (CL: $1)/Check area status./About sharing.]
- **16724**: Shared is a status where solo adventurers all join the same instance.
- **16725**: Players can enter once per day (Earth time), and this applies to all Dynamis - Divergence shared areas.
- **16726**: This does not apply to non-shared Dynamis - Divergence instances.
- **16727**: Shared [D. San d'Oria/D. Bastok/D. Windurst/D. Jeuno] instaces are open for two hours starting at : (JST) and have a time limit of $11 minutes. Unlike non-shared instances, this time cannot be extended.
- **16728**: If the instance is late to open, the time limit will be extended by a similar amount.
- **16729**: The instane will close when the time limit is reached or the Wave 2 boss monster is defeated.
- **16730**: You can check wave and monster status from the Check Area Status dialog selection.
- **16732**: Entering [D. San d'Oria/D. Bastok/D. Windurst/D. Jeuno] (Shared). Proceed?
- **16733**: You have chosen not to enter [D. San d'Oria/D. Bastok/D. Windurst/D. Jeuno] (Shared).
- **16734**: Entering [D. San d'Oria/D. Bastok/D. Windurst/D. Jeuno] (Shared).
...
SUBROUTINE_003D:
 ...
 15: 0x0042 [0x24] CREATE_DIALOG(message_id=16723*, default_option=0*, option_flags=ExtData[1]->WorkLocal[7])
