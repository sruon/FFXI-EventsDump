...
- **16661**: [Apply to proceed/Proceed]? [Definitely!/Not yet.]
- **16676**: Treasure chest bonuses are now active!
- **16713**: Enter [D. San d'Oria/D. Bastok/D. Windurst/D. Jeuno] (Shared)? [No thanks./Enter. (CL: $1)/Check area status./About sharing.]
- **16714**: Shared is a status where solo adventurers all join the same instance.
- **16715**: Players can enter once per day (Earth time), and this applies to all Dynamis - Divergence shared areas.
- **16716**: This does not apply to non-shared Dynamis - Divergence instances.
- **16717**: Shared [D. San d'Oria/D. Bastok/D. Windurst/D. Jeuno] instaces are open for two hours starting at : (JST) and have a time limit of $11 minutes. Unlike non-shared instances, this time cannot be extended.
- **16718**: If the instance is late to open, the time limit will be extended by a similar amount.
- **16719**: The instane will close when the time limit is reached or the Wave 2 boss monster is defeated.
- **16720**: You can check wave and monster status from the Check Area Status dialog selection.
- **16722**: Entering [D. San d'Oria/D. Bastok/D. Windurst/D. Jeuno] (Shared). Proceed?
- **16723**: You have chosen not to enter [D. San d'Oria/D. Bastok/D. Windurst/D. Jeuno] (Shared).
- **16724**: Entering [D. San d'Oria/D. Bastok/D. Windurst/D. Jeuno] (Shared).
...
SUBROUTINE_003D:
 ...
 15: 0x0042 [0x24] CREATE_DIALOG(message_id=16713*, default_option=0*, option_flags=ExtData[1]->WorkLocal[7])
