...
- **15616**: Kupo ho ho! Merry Starlight! As with past celebrations, we've prepared a veritable mountain of presents for everyone, kupo.
- **15617**: For this year's Starlight Celebration, we moogles have set ourselves a challenge: breaking the all-Vana'diel present-distribution record! But we couldn't possibly dream of succeeding at such an ambitious undertaking just by ourselves, kupo.
- **15618**: We could really do with some adventurer-offered assistance. Would you be interested in lending a hand in this noble endeavor, in the spirit of giving, kupo?
- **15619**: Help the moogles? [Sign me up!/I'm a little busy, sorry.]
- **15620**: We understand... But we'll be waiting right here if it turns out you can spare some time after all, kupo!
- **15621**: You've made this little moogle very happy, kupo! Now then, let's not waste any time. We'd like you to deliver these presents here.
- **15622**: The recipients are Tall Mountain, Tami, Virnage, and Christina. Four people in total, kupo.
- **15623**: Report back to us after you've completed your task, kupo.
- **15624**: Also, we don't mind you working in a group if you feel lonesome doing the deliveries on your own. Just form a party and have everyone come talk to us.
- **15625**: And I have to warn you, presents can't be taken to other areas, kupo. Be careful, okay?
- **15626**: Happy delivering, kupo!
- **15627**: We want you to deliver the presents to Tall Mountain, Tami, Virnage, and Christina. Four people in total, kupo.
- **15628**: You've yet to deliver presents to [Tall Mountain,/Tami,/Virnage,/Christina,] [Tall Mountain,/Tami,/Virnage,/Christina,] and [Tall Mountain,/Tami,/Virnage,/Christina,] kupo.
- **15629**: You've yet to deliver presents to [Tall Mountain,/Tami,/Virnage,/Christina,] and [Tall Mountain,/Tami,/Virnage,/Christina,] kupo.
- **15630**: You've yet to deliver a present to [Tall Mountain,/Tami,/Virnage,/Christina,] kupo.
- **15631**: Wow, you've delivered every single present! Thank you so much, kupo!
- **15632**: Here's a little something for your kindness.
- **15633**: You want to help us again? That's very kind of you, but we need more time to put together a new set of presents, kupo. Would you mind coming back tomorrow?
...
```
  ...
  2: 0x000B [0x1D] PRINT_EVENT_MESSAGE(message_id=15616*)
  ...
  4: 0x000F [0x1D] PRINT_EVENT_MESSAGE(message_id=15617*)
  ...
  6: 0x0013 [0x1D] PRINT_EVENT_MESSAGE(message_id=15618*)
  ...
  8: 0x0017 [0x24] CREATE_DIALOG(message_id=15619*, default_option=0*, option_flags=0*)
 ...
 13: 0x002D [0x1D] PRINT_EVENT_MESSAGE(message_id=15621*)
 ...
 15: 0x0031 [0x1D] PRINT_EVENT_MESSAGE(message_id=15622*)
 ...
 17: 0x0035 [0x1D] PRINT_EVENT_MESSAGE(message_id=15623*)
    → "Report back to us after you've completed your task, kupo."
 18: 0x0038 [0x23] WAIT_FOR_DIALOG_INTERACTION
 19: 0x0039 [0x1D] PRINT_EVENT_MESSAGE(message_id=15624*)
 ...
 21: 0x003D [0x1D] PRINT_EVENT_MESSAGE(message_id=15625*)
 ...
 23: 0x0041 [0x1D] PRINT_EVENT_MESSAGE(message_id=15626*)
 ...
 27: 0x0050 [0x1D] PRINT_EVENT_MESSAGE(message_id=15620*)
...
SUBROUTINE_00AD:
 ...
 19: 0x00BB [0x1D] PRINT_EVENT_MESSAGE(message_id=15630*)
 ...
 23: 0x00CA [0x1D] PRINT_EVENT_MESSAGE(message_id=15629*)
 ...
 27: 0x00D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=15628*)
 ...
 31: 0x00E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=15627*)
...
```
  ...
  1: 0x0106 [0x1D] PRINT_EVENT_MESSAGE(message_id=15633*)
