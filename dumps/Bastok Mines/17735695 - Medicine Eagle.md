...
- **10555**: There's an inn and the Alchemists' Guild through here, but other than that, you'll only find the homes of Bastok's poor. I don't think there's anything you'd want in there.
- **11542**: And now there is talk of sending a party to investigate the Altepa Desert, but you should talk to Drake Fang in the Zeruhn Mines about that.
...
```
  ...
  1: 0x0007 [0x1D] PRINT_EVENT_MESSAGE(message_id=10555*)
...
```
  ...
  1: 0x0021 [0x1D] PRINT_EVENT_MESSAGE(message_id=11542*)
