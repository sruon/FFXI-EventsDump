...
```
 ...
 41: 0x00AB [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8004, condition_work_offset=0x8009)
 42: 0x00B2 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8002, condition_work_offset=0x8009)
 43: 0x00B9 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x800A, condition_work_offset=0x8009)
 44: 0x00C0 [0x01] GOTO 0x013D

SUBROUTINE_00C3:
 45: 0x00C3 [0x02] IF !(ExtData[1]->WorkLocal[5] == 1*) GOTO 0x00E3
 46: 0x00CB [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8004, condition_work_offset=0x8009)
 47: 0x00D2 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8002, condition_work_offset=0x8009)
 48: 0x00D9 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x800A, condition_work_offset=0x8009)
...
SUBROUTINE_00E3:
 ...
 52: 0x00F3 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8004, condition_work_offset=0x8009)
 53: 0x00FA [0x01] GOTO 0x010F

SUBROUTINE_00FD:
 54: 0x00FD [0x02] IF !(ExtData[1]->WorkLocal[20] == 1*) GOTO 0x010F
 55: 0x0105 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8002, condition_work_offset=0x8009)
...
SUBROUTINE_011D:
 ...
 61: 0x0125 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8004, condition_work_offset=0x8009)
 62: 0x012C [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8002, condition_work_offset=0x8009)
 63: 0x0133 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x800A, condition_work_offset=0x8009)
...
111: 0x0226 [0x24] CREATE_DIALOG(message_id=7302*, default_option=0*, option_flags=0x1B)
...
136: 0x02B1 [0x24] CREATE_DIALOG(message_id=7321*, default_option=0*, option_flags=0x1D)
...
# Data Section: 0x05D3 (176 bytes)
     0x05D3: 03 18 00 00 80 03 01 00 02 10 41 01 80 00 80 01
     0x05E3: 00 05 00 41 02 80 03 80 01 00 06 00 41 04 80 04
     0x05F3: 80 01 00 14 00 41 05 80 06 80 01 00 15 00 41 07
     0x0603: 80 07 80 01 00 16 00 41 08 80 08 80 01 00 17 00
     0x0613: 03 1C 00 03 10 03 1D 00 04 10 03 13 00 06 10 03
     0x0623: 02 00 07 10 41 01 80 18 80 02 00 06 00 41 1A 80
     0x0633: 03 80 02 00 07 00 41 05 80 22 80 02 00 08 00 03
     ...
     0x0673: 06 80 04 00 0D 00 41 07 80 26 80 04 00 0E 00 1B
```