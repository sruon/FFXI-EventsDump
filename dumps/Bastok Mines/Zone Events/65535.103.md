...
```
  ...
  1: 0x4482 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=149*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
  2: 0x4491 [0x01] GOTO 0x454A

SUBROUTINE_4494:
  3: 0x4494 [0x02] IF !(Entity->Race == 2*) GOTO 0x44AE
  4: 0x449C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=159*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
  5: 0x44AB [0x01] GOTO 0x454A

SUBROUTINE_44AE:
  6: 0x44AE [0x02] IF !(Entity->Race == 3*) GOTO 0x44C8
  7: 0x44B6 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=169*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
  8: 0x44C5 [0x01] GOTO 0x454A

SUBROUTINE_44C8:
  9: 0x44C8 [0x02] IF !(Entity->Race == 4*) GOTO 0x44E2
 10: 0x44D0 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=179*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 11: 0x44DF [0x01] GOTO 0x454A

SUBROUTINE_44E2:
 12: 0x44E2 [0x02] IF !(Entity->Race == 5*) GOTO 0x44FC
 13: 0x44EA [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=189*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 14: 0x44F9 [0x01] GOTO 0x454A

SUBROUTINE_44FC:
 15: 0x44FC [0x02] IF !(Entity->Race == 6*) GOTO 0x4516
 16: 0x4504 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=189*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 17: 0x4513 [0x01] GOTO 0x454A

SUBROUTINE_4516:
 18: 0x4516 [0x02] IF !(Entity->Race == 7*) GOTO 0x4530
 19: 0x451E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=199*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 20: 0x452D [0x01] GOTO 0x454A

SUBROUTINE_4530:
 21: 0x4530 [0x02] IF !(Entity->Race == 8*) GOTO 0x454A
 22: 0x4538 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=209*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 23: 0x4547 [0x01] GOTO 0x454A

SUBROUTINE_454A:
 24: 0x454A [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
