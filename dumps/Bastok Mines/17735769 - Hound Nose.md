...
- **10955**: Welcome to the auction house. Do you have any questions about our establishment?
- **10956**: What do you want to know? [What is the auction house?/How are auctions run?/Are there any fees?/Are there any limits?/How do you check up on merchandise?/How do you remove an item?/My "Sales Status" list is full!/Nothing right now.]
- **10957**: Auction houses can be found in all of Vana'diel's major cities. Here adventurers gather to bid on battle spoils, unwanted items, old armor...almost anything.
- **10959**: Adventurers may use any auction house regardless of nationality.
- **10960**: The first adventurer to bid at or above the asking price will automatically purchase the product.
- **10961**: Once put up for auction, merchandise will remain there for a maximum of thirty weeks Vana'diel time (nine-and-a-half days Earth time).
- **10962**: If merchandise does not sell within this time limit, it will be returned to the seller's current residence.
- **10963**: Transaction fees are proportional to the amount for which an item is put up on auction. The method of calculating this fee is different for single items and stackable items.
- **10964**: A transaction fee is collected when any merchandise is put up for auction. This fee is nonrefundable.
- **10965**: The International Auction House Committee, or IAHC, has declared that a maximum of seven items may be put up for auction at one time.
- **10966**: However, the IAHC has recently removed the limit to how many items one may purchase.
- **10967**: A small amount of time is required before new merchandise appears on our bid list.
- **10968**: Once an item appears on your "Sales Status" list, it may not immediately appear on the bid list. If you do not see your item on the bid list, try looking again at a later time.
- **10969**: If you would like to withdraw an item from an auction, you must travel to the auction house, and select "Stop Sale" from the "Sales Status" menu.
- **10970**: To remove an item from your "Sales Status" list, you must visit an auction counter to acknowledge the sale or return of your merchandise.
- **10971**: Otherwise, previously sold or returned items will fill up your list and prevent you from selling any more merchandise.
- **10972**: At any auction counter, open the "Sales Status" menu and acknowledge the transaction to clear it from the list.
- **10973**: Press the confirm button to remove any transaction colored yellow (sold) or red (returned).
- **10974**: Is there anything else you would like to know?
- **10975**: In the past, many have amassed great wealth through the auction house. I hope you find fortune, too!
...
```
  ...
  2: 0x0009 [0x1D] PRINT_EVENT_MESSAGE(message_id=10955*)
    → "Welcome to the auction house. Do you have any questions about our establishment?"
  3: 0x000C [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x000D [0x24] CREATE_DIALOG(message_id=10956*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
  ...
  7: 0x001D [0x1D] PRINT_EVENT_MESSAGE(message_id=10957*)
  ...
  9: 0x0021 [0x1D] PRINT_EVENT_MESSAGE(message_id=10959*)
 ...
 14: 0x0037 [0x1D] PRINT_EVENT_MESSAGE(message_id=10960*)
 ...
 16: 0x003B [0x1D] PRINT_EVENT_MESSAGE(message_id=10961*)
 ...
 18: 0x003F [0x1D] PRINT_EVENT_MESSAGE(message_id=10962*)
 ...
 23: 0x0055 [0x1D] PRINT_EVENT_MESSAGE(message_id=10963*)
 ...
 25: 0x0059 [0x1D] PRINT_EVENT_MESSAGE(message_id=10964*)
 ...
 30: 0x006F [0x1D] PRINT_EVENT_MESSAGE(message_id=10965*)
 ...
 32: 0x0073 [0x1D] PRINT_EVENT_MESSAGE(message_id=10966*)
 ...
 37: 0x0089 [0x1D] PRINT_EVENT_MESSAGE(message_id=10967*)
 ...
 39: 0x008D [0x1D] PRINT_EVENT_MESSAGE(message_id=10968*)
 ...
 44: 0x00A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10969*)
 ...
 49: 0x00B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10970*)
 ...
 51: 0x00BD [0x1D] PRINT_EVENT_MESSAGE(message_id=10971*)
 ...
 53: 0x00C1 [0x1D] PRINT_EVENT_MESSAGE(message_id=10972*)
 ...
 55: 0x00C5 [0x1D] PRINT_EVENT_MESSAGE(message_id=10973*)
 ...
 60: 0x00DB [0x1D] PRINT_EVENT_MESSAGE(message_id=10975*)
...
SUBROUTINE_00E3:
 63: 0x00E3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10974*)
