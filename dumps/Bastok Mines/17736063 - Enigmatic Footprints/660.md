...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
02B0:             05 0A 00 02  0A 00 02 80 00 71 03 24      .........q.$
02C0: 1A 80 00 80 00 80 25 02  00 10 00 80 00 DB 02 03  ......%.........
02D0: 01 10 02 80 43 00 43 01  01 6E 03 02 00 10 02 80  ....C.C..n......
02E0: 00 EF 02 03 01 10 03 80  43 00 43 01 01 6E 03 02  ........C.C..n..
...
0320: 01 6E 03 02 00 10 08 80  00 57 03 03 02 10 02 80  .n.......W......
0330: 03 03 10 1B 80 48 1C 80  71 12 02 80 03 80 71 13  .....H..q.....q.
0340: 00 00 03 01 10 09 80 40  1D 80 1E 80 01 10 00 00  .......@........
0350: 43 00 43 01 01 6E 03 02  00 10 09 80 00 6B 03 03  C.C..n.......k..
0360: 01 10 1F 80 43 00 43 01  01 6E 03 06 0A 00 01 B7  ....C.C..n......
0370: 02 21 00 62 02 80 F0 FF  FF 7F F0 FF FF 7F 6D 61  .!.b..........ma
0380: 69 6E 00 80 1C 20 80 45  21 80 F0 FF FF 7F F0 FF  in... .E!.......
0390: FF 7F 77 68 6F 31 00 80  55 21 80 F0 FF FF 7F F0  ..who1..U!......
03A0: FF FF 7F 77 68 6F 31 1C  22 80 45 23 80 F0 FF FF  ...who1.".E#....
03B0: 7F F0 FF FF 7F 66 64 6F  31 00 80 55 23 80 F0 FF  .....fdo1..U#...
03C0: FF 7F F0 FF FF 7F 66 64  6F 31 45 21 80 F0 FF FF  ......fdo1E!....
03D0: 7F F0 FF FF 7F 77 68 69  31 00 80 1C 1E 80 30 1B  .....whi1.....0.
```
...
```
  ...
  1: 0x02B7 [0x02] IF !(ExtData[1]->WorkLocal[10] == 1*) GOTO 0x0371
  2: 0x02BF [0x24] CREATE_DIALOG(message_id=16697*, default_option=0*, option_flags=0*)
...
\u0001.\u0000\u0007"
 ...
 40: 0x0368 [0x01] GOTO 0x036E
 41: 0x036B [0x06] ExtData[1]->WorkLocal[10] = 0
 42: 0x036E [0x01] GOTO 0x02B7
 43: 0x0371 [0x21] END_EVENT
 44: 0x0372 [0x00] END_REQSTACK()
```
...
# Dead code (unreachable instructions):
     0x0373 [0x62] LOAD_EVENT_SCHEDULER: Load scheduler "main" with entities [LocalPlayer, LocalPlayer], work=[1*, 0*]
     0x0384 [0x1C] WAIT(90* ticks)
     0x0387 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "who1" with entities [LocalPlayer, LocalPlayer], work=[201*, 0*]
     0x0398 [0x55] WAIT_LOAD_SCHEDULER: Wait for scheduler "who1" with entities [LocalPlayer, LocalPlayer], work=201*
     0x03A7 [0x1C] WAIT(45* ticks)
     0x03AA [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
     0x03BB [0x55] WAIT_LOAD_SCHEDULER: Wait for scheduler "fdo1" with entities [LocalPlayer, LocalPlayer], work=200*
     0x03CA [0x45] LOAD_SCHEDULED_TASK: Load scheduler "whi1" with entities [LocalPlayer, LocalPlayer], work=[201*, 0*]
     0x03DB [0x1C] WAIT(15* ticks)
     0x03DE [0x30] SET_UCOFF_CONTINUE_ZERO()
     0x03DF [0x1B] RETURN
```