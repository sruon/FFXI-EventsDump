# 17563872 - Ancient Magical Gizmo
...
| [56](#event-56)       | 0x0001       |    153 |             24 |
| [57](#event-57)       | 0x009A       |    188 |             25 |
...
0020: FF 7F F0 FF FF 7F 6D 64  73 35 01 80 27 0B F0 FF  ......mds5..'...
0030: FF 7F 0A 45 00 80 F0 FF  FF 7F F0 FF FF 7F 66 64  ...E..........fd
0040: 69 31 01 80 1C 05 80 4C  1C 06 80 45 00 80 F0 FF  i1.....L...E....
0050: FF 7F F0 FF FF 7F 66 64  6F 31 01 80 1C 02 80 2C  ......fdo1.....,
0060: F8 FF FF 7F F8 FF FF 7F  6D 67 30 35 52 04 80 F0  ........mg05R...
0070: FF FF 7F F0 FF FF 7F 6D  64 73 35 1C 07 80 4D 1C  .......mds5...M.
...
```
  ...
  5: 0x001B [0x45] LOAD_SCHEDULED_TASK: Load scheduler "mds5" with entities [LocalPlayer, LocalPlayer], work=[94*, 0*]
  6: 0x002C [0x27] REQ_SET(priority=0x0B, entity_id=LocalPlayer, tag_num=0x0A)
 ...
 13: 0x005F [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "mg05" with entities [EventEntity, EventEntity]
 14: 0x006C [0x52] END_LOAD_SCHEDULER: End scheduler "mds5" with entities [LocalPlayer, LocalPlayer], work=94*
...
00C0: 64 30 35 01 80 27 0B F0  FF FF 7F 0A 45 00 80 F0  d05..'......E...
00D0: FF FF 7F F0 FF FF 7F 66  64 69 31 01 80 1C 05 80  .......fdi1.....
00E0: 4C 2D F8 FF FF 7F F8 FF  FF 7F 70 74 64 33 2C F8  L-........ptd3,.
00F0: FF FF 7F F8 FF FF 7F 6F  6D 64 33 1C 08 80 2C F8  .......omd3...,.
0100: FF FF 7F F8 FF FF 7F 6B  6F 64 33 1C 09 80 45 00  .......kod3...E.
0110: 80 F0 FF FF 7F F0 FF FF  7F 66 64 6F 31 01 80 1C  .........fdo1...
0120: 02 80 52 04 80 F0 FF FF  7F F0 FF FF 7F 6D 64 30  ..R..........md0
0130: 35 2D F8 FF FF 7F F8 FF  FF 7F 6B 70 64 33 4D 46  5-........kpd3MF
...
```
  ...
  5: 0x00B4 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "md05" with entities [LocalPlayer, LocalPlayer], work=[94*, 0*]
  6: 0x00C5 [0x27] REQ_SET(priority=0x0B, entity_id=LocalPlayer, tag_num=0x0A)
 ...
 10: 0x00E1 [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "ptd3" with entities [EventEntity, EventEntity]
 11: 0x00EE [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "omd3" with entities [EventEntity, EventEntity]
 12: 0x00FB [0x1C] WAIT(100* ticks)
 13: 0x00FE [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "kod3" with entities [EventEntity, EventEntity]
 ...
 17: 0x0122 [0x52] END_LOAD_SCHEDULER: End scheduler "md05" with entities [LocalPlayer, LocalPlayer], work=94*
 18: 0x0131 [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "kpd3" with entities [EventEntity, EventEntity]
