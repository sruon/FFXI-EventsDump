...
```
  ...
  5: 0x001B [0x45] LOAD_SCHEDULED_TASK: Load scheduler "mds4" with entities [LocalPlayer, LocalPlayer], work=[94*, 0*]
 ...
 13: 0x005F [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "mg04" with entities [EventEntity, EventEntity]
