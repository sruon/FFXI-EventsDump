...
```
  ...
  5: 0x00B4 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "md04" with entities [LocalPlayer, LocalPlayer], work=[94*, 0*]
 ...
 10: 0x00E1 [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "ptd1" with entities [EventEntity, EventEntity]
 11: 0x00EE [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "omd1" with entities [EventEntity, EventEntity]
 12: 0x00FB [0x1C] WAIT(100* ticks)
 13: 0x00FE [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "kod1" with entities [EventEntity, EventEntity]
 ...
 18: 0x0131 [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "kpd1" with entities [EventEntity, EventEntity]
