# 17563873 - Ancient Magical Gizmo
...
| [58](#event-58)       | 0x0001       |    153 |             24 |
| [59](#event-59)       | 0x009A       |    188 |             25 |
...
0020: FF 7F F0 FF FF 7F 6D 64  73 36 01 80 27 0B F0 FF  ......mds6..'...
0030: FF 7F 0B 45 00 80 F0 FF  FF 7F F0 FF FF 7F 66 64  ...E..........fd
0040: 69 31 01 80 1C 05 80 4C  1C 06 80 45 00 80 F0 FF  i1.....L...E....
0050: FF 7F F0 FF FF 7F 66 64  6F 31 01 80 1C 02 80 2C  ......fdo1.....,
0060: F8 FF FF 7F F8 FF FF 7F  6D 67 30 36 52 04 80 F0  ........mg06R...
0070: FF FF 7F F0 FF FF 7F 6D  64 73 36 1C 07 80 4D 1C  .......mds6...M.
...
```
  ...
  5: 0x001B [0x45] LOAD_SCHEDULED_TASK: Load scheduler "mds6" with entities [LocalPlayer, LocalPlayer], work=[94*, 0*]
  6: 0x002C [0x27] REQ_SET(priority=0x0B, entity_id=LocalPlayer, tag_num=0x0B)
 ...
 13: 0x005F [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "mg06" with entities [EventEntity, EventEntity]
 14: 0x006C [0x52] END_LOAD_SCHEDULER: End scheduler "mds6" with entities [LocalPlayer, LocalPlayer], work=94*
...
```
  ...
  5: 0x00B4 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "md06" with entities [LocalPlayer, LocalPlayer], work=[94*, 0*]
 ...
 10: 0x00E1 [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "ptd2" with entities [EventEntity, EventEntity]
 11: 0x00EE [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "omd2" with entities [EventEntity, EventEntity]
 12: 0x00FB [0x1C] WAIT(100* ticks)
 13: 0x00FE [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "kod2" with entities [EventEntity, EventEntity]
 ...
 18: 0x0131 [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "kpd2" with entities [EventEntity, EventEntity]
