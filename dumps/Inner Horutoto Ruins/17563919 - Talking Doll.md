...
- **7382**: ...Beep...
- **7383**: ...Beeeep! Beeeep! Beeeep!
- **7384**: ...Detected... Unclassifiable magic source... ...Location... Sealed area...
- **7385**: Contact manufacturer...
- **7386**: ...Detected... Unclassifiable magic source... ...Location... Behind door...
- **7387**: Contact manufacturer...
...
```
 ...
 12: 0x004D [0x1D] PRINT_EVENT_MESSAGE(message_id=7382*)
    → "...Beep..."
 13: 0x0050 [0x23] WAIT_FOR_DIALOG_INTERACTION
 14: 0x0051 [0x1D] PRINT_EVENT_MESSAGE(message_id=7382*)
    → "...Beep..."
 15: 0x0054 [0x23] WAIT_FOR_DIALOG_INTERACTION
 16: 0x0055 [0x1D] PRINT_EVENT_MESSAGE(message_id=7382*)
    → "...Beep..."
 17: 0x0058 [0x23] WAIT_FOR_DIALOG_INTERACTION
 18: 0x0059 [0x1C] WAIT(100* ticks)
 19: 0x005C [0x1D] PRINT_EVENT_MESSAGE(message_id=7383*)
 ...
 23: 0x0080 [0x1D] PRINT_EVENT_MESSAGE(message_id=7384*)
    → "...Detected... Unclassifiable magic source... ...Location... Sealed area..."
 24: 0x0083 [0x23] WAIT_FOR_DIALOG_INTERACTION
 25: 0x0084 [0x1D] PRINT_EVENT_MESSAGE(message_id=7385*)
...
```
  0: 0x00B3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7386*)
    → "...Detected... Unclassifiable magic source... ...Location... Behind door..."
  1: 0x00B6 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x00B7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7387*)
    → "Contact manufacturer..."
...
```
 ...
 12: 0x010B [0x1D] PRINT_EVENT_MESSAGE(message_id=7382*)
    → "...Beep..."
 13: 0x010E [0x23] WAIT_FOR_DIALOG_INTERACTION
 14: 0x010F [0x1D] PRINT_EVENT_MESSAGE(message_id=7382*)
    → "...Beep..."
 15: 0x0112 [0x23] WAIT_FOR_DIALOG_INTERACTION
 16: 0x0113 [0x1D] PRINT_EVENT_MESSAGE(message_id=7382*)
    → "...Beep..."
 17: 0x0116 [0x23] WAIT_FOR_DIALOG_INTERACTION
 18: 0x0117 [0x1C] WAIT(100* ticks)
 19: 0x011A [0x1D] PRINT_EVENT_MESSAGE(message_id=7383*)
    → "...Beeeep! Beeeep! Beeeep!"
 ...
 23: 0x013E [0x1D] PRINT_EVENT_MESSAGE(message_id=7384*)
    → "...Detected... Unclassifiable magic source... ...Location... Sealed area..."
 24: 0x0141 [0x23] WAIT_FOR_DIALOG_INTERACTION
 25: 0x0142 [0x1D] PRINT_EVENT_MESSAGE(message_id=7385*)
    → "Contact manufacturer..."
