...
- **6524**: The shared memories of generations of mooglekind flood into your mind, granting you the ability to decipher the cryptic glyphs of your $3...
- **6525**: Review which trial? [Trial $0./Trial $1./Trial $2./Trial $3./Trial $4./Trial $5./Trial $6./Trial $7./Trial $8./Trial $9./Moogle's Almanack./Return.]
- **6530**: You open the tome to the "Moogle's Almanack" chapter and peruse its weather prognostication pages.
- **6531**: Close observation of the sky reveals that the weather in this area today will be $0 with occasional $1. There is also a slight chance of $2, so caution is in order.
- **6532**: Predicting ahead, tomorrow's weather looks to be $0 with occasional $1. There is also a slight chance of $2, so caution is in order.
- **6533**: Finally, the forecast for the day after tomorrow calls for $0 with occasional $1. There is also a slight chance of $2, so caution is in order.
- **6534**: Close observation of the sky reveals that the weather in this area today will be $0 with a chance of $1.
- **6535**: Predicting ahead, tomorrow's weather looks to be $0 with a chance of $1.
- **6536**: Finally, the forecast for the day after tomorrow calls for $0 with a chance of $1.
- **6537**: Close observation of the sky reveals that the weather in this area today will be $0. There is also the possibility of $2, so caution is in order.
- **6538**: Predicting ahead, tomorrow's weather looks to be $0. There is also the possibility of $2, so caution is in order.
- **6539**: Finally, the forecast for the day after tomorrow calls for $0. There is also the possibility of $2, so caution is advised.
- **6540**: Close observation of the sky reveals that the weather in this area today will be $0.
- **6541**: Predicting ahead, tomorrow's weather looks to be $0.
- **6542**: Finally, the forecast for the day after tomorrow calls for $0.
...
```
 ...
 46: 0x013E [0x24] CREATE_DIALOG(message_id=6525*, default_option=0*, option_flags=ExtData[1]->WorkLocal[11])
 ...
 63: 0x0198 [0x07] ExtData[1]->WorkLocal[13] += 380*
 64: 0x019D [0x03] ExtData[1]->WorkLocal[14] = Work_Zone[2]
 65: 0x01A2 [0x07] ExtData[1]->WorkLocal[14] += 2428*
 66: 0x01A7 [0x03] ExtData[1]->WorkLocal[15] = Work_Zone[2]
 67: 0x01AC [0x07] ExtData[1]->WorkLocal[15] += 4476*
 ...
 74: 0x01C7 [0x48] [System] [ExtData[1]->WorkLocal[15]]:
    → "This region is currently under beastman control. You cannot obtain crystals in this region."
