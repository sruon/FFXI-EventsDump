...
```
  ...
  8: 0x001A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 20: 0x0058 [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s039", work_offset2=0*)
 21: 0x0069 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 22: 0x007A [0x2A] GET_REQ_LEVEL(level=11, entity_id=LocalPlayer)
 23: 0x0080 [0x1C] WAIT(100* ticks)
 24: 0x0083 [0x55] WAIT_LOAD_SCHEDULER(work_offset=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s039")
 25: 0x0092 [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s057", work_offset2=0*)
 ...
 31: 0x00C9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s040", work_offset2=0*)
 ...
 36: 0x00F9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s042", work_offset2=0*)
 37: 0x010A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="blon", work_offset2=0*)
 38: 0x011B [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="blon", work_offset2=0*)
 39: 0x012C [0x7B] LocalPlayer stops talking
 40: 0x0131 [0x5D] SET_MUSIC_VOLUME(volume=0*, fade_time=200*)
 41: 0x0136 [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "main" with entities [LocalPlayer, LocalPlayer], work=[15*, 0*]
 42: 0x0147 [0x27] REQ_SET(priority=0x0B, entity_id=LocalPlayer, tag_num=0x2B)
 43: 0x014E [0x1C] WAIT(60* ticks)
 44: 0x0151 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="blof", work_offset2=0*)
 45: 0x0162 [0x2A] GET_REQ_LEVEL(level=11, entity_id=LocalPlayer)
 46: 0x0168 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 55: 0x01AC [0x55] WAIT_LOAD_SCHEDULER(work_offset=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s042")
 ...
 60: 0x01D8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s059", work_offset2=0*)
 61: 0x01E9 [0x01] GOTO 0x01FD

SUBROUTINE_01EC:
 62: 0x01EC [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s041", work_offset2=0*)
 63: 0x01FD [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
...
SUBROUTINE_0241:
 ...
 73: 0x0250 [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s056", work_offset2=0*)
 ...
 77: 0x0278 [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s044", work_offset2=0*)
 ...
 82: 0x029E [0x55] WAIT_LOAD_SCHEDULER(work_offset=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s044")
 ...
 86: 0x02C5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s060", work_offset2=0*)
 87: 0x02D6 [0x01] GOTO 0x02EA

SUBROUTINE_02D9:
 88: 0x02D9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s045", work_offset2=0*)
 ...
 94: 0x0314 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 95: 0x0325 [0x1C] WAIT(300* ticks)
 96: 0x0328 [0x02] IF !(Work_Zone[9] == 8*) GOTO 0x0344
 97: 0x0330 [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s061", work_offset2=0*)
 98: 0x0341 [0x01] GOTO 0x0355

SUBROUTINE_0344:
 99: 0x0344 [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s043", work_offset2=0*)
100: 0x0355 [0x1C] WAIT(30* ticks)
101: 0x0358 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
...
108: 0x039C [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s047", work_offset2=0*)
...
113: 0x03CF [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s044", work_offset2=0*)
...
116: 0x03EA [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
117: 0x03FB [0x4C] EventEntity->StatusEvent = 8 // Open door
118: 0x03FC [0x1C] WAIT(100* ticks)
119: 0x03FF [0x55] WAIT_LOAD_SCHEDULER(work_offset=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s044")
...
129: 0x042C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
