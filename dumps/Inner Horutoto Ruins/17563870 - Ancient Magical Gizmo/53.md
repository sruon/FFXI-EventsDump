...
```
  ...
  5: 0x00B4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=94*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="md03", work_offset2=0*)
 ...
 10: 0x00E1 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="ptd6")
 11: 0x00EE [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "omd6" for entities [EventEntity, EventEntity]
 12: 0x00FB [0x1C] WAIT(100* ticks)
 13: 0x00FE [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "kod6" for entities [EventEntity, EventEntity]
 ...
 18: 0x0131 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="kpd6")
