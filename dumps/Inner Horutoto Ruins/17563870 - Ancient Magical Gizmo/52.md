...
```
  ...
  5: 0x001B [0x45] LOAD_SCHEDULED_TASK(work_offset1=94*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="mds3", work_offset2=0*)
 ...
 13: 0x005F [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "mg03" for entities [EventEntity, EventEntity]
