...
- **7373**: Why, it didily-doodily looks like it's didily-dried up.
- **7378**: I followed-a-roo, thinking that my sweetie-pie Mojiji was all trap-dappily trapped up in here. What a waste of timely-time.
...
```
  ...
  2: 0x0214 [0x1D] PRINT_EVENT_MESSAGE(message_id=7373*)
...
```
  0: 0x0219 [0x1D] PRINT_EVENT_MESSAGE(message_id=7378*)
