...
- **7238**: Return the dropped item? [Yes./No.]
- **7239**: Can I help you?
- **7240**: Oh, thanks... I'm not sure that this belongs to me, though...
- **7241**: Wow, thanks... I don't really remember dropping anything, though...
- **7242**: Thank you! I've been looking all over the place for this!
- **7243**: Thank you! I don't know what I would've done if I had lost this!
- **7244**: Please take this as a token of my gratitude.
- **7245**: I wonder if I could see my house from up here...
- **7246**: There seem to be a lot of disreputable characters riding the airships these days...
- **7247**: It's hard to tell people apart these days, don't you agree? For some reason, that thought occurs to me whenever I ride an airship...
- **7248**: These flights to Jeuno are always so crowded, aren't they?
...
SUBROUTINE_00D2:
  ...
  6: 0x00E4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7245*)
 ...
 10: 0x00F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7246*)
 ...
 14: 0x0102 [0x1D] PRINT_EVENT_MESSAGE(message_id=7247*)
 ...
 18: 0x0111 [0x1D] PRINT_EVENT_MESSAGE(message_id=7248*)
...
# Dead code (unreachable instructions):
     ...
     0x0010 [0x1D] PRINT_EVENT_MESSAGE(message_id=7239*)
    → "Can I help you?"
     0x0013 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0014 [0x24] CREATE_DIALOG(message_id=7238*, default_option=1*, option_flags=0*)
    → "Return the dropped item? [Yes./No.]"
     ...
     0x0039 [0x1D] PRINT_EVENT_MESSAGE(message_id=7242*)
    ...
    → "Please take this as a token of my gratitude."
     ...
     0x0091 [0x1D] PRINT_EVENT_MESSAGE(message_id=7240*)
