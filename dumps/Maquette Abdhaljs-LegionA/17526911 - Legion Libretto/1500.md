...
```
  ...
  2: 0x000B [0x48] [System] [7266*]:
    → "The tome contains the symphonic scores for a veritable host of rousing battle fanfares.\u007F1\u0000\u0007"
  ...
  6: 0x001A [0x24] CREATE_DIALOG(message_id=7267*, default_option=0x0000, option_flags=0x03)
    → "Select a new battle fanfare?\u0007\u000BNot now.\u0007Belief.\u0007Fighters of the Crystal.\u0007Conflict: March of the Hero.\u0007The Colosseum.\u0007Run Maggot, Run!\u0007Iron Colossus.\u0007Ragnarok.\u0007Feast of the Ladies.\u0007Random selection.\u0007Restore default.\u0007\u0001@\u007F1\u0000\u0007"
...
SUBROUTINE_006B:
 ...
 28: 0x0084 [0x24] CREATE_DIALOG(message_id=7268*, default_option=0*, option_flags=0*)
    → "Fight to this fanfare?\u0007\u000BYes.\u0007No, select another.\u007F1\u0000\u0007"
...
SUBROUTINE_016D:
 76: 0x016D [0x0C] ExtData[1]->WorkLocal[1]--
 77: 0x0170 [0x3E] IF !(ExtData[1]->WorkLocal[3] bit 2*) GOTO 0x017A
 78: 0x0177 [0x01] GOTO 0x018E

SUBROUTINE_017A:
 79: 0x017A [0x02] IF !(ExtData[1]->WorkLocal[1] == 0*) GOTO 0x018B
 80: 0x0182 [0x03] ExtData[1]->WorkLocal[1] = 2*
 81: 0x0187 [0x1B] RETURN

SUBROUTINE_018B:
 82: 0x018B [0x0C] ExtData[1]->WorkLocal[1]--
 83: 0x018E [0x3E] IF !(ExtData[1]->WorkLocal[3] bit 3*) GOTO 0x0198
 84: 0x0195 [0x01] GOTO 0x01AC

SUBROUTINE_0198:
 85: 0x0198 [0x02] IF !(ExtData[1]->WorkLocal[1] == 0*) GOTO 0x01A9
 86: 0x01A0 [0x03] ExtData[1]->WorkLocal[1] = 3*
 87: 0x01A5 [0x1B] RETURN

SUBROUTINE_01A9:
 88: 0x01A9 [0x0C] ExtData[1]->WorkLocal[1]--
 89: 0x01AC [0x3E] IF !(ExtData[1]->WorkLocal[3] bit 4*) GOTO 0x01B6
 90: 0x01B3 [0x01] GOTO 0x01CA

SUBROUTINE_01B6:
 91: 0x01B6 [0x02] IF !(ExtData[1]->WorkLocal[1] == 0*) GOTO 0x01C7
 92: 0x01BE [0x03] ExtData[1]->WorkLocal[1] = 4*
 93: 0x01C3 [0x1B] RETURN

SUBROUTINE_01C7:
 94: 0x01C7 [0x0C] ExtData[1]->WorkLocal[1]--
 95: 0x01CA [0x3E] IF !(ExtData[1]->WorkLocal[3] bit 5*) GOTO 0x01D4
 96: 0x01D1 [0x01] GOTO 0x01E8

SUBROUTINE_01D4:
 97: 0x01D4 [0x02] IF !(ExtData[1]->WorkLocal[1] == 0*) GOTO 0x01E5
 98: 0x01DC [0x03] ExtData[1]->WorkLocal[1] = 5*
 99: 0x01E1 [0x1B] RETURN

SUBROUTINE_01E5:
100: 0x01E5 [0x0C] ExtData[1]->WorkLocal[1]--
101: 0x01E8 [0x3E] IF !(ExtData[1]->WorkLocal[3] bit 6*) GOTO 0x01F2
102: 0x01EF [0x01] GOTO 0x0206

SUBROUTINE_01F2:
103: 0x01F2 [0x02] IF !(ExtData[1]->WorkLocal[1] == 0*) GOTO 0x0203
104: 0x01FA [0x03] ExtData[1]->WorkLocal[1] = 6*
105: 0x01FF [0x1B] RETURN

SUBROUTINE_0203:
106: 0x0203 [0x0C] ExtData[1]->WorkLocal[1]--
107: 0x0206 [0x3E] IF !(ExtData[1]->WorkLocal[3] bit 7*) GOTO 0x0210
108: 0x020D [0x01] GOTO 0x0224

SUBROUTINE_0210:
109: 0x0210 [0x02] IF !(ExtData[1]->WorkLocal[1] == 0*) GOTO 0x0221
110: 0x0218 [0x03] ExtData[1]->WorkLocal[1] = 7*
111: 0x021D [0x1B] RETURN

SUBROUTINE_0221:
112: 0x0221 [0x0C] ExtData[1]->WorkLocal[1]--
113: 0x0224 [0x3E] IF !(ExtData[1]->WorkLocal[3] bit 8*) GOTO 0x022E
114: 0x022B [0x01] GOTO 0x0242

SUBROUTINE_022E:
115: 0x022E [0x02] IF !(ExtData[1]->WorkLocal[1] == 0*) GOTO 0x023F
116: 0x0236 [0x03] ExtData[1]->WorkLocal[1] = 8*
117: 0x023B [0x1B] RETURN

SUBROUTINE_023F:
118: 0x023F [0x06] ExtData[1]->WorkLocal[1] = 0
119: 0x0242 [0x1B] RETURN
```
