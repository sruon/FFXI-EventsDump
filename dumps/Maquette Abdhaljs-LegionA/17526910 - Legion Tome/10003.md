...
```
  ...
  7: 0x001B [0x24] CREATE_DIALOG(message_id=7077*, default_option=1*, option_flags=0*)
    → "Truly exit the maquette?\u0007\u000BYes, exit.\u0007No, remain.\u007F1\u0000\u0007"
 ...
 14: 0x0037 [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "main" with entities [LocalPlayer, LocalPlayer], work=[1*, 0*]
