...
- **7072**: Proceed to the Hall of [An/Ki/Im/Muru/Mul]? [Yes./Not yet.]
...
```
  ...
  2: 0x0007 [0x24] CREATE_DIALOG(message_id=7072*, default_option=1*, option_flags=0*)
