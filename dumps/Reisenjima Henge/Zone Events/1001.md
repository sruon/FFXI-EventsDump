...
SUBROUTINE_02FE:
105: 0x02FE [0xD0] LOAD_SCHEDULED_TASK_ALT5(work_offset=168*, entity1=LocalPlayer, entity2=LocalPlayer, action="main", work_offset2=0*)
106: 0x030F [0x1C] WAIT(160* ticks)
107: 0x0312 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
108: 0x0323 [0x1C] WAIT(60* ticks)
109: 0x0326 [0x1B] RETURN

SUBROUTINE_0327:
110: 0x0327 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
111: 0x0338 [0xD0] LOAD_SCHEDULED_TASK_ALT5(work_offset=169*, entity1=LocalPlayer, entity2=LocalPlayer, action="main", work_offset2=0*)
112: 0x0349 [0x1C] WAIT(160* ticks)
113: 0x034C [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
114: 0x035B [0x1B] RETURN

SUBROUTINE_035C:
115: 0x035C [0xD0] LOAD_SCHEDULED_TASK_ALT5(work_offset=168*, entity1=LocalPlayer, entity2=LocalPlayer, action="main", work_offset2=0*)
116: 0x036D [0x1C] WAIT(160* ticks)
117: 0x0370 [0x48] [System] [7331*]:
    → "The light contains...something other than peace and serenity!\u0000\u0007"
118: 0x0373 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="who1", work_offset2=0*)
119: 0x0384 [0x1C] WAIT(60* ticks)
120: 0x0387 [0x1B] RETURN

SUBROUTINE_0388:
121: 0x0388 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="whi1", work_offset2=0*)
122: 0x0399 [0xD0] LOAD_SCHEDULED_TASK_ALT5(work_offset=169*, entity1=LocalPlayer, entity2=LocalPlayer, action="main", work_offset2=0*)
123: 0x03AA [0x1C] WAIT(160* ticks)
124: 0x03AD [0x55] WAIT_LOAD_SCHEDULER(work_offset=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="whi1")
