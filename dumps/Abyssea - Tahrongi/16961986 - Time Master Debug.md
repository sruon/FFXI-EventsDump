...
- **7744**: Time debug: Time limit: $0 [sec./min.] Time debug: Search flag: [OFF/ON] Time debug: Search flag switched ON flag: [OFF/ON] Time debug: Forced exit flag: [OFF/ON]
- **7745**: Time debug: Do what? [Nuttin'./Increase time limit./Reduce time limit./Switch OFF "Search flag switched ON flag."/Forced exit flag OFF./Receive one $3.]
- **7746**: Time debug: Increase by how much? [Return./+0 minute./+1 minute./+2 minutes./+3 minutes./+5 minutes./+10 minutes./+15 minutes./+30 minutes./+45 minutes./+60 minutes./+75 minutes./+90 minutes./+120 minutes.]
- **7747**: Time debug: Reduce by how much? [\`Gi/-0 minute./-1 minute./-2 minutes./-3 minutes./-5 minutes./-10 minutes./-15 minutes./-30 minutes./-45 minutes./-60 minutes./-75 minutes./-90 minutes./-120 minutes.]
...
SUBROUTINE_00CC:
 ...
 43: 0x00E0 [0x24] CREATE_DIALOG(message_id=7745*, default_option=0*, option_flags=ExtData[1]->WorkLocal[4])
 ...
 49: 0x0100 [0x24] CREATE_DIALOG(message_id=7746*, default_option=0*, option_flags=0*)
...
108: 0x029C [0x24] CREATE_DIALOG(message_id=7747*, default_option=0*, option_flags=0*)
