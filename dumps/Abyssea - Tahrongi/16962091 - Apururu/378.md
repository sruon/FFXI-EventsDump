...
```
 ...
 11: 0x01ED [0x24] CREATE_DIALOG(message_id=8030*, default_option=0*, option_flags=0x00)
 ...
 14: 0x01FD [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x00, bit_index_work_offset=0x8011, condition_work_offset=0x801B)
 15: 0x0204 [0x01] GOTO 0x027A

SUBROUTINE_0207:
 16: 0x0207 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x0219
 17: 0x020F [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x00, bit_index_work_offset=0x801B, condition_work_offset=0x801B)
 18: 0x0216 [0x01] GOTO 0x027A

SUBROUTINE_0219:
 19: 0x0219 [0x02] IF !(Work_Zone[0] == 2*) GOTO 0x022B
 20: 0x0221 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x00, bit_index_work_offset=0x801D, condition_work_offset=0x801B)
 21: 0x0228 [0x01] GOTO 0x027A

SUBROUTINE_022B:
 22: 0x022B [0x02] IF !(Work_Zone[0] == 3*) GOTO 0x023D
 23: 0x0233 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x00, bit_index_work_offset=0x801E, condition_work_offset=0x801B)
 24: 0x023A [0x01] GOTO 0x027A

SUBROUTINE_023D:
 25: 0x023D [0x02] IF !(Work_Zone[0] == 4*) GOTO 0x024F
 26: 0x0245 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x00, bit_index_work_offset=0x801F, condition_work_offset=0x801B)
...
SUBROUTINE_026B:
 ...
 35: 0x0270 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1001, bit_index_work_offset=0x8022, condition_work_offset=0x801B)
...
SUBROUTINE_0286:
 ...
 44: 0x0292 [0x5B] LOAD_EXT_SCHEDULER(work_offset=341*, entity1=EventEntity, entity2=EventEntity, action="bik0")
 ...
 47: 0x02A5 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="bik0")
...
SUBROUTINE_0302:
 ...
 73: 0x031B [0x5B] LOAD_EXT_SCHEDULER(work_offset=339*, entity1=EventEntity, entity2=EventEntity, action="gmn0")
 ...
 78: 0x0332 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
...
SUBROUTINE_0346:
 ...
 84: 0x0354 [0x4B] UPDATE_ENTITY_YAW(entity=EventEntity, yaw=0.02°)
 ...
 92: 0x0368 [0x5B] LOAD_EXT_SCHEDULER(work_offset=337*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 97: 0x037F [0x5B] LOAD_EXT_SCHEDULER(work_offset=337*, entity1=EventEntity, entity2=EventEntity, action="thk2")
...
100: 0x0392 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1001, bit_index_work_offset=0x8022, condition_work_offset=0x801B)
...
106: 0x03A8 [0x5B] LOAD_EXT_SCHEDULER(work_offset=339*, entity1=EventEntity, entity2=EventEntity, action="shk0")
...
111: 0x03BF [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="shk0")
112: 0x03CC [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1001, bit_index_work_offset=0x8022, condition_work_offset=0x801B)
