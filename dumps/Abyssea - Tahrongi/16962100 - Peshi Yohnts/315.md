...
```
  ...
  6: 0x008C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  ...
  9: 0x009F [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
 10: 0x00AC [0x5E] EventEntity goes idle (kills current action) (animation: "idl0")
 11: 0x00B1 [0x1C] WAIT(30* ticks)
 12: 0x00B4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
