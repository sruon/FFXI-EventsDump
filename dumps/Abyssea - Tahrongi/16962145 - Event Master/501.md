...
```
  ...
  7: 0x0023 [0x24] CREATE_DIALOG(message_id=8153*, default_option=0*, option_flags=0*)
    → "Do something?\u0007\u000BNope.\u0007Reset fame.\u0007Quest 01 (Fame rank: 
\u0000\u0007Quest 02 (Fame rank: 
\u0001\u0007Quest 03 (Fame rank: 
\u0002\u0007Quest 04 (Fame rank: 
\u0003\u0007Quest 05 (Fame rank: 
...
SUBROUTINE_008E:
 ...
 32: 0x00A3 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x03, bit_index_work_offset=0x800C, condition_work_offset=0x8000)
 33: 0x00AA [0x02] IF !(ExtData[1]->WorkLocal[2] == 1*) GOTO 0x00BC
 34: 0x00B2 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x03, bit_index_work_offset=0x800D, condition_work_offset=0x8000)
 35: 0x00B9 [0x01] GOTO 0x00F2
 36: 0x00BC [0x02] IF !(ExtData[1]->WorkLocal[2] == 2*) GOTO 0x00CE
 37: 0x00C4 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x03, bit_index_work_offset=0x800D, condition_work_offset=0x8000)
 38: 0x00CB [0x01] GOTO 0x00F2
 39: 0x00CE [0x02] IF !(ExtData[1]->WorkLocal[2] == 4*) GOTO 0x00E0
 40: 0x00D6 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x03, bit_index_work_offset=0x800D, condition_work_offset=0x8000)
 41: 0x00DD [0x01] GOTO 0x00F2
 42: 0x00E0 [0x02] IF !(ExtData[1]->WorkLocal[2] == 8*) GOTO 0x00F2
 43: 0x00E8 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x03, bit_index_work_offset=0x800D, condition_work_offset=0x8000)
 44: 0x00EF [0x01] GOTO 0x00F2

SUBROUTINE_00F2:
 45: 0x00F2 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x03, bit_index_work_offset=0x8006, condition_work_offset=0x8000)
...
SUBROUTINE_010C:
 53: 0x010C [0x24] CREATE_DIALOG(message_id=8154*, default_option=0*, option_flags=0x03)
    → "Do something? (Quest \u007F\u0014\u001F).\u0007\u000BNope.\u0007Set to incomplete.\u0007Progress report.\u0007Obtain key item.\u0007Set to complete.\u0007Set times completed.\u007F1\u0000\u0007"
