...
- **7770**: AP Debug: Do what? [Nuttin'./AP: Adjust elapsed time./AP: Adjust number of quests cleared for all PCs./AP: Adjust amount of XP obtained for all PCs./AP: Adjust amount of cruor for all PCs./AP: Adjust number of NMs defeated for all PCs./AP: Adjust number of HNMs defeated for all PCs./AP: Adjust pollution levels for this area./AP: Adjust number of defenses for this area./OT: Acquire info pertaining to "Order Trophy."]
- **7771**: Elapsed time: $0P (1P = $1 min)
- **7772**: XP: $0P (1P = $1 QUEST)
- **7773**: XP: $0P (1P = $1 XP)
- **7774**: Cruor: $0P (1P = $1 cruor)
- **7775**: NMs defeated: $0P (1P = $1 NM)
- **7776**: HNMs defeated: $0P (1P = $1 HNM)
- **7777**: Pollution level: $0 P
- **7778**: Number of defenses: $0 P
- **7779**: Change value? [No thanks./Increase./Decrease.]
- **7780**: All clear to receive the effect of "Flee"? [ Oh Goddess, no!/ Bring it on!]
- **7781**: Your fortune for today is [terrible/meh/decent/moderately good/very good]. As such, I shall imbue you with $1 minute(s) of "Flee."
- **7782**: OT Debug: Do what? [Nothing for now./OT: Obtainment bonus./OT: Fortune rate./OT: Externimation record.]
- **7783**: Obtained bonus work. XP added: $0. Cruor added: $1. NMs defeated: $2.
- **7784**: Fortune rate work. Spawn rate added value: $0 Blue casket spawn rate: $1 Red casket spawn rate: $2 Gold casket spawn rate: $3
- **7785**: Extermination record work. Previous monster defeated: $0. No. of same ID defeated: $1. No. of diff. ID defeated: $2.
...
```
 ...
 11: 0x0035 [0x24] CREATE_DIALOG(message_id=7770*, default_option=0*, option_flags=0*)
 ...
 23: 0x0077 [0x1D] PRINT_EVENT_MESSAGE(message_id=7771*)
 ...
 31: 0x009E [0x1D] PRINT_EVENT_MESSAGE(message_id=7772*)
    → "XP: $0P (1P = $1 QUEST)"
 ...
 39: 0x00C5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7773*)
    → "XP: $0P (1P = $1 XP)"
 ...
 47: 0x00EC [0x1D] PRINT_EVENT_MESSAGE(message_id=7774*)
    → "Cruor: $0P (1P = $1 cruor)"
 ...
 55: 0x0113 [0x1D] PRINT_EVENT_MESSAGE(message_id=7775*)
 ...
 63: 0x013A [0x1D] PRINT_EVENT_MESSAGE(message_id=7776*)
 ...
 70: 0x015C [0x1D] PRINT_EVENT_MESSAGE(message_id=7777*)
    → "Pollution level: $0 P"
 ...
 77: 0x017E [0x1D] PRINT_EVENT_MESSAGE(message_id=7778*)
 ...
 81: 0x018D [0x24] CREATE_DIALOG(message_id=7782*, default_option=0*, option_flags=0*)
...
109: 0x01F8 [0x24] CREATE_DIALOG(message_id=7780*, default_option=0*, option_flags=0*)
...
138: 0x02A8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7781*)
...
145: 0x02C8 [0x24] CREATE_DIALOG(message_id=7779*, default_option=0*, option_flags=0*)
