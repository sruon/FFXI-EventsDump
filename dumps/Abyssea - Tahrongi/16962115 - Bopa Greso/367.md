...
SUBROUTINE_008F:
 21: 0x008F [0x5B] LOAD_EXT_SCHEDULER(work_offset=359*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 24: 0x00A2 [0x5B] LOAD_EXT_SCHEDULER(work_offset=359*, entity1=EventEntity, entity2=EventEntity, action="tlk2")
 25: 0x00B1 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk2")
 26: 0x00BE [0x4A] LocalPlayer looks at Cha Lebagta (ID: 16962116/0x0102D244)
 27: 0x00C7 [0x5B] LOAD_EXT_SCHEDULER(work_offset=359*, entity1=Cha Lebagta (ID: 16962116/0x0102D244), entity2=Cha Lebagta (ID: 16962116/0x0102D244), action="tlk0")
 ...
 30: 0x00DE [0x5B] LOAD_EXT_SCHEDULER(work_offset=359*, entity1=Cha Lebagta (ID: 16962116/0x0102D244), entity2=Cha Lebagta (ID: 16962116/0x0102D244), action="tlk2")
 31: 0x00ED [0x53] WAIT_SCHEDULER_TASK(entity1=Cha Lebagta (ID: 16962116/0x0102D244), entity2=Cha Lebagta (ID: 16962116/0x0102D244), action_id="tlk2")
 32: 0x00FA [0x4A] LocalPlayer looks at EventEntity
 33: 0x0103 [0x5B] LOAD_EXT_SCHEDULER(work_offset=359*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 36: 0x0116 [0x5B] LOAD_EXT_SCHEDULER(work_offset=359*, entity1=EventEntity, entity2=EventEntity, action="tlk2")
 37: 0x0125 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk2")
 ...
 40: 0x0141 [0x5B] LOAD_EXT_SCHEDULER(work_offset=358*, entity1=Cha Lebagta (ID: 16962116/0x0102D244), entity2=Cha Lebagta (ID: 16962116/0x0102D244), action="gut0")
 ...
 43: 0x0158 [0x53] WAIT_SCHEDULER_TASK(entity1=Cha Lebagta (ID: 16962116/0x0102D244), entity2=Cha Lebagta (ID: 16962116/0x0102D244), action_id="gut0")
 44: 0x0165 [0x7C] Cha Lebagta (ID: 16962116/0x0102D244)->Render.Flags2 |= 0x01
 45: 0x016B [0x4A] LocalPlayer looks at EventEntity
 46: 0x0174 [0x5B] LOAD_EXT_SCHEDULER(work_offset=359*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 53: 0x018F [0x5B] LOAD_EXT_SCHEDULER(work_offset=359*, entity1=EventEntity, entity2=EventEntity, action="tlk2")
 54: 0x019E [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk2")
 55: 0x01AB [0x4A] LocalPlayer looks at Cha Lebagta (ID: 16962116/0x0102D244)
 56: 0x01B4 [0x5B] LOAD_EXT_SCHEDULER(work_offset=361*, entity1=Cha Lebagta (ID: 16962116/0x0102D244), entity2=Cha Lebagta (ID: 16962116/0x0102D244), action="poi0")
 ...
 59: 0x01CB [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk2")
 60: 0x01D8 [0x53] WAIT_SCHEDULER_TASK(entity1=Cha Lebagta (ID: 16962116/0x0102D244), entity2=Cha Lebagta (ID: 16962116/0x0102D244), action_id="poi0")
 61: 0x01E5 [0x4A] LocalPlayer looks at EventEntity
 62: 0x01EE [0x5B] LOAD_EXT_SCHEDULER(work_offset=359*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 65: 0x0201 [0x5B] LOAD_EXT_SCHEDULER(work_offset=359*, entity1=EventEntity, entity2=EventEntity, action="tlk2")
 66: 0x0210 [0x4A] LocalPlayer looks at Cha Lebagta (ID: 16962116/0x0102D244)
 67: 0x0219 [0x5B] LOAD_EXT_SCHEDULER(work_offset=361*, entity1=Cha Lebagta (ID: 16962116/0x0102D244), entity2=Cha Lebagta (ID: 16962116/0x0102D244), action="wav0")
 68: 0x0228 [0x2B] Cha Lebagta (ID: 16962116/0x0102D244) [8010*]:
    → "Now get crrrackin'!\u007F1\u0000\u0007"
 69: 0x022F [0x23] WAIT_FOR_DIALOG_INTERACTION
 70: 0x0230 [0x53] WAIT_SCHEDULER_TASK(entity1=Cha Lebagta (ID: 16962116/0x0102D244), entity2=Cha Lebagta (ID: 16962116/0x0102D244), action_id="wav0")
