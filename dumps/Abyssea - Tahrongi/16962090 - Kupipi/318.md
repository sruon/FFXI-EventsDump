...
```
  ...
  5: 0x017B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="zit0")
 ...
 10: 0x0192 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="zit0")
 11: 0x019F [0x5E] EventEntity goes idle (kills current action) (animation: "idl0")
 12: 0x01A4 [0x1C] WAIT(30* ticks)
 13: 0x01A7 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
...
\u0001 \u0001	)\u0002\u0001\u0000\u0000\u0002\u0000\u0000\u0000 as proof of your exploitarus.\u007F1\u0000\u0007"
 ...
 22: 0x01C6 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 23: 0x01D5 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
 24: 0x01E2 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="syu0")
 25: 0x01F1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7899*)
    → "Now go\u0001`oo get'em, tiger!\u007F1\u0000\u0007"
 26: 0x01F4 [0x23] WAIT_FOR_DIALOG_INTERACTION
 27: 0x01F5 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="syu0")
