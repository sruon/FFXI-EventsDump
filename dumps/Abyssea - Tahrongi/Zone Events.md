...
|---------|-------------|-------------|
|       0 | 0xFFFF9CBB  |  4294941883 |
|       1 | 0xFFF5A525  |  4294288677 |
|       2 | 0xAFA9      |       44969 |
|       3 | 0x0718      |        1816 |
|       4 | 0x0094      |         148 |
|       5 | 0x0000      |           0 |
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0010:       BB 04 80 F0 FF FF  7F 29 D2 02 01 6D 61 69    .......)...mai
...
```
  0: 0x0012 [0xBB] LOAD_EVENT_SCHEDULER_ALT: Load scheduler "main" with entities [LocalPlayer, Cavernous Maw (ID: 16962089/0x0102D229)], work=[148*, 0*]
