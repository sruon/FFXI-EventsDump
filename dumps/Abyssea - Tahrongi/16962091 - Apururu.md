- **8044**: Well, better safe than sorry-worry, I suppose... I'll have a thorough checkup performed, just in case.
- **8045**: I've afraid I have my hands full dealing with our rogue Cardian. Come back when things have settled-wettled down a bit, will you?
- **8050**: Ah, <Player>. Could I trouble-wouble you to check on our Cardians again?
- **8051**: Need an explanation? [Good to go!/Just to be safe...]
...
```
  ...
  1: 0x0010 [0x1D] PRINT_EVENT_MESSAGE(message_id=7848*)
...
```
  ...
  4: 0x0033 [0x1D] PRINT_EVENT_MESSAGE(message_id=7849*)
  ...
  7: 0x0046 [0x1D] PRINT_EVENT_MESSAGE(message_id=7850*)
  ...
  9: 0x004A [0x1D] PRINT_EVENT_MESSAGE(message_id=7851*)
 ...
 11: 0x004E [0x1D] PRINT_EVENT_MESSAGE(message_id=7852*)
 ...
 13: 0x0052 [0x1D] PRINT_EVENT_MESSAGE(message_id=7853*)
 ...
 15: 0x0056 [0x1D] PRINT_EVENT_MESSAGE(message_id=7854*)
...
```
  ...
  4: 0x0072 [0x1D] PRINT_EVENT_MESSAGE(message_id=7854*)
    → "Our quartermastaru Kopuro-Popuro oversees the supply chest there. He is a bit, shall we say, eccentric? But he will certainly provide you with what we need."
...
```
  ...
  4: 0x0080 [0x1D] PRINT_EVENT_MESSAGE(message_id=7876*)
  ...
  7: 0x0093 [0x1D] PRINT_EVENT_MESSAGE(message_id=7877*)
 ...
 11: 0x00B3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7878*)
 ...
 16: 0x00CC [0x1D] PRINT_EVENT_MESSAGE(message_id=7879*)
 ...
 19: 0x00DF [0x1D] PRINT_EVENT_MESSAGE(message_id=7880*)
 ...
 24: 0x00F8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7881*)
...
```
  ...
  3: 0x0116 [0x1D] PRINT_EVENT_MESSAGE(message_id=7882*)
...
```
  ...
  4: 0x0124 [0x1D] PRINT_EVENT_MESSAGE(message_id=8023*)
  ...
  7: 0x0137 [0x1D] PRINT_EVENT_MESSAGE(message_id=8024*)
 ...
 11: 0x014D [0x1D] PRINT_EVENT_MESSAGE(message_id=8025*)
 ...
 13: 0x0151 [0x1D] PRINT_EVENT_MESSAGE(message_id=8026*)
 ...
 15: 0x0155 [0x1D] PRINT_EVENT_MESSAGE(message_id=8027*)
 ...
 18: 0x0168 [0x1D] PRINT_EVENT_MESSAGE(message_id=8028*)
 ...
 20: 0x016C [0x1D] PRINT_EVENT_MESSAGE(message_id=8029*)
...
```
  ...
  3: 0x018E [0x1D] PRINT_EVENT_MESSAGE(message_id=8025*)
    → "It would seem that, er, not all the Cardians are behaving according to prescribed speci-wecifications."
  4: 0x0191 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0192 [0x1D] PRINT_EVENT_MESSAGE(message_id=8026*)
    → "Could I trouble you to investigate and reportaru back on any Cardians whose behavior seems...amiss?"
  6: 0x0195 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0196 [0x1D] PRINT_EVENT_MESSAGE(message_id=8027*)
    → "There are five of them in all. If you've any experience with them, a quick chat with each should be enough to isolate any potential problems."
 ...
 10: 0x01A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=8028*)
    → "And one more thing...I would suggest staying in the canyon until the job is completaru."
 11: 0x01AC [0x23] WAIT_FOR_DIALOG_INTERACTION
 12: 0x01AD [0x1D] PRINT_EVENT_MESSAGE(message_id=8029*)
    → "If you absolutely must go elsewhere, you'll want to start your investigation over upon your return. Their condition is known to fluctuate-wuctuate most rapidly, you see."
...
```
  ...
  5: 0x01D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=8030*)
 ...
 11: 0x01ED [0x24] CREATE_DIALOG(message_id=8031*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_027A:
 ...
 41: 0x0286 [0x1D] PRINT_EVENT_MESSAGE(message_id=8032*)
 ...
 45: 0x02A1 [0x1D] PRINT_EVENT_MESSAGE(message_id=8034*)
...
SUBROUTINE_02C2:
 ...
 55: 0x02D6 [0x1D] PRINT_EVENT_MESSAGE(message_id=8033*)
...
SUBROUTINE_02E0:
 59: 0x02E0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8035*)
    → "Are you sure, now?"
 60: 0x02E3 [0x23] WAIT_FOR_DIALOG_INTERACTION
 61: 0x02E4 [0x24] CREATE_DIALOG(message_id=8036*, default_option=1*, option_flags=0*)
...
SUBROUTINE_02FF:
 ...
 80: 0x0346 [0x1D] PRINT_EVENT_MESSAGE(message_id=8039*)
 ...
 87: 0x035D [0x1D] PRINT_EVENT_MESSAGE(message_id=8042*)
 ...
 93: 0x0377 [0x1D] PRINT_EVENT_MESSAGE(message_id=8043*)
 ...
 95: 0x037B [0x1D] PRINT_EVENT_MESSAGE(message_id=8044*)
 ...
 98: 0x038E [0x1D] PRINT_EVENT_MESSAGE(message_id=8045*)
...
102: 0x039C [0x1D] PRINT_EVENT_MESSAGE(message_id=8039*)
    → "Wonderful! I'll pass along your findings to our maintenance team immed-- Hm? What's this? An emergency dispatchy-watch?"
103: 0x039F [0x23] WAIT_FOR_DIALOG_INTERACTION
104: 0x03A0 [0x2B] ??? (ID: 16962143/0x0102D25F) [8040*]:
...
```
  ...
  3: 0x03DC [0x1D] PRINT_EVENT_MESSAGE(message_id=8038*)
    → "The Cardians serve us well, but with the strain of this harsh environment, their condition is known to degenerataru rapidly. If it wouldn't be too much of a burden, please lend us your powers of observation from time to time."
...
```
  ...
  3: 0x03E9 [0x1D] PRINT_EVENT_MESSAGE(message_id=8045*)
    → "I've afraid I have my hands full dealing with our rogue Cardian. Come back when things have settled-wettled down a bit, will you?"
...
```
 ...
 12: 0x041E [0x1D] PRINT_EVENT_MESSAGE(message_id=8028*)
    → "And one more thing...I would suggest staying in the canyon until the job is completaru."
 13: 0x0421 [0x23] WAIT_FOR_DIALOG_INTERACTION
 14: 0x0422 [0x1D] PRINT_EVENT_MESSAGE(message_id=8029*)
    → "If you absolutely must go elsewhere, you'll want to start your investigation over upon your return. Their condition is known to fluctuate-wuctuate most rapidly, you see."
 ...
 21: 0x0446 [0x1D] PRINT_EVENT_MESSAGE(message_id=8025*)
    → "It would seem that, er, not all the Cardians are behaving according to prescribed speci-wecifications."
 22: 0x0449 [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x044A [0x1D] PRINT_EVENT_MESSAGE(message_id=8026*)
    → "Could I trouble you to investigate and reportaru back on any Cardians whose behavior seems...amiss?"
 24: 0x044D [0x23] WAIT_FOR_DIALOG_INTERACTION
 25: 0x044E [0x1D] PRINT_EVENT_MESSAGE(message_id=8027*)
    → "There are five of them in all. If you've any experience with them, a quick chat with each should be enough to isolate any potential problems."
 ...
 28: 0x0461 [0x1D] PRINT_EVENT_MESSAGE(message_id=8028*)
    → "And one more thing...I would suggest staying in the canyon until the job is completaru."
 29: 0x0464 [0x23] WAIT_FOR_DIALOG_INTERACTION
 30: 0x0465 [0x1D] PRINT_EVENT_MESSAGE(message_id=8029*)
    → "If you absolutely must go elsewhere, you'll want to start your investigation over upon your return. Their condition is known to fluctuate-wuctuate most rapidly, you see."
