...
- **7387**: You take one last, long look at the painting.
- **7388**: A hideous voice rings in your ears...
- **7389**: (That abomination has no place in my gallery!)
- **7390**: Hang $3 on the wall? [Yes./Not yet.]
- **7391**: You place $3 in the frame.
...
```
  ...
  2: 0x0004 [0x24] CREATE_DIALOG(message_id=7390*, default_option=0*, option_flags=0*)
...
```
  ...
  2: 0x00D0 [0x24] CREATE_DIALOG(message_id=7390*, default_option=0*, option_flags=0*)
    → "Hang $3 on the wall? [Yes./Not yet.]"
 ...
 19: 0x013E [0x48] [System] [7388*]:
    → "A hideous voice rings in your ears..."
 20: 0x0141 [0x1C] WAIT(60* ticks)
 21: 0x0144 [0x48] [System] [7389*]:
    → "(That abomination has no place in my gallery!)"
...
```
  ...
  2: 0x019C [0x24] CREATE_DIALOG(message_id=7390*, default_option=0*, option_flags=0*)
    → "Hang $3 on the wall? [Yes./Not yet.]"
...
```
  ...
  2: 0x0264 [0x24] CREATE_DIALOG(message_id=7390*, default_option=0*, option_flags=0*)
    → "Hang $3 on the wall? [Yes./Not yet.]"
