...
```
  ...
  8: 0x027A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 ...
 14: 0x029D [0x45] LOAD_SCHEDULED_TASK(work_offset1=234*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="art0", work_offset2=0*)
 15: 0x02AE [0x1C] WAIT(20* ticks)
 16: 0x02B1 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="s000")
 17: 0x02BE [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 ...
 21: 0x02D8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 22: 0x02E9 [0x1C] WAIT(60* ticks)
 23: 0x02EC [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="kill")
 24: 0x02F9 [0x46] CAMERA_CONTROL: Restore default settings
 25: 0x02FB [0x4E] SET_ENTITY_HIDE_FLAG: Show LocalPlayer
 26: 0x0301 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
