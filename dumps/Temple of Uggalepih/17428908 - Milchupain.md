...
| [65535.3](#event-655353) | 0x004D       |     16 |              5 |
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0040:                                         32 04 80               2..
0050: 1F 00 00 80 08 80 09 80  1F 01 22 01 00           .........."..   
```
...
```
  ...
  1: 0x0050 [0x1F] MOVE_ENTITY: EventEntity moves to X=60.915*, Z=-101.797*, Y=1.494*
