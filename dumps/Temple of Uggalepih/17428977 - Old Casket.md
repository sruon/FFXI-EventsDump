...
- **7350**: Use your $3 to open it? [Yes./No.]
- **7351**: You find a strange brush inside the box.
- **7352**: When the $3 projects the deepest, darkest corner of your soul onto the blank canvas...only then will the doors to rancor open.
- **7387**: A hideous voice rings in your ears...
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=7350*, default_option=0*, option_flags=0*)
