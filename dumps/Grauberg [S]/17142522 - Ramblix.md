...
- **7725**: Oh my Gob! You're one of those adventurerurers, aren't ya? You got nothin' on me, [man./lady.] I was just mindin' my own businesesess, lookin' for junk an' stuff.
- **7726**: Hey, watch out. You don't wanna fight me. I'll turn you into meat jerky! Wait, how about you and me be friends instead? Sound good?
- **7727**: I travel all over the world and hear lots of differererent stories. I even hear your stories. I can tell you one, if you want.
- **7728**: Now, listen close...
- **7729**: Oh... Well, if that's the case, I'm outta here.
- **7735**: Do you want to hear a story? [No, thank you./Let's hear one./Let's hear some more!]
- **7736**: What story would you like to be told? [On second thought, maybe later./Pillar of Hope./Glimmer of Life./Time Slips Away(pt.1)./Time Slips Away(pt.2)./When Wills Collide(pt.1)./When Wills Collide(pt.2)./When Wills Collide(pt.3)./When Wills Collide(pt.4)./A Dreamy Interlude(pt.1)./A Dreamy Interlude(pt.2)./Cait in the Woods(pt.1)./Cait in the Woods(pt.2)./Maiden of the Dusk(pt.1)./Maiden of the Dusk(pt.2)./Maiden of the Dusk(pt.3)./Lest We Forget(pt.1)./Lest We Forget(pt.2).]
- **7737**: What story would you like to be told? [On second thought, maybe later./Message on the Wind(pt.1)./Message on the Wind(pt.2)./Message on the Wind(pt.3)./Message on the Wind(pt.4)./Fires of Discontent./The Unfinished Waltz(pt.1)./The Unfinished Waltz(pt.2)./Seeing Blood-red(pt.1)./Seeing Blood-red(pt.2)./Storm on the Horizon./Beast from the East(pt.1)./Beast from the East(pt.2)./The Forbidden Path(pt.1)./The Forbidden Path(pt.2)./The Forbidden Path(pt.3)./Her Memories: Of Malign Maladies(pt.1)./Her Memories: Of Malign Maladies(pt.2)./Somber Dreams(pt.1)./Somber Dreams(pt.2).]
- **7738**: What story would you like to be told? [On second thought, maybe later.]
