...
- **7732**: Do you want to hear a story? [No, thank you./Let's hear one./Let's hear some more!]
...
- **7734**: What story would you like to be told? [On second thought, maybe later./Message on the Wind(pt.1)./Message on the Wind(pt.2)./Message on the Wind(pt.3)./Message on the Wind(pt.4)./Fires of Discontent./The Unfinished Waltz(pt.1)./The Unfinished Waltz(pt.2)./Seeing Blood-red(pt.1)./Seeing Blood-red(pt.2)./Storm on the Horizon./Beast from the East(pt.1)./Beast from the East(pt.2)./The Forbidden Path(pt.1)./The Forbidden Path(pt.2)./The Forbidden Path(pt.3)./Her Memories: Of Malign Maladies(pt.1)./Her Memories: Of Malign Maladies(pt.2)./Somber Dreams(pt.1)./Somber Dreams(pt.2).]
