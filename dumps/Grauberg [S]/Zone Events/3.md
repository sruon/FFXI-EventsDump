...
```
  ...
  1: 0x03A6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  2: 0x03B7 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
  ...
  8: 0x03DD [0xBA] SET_ENTITY_POSITION(entity_id=References[17109749], pos_x=433.178*, pos_z=78.616*, pos_y=-40.576*, direction=5.4°*)
 ...
 12: 0x0401 [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s038", work_offset2=0*)
 13: 0x0412 [0x1C] WAIT(15* ticks)
 14: 0x0415 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 15: 0x0426 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1")
 16: 0x0435 [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="nage", work_offset2=0*)
 ...
 22: 0x0463 [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s039", work_offset2=0*)
 ...
 27: 0x0491 [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s040", work_offset2=0*)
 ...
 31: 0x04B9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s041", work_offset2=0*)
 ...
 35: 0x04E1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s042", work_offset2=0*)
 ...
 40: 0x0502 [0xBA] SET_ENTITY_POSITION(entity_id=References[17109749], pos_x=427.606*, pos_z=70.146*, pos_y=-43.739*, direction=342.1°*)
 ...
 43: 0x0523 [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s043", work_offset2=0*)
 44: 0x0534 [0x1C] WAIT(30* ticks)
 45: 0x0537 [0x4A] LocalPlayer looks at Bhoratz (ID: 17142517/0x010592F5)
 46: 0x0540 [0x55] WAIT_LOAD_SCHEDULER(work_offset=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s043")
 47: 0x054F [0x1C] WAIT(30* ticks)
 48: 0x0552 [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="knag", work_offset2=0*)
 49: 0x0563 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 50: 0x0574 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 51: 0x0583 [0x46] CAMERA_CONTROL: Restore default settings
 52: 0x0585 [0x1C] WAIT(60* ticks)
 53: 0x0588 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
