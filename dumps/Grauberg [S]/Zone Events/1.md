...
```
  ...
  2: 0x00B8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  3: 0x00C9 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 19: 0x012A [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s030", work_offset2=0*)
 20: 0x013B [0x1C] WAIT(15* ticks)
 21: 0x013E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 22: 0x014F [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1")
 ...
 26: 0x0175 [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s031", work_offset2=0*)
 27: 0x0186 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Childerich (ID: 17142516/0x010592F4), entity2=Childerich (ID: 17142516/0x010592F4), action="tlk0")
 ...
 32: 0x01A5 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Childerich (ID: 17142516/0x010592F4), entity2=Childerich (ID: 17142516/0x010592F4), action="tlk1")
 33: 0x01B4 [0x52] END_LOAD_SCHEDULER: End scheduler "s031" with entities [EventEntity, EventEntity], work=331*
 34: 0x01C3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s032", work_offset2=0*)
 ...
 38: 0x01E2 [0xBA] SET_ENTITY_POSITION(entity_id=References[17109749], pos_x=-317.139*, pos_z=-500.695*, pos_y=16.509*, direction=189.5°*)
 ...
 41: 0x0203 [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s033", work_offset2=0*)
 ...
 47: 0x0241 [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s034", work_offset2=0*)
 ...
 51: 0x026F [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s081", work_offset2=0*)
 ...
 54: 0x0288 [0x55] WAIT_LOAD_SCHEDULER(work_offset=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s081")
 55: 0x0297 [0x1C] WAIT(30* ticks)
 56: 0x029A [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s035", work_offset2=0*)
 57: 0x02AB [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=69*, entity1=Bhoratz (ID: 17142517/0x010592F5), entity2=Bhoratz (ID: 17142517/0x010592F5), action="tlk0")
 ...
 60: 0x02C2 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=69*, entity1=Bhoratz (ID: 17142517/0x010592F5), entity2=Bhoratz (ID: 17142517/0x010592F5), action="tlk1")
 61: 0x02D1 [0x52] END_LOAD_SCHEDULER: End scheduler "s035" with entities [EventEntity, EventEntity], work=331*
 62: 0x02E0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s036", work_offset2=0*)
 ...
 66: 0x030A [0x45] LOAD_SCHEDULED_TASK(work_offset1=331*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s037", work_offset2=0*)
 ...
 69: 0x0323 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 70: 0x0334 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 77: 0x0360 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
