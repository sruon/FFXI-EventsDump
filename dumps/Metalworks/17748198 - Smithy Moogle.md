...
- **11502**: The blacksmiths' guild here is huge, kupo! There's so much to learn!
- **11503**: Hmmm...wait, you aren't a moogle!
- **11504**: @You show the moogle your $0.
- **11505**: Let me take a look at that, kupo.
- **11506**: ...
- **11507**: Hmm...
- **11508**: An...empyrean weapon?
- **11509**: No...a Mog Bonanza weapon...
- **11510**: And the crystallization is impressive, kupo!
- **11511**: Kupofried truly is a master of his art...but how can we use this, kupo?
- **11512**: Forgive my musing.
- **11513**: That $0 utilizes special magics found in Bonanza weapons, kupo.
- **11514**: In fact, it can probably even be used to reforge them.
- **11515**: But don't expect it to have any effect on other weapons, kupo.
- **11516**: I admit to being intrigued... What is the exact process that makes it so?
- **11517**: It doesn't seem incredibly complicated, yet I admit to being particularly stumped, kupo.
- **11518**: The Mog Bonanza weapons utilize special moogle magic. Perhaps we might be able to take advantage of this magic in other ways.
- **11519**: But either way, this one cannot be used for more generic purposes.
- **11520**: But that's just me thinking out loud, kupo.
- **11521**: Be that as it may, I can use $0 to reforge Mog Bonanza weapons.
- **11522**: Your reforged weapon will look something like this, kupo.
- **11524**: Reforge the $0?
- **11525**: Proceed with the reforging? [Yes./No.]
...
```
  ...
  3: 0x0016 [0x1D] PRINT_EVENT_MESSAGE(message_id=11502*)
...
```
  ...
  5: 0x004D [0x1D] PRINT_EVENT_MESSAGE(message_id=11503*)
 ...
 14: 0x0080 [0x1D] PRINT_EVENT_MESSAGE(message_id=11505*)
 ...
 17: 0x0091 [0x1D] PRINT_EVENT_MESSAGE(message_id=11506*)
    → "..."
 18: 0x0094 [0x23] WAIT_FOR_DIALOG_INTERACTION
 19: 0x0095 [0x1D] PRINT_EVENT_MESSAGE(message_id=11507*)
    → "Hmm..."
 ...
 22: 0x00A6 [0x1D] PRINT_EVENT_MESSAGE(message_id=11508*)
    → "An...empyrean weapon?"
 23: 0x00A9 [0x23] WAIT_FOR_DIALOG_INTERACTION
 24: 0x00AA [0x1D] PRINT_EVENT_MESSAGE(message_id=11509*)
    → "No...a Mog Bonanza weapon..."
 25: 0x00AD [0x23] WAIT_FOR_DIALOG_INTERACTION
 26: 0x00AE [0x1D] PRINT_EVENT_MESSAGE(message_id=11510*)
    → "And the crystallization is impressive, kupo!"
 27: 0x00B1 [0x23] WAIT_FOR_DIALOG_INTERACTION
 28: 0x00B2 [0x1D] PRINT_EVENT_MESSAGE(message_id=11511*)
 ...
 31: 0x00C3 [0x1D] PRINT_EVENT_MESSAGE(message_id=11507*)
    → "Hmm..."
 32: 0x00C6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 33: 0x00C7 [0x1D] PRINT_EVENT_MESSAGE(message_id=11506*)
    → "..."
 ...
 36: 0x00D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=11512*)
    → "Forgive my musing."
 ...
 41: 0x00FB [0x1D] PRINT_EVENT_MESSAGE(message_id=11513*)
    → "That $0 utilizes special magics found in Bonanza weapons, kupo."
 42: 0x00FE [0x23] WAIT_FOR_DIALOG_INTERACTION
 43: 0x00FF [0x1D] PRINT_EVENT_MESSAGE(message_id=11514*)
 ...
 46: 0x0108 [0x1D] PRINT_EVENT_MESSAGE(message_id=11515*)
 ...
 49: 0x0119 [0x1D] PRINT_EVENT_MESSAGE(message_id=11506*)
    → "..."
 50: 0x011C [0x23] WAIT_FOR_DIALOG_INTERACTION
 51: 0x011D [0x1D] PRINT_EVENT_MESSAGE(message_id=11507*)
    → "Hmm..."
 ...
 58: 0x0136 [0x1D] PRINT_EVENT_MESSAGE(message_id=11518*)
 ...
 60: 0x013A [0x1D] PRINT_EVENT_MESSAGE(message_id=11519*)
 ...
 63: 0x014B [0x1D] PRINT_EVENT_MESSAGE(message_id=11507*)
    → "Hmm..."
 64: 0x014E [0x23] WAIT_FOR_DIALOG_INTERACTION
 65: 0x014F [0x1D] PRINT_EVENT_MESSAGE(message_id=11506*)
    → "..."
 ...
 68: 0x0160 [0x1D] PRINT_EVENT_MESSAGE(message_id=11520*)
 ...
 73: 0x0183 [0x1D] PRINT_EVENT_MESSAGE(message_id=11521*)
 ...
 79: 0x01A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=11522*)
...
```
  ...
  4: 0x02D5 [0x1D] PRINT_EVENT_MESSAGE(message_id=11524*)
    → "Reforge the $0?"
  ...
  8: 0x02E9 [0x24] CREATE_DIALOG(message_id=11525*, default_option=1*, option_flags=0*)
