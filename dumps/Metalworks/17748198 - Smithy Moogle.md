...
- **11500**: The blacksmiths' guild here is huge, kupo! There's so much to learn!
- **11501**: Hmmm...wait, you aren't a moogle!
- **11502**: @You show the moogle your $0.
- **11503**: Let me take a look at that, kupo.
- **11504**: ...
- **11505**: Hmm...
- **11506**: An...empyrean weapon?
- **11507**: No...a Mog Bonanza weapon...
- **11508**: And the crystallization is impressive, kupo!
- **11509**: Kupofried truly is a master of his art...but how can we use this, kupo?
- **11510**: Forgive my musing.
- **11511**: That $0 utilizes special magics found in Bonanza weapons, kupo.
- **11512**: In fact, it can probably even be used to reforge them.
- **11513**: But don't expect it to have any effect on other weapons, kupo.
- **11514**: I admit to being intrigued... What is the exact process that makes it so?
- **11515**: It doesn't seem incredibly complicated, yet I admit to being particularly stumped, kupo.
- **11516**: The Mog Bonanza weapons utilize special moogle magic. Perhaps we might be able to take advantage of this magic in other ways.
- **11517**: But either way, this one cannot be used for more generic purposes.
- **11518**: But that's just me thinking out loud, kupo.
- **11519**: Be that as it may, I can use $0 to reforge Mog Bonanza weapons.
- **11520**: Your reforged weapon will look something like this, kupo.
- **11522**: Reforge the $0?
- **11523**: Proceed with the reforging? [Yes./No.]
...
```
  ...
  3: 0x0016 [0x1D] PRINT_EVENT_MESSAGE(message_id=11500*)
...
```
  ...
  5: 0x004D [0x1D] PRINT_EVENT_MESSAGE(message_id=11501*)
 ...
 14: 0x0080 [0x1D] PRINT_EVENT_MESSAGE(message_id=11503*)
 ...
 17: 0x0091 [0x1D] PRINT_EVENT_MESSAGE(message_id=11504*)
    → "..."
 18: 0x0094 [0x23] WAIT_FOR_DIALOG_INTERACTION
 19: 0x0095 [0x1D] PRINT_EVENT_MESSAGE(message_id=11505*)
    → "Hmm..."
 ...
 22: 0x00A6 [0x1D] PRINT_EVENT_MESSAGE(message_id=11506*)
    → "An...empyrean weapon?"
 23: 0x00A9 [0x23] WAIT_FOR_DIALOG_INTERACTION
 24: 0x00AA [0x1D] PRINT_EVENT_MESSAGE(message_id=11507*)
    → "No...a Mog Bonanza weapon..."
 25: 0x00AD [0x23] WAIT_FOR_DIALOG_INTERACTION
 26: 0x00AE [0x1D] PRINT_EVENT_MESSAGE(message_id=11508*)
    → "And the crystallization is impressive, kupo!"
 27: 0x00B1 [0x23] WAIT_FOR_DIALOG_INTERACTION
 28: 0x00B2 [0x1D] PRINT_EVENT_MESSAGE(message_id=11509*)
 ...
 31: 0x00C3 [0x1D] PRINT_EVENT_MESSAGE(message_id=11505*)
    → "Hmm..."
 32: 0x00C6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 33: 0x00C7 [0x1D] PRINT_EVENT_MESSAGE(message_id=11504*)
    → "..."
 ...
 36: 0x00D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=11510*)
    → "Forgive my musing."
 ...
 41: 0x00FB [0x1D] PRINT_EVENT_MESSAGE(message_id=11511*)
    → "That $0 utilizes special magics found in Bonanza weapons, kupo."
 42: 0x00FE [0x23] WAIT_FOR_DIALOG_INTERACTION
 43: 0x00FF [0x1D] PRINT_EVENT_MESSAGE(message_id=11512*)
 ...
 46: 0x0108 [0x1D] PRINT_EVENT_MESSAGE(message_id=11513*)
 ...
 49: 0x0119 [0x1D] PRINT_EVENT_MESSAGE(message_id=11504*)
    → "..."
 50: 0x011C [0x23] WAIT_FOR_DIALOG_INTERACTION
 51: 0x011D [0x1D] PRINT_EVENT_MESSAGE(message_id=11505*)
    → "Hmm..."
 ...
 58: 0x0136 [0x1D] PRINT_EVENT_MESSAGE(message_id=11516*)
 ...
 60: 0x013A [0x1D] PRINT_EVENT_MESSAGE(message_id=11517*)
 ...
 63: 0x014B [0x1D] PRINT_EVENT_MESSAGE(message_id=11505*)
    → "Hmm..."
 64: 0x014E [0x23] WAIT_FOR_DIALOG_INTERACTION
 65: 0x014F [0x1D] PRINT_EVENT_MESSAGE(message_id=11504*)
    → "..."
 ...
 68: 0x0160 [0x1D] PRINT_EVENT_MESSAGE(message_id=11518*)
 ...
 73: 0x0183 [0x1D] PRINT_EVENT_MESSAGE(message_id=11519*)
 ...
 79: 0x01A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=11520*)
...
```
  ...
  4: 0x02D5 [0x1D] PRINT_EVENT_MESSAGE(message_id=11522*)
    → "Reforge the $0?"
  ...
  8: 0x02E9 [0x24] CREATE_DIALOG(message_id=11523*, default_option=1*, option_flags=0*)
