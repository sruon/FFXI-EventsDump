...
SUBROUTINE_0908:
 ...
 54: 0x0910 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
...
SUBROUTINE_0926:
 ...
 60: 0x0928 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=60*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
...
```
# Data Section: 0x093E (32 bytes)
     0x093E: 6F 70 66 21 80 F8 FF FF 7F F8 FF FF 7F 70 61 73
     0x094E: 30 1B 53 F8 FF FF 7F F8 FF FF 7F 70 61 73 30 1B
```