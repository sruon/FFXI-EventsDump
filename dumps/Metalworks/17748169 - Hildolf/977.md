...
```
  ...
  3: 0x05AF [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 ...
 14: 0x05FC [0x45] LOAD_SCHEDULED_TASK(work_offset1=557*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s078", work_offset2=0*)
 15: 0x060D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 16: 0x061E [0x1C] WAIT(30* ticks)
 17: 0x0621 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 22: 0x064B [0x45] LOAD_SCHEDULED_TASK(work_offset1=557*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s079", work_offset2=0*)
 ...
 30: 0x067D [0x45] LOAD_SCHEDULED_TASK(work_offset1=557*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s080", work_offset2=0*)
 ...
 35: 0x0696 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
...
SUBROUTINE_06B7:
 ...
 42: 0x06BF [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 43: 0x06CE [0x52] END_LOAD_SCHEDULER: End scheduler "s078" with entities [LocalPlayer, LocalPlayer], work=557*
 44: 0x06DD [0x45] LOAD_SCHEDULED_TASK(work_offset1=557*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s081", work_offset2=0*)
...
SUBROUTINE_07C6:
 ...
 89: 0x07DD [0x45] LOAD_SCHEDULED_TASK(work_offset1=557*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s082", work_offset2=0*)
 90: 0x07EE [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 93: 0x0801 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 ...
 98: 0x082B [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
...
102: 0x0850 [0x45] LOAD_SCHEDULED_TASK(work_offset1=557*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s083", work_offset2=0*)
103: 0x0861 [0x93] DISPLAY_ITEM_INFO(item_id=Work_Zone[2])
104: 0x0864 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
105: 0x0873 [0x1D] PRINT_EVENT_MESSAGE(message_id=7357*)
    → "It is \u0001\u0001\u0001 \u0001\u0005$\u0002\u0000\u0000\u0000 you seek, yes?\u007F1\u0000\u0007"
106: 0x0876 [0x23] WAIT_FOR_DIALOG_INTERACTION
107: 0x0877 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
...
113: 0x08A8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=557*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s084", work_offset2=0*)
114: 0x08B9 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
...
SUBROUTINE_08F4:
123: 0x08F4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
...
126: 0x0917 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="qstc", work_offset2=0*)
127: 0x0928 [0x46] CAMERA_CONTROL: Restore default settings
128: 0x092A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
