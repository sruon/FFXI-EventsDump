...
```
 ...
 13: 0x005A [0x45] LOAD_SCHEDULED_TASK(work_offset1=399*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s079", work_offset2=0*)
 14: 0x006B [0x1C] WAIT(15* ticks)
 15: 0x006E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 16: 0x007F [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 ...
 21: 0x00A2 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=69*, entity1=Striking Snake (ID: 17747979/0x010ED00B), entity2=Striking Snake (ID: 17747979/0x010ED00B), action="tlk0")
 22: 0x00B1 [0x52] END_LOAD_SCHEDULER: End scheduler "s079" with entities [EventEntity, EventEntity], work=399*
 23: 0x00C0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=399*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s080", work_offset2=0*)
 ...
 27: 0x00DE [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 28: 0x00EF [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 31: 0x0116 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=69*, entity1=Striking Snake (ID: 17747979/0x010ED00B), entity2=Striking Snake (ID: 17747979/0x010ED00B), action="thk1")
 32: 0x0125 [0x53] WAIT_SCHEDULER_TASK(entity1=Striking Snake (ID: 17747979/0x010ED00B), entity2=Striking Snake (ID: 17747979/0x010ED00B), action_id="thk1")
 33: 0x0132 [0x45] LOAD_SCHEDULED_TASK(work_offset1=399*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s081", work_offset2=0*)
 34: 0x0143 [0x1C] WAIT(15* ticks)
 35: 0x0146 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 36: 0x0157 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 ...
 40: 0x017D [0x45] LOAD_SCHEDULED_TASK(work_offset1=399*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s082", work_offset2=0*)
 41: 0x018E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=69*, entity1=Striking Snake (ID: 17747979/0x010ED00B), entity2=Striking Snake (ID: 17747979/0x010ED00B), action="thk2")
 ...
 49: 0x01C8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=399*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s083", work_offset2=0*)
 50: 0x01D9 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=69*, entity1=Striking Snake (ID: 17747979/0x010ED00B), entity2=Striking Snake (ID: 17747979/0x010ED00B), action="tlk0")
 ...
 53: 0x01F0 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=69*, entity1=Striking Snake (ID: 17747979/0x010ED00B), entity2=Striking Snake (ID: 17747979/0x010ED00B), action="tlk1")
 54: 0x01FF [0x52] END_LOAD_SCHEDULER: End scheduler "s083" with entities [EventEntity, EventEntity], work=399*
 55: 0x020E [0x45] LOAD_SCHEDULED_TASK(work_offset1=399*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s084", work_offset2=0*)
 ...
 59: 0x0236 [0x45] LOAD_SCHEDULED_TASK(work_offset1=399*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s085", work_offset2=0*)
 60: 0x0247 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=69*, entity1=Striking Snake (ID: 17747979/0x010ED00B), entity2=Striking Snake (ID: 17747979/0x010ED00B), action="tlk0")
 ...
 68: 0x027F [0x45] LOAD_SCHEDULED_TASK(work_offset1=399*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s086", work_offset2=0*)
 69: 0x0290 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=69*, entity1=Striking Snake (ID: 17747979/0x010ED00B), entity2=Striking Snake (ID: 17747979/0x010ED00B), action="tlk1")
 ...
 72: 0x02A7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 73: 0x02B8 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 76: 0x02D8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
