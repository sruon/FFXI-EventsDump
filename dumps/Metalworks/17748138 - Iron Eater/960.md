...
```
  ...
  1: 0x0332 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  2: 0x0343 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 15: 0x0395 [0x45] LOAD_SCHEDULED_TASK(work_offset1=399*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s087", work_offset2=0*)
 16: 0x03A6 [0x1C] WAIT(15* ticks)
 17: 0x03A9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 18: 0x03BA [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 ...
 24: 0x03EC [0x45] LOAD_SCHEDULED_TASK(work_offset1=399*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s088", work_offset2=0*)
 25: 0x03FD [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=69*, entity1=Striking Snake (ID: 17747979/0x010ED00B), entity2=Striking Snake (ID: 17747979/0x010ED00B), action="tlk0")
 ...
 28: 0x0414 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 29: 0x0425 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 32: 0x0445 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
