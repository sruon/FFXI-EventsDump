...
- **6822**: Wh-what do you want? Someday, I'm going to be as strong as a Galka... M-maybe then Wise Owl will stop picking on me...
- **6823**: I-I just helped you. Puh-puh-please, stop t-talking to me, or the guildmaster will th-th-think that I'm slacking off.
- **6825**: Alright, sir. Now close your eyes...
- **6826**: Um, yeah... You could try making $0. Are you ready?
- **6827**: I th-think that's all. Be careful when gathering your items. Sometimes you'll end up spending more if you try buying all your ma-ma-materials. But d-d-don't let the guys at the guild shop know I t-told you that.
...
```
  ...
  5: 0x0020 [0x1D] PRINT_EVENT_MESSAGE(message_id=6823*)
    → "I-I just helped you. Puh-puh-please, stop t-talking to me, or the guildmaster will th-th-think that I'm slacking off."
  6: 0x0023 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0024 [0x01] GOTO 0x0056
  8: 0x0027 [0x1D] PRINT_EVENT_MESSAGE(message_id=6825*)
    → "Alright, sir. Now close your eyes..."
...
SUBROUTINE_0056:
 ...
 21: 0x0075 [0x1D] PRINT_EVENT_MESSAGE(message_id=6826*)
    → "Um, yeah... You could try making $0. Are you ready?"
...
SUBROUTINE_00A5:
 ...
 67: 0x0139 [0x48] [System] [6885*]:
    → "$4 x $0"
 68: 0x013C [0x23] WAIT_FOR_DIALOG_INTERACTION
 69: 0x013D [0x01] GOTO 0x0162
 70: 0x0140 [0x02] IF !(Work_Zone[8] == 0*) GOTO 0x014F
 71: 0x0148 [0x48] [System] [6884*]:
    → "$4 x $0 $5 x $0$0"
 72: 0x014B [0x23] WAIT_FOR_DIALOG_INTERACTION
 73: 0x014C [0x01] GOTO 0x0162
 74: 0x014F [0x02] IF !(Work_Zone[9] == 0*) GOTO 0x015E
 75: 0x0157 [0x48] [System] [6883*]:
    → "$4 x $0 $5 x $0$0 $6 x $0"
 76: 0x015A [0x23] WAIT_FOR_DIALOG_INTERACTION
 77: 0x015B [0x01] GOTO 0x0162
 78: 0x015E [0x48] [System] [6882*]:
    → "$4 x $0 $5 x $0$0 $6 x $0 $7 x $0$3"
 79: 0x0161 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_0162:
 80: 0x0162 [0x1D] PRINT_EVENT_MESSAGE(message_id=6827*)
    → "I th-think that's all. Be careful when gathering your items. Sometimes you'll end up spending more if you try buying all your ma-ma-materials. But d-d-don't let the guys at the guild shop know I t-told you that."
...
SUBROUTINE_0174:
 ...
 86: 0x0177 [0x1D] PRINT_EVENT_MESSAGE(message_id=6822*)
    → "Wh-what do you want? Someday, I'm going to be as strong as a Galka... M-maybe then Wise Owl will stop picking on me..."
