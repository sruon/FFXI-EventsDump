...
|---------|-------------|-------------|
|       0 | 0xFFFDAD7B  |  4294815099 |
|       1 | 0x4F71      |       20337 |
|       2 | 0xFFFFBEAE  |  4294950574 |
|       3 | 0x0021      |          33 |
|       4 | 0x0000      |           0 |
|       5 | 0x0001      |           1 |
|       6 | 0x0080      |         128 |
...
```
  0: 0x0002 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-152.197*, z=20.337*, y=-16.722*, direction=2.9°*
