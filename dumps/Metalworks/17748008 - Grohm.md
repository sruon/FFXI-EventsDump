...
- **7520**: Whether it's mining, smithing, or adventuring, it's all the same. We Galka do all the dirty work while the Humes sit back and watch.
- **7759**: Hm? What do you want? Hey, you're not from Bastok, are you?
- **7760**: What!? You're [San d'Orian/Windurstian], and you listened to what a Bastokan official told you to do?
- **7761**: Hah! I have no idea why that Hume sent you here...or why your consulate sent you to him in the first place.
- **7762**: You better listen good. A lot of us died trying to win the Palborough Mines back from the Quadav...
- **7763**: It might not matter to a foreigner like you, but they always send us Galka to do the dirty work!
- **7764**: What gets me the most is that they don't even think about it twice! Even if you haven't been here long, you must've seen how they treat us.
- **7765**: Never mind. Shouting at you won't change anything. You wanted to know about refining ore, right? It's easy, but you have to remember the steps.
- **7766**: Here goes: 1. Get $6.". Put that into the upper part of the refiner.". Take the $7 out of the lower part of the refiner.
- **7767**: You can either buy $6 from someone, or get some by using $5 on a mythril seam inside Palborough.
- **7768**: The refining machine is so big, its upper and lower sections are on different floors. Put $6 into it on the third floor, and it'll produce $7 on the second floor.
- **7769**: I know it sounds simple, but it's not. You've got the Quadav to deal with, and they're everywhere.
- **7770**: Here, take these $5. Good luck. You're gonna need it.
- **7781**: Never mind, shouting at you won't change anything. You wanted to know about the beastmen, right?
- **7782**: I've heard rumors that those dumb Quadav are acting organized.
- **7783**: There's even talk that they have a leader now, like in the Great War...
- **7784**: Oh, and there's a strange magic circle at the deepest end of the Palborough Mines. It's said that whoever goes beyond it never comes back.
- **7785**: Sounds real suspicious, doesn't it? I'm sure you'll find your answers there.
- **7786**: Me? Oh, no. I'm never going back there. Good luck. You're gonna need it!
- **11379**: @@
...
```
  ...
  4: 0x001C [0x1D] PRINT_EVENT_MESSAGE(message_id=7765*)
  ...
  7: 0x0023 [0x1D] PRINT_EVENT_MESSAGE(message_id=7770*)
 ...
 17: 0x007D [0x2B] Lion (ID: 17748021/0x010ED035) [7771*]:
 ...
 22: 0x0099 [0x2B] Lion (ID: 17748021/0x010ED035) [7772*]:
 ...
 27: 0x00C0 [0x2B] Lion (ID: 17748021/0x010ED035) [7773*]:
 ...
 29: 0x00C8 [0x2B] Lion (ID: 17748021/0x010ED035) [7774*]:
    → "At least, for now."
 ...
 40: 0x013B [0x2B] Lion (ID: 17748021/0x010ED035) [7775*]:
 ...
 43: 0x0152 [0x2B] Lion (ID: 17748021/0x010ED035) [7776*]:
 ...
 45: 0x015A [0x2B] Lion (ID: 17748021/0x010ED035) [7777*]:
 ...
 54: 0x01BC [0x2B] Lion (ID: 17748021/0x010ED035) [7778*]:
 ...
 57: 0x01D3 [0x2B] Lion (ID: 17748021/0x010ED035) [7779*]:
 ...
 63: 0x0217 [0x2B] Lion (ID: 17748021/0x010ED035) [7780*]:
...
SUBROUTINE_0246:
 ...
 83: 0x029F [0x2B] Lion (ID: 17748021/0x010ED035) [11105*]:
 ...
 98: 0x032E [0x2B] Lion (ID: 17748021/0x010ED035) [11106*]:
...
101: 0x0345 [0x2B] Lion (ID: 17748021/0x010ED035) [11107*]:
...
105: 0x036D [0x2B] Lion (ID: 17748021/0x010ED035) [11108*]:
...
107: 0x0375 [0x2B] Lion (ID: 17748021/0x010ED035) [11109*]:
...
112: 0x03AC [0x2B] Lion (ID: 17748021/0x010ED035) [11110*]:
...
```
  ...
  3: 0x03EF [0x1D] PRINT_EVENT_MESSAGE(message_id=7781*)
...
```
  ...
  2: 0x040D [0x1D] PRINT_EVENT_MESSAGE(message_id=7770*)
    → "Here, take these $5. Good luck. You're gonna need it."
...
SUBROUTINE_04F4:
 ...
 13: 0x0521 [0x1D] PRINT_EVENT_MESSAGE(message_id=7785*)
 ...
 16: 0x0534 [0x1D] PRINT_EVENT_MESSAGE(message_id=7786*)
...
# Dead code (unreachable instructions):
     0x041D [0x1D] PRINT_EVENT_MESSAGE(message_id=7759*)
    → "Hm? What do you want? Hey, you're not from Bastok, are you?"
     ...
     0x0430 [0x1D] PRINT_EVENT_MESSAGE(message_id=7760*)
    → "What!? You're [San d'Orian/Windurstian], and you listened to what a Bastokan official told you to do?"
     ...
     0x0434 [0x1D] PRINT_EVENT_MESSAGE(message_id=7761*)
    → "Hah! I have no idea why that Hume sent you here...or why your consulate sent you to him in the first place."
     ...
     0x0438 [0x1D] PRINT_EVENT_MESSAGE(message_id=7762*)
    → "You better listen good. A lot of us died trying to win the Palborough Mines back from the Quadav..."
     ...
     0x0461 [0x1D] PRINT_EVENT_MESSAGE(message_id=7763*)
    → "It might not matter to a foreigner like you, but they always send us Galka to do the dirty work!"
     ...
     0x0474 [0x1D] PRINT_EVENT_MESSAGE(message_id=7764*)
    → "What gets me the most is that they don't even think about it twice! Even if you haven't been here long, you must've seen how they treat us."
     ...
     0x04A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7766*)
    → "Here goes: 1. Get $6.". Put that into the upper part of the refiner.". Take the $7 out of the lower part of the refiner."
     ...
     0x04A8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7767*)
    → "You can either buy $6 from someone, or get some by using $5 on a mythril seam inside Palborough."
     ...
     0x04B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7768*)
    → "The refining machine is so big, its upper and lower sections are on different floors. Put $6 into it on the third floor, and it'll produce $7 on the second floor."
     ...
     0x04C4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7769*)
