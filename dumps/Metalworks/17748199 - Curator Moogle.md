...
- **11529**: Hail, adventurer! Take a look and see if there's anything you like, kupo! No gil necessary, just a quick little item in exchange!
- **11531**: If so, then I require that you trade me the following all at once in exchange for the $30.
- **11532**: $ $0 .
- **11533**: $ $0 .
- **11534**: Come again soon, kupo!
...
00B0: 00 04 80 9D 00 46 01 10  00 0D 00 03 0D 00 04 00  .....F..........
00C0: 14 0D 00 05 80 03 0E 00  01 80 03 18 00 01 80 02  ................
00D0: 0E 00 10 00 03 15 01 9D  00 66 01 17 17 0D 00 9D  .........f......
00E0: 00 86 01 18 17 0D 00 0B  18 00 0B 0D 00 02 18 00  ................
00F0: 10 00 00 FC 00 48 0A 80  23 01 0F 01 02 18 00 0B  .....H..#.......
0100: 80 00 0B 01 48 0A 80 23  01 0F 01 48 0C 80 23 0B  ....H..#...H..#.
...
```
  ...
  3: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=11529*)
...
# Dead code (unreachable instructions):
     ...
     0x0073 [0x1D] PRINT_EVENT_MESSAGE(message_id=11534*)
    → "Come again soon, kupo!"
     ...
     0x0092 [0x1D] PRINT_EVENT_MESSAGE(message_id=11531*)
    → "If so, then I require that you trade me the following all at once in exchange for the $30."
     ...
     0x00D7 [0x9D] Work_Zone_1700[23] = 0x0166[ExtData[1]->WorkLocal[13]] // Read WORD
     0x00DF [0x9D] Work_Zone_1700[24] = 0x0186[ExtData[1]->WorkLocal[13]] // Read WORD
