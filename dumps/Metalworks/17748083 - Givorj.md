...
- **8787**: Which memory will you have recalled? [Nothing./Additional Scenarios.]
- **8788**: Which memory will you have recalled? [Nothing./Cornelia's Call to Action(pt.1)./Cornelia's Call to Action(pt.2).]
...
```
 ...
 39: 0x00D4 [0x24] CREATE_DIALOG(message_id=8787*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00E4:
 42: 0x00E4 [0x24] CREATE_DIALOG(message_id=8788*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_0113:
 50: 0x0113 [0x24] CREATE_DIALOG(message_id=8789*, default_option=0*, option_flags=Work_Zone[3])
...
SUBROUTINE_0142:
 58: 0x0142 [0x24] CREATE_DIALOG(message_id=8790*, default_option=0*, option_flags=Work_Zone[4])
    → "Which memory will you have recalled? [Nothing.]"
...
SUBROUTINE_0171:
 66: 0x0171 [0x24] CREATE_DIALOG(message_id=8791*, default_option=0*, option_flags=Work_Zone[5])
    → "Which memory will you have recalled? [Nothing.]"
...
SUBROUTINE_01A0:
 74: 0x01A0 [0x24] CREATE_DIALOG(message_id=8792*, default_option=0*, option_flags=Work_Zone[6])
    → "Which memory will you have recalled? [Nothing.]"
...
SUBROUTINE_01CF:
 82: 0x01CF [0x24] CREATE_DIALOG(message_id=8793*, default_option=0*, option_flags=Work_Zone[7])
    → "Which memory will you have recalled? [Nothing.]"
