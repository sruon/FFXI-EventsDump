...
SUBROUTINE_014E:
 45: 0x014E [0x24] CREATE_DIALOG(message_id=6904*, default_option=0x0011, option_flags=0*)
...
SUBROUTINE_0170:
 ...
 61: 0x01A3 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8000, condition_work_offset=0x800F)
 62: 0x01AA [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x801D, condition_work_offset=0x800F)
 ...
 74: 0x01E9 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8026, condition_work_offset=0x800F)
 ...
 86: 0x0228 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8026, condition_work_offset=0x800F)
 ...
 98: 0x0267 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8026, condition_work_offset=0x800F)
...
110: 0x02A6 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8026, condition_work_offset=0x800F)
...
122: 0x02E5 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8026, condition_work_offset=0x800F)
...
134: 0x0324 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8026, condition_work_offset=0x800F)
...
146: 0x0363 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8026, condition_work_offset=0x800F)
...
158: 0x03A2 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8026, condition_work_offset=0x800F)
...
\u0000 \u007F\u0012\u0000[monster/monsters] of any family.\u0007Equipment: Target item must be equipped.\u007F1\u0000\u0007"
     ...
     0x04B3 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8073, condition_work_offset=0x800F)
     ...
     0x0C2A [0x24] CREATE_DIALOG(message_id=6920*, default_option=0x0013, option_flags=0x05)
...
\u000B).\u0007\u007F\u0000\u0001\u0001\u00053\u0002\u000C\u0000\u0000(
     ...
     0x0D0B [0x1D] PRINT_EVENT_MESSAGE(message_id=6921*)
    → "Trade 
\u0001 guild points for \u0001\u00053\u0002\u0000\u0000\u0000?\u007F1\u0000\u0007"
     0x0D0E [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0D0F [0x24] CREATE_DIALOG(message_id=6918*, default_option=1*, option_flags=0*)
...
# Dead code (unreachable instructions):
     ...
     0x0E03 [0x1D] PRINT_EVENT_MESSAGE(message_id=6916*)
    → "How many do you wish to trade for?\u007F1\u0000\u0007"
     ...
     0x0E38 [0x1D] PRINT_EVENT_MESSAGE(message_id=6915*)
    → "Trade 
\u0001 guild points for \u0001\u0005%\u0002\u0000\u0000\u0000?\u007F1\u0000\u0007"
     0x0E3B [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0E3C [0x01] GOTO 0x0E43
     0x0E3F [0x1D] PRINT_EVENT_MESSAGE(message_id=6917*)
    → "Trade 
\u0001 guild points for 
\u0002 \u0001	)\u0002\u0002\u0000\u0000\u0002\u0000\u0000\u0000?\u007F1\u0000\u0007"
     ...
     0x0E4B [0x24] CREATE_DIALOG(message_id=6918*, default_option=1*, option_flags=0*)
    → "Proceed with the transaction? (GP: 
 )\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
     ...
     0x0E8C [0x1B] RETURN
     0x0E8D [0x02] IF !(Work_Zone[2] == 1993*) GOTO 0x0E9C
     0x0E95 [0x1D] PRINT_EVENT_MESSAGE(message_id=6840*)
    → "\u007F\u0000\u0001\u0001\u00053\u0002\u0000\u0000\u0000 is a wonderful new method of smithing that allows you to enchant metals with the mysterious energy of black magic and anima.\u007F1\u0000\u0007"
     ...
     0x0E99 [0x01] GOTO 0x0EC9
     0x0E9C [0x02] IF !(Work_Zone[2] == 1992*) GOTO 0x0EAB
     0x0EA4 [0x1D] PRINT_EVENT_MESSAGE(message_id=6841*)
    → "\u007F\u0000\u0001\u0001\u00053\u0002\u0000\u0000\u0000 is a wonderful new method of smithing that allows you to enchant metals with the mysterious energy of white magic and anima.\u007F1\u0000\u0007"
     ...
     0x0EB3 [0x1D] PRINT_EVENT_MESSAGE(message_id=6849*)
    → "\u007F\u0000\u0001\u0001\u00053\u0002\u0000\u0000\u0000 is a wonderful new method of goldsmithing that allows you to shape softened ingots with a mandrel, making it easier to process more chains with one crystal.\u007F1\u0000\u0007"
     ...
     0x0EC2 [0x1D] PRINT_EVENT_MESSAGE(message_id=6850*)
