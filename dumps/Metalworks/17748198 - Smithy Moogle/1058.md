...
```
  ...
  4: 0x0040 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "exp0" for entities [EventEntity, EventEntity]
  ...
  7: 0x0051 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "exp1" for entities [EventEntity, EventEntity]
 ...
 13: 0x0073 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "exp0" for entities [EventEntity, EventEntity]
 ...
 16: 0x0084 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "exp1" for entities [EventEntity, EventEntity]
 ...
 21: 0x0099 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "tlk0" for entities [EventEntity, EventEntity]
 ...
 30: 0x00B6 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "tlk1" for entities [EventEntity, EventEntity]
 ...
 35: 0x00CB [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "tlk0" for entities [EventEntity, EventEntity]
 36: 0x00D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=11508*)
    → "Forgive my musing.\u007F1\u0000\u0007"
 37: 0x00DB [0x23] WAIT_FOR_DIALOG_INTERACTION
 38: 0x00DC [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "tlk1" for entities [EventEntity, EventEntity]
 39: 0x00E9 [0x03] Work_Zone[2] = 9949*
 40: 0x00EE [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "exp0" for entities [EventEntity, EventEntity]
 ...
 48: 0x010C [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "exp1" for entities [EventEntity, EventEntity]
 ...
 53: 0x0121 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "tlk0" for entities [EventEntity, EventEntity]
 ...
 62: 0x013E [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "tlk1" for entities [EventEntity, EventEntity]
 ...
 67: 0x0153 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "tlk0" for entities [EventEntity, EventEntity]
 ...
 70: 0x0164 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "tlk1" for entities [EventEntity, EventEntity]
 71: 0x0171 [0x03] Work_Zone[2] = 9949*
 72: 0x0176 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "exp0" for entities [EventEntity, EventEntity]
 ...
 75: 0x0187 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "exp1" for entities [EventEntity, EventEntity]
 ...
 78: 0x0198 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "exp0" for entities [EventEntity, EventEntity]
 ...
 81: 0x01A9 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "exp1" for entities [EventEntity, EventEntity]
