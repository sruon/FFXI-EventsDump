...
```
 ...
 30: 0x0086 [0xAD] DUAL_ENTITY_SCHEDULER: Execute sub-case 0 with entities [Geomantic Reservoir (ID: 17195730/0x010662D2), LocalPlayer], param=ExtData[1]->WorkLocal[2]
