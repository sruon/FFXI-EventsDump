...
0020: 6F 31 46 01 38 02 80 2F  00 A0 62 06 01 4E 00 A0  o1F.8../..b..N..
0030: 62 06 01 92 01 A0 62 06  01 2F 00 A1 62 06 01 4E  b.....b../..b..N
0040: 00 A1 62 06 01 29 05 A0  62 06 01 02 29 05 A1 62  ..b..)..b...)..b
0050: 06 01 02 29 05 F0 FF FF  7F 25 4A F0 FF FF 7F A0  ...).....%J.....
0060: 62 06 01 45 03 80 F8 FF  FF 7F F8 FF FF 7F 73 32  b..E..........s2
0070: 30 35 01 80 1C 04 80 27  05 A0 62 06 01 03 45 00  05.....'..b...E.
0080: 80 F8 FF FF 7F F8 FF FF  7F 66 64 69 31 01 80 2A  .........fdi1..*
0090: 05 A0 62 06 01 4A A0 62  06 01 A1 62 06 01 1C 04  ..b..J.b...b....
00A0: 80 27 05 A1 62 06 01 03  52 03 80 F8 FF FF 7F F8  .'..b...R.......
...
0110: A1 62 06 01 4A A1 62 06  01 A0 62 06 01 27 05 F0  .b..J.b...b..'..
0120: FF FF 7F 26 55 03 80 F8  FF FF 7F F8 FF FF 7F 73  ...&U..........s
0130: 32 30 36 45 03 80 F8 FF  FF 7F F8 FF FF 7F 73 32  206E..........s2
0140: 30 37 01 80 1C 04 80 27  05 A1 62 06 01 04 45 06  07.....'..b...E.
0150: 80 F0 FF FF 7F F0 FF FF  7F 6E 61 6B 31 01 80 2B  .........nak1..+
0160: A0 62 06 01 07 80 23 2A  05 F0 FF FF 7F 1C 04 80  .b....#*........
0170: 27 05 F0 FF FF 7F 27 1C  08 80 27 05 A0 62 06 01  '.....'...'..b..
...
01B0: 32 30 37 4E 01 A0 62 06  01 2F 01 A0 62 06 01 4E  207N..b../..b..N
01C0: 01 A1 62 06 01 2F 01 A1  62 06 01 46 00 1C 04 80  ..b../..b..F....
...
```
  ...
  5: 0x0027 [0x2F] Chocobo (ID: 17195680/0x010662A0)->Render.Flags0 &= ~0x80000 // Bit 19
  6: 0x002D [0x4E] SET_ENTITY_HIDE_FLAG: Show Chocobo (ID: 17195680/0x010662A0)
  7: 0x0033 [0x92] Chocobo (ID: 17195680/0x010662A0)->Render.Flags3 ^= 0x01
  8: 0x0039 [0x2F] Unnamed NPC (ID: 17195681/0x010662A1)->Render.Flags0 &= ~0x80000 // Bit 19
  9: 0x003F [0x4E] SET_ENTITY_HIDE_FLAG: Show Unnamed NPC (ID: 17195681/0x010662A1)
 10: 0x0045 [0x29] REQ_SET_WAIT(priority=0x05, entity_id=Chocobo (ID: 17195680/0x010662A0), tag_num=0x02)
 11: 0x004C [0x29] REQ_SET_WAIT(priority=0x05, entity_id=Unnamed NPC (ID: 17195681/0x010662A1), tag_num=0x02)
 12: 0x0053 [0x29] REQ_SET_WAIT(priority=0x05, entity_id=LocalPlayer, tag_num=0x25)
 13: 0x005A [0x4A] LocalPlayer looks at Chocobo (ID: 17195680/0x010662A0)
 ...
 16: 0x0077 [0x27] REQ_SET(priority=0x05, entity_id=Chocobo (ID: 17195680/0x010662A0), tag_num=0x03)
 17: 0x007E [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi1" with entities [EventEntity, EventEntity], work=[200*, 0*]
 18: 0x008F [0x2A] GET_REQ_LEVEL(level=5, entity_id=Chocobo (ID: 17195680/0x010662A0))
 19: 0x0095 [0x4A] Chocobo (ID: 17195680/0x010662A0) looks at Unnamed NPC (ID: 17195681/0x010662A1)
 20: 0x009E [0x1C] WAIT(60* ticks)
 21: 0x00A1 [0x27] REQ_SET(priority=0x05, entity_id=Unnamed NPC (ID: 17195681/0x010662A1), tag_num=0x03)
 ...
 30: 0x010E [0x2A] GET_REQ_LEVEL(level=5, entity_id=Unnamed NPC (ID: 17195681/0x010662A1))
 31: 0x0114 [0x4A] Unnamed NPC (ID: 17195681/0x010662A1) looks at Chocobo (ID: 17195680/0x010662A0)
 ...
 38: 0x015F [0x2B] Chocobo (ID: 17195680/0x010662A0) [7898*]:
    → "Kweh!"
 ...
 44: 0x017A [0x27] REQ_SET(priority=0x05, entity_id=Chocobo (ID: 17195680/0x010662A0), tag_num=0x04)
 ...
 49: 0x01B3 [0x4E] SET_ENTITY_HIDE_FLAG: Hide Chocobo (ID: 17195680/0x010662A0)
 50: 0x01B9 [0x2F] Chocobo (ID: 17195680/0x010662A0)->Render.Flags0 |= 0x80000 // Bit 19
 51: 0x01BF [0x4E] SET_ENTITY_HIDE_FLAG: Hide Unnamed NPC (ID: 17195681/0x010662A1)
 52: 0x01C5 [0x2F] Unnamed NPC (ID: 17195681/0x010662A1)->Render.Flags0 |= 0x80000 // Bit 19
