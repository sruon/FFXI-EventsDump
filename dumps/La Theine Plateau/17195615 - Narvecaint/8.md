...
```
  ...
  3: 0x0022 [0x1D] PRINT_EVENT_MESSAGE(message_id=7741*)
    → "Thanks to our effective training drills, we were able to capture the new suspect with little trouble. Although I do wonder where that other knight disappeared to...\u007F1\u0000\u0007"
