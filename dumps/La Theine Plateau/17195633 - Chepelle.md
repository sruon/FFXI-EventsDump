...
- **7527**: Would you mind introducing your friends to the rest of us, Vauderame?
- **7537**: The royal scepter has already found its way into that Mithra's pocket. Even if her knowledge of its history is lacking, she still has a nose for value.
- **7543**: ...Are you sure about those two? It's not like you to leave loose ends, even if their memory has been erased.
...
```
  0: 0x00F4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7527*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
00F0:                             29 08 71 62 06 01 03           ).qb...
0100: 1D 09 80 23 29 08 71 62  06 01 04 00              ...#).qb....    
```

#### Opcodes

```
  0: 0x00F9 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Chepelle (ID: 17195633/0x01066271), tag_num=0x03)
  1: 0x0100 [0x1D] PRINT_EVENT_MESSAGE(message_id=7537*)
  ...
  3: 0x0104 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Chepelle (ID: 17195633/0x01066271), tag_num=0x04)
...
```
  0: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7543*)
