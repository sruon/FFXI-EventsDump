...
```
 ...
 23: 0x006A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 ...
 25: 0x0082 [0x2B] Nanaa Mihgo (ID: 17195642/0x0106627A) [7509*]:
    → "Hey!\u0007What do you think you're doing, finding the trrreasure chest before me!?\u007F1\u0000\u0007"
 ...
 31: 0x00AE [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s076", work_offset2=0*)
 ...
 35: 0x00CE [0x2B] Nanaa Mihgo (ID: 17195642/0x0106627A) [7511*]:
    → "There might be some kinda nasty trrrap just waiting to spring on a kitten like you.\u007F1\u0000\u0007"
 ...
 41: 0x00F5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 48: 0x0125 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s078", work_offset2=0*)
 49: 0x0136 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "open" for entities [EventEntity, EventEntity]
 50: 0x0143 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 51: 0x0154 [0x2B] Nanaa Mihgo (ID: 17195642/0x0106627A) [7512*]:
    → "...Rauuugh!\u0007Got it open! Now, let's take a look at the treasure...\u007F1\u0000\u0007"
 ...
 56: 0x0178 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s079", work_offset2=0*)
 ...
 70: 0x01DD [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s072", work_offset2=0*)
 ...
 82: 0x0232 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
 83: 0x0243 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s073", work_offset2=0*)
 ...
 90: 0x027E [0x55] WAIT_LOAD_SCHEDULER(work_offset=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s073")
 91: 0x028D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
 92: 0x029E [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s074", work_offset2=0*)
 ...
 95: 0x02C1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
 96: 0x02D2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s074", work_offset2=0*)
...
108: 0x0331 [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s072", work_offset2=0*)
...
112: 0x035F [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s080", work_offset2=0*)
...
120: 0x03A6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s081", work_offset2=0*)
...
127: 0x03EC [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
128: 0x03FD [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s082", work_offset2=0*)
...
131: 0x0424 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s083", work_offset2=0*)
...
137: 0x0461 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s084", work_offset2=0*)
...
142: 0x0497 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s085", work_offset2=0*)
...
151: 0x04E0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s086", work_offset2=0*)
...
158: 0x0528 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s087", work_offset2=0*)
...
160: 0x0540 [0x2B] Vauderame (ID: 17195633/0x01066271) [7529*]:
    → "You forget, Kanika.\u0007Atarefaunet's band is no more. We are now known as Vauderame's Knights.\u007F1\u0000\u0007"
...
166: 0x0569 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s088", work_offset2=0*)
...
169: 0x0590 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s089", work_offset2=0*)
...
177: 0x05E1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s090", work_offset2=0*)
...
190: 0x0641 [0x45] LOAD_SCHEDULED_TASK(work_offset1=92*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s073", work_offset2=0*)
...
193: 0x0664 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s091", work_offset2=0*)
...
197: 0x0686 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="who1", work_offset2=0*)
...
205: 0x06C2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
...
209: 0x06E4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s092", work_offset2=0*)
210: 0x06F5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="whi1", work_offset2=0*)
...
224: 0x0758 [0x2B] Vauderame (ID: 17195633/0x01066271) [7540*]:
    → "Then there is this adventurer.\u0007\u007F\u0005[He/She] looks like someone I did away with in another time...\u007F1\u0000\u0007"
...
262: 0x082C [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s093", work_offset2=0*)
263: 0x083D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
...
267: 0x086A [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s094", work_offset2=0*)
...
271: 0x0898 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s095", work_offset2=0*)
...
280: 0x08E9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s096", work_offset2=0*)
281: 0x08FA [0x29] REQ_SET_WAIT(priority=0x0B, entity_id=Nanaa Mihgo (ID: 17195642/0x0106627A), tag_num=0x30)
282: 0x0901 [0x45] LOAD_SCHEDULED_TASK(work_offset1=15*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s097", work_offset2=0*)
...
289: 0x092F [0x2B] Nanaa Mihgo (ID: 17195642/0x0106627A) [7553*]:
    → "...Hmmm.\u0007I get the feeling there's something important I'm forgetting...\u007F1\u0000\u0007"
290: 0x0936 [0x23] WAIT_FOR_DIALOG_INTERACTION
291: 0x0937 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
...
298: 0x0969 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
299: 0x097A [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
