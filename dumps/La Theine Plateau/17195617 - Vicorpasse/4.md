...
```
  ...
  3: 0x0022 [0x1D] PRINT_EVENT_MESSAGE(message_id=7748*)
    → "Another chance to test the effectiveness of our training in almost exactly the same setting! This time, I expect perfect coordination and execution from my men.\u007F1\u0000\u0007"
