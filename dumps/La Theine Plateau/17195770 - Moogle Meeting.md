...
- **12580**: [Apply to proceed/Proceed]? [Definitely!/Not yet.]
- **12591**: You will be able to call forth up to $4 alter ego[/s] given the current number of players in your party.
- **12598**: Prepare yourselves! The battlefield is almost ready!
- **12599**: Your number: $3. (Auto-transport: [off/on]) [Remove your name./Toggle auto-transport./Close dialogue.]
- **12611**: Debug menu. [Check information./View applicants./Applicant parameters./Change maximum limit./Clear applications./Automatically create./Close dialogue.]
- **12620**: Designate a value between $0 and $1.
- **12631**: $)$P13.$P106$P10, $P13.$lF$0 [1"/%<$P15{/$~_i/$m$P14F/$3$43308646i]
- **12643**: Enter which? (Auto-transport: [Off/On].) [Never mind./Moglesse Oblige./././././././././././././././Toggle auto-transport.]
- **12644**: Only party members present with you in this area will be transported to [/Moglesse Oblige][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **12645**: Entering [/Moglesse Oblige][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **12646**: You have chosen not to [apply to/enter] [/Moglesse Oblige][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **12649**: Applying to enter [/Moglesse Oblige][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy]. You will be unable to participate if you add any more party members. Are you sure?
- **12650**: You are currently applying to enter [/Moglesse Oblige][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **12652**: Your registration number for entering this nightmare is $3.
- **12653**: IDs up through $3 have been registered, and ID $2 is currently ready.
...
```
 ...
 13: 0x003F [0x24] CREATE_DIALOG(message_id=12643*, default_option=0*, option_flags=ExtData[1]->WorkLocal[7])
...
SUBROUTINE_00D3:
 ...
 46: 0x00E6 [0x24] CREATE_DIALOG(message_id=12580*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0157:
 ...
 16: 0x0178 [0x24] CREATE_DIALOG(message_id=12599*, default_option=1*, option_flags=0*)
...
```
  ...
  6: 0x01BB [0x24] CREATE_DIALOG(message_id=12580*, default_option=0*, option_flags=0*)
    → "[Apply to proceed/Proceed]? [Definitely!/Not yet.]"
...
```
  ...
  3: 0x0214 [0x24] CREATE_DIALOG(message_id=12611*, default_option=0*, option_flags=0*)
 ...
 44: 0x02CD [0x24] CREATE_DIALOG(message_id=12631*, default_option=0*, option_flags=0*)
