...
| [119](#event-119)          | 0x0120       |      1 |              1 |
| [65535.20](#event-6553520) | 0x0121       |     14 |              4 |
| [65535.21](#event-6553521) | 0x012F       |     14 |              4 |
| [65535.22](#event-6553522) | 0x013D       |     11 |              3 |
| [65535.23](#event-6553523) | 0x0148       |     53 |              5 |
| [65535.24](#event-6553524) | 0x017D       |      5 |              3 |
| [65535.25](#event-6553525) | 0x0182       |      5 |              3 |
| [65535.26](#event-6553526) | 0x0187       |      5 |              3 |
| [65535.27](#event-6553527) | 0x018C       |      5 |              3 |
| [65535.28](#event-6553528) | 0x0191       |      5 |              3 |
| [65535.29](#event-6553529) | 0x0196       |      5 |              3 |
| [65535.30](#event-6553530) | 0x019B       |     19 |              5 |
| [65535.31](#event-6553531) | 0x01AE       |      5 |              3 |
| [65535.32](#event-6553532) | 0x01B3       |     19 |              5 |
...
- **7519**: Well, well. It seems we have some uninvited guests...
- **7524**: Wait, I know these people. They helped me with a little task at the Tenshodo.
- **7525**: I thought this might happen, but... For the two of you to make it this far, it would seem that not all thieves are totally incompetent these days.
- **7527**: Of course. This is Nanaa Mihgo of Windurst, and <Player>, an adventurer [of San d'Oria/of Bastok/also of Windurst].
- **7528**: Linzaza, you mentioned someone asked for your signature again. I'm assuming that that someone is standing before you now.
- **7533**: You forget, Kanika. Atarefaunet's band is no more. We are now known as Vauderame's Knights.
- **7534**: I waited twenty years for the former Marquis to remember everything. All that is left is to restore the glory of our lost kingdom.
- **7537**: Not one of you has changed, even after all these years. Luckily, I was prepared for this.
- **7538**: ...Take care of it.
- **7543**: Mithra might seem wild and free, but they are deeply tied to one another. If we kill this one now, others will come looking for revenge. They will chase us to the ends of Vana'diel.
- **7544**: Then there is this adventurer. [He/She] looks like someone I did away with in another time...
- **7546**: ...Perhaps you're right. A foothold into the country I have spent twenty years restoring... Maybe my ego demands a witness to all that I have accomplished.
- **7548**: I will join you as soon as I can. Let us meet again in a newborn country...
...
```
  ...
  1: 0x0124 [0x1F] MOVE_ENTITY: EventEntity moves to X=-76.026*, Z=-434.573*, Y=54.820*
...
```
  0: 0x017D [0x1D] PRINT_EVENT_MESSAGE(message_id=7519*)
...
```
  0: 0x0182 [0x1D] PRINT_EVENT_MESSAGE(message_id=7524*)
...
```
  0: 0x0187 [0x1D] PRINT_EVENT_MESSAGE(message_id=7525*)
...
```
  0: 0x018C [0x1D] PRINT_EVENT_MESSAGE(message_id=7527*)
...
```
  0: 0x0191 [0x1D] PRINT_EVENT_MESSAGE(message_id=7528*)
...
```
  0: 0x0196 [0x1D] PRINT_EVENT_MESSAGE(message_id=7533*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0190:                                   29 08 70 62 06             ).pb.
01A0: 01 01 1D 16 80 23 29 08  70 62 06 01 02 00        .....#).pb....  
```
...
```
  ...
  1: 0x01A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7534*)
...
```
  0: 0x01AE [0x1D] PRINT_EVENT_MESSAGE(message_id=7537*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
01B0:          29 08 70 62 06  01 01 1D 18 80 23 29 08     ).pb......#).
01C0: 70 62 06 01 02 00                                 pb....          
```
...
```
  ...
  1: 0x01BA [0x1D] PRINT_EVENT_MESSAGE(message_id=7538*)
    → "...Take care of it."
...
```
  0: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7543*)
...
```
  0: 0x01CB [0x1D] PRINT_EVENT_MESSAGE(message_id=7544*)
...
```
  0: 0x01D0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7546*)
...
```
  0: 0x01D5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7548*)
