...
|---------|-------------|-------------|
|       0 | 0x4B6CE     |      308942 |
|       1 | 0xFFFF7F49  |  4294934345 |
|       2 | 0x5D52      |       23890 |
|       3 | 0x02C1      |         705 |
|       4 | 0x0050      |          80 |
|       5 | 0x4D17A     |      315770 |
|       6 | 0xFFFF4F8C  |  4294922124 |
|       7 | 0x5D31      |       23857 |
...
```
  ...
  1: 0x000A [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=308.942*, z=-32.951*, y=23.890*, direction=62.0°*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0020:                32 04 80  79 00 F8 FF FF 7F 8A 62       2..y......b
...
```
  ...
  1: 0x0028 [0x79] EventEntity looks at Cid (ID: 17195658/0x0106628A) (Basic look)
  2: 0x0032 [0x1F] MOVE_ENTITY: EventEntity moves to X=315.770*, Z=-45.172*, Y=23.857*
