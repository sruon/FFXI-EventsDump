...
- **7485**: Give the physician orders. [Commence healing, stat!/Specify healing methods./Offer moral support./Rest and recover./Issue no orders.]
- **7486**: Prescribe what type of treatment? [Cures and physical healing./Status ailment recovery.]
...
```
  0: 0x0001 [0x24] CREATE_DIALOG(message_id=7485*, default_option=0*, option_flags=0*)
  ...
  6: 0x0021 [0x24] CREATE_DIALOG(message_id=7486*, default_option=0*, option_flags=0*)
