...
- **7386**: Touch the crystal? [Yes./No.]
- **7389**: Touch the crystal? [Yes./No.]
...
```
  ...
  3: 0x0287 [0x24] CREATE_DIALOG(message_id=7389*, default_option=1*, option_flags=0*)
...
SUBROUTINE_02A4:
 ...
 11: 0x02AF [0x24] CREATE_DIALOG(message_id=7386*, default_option=1*, option_flags=0*)
    → "Touch the crystal? [Yes./No.]"
