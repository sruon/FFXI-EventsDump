...
- **7438**: Well, it's about time you showed up! You're here for the V.E.R.M.I.N. extermination operation, yes?
- **7439**: I'll get straight to the point. We want you to find and defeat the fiend that has been wreaking havoc down here, then take the evidence of its extermination to Norejaie in San d'Oria.
- **7440**: In order to lure the creature into the open, we have prepared this special ointment that must be applied to your skin.
- **7441**: Lest you think me unhelpful, I will share with you what I know: sightings have been reported from the area around G-9.
- **7442**: The effect of the ointment lasts for about a day. If it wears off early, or you want the effect removed, just come back here and talk to me.
- **7443**: There may be some...unexpected side effects. But we won't let a little discomfort bother us now, will we?
- **7444**: Apply the ointment? [Slap it on./Did you say, "side effects"...?]
- **7445**: Come now, you call yourself an adventurer?
- **7446**: I have no time for your idle chatter.
- **7447**: Now, close your eyes for a moment. This won't hurt a bit...
- **7448**: You wish the effect removed? Well then, close your eyes. This will be relatively painless...
- **7449**: What's that you have there? 6 from the fiend? That should be proof enough for Norejaie. Take it back to her in San d'Oria.
- **7450**: Hmmm? Perhaps you forgot something?
- **7451**: What do you desire? [Nothing./To have the ointment removed./To reconfirm where I'm going.]
...
```
  ...
  5: 0x0018 [0x1D] PRINT_EVENT_MESSAGE(message_id=7446*)
...
```
  ...
  4: 0x0045 [0x1D] PRINT_EVENT_MESSAGE(message_id=7438*)
  ...
  6: 0x0049 [0x1D] PRINT_EVENT_MESSAGE(message_id=7439*)
  ...
  8: 0x004D [0x1D] PRINT_EVENT_MESSAGE(message_id=7440*)
 ...
 10: 0x0051 [0x1D] PRINT_EVENT_MESSAGE(message_id=7441*)
 ...
 12: 0x0055 [0x1D] PRINT_EVENT_MESSAGE(message_id=7442*)
 ...
 14: 0x0059 [0x1D] PRINT_EVENT_MESSAGE(message_id=7443*)
 ...
 16: 0x005D [0x24] CREATE_DIALOG(message_id=7444*, default_option=1*, option_flags=0*)
 ...
 22: 0x0072 [0x1D] PRINT_EVENT_MESSAGE(message_id=7447*)
 ...
 37: 0x00DC [0x1D] PRINT_EVENT_MESSAGE(message_id=7445*)
...
```
  ...
  7: 0x0117 [0x1D] PRINT_EVENT_MESSAGE(message_id=7447*)
    → "Now, close your eyes for a moment. This won't hurt a bit..."
 ...
 16: 0x016C [0x1D] PRINT_EVENT_MESSAGE(message_id=7441*)
    → "Lest you think me unhelpful, I will share with you what I know: sightings have been reported from the area around G-9."
 17: 0x016F [0x23] WAIT_FOR_DIALOG_INTERACTION
 18: 0x0170 [0x1D] PRINT_EVENT_MESSAGE(message_id=7442*)
    → "The effect of the ointment lasts for about a day. If it wears off early, or you want the effect removed, just come back here and talk to me."
...
```
  ...
  7: 0x01A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7450*)
    → "Hmmm? Perhaps you forgot something?"
  8: 0x01A5 [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x01A6 [0x24] CREATE_DIALOG(message_id=7451*, default_option=0*, option_flags=0*)
 ...
 16: 0x01D5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7448*)
 ...
 27: 0x022B [0x1D] PRINT_EVENT_MESSAGE(message_id=7441*)
    → "Lest you think me unhelpful, I will share with you what I know: sightings have been reported from the area around G-9."
...
```
  ...
  6: 0x0266 [0x1D] PRINT_EVENT_MESSAGE(message_id=7449*)
