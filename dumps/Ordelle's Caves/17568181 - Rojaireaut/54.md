...
```
  ...
  4: 0x0252 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  5: 0x0261 [0x03] Work_Zone[2] = 472*
  6: 0x0266 [0x1D] PRINT_EVENT_MESSAGE(message_id=7447*)
    → "What's that you have there? \u007F\u0000\u0001\u0001\u00056\u0002\u0000\u0000\u0000 from the fiend?\u0007That should be proof enough for Norejaie. Take it back to her in San d'Oria.\u007F1\u0000\u0007"
  7: 0x0269 [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x026A [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
