...
```
  ...
  5: 0x00F3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi2", work_offset2=0*)
  6: 0x0104 [0x45] LOAD_SCHEDULED_TASK(work_offset1=204*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s012", work_offset2=0*)
 ...
 20: 0x015D [0x45] LOAD_SCHEDULED_TASK(work_offset1=204*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s013", work_offset2=0*)
 ...
 26: 0x0184 [0x5B] LOAD_EXT_SCHEDULER(work_offset=376*, entity1=Zeid (ID: 17568180/0x010C11B4), entity2=Zeid (ID: 17568180/0x010C11B4), action="tlk0")
 ...
 34: 0x01B4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo0", work_offset2=0*)
 35: 0x01C5 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo0")
 36: 0x01D4 [0x52] END_LOAD_SCHEDULER: End scheduler "s013" with entities [EventEntity, EventEntity], work=204*
 37: 0x01E3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=204*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s014", work_offset2=0*)
 38: 0x01F4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 ...
 41: 0x020D [0x5B] LOAD_EXT_SCHEDULER(work_offset=376*, entity1=Zeid (ID: 17568180/0x010C11B4), entity2=Zeid (ID: 17568180/0x010C11B4), action="tlk0")
 ...
 50: 0x024C [0x45] LOAD_SCHEDULED_TASK(work_offset1=204*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s015", work_offset2=0*)
 ...
 55: 0x0273 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo2", work_offset2=0*)
 56: 0x0284 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo2")
 ...
 59: 0x02A4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi2", work_offset2=0*)
