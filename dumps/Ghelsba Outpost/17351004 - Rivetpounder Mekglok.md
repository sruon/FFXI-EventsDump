...
```
  ...
  1: 0x0048 [0x1F] MOVE_ENTITY: EventEntity moves to X=397.471*, Z=2.791*, Y=9.999*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0050:          32 07 80 1F 00  08 80 09 80 06 80 1F 01     2............
0060: 00                                                .               
```
...
```
  ...
  1: 0x0056 [0x1F] MOVE_ENTITY: EventEntity moves to X=399.181*, Z=0.101*, Y=9.999*
