...
```
  ...
  3: 0x002F [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "main" with entities [kagami_test (ID: 17350989/0x0108C14D), kagami_test (ID: 17350989/0x0108C14D)], work=[3*, 0*]
