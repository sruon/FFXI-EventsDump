...
```
  ...
  2: 0x0339 [0x39] SET_ENTITY_DIRECTION(direction=0.0°)
  ...
  5: 0x033E [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="@tl0")
  6: 0x034B [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="@tr0")
  7: 0x0358 [0x5B] LOAD_EXT_SCHEDULER(work_offset=303*, entity1=EventEntity, entity2=EventEntity, action="cha0")
