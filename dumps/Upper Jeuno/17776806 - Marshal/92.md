...
SUBROUTINE_02B6:
 64: 0x02B6 [0x01] GOTO 0x0417
 65: 0x02B9 [0x02] IF !(Work_Zone[0] == 6*) GOTO 0x0300
 66: 0x02C1 [0x03] Work_Zone[2] = 1000*
 67: 0x02C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=11088*)
    → "A fee of 
\u0000 gil is required to change your registered linkshell. In addition, all of your previous LS Liga records will be erased.\u007F1\u0000\u0007"
 68: 0x02C9 [0x23] WAIT_FOR_DIALOG_INTERACTION
 69: 0x02CA [0x24] CREATE_DIALOG(message_id=11089*, default_option=1*, option_flags=0*)
    → "What will you do?\u0007\u000BChange linkshells.\u0007I changed my mind.\u007F1\u0000\u0007"
 70: 0x02D1 [0x25] WAIT_DIALOG_SELECT()
 71: 0x02D2 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x02FA
 72: 0x02DA [0x42] SET_CLI_EVENT_CANCEL_DATA()
 73: 0x02DB [0x03] Work_Zone[1] = 6*
 74: 0x02E0 [0x43] SEND_EVENT_UPDATE: Send pending tag to server (packet 0x005B)
 75: 0x02E2 [0x43] SEND_EVENT_UPDATE: Check pending flag (skip if not pending)
 76: 0x02E4 [0x02] IF !(Work_Zone[2] == 1*) GOTO 0x02F3
 77: 0x02EC [0x1D] PRINT_EVENT_MESSAGE(message_id=11090*)
    → "Your linkshell (\u00072\u001C\u0000\u00073) registration settings have been changed.\u007F1\u0000\u0007"
 78: 0x02EF [0x23] WAIT_FOR_DIALOG_INTERACTION
 79: 0x02F0 [0x01] GOTO 0x02F7
 80: 0x02F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=11091*)
    → "I am sorry, but I was unable to process the changes.\u007F1\u0000\u0007"
 81: 0x02F6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 82: 0x02F7 [0x01] GOTO 0x02FD
 83: 0x02FA [0x01] GOTO 0x014B

SUBROUTINE_02FD:
 84: 0x02FD [0x01] GOTO 0x0417
 85: 0x0300 [0x02] IF !(Work_Zone[0] == 7*) GOTO 0x0343
 86: 0x0308 [0x1D] PRINT_EVENT_MESSAGE(message_id=11092*)
 ...
 87: 0x030B [0x23] WAIT_FOR_DIALOG_INTERACTION
 88: 0x030C [0x1D] PRINT_EVENT_MESSAGE(message_id=11093*)
    → "To participate in LS Liga, select \u00072linkshell\u00073 under the \u00072entry type\u00073 category.\u007F1\u0000\u0007"
 89: 0x030F [0x23] WAIT_FOR_DIALOG_INTERACTION
 90: 0x0310 [0x1D] PRINT_EVENT_MESSAGE(message_id=11094*)
    → "The Herald will lead you through the necessary procedures.\u007F1\u0000\u0007"
 91: 0x0313 [0x23] WAIT_FOR_DIALOG_INTERACTION
 92: 0x0314 [0x03] Work_Zone[2] = 15*
 93: 0x0319 [0x1D] PRINT_EVENT_MESSAGE(message_id=11095*)
    → "A record is kept of the outcome of the linkshell leader's most recent 
\u0000 matches.\u007F1\u0000\u0007"
 94: 0x031C [0x23] WAIT_FOR_DIALOG_INTERACTION
 95: 0x031D [0x03] Work_Zone[2] = 4*
 96: 0x0322 [0x03] Work_Zone[3] = 3*
 97: 0x0327 [0x03] Work_Zone[4] = 1*
 98: 0x032C [0x1D] PRINT_EVENT_MESSAGE(message_id=11096*)
...
\u0002 \u007F\u0012\u0002[point/points]. Each member's personal Brenner record will also be calculated in the result.\u007F1\u0000\u0007"
 99: 0x032F [0x23] WAIT_FOR_DIALOG_INTERACTION
100: 0x0330 [0x03] Work_Zone[2] = 6*
101: 0x0335 [0x1D] PRINT_EVENT_MESSAGE(message_id=11097*)
...
102: 0x0338 [0x23] WAIT_FOR_DIALOG_INTERACTION
103: 0x0339 [0x1D] PRINT_EVENT_MESSAGE(message_id=11098*)
...
104: 0x033C [0x23] WAIT_FOR_DIALOG_INTERACTION
105: 0x033D [0x01] GOTO 0x014B

SUBROUTINE_039A:
106: 0x039A [0x01] GOTO 0x03B9
107: 0x039D [0x24] CREATE_DIALOG(message_id=8592*, default_option=1*, option_flags=0*)
    → "Return the \u0001\u00053\u0002\u0000\u0000\u0000?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
108: 0x03A4 [0x25] WAIT_DIALOG_SELECT()
109: 0x03A5 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x03B6
110: 0x03AD [0x42] SET_CLI_EVENT_CANCEL_DATA()
111: 0x03AE [0x03] Work_Zone[1] = 9*
112: 0x03B3 [0x01] GOTO 0x03B9
113: 0x03B6 [0x01] GOTO 0x014B

SUBROUTINE_03B9:
114: 0x03B9 [0x01] GOTO 0x0417
115: 0x03BC [0x02] IF !(Work_Zone[0] == 10*) GOTO 0x0417
116: 0x03C4 [0x03] Work_Zone[2] = 759*
117: 0x03C9 [0x1D] PRINT_EVENT_MESSAGE(message_id=8593*)
...
118: 0x03CC [0x23] WAIT_FOR_DIALOG_INTERACTION
119: 0x03CD [0x1D] PRINT_EVENT_MESSAGE(message_id=8594*)
    → "You can speak to me to borrow or return the band at any time.\u007F1\u0000\u0007"
120: 0x03D0 [0x23] WAIT_FOR_DIALOG_INTERACTION
121: 0x03D1 [0x02] IF !(ExtData[1]->WorkLocal[30] == 0*) GOTO 0x03F8
122: 0x03D9 [0x24] CREATE_DIALOG(message_id=8591*, default_option=1*, option_flags=0*)
    → "Borrow the \u0001\u00053\u0002\u0000\u0000\u0000?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
123: 0x03E0 [0x25] WAIT_DIALOG_SELECT()
124: 0x03E1 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x03F2
125: 0x03E9 [0x42] SET_CLI_EVENT_CANCEL_DATA()
126: 0x03EA [0x03] Work_Zone[1] = 10*
127: 0x03EF [0x01] GOTO 0x03F5
128: 0x03F2 [0x01] GOTO 0x014B

SUBROUTINE_03F5:
129: 0x03F5 [0x01] GOTO 0x0414
130: 0x03F8 [0x24] CREATE_DIALOG(message_id=8592*, default_option=1*, option_flags=0*)
    → "Return the \u0001\u00053\u0002\u0000\u0000\u0000?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
131: 0x03FF [0x25] WAIT_DIALOG_SELECT()
132: 0x0400 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0411
133: 0x0408 [0x42] SET_CLI_EVENT_CANCEL_DATA()
134: 0x0409 [0x03] Work_Zone[1] = 10*
135: 0x040E [0x01] GOTO 0x0414
136: 0x0411 [0x01] GOTO 0x014B

SUBROUTINE_0414:
137: 0x0414 [0x01] GOTO 0x0417

SUBROUTINE_0417:
138: 0x0417 [0x21] END_EVENT
139: 0x0418 [0x00] END_REQSTACK()
```
