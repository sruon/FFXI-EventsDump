...
- **11106**: Hello there, [mister/miss]! Would you happen to be an "adventurer"?
- **11107**: 'Fess up. [Yes...why?/Definitely not!]
- **11108**: Splendid! You must wear this, [mister/miss]!
- **11109**: No? Well, I think this would look splendid on you anyway!
- **11110**: Ajithaam tacks a $3 on you!
- **11111**: This badge is made to resemble the head of a wildcat, the mark of the prestigious mercenary company "Salaheem's Sentinels." Beautiful, isn't it?
- **11112**: Our company is also authorized by the empress of Aht Urhgan. Does not that alone make your heart race?
- **11113**: It doesn't? Well, if you change your mind, we are currently recruiting. Be sure to let everyone know!
- **11114**: The number of people interested in our company seems to be gradually increasing. Or could it simply be my imagination?
- **11115**: I have something to tell you that may be of use. The $3 was created using advanced alchemy techniques. It contains a device that makes the eyes of the wildcat glimmer when somebody catches a glimpse of it.
- **11116**: Thanks to you, I have had to deal with huge lines of Jeunoans looking for information on Salaheem's Sentinels!
- **11117**: Okay, that was an untruth...but honestly, people are talking about our company. I suppose that means I will be able to keep my job. Thank you for your fantastic work!
- **11118**: The wildcat on your $3 seems drained of its energy. It must be restored now, so if you please...
- **11119**: <Player> hands over the $3.
- **11120**: You can have this instead. When you join our company, you will learn of its use. That will be something to look forward to...
- **11122**: When you go to the town of "Al Zahbi," give my regards to everyone at Salaheem's Sentinels! And remind them to be polite, because Ajithaam here is going to be in a top position someday!
- **12360**: Ah, I've seen you before. You're a mercenary from Salaheem's Sentinels, are you not? It is so refreshing to see one of our own out in these parts, spreading the company's good name.
- **12361**: By the way, might you have already heard the news? You haven't? In that case, it'd be my pleasure to inform you!
- **12362**: With our beloved President Naja's blessing, we've commenced the operation of a teleportation service right here in Jeuno! Within the space of a heartbeat, you'll be whisked all the way to Aht Urhgan Whitegate, the gateway to the exotic Near East! Doesn't the thought alone invigorate your entire being?
- **12363**: Oh, it doesn't? Well, if ever you change your mind, just come here and trade me $0 gil. What's it for, you ask? Ha! You are quite the jokester, my friend!
- **12364**: <Gasp>... I see... You needn't say another word. Just close your eyes, take a deep breath, and try to relax.
- **12365**: A pleasant journey to you!
...
```
  ...
  4: 0x000F [0x1D] PRINT_EVENT_MESSAGE(message_id=11106*)
    → "Hello there, [mister/miss]! Would you happen to be an "adventurer"?"
  5: 0x0012 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0013 [0x24] CREATE_DIALOG(message_id=11107*, default_option=0*, option_flags=0*)
 ...
 10: 0x0032 [0x1D] PRINT_EVENT_MESSAGE(message_id=11108*)
 ...
 15: 0x0050 [0x1D] PRINT_EVENT_MESSAGE(message_id=11109*)
...
SUBROUTINE_0057:
 ...
 22: 0x0071 [0x1D] PRINT_EVENT_MESSAGE(message_id=11111*)
 ...
 24: 0x0075 [0x1D] PRINT_EVENT_MESSAGE(message_id=11112*)
 ...
 28: 0x008B [0x1D] PRINT_EVENT_MESSAGE(message_id=11113*)
...
```
  ...
  4: 0x00AD [0x1D] PRINT_EVENT_MESSAGE(message_id=11115*)
...
```
  ...
  3: 0x00DC [0x1D] PRINT_EVENT_MESSAGE(message_id=11114*)
...
```
  ...
  4: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=11116*)
  ...
  6: 0x0110 [0x1D] PRINT_EVENT_MESSAGE(message_id=11117*)
 ...
 10: 0x0128 [0x1D] PRINT_EVENT_MESSAGE(message_id=11118*)
 ...
 16: 0x0146 [0x1D] PRINT_EVENT_MESSAGE(message_id=11120*)
...
```
  ...
  3: 0x0177 [0x1D] PRINT_EVENT_MESSAGE(message_id=11122*)
...
```
  ...
  4: 0x01A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=12360*)
  ...
  8: 0x01BB [0x1D] PRINT_EVENT_MESSAGE(message_id=12361*)
 ...
 10: 0x01BF [0x1D] PRINT_EVENT_MESSAGE(message_id=12362*)
 ...
 17: 0x01F0 [0x1D] PRINT_EVENT_MESSAGE(message_id=12363*)
...
```
  ...
  5: 0x0215 [0x1D] PRINT_EVENT_MESSAGE(message_id=12364*)
  ...
  9: 0x0235 [0x1D] PRINT_EVENT_MESSAGE(message_id=12365*)
