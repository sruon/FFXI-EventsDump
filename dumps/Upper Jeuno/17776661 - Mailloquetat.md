...
- **7087**: In this temple we pray to Altana. You should pray for forgiveness, too.
- **7094**: You, too, should pray as that faithful one does.
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=7087*)
...
```
  ...
  1: 0x0044 [0x1D] PRINT_EVENT_MESSAGE(message_id=7094*)
