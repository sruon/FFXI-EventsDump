...
|---------|-------------|-------------|
|       0 | 0x0028      |          40 |
|       1 | 0xFFFA9596  |  4294612374 |
|       2 | 0xFFFD59D4  |  4294793684 |
...
0010: 80 03 80 1F 01 1E C5 40  0F 01 1C 04 80 00        .......@......  
```
...
```
  ...
  1: 0x000B [0x1F] MOVE_ENTITY: EventEntity moves to X=-354.922*, Z=-173.612*, Y=-10.002*
  2: 0x0013 [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x0015 [0x1E] EventEntity looks at Valeriano (ID: 17776837/0x010F40C5) and starts talking
