...
| [65535.6](#event-655356)   | 0x003D       |      8 |              3 |
| [65535.7](#event-655357)   | 0x0045       |     18 |              3 |
| [65535.8](#event-655358)   | 0x0057       |     16 |              2 |
| [65535.9](#event-655359)   | 0x0067       |     16 |              2 |
| [65535.10](#event-6553510) | 0x0077       |     16 |              2 |
| [65535.11](#event-6553511) | 0x0087       |     16 |              2 |
| [10184](#event-10184)      | 0x0097       |      1 |              1 |
...
```
  0: 0x003D [0xB6] ENTITY_APPEARANCE_HANDLER(case=Hair style, value=2364*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0060:                      5B  06 80 F8 FF FF 7F F8 FF         [........
0070: FF 7F 62 6B 61 31 00                              ..bka1.         
```

#### Opcodes

```
  0: 0x0067 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "bka1" with entities [EventEntity, EventEntity], work=2640*
...
```
  0: 0x0087 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "bkr1" with entities [EventEntity, EventEntity], work=2640*
