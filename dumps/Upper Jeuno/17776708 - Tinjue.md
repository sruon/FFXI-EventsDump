...
- **8545**: Which memory will you have recalled? [Nothing./Missions./Jeuno Quests 1./Jeuno Quests 2./Jeuno Quests 3./Jeuno Quests 4./Promathia Missions.]
- **8546**: Which memory will you have recalled? [Nothing./Magicite/Fickblix's flowerbed.]
- **8547**: Which memory will you have recalled? [Nothing./Crest of Davoi./Save My Sister(pt.1)./Save My Sister(pt.2)./Save My Sister(pt.3)./A Clock Most Delicate(pt.1)./A Clock Most Delicate(pt.2)./A Clock Most Delicate(pt.3)./The Clockmaster./Chocobo's Wounds(pt.1)./Chocobo's Wounds(pt.2)./Save My Son./Path of the Beastmaster./A Candlelight Vigil(pt.1)./A Candlelight Vigil(pt.2)./Searching for the Right Words(pt.1)./Searching for the Right Words(pt.2)./The Kind Cardian./Axe the Competition(pt.1)./Axe the Competition(pt.2)./Axe the Competition(pt.3)./A Chocobo's Tale(pt.1)./A Chocobo's Tale(pt.2)./A Reputation in Ruins.]
- **8548**: Which memory will you have recalled? [Nothing./Borghertz's Warring Hands./Borghertz's Striking Hands./Borghertz's Healing Hands./Borghertz's Sorcerous Hands./Borghertz's Vermillion Hands./Borghertz's Sneaky Hands./Borghertz's Stalwart Hands./Borghertz's Shadowy Hands./Borghertz's Wild Hands./Borghertz's Harmonious Hands./Borghertz's Chasing Hands./Borghertz's Loyal Hands./Borghertz's Lurking Hands./Borghertz's Dragon Hands./Borghertz's Calling Hands./Unlisted Qualities(pt.1)./Unlisted Qualities(pt.2)./Unlisted Qualities(pt.3)./Girl in the Looking Glass(pt.1)./Girl in the Looking Glass(pt.2)./Girl in the Looking Glass(pt.3)./Mirror, Mirror(pt.1)./Mirror, Mirror(pt.2).]
- **8549**: Which memory will you have recalled? [Nothing./Chameleon Capers(pt.1)./Chameleon Capers(pt.2)./Past Reflections(pt.1)./Past Reflections(pt.2)./Regaining Trust(pt.1)./Regaining Trust(pt.2)./Regaining Trust(pt.3)./Regaining Trust(pt.4)./Regaining Trust(pt.5)./Regaining Trust(pt.6)./Regaining Trust(pt.7)./Regaining Trust(pt.8)./Regaining Trust(pt.9)./Blighted Gloom(pt.1)./Blighted Gloom(pt.2)./Blessed Radiance(pt.1)./Blessed Radiance(pt.2)./Mirror Images(pt.1)./Mirror Images(pt.2)./Mixed Signals(pt.1)./Mixed Signals(pt.2)./Mixed Signals(pt.3)./Mixed Signals(pt.4)./C.E.A. - Brenner(pt.1)./C.E.A. - Brenner(pt.2)./Chocobo on the Loose!(pt.1)./Chocobo on the Loose!(pt.2)./Chocobo on the Loose!(pt.3)./Chocobo on the Loose!(pt.4).]
- **8550**: Which memory will you have recalled? [Nothing./Lakeside Minuet(pt.1)./Lakeside Minuet(pt.2)./Lakeside Minuet(pt.3)./Lakeside Minuet(pt.4)./The Unfinished Waltz(pt.1)./The Unfinished Waltz(pt.2)./The Unfinished Waltz(pt.3)./The Road to Divadom(pt.1)./The Road to Divadom(pt.2)./The Road to Divadom(pt.3)./The Road to Divadom(pt.4)./Comeback Queen(pt.1)./Comeback Queen(pt.2)./Comeback Queen(pt.3)./Comeback Queen(pt.4)./Comeback Queen(pt.5)./Comeback Queen(pt.6)./Comeback Queen(pt.7)./Comeback Queen(pt.8)./A Furious Finale(pt.1)./A Furious Finale(pt.2)./Dancer Attire.]
- **8551**: Which memory will you have recalled? [Nothing./The Rites of Life(pt.1)./The Rites of Life(pt.2)./The Rites of Life(pt.3)./The Rites of Life(pt.4)./Darkness Named(pt.1)./Darkness Named(pt.2)./Branded./For Whom the Verse Is Sung./Flames in the Darkness./The Chains Fall Free(pt.1)./The Chains Fall Free(pt.2)./The Chains Fall Free(pt.3)./The Chains Fall Free(pt.4).]
...
```
 ...
 39: 0x00D4 [0x24] CREATE_DIALOG(message_id=8545*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00E4:
 42: 0x00E4 [0x24] CREATE_DIALOG(message_id=8546*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_0113:
 50: 0x0113 [0x24] CREATE_DIALOG(message_id=8547*, default_option=0*, option_flags=Work_Zone[3])
...
SUBROUTINE_0142:
 58: 0x0142 [0x24] CREATE_DIALOG(message_id=8548*, default_option=0*, option_flags=Work_Zone[4])
...
SUBROUTINE_0171:
 66: 0x0171 [0x24] CREATE_DIALOG(message_id=8549*, default_option=0*, option_flags=Work_Zone[5])
...
SUBROUTINE_01A0:
 74: 0x01A0 [0x24] CREATE_DIALOG(message_id=8550*, default_option=0*, option_flags=Work_Zone[6])
...
SUBROUTINE_01CF:
 82: 0x01CF [0x24] CREATE_DIALOG(message_id=8551*, default_option=0*, option_flags=Work_Zone[7])
