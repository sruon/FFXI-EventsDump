...
- **7627**: The master of this chocobo stable is famous! It is an honor to ride a bird here.
- **7628**: I want to have one of the chocobos for my own, but the master's stubborn! I wonder if he'll ever say yes.
...
```
  ...
  4: 0x001A [0x1D] PRINT_EVENT_MESSAGE(message_id=7627*)
 ...
 12: 0x003C [0x1D] PRINT_EVENT_MESSAGE(message_id=7628*)
