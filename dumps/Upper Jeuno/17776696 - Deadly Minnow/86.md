...
```
  ...
  3: 0x0027 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=60*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  4: 0x0036 [0x1D] PRINT_EVENT_MESSAGE(message_id=7699*)
    → "Much is told of Borghertz, but it's all just a legend. Don't let greed cloud your judgment.\u007F1\u0000\u0007"
