...
- **8593**: When in possession of the key item $3, temporary items will be automatically added to the player's inventory when quarried.
- **8594**: When a player's inventory exceeds the maximum capacity, any temporary item found will simply be discarded. You can speak to me to borrow or return the shovel at any time.
- **8595**: Borrow the $3? [Yes./No.]
- **8596**: Return the $3? [Yes./No.]
- **8597**: When in possession of the key item $3, you will have the choice of keeping or throwing away the first Petra you quarry. You will also retain the ability to sprint.
- **8598**: You can speak to me to borrow or return the band at any time.
- **11072**: A procedural error has occurred.
- **11073**: I have been dispatched to assist Afdeen in affairs dealing with LS Liga matches.
- **11074**: You are the leader of a linkshell that is currently registered for LS Liga, but certain procedures cannot be performed while you have another linkshell equipped.
- **11075**: Select one... [Nothing./Personal Brenner record./Linkshell record./LS Liga Ranking Information./LS Liga Ranking Registration./Participating in LS Liga./Changing linkshells./FAQ: What is LS Liga?/FAQ: What is LS Liga Ranking?/To borrow/return $6./To borrow/return $6.]
- **11076**: You have earned $0 [victory/victories] and experienced $1 [draw/draws], during a total of $2 [match/matches].
- **11077**: Your linkshell, "%0," has earned $0 [Liga point/Liga points] over the past $3 [match/matches] ($1 [victory/victories], $2 [draw/draws], and $4 [defeat/defeats])
- **11078**: The ranking board displays the following from left to right: Rank and linkshell group. Liga points (victories - draws - defeats) Date of recorded match.
- **11079**: Ranking registration has been successfully completed. Your linkshell, "%0," ranks $1 out of $0 participating groups.
- **11080**: Congratulations on taking the top spot! But the other linkshells are not going to give you a moment's rest. Accept their challenges and prove your team to be the best in Vana'diel!
- **11081**: Ranking results will take a moment to display. Please wait.
- **11082**: I apologize, but I was unable to update the results.
- **11083**: I cannot register your record because it is not recent enough.
- **11084**: I am sorry, but you did not rank high enough to display on the results list. Please try again!
- **11087**: You may participate in LS Liga as the leader of one linkshell at a time, and must pay a registration fee of $0 gil.
- **11088**: You can change the linkshell that you have registered for a fee of $1 gil, but no other costs will be incurred.
- **11089**: What will you do? [Register for LS Liga./I changed my mind.]
- **11090**: Your linkshell, "%0," is now registered for LS Liga!
- **11091**: I am sorry, but I was unable to process your registration for LS Liga.
- **11092**: A fee of $0 gil is required to change your registered linkshell. In addition, all of your previous LS Liga records will be erased.
- **11093**: What will you do? [Change linkshells./I changed my mind.]
- **11094**: Your linkshell ("%0") registration settings have been changed.
- **11095**: I am sorry, but I was unable to process the changes.
- **11096**: "LS Liga" is a type of Brenner match in which linkshell groups compete against each other. Each leader can have only one linkshell registered at a time.
- **11097**: To participate in LS Liga, select "linkshell" under the "entry type" category.
- **11098**: The Herald will lead you through the necessary procedures.
- **11099**: A record is kept of the outcome of the linkshell leader's most recent $0 matches.
- **11100**: Victories earned by lighting all Flammen-Brenner will award the linkshell with $0 [point/points]. All other wins are worth $1 [point/points], and draws are worth $2 [point/points]. Each member's personal Brenner record will also be calculated in the result.
- **11101**: However, repeated matches with the same linkshell members during a single reservation period will be counted as training matches, and will not be recorded. Matches won against a team whose number of victories differs from yours by a substantial amount ($0 wins) will also be treated likewise.
- **11102**: The linkshell leader's participation in the match is required, but other members may join or leave as they wish. The leader may also participate in other LS Liga matches as the member of a different linkshell.
- **11103**: You begin participating in the LS Liga ranking system the moment the leader registers your linkshell. LS Liga ranking lists registered linkshells in order of match score.
- **11104**: Still, the ranking system is not a tournament. There are no rewards.
- **11105**: Instead, we would like you to think of it as a way of advertising your linkshell. That would make the great Abdhaljs most pleased.
- **11106**: Please be aware that ranking information resets after a certain period of time.
...
```
 ...
 25: 0x00AC [0x1D] PRINT_EVENT_MESSAGE(message_id=11073*)
 ...
 30: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=11074*)
...
SUBROUTINE_014B:
 ...
 54: 0x0156 [0x24] CREATE_DIALOG(message_id=11075*, default_option=ExtData[1]->WorkLocal[8], option_flags=ExtData[1]->WorkLocal[7])
 ...
 61: 0x017A [0x1D] PRINT_EVENT_MESSAGE(message_id=11076*)
...
SUBROUTINE_02B6:
 ...
 69: 0x02C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=11092*)
 ...
 71: 0x02CA [0x24] CREATE_DIALOG(message_id=11093*, default_option=1*, option_flags=0*)
 ...
 79: 0x02EC [0x1D] PRINT_EVENT_MESSAGE(message_id=11094*)
 ...
 82: 0x02F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=11095*)
...
SUBROUTINE_02FD:
 ...
 88: 0x0308 [0x1D] PRINT_EVENT_MESSAGE(message_id=11096*)
 ...
 95: 0x0319 [0x1D] PRINT_EVENT_MESSAGE(message_id=11099*)
...
100: 0x032C [0x1D] PRINT_EVENT_MESSAGE(message_id=11100*)
...
103: 0x0335 [0x1D] PRINT_EVENT_MESSAGE(message_id=11101*)
...
105: 0x0339 [0x1D] PRINT_EVENT_MESSAGE(message_id=11102*)
...
109: 0x039D [0x24] CREATE_DIALOG(message_id=8596*, default_option=1*, option_flags=0*)
    → "Return the $3? [Yes./No.]"
...
119: 0x03C9 [0x1D] PRINT_EVENT_MESSAGE(message_id=8597*)
...
121: 0x03CD [0x1D] PRINT_EVENT_MESSAGE(message_id=8598*)
...
124: 0x03D9 [0x24] CREATE_DIALOG(message_id=8595*, default_option=1*, option_flags=0*)
    → "Borrow the $3? [Yes./No.]"
...
132: 0x03F8 [0x24] CREATE_DIALOG(message_id=8596*, default_option=1*, option_flags=0*)
    → "Return the $3? [Yes./No.]"
...
# Dead code (unreachable instructions):
    ...
    → "A procedural error has occurred."
     ...
     0x021B [0x1D] PRINT_EVENT_MESSAGE(message_id=11082*)
    → "I apologize, but I was unable to update the results."
     ...
     0x022A [0x1D] PRINT_EVENT_MESSAGE(message_id=11083*)
    → "I cannot register your record because it is not recent enough."
     ...
     0x023E [0x1D] PRINT_EVENT_MESSAGE(message_id=11084*)
    → "I am sorry, but you did not rank high enough to display on the results list. Please try again!"
     ...
     0x024F [0x1D] PRINT_EVENT_MESSAGE(message_id=11079*)
    → "Ranking registration has been successfully completed. Your linkshell, "%0," ranks $1 out of $0 participating groups."
     ...
     0x0253 [0x1D] PRINT_EVENT_MESSAGE(message_id=11081*)
    → "Ranking results will take a moment to display. Please wait."
     ...
     0x025F [0x1D] PRINT_EVENT_MESSAGE(message_id=11080*)
