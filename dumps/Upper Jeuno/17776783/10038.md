...
```
  ...
  2: 0x000F [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo2", work_offset2=0*)
  3: 0x0020 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo2")
 ...
 21: 0x0080 [0x45] LOAD_SCHEDULED_TASK(work_offset1=191*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s052", work_offset2=0*)
 22: 0x0091 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 ...
 38: 0x00F2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=191*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s053", work_offset2=0*)
 ...
 47: 0x0127 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 48: 0x0138 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 55: 0x016B [0x4B] UPDATE_ENTITY_YAW(entity=Bheem (ID: 17776686/0x010F402E), yaw=2.25°*)
 ...
 58: 0x0178 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=Bheem (ID: 17776686/0x010F402E), entity2=Bheem (ID: 17776686/0x010F402E), action="tlk0")
 59: 0x0187 [0x45] LOAD_SCHEDULED_TASK(work_offset1=34*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s055", work_offset2=0*)
 60: 0x0198 [0x1C] WAIT(60* ticks)
 61: 0x019B [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi2", work_offset2=0*)
 62: 0x01AC [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi2")
 ...
 67: 0x01C9 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=Bheem (ID: 17776686/0x010F402E), entity2=Bheem (ID: 17776686/0x010F402E), action="ten0")
 68: 0x01D8 [0x1C] WAIT(60* ticks)
 69: 0x01DB [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 70: 0x01EC [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 77: 0x021C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi0", work_offset2=0*)
