...
- **6887**: You may use one of the instruments in your Mog House to play a different tune.
- **6888**: Play music from which instrument?
- **6889**: Select an instrument. [None for now./#./$1./$2./$3.]
...
SUBROUTINE_0066:
 ...
 38: 0x008C [0x24] CREATE_DIALOG(message_id=6889*, default_option=ExtData[1]->WorkLocal[9], option_flags=ExtData[1]->WorkLocal[6])
...
SUBROUTINE_0119:
 ...
 70: 0x0127 [0x24] CREATE_DIALOG(message_id=6890*, default_option=ExtData[1]->WorkLocal[1], option_flags=ExtData[1]->WorkLocal[6])
...
114: 0x0206 [0x24] CREATE_DIALOG(message_id=6894*, default_option=1*, option_flags=0*)
...
132: 0x0257 [0x24] CREATE_DIALOG(message_id=6891*, default_option=ExtData[1]->WorkLocal[1], option_flags=ExtData[1]->WorkLocal[6])
...
151: 0x02C2 [0x24] CREATE_DIALOG(message_id=6894*, default_option=1*, option_flags=0*)
    → "Select this song? [Yes, this sounds splendid!/No, I've changed my tune.]"
...
169: 0x0313 [0x24] CREATE_DIALOG(message_id=6892*, default_option=ExtData[1]->WorkLocal[1], option_flags=ExtData[1]->WorkLocal[6])
...
188: 0x037E [0x24] CREATE_DIALOG(message_id=6894*, default_option=1*, option_flags=0*)
    → "Select this song? [Yes, this sounds splendid!/No, I've changed my tune.]"
...
206: 0x03CF [0x24] CREATE_DIALOG(message_id=6893*, default_option=ExtData[1]->WorkLocal[1], option_flags=ExtData[1]->WorkLocal[6])
...
225: 0x043A [0x24] CREATE_DIALOG(message_id=6894*, default_option=1*, option_flags=0*)
    → "Select this song? [Yes, this sounds splendid!/No, I've changed my tune.]"
