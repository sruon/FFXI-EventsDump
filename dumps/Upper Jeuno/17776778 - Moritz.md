...
| [10027](#event-10027) | 0x0001       |      6 |              4 |
| [10028](#event-10028) | 0x0007       |    190 |             57 |
| [10029](#event-10029) | 0x00C5       |    119 |             32 |
...
- **8754**: At the request of a certain society, I am investigating the effects of the dreaded "Emptiness" on living beings.
- **8755**: You appear to be a well-traveled adventurer. Perhaps you have seen one of the Emptiness-ravaged creatures of which I speak?
- **8756**: We have labeled these monstrosities "Empty Notorious Monsters," or ENMs...
- **8757**: Have you seen one? [Indeed I have./I'm not quite sure...]
- **8758**: Aha, so you have firsthand experience. You probably don't need a scholar's explanation, but please indulge me...
- **8759**: The material presence of ENMs has become temporary and insubstantial, meaning that those who have witnessed a particular ENM's existence are unable to encounter it again until a period of time has passed.
- **8760**: My research has allowed me to measure the length of time between ENM manifestations. Tell me, which ENM would you like to know about?
- **8761**: I wish to know about the ENM in... [Nowhere in particular./The Spire of Holla./The Spire of Dem./The Spire of Mea./The Spire of Vahzl./Monarch Linn./The Shrouded Maw./Mine Shaft #2716./Bearclaw Pinnacle./Boneyard Gully.]
- **8762**: You won't be able to encounter that particular ENM until ( Earth time).
- **8763**: The ENM in that area should be sufficiently manifest for your next encounter.
- **8764**: You have no need of my expertise at the moment? Very well.
- **8765**: And now we come to the crux of the matter...
- **8766**: If there is an ENM that you are currently able to locate, I strongly urge you to take action.
- **8767**: These...creatures...are no longer natural beings of Vana'diel. They must be destroyed.
- **8768**: I cannot elaborate on the details, but know that the fate of the world depends on the early elimination of this threat...
- **8769**: Then perhaps it is best if you forget this conversation entirely.
- **8770**: I hope I have been of some assistance to you.
- **8771**: This dark plague grows ever stronger... If it is not stopped soon...
- **8772**: Which item will you use to enter? [6./$6.]
...
```
  0: 0x0001 [0x1D] PRINT_EVENT_MESSAGE(message_id=8771*)
...
```
  ...
  1: 0x000C [0x1D] PRINT_EVENT_MESSAGE(message_id=8754*)
  ...
  3: 0x0010 [0x1D] PRINT_EVENT_MESSAGE(message_id=8755*)
  ...
  5: 0x0014 [0x1D] PRINT_EVENT_MESSAGE(message_id=8756*)
    → "We have labeled these monstrosities "Empty Notorious Monsters," or ENMs..."
  6: 0x0017 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0018 [0x24] CREATE_DIALOG(message_id=8757*, default_option=1*, option_flags=0*)
 ...
 10: 0x0028 [0x1D] PRINT_EVENT_MESSAGE(message_id=8758*)
 ...
 12: 0x002C [0x1D] PRINT_EVENT_MESSAGE(message_id=8759*)
 ...
 14: 0x0030 [0x1D] PRINT_EVENT_MESSAGE(message_id=8760*)
 ...
 16: 0x0034 [0x24] CREATE_DIALOG(message_id=8761*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_0047:
 ...
 24: 0x005E [0x24] CREATE_DIALOG(message_id=8772*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0076:
 ...
 32: 0x0082 [0x1D] PRINT_EVENT_MESSAGE(message_id=8764*)
 ...
 36: 0x0091 [0x1D] PRINT_EVENT_MESSAGE(message_id=8763*)
...
SUBROUTINE_009C:
 ...
 45: 0x00A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=8767*)
 ...
 47: 0x00A8 [0x1D] PRINT_EVENT_MESSAGE(message_id=8768*)
...
SUBROUTINE_00AC:
 ...
 51: 0x00B7 [0x1D] PRINT_EVENT_MESSAGE(message_id=8769*)
...
```
  ...
  1: 0x00CA [0x1D] PRINT_EVENT_MESSAGE(message_id=8760*)
    → "My research has allowed me to measure the length of time between ENM manifestations. Tell me, which ENM would you like to know about?"
  2: 0x00CD [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x00CE [0x24] CREATE_DIALOG(message_id=8761*, default_option=0*, option_flags=Work_Zone[2])
    → "I wish to know about the ENM in... [Nowhere in particular./The Spire of Holla./The Spire of Dem./The Spire of Mea./The Spire of Vahzl./Monarch Linn./The Shrouded Maw./Mine Shaft #2716./Bearclaw Pinnacle./Boneyard Gully.]"
...
SUBROUTINE_00E1:
 ...
 11: 0x00F8 [0x24] CREATE_DIALOG(message_id=8772*, default_option=0*, option_flags=0*)
    → "Which item will you use to enter? [6./$6.]"
