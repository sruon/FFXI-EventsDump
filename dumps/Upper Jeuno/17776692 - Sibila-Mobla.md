...
- **7643**: Move itaru! I want to join the Ducal Guards! Must...march...more...
- **11125**: <Player>'s badge flashes brightly.
- **11126**: Huff...puff... I'm trying to buildy-wuild some muscle so I can join the Ducal Guards, but whew! This is a lotta work!
- **11127**: Puff...huff... Mercenaries fight on the very fwont lines, so I bet they hafta be weaaally tough! Their twaining must be even worse!
...
```
  ...
  3: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=7643*)
...
```
  ...
  4: 0x001D [0x1D] PRINT_EVENT_MESSAGE(message_id=11126*)
  ...
  6: 0x0021 [0x1D] PRINT_EVENT_MESSAGE(message_id=11127*)
