...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0000:    03 00 00 25 10 03 02  00 26 10 03 01 00 27 10   ...%....&....'.
...
```
  ...
  1: 0x0006 [0x03] ExtData[1]->WorkLocal[2] = Work_Zone[38]
  2: 0x000B [0x03] ExtData[1]->WorkLocal[1] = Work_Zone[39]
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0020:             03 00 00 25  10 03 02 00 26 10 03 01      ...%....&...
0030: 00 27 10 03 03 00 28 10  32 01 80 1F 00 00 00 02  .'....(.2.......
...
```
  ...
  1: 0x0029 [0x03] ExtData[1]->WorkLocal[2] = Work_Zone[38]
  2: 0x002E [0x03] ExtData[1]->WorkLocal[1] = Work_Zone[39]
