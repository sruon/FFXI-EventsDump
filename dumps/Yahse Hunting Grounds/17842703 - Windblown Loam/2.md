...
```
 ...
 13: 0x0061 [0x45] LOAD_SCHEDULED_TASK(work_offset1=558*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s098", work_offset2=0*)
 14: 0x0072 [0x1C] WAIT(15* ticks)
 15: 0x0075 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 ...
 24: 0x00B9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=558*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s099", work_offset2=0*)
 25: 0x00CA [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "sp00" for entities [Unnamed NPC (ID: 17842704/0x01104210), Unnamed NPC (ID: 17842704/0x01104210)]
 ...
 30: 0x00E7 [0x53] WAIT_SCHEDULER_TASK(entity1=Unnamed NPC (ID: 17842704/0x01104210), entity2=Unnamed NPC (ID: 17842704/0x01104210), action_id="sp00")
 31: 0x00F4 [0x52] END_LOAD_SCHEDULER: End scheduler "s099" with entities [LocalPlayer, LocalPlayer], work=558*
 32: 0x0103 [0x45] LOAD_SCHEDULED_TASK(work_offset1=558*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s100", work_offset2=0*)
 ...
 35: 0x011E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 36: 0x012F [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 39: 0x014F [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
