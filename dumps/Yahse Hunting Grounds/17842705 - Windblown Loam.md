...
- **7836**: The leafkin is daintily planting seeds in the ground, its expression one of mischievous joy.
...
0020: 6F 31 46 01 38 02 80 2F  00 12 42 10 01 4E 00 12  o1F.8../..B..N..
0030: 42 10 01 BA F0 FF FF 7F  03 80 04 80 01 80 05 80  B...............
0040: BA 12 42 10 01 06 80 07  80 01 80 08 80 80 F0 FF  ..B.............
0050: FF 7F 80 12 42 10 01 27  05 12 42 10 01 02 1C 09  ....B..'..B.....
0060: 80 45 0A 80 F0 FF FF 7F  F0 FF FF 7F 73 30 39 38  .E..........s098
0070: 01 80 1C 0B 80 45 00 80  F0 FF FF 7F F0 FF FF 7F  .....E..........
0080: 66 64 69 31 01 80 2A 05  12 42 10 01 4B 12 42 10  fdi1..*..B..K.B.
0090: 01 0C 80 1C 0D 80 4B 12  42 10 01 0E 80 1C 0D 80  ......K.B.......
00A0: 4B 12 42 10 01 0F 80 1C  0D 80 52 0A 80 F0 FF FF  K.B.......R.....
00B0: 7F F0 FF FF 7F 73 30 39  38 45 0A 80 F0 FF FF 7F  .....s098E......
00C0: F0 FF FF 7F 73 30 39 39  01 80 2C 12 42 10 01 12  ....s099..,.B...
00D0: 42 10 01 73 70 30 30 1C  0B 80 4A F0 FF FF 7F 12  B..sp00...J.....
00E0: 42 10 01 48 10 80 23 53  12 42 10 01 12 42 10 01  B..H..#S.B...B..
00F0: 73 70 30 30 52 0A 80 F0  FF FF 7F F0 FF FF 7F 73  sp00R..........s
0100: 30 39 39 45 0A 80 F0 FF  FF 7F F0 FF FF 7F 73 31  099E..........s1
0110: 30 30 01 80 27 05 12 42  10 01 03 1C 11 80 45 00  00..'..B......E.
...
```
  ...
  5: 0x0027 [0x2F] Unnamed NPC (ID: 17842706/0x01104212)->Render.Flags0 &= ~0x80000 // Bit 19
  6: 0x002D [0x4E] SET_ENTITY_HIDE_FLAG: Show Unnamed NPC (ID: 17842706/0x01104212)
  7: 0x0033 [0xBA] SET_ENTITY_POSITION(entity_id=LocalPlayer, pos_x=199.742*, pos_z=273.557*, pos_y=0.000*, direction=240.3°*)
  8: 0x0040 [0xBA] SET_ENTITY_POSITION(entity_id=Unnamed NPC (ID: 17842706/0x01104212), pos_x=196.495*, pos_z=281.129*, pos_y=0.000*, direction=231.3°*)
  9: 0x004D [0x80] LOAD_WAIT(entity=LocalPlayer)
 10: 0x0052 [0x80] LOAD_WAIT(entity=Unnamed NPC (ID: 17842706/0x01104212))
 11: 0x0057 [0x27] REQ_SET(priority=0x05, entity_id=Unnamed NPC (ID: 17842706/0x01104212), tag_num=0x02)
 ...
 16: 0x0086 [0x2A] GET_REQ_LEVEL(level=5, entity_id=Unnamed NPC (ID: 17842706/0x01104212))
 17: 0x008C [0x4B] UPDATE_ENTITY_YAW(entity=Unnamed NPC (ID: 17842706/0x01104212), yaw=20.9°*)
 18: 0x0093 [0x1C] WAIT(60* ticks)
 19: 0x0096 [0x4B] UPDATE_ENTITY_YAW(entity=Unnamed NPC (ID: 17842706/0x01104212), yaw=10.5°*)
 20: 0x009D [0x1C] WAIT(60* ticks)
 21: 0x00A0 [0x4B] UPDATE_ENTITY_YAW(entity=Unnamed NPC (ID: 17842706/0x01104212), yaw=14.3°*)
 ...
 25: 0x00CA [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "sp00" with entities [Unnamed NPC (ID: 17842706/0x01104212), Unnamed NPC (ID: 17842706/0x01104212)]
 26: 0x00D7 [0x1C] WAIT(15* ticks)
 27: 0x00DA [0x4A] LocalPlayer looks at Unnamed NPC (ID: 17842706/0x01104212)
 28: 0x00E3 [0x48] [System] [7836*]:
 ...
 30: 0x00E7 [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "sp00" with entities [Unnamed NPC (ID: 17842706/0x01104212), Unnamed NPC (ID: 17842706/0x01104212)]
 ...
 33: 0x0114 [0x27] REQ_SET(priority=0x05, entity_id=Unnamed NPC (ID: 17842706/0x01104212), tag_num=0x03)
