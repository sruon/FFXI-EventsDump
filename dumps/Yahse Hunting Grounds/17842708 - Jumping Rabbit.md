...
- **7841**: When I think of how many good men and women drowned from the crashing waves of the Senroh Sea...
- **7843**: I never expected one from the Middle Lands to emit such a familiar aura...
- **7844**: ...You must have studied under the tutelage of Sylvie or Octavien.
- **7845**: I stand guard over this spot, waiting for ill tidings to be borne from the Senroh Sea.
- **7846**: Bah. I say ill tidings, but in truth nothing of the sort has happened in months.
- **7847**: And what about you? Are you here in search of answers?
- **7848**: Need any answers? [I like answers./I'm better off not knowing.]
- **7849**: Hush now. You needn't say a word.
- **7850**: I can sense you questioning. Questioning whether you'll be able to recapture a sense of powers once gleaned but later lost.
- **7851**: Perhaps...perhaps I can guide you.
- **7857**: A deal. Right.
- **7859**: Hmm hmm hmm...given your height and weight, I'd say...
- **7860**: Yo, Nunana! You're better at this than I am. What d'you think will fit her?
- **7862**: Absolutely perfect! You'll have an endless parade of people clawing to get a look at you!
- **7863**: We're willing to part with it for, say...$0 bayld.
- **7867**: Enjoy, and may this be the answer you were looking for!
- **7869**: Can't help you if you don't have enough bayld!
...
0020: 15 42 10 01 F0 FF FF 7F  6F 76 15 42 10 01 23 06  .B......ov.B..#.
...
0220: 4A 15 42 10 01 F8 FF FF  7F 6F 76 15 42 10 01 1C  J.B......ov.B...
0230: 1F 80 23 01 6F 02 1E 15  42 10 01 6F 70 1D 20 80  ..#.o...B..op. .
0240: 23 6E 15 42 10 01 15 80  99 15 42 10 01 2B 15 42  #n.B......B..+.B
0250: 10 01 21 80 23 1C 1E 80  23 4A 15 42 10 01 F8 FF  ..!.#...#J.B....
0260: FF 7F 6F 76 15 42 10 01  1E F0 FF FF 7F 6F 70 1D  ..ov.B.......op.
0270: 22 80 23 03 02 10 23 80  1D 24 80 23 6E 15 42 10  ".#...#..$.#n.B.
0280: 01 25 80 99 15 42 10 01  2B 15 42 10 01 26 80 1C  .%...B..+.B..&..
0290: 27 80 23 4A 15 42 10 01  F0 FF FF 7F 6F 76 15 42  '.#J.B......ov.B
...
0310: F8 FF FF 7F 70 61 73 30  2B 80 1D 2C 80 23 6E 15  ....pas0+..,.#n.
0320: 42 10 01 2D 80 99 15 42  10 01 2B 15 42 10 01 2E  B..-...B..+.B...
...
```
  ...
  6: 0x0019 [0x1D] PRINT_EVENT_MESSAGE(message_id=7857*)
    → "A deal. Right."
  7: 0x001C [0x1C] WAIT(40* ticks)
  8: 0x001F [0x4A] Nunana (ID: 17842709/0x01104215) looks at LocalPlayer
  9: 0x0028 [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
 10: 0x0029 [0x76] CHECK_ENTITY_RENDER_FLAGS: Wait until Nunana (ID: 17842709/0x01104215) Render.Flags0 and Render.Flags3 conditions are met
...
# Dead code (unreachable instructions):
     ...
     0x021A [0x1D] PRINT_EVENT_MESSAGE(message_id=7859*)
    → "Hmm hmm hmm...given your height and weight, I'd say..."
     0x021D [0x1C] WAIT(80* ticks)
     0x0220 [0x4A] Nunana (ID: 17842709/0x01104215) looks at EventEntity
     0x0229 [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
     0x022A [0x76] CHECK_ENTITY_RENDER_FLAGS: Wait until Nunana (ID: 17842709/0x01104215) Render.Flags0 and Render.Flags3 conditions are met
     0x022F [0x1C] WAIT(70* ticks)
     0x0232 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0233 [0x01] GOTO 0x026F
     0x0236 [0x1E] EventEntity looks at Nunana (ID: 17842709/0x01104215) and starts talking
     ...
     0x023D [0x1D] PRINT_EVENT_MESSAGE(message_id=7860*)
    → "Yo, Nunana! You're better at this than I am. What d'you think will fit her?"
     0x0240 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0241 [0x6E] Nunana (ID: 17842709/0x01104215) uses emote 7*
     0x0248 [0x99] Wait for Nunana (ID: 17842709/0x01104215) animation to complete
     0x024D [0x2B] Nunana (ID: 17842709/0x01104215) [7861*]:
    → "Hmm... Maybe you could stand to lose a few ponzes-wonzes... How about this?"
     ...
     0x0259 [0x4A] Nunana (ID: 17842709/0x01104215) looks at EventEntity
     0x0262 [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
     0x0263 [0x76] CHECK_ENTITY_RENDER_FLAGS: Wait until Nunana (ID: 17842709/0x01104215) Render.Flags0 and Render.Flags3 conditions are met
     ...
     0x026F [0x1D] PRINT_EVENT_MESSAGE(message_id=7862*)
    → "Absolutely perfect! You'll have an endless parade of people clawing to get a look at you!"
     ...
     0x0278 [0x1D] PRINT_EVENT_MESSAGE(message_id=7863*)
    → "We're willing to part with it for, say...$0 bayld."
     0x027B [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x027C [0x6E] Nunana (ID: 17842709/0x01104215) uses emote 38*
     0x0283 [0x99] Wait for Nunana (ID: 17842709/0x01104215) animation to complete
     0x0288 [0x2B] Nunana (ID: 17842709/0x01104215) [7864*]:
    → "Hey, Rabbit! You tryin' to run us out of business-wusiness?"
     0x028F [0x1C] WAIT(150* ticks)
     0x0292 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0293 [0x4A] Nunana (ID: 17842709/0x01104215) looks at LocalPlayer
     0x029C [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
     0x029D [0x76] CHECK_ENTITY_RENDER_FLAGS: Wait until Nunana (ID: 17842709/0x01104215) Render.Flags0 and Render.Flags3 conditions are met
     ...
     0x031A [0x1D] PRINT_EVENT_MESSAGE(message_id=7867*)
    → "Enjoy, and may this be the answer you were looking for!"
     0x031D [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x031E [0x6E] Nunana (ID: 17842709/0x01104215) uses emote 36*
     0x0325 [0x99] Wait for Nunana (ID: 17842709/0x01104215) animation to complete
     0x032A [0x2B] Nunana (ID: 17842709/0x01104215) [7868*]:
    → "Come back if you need anything else!"
     ...
     0x0358 [0x1D] PRINT_EVENT_MESSAGE(message_id=7869*)
    → "Can't help you if you don't have enough bayld!"
     ...
     0x037C [0x1D] PRINT_EVENT_MESSAGE(message_id=7869*)
    → "Can't help you if you don't have enough bayld!"
...
03B0: 99 F8 FF FF 7F 1D 33 80  1C 02 80 4A 15 42 10 01  ......3....J.B..
03C0: F0 FF FF 7F 6F 76 15 42  10 01 23 1D 34 80 23 1D  ....ov.B..#.4.#.
...
0420: 1D 3C 80 23 1D 3D 80 1C  2F 80 23 6E 15 42 10 01  .<.#.=../.#n.B..
0430: 3E 80 99 15 42 10 01 2B  15 42 10 01 3F 80 23 2B  >...B..+.B..?.#+
0440: 15 42 10 01 40 80 23 2B  15 42 10 01 41 80 1C 42  .B..@.#+.B..A..B
0450: 80 23 21 00                                       .#!.            
```
...
```
  ...
  8: 0x03B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7843*)
    → "I never expected one from the Middle Lands to emit such a familiar aura..."
  9: 0x03B8 [0x1C] WAIT(40* ticks)
 10: 0x03BB [0x4A] Nunana (ID: 17842709/0x01104215) looks at LocalPlayer
 11: 0x03C4 [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
 12: 0x03C5 [0x76] CHECK_ENTITY_RENDER_FLAGS: Wait until Nunana (ID: 17842709/0x01104215) Render.Flags0 and Render.Flags3 conditions are met
 13: 0x03CA [0x23] WAIT_FOR_DIALOG_INTERACTION
 14: 0x03CB [0x1D] PRINT_EVENT_MESSAGE(message_id=7844*)
    → "...You must have studied under the tutelage of Sylvie or Octavien."
 15: 0x03CE [0x23] WAIT_FOR_DIALOG_INTERACTION
 16: 0x03CF [0x1D] PRINT_EVENT_MESSAGE(message_id=7845*)
 ...
 18: 0x03D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7846*)
 ...
 26: 0x03EB [0x1D] PRINT_EVENT_MESSAGE(message_id=7847*)
    → "And what about you? Are you here in search of answers?"
 27: 0x03EE [0x23] WAIT_FOR_DIALOG_INTERACTION
 28: 0x03EF [0x24] CREATE_DIALOG(message_id=7848*, default_option=0*, option_flags=0*)
...
SUBROUTINE_040D:
 34: 0x040D [0x1D] PRINT_EVENT_MESSAGE(message_id=7849*)
 ...
 39: 0x0420 [0x1D] PRINT_EVENT_MESSAGE(message_id=7850*)
 ...
 41: 0x0424 [0x1D] PRINT_EVENT_MESSAGE(message_id=7851*)
    → "Perhaps...perhaps I can guide you."
 42: 0x0427 [0x1C] WAIT(90* ticks)
 43: 0x042A [0x23] WAIT_FOR_DIALOG_INTERACTION
 44: 0x042B [0x6E] Nunana (ID: 17842709/0x01104215) uses emote 16*
 45: 0x0432 [0x99] Wait for Nunana (ID: 17842709/0x01104215) animation to complete
 46: 0x0437 [0x2B] Nunana (ID: 17842709/0x01104215) [7852*]:
    → "(Psssssst! You there, with the face!)"
 47: 0x043E [0x23] WAIT_FOR_DIALOG_INTERACTION
 48: 0x043F [0x2B] Nunana (ID: 17842709/0x01104215) [7853*]:
 ...
 50: 0x0447 [0x2B] Nunana (ID: 17842709/0x01104215) [7854*]:
...
```
  ...
  2: 0x0460 [0x1D] PRINT_EVENT_MESSAGE(message_id=7841*)
