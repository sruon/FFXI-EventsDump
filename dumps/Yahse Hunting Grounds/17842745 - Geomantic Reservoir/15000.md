...
```
 ...
 30: 0x0086 [0xAD] DUAL_ENTITY_SCHEDULER: Execute sub-case 0 with entities [Geomantic Reservoir (ID: 17842745/0x01104239), LocalPlayer], param=ExtData[1]->WorkLocal[2]
