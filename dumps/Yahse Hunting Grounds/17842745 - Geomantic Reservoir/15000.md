...
0040: 04 80 23 1C 05 80 03 02  10 03 00 28 10 3A 42 10  ..#........(.:B.
0050: 01 02 28 10 3B 42 10 01  02 48 06 80 23 7A 00 3A  ..(.;B...H..#z.:
0060: 42 10 01 7A 00 3B 42 10  01 28 10 3B 42 10 01 03  B..z.;B..(.;B...
0070: 03 05 00 03 10 02 05 00  07 80 04 82 00 03 05 00  ................
0080: 07 80 48 08 80 23 AD 00  02 00 39 42 10 01 F0 FF  ..H..#....9B....
...
```
 ...
 18: 0x004B [0x28] REQ_SET_WITH_CONDITIONS(priority=0x10, target_entity=Unknown NPC (ID: 17842746/0x0110423A), tag_num=0x02)
 19: 0x0052 [0x28] REQ_SET_WITH_CONDITIONS(priority=0x10, target_entity=Unknown NPC (ID: 17842747/0x0110423B), tag_num=0x02)
 20: 0x0059 [0x48] [System] [7876*]:
    → "\u007F1\u0000\u0007"
 21: 0x005C [0x23] WAIT_FOR_DIALOG_INTERACTION
 22: 0x005D [0x7A] VM_CONTROL: Reset VM for Unknown NPC (ID: 17842746/0x0110423A)
 23: 0x0063 [0x7A] VM_CONTROL: Reset VM for Unknown NPC (ID: 17842747/0x0110423B)
 24: 0x0069 [0x28] REQ_SET_WITH_CONDITIONS(priority=0x10, target_entity=Unknown NPC (ID: 17842747/0x0110423B), tag_num=0x03)
 ...
 28: 0x0082 [0x48] [System] [7879*]:
    → "You feel a mystical warmth welling up inside you!\u007F1\u0000\u0007"
 29: 0x0085 [0x23] WAIT_FOR_DIALOG_INTERACTION
 30: 0x0086 [0xAD] DUAL_ENTITY_SCHEDULER_HANDLER: Execute sub-case 0 with entities [Geomantic Reservoir (ID: 17842745/0x01104239), LocalPlayer], work=ExtData[1]->WorkLocal[2]
