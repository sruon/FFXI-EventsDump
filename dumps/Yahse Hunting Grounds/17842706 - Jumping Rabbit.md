...
- **7836**: When I think of how many good men and women drowned from the crashing waves of the Senroh Sea...
- **7838**: I never expected one from the Middle Lands to emit such a familiar aura...
- **7839**: ...You must have studied under the tutelage of Sylvie or Octavien.
- **7840**: I stand guard over this spot, waiting for ill tidings to be borne from the Senroh Sea.
- **7841**: Bah. I say ill tidings, but in truth nothing of the sort has happened in months.
- **7842**: And what about you? Are you here in search of answers?
- **7843**: Need any answers? [I like answers./I'm better off not knowing.]
- **7844**: Hush now. You needn't say a word.
- **7845**: I can sense you questioning. Questioning whether you'll be able to recapture a sense of powers once gleaned but later lost.
- **7846**: Perhaps...perhaps I can guide you.
- **7852**: A deal. Right.
- **7854**: Hmm hmm hmm...given your height and weight, I'd say...
- **7855**: Yo, Nunana! You're better at this than I am. What d'you think will fit her?
- **7857**: Absolutely perfect! You'll have an endless parade of people clawing to get a look at you!
- **7858**: We're willing to part with it for, say...$0 bayld.
- **7862**: Enjoy, and may this be the answer you were looking for!
- **7864**: Can't help you if you don't have enough bayld!
...
```
  ...
  6: 0x0019 [0x1D] PRINT_EVENT_MESSAGE(message_id=7852*)
    → "A deal. Right."
...
# Dead code (unreachable instructions):
     ...
     0x021A [0x1D] PRINT_EVENT_MESSAGE(message_id=7854*)
    → "Hmm hmm hmm...given your height and weight, I'd say..."
     ...
     0x023D [0x1D] PRINT_EVENT_MESSAGE(message_id=7855*)
    → "Yo, Nunana! You're better at this than I am. What d'you think will fit her?"
     ...
     0x024D [0x2B] Nunana (ID: 17842707/0x01104213) [7856*]:
    → "Hmm... Maybe you could stand to lose a few ponzes-wonzes... How about this?"
     ...
     0x026F [0x1D] PRINT_EVENT_MESSAGE(message_id=7857*)
    → "Absolutely perfect! You'll have an endless parade of people clawing to get a look at you!"
     ...
     0x0278 [0x1D] PRINT_EVENT_MESSAGE(message_id=7858*)
    → "We're willing to part with it for, say...$0 bayld."
     ...
     0x0288 [0x2B] Nunana (ID: 17842707/0x01104213) [7859*]:
    → "Hey, Rabbit! You tryin' to run us out of business-wusiness?"
     ...
     0x031A [0x1D] PRINT_EVENT_MESSAGE(message_id=7862*)
    → "Enjoy, and may this be the answer you were looking for!"
     ...
     0x032A [0x2B] Nunana (ID: 17842707/0x01104213) [7863*]:
    → "Come back if you need anything else!"
     ...
     0x0358 [0x1D] PRINT_EVENT_MESSAGE(message_id=7864*)
    → "Can't help you if you don't have enough bayld!"
     ...
     0x037C [0x1D] PRINT_EVENT_MESSAGE(message_id=7864*)
    → "Can't help you if you don't have enough bayld!"
...
```
  ...
  8: 0x03B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7838*)
 ...
 18: 0x03D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7841*)
 ...
 26: 0x03EB [0x1D] PRINT_EVENT_MESSAGE(message_id=7842*)
    → "And what about you? Are you here in search of answers?"
 27: 0x03EE [0x23] WAIT_FOR_DIALOG_INTERACTION
 28: 0x03EF [0x24] CREATE_DIALOG(message_id=7843*, default_option=0*, option_flags=0*)
...
SUBROUTINE_040D:
 34: 0x040D [0x1D] PRINT_EVENT_MESSAGE(message_id=7844*)
 ...
 39: 0x0420 [0x1D] PRINT_EVENT_MESSAGE(message_id=7845*)
 ...
 41: 0x0424 [0x1D] PRINT_EVENT_MESSAGE(message_id=7846*)
 ...
 46: 0x0437 [0x2B] Nunana (ID: 17842707/0x01104213) [7847*]:
    → "(Psssssst! You there, with the face!)"
 47: 0x043E [0x23] WAIT_FOR_DIALOG_INTERACTION
 48: 0x043F [0x2B] Nunana (ID: 17842707/0x01104213) [7848*]:
 ...
 50: 0x0447 [0x2B] Nunana (ID: 17842707/0x01104213) [7849*]:
...
```
  ...
  2: 0x0460 [0x1D] PRINT_EVENT_MESSAGE(message_id=7836*)
