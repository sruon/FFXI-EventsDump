...
- **7890**: You should be able to head [to the other side/over there] if you have the $3 and $3.
- **7893**: Head [for the other side/over there]? [Yes./No./Dive right in.]
...
0230: FF 7F F0 FF FF 7F 73 33  30 34 29 10 2E 42 10 01  ......s304)..B..
0240: 04 46 00 1B                                       .F..            
```
...
```
  ...
  6: 0x0019 [0x24] CREATE_DIALOG(message_id=7893*, default_option=0*, option_flags=4*)
...
SUBROUTINE_0126:
 ...
 49: 0x016F [0x29] REQ_SET_WAIT(priority=0x10, entity_id=Unnamed NPC (ID: 17842734/0x0110422E), tag_num=0x03)
 ...
 54: 0x01A6 [0x29] REQ_SET_WAIT(priority=0x10, entity_id=Unnamed NPC (ID: 17842734/0x0110422E), tag_num=0x02)
...
SUBROUTINE_023A:
 68: 0x023A [0x29] REQ_SET_WAIT(priority=0x10, entity_id=Unnamed NPC (ID: 17842734/0x0110422E), tag_num=0x04)
