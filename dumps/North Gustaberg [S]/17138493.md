...
|---------|-------------|-------------|
|       0 | 0x000D      |          13 |
|       1 | 0xFFFC62D1  |  4294730449 |
|       2 | 0x67DD4     |      425428 |
|       3 | 0x9EDF      |       40671 |
|       4 | 0x001E      |          30 |
|       5 | 0xFFFC62C6  |  4294730438 |
|       6 | 0x66D91     |      421265 |
|       7 | 0x9CD7      |       40151 |
...
```
  ...
  1: 0x0005 [0x1F] MOVE_ENTITY: EventEntity moves to X=-236.847*, Z=425.428*, Y=40.671*
...
```
  ...
  1: 0x001B [0x1F] MOVE_ENTITY: EventEntity moves to X=-236.858*, Z=421.265*, Y=40.151*
