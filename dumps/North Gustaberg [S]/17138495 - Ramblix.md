...
```
 ...
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=7786*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7787*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_00E6:
 43: 0x00E6 [0x24] CREATE_DIALOG(message_id=7788*, default_option=0*, option_flags=Work_Zone[3])
    → ""
...
SUBROUTINE_012A:
 54: 0x012A [0x24] CREATE_DIALOG(message_id=7789*, default_option=0*, option_flags=Work_Zone[4])
    → ""
...
SUBROUTINE_016E:
 65: 0x016E [0x24] CREATE_DIALOG(message_id=7790*, default_option=0*, option_flags=Work_Zone[5])
    → ""
