...
- **7127**: Good show on your last operation. Now go make an official report to Sir Rasdinice.
- **7128**: Good work on that last operation. Now report back to First Centurion Hieronymus before he has your hide!
- **7129**: Nice job on your last operation. Now don't forget to report back to Emhi Tchaoryo!
- **7130**: It seems that you were not successful in your last operation. But do not let one small failure hang heavy on your soul. Report to Sir Rasdinice and put this all behind you.
- **7131**: Weren't so lucky during that last operation, were you? Well, don't worry about it too much. Report to First Centurion Hieronymus and get some rest, soldier.
- **7132**: Hmmm... Didn't do so well on that last operation, did you? I know it's hard, but it's better if you're up-front about these things. If you know what's good for you, you'll hurry down and report to Emhi Tchaoryo before the major finds out first.
- **7359**: What will you do? [Nothing./Transfer to another union./Resign union membership.]
...
```
 ...
 11: 0x0044 [0x1D] PRINT_EVENT_MESSAGE(message_id=7127*)
 ...
 15: 0x0053 [0x1D] PRINT_EVENT_MESSAGE(message_id=7128*)
 ...
 19: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=7129*)
...
159: 0x0699 [0x1D] PRINT_EVENT_MESSAGE(message_id=7130*)
...
163: 0x06A8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7131*)
...
167: 0x06B7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7132*)
...
172: 0x06C9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7127*)
    → "Good show on your last operation. Now go make an official report to Sir Rasdinice."
...
176: 0x06D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7128*)
    → "Good work on that last operation. Now report back to First Centurion Hieronymus before he has your hide!"
...
180: 0x06E7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7129*)
    → "Nice job on your last operation. Now don't forget to report back to Emhi Tchaoryo!"
...
# Dead code (unreachable instructions):
    ...
    → "Register for a union? [Yes./No.]"
     ...
     0x16FD [0x24] CREATE_DIALOG(message_id=7359*, default_option=0*, option_flags=0*)
    → "What will you do? [Nothing./Transfer to another union./Resign union membership.]"
     ...
     0x172A [0x1D] PRINT_EVENT_MESSAGE(message_id=7360*)
    ...
    → "[Transfer/Resign] from your current union? [Yes./No.]"
     ...
     0x1773 [0x1D] PRINT_EVENT_MESSAGE(message_id=7360*)
    → "Your steadfast efforts have earned you a claim to share in your union's spoils of war. By [transferring to another union/resigning from your union], you will relinquish this right. It is not my place to question your decision, but I suggest you pay the matter due heed."
    ...
    → "[Transfer/Resign] from your current union? [Yes./No.]"
     ...
     0x1820 [0x1D] PRINT_EVENT_MESSAGE(message_id=7366*)
    → "I am afraid that all unions are currently at their maximum enrollment, and unable to accept new recruits. For better or for worse, though, I suspect it shall not be long before we are in need of some new blood. Such is the nature of war..."
     ...
     0x182C [0x24] CREATE_DIALOG(message_id=7362*, default_option=0*, option_flags=ExtData[1]->WorkLocal[49])
