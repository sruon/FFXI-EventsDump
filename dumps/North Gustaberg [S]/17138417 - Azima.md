...
- **7892**: <Sigh>... The road to the Konschtat Highlands has been barricaded...
- **7893**: <Sigh>... Is there no way into the Palborough Mines?
- **7894**: <Sigh>... I was so looking forward to traveling to South Gustaberg, but it seems the way is obstructed.
- **7895**: Oh, you appear quite versed in the alchemic arts. I just started, myself. Magic is fun and all, but you are always left with nothing but the afterglow. Alchemy is like magic that gives you a gift when you are finished!
- **7896**: Ahahaha! Are you trying to flatter me with your gifts? Well, I must say...you are doing quite a good job! Ahaha!
...
```
 ...
 17: 0x005D [0x1D] PRINT_EVENT_MESSAGE(message_id=7895*)
 ...
 22: 0x0071 [0x1D] PRINT_EVENT_MESSAGE(message_id=7895*)
    → "Oh, you appear quite versed in the alchemic arts. I just started, myself. Magic is fun and all, but you are always left with nothing but the afterglow. Alchemy is like magic that gives you a gift when you are finished!"
 ...
 27: 0x0085 [0x1D] PRINT_EVENT_MESSAGE(message_id=7895*)
    → "Oh, you appear quite versed in the alchemic arts. I just started, myself. Magic is fun and all, but you are always left with nothing but the afterglow. Alchemy is like magic that gives you a gift when you are finished!"
...
SUBROUTINE_008C:
 ...
 32: 0x0097 [0x1D] PRINT_EVENT_MESSAGE(message_id=7892*)
 ...
 36: 0x00A6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7893*)
 ...
 40: 0x00B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7894*)
 ...
 44: 0x00C4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7894*)
    → "<Sigh>... I was so looking forward to traveling to South Gustaberg, but it seems the way is obstructed."
...
SUBROUTINE_00CB:
 ...
 54: 0x00F6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7896*)
 ...
 57: 0x00FD [0x1D] PRINT_EVENT_MESSAGE(message_id=7896*)
    → "Ahahaha! Are you trying to flatter me with your gifts? Well, I must say...you are doing quite a good job! Ahaha!"
...
SUBROUTINE_0101:
 ...
 63: 0x0119 [0x1D] PRINT_EVENT_MESSAGE(message_id=7896*)
    → "Ahahaha! Are you trying to flatter me with your gifts? Well, I must say...you are doing quite a good job! Ahaha!"
 64: 0x011C [0x23] WAIT_FOR_DIALOG_INTERACTION
 65: 0x011D [0x01] GOTO 0x0124
 66: 0x0120 [0x1D] PRINT_EVENT_MESSAGE(message_id=7896*)
    → "Ahahaha! Are you trying to flatter me with your gifts? Well, I must say...you are doing quite a good job! Ahaha!"
...
SUBROUTINE_0124:
 ...
 72: 0x013C [0x1D] PRINT_EVENT_MESSAGE(message_id=7896*)
    → "Ahahaha! Are you trying to flatter me with your gifts? Well, I must say...you are doing quite a good job! Ahaha!"
 73: 0x013F [0x23] WAIT_FOR_DIALOG_INTERACTION
 74: 0x0140 [0x01] GOTO 0x0147
 75: 0x0143 [0x1D] PRINT_EVENT_MESSAGE(message_id=7896*)
    → "Ahahaha! Are you trying to flatter me with your gifts? Well, I must say...you are doing quite a good job! Ahaha!"
...
SUBROUTINE_014D:
 ...
 81: 0x0158 [0x1D] PRINT_EVENT_MESSAGE(message_id=7892*)
    → "<Sigh>... The road to the Konschtat Highlands has been barricaded..."
 ...
 85: 0x0167 [0x1D] PRINT_EVENT_MESSAGE(message_id=7893*)
    → "<Sigh>... Is there no way into the Palborough Mines?"
 ...
 89: 0x0176 [0x1D] PRINT_EVENT_MESSAGE(message_id=7894*)
    → "<Sigh>... I was so looking forward to traveling to South Gustaberg, but it seems the way is obstructed."
 ...
 93: 0x0185 [0x1D] PRINT_EVENT_MESSAGE(message_id=7894*)
    → "<Sigh>... I was so looking forward to traveling to South Gustaberg, but it seems the way is obstructed."
