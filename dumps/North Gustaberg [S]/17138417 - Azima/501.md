...
SUBROUTINE_008C:
 ...
 32: 0x0097 [0x1D] PRINT_EVENT_MESSAGE(message_id=7890*)
    → "<Sigh>... The road to the Konschtat Highlands has been barricaded...\u007F1\u0000\u0007"
 ...
 36: 0x00A6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7891*)
    → "<Sigh>... Is there no way into the Palborough Mines?\u007F1\u0000\u0007"
 ...
 40: 0x00B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7892*)
    → "<Sigh>... I was so looking forward to traveling to South Gustaberg, but it seems the way is obstructed.\u007F1\u0000\u0007"
