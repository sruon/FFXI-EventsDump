...
```
  0: 0x000D [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=675.076*, z=-474.756*, y=-31.894*, direction=221.1°*
...
00C0: F8 FF FF 7F 64 66 6B 30  00                       ....dfk0.       
```

#### Opcodes

```
  0: 0x00B9 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "dfk0" with entities [EventEntity, EventEntity], work=441*
...
00D0: F8 FF FF 7F 64 66 6B 31  00                       ....dfk1.       
```

#### Opcodes

```
  0: 0x00C9 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "dfk1" with entities [EventEntity, EventEntity], work=441*
