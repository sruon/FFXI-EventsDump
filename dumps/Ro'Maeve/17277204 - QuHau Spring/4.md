...
```
  ...
  4: 0x03E8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 ...
 59: 0x0553 [0x45] LOAD_SCHEDULED_TASK(work_offset1=252*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s050", work_offset2=0*)
 60: 0x0564 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
...
SUBROUTINE_0591:
 ...
 66: 0x05AA [0x55] WAIT_LOAD_SCHEDULER(work_offset=252*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s050")
 ...
 69: 0x05BD [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
...
102: 0x0720 [0x45] LOAD_SCHEDULED_TASK(work_offset1=252*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s051", work_offset2=0*)
103: 0x0731 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
...
106: 0x0754 [0x45] LOAD_SCHEDULED_TASK(work_offset1=252*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s055", work_offset2=0*)
...
110: 0x077E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
111: 0x078F [0x45] LOAD_SCHEDULED_TASK(work_offset1=252*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s052", work_offset2=0*)
...
114: 0x07B2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
115: 0x07C3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=252*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s056", work_offset2=0*)
...
121: 0x07FB [0x45] LOAD_SCHEDULED_TASK(work_offset1=252*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s053", work_offset2=0*)
122: 0x080C [0x1C] WAIT(200* ticks)
123: 0x080F [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="who1", work_offset2=0*)
...
128: 0x083A [0x45] LOAD_SCHEDULED_TASK(work_offset1=252*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s058", work_offset2=0*)
...
132: 0x085F [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="whi1", work_offset2=0*)
