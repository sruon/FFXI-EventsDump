...
SUBROUTINE_01A4:
 67: 0x01A4 [0x02] IF !(ExtData[1]->WorkLocal[0] > 3*) GOTO 0x0803
 ...
 76: 0x01DD [0x1A] CALL_SUBROUTINE(address=0x15D2)
...
249: 0x0792 [0x1A] CALL_SUBROUTINE(address=0x1060)
...
SUBROUTINE_07E0:
263: 0x07E0 [0x03] Work_Zone[1] = 100*
264: 0x07E5 [0x07] Work_Zone[1] += ExtData[1]->WorkLocal[3]
265: 0x07EA [0x01] GOTO 0x0807

SUBROUTINE_07F0:
266: 0x07F0 [0x0B] ExtData[1]->WorkLocal[0]++
267: 0x07F3 [0x02] IF !(0* == 1*) GOTO 0x0800
268: 0x07FB [0x03] ExtData[1]->WorkLocal[0] = 4*
269: 0x0800 [0x01] GOTO 0x01A4
270: 0x0803 [0x48] [System] [7071*]:
    → "You cannot enter the battlefield at present. Please wait a little longer.\u007F4\u0001\u007F1\u0000\u0007"
271: 0x0806 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_0807:
272: 0x0807 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "whi1" with entities [LocalPlayer, LocalPlayer], work=[201*, 0*]
273: 0x0818 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "blof" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
274: 0x0829 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi0" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]

SUBROUTINE_083A:
275: 0x083A [0x02] IF !(ExtData[1]->WorkLocal[7] == 1*) GOTO 0x0852
276: 0x0842 [0x5C] MUSIC_CONTROL: Set Idle (Day) music to song 0*
277: 0x0846 [0x5C] MUSIC_CONTROL: Set Idle (Night) music to song 0*
278: 0x084A [0x5C] MUSIC_CONTROL: Set Combat (Solo) music to song 220*
279: 0x084E [0x5C] MUSIC_CONTROL: Set Combat (Party) music to song 220*
280: 0x0852 [0x21] END_EVENT
281: 0x0853 [0x00] END_REQSTACK()

SUBROUTINE_0854:
282: 0x0854 [0x02] IF !(ExtData[1]->WorkLocal[3] == 1*) GOTO 0x0866
283: 0x085C [0x48] [System] [7607*]:
