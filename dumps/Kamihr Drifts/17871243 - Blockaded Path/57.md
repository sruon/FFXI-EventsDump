...
SUBROUTINE_0030:
 15: 0x0030 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x0040
 16: 0x0038 [0x03] Work_Zone[1] = 2*
 17: 0x003D [0x01] GOTO 0x0040

SUBROUTINE_0040:
 18: 0x0040 [0x20] SET_CLI_EVENT_UC_FLAG: Unlock player control
 19: 0x0042 [0x21] END_EVENT
 20: 0x0043 [0x00] END_REQSTACK()
```
