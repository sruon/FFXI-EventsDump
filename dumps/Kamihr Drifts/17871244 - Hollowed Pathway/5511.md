...
```
 ...
 11: 0x00D8 [0x24] CREATE_DIALOG(message_id=8018*, default_option=0*, option_flags=0x0F)
...
SUBROUTINE_00F2:
 ...
 31: 0x0141 [0x24] CREATE_DIALOG(message_id=7999*, default_option=0x0007, option_flags=0*)
    → "Proceed?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
