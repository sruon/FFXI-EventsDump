# 17871264 - Diaphanous Transposer
...
- **8772**: Attempt which? (Auto-transport: [off/on]) [None./Sortie./././././././././././././././Toggle auto-transport.]
- **8774**: Only party members present with you in this area will be transported to [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8775**: [Apply to proceed/Proceed]? [Definitely!/Not yet.]
- **8776**: Entering [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8777**: You have chosen not to [apply to/enter] [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8789**: You will be able to call forth up to $4 alter ego[/s] given the current number of players in your party.
- **8796**: Applying to enter [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy]. You will be unable to participate if you add any more party members. Are you sure?
- **8799**: You are currently number in line to be drawn into this nightmare.
- **8800**: You are currently number in line, with in front of you.
- **8801**: Prepare yourselves! The battlefield is almost ready!
- **8802**: You are currently applying to enter [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8803**: Your number: . (Auto-transport: [off/on]) [Remove your name./Toggle auto-transport./Close dialogue.]
- **8815**: Debug menu. [Check information./View applicants./Create./Change maximum limit./Clear applications./Automatically create./Check issued tickets./Close dialogue.]
- **8822**: Create [ASSIGN 1 : [standby/make/retry/rest/suspend]/ASSIGN 2 : [standby/make/retry/rest/suspend]/ASSIGN 3 : [standby/make/retry/rest/suspend]/Close menu.]
- **8825**: Designate a value between $0 and $1.
...
```
 ...
 11: 0x0035 [0x24] CREATE_DIALOG(message_id=8772*, default_option=0*, option_flags=ExtData[1]->WorkLocal[7])
...
SUBROUTINE_0087:
 ...
 32: 0x009D [0x24] CREATE_DIALOG(message_id=8775*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0105:
 ...
 16: 0x0126 [0x24] CREATE_DIALOG(message_id=8803*, default_option=1*, option_flags=0*)
...
```
  ...
  6: 0x0169 [0x24] CREATE_DIALOG(message_id=8775*, default_option=0*, option_flags=0*)
    → "[Apply to proceed/Proceed]? [Definitely!/Not yet.]"
...
```
  ...
  5: 0x01CC [0x24] CREATE_DIALOG(message_id=8815*, default_option=0*, option_flags=0*)
 ...
 21: 0x0213 [0x24] CREATE_DIALOG(message_id=8822*, default_option=0*, option_flags=0*)
