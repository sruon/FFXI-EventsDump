...
- **8768**: Attempt which? (Auto-transport: [off/on]) [None./Sortie./././././././././././././././Toggle auto-transport.]
- **8770**: Only party members present with you in this area will be transported to [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8771**: [Apply to proceed/Proceed]? [Definitely!/Not yet.]
- **8772**: Entering [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8773**: You have chosen not to [apply to/enter] [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8785**: You will be able to call forth up to $4 alter ego[/s] given the current number of players in your party.
- **8792**: Applying to enter [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy]. You will be unable to participate if you add any more party members. Are you sure?
- **8795**: You are currently number in line to be drawn into this nightmare.
- **8796**: You are currently number in line, with in front of you.
- **8797**: Prepare yourselves! The battlefield is almost ready!
- **8798**: You are currently applying to enter [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8799**: Your number: . (Auto-transport: [off/on]) [Remove your name./Toggle auto-transport./Close dialogue.]
- **8811**: Debug menu. [Check information./View applicants./Create./Change maximum limit./Clear applications./Automatically create./Check issued tickets./Close dialogue.]
- **8818**: Create [ASSIGN 1 : [standby/make/retry/rest/suspend]/ASSIGN 2 : [standby/make/retry/rest/suspend]/ASSIGN 3 : [standby/make/retry/rest/suspend]/Close menu.]
- **8821**: Designate a value between $0 and $1.
...
```
 ...
 11: 0x0035 [0x24] CREATE_DIALOG(message_id=8768*, default_option=0*, option_flags=ExtData[1]->WorkLocal[7])
...
SUBROUTINE_0087:
 ...
 32: 0x009D [0x24] CREATE_DIALOG(message_id=8771*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0105:
 ...
 16: 0x0126 [0x24] CREATE_DIALOG(message_id=8799*, default_option=1*, option_flags=0*)
...
```
  ...
  6: 0x0169 [0x24] CREATE_DIALOG(message_id=8771*, default_option=0*, option_flags=0*)
    → "[Apply to proceed/Proceed]? [Definitely!/Not yet.]"
...
```
  ...
  5: 0x01CC [0x24] CREATE_DIALOG(message_id=8811*, default_option=0*, option_flags=0*)
 ...
 21: 0x0213 [0x24] CREATE_DIALOG(message_id=8818*, default_option=0*, option_flags=0*)
