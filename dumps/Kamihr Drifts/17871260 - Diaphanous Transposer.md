...
- **8767**: Attempt which? (Auto-transport: [off/on]) [None./Sortie./././././././././././././././Toggle auto-transport.]
- **8769**: Only party members present with you in this area will be transported to [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8770**: [Apply to proceed/Proceed]? [Definitely!/Not yet.]
- **8771**: Entering [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8772**: You have chosen not to [apply to/enter] [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8784**: You will be able to call forth up to $4 alter ego[/s] given the current number of players in your party.
- **8791**: Applying to enter [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy]. You will be unable to participate if you add any more party members. Are you sure?
- **8794**: You are currently number in line to be drawn into this nightmare.
- **8795**: You are currently number in line, with in front of you.
- **8796**: Prepare yourselves! The battlefield is almost ready!
- **8797**: You are currently applying to enter [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **8798**: Your number: . (Auto-transport: [off/on]) [Remove your name./Toggle auto-transport./Close dialogue.]
- **8810**: Debug menu. [Check information./View applicants./Create./Change maximum limit./Clear applications./Automatically create./Check issued tickets./Close dialogue.]
- **8817**: Create [ASSIGN 1 : [standby/make/retry/rest/suspend]/ASSIGN 2 : [standby/make/retry/rest/suspend]/ASSIGN 3 : [standby/make/retry/rest/suspend]/Close menu.]
- **8820**: Designate a value between $0 and $1.
...
```
 ...
 11: 0x0035 [0x24] CREATE_DIALOG(message_id=8767*, default_option=0*, option_flags=ExtData[1]->WorkLocal[7])
...
SUBROUTINE_0087:
 ...
 32: 0x009D [0x24] CREATE_DIALOG(message_id=8770*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0105:
 ...
 16: 0x0126 [0x24] CREATE_DIALOG(message_id=8798*, default_option=1*, option_flags=0*)
...
```
  ...
  6: 0x0169 [0x24] CREATE_DIALOG(message_id=8770*, default_option=0*, option_flags=0*)
    → "[Apply to proceed/Proceed]? [Definitely!/Not yet.]"
...
```
  ...
  5: 0x01CC [0x24] CREATE_DIALOG(message_id=8810*, default_option=0*, option_flags=0*)
 ...
 21: 0x0213 [0x24] CREATE_DIALOG(message_id=8817*, default_option=0*, option_flags=0*)
