...
| [101](#event-101)     | 0x0001       |    684 |            138 |
| [69](#event-69)       | 0x02AD       |     46 |              8 |
...
- **8776**: Entering [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
...
```
  ...
  1: 0x02AE [0x48] [System] [8776*]:
    → "Entering [/Sortie][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy]."
  2: 0x02B1 [0x1C] WAIT(90* ticks)
  3: 0x02B4 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
  4: 0x02C5 [0xCD] LOAD_SCHEDULED_TASK_ALT4: Load scheduler "s000" with entities [LocalPlayer, LocalPlayer], work=[194*, 0*]
