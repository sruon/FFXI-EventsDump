...
- **7505**: Which service do you request? [Buy/Sell items./Teleportation./Nothing.]
- **7506**: Do you really wish to be teleported? [Yes./Teleport with gil./Teleport with conquest points./No.]
- **7507**: Welcome to the border shop! If you trade me unused equipment, I'll add their value to your country's region points!
- **7508**: It should please you to know that I now also deal in $0. Bigger pieces will earn you more points for your nation, and I'll even toss some gil into the equation!
- **7509**: I see that your home country has control of this region. Feel free to browse through my wares.
- **7510**: I see that your home country is allies with the country in control of this region. Feel free to browse through my wares.
- **7511**: I can teleport you to your home country for $1 gil or $3 conquest [point/points].
- **7512**: Word has it that the entire set of mog tablets has been recovered. Oh, happy day! In honor of the occasion, I can teleport you to your home country free of charge.
- **7513**: I am terribly sorry, but it seems as if you do not have enough gil.
- **7514**: I am terribly sorry, but it seems as if you do not have enough conquest points.
- **7515**: However, due to your home country's lack of influence in the region, this is the only transaction I am authorized to perform with you at the moment.
- **7516**: I am looking forward to doing business with you again in the future!
...
```
 ...
 10: 0x0033 [0x1D] PRINT_EVENT_MESSAGE(message_id=7507*)
 ...
 13: 0x003C [0x1D] PRINT_EVENT_MESSAGE(message_id=7508*)
 ...
 17: 0x004B [0x24] CREATE_DIALOG(message_id=7505*, default_option=2*, option_flags=0*)
 ...
 21: 0x0063 [0x1D] PRINT_EVENT_MESSAGE(message_id=7509*)
 ...
 25: 0x0072 [0x1D] PRINT_EVENT_MESSAGE(message_id=7510*)
...
SUBROUTINE_0089:
 ...
 38: 0x00A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7511*)
    → "I can teleport you to your home country for $1 gil or $3 conquest [point/points]."
 39: 0x00A7 [0x23] WAIT_FOR_DIALOG_INTERACTION
 40: 0x00A8 [0x24] CREATE_DIALOG(message_id=7506*, default_option=3*, option_flags=1*)
 ...
 48: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7516*)
 ...
 55: 0x00ED [0x1D] PRINT_EVENT_MESSAGE(message_id=7513*)
...
SUBROUTINE_00F1:
 ...
 64: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7516*)
    → "I am looking forward to doing business with you again in the future!"
 ...
 71: 0x0131 [0x1D] PRINT_EVENT_MESSAGE(message_id=7514*)
...
```
 ...
 10: 0x019D [0x1D] PRINT_EVENT_MESSAGE(message_id=7507*)
    → "Welcome to the border shop! If you trade me unused equipment, I'll add their value to your country's region points!"
 ...
 14: 0x01AC [0x24] CREATE_DIALOG(message_id=7505*, default_option=2*, option_flags=0*)
    → "Which service do you request? [Buy/Sell items./Teleportation./Nothing.]"
 ...
 18: 0x01C4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7509*)
    → "I see that your home country has control of this region. Feel free to browse through my wares."
 ...
 22: 0x01D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7510*)
    → "I see that your home country is allies with the country in control of this region. Feel free to browse through my wares."
...
SUBROUTINE_01EA:
 ...
 35: 0x0205 [0x1D] PRINT_EVENT_MESSAGE(message_id=7512*)
 ...
 37: 0x0209 [0x24] CREATE_DIALOG(message_id=7506*, default_option=3*, option_flags=6*)
    → "Do you really wish to be teleported? [Yes./Teleport with gil./Teleport with conquest points./No.]"
 ...
 44: 0x0221 [0x1D] PRINT_EVENT_MESSAGE(message_id=7516*)
    → "I am looking forward to doing business with you again in the future!"
