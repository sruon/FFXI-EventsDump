...
- **7387**: What story would you like to be told? [On second thought, maybe later./The Decisive Heroine(pt.1)./The Decisive Heroine(pt.2)./The Decisive Heroine(pt.3)./Fall from Grace./Both Paths Taken./Pretender to the Throne(pt.1)./Pretender to the Throne(pt.2)./Banished(pt.1)./Banished(pt.2)./Banished(pt.3)./The Silent Forest.]
- **7388**: 
- **7389**: 
- **7390**: 
...
0020: 1C 04 80 1E F0 FF FF 7F  4A F0 FF FF 7F CF 12 12  ........J.......
...
```
  ...
  9: 0x0028 [0x4A] LocalPlayer looks at Grumblix (ID: 17961679/0x011212CF)
...
SUBROUTINE_00B7:
 33: 0x00B7 [0x24] CREATE_DIALOG(message_id=7387*, default_option=0*, option_flags=Work_Zone[2])
    → "What story would you like to be told? [On second thought, maybe later./The Decisive Heroine(pt.1)./The Decisive Heroine(pt.2)./The Decisive Heroine(pt.3)./Fall from Grace./Both Paths Taken./Pretender to the Throne(pt.1)./Pretender to the Throne(pt.2)./Banished(pt.1)./Banished(pt.2)./Banished(pt.3)./The Silent Forest.]"
