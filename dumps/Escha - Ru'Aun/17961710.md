...
| [9211](#event-9211)   | 0x0001       |   1283 |            163 |
...
- **7804**: Proffer which item? [None of these./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./Previous page./Next page.]
- **7805**: Commence battle? [Yes./No.]
...
```
 ...
 10: 0x0028 [0x24] CREATE_DIALOG(message_id=7804*, default_option=ExtData[1]->WorkLocal[2], option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00F5:
 ...
 55: 0x0113 [0x24] CREATE_DIALOG(message_id=7805*, default_option=1*, option_flags=0*)
