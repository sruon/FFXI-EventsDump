...
```
  ...
  1: 0x0047 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-239.942*, z=0.372*, y=-60.000*, direction=90.0°*
...
```
  ...
  1: 0x0053 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-239.998*, z=-0.389*, y=60.000*, direction=270.0°*
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0050:                                         33 01 37               3.7
0060: 0B 80 0C 80 09 80 0A 80  00                       .........       
```
...
```
  ...
  1: 0x005F [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-239.991*, z=-0.420*, y=60.000*, direction=270.0°*
