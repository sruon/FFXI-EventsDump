...
```
 ...
 15: 0x016B [0x45] LOAD_SCHEDULED_TASK: Load scheduler "z79c" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
 ...
 19: 0x0193 [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "1pd2" with entities [EventEntity, EventEntity]
 ...
 24: 0x01D6 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "z79d" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
