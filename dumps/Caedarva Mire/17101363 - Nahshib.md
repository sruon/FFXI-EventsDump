...
- **7438**: <Player>'s mercenary badge flashes.
- **7498**: Greetings, mercenary. I am % of the Immortals.
- **7499**: You are here on an Assault mission? Then you'll be wanting command verification.
- **7500**: Do you want command verification? [Yes./No./Command what...?]
- **7501**: If you have $0 [credit/credits] available from your Imperial Standing, I will recognize your ability to lead this Assault mission.
- **7502**: Receive command verification? [Yes. ($0 [credit/credits])/No.]
- **7503**: Very well. Consider your command of this mission verified.
- **7504**: With this in your possession, you will be able to pass through the runic seal and enter the Assault area. Good luck.
- **7505**: I cannot entrust leadership of a mission to a mercenary with such an unimpressive standing. Return to me when you are worthy.
- **7506**: You refuse to assume leadership? Perhaps you should make that decision before you speak to me.
- **7507**: No? Then I suggest you complete your preparations and await your leader's orders!
- **7508**: Receiving command verification will authorize you to begin an Assault mission.
- **7509**: Naturally, you are also charged with the responsibility of making sure your party members are ready to enter the Assault area.
- **7510**: However, successfully completing an Assault mission under your command will most certainly improve your standing with the Empire.
...
```
  ...
  5: 0x0015 [0x2B] Nahshib (ID: 17101363/0x0104F233) [7415*]:
  ...
  7: 0x001D [0x2B] Nahshib (ID: 17101363/0x0104F233) [7416*]:
 ...
 13: 0x0037 [0x2B] Nareema (ID: 17101364/0x0104F234) [7443*]:
 ...
 15: 0x003F [0x2B] Nareema (ID: 17101364/0x0104F234) [7444*]:
    → "Wait! I do believe you're trespassing on Imperial property!"
 16: 0x0046 [0x23] WAIT_FOR_DIALOG_INTERACTION
 17: 0x0047 [0x2B] Nareema (ID: 17101364/0x0104F234) [7445*]:
    → "Get out of here!"
...
```
  ...
  5: 0x0066 [0x2B] Nahshib (ID: 17101363/0x0104F233) [7437*]:
 ...
 11: 0x0080 [0x2B] Nareema (ID: 17101364/0x0104F234) [7462*]:
...
```
  ...
  5: 0x009E [0x48] [System] [7438*]:
    → "<Player>'s mercenary badge flashes."
  6: 0x00A1 [0x1C] WAIT(90* ticks)
  7: 0x00A4 [0x2B] Nahshib (ID: 17101363/0x0104F233) [7439*]:
  ...
  9: 0x00AC [0x2B] Nahshib (ID: 17101363/0x0104F233) [7440*]:
 ...
 15: 0x00C6 [0x48] [System] [7438*]:
    → "<Player>'s mercenary badge flashes."
 16: 0x00C9 [0x1C] WAIT(90* ticks)
 17: 0x00CC [0x2B] Nareema (ID: 17101364/0x0104F234) [7463*]:
 ...
 19: 0x00D4 [0x2B] Nareema (ID: 17101364/0x0104F234) [7464*]:
...
```
  ...
  9: 0x0100 [0x1D] PRINT_EVENT_MESSAGE(message_id=7501*)
 ...
 11: 0x0104 [0x24] CREATE_DIALOG(message_id=7502*, default_option=1*, option_flags=0*)
 ...
 15: 0x011C [0x1D] PRINT_EVENT_MESSAGE(message_id=7505*)
 ...
 19: 0x0124 [0x1D] PRINT_EVENT_MESSAGE(message_id=7503*)
    → "Very well. Consider your command of this mission verified."
 20: 0x0127 [0x23] WAIT_FOR_DIALOG_INTERACTION
 21: 0x0128 [0x1D] PRINT_EVENT_MESSAGE(message_id=7504*)
...
SUBROUTINE_0131:
 ...
 26: 0x013C [0x1D] PRINT_EVENT_MESSAGE(message_id=7506*)
...
SUBROUTINE_0143:
 ...
 31: 0x014E [0x1D] PRINT_EVENT_MESSAGE(message_id=7507*)
 ...
 39: 0x0165 [0x1D] PRINT_EVENT_MESSAGE(message_id=7510*)
...
```
  ...
  1: 0x0170 [0x2B] Nahshib (ID: 17101363/0x0104F233) [7595*]:
...
```
  ...
  5: 0x0265 [0x2B] Nahshib (ID: 17101363/0x0104F233) [7821*]:
    → "You lost your $3? Typical mercenary..."
  6: 0x026C [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x026D [0x2B] Nahshib (ID: 17101363/0x0104F233) [7822*]:
