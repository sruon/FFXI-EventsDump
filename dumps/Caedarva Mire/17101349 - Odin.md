...
| [65535.9](#event-655359) | 0x0051       |      4 |              2 |
...
|       2 | 0x0080      |         128 |
|       3 | 0x2EE6C     |      192108 |
|       4 | 0xFFFA1C2F  |  4294581295 |
|       5 | 0xFFFFC25C  |  4294951516 |
|       6 | 0x0800      |        2048 |
...
```
  ...
  1: 0x0047 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=192.108*, z=-386.001*, y=-15.780*, direction=180.0°*
...
```
  0: 0x0051 [0xC0] EventEntity->Render.Flags3 |= 0x1000 // Set bit 12 (from 1*)
