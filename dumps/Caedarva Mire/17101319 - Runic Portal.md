...
| [131](#event-131)     | 0x0001       |    298 |             38 |
| [124](#event-124)     | 0x012B       |    305 |             41 |
...
- **7342**: <Player> has attuned [himself/herself] to the runic portal, and opened a path from the Azouph Isle staging point to the Chamber of Passage.
...
0030: 1C 04 80 38 05 80 29 01  F0 FF FF 7F 12 45 06 80  ...8..)......E..
0040: F0 FF FF 7F F0 FF FF 7F  7A 37 39 63 02 80 45 03  ........z79c..E.
0050: 80 F0 FF FF 7F F0 FF FF  7F 66 64 69 31 02 80 1C  .........fdi1...
0060: 04 80 2D F8 FF FF 7F F8  FF FF 7F 31 70 64 32 1C  ..-........1pd2.
...
00B0: 7A 37 39 64 02 80 29 01  F0 FF FF 7F 03 1C 09 80  z79d..).........
...
```
 ...
 12: 0x0036 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x12)
 13: 0x003D [0x45] LOAD_SCHEDULED_TASK: Load scheduler "z79c" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
 ...
 16: 0x0062 [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "1pd2" with entities [EventEntity, EventEntity]
 ...
 21: 0x00A5 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "z79d" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
...
```
 ...
 17: 0x018D [0x48] [System] [7342*]:
    → "<Player> has attuned [himself/herself] to the runic portal, and opened a path from the Azouph Isle staging point to the Chamber of Passage."
