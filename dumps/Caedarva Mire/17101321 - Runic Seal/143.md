...
00B0: 07 80 07 80 00 BF 00 03  02 00 0A 80 01 DF 00 02  ................
...
0140: 00 10 09 80 00 4A 01 01  55 01 02 00 10 07 80 00  .....J..U.......
...
01B0: A7 01 00 00 03 01 10 03  80 40 03 80 07 80 01 10  .........@......
01C0: 00 00 02 00 00 0B 80 00  CD 02 03 06 10 01 00 48  ...............H
01D0: 1B 80 02 07 80 03 80 00  39 02 2D F8 FF FF 7F F8  ........9.-.....
...
0230: 77 68 69 31 03 80 01 CC  02 02 07 80 01 80 00 44  whi1...........D
0240: 02 01 CC 02 02 07 80 09  80 00 4F 02 01 CC 02 02  ..........O.....
0250: 07 80 07 80 00 B6 02 2D  F8 FF FF 7F F8 FF FF 7F  .......-........
...
02B0: 31 03 80 01 CC 02 02 07  80 0B 80 00 C1 02 01 CC  1...............
02C0: 02 02 07 80 0C 80 00 CC  02 01 CC 02 30 01 E4 02  ............0...
...
SUBROUTINE_017B:
 ...
 76: 0x01D2 [0x02] IF !(3* == 0*) GOTO 0x0239
 77: 0x01DA [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2pc2")
 78: 0x01E7 [0x1C] WAIT(540* ticks)
 79: 0x01EA [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x03)
 80: 0x01F1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="who1", work_offset2=0*)
 81: 0x0202 [0x1C] WAIT(60* ticks)
 82: 0x0205 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2pck")
 83: 0x0212 [0x1C] WAIT(30* ticks)
 84: 0x0215 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2pc1")
 85: 0x0222 [0x1C] WAIT(30* ticks)
 86: 0x0225 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="whi1", work_offset2=0*)
 87: 0x0236 [0x01] GOTO 0x02CC

SUBROUTINE_0239:
 88: 0x0239 [0x02] IF !(3* == 1*) GOTO 0x0244
 89: 0x0241 [0x01] GOTO 0x02CC

SUBROUTINE_0244:
 90: 0x0244 [0x02] IF !(3* == 2*) GOTO 0x024F
 91: 0x024C [0x01] GOTO 0x02CC

SUBROUTINE_024F:
 92: 0x024F [0x02] IF !(3* == 3*) GOTO 0x02B6
 93: 0x0257 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2pb2")
 94: 0x0264 [0x1C] WAIT(540* ticks)
 95: 0x0267 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x03)
 96: 0x026E [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="who1", work_offset2=0*)
 97: 0x027F [0x1C] WAIT(60* ticks)
 98: 0x0282 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2pbk")
 99: 0x028F [0x1C] WAIT(30* ticks)
100: 0x0292 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2pb1")
101: 0x029F [0x1C] WAIT(30* ticks)
102: 0x02A2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="whi1", work_offset2=0*)
103: 0x02B3 [0x01] GOTO 0x02CC

SUBROUTINE_02B6:
104: 0x02B6 [0x02] IF !(3* == 4*) GOTO 0x02C1
105: 0x02BE [0x01] GOTO 0x02CC

SUBROUTINE_02C1:
106: 0x02C1 [0x02] IF !(3* == 6*) GOTO 0x02CC
