...
| [162](#event-162)     | 0x0001       |     37 |             16 |
| [163](#event-163)     | 0x0026       |    158 |             30 |
| [164](#event-164)     | 0x00C4       |    237 |             45 |
| [170](#event-170)     | 0x01B1       |     14 |              4 |
| [171](#event-171)     | 0x01BF       |      4 |              2 |
| [172](#event-172)     | 0x01C3       |     14 |              4 |
| [173](#event-173)     | 0x01D1       |      4 |              2 |
...
0050: 7F F0 FF FF 7F 61 6C 6B  32 08 80 29 01 F0 FF FF  .....alk2..)....
0060: 7F 14 45 07 80 F0 FF FF  7F F0 FF FF 7F 66 64 69  ..E..........fdi
0070: 31 08 80 1C 09 80 1D 0C  80 1C 09 80 29 01 0F F2  1...........)...
0080: 04 01 04 29 01 0F F2 04  01 05 29 01 0B F2 04 01  ...)......).....
0090: 01 1C 09 80 27 01 F0 FF  FF 7F 15 1C 0D 80 45 07  ....'.........E.
00A0: 80 F0 FF FF 7F F0 FF FF  7F 66 64 6F 31 08 80 1C  .........fdo1...
00B0: 09 80 03 01 10 04 80 29  01 0B F2 04 01 02 46 00  .......)......F.
00C0: 20 00 21 00                                        .!.            
```
...
```
 ...
 10: 0x004A [0x45] LOAD_SCHEDULED_TASK: Load scheduler "alk2" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
 11: 0x005B [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x14)
 ...
 14: 0x0076 [0x1D] PRINT_EVENT_MESSAGE(message_id=7356*)
    → "Very well. You may proceed."
 15: 0x0079 [0x1C] WAIT(60* ticks)
 16: 0x007C [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Tyamah (ID: 17101327/0x0104F20F), tag_num=0x04)
 17: 0x0083 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Tyamah (ID: 17101327/0x0104F20F), tag_num=0x05)
 18: 0x008A [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Door_276 (ID: 17101323/0x0104F20B), tag_num=0x01)
 19: 0x0091 [0x1C] WAIT(60* ticks)
 20: 0x0094 [0x27] REQ_SET(priority=0x01, entity_id=LocalPlayer, tag_num=0x15)
 ...
 25: 0x00B7 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Door_276 (ID: 17101323/0x0104F20B), tag_num=0x02)
...
0100: 45 0B 80 F0 FF FF 7F F0  FF FF 7F 61 6C 6B 32 08  E..........alk2.
0110: 80 29 01 F0 FF FF 7F 18  29 01 F0 FF FF 7F 16 45  .)......)......E
0120: 07 80 F0 FF FF 7F F0 FF  FF 7F 66 64 69 31 08 80  ..........fdi1..
0130: 1C 09 80 29 01 0F F2 04  01 04 29 01 0F F2 04 01  ...)......).....
0140: 05 29 01 0B F2 04 01 01  1C 09 80 27 01 F0 FF FF  .).........'....
0150: 7F 17 1C 10 80 29 01 0F  F2 04 01 06 29 01 0F F2  .....)......)...
0160: 04 01 07 45 07 80 F0 FF  FF 7F F0 FF FF 7F 66 64  ...E..........fd
0170: 6F 31 08 80 1C 09 80 03  01 10 04 80 29 01 0B F2  o1..........)...
...
```
  ...
  5: 0x00CE [0x1D] PRINT_EVENT_MESSAGE(message_id=7357*)
  ...
  7: 0x00D2 [0x24] CREATE_DIALOG(message_id=7358*, default_option=1*, option_flags=0*)
 ...
 17: 0x0100 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "alk2" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
 18: 0x0111 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x18)
 19: 0x0118 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x16)
 ...
 22: 0x0133 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Tyamah (ID: 17101327/0x0104F20F), tag_num=0x04)
 23: 0x013A [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Tyamah (ID: 17101327/0x0104F20F), tag_num=0x05)
 24: 0x0141 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Door_276 (ID: 17101323/0x0104F20B), tag_num=0x01)
 25: 0x0148 [0x1C] WAIT(60* ticks)
 26: 0x014B [0x27] REQ_SET(priority=0x01, entity_id=LocalPlayer, tag_num=0x17)
 27: 0x0152 [0x1C] WAIT(180* ticks)
 28: 0x0155 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Tyamah (ID: 17101327/0x0104F20F), tag_num=0x06)
 29: 0x015C [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Tyamah (ID: 17101327/0x0104F20F), tag_num=0x07)
 ...
 33: 0x017C [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Door_276 (ID: 17101323/0x0104F20B), tag_num=0x02)
...
```
  ...
  1: 0x01B4 [0x1F] MOVE_ENTITY: EventEntity moves to X=320.468*, Z=-702.003*, Y=3.999*
...
```
  0: 0x01BF [0x39] SET_ENTITY_DIRECTION(direction=16.9°*)
...
```
  ...
  1: 0x01C6 [0x1F] MOVE_ENTITY: EventEntity moves to X=321.003*, Z=-700.011*, Y=1.124*
