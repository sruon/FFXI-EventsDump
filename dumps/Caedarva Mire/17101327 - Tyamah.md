...
```
 ...
 14: 0x0076 [0x1D] PRINT_EVENT_MESSAGE(message_id=7355*)
...
```
  ...
  5: 0x00CE [0x1D] PRINT_EVENT_MESSAGE(message_id=7356*)
  ...
  7: 0x00D2 [0x24] CREATE_DIALOG(message_id=7357*, default_option=1*, option_flags=0*)
