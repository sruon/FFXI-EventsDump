...
| [222](#event-222)     | 0x0001       |     37 |             16 |
| [223](#event-223)     | 0x0026       |    158 |             30 |
| [224](#event-224)     | 0x00C4       |    237 |             45 |
| [230](#event-230)     | 0x01B1       |     14 |              4 |
| [231](#event-231)     | 0x01BF       |      4 |              2 |
| [232](#event-232)     | 0x01C3       |     14 |              4 |
| [233](#event-233)     | 0x01D1       |      4 |              2 |
...
0050: 7F F0 FF FF 7F 61 6C 6B  35 08 80 29 01 F0 FF FF  .....alk5..)....
0060: 7F 23 45 07 80 F0 FF FF  7F F0 FF FF 7F 66 64 69  .#E..........fdi
0070: 31 08 80 1C 09 80 1D 0C  80 1C 09 80 29 01 12 F2  1...........)...
0080: 04 01 04 29 01 12 F2 04  01 05 29 01 0E F2 04 01  ...)......).....
0090: 01 1C 09 80 27 01 F0 FF  FF 7F 24 1C 0D 80 45 07  ....'.....$...E.
00A0: 80 F0 FF FF 7F F0 FF FF  7F 66 64 6F 31 08 80 1C  .........fdo1...
00B0: 09 80 03 01 10 04 80 29  01 0E F2 04 01 02 46 00  .......)......F.
00C0: 20 00 21 00                                        .!.            
```
...
```
 ...
 10: 0x004A [0x45] LOAD_SCHEDULED_TASK: Load scheduler "alk5" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
 11: 0x005B [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x23)
 ...
 16: 0x007C [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Kwadaaf (ID: 17101330/0x0104F212), tag_num=0x04)
 17: 0x0083 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Kwadaaf (ID: 17101330/0x0104F212), tag_num=0x05)
 18: 0x008A [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Door_279 (ID: 17101326/0x0104F20E), tag_num=0x01)
 19: 0x0091 [0x1C] WAIT(60* ticks)
 20: 0x0094 [0x27] REQ_SET(priority=0x01, entity_id=LocalPlayer, tag_num=0x24)
 ...
 25: 0x00B7 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Door_279 (ID: 17101326/0x0104F20E), tag_num=0x02)
...
0100: 45 0B 80 F0 FF FF 7F F0  FF FF 7F 61 6C 6B 35 08  E..........alk5.
0110: 80 29 01 F0 FF FF 7F 27  29 01 F0 FF FF 7F 25 45  .).....').....%E
0120: 07 80 F0 FF FF 7F F0 FF  FF 7F 66 64 69 31 08 80  ..........fdi1..
0130: 1C 09 80 29 01 12 F2 04  01 04 29 01 12 F2 04 01  ...)......).....
0140: 05 29 01 0E F2 04 01 01  1C 09 80 27 01 F0 FF FF  .).........'....
0150: 7F 26 1C 10 80 29 01 12  F2 04 01 06 29 01 12 F2  .&...)......)...
0160: 04 01 07 45 07 80 F0 FF  FF 7F F0 FF FF 7F 66 64  ...E..........fd
0170: 6F 31 08 80 1C 09 80 03  01 10 04 80 29 01 0E F2  o1..........)...
...
```
 ...
 17: 0x0100 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "alk5" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
 18: 0x0111 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x27)
 19: 0x0118 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x25)
 ...
 22: 0x0133 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Kwadaaf (ID: 17101330/0x0104F212), tag_num=0x04)
 23: 0x013A [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Kwadaaf (ID: 17101330/0x0104F212), tag_num=0x05)
 24: 0x0141 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Door_279 (ID: 17101326/0x0104F20E), tag_num=0x01)
 25: 0x0148 [0x1C] WAIT(60* ticks)
 26: 0x014B [0x27] REQ_SET(priority=0x01, entity_id=LocalPlayer, tag_num=0x26)
 27: 0x0152 [0x1C] WAIT(180* ticks)
 28: 0x0155 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Kwadaaf (ID: 17101330/0x0104F212), tag_num=0x06)
 29: 0x015C [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Kwadaaf (ID: 17101330/0x0104F212), tag_num=0x07)
 ...
 33: 0x017C [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Door_279 (ID: 17101326/0x0104F20E), tag_num=0x02)
...
```
  ...
  1: 0x01B4 [0x1F] MOVE_ENTITY: EventEntity moves to X=-638.966*, Z=-262.392*, Y=15.999*
...
```
  ...
  1: 0x01C6 [0x1F] MOVE_ENTITY: EventEntity moves to X=-639.000*, Z=-260.000*, Y=13.323*
