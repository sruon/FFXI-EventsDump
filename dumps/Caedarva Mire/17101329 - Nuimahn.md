...
| [202](#event-202)     | 0x0001       |     37 |             16 |
| [203](#event-203)     | 0x0026       |    158 |             30 |
| [204](#event-204)     | 0x00C4       |    237 |             45 |
| [210](#event-210)     | 0x01B1       |     14 |              4 |
| [211](#event-211)     | 0x01BF       |      4 |              2 |
| [212](#event-212)     | 0x01C3       |     14 |              4 |
| [213](#event-213)     | 0x01D1       |      4 |              2 |
...
0050: 7F F0 FF FF 7F 61 6C 6B  34 08 80 29 01 F0 FF FF  .....alk4..)....
0060: 7F 1E 45 07 80 F0 FF FF  7F F0 FF FF 7F 66 64 69  ..E..........fdi
0070: 31 08 80 1C 09 80 1D 0C  80 1C 09 80 29 01 11 F2  1...........)...
0080: 04 01 04 29 01 11 F2 04  01 05 29 01 0D F2 04 01  ...)......).....
0090: 01 1C 09 80 27 01 F0 FF  FF 7F 1F 1C 0D 80 45 07  ....'.........E.
00A0: 80 F0 FF FF 7F F0 FF FF  7F 66 64 6F 31 08 80 1C  .........fdo1...
00B0: 09 80 03 01 10 04 80 29  01 0D F2 04 01 02 46 00  .......)......F.
00C0: 20 00 21 00                                        .!.            
```
...
```
 ...
 10: 0x004A [0x45] LOAD_SCHEDULED_TASK: Load scheduler "alk4" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
 11: 0x005B [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x1E)
 ...
 16: 0x007C [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Nuimahn (ID: 17101329/0x0104F211), tag_num=0x04)
 17: 0x0083 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Nuimahn (ID: 17101329/0x0104F211), tag_num=0x05)
 18: 0x008A [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Door_278 (ID: 17101325/0x0104F20D), tag_num=0x01)
 19: 0x0091 [0x1C] WAIT(60* ticks)
 20: 0x0094 [0x27] REQ_SET(priority=0x01, entity_id=LocalPlayer, tag_num=0x1F)
 ...
 25: 0x00B7 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Door_278 (ID: 17101325/0x0104F20D), tag_num=0x02)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
01B0:    32 12 80 1F 00 13 80  14 80 08 80 1F 01 00      2............. 
```
...
```
  ...
  1: 0x01B4 [0x1F] MOVE_ENTITY: EventEntity moves to X=-381.991*, Z=-280.931*, Y=0.000*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
01C0:          32 12 80 1F 00  15 80 16 80 17 80 1F 01     2............
01D0: 00                                                .               
```
...
```
  ...
  1: 0x01C6 [0x1F] MOVE_ENTITY: EventEntity moves to X=-380.000*, Z=-281.000*, Y=-2.669*
...
```
  0: 0x01D1 [0x39] SET_ENTITY_DIRECTION(direction=16.9°*)
