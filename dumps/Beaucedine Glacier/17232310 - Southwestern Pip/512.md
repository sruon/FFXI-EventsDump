...
# Dead code (unreachable instructions):
     ...
     0x0113 [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 2332111744/0x8B013380))
     0x0118 [0x11] 0x80 >>= 0x0100
     0x011D [0x00] END_REQSTACK()
     0x011E [0x02] IF !(0x5700 > 0x7461) GOTO 0x0072
     0x0126 [0x00] END_REQSTACK()
     0x0127 [0x00] END_REQSTACK()
     0x0128 [0x00] END_REQSTACK()
     0x0129 [0x00] END_REQSTACK()
