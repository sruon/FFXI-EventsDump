...
0010: 71 F1 06 01 03 00 00 00  80 02 02 10 01 80 01 28  q..............(
...
```
  ...
  4: 0x000B [0x4A] LocalPlayer looks at Ramblix (ID: 17232241/0x0106F171)
 ...
 15: 0x005A [0x1D] PRINT_EVENT_MESSAGE(message_id=7855*)
 ...
 17: 0x005E [0x1D] PRINT_EVENT_MESSAGE(message_id=7856*)
 ...
 19: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=7857*)
...
SUBROUTINE_0092:
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=7865*, default_option=0*, option_flags=0x00)
 ...
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7866*, default_option=0*, option_flags=0x1002)
    → "What story would you like to be told?\u0007\u000BOn second thought, maybe later.\u0007Love and Ice.\u0007Dynamis - The Shrouded Land.\u0007Dynamis Interloper.\u0007Ragnorok.\u0007Desires of Emptiness.\u0007Tuning Out.\u0007Blessed Radiance(pt.1).\u0007Blessed Radiance(pt.2).\u0007Run, Excenmille, Run!(pt.1).\u0007Run, Excenmille, Run!(pt.2).\u0007Of Knights and Orcs(pt.1).\u0007Of Knights and Orcs(pt.2).\u007F1\u0000\u0007"
 ...
 37: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7859*)
...
SUBROUTINE_00DE:
 ...
 45: 0x00E6 [0x24] CREATE_DIALOG(message_id=7867*, default_option=0*, option_flags=0x1003)
    → "\u007F1\u0000\u0007"
 ...
 50: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7859*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_0122:
 ...
 58: 0x012A [0x24] CREATE_DIALOG(message_id=7868*, default_option=0*, option_flags=0x1004)
    → "\u007F1\u0000\u0007"
 ...
 63: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=7859*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_0166:
 ...
 71: 0x016E [0x24] CREATE_DIALOG(message_id=7869*, default_option=0*, option_flags=0x1005)
    → "\u007F1\u0000\u0007"
 ...
 76: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=7859*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_01AA:
 ...
 85: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7859*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_01C6:
 89: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7858*)
    → "Now, listen close...\u007F1\u0000\u0007"
