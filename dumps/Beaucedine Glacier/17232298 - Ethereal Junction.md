...
- **7396**: Toggle which flag? [UZ2: Set position./U1: Flag - Trigger gathering./U2: Key item - Bomb./U3: Key item - Glacier key./U4: Key item - Snowfield map./UZ1: Flag - Spoke with moogle./UZ2: Flag - Spoke with goblin./UZ5: Toggle markers./Reset all.]
...
```
  ...
  2: 0x04DE [0x24] CREATE_DIALOG(message_id=7396*, default_option=0*, option_flags=0*)
