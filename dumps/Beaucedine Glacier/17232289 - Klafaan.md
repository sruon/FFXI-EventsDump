...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0000:       A5 01 6C A1 F1 06  01 00 80 01 80 37 02 80    ..l........7..
...
```
  ...
  1: 0x0004 [0x6C] FADE_ENTITY_COLOR(entity_id=Klafaan (ID: 17232289/0x0106F1A1), end_alpha=0*, fade_time=60*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0010:                      61  00 6C A1 F1 06 01 06 80         a.l......
...
```
  ...
  1: 0x0019 [0x6C] FADE_ENTITY_COLOR(entity_id=Klafaan (ID: 17232289/0x0106F1A1), end_alpha=80*, fade_time=120*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0040:             6C A1 F1 06  01 00 80 10 80 00            l.........  
```

#### Opcodes

```
  0: 0x0044 [0x6C] FADE_ENTITY_COLOR(entity_id=Klafaan (ID: 17232289/0x0106F1A1), end_alpha=0*, fade_time=300*)
