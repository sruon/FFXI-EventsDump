...
SUBROUTINE_00BE:
 ...
 38: 0x00D4 [0x24] CREATE_DIALOG(message_id=8710*, default_option=0*, option_flags=0x01)
...
SUBROUTINE_014A:
 ...
 67: 0x015F [0x24] CREATE_DIALOG(message_id=8711*, default_option=0*, option_flags=0x03)
...
SUBROUTINE_0175:
 ...
 83: 0x01A5 [0x48] [System] [10761*]:
    → "Target level range: 
\u0005\u0001`
\u0006.\u007F1\u0000\u0007"
 84: 0x01A8 [0x23] WAIT_FOR_DIALOG_INTERACTION
 85: 0x01A9 [0x03] ExtData[1]->WorkLocal[7] = 10766*
 ...
 89: 0x01B7 [0x24] CREATE_DIALOG(message_id=10762*, default_option=1*, option_flags=0*)
 ...
 92: 0x01C7 [0x48] [System] [11810*]:
    → "Set training regime to automatically repeat upon completion?\u0000\u0007"
 93: 0x01CA [0x23] WAIT_FOR_DIALOG_INTERACTION
 94: 0x01CB [0x24] CREATE_DIALOG(message_id=11811*, default_option=0*, option_flags=0*)
...
119: 0x023B [0x03] ExtData[1]->WorkLocal[7] = 9737*
...
127: 0x025E [0x48] [System] [10761*]:
    → "Target level range: 
\u0005\u0001`
\u0006.\u007F1\u0000\u0007"
128: 0x0261 [0x23] WAIT_FOR_DIALOG_INTERACTION
129: 0x0262 [0x03] ExtData[1]->WorkLocal[7] = 10766*
...
143: 0x02A5 [0x24] CREATE_DIALOG(message_id=11793*, default_option=1*, option_flags=0*)
    → "Are you certain?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
...
175: 0x0345 [0x24] CREATE_DIALOG(message_id=11798*, default_option=0*, option_flags=0*)
    → "Which one? (You have 
...
221: 0x0414 [0x24] CREATE_DIALOG(message_id=10762*, default_option=1*, option_flags=0*)
    → "Undertake this training regime?\u0007\u000BBring it on!\u0007No, wait...\u007F1\u0000\u0007"
...
257: 0x04B8 [0x24] CREATE_DIALOG(message_id=11792*, default_option=0*, option_flags=0x02)
    → "Which one? (You have 
...
312: 0x05D2 [0x24] CREATE_DIALOG(message_id=11792*, default_option=0*, option_flags=0x02)
    → "Which one? (You have 
\u0008 \u007F\u0012\u0008[tab/tabs]).\u0007\u000BNothing for now.\u0007Repatriation (
	).\u0007White magic: Reraise (
...
355: 0x06B8 [0x03] ExtData[1]->WorkLocal[0] = 11794*
356: 0x06BD [0x01] GOTO 0x06C5

SUBROUTINE_06C0:
357: 0x06C0 [0x03] ExtData[1]->WorkLocal[0] = 11793*
