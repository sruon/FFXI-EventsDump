...
SUBROUTINE_00CC:
 ...
 38: 0x00D4 [0x24] CREATE_DIALOG(message_id=8710*, default_option=0*, option_flags=ExtData[1]->WorkLocal[1])
...
SUBROUTINE_014D:
 ...
 67: 0x015F [0x24] CREATE_DIALOG(message_id=8711*, default_option=0*, option_flags=ExtData[1]->WorkLocal[3])
...
257: 0x04B8 [0x24] CREATE_DIALOG(message_id=11792*, default_option=0*, option_flags=ExtData[1]->WorkLocal[2])
    → "Which one? (You have 
...
312: 0x05D2 [0x24] CREATE_DIALOG(message_id=11792*, default_option=0*, option_flags=ExtData[1]->WorkLocal[2])
    → "Which one? (You have 
\u0008 \u007F\u0012\u0008[tab/tabs]).\u0007\u000BNothing for now.\u0007Repatriation (
	).\u0007White magic: Reraise (
