...
| [102](#event-102)          | 0x0481       |     29 |             10 |
| [106](#event-106)          | 0x049E       |     33 |             12 |
| [111](#event-111)          | 0x04BF       |     37 |             14 |
| [213](#event-213)          | 0x04E4       |     33 |             12 |
| [217](#event-217)          | 0x0505       |     33 |             12 |
| [216](#event-216)          | 0x0526       |     37 |             14 |
| [207](#event-207)          | 0x054B       |      9 |              3 |
| [65535.71](#event-6553571) | 0x0554       |     10 |              2 |
| [210](#event-210)          | 0x055E       |     47 |             14 |
...
- **7451**: B-b-brrrrrr... I f-f-feel like a P-P-Potete p-p-popsicle...
- **7467**: This must be a pretty unbelievable place for a city dweller like you. But if you think this is strangey-wangey, just waitaru you see the ruins of Fei'Yin!
- **7468**: We are investigating the mystery that shrouds this land, just as the Multinational Expedition members did 30 years ago.
- **7476**: The Multinational Expedition of thirty years past lost two of their members in this area.
- **7477**: Mr. Iru-Kuiru, who had joined the company from Windurst, managed to return to the Federation safely...but lost his life through highly unusual circumstances somewhere to the south.
- **7478**: You don't think...? Could it have been a curse!? B-b-brrrrr...!
- **8320**: That little girl was in bad shape. By the time we got to her, she was as hard as ice. You could use her crikey-spiky hair as nails! I know, because I tried!
- **8321**: To make sure she didn't croak, we sent her back to Windurst, a la Warp II!
- **8322**: Guess what? The guy that brought the girl to us--I saw him asking some adventurers to take him to Bastok! He said he was looking for his companions and that it was urgent!
- **8323**: I wonder why he lied to Torino and said that he was going to travel north. My mommy-wommy told me that only thieves and criminals lie...
- **8329**: So you sprintarued down here to pokey-wokey your nose into Pso'Xja as soon as you heard it was opened up to adventurers?
- **8330**: Not that I think you'll get that far, but beware of the big gate in the deepestaru section of the ruins.
- **8331**: We were warned by the guiding star that led us to Windurst to never ever mess aboutaru with the ruins of Pso'Xja.
- **8390**: That Mithra mentioned that a protocrystal had been shattered into itty-bitty pieces. How is that possible?
- **8391**: If we reportaru this to Minister Rukususu, she'll make us venture-wenture into the Uleguerand Range! Brrr!
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0480:    1E F0 FF FF 7F 6F 70  29 08 6B F1 06 01 01 1D   .....op).k.....
0490: 0D 80 23 29 08 6B F1 06  01 02 20 00 21 00        ..#).k.... .!.  
```
...
```
  ...
  3: 0x0488 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Potete (ID: 17232235/0x0106F16B), tag_num=0x01)
  4: 0x048F [0x1D] PRINT_EVENT_MESSAGE(message_id=7451*)
    → "B-b-brrrrrr... I f-f-feel like a P-P-Potete p-p-popsicle..."
  5: 0x0492 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0493 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Potete (ID: 17232235/0x0106F16B), tag_num=0x02)
...
```
  ...
  4: 0x04AC [0x1D] PRINT_EVENT_MESSAGE(message_id=7467*)
    → "This must be a pretty unbelievable place for a city dweller like you. But if you think this is strangey-wangey, just waitaru you see the ruins of Fei'Yin!"
  5: 0x04AF [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x04B0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7468*)
    → "We are investigating the mystery that shrouds this land, just as the Multinational Expedition members did 30 years ago."
...
```
  ...
  4: 0x04CD [0x1D] PRINT_EVENT_MESSAGE(message_id=7476*)
    → "The Multinational Expedition of thirty years past lost two of their members in this area."
  5: 0x04D0 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x04D1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7477*)
    → "Mr. Iru-Kuiru, who had joined the company from Windurst, managed to return to the Federation safely...but lost his life through highly unusual circumstances somewhere to the south."
  ...
  9: 0x04DC [0x1D] PRINT_EVENT_MESSAGE(message_id=7478*)
    → "You don't think...? Could it have been a curse!? B-b-brrrrr...!"
...
```
  ...
  4: 0x04F2 [0x1D] PRINT_EVENT_MESSAGE(message_id=8322*)
    → "Guess what? The guy that brought the girl to us--I saw him asking some adventurers to take him to Bastok! He said he was looking for his companions and that it was urgent!"
  5: 0x04F5 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x04F6 [0x1D] PRINT_EVENT_MESSAGE(message_id=8323*)
    → "I wonder why he lied to Torino and said that he was going to travel north. My mommy-wommy told me that only thieves and criminals lie..."
...
```
  ...
  4: 0x0513 [0x1D] PRINT_EVENT_MESSAGE(message_id=8320*)
    → "That little girl was in bad shape. By the time we got to her, she was as hard as ice. You could use her crikey-spiky hair as nails! I know, because I tried!"
  5: 0x0516 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0517 [0x1D] PRINT_EVENT_MESSAGE(message_id=8321*)
    → "To make sure she didn't croak, we sent her back to Windurst, a la Warp II!"
...
```
  ...
  4: 0x0534 [0x1D] PRINT_EVENT_MESSAGE(message_id=8329*)
    → "So you sprintarued down here to pokey-wokey your nose into Pso'Xja as soon as you heard it was opened up to adventurers?"
  5: 0x0537 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0538 [0x1D] PRINT_EVENT_MESSAGE(message_id=8330*)
    → "Not that I think you'll get that far, but beware of the big gate in the deepestaru section of the ruins."
  7: 0x053B [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x053C [0x1D] PRINT_EVENT_MESSAGE(message_id=8331*)
    → "We were warned by the guiding star that led us to Windurst to never ever mess aboutaru with the ruins of Pso'Xja."
...
```
  0: 0x054B [0x94] EventEntity->Render.Flags3 ^= 0x01
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0550:             37 1A 80 1B  80 1C 80 1D 80 00            7.........  
```

#### Opcodes

```
  0: 0x0554 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=105.183*, z=140.951*, y=-20.249*, direction=341.3°*
...
```
  ...
  4: 0x056C [0x1D] PRINT_EVENT_MESSAGE(message_id=8390*)
    → "That Mithra mentioned that a protocrystal had been shattered into itty-bitty pieces. How is that possible?"
  ...
  8: 0x057E [0x1D] PRINT_EVENT_MESSAGE(message_id=8391*)
    → "If we reportaru this to Minister Rukususu, she'll make us venture-wenture into the Uleguerand Range! Brrr!"
