...
```
  ...
  9: 0x001F [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=10*, entity1=Dariah (ID: 17232208/0x0106F150), entity2=Dariah (ID: 17232208/0x0106F150), action=0xFEFEFE00)
 10: 0x002E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=11*, entity1=Dariah (ID: 17232208/0x0106F150), entity2=Dariah (ID: 17232208/0x0106F150), action=0xFEFEFE00)
 11: 0x003D [0x38] SET_CLIENT_EVENT_MODE(mode=3*)
 12: 0x0040 [0x27] REQ_SET(priority=0x10, entity_id=LocalPlayer, tag_num=0x02)
 13: 0x0047 [0x45] LOAD_SCHEDULED_TASK(work_offset1=11*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="sg01", work_offset2=0*)
 14: 0x0058 [0x1A] CALL_SUBROUTINE(address=0x0293)
 15: 0x005B [0x2A] GET_REQ_LEVEL(level=16, entity_id=LocalPlayer)
 16: 0x0061 [0x55] WAIT_LOAD_SCHEDULER(work_offset=11*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="sg01")
 17: 0x0070 [0x27] REQ_SET(priority=0x10, entity_id=Dariah (ID: 17232208/0x0106F150), tag_num=0x02)
 18: 0x0077 [0x45] LOAD_SCHEDULED_TASK(work_offset1=11*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="sg02", work_offset2=0*)
 19: 0x0088 [0x55] WAIT_LOAD_SCHEDULER(work_offset=11*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="sg02")
 20: 0x0097 [0x45] LOAD_SCHEDULED_TASK(work_offset1=11*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="sg03", work_offset2=0*)
 21: 0x00A8 [0x1C] WAIT(30* ticks)
 22: 0x00AB [0x2B] Dariah (ID: 17232208/0x0106F150) [7439*]:
    → "Hey! What are you doing there?\u007F1\u0000\u0007"
 ...
 31: 0x00D8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=11*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="sg04", work_offset2=0*)
 ...
 34: 0x00F2 [0x55] WAIT_LOAD_SCHEDULER(work_offset=11*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="sg04")
 35: 0x0101 [0x45] LOAD_SCHEDULED_TASK(work_offset1=11*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="sg05", work_offset2=0*)
 36: 0x0112 [0x1C] WAIT(30* ticks)
 37: 0x0115 [0x2B] Dariah (ID: 17232208/0x0106F150) [7440*]:
    → "Carmelo asked you? You mean he's still...\u007F1\u0000\u0007"
 38: 0x011C [0x23] WAIT_FOR_DIALOG_INTERACTION
 39: 0x011D [0x4B] UPDATE_ENTITY_YAW(entity=Dariah (ID: 17232208/0x0106F150), yaw=16.57°*)
 ...
 43: 0x012D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=11*, entity1=Dariah (ID: 17232208/0x0106F150), entity2=Dariah (ID: 17232208/0x0106F150), action="utl0")
 44: 0x013C [0x2B] Dariah (ID: 17232208/0x0106F150) [7441*]:
    → "Yes, I am the woman he seeks. Why did I leave him? Let's just say that the hands of his clock were about to break.\u007F1\u0000\u0007"
 45: 0x0143 [0x23] WAIT_FOR_DIALOG_INTERACTION
 46: 0x0144 [0x2B] Dariah (ID: 17232208/0x0106F150) [7442*]:
    → "In those days, he would do anything to make me happy. Anything! He even sold the one thing that brought us together to buy me something that would make me more happy.\u007F1\u0000\u0007"
 47: 0x014B [0x23] WAIT_FOR_DIALOG_INTERACTION
 48: 0x014C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=11*, entity1=Dariah (ID: 17232208/0x0106F150), entity2=Dariah (ID: 17232208/0x0106F150), action="utl1")
 49: 0x015B [0x53] WAIT_SCHEDULER_TASK(entity1=Dariah (ID: 17232208/0x0106F150), entity2=Dariah (ID: 17232208/0x0106F150), action_id="utl1")
 50: 0x0168 [0x1C] WAIT(30* ticks)
 51: 0x016B [0x2B] Dariah (ID: 17232208/0x0106F150) [7443*]:
    → "I'm not mad about that, it's just that...I felt that if I had stayed, he would have thrown away everything--all that he cherished, all that he was--just for me.\u007F1\u0000\u0007"
 52: 0x0172 [0x23] WAIT_FOR_DIALOG_INTERACTION
 53: 0x0173 [0x53] WAIT_SCHEDULER_TASK(entity1=Dariah (ID: 17232208/0x0106F150), entity2=Dariah (ID: 17232208/0x0106F150), action_id="unz0")
 54: 0x0180 [0x45] LOAD_SCHEDULED_TASK(work_offset1=11*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="sg06", work_offset2=0*)
 55: 0x0191 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=10*, entity1=Dariah (ID: 17232208/0x0106F150), entity2=Dariah (ID: 17232208/0x0106F150), action="thk1")
 56: 0x01A0 [0x2B] Dariah (ID: 17232208/0x0106F150) [7444*]:
    → "I feared he would throw away his future for the sake of our present.\u0007Eventually, his time would have come to a stop.\u007F1\u0000\u0007"
 57: 0x01A7 [0x23] WAIT_FOR_DIALOG_INTERACTION
 58: 0x01A8 [0x2B] Dariah (ID: 17232208/0x0106F150) [7445*]:
    → "I told him that we were like the hands of a clock... That even if we parted, we would meet again.\u007F1\u0000\u0007"
 59: 0x01AF [0x23] WAIT_FOR_DIALOG_INTERACTION
 60: 0x01B0 [0x2B] Dariah (ID: 17232208/0x0106F150) [7446*]:
    → "But he wanted us to stay where both hands met...even if that meant breaking the gears that kept us in motion.\u007F1\u0000\u0007"
 61: 0x01B7 [0x23] WAIT_FOR_DIALOG_INTERACTION
 62: 0x01B8 [0x2B] Dariah (ID: 17232208/0x0106F150) [7447*]:
    → "Try to stop time...and you'll only break the hands of the clock.\u007F1\u0000\u0007"
 63: 0x01BF [0x23] WAIT_FOR_DIALOG_INTERACTION
 64: 0x01C0 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=10*, entity1=Dariah (ID: 17232208/0x0106F150), entity2=Dariah (ID: 17232208/0x0106F150), action="thk2")
 65: 0x01CF [0x53] WAIT_SCHEDULER_TASK(entity1=Dariah (ID: 17232208/0x0106F150), entity2=Dariah (ID: 17232208/0x0106F150), action_id="thk2")
 66: 0x01DC [0x55] WAIT_LOAD_SCHEDULER(work_offset=11*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="sg06")
 67: 0x01EB [0x45] LOAD_SCHEDULED_TASK(work_offset1=11*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="sg07", work_offset2=0*)
 ...
 71: 0x020B [0x2B] Dariah (ID: 17232208/0x0106F150) [7448*]:
    → "Tell him that as long as we live, we will meet again--as long as the hands of the clock are moving.\u007F1\u0000\u0007"
 72: 0x0212 [0x23] WAIT_FOR_DIALOG_INTERACTION
 73: 0x0213 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=11*, entity1=Dariah (ID: 17232208/0x0106F150), entity2=Dariah (ID: 17232208/0x0106F150), action="kas0")
 ...
 82: 0x023C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
 83: 0x024D [0x46] CAMERA_CONTROL: Restore default settings
 84: 0x024F [0x21] END_EVENT
 85: 0x0250 [0x00] END_REQSTACK()

 86: 0x0272 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo0", work_offset2=0*)
 87: 0x0283 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo0")
 88: 0x0292 [0x1B] RETURN

SUBROUTINE_0293:
 89: 0x0293 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 90: 0x02A4 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 91: 0x02B3 [0x1B] RETURN

SUBROUTINE_02B4:
 92: 0x02B4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 93: 0x02C5 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
...
```
# Data Section: 0x0251 (33 bytes)
     0x0251: 45 18 80 F0 FF FF 7F F0 FF FF 7F 66 64 69 30 07
     0x0261: 80 55 18 80 F0 FF FF 7F F0 FF FF 7F 66 64 69 30
     0x0271: 1B
```