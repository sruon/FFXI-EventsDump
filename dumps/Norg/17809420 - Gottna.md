...
- **10369**: Hold on there, [buddy/lady]. Nobody, not even adventurers, is allowed through here.
- **12615**: Aye, I be hearin' all about ya. If yer done here in Norg, then take a ship t' wherever ya want.
- **12616**: Set sail for where? [Selbina./Mhaura./Nowhere.]
- **12617**: 'Twasn't so long ago that I'd say ya were spewing brine if ya told me an adventurer wanted to use our ships. But the times, they be a-changin'.
- **12618**: I'll be here if ya change yer mind.
...
```
  ...
  2: 0x0013 [0x1D] PRINT_EVENT_MESSAGE(message_id=10369*)
...
```
  ...
  1: 0x011B [0x1D] PRINT_EVENT_MESSAGE(message_id=12615*)
  ...
  4: 0x0122 [0x24] CREATE_DIALOG(message_id=12616*, default_option=2*, option_flags=0*)
 ...
 13: 0x0152 [0x1D] PRINT_EVENT_MESSAGE(message_id=12618*)
...
SUBROUTINE_015B:
 ...
 18: 0x015C [0x1D] PRINT_EVENT_MESSAGE(message_id=12617*)
