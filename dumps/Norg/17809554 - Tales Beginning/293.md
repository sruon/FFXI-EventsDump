...
```
  ...
  7: 0x0024 [0x24] CREATE_DIALOG(message_id=12916*, default_option=1*, option_flags=0*)
...
SUBROUTINE_004C:
 ...
 16: 0x004F [0x48] [System] [12913*]:
    → "Would you like to start a new storyline that you previously postponed?\u007F1\u0000\u0007"
 17: 0x0052 [0x23] WAIT_FOR_DIALOG_INTERACTION
 18: 0x0053 [0x24] CREATE_DIALOG(message_id=12914*, default_option=0*, option_flags=Work_Zone[3])
