...
- **10286**: 'Old on there. Yer that adventurer, <Player>, everybody's talkin' 'bout. Perfect timin' there, matey. I need a hand.
- **10287**: That storage room I jus' mentioned--I need somebody t'go down there and fetch me $6. Unless the Sahagin have thrown 'er in the sea, she should still be down there.
- **10288**: Don't think I'd ask ya t'go down for nothin' now, would ya? There's a pretty penny in it fer ya, if yer interested.
- **10289**: Whaddaya say, matey? [Arrrg, sign me up./I forgot my eye patch at home.]
- **10290**: Well, ya can't go huntin' fer booty without yer eye patch...
- **10291**: So, yer ready to hunt fer some booty?
- **10292**: Spoken like a true pirate! Just go down t'the storage room and bring back the booty. It be as simple as takin' candy from a baby.
- **10293**: I'll be waitin' 'ere for ya.
- **10294**: Where's the storage room? Remember passin' by a false door on yer way to Norg? There's a 'idden door to the west of that one, but if ya don't have $6, ya may have some trouble.
- **10295**: Stay along the walls and ya should find a hidden passageway. Ya made it t'Norg, so findin' it should be no problem. Jus' watch out fer the monsters lurkin' down there.
- **10296**: That's what I was lookin' fer! Now, when openin' these, ya gotta be careful of traps. Ya do this...then turn this...then wiggle this...then...
- **10297**: Arrrg! Its contents are still intact after all these years. Oh yeah, yer reward. Take this. It'll come in handy on yer landlubbin' adventures.
- **10298**: Rottin' floor, fallen crates... Condition of me storage room don't sound so good. I'll have t'head down there with me mateys t'check it out.
- **10343**: We pirates call tha cave connectin' Norg t'tha mainland the "Sea Serpent Grotto." Just like there be beastmen on tha continents, tha grotto has its share of slimy dwellers. Namely, tha Sahagin.
- **10344**: And t'make things worse, those nasty little beasts have filled tha place up with trick doors so ya can't get t'tha deeper parts of the cave.
- **10345**: We used t'have a vault down there, but nobody's been able t'get close to it fer years.
...
```
  ...
  4: 0x000B [0x1D] PRINT_EVENT_MESSAGE(message_id=10344*)
  ...
  9: 0x0030 [0x1D] PRINT_EVENT_MESSAGE(message_id=10345*)
...
```
  ...
  2: 0x0053 [0x1D] PRINT_EVENT_MESSAGE(message_id=10291*)
  ...
  6: 0x005D [0x1D] PRINT_EVENT_MESSAGE(message_id=10343*)
    → "We pirates call tha cave connectin' Norg t'tha mainland the "Sea Serpent Grotto." Just like there be beastmen on tha continents, tha grotto has its share of slimy dwellers. Namely, tha Sahagin."
  7: 0x0060 [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x0061 [0x1D] PRINT_EVENT_MESSAGE(message_id=10344*)
    → "And t'make things worse, those nasty little beasts have filled tha place up with trick doors so ya can't get t'tha deeper parts of the cave."
 ...
 13: 0x0086 [0x1D] PRINT_EVENT_MESSAGE(message_id=10345*)
    → "We used t'have a vault down there, but nobody's been able t'get close to it fer years."
 ...
 16: 0x0099 [0x1D] PRINT_EVENT_MESSAGE(message_id=10286*)
 ...
 18: 0x009D [0x1D] PRINT_EVENT_MESSAGE(message_id=10287*)
 ...
 20: 0x00A1 [0x1D] PRINT_EVENT_MESSAGE(message_id=10288*)
...
SUBROUTINE_00A5:
 22: 0x00A5 [0x24] CREATE_DIALOG(message_id=10289*, default_option=0*, option_flags=0*)
 ...
 25: 0x00B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=10290*)
...
SUBROUTINE_00BF:
 ...
 31: 0x00D4 [0x1D] PRINT_EVENT_MESSAGE(message_id=10292*)
 ...
 33: 0x00D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=10293*)
...
```
  ...
  2: 0x0102 [0x1D] PRINT_EVENT_MESSAGE(message_id=10294*)
  ...
  4: 0x0106 [0x1D] PRINT_EVENT_MESSAGE(message_id=10295*)
...
```
  ...
  3: 0x0125 [0x1D] PRINT_EVENT_MESSAGE(message_id=10296*)
  ...
  5: 0x0129 [0x1D] PRINT_EVENT_MESSAGE(message_id=10297*)
...
```
  ...
  1: 0x0155 [0x1D] PRINT_EVENT_MESSAGE(message_id=10298*)
