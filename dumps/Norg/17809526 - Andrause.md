...
- **9959**: You... Yes, the description fits. I daresay, you're the one "she" sent, yes?
- **9960**: Can I count on you to aid my investigation once more?
- **9961**: At my client's behest, I have procured the item you require. But alas, doing so drained far more of my time and resources than had been reckoned. As recompense for having exerted undue effort, I would ask a favor of you. Do as I say, and you may consider the item yours.
- **9962**: Do as he says? [Yes./No.]
- **9963**: Very good. I knew I could count on us being on the same page. Now then, without further ado, I shall explain the task to you. It truly is simple.
- **9964**: You are to investigate a number of creatures dwelling within the Sea Serpent Grotto in my stead.
- **9965**: Should you not possess $0 and $1, I can furnish you with both for a nominal fee of 800 gil.
- **9966**: Using the $0 will turn $1 into $2--a visual record of the subject's physical characteristics.
- **9967**: I'm currently investigating the %0, the %1, and the %2.
- **9969**: That is most disappointing... "She" would not be pleased to hear of this.
- **9970**: Ah, yes...
- **9971**: A truly menacing image of the %0! All that remains, then, is one each of the %1 and the %2.
- **9972**: Do you require $1 and $2? I can provide you with both for a nominal fee of 800 gil.
- **9973**: Buy for 800 gil? (You have $3) [Yes, please./No, thank you.]
- **9974**: Should you not possess $0 and $1, I can furnish you with both for a nominal fee. I've recently depleted my stores, however, so you will have to wait until the next shipment arrives.
- **9976**: Ah, a positively imposing image of the %0! All that remains, then, is one of the %1.
- **9977**: I've eagerly awaited your return. With this image of the %0, I hold your task fulfilled.
- **9978**: As promised, I relinquish this to you. Should another be required, you shall find me here.
- **9979**: I need images of the %0, the %1, and the %2.
- **9980**: You've yet to bring me images of the %0 and the %1.
- **9981**: You've yet to bring me an image of the %0.
- **9982**: A fine image this is, but this creature isn't one of my investigation subjects.
- **9983**: I fear I haven't the time to trade pleasantries with random strangers. Please leave me be.
- **9984**: Is there something else you wish of me? You already have what you came for, no?
...
```
 ...
 17: 0x0043 [0x1D] PRINT_EVENT_MESSAGE(message_id=9960*)
    → "Can I count on you to aid my investigation once more?"
 18: 0x0046 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_0047:
 19: 0x0047 [0x24] CREATE_DIALOG(message_id=9962*, default_option=0*, option_flags=0*)
 ...
 27: 0x006D [0x1D] PRINT_EVENT_MESSAGE(message_id=9963*)
 ...
 29: 0x0071 [0x1D] PRINT_EVENT_MESSAGE(message_id=9964*)
 ...
 34: 0x007E [0x1D] PRINT_EVENT_MESSAGE(message_id=9965*)
 ...
 39: 0x008B [0x1D] PRINT_EVENT_MESSAGE(message_id=9966*)
 ...
 44: 0x0098 [0x1D] PRINT_EVENT_MESSAGE(message_id=9967*)
 ...
 50: 0x00AD [0x1D] PRINT_EVENT_MESSAGE(message_id=9972*)
 ...
 52: 0x00B1 [0x24] CREATE_DIALOG(message_id=9973*, default_option=1*, option_flags=0*)
...
SUBROUTINE_00E2:
 ...
 67: 0x00EE [0x1D] PRINT_EVENT_MESSAGE(message_id=9974*)
...
SUBROUTINE_00F7:
 ...
 72: 0x0102 [0x1D] PRINT_EVENT_MESSAGE(message_id=9969*)
...
```
  ...
  5: 0x0129 [0x1D] PRINT_EVENT_MESSAGE(message_id=9981*)
  ...
  9: 0x0138 [0x1D] PRINT_EVENT_MESSAGE(message_id=9980*)
 ...
 13: 0x0147 [0x1D] PRINT_EVENT_MESSAGE(message_id=9979*)
...
SUBROUTINE_014E:
 ...
 20: 0x015F [0x1D] PRINT_EVENT_MESSAGE(message_id=9972*)
    → "Do you require $1 and $2? I can provide you with both for a nominal fee of 800 gil."
 21: 0x0162 [0x23] WAIT_FOR_DIALOG_INTERACTION
 22: 0x0163 [0x24] CREATE_DIALOG(message_id=9973*, default_option=1*, option_flags=0*)
    → "Buy for 800 gil? (You have $3) [Yes, please./No, thank you.]"
...
SUBROUTINE_0194:
 ...
 37: 0x01A0 [0x1D] PRINT_EVENT_MESSAGE(message_id=9974*)
    → "Should you not possess $0 and $1, I can furnish you with both for a nominal fee. I've recently depleted my stores, however, so you will have to wait until the next shipment arrives."
...
```
  ...
  3: 0x01B2 [0x1D] PRINT_EVENT_MESSAGE(message_id=9983*)
...
```
  ...
  3: 0x01BF [0x1D] PRINT_EVENT_MESSAGE(message_id=9984*)
...
```
  ...
  9: 0x01E3 [0x1D] PRINT_EVENT_MESSAGE(message_id=9970*)
    → "Ah, yes..."
 ...
 16: 0x01FD [0x1D] PRINT_EVENT_MESSAGE(message_id=9977*)
 ...
 18: 0x0201 [0x1D] PRINT_EVENT_MESSAGE(message_id=9978*)
 ...
 23: 0x0215 [0x1D] PRINT_EVENT_MESSAGE(message_id=9976*)
...
SUBROUTINE_0257:
 ...
 40: 0x0262 [0x1D] PRINT_EVENT_MESSAGE(message_id=9971*)
...
```
  ...
  3: 0x02B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9982*)
