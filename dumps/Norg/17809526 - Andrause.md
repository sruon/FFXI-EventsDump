...
- **9964**: You... Yes, the description fits. I daresay, you're the one "she" sent, yes?
- **9965**: Can I count on you to aid my investigation once more?
- **9966**: At my client's behest, I have procured the item you require. But alas, doing so drained far more of my time and resources than had been reckoned. As recompense for having exerted undue effort, I would ask a favor of you. Do as I say, and you may consider the item yours.
- **9967**: Do as he says? [Yes./No.]
- **9968**: Very good. I knew I could count on us being on the same page. Now then, without further ado, I shall explain the task to you. It truly is simple.
- **9969**: You are to investigate a number of creatures dwelling within the Sea Serpent Grotto in my stead.
- **9970**: Should you not possess $0 and $1, I can furnish you with both for a nominal fee of 800 gil.
- **9971**: Using the $0 will turn $1 into $2--a visual record of the subject's physical characteristics.
- **9972**: I'm currently investigating the %0, the %1, and the %2.
- **9974**: That is most disappointing... "She" would not be pleased to hear of this.
- **9975**: Ah, yes...
- **9976**: A truly menacing image of the %0! All that remains, then, is one each of the %1 and the %2.
- **9977**: Do you require $1 and $2? I can provide you with both for a nominal fee of 800 gil.
- **9978**: Buy for 800 gil? (You have $3) [Yes, please./No, thank you.]
- **9979**: Should you not possess $0 and $1, I can furnish you with both for a nominal fee. I've recently depleted my stores, however, so you will have to wait until the next shipment arrives.
- **9981**: Ah, a positively imposing image of the %0! All that remains, then, is one of the %1.
- **9982**: I've eagerly awaited your return. With this image of the %0, I hold your task fulfilled.
- **9983**: As promised, I relinquish this to you. Should another be required, you shall find me here.
- **9984**: I need images of the %0, the %1, and the %2.
- **9985**: You've yet to bring me images of the %0 and the %1.
- **9986**: You've yet to bring me an image of the %0.
- **9987**: A fine image this is, but this creature isn't one of my investigation subjects.
- **9988**: I fear I haven't the time to trade pleasantries with random strangers. Please leave me be.
- **9989**: Is there something else you wish of me? You already have what you came for, no?
...
```
 ...
 17: 0x0043 [0x1D] PRINT_EVENT_MESSAGE(message_id=9965*)
    → "Can I count on you to aid my investigation once more?"
 18: 0x0046 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_0047:
 19: 0x0047 [0x24] CREATE_DIALOG(message_id=9967*, default_option=0*, option_flags=0*)
 ...
 27: 0x006D [0x1D] PRINT_EVENT_MESSAGE(message_id=9968*)
 ...
 29: 0x0071 [0x1D] PRINT_EVENT_MESSAGE(message_id=9969*)
 ...
 34: 0x007E [0x1D] PRINT_EVENT_MESSAGE(message_id=9970*)
 ...
 39: 0x008B [0x1D] PRINT_EVENT_MESSAGE(message_id=9971*)
 ...
 44: 0x0098 [0x1D] PRINT_EVENT_MESSAGE(message_id=9972*)
 ...
 50: 0x00AD [0x1D] PRINT_EVENT_MESSAGE(message_id=9977*)
 ...
 52: 0x00B1 [0x24] CREATE_DIALOG(message_id=9978*, default_option=1*, option_flags=0*)
...
SUBROUTINE_00E2:
 ...
 67: 0x00EE [0x1D] PRINT_EVENT_MESSAGE(message_id=9979*)
...
SUBROUTINE_00F7:
 ...
 72: 0x0102 [0x1D] PRINT_EVENT_MESSAGE(message_id=9974*)
...
```
  ...
  5: 0x0129 [0x1D] PRINT_EVENT_MESSAGE(message_id=9986*)
  ...
  9: 0x0138 [0x1D] PRINT_EVENT_MESSAGE(message_id=9985*)
 ...
 13: 0x0147 [0x1D] PRINT_EVENT_MESSAGE(message_id=9984*)
...
SUBROUTINE_014E:
 ...
 20: 0x015F [0x1D] PRINT_EVENT_MESSAGE(message_id=9977*)
    → "Do you require $1 and $2? I can provide you with both for a nominal fee of 800 gil."
 21: 0x0162 [0x23] WAIT_FOR_DIALOG_INTERACTION
 22: 0x0163 [0x24] CREATE_DIALOG(message_id=9978*, default_option=1*, option_flags=0*)
    → "Buy for 800 gil? (You have $3) [Yes, please./No, thank you.]"
...
SUBROUTINE_0194:
 ...
 37: 0x01A0 [0x1D] PRINT_EVENT_MESSAGE(message_id=9979*)
    → "Should you not possess $0 and $1, I can furnish you with both for a nominal fee. I've recently depleted my stores, however, so you will have to wait until the next shipment arrives."
...
```
  ...
  3: 0x01B2 [0x1D] PRINT_EVENT_MESSAGE(message_id=9988*)
...
```
  ...
  3: 0x01BF [0x1D] PRINT_EVENT_MESSAGE(message_id=9989*)
...
```
  ...
  9: 0x01E3 [0x1D] PRINT_EVENT_MESSAGE(message_id=9975*)
    → "Ah, yes..."
 ...
 16: 0x01FD [0x1D] PRINT_EVENT_MESSAGE(message_id=9982*)
 ...
 18: 0x0201 [0x1D] PRINT_EVENT_MESSAGE(message_id=9983*)
 ...
 23: 0x0215 [0x1D] PRINT_EVENT_MESSAGE(message_id=9981*)
...
SUBROUTINE_0257:
 ...
 40: 0x0262 [0x1D] PRINT_EVENT_MESSAGE(message_id=9976*)
...
```
  ...
  3: 0x02B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9987*)
