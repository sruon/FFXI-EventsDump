...
- **12292**: Leaning in closely to the device, one can make out miniscule etchings that read, "Trade various crystals to this waypoint to receive kinetic units that may be used when you wish to warp to another locale."
- **12293**: "Travelers may not possess more than $1 at a given time. Should someone trade an amount of crystals that would result in a surplus of kinetic units, those units will be lost to the aether."
- **12303**: You will not be asked to confirm your choice of destination. Switching to simple teleporation mode.
- **12304**: You will be asked to confirm your choice of destination. Returning to normal teleportation mode.
- **12305**: Warp to your destination? [Yes./No.]
- **12306**: Where will you go? (Kinetic Units: $3) [Nowhere, thanks./I'd rather read an explanation./Ru'Lude Gardens. ($4 unit[/s])/Selbina. ($4 unit[/s])/Mhaura. ($4 unit[/s])/Rabao. ($4 unit[/s])/Norg. ($4 unit[/s])/West Ronfaure. ($5 unit[/s])/North Gustaberg. ($5 unit[/s])/West Sarutabaruta. ($5 unit[/s])/La Theine Plateau. ($5 unit[/s])/Konschtat Highlands. ($5 unit[/s])/Tahrongi Canyon. ($5 unit[/s])/Jugner Forest. ($5 unit[/s])/Pashhow Marshlands. ($5 unit[/s])/Meriphataud Mountains. ($5 unit[/s])/Attohwa Chasm. ($5 unit[/s])/Uleguerand Range. ($5 unit[/s])/Davoi. ($6 unit[/s])/Beadeaux. ($6 unit[/s])/Castle Oztroja. ($6 unit[/s])/Quicksand Caves. ($6 unit[/s])/Sea Serpent Grotto. ($6 unit[/s])/Temple of Uggalepih. ($6 unit[/s])/The Boyahda Tree. ($6 unit[/s])/Oldton Movalpolos. ($6 unit[/s])/Riverne - Site #B01. ($6 unit[/s])/Castle Zvahl Keep. ($6 unit[/s])/Decline destination confirmation./Accept destination confirmation.]
...
SUBROUTINE_00B7:
 ...
 37: 0x00D5 [0x24] CREATE_DIALOG(message_id=12306*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_0141:
 ...
 48: 0x015C [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
...
SUBROUTINE_0182:
 ...
 60: 0x019D [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
SUBROUTINE_01C3:
 ...
 72: 0x01DE [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
SUBROUTINE_0204:
 ...
 84: 0x021F [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
SUBROUTINE_0245:
 ...
 96: 0x0260 [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
108: 0x02A1 [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
120: 0x02E2 [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
132: 0x0323 [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
144: 0x0364 [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
156: 0x03A5 [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
168: 0x03E6 [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
180: 0x0427 [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
192: 0x0468 [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
204: 0x04A9 [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
216: 0x04EA [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
228: 0x052B [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
240: 0x056C [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
252: 0x05AD [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
264: 0x05EE [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
276: 0x062F [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
288: 0x0670 [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
300: 0x06B1 [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
312: 0x06F2 [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
324: 0x0733 [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
...
336: 0x0774 [0x24] CREATE_DIALOG(message_id=12305*, default_option=1*, option_flags=0*)
    → "Warp to your destination? [Yes./No.]"
