...
```
  ...
  2: 0x000A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  3: 0x001B [0x02] IF !(Work_Zone[4] == 0*) GOTO 0x0034
  4: 0x0023 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="chco", work_offset2=0*)
...
\u0001 gil.\u007F1\u0000\u0007"
 ...
 20: 0x0065 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 21: 0x0076 [0x02] IF !(Work_Zone[4] == 0*) GOTO 0x008F
 22: 0x007E [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="chco", work_offset2=0*)
...
SUBROUTINE_00A0:
 29: 0x00A0 [0x03] Work_Zone[1] = 1073741824*
 30: 0x00A5 [0x21] END_EVENT
 31: 0x00A6 [0x00] END_REQSTACK()
```
