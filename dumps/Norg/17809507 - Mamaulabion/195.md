...
```
  ...
  2: 0x0323 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="thk1")
  ...
  5: 0x0336 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="thk2")
  6: 0x0345 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="thk2")
  ...
  9: 0x0364 [0x45] LOAD_SCHEDULED_TASK(work_offset1=215*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qs04", work_offset2=0*)
 ...
 13: 0x037C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
