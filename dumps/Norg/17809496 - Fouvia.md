...
- **10589**: Select a name for your Wyvern. [Azure/Cerulean/Rygor/Firewing/Delphyne/Ember/Rover/Max/Buster/Duke/Oscar/Maggie/Jessie/Lady/Hien/Raiden/Lumiere/Eisenzahn/Pfeil/Wuffi/George/Donryu/Qiqiru/Karav-Marav/Oboro/Darug-Borug/Mikan/Vhiki/Sasavi/Tatang/Nanaja/Khocha]
- **10592**: Is this the name you really want? [This is the one./I need more time to think./Forget about it.]
- **10594**: Oi spy ye've got a gran' wyvern dare witcha.
- **10595**: Ye gave a name ter yer wyvern whaen yer made yer pact, roi? Well, I'll let ye in on a secret. Did ye know ye can change yer wyvern's name?
- **10596**: If ye pay me fee of $7 gil, oi can 'elp yer. Waaat do yer say? You can alwus back oyt at any time.
- **10597**: Ye want ter change yer wyvern's name again? Jes pay me fee of $7 gil, an' oi can 'elp yer.
- **10598**: Ask the woman for her help? [Yes./No.]
- **10599**: A wyvern's name is a part av its destiny. A change may be good for it. Come back if ye change yer mind.
- **10600**: Choose a new name from de followin'. An' don't go givin' yer wyvern de seem name, now, hear?
- **10601**: Waaat a gran' name ye 'av chosen. Good day!
- **10603**: Select a name for your wyvern. [Azure/Cerulean/Rygor/Firewing/Delphyne/Ember/Rover/Max/Buster/Duke/Oscar/Maggie/Jessie/Lady/Hien/Raiden/Lumiere/Eisenzahn/Pfeil/Wuffi/George/Donryu/Qiqiru/Karav-Marav/Oboro/Darug-Borug/Mikan/Vhiki/Sasavi/Tatang/Look at the next list./Quit]
- **10604**: Select a name for your wyvern. [Nanaja/Khocha/Dino/Chomper/Huffy/Pouncer/Fido/Lucy/Jake/Rocky/Rex/Rusty/Himmelskralle/Gizmo/Spike/Sylvester/Milo/Tom/Toby/Felix/Komet/Bo/Molly/Unryu/Daisy/Baron/Ginger/Muffin/Lumineux/Look at the previous list./Look at the next list./Quit]
- **10605**: Select a name for your wyvern. [Quatrevents/Toryu/Tataba/Etoilazuree/Grisnuage/Belorage/Centonnerre/Nouvellune/Missy/Amedeo/Tranchevent/Soufflefeu/Etoile/Tonnerre/Nuage/Foudre/Hyuh/Orage/Lune/Astre/Waffenzahn/Soleil/Courageux/Koffla-Paffla/Venteuse/Lunaire/Tora/Celeste/Galja-Mogalja/Look at the previous list./Look at the next list./Quit]
...
```
  ...
  6: 0x0024 [0x1D] PRINT_EVENT_MESSAGE(message_id=10597*)
  ...
  9: 0x002B [0x1D] PRINT_EVENT_MESSAGE(message_id=10594*)
 ...
 12: 0x003E [0x1D] PRINT_EVENT_MESSAGE(message_id=10595*)
 ...
 14: 0x0042 [0x1D] PRINT_EVENT_MESSAGE(message_id=10596*)
...
SUBROUTINE_0046:
 ...
 17: 0x004B [0x24] CREATE_DIALOG(message_id=10598*, default_option=1*, option_flags=0*)
    → "Ask the woman for her help? [Yes./No.]"
 18: 0x0052 [0x25] WAIT_DIALOG_SELECT()
 19: 0x0053 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x007C
 20: 0x005B [0x1D] PRINT_EVENT_MESSAGE(message_id=10600*)
 ...
 27: 0x0075 [0x1D] PRINT_EVENT_MESSAGE(message_id=10601*)
 ...
 31: 0x0084 [0x1D] PRINT_EVENT_MESSAGE(message_id=10599*)
...
SUBROUTINE_00CF:
 ...
 38: 0x00D2 [0x24] CREATE_DIALOG(message_id=10603*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0100:
 ...
 48: 0x0110 [0x24] CREATE_DIALOG(message_id=10604*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0151:
 ...
 55: 0x0161 [0x24] CREATE_DIALOG(message_id=10605*, default_option=0*, option_flags=0*)
...
SUBROUTINE_01A2:
 ...
 62: 0x01B2 [0x24] CREATE_DIALOG(message_id=10606*, default_option=0*, option_flags=1073741824*)
...
SUBROUTINE_01E3:
 67: 0x01E3 [0x24] CREATE_DIALOG(message_id=10592*, default_option=1*, option_flags=0*)
...
# Dead code (unreachable instructions):
     0x0092 [0x24] CREATE_DIALOG(message_id=10589*, default_option=0*, option_flags=0*)
    → "Select a name for your Wyvern. [Azure/Cerulean/Rygor/Firewing/Delphyne/Ember/Rover/Max/Buster/Duke/Oscar/Maggie/Jessie/Lady/Hien/Raiden/Lumiere/Eisenzahn/Pfeil/Wuffi/George/Donryu/Qiqiru/Karav-Marav/Oboro/Darug-Borug/Mikan/Vhiki/Sasavi/Tatang/Nanaja/Khocha]"
     ...
     0x00AA [0x24] CREATE_DIALOG(message_id=10592*, default_option=1*, option_flags=4*)
    → "Is this the name you really want? [This is the one./I need more time to think./Forget about it.]"
