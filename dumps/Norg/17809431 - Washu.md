...
- **10171**: <Sigh> What am I to do...?
- **10172**: Rations? We have more than enough. But the drink...these hooligans guzzle it down like it was water. We're always low on supply!
- **10173**: Ah, you came at the perfect time. You're one of those adventurers, aren't you? Well, I need you to run an errand for me in the Yhoator Jungle.
- **10174**: Deep in that jungle, the wild Opo-opos brew a special drink by fermenting berries in the trees.
- **10175**: You must be wondering how you get there, right? You'll find the Yhoator Jungle just beyond the Yuhtunga Jungle. But you should watch your back. There are a lot of wild animals creeping around in that place.
- **10176**: Don't worry. I'll pay you for your trouble.
- **10177**: Will you help me out? [Of course./Maybe some other time.]
- **10178**: I can't thank you enough! Now take this $3 and fill it chock full of that Opo-Opo brew. I'll be waiting!
- **10179**: Well, I guess you adventurers must be busy with your adventuring. I'll try to find somebody else to go.
- **10180**: Oh, have you changed your mind?
- **10181**: Okay, now listen up. The Opo-opos don't hide their brew in the Yuhtunga Jungle, only in the Yhoator Jungle.
- **10182**: When you find one of the trees those little buggers are making it in, fill this $3 up to the brim, and bring it back to me.
- **10183**: Mmm-mmm! The color! The aroma! Only nature can work magic like this!
- **10184**: Now if only those hooligans would appreciate it! Knowing them, this batch will be gone by the end of the night...
- **10185**: Here's a little something for your trouble. Now, I have to remember to double our next order from our suppliers...
- **10186**: Oh, thanks again for helping me out. What's beyond this door? Why, that's the kitchen--the heart of Norg. I can't let you in there, you know.
- **10694**: So you're the adventurer that Gilgamesh sent, eh? Get out a piece of paper and a pencil. You're going to have to go fetch me the following four items.
- **10695**: What? You thought I'd have everything you need here? With the way these hooligans eat, I barely have enough grub to feed the dogs! Oh, don't worry. The way you adventurers put everything up on auction, you should be able to get your hands on these items easy enough.
- **10696**: All I need is $0, $1, $2, and $3.
- **10697**: When you've got all four, bring them to me. I'll whip you up your bait in no time.
- **10698**: What, did you forget what I need you to bring already? And you call yourself an adventurer!
- **10699**: Well, that was quick. Pretty good for an adventurer. There may be some hope for you yet! Ha ha ha!
- **10700**: Now, let me whip up your bird bait, just like I promised.
- **10701**: Here you go. Be careful, though. From what I hear, that Onzozo place is a lot rougher than our jungles.
- **10702**: Why are you still here? You've got to get my bait to the birdy before it goes bad. If you were a monster, would you settle for a spoiled meal?
- **11126**: Here, take this flask.
- **11127**: Fill it from the four big clams in the Korroloka Tunnel. We'll see who has the last laugh...
- **11128**: Good work. Now hand it over to Sohyon.
...
```
  ...
  2: 0x0013 [0x1D] PRINT_EVENT_MESSAGE(message_id=10171*)
    → "<Sigh> What am I to do...?"
  3: 0x0016 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=10172*)
...
```
  ...
  2: 0x0028 [0x1D] PRINT_EVENT_MESSAGE(message_id=10180*)
  ...
  6: 0x003E [0x1D] PRINT_EVENT_MESSAGE(message_id=10171*)
    → "<Sigh> What am I to do...?"
  7: 0x0041 [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x0042 [0x1D] PRINT_EVENT_MESSAGE(message_id=10172*)
    → "Rations? We have more than enough. But the drink...these hooligans guzzle it down like it was water. We're always low on supply!"
  9: 0x0045 [0x23] WAIT_FOR_DIALOG_INTERACTION
 10: 0x0046 [0x1D] PRINT_EVENT_MESSAGE(message_id=10173*)
 ...
 12: 0x004A [0x1D] PRINT_EVENT_MESSAGE(message_id=10174*)
 ...
 14: 0x004E [0x1D] PRINT_EVENT_MESSAGE(message_id=10175*)
 ...
 16: 0x0052 [0x1D] PRINT_EVENT_MESSAGE(message_id=10176*)
    → "Don't worry. I'll pay you for your trouble."
 17: 0x0055 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_0056:
 18: 0x0056 [0x24] CREATE_DIALOG(message_id=10177*, default_option=0*, option_flags=0*)
 ...
 21: 0x0066 [0x1D] PRINT_EVENT_MESSAGE(message_id=10179*)
...
SUBROUTINE_0070:
 ...
 27: 0x007B [0x1D] PRINT_EVENT_MESSAGE(message_id=10178*)
...
```
  ...
  2: 0x0089 [0x1D] PRINT_EVENT_MESSAGE(message_id=10181*)
  ...
  4: 0x008D [0x1D] PRINT_EVENT_MESSAGE(message_id=10182*)
...
```
  ...
  6: 0x00A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10185*)
...
```
  ...
  2: 0x00C5 [0x1D] PRINT_EVENT_MESSAGE(message_id=10184*)
    → "Now if only those hooligans would appreciate it! Knowing them, this batch will be gone by the end of the night..."
  3: 0x00C8 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x00C9 [0x01] GOTO 0x00D0
  5: 0x00CC [0x1D] PRINT_EVENT_MESSAGE(message_id=10186*)
...
```
  ...
  6: 0x00EA [0x1D] PRINT_EVENT_MESSAGE(message_id=10694*)
  ...
  8: 0x00EE [0x1D] PRINT_EVENT_MESSAGE(message_id=10695*)
 ...
 11: 0x0101 [0x1D] PRINT_EVENT_MESSAGE(message_id=10696*)
    → "All I need is $0, $1, $2, and $3."
 12: 0x0104 [0x23] WAIT_FOR_DIALOG_INTERACTION
 13: 0x0105 [0x1D] PRINT_EVENT_MESSAGE(message_id=10697*)
...
```
  ...
  6: 0x0131 [0x1D] PRINT_EVENT_MESSAGE(message_id=10698*)
 ...
 10: 0x0151 [0x1D] PRINT_EVENT_MESSAGE(message_id=10696*)
    → "All I need is $0, $1, $2, and $3."
 11: 0x0154 [0x23] WAIT_FOR_DIALOG_INTERACTION
 12: 0x0155 [0x1D] PRINT_EVENT_MESSAGE(message_id=10697*)
    → "When you've got all four, bring them to me. I'll whip you up your bait in no time."
...
```
  ...
  3: 0x016E [0x1D] PRINT_EVENT_MESSAGE(message_id=10699*)
  ...
  5: 0x0172 [0x1D] PRINT_EVENT_MESSAGE(message_id=10700*)
 ...
 12: 0x0193 [0x1D] PRINT_EVENT_MESSAGE(message_id=10701*)
...
```
  ...
  1: 0x01A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10702*)
...
```
  ...
  4: 0x01CD [0x1D] PRINT_EVENT_MESSAGE(message_id=11126*)
  ...
  7: 0x01DE [0x1D] PRINT_EVENT_MESSAGE(message_id=11127*)
...
```
  ...
  1: 0x01E7 [0x1D] PRINT_EVENT_MESSAGE(message_id=11127*)
    → "Fill it from the four big clams in the Korroloka Tunnel. We'll see who has the last laugh..."
...
```
  ...
  1: 0x01F0 [0x1D] PRINT_EVENT_MESSAGE(message_id=11128*)
