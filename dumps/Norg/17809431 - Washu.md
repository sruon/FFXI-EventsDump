...
- **10174**: <Sigh> What am I to do...?
- **10175**: Rations? We have more than enough. But the drink...these hooligans guzzle it down like it was water. We're always low on supply!
- **10176**: Ah, you came at the perfect time. You're one of those adventurers, aren't you? Well, I need you to run an errand for me in the Yhoator Jungle.
- **10177**: Deep in that jungle, the wild Opo-opos brew a special drink by fermenting berries in the trees.
- **10178**: You must be wondering how you get there, right? You'll find the Yhoator Jungle just beyond the Yuhtunga Jungle. But you should watch your back. There are a lot of wild animals creeping around in that place.
- **10179**: Don't worry. I'll pay you for your trouble.
- **10180**: Will you help me out? [Of course./Maybe some other time.]
- **10181**: I can't thank you enough! Now take this $3 and fill it chock full of that Opo-Opo brew. I'll be waiting!
- **10182**: Well, I guess you adventurers must be busy with your adventuring. I'll try to find somebody else to go.
- **10183**: Oh, have you changed your mind?
- **10184**: Okay, now listen up. The Opo-opos don't hide their brew in the Yuhtunga Jungle, only in the Yhoator Jungle.
- **10185**: When you find one of the trees those little buggers are making it in, fill this $3 up to the brim, and bring it back to me.
- **10186**: Mmm-mmm! The color! The aroma! Only nature can work magic like this!
- **10187**: Now if only those hooligans would appreciate it! Knowing them, this batch will be gone by the end of the night...
- **10188**: Here's a little something for your trouble. Now, I have to remember to double our next order from our suppliers...
- **10189**: Oh, thanks again for helping me out. What's beyond this door? Why, that's the kitchen--the heart of Norg. I can't let you in there, you know.
- **10697**: So you're the adventurer that Gilgamesh sent, eh? Get out a piece of paper and a pencil. You're going to have to go fetch me the following four items.
- **10698**: What? You thought I'd have everything you need here? With the way these hooligans eat, I barely have enough grub to feed the dogs! Oh, don't worry. The way you adventurers put everything up on auction, you should be able to get your hands on these items easy enough.
- **10699**: All I need is $0, $1, $2, and $3.
- **10700**: When you've got all four, bring them to me. I'll whip you up your bait in no time.
- **10701**: What, did you forget what I need you to bring already? And you call yourself an adventurer!
- **10702**: Well, that was quick. Pretty good for an adventurer. There may be some hope for you yet! Ha ha ha!
- **10703**: Now, let me whip up your bird bait, just like I promised.
- **10704**: Here you go. Be careful, though. From what I hear, that Onzozo place is a lot rougher than our jungles.
- **10705**: Why are you still here? You've got to get my bait to the birdy before it goes bad. If you were a monster, would you settle for a spoiled meal?
- **11129**: Here, take this flask.
- **11130**: Fill it from the four big clams in the Korroloka Tunnel. We'll see who has the last laugh...
- **11131**: Good work. Now hand it over to Sohyon.
...
```
  ...
  2: 0x0013 [0x1D] PRINT_EVENT_MESSAGE(message_id=10174*)
    → "<Sigh> What am I to do...?"
  3: 0x0016 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=10175*)
...
```
  ...
  2: 0x0028 [0x1D] PRINT_EVENT_MESSAGE(message_id=10183*)
  ...
  6: 0x003E [0x1D] PRINT_EVENT_MESSAGE(message_id=10174*)
    → "<Sigh> What am I to do...?"
  7: 0x0041 [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x0042 [0x1D] PRINT_EVENT_MESSAGE(message_id=10175*)
    → "Rations? We have more than enough. But the drink...these hooligans guzzle it down like it was water. We're always low on supply!"
  9: 0x0045 [0x23] WAIT_FOR_DIALOG_INTERACTION
 10: 0x0046 [0x1D] PRINT_EVENT_MESSAGE(message_id=10176*)
 ...
 12: 0x004A [0x1D] PRINT_EVENT_MESSAGE(message_id=10177*)
 ...
 14: 0x004E [0x1D] PRINT_EVENT_MESSAGE(message_id=10178*)
 ...
 16: 0x0052 [0x1D] PRINT_EVENT_MESSAGE(message_id=10179*)
    → "Don't worry. I'll pay you for your trouble."
 17: 0x0055 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_0056:
 18: 0x0056 [0x24] CREATE_DIALOG(message_id=10180*, default_option=0*, option_flags=0*)
 ...
 21: 0x0066 [0x1D] PRINT_EVENT_MESSAGE(message_id=10182*)
...
SUBROUTINE_0070:
 ...
 27: 0x007B [0x1D] PRINT_EVENT_MESSAGE(message_id=10181*)
...
```
  ...
  2: 0x0089 [0x1D] PRINT_EVENT_MESSAGE(message_id=10184*)
  ...
  4: 0x008D [0x1D] PRINT_EVENT_MESSAGE(message_id=10185*)
...
```
  ...
  6: 0x00A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10188*)
...
```
  ...
  2: 0x00C5 [0x1D] PRINT_EVENT_MESSAGE(message_id=10187*)
    → "Now if only those hooligans would appreciate it! Knowing them, this batch will be gone by the end of the night..."
  3: 0x00C8 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x00C9 [0x01] GOTO 0x00D0
  5: 0x00CC [0x1D] PRINT_EVENT_MESSAGE(message_id=10189*)
...
```
  ...
  6: 0x00EA [0x1D] PRINT_EVENT_MESSAGE(message_id=10697*)
  ...
  8: 0x00EE [0x1D] PRINT_EVENT_MESSAGE(message_id=10698*)
 ...
 11: 0x0101 [0x1D] PRINT_EVENT_MESSAGE(message_id=10699*)
    → "All I need is $0, $1, $2, and $3."
 12: 0x0104 [0x23] WAIT_FOR_DIALOG_INTERACTION
 13: 0x0105 [0x1D] PRINT_EVENT_MESSAGE(message_id=10700*)
...
```
  ...
  6: 0x0131 [0x1D] PRINT_EVENT_MESSAGE(message_id=10701*)
 ...
 10: 0x0151 [0x1D] PRINT_EVENT_MESSAGE(message_id=10699*)
    → "All I need is $0, $1, $2, and $3."
 11: 0x0154 [0x23] WAIT_FOR_DIALOG_INTERACTION
 12: 0x0155 [0x1D] PRINT_EVENT_MESSAGE(message_id=10700*)
    → "When you've got all four, bring them to me. I'll whip you up your bait in no time."
...
```
  ...
  3: 0x016E [0x1D] PRINT_EVENT_MESSAGE(message_id=10702*)
  ...
  5: 0x0172 [0x1D] PRINT_EVENT_MESSAGE(message_id=10703*)
 ...
 12: 0x0193 [0x1D] PRINT_EVENT_MESSAGE(message_id=10704*)
...
```
  ...
  1: 0x01A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10705*)
...
```
  ...
  4: 0x01CD [0x1D] PRINT_EVENT_MESSAGE(message_id=11129*)
  ...
  7: 0x01DE [0x1D] PRINT_EVENT_MESSAGE(message_id=11130*)
...
```
  ...
  1: 0x01E7 [0x1D] PRINT_EVENT_MESSAGE(message_id=11130*)
    → "Fill it from the four big clams in the Korroloka Tunnel. We'll see who has the last laugh..."
...
```
  ...
  1: 0x01F0 [0x1D] PRINT_EVENT_MESSAGE(message_id=11131*)
