...
- **6415**: Obtained $0 gil.
- **10766**: Hey, [mister/lady]. You look like you could use some extra cash, and what easier way to get gil than by making a date with Lady Luck?
- **10767**: Give "Lucky Roll" a try? [Luck be a lady tonight!/I'm not throwing my money away!/Fill me in on the details.]
- **10768**: Let me explain to you how it works. One game of Lucky Roll is played each Vana'diel day.
- **10769**: One play is 100 gil, but as long as you keep paying, you can keep playing.
- **10770**: For each 100 gil, you get one roll of our six-sided die. The number that appears is added to the running total for that day.
- **10771**: The lucky adventurer who rolls the die that gets the running total over 400 wins...get this...a whopping 10000 gil!
- **10772**: And that's not all! You'll receive extra prizes if the total comes to 401 or 402, and a super bonus prize if your roll brings the total to exactly 400!
- **10773**: But be careful; the only time you can find out the running total is after you have rolled.
- **10774**: And that's it! Pretty simple, huh? You can attack from the get go, or you can sit back while other people roll, and then come in for the final kill. We provide you with the die, you choose the strategy.
- **10775**: Alright, enough talk, let's get rolling!
- **10776**: You rolled a...$1! The running total is now $3!
- **10777**: Congratulations! Lady Luck has smiled on you today! Here's your 10000 gil!
- **10778**: And because your roll put the running total at exactly 400, you receive a bonus prize!
- **10779**: And for bringing the total so close to 400, here is your extra prize!
- **10780**: I'm sorry, but that's it for today's game of Lucky Roll. Come by tomorrow, and maybe Lady Luck will be waiting for you!
...
```
  ...
  2: 0x000E [0x1D] PRINT_EVENT_MESSAGE(message_id=10766*)
  ...
  6: 0x0022 [0x1D] PRINT_EVENT_MESSAGE(message_id=10769*)
...
SUBROUTINE_0029:
  9: 0x0029 [0x24] CREATE_DIALOG(message_id=10767*, default_option=1*, option_flags=0*)
 ...
 13: 0x003A [0x1D] PRINT_EVENT_MESSAGE(message_id=10775*)
 ...
 20: 0x006A [0x1D] PRINT_EVENT_MESSAGE(message_id=10776*)
 ...
 23: 0x007D [0x1D] PRINT_EVENT_MESSAGE(message_id=10777*)
 ...
 29: 0x0094 [0x1D] PRINT_EVENT_MESSAGE(message_id=10778*)
 ...
 33: 0x00A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10779*)
 ...
 37: 0x00B2 [0x1D] PRINT_EVENT_MESSAGE(message_id=10779*)
    → "And for bringing the total so close to 400, here is your extra prize!"
...
SUBROUTINE_00D8:
 ...
 53: 0x0102 [0x1D] PRINT_EVENT_MESSAGE(message_id=10768*)
 ...
 55: 0x0106 [0x1D] PRINT_EVENT_MESSAGE(message_id=10769*)
    → "One play is 100 gil, but as long as you keep paying, you can keep playing."
 56: 0x0109 [0x23] WAIT_FOR_DIALOG_INTERACTION
 57: 0x010A [0x1D] PRINT_EVENT_MESSAGE(message_id=10770*)
 ...
 59: 0x010E [0x1D] PRINT_EVENT_MESSAGE(message_id=10771*)
 ...
 61: 0x0112 [0x1D] PRINT_EVENT_MESSAGE(message_id=10772*)
 ...
 63: 0x0116 [0x1D] PRINT_EVENT_MESSAGE(message_id=10773*)
 ...
 66: 0x011F [0x1D] PRINT_EVENT_MESSAGE(message_id=10774*)
...
SUBROUTINE_0129:
 ...
 70: 0x012C [0x1D] PRINT_EVENT_MESSAGE(message_id=10768*)
    → "Let me explain to you how it works. One game of Lucky Roll is played each Vana'diel day."
...
SUBROUTINE_0130:
 ...
 76: 0x014B [0x1D] PRINT_EVENT_MESSAGE(message_id=10778*)
    → "And because your roll put the running total at exactly 400, you receive a bonus prize!"
 ...
 81: 0x0162 [0x1D] PRINT_EVENT_MESSAGE(message_id=10779*)
    → "And for bringing the total so close to 400, here is your extra prize!"
