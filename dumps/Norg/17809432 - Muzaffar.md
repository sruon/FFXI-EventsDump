...
- **10158**: Gnyah-hah-hoh! A fine lookin' adventurer you are. I heard that if the price is right, your kind will do almost anything.
- **10159**: How's about it? Are ya game?
- **10160**: Accept Muzaffar's offer? [Yes./No.]
- **10161**: That's too bad. I was ready to pay a bundle... Guess I'll just have to find someone with a little more moxie.
- **10162**: That's the answer I was lookin' for! As you know, we sell items here that are forbidden to import and export on the mainland.
- **10163**: But as of late there's been mighty more demand than our supply can handle. We just don't have enough people to keep up. That's where you come in.
- **10164**: If you can make it here, you can make it to where all those forbidden items are found. You bring me some, and I'll pay you well. Oh, and I wouldn't try sellin' the goods at any other shop. You won't get ten gil for them.
- **10165**: This is what I need: $1, $2, and $3.
- **10166**: Bring them to me in sets. Four items make one set. I'll pay you for one set at a time.
- **10167**: You already forgot what I want you to bring? Not that smart for an adventurer, are you? Now listen up, I don't want to have to tell you again.
- **10168**: Gnyah-hoh-hoh! If it isn't a set of $1! Here's the payment I promised you.
- **10169**: If you ever come across any more, bring them to me, 'cause I'll be happy to take them off your hands for you. Like they say, "You scratch my back, I'll scratch yours."
- **10170**: If you ever have any more $1, $2, or $3, come to Muzaffar. I'll be happy to take them off your hands for you.
...
```
  ...
  1: 0x0004 [0x1D] PRINT_EVENT_MESSAGE(message_id=10158*)
  ...
  3: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=10159*)
    → "How's about it? Are ya game?"
  4: 0x000B [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x000C [0x24] CREATE_DIALOG(message_id=10160*, default_option=0*, option_flags=0*)
  ...
  9: 0x002B [0x1D] PRINT_EVENT_MESSAGE(message_id=10161*)
...
SUBROUTINE_0035:
 ...
 14: 0x0039 [0x1D] PRINT_EVENT_MESSAGE(message_id=10162*)
 ...
 16: 0x003D [0x1D] PRINT_EVENT_MESSAGE(message_id=10163*)
 ...
 18: 0x0041 [0x1D] PRINT_EVENT_MESSAGE(message_id=10164*)
 ...
 23: 0x0054 [0x1D] PRINT_EVENT_MESSAGE(message_id=10165*)
 ...
 26: 0x0067 [0x1D] PRINT_EVENT_MESSAGE(message_id=10166*)
...
```
  ...
  2: 0x0078 [0x1D] PRINT_EVENT_MESSAGE(message_id=10167*)
  ...
  7: 0x008B [0x1D] PRINT_EVENT_MESSAGE(message_id=10165*)
    → "This is what I need: $1, $2, and $3."
 ...
 10: 0x009E [0x1D] PRINT_EVENT_MESSAGE(message_id=10166*)
    → "Bring them to me in sets. Four items make one set. I'll pay you for one set at a time."
...
```
  ...
  2: 0x00A8 [0x1D] PRINT_EVENT_MESSAGE(message_id=10168*)
  ...
  5: 0x00BB [0x1D] PRINT_EVENT_MESSAGE(message_id=10169*)
...
```
  ...
  2: 0x00D6 [0x1D] PRINT_EVENT_MESSAGE(message_id=10168*)
    → "Gnyah-hoh-hoh! If it isn't a set of $1! Here's the payment I promised you."
  ...
  5: 0x00E9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10169*)
    → "If you ever come across any more, bring them to me, 'cause I'll be happy to take them off your hands for you. Like they say, "You scratch my back, I'll scratch yours.""
...
```
  ...
  2: 0x0104 [0x1D] PRINT_EVENT_MESSAGE(message_id=10168*)
    → "Gnyah-hoh-hoh! If it isn't a set of $1! Here's the payment I promised you."
  ...
  5: 0x0117 [0x1D] PRINT_EVENT_MESSAGE(message_id=10169*)
    → "If you ever come across any more, bring them to me, 'cause I'll be happy to take them off your hands for you. Like they say, "You scratch my back, I'll scratch yours.""
...
```
  ...
  4: 0x0140 [0x1D] PRINT_EVENT_MESSAGE(message_id=10170*)
