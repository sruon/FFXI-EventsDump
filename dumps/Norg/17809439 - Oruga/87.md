...
```
  ...
  2: 0x0007 [0x1D] PRINT_EVENT_MESSAGE(message_id=10339*)
    → "The volcano on this island, Mount Yuhtunga, is still active. They say that Elshimo was created when it erupted thousands of years ago.\u007F1\u0000\u0007"
...
SUBROUTINE_000D:
 ...
 11: 0x003B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=10*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
...
```
# Data Section: 0x001B (32 bytes)
     0x001B: 66 01 80 F8 FF FF 7F F8 FF FF 7F 74 6C 6B 30 1B
     0x002B: 66 01 80 F8 FF FF 7F F8 FF FF 7F 74 6C 6B 31 1B
# Data Section: 0x004B (160 bytes)
