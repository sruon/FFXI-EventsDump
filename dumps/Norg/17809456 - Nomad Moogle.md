...
- **10567**: I'm a traveling moogle, kupo. I help adventurers in the Outlands access items they have stored in a Mog House elsewhere, kupo.
- **10568**: This isn't a Mog House, so you can only use the "Mog Safe," "Change Jobs," and "Delivery Box" commands, kupo.
- **10569**: You have to pay fee of $0 gil to transfer your items to the Outlands, kupo. Why? Because the world is a cold place for rogue moogles, kupo.
- **10570**: Of course, you can move your items back to your Mog House in town, but if you want to transfer them to the Outlands again, you'll have to pay another fee, kupo. I've got to make a living too, kupo.
- **10571**: Transfer items? (Current gil:$1) [Pay $0 gil./Don't transfer items.]
...
```
  ...
  2: 0x000E [0x1D] PRINT_EVENT_MESSAGE(message_id=10567*)
  ...
  5: 0x001F [0x1D] PRINT_EVENT_MESSAGE(message_id=10568*)
  ...
  7: 0x0023 [0x1D] PRINT_EVENT_MESSAGE(message_id=10569*)
 ...
 10: 0x0034 [0x1D] PRINT_EVENT_MESSAGE(message_id=10570*)
 ...
 12: 0x0038 [0x24] CREATE_DIALOG(message_id=10571*, default_option=1*, option_flags=0*)
