...
```
  ...
  2: 0x0007 [0x1D] PRINT_EVENT_MESSAGE(message_id=10355*)
    → "Hey, \u007F\u0005[mister/lady]! This way to the exit.\u0007You don't happen to have any extra gil, do ya? I'm savin' up for a new pet parrot.\u007F1\u0000\u0007"
...
SUBROUTINE_000D:
 ...
 11: 0x00AB [0x5B] LOAD_EXT_SCHEDULER(work_offset=80*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
