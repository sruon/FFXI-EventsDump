...
- **10608**: If you wish to ride a chocobo, you must possess $6 and have a high enough job level.
- **10609**: You can rent a chocobo for $0 gil. I see you currently have $1 gil.
- **10612**: Do you wish to rent a chocobo? [Yes, I do./No, thank you.]
- **10613**: You don't have enough gil.
- **10620**: Our chocobos do not like traveling in the Sea Serpent Grotto, so we have dug a special exit tunnel leading from here to the Yuhtunga Jungle.
- **10621**: However, take care, as you will not be able to use this tunnel if you wish to return to Norg.
...
```
 ...
 13: 0x0048 [0x1D] PRINT_EVENT_MESSAGE(message_id=10621*)
 ...
 15: 0x004C [0x24] CREATE_DIALOG(message_id=10612*, default_option=1*, option_flags=0*)
 ...
 24: 0x0092 [0x1D] PRINT_EVENT_MESSAGE(message_id=10613*)
...
```
  ...
  2: 0x00B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=10608*)
