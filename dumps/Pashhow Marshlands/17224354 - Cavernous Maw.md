...
- **7829**: An unseen force is drawing you towards the maw.
- **7831**: Raise your $3? [Yes./No.]
- **7846**: To where will you head? [[The past/The present]./Walk of Echoes./Nowhere for now.]
...
```
  ...
  1: 0x00DD [0x48] [System] [7829*]:
    → "An unseen force is drawing you towards the maw."
  2: 0x00E0 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x00E1 [0x03] Work_Zone[2] = 2843*
  4: 0x00E6 [0x24] CREATE_DIALOG(message_id=7831*, default_option=1*, option_flags=0*)
    → "Raise your $3? [Yes./No.]"
  5: 0x00ED [0x25] WAIT_DIALOG_SELECT()
  6: 0x00EE [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0281
  7: 0x00F6 [0x03] Work_Zone[2] = 0*
  8: 0x00FB [0x24] CREATE_DIALOG(message_id=7846*, default_option=2*, option_flags=0*)
