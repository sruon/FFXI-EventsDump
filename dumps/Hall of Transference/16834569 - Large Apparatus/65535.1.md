...
```
  ...
  3: 0x00CF [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  ...
  7: 0x00ED [0x45] LOAD_SCHEDULED_TASK(work_offset1=94*, entity1=EventEntity, entity2=EventEntity, scheduler_id="z14a", work_offset2=0*)
  8: 0x00FE [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
  9: 0x010F [0x1C] WAIT(60* ticks)
 10: 0x0112 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2sw1")
 ...
 13: 0x0131 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
 14: 0x0142 [0x45] LOAD_SCHEDULED_TASK(work_offset1=94*, entity1=EventEntity, entity2=EventEntity, scheduler_id="z14b", work_offset2=0*)
