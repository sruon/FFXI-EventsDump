...
SUBROUTINE_0196:
 ...
 21: 0x019D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 ...
 25: 0x01BB [0x45] LOAD_SCHEDULED_TASK(work_offset1=94*, entity1=EventEntity, entity2=EventEntity, scheduler_id="z14a", work_offset2=0*)
 26: 0x01CC [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 27: 0x01DD [0x1C] WAIT(60* ticks)
 28: 0x01E0 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2sw2")
 ...
 31: 0x01FF [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
 32: 0x0210 [0x45] LOAD_SCHEDULED_TASK(work_offset1=94*, entity1=EventEntity, entity2=EventEntity, scheduler_id="z14b", work_offset2=0*)
 33: 0x0221 [0x1C] WAIT(900* ticks)
 34: 0x0224 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
