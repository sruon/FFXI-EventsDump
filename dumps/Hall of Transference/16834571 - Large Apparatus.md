...
| [123](#event-123)     | 0x0001       |    201 |             25 |
| [124](#event-124)     | 0x00CA       |      1 |              1 |
| [125](#event-125)     | 0x00CB       |    242 |             42 |
| [160](#event-160)     | 0x01BD       |      1 |              1 |
...
```
  ...
  5: 0x00D5 [0x24] CREATE_DIALOG(message_id=7303*, default_option=1*, option_flags=0*)
...
SUBROUTINE_00EF:
 11: 0x00EF [0x24] CREATE_DIALOG(message_id=7304*, default_option=1*, option_flags=0*)
...
SUBROUTINE_0109:
 ...
 21: 0x0110 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
 ...
 25: 0x012E [0x45] LOAD_SCHEDULED_TASK: Load scheduler "z14a" with entities [EventEntity, EventEntity], work=[94*, 0*]
 26: 0x013F [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi1" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
 27: 0x0150 [0x1C] WAIT(60* ticks)
 28: 0x0153 [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "2sw2" with entities [EventEntity, EventEntity]
 ...
 31: 0x0172 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "ovl1" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
 32: 0x0183 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "z14b" with entities [EventEntity, EventEntity], work=[94*, 0*]
 33: 0x0194 [0x1C] WAIT(900* ticks)
 34: 0x0197 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
