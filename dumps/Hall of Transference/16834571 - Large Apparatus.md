...
```
  ...
  5: 0x00D5 [0x24] CREATE_DIALOG(message_id=7301*, default_option=1*, option_flags=0*)
...
SUBROUTINE_00EF:
 11: 0x00EF [0x24] CREATE_DIALOG(message_id=7302*, default_option=1*, option_flags=0*)
