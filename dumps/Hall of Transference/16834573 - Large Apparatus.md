...
```
  ...
  5: 0x00C3 [0x24] CREATE_DIALOG(message_id=7303*, default_option=1*, option_flags=0*)
...
SUBROUTINE_00DD:
 11: 0x00DD [0x24] CREATE_DIALOG(message_id=7304*, default_option=1*, option_flags=0*)
