...
- **9315**: Hail, adventurer! Take a look and see if there's anything you like, kupo! No gil necessary, just a quick little item in exchange!
- **9317**: If so, then I require that you trade me the following all at once in exchange for the $30.
- **9318**: $ $0 .
- **9319**: $ $0 .
- **9320**: Come again soon, kupo!
...
```
  ...
  3: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=9315*)
...
# Dead code (unreachable instructions):
     ...
     0x0073 [0x1D] PRINT_EVENT_MESSAGE(message_id=9320*)
    → "Come again soon, kupo!"
     ...
     0x0092 [0x1D] PRINT_EVENT_MESSAGE(message_id=9317*)
