...
```
  ...
  3: 0x0022 [0x1D] PRINT_EVENT_MESSAGE(message_id=7879*)
    → "It's now time to show those Orcs the true force of the Royal Knights. The battle will go down in history as the day we put an end to their fiendish plots!\u007F1\u0000\u0007"
