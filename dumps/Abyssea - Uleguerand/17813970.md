...
- **7495**: You sense an aura of boundless rage...
- **7496**: Your keen senses tell you that something may happen if only you had [this item/these items].
- **7498**: 6...
- **7499**: Use the [key item/key items]? [Yes./No.]
...
SUBROUTINE_00BA:
 ...
 48: 0x00BE [0x24] CREATE_DIALOG(message_id=7499*, default_option=1*, option_flags=0*)
