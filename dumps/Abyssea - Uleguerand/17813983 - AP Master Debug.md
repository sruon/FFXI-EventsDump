...
- **7669**: AP Debug: Do what? [Nuttin'./AP: Adjust elapsed time./AP: Adjust number of quests cleared for all PCs./AP: Adjust amount of XP obtained for all PCs./AP: Adjust amount of cruor for all PCs./AP: Adjust number of NMs defeated for all PCs./AP: Adjust number of HNMs defeated for all PCs./AP: Adjust pollution levels for this area./AP: Adjust number of defenses for this area./OT: Acquire info pertaining to "Order Trophy."]
- **7670**: Elapsed time: $0P (1P = $1 min)
- **7671**: XP: $0P (1P = $1 QUEST)
- **7672**: XP: $0P (1P = $1 XP)
- **7673**: Cruor: $0P (1P = $1 cruor)
- **7674**: NMs defeated: $0P (1P = $1 NM)
- **7675**: HNMs defeated: $0P (1P = $1 HNM)
- **7676**: Pollution level: $0 P
- **7677**: Number of defenses: $0 P
- **7678**: Change value? [No thanks./Increase./Decrease.]
- **7679**: All clear to receive the effect of "Flee"? [ Oh Goddess, no!/ Bring it on!]
- **7680**: Your fortune for today is [terrible/meh/decent/moderately good/very good]. As such, I shall imbue you with $1 minute(s) of "Flee."
- **7681**: OT Debug: Do what? [Nothing for now./OT: Obtainment bonus./OT: Fortune rate./OT: Externimation record.]
- **7682**: Obtained bonus work. XP added: $0. Cruor added: $1. NMs defeated: $2.
- **7683**: Fortune rate work. Spawn rate added value: $0 Blue casket spawn rate: $1 Red casket spawn rate: $2 Gold casket spawn rate: $3
- **7684**: Extermination record work. Previous monster defeated: $0. No. of same ID defeated: $1. No. of diff. ID defeated: $2.
...
```
 ...
 11: 0x0035 [0x24] CREATE_DIALOG(message_id=7669*, default_option=0*, option_flags=0*)
 ...
 23: 0x0077 [0x1D] PRINT_EVENT_MESSAGE(message_id=7670*)
 ...
 31: 0x009E [0x1D] PRINT_EVENT_MESSAGE(message_id=7671*)
    → "XP: $0P (1P = $1 QUEST)"
 ...
 39: 0x00C5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7672*)
    → "XP: $0P (1P = $1 XP)"
 ...
 47: 0x00EC [0x1D] PRINT_EVENT_MESSAGE(message_id=7673*)
    → "Cruor: $0P (1P = $1 cruor)"
 ...
 55: 0x0113 [0x1D] PRINT_EVENT_MESSAGE(message_id=7674*)
 ...
 63: 0x013A [0x1D] PRINT_EVENT_MESSAGE(message_id=7675*)
 ...
 70: 0x015C [0x1D] PRINT_EVENT_MESSAGE(message_id=7676*)
    → "Pollution level: $0 P"
 ...
 77: 0x017E [0x1D] PRINT_EVENT_MESSAGE(message_id=7677*)
 ...
 81: 0x018D [0x24] CREATE_DIALOG(message_id=7681*, default_option=0*, option_flags=0*)
...
109: 0x01F8 [0x24] CREATE_DIALOG(message_id=7679*, default_option=0*, option_flags=0*)
...
138: 0x02A8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7680*)
...
145: 0x02C8 [0x24] CREATE_DIALOG(message_id=7678*, default_option=0*, option_flags=0*)
