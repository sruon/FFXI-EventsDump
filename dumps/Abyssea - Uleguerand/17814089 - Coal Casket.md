...
- **7880**: The casket contains an ample supply of $3.
- **7881**: You cannot carry any more $3.
...
```
  ...
  1: 0x001D [0x48] [System] [7880*]:
    → "The casket contains an ample supply of $3."
  2: 0x0020 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0021 [0x48] [System] [7881*]:
