...
- **8249**: Fame value for this area: $0 Input a value from 0 - 63. (Cancel: 0)
- **8251**: What will you do? [Nothing./Set fame./Quest 01 (Fame: $0)/Quest 02 (Fame: $1)/Quest 03 (Fame: $2)/Quest 04 (Fame: $3)/Quest 05 (Fame: $4)/Quest 06 (Fame: $5)/Quest 07 (Fame: $6)/Quest 08 (Fame: $7)/Quest 09 (Fame: $8)/Quest 10 (Fame: $9)/AP (elapsed time) check (Currently: [Seeing/Not seeing])]
- **8252**: What will yo do? (Quest ) [Nothing./Set quest eligibility./Quest progress./Obtain key item./Complete quest./Set times completed.]
...
```
  ...
  7: 0x0023 [0x24] CREATE_DIALOG(message_id=8251*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00D2:
 44: 0x00D2 [0x24] CREATE_DIALOG(message_id=8252*, default_option=0*, option_flags=ExtData[1]->WorkLocal[3])
