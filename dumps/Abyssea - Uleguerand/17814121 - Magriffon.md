...
- **7861**: Current progress: [Ancient abyssite obtained: $0/$1/Atma obtained: $2/$3/Quests completed: $4/$5/Return.]
- **7862**: [Requirement/Objective completed]: Obtain all ancient abyssite found in this area.
- **7863**: [Requirement/Objective completed]: Obtain all atma found in this area.
- **7864**: [Requirement/Objective completed]: Complete all quests issued in this area.
- **8072**: <Player>? Can't say I've ever heard that name.
- **8073**: What did you expect? Those who live in chill, harsh environs such as these are slow to warm up to strangers.
- **8074**: But take heart. Do what you can to make yourself useful, and someday you might find yourself as beloved as me. Ahahaha!
- **8075**: <Player>, you say? Yes, I may have overheard a person mention someone who claims he might have possibly known a fellow who spoke a name that almost vaguely resembles yours...though I cannot be sure.
- **8076**: Keep working as you are, and I'm sure the community will warm up to you before long. Even if you're not as charming as yours truly. Ahahaha!
- **8077**: <Player>...? Yes, there's no mistaking it. That's a name I heard just this past day.
- **8078**: "Why, [he/she] almost reminds me of a young Magriffon," the fellow said. "Not half as brave and gallant, of course...but then again, who is?"
- **8079**: <Player>! You're quite the talk of the range these days. Seems your hard work has made quite an impression on the survivors.
- **8080**: Just between you and me, do feel free to take a break from playing [hero/heroine] all the time. There's no need to overshadow, er, a certain other prestigious personage. Would you not agree?
- **8081**: Ah, greetings, <Player>. Always a pleasure.
- **8082**: Every time I hear your name--quite often these days, I must say--it brings to mind my own remarkable exploits. Exploits that people don't seem to be speaking much of these days...<sigh>.
- **8083**: Well, you've certainly done it, <Player>. You've completely eclipsed yours truly in the hearts and minds of the survivors of Uleguerand.
- **8084**: I must admit: at first, I was more than a little jealous. But not anymore. We're truly fortunate that you arrived.
- **8085**: No doubt it's thanks to the $3 I acquired. I knew it was worth every last coin!
...
SUBROUTINE_0031:
 ...
 12: 0x003D [0x1D] PRINT_EVENT_MESSAGE(message_id=8083*)
 ...
 14: 0x0041 [0x1D] PRINT_EVENT_MESSAGE(message_id=8084*)
 ...
 17: 0x004A [0x1D] PRINT_EVENT_MESSAGE(message_id=8085*)
...
SUBROUTINE_0075:
 ...
 28: 0x0081 [0x1D] PRINT_EVENT_MESSAGE(message_id=8081*)
    → "Ah, greetings, <Player>. Always a pleasure."
 29: 0x0084 [0x23] WAIT_FOR_DIALOG_INTERACTION
 30: 0x0085 [0x1D] PRINT_EVENT_MESSAGE(message_id=8082*)
...
SUBROUTINE_00B0:
 ...
 40: 0x00BF [0x1D] PRINT_EVENT_MESSAGE(message_id=8079*)
 ...
 42: 0x00C3 [0x1D] PRINT_EVENT_MESSAGE(message_id=8080*)
...
SUBROUTINE_0138:
 ...
 66: 0x0147 [0x1D] PRINT_EVENT_MESSAGE(message_id=8075*)
 ...
 68: 0x014B [0x1D] PRINT_EVENT_MESSAGE(message_id=8076*)
...
SUBROUTINE_017D:
 ...
 78: 0x018C [0x1D] PRINT_EVENT_MESSAGE(message_id=8072*)
    → "<Player>? Can't say I've ever heard that name."
 79: 0x018F [0x23] WAIT_FOR_DIALOG_INTERACTION
 80: 0x0190 [0x1D] PRINT_EVENT_MESSAGE(message_id=8073*)
 ...
 82: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=8074*)
...
# Dead code (unreachable instructions):
     ...
     0x01DD [0x24] CREATE_DIALOG(message_id=7861*, default_option=0*, option_flags=0*)
