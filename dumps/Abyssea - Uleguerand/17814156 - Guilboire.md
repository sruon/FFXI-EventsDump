...
- **8154**: A sharp pair of eyes you have there, friend. Don't travel too far. I may have need of you before long.
- **8155**: A sharp pair of eyes you have there, friend. Yes, I believe I have just the job for you.
- **8156**: Feast those eyes of yours upon this parchment. These are plans for harnessing the fearsome explosive power of snolls, recovered from Xarcabard by my father during the Great War.
- **8157**: After the cataclysm, I made it my life's work to see this project to fruition, that we might strike back at the hordes with the shattering force of a thousand avalanches.
- **8158**: After months of painstaking research, all that stands between me and success is one final detonation experiment. An experiment in which you will be graciously serving as my assistant.
- **8159**: Worry not, friend. The experiment will pose little risk to your well-being...if conducted properly, that is.
- **8160**: So pray listen carefully. First, I will be entrusting you with a high-precision instrument.
- **8161**: You are to take it and make your way to the testing site located due north of here.
- **8162**: When you arrive, you are to set it--$6, I call it--at the designated point of impact. Upon doing so, you will soon observe that snolls are drawn to its presence.
- **8163**: The $3 emits a light that, while invisible to our eyes, will affect the snoll in myriad ways. In addition to attracting their attention, it will also disrupt their internal biological workings, accelerating the process known as hypothermal combustion.
- **8164**: You are to make skillful use of this instrument and trigger an explosion as close to the impact point as possible.
- **8165**: Setting off explosions haphazardly will serve only to waste time and resources that we do not have. I have put down detailed instructions in writing to ensure that the experiment will proceed as intended.
- **8166**: When your work is done, retrieve the $3 and deliver it back to me.
- **8167**: I would collect the data myself if I could, but alas! The infirm body of a researcher is ill-suited for manual labor.
- **8168**: You are not the only one who has graciously agreed to aid in my work. Should you come across any of my other assistants in the field, you will no doubt find it beneficial to work as a team.
- **8169**: I await word of your success. Go in safety!
- **8170**: Ah, there you are, friend! Allow me to examine your $3.
- **8171**: ...
- **8172**: Marvelous! It would seem the experiment was a success beyond even my wildest expectations! I truly cannot thank you enough.
- **8173**: Of course, my work is not yet complete. There are still improvements and adjustments to be made.
- **8174**: Promise me that I can count on your aid again.
- **8175**: ...I see. While not an outright failure, it would seem there is still considerable room for improvement.
- **8176**: The experiment was a failure!? You cannot be serious!
- **8177**: Fortunately, I have a spare set of instruments. Take this, and do try to be more careful this time.
- **8178**: Ah, there you are! And your timing could not be better. I am pleased to announce that preparations for my latest experiment are complete.
- **8179**: I trust you remember the procedure?
- **8180**: Do you remember? [Of course!/Uh, actually...]
...
```
  ...
  3: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=8154*)
...
```
  ...
  4: 0x0016 [0x1D] PRINT_EVENT_MESSAGE(message_id=8155*)
  ...
  7: 0x0029 [0x1D] PRINT_EVENT_MESSAGE(message_id=8156*)
 ...
 10: 0x003C [0x1D] PRINT_EVENT_MESSAGE(message_id=8157*)
 ...
 12: 0x0040 [0x1D] PRINT_EVENT_MESSAGE(message_id=8158*)
 ...
 17: 0x005F [0x1D] PRINT_EVENT_MESSAGE(message_id=8159*)
 ...
 20: 0x0072 [0x1D] PRINT_EVENT_MESSAGE(message_id=8160*)
 ...
 22: 0x0076 [0x1D] PRINT_EVENT_MESSAGE(message_id=8161*)
 ...
 25: 0x0089 [0x1D] PRINT_EVENT_MESSAGE(message_id=8162*)
 ...
 27: 0x008D [0x1D] PRINT_EVENT_MESSAGE(message_id=8163*)
 ...
 30: 0x00A0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8164*)
 ...
 33: 0x00B3 [0x1D] PRINT_EVENT_MESSAGE(message_id=8165*)
 ...
 40: 0x00CE [0x1D] PRINT_EVENT_MESSAGE(message_id=8168*)
 ...
 42: 0x00D2 [0x1D] PRINT_EVENT_MESSAGE(message_id=8169*)
...
```
  ...
  3: 0x00EE [0x1D] PRINT_EVENT_MESSAGE(message_id=8169*)
    → "I await word of your success. Go in safety!"
...
```
  ...
  4: 0x00FC [0x1D] PRINT_EVENT_MESSAGE(message_id=8176*)
  ...
  7: 0x010F [0x1D] PRINT_EVENT_MESSAGE(message_id=8177*)
  ...
  9: 0x0113 [0x1D] PRINT_EVENT_MESSAGE(message_id=8169*)
    → "I await word of your success. Go in safety!"
...
```
 ...
 11: 0x0135 [0x1D] PRINT_EVENT_MESSAGE(message_id=8173*)
 ...
 15: 0x014B [0x1D] PRINT_EVENT_MESSAGE(message_id=8175*)
...
SUBROUTINE_015E:
 18: 0x015E [0x1D] PRINT_EVENT_MESSAGE(message_id=8174*)
...
```
  ...
  3: 0x017C [0x1D] PRINT_EVENT_MESSAGE(message_id=8173*)
    → "Of course, my work is not yet complete. There are still improvements and adjustments to be made."
  4: 0x017F [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0180 [0x1D] PRINT_EVENT_MESSAGE(message_id=8174*)
    → "Promise me that I can count on your aid again."
...
```
  ...
  4: 0x018E [0x1D] PRINT_EVENT_MESSAGE(message_id=8178*)
  ...
  6: 0x0192 [0x1D] PRINT_EVENT_MESSAGE(message_id=8179*)
    → "I trust you remember the procedure?"
  7: 0x0195 [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x0196 [0x24] CREATE_DIALOG(message_id=8180*, default_option=0*, option_flags=0*)
 ...
 13: 0x01B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=8158*)
    → "After months of painstaking research, all that stands between me and success is one final detonation experiment. An experiment in which you will be graciously serving as my assistant."
 ...
 16: 0x01C4 [0x1D] PRINT_EVENT_MESSAGE(message_id=8160*)
    → "So pray listen carefully. First, I will be entrusting you with a high-precision instrument."
 17: 0x01C7 [0x23] WAIT_FOR_DIALOG_INTERACTION
 18: 0x01C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=8161*)
    → "You are to take it and make your way to the testing site located due north of here."
 ...
 21: 0x01DB [0x1D] PRINT_EVENT_MESSAGE(message_id=8162*)
    → "When you arrive, you are to set it--$6, I call it--at the designated point of impact. Upon doing so, you will soon observe that snolls are drawn to its presence."
 22: 0x01DE [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x01DF [0x1D] PRINT_EVENT_MESSAGE(message_id=8163*)
    → "The $3 emits a light that, while invisible to our eyes, will affect the snoll in myriad ways. In addition to attracting their attention, it will also disrupt their internal biological workings, accelerating the process known as hypothermal combustion."
 ...
 26: 0x01F2 [0x1D] PRINT_EVENT_MESSAGE(message_id=8164*)
    → "You are to make skillful use of this instrument and trigger an explosion as close to the impact point as possible."
 ...
 29: 0x0205 [0x1D] PRINT_EVENT_MESSAGE(message_id=8165*)
    → "Setting off explosions haphazardly will serve only to waste time and resources that we do not have. I have put down detailed instructions in writing to ensure that the experiment will proceed as intended."
 30: 0x0208 [0x23] WAIT_FOR_DIALOG_INTERACTION
 31: 0x0209 [0x1D] PRINT_EVENT_MESSAGE(message_id=8166*)
    → "When your work is done, retrieve the $3 and deliver it back to me."
 32: 0x020C [0x23] WAIT_FOR_DIALOG_INTERACTION
 33: 0x020D [0x01] GOTO 0x0210

SUBROUTINE_0210:
 34: 0x0210 [0x1D] PRINT_EVENT_MESSAGE(message_id=8168*)
    → "You are not the only one who has graciously agreed to aid in my work. Should you come across any of my other assistants in the field, you will no doubt find it beneficial to work as a team."
 35: 0x0213 [0x23] WAIT_FOR_DIALOG_INTERACTION
 36: 0x0214 [0x1D] PRINT_EVENT_MESSAGE(message_id=8169*)
    → "I await word of your success. Go in safety!"
