...
```
  ...
  7: 0x0023 [0x24] CREATE_DIALOG(message_id=8246*, default_option=0*, option_flags=0*)
    → "What will you do?\u0007\u000BNothing.\u0007Set fame.\u0007Quest 01 (Fame: 
\u0000)\u0007Quest 02 (Fame: 
\u0001)\u0007Quest 03 (Fame: 
\u0002)\u0007Quest 04 (Fame: 
\u0003)\u0007Quest 05 (Fame: 
...
\u0007)\u0007Quest 09 (Fame: 
\u0008)\u0007Quest 10 (Fame: 
	)\u0007AP (elapsed time) check (Currently: \u000C
[Seeing/Not seeing])\u007F1\u0000\u0007"
 ...
 16: 0x0050 [0x48] [System] [8244*]:
    → "Fame value for this area: 
\u0000\u0007Input a value from 0 - 63.\u0007(Cancel: 0)\u0000\u0007"
...
SUBROUTINE_00D2:
 44: 0x00D2 [0x24] CREATE_DIALOG(message_id=8247*, default_option=0*, option_flags=0x03)
    → "What will yo do? (Quest \u007F\u0014\u001F)\u0007\u000BNothing.\u0007Set quest eligibility.\u0007Quest progress.\u0007Obtain key item.\u0007Complete quest.\u0007Set times completed.\u007F1\u0000\u0007"
