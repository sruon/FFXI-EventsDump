...
```
  ...
  2: 0x029D [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=1*, source=Work_Zone[3], result=ExtData[1]->WorkLocal[4])
  3: 0x02A6 [0x41] GET_BIT_WORK_RANGE(start_bit=2*, end_bit=5*, source=Work_Zone[3], result=ExtData[1]->WorkLocal[5])
