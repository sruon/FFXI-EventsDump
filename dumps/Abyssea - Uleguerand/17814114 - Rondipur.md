...
- **8028**: ...Still no contact. If this persists, we'll have a serious situation on our hands.
- **8029**: You. You are <Player>, yes? I have heard much of you.
- **8030**: Time is of the essence, so I will be brief. I have lost contact with my three scouts.
- **8031**: Without their reports, we are all in grave danger. We must find them. Will you aid?
- **8032**: Search for the scouts? [I will./I will not.]
- **8033**: Excellent. You have my thanks.
- **8034**: ...Then leave me.
- **8035**: As I said a moment ago, the scouts are three. Cannau, dispatched to the northwestern reaches, Olavia in the southeast, and Wanzo-Unzozo, who last reported from north of Bearclaw Pinnacle.
- **8036**: I await word of your success.
- **8054**: Oh, there you are. I'm pleased to inform you that I received reports from all three of my scouts. Of course, only Olavia had anything of import to share...
- **8055**: And even that was no doubt more your doing than hers. Take this as a reward for your efforts, friend.
- **8056**: I hope I can count on you to bring my scouts in line again, should the need arise.
- **8057**: Ah, there you are, <Player>, and not a moment too soon. I suspect this will come as little surprise to you, but...
...
```
  ...
  3: 0x0010 [0x1D] PRINT_EVENT_MESSAGE(message_id=8028*)
...
```
  ...
  5: 0x002D [0x1D] PRINT_EVENT_MESSAGE(message_id=8029*)
    → "You. You are <Player>, yes? I have heard much of you."
  6: 0x0030 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0031 [0x1D] PRINT_EVENT_MESSAGE(message_id=8030*)
  ...
  9: 0x0035 [0x1D] PRINT_EVENT_MESSAGE(message_id=8031*)
 ...
 12: 0x0048 [0x24] CREATE_DIALOG(message_id=8032*, default_option=0*, option_flags=0*)
    → "Search for the scouts? [I will./I will not.]"
 13: 0x004F [0x25] WAIT_DIALOG_SELECT()
 14: 0x0050 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0064
 15: 0x0058 [0x1D] PRINT_EVENT_MESSAGE(message_id=8033*)
 ...
 20: 0x006C [0x1D] PRINT_EVENT_MESSAGE(message_id=8034*)
    → "...Then leave me."
...
SUBROUTINE_0079:
 ...
 26: 0x0085 [0x1D] PRINT_EVENT_MESSAGE(message_id=8035*)
 ...
 28: 0x0089 [0x1D] PRINT_EVENT_MESSAGE(message_id=8036*)
...
```
  ...
  4: 0x00A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=8035*)
    → "As I said a moment ago, the scouts are three. Cannau, dispatched to the northwestern reaches, Olavia in the southeast, and Wanzo-Unzozo, who last reported from north of Bearclaw Pinnacle."
  5: 0x00A8 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x00A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=8036*)
    → "I await word of your success."
...
```
  ...
  4: 0x00C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=8054*)
  ...
  6: 0x00CA [0x1D] PRINT_EVENT_MESSAGE(message_id=8055*)
...
```
  ...
  3: 0x00F7 [0x1D] PRINT_EVENT_MESSAGE(message_id=8056*)
...
```
  ...
  7: 0x0114 [0x1D] PRINT_EVENT_MESSAGE(message_id=8057*)
  ...
  9: 0x0118 [0x1D] PRINT_EVENT_MESSAGE(message_id=8030*)
    → "Time is of the essence, so I will be brief. I have lost contact with my three scouts."
 10: 0x011B [0x23] WAIT_FOR_DIALOG_INTERACTION
 11: 0x011C [0x24] CREATE_DIALOG(message_id=8032*, default_option=0*, option_flags=0*)
    → "Search for the scouts? [I will./I will not.]"
 12: 0x0123 [0x25] WAIT_DIALOG_SELECT()
 13: 0x0124 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0138
 14: 0x012C [0x1D] PRINT_EVENT_MESSAGE(message_id=8033*)
    → "Excellent. You have my thanks."
 ...
 19: 0x0140 [0x1D] PRINT_EVENT_MESSAGE(message_id=8034*)
    → "...Then leave me."
...
SUBROUTINE_014D:
 ...
 25: 0x0159 [0x1D] PRINT_EVENT_MESSAGE(message_id=8035*)
    → "As I said a moment ago, the scouts are three. Cannau, dispatched to the northwestern reaches, Olavia in the southeast, and Wanzo-Unzozo, who last reported from north of Bearclaw Pinnacle."
 26: 0x015C [0x23] WAIT_FOR_DIALOG_INTERACTION
 27: 0x015D [0x1D] PRINT_EVENT_MESSAGE(message_id=8036*)
    → "I await word of your success."
