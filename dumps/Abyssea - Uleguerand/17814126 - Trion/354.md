...
```
  ...
  4: 0x0010 [0x5B] LOAD_EXT_SCHEDULER(work_offset=115*, entity1=EventEntity, entity2=EventEntity, action="lau0")
  ...
  9: 0x0027 [0x5B] LOAD_EXT_SCHEDULER(work_offset=115*, entity1=EventEntity, entity2=EventEntity, action="lau1")
 10: 0x0036 [0x01] GOTO 0x00F6

SUBROUTINE_0039:
 11: 0x0039 [0x02] IF !(Work_Zone[2] <= 75*) GOTO 0x006A
 12: 0x0041 [0x5B] LOAD_EXT_SCHEDULER(work_offset=115*, entity1=EventEntity, entity2=EventEntity, action="lau0")
 ...
 17: 0x0058 [0x5B] LOAD_EXT_SCHEDULER(work_offset=115*, entity1=EventEntity, entity2=EventEntity, action="lau1")
 18: 0x0067 [0x01] GOTO 0x00F6

SUBROUTINE_006A:
 19: 0x006A [0x02] IF !(Work_Zone[2] <= 50*) GOTO 0x009B
 20: 0x0072 [0x5B] LOAD_EXT_SCHEDULER(work_offset=115*, entity1=EventEntity, entity2=EventEntity, action="ara0")
 ...
 25: 0x0089 [0x5B] LOAD_EXT_SCHEDULER(work_offset=115*, entity1=EventEntity, entity2=EventEntity, action="ara1")
 26: 0x0098 [0x01] GOTO 0x00F6

SUBROUTINE_009B:
 27: 0x009B [0x02] IF !(Work_Zone[2] <= 25*) GOTO 0x00CC
 28: 0x00A3 [0x5B] LOAD_EXT_SCHEDULER(work_offset=115*, entity1=EventEntity, entity2=EventEntity, action="ara0")
 ...
 33: 0x00BA [0x5B] LOAD_EXT_SCHEDULER(work_offset=115*, entity1=EventEntity, entity2=EventEntity, action="ara1")
 34: 0x00C9 [0x01] GOTO 0x00F6

SUBROUTINE_00CC:
 35: 0x00CC [0x5B] LOAD_EXT_SCHEDULER(work_offset=115*, entity1=EventEntity, entity2=EventEntity, action="ara0")
 ...
 40: 0x00E3 [0x5B] LOAD_EXT_SCHEDULER(work_offset=115*, entity1=EventEntity, entity2=EventEntity, action="ara1")
