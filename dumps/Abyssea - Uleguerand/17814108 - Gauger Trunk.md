...
- **8142**: It appears sturdily built.
- **8143**: The casket is stocked with $0. A message scrawled on the lid reads: "$1 cruor a pop! No freebies!"
- **8144**: Purchase $0?
- **8145**: You have $0 cruor. Purchase? [Yes./No.]
- **8146**: Purchase how many? (Maximum purchase: 12).
- **8147**: The total fee comes to $0 cruor. Make the purchase?
...
```
 ...
 21: 0x0061 [0x24] CREATE_DIALOG(message_id=8145*, default_option=0*, option_flags=0*)
    → "You have $0 cruor. Purchase? [Yes./No.]"
