...
- **8082**: I can share with you the records of your exploits, if you're inclined to hear them. Or even if you're not, for that matter.
- **8083**: ...This here's what you've managed to accomplish.
- **8084**: Are my eyes to be believed!? Have you truly completed each and every task?
- **8085**: I believe this calls for a celebration. Take this, friend. You've certainly earned it.
- **8086**: The fiends are fierce in these parts, and the terrain's just as frightful. You'd do well to watch your back...and your footing.
...
# Dead code (unreachable instructions):
     ...
     0x0035 [0x24] CREATE_DIALOG(message_id=7857*, default_option=0*, option_flags=0*)
...
```
  ...
  3: 0x00D0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8082*)
  ...
  6: 0x00D7 [0x1D] PRINT_EVENT_MESSAGE(message_id=8086*)
...
```
  ...
  9: 0x0100 [0x1D] PRINT_EVENT_MESSAGE(message_id=8083*)
 ...
 16: 0x0120 [0x1D] PRINT_EVENT_MESSAGE(message_id=8084*)
...
SUBROUTINE_012C:
 20: 0x012C [0x1D] PRINT_EVENT_MESSAGE(message_id=8085*)
