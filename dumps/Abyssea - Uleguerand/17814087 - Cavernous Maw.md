...
- **7850**: An unseen force is drawing you towards the maw.
- **7852**: Warp to [Dummy/the La Theine Plateau/the Konschtat Highlands/the Tahrongi Canyon/the Buburimu Peninsula/the Valkurm Dunes/the Jugner Forest/South Gustaberg/North Gustaberg/Xarcabard/Qufim Island]? [Proceed./Not yet.]
...
0040: 01 F0 FF FF 7F 07 45 08  80 F0 FF FF 7F F0 FF FF  ......E.........
0050: 7F 61 62 30 37 04 80 45  05 80 F0 FF FF 7F F0 FF  .ab07..E........
...
00B0: 01 F0 FF FF 7F 08 45 05  80 F0 FF FF 7F F0 FF FF  ......E.........
...
```
 ...
 15: 0x003F [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x07)
 16: 0x0046 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "ab07" with entities [LocalPlayer, LocalPlayer], work=[499*, 0*]
 ...
 23: 0x00AF [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x08)
