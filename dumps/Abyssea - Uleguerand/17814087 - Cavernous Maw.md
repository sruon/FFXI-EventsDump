...
- **7854**: An unseen force is drawing you towards the maw.
- **7856**: Warp to [Dummy/the La Theine Plateau/the Konschtat Highlands/the Tahrongi Canyon/the Buburimu Peninsula/the Valkurm Dunes/the Jugner Forest/South Gustaberg/North Gustaberg/Xarcabard/Qufim Island]? [Proceed./Not yet.]
...
```
  ...
  4: 0x000C [0x24] CREATE_DIALOG(message_id=7856*, default_option=1*, option_flags=0*)
