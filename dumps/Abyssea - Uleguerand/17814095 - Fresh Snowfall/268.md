...
SUBROUTINE_007B:
 28: 0x007B [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x008F
 29: 0x0083 [0x03] Work_Zone[1] = 1*
 30: 0x0088 [0x43] SEND_EVENT_UPDATE: Send pending tag to server (packet 0x005B)
 31: 0x008A [0x43] SEND_EVENT_UPDATE: Check pending flag (skip if not pending)
 32: 0x008C [0x01] GOTO 0x00C2

SUBROUTINE_008F:
 33: 0x008F [0x02] IF !(Work_Zone[0] == 2*) GOTO 0x00A3
 34: 0x0097 [0x03] Work_Zone[1] = 2*
 35: 0x009C [0x43] SEND_EVENT_UPDATE: Send pending tag to server (packet 0x005B)
 36: 0x009E [0x43] SEND_EVENT_UPDATE: Check pending flag (skip if not pending)
 37: 0x00A0 [0x01] GOTO 0x00C2

SUBROUTINE_00A3:
 38: 0x00A3 [0x02] IF !(Work_Zone[0] == 3*) GOTO 0x00C2
 39: 0x00AB [0x03] Work_Zone[1] = 3*
 40: 0x00B0 [0x43] SEND_EVENT_UPDATE: Send pending tag to server (packet 0x005B)
 41: 0x00B2 [0x43] SEND_EVENT_UPDATE: Check pending flag (skip if not pending)
 42: 0x00B4 [0x03] Work_Zone[3] = 1717*
 43: 0x00B9 [0x03] Work_Zone[1] = 1*
 44: 0x00BE [0x21] END_EVENT

SUBROUTINE_00C2:
 45: 0x00C2 [0x02] IF !(Work_Zone[9] > 9*) GOTO 0x00D2
 46: 0x00CA [0x03] Work_Zone[4] = 0*
 47: 0x00CF [0x01] GOTO 0x0107

SUBROUTINE_00D2:
 48: 0x00D2 [0x02] IF !(Work_Zone[9] > 19*) GOTO 0x00E2
 49: 0x00DA [0x03] Work_Zone[4] = 1*
 50: 0x00DF [0x01] GOTO 0x0107

SUBROUTINE_00E2:
 51: 0x00E2 [0x02] IF !(Work_Zone[9] > 29*) GOTO 0x00F2
 52: 0x00EA [0x03] Work_Zone[4] = 2*
 53: 0x00EF [0x01] GOTO 0x0107

SUBROUTINE_00F2:
 54: 0x00F2 [0x02] IF !(Work_Zone[9] > 39*) GOTO 0x0102
 55: 0x00FA [0x03] Work_Zone[4] = 3*
 56: 0x00FF [0x01] GOTO 0x0107

SUBROUTINE_0102:
 57: 0x0102 [0x03] Work_Zone[4] = 4*
 58: 0x0107 [0x48] [System] [7908*]:
    → "The chamber of the \u0001\u00055\u0002\u0001\u0000\u0000 \u000C\u0002[contains only a pinch of firesand/contains a small lump of firesand/is filled halfway with firesand/is filled to the brim with firesand/is overflowing with firesand]...\u007F1\u0000\u0007"
 59: 0x010A [0x23] WAIT_FOR_DIALOG_INTERACTION
 60: 0x010B [0x06] ExtData[1]->WorkLocal[1] = 0
 61: 0x010E [0x03] Work_Zone[2] = 1717*
 62: 0x0113 [0x01] GOTO 0x0062
```
