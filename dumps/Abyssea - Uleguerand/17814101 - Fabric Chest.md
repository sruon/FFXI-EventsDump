...
| [282](#event-282)     | 0x0001       |     12 |              6 |
| [283](#event-283)     | 0x000D       |     11 |              5 |
...
- **7931**: It is stocked to the brim with $5.
...
```
  0: 0x0001 [0x03] Work_Zone[2] = 1719*
  1: 0x0006 [0x42] SET_CLI_EVENT_CANCEL_DATA()
  2: 0x0007 [0x48] [System] [7931*]:
