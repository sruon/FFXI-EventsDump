...
- **7471**: You are an adventurer, are you not? Tell me, what's your mission rank?
- **7472**: Well? Hmm... Even the longest journey begins with a single step, they say!
- **7475**: Uh-oh!
- **7479**: Say, that man needs help! Why don't you help him? You are an adventurer, right?
- **7485**: Say, is this yours? It looks like a button... Maybe it fell off when that lady ran into you.
- **7486**: It's not yours, huh? How odd... I'm sure it wasn't here a moment ago!
- **7487**: Well, I'll give it to you anyway. Perhaps it will be of some use.
- **7488**: Say, what's this doing here? Isn't this the button I gave you? You must have dropped it, silly!
- **7489**: You're working hard, right? I think adventurers should battle in the field, not boast in the tavern!
- **7494**: Oh, you can't carry it? It's just a button! Why don't you get rid of some of those other things you're carrying first.
...
```
  ...
  1: 0x003B [0x1D] PRINT_EVENT_MESSAGE(message_id=7475*)
    → "Uh-oh!"
...
```
 ...
 15: 0x00DA [0x1D] PRINT_EVENT_MESSAGE(message_id=7471*)
 ...
 20: 0x00F5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7472*)
 ...
 32: 0x0155 [0x2B] Esca (ID: 17727494/0x010E8006) [7473*]:
    → "Hey! Out of my way!"
 ...
 46: 0x01B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7475*)
    → "Uh-oh!"
 ...
 61: 0x021E [0x2B] Esca (ID: 17727494/0x010E8006) [7477*]:
 ...
 83: 0x02CD [0x1D] PRINT_EVENT_MESSAGE(message_id=7479*)
...
```
  ...
  4: 0x02F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7479*)
    → "Say, that man needs help! Why don't you help him? You are an adventurer, right?"
...
```
  ...
  4: 0x0317 [0x1D] PRINT_EVENT_MESSAGE(message_id=7485*)
  ...
  7: 0x031E [0x1D] PRINT_EVENT_MESSAGE(message_id=7486*)
 ...
 12: 0x0339 [0x1D] PRINT_EVENT_MESSAGE(message_id=7487*)
...
```
  ...
  4: 0x0365 [0x1D] PRINT_EVENT_MESSAGE(message_id=7489*)
...
```
  ...
  4: 0x0389 [0x1D] PRINT_EVENT_MESSAGE(message_id=7494*)
...
```
  ...
  4: 0x03AD [0x1D] PRINT_EVENT_MESSAGE(message_id=7488*)
