...
- **7468**: You are an adventurer, are you not? Tell me, what's your mission rank?
- **7469**: Well? Hmm... Even the longest journey begins with a single step, they say!
- **7472**: Uh-oh!
- **7476**: Say, that man needs help! Why don't you help him? You are an adventurer, right?
- **7482**: Say, is this yours? It looks like a button... Maybe it fell off when that lady ran into you.
- **7483**: It's not yours, huh? How odd... I'm sure it wasn't here a moment ago!
- **7484**: Well, I'll give it to you anyway. Perhaps it will be of some use.
- **7485**: Say, what's this doing here? Isn't this the button I gave you? You must have dropped it, silly!
- **7486**: You're working hard, right? I think adventurers should battle in the field, not boast in the tavern!
- **7491**: Oh, you can't carry it? It's just a button! Why don't you get rid of some of those other things you're carrying first.
...
```
  ...
  1: 0x003B [0x1D] PRINT_EVENT_MESSAGE(message_id=7472*)
    → "Uh-oh!"
...
```
 ...
 15: 0x00DA [0x1D] PRINT_EVENT_MESSAGE(message_id=7468*)
 ...
 20: 0x00F5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7469*)
 ...
 32: 0x0155 [0x2B] Esca (ID: 17727494/0x010E8006) [7470*]:
    → "Hey! Out of my way!"
 ...
 46: 0x01B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7472*)
    → "Uh-oh!"
 ...
 61: 0x021E [0x2B] Esca (ID: 17727494/0x010E8006) [7474*]:
 ...
 83: 0x02CD [0x1D] PRINT_EVENT_MESSAGE(message_id=7476*)
...
```
  ...
  4: 0x02F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7476*)
    → "Say, that man needs help! Why don't you help him? You are an adventurer, right?"
...
```
  ...
  4: 0x0317 [0x1D] PRINT_EVENT_MESSAGE(message_id=7482*)
  ...
  7: 0x031E [0x1D] PRINT_EVENT_MESSAGE(message_id=7483*)
 ...
 12: 0x0339 [0x1D] PRINT_EVENT_MESSAGE(message_id=7484*)
...
```
  ...
  4: 0x0365 [0x1D] PRINT_EVENT_MESSAGE(message_id=7486*)
...
```
  ...
  4: 0x0389 [0x1D] PRINT_EVENT_MESSAGE(message_id=7491*)
...
```
  ...
  4: 0x03AD [0x1D] PRINT_EVENT_MESSAGE(message_id=7485*)
