...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=7664*)
    → "Up ahead are the airship docks. The Grand Duchy of Jeuno runs all the airships, you know.\u007F1\u0000\u0007"
  5: 0x001A [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x001B [0x1C] WAIT(30* ticks)
  7: 0x001E [0x1D] PRINT_EVENT_MESSAGE(message_id=7665*)
    → "Only those of good standing, or deep pockets, are allowed onboard. I can't see why you'd want to go there.\u007F1\u0000\u0007"
