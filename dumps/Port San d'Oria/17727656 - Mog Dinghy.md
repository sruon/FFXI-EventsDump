...
- **11811**: Move to a Mog Garden? [Most definitely!/Maybe not.]
...
```
  ...
  1: 0x0006 [0x24] CREATE_DIALOG(message_id=11811*, default_option=0*, option_flags=0*)
