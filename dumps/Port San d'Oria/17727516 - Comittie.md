...
- **7990**: Now delivering parcels to rooms everywhere!
- **7991**: Send? [Yes./Not now.]
...
```
  ...
  4: 0x0018 [0x1D] PRINT_EVENT_MESSAGE(message_id=7990*)
  ...
  7: 0x0021 [0x24] CREATE_DIALOG(message_id=7991*, default_option=0*, option_flags=0*)
    → "Send? [Yes./Not now.]"
