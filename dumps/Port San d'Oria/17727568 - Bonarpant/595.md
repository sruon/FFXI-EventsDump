...
```
  ...
  3: 0x0091 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  4: 0x00A0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7902*)
    → "It seems everyone is worried about the Orcs these days. Something's going on, that's for certain!\u007F1\u0000\u0007"
  5: 0x00A3 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x00A4 [0x1C] WAIT(30* ticks)
  7: 0x00A7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7903*)
    → "It's about time we marched on their camps, I say. We've put up with those Orcs long enough! We Elvaan must put them back in their place.\u007F1\u0000\u0007"
