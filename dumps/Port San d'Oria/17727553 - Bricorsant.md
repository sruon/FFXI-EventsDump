...
- **7973**: Know your way around Port San d'Oria? Perhaps my map may be of service.
- **7974**: Look at the map? [Yes./No.]
- **7975**: Lufet Lake occupies half of Port San d'Oria. The travel agency and a pub lie at the north end of the wharf, and the auction house and cargo rooms at the south.
- **7976**: Head southeast for the Magicmart and residential area, or southwest for Laborman's Way in Northern San d'Oria.
- **7977**: As you wish.
...
```
  ...
  4: 0x0018 [0x1D] PRINT_EVENT_MESSAGE(message_id=7973*)
  ...
  7: 0x0021 [0x24] CREATE_DIALOG(message_id=7974*, default_option=0*, option_flags=0*)
 ...
 11: 0x0036 [0x1D] PRINT_EVENT_MESSAGE(message_id=7975*)
 ...
 14: 0x003D [0x1D] PRINT_EVENT_MESSAGE(message_id=7976*)
 ...
 22: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=7977*)
    → "As you wish."
