...
| [811](#event-811)        | 0x01D8       |    733 |            155 |
| [800](#event-800)        | 0x04B5       |    147 |             29 |
| [801](#event-801)        | 0x0548       |     30 |             10 |
| [802](#event-802)        | 0x0566       |     28 |              8 |
| [803](#event-803)        | 0x0582       |     28 |              8 |
| [65535.1](#event-655351) | 0x059E       |     28 |              8 |
| [812](#event-812)        | 0x05BA       |     93 |             23 |
| [813](#event-813)        | 0x0617       |     33 |             11 |
| [814](#event-814)        | 0x0638       |     28 |              8 |
| [815](#event-815)        | 0x0654       |     28 |              8 |
| [816](#event-816)        | 0x0670       |     33 |             11 |
...
- **11490**: Oy, would ya get a look at yer $0! I guess I can let ya open [/Dial 1/Dial 2/Dial 3/Dial 4/Dial 5/the special dial///the abjuration dial/the fortune dial/the furnishings dial//the Vana'versary dial] whenever ya want fer not a single onz o' daily tally!
- **11491**: Dun think that I's be a gil-grubbin' good-fer-nuthin'. If'n ya dun wanna open any dial, then I gives ya back yer $0.
- **11492**: Yer eyes be bigger'n yer stomach. If'n ya wanna open [/Dial 1/Dial 2/Dial 3/Dial 4/Dial 5/the Special Dial///the abjuration dial/the fortune dial/the furnishings dial//the Vana'versary dial] usin' yer $0, then ya gotta make room in yer bags!
...
# Dead code (unreachable instructions):
    ...
    → "So ya be wantin' the [special/Adoulin/pictlogica/Wanted] dial? Whoawhoawhoa! Get yer grubby hands offa that! I's already opened one fer ya today! Haul that keister outta here and come back t'morrow."
     ...
     0x0419 [0x1D] PRINT_EVENT_MESSAGE(message_id=11468*)
    → "Dis box is full o' myst'ries,t Dat span da realm's his'try,t So whatcha gonna get from da chest...o'...uh, fortunery?t"
     ...
     0x0483 [0x1D] PRINT_EVENT_MESSAGE(message_id=11469*)
    → "Oooh, looks at what popped out! I hopes it makes yer adventures dat much more adventumarous!"
...
```
 ...
 16: 0x0526 [0x1D] PRINT_EVENT_MESSAGE(message_id=11478*)
 ...
 20: 0x0535 [0x1D] PRINT_EVENT_MESSAGE(message_id=11479*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0540:                          42 1E 93 80 0E 01 6F 70          B.....op
...
```
  ...
  1: 0x0549 [0x1E] EventEntity looks at Treasure Coffer (ID: 17727635/0x010E8093) and starts talking
  ...
  6: 0x0560 [0x1D] PRINT_EVENT_MESSAGE(message_id=11481*)
...
```
  ...
  4: 0x057C [0x1D] PRINT_EVENT_MESSAGE(message_id=11482*)
...
```
  ...
  4: 0x0598 [0x1D] PRINT_EVENT_MESSAGE(message_id=11483*)
...
```
  ...
  4: 0x05B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=11486*)
...
```
  ...
  1: 0x05BB [0x7A] VM_CONTROL: Copy data from Unknown NPC (ID: 243307392/0x0E809380) (params=1, 2)
  ...
  6: 0x05D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=11490*)
...
```
  ...
  5: 0x062E [0x1D] PRINT_EVENT_MESSAGE(message_id=11491*)
...
```
  ...
  4: 0x064E [0x1D] PRINT_EVENT_MESSAGE(message_id=11492*)
...
```
  ...
  4: 0x066A [0x1D] PRINT_EVENT_MESSAGE(message_id=11493*)
...
```
  ...
  5: 0x0687 [0x1D] PRINT_EVENT_MESSAGE(message_id=11470*)
    → "Ya's thought I threw yer prize away?! Prepostamarous! I's just tucked it away for safekeepin' is all."
