...
- **7521**: Ah, what have we here, a new recruit? I am Fontoumant. Nothing comes in or out the Consortium's warehouses without me knowing about it.
- **7522**: We get shipments from every land here. I can never hire enough workers to handle the load.
- **7523**: Youngsters these days, they lack fortitude! They show up for work once or twice and they disappear. Like seabirds before a gale, they are. Leaving me holding the feathers!
- **7524**: Ah, which reminds me. You wouldn't be needing work, would you? My gil is good, and there's much to be done.
- **7525**: How about it? [I'll work./No, thanks.]
- **7526**: Ach, just like the yearlings I get everyday, you are. Not a strong back in the lot of you!
- **7528**: That's the spirit! There may be some hope for your generation, yet. Here, your first parcel!
- **7529**: Mind you, if you lose it, I'll expect payment for the lost goods. That's my only rule.
- **7530**: Hmm...seems you've a fondness for hauling things already! Clear out your inventory before you take on mine.
- **7531**: I expect you to deliver a parcel before taking another. Everything in the proper order, please.
- **7532**: Wait, you haven't lost the extremely important parcel I entrusted you with, have you?
- **7533**: If you've lost it, you'll have to pay for the loss. Give me 100 gil then and we'll be even.
- **7534**: Fine. Very well, I'll have to go apologize to Regine over at the Magicmart in person. Take more care, next time.
- **7535**: Fine. Very well, I'll have to go apologize to Apstaule over at the auction house in person. Take more care, next time.
- **7536**: Fine. Very well, I'll have to go apologize to Thierride over at the tavern in person. Take more care, next time.
- **7537**: Your first parcel is for Regine's Magicmart.
- **7538**: You'll find it at the end of a passage branching off from the east tunnel.
- **7539**: Give the parcel to the shop owner, Miss Regine, if you would.
- **7553**: This should be easy. Your next parcel is for the auction house.
- **7554**: Walk out that door over there, and it will be right in front of your nose. You can't miss it.
- **7555**: Give the parcel to Apstaule, understood?
- **7560**: Finally! Your third parcel's for the pub.
- **7561**: Go out the door below, turn left, and walk along the waterfront. You'll find the Rusty Anchor there.
- **7562**: Deliver the parcel to a Mr. Thierride. And remember, you're on business!
- **7568**: You did well, <Player>. That should do it for now.
- **7569**: You've done well. Here, take this.
- **7570**: You cannot carry any more gil.
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=7521*)
  ...
  7: 0x001E [0x1D] PRINT_EVENT_MESSAGE(message_id=7522*)
 ...
 10: 0x0025 [0x1D] PRINT_EVENT_MESSAGE(message_id=7523*)
 ...
 13: 0x002C [0x1D] PRINT_EVENT_MESSAGE(message_id=7524*)
 ...
 16: 0x0035 [0x24] CREATE_DIALOG(message_id=7525*, default_option=0*, option_flags=0*)
 ...
 20: 0x0054 [0x1D] PRINT_EVENT_MESSAGE(message_id=7528*)
 ...
 23: 0x005B [0x1D] PRINT_EVENT_MESSAGE(message_id=7529*)
 ...
 32: 0x0070 [0x1D] PRINT_EVENT_MESSAGE(message_id=7539*)
 ...
 40: 0x009B [0x1D] PRINT_EVENT_MESSAGE(message_id=7526*)
...
```
  ...
  4: 0x00C7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7553*)
 ...
 12: 0x00E9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7554*)
 ...
 15: 0x00F0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7555*)
...
```
  ...
  4: 0x0114 [0x1D] PRINT_EVENT_MESSAGE(message_id=7560*)
 ...
 11: 0x013B [0x1D] PRINT_EVENT_MESSAGE(message_id=7561*)
 ...
 14: 0x0142 [0x1D] PRINT_EVENT_MESSAGE(message_id=7562*)
...
```
  ...
  5: 0x0167 [0x1D] PRINT_EVENT_MESSAGE(message_id=7568*)
 ...
 10: 0x0182 [0x1D] PRINT_EVENT_MESSAGE(message_id=7569*)
...
```
  ...
  4: 0x01BF [0x1D] PRINT_EVENT_MESSAGE(message_id=7568*)
    → "You did well, <Player>. That should do it for now."
...
```
  ...
  4: 0x01E3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7531*)
  ...
  7: 0x01EA [0x1D] PRINT_EVENT_MESSAGE(message_id=7532*)
 ...
 10: 0x01F1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7533*)
...
```
  ...
  4: 0x0215 [0x1D] PRINT_EVENT_MESSAGE(message_id=7530*)
...
```
  ...
  6: 0x0242 [0x1D] PRINT_EVENT_MESSAGE(message_id=7534*)
...
```
  ...
  6: 0x026B [0x1D] PRINT_EVENT_MESSAGE(message_id=7535*)
...
```
  ...
  6: 0x0294 [0x1D] PRINT_EVENT_MESSAGE(message_id=7536*)
