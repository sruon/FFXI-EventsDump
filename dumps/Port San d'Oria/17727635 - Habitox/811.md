...
02B0: 02 1D 2A 80 23 5E 69 64  6C 30 1E 94 80 0E 01 6F  ..*.#^idl0.....o
02C0: 70 5B 2B 80 F8 FF FF 7F  F8 FF FF 7F 68 61 70 30  p[+.........hap0
02D0: 1D 2C 80 23 02 04 00 03  80 00 EB 02 03 03 10 02  .,.#............
02E0: 00 29 80 94 80 0E 01 01  1C 2D 80 2C 94 80 0E 01  .).......-.,....
02F0: 94 80 0E 01 6F 70 65 6E  1C 2D 80 50 94 80 0E 01  ....open.-.P....
0300: 94 80 0E 01 6F 70 65 6E  5B 2B 80 F8 FF FF 7F F8  ....open[+......
0310: FF FF 7F 68 61 70 31 2C  94 80 0E 01 94 80 0E 01  ...hap1,........
...
0400: 80 B4 04 1E 94 80 0E 01  6F 70 5B 2B 80 F8 FF FF  ........op[+....
0410: 7F F8 FF FF 7F 68 61 70  30 1D 2C 80 23 02 04 00  .....hap0.,.#...
0420: 03 80 00 34 04 03 03 10  02 00 29 80 94 80 0E 01  ...4......).....
0430: 01 1C 2D 80 2C 94 80 0E  01 94 80 0E 01 6F 70 65  ..-.,........ope
0440: 6E 1C 2D 80 50 94 80 0E  01 94 80 0E 01 6F 70 65  n.-.P........ope
0450: 6E 5B 2B 80 F8 FF FF 7F  F8 FF FF 7F 68 61 70 31  n[+.........hap1
0460: 2C 94 80 0E 01 94 80 0E  01 63 6C 6F 73 1E F0 FF  ,........clos...
...
\u0001, huh? Lessee what myst'ries await!\u0000\u0007"
    ...
    → "So ya be wantin' the \u000C\u0000[special/Adoulin/pictlogica/Wanted/campaign] dial?\u0007M'kay, get yerself all steeled up, 'cause here we go! 'Member, no complaints!\u0000\u0007"
     ...
     0x02BA [0x1E] EventEntity looks at Treasure Coffer (ID: 17727636/0x010E8094) and starts talking
    ...
    → "Dis box is full o' myst'ries,\u0001t\u0007Dat span da realm's his'try,\u0001t\u0007So whatcha gonna get from da chest...o'...uh, fortunery?\u0001t\u0000\u0007"
     ...
     0x02E1 [0x29] REQ_SET_WAIT(priority=0x80, entity_id=Treasure Coffer (ID: 17727636/0x010E8094), tag_num=0x01)
     0x02E8 [0x1C] WAIT(90* ticks)
     0x02EB [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "open" with entities [Treasure Coffer (ID: 17727636/0x010E8094), Treasure Coffer (ID: 17727636/0x010E8094)]
     0x02F8 [0x1C] WAIT(90* ticks)
     0x02FB [0x50] END_SCHEDULER_TASK: End scheduler "op" with entities [References[148], References[148]], work=[270, 270]
     0x0308 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "hap1" with entities [EventEntity, EventEntity], work=216*
     0x0317 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "clos" with entities [Treasure Coffer (ID: 17727636/0x010E8094), Treasure Coffer (ID: 17727636/0x010E8094)]
...
\u0001, huh? \u007F6\u0002\u0007Whatchu tryin' ta pull!? Yer daily tally's too low.\u007F1\u0000\u0007"
    ...
    → "So ya be wantin' the \u000C\u0000[special/Adoulin/pictlogica/Wanted] dial?\u007F6\u0001\u0007Whoawhoawhoa! Get yer grubby hands offa that! I's already opened one fer ya today! Haul that keister outta here and come back t'morrow.\u007F1\u0000\u0007"
     ...
     0x0403 [0x1E] EventEntity looks at Treasure Coffer (ID: 17727636/0x010E8094) and starts talking
    ...
    → "Dis box is full o' myst'ries,\u0001t\u0007Dat span da realm's his'try,\u0001t\u0007So whatcha gonna get from da chest...o'...uh, fortunery?\u0001t\u0000\u0007"
     ...
     0x042A [0x29] REQ_SET_WAIT(priority=0x80, entity_id=Treasure Coffer (ID: 17727636/0x010E8094), tag_num=0x01)
     0x0431 [0x1C] WAIT(90* ticks)
     0x0434 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "open" with entities [Treasure Coffer (ID: 17727636/0x010E8094), Treasure Coffer (ID: 17727636/0x010E8094)]
     0x0441 [0x1C] WAIT(90* ticks)
     0x0444 [0x50] END_SCHEDULER_TASK: End scheduler "op" with entities [References[148], References[148]], work=[270, 270]
     0x0451 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "hap1" with entities [EventEntity, EventEntity], work=216*
     0x0460 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "clos" with entities [Treasure Coffer (ID: 17727636/0x010E8094), Treasure Coffer (ID: 17727636/0x010E8094)]
