...
- **11845**: The following individuals are likely to request your assistance if you are to speak to them.
...
- **11910**: On the other hand, orders handed down directly from those involved with the nation's administration are called "missions." Converse with the guard by the gate for a more detailed explanation.
...
SUBROUTINE_01F6:
 ...
 82: 0x027C [0x24] CREATE_DIALOG(message_id=11844*, default_option=0*, option_flags=Work_Zone[2])
...
146: 0x0374 [0x24] CREATE_DIALOG(message_id=11846*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
173: 0x0B16 [0x24] CREATE_DIALOG(message_id=11847*, default_option=0*, option_flags=ExtData[1]->WorkLocal[1])
...
201: 0x1232 [0x24] CREATE_DIALOG(message_id=11848*, default_option=0*, option_flags=ExtData[1]->WorkLocal[2])
...
227: 0x15E7 [0x24] CREATE_DIALOG(message_id=11849*, default_option=0*, option_flags=ExtData[1]->WorkLocal[3])
...
249: 0x1ABF [0x1D] PRINT_EVENT_MESSAGE(message_id=11836*)
...
251: 0x1AC3 [0x1D] PRINT_EVENT_MESSAGE(message_id=11837*)
...
257: 0x1AEB [0x1D] PRINT_EVENT_MESSAGE(message_id=11818*)
...
269: 0x1B49 [0x1D] PRINT_EVENT_MESSAGE(message_id=11838*)
...
285: 0x1D06 [0x1D] PRINT_EVENT_MESSAGE(message_id=11818*)
    → "I can mark the locations of important people on your map of the San d'Oria area, should you require it."
286: 0x1D09 [0x23] WAIT_FOR_DIALOG_INTERACTION
287: 0x1D0A [0x1D] PRINT_EVENT_MESSAGE(message_id=11821*)
...
289: 0x1D0E [0x1D] PRINT_EVENT_MESSAGE(message_id=11825*)
