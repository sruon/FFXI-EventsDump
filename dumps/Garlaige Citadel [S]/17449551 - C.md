...
| [65535.3](#event-655353) | 0x0049       |     50 |             10 |
...
```
  ...
  8: 0x006B [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "com0" with entities [C (ID: 17449551/0x010A424F), C (ID: 17449551/0x010A424F)], work=1433*
...
0080: 02 80 03 80 04 80 1F 01  6F 00                    ........o.      
```
...
```
  ...
  1: 0x007E [0x1F] MOVE_ENTITY: EventEntity moves to X=-29.055*, Z=-265.560*, Y=-0.191*
