...
```
  ...
  1: 0x004D [0x1F] MOVE_ENTITY: EventEntity moves to X=-20.515*, Z=-279.691*, Y=0.448*
...
```
  ...
  8: 0x007B [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "com0" with entities [B (ID: 17449539/0x010A4243), B (ID: 17449539/0x010A4243)], work=218*
