...
- **7687**: The Firesand Storeroom lies beyond this gate. But be warned, adventurer. The way is rife with danger. Proceed at your own peril.
...
```
  ...
  3: 0x0010 [0x1D] PRINT_EVENT_MESSAGE(message_id=7687*)
    → "The Firesand Storeroom lies beyond this gate. But be warned, adventurer. The way is rife with danger. Proceed at your own peril."
...
```
  0: 0x005E [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=4*, hair=15*, head=12*, body=12*, hands=12*, legs=12*, feet=12*, main=251*, sub=27*)
...
```
  0: 0x0073 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=4*, hair=15*, head=124*, body=124*, hands=21*, legs=21*, feet=21*, main=0*, sub=0*)
...
```
  0: 0x0088 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=3*, hair=15*, head=56*, body=12*, hands=12*, legs=12*, feet=12*, main=270*, sub=27*)
