...
```
  ...
  3: 0x0096 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=149*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  4: 0x00A5 [0x1C] WAIT(Work_Zone[3] ticks)
  5: 0x00A8 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=149*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
  6: 0x00B7 [0x01] GOTO 0x01EE

SUBROUTINE_00BA:
  7: 0x00BA [0x02] IF !(Work_Zone[2] == 2*) GOTO 0x00E6
  8: 0x00C2 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=159*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  9: 0x00D1 [0x1C] WAIT(Work_Zone[3] ticks)
 10: 0x00D4 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=159*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 11: 0x00E3 [0x01] GOTO 0x01EE

SUBROUTINE_00E6:
 12: 0x00E6 [0x02] IF !(Work_Zone[2] == 3*) GOTO 0x0112
 13: 0x00EE [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=169*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 14: 0x00FD [0x1C] WAIT(Work_Zone[3] ticks)
 15: 0x0100 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=169*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 16: 0x010F [0x01] GOTO 0x01EE

SUBROUTINE_0112:
 17: 0x0112 [0x02] IF !(Work_Zone[2] == 4*) GOTO 0x013E
 18: 0x011A [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=179*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 19: 0x0129 [0x1C] WAIT(Work_Zone[3] ticks)
 20: 0x012C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=179*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 21: 0x013B [0x01] GOTO 0x01EE

SUBROUTINE_013E:
 22: 0x013E [0x02] IF !(Work_Zone[2] == 5*) GOTO 0x016A
 23: 0x0146 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=189*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 24: 0x0155 [0x1C] WAIT(Work_Zone[3] ticks)
 25: 0x0158 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=189*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 26: 0x0167 [0x01] GOTO 0x01EE

SUBROUTINE_016A:
 27: 0x016A [0x02] IF !(Work_Zone[2] == 6*) GOTO 0x0196
 28: 0x0172 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=189*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 29: 0x0181 [0x1C] WAIT(Work_Zone[3] ticks)
 30: 0x0184 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=189*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 31: 0x0193 [0x01] GOTO 0x01EE

SUBROUTINE_0196:
 32: 0x0196 [0x02] IF !(Work_Zone[2] == 7*) GOTO 0x01C2
 33: 0x019E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=199*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 34: 0x01AD [0x1C] WAIT(Work_Zone[3] ticks)
 35: 0x01B0 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=199*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 36: 0x01BF [0x01] GOTO 0x01EE

SUBROUTINE_01C2:
 37: 0x01C2 [0x02] IF !(Work_Zone[2] == 8*) GOTO 0x01EE
 38: 0x01CA [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=209*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 39: 0x01D9 [0x1C] WAIT(Work_Zone[3] ticks)
 40: 0x01DC [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=209*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
