...
- **7864**: Would you like to hear a story? [No, thank you./Let's hear one.]
- **7865**: Would you like to hear a story? [No, thank you./Scaredy-Cats(pt.1)./Scaredy-Cats(pt.2)./Vegetable Vegetable Revolution(pt.1)./Vegetable Vegetable Revolution(pt.1)./Saved by the Bell.]
- **7866**: 
- **7867**: 
- **7868**: 
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7865*, default_option=0*, option_flags=Work_Zone[2])
    → "Would you like to hear a story? [No, thank you./Scaredy-Cats(pt.1)./Scaredy-Cats(pt.2)./Vegetable Vegetable Revolution(pt.1)./Vegetable Vegetable Revolution(pt.1)./Saved by the Bell.]"
