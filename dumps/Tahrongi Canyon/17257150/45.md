...
```
  ...
  1: 0x01EE [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  2: 0x01FF [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 14: 0x0246 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "corp" for entities [LocalPlayer, LocalPlayer]
 15: 0x0253 [0x1C] WAIT(30* ticks)
 16: 0x0256 [0x45] LOAD_SCHEDULED_TASK(work_offset1=766*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s041", work_offset2=0*)
 17: 0x0267 [0x1C] WAIT(15* ticks)
 18: 0x026A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 19: 0x027B [0x1C] WAIT(150* ticks)
 20: 0x027E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
 21: 0x028F [0x52] END_LOAD_SCHEDULER: End scheduler "s041" with entities [EventEntity, EventEntity], work=766*
 22: 0x029E [0x45] LOAD_SCHEDULED_TASK(work_offset1=766*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s042", work_offset2=0*)
 ...
 30: 0x02E7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=766*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s043", work_offset2=0*)
 ...
 34: 0x0311 [0x45] LOAD_SCHEDULED_TASK(work_offset1=766*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s119", work_offset2=0*)
 ...
 40: 0x0342 [0x45] LOAD_SCHEDULED_TASK(work_offset1=766*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s120", work_offset2=0*)
 41: 0x0353 [0x1C] WAIT(180* ticks)
 42: 0x0356 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 43: 0x0367 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 46: 0x0387 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
