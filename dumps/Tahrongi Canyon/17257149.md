...
0020: FF FF 7F 66 64 6F 31 46  01 38 02 80 2F 00 A8 52  ...fdo1F.8../..R
0030: 07 01 4E 00 A8 52 07 01  92 01 A8 52 07 01 94 01  ..N..R.....R....
0040: A8 52 07 01 94 01 F0 FF  FF 7F BA A8 52 07 01 03  .R..........R...
0050: 80 04 80 05 80 06 80 BA  F0 FF FF 7F 07 80 08 80  ................
0060: 09 80 0A 80 80 A8 52 07  01 80 F0 FF FF 7F 27 05  ......R.......'.
0070: A8 52 07 01 14 45 0B 80  F8 FF FF 7F F8 FF FF 7F  .R...E..........
0080: 73 30 30 37 01 80 1C 0C  80 45 00 80 F8 FF FF 7F  s007.....E......
0090: F8 FF FF 7F 66 64 69 31  01 80 1C 0D 80 4A F0 FF  ....fdi1.....J..
00A0: FF 7F A8 52 07 01 2B A8  52 07 01 0E 80 23 2A 05  ...R..+.R....#*.
00B0: A8 52 07 01 52 0B 80 F8  FF FF 7F F8 FF FF 7F 73  .R..R..........s
00C0: 30 30 37 45 0B 80 F8 FF  FF 7F F8 FF FF 7F 73 30  007E..........s0
00D0: 30 38 01 80 5B 0F 80 A8  52 07 01 A8 52 07 01 79  08..[...R...R..y
00E0: 65 73 30 2B A8 52 07 01  10 80 1C 11 80 23 52 0B  es0+.R.......#R.
00F0: 80 F8 FF FF 7F F8 FF FF  7F 73 30 30 38 45 0B 80  .........s008E..
0100: F8 FF FF 7F F8 FF FF 7F  73 30 30 39 01 80 27 05  ........s009..'.
0110: A8 52 07 01 15 7B A8 52  07 01 1C 12 80 29 05 F0  .R...{.R.....)..
0120: FF FF 7F 21 1C 12 80 9F  13 80 F0 FF FF 7F F0 FF  ...!............
0130: FF 7F 6D 61 69 6E 01 80  1C 12 80 9F 13 80 A8 52  ..main.........R
0140: 07 01 A8 52 07 01 6D 61  69 6E 01 80 1C 0D 80 92  ...R..main......
...
```
  ...
  6: 0x002C [0x2F] Iroha (ID: 17257128/0x010752A8)->Render.Flags0 &= ~0x80000 // Bit 19
  7: 0x0032 [0x4E] SET_ENTITY_HIDE_FLAG: Show Iroha (ID: 17257128/0x010752A8)
  8: 0x0038 [0x92] Iroha (ID: 17257128/0x010752A8)->Render.Flags3 ^= 0x01
  9: 0x003E [0x94] Iroha (ID: 17257128/0x010752A8)->Render.Flags3 ^= 0x01
 10: 0x0044 [0x94] LocalPlayer->Render.Flags3 ^= 0x01
 11: 0x004A [0xBA] SET_ENTITY_POSITION(entity_id=Iroha (ID: 17257128/0x010752A8), pos_x=268.746*, pos_z=338.640*, pos_y=35.650*, direction=183.6°*)
 12: 0x0057 [0xBA] SET_ENTITY_POSITION(entity_id=LocalPlayer, pos_x=261.770*, pos_z=341.797*, pos_y=35.150*, direction=145.9°*)
 13: 0x0064 [0x80] LOAD_WAIT(entity=Iroha (ID: 17257128/0x010752A8))
 14: 0x0069 [0x80] LOAD_WAIT(entity=LocalPlayer)
 15: 0x006E [0x27] REQ_SET(priority=0x05, entity_id=Iroha (ID: 17257128/0x010752A8), tag_num=0x14)
 ...
 20: 0x009D [0x4A] LocalPlayer looks at Iroha (ID: 17257128/0x010752A8)
 21: 0x00A6 [0x2B] Iroha (ID: 17257128/0x010752A8) [12135*]:
    → "Ah, Master. Excellent timing."
 22: 0x00AD [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x00AE [0x2A] GET_REQ_LEVEL(level=5, entity_id=Iroha (ID: 17257128/0x010752A8))
 ...
 26: 0x00D4 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "yes0" with entities [Iroha (ID: 17257128/0x010752A8), Iroha (ID: 17257128/0x010752A8)], work=3862*
 27: 0x00E3 [0x2B] Iroha (ID: 17257128/0x010752A8) [12136*]:
 ...
 32: 0x010E [0x27] REQ_SET(priority=0x05, entity_id=Iroha (ID: 17257128/0x010752A8), tag_num=0x15)
 33: 0x0115 [0x7B] Iroha (ID: 17257128/0x010752A8) stops talking
 ...
 39: 0x013B [0x9F] LOAD_SCHEDULED_TASK_ALT: Load scheduler "main" with entities [Iroha (ID: 17257128/0x010752A8), Iroha (ID: 17257128/0x010752A8)], work=[75*, 0*]
...
```
 ...
 36: 0x032C [0x1D] PRINT_EVENT_MESSAGE(message_id=12137*)
    → "Meet...Altana..."
