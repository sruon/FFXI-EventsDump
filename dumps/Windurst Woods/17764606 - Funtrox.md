...
- **14233**: Oy, would ya get a look at yer $0! I guess I can let ya open [/Dial 1/Dial 2/Dial 3/Dial 4/Dial 5/the special dial///the abjuration dial/the fortune dial/the furnishings dial//the Vana'versary dial] whenever ya want fer not a single onz o' daily tally!
- **14234**: Dun think that I's be a gil-grubbin' good-fer-nuthin'. If'n ya dun wanna open any dial, then I gives ya back yer $0.
- **14235**: Yer eyes be bigger'n yer stomach. If'n ya wanna open [/Dial 1/Dial 2/Dial 3/Dial 4/Dial 5/the Special Dial///the abjuration dial/the fortune dial/the furnishings dial//the Vana'versary dial] usin' yer $0, then ya gotta make room in yer bags!
...
0400: 80 B4 04 1E FF 10 0F 01  6F 70 5B 2B 80 F8 FF FF  ........op[+....
0410: 7F F8 FF FF 7F 68 61 70  30 1D 2C 80 23 02 04 00  .....hap0.,.#...
0420: 03 80 00 34 04 03 03 10  02 00 29 80 FF 10 0F 01  ...4......).....
0430: 01 1C 2D 80 2C FF 10 0F  01 FF 10 0F 01 6F 70 65  ..-.,........ope
0440: 6E 1C 2D 80 50 FF 10 0F  01 FF 10 0F 01 6F 70 65  n.-.P........ope
0450: 6E 5B 2B 80 F8 FF FF 7F  F8 FF FF 7F 68 61 70 31  n[+.........hap1
0460: 2C FF 10 0F 01 FF 10 0F  01 63 6C 6F 73 1E F0 FF  ,........clos...
...
# Dead code (unreachable instructions):
    ...
    → "So ya be wantin' the [special/Adoulin/pictlogica/Wanted] dial? Whoawhoawhoa! Get yer grubby hands offa that! I's already opened one fer ya today! Haul that keister outta here and come back t'morrow."
     ...
     0x0403 [0x1E] EventEntity looks at Treasure Coffer (ID: 17764607/0x010F10FF) and starts talking
     ...
     0x0419 [0x1D] PRINT_EVENT_MESSAGE(message_id=14211*)
    → "Dis box is full o' myst'ries,t Dat span da realm's his'try,t So whatcha gonna get from da chest...o'...uh, fortunery?t"
     ...
     0x042A [0x29] REQ_SET_WAIT(priority=0x80, entity_id=Treasure Coffer (ID: 17764607/0x010F10FF), tag_num=0x01)
     0x0431 [0x1C] WAIT(90* ticks)
     0x0434 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "open" with entities [Treasure Coffer (ID: 17764607/0x010F10FF), Treasure Coffer (ID: 17764607/0x010F10FF)]
     0x0441 [0x1C] WAIT(90* ticks)
     0x0444 [0x50] END_SCHEDULER_TASK: End scheduler "op" with entities [0x10FF, 0x10FF], work=[271, 271]
     0x0451 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "hap1" with entities [EventEntity, EventEntity], work=216*
     0x0460 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "clos" with entities [Treasure Coffer (ID: 17764607/0x010F10FF), Treasure Coffer (ID: 17764607/0x010F10FF)]
     ...
     0x0483 [0x1D] PRINT_EVENT_MESSAGE(message_id=14212*)
    → "Oooh, looks at what popped out! I hopes it makes yer adventures dat much more adventumarous!"
...
```
 ...
 16: 0x0526 [0x1D] PRINT_EVENT_MESSAGE(message_id=14221*)
 ...
 20: 0x0535 [0x1D] PRINT_EVENT_MESSAGE(message_id=14222*)
...
```
  ...
  6: 0x0560 [0x1D] PRINT_EVENT_MESSAGE(message_id=14224*)
...
```
  ...
  4: 0x057C [0x1D] PRINT_EVENT_MESSAGE(message_id=14225*)
...
```
  ...
  4: 0x0598 [0x1D] PRINT_EVENT_MESSAGE(message_id=14226*)
...
```
  ...
  4: 0x05B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=14229*)
...
```
  ...
  6: 0x05D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=14233*)
...
```
  ...
  5: 0x062E [0x1D] PRINT_EVENT_MESSAGE(message_id=14234*)
...
```
  ...
  4: 0x064E [0x1D] PRINT_EVENT_MESSAGE(message_id=14235*)
...
```
  ...
  4: 0x066A [0x1D] PRINT_EVENT_MESSAGE(message_id=14236*)
...
```
  ...
  5: 0x0687 [0x1D] PRINT_EVENT_MESSAGE(message_id=14213*)
    → "Ya's thought I threw yer prize away?! Prepostamarous! I's just tucked it away for safekeepin' is all."
