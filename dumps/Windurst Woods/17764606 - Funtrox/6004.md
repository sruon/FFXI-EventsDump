...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0540:                          42 1E FF 10 0F 01 6F 70          B.....op
...
```
  ...
  1: 0x0549 [0x1E] EventEntity looks at Treasure Coffer (ID: 17764607/0x010F10FF) and starts talking
  ...
  6: 0x0560 [0x1D] PRINT_EVENT_MESSAGE(message_id=14221*)
