...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0000:    2C 05 10 0F 01 05 10  0F 01 63 61 62 6B 24 00   ,........cabk$.
...
```
  0: 0x0001 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "cabk" with entities [warp04 (ID: 17764357/0x010F1005), warp04 (ID: 17764357/0x010F1005)]
  1: 0x000E [0x24] CREATE_DIALOG(message_id=6722*, default_option=0*, option_flags=0*)
