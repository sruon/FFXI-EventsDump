...
```
  ...
  4: 0x0031 [0x1D] PRINT_EVENT_MESSAGE(message_id=8258*)
    → "Blessed is the one with the crimson tides flooding through herrr breast and the azure glow beaming from herrr eyes.\u007F1\u0000\u0007"
  5: 0x0034 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0035 [0x1D] PRINT_EVENT_MESSAGE(message_id=8259*)
    → "Forrr only one such as that may inherit the chieftainness's bow and arrow.\u007F1\u0000\u0007"
