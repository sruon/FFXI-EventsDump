...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0940:             29 08 72 10  0F 01 09 1D 41 80 23 29      ).r.....A.#)
0950: 08 72 10 0F 01 0A 00                              .r.....         
```
...
```
  ...
  1: 0x094B [0x1D] PRINT_EVENT_MESSAGE(message_id=8821*)
    → "The Tenshodo came to us, so don't even think of turning down their offer.\u007F1\u0000\u0007"
