...
- **13160**: Visit the Chocobo Circuit? [Off to the races!/Not right now.]
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=13160*, default_option=1*, option_flags=0*)
