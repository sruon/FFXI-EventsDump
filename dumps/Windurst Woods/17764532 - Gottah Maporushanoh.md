...
| [420](#event-420)          | 0x0191       |     36 |             13 |
| [483](#event-483)          | 0x01B5       |     36 |             13 |
| [484](#event-484)          | 0x01D9       |      1 |              1 |
| [65535.26](#event-6553526) | 0x01DA       |      5 |              3 |
| [65535.27](#event-6553527) | 0x01DF       |      5 |              3 |
| [65535.28](#event-6553528) | 0x01E4       |      5 |              3 |
| [65535.29](#event-6553529) | 0x01E9       |      5 |              3 |
| [486](#event-486)          | 0x01EE       |     32 |             11 |
| [839](#event-839)          | 0x020E       |      1 |              1 |
| [871](#event-871)          | 0x020F       |      1 |              1 |
| [872](#event-872)          | 0x0210       |    156 |             36 |
...
- **8523**: How's it goin', mate? Enjoyin' a spot of adventurrrin', I see...
- **8524**: Life's long, and you can put off till tommora what you don't wanta do today. So don't you be wearin' yourself out with all that adventurrrin', you hear?
- **8706**: Of course I've lost me passion for adventurrre! I've come all the way to Windurst lookin' for the old pirate king's treasurrre, only to have 'em tell me that all that talk o' pirate treasurrre is just a fairy tale.
- **8707**: Speakin' of which...I bet that legend o' the great monk Scorpio who fought a giant scorrrpion with his bare hands was also just made up to excite the kiddies, too.
- **8712**: Ho-hum...
- **8717**: Ah!?
- **8719**: His eye carved out by a briny blusterrr His heart pierced by a scorpion's sting Cloaked in his treasure's golden lusterrr Beneath the earth sleeps that pirate king.
- **8721**: Hold your horrrses, Soni-Muni! I've hearrrd that maze is no walk in the park. We don't stand a chance at our current level, so we'd better get some trainin' in firrrst!
- **8723**: But then we wouldn't have heard the lowdown on the Maze of Shakhrami, would we? Rrright?
- **11890**: Ask if this person is the chick's owner? [Yes./No.]
- **11924**: You've got me chocobo!?
- **11925**: Me feathered mate is livin' in safety, then? I've neverrr heard such happy tidin's! I'll be sure to watch the little fella close from now on!
- **11926**: Let me show me grrratitude by tellin' you a story I often tell me little mate...
- **11943**: You say you've got me chocobo?
- **11944**: I'm afraid you've got the wrong person. Adventurers are bound to make mistakes from time to time, so don't let it get you down, mate.
...
```
  ...
  4: 0x019F [0x1D] PRINT_EVENT_MESSAGE(message_id=8523*)
    → "How's it goin', mate? Enjoyin' a spot of adventurrrin', I see..."
  5: 0x01A2 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x01A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=8524*)
...
```
  ...
  4: 0x01C3 [0x1D] PRINT_EVENT_MESSAGE(message_id=8706*)
  ...
  7: 0x01CE [0x1D] PRINT_EVENT_MESSAGE(message_id=8707*)
...
```
  0: 0x01DA [0x1D] PRINT_EVENT_MESSAGE(message_id=8712*)
    → "Ho-hum..."
...
```
  0: 0x01DF [0x1D] PRINT_EVENT_MESSAGE(message_id=8717*)
    → "Ah!?"
...
```
  0: 0x01E4 [0x1D] PRINT_EVENT_MESSAGE(message_id=8719*)
...
```
  0: 0x01E9 [0x1D] PRINT_EVENT_MESSAGE(message_id=8721*)
...
```
  ...
  4: 0x01FC [0x1D] PRINT_EVENT_MESSAGE(message_id=8723*)
...
# Dead code (unreachable instructions):
     ...
     0x022B [0x24] CREATE_DIALOG(message_id=11890*, default_option=1*, option_flags=0*)
    → "Ask if this person is the chick's owner? [Yes./No.]"
     ...
     0x0254 [0x1D] PRINT_EVENT_MESSAGE(message_id=11924*)
    → "You've got me chocobo!?"
     ...
     0x0267 [0x1D] PRINT_EVENT_MESSAGE(message_id=11925*)
    → "Me feathered mate is livin' in safety, then? I've neverrr heard such happy tidin's! I'll be sure to watch the little fella close from now on!"
     ...
     0x027A [0x1D] PRINT_EVENT_MESSAGE(message_id=11926*)
    → "Let me show me grrratitude by tellin' you a story I often tell me little mate..."
     ...
     0x0281 [0x1D] PRINT_EVENT_MESSAGE(message_id=11943*)
    → "You say you've got me chocobo?"
     ...
     0x0294 [0x1D] PRINT_EVENT_MESSAGE(message_id=11944*)
