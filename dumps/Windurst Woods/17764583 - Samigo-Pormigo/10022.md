...
SUBROUTINE_014E:
 45: 0x014E [0x24] CREATE_DIALOG(message_id=7263*, default_option=0x0011, option_flags=0*)
...
# Dead code (unreachable instructions):
     ...
     0x0472 [0x05] ExtData[1]->WorkLocal[0] = 1
     ...
     0x0539 [0xD4] MAP_QUERY_WINDOW: Prepare buffer configuration A (buffer=[00 80 07 10 D4 03 5A 80...])
     ...
     0x06E7 [0xD4] MAP_QUERY_WINDOW: Prepare buffer configuration A (buffer=[00 80 07 10 D4 03 5A 80...])
     ...
     0x0C2A [0x24] CREATE_DIALOG(message_id=7279*, default_option=0x0013, option_flags=0x05)
