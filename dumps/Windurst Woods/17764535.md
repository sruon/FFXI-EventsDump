...
- **14610**: @@
- **15179**: You are now able to enjoy a new storyline, Seekers of Adoulin.
- **15180**: Start Seekers of Adoulin? [Yes (View cutscene)./Maybe later.]
- **15181**: Examine the Tales' Beginning in Northern San d'Oria, Bastok Markets, or Windurst Woods when you wish to start Seekers of Adoulin.
...
```
 ...
 11: 0x00B2 [0x48] [System] [15179*]:
    → "You are now able to enjoy a new storyline, Seekers of Adoulin."
 12: 0x00B5 [0x24] CREATE_DIALOG(message_id=15180*, default_option=1*, option_flags=0*)
