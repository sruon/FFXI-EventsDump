...
```
  ...
  4: 0x15A4 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  5: 0x15B3 [0x1D] PRINT_EVENT_MESSAGE(message_id=14942*)
    → "Your current requestaru is...\u007F1\u0000\u0007"
  6: 0x15B6 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x15B7 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
...
SUBROUTINE_160D:
 28: 0x160D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 31: 0x1620 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="thk2")
...
SUBROUTINE_164D:
 ...
 41: 0x164E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 46: 0x1665 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
