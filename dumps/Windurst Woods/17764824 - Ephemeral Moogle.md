...
- **14887**: Able adventurer, warmest welcome from the Magian Mooglehood.
- **14888**: To think you can perceive me in my true form, kupo! The trials of time take a toll on us all.
- **14889**: I command and control crystal-related incantations. Their ephemeral essence helps hold Vana'diel together.
- **14890**: Surely you have studied synthesis? Then you are doubtlessly versed in their myriad uses, kupo.
- **14891**: Promise you will not speak a syllable to others of my existence here.
- **14892**: Will you stay mum? [Mum's the word./I don't think so.]
- **14893**: ...
- **14894**: I scarce have the stamina to stop you, but I doubt others would believe this tale anyway.
- **14895**: Still, I shan't assist you if you don't promise.
- **14896**: Then the deed is done! In exchange, I shall proudly proffer my services in making your crystals ephemeral, too, kupo.
- **14897**: Ahhh, mayhap I have moved too quickly. Allow me to apprise you of the particulars--of this "crystal storage," if you will.
- **14898**: It's strikingly simple. Trade me your crystals and I shall safely store them for you. You need only glance at your currencies list to see the amount I'm holding for you.
- **14899**: But I can store more than crystals alone. % and the like are also acceptable.
- **14900**: My mysterious moogle magic has limits, kupo, so I can only hold up to 5000 of a particular element.
- **14901**: You never know what secrets are in store unless you try!
- **14902**: You can wistfully withdraw them at any time by speaking to me.
- **14903**: Any number over 12 will be returned as clusters, kupo.
- **14904**: The % gives a sly smile.
- **14905**: This service is available to you free from the fetters of funding. As long as you keep this hush-hush, I'll always assist you with no recompense required.
- **14906**: If you can find me here, then you'll surely see me in other locations too, kupo. Moogle magic, you know.
- **14907**: Of course, I do not actually exist in Vana'diel. Only a part of me projects into your world.
- **14908**: It's rather similar to summoning magic, kupo.
- **14909**: I promise not to bore you with the particulars. Just come chat if you need me, kupo.
- **14910**: You are now able to store crystals!
- **14911**: Come for crystal-related concerns, hmm?
- **14912**: What would you like? [Crystals returned to me./A bit of an explanation./Nothing for now.]
- **14913**: Which element? [Never mind./Fire o $0/Ice o . $1/Wind o!. $2/Earth o". $3/Lightning o#. $4/Water o$. $5/Light o%. $6/Darkness o&. $7]
- **14914**: How many would you like? [None, actually./A specific number./As many you can fit.]
- **14915**: How many? ($8 stored)
- **14916**: $1 [/fire/ice/wind/earth/lightning/water/light/darkness] crystal[/s], correct? Then that will mean a total of...
- **14917**: $1 $0 .
- **14918**: $1 $0 and $3 $0 .
- **14919**: Are you sure?
- **14920**: Is this what you desire? [Yes./No.]
- **14921**: "As many as you can fit!?" I-if you say so...
- **14922**: Okay... Moogle Magic, ahoy!
- **14923**: There are limits to what my mysterious moogle magic can make up.
- **14924**: Inquire about what? [Your purpose./Storing crystals./Retrieving crystals./Who are you?/Nothing in particular.]
- **14925**: I'm in charge of crystal chants. Crystals, of course, are the very lifeblood of Vana'diel, kupo.
- **14926**: Surely your sacks are spilling over with them! I can perhaps assist you with your problem.
- **14932**: That's all there is to it, kupo! Let me know if you need me again.
- **14933**: Unfortunately, it's all I can do to hold on to what you've already given me, kupo!
- **14936**: You want me to hold onto these, kupo? Then let the magic begin!
- **14937**: You have stored $1 $0 for a total of $4.
- **14938**: You have stored $1 $0 and $3 $0 for a total of $4.
...
SUBROUTINE_077D:
  ...
  2: 0x0782 [0x1D] PRINT_EVENT_MESSAGE(message_id=14933*)
...
# Dead code (unreachable instructions):
    ...
    → "To think you can perceive me in my true form, kupo! The trials of time take a toll on us all."
     ...
     0x002C [0x1D] PRINT_EVENT_MESSAGE(message_id=14889*)
    → "I command and control crystal-related incantations. Their ephemeral essence helps hold Vana'diel together."
     ...
     0x0030 [0x1D] PRINT_EVENT_MESSAGE(message_id=14890*)
    → "Surely you have studied synthesis? Then you are doubtlessly versed in their myriad uses, kupo."
     ...
     0x0034 [0x1D] PRINT_EVENT_MESSAGE(message_id=14891*)
    → "Promise you will not speak a syllable to others of my existence here."
     ...
     0x0045 [0x24] CREATE_DIALOG(message_id=14892*, default_option=0*, option_flags=0*)
    → "Will you stay mum? [Mum's the word./I don't think so.]"
     ...
     0x0058 [0x1D] PRINT_EVENT_MESSAGE(message_id=14893*)
    → "..."
     ...
     0x0069 [0x1D] PRINT_EVENT_MESSAGE(message_id=14894*)
    → "I scarce have the stamina to stop you, but I doubt others would believe this tale anyway."
     ...
     0x006D [0x1D] PRINT_EVENT_MESSAGE(message_id=14895*)
    → "Still, I shan't assist you if you don't promise."
     ...
     0x008F [0x1D] PRINT_EVENT_MESSAGE(message_id=14896*)
    → "Then the deed is done! In exchange, I shall proudly proffer my services in making your crystals ephemeral, too, kupo."
     ...
     0x0093 [0x1D] PRINT_EVENT_MESSAGE(message_id=14897*)
    → "Ahhh, mayhap I have moved too quickly. Allow me to apprise you of the particulars--of this "crystal storage," if you will."
     ...
     0x00B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=14898*)
    ...
    → "This service is available to you free from the fetters of funding. As long as you keep this hush-hush, I'll always assist you with no recompense required."
     ...
     0x00D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=14906*)
    → "If you can find me here, then you'll surely see me in other locations too, kupo. Moogle magic, you know."
     ...
     0x00DC [0x1D] PRINT_EVENT_MESSAGE(message_id=14907*)
    → "Of course, I do not actually exist in Vana'diel. Only a part of me projects into your world."
     ...
     0x00E0 [0x1D] PRINT_EVENT_MESSAGE(message_id=14908*)
    → "It's rather similar to summoning magic, kupo."
     0x00E3 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x00E4 [0x1D] PRINT_EVENT_MESSAGE(message_id=14909*)
    ...
    → "You are now able to store crystals!"
     ...
     0x014A [0x1D] PRINT_EVENT_MESSAGE(message_id=14911*)
    → "Come for crystal-related concerns, hmm?"
     ...
     0x0159 [0x24] CREATE_DIALOG(message_id=14912*, default_option=0*, option_flags=0*)
    → "What would you like? [Crystals returned to me./A bit of an explanation./Nothing for now.]"
     ...
     0x0217 [0x24] CREATE_DIALOG(message_id=14913*, default_option=0*, option_flags=ExtData[1]->WorkLocal[9])
    → "Which element? [Never mind./Fire o $0/Ice o . $1/Wind o!. $2/Earth o". $3/Lightning o#. $4/Water o$. $5/Light o%. $6/Darkness o&. $7]"
     ...
     0x035F [0x24] CREATE_DIALOG(message_id=14914*, default_option=0*, option_flags=0*)
    → "How many would you like? [None, actually./A specific number./As many you can fit.]"
     ...
     0x0382 [0x1D] PRINT_EVENT_MESSAGE(message_id=14915*)
    → "How many? ($8 stored)"
     ...
     0x0395 [0x1D] PRINT_EVENT_MESSAGE(message_id=14923*)
    → "There are limits to what my mysterious moogle magic can make up."
     ...
     0x03A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=14923*)
    → "There are limits to what my mysterious moogle magic can make up."
     ...
     0x03C3 [0x1D] PRINT_EVENT_MESSAGE(message_id=14916*)
    → "$1 [/fire/ice/wind/earth/lightning/water/light/darkness] crystal[/s], correct? Then that will mean a total of..."
     ...
     0x03FC [0x1D] PRINT_EVENT_MESSAGE(message_id=14918*)
    → "$1 $0 and $3 $0 ."
     ...
     0x040D [0x1D] PRINT_EVENT_MESSAGE(message_id=14917*)
    → "$1 $0 ."
     ...
     0x0426 [0x1D] PRINT_EVENT_MESSAGE(message_id=14917*)
    → "$1 $0 ."
     0x0429 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x042A [0x01] GOTO 0x042D
     0x042D [0x1D] PRINT_EVENT_MESSAGE(message_id=14919*)
    → "Are you sure?"
     0x0430 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0431 [0x24] CREATE_DIALOG(message_id=14920*, default_option=0*, option_flags=0*)
    → "Is this what you desire? [Yes./No.]"
     ...
     0x0442 [0x1D] PRINT_EVENT_MESSAGE(message_id=14922*)
    → "Okay... Moogle Magic, ahoy!"
     ...
     0x04AE [0x1D] PRINT_EVENT_MESSAGE(message_id=14921*)
    → ""As many as you can fit!?" I-if you say so..."
     ...
     0x04BF [0x1D] PRINT_EVENT_MESSAGE(message_id=14919*)
    → "Are you sure?"
     0x04C2 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x04C3 [0x24] CREATE_DIALOG(message_id=14920*, default_option=0*, option_flags=0*)
    → "Is this what you desire? [Yes./No.]"
     0x04CA [0x25] WAIT_DIALOG_SELECT()
     0x04CB [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x050B
     0x04D3 [0x42] SET_CLI_EVENT_CANCEL_DATA()
     0x04D4 [0x1D] PRINT_EVENT_MESSAGE(message_id=14922*)
    → "Okay... Moogle Magic, ahoy!"
     ...
     0x0541 [0x24] CREATE_DIALOG(message_id=14924*, default_option=0*, option_flags=0*)
    → "Inquire about what? [Your purpose./Storing crystals./Retrieving crystals./Who are you?/Nothing in particular.]"
     ...
     0x055E [0x1D] PRINT_EVENT_MESSAGE(message_id=14925*)
    → "I'm in charge of crystal chants. Crystals, of course, are the very lifeblood of Vana'diel, kupo."
     ...
     0x0562 [0x1D] PRINT_EVENT_MESSAGE(message_id=14926*)
    → "Surely your sacks are spilling over with them! I can perhaps assist you with your problem."
     ...
     0x058B [0x1D] PRINT_EVENT_MESSAGE(message_id=14898*)
    → "It's strikingly simple. Trade me your crystals and I shall safely store them for you. You need only glance at your currencies list to see the amount I'm holding for you."
     0x058E [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x058F [0x03] Work_Zone[2] = 4104*
     0x0594 [0x1D] PRINT_EVENT_MESSAGE(message_id=14899*)
    → "But I can store more than crystals alone. % and the like are also acceptable."
     0x0597 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0598 [0x1D] PRINT_EVENT_MESSAGE(message_id=14900*)
    → "My mysterious moogle magic has limits, kupo, so I can only hold up to 5000 of a particular element."
     0x059B [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x059C [0x1D] PRINT_EVENT_MESSAGE(message_id=14901*)
    → "You never know what secrets are in store unless you try!"
     ...
     0x05C5 [0x1D] PRINT_EVENT_MESSAGE(message_id=14902*)
    → "You can wistfully withdraw them at any time by speaking to me."
     0x05C8 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x05C9 [0x1D] PRINT_EVENT_MESSAGE(message_id=14903*)
    → "Any number over 12 will be returned as clusters, kupo."
     0x05CC [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x05CD [0x48] [System] [14904*]:
    → "The % gives a sly smile."
     0x05D0 [0x1C] WAIT(60* ticks)
     0x05D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=14905*)
    → "This service is available to you free from the fetters of funding. As long as you keep this hush-hush, I'll always assist you with no recompense required."
     ...
     0x05FC [0x1D] PRINT_EVENT_MESSAGE(message_id=14906*)
    → "If you can find me here, then you'll surely see me in other locations too, kupo. Moogle magic, you know."
     0x05FF [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0600 [0x1D] PRINT_EVENT_MESSAGE(message_id=14907*)
    → "Of course, I do not actually exist in Vana'diel. Only a part of me projects into your world."
     0x0603 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0604 [0x1D] PRINT_EVENT_MESSAGE(message_id=14908*)
    → "It's rather similar to summoning magic, kupo."
     0x0607 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0608 [0x1D] PRINT_EVENT_MESSAGE(message_id=14909*)
    → "I promise not to bore you with the particulars. Just come chat if you need me, kupo."
     ...
     0x072F [0x1D] PRINT_EVENT_MESSAGE(message_id=14936*)
    → "You want me to hold onto these, kupo? Then let the magic begin!"
     ...
     0x075C [0x1D] PRINT_EVENT_MESSAGE(message_id=14932*)
