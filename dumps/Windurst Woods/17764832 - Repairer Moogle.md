...
| [983](#event-983)     | 0x0001       |     24 |             10 |
| [984](#event-984)     | 0x0019       |     21 |              9 |
| [985](#event-985)     | 0x002E       |     16 |              6 |
...
- **15152**: Good day, adventurer! I am able to repair any broken item data related to $0.
- **15153**: If you are unable to deliver $0, it's possible that the item data has been corrupted.
- **15154**: Please trade your $0 to me so that I may fix it.
- **15155**: I have confirmed that the item data for your $0 has been corrupted. We apologize for the inconvenience.
- **15156**: I have restored it to its intended functionality. Here you are!
- **15157**: It appears that your item is working as intended.
...
```
  ...
  6: 0x0013 [0x1D] PRINT_EVENT_MESSAGE(message_id=15154*)
...
```
  ...
  3: 0x0024 [0x1D] PRINT_EVENT_MESSAGE(message_id=15155*)
  ...
  5: 0x0028 [0x1D] PRINT_EVENT_MESSAGE(message_id=15156*)
...
```
  ...
  2: 0x0038 [0x1D] PRINT_EVENT_MESSAGE(message_id=15157*)
