...
- **10117**: At the request of a certain society, I am investigating the effects of the dreaded "Emptiness" on living beings.
- **10118**: You appear to be a well-traveled adventurer. Perhaps you have seen one of the Emptiness-ravaged creatures of which I speak?
- **10119**: We have labeled these monstrosities "Empty Notorious Monsters," or ENMs...
- **10120**: Have you seen one? [Indeed I have./I'm not quite sure...]
- **10121**: Aha, so you have firsthand experience. You probably don't need a scholar's explanation, but please indulge me...
- **10122**: The material presence of ENMs has become temporary and insubstantial, meaning that those who have witnessed a particular ENM's existence are unable to encounter it again until a period of time has passed.
- **10123**: My research has allowed me to measure the length of time between ENM manifestations. Tell me, which ENM would you like to know about?
- **10124**: I wish to know about the ENM in... [Nowhere in particular./The Spire of Holla./The Spire of Dem./The Spire of Mea./The Spire of Vahzl./Monarch Linn./The Shrouded Maw./Mine Shaft #2716./Bearclaw Pinnacle./Boneyard Gully.]
- **10125**: You won't be able to encounter that particular ENM until ( Earth time).
- **10126**: The ENM in that area should be sufficiently manifest for your next encounter.
- **10127**: You have no need of my expertise at the moment? Very well.
- **10128**: And now we come to the crux of the matter...
- **10129**: If there is an ENM that you are currently able to locate, I strongly urge you to take action.
- **10130**: These...creatures...are no longer natural beings of Vana'diel. They must be destroyed.
- **10131**: I cannot elaborate on the details, but know that the fate of the world depends on the early elimination of this threat...
- **10132**: Then perhaps it is best if you forget this conversation entirely.
- **10133**: I hope I have been of some assistance to you.
- **10134**: This dark plague grows ever stronger... If it is not stopped soon...
- **10149**: Which item will you use to enter? [6./$6.]
...
```
  0: 0x0001 [0x1D] PRINT_EVENT_MESSAGE(message_id=10134*)
...
```
  ...
  1: 0x000C [0x1D] PRINT_EVENT_MESSAGE(message_id=10117*)
  ...
  3: 0x0010 [0x1D] PRINT_EVENT_MESSAGE(message_id=10118*)
  ...
  5: 0x0014 [0x1D] PRINT_EVENT_MESSAGE(message_id=10119*)
    → "We have labeled these monstrosities "Empty Notorious Monsters," or ENMs..."
  6: 0x0017 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0018 [0x24] CREATE_DIALOG(message_id=10120*, default_option=1*, option_flags=0*)
 ...
 10: 0x0028 [0x1D] PRINT_EVENT_MESSAGE(message_id=10121*)
 ...
 12: 0x002C [0x1D] PRINT_EVENT_MESSAGE(message_id=10122*)
 ...
 14: 0x0030 [0x1D] PRINT_EVENT_MESSAGE(message_id=10123*)
 ...
 16: 0x0034 [0x24] CREATE_DIALOG(message_id=10124*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_0047:
 ...
 24: 0x005E [0x24] CREATE_DIALOG(message_id=10149*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0076:
 ...
 32: 0x0082 [0x1D] PRINT_EVENT_MESSAGE(message_id=10127*)
 ...
 36: 0x0091 [0x1D] PRINT_EVENT_MESSAGE(message_id=10126*)
...
SUBROUTINE_009C:
 ...
 45: 0x00A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=10130*)
 ...
 47: 0x00A8 [0x1D] PRINT_EVENT_MESSAGE(message_id=10131*)
...
SUBROUTINE_00AC:
 ...
 51: 0x00B7 [0x1D] PRINT_EVENT_MESSAGE(message_id=10132*)
...
```
  ...
  1: 0x00CA [0x1D] PRINT_EVENT_MESSAGE(message_id=10123*)
    → "My research has allowed me to measure the length of time between ENM manifestations. Tell me, which ENM would you like to know about?"
  2: 0x00CD [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x00CE [0x24] CREATE_DIALOG(message_id=10124*, default_option=0*, option_flags=Work_Zone[2])
    → "I wish to know about the ENM in... [Nowhere in particular./The Spire of Holla./The Spire of Dem./The Spire of Mea./The Spire of Vahzl./Monarch Linn./The Shrouded Maw./Mine Shaft #2716./Bearclaw Pinnacle./Boneyard Gully.]"
...
SUBROUTINE_00E1:
 ...
 11: 0x00F8 [0x24] CREATE_DIALOG(message_id=10149*, default_option=0*, option_flags=0*)
    → "Which item will you use to enter? [6./$6.]"
