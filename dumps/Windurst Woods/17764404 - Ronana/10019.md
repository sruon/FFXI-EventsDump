...
```
  0: 0x0001 [0x3E] IF !(Work_Zone[5] bit 6*) GOTO 0x0177
  ...
  5: 0x0020 [0x1D] PRINT_EVENT_MESSAGE(message_id=7418*)
    → "Didn't somebody just help you...?\u007F1\u0000\u0007"
  6: 0x0023 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0024 [0x01] GOTO 0x0056

SUBROUTINE_0027:
  8: 0x0027 [0x1D] PRINT_EVENT_MESSAGE(message_id=7420*)
    → "Okay! Blink your eyes three times...\u007F1\u0000\u0007"
...
SUBROUTINE_0059:
 ...
 21: 0x0075 [0x1D] PRINT_EVENT_MESSAGE(message_id=7421*)
    → "Why don't you try \u0001\u0001\u0001 \u0001\u0005$\u0002\u0000\u0000\u0000? I can always help you if you want!\u007F1\u0000\u0007"
...
\u0007 x \u0001	)\u0002\u0007\u0000\u0000\u0002\u0003\u0000\u0000\u007F1\u0000\u0007"
 ...
 80: 0x0162 [0x1D] PRINT_EVENT_MESSAGE(message_id=7422*)
    → "...is all you'll need!\u0007I can feel it in my bones... You're going to be a great boneworker!\u007F1\u0000\u0007"
...
SUBROUTINE_0177:
 86: 0x0177 [0x1D] PRINT_EVENT_MESSAGE(message_id=7417*)
    → "Dem bones, dem bones, dem wight bones...\u0001t\u0007Don't you just love the way dem bones shiney-shine when you wash them?\u007F1\u0000\u0007"
