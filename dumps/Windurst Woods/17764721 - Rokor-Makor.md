...
- **13295**: Hellooo! Welcome to the Chocobo Chick Catchery!
- **13296**: What would you like to do? [Learn how to play./Check current high score./Have a go!/Nothing.]
- **13297**: Catch as many chicks as you can by moving the chocobo left and rightaru. But make sure you don't pick up any mandragoras by mistakey-wake! That'll mean the end of the game!
- **13298**: You need to catch at leastaru 20 chicks in one minute to clear the game.
- **13299**: Current high score: $0 [chick/chicks]. Record holder: %0.
- **13300**: It's $0 gil to play.
- **13301**: Play the game? (You have $0 gil.) [Play./Don't play.]
- **13302**: Thank you, and good luck!
- **13303**: Move which direction? [Right./Left.]
- **13304**: [Excellentaru!/Awww...] You caught $2 [chick/chicks].
- **13305**: Well, whataru do you know? It's a new record!
- **13306**: Here's your hard-earned prize.
- **13307**: I'll see you again.
- **13308**: Ahhh! A premature exitaru!
- **13309**: You're not supposed to catch mandragoras.
- **13313**: Phew...is it just me, or is it getting hot in here? Man, you look greataru in that outfit! You should try playing the game in hard mode!
- **13314**: What would you like to do? [Learn how to play./Check current high score./Play normal mode./Try hard mode./Nothing.]
- **13315**: In normal mode, you need to catch only 20 chicks in one minute to clear the game.
- **13316**: But it's no cakewalk in hard mode. You'll need at leastaru 35!
- **13317**: Check high score for which mode? [Normal mode./Hard mode./Don't check.]
- **13318**: Normal mode high score: $0 [chick/chicks]. Record holder: %0.
- **13319**: Hard mode high score: $1 [chick/chicks]. Record holder: %1.
- **13322**: You're on fire, adventurer! A red-hotaru display like that deserves a cool, cool prize. Here you go!
...
```
 ...
 10: 0x002D [0x1D] PRINT_EVENT_MESSAGE(message_id=13295*)
 ...
 14: 0x003E [0x1D] PRINT_EVENT_MESSAGE(message_id=13313*)
 ...
 19: 0x0057 [0x24] CREATE_DIALOG(message_id=13314*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
 ...
 22: 0x0067 [0x1D] PRINT_EVENT_MESSAGE(message_id=13297*)
 ...
 24: 0x006B [0x1D] PRINT_EVENT_MESSAGE(message_id=13315*)
 ...
 26: 0x006F [0x1D] PRINT_EVENT_MESSAGE(message_id=13316*)
...
SUBROUTINE_00A6:
 29: 0x00A6 [0x24] CREATE_DIALOG(message_id=13317*, default_option=0*, option_flags=ExtData[1]->WorkLocal[1])
 ...
 33: 0x00BB [0x1D] PRINT_EVENT_MESSAGE(message_id=13318*)
...
SUBROUTINE_0112:
 ...
 42: 0x012C [0x1D] PRINT_EVENT_MESSAGE(message_id=13302*)
 ...
 48: 0x0143 [0x1D] PRINT_EVENT_MESSAGE(message_id=13300*)
    → "It's $0 gil to play."
 ...
 53: 0x0150 [0x24] CREATE_DIALOG(message_id=13301*, default_option=1*, option_flags=0*)
...
SUBROUTINE_0166:
 ...
 63: 0x0185 [0x1D] PRINT_EVENT_MESSAGE(message_id=13302*)
    → "Thank you, and good luck!"
...
SUBROUTINE_019F:
 70: 0x019F [0x24] CREATE_DIALOG(message_id=13296*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
 ...
 73: 0x01AF [0x1D] PRINT_EVENT_MESSAGE(message_id=13297*)
    → "Catch as many chicks as you can by moving the chocobo left and rightaru. But make sure you don't pick up any mandragoras by mistakey-wake! That'll mean the end of the game!"
 74: 0x01B2 [0x23] WAIT_FOR_DIALOG_INTERACTION
 75: 0x01B3 [0x1D] PRINT_EVENT_MESSAGE(message_id=13298*)
...
SUBROUTINE_0204:
 ...
 83: 0x021E [0x1D] PRINT_EVENT_MESSAGE(message_id=13302*)
    → "Thank you, and good luck!"
...
183: 0x04DF [0x24] CREATE_DIALOG(message_id=13303*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
214: 0x05B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=13308*)
...
225: 0x0602 [0x1D] PRINT_EVENT_MESSAGE(message_id=13309*)
    → "You're not supposed to catch mandragoras."
226: 0x0605 [0x23] WAIT_FOR_DIALOG_INTERACTION
227: 0x0606 [0x1D] PRINT_EVENT_MESSAGE(message_id=13307*)
    → "I'll see you again."
...
235: 0x062C [0x1D] PRINT_EVENT_MESSAGE(message_id=13304*)
...
238: 0x0638 [0x1D] PRINT_EVENT_MESSAGE(message_id=13305*)
...
241: 0x0645 [0x1D] PRINT_EVENT_MESSAGE(message_id=13306*)
...
248: 0x0664 [0x1D] PRINT_EVENT_MESSAGE(message_id=13304*)
    → "[Excellentaru!/Awww...] You caught $2 [chick/chicks]."
249: 0x0667 [0x23] WAIT_FOR_DIALOG_INTERACTION
250: 0x0668 [0x1D] PRINT_EVENT_MESSAGE(message_id=13307*)
    → "I'll see you again."
...
264: 0x06A7 [0x1D] PRINT_EVENT_MESSAGE(message_id=13322*)
...
267: 0x06AE [0x1D] PRINT_EVENT_MESSAGE(message_id=13306*)
    → "Here's your hard-earned prize."
...
274: 0x06CD [0x1D] PRINT_EVENT_MESSAGE(message_id=13304*)
    → "[Excellentaru!/Awww...] You caught $2 [chick/chicks]."
275: 0x06D0 [0x23] WAIT_FOR_DIALOG_INTERACTION
276: 0x06D1 [0x1D] PRINT_EVENT_MESSAGE(message_id=13307*)
    → "I'll see you again."
