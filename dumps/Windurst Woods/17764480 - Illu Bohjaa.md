...
| [65535.5](#event-655355)   | 0x005D       |     22 |              3 |
| [65535.6](#event-655356)   | 0x0073       |     20 |              3 |
| [65535.7](#event-655357)   | 0x0087       |      9 |              3 |
| [332](#event-332)          | 0x0090       |     33 |             12 |
| [333](#event-333)          | 0x00B1       |     86 |             19 |
| [65535.8](#event-655358)   | 0x0107       |     23 |              7 |
| [65535.9](#event-655359)   | 0x011E       |     19 |              5 |
| [65535.10](#event-6553510) | 0x0131       |     19 |              5 |
| [65535.11](#event-6553511) | 0x0144       |     19 |              5 |
| [65535.12](#event-6553512) | 0x0157       |     19 |              5 |
| [334](#event-334)          | 0x016A       |     33 |             12 |
| [335](#event-335)          | 0x018B       |     56 |             16 |
| [336](#event-336)          | 0x01C3       |     33 |             12 |
| [337](#event-337)          | 0x01E4       |     55 |             18 |
...
- **6552**: Obtained $0 gil.
- **8237**: Haw!? Yeah, that be rrright! I look afterrr these here dhalmel all by m'self, y'know! Why, you ain't got an issue with that, do ya?
- **8238**: Oh, and while y'all are herrre... Don't ya go taumentin' the poorrr things, now! Not if y'know what's good for ya!
- **8239**: Lately them crrrawler crrritters out thar in Sarutabaruta have been eatin' up all the $2 that these dhalmel love so much.
- **8240**: It's put me in a rrreeeal fiddle, 'coz now I have to work rrreeeal hard to git me some of them thar $2.
- **8241**: I do declare... You seem to be the adventurrrer type now, huh!? Would you mind doin' me a favor the next time yer out thar a-huntin' in Sarutabaruta, and concentrate on depleting the numberrrs of crawlers in them parrrts?
- **8242**: If ya cull enough of them crawlers to git your hands on three $1 or $3, then I'll give you a little somethin' as a rrreward! Whaddaya say?
- **8243**: Help cull them thar crawlers? [Yup!/Naw!]
- **8244**: I see... So, y'don't give a damn 'bout what happens to my dhalmel, then do ya? You yellow-strrreaked crrrawler-kisser, you!
- **8245**: Crawlers can be found in both East and West Sarutabaruta. So exterrrminate as many of them thar pesty crrritters as you can in both'a them parts.
- **8246**: Them crawlers are out of control, and I'm at my wit's end! Cull enuff of them critters to git your hands on three $1 or $3, and I'll pay you a rrreward!
- **8247**: Crawlers can be found in both East and West Sarutabaruta. So exterrrminate as many of them thar pesty crrritters as you can in both'a them parts.
- **8248**: Why, thankee you, pardnerrr! Seems like y'did indeed kill off a mighty big numberrr of them thar crawlers. Here's ya rrreward! Much obliged to ya.
- **8249**: If everrr ya have the time, would ya be so good as to cull some morrre of them thar crawlers for little ol' me? Cull enuff of them critters to git your hands on three $1 or $3, and I'll pay you a handsome rrreward!
- **8250**: You saw them towerrrs out thar in Sarutabaruta, huh? Why, they be called the Horutoto Ruins. Once they broke down, the animals of Sarutabaruta starrrted runnin' amuck, y'know?
- **8251**: I ain't got much of a clue what them towers was forrr, but they sure was magical. I wonderrr if they'll e'er be able to fix them up again?
...
```
  ...
  2: 0x0033 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "ang0" with entities [EventEntity, EventEntity], work=358*
...
```
  0: 0x0073 [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "sis0" with entities [EventEntity, EventEntity]
...
```
  ...
  4: 0x009E [0x1D] PRINT_EVENT_MESSAGE(message_id=8237*)
  ...
  6: 0x00A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=8238*)
...
```
  ...
  6: 0x00CD [0x24] CREATE_DIALOG(message_id=8243*, default_option=0*, option_flags=0*)
...
```
  ...
  1: 0x010E [0x1D] PRINT_EVENT_MESSAGE(message_id=8239*)
  ...
  3: 0x0112 [0x1D] PRINT_EVENT_MESSAGE(message_id=8240*)
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0110:                                            29 08                ).
0120: 80 10 0F 01 01 1D 0A 80  23 29 08 80 10 0F 01 07  ........#)......
0130: 00                                                .               
```
...
```
  ...
  1: 0x0125 [0x1D] PRINT_EVENT_MESSAGE(message_id=8241*)
...
```
  ...
  1: 0x0138 [0x1D] PRINT_EVENT_MESSAGE(message_id=8242*)
...
```
  ...
  1: 0x014B [0x1D] PRINT_EVENT_MESSAGE(message_id=8244*)
...
```
  ...
  1: 0x015E [0x1D] PRINT_EVENT_MESSAGE(message_id=8245*)
...
```
  ...
  4: 0x0178 [0x1D] PRINT_EVENT_MESSAGE(message_id=8246*)
  ...
  6: 0x017C [0x1D] PRINT_EVENT_MESSAGE(message_id=8247*)
    → "Crawlers can be found in both East and West Sarutabaruta. So exterrrminate as many of them thar pesty crrritters as you can in both'a them parts."
...
```
  ...
  6: 0x019C [0x1D] PRINT_EVENT_MESSAGE(message_id=8248*)
  ...
  8: 0x01A0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8249*)
...
```
  ...
  4: 0x01D1 [0x1D] PRINT_EVENT_MESSAGE(message_id=8250*)
  ...
  6: 0x01D5 [0x1D] PRINT_EVENT_MESSAGE(message_id=8251*)
...
```
  ...
  4: 0x01F2 [0x1D] PRINT_EVENT_MESSAGE(message_id=8239*)
    → "Lately them crrrawler crrritters out thar in Sarutabaruta have been eatin' up all the $2 that these dhalmel love so much."
  5: 0x01F5 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x01F6 [0x1D] PRINT_EVENT_MESSAGE(message_id=8240*)
    → "It's put me in a rrreeeal fiddle, 'coz now I have to work rrreeeal hard to git me some of them thar $2."
  7: 0x01F9 [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x01FA [0x1D] PRINT_EVENT_MESSAGE(message_id=8241*)
    → "I do declare... You seem to be the adventurrrer type now, huh!? Would you mind doin' me a favor the next time yer out thar a-huntin' in Sarutabaruta, and concentrate on depleting the numberrrs of crawlers in them parrrts?"
 ...
 12: 0x020C [0x1D] PRINT_EVENT_MESSAGE(message_id=8242*)
    → "If ya cull enough of them crawlers to git your hands on three $1 or $3, then I'll give you a little somethin' as a rrreward! Whaddaya say?"
