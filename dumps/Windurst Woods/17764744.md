...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0000:          02 05 17 00 80  00 27 00 1E 87 11 0F 01     ......'......
0010: 6F 70 C4 02 05 17 F8 FF  FF 7F 87 11 0F 01 1C 01  op..............
...
```
  ...
  1: 0x000B [0x1E] EventEntity looks at Ensemble Maven (ID: 17764743/0x010F1187) and starts talking
  ...
  4: 0x0012 [0xC4] SCHEDULE_MAGIC_CASTING_ALT (arg=18): EventEntity casts magic Work_Zone_1700[5] on Ensemble Maven (ID: 17764743/0x010F1187)
  5: 0x001E [0x1C] WAIT(240* ticks)
  6: 0x0021 [0x39] SET_ENTITY_DIRECTION(direction=358.6°*)
