...
```
  ...
  3: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=8007*)
    → "Sew...I mean...\u00072So,\u00073 want to get your paws on the top-quality materials as used in the Weaverrrs' Guild?\u007F1\u0000\u0007"
  4: 0x000B [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x000C [0x1D] PRINT_EVENT_MESSAGE(message_id=8008*)
    → "Then step rrright up and take a look! Just be carrreful not to get too giddy with excitement, now!\u007F1\u0000\u0007"
