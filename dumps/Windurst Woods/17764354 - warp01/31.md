...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0000:    2C 02 10 0F 01 02 10  0F 01 63 61 62 6B 24 00   ,........cabk$.
...
```
  0: 0x0001 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "cabk" with entities [warp01 (ID: 17764354/0x010F1002), warp01 (ID: 17764354/0x010F1002)]
