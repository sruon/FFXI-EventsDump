...
- **6794**: If you wish to ride a chocobo, you must possess $6 and have a high enough job level.
- **6795**: You can rent a chocobo for $0 gil. I see you currently have $1 gil.
- **6796**: You can rent a chocobo, but because your level is so low, you won't be able to ride for very long. Also, equipment that extends your riding time will have no effect.
- **6797**: If you still want one, it will cost you $0 gil. I see you currently have $1 gil.
- **6798**: Do you wish to rent a chocobo? [Yes, I do./No, thank you.]
- **6799**: You don't have enough gil.
- **6800**: I realize that you are in a hurry, [sir/ma'am]. However, might I make a simple request? One of our associate's chocobos has lost her way and cannot return home.
- **6801**: Would you be so kind as to deliver her to [the Kingdom/the Republic/the Federation/the Duchy/the Duchy/the Duchy/the hidden] stables in [Southern San d'Oria/the Bastok Mines/Windurst Woods/Upper Jeuno/Lower Jeuno/Port Jeuno/Norg]?
- **6802**: Lend a helping hand? [I have better things to do./Of course!]
- **6803**: Oh, thank you so very much! You shall be rewarded by our associates upon delivery of the chocobo.
...
```
  ...
  4: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=6800*)
  ...
  6: 0x001F [0x1D] PRINT_EVENT_MESSAGE(message_id=6801*)
  ...
  8: 0x0023 [0x24] CREATE_DIALOG(message_id=6802*, default_option=0*, option_flags=0*)
...
SUBROUTINE_004F:
 ...
 22: 0x0084 [0x1D] PRINT_EVENT_MESSAGE(message_id=6795*)
 ...
 25: 0x008B [0x1D] PRINT_EVENT_MESSAGE(message_id=6796*)
 ...
 27: 0x008F [0x1D] PRINT_EVENT_MESSAGE(message_id=6797*)
    → "If you still want one, it will cost you $0 gil. I see you currently have $1 gil."
 28: 0x0092 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_0093:
 29: 0x0093 [0x24] CREATE_DIALOG(message_id=6798*, default_option=1*, option_flags=0*)
...
SUBROUTINE_00AB:
 ...
 56: 0x0149 [0x1D] PRINT_EVENT_MESSAGE(message_id=6799*)
...
```
  ...
  2: 0x0168 [0x1D] PRINT_EVENT_MESSAGE(message_id=6794*)
