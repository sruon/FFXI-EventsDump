...
```
  ...
  4: 0x0031 [0x1D] PRINT_EVENT_MESSAGE(message_id=8015*)
    → "This is the arrrchway to Windurst Walls, the hearrrtland of Windurst.\u007F1\u0000\u0007"
  5: 0x0034 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0035 [0x1D] PRINT_EVENT_MESSAGE(message_id=8016*)
    → "In the centerrr of Windurst Walls is a giant star tree that grew out of and then encompassed Heavens Tower. That's where the Star Sibyl, who rules overrr our federation, lives.\u007F1\u0000\u0007"
