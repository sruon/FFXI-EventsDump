...
- **9765**: The minstrel of melodies is my name, For a mere $6 gil I'll recall your past. Your stories of love, anger, triumph, and shame, The river of memories runs deep and vast.
- **9766**: The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last.
- **13735**: What memory will you have recalled? [None./Seekers of Adoulin.]
- **13736**: What memory will you have recalled? [None./Rumors from the West.]
...
- **13741**: What memory will you have recalled? [None.]
...
```
  ...
  3: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=9766*)
 ...
 21: 0x0088 [0x1D] PRINT_EVENT_MESSAGE(message_id=9766*)
    → "The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last."
 22: 0x008B [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x008C [0x21] END_EVENT
 24: 0x008D [0x00] END_REQSTACK()
 25: 0x008E [0x1D] PRINT_EVENT_MESSAGE(message_id=9765*)
 ...
 39: 0x00D4 [0x24] CREATE_DIALOG(message_id=13735*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00E4:
 42: 0x00E4 [0x24] CREATE_DIALOG(message_id=13736*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_0113:
 50: 0x0113 [0x24] CREATE_DIALOG(message_id=13737*, default_option=0*, option_flags=Work_Zone[3])
...
SUBROUTINE_0142:
 58: 0x0142 [0x24] CREATE_DIALOG(message_id=13738*, default_option=0*, option_flags=Work_Zone[4])
    → "What memory will you have recalled? [None.]"
...
SUBROUTINE_0171:
 66: 0x0171 [0x24] CREATE_DIALOG(message_id=13739*, default_option=0*, option_flags=Work_Zone[5])
    → "What memory will you have recalled? [None.]"
...
SUBROUTINE_01A0:
 74: 0x01A0 [0x24] CREATE_DIALOG(message_id=13740*, default_option=0*, option_flags=Work_Zone[6])
    → "What memory will you have recalled? [None.]"
...
SUBROUTINE_01CF:
 82: 0x01CF [0x24] CREATE_DIALOG(message_id=13741*, default_option=0*, option_flags=Work_Zone[7])
    → "What memory will you have recalled? [None.]"
