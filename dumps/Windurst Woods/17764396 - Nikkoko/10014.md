...
```
  0: 0x0001 [0x3E] IF !(Work_Zone[5] bit 4*) GOTO 0x0177
  ...
  5: 0x0020 [0x1D] PRINT_EVENT_MESSAGE(message_id=7313*)
    → "Hey, Nikkoko can only do so much.\u007F1\u0000\u0007"
  6: 0x0023 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0024 [0x01] GOTO 0x0056

SUBROUTINE_0027:
  8: 0x0027 [0x1D] PRINT_EVENT_MESSAGE(message_id=7315*)
    → "All righty! Now cross your eyes and dot your T's...\u007F1\u0000\u0007"
...
SUBROUTINE_0059:
 ...
 21: 0x0075 [0x1D] PRINT_EVENT_MESSAGE(message_id=7316*)
    → "Hmm... How about \u0001\u0001\u0001 \u0001\u0005$\u0002\u0000\u0000\u0000? They're always popular among adventurers.\u0007You'll need...\u007F1\u0000\u0007"
...
\u0007 x \u0001	)\u0002\u0007\u0000\u0000\u0002\u0003\u0000\u0000\u007F1\u0000\u0007"
 ...
 80: 0x0162 [0x1D] PRINT_EVENT_MESSAGE(message_id=7317*)
    → "Got it?\u0007When you're done, bring it right on over to Nikkoko. I'd love to see it!\u007F1\u0000\u0007"
...
SUBROUTINE_0177:
 86: 0x0177 [0x1D] PRINT_EVENT_MESSAGE(message_id=7312*)
    → "I...I think I'm getting a little dizzy-wizzy... Oooh...\u007F1\u0000\u0007"
