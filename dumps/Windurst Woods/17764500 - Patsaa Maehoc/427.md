...
```
  ...
  5: 0x0037 [0x1D] PRINT_EVENT_MESSAGE(message_id=8531*)
    → "It's purrr-etty darn hard to catch a dhalmel, you know? Only we Mithra have the necessary abilities to do it propurrrly!\u007F1\u0000\u0007"
  6: 0x003A [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x003B [0x1D] PRINT_EVENT_MESSAGE(message_id=8532*)
    → "To carry out that ability, you need something in purrrticular. To give you a hint, it's something that only Mithra have... Purrr...\u007F1\u0000\u0007"
