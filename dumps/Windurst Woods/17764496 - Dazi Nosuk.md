...
- **8539**: The centrrral hub of Windurst is the Windurst Walls distrrrict, with Heavens Tower encompassed by that overgrrrown star tree. You'll get there if you head north strrraight along this path.
- **8540**: But it's too quiet there, with too many brrridges for my liking. I don't find it the least bit interrresting.
...
```
  ...
  5: 0x0037 [0x1D] PRINT_EVENT_MESSAGE(message_id=8539*)
  ...
  7: 0x003B [0x1D] PRINT_EVENT_MESSAGE(message_id=8540*)
