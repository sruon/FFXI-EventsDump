...
```
 ...
 12: 0x006A [0x45] LOAD_SCHEDULED_TASK(work_offset1=197*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s247", work_offset2=0*)
 13: 0x007B [0x1C] WAIT(60* ticks)
 14: 0x007E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 15: 0x008F [0x1C] WAIT(60* ticks)
 16: 0x0092 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=Pulonono (ID: 17764419/0x010F1043), entity2=Pulonono (ID: 17764419/0x010F1043), action="tlk0")
...
SUBROUTINE_00AC:
 20: 0x00AC [0x45] LOAD_SCHEDULED_TASK(work_offset1=197*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s248", work_offset2=0*)
 21: 0x00BD [0x1C] WAIT(60* ticks)
 22: 0x00C0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 23: 0x00D1 [0x1C] WAIT(60* ticks)
 24: 0x00D4 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=Pulonono (ID: 17764419/0x010F1043), entity2=Pulonono (ID: 17764419/0x010F1043), action="tlk0")
 ...
 27: 0x00EB [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=Pulonono (ID: 17764419/0x010F1043), entity2=Pulonono (ID: 17764419/0x010F1043), action="tlk1")
 28: 0x00FA [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 29: 0x010B [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 34: 0x013D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
