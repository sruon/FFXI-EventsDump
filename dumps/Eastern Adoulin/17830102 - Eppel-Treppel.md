...
- **10486**: The Celennia Memorial Library contains relics of knowledge from ages past as well as the latest-watest illuminated publications. We can't grantaru access to unproven philistines, however. Sorry.
- **10487**: The Celennia Memorial Library contains relics of knowledge from ages past as well as the latest-watest illuminated publications. Would you care to enter this vastaru vault of knowledge?
- **10488**: Enter the library? [Yes./No.]
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=10486*)
...
```
  ...
  4: 0x0042 [0x1D] PRINT_EVENT_MESSAGE(message_id=10487*)
  ...
  6: 0x0046 [0x24] CREATE_DIALOG(message_id=10488*, default_option=0*, option_flags=0*)
