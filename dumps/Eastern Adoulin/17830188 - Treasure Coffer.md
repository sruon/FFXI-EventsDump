...
| [5136](#event-5136)      | 0x0070       |      6 |              2 |
| [5145](#event-5145)      | 0x0076       |      6 |              2 |
...
```
  0: 0x004C [0x7A] VM_CONTROL: Reset copy state for Treasure Coffer (ID: 17830188/0x0110112C)
