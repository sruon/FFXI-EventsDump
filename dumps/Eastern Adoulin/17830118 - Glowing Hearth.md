...
- **10481**: Get lost, commoner.
- **10482**: ...Welcome to the Silver Knife.
- **10485**: Enter the premises? [Of course, it's my right./No, it's not worth my attention.]
...
```
  ...
  3: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=10481*)
    → "Get lost, commoner."
...
```
  ...
  4: 0x0034 [0x1D] PRINT_EVENT_MESSAGE(message_id=10482*)
    → "...Welcome to the Silver Knife."
  5: 0x0037 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0038 [0x24] CREATE_DIALOG(message_id=10485*, default_option=0*, option_flags=0*)
