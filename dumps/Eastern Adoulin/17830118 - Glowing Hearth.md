...
- **10479**: Get lost, commoner.
- **10480**: ...Welcome to the Silver Knife.
- **10483**: Enter the premises? [Of course, it's my right./No, it's not worth my attention.]
...
```
  ...
  3: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=10479*)
    → "Get lost, commoner."
...
```
  ...
  6: 0x0038 [0x24] CREATE_DIALOG(message_id=10483*, default_option=0*, option_flags=0*)
