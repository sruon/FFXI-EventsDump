...
```
  ...
  9: 0x0106 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 ...
 16: 0x0127 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="ten1")
 17: 0x0136 [0x1D] PRINT_EVENT_MESSAGE(message_id=11049*)
    → "\u00072How do you decode them?\u00073\u007F1\u0000\u0007"
 18: 0x0139 [0x23] WAIT_FOR_DIALOG_INTERACTION
 19: 0x013A [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="ten1")
 20: 0x0147 [0x7B] EventEntity stops talking
 21: 0x014C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 24: 0x015F [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="thk1")
 25: 0x016C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 26: 0x017B [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="thk2")
 27: 0x0188 [0x79] EventEntity looks at LocalPlayer (Basic look)
 28: 0x0192 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 33: 0x01A9 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="ten0")
