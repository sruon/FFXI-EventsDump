...
- **9983**: There's no way we'll get any further without more data. If only we could find someone willing to...
- **9984**: You there! Are you familiar with the leafkin?
- **9985**: They're creatures about as big as coconuts, and they wrap themselves in leaves for clothing. They're so adorable that I just want to give them a big hug!
- **9986**: They may not be a part of mankind, but I wouldn't go so far as to call them "monsters." They aren't aggressive, and they have many fans throughout Adoulin.
- **9987**: The Scouts' Coalition wants to learn more about their behavioral patterns and life cycles, but we lack any credible information.
- **9988**: That being the case, we're looking for people willing to assist in our surveys.
- **9989**: Please, think of the leafkin.
- **9990**: How about it? [Sure./Let's "leaf" this alone.]
- **9991**: Dang it! Well, you know where to find me if you change your mind.
- **9992**: Let's get right down to business, then. Step one is to gather information in town.
- **9993**: I've received reports of leafkin sightings from the Couriers', Pioneers', and Peacekeepers' Coalitions.
- **9994**: However, we have to verify the authenticity of any information we receive if we don't want to go on a wild-goose chase.
- **9995**: Should you come across any promising leads, follow up on them by going to the source, and report back to me with your findings.
- **9996**: I suggest you get started by visiting the other coalitions I've mentioned--Couriers', Pioneers', and Peacekeepers'.
- **10005**: You're the [man/woman] who's been assisting us with the leafkin investigation? Any news?
- **10006**: Hmm? A rusty pioneer's pickaxe...?
- **10007**: You caught it while fishing in the Zoldeff River?
- **10008**: Now that you mention it, the Pioneers' Coalition has reported large quantities of equipment vanishing.
- **10009**: The leafkin are behind it, aren't they? What are they playing at, hampering the progress of our efforts?
- **10010**: I'll inform the Pioneers' Coalition of the situation.
- **10011**: The leafkin are planting seedlings? Hmm...
- **10012**: Well, they DO use leaves and fruit as garb. Trying to replenish the forest to fashion more garb, no doubt.
- **10013**: That would explain why they feel threatened by our activities in Ulbuka.
- **10014**: You saw a leafkin...take an umbril head-on!? I didn't think they had such gumption in their buds!
- **10015**: Umbrils are ancient, mysterious creatures that have nested in Ulbuka since time immemorial.
- **10016**: We know as little about them as we do the leafkin. Perhaps the two are natural enemies?
- **10017**: This is really something to ponder. We'll make sure to analyze the leafkin in light of what we've learned about the umbrils.
- **10018**: We might be able to use this as a foothold for further knowledge.
- **10019**: You've delivered us some valuable information. The coalition cannot offer much in terms of payment, but it is the thought that counts--not the size of the reward.
- **10020**: Come back if you learn anything more.
- **10021**: You've come up with far more than we could have expected. This will help our research proceed much more smoothly.
- **10022**: The more we learn, the more we realize we don't know. Unique creatures, indeed, these leafkin.
- **10023**: They must have some purpose in life that we cannot yet comprehend...
- **10024**: ...Pay no attention to my ramblings. A member of the Scouts' Coalition should not speak authoritatively without sufficient proof.
- **10025**: One day, we'll figure out what makes them tick. I'm sure you'll be interested in our findings as well.
- **10026**: The leafkin surely are mystifying creatures. I hope you're looking forward to what we find out about them as much as we are.
...
```
  ...
  1: 0x0010 [0x1D] PRINT_EVENT_MESSAGE(message_id=9983*)
...
```
 ...
 18: 0x00A6 [0x1D] PRINT_EVENT_MESSAGE(message_id=9984*)
    → "You there! Are you familiar with the leafkin?"
 19: 0x00A9 [0x23] WAIT_FOR_DIALOG_INTERACTION
 20: 0x00AA [0x1D] PRINT_EVENT_MESSAGE(message_id=9985*)
 ...
 22: 0x00AE [0x1D] PRINT_EVENT_MESSAGE(message_id=9986*)
 ...
 27: 0x00E1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9987*)
 ...
 29: 0x00E5 [0x1D] PRINT_EVENT_MESSAGE(message_id=9988*)
 ...
 34: 0x0118 [0x1D] PRINT_EVENT_MESSAGE(message_id=9989*)
    → "Please, think of the leafkin."
 35: 0x011B [0x23] WAIT_FOR_DIALOG_INTERACTION
 36: 0x011C [0x24] CREATE_DIALOG(message_id=9990*, default_option=0*, option_flags=0*)
 ...
 42: 0x015B [0x1D] PRINT_EVENT_MESSAGE(message_id=9992*)
 ...
 44: 0x015F [0x1D] PRINT_EVENT_MESSAGE(message_id=9993*)
 ...
 50: 0x01A1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9994*)
 ...
 52: 0x01A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=9995*)
 ...
 60: 0x01E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=9991*)
...
```
  ...
  3: 0x024A [0x1D] PRINT_EVENT_MESSAGE(message_id=9996*)
  ...
  5: 0x024E [0x1D] PRINT_EVENT_MESSAGE(message_id=9995*)
    → "Should you come across any promising leads, follow up on them by going to the source, and report back to me with your findings."
...
```
 ...
 18: 0x02E2 [0x1D] PRINT_EVENT_MESSAGE(message_id=10005*)
 ...
 28: 0x0338 [0x1D] PRINT_EVENT_MESSAGE(message_id=10014*)
 ...
 34: 0x0378 [0x1D] PRINT_EVENT_MESSAGE(message_id=10015*)
 ...
 37: 0x038B [0x1D] PRINT_EVENT_MESSAGE(message_id=10016*)
 ...
 41: 0x03AF [0x1D] PRINT_EVENT_MESSAGE(message_id=10017*)
 ...
 43: 0x03B3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10018*)
 ...
 51: 0x0400 [0x1D] PRINT_EVENT_MESSAGE(message_id=10019*)
 ...
 55: 0x0420 [0x1D] PRINT_EVENT_MESSAGE(message_id=10020*)
 ...
 60: 0x0447 [0x1D] PRINT_EVENT_MESSAGE(message_id=10021*)
 ...
 65: 0x047A [0x1D] PRINT_EVENT_MESSAGE(message_id=10022*)
 ...
 67: 0x047E [0x1D] PRINT_EVENT_MESSAGE(message_id=10023*)
 ...
 72: 0x04B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=10024*)
 ...
 75: 0x04C4 [0x1D] PRINT_EVENT_MESSAGE(message_id=10025*)
...
```
 ...
 18: 0x05BA [0x1D] PRINT_EVENT_MESSAGE(message_id=10005*)
    → "You're the [man/woman] who's been assisting us with the leafkin investigation? Any news?"
 ...
 28: 0x0610 [0x1D] PRINT_EVENT_MESSAGE(message_id=10006*)
 ...
 33: 0x0643 [0x1D] PRINT_EVENT_MESSAGE(message_id=10007*)
 ...
 38: 0x0676 [0x1D] PRINT_EVENT_MESSAGE(message_id=10008*)
 ...
 40: 0x067A [0x1D] PRINT_EVENT_MESSAGE(message_id=10009*)
 ...
 42: 0x067E [0x1D] PRINT_EVENT_MESSAGE(message_id=10010*)
 ...
 50: 0x06CB [0x1D] PRINT_EVENT_MESSAGE(message_id=10019*)
    → "You've delivered us some valuable information. The coalition cannot offer much in terms of payment, but it is the thought that counts--not the size of the reward."
 ...
 54: 0x06EB [0x1D] PRINT_EVENT_MESSAGE(message_id=10020*)
    → "Come back if you learn anything more."
 ...
 59: 0x0712 [0x1D] PRINT_EVENT_MESSAGE(message_id=10021*)
    → "You've come up with far more than we could have expected. This will help our research proceed much more smoothly."
 ...
 64: 0x0745 [0x1D] PRINT_EVENT_MESSAGE(message_id=10022*)
    → "The more we learn, the more we realize we don't know. Unique creatures, indeed, these leafkin."
 65: 0x0748 [0x23] WAIT_FOR_DIALOG_INTERACTION
 66: 0x0749 [0x1D] PRINT_EVENT_MESSAGE(message_id=10023*)
    → "They must have some purpose in life that we cannot yet comprehend..."
 ...
 71: 0x077C [0x1D] PRINT_EVENT_MESSAGE(message_id=10024*)
    → "...Pay no attention to my ramblings. A member of the Scouts' Coalition should not speak authoritatively without sufficient proof."
 ...
 74: 0x078F [0x1D] PRINT_EVENT_MESSAGE(message_id=10025*)
    → "One day, we'll figure out what makes them tick. I'm sure you'll be interested in our findings as well."
...
```
 ...
 18: 0x0885 [0x1D] PRINT_EVENT_MESSAGE(message_id=10005*)
    → "You're the [man/woman] who's been assisting us with the leafkin investigation? Any news?"
 ...
 28: 0x08DB [0x1D] PRINT_EVENT_MESSAGE(message_id=10011*)
    → "The leafkin are planting seedlings? Hmm..."
 29: 0x08DE [0x23] WAIT_FOR_DIALOG_INTERACTION
 30: 0x08DF [0x1D] PRINT_EVENT_MESSAGE(message_id=10012*)
 ...
 33: 0x08EB [0x1D] PRINT_EVENT_MESSAGE(message_id=10013*)
 ...
 40: 0x0935 [0x1D] PRINT_EVENT_MESSAGE(message_id=10019*)
    → "You've delivered us some valuable information. The coalition cannot offer much in terms of payment, but it is the thought that counts--not the size of the reward."
 ...
 44: 0x0955 [0x1D] PRINT_EVENT_MESSAGE(message_id=10020*)
    → "Come back if you learn anything more."
 ...
 48: 0x096D [0x1D] PRINT_EVENT_MESSAGE(message_id=10021*)
    → "You've come up with far more than we could have expected. This will help our research proceed much more smoothly."
 ...
 53: 0x09A0 [0x1D] PRINT_EVENT_MESSAGE(message_id=10022*)
    → "The more we learn, the more we realize we don't know. Unique creatures, indeed, these leafkin."
 54: 0x09A3 [0x23] WAIT_FOR_DIALOG_INTERACTION
 55: 0x09A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=10023*)
    → "They must have some purpose in life that we cannot yet comprehend..."
 ...
 60: 0x09D7 [0x1D] PRINT_EVENT_MESSAGE(message_id=10024*)
    → "...Pay no attention to my ramblings. A member of the Scouts' Coalition should not speak authoritatively without sufficient proof."
 ...
 63: 0x09EA [0x1D] PRINT_EVENT_MESSAGE(message_id=10025*)
    → "One day, we'll figure out what makes them tick. I'm sure you'll be interested in our findings as well."
...
```
  ...
  4: 0x0A6A [0x1D] PRINT_EVENT_MESSAGE(message_id=10026*)
