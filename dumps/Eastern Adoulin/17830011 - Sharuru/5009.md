...
```
  ...
  2: 0x0009 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="moj0")
  3: 0x0018 [0x1D] PRINT_EVENT_MESSAGE(message_id=8003*)
    → "How are you finding the waypointarus? You'd better not have made me go through all that explanation for nothing!\u007F1\u0000\u0007"
