...
```
  ...
  4: 0x0015 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  5: 0x0024 [0x01] GOTO 0x0041

SUBROUTINE_0027:
  6: 0x0027 [0x02] IF !(ExtData[1]->WorkLocal[0] == 1*) GOTO 0x0041
  7: 0x002F [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=34*, entity1=EventEntity, entity2=EventEntity, action="tlb0")
...
SUBROUTINE_0041:
 ...
 16: 0x005B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 17: 0x006A [0x01] GOTO 0x0087

SUBROUTINE_006D:
 18: 0x006D [0x02] IF !(ExtData[1]->WorkLocal[0] == 1*) GOTO 0x0087
 19: 0x0075 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=34*, entity1=EventEntity, entity2=EventEntity, action="tlb1")
