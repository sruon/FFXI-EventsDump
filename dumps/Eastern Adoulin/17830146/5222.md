...
```
 ...
 35: 0x82DA [0x45] LOAD_SCHEDULED_TASK(work_offset1=714*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s015", work_offset2=0*)
...
SUBROUTINE_8389:
 ...
 71: 0x83A8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=714*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s016", work_offset2=0*)
 ...
 83: 0x83F9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=714*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s017", work_offset2=0*)
 ...
 93: 0x843C [0x45] LOAD_SCHEDULED_TASK(work_offset1=714*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s018", work_offset2=0*)
...
109: 0x84A9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=714*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s019", work_offset2=0*)
110: 0x84BA [0x01] GOTO 0x853E

SUBROUTINE_84BD:
111: 0x84BD [0x02] IF !(LocalPlayer->Race == 4*) GOTO 0x84D9
112: 0x84C5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=714*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s019", work_offset2=0*)
113: 0x84D6 [0x01] GOTO 0x853E

SUBROUTINE_84D9:
114: 0x84D9 [0x02] IF !(LocalPlayer->Race == 5*) GOTO 0x84F5
115: 0x84E1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=714*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s021", work_offset2=0*)
116: 0x84F2 [0x01] GOTO 0x853E

SUBROUTINE_84F5:
117: 0x84F5 [0x02] IF !(LocalPlayer->Race == 6*) GOTO 0x8511
118: 0x84FD [0x45] LOAD_SCHEDULED_TASK(work_offset1=714*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s021", work_offset2=0*)
119: 0x850E [0x01] GOTO 0x853E

SUBROUTINE_8511:
120: 0x8511 [0x02] IF !(LocalPlayer->Race == 8*) GOTO 0x852D
121: 0x8519 [0x45] LOAD_SCHEDULED_TASK(work_offset1=714*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s019", work_offset2=0*)
122: 0x852A [0x01] GOTO 0x853E

SUBROUTINE_852D:
123: 0x852D [0x45] LOAD_SCHEDULED_TASK(work_offset1=714*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s020", work_offset2=0*)
...
211: 0x874C [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="qstc", work_offset2=0*)
212: 0x875D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
