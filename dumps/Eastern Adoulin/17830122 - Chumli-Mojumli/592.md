...
```
  ...
  5: 0x005C [0x5F] MULTI_HANDLER_COMPLEX(mode=0x06 - Load ext scheduler with flag (OpCode 0x5B mode 1, flag 1), ref=References[3], entity1=EventEntity, entity2=EventEntity, string="gkr0", extra=References[6])
  ...
  9: 0x0080 [0x5F] MULTI_HANDLER_COMPLEX(mode=0x06 - Load ext scheduler with flag (OpCode 0x5B mode 1, flag 1), ref=References[3], entity1=EventEntity, entity2=EventEntity, string="gkr1", extra=References[8])
