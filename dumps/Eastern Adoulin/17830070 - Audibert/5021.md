...
```
  ...
  3: 0x0A5B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  4: 0x0A6A [0x1D] PRINT_EVENT_MESSAGE(message_id=10020*)
    → "The leafkin surely are mystifying creatures. I hope you're looking forward to what we find out about them as much as we are.\u007F1\u0000\u0007"
