...
```
  ...
  1: 0x052D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  2: 0x053E [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 13: 0x0583 [0x45] LOAD_SCHEDULED_TASK(work_offset1=621*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s009", work_offset2=0*)
 14: 0x0594 [0x1C] WAIT(15* ticks)
 15: 0x0597 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 16: 0x05A8 [0x1C] WAIT(30* ticks)
 17: 0x05AB [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 20: 0x05BE [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 21: 0x05CD [0x52] END_LOAD_SCHEDULER: End scheduler "s009" with entities [LocalPlayer, LocalPlayer], work=621*
 22: 0x05DC [0x45] LOAD_SCHEDULED_TASK(work_offset1=621*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s014", work_offset2=0*)
 ...
 27: 0x0601 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 31: 0x0623 [0x45] LOAD_SCHEDULED_TASK(work_offset1=621*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s015", work_offset2=0*)
 32: 0x0634 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 ...
 36: 0x0656 [0x45] LOAD_SCHEDULED_TASK(work_offset1=621*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s016", work_offset2=0*)
 37: 0x0667 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 46: 0x0699 [0x45] LOAD_SCHEDULED_TASK(work_offset1=621*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s013", work_offset2=0*)
 47: 0x06AA [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 48: 0x06B9 [0x1C] WAIT(30* ticks)
 49: 0x06BC [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="pas0")
 ...
 52: 0x06CF [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="pas0")
 53: 0x06DC [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
...
SUBROUTINE_06F2:
 57: 0x06F2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=621*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s018", work_offset2=0*)
 58: 0x0703 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 ...
 62: 0x0725 [0x45] LOAD_SCHEDULED_TASK(work_offset1=621*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s019", work_offset2=0*)
 63: 0x0736 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 69: 0x075C [0x45] LOAD_SCHEDULED_TASK(work_offset1=621*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s020", work_offset2=0*)
 70: 0x076D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 ...
 73: 0x0780 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 76: 0x0793 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="qstc", work_offset2=0*)
 77: 0x07A4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 78: 0x07B5 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 82: 0x07E4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
