...
- **13409**: Your fate rides on the changing winds of Vana'diel. I can give you insight on the local weather.
...
- **13411**: That area's forecast for today is for $0 with occasional $1. There is also a slight chance of $2, so caution is advised.
- **13412**: The forecast for tomorrow is for $0 with occasional $1. There is also a slight chance of $2, so caution is advised.
- **13413**: And, the forecast for the day after tomorrow is for $0 with occasional $1. There is also a slight chance of $2, so caution is advised.
- **13414**: Today, that area's weather will be $0 with a chance of $1.
- **13415**: Tomorrow, the weather will be $0 with a chance of $1.
- **13416**: And, the day after tomorrow, the weather will be $0 with a chance of $1.
- **13417**: Today, the weather in that area will be $0. There is also the possibility of $2, so caution is advised.
- **13418**: Tomorrow, the weather will be $0. There is also the possibility of $2, so caution is advised.
- **13419**: And, the day after tomorrow, the weather will be $0. There is also the possibility of $2, so caution is advised.
- **13420**: The weather in that area today will be $0.
- **13421**: The weather tomorrow will be $0.
- **13422**: The weather the day after tomorrow will be $0.
- **13423**: And that's the report, straight from Vana'diel's official weather linkshell.
- **13425**: What area's weather do you wish to know? [Nowhere./Ceizak Battlegrounds./Yahse Hunting Grounds./Foret de Hennetiel./Morimar Basalt Fields./Yorcia Weald./Marjami Ravine./Kamihr Drifts.]
...
SUBROUTINE_0013:
 ...
 11: 0x002A [0x1D] PRINT_EVENT_MESSAGE(message_id=12540*)
 ...
 14: 0x0033 [0x1D] PRINT_EVENT_MESSAGE(message_id=12541*)
...
```
  ...
  1: 0x01E2 [0x1D] PRINT_EVENT_MESSAGE(message_id=13409*)
  ...
  3: 0x01E6 [0x24] CREATE_DIALOG(message_id=13425*, default_option=0*, option_flags=0*)
...
SUBROUTINE_047B:
 ...
 23: 0x0486 [0x1D] PRINT_EVENT_MESSAGE(message_id=13414*)
 ...
 26: 0x048D [0x1D] PRINT_EVENT_MESSAGE(message_id=13411*)
...
SUBROUTINE_0491:
 ...
 32: 0x04AE [0x1D] PRINT_EVENT_MESSAGE(message_id=13421*)
    → "The weather tomorrow will be $0."
 33: 0x04B1 [0x23] WAIT_FOR_DIALOG_INTERACTION
 34: 0x04B2 [0x01] GOTO 0x04B9
 35: 0x04B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=13418*)
...
SUBROUTINE_04F7:
 ...
 55: 0x0502 [0x1D] PRINT_EVENT_MESSAGE(message_id=13416*)
 ...
 58: 0x0509 [0x1D] PRINT_EVENT_MESSAGE(message_id=13413*)
...
SUBROUTINE_050D:
 60: 0x050D [0x1D] PRINT_EVENT_MESSAGE(message_id=13423*)
...
# Dead code (unreachable instructions):
     0x0270 [0x24] CREATE_DIALOG(message_id=13410*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
