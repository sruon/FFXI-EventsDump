...
- **13411**: Your fate rides on the changing winds of Vana'diel. I can give you insight on the local weather.
- **13412**: What area's weather do you wish to know? [Nowhere./Ronfaure./La Theine Plateau./Valkurm Dunes./Jugner Forest./Batallia Downs./Gustaberg./Konschtat Highlands./Pashhow Marshlands./Rolanberry Fields./Beaucedine Glacier./Xarcabard./Cape Teriggan./Altepa Desert./Sarutabaruta./Tahrongi Canyon./Buburimu Peninsula./Meriphataud Mountains./Sauromugue Champaign./The Sanctuary of Zi'Tah./Yuhtunga & Yhoator Jungles./Qufim Island./Tu'Lia./Ferry./Airship./Jeuno./Uleguerand Range./Tavnazian Archipelago./Riverne - Sites #A01 & #B01.]
- **13413**: That area's forecast for today is for $0 with occasional $1. There is also a slight chance of $2, so caution is advised.
- **13414**: The forecast for tomorrow is for $0 with occasional $1. There is also a slight chance of $2, so caution is advised.
- **13415**: And, the forecast for the day after tomorrow is for $0 with occasional $1. There is also a slight chance of $2, so caution is advised.
- **13416**: Today, that area's weather will be $0 with a chance of $1.
- **13417**: Tomorrow, the weather will be $0 with a chance of $1.
- **13418**: And, the day after tomorrow, the weather will be $0 with a chance of $1.
- **13419**: Today, the weather in that area will be $0. There is also the possibility of $2, so caution is advised.
- **13420**: Tomorrow, the weather will be $0. There is also the possibility of $2, so caution is advised.
- **13421**: And, the day after tomorrow, the weather will be $0. There is also the possibility of $2, so caution is advised.
- **13422**: The weather in that area today will be $0.
- **13423**: The weather tomorrow will be $0.
- **13424**: The weather the day after tomorrow will be $0.
- **13425**: And that's the report, straight from Vana'diel's official weather linkshell.
- **13427**: What area's weather do you wish to know? [Nowhere./Ceizak Battlegrounds./Yahse Hunting Grounds./Foret de Hennetiel./Morimar Basalt Fields./Yorcia Weald./Marjami Ravine./Kamihr Drifts.]
...
SUBROUTINE_0013:
 ...
 11: 0x002A [0x1D] PRINT_EVENT_MESSAGE(message_id=12542*)
 ...
 14: 0x0033 [0x1D] PRINT_EVENT_MESSAGE(message_id=12543*)
...
```
  ...
  1: 0x01E2 [0x1D] PRINT_EVENT_MESSAGE(message_id=13411*)
  ...
  3: 0x01E6 [0x24] CREATE_DIALOG(message_id=13427*, default_option=0*, option_flags=0*)
...
SUBROUTINE_047B:
 ...
 23: 0x0486 [0x1D] PRINT_EVENT_MESSAGE(message_id=13416*)
 ...
 26: 0x048D [0x1D] PRINT_EVENT_MESSAGE(message_id=13413*)
...
SUBROUTINE_0491:
 ...
 32: 0x04AE [0x1D] PRINT_EVENT_MESSAGE(message_id=13423*)
    → "The weather tomorrow will be $0."
 33: 0x04B1 [0x23] WAIT_FOR_DIALOG_INTERACTION
 34: 0x04B2 [0x01] GOTO 0x04B9
 35: 0x04B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=13420*)
...
SUBROUTINE_04F7:
 ...
 55: 0x0502 [0x1D] PRINT_EVENT_MESSAGE(message_id=13418*)
 ...
 58: 0x0509 [0x1D] PRINT_EVENT_MESSAGE(message_id=13415*)
...
SUBROUTINE_050D:
 60: 0x050D [0x1D] PRINT_EVENT_MESSAGE(message_id=13425*)
...
# Dead code (unreachable instructions):
     0x0270 [0x24] CREATE_DIALOG(message_id=13412*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
