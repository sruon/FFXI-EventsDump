...
- **10456**: It takes a certain type of genius to sketch a jungle landscape.
- **10457**: That's why I must focus all my creative energy into a dense ball of concentration. I need my muse to descend from the heavens and set my spirit on fire with a volcanic eruption of inspiration!
...
```
  0: 0x0001 [0x1D] PRINT_EVENT_MESSAGE(message_id=10456*)
    → "It takes a certain type of genius to sketch a jungle landscape."
  1: 0x0004 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0005 [0x1D] PRINT_EVENT_MESSAGE(message_id=10457*)
