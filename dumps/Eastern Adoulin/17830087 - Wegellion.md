...
- **10164**: Maester Margret has pledged her support to your cause.
- **10165**: Bring us $0 and $1 that she might continue her pursuits.
- **10193**: Difficult though it is to forget Ari-Barali's sordid tale, I'll make sure word of it never leaves my lips.
- **10258**: Reepi-Molpi? He ventured off towards Yorcia Weald.
- **10259**: As grizzled an outdoorsman as he sounds, I fear for his safety. Would you mind checking up on him?
- **10429**: Oh, pardon me. You're searching for records on Adoulin's founding?
- **10430**: I believe your best bet would be to flip through some of our historical primers.
- **10431**: They're all on that shelf over there. You can have one, but we kindly ask you to refrain from taking any more with you.
- **10432**: All the documents we've compiled in the coalition are for public use. Search 'til your fingers are covered in paper cuts if you want.
- **11050**: Hey, that looks like the Scouts' Coalition-issue parchment we used for daily reports.
- **11051**: Writing on it with a special ink renders the text invisible to those without the proper decoding tools.
- **11052**: Judging from its consistency, I'd say it's the type our espionage agents stopped using a little while ago.
- **11053**: "How do you decode them?"
- **11054**: Hmmm... I guess if we're not using them anymore, there's no need to keep the process a secret.
- **11055**: The magic happens in Foret de Hennetiel. Certain poisons in the Zoldeff River will react with the ink, causing it to change color. Downright sorcerous, yeah?
- **11056**: I've seen Palomel taking some sheets from the stockroom every now and then, but I can't imagine she actually uses them. I know twitherym that're more skilled with ciphers than she is.
- **11057**: If you wanna see the magic in action, dip that paper somewhere along the Zoldeff River in Foret de Hennetiel.
- **11659**: Wh-where on Vana'diel did you stumble across that hat?
- **11660**: What a terrible situation. I'd recognize that brim anywhere--that hat almost certainly belonged to Cedricaste.
- **11661**: He was a damn fine man, and a mentor to Margret in her younger years.
- **11662**: How does the saying go? "A person like him only appears once a century"? The coalition is lucky that we had two--Cedricaste and Margret.
- **11663**: Margret held him in the highest regard--we all did--and to think he met such an ignoble end in the hinterlands...
- **11664**: Perhaps you think this morbid, but...would you mind if I had that hat? I promise to treat it with the utmost care.
- **11665**: As talented as Margret is, she is young of age and should be looking toward the future, not beholden to the past.
- **11666**: When the time is right, I'll tell her the truth.
- **11667**: What do you do? [Hand over the hat./Keep it for yourself.]
- **11668**: I beg you to reconsider. This article means a lot to the coalition.
- **11669**: You have my sincerest thanks.
- **11670**: Cedricaste taught me that although the eyes may be deceived, the mind can always find the truth.
- **11671**: That's why all forms of information are valuable.
- **11672**: Margret doesn't need to know of our little arrangement.
- **11673**: Consider this not as hush money, but as payment for finding an invaluable artifact of the coalition.
...
```
  ...
  6: 0x0023 [0x1D] PRINT_EVENT_MESSAGE(message_id=10432*)
...
```
  ...
  4: 0x004B [0x1D] PRINT_EVENT_MESSAGE(message_id=10429*)
...
```
  ...
  3: 0x0097 [0x1D] PRINT_EVENT_MESSAGE(message_id=10164*)
  ...
  7: 0x00A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=10165*)
...
```
  ...
  3: 0x00C3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10193*)
...
```
  ...
  3: 0x00E1 [0x1D] PRINT_EVENT_MESSAGE(message_id=10258*)
    → "Reepi-Molpi? He ventured off towards Yorcia Weald."
  4: 0x00E4 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x00E5 [0x1D] PRINT_EVENT_MESSAGE(message_id=10259*)
...
```
  ...
  7: 0x0102 [0x1D] PRINT_EVENT_MESSAGE(message_id=11050*)
 ...
 10: 0x0115 [0x1D] PRINT_EVENT_MESSAGE(message_id=11051*)
 ...
 12: 0x0119 [0x1D] PRINT_EVENT_MESSAGE(message_id=11052*)
 ...
 17: 0x0136 [0x1D] PRINT_EVENT_MESSAGE(message_id=11053*)
 ...
 22: 0x015B [0x1D] PRINT_EVENT_MESSAGE(message_id=11054*)
 ...
 29: 0x01A1 [0x1D] PRINT_EVENT_MESSAGE(message_id=11055*)
 ...
 31: 0x01A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=11056*)
...
```
  ...
  7: 0x01E2 [0x1D] PRINT_EVENT_MESSAGE(message_id=11057*)
...
```
  ...
  8: 0x0222 [0x1D] PRINT_EVENT_MESSAGE(message_id=11659*)
 ...
 20: 0x0277 [0x1D] PRINT_EVENT_MESSAGE(message_id=11660*)
 ...
 30: 0x02B8 [0x1D] PRINT_EVENT_MESSAGE(message_id=11663*)
 ...
 34: 0x02DC [0x1D] PRINT_EVENT_MESSAGE(message_id=11664*)
 ...
 36: 0x02E0 [0x1D] PRINT_EVENT_MESSAGE(message_id=11665*)
 ...
 40: 0x0304 [0x1D] PRINT_EVENT_MESSAGE(message_id=11666*)
 ...
 44: 0x0319 [0x24] CREATE_DIALOG(message_id=11667*, default_option=0*, option_flags=0*)
 ...
 49: 0x0343 [0x1D] PRINT_EVENT_MESSAGE(message_id=11669*)
 ...
 54: 0x035B [0x1D] PRINT_EVENT_MESSAGE(message_id=11669*)
    → "You have my sincerest thanks."
...
SUBROUTINE_0362:
 ...
 60: 0x0375 [0x1D] PRINT_EVENT_MESSAGE(message_id=11668*)
 ...
 65: 0x0391 [0x1D] PRINT_EVENT_MESSAGE(message_id=11668*)
    → "I beg you to reconsider. This article means a lot to the coalition."
...
SUBROUTINE_03A9:
 ...
 70: 0x03BB [0x1D] PRINT_EVENT_MESSAGE(message_id=11670*)
 ...
 72: 0x03BF [0x1D] PRINT_EVENT_MESSAGE(message_id=11671*)
 ...
 76: 0x03E3 [0x1D] PRINT_EVENT_MESSAGE(message_id=11672*)
 ...
 80: 0x0407 [0x1D] PRINT_EVENT_MESSAGE(message_id=11673*)
