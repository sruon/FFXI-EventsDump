...
| [84](#event-84)            | 0x010D       |      7 |              2 |
| [65535.19](#event-6553519) | 0x0114       |     15 |              5 |
| [65535.20](#event-6553520) | 0x0123       |     22 |              8 |
...
```
  ...
  1: 0x0117 [0x1F] MOVE_ENTITY: EventEntity moves to X=-92.591*, Z=366.126*, Y=-189.999*
...
0130: 6F 1E 19 22 11 01 6F 70  00                       o.."..op.       
```
...
```
  ...
  1: 0x0126 [0x1F] MOVE_ENTITY: EventEntity moves to X=-98.078*, Z=364.419*, Y=-189.999*
  2: 0x012E [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x0130 [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
  4: 0x0131 [0x1E] EventEntity looks at Egg (ID: 17900057/0x01112219) and starts talking
