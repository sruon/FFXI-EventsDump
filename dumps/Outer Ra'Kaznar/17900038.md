...
- **7733**: Teleportation protocols active. Proceed? [No./Take me to the entrance.]
...
```
  0: 0x0001 [0x24] CREATE_DIALOG(message_id=7733*, default_option=0*, option_flags=0*)
