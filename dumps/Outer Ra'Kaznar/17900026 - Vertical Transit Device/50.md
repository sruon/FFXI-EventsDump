...
```
  ...
  1: 0x03E2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  2: 0x03F3 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 10: 0x042A [0x45] LOAD_SCHEDULED_TASK(work_offset1=617*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s024", work_offset2=0*)
 11: 0x043B [0x27] REQ_SET(priority=0x08, entity_id=LocalPlayer, tag_num=0x02)
 12: 0x0442 [0x1C] WAIT(15* ticks)
 13: 0x0445 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 ...
 17: 0x0470 [0x45] LOAD_SCHEDULED_TASK(work_offset1=617*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s025", work_offset2=0*)
 18: 0x0481 [0x01] GOTO 0x0505

SUBROUTINE_0484:
 19: 0x0484 [0x02] IF !(LocalPlayer->Race == 4*) GOTO 0x04A0
 20: 0x048C [0x45] LOAD_SCHEDULED_TASK(work_offset1=617*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s025", work_offset2=0*)
 21: 0x049D [0x01] GOTO 0x0505

SUBROUTINE_04A0:
 22: 0x04A0 [0x02] IF !(LocalPlayer->Race == 5*) GOTO 0x04BC
 23: 0x04A8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=617*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s027", work_offset2=0*)
 24: 0x04B9 [0x01] GOTO 0x0505

SUBROUTINE_04BC:
 25: 0x04BC [0x02] IF !(LocalPlayer->Race == 6*) GOTO 0x04D8
 26: 0x04C4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=617*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s027", work_offset2=0*)
 27: 0x04D5 [0x01] GOTO 0x0505

SUBROUTINE_04D8:
 28: 0x04D8 [0x02] IF !(LocalPlayer->Race == 8*) GOTO 0x04F4
 29: 0x04E0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=617*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s025", work_offset2=0*)
 30: 0x04F1 [0x01] GOTO 0x0505

SUBROUTINE_04F4:
 31: 0x04F4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=617*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s026", work_offset2=0*)
 ...
 34: 0x0512 [0xCD] LOAD_SCHEDULED_TASK_ALT4(work_offset=193*, entity1=LocalPlayer, entity2=LocalPlayer, action="s000", work_offset2=0*)
 ...
 39: 0x0553 [0x45] LOAD_SCHEDULED_TASK(work_offset1=617*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s028", work_offset2=0*)
 40: 0x0564 [0x1C] WAIT(170* ticks)
 41: 0x0567 [0x2A] GET_REQ_LEVEL(level=8, entity_id=LocalPlayer)
 42: 0x056D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 43: 0x057E [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 51: 0x05AF [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
