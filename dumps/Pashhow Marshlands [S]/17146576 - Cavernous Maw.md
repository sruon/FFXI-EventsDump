...
- **7088**: To where will you head? [[The past/The present]./Walk of Echoes./Nowhere for now.]
...
```
  ...
  1: 0x01BA [0x48] [System] [7071*]:
    → "An unseen force is drawing you towards the maw."
  2: 0x01BD [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x01BE [0x03] Work_Zone[2] = 2843*
  4: 0x01C3 [0x24] CREATE_DIALOG(message_id=7073*, default_option=1*, option_flags=0*)
    → "Raise your $3? [Yes./No.]"
  5: 0x01CA [0x25] WAIT_DIALOG_SELECT()
  6: 0x01CB [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x035E
  7: 0x01D3 [0x03] Work_Zone[2] = 1*
  8: 0x01D8 [0x24] CREATE_DIALOG(message_id=7088*, default_option=2*, option_flags=0*)
