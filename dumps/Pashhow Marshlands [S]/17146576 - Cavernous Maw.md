...
- **7073**: You can feel the warm, moist breath of the maw on your skin.
- **7074**: An unseen force is drawing you towards the maw.
- **7075**: A portal has opened within the depths of the maw.
- **7076**: Raise your $3? [Yes./No.]
- **7091**: To where will you head? [[The past/The present]./Walk of Echoes./Nowhere for now.]
...
0040: 01 F0 FF FF 7F 05 45 08  80 F0 FF FF 7F F0 FF FF  ......E.........
0050: 7F 61 74 31 30 04 80 45  05 80 F0 FF FF 7F F0 FF  .at10..E........
...
00B0: 04 80 29 01 F0 FF FF 7F  06 45 05 80 F0 FF FF 7F  ..)......E......
...
```
  ...
  4: 0x000C [0x24] CREATE_DIALOG(message_id=7076*, default_option=1*, option_flags=0*)
    → "Raise your $3? [Yes./No.]"
 ...
 15: 0x003F [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x05)
 16: 0x0046 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "at10" with entities [LocalPlayer, LocalPlayer], work=[341*, 0*]
 17: 0x0057 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi1" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
 18: 0x0068 [0x48] [System] [7075*]:
 ...
 24: 0x00B2 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x06)
...
0130: 31 30 04 80 45 05 80 F0  FF FF 7F F0 FF FF 7F 66  10..E..........f
...
```
 ...
 16: 0x0123 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "at10" with entities [LocalPlayer, LocalPlayer], work=[341*, 0*]
...
0210: 7F 05 45 08 80 F0 FF FF  7F F0 FF FF 7F 61 74 31  ..E..........at1
0220: 30 04 80 45 05 80 F0 FF  FF 7F F0 FF FF 7F 66 64  0..E..........fd
...
02D0: 7F F0 FF FF 7F 61 74 31  30 04 80 45 05 80 F0 FF  .....at10..E....
...
```
  ...
  1: 0x01BA [0x48] [System] [7074*]:
    → "An unseen force is drawing you towards the maw."
  2: 0x01BD [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x01BE [0x03] Work_Zone[2] = 2843*
  4: 0x01C3 [0x24] CREATE_DIALOG(message_id=7076*, default_option=1*, option_flags=0*)
    → "Raise your $3? [Yes./No.]"
  5: 0x01CA [0x25] WAIT_DIALOG_SELECT()
  6: 0x01CB [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x035E
  7: 0x01D3 [0x03] Work_Zone[2] = 1*
  8: 0x01D8 [0x24] CREATE_DIALOG(message_id=7091*, default_option=2*, option_flags=0*)
 ...
 20: 0x0212 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "at10" with entities [LocalPlayer, LocalPlayer], work=[341*, 0*]
 ...
 41: 0x02CA [0x45] LOAD_SCHEDULED_TASK: Load scheduler "at10" with entities [LocalPlayer, LocalPlayer], work=[341*, 0*]
