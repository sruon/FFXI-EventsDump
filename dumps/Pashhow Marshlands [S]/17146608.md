...
```
  ...
  1: 0x0005 [0x1F] MOVE_ENTITY: EventEntity moves to X=243.940*, Z=263.412*, Y=1.540*
  2: 0x000D [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x000F [0x1E] EventEntity looks at Volker (ID: 17146603/0x0105A2EB) and starts talking
...
```
  ...
  1: 0x001B [0x1F] MOVE_ENTITY: EventEntity moves to X=238.213*, Z=263.752*, Y=1.499*
