...
- **7638**: Are you one of the mercenaries sent to retrieve the Mark-IIs? We've been waiting for you.
- **7639**: Listen carefully, for this mission is not as simple as it may seem. The battle automaton Mark-II, a.k.a. Maymun, is a very...unique model.
- **7640**: To prevent usage by enemy forces in the event of capture, the machines have been programmed to only respond to specific gestures.
- **7641**: In other words, you must use body language to communicate with them.
- **7642**: Our scouts have confirmed a total of six Mark-IIs in the area.
- **7643**: If you have any questions, feel free to ask.
- **7644**: What would you like to know about? [Mission objectives./Maymun commands./Maymun personality./Current number retrieved./Nothing.]
- **7645**: Your orders are as follows:
- **7646**: 1. Retrieve at least four Mark-II automatons and lead them back to headquarters.
- **7647**: 2. /salute to activate the Maymun and register as its "master."". Wave /goodbye to deactivate it.
- **7648**: 4. /clap to initiate "follow" mode. 5. A /hurray gesture will switch on/off "battle" mode.
- **7649**: 6. The Maymun will not accept orders from a "master" who is currently controlling another Mark-II.
- **7650**: To maintain control of the Maymun, you will need to respond correctly to its unique gestures.
- **7651**: Learn about which gestures? [Bowing./Pointing./Waving./Dancing./Blushing./Saluting./Happy./Confused./Shocked./Praising./Clapping./Cheering./Quit.]
- **7652**: When the Mark-II bows, you should politely /kneel before her.
- **7653**: When the Mark-II wanders astray, you should tell her /no.
- **7654**: When the Mark-II waves her hand, you should /welcome her.
- **7655**: When the Mark-II dances, you should express your /joy.
- **7656**: When the Mark-II is pretending to act embarrassed, you should ignore her by pretending to /doze off.
- **7657**: When the Mark-II salutes, you should /praise her.
- **7658**: When the Mark-II is happy, you should /smile.
- **7659**: When the Mark-II is confused, you should /slap her lightly to realign her circuitry.
- **7660**: When the Mark-II is in shock, you should /comfort her.
- **7661**: When the Mark-II praises you, you should /blush.
- **7662**: When the Mark-II applauds, you should become /angry with her.
- **7663**: If the Mark-II cheers, you should /psyche up.
- **7664**: There are six different personality programs used in the Mark-II models.
- **7665**: The violent "Diemun"... The hyperactive "Flymun"... The carefree "Highmun"...
- **7666**: The sensitive "Crymun"... The peaceful "Whymun"... And...
- **7667**: The basic "Maymun" model. Oh, and those names aren't official. I've simply had a lot of free time waiting out here for you mercenaries to come along.
- **7668**: You have retrieved $0 Mark-II[/s] so far.
- **7669**: You still haven't brought me any...
- **7670**: To complete your mission, you must retrieve at least four.
...
```
  ...
  4: 0x0013 [0x1D] PRINT_EVENT_MESSAGE(message_id=7638*)
  ...
  6: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=7639*)
  ...
  8: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=7640*)
...
SUBROUTINE_002F:
 ...
 20: 0x003C [0x24] CREATE_DIALOG(message_id=7644*, default_option=4*, option_flags=0*)
 ...
 32: 0x005D [0x1D] PRINT_EVENT_MESSAGE(message_id=7648*)
 ...
 34: 0x0061 [0x1D] PRINT_EVENT_MESSAGE(message_id=7649*)
...
SUBROUTINE_0075:
 ...
 42: 0x007D [0x1D] PRINT_EVENT_MESSAGE(message_id=7650*)
 ...
 44: 0x0081 [0x24] CREATE_DIALOG(message_id=7651*, default_option=12*, option_flags=0*)
 ...
 49: 0x009D [0x1D] PRINT_EVENT_MESSAGE(message_id=7652*)
 ...
 55: 0x00B8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7653*)
 ...
 61: 0x00D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7654*)
 ...
 67: 0x00EE [0x1D] PRINT_EVENT_MESSAGE(message_id=7655*)
 ...
 73: 0x0109 [0x1D] PRINT_EVENT_MESSAGE(message_id=7656*)
 ...
 79: 0x0124 [0x1D] PRINT_EVENT_MESSAGE(message_id=7657*)
 ...
 85: 0x013F [0x1D] PRINT_EVENT_MESSAGE(message_id=7658*)
 ...
 91: 0x015A [0x1D] PRINT_EVENT_MESSAGE(message_id=7659*)
 ...
 97: 0x0175 [0x1D] PRINT_EVENT_MESSAGE(message_id=7660*)
...
103: 0x0190 [0x1D] PRINT_EVENT_MESSAGE(message_id=7661*)
...
109: 0x01AB [0x1D] PRINT_EVENT_MESSAGE(message_id=7662*)
...
115: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7663*)
...
141: 0x0218 [0x1D] PRINT_EVENT_MESSAGE(message_id=7669*)
    → "You still haven't brought me any..."
142: 0x021B [0x23] WAIT_FOR_DIALOG_INTERACTION
143: 0x021C [0x01] GOTO 0x0223
144: 0x021F [0x1D] PRINT_EVENT_MESSAGE(message_id=7668*)
