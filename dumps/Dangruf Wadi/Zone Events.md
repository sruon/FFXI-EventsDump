...
- **7426**: Where do you want to go? (This page scrolls down.) [Nowhere./San d'Oria./Windurst./Elevator in Ghelsba/Bastok/Ronfaure Forest]
...
```
  0: 0x00E0 [0x24] CREATE_DIALOG(message_id=7426*, default_option=0*, option_flags=0*)
...
```
 ...
 15: 0x058B [0x2B] Ken (ID: 17559926/0x010BF176) [7467*]:
 ...
 18: 0x0599 [0x2B] Ken (ID: 17559926/0x010BF176) [7468*]:
