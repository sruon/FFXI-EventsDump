...
| [32000](#event-32000)      | 0x01F9       |      1 |              1 |
| [32001](#event-32001)      | 0x01FA       |      1 |              1 |
| [65535.33](#event-6553533) | 0x01FB       |      1 |              1 |
| [65535.34](#event-6553534) | 0x01FC       |     10 |              2 |
| [65535.35](#event-6553535) | 0x0206       |     10 |              2 |
| [65535.36](#event-6553536) | 0x0210       |     24 |              6 |
| [65535.37](#event-6553537) | 0x0228       |     14 |              4 |
| [65535.38](#event-6553538) | 0x0236       |     14 |              4 |
| [65535.39](#event-6553539) | 0x0244       |      9 |              5 |
| [65535.40](#event-6553540) | 0x024D       |      5 |              3 |
| [65535.41](#event-6553541) | 0x0252       |      5 |              3 |
| [65535.42](#event-6553542) | 0x0257       |     17 |              5 |
| [65535.43](#event-6553543) | 0x0268       |      5 |              3 |
| [65535.44](#event-6553544) | 0x026D       |     17 |              5 |
...
- **7720**: Vhy are you doing this!? Vhat on Vana'diel happened at the Manustery!?
- **7721**: After you became minister-vinister, you spent all your vaking hours there, vorking diligently. And then you pull your disappearing-vearing act and erase everyone's memories of you...!
- **7725**: Uran-Mafran...
- **7729**: No, that's not true. You know as vell as I do that I was desty-vestined for the Rhinostery.
- **7732**: ......
- **7736**: But, I remember-vember you being in there with me...
- **7742**: ......
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
01D0:                                   66 04 80 F8 FF             f....
01E0: FF 7F F8 FF FF 7F 66 72  61 30 00                 ......fra0.     
```

#### Opcodes

```
  0: 0x01DB [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "fra0" with entities [EventEntity, EventEntity], work=15*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0200:                   37 09  80 0A 80 0B 80 0C 80 00        7.........
```

#### Opcodes

```
  0: 0x0206 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=20.848*, z=28.066*, y=-18.291*, direction=311.2°*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0230:                   32 13  80 5A 00 17 80 18 80 19        2..Z......
0240: 80 5A 01 00                                       .Z..            
```
...
```
  ...
  1: 0x0239 [0x5A] UPDATE_EVENT_POSITION: Set EventEntity MovePosition to X=21.133*, Z=28.313*, Y=-18.267*
...
```
  0: 0x024D [0x1D] PRINT_EVENT_MESSAGE(message_id=7725*)
    → "Uran-Mafran..."
...
```
  0: 0x0252 [0x1D] PRINT_EVENT_MESSAGE(message_id=7729*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0250:                      7C  00 F8 FF FF 7F 1D 1E 80         |........
0260: 23 7C 01 F8 FF FF 7F 00                           #|......        
```
...
```
  ...
  1: 0x025D [0x1D] PRINT_EVENT_MESSAGE(message_id=7732*)
    → "......"
...
```
  0: 0x0268 [0x1D] PRINT_EVENT_MESSAGE(message_id=7736*)
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0260:                                         7C 00 F8               |..
0270: FF FF 7F 1D 20 80 23 7C  01 F8 FF FF 7F 00        .... .#|......  
```
...
```
  ...
  1: 0x0273 [0x1D] PRINT_EVENT_MESSAGE(message_id=7742*)
    → "......"
