...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0090:                                         03 04 00               ...
00A0: 02 10 03 05 00 03 10 03  06 00 04 10 03 07 00 05  ................
00B0: 10 42 62 01 80 F0 FF FF  7F F0 FF FF 7F 6D 61 69  .Bb..........mai
00C0: 6E 00 80 1C 02 80 45 03  80 F0 FF FF 7F F0 FF FF  n.....E.........
00D0: 7F 66 64 6F 31 00 80 1C  04 80 47 00 04 00 06 00  .fdo1.....G.....
00E0: 05 00 07 00 47 01 45 03  80 F0 FF FF 7F F0 FF FF  ....G.E.........
...
```
  0: 0x009D [0x03] ExtData[1]->WorkLocal[4] = Work_Zone[2]
  1: 0x00A2 [0x03] ExtData[1]->WorkLocal[5] = Work_Zone[3]
  2: 0x00A7 [0x03] ExtData[1]->WorkLocal[6] = Work_Zone[4]
  3: 0x00AC [0x03] ExtData[1]->WorkLocal[7] = Work_Zone[5]
  ...
  9: 0x00DA [0x47] UPDATE_PLAYER_POS(ExtData[1]->WorkLocal[4], ExtData[1]->WorkLocal[6], ExtData[1]->WorkLocal[5], yaw=ExtData[1]->WorkLocal[7])
...
```
  ...
  6: 0x0126 [0x1F] MOVE_ENTITY: EventEntity moves to X=ExtData[1]->WorkLocal[0], Z=ExtData[1]->WorkLocal[2], Y=ExtData[1]->WorkLocal[1]
