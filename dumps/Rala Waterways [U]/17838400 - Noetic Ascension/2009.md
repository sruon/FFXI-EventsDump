...
```
  ...
  6: 0x0020 [0x24] CREATE_DIALOG(message_id=7363*, default_option=0*, option_flags=0x02)
...
119: 0x025A [0x24] CREATE_DIALOG(message_id=7365*, default_option=0*, option_flags=0x06)
...
126: 0x027B [0x24] CREATE_DIALOG(message_id=7365*, default_option=0*, option_flags=0x06)
    → "Which benefit?\u0007\u000BNone.\u0007Bayld+.\u0007Obsidian Fragments+.\u0007Attack+.\u0007Defense+.\u0007Magic Attack+.\u0007Magic Defense+.\u0007Map Obtainment.\u0007HP & MP Recovery+.\u0007TP3000+.\u0007HP+.\u0007MP+.\u0007Movement Speed+.\u0007Defensive Measures.\u007F1\u0000\u0007"
...
132: 0x0299 [0x24] CREATE_DIALOG(message_id=7383*, default_option=0*, option_flags=0x09)
...
141: 0x02C2 [0x24] CREATE_DIALOG(message_id=7364*, default_option=0*, option_flags=0x06)
...
147: 0x02E0 [0x24] CREATE_DIALOG(message_id=7391*, default_option=0*, option_flags=0x09)
...
SUBROUTINE_03D7:
204: 0x03D7 [0x41] GET_BIT_WORK_RANGE(start_bit=3*, end_bit=3*, source=ExtData[1]->WorkLocal[0], result=ExtData[1]->WorkLocal[15])
205: 0x03E0 [0x41] GET_BIT_WORK_RANGE(start_bit=4*, end_bit=4*, source=ExtData[1]->WorkLocal[0], result=ExtData[1]->WorkLocal[16])
206: 0x03E9 [0x41] GET_BIT_WORK_RANGE(start_bit=5*, end_bit=5*, source=ExtData[1]->WorkLocal[0], result=ExtData[1]->WorkLocal[17])
207: 0x03F2 [0x41] GET_BIT_WORK_RANGE(start_bit=6*, end_bit=6*, source=ExtData[1]->WorkLocal[0], result=ExtData[1]->WorkLocal[18])
208: 0x03FB [0x41] GET_BIT_WORK_RANGE(start_bit=10*, end_bit=10*, source=ExtData[1]->WorkLocal[0], result=ExtData[1]->WorkLocal[19])
209: 0x0404 [0x41] GET_BIT_WORK_RANGE(start_bit=11*, end_bit=11*, source=ExtData[1]->WorkLocal[0], result=ExtData[1]->WorkLocal[20])
210: 0x040D [0x41] GET_BIT_WORK_RANGE(start_bit=12*, end_bit=12*, source=ExtData[1]->WorkLocal[0], result=ExtData[1]->WorkLocal[21])
