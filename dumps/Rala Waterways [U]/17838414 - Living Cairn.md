...
- **7428**: Teleport to the next location? [Proceed./Not yet.]
- **7429**: Teleport to which area? [None./1."."./4./5./6./7./8./9./10.]
...
```
  0: 0x0001 [0x24] CREATE_DIALOG(message_id=7428*, default_option=1*, option_flags=0*)
...
```
  0: 0x002B [0x24] CREATE_DIALOG(message_id=7429*, default_option=0*, option_flags=0*)
