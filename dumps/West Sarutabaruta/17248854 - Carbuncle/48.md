...
SUBROUTINE_01F5:
 ...
 16: 0x0215 [0x62] LOAD_EVENT_SCHEDULER: Load scheduler "main" with entities [EFFECTER (ID: 17248853/0x01073255), EFFECTER (ID: 17248853/0x01073255)], work=[42*, 0*]
 17: 0x0226 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s006" with entities [Carbuncle (ID: 17248854/0x01073256), Carbuncle (ID: 17248854/0x01073256)], work=[213*, 0*]
 18: 0x0237 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "whi1" with entities [EventEntity, EventEntity], work=[201*, 0*]
 19: 0x0248 [0x6C] FADE_ENTITY_COLOR(entity_id=Carbuncle (ID: 17248854/0x01073256), end_alpha=0*, fade_time=1*)
 20: 0x0251 [0x1C] WAIT(1* ticks)
 21: 0x0254 [0x4E] SET_ENTITY_HIDE_FLAG: Show Carbuncle (ID: 17248854/0x01073256)
 22: 0x025A [0x1C] WAIT(60* ticks)
 23: 0x025D [0x6C] FADE_ENTITY_COLOR(entity_id=Carbuncle (ID: 17248854/0x01073256), end_alpha=100*, fade_time=72*)
 ...
 28: 0x0270 [0x6C] FADE_ENTITY_COLOR(entity_id=Carbuncle (ID: 17248854/0x01073256), end_alpha=0*, fade_time=100*)
