...
```
 ...
 23: 0x0063 [0x45] LOAD_SCHEDULED_TASK(work_offset1=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s193", work_offset2=0*)
 24: 0x0074 [0x1A] CALL_SUBROUTINE(address=0x0487)
 25: 0x0077 [0x55] WAIT_LOAD_SCHEDULER(work_offset=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s193")
 26: 0x0086 [0x45] LOAD_SCHEDULED_TASK(work_offset1=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s012", work_offset2=0*)
 ...
 29: 0x00A1 [0x55] WAIT_LOAD_SCHEDULER(work_offset=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s012")
 30: 0x00B0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s040", work_offset2=0*)
 31: 0x00C1 [0x2A] GET_REQ_LEVEL(level=16, entity_id=Unnamed NPC (ID: 17248906/0x0107328A))
 32: 0x00C7 [0x5B] LOAD_EXT_SCHEDULER(work_offset=2161*, entity1=Unnamed NPC (ID: 17248906/0x0107328A), entity2=Unnamed NPC (ID: 17248906/0x0107328A), action="sky0")
 ...
 35: 0x00DA [0x55] WAIT_LOAD_SCHEDULER(work_offset=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s040")
 ...
 39: 0x00F8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s013", work_offset2=0*)
 ...
 47: 0x0116 [0x55] WAIT_LOAD_SCHEDULER(work_offset=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s013")
 48: 0x0125 [0x45] LOAD_SCHEDULED_TASK(work_offset1=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s014", work_offset2=0*)
 ...
 52: 0x013B [0x55] WAIT_LOAD_SCHEDULER(work_offset=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s014")
 53: 0x014A [0x6C] FADE_ENTITY_COLOR(entity_id=Unnamed NPC (ID: 17248906/0x0107328A), end_alpha=0*, fade_time=1*)
 54: 0x0153 [0x45] LOAD_SCHEDULED_TASK(work_offset1=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s015", work_offset2=0*)
 ...
 59: 0x0170 [0x55] WAIT_LOAD_SCHEDULER(work_offset=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s015")
 60: 0x017F [0x45] LOAD_SCHEDULED_TASK(work_offset1=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s016", work_offset2=0*)
 ...
 65: 0x019C [0x55] WAIT_LOAD_SCHEDULER(work_offset=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s016")
 66: 0x01AB [0x45] LOAD_SCHEDULED_TASK(work_offset1=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s017", work_offset2=0*)
 ...
 79: 0x01E9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s019", work_offset2=0*)
 ...
 87: 0x021F [0x45] LOAD_SCHEDULED_TASK(work_offset1=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s018", work_offset2=0*)
 ...
 93: 0x023F [0x55] WAIT_LOAD_SCHEDULER(work_offset=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s018")
 ...
 97: 0x025D [0x45] LOAD_SCHEDULED_TASK(work_offset1=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s021", work_offset2=0*)
...
117: 0x02DB [0x45] LOAD_SCHEDULED_TASK(work_offset1=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s022", work_offset2=0*)
...
122: 0x0300 [0x55] WAIT_LOAD_SCHEDULER(work_offset=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s022")
123: 0x030F [0x45] LOAD_SCHEDULED_TASK(work_offset1=387*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s020", work_offset2=0*)
124: 0x0320 [0x5B] LOAD_EXT_SCHEDULER(work_offset=2161*, entity1=Babban Ny Mheillea (ID: 17248905/0x01073289), entity2=Babban Ny Mheillea (ID: 17248905/0x01073289), action="sky0")
...
146: 0x0372 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
147: 0x0383 [0x21] END_EVENT
148: 0x0384 [0x00] END_REQSTACK()

149: 0x040C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
150: 0x041D [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
151: 0x042C [0x1B] RETURN

SUBROUTINE_042D:
152: 0x042D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2", work_offset2=0*)
153: 0x043E [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2")
154: 0x044D [0x1B] RETURN

155: 0x0487 [0x45] LOAD_SCHEDULED_TASK(work_offset1=215*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="efon", work_offset2=0*)
156: 0x0498 [0x55] WAIT_LOAD_SCHEDULER(work_offset=215*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="efon")
...
```
# Data Section: 0x0385 (135 bytes)
     0x0385: 45 28 80 F0 FF FF 7F F0 FF FF 7F 77 68 6F 30 0B
     0x0395: 80 55 28 80 F0 FF FF 7F F0 FF FF 7F 77 68 6F 30
     0x03A5: 1B 45 28 80 F0 FF FF 7F F0 FF FF 7F 77 68 6F 31
     0x03B5: 0B 80 55 28 80 F0 FF FF 7F F0 FF FF 7F 77 68 6F
     0x03C5: 31 1B 45 28 80 F0 FF FF 7F F0 FF FF 7F 77 68 69
     0x03D5: 30 0B 80 1B 45 28 80 F0 FF FF 7F F0 FF FF 7F 77
     0x03E5: 68 69 31 0B 80 1B 45 27 80 F0 FF FF 7F F0 FF FF
     0x03F5: 7F 66 64 6F 30 0B 80 55 27 80 F0 FF FF 7F F0 FF
     0x0405: FF 7F 66 64 6F 30 1B
# Data Section: 0x044E (57 bytes)
     0x044E: 45 27 80 F8 FF FF 7F F8 FF FF 7F 66 64 69 30 0B
     0x045E: 80 1B 45 27 80 F8 FF FF 7F F8 FF FF 7F 66 64 69
     0x046E: 31 0B 80 1B 45 27 80 F8 FF FF 7F F8 FF FF 7F 66
     0x047E: 64 69 32 0B 80 1C 05 80 1B
```