...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0000:    42 4A F0 FF FF 7F 32  10 0D 01 6F 76 F0 FF FF   BJ....2...ov...
...
```
  ...
  1: 0x0002 [0x4A] LocalPlayer looks at Earth Protocrystal (ID: 17633330/0x010D1032)
...
```
 ...
 24: 0x00AD [0x4B] UPDATE_ENTITY_YAW(entity=??? (ID: 17633356/0x010D104C), yaw=ExtData[1]->WorkLocal[1])
