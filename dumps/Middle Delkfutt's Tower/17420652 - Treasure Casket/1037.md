...
```
 ...
 40: 0x02F6 [0x24] CREATE_DIALOG(message_id=7384*, default_option=0*, option_flags=ExtData[1]->WorkLocal[8])
...
SUBROUTINE_03BB:
 ...
 81: 0x03CE [0x48] [System] [7409*]:
    → "Obtain this item?\u007F1\u0000\u0007"
 82: 0x03D1 [0x23] WAIT_FOR_DIALOG_INTERACTION
 83: 0x03D2 [0x93] DISPLAY_ITEM_INFO(item_id=0*)
 84: 0x03D5 [0x24] CREATE_DIALOG(message_id=7386*, default_option=1*, option_flags=0*)
