...
```
  ...
  6: 0x042B [0x48] [System] [7391*]:
    → "The chest is locked.\u007F1\u0000\u0007"
  7: 0x042E [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x042F [0x24] CREATE_DIALOG(message_id=7392*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0447:
 ...
 16: 0x0459 [0x24] CREATE_DIALOG(message_id=7393*, default_option=0*, option_flags=0*)
    → "What will you do? (
