...
- **12489**: What'll it be? [Peace out./Help an adventurer recover!/Receive $6./Get key items and titles./Receive 10,000 research marks./Receive a completed $0. /
- **12493**: For what expedition rank? [Quit wasting my time./Adjunct./Assistant./Instructor./Associate Researcher./Researcher./??? /
...
```
  ...
  6: 0x0026 [0x24] CREATE_DIALOG(message_id=12489*, default_option=0*, option_flags=ExtData[1]->WorkLocal[1])
 ...
 18: 0x0066 [0x24] CREATE_DIALOG(message_id=12493*, default_option=0*, option_flags=0*)
