...
- **8130**: The objectives of the missions given out at gatehouses are not prrroperly scrutinized. It seems the ministers are having adventurers participate in all sorts of harebrrrained schemes.
- **8131**: Brrringing the ministers back into line will be the first step in changing Windurst for the better.
- **8155**: Opening the Darrrk Dungeon requires a "Charm of Darkness." However, only the Star Sibyl is capable of making them.
- **8156**: This spells the end for the Orastery ministerrr... It's such a shame...
- **8311**: We were faced with such incredible powerrr... Even we Sibyl Guards were frozen to the spot by the terrrror that creature inspired.
- **8312**: In coming to Heavens Tower, was its goal to seek out the Star Sibyl?
- **8324**: We Sibyl Guards were formed to protect the perrrson of the Star Sibyl.
- **8325**: But if we can't perform our duties as bodyguards, our prrresence here outside the Vestal Chamber becomes no more than a charrrade.
- **8326**: ...This must be something like the frustrrration the Star Sibyl felt when performing those meaningless ceremonies at the magic-drained Star Spring.
- **8451**: At times like this, the Star Sibyl's stamina and spirrrit are being put to the test.
- **8452**: We must rescue her from those puppets as soon as possible, but Semih Lafihna has yet to give the orrrder. I suppose just rushing in might make things worrrse...
- **8459**: Semih Lafihna has given her orrrders. The time has come for the Sibyl Guards to unsheathe our claws and fight with all our strrrength...
- **8543**: The ceremony performed by the Star Sibyl at the Full Moon Fountain is known as the Moon Reading.
- **8544**: The Moon Reading uses the powerrr of the Stars and the Moon to grant one tremendous wish. It is this power that has allowed the cheerful Tarutaru to exist in this land for as long as they have.
...
```
  ...
  4: 0x027E [0x1D] PRINT_EVENT_MESSAGE(message_id=8130*)
  ...
  6: 0x0282 [0x1D] PRINT_EVENT_MESSAGE(message_id=8131*)
...
```
  ...
  4: 0x02A6 [0x1D] PRINT_EVENT_MESSAGE(message_id=8155*)
  ...
  6: 0x02AA [0x1D] PRINT_EVENT_MESSAGE(message_id=8156*)
...
```
  ...
  4: 0x02CE [0x1D] PRINT_EVENT_MESSAGE(message_id=8311*)
  ...
  6: 0x02D2 [0x1D] PRINT_EVENT_MESSAGE(message_id=8312*)
...
```
  ...
  8: 0x02FE [0x1D] PRINT_EVENT_MESSAGE(message_id=8326*)
...
```
  ...
  4: 0x0322 [0x1D] PRINT_EVENT_MESSAGE(message_id=8451*)
  ...
  6: 0x0326 [0x1D] PRINT_EVENT_MESSAGE(message_id=8452*)
...
```
  ...
  4: 0x034A [0x1D] PRINT_EVENT_MESSAGE(message_id=8459*)
...
```
  ...
  4: 0x036E [0x1D] PRINT_EVENT_MESSAGE(message_id=8543*)
  ...
  6: 0x0372 [0x1D] PRINT_EVENT_MESSAGE(message_id=8544*)
