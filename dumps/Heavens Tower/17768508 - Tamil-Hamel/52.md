...
```
  ...
  3: 0x0021 [0x1D] PRINT_EVENT_MESSAGE(message_id=19*)
    → "On the highest-driest-bo-biased floor of this tower, you will find the Planetarium and the Star Spring. There, one can see all the stars-jars-bo-bars in the heavens.\u007F1\u0000\u0007"
  4: 0x0024 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0025 [0x1D] PRINT_EVENT_MESSAGE(message_id=20*)
    → "The Star Sibyl uses the power-cower-toe-tower of those stars in the Star Spring to see all the way into the future.\u007F1\u0000\u0007"
