...
- **7139**: You do not have enough gil.
- **8603**: The minstrel of melodies is my name, For a mere $6 gil I'll recall your past. Your stories of love, anger, triumph, and shame, The river of memories runs deep and vast.
- **8604**: The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last.
- **8606**: Which memory will you have recalled? [Nothing./Windurst Missions./Foreign Missions./Windurst Quests./Foreign Quests./Additional Stories.]
- **8607**: Which memory will you have recalled? [Nothing./The Three Kingdoms(pt.1)./The Three Kingdoms(pt.2)./The Three Kingdoms(pt.3)./To Each His Own Right(pt.1)./To Each His Own Right(pt.2)./Written in the Stars./A New Journey./The Final Seal(pt.1)./The Final Seal(pt.2)./The Shadow Awaits(pt.1)./The Shadow Awaits(pt.2)./The Shadow Awaits(pt.3)./Saintly Invitation(pt.1)./Saintly Invitation(pt.2)./The Jester Who'd Be King./Doll of the Dead(pt.1)./Doll of the Dead(pt.2)./Moon Reading(pt.1)./Moon Reading(pt.2)./Moon Reading(pt.3)./Moon Reading(pt.4).]
- **8608**: Which memory will you have recalled? [Nothing./Journey Abroad(pt.1)./Journey Abroad(pt.2)./The Emissary(pt.1)./The Emissary(pt.2).]
- **8609**: Which memory will you have recalled? [Nothing./The Three Magi./Recollections(pt.1)./Recollections(pt.2)./Recollections(pt.3)./The Root of the Problem(pt.1)./The Root of the Problem(pt.2)./The Root of the Problem(pt.3)./136th C.E.A.(pt.1)./136th C.E.A.(pt.2)./Conflict./Trust: Windurst(pt.1)./Trust: Windurst(pt.2).]
- **8610**: Which memory will you have recalled? [Nothing./Conflict (San d'Oria)./Conflict (Bastok)./Waking the Colossus(pt.1)./Waking the Colossus(pt.2)./Trust: Semih Lafihna.]
- **8611**: Which memory will you have recalled? [Nothing./Kupipi's Dilemma(pt.1)./Kupipi's Dilemma(pt.2)./Kupipi's Dilemma(pt.3)./The Cardians' Duty(pt.1)./The Cardians' Duty(pt.2)./Zhuu Buxu's Gambit./The Doll Whisperer.]
- **8612**: Which memory will you have recalled? [Nothing.]
...
```
  ...
  3: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=8604*)
 ...
 21: 0x0088 [0x1D] PRINT_EVENT_MESSAGE(message_id=8604*)
    → "The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last."
 22: 0x008B [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x008C [0x21] END_EVENT
 24: 0x008D [0x00] END_REQSTACK()
 25: 0x008E [0x1D] PRINT_EVENT_MESSAGE(message_id=8603*)
 ...
 39: 0x00D4 [0x24] CREATE_DIALOG(message_id=8606*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00E4:
 42: 0x00E4 [0x24] CREATE_DIALOG(message_id=8607*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_0113:
 50: 0x0113 [0x24] CREATE_DIALOG(message_id=8608*, default_option=0*, option_flags=Work_Zone[3])
...
SUBROUTINE_0142:
 58: 0x0142 [0x24] CREATE_DIALOG(message_id=8609*, default_option=0*, option_flags=Work_Zone[4])
...
SUBROUTINE_0171:
 66: 0x0171 [0x24] CREATE_DIALOG(message_id=8610*, default_option=0*, option_flags=Work_Zone[5])
...
SUBROUTINE_01A0:
 74: 0x01A0 [0x24] CREATE_DIALOG(message_id=8611*, default_option=0*, option_flags=Work_Zone[6])
...
SUBROUTINE_01CF:
 82: 0x01CF [0x24] CREATE_DIALOG(message_id=8612*, default_option=0*, option_flags=Work_Zone[7])
