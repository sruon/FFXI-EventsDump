...
- **61**: Cool! So this is the Star Spring!
- **62**: Huh. I don't see any stars... What? Is it cloudy out?
...
```
  ...
  3: 0x0021 [0x1D] PRINT_EVENT_MESSAGE(message_id=61*)
    → "Cool! So this is the Star Spring!"
  4: 0x0024 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0025 [0x1D] PRINT_EVENT_MESSAGE(message_id=62*)
    → "Huh. I don't see any stars... What? Is it cloudy out?"
