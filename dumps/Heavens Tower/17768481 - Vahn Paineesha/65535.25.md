...
```
  ...
  6: 0x0185 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=57*, entity1=EventEntity, entity2=EventEntity, action="mhi0")
  7: 0x0194 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="mhi0")
