...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0680:                          29 08 1D 20 0F 01 01 1D          ).. ....
0690: 72 80 23 29 08 1D 20 0F  01 02 00                 r.#).. ....     
```
...
```
  ...
  1: 0x068F [0x1D] PRINT_EVENT_MESSAGE(message_id=8191*)
    → "I now declare your crimes to be forgiven, and grant you your freedom.\u007F1\u0000\u0007"
