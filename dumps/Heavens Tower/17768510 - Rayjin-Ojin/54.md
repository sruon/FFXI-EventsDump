...
```
  ...
  3: 0x0021 [0x1D] PRINT_EVENT_MESSAGE(message_id=23*)
    → "Somebody somewhere said something about rubbing the Great Star Tree's roots for good luck. Well, that's just rubbing-rubbish!\u007F1\u0000\u0007"
  4: 0x0024 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0025 [0x1D] PRINT_EVENT_MESSAGE(message_id=24*)
    → "You don't have to touch, feel, stroke, or pet anything to have the tree help your dreams travel to the heavens.\u007F1\u0000\u0007"
