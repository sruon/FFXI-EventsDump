...
| [52](#event-52)          | 0x001A       |     19 |             10 |
| [455](#event-455)        | 0x002D       |      1 |              1 |
| [462](#event-462)        | 0x002E       |      1 |              1 |
...
- **19**: On the highest-driest-bo-biased floor of this tower, you will find the Planetarium and the Star Spring. There, one can see all the stars-jars-bo-bars in the heavens.
- **20**: The Star Sibyl uses the power-cower-toe-tower of those stars in the Star Spring to see all the way into the future.
...
```
  ...
  3: 0x0021 [0x1D] PRINT_EVENT_MESSAGE(message_id=19*)
    → "On the highest-driest-bo-biased floor of this tower, you will find the Planetarium and the Star Spring. There, one can see all the stars-jars-bo-bars in the heavens."
  4: 0x0024 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0025 [0x1D] PRINT_EVENT_MESSAGE(message_id=20*)
    → "The Star Sibyl uses the power-cower-toe-tower of those stars in the Star Spring to see all the way into the future."
