...
- **8159**: Do you remember the bearer of darkness that appearrred here?
- **8160**: Someone came here claiming to have seen it in another country. What on Vana'diel is that thing?
- **8315**: I rrrecognized the stench that the bearer of darkness exuded...
- **8316**: It was the smell of the dead... That putrid miasma has no place in this world.
- **8322**: Rescuing the Star Sibyl will be best accomplished by a small, well-coordinated team.
- **8323**: The Cardians might decide to use the Star Sibyl as a shield, though. Those puppets probably have no idea of how much a person's life is worth.
- **8449**: Why do the Yagudo have to stick their beaks in at a time like this!?
- **8450**: Without the Star Sibyl here, we can't send an apology or even a declaration of war if it comes to that!
- **8541**: You know how the Yagudo have become so fixated on the magic towerrrs in Sarutabaruta? It must have something to do with the massive destruction wrrrought upon them by the summoning twenty years ago.
- **8542**: The Yagudo have lived in this region for far longer than the Mithra. They probably have as much knowledge about the towers as the Tarutaru.
...
```
  ...
  4: 0x030B [0x1D] PRINT_EVENT_MESSAGE(message_id=8322*)
  ...
  6: 0x030F [0x1D] PRINT_EVENT_MESSAGE(message_id=8323*)
...
```
  ...
  4: 0x035B [0x1D] PRINT_EVENT_MESSAGE(message_id=8541*)
  ...
  6: 0x035F [0x1D] PRINT_EVENT_MESSAGE(message_id=8542*)
