...
```
  ...
  4: 0x00E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=466*)
    → "At the last Star Reading, the Star Sibyl foresaw everlasting, lasting peace for Windurst, but I don't know if we can call our current situation peaceful.\u007F1\u0000\u0007"
  5: 0x00EB [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x00EC [0x1D] PRINT_EVENT_MESSAGE(message_id=467*)
    → "Could it be the Star Sibyl was...?\u007F1\u0000\u0007"
