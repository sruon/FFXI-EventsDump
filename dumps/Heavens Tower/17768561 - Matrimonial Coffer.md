...
- **9120**: An assortment of wedding attire and wedding rings are available for purchase.
- **9121**: What will you buy? [[Wedding dress/Benedight] set: $1 gil./$2: $3 gil./Nothing.]
- **9122**: This set includes a benedight coat and a pair of benedight hose. Price: $1 gil.
- **9123**: This set includes a bridal corsage, a wedding dress, a pair of wedding hose, and a pair of wedding boots. Price: $1 gil.
- **9124**: Confirm purchase? (Current gil: $4) [Yes./Cancel.]
...
SUBROUTINE_0059:
 23: 0x0059 [0x24] CREATE_DIALOG(message_id=9124*, default_option=1*, option_flags=0*)
