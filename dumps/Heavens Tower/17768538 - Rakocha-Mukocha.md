...
- **7976**: I've a re-port sta-ting that a dread dra-gon is ham-per-ing a group of red ma-ges' pro-gress through the gate-way.
- **7990**: Hey, is there a-ny way of shut-ting this doll up?
...
```
  0: 0x019D [0x1D] PRINT_EVENT_MESSAGE(message_id=7976*)
...
```
  ...
  1: 0x01A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7990*)
