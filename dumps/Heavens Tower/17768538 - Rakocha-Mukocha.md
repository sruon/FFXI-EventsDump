...
- **7977**: I've a re-port sta-ting that a dread dra-gon is ham-per-ing a group of red ma-ges' pro-gress through the gate-way.
- **7991**: Hey, is there a-ny way of shut-ting this doll up?
...
```
  0: 0x019D [0x1D] PRINT_EVENT_MESSAGE(message_id=7977*)
...
```
  ...
  1: 0x01A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7991*)
