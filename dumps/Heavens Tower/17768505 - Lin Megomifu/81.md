...
```
  ...
  3: 0x000D [0x1D] PRINT_EVENT_MESSAGE(message_id=76*)
    → "Whoa... It's busting strrraight through the ceiling!\u007F1\u0000\u0007"
  4: 0x0010 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0011 [0x1D] PRINT_EVENT_MESSAGE(message_id=77*)
    → "I can see what my mom meant when she told me to grow up big and strong like the Grrreat Star Tree! You can feel the powerrr!\u007F1\u0000\u0007"
