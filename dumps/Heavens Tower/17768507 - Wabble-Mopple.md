...
- **18**: We are inside the Great Star Tree--the protector of Windurst and the bridge between the heavens and Vana'diel.
...
```
  ...
  3: 0x0021 [0x1D] PRINT_EVENT_MESSAGE(message_id=18*)
    → "We are inside the Great Star Tree--the protector of Windurst and the bridge between the heavens and Vana'diel."
