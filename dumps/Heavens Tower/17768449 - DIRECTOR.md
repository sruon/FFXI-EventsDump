...
- **7277**: Abracadabra!
- **7278**: Oh no! Your Adventurers' certificate vanished!
- **7279**: Counting $0 people!
- **7280**: Your rank is now $7!!
- **7298**: ex [u6-1:v$P12<$P11O/u6-2:v$P12<$P11O/u7-1:v$P12<$P11O/u7-2:v$P12<$P11O/u8-1:v$P12<$P11O/u8-2:v$P12<$P11O/u9-1:v$P12<$P11O/u9-2:v$P12<$P11O/u9-2:$6816365]
- **7299**: $P122$8n [@$n$P16{n/$3~$3b$3V$3/$3$12n/$3][$3$3t$3$3On]
- **7300**: U_START_WS_QSM$0@U_END_WS_QSM$1 U_SPECIAL_FLAGM$2@U_SPECIAL_FLAG2M$3 U_SPECIAL_BIT(2)M$4$330317 U_RANK_LEVEL_WSM$6@U_FAME_WS_COMMONM$7
- **7301**: U_MS_STARTM$0@U_END_WS_MSM$1 U_RANK_POINT_WSM$2@U_MS_COUNTERM$3 U_WS_FLAGSM$4@U_SPECIAL_FLAGM$5 U_RANK_LEVEL_WSM$6@U_FAME_WS_COMMONM$7
- **7302**: Z_ipc_id01M$0@Z_ipc_id02M$1 Z_ipc_id03M$2@Z_ipc_id04M$3 Z_ipc_id05M$4@Z_ipc_id06M$5 Z_ipc_id07M$6@Z_ANG_time01M$7
- **7328**: $7p$hI$P13|j\\5=><Player>
...
```
  0: 0x009E [0x24] CREATE_DIALOG(message_id=7298*, default_option=0*, option_flags=0*)
...
```
 ...
 12: 0x0189 [0x1D] PRINT_EVENT_MESSAGE(message_id=7278*)
...
```
 ...
 15: 0x01E9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7278*)
    → "Oh no! Your Adventurers' certificate vanished!"
...
```
  0: 0x01F9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7328*)
...
```
  ...
  3: 0x0211 [0x1D] PRINT_EVENT_MESSAGE(message_id=7277*)
    → "Abracadabra!"
 ...
 20: 0x0265 [0x1D] PRINT_EVENT_MESSAGE(message_id=7278*)
    → "Oh no! Your Adventurers' certificate vanished!"
...
```
  0: 0x0275 [0x24] CREATE_DIALOG(message_id=7299*, default_option=0*, option_flags=0*)
...
```
  0: 0x02B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7300*)
...
```
  0: 0x02B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7301*)
...
```
  0: 0x02C1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7302*)
...
```
  0: 0x02C9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7279*)
    → "Counting $0 people!"
...
```
  ...
  1: 0x02E3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7280*)
    → "Your rank is now $7!!"
