...
- **8124**: Now that the Shadow Lord, King of the beastmen, has been defeated, it is time for the people of Vana'diel to rrrise again. To keep ahead of other nations, we must first stabilize our own country...
- **8125**: Leave the prrroblems of Windurst in the hands of the Sibyl Guards. You need to be keeping an eye on the progress of our rrrival countries. It is not unthinkable that certain elements could be plotting against us.
- **8132**: After the defeat of the Shadow Lord, I thought there would be a change in attitude from the Yagudo. However, Castle Oztroja continues to maintain its silence.
- **8133**: This silence is verrry unsettling. I wonder if they still have another card left to play?
- **8152**: Proceed to the door in the back.
- **8159**: The Shadow Lord has fallen, but the beastmen are still stirring.
- **8160**: They will embrace a new leader and turn their predatory gaze towards us once more. We must keep our skills sharp for the next uprising.
- **8307**: I, I feel so useless...
- **8308**: Our best attacks merely rrrebounded off that thing. So this is what it feels like to be completely outmatched...
- **8327**: For some reason or another, that Joker Cardian and the bearer of darkness seem to share the same kind of aura.
- **8328**: I can't really explain it very well, but I think Semih Lafihna underrrstands what I mean.
- **8453**: Semih Lafihna awaits you in the Vestal Chamber.
- **8455**: Let us join our strength and change the flow of fate.
- **8456**: A need to fight comes from one's own weakness. A weakness born from lack of rrresolve, impatience, and fear. We must rrrise above all these to grasp a higher power.
- **8545**: Semih Lafihna and Chieftainness Perih Vashai have been holding talks on what to do concerning the Yagudo.
- **8546**: Things probably won't change for a while yet. A prrrotracted battle is the same as a defeat. First we need to increase our military strength.
...
```
  ...
  3: 0x024A [0x1D] PRINT_EVENT_MESSAGE(message_id=8124*)
  ...
  5: 0x024E [0x1D] PRINT_EVENT_MESSAGE(message_id=8125*)
...
```
  ...
  3: 0x025D [0x1D] PRINT_EVENT_MESSAGE(message_id=8132*)
  ...
  5: 0x0261 [0x1D] PRINT_EVENT_MESSAGE(message_id=8133*)
...
```
  ...
  4: 0x0277 [0x1D] PRINT_EVENT_MESSAGE(message_id=8152*)
    → "Proceed to the door in the back."
...
```
  ...
  3: 0x02A0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8307*)
    → "I, I feel so useless..."
  4: 0x02A3 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x02A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=8308*)
...
```
  ...
  3: 0x02B3 [0x1D] PRINT_EVENT_MESSAGE(message_id=8327*)
  ...
  5: 0x02B7 [0x1D] PRINT_EVENT_MESSAGE(message_id=8328*)
...
```
  ...
  4: 0x02CD [0x1D] PRINT_EVENT_MESSAGE(message_id=8453*)
...
```
  ...
  3: 0x02E3 [0x1D] PRINT_EVENT_MESSAGE(message_id=8455*)
    → "Let us join our strength and change the flow of fate."
  4: 0x02E6 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x02E7 [0x1D] PRINT_EVENT_MESSAGE(message_id=8456*)
...
```
  ...
  3: 0x02F6 [0x1D] PRINT_EVENT_MESSAGE(message_id=8545*)
  ...
  5: 0x02FA [0x1D] PRINT_EVENT_MESSAGE(message_id=8546*)
