...
```
  ...
  1: 0x0127 [0x45] LOAD_SCHEDULED_TASK(work_offset1=77*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s131", work_offset2=0*)
  2: 0x0138 [0x5B] LOAD_EXT_SCHEDULER(work_offset=501*, entity1=EventEntity, entity2=EventEntity, action="hou1")
  3: 0x0147 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="hou1")
