...
```
  ...
  1: 0x03B5 [0x24] CREATE_DIALOG(message_id=7444*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0420 [0x24] CREATE_DIALOG(message_id=7444*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0468 [0x24] CREATE_DIALOG(message_id=7444*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x04B7 [0x24] CREATE_DIALOG(message_id=7444*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x04E5 [0x24] CREATE_DIALOG(message_id=7444*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0534 [0x24] CREATE_DIALOG(message_id=7446*, default_option=1*, option_flags=0*)
