...
| [335](#event-335)     | 0x0001       |     83 |             18 |
| [334](#event-334)     | 0x0054       |    476 |             93 |
...
- **6846**: Greetings adventurer! I'm so glad you've come, kupo! To celebrate the safe recovery of all eleven of King Kupofried's mog tablets, we're offering a limited-time teleportation service for the low, low price of $0 gil! What do you say?
- **6847**: Teleport to where? (Cost: $0 gil.) [Nowhere./San d'Oria./Bastok./Windurst./Selbina./Mhaura.]
- **6848**: Your wish is my command, kupo! For a small fee of $0 gil, that is...
- **6849**: Safe travels, kupo!
- **6850**: Looks like you're light on funds, kupo... Sorry!
- **6851**: What's this? You're still new to this land? I'm afraid you're not yet strong enough to handle our potent moogle magic! Just forget I said anything, kupo!
...
```
  ...
  6: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=6846*)
 ...
 11: 0x0038 [0x1D] PRINT_EVENT_MESSAGE(message_id=6851*)
...
0180: 6F 62 30 1D 0D 80 73 0E  80 86 90 0F 01 F0 FF FF  ob0...s.........
0190: 7F 1C 0F 80 45 10 80 F0  FF FF 7F F0 FF FF 7F 66  ....E..........f
01A0: 64 6F 31 06 80 1C 11 80  21 00 2C F8 FF FF 7F F8  do1.....!.,.....
01B0: FF FF 7F 67 61 6B 30 03  02 10 02 80 27 10 86 90  ...gak0.....'...
01C0: 0F 01 03 1D 12 80 23 2A  10 86 90 0F 01 2C F8 FF  ......#*.....,..
...
```
  ...
  9: 0x007B [0x1D] PRINT_EVENT_MESSAGE(message_id=6846*)
    → "Greetings adventurer! I'm so glad you've come, kupo! To celebrate the safe recovery of all eleven of King Kupofried's mog tablets, we're offering a limited-time teleportation service for the low, low price of $0 gil! What do you say?"
 ...
 12: 0x008C [0x24] CREATE_DIALOG(message_id=6847*, default_option=0*, option_flags=ExtData[1]->WorkLocal[2])
...
SUBROUTINE_0146:
 ...
 19: 0x0158 [0x1D] PRINT_EVENT_MESSAGE(message_id=6848*)
 ...
 24: 0x0183 [0x1D] PRINT_EVENT_MESSAGE(message_id=6849*)
    → "Safe travels, kupo!"
 25: 0x0186 [0x73] mgtest (ID: 17797254/0x010F9086) casts magic 122* on LocalPlayer
...
SUBROUTINE_01AA:
 ...
 33: 0x01BC [0x27] REQ_SET(priority=0x10, entity_id=mgtest (ID: 17797254/0x010F9086), tag_num=0x03)
 34: 0x01C3 [0x1D] PRINT_EVENT_MESSAGE(message_id=6850*)
    → "Looks like you're light on funds, kupo... Sorry!"
 35: 0x01C6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 36: 0x01C7 [0x2A] GET_REQ_LEVEL(level=16, entity_id=mgtest (ID: 17797254/0x010F9086))
