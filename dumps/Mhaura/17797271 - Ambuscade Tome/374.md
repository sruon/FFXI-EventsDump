...
```
 ...
 12: 0x003A [0x24] CREATE_DIALOG(message_id=8090*, default_option=0*, option_flags=0x07)
...
SUBROUTINE_009C:
 31: 0x009C [0x03] Work_Zone[1] = 1073741824*
 32: 0x00A1 [0x21] END_EVENT
 33: 0x00A2 [0x00] END_REQSTACK()

SUBROUTINE_00A3:
 34: 0x00A3 [0x03] Work_Zone_1700[2] = ExtData[1]->WorkLocal[4]
 35: 0x00A8 [0x03] Work_Zone_1700[3] = ExtData[1]->WorkLocal[4]
 36: 0x00AD [0x03] Work_Zone_1700[4] = ExtData[1]->WorkLocal[4]
 37: 0x00B2 [0x03] Work_Zone_1700[5] = ExtData[1]->WorkLocal[4]
 38: 0x00B7 [0x07] Work_Zone_1700[2] += 15*
 39: 0x00BC [0x07] Work_Zone_1700[3] += 10*
 40: 0x00C1 [0x07] Work_Zone_1700[4] += 5*
 41: 0x00C6 [0x07] Work_Zone_1700[5] += 0*
 42: 0x00CB [0x02] IF !(ExtData[1]->WorkLocal[3] == 0*) GOTO 0x0130
 43: 0x00D3 [0x24] CREATE_DIALOG(message_id=8091*, default_option=0*, option_flags=0*)
...
\u000C)\u0007Very easy. (Level: 
 ...
 44: 0x00DA [0x25] WAIT_DIALOG_SELECT()
 45: 0x00DB [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x00EB
 46: 0x00E3 [0x03] ExtData[1]->WorkLocal[3] = 1*
 47: 0x00E8 [0x01] GOTO 0x0130

SUBROUTINE_00EB:
 48: 0x00EB [0x02] IF !(Work_Zone[0] == 2*) GOTO 0x00FB
 49: 0x00F3 [0x03] ExtData[1]->WorkLocal[3] = 2*
 50: 0x00F8 [0x01] GOTO 0x0130

SUBROUTINE_00FB:
 51: 0x00FB [0x02] IF !(Work_Zone[0] == 3*) GOTO 0x010B
 52: 0x0103 [0x03] ExtData[1]->WorkLocal[3] = 3*
 53: 0x0108 [0x01] GOTO 0x0130

SUBROUTINE_010B:
 54: 0x010B [0x02] IF !(Work_Zone[0] == 4*) GOTO 0x011B
 55: 0x0113 [0x03] ExtData[1]->WorkLocal[3] = 4*
 56: 0x0118 [0x01] GOTO 0x0130

SUBROUTINE_011B:
 57: 0x011B [0x02] IF !(Work_Zone[0] == 5*) GOTO 0x012B
 58: 0x0123 [0x03] ExtData[1]->WorkLocal[3] = 5*
 59: 0x0128 [0x01] GOTO 0x0130

SUBROUTINE_012B:
 60: 0x012B [0x03] ExtData[1]->WorkLocal[2] = 0*
 61: 0x0130 [0x03] ExtData[1]->WorkLocal[1] = ExtData[1]->WorkLocal[2]
 62: 0x0135 [0x0C] ExtData[1]->WorkLocal[1]--
 63: 0x0138 [0x14] ExtData[1]->WorkLocal[1] *= 5*
 64: 0x013D [0x07] ExtData[1]->WorkLocal[1] += ExtData[1]->WorkLocal[3]
 65: 0x0142 [0x02] IF !(ExtData[1]->WorkLocal[1] < 1*) GOTO 0x0155
 66: 0x014A [0x02] IF !(ExtData[1]->WorkLocal[1] > 11*) GOTO 0x0155
 67: 0x0152 [0x06] ExtData[1]->WorkLocal[8] = 0
 68: 0x0155 [0x01] GOTO 0x001E

SUBROUTINE_0158:
 69: 0x0158 [0x03] Work_Zone[6] = ExtData[1]->WorkLocal[11]
 70: 0x015D [0x48] [System] [8106*]:
    → "You will be able to call forth up to 
\u0004 alter ego\u007F\u0012\u0004[/s] given the current number of players in your party.\u007F1\u0000\u0007"
 71: 0x0160 [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[1]
 72: 0x0165 [0x48] [System] [8111*]:
 ...
 73: 0x0168 [0x23] WAIT_FOR_DIALOG_INTERACTION
 74: 0x0169 [0x03] Work_Zone[3] = 0*
 75: 0x016E [0x24] CREATE_DIALOG(message_id=8093*, default_option=0*, option_flags=0*)
    → "\u000C\u0001[Apply to proceed/Proceed]?\u0007\u000BMost certainly!\u0007Not yet.\u007F1\u0000\u0007"
 76: 0x0175 [0x25] WAIT_DIALOG_SELECT()
 77: 0x0176 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x019E
 78: 0x017E [0x03] Work_Zone[1] = 0*
 79: 0x0183 [0x40] SET_BIT_WORK_RANGE(start_bit=0*, end_bit=11*, target=Work_Zone[1], source=ExtData[1]->WorkLocal[1])
 80: 0x018C [0x43] SEND_EVENT_UPDATE: Send pending tag to server (packet 0x005B)
 81: 0x018E [0x43] SEND_EVENT_UPDATE: Check pending flag (skip if not pending)
 82: 0x0190 [0x02] IF !(Work_Zone[9] == 0*) GOTO 0x019B
 83: 0x0198 [0x01] GOTO 0x0158

SUBROUTINE_019B:
 84: 0x019B [0x01] GOTO 0x01B2

SUBROUTINE_019E:
 85: 0x019E [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[1]
 86: 0x01A3 [0x03] Work_Zone[3] = 0*
 87: 0x01A8 [0x48] [System] [8095*]:
 ...
 88: 0x01AB [0x03] Work_Zone[1] = 1073741824*
 89: 0x01B0 [0x21] END_EVENT
 90: 0x01B1 [0x00] END_REQSTACK()

SUBROUTINE_01B2:
 91: 0x01B2 [0x21] END_EVENT
 92: 0x01B3 [0x00] END_REQSTACK()
```
