...
- **7078**: Fishing is an art... I have nothing to say to one who has never held a fishing rod in his life.
- **7079**: Ah, I see you have dabbled in the art of fishing...
- **7080**: But you still have a long way to go. Come back when you've managed to catch some bigger game.
- **7081**: Tell me...do you remember all the catches you've made until now? Do you wish to know?
- **7082**: Do you want to know your fishing history? [Yes./No.]
- **7083**: Of course you do. As would all practitioners of the art.
- **7084**: But no one can keep track of all their catches. Except for me. I can even tell you of your past achievements...for a price.
- **7085**: I only ask you to bring me $0. A small price to pay for such information, isn't it?
- **7086**: You've brought it. Very well, I will tell you.
- **7087**: You've cast your line $1 time[/s] and made $2 catch[/es].
- **7088**: The biggest fish you caught by size was $4 measuring $3 [ilm/ilms], and the biggest fish you caught by weight was $6 weighing $5 [ponz/ponzes].
- **7089**: If you want me to tell you again, then just come see me. I'll be waiting here.
- **7090**: If you want me to tell you about your past catches, bring me $0.
- **7091**: I see... You may not want me to do so now, but you will eventually. You know where to find me.
- **7092**: Back, I see. what do you want to know?
- **7093**: What would you like to know about? [Types of fish caught./Catching fish./None of the above.]
- **7095**: Debug menu! [Check flags./Restore fish count./Reset flags./Nope.]
...
```
  ...
  3: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=7078*)
...
```
  ...
  3: 0x0015 [0x1D] PRINT_EVENT_MESSAGE(message_id=7079*)
    → "Ah, I see you have dabbled in the art of fishing..."
  4: 0x0018 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0019 [0x1D] PRINT_EVENT_MESSAGE(message_id=7080*)
...
```
  ...
  3: 0x0026 [0x1D] PRINT_EVENT_MESSAGE(message_id=7079*)
    → "Ah, I see you have dabbled in the art of fishing..."
  4: 0x0029 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x002A [0x1D] PRINT_EVENT_MESSAGE(message_id=7081*)
  ...
  7: 0x002E [0x24] CREATE_DIALOG(message_id=7082*, default_option=0*, option_flags=0*)
 ...
 12: 0x0041 [0x1D] PRINT_EVENT_MESSAGE(message_id=7083*)
    → "Of course you do. As would all practitioners of the art."
 13: 0x0044 [0x23] WAIT_FOR_DIALOG_INTERACTION
 14: 0x0045 [0x1D] PRINT_EVENT_MESSAGE(message_id=7084*)
 ...
 16: 0x0049 [0x1D] PRINT_EVENT_MESSAGE(message_id=7085*)
 ...
 21: 0x005D [0x1D] PRINT_EVENT_MESSAGE(message_id=7091*)
...
```
  ...
  5: 0x0070 [0x1D] PRINT_EVENT_MESSAGE(message_id=7086*)
    → "You've brought it. Very well, I will tell you."
  6: 0x0073 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0074 [0x1D] PRINT_EVENT_MESSAGE(message_id=7087*)
 ...
 11: 0x0088 [0x1D] PRINT_EVENT_MESSAGE(message_id=7088*)
 ...
 13: 0x008C [0x1D] PRINT_EVENT_MESSAGE(message_id=7089*)
...
```
  ...
  5: 0x00AD [0x1D] PRINT_EVENT_MESSAGE(message_id=7086*)
    → "You've brought it. Very well, I will tell you."
  6: 0x00B0 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x00B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7087*)
    → "You've cast your line $1 time[/s] and made $2 catch[/es]."
  8: 0x00B4 [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x00B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7089*)
    → "If you want me to tell you again, then just come see me. I'll be waiting here."
...
```
  ...
  3: 0x00D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7090*)
...
```
  ...
  5: 0x00EA [0x1D] PRINT_EVENT_MESSAGE(message_id=7092*)
  ...
  8: 0x00F6 [0x24] CREATE_DIALOG(message_id=7093*, default_option=0*, option_flags=0*)
 ...
 17: 0x0122 [0x1D] PRINT_EVENT_MESSAGE(message_id=7089*)
    → "If you want me to tell you again, then just come see me. I'll be waiting here."
...
```
  ...
  5: 0x014F [0x24] CREATE_DIALOG(message_id=7095*, default_option=0*, option_flags=0*)
