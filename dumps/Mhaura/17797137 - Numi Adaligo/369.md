...
SUBROUTINE_0106:
  ...
  4: 0x0107 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  5: 0x0118 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
...
SUBROUTINE_0180:
 ...
 30: 0x01C6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s006", work_offset2=0*)
 31: 0x01D7 [0x01] GOTO 0x0207

SUBROUTINE_01DA:
 32: 0x01DA [0x02] IF !(LocalPlayer->Race == 6*) GOTO 0x01F6
 33: 0x01E2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s006", work_offset2=0*)
 34: 0x01F3 [0x01] GOTO 0x0207

SUBROUTINE_01F6:
 35: 0x01F6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s004", work_offset2=0*)
 36: 0x0207 [0x1C] WAIT(15* ticks)
 37: 0x020A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 38: 0x021B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=Numi Adaligo (ID: 17797137/0x010F9011), entity2=Numi Adaligo (ID: 17797137/0x010F9011), action="tlk0")
 ...
 41: 0x0232 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=Numi Adaligo (ID: 17797137/0x010F9011), entity2=Numi Adaligo (ID: 17797137/0x010F9011), action="tlk2")
 ...
 48: 0x0276 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s007", work_offset2=0*)
 49: 0x0287 [0x01] GOTO 0x02B7

SUBROUTINE_028A:
 50: 0x028A [0x02] IF !(LocalPlayer->Race == 6*) GOTO 0x02A6
 51: 0x0292 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s007", work_offset2=0*)
 52: 0x02A3 [0x01] GOTO 0x02B7

SUBROUTINE_02A6:
 53: 0x02A6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s005", work_offset2=0*)
 54: 0x02B7 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=Numi Adaligo (ID: 17797137/0x010F9011), entity2=Numi Adaligo (ID: 17797137/0x010F9011), action="tlk0")
 ...
 57: 0x02CE [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=Numi Adaligo (ID: 17797137/0x010F9011), entity2=Numi Adaligo (ID: 17797137/0x010F9011), action="tlk2")
 ...
 62: 0x0305 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s008", work_offset2=0*)
...
SUBROUTINE_0349:
 ...
 74: 0x0360 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Ekokoko (ID: 17797136/0x010F9010), entity2=Ekokoko (ID: 17797136/0x010F9010), action="tlk0")
 ...
 78: 0x0386 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s009", work_offset2=0*)
 ...
 81: 0x039F [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Ekokoko (ID: 17797136/0x010F9010), entity2=Ekokoko (ID: 17797136/0x010F9010), action="tlk1")
 82: 0x03AE [0x1C] WAIT(60* ticks)
 83: 0x03B1 [0x81] SET_ENTITY_BLINKING(blink_flag=0x00, entity=Ekokoko (ID: 17797136/0x010F9010))
 84: 0x03B7 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=Ekokoko (ID: 17797136/0x010F9010), entity2=Ekokoko (ID: 17797136/0x010F9010), action="thk1")
 ...
 88: 0x03DD [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s010", work_offset2=0*)
 89: 0x03EE [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=Ekokoko (ID: 17797136/0x010F9010), entity2=Ekokoko (ID: 17797136/0x010F9010), action="thk2")
 ...
 93: 0x040B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Ekokoko (ID: 17797136/0x010F9010), entity2=Ekokoko (ID: 17797136/0x010F9010), action="tlk0")
 ...
 99: 0x042F [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Ekokoko (ID: 17797136/0x010F9010), entity2=Ekokoko (ID: 17797136/0x010F9010), action="tlk1")
100: 0x043E [0x52] END_LOAD_SCHEDULER: End scheduler "s010" with entities [EventEntity, EventEntity], work=760*
101: 0x044D [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s011", work_offset2=0*)
102: 0x045E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=Numi Adaligo (ID: 17797137/0x010F9011), entity2=Numi Adaligo (ID: 17797137/0x010F9011), action="tlk0")
...
105: 0x0475 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=Numi Adaligo (ID: 17797137/0x010F9011), entity2=Numi Adaligo (ID: 17797137/0x010F9011), action="tlk2")
106: 0x0484 [0x52] END_LOAD_SCHEDULER: End scheduler "s011" with entities [EventEntity, EventEntity], work=760*
107: 0x0493 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s012", work_offset2=0*)
108: 0x04A4 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Ekokoko (ID: 17797136/0x010F9010), entity2=Ekokoko (ID: 17797136/0x010F9010), action="tlk0")
...
115: 0x04D7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s013", work_offset2=0*)
...
121: 0x04FD [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Ekokoko (ID: 17797136/0x010F9010), entity2=Ekokoko (ID: 17797136/0x010F9010), action="tlk1")
122: 0x050C [0x52] END_LOAD_SCHEDULER: End scheduler "s013" with entities [EventEntity, EventEntity], work=760*
123: 0x051B [0x45] LOAD_SCHEDULED_TASK(work_offset1=760*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s014", work_offset2=0*)
124: 0x052C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=Numi Adaligo (ID: 17797137/0x010F9011), entity2=Numi Adaligo (ID: 17797137/0x010F9011), action="tlk0")
125: 0x053B [0x2B] Numi Adaligo (ID: 17797137/0x010F9011) [8056*]:
    → "Come back soon!\u007F1\u0000\u0007"
126: 0x0542 [0x23] WAIT_FOR_DIALOG_INTERACTION
127: 0x0543 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
128: 0x0554 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
...
131: 0x0574 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi2", work_offset2=0*)
