...
```
  ...
  3: 0x0024 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 11: 0x004D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 14: 0x0060 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
 15: 0x006D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 16: 0x007E [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 17: 0x008D [0x46] CAMERA_CONTROL: Disable user control
 18: 0x008F [0x45] LOAD_SCHEDULED_TASK(work_offset1=149*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="se07", work_offset2=0*)
 19: 0x00A0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 20: 0x00B1 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 ...
 24: 0x00C5 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=52*, entity1=EventEntity, entity2=EventEntity, action="poi1")
 ...
 27: 0x00D8 [0x55] WAIT_LOAD_SCHEDULER(work_offset=149*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="se07")
 28: 0x00E7 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="poi1")
 29: 0x00F4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 30: 0x0105 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 31: 0x0114 [0x46] CAMERA_CONTROL: Restore default settings
 32: 0x0116 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=52*, entity1=EventEntity, entity2=EventEntity, action="poi2")
 33: 0x0125 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 34: 0x0134 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 35: 0x0145 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
 36: 0x0152 [0x03] Work_Zone[1] = 2*
 37: 0x0157 [0x01] GOTO 0x0181

SUBROUTINE_015A:
 38: 0x015A [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x0181
 39: 0x0162 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
