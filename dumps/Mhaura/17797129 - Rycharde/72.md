...
```
  ...
  3: 0x0125 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="tlk2")
  4: 0x0134 [0x1D] PRINT_EVENT_MESSAGE(message_id=6882*)
    → "How's it going? You're not done yet, huh? Well, you know where to find me. Good luck.\u007F1\u0000\u0007"
