...
```
  ...
  3: 0x0141 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
  4: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=6883*)
    → "Hey, wait a second! This isn't enough!\u0007Come back when you have two, okay?\u007F1\u0000\u0007"
