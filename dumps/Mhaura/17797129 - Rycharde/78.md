...
```
  ...
  3: 0x0248 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  4: 0x0257 [0x1D] PRINT_EVENT_MESSAGE(message_id=6892*)
    → "Go and get those things I asked for, quick! You have 
\u0000 \u007F\u0012\u0000[hour/hours] left!\u007F1\u0000\u0007"
