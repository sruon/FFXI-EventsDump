...
```
  ...
  3: 0x0024 [0x5B] LOAD_EXT_SCHEDULER(work_offset=60*, entity1=EventEntity, entity2=EventEntity, action="tl10")
  4: 0x0033 [0x1D] PRINT_EVENT_MESSAGE(message_id=7037*)
    → "\u007F\u0000\u0001\u0001\u0005#\u0002\u0000\u0000\u0000?\u0007Thanks, but I have enough for now.\u0007Come back later. I may need some more then.\u007F1\u0000\u0007"
