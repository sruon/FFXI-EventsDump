...
```
  ...
  1: 0x0006 [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=EventEntity, entity2=EventEntity, action="ehe0")
  2: 0x0015 [0x1D] PRINT_EVENT_MESSAGE(message_id=7153*)
    → "Say, did you know?\u007F1\u0000\u0007"
  3: 0x0018 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0019 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="ehe0")
  5: 0x0026 [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
  ...
  9: 0x0041 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
 10: 0x004E [0x5E] EventEntity goes idle (kills current action) (animation: "idl0")
 11: 0x0053 [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=Jikka-Abukka (ID: 17797151/0x010F901F), entity2=Jikka-Abukka (ID: 17797151/0x010F901F), action="kou0")
 ...
 14: 0x006A [0x5B] LOAD_EXT_SCHEDULER(work_offset=80*, entity1=Itzha Delavhitta (ID: 17797152/0x010F9020), entity2=Itzha Delavhitta (ID: 17797152/0x010F9020), action="thk1")
...
SUBROUTINE_0084:
 ...
 21: 0x0090 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
 ...
 24: 0x00A9 [0x5B] LOAD_EXT_SCHEDULER(work_offset=81*, entity1=Itzha Delavhitta (ID: 17797152/0x010F9020), entity2=Itzha Delavhitta (ID: 17797152/0x010F9020), action="hai0")
 25: 0x00B8 [0x53] WAIT_SCHEDULER_TASK(entity1=Itzha Delavhitta (ID: 17797152/0x010F9020), entity2=Itzha Delavhitta (ID: 17797152/0x010F9020), action_id="hai0")
 26: 0x00C5 [0x5B] LOAD_EXT_SCHEDULER(work_offset=80*, entity1=Itzha Delavhitta (ID: 17797152/0x010F9020), entity2=Itzha Delavhitta (ID: 17797152/0x010F9020), action="tlk0")
 27: 0x00D4 [0x23] WAIT_FOR_DIALOG_INTERACTION
 28: 0x00D5 [0x53] WAIT_SCHEDULER_TASK(entity1=Itzha Delavhitta (ID: 17797152/0x010F9020), entity2=Itzha Delavhitta (ID: 17797152/0x010F9020), action_id="tlk0")
 ...
 35: 0x0100 [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=EventEntity, entity2=EventEntity, action="kow0")
 36: 0x010F [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=Jikka-Abukka (ID: 17797151/0x010F901F), entity2=Jikka-Abukka (ID: 17797151/0x010F901F), action="kow0")
...
SUBROUTINE_0129:
 ...
 43: 0x0135 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
 44: 0x0142 [0x5E] EventEntity goes idle (kills current action) (animation: "idl0")
 45: 0x0147 [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=Jikka-Abukka (ID: 17797151/0x010F901F), entity2=Jikka-Abukka (ID: 17797151/0x010F901F), action="thk1")
 ...
 49: 0x0165 [0x5B] LOAD_EXT_SCHEDULER(work_offset=81*, entity1=Itzha Delavhitta (ID: 17797152/0x010F9020), entity2=Itzha Delavhitta (ID: 17797152/0x010F9020), action="hai0")
 50: 0x0174 [0x53] WAIT_SCHEDULER_TASK(entity1=Itzha Delavhitta (ID: 17797152/0x010F9020), entity2=Itzha Delavhitta (ID: 17797152/0x010F9020), action_id="hai0")
 51: 0x0181 [0x5B] LOAD_EXT_SCHEDULER(work_offset=80*, entity1=Itzha Delavhitta (ID: 17797152/0x010F9020), entity2=Itzha Delavhitta (ID: 17797152/0x010F9020), action="tlk0")
 52: 0x0190 [0x4A] EventEntity looks at Itzha Delavhitta (ID: 17797152/0x010F9020)
 53: 0x0199 [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=Jikka-Abukka (ID: 17797151/0x010F901F), entity2=Jikka-Abukka (ID: 17797151/0x010F901F), action="thk2")
 54: 0x01A8 [0x53] WAIT_SCHEDULER_TASK(entity1=Jikka-Abukka (ID: 17797151/0x010F901F), entity2=Jikka-Abukka (ID: 17797151/0x010F901F), action_id="thk2")
...
SUBROUTINE_01C2:
 ...
 61: 0x01CE [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
 62: 0x01DB [0x5E] EventEntity goes idle (kills current action) (animation: "idl0")
 63: 0x01E0 [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=Jikka-Abukka (ID: 17797151/0x010F901F), entity2=Jikka-Abukka (ID: 17797151/0x010F901F), action="kou0")
 ...
 66: 0x01F7 [0x5B] LOAD_EXT_SCHEDULER(work_offset=80*, entity1=Itzha Delavhitta (ID: 17797152/0x010F9020), entity2=Itzha Delavhitta (ID: 17797152/0x010F9020), action="thk1")
