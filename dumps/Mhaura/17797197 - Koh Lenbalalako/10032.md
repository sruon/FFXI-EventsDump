...
```
  ...
  1: 0x040E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  2: 0x041F [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="fdo1")
 ...
 88: 0x0605 [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s026", work_offset2=0*)
 89: 0x0616 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
...
127: 0x06F5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s020", work_offset2=0*)
128: 0x0706 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
...
132: 0x0734 [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s018", work_offset2=0*)
...
135: 0x075B [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s033", work_offset2=0*)
...
141: 0x0793 [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s031", work_offset2=0*)
...
151: 0x07DC [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s032", work_offset2=0*)
...
155: 0x080B [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s129", work_offset2=0*)
156: 0x081C [0x01] GOTO 0x0884

SUBROUTINE_081F:
157: 0x081F [0x02] IF !(Work_Zone[9] == 5*) GOTO 0x083B
158: 0x0827 [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s130", work_offset2=0*)
159: 0x0838 [0x01] GOTO 0x0884

SUBROUTINE_083B:
160: 0x083B [0x02] IF !(Work_Zone[9] == 6*) GOTO 0x0857
161: 0x0843 [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s130", work_offset2=0*)
162: 0x0854 [0x01] GOTO 0x0884

SUBROUTINE_0857:
163: 0x0857 [0x02] IF !(Work_Zone[9] == 8*) GOTO 0x0873
164: 0x085F [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s129", work_offset2=0*)
165: 0x0870 [0x01] GOTO 0x0884

SUBROUTINE_0873:
166: 0x0873 [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s034", work_offset2=0*)
...
185: 0x0918 [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s035", work_offset2=0*)
...
190: 0x093F [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
...
199: 0x097A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
