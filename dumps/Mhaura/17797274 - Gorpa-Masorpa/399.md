...
SUBROUTINE_4CAD:
 18: 0x4CAD [0x1C] WAIT(60* ticks)
 19: 0x4CB0 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "ghn1" with entities [EventEntity, EventEntity], work=41*
 20: 0x4CBF [0x1D] PRINT_EVENT_MESSAGE(message_id=8237*)
    → "Um, you see...\u007F1\u0000\u0007"
 21: 0x4CC2 [0x23] WAIT_FOR_DIALOG_INTERACTION
 22: 0x4CC3 [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "ghn1" with entities [EventEntity, EventEntity]
 23: 0x4CD0 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk0" with entities [EventEntity, EventEntity], work=40*
 24: 0x4CDF [0x1D] PRINT_EVENT_MESSAGE(message_id=8238*)
    → "This letter comes from the greataru mage Abdhaljs himself.\u007F1\u0000\u0007"
 25: 0x4CE2 [0x23] WAIT_FOR_DIALOG_INTERACTION
 26: 0x4CE3 [0x1D] PRINT_EVENT_MESSAGE(message_id=8239*)
    → "Here, you may feel free to give it a read-wead.\u007F1\u0000\u0007"
 27: 0x4CE6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 28: 0x4CE7 [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "tlk0" with entities [EventEntity, EventEntity]
 29: 0x4CF4 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk1" with entities [EventEntity, EventEntity], work=40*
 30: 0x4D03 [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "tlk1" with entities [EventEntity, EventEntity]
 31: 0x4D10 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "pas0" with entities [EventEntity, EventEntity], work=40*
 32: 0x4D1F [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "pas0" with entities [EventEntity, EventEntity]
 33: 0x4D2C [0x13] ExtData[1]->WorkLocal[30] = rand() % 99*
 34: 0x4D31 [0x02] IF !(ExtData[1]->WorkLocal[30] > 4*) GOTO 0x4DB9
 35: 0x4D39 [0x48] [System] [8216*]:
    → "\u007F6\u0001\u007F1\u0000\u0007"
 36: 0x4D3C [0x23] WAIT_FOR_DIALOG_INTERACTION
 37: 0x4D3D [0x48] [System] [8295*]:
    → "\u00072Mommy Dearest,\u0007How have you been? I have been doing quite well.\u007F1\u0000\u0007"
 38: 0x4D40 [0x23] WAIT_FOR_DIALOG_INTERACTION
 39: 0x4D41 [0x13] ExtData[1]->WorkLocal[30] = rand() % 99*
 40: 0x4D46 [0x02] IF !(ExtData[1]->WorkLocal[30] > 49*) GOTO 0x4D7D
 41: 0x4D4E [0x03] Work_Zone[2] = 6458*
 42: 0x4D53 [0x48] [System] [8296*]:
 ...
 43: 0x4D56 [0x23] WAIT_FOR_DIALOG_INTERACTION
 44: 0x4D57 [0x13] ExtData[1]->WorkLocal[30] = rand() % 99*
 45: 0x4D5C [0x02] IF !(ExtData[1]->WorkLocal[30] > 49*) GOTO 0x4D7D
 46: 0x4D64 [0x48] [System] [8297*]:
 ...
 47: 0x4D67 [0x23] WAIT_FOR_DIALOG_INTERACTION
 48: 0x4D68 [0x13] ExtData[1]->WorkLocal[30] = rand() % 99*
 49: 0x4D6D [0x02] IF !(ExtData[1]->WorkLocal[30] > 49*) GOTO 0x4D7D
 50: 0x4D75 [0x48] [System] [8298*]:
    → "\u00072P.S.\u0007While it's fun answering quiz questions-wuestions, I also like thinking up new ones!\u00073\u007F1\u0000\u0007"
 51: 0x4D78 [0x23] WAIT_FOR_DIALOG_INTERACTION
 52: 0x4D79 [0x48] [System] [8216*]:
    → "\u007F6\u0001\u007F1\u0000\u0007"
 53: 0x4D7C [0x23] WAIT_FOR_DIALOG_INTERACTION
 54: 0x4D7D [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "zit0" with entities [EventEntity, EventEntity], work=40*
 55: 0x4D8C [0x1D] PRINT_EVENT_MESSAGE(message_id=8215*)
    → "Wh-wh-what!? G-give that back!\u007F6\u0001\u0007Here! Here's the right one!\u007F1\u0000\u0007"
 56: 0x4D8F [0x23] WAIT_FOR_DIALOG_INTERACTION
 57: 0x4D90 [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "zit0" with entities [EventEntity, EventEntity]
 58: 0x4D9D [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "pas0" with entities [EventEntity, EventEntity], work=40*
 59: 0x4DAC [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "pas0" with entities [EventEntity, EventEntity]
 60: 0x4DB9 [0x48] [System] [8216*]:
    → "\u007F6\u0001\u007F1\u0000\u0007"
 61: 0x4DBC [0x23] WAIT_FOR_DIALOG_INTERACTION
 62: 0x4DBD [0x48] [System] [8293*]:
    → "\u00072Dearest adventurer,\u0007Once again, allow me to get straight to the point.\u007F1\u0000\u0007"
 63: 0x4DC0 [0x23] WAIT_FOR_DIALOG_INTERACTION
 64: 0x4DC1 [0x03] Work_Zone[2] = 21517*
 65: 0x4DC6 [0x03] Work_Zone[3] = 9784*
 66: 0x4DCB [0x48] [System] [8294*]:
 ...
 67: 0x4DCE [0x23] WAIT_FOR_DIALOG_INTERACTION
 68: 0x4DCF [0x03] Work_Zone[2] = 21517*
 69: 0x4DD4 [0x48] [System] [8283*]:
 ...
 70: 0x4DD7 [0x23] WAIT_FOR_DIALOG_INTERACTION
 71: 0x4DD8 [0x48] [System] [8284*]:
 ...
 72: 0x4DDB [0x23] WAIT_FOR_DIALOG_INTERACTION
 73: 0x4DDC [0x48] [System] [8244*]:
    → "\u00072I have left the details with my representative at the A.M.A.N. Please check with him for more information.\u007F1\u0000\u0007"
 74: 0x4DDF [0x23] WAIT_FOR_DIALOG_INTERACTION
 75: 0x4DE0 [0x03] Work_Zone[2] = 9784*
 76: 0x4DE5 [0x48] [System] [8268*]:
 ...
 77: 0x4DE8 [0x23] WAIT_FOR_DIALOG_INTERACTION
 78: 0x4DE9 [0x48] [System] [8216*]:
    → "\u007F6\u0001\u007F1\u0000\u0007"
 79: 0x4DEC [0x23] WAIT_FOR_DIALOG_INTERACTION
 80: 0x4DED [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk0" with entities [EventEntity, EventEntity], work=40*
 81: 0x4DFC [0x1D] PRINT_EVENT_MESSAGE(message_id=8240*)
    → "I look forward to helping you with all of your equipment needs!\u007F1\u0000\u0007"
 82: 0x4DFF [0x23] WAIT_FOR_DIALOG_INTERACTION
 83: 0x4E00 [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "tlk0" with entities [EventEntity, EventEntity]
 84: 0x4E0D [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk1" with entities [EventEntity, EventEntity], work=40*
 85: 0x4E1C [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "tlk1" with entities [EventEntity, EventEntity]
 86: 0x4E29 [0x21] END_EVENT
 87: 0x4E2A [0x00] END_REQSTACK()
```
