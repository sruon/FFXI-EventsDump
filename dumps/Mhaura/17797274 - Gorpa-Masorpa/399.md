...
```
  ...
  9: 0x4B8D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 14: 0x4BAA [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
...
SUBROUTINE_4BF7:
 ...
 20: 0x4BFF [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 25: 0x4C1A [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
...
SUBROUTINE_4C3B:
 ...
 32: 0x4C43 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 37: 0x4C60 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
...
SUBROUTINE_4CAD:
 ...
 43: 0x4CB0 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=41*, entity1=EventEntity, entity2=EventEntity, action="ghn1")
 44: 0x4CBF [0x1D] PRINT_EVENT_MESSAGE(message_id=8237*)
    → "Um, you see...\u007F1\u0000\u0007"
 45: 0x4CC2 [0x23] WAIT_FOR_DIALOG_INTERACTION
 46: 0x4CC3 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="ghn1")
 47: 0x4CD0 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 52: 0x4CE7 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
 53: 0x4CF4 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 54: 0x4D03 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
 55: 0x4D10 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="pas0")
 56: 0x4D1F [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="pas0")
 ...
 78: 0x4D7D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="zit0")
 ...
 81: 0x4D90 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="zit0")
 82: 0x4D9D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="pas0")
 83: 0x4DAC [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="pas0")
...
104: 0x4DED [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
...
107: 0x4E00 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
108: 0x4E0D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
109: 0x4E1C [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
...
```
# Data Section: 0x4BD4 (32 bytes)
     0x4BD4: 9D 08 00 00 00 61 62 64 68 61 6C 6A 73 00 00 00
     0x4BE4: 00 00 00 00 00 F1 4B 1A 69 5F 01 F4 4B 1A 8A 5F
# Data Section: 0x4C8A (32 bytes)
     0x4C8A: 9D 08 00 00 00 6A 65 75 6E 6F 00 00 00 00 00 00
     0x4C9A: 00 00 00 00 00 A7 4C 1A 69 5F 01 AA 4C 1A 8A 5F
```