...
SUBROUTINE_49E1:
 18: 0x49E1 [0x1C] WAIT(60* ticks)
 19: 0x49E4 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "ghn1" with entities [EventEntity, EventEntity], work=41*
 20: 0x49F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=8237*)
    → "Um, you see...\u007F1\u0000\u0007"
 21: 0x49F6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 22: 0x49F7 [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "ghn1" with entities [EventEntity, EventEntity]
 23: 0x4A04 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk0" with entities [EventEntity, EventEntity], work=40*
 24: 0x4A13 [0x1D] PRINT_EVENT_MESSAGE(message_id=8238*)
    → "This letter comes from the greataru mage Abdhaljs himself.\u007F1\u0000\u0007"
 25: 0x4A16 [0x23] WAIT_FOR_DIALOG_INTERACTION
 26: 0x4A17 [0x1D] PRINT_EVENT_MESSAGE(message_id=8239*)
    → "Here, you may feel free to give it a read-wead.\u007F1\u0000\u0007"
 27: 0x4A1A [0x23] WAIT_FOR_DIALOG_INTERACTION
 28: 0x4A1B [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "tlk0" with entities [EventEntity, EventEntity]
 29: 0x4A28 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk1" with entities [EventEntity, EventEntity], work=40*
 30: 0x4A37 [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "tlk1" with entities [EventEntity, EventEntity]
 31: 0x4A44 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "pas0" with entities [EventEntity, EventEntity], work=40*
 32: 0x4A53 [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "pas0" with entities [EventEntity, EventEntity]
 33: 0x4A60 [0x13] ExtData[1]->WorkLocal[30] = rand() % 99*
 34: 0x4A65 [0x02] IF !(ExtData[1]->WorkLocal[30] > 4*) GOTO 0x4AF7
 35: 0x4A6D [0x48] [System] [8216*]:
    → "\u007F6\u0001\u007F1\u0000\u0007"
 36: 0x4A70 [0x23] WAIT_FOR_DIALOG_INTERACTION
 37: 0x4A71 [0x48] [System] [8285*]:
    → "\u00072Mommy Dearest,\u0007How have you been? I have been doing quite well.\u007F1\u0000\u0007"
 38: 0x4A74 [0x23] WAIT_FOR_DIALOG_INTERACTION
 39: 0x4A75 [0x13] ExtData[1]->WorkLocal[30] = rand() % 99*
 40: 0x4A7A [0x02] IF !(ExtData[1]->WorkLocal[30] > 49*) GOTO 0x4ABB
 41: 0x4A82 [0x03] Work_Zone[2] = 620*
 42: 0x4A87 [0x03] Work_Zone[3] = 624*
 43: 0x4A8C [0x03] Work_Zone[4] = 4405*
 44: 0x4A91 [0x48] [System] [8286*]:
 ...
 45: 0x4A94 [0x23] WAIT_FOR_DIALOG_INTERACTION
 46: 0x4A95 [0x13] ExtData[1]->WorkLocal[30] = rand() % 99*
 47: 0x4A9A [0x02] IF !(ExtData[1]->WorkLocal[30] > 49*) GOTO 0x4ABB
 48: 0x4AA2 [0x48] [System] [8287*]:
 ...
 49: 0x4AA5 [0x23] WAIT_FOR_DIALOG_INTERACTION
 50: 0x4AA6 [0x13] ExtData[1]->WorkLocal[30] = rand() % 99*
 51: 0x4AAB [0x02] IF !(ExtData[1]->WorkLocal[30] > 49*) GOTO 0x4ABB
 52: 0x4AB3 [0x48] [System] [8288*]:
    → "\u00072P.S.\u0007\u00072One day, I hope to be able to fully pass the Orastery's Vana'diel Exam.\u00073\u007F1\u0000\u0007"
 53: 0x4AB6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 54: 0x4AB7 [0x48] [System] [8216*]:
    → "\u007F6\u0001\u007F1\u0000\u0007"
 55: 0x4ABA [0x23] WAIT_FOR_DIALOG_INTERACTION
 56: 0x4ABB [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "zit0" with entities [EventEntity, EventEntity], work=40*
 57: 0x4ACA [0x1D] PRINT_EVENT_MESSAGE(message_id=8215*)
    → "Wh-wh-what!? G-give that back!\u007F6\u0001\u0007Here! Here's the right one!\u007F1\u0000\u0007"
 58: 0x4ACD [0x23] WAIT_FOR_DIALOG_INTERACTION
 59: 0x4ACE [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "zit0" with entities [EventEntity, EventEntity]
 60: 0x4ADB [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "pas0" with entities [EventEntity, EventEntity], work=40*
 61: 0x4AEA [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "pas0" with entities [EventEntity, EventEntity]
 62: 0x4AF7 [0x48] [System] [8216*]:
    → "\u007F6\u0001\u007F1\u0000\u0007"
 63: 0x4AFA [0x23] WAIT_FOR_DIALOG_INTERACTION
 64: 0x4AFB [0x48] [System] [8281*]:
    → "\u00072Dearest adventurers,\u0007\u00072Permit me to dispense with the pleasantries and get right down to business.\u007F1\u0000\u0007"
 65: 0x4AFE [0x23] WAIT_FOR_DIALOG_INTERACTION
 66: 0x4AFF [0x03] Work_Zone[2] = 21516*
 67: 0x4B04 [0x03] Work_Zone[3] = 9783*
 68: 0x4B09 [0x48] [System] [8282*]:
 ...
 69: 0x4B0C [0x23] WAIT_FOR_DIALOG_INTERACTION
 70: 0x4B0D [0x03] Work_Zone[2] = 21516*
 71: 0x4B12 [0x48] [System] [8283*]:
 ...
 72: 0x4B15 [0x23] WAIT_FOR_DIALOG_INTERACTION
 73: 0x4B16 [0x48] [System] [8284*]:
 ...
 74: 0x4B19 [0x23] WAIT_FOR_DIALOG_INTERACTION
 75: 0x4B1A [0x48] [System] [8244*]:
    → "\u00072I have left the details with my representative at the A.M.A.N. Please check with him for more information.\u007F1\u0000\u0007"
 76: 0x4B1D [0x23] WAIT_FOR_DIALOG_INTERACTION
 77: 0x4B1E [0x03] Work_Zone[2] = 9783*
 78: 0x4B23 [0x48] [System] [8268*]:
 ...
 79: 0x4B26 [0x23] WAIT_FOR_DIALOG_INTERACTION
 80: 0x4B27 [0x48] [System] [8216*]:
    → "\u007F6\u0001\u007F1\u0000\u0007"
 81: 0x4B2A [0x23] WAIT_FOR_DIALOG_INTERACTION
 82: 0x4B2B [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk0" with entities [EventEntity, EventEntity], work=40*
 83: 0x4B3A [0x1D] PRINT_EVENT_MESSAGE(message_id=8240*)
    → "I look forward to helping you with all of your equipment needs!\u007F1\u0000\u0007"
 84: 0x4B3D [0x23] WAIT_FOR_DIALOG_INTERACTION
 85: 0x4B3E [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "tlk0" with entities [EventEntity, EventEntity]
 86: 0x4B4B [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk1" with entities [EventEntity, EventEntity], work=40*
 87: 0x4B5A [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "tlk1" with entities [EventEntity, EventEntity]
 88: 0x4B67 [0x21] END_EVENT
 89: 0x4B68 [0x00] END_REQSTACK()
```
