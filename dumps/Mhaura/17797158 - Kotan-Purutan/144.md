...
```
  ...
  3: 0x00A3 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  ...
  6: 0x00B6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7099*)
    → "Could you come back when it's dark?\u0007I know it's a bother-wother, but I was specifically instructed not to take it out during the day.\u007F1\u0000\u0007"
