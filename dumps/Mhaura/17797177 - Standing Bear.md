...
| [14](#event-14)          | 0x0001       |     28 |              8 |
| [221](#event-221)        | 0x001D       |      1 |              1 |
| [230](#event-230)        | 0x001E       |      1 |              1 |
...
- **7142**: Hey, I'm only a deputy. Talk to Felisa at the counter if you want to board the ferry.
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=7142*)
    → "Hey, I'm only a deputy. Talk to Felisa at the counter if you want to board the ferry."
