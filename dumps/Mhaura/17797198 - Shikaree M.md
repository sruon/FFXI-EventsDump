...
- **7293**: I go now to check the verrracity of that story, to see for my own eyes the body of Syu Befrathi, daughter of Chieftainness Nhev Befrathi.
- **7294**: I have heard from the townspeople that dangerous creatures rrroam the dark hallways of the Eldieme Necropolis.
- **7295**: It is a place that cannot be entered alone. But of course, I have no intention of giving up on my quarrry.
- **7296**: You are one of the brrreed they call adventurers, right? Adventurers are said to take on almost any kind of work as long as the pay is good.
- **7297**: I will follow after you, keeping out of sight. Clear the path ahead, making for the cemetery in the center of the necropolis.
- **7298**: Meet me at the necropolis, and don't be late.
...
```
  0: 0x0546 [0x1D] PRINT_EVENT_MESSAGE(message_id=7293*)
...
```
  0: 0x054B [0x1D] PRINT_EVENT_MESSAGE(message_id=7294*)
  ...
  2: 0x054F [0x1D] PRINT_EVENT_MESSAGE(message_id=7295*)
...
```
  0: 0x0554 [0x1D] PRINT_EVENT_MESSAGE(message_id=7296*)
...
```
  0: 0x0559 [0x1D] PRINT_EVENT_MESSAGE(message_id=7297*)
...
```
  0: 0x055E [0x1D] PRINT_EVENT_MESSAGE(message_id=7298*)
