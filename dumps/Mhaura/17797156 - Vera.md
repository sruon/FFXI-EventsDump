- **7070**: Good. Then why are you still here? Go try it out, already! And don't forget to thank me when it saves your skin. Hoh-hoh.
- **7071**: Oh, you again. You must've thought I was asking you to bring me those things out of greed. Hoh-hoh.
- **7072**: But you realize I was only testing you to see if you could actually get them. I used to be in the Market...Mooseket...Muskewhatchamacallits before, you know?
- **7073**: You look dubious. I did teach you how to use support jobs, didn't I? Well, you're free to believe whatever you want, but what you have now is real power. Use it wisely. Hoh-hoh.
...
```
  ...
  4: 0x0033 [0x1D] PRINT_EVENT_MESSAGE(message_id=7040*)
...
```
 ...
 13: 0x0061 [0x1D] PRINT_EVENT_MESSAGE(message_id=7043*)
    → "Not that I'd be terribly upset with $6, provided you could get your hands on one."
 14: 0x0064 [0x23] WAIT_FOR_DIALOG_INTERACTION
 15: 0x0065 [0x24] CREATE_DIALOG(message_id=7044*, default_option=1*, option_flags=0*)
 ...
 20: 0x0085 [0x1D] PRINT_EVENT_MESSAGE(message_id=7045*)
 ...
 26: 0x00A6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7046*)
...
```
  ...
  3: 0x00D0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7048*)
  ...
  6: 0x00D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7043*)
    → "Not that I'd be terribly upset with $6, provided you could get your hands on one."
...
```
  ...
  5: 0x00E9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7049*)
  ...
  9: 0x0104 [0x1D] PRINT_EVENT_MESSAGE(message_id=7056*)
 ...
 15: 0x0140 [0x1D] PRINT_EVENT_MESSAGE(message_id=7057*)
...
SUBROUTINE_01DC:
 ...
 22: 0x01E1 [0x24] CREATE_DIALOG(message_id=7112*, default_option=0*, option_flags=0*)
 ...
 26: 0x0200 [0x1D] PRINT_EVENT_MESSAGE(message_id=7053*)
 ...
 34: 0x0247 [0x1D] PRINT_EVENT_MESSAGE(message_id=7054*)
...
```
 ...
 14: 0x02D5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7057*)
    → "And if you can't use support jobs, you don't deserve to be called an adventurer! But I can help you with that. Hoh-hoh."
...
```
  ...
  5: 0x0345 [0x1D] PRINT_EVENT_MESSAGE(message_id=7059*)
  ...
  8: 0x0358 [0x1D] PRINT_EVENT_MESSAGE(message_id=7060*)
 ...
 10: 0x035C [0x1D] PRINT_EVENT_MESSAGE(message_id=7061*)
 ...
 12: 0x0360 [0x1D] PRINT_EVENT_MESSAGE(message_id=7062*)
 ...
 14: 0x0364 [0x1D] PRINT_EVENT_MESSAGE(message_id=7063*)
 ...
 18: 0x0384 [0x1D] PRINT_EVENT_MESSAGE(message_id=7064*)
 ...
 20: 0x0388 [0x1D] PRINT_EVENT_MESSAGE(message_id=7065*)
 ...
 22: 0x038C [0x1D] PRINT_EVENT_MESSAGE(message_id=7066*)
 ...
 24: 0x0390 [0x1D] PRINT_EVENT_MESSAGE(message_id=7067*)
 ...
 26: 0x0394 [0x1D] PRINT_EVENT_MESSAGE(message_id=7068*)
 ...
 32: 0x03C6 [0x24] CREATE_DIALOG(message_id=7069*, default_option=0*, option_flags=0*)
 ...
 35: 0x03D6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7070*)
...
```
  ...
  4: 0x0419 [0x1D] PRINT_EVENT_MESSAGE(message_id=7071*)
  ...
  6: 0x041D [0x1D] PRINT_EVENT_MESSAGE(message_id=7072*)
  ...
  8: 0x0421 [0x1D] PRINT_EVENT_MESSAGE(message_id=7073*)
