...
- **7699**: Do you wish to know your fortune? Fate's secrets can be yours for a paltry 200 gil.
- **7700**: I am sorry, your future is clouded and unreadable. Come again next week when the fog of uncertainty has lifted.
- **7701**: Have you forgotten fate's secrets already?
- **7702**: Your lucky color is red. A burning, crimson shade.
- **7703**: Your lucky color is pale blue. A chill, translucent shade.
- **7704**: Your lucky color is green. A refreshing, breezy shade.
- **7705**: Your lucky color is yellow. A gentle, earthy shade.
- **7706**: Your lucky color is purple. An electric, dazzling shade.
- **7707**: Your lucky color is blue. A fluid, soothing shade.
- **7708**: Your lucky color is white. A pure, brilliant shade.
- **7709**: Your lucky color is black. A dark, ominous shade.
- **7710**: Your lucky color is red.
- **7711**: Your lucky color is pale blue.
- **7712**: Your lucky color is green.
- **7713**: Your lucky color is yellow.
- **7714**: Your lucky color is purple.
- **7715**: Your lucky color is blue.
- **7716**: Your lucky color is white.
- **7717**: Your lucky color is black.
- **7718**: Your fortune lies to the south.
- **7719**: Your fortune lies to the west.
- **7720**: Your fortune lies to the northwest.
- **7721**: Your fortune lies to the north.
- **7722**: Your fortune lies north-northwest.
- **7723**: Your fortune lies west-northwest.
- **7724**: Your fortune lies far to the northwest.
- **7725**: Your fortune lies a great distance to the northwest.
- **7726**: I see great compatibility with one who holds the title of "$5."
- **7727**: Have your fortune told? [Scry away./I predict I'll be needing my money.]
- **7728**: It appears my paltry fee outweighs your paltry purse...
- **7729**: Very well. Let us see what the spirits reveal...
- **7730**: Hmmm... Ve\`ry interesting...
- **7731**: And as for your perfect partner... Seek one who bears the title of "$2."
- **7732**: I'll be waiting when your need to know grows beyond tolerance.
- **7733**: Here are a few words of wisdom to see you on your way.
- **7734**: "The poor warrior blames his weapons."
- **7735**: "The hippogriff has fair feathers, but foul feet."
- **7736**: "To love a person, you must love their faults."
- **7737**: "Love and courage will find a way."
- **7738**: "Even the best party comes to an end."
- **7739**: "The balance distinguishes not between gold and lead."
- **7740**: "Ill gotten gil becomes gil ill gone."
- **7741**: "The proof of an apple pie is in the eating."
...
```
  ...
  2: 0x000E [0x1D] PRINT_EVENT_MESSAGE(message_id=7699*)
  ...
  6: 0x001D [0x1D] PRINT_EVENT_MESSAGE(message_id=7700*)
  ...
  9: 0x0024 [0x1D] PRINT_EVENT_MESSAGE(message_id=7701*)
 ...
 19: 0x004B [0x1D] PRINT_EVENT_MESSAGE(message_id=7722*)
...
SUBROUTINE_0061:
 ...
 45: 0x00A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7722*)
    → "Your fortune lies north-northwest."
 46: 0x00A5 [0x23] WAIT_FOR_DIALOG_INTERACTION
 47: 0x00A6 [0x01] GOTO 0x00A9

SUBROUTINE_00A9:
 48: 0x00A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7726*)
    → "I see great compatibility with one who holds the title of "$5.""
 49: 0x00AC [0x23] WAIT_FOR_DIALOG_INTERACTION
 50: 0x00AD [0x1D] PRINT_EVENT_MESSAGE(message_id=7733*)
    → "Here are a few words of wisdom to see you on your way."
 51: 0x00B0 [0x23] WAIT_FOR_DIALOG_INTERACTION
 52: 0x00B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7735*)
 ...
 67: 0x00EA [0x1D] PRINT_EVENT_MESSAGE(message_id=7722*)
    → "Your fortune lies north-northwest."
 68: 0x00ED [0x23] WAIT_FOR_DIALOG_INTERACTION
 69: 0x00EE [0x01] GOTO 0x00F1

SUBROUTINE_00F1:
 70: 0x00F1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7726*)
    → "I see great compatibility with one who holds the title of "$5.""
 71: 0x00F4 [0x23] WAIT_FOR_DIALOG_INTERACTION
 72: 0x00F5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7733*)
    → "Here are a few words of wisdom to see you on your way."
 73: 0x00F8 [0x23] WAIT_FOR_DIALOG_INTERACTION
 74: 0x00F9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7736*)
...
SUBROUTINE_026A:
189: 0x026A [0x24] CREATE_DIALOG(message_id=7727*, default_option=1*, option_flags=0*)
...
193: 0x0282 [0x1D] PRINT_EVENT_MESSAGE(message_id=7729*)
    → "Very well. Let us see what the spirits reveal..."
194: 0x0285 [0x23] WAIT_FOR_DIALOG_INTERACTION
195: 0x0286 [0x1D] PRINT_EVENT_MESSAGE(message_id=7730*)
...
202: 0x029C [0x1D] PRINT_EVENT_MESSAGE(message_id=7709*)
...
218: 0x02D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7707*)
...
234: 0x0314 [0x1D] PRINT_EVENT_MESSAGE(message_id=7705*)
...
250: 0x0350 [0x1D] PRINT_EVENT_MESSAGE(message_id=7704*)
...
266: 0x038C [0x1D] PRINT_EVENT_MESSAGE(message_id=7703*)
...
282: 0x03C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7706*)
...
298: 0x0404 [0x1D] PRINT_EVENT_MESSAGE(message_id=7708*)
...
314: 0x0440 [0x1D] PRINT_EVENT_MESSAGE(message_id=7702*)
...
SUBROUTINE_0474:
329: 0x0474 [0x1D] PRINT_EVENT_MESSAGE(message_id=7731*)
...
332: 0x047B [0x1D] PRINT_EVENT_MESSAGE(message_id=7728*)
...
337: 0x048F [0x1D] PRINT_EVENT_MESSAGE(message_id=7732*)
