...
- **7241**: Hold the vines up to the flames? [Yes./Not yet.]
...
```
  0: 0x0001 [0x24] CREATE_DIALOG(message_id=7241*, default_option=0*, option_flags=0*)
