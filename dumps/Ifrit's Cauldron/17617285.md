...
- **11634**: Obtained key item: 3.
- **11635**: You find some $3, but your $1 is destroyed in the process.
...
```
  ...
  5: 0x02AC [0x48] [System] [11634*]:
    → "Obtained key item: 3."
  6: 0x02AF [0x01] GOTO 0x02BF
  7: 0x02B2 [0x03] Work_Zone[2] = 3296*
  8: 0x02B7 [0x03] Work_Zone[3] = 605*
  9: 0x02BC [0x48] [System] [11635*]:
    → "You find some $3, but your $1 is destroyed in the process."
