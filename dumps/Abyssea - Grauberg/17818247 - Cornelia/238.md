...
```
  ...
  2: 0x0009 [0x5B] LOAD_EXT_SCHEDULER(work_offset=145*, entity1=EventEntity, entity2=EventEntity, action="tla0")
  3: 0x0018 [0x1D] PRINT_EVENT_MESSAGE(message_id=8179*)
    → "Well met, wayfarer. I am in the midst of investigating the behavioral patterns of wyverns.\u007F1\u0000\u0007"
  4: 0x001B [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x001C [0x1D] PRINT_EVENT_MESSAGE(message_id=8180*)
    → "Should you learn something of these diabolical creatures in your journeys--anything at all--I would be glad for that information.\u007F1\u0000\u0007"
