...
```
  ...
  6: 0x0032 [0x5B] LOAD_EXT_SCHEDULER(work_offset=220*, entity1=EventEntity, entity2=EventEntity, action="mog0")
 ...
 10: 0x004A [0x5B] LOAD_EXT_SCHEDULER(work_offset=220*, entity1=EventEntity, entity2=EventEntity, action="mog1")
 ...
 18: 0x007D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=Kuoh Rhel (ID: 17818235/0x010FE27B), entity2=Kuoh Rhel (ID: 17818235/0x010FE27B), action="thk1")
 ...
 22: 0x0099 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=Kuoh Rhel (ID: 17818235/0x010FE27B), entity2=Kuoh Rhel (ID: 17818235/0x010FE27B), action="thk2")
 ...
 28: 0x00C5 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=Kuoh Rhel (ID: 17818235/0x010FE27B), entity2=Kuoh Rhel (ID: 17818235/0x010FE27B), action="pas0")
 ...
 32: 0x00E1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
...
SUBROUTINE_010C:
 ...
 43: 0x011C [0x5B] LOAD_EXT_SCHEDULER(work_offset=220*, entity1=EventEntity, entity2=EventEntity, action="mog0")
 44: 0x012B [0x03] Work_Zone[2] = 1*
 45: 0x0130 [0x1D] PRINT_EVENT_MESSAGE(message_id=8062*)
    → "\u000C\u0000[Kweh.../Kweh!/Kwe\u0001`h.\u0001t/Kwehhh!/Kwe\u0001`h.]\u007F1\u0000\u0007"
 46: 0x0133 [0x23] WAIT_FOR_DIALOG_INTERACTION
 47: 0x0134 [0x5B] LOAD_EXT_SCHEDULER(work_offset=220*, entity1=EventEntity, entity2=EventEntity, action="mog1")
 ...
 58: 0x0177 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=Kuoh Rhel (ID: 17818235/0x010FE27B), entity2=Kuoh Rhel (ID: 17818235/0x010FE27B), action="tlk0")
 ...
 63: 0x0196 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=Kuoh Rhel (ID: 17818235/0x010FE27B), entity2=Kuoh Rhel (ID: 17818235/0x010FE27B), action="tlk2")
...
SUBROUTINE_01C3:
 ...
 73: 0x01CB [0x5B] LOAD_EXT_SCHEDULER(work_offset=220*, entity1=EventEntity, entity2=EventEntity, action="mog0")
 74: 0x01DA [0x03] Work_Zone[2] = 1*
 75: 0x01DF [0x1D] PRINT_EVENT_MESSAGE(message_id=8062*)
    → "\u000C\u0000[Kweh.../Kweh!/Kwe\u0001`h.\u0001t/Kwehhh!/Kwe\u0001`h.]\u007F1\u0000\u0007"
 76: 0x01E2 [0x23] WAIT_FOR_DIALOG_INTERACTION
 77: 0x01E3 [0x5B] LOAD_EXT_SCHEDULER(work_offset=220*, entity1=EventEntity, entity2=EventEntity, action="mog1")
...
SUBROUTINE_020F:
 ...
 88: 0x0217 [0x5B] LOAD_EXT_SCHEDULER(work_offset=220*, entity1=EventEntity, entity2=EventEntity, action="mog0")
 89: 0x0226 [0x03] Work_Zone[2] = 1*
 90: 0x022B [0x1D] PRINT_EVENT_MESSAGE(message_id=8062*)
    → "\u000C\u0000[Kweh.../Kweh!/Kwe\u0001`h.\u0001t/Kwehhh!/Kwe\u0001`h.]\u007F1\u0000\u0007"
 91: 0x022E [0x23] WAIT_FOR_DIALOG_INTERACTION
 92: 0x022F [0x5B] LOAD_EXT_SCHEDULER(work_offset=220*, entity1=EventEntity, entity2=EventEntity, action="mog1")
 93: 0x023E [0x03] Work_Zone[2] = 4373*
 94: 0x0243 [0x48] [System] [8064*]:
    → "\u001F\u000FThe chocobo hungrily scoffs down the \u0001\u0005#\u0002\u0000\u0000\u0000!\u007F1\u0000\u0007"
 95: 0x0246 [0x1C] WAIT(90* ticks)
 96: 0x0249 [0x5B] LOAD_EXT_SCHEDULER(work_offset=222*, entity1=EventEntity, entity2=EventEntity, action="joy0")
...
102: 0x026D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=Kuoh Rhel (ID: 17818235/0x010FE27B), entity2=Kuoh Rhel (ID: 17818235/0x010FE27B), action="tlk0")
...
105: 0x0284 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=Kuoh Rhel (ID: 17818235/0x010FE27B), entity2=Kuoh Rhel (ID: 17818235/0x010FE27B), action="tlk2")
106: 0x0293 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=Kuoh Rhel (ID: 17818235/0x010FE27B), entity2=Kuoh Rhel (ID: 17818235/0x010FE27B), action="thk1")
...
110: 0x02AF [0x5B] LOAD_EXT_SCHEDULER(work_offset=220*, entity1=EventEntity, entity2=EventEntity, action="ton0")
...
114: 0x02C7 [0x5B] LOAD_EXT_SCHEDULER(work_offset=220*, entity1=EventEntity, entity2=EventEntity, action="ton1")
115: 0x02D6 [0x48] [System] [8077*]:
    → "\u001F\u000FThe chocobo digs up something from the ground!\u007F1\u0000\u0007"
116: 0x02D9 [0x1C] WAIT(90* ticks)
117: 0x02DC [0x5B] LOAD_EXT_SCHEDULER(work_offset=223*, entity1=EventEntity, entity2=EventEntity, action="nak0")
118: 0x02EB [0x48] [System] [8078*]:
    → "\u001F\u000FThe chocobo proffers the object to \u0008.\u007F1\u0000\u0007"
119: 0x02EE [0x1C] WAIT(90* ticks)
120: 0x02F1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
