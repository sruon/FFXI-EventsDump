...
```
  ...
  3: 0x0018 [0x1D] PRINT_EVENT_MESSAGE(message_id=8265*)
    → "It feels like another lifetime that I was training at the Orastery.\u0007It was all fun and games back then, to be honestaru.\u007F1\u0000\u0007"
  4: 0x001B [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x001C [0x1D] PRINT_EVENT_MESSAGE(message_id=8266*)
    → "I never imagined I'd one day need to ply my skills for the very survival-wival of mankind.\u007F1\u0000\u0007"
  6: 0x001F [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0020 [0x1D] PRINT_EVENT_MESSAGE(message_id=8267*)
    → "<Sigh> If only I had known that monsters would overrun the world, I would've applied myself bettaru in class.\u007F1\u0000\u0007"
