...
- **7723**: What story would you like to be told? [On second thought, maybe later./Trial by Fire(pt.1)./Trial by Fire(pt.2)./Trial-Size Trial by Fire(pt.1)./Trial-Size Trial by Fire(pt.2)./Waking the Beast(pt.1)./Waking the Beast(pt.2)./Sugar-coated Directive.]
- **7724**: 
- **7725**: 
- **7726**: 
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7723*, default_option=0*, option_flags=Work_Zone[2])
    → "What story would you like to be told? [On second thought, maybe later./Trial by Fire(pt.1)./Trial by Fire(pt.2)./Trial-Size Trial by Fire(pt.1)./Trial-Size Trial by Fire(pt.2)./Waking the Beast(pt.1)./Waking the Beast(pt.2)./Sugar-coated Directive.]"
