...
```
  0: 0x0170 [0x45] LOAD_SCHEDULED_TASK(work_offset1=82*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="x00b", work_offset2=0*)
  ...
  3: 0x0193 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
  4: 0x01A4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=82*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="x002", work_offset2=0*)
  5: 0x01B5 [0x55] WAIT_LOAD_SCHEDULER(work_offset=82*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="x002")
