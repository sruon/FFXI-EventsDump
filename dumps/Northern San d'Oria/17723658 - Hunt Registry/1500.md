...
```
 ...
 41: 0x00AB [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8005, condition_work_offset=0x8000)
 42: 0x00B2 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8003, condition_work_offset=0x8000)
 43: 0x00B9 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x800A, condition_work_offset=0x8000)
 44: 0x00C0 [0x01] GOTO 0x013D
 45: 0x00C3 [0x02] IF !(ExtData[1]->WorkLocal[5] == 1*) GOTO 0x00E3
 46: 0x00CB [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8005, condition_work_offset=0x8000)
 47: 0x00D2 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8003, condition_work_offset=0x8000)
 48: 0x00D9 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x800A, condition_work_offset=0x8000)
 ...
 52: 0x00F3 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8005, condition_work_offset=0x8000)
 53: 0x00FA [0x01] GOTO 0x010F
 54: 0x00FD [0x02] IF !(ExtData[1]->WorkLocal[20] == 1*) GOTO 0x010F
 55: 0x0105 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8003, condition_work_offset=0x8000)
...
SUBROUTINE_010F:
 ...
 61: 0x0125 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8005, condition_work_offset=0x8000)
 62: 0x012C [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8003, condition_work_offset=0x8000)
 63: 0x0133 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x800A, condition_work_offset=0x8000)
...
111: 0x0226 [0x24] CREATE_DIALOG(message_id=8001*, default_option=0*, option_flags=0x1B)
...
136: 0x02B1 [0x24] CREATE_DIALOG(message_id=8020*, default_option=0*, option_flags=0x1D)
