...
```
  ...
  5: 0x000E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=52*, entity1=EventEntity, entity2=EventEntity, action="poi0")
  6: 0x001D [0x1D] PRINT_EVENT_MESSAGE(message_id=11460*)
    → "Welcome to the Consulate of Windurst. Consul Kasaroro is inside, if you're looking forrr her.\u007F1\u0000\u0007"
  7: 0x0020 [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x0021 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="poi0")
