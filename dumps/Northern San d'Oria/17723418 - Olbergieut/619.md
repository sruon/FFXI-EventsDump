...
```
  ...
  3: 0x0094 [0x5B] LOAD_EXT_SCHEDULER(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 12: 0x00B5 [0x5B] LOAD_EXT_SCHEDULER(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 13: 0x00C4 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
 ...
 17: 0x00E1 [0x5B] LOAD_EXT_SCHEDULER(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 21: 0x00F9 [0x5B] LOAD_EXT_SCHEDULER(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 22: 0x0108 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
 23: 0x0115 [0x1C] WAIT(30* ticks)
 24: 0x0118 [0x01] GOTO 0x015D

SUBROUTINE_011B:
 25: 0x011B [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x015D
 26: 0x0123 [0x5B] LOAD_EXT_SCHEDULER(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 29: 0x0136 [0x5B] LOAD_EXT_SCHEDULER(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 30: 0x0145 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
