...
```
  ...
  4: 0x0009 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "hap0" for entities [EventEntity, EventEntity]
...
\u0000 gil! What do you say?\u007F1\u0000\u0007"
  ...
  8: 0x001F [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "gak0" for entities [EventEntity, EventEntity]
 ...
 14: 0x0042 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "gak1" for entities [EventEntity, EventEntity]
