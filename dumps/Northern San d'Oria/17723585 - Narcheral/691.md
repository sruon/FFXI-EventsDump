...
```
  ...
  4: 0x0047 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="pas0")
  5: 0x0056 [0x1D] PRINT_EVENT_MESSAGE(message_id=12498*)
    → "Excellent work, my friend. This is what I promised. We can only await Prince Pieuje's decision now.\u007F1\u0000\u0007"
  6: 0x0059 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x005A [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
