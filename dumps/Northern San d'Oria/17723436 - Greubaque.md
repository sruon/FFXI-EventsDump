...
- **6992**: Image support: $0 gil. [Accept./Decline.]
...
- **7137**: Can't you see I'm busy? We are up to our ears in work these days!
- **7138**: No, you should try it on your own.
- **7139**: Oh, I'm sorry. The guildmaster is displeased when we give help for free. "A friend is but a competitor," he likes to say.
- **7140**: All right. Close your eyes, and focus on the craft.
- **7141**: Hmm... Well, I'd recommend someone of your skill to try crafting $0. Here's what you'll need:
- **7142**: Did you get that? Remember, our guildmaster is strict, but behind his grim face lies joy at seeing new apprentices. Come back any time, friend!
...
```
  ...
  1: 0x0009 [0x24] CREATE_DIALOG(message_id=6991*, default_option=2*, option_flags=0*)
  ...
  5: 0x0021 [0x1D] PRINT_EVENT_MESSAGE(message_id=7138*)
    → "No, you should try it on your own."
  6: 0x0024 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0025 [0x01] GOTO 0x0084
  8: 0x0028 [0x24] CREATE_DIALOG(message_id=6992*, default_option=1*, option_flags=0*)
 ...
 12: 0x0040 [0x1D] PRINT_EVENT_MESSAGE(message_id=7140*)
 ...
 20: 0x0072 [0x1D] PRINT_EVENT_MESSAGE(message_id=7139*)
...
SUBROUTINE_0084:
 ...
 31: 0x00A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7141*)
...
SUBROUTINE_01A2:
 ...
 96: 0x01A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7137*)
