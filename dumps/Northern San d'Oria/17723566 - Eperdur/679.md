...
```
  ...
  4: 0x0040 [0x5B] LOAD_EXT_SCHEDULER(work_offset=25*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  ...
  7: 0x0053 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
  8: 0x0060 [0x5B] LOAD_EXT_SCHEDULER(work_offset=25*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 ...
 11: 0x0073 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
 12: 0x0080 [0x5B] LOAD_EXT_SCHEDULER(work_offset=25*, entity1=EventEntity, entity2=EventEntity, action="pas0")
 ...
 15: 0x0093 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="pas0")
 16: 0x00A0 [0x5B] LOAD_EXT_SCHEDULER(work_offset=25*, entity1=EventEntity, entity2=EventEntity, action="ino0")
 ...
 19: 0x00B3 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="ino0")
 20: 0x00C0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
