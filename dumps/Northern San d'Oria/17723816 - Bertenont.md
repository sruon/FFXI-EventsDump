...
```
  0: 0x007C [0x6C] FADE_ENTITY_COLOR(entity_id=Bertenont (ID: 17723816/0x010E71A8), end_alpha=0*, fade_time=1*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0080:                   6C A8  71 0E 01 18 80 17 80 00        l.q.......
```

#### Opcodes

```
  0: 0x0086 [0x6C] FADE_ENTITY_COLOR(entity_id=Bertenont (ID: 17723816/0x010E71A8), end_alpha=128*, fade_time=1*)
