...
```
  ...
  4: 0x0192 [0x5B] LOAD_EXT_SCHEDULER(work_offset=16*, entity1=EventEntity, entity2=EventEntity, action="atk0")
  5: 0x01A1 [0x6C] FADE_ENTITY_COLOR(entity_id=Rochefogne (ID: 17723599/0x010E70CF), end_alpha=128*, fade_time=1*)
  6: 0x01AA [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="atk0")
  ...
  9: 0x01C9 [0x5B] LOAD_EXT_SCHEDULER(work_offset=15*, entity1=EventEntity, entity2=EventEntity, action="shg0")
