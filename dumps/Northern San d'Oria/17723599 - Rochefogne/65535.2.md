...
```
  ...
  3: 0x004B [0x5B] LOAD_EXT_SCHEDULER(work_offset=13*, entity1=EventEntity, entity2=EventEntity, action="ksg0")
  4: 0x005A [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="ksg0")
