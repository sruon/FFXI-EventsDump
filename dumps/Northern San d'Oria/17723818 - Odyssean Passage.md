...
- **18343**: Vague images of worlds beyond coalesce and diffuse within.
- **18344**: Enter the light? [Take me now!/Absolutely not!]
- **18345**: Enter the light? [Take me now!/I'll dive in head first!/Absolutely not!]
...
```
  ...
  6: 0x001F [0x24] CREATE_DIALOG(message_id=18344*, default_option=0*, option_flags=0*)
...
SUBROUTINE_006F:
 ...
 18: 0x0072 [0x24] CREATE_DIALOG(message_id=18345*, default_option=0*, option_flags=0*)
