...
```
  ...
  5: 0x0018 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  6: 0x0029 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 28: 0x00AF [0x5B] LOAD_EXT_SCHEDULER(work_offset=140*, entity1=Curilla (ID: 17723569/0x010E70B1), entity2=Curilla (ID: 17723569/0x010E70B1), action=0xFEFEFE00)
 29: 0x00BE [0x5B] LOAD_EXT_SCHEDULER(work_offset=115*, entity1=Trion (ID: 17723394/0x010E7002), entity2=Trion (ID: 17723394/0x010E7002), action=0xFEFEFE00)
 30: 0x00CD [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r000", work_offset2=0*)
 31: 0x00DE [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 32: 0x00EF [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 33: 0x00FE [0x27] REQ_SET(priority=0x03, entity_id=Maurine (ID: 17723412/0x010E7014), tag_num=0x09)
 34: 0x0105 [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r000")
 35: 0x0114 [0x1C] WAIT(40* ticks)
 36: 0x0117 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r001", work_offset2=0*)
 37: 0x0128 [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r001")
 ...
 46: 0x0167 [0x2B] Maurine (ID: 17723412/0x010E7014) [12229*]:
    → "A ghost of a red mage is in the church!\u007F1\u0000\u0007"
 ...
 53: 0x0189 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r002", work_offset2=0*)
 54: 0x019A [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r002")
 ...
 69: 0x01FE [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r003", work_offset2=0*)
 70: 0x020F [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r003")
 ...
 90: 0x028B [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r004", work_offset2=0*)
 91: 0x029C [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r004")
 ...
 95: 0x02BB [0x2B] Trion (ID: 17723394/0x010E7002) [12232*]:
    → "Wait, Curilla! Be not deceived! That is no father of yours!\u007F1\u0000\u0007"
...
100: 0x02D3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r005", work_offset2=0*)
...
110: 0x031B [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r005")
...
119: 0x0357 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r006", work_offset2=0*)
120: 0x0368 [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r006")
...
132: 0x03AE [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r007", work_offset2=0*)
133: 0x03BF [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r007")
...
141: 0x0410 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r019", work_offset2=0*)
142: 0x0421 [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r019")
...
146: 0x043B [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r022", work_offset2=0*)
147: 0x044C [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r022")
...
158: 0x048A [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r008", work_offset2=0*)
159: 0x049B [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r008")
...
162: 0x04B4 [0x2B] Trion (ID: 17723394/0x010E7002) [12237*]:
    → "Curilla, drop your sword.\u007F1\u0000\u0007"
163: 0x04BB [0x23] WAIT_FOR_DIALOG_INTERACTION
164: 0x04BC [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r009", work_offset2=0*)
165: 0x04CD [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r009")
...
171: 0x04F5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r025", work_offset2=0*)
172: 0x0506 [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r025")
173: 0x0515 [0x2A] GET_REQ_LEVEL(level=3, entity_id=Curilla (ID: 17723569/0x010E70B1))
174: 0x051B [0x1C] WAIT(60* ticks)
175: 0x051E [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r026", work_offset2=0*)
176: 0x052F [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r026")
...
186: 0x056A [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r023", work_offset2=0*)
187: 0x057B [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r023")
188: 0x058A [0x2B] Trion (ID: 17723394/0x010E7002) [12240*]:
    → "Curilla!\u007F1\u0000\u0007"
189: 0x0591 [0x23] WAIT_FOR_DIALOG_INTERACTION
190: 0x0592 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r024", work_offset2=0*)
191: 0x05A3 [0x2B] Curilla (ID: 17723569/0x010E70B1) [12241*]:
    → "But I am not afraid of defeat.\u007F1\u0000\u0007"
192: 0x05AA [0x23] WAIT_FOR_DIALOG_INTERACTION
193: 0x05AB [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r024")
...
196: 0x05C4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r011", work_offset2=0*)
197: 0x05D5 [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r011")
...
203: 0x0603 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r012", work_offset2=0*)
204: 0x0614 [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r012")
...
208: 0x0632 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r013", work_offset2=0*)
209: 0x0643 [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r013")
...
219: 0x0688 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r014", work_offset2=0*)
220: 0x0699 [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r014")
...
228: 0x06D5 [0x2B] Rainemard (ID: 17723567/0x010E70AF) [12244*]:
    → "By a hair's breadth I made it in time. Curilla, forgive me for exposing you to this danger.\u007F1\u0000\u0007"
...
234: 0x06F9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r020", work_offset2=0*)
235: 0x070A [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r020")
...
239: 0x0727 [0x2B] Rainemard (ID: 17723567/0x010E70AF) [12246*]:
    → "A true warrior does not shrink from defeat. My only regret was not teaching that to you.\u007F1\u0000\u0007"
240: 0x072E [0x23] WAIT_FOR_DIALOG_INTERACTION
241: 0x072F [0x2B] Rainemard (ID: 17723567/0x010E70AF) [12247*]:
    → "But it seems that you have already learned, Curilla. My, how you have grown!\u007F1\u0000\u0007"
...
251: 0x075D [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r015", work_offset2=0*)
252: 0x076E [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r015")
253: 0x077D [0x1C] WAIT(60* ticks)
254: 0x0780 [0x2B] Rainemard (ID: 17723567/0x010E70AF) [12248*]:
    → "Watch over her, Prince.\u007F1\u0000\u0007"
...
264: 0x07B1 [0x2B] Rainemard (ID: 17723567/0x010E70AF) [12250*]:
    → "Long have I troubled you. When I appeared here, a minion of the dark followed me. For that I am sorry.\u007F1\u0000\u0007"
265: 0x07B8 [0x23] WAIT_FOR_DIALOG_INTERACTION
266: 0x07B9 [0x2B] Rainemard (ID: 17723567/0x010E70AF) [12251*]:
    → "This will not fully expiate my sins, but perhaps you may find some use for it. Please accept it.\u007F1\u0000\u0007"
...
269: 0x07C8 [0x2B] Rainemard (ID: 17723567/0x010E70AF) [12252*]:
    → "And keep a watchful eye on this church. It is a pity I can say nothing more.\u007F1\u0000\u0007"
...
276: 0x07E5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r016", work_offset2=0*)
277: 0x07F6 [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r016")
...
280: 0x080B [0x2B] Rainemard (ID: 17723567/0x010E70AF) [12253*]:
    → "Curilla, I am relieved to see you standing tall. Though we shall never meet again, I want you to remember...\u007F1\u0000\u0007"
281: 0x0812 [0x23] WAIT_FOR_DIALOG_INTERACTION
282: 0x0813 [0x2B] Rainemard (ID: 17723567/0x010E70AF) [12254*]:
    → "You will always be my daughter. And I will always watch over you.\u007F1\u0000\u0007"
...
285: 0x0822 [0x2B] Rainemard (ID: 17723567/0x010E70AF) [12255*]:
    → "I should return this watch. Carry it in memory of me.\u007F1\u0000\u0007"
...
289: 0x0833 [0x2B] Rainemard (ID: 17723567/0x010E70AF) [12256*]:
    → "Now, I must go... Farewell, my daughter!\u007F1\u0000\u0007"
...
299: 0x086D [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r017", work_offset2=0*)
300: 0x087E [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r017")
...
305: 0x089F [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r018", work_offset2=0*)
306: 0x08B0 [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r018")
...
311: 0x08D8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r017", work_offset2=0*)
312: 0x08E9 [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r017")
...
316: 0x0907 [0x2B] Curilla (ID: 17723569/0x010E70B1) [12258*]:
    → "I'll always be your daughter.\u007F1\u0000\u0007"
317: 0x090E [0x23] WAIT_FOR_DIALOG_INTERACTION
318: 0x090F [0x1C] WAIT(120* ticks)
319: 0x0912 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r021", work_offset2=0*)
320: 0x0923 [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r021")
...
324: 0x0943 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2", work_offset2=0*)
325: 0x0954 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2")
...
329: 0x096D [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
330: 0x097E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
