...
- **11533**: These sluice gates divide Northern San d'Oria into two parts: the Parade Grounds, and Laborman's Way.
- **11534**: Laborman's Way is much lower than the rest of the city. So to prevent flooding, we use these sluice gates to adjust the water for the entire district!
- **11535**: Wait, you're an adventurer, aren't you? I have a request, if you've the time...
- **11536**: Don't tell anyone, but someone sent me a letter saying they poisoned the water here! We're looking into the veracity of that claim now.
- **11537**: In the meantime, we must prepare a neutralizer to eliminate the poison. Might you be willing to obtain one?
- **11538**: Go fetch the neutralizer? [Let's do it./Not right now.]
- **11539**: That is good news, indeed! Now, all we need is someone versed in the ways of poison, but they're a hard lot to find...
- **11540**: Oh, we can't just let innocent people die from poisoned water now, can we?
- **11541**: It's no easy task, finding a neutralizer, is it? Few are skilled in the arts of poison, though that's a good thing, I suppose.
- **11542**: You've got the neutralizer! But, the thing is...it turns out it was all just a hoax. But we'll reward you anyway.
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=11533*)
  ...
  7: 0x001E [0x1D] PRINT_EVENT_MESSAGE(message_id=11534*)
...
```
  ...
  9: 0x004F [0x1D] PRINT_EVENT_MESSAGE(message_id=11537*)
 ...
 12: 0x0058 [0x24] CREATE_DIALOG(message_id=11538*, default_option=1*, option_flags=0*)
 ...
 17: 0x007C [0x1D] PRINT_EVENT_MESSAGE(message_id=11539*)
 ...
 22: 0x009A [0x1D] PRINT_EVENT_MESSAGE(message_id=11540*)
...
```
  ...
  4: 0x00B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=11541*)
...
```
  ...
  4: 0x00D5 [0x1D] PRINT_EVENT_MESSAGE(message_id=11542*)
