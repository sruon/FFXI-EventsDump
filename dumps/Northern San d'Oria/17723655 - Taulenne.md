...
- **13470**: Hello, [sir/ma'am]. Have you ever found yourself throwing away items because your Mog Safe is overflowing with dusty sets of armor collected on your many adventures? My colleagues and I have heard the cries of our fellow adventurers and joined together to aid all those in need.
- **13471**: Trade me a full set, and for a small fee (payable on pickup) we will hold on to it, all the while protecting it from thieves, moths, and any/all acts of god and/or goddess.
- **13472**: Please be forewarned that we cannot store any high-quality equipment, and that the signatures on any pieces of collected armor will be lost.
- **13473**: How may I be of service today?
- **13474**: What to do... [Nothing./View list of storable armor sets./Have stored armor returned.]
- **13477**: [View which set?/Remove which set from storage?] [None./Level 24\`30 armor./Level 31\`40 armor./Level 41\`50 armor./Artifact armor/High level gear./Relic armor.]
- **13478**: [View which set?/Remove which set?] [None./Iron Chainmail./Shade Harness./Brass Scale Armor./Wool Robe./Eisenplatte Armor./Soil Gi./Seer's Tunic./Studded Armor./Centurion's Scale Mail./Mercenary Captain's Doublet./Garish Tunic./Noct Doublet.]
...
- **13480**: [View which set?/Remove which set?] [None./Alumine Haubert./Carapace Armor./Banded Mail./Hara-Ate./Raptor Armor./Steel Scale Armor./Wool Gambison./Shinobi Gi./Mythril Plate Armor./Iron Musketeer's Cuirass./Tactician Magician's Cloak./White Cloak./Austere Robe./Crow Jupon.]
- **13481**: This set is comprised of the following items: #, $1, $2, $3, and $4.
- **13482**: This set is comprised of the following items: $1, $2, $3, and $4.
- **13483**: This set is comprised of the following items: #, $1, $3, and $4.
- **13484**: This set is comprised of the following items: $1, and $3.
- **13485**: A storage fee of $5 gil will be required upon pickup of this particular set.
...
- **13487**: The storage fee for your armor comes to $5 gil.
- **13488**: Do you wish to pay the fee? [Not at this time./Yes.]
- **13489**: I am sorry, [sir/ma'am]. $5 gil is required before we can return your armor.
- **13490**: Very well, [sir/ma'am]. When you wish to have your armor returned, remember to present this claim slip along with the $5-gil storage fee at any of our five convenient pickup locations around Vana'diel.
- **13491**: Regulations do not allow adventurers to store more than one set of the same armor.
- **13493**: [View which set?/Remove which set?] [None at this time./Warrior's Armor./Melee Attire./Cleric's Attire./Sorcerer's Attire./Duelist's Armor./Assassin's Attire./Valor Armor./Abyss Armor./Monster Armor./Bard's Attire./Scout's Attire./Saotome Armor./Koga Garb./Wyrm Armor./Summoner's Attire./Mirage Attire./Commodore Attire./Pantin Attire./Etoile Attire./Argute Attire.]
...
```
 ...
 13: 0x004F [0x1D] PRINT_EVENT_MESSAGE(message_id=13470*)
 ...
 15: 0x0053 [0x1D] PRINT_EVENT_MESSAGE(message_id=13471*)
 ...
 17: 0x0057 [0x1D] PRINT_EVENT_MESSAGE(message_id=13472*)
 ...
 20: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=13473*)
    → "How may I be of service today?"
 21: 0x0065 [0x23] WAIT_FOR_DIALOG_INTERACTION
 22: 0x0066 [0x24] CREATE_DIALOG(message_id=13474*, default_option=0*, option_flags=ExtData[1]->WorkLocal[6])
...
SUBROUTINE_0128:
 28: 0x0128 [0x24] CREATE_DIALOG(message_id=13477*, default_option=0*, option_flags=ExtData[1]->WorkLocal[6])
...
SUBROUTINE_0160:
 39: 0x0160 [0x24] CREATE_DIALOG(message_id=13478*, default_option=0*, option_flags=ExtData[1]->WorkLocal[6])
...
SUBROUTINE_01A5:
 54: 0x01A5 [0x24] CREATE_DIALOG(message_id=13479*, default_option=0*, option_flags=ExtData[1]->WorkLocal[6])
...
SUBROUTINE_01FA:
 72: 0x01FA [0x24] CREATE_DIALOG(message_id=13480*, default_option=0*, option_flags=ExtData[1]->WorkLocal[6])
...
SUBROUTINE_027B:
 97: 0x027B [0x24] CREATE_DIALOG(message_id=13486*, default_option=0*, option_flags=ExtData[1]->WorkLocal[6])
    → "[View which set?/Remove which set?] [None at this time./Fighter's Armor./Temple Attire./Healer's Attire./Wizard's Attire./Warlock's Armor./Rogue's Attire./Gallant Armor./Chaos Armor./Beast Armor./Choral Attire./Hunter's Attire./Myochin Armor./Ninja Garb./Drachen Armor./Evoker's Attire./Magus Attire./Corsair's Attire./Puppetry Attire./Dancer's Attire./Dancer's Attire./Scholar's Attire./Amir Armor Set./Pahluwan Armor Set./Yigit Armor Set.]"
...
SUBROUTINE_02D8:
116: 0x02D8 [0x24] CREATE_DIALOG(message_id=13493*, default_option=0*, option_flags=ExtData[1]->WorkLocal[6])
...
134: 0x032C [0x1D] PRINT_EVENT_MESSAGE(message_id=13484*)
...
137: 0x0333 [0x1D] PRINT_EVENT_MESSAGE(message_id=13482*)
...
141: 0x0342 [0x1D] PRINT_EVENT_MESSAGE(message_id=13483*)
...
144: 0x0349 [0x1D] PRINT_EVENT_MESSAGE(message_id=13481*)
    → "This set is comprised of the following items: #, $1, $2, $3, and $4."
145: 0x034C [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_034D:
146: 0x034D [0x1D] PRINT_EVENT_MESSAGE(message_id=13485*)
...
```
  ...
  3: 0x03B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=13491*)
  ...
  7: 0x03C1 [0x1D] PRINT_EVENT_MESSAGE(message_id=13490*)
