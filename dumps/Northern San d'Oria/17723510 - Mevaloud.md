...
- **7271**: Nearby is a large square with a fountain: the Parade Grounds. Each country has a consulate there.
- **7272**: Where are the consulates? Really, you adventurers should learn to open your main menu and select "Map" before asking directions!
- **7273**: Nearby is a large square with a fountain: the Parade Grounds. Each country has a consulate there.
- **7274**: You want to find the consulates? Really, you should go to Southern San d'Oria and buy a map from the lady in front the Westgate!
...
```
  ...
  4: 0x00B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7273*)
    → "Nearby is a large square with a fountain: the Parade Grounds. Each country has a consulate there."
  5: 0x00BC [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x00BD [0x1D] PRINT_EVENT_MESSAGE(message_id=7274*)
