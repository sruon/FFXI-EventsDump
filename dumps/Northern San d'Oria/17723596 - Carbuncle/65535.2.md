...
```
  0: 0x0019 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
  1: 0x002A [0x02] IF !(Work_Zone[9] == 5*) GOTO 0x0046
  2: 0x0032 [0x45] LOAD_SCHEDULED_TASK(work_offset1=249*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s017", work_offset2=0*)
  3: 0x0043 [0x01] GOTO 0x0073

SUBROUTINE_0046:
  4: 0x0046 [0x02] IF !(Work_Zone[9] == 6*) GOTO 0x0062
  5: 0x004E [0x45] LOAD_SCHEDULED_TASK(work_offset1=249*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s017", work_offset2=0*)
  6: 0x005F [0x01] GOTO 0x0073

SUBROUTINE_0062:
  7: 0x0062 [0x45] LOAD_SCHEDULED_TASK(work_offset1=249*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s011", work_offset2=0*)
...
SUBROUTINE_00AA:
 ...
 16: 0x00B9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
 17: 0x00CA [0x45] LOAD_SCHEDULED_TASK(work_offset1=249*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s010", work_offset2=0*)
 18: 0x00DB [0x1C] WAIT(200* ticks)
 19: 0x00DE [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="who1", work_offset2=0*)
