...
```
  ...
  2: 0x0968 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  ...
  7: 0x098D [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s023", work_offset2=0*)
  8: 0x099E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
  9: 0x09AF [0x02] IF !(Work_Zone[6] == 1*) GOTO 0x09D2
 10: 0x09B7 [0x03] Work_Zone[5] = 891*
 11: 0x09BC [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
...
SUBROUTINE_09D2:
 15: 0x09D2 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 18: 0x09E5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s019", work_offset2=0*)
 ...
 22: 0x09FF [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 26: 0x0A1A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 27: 0x0A2B [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
