...
```
  ...
  2: 0x0028 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  ...
  7: 0x004D [0x45] LOAD_SCHEDULED_TASK(work_offset1=90*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s026", work_offset2=0*)
  8: 0x005E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
  9: 0x006F [0x55] WAIT_LOAD_SCHEDULER(work_offset=90*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s026")
 10: 0x007E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 18: 0x00A9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s019", work_offset2=0*)
 19: 0x00BA [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 23: 0x00D0 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 24: 0x00DF [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="thk2")
 25: 0x00EC [0x1C] WAIT(30* ticks)
 26: 0x00EF [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 27: 0x00FE [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s021", work_offset2=0*)
 ...
 37: 0x012F [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 38: 0x013E [0x45] LOAD_SCHEDULED_TASK(work_offset1=90*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s105", work_offset2=0*)
 ...
 47: 0x0176 [0x45] LOAD_SCHEDULED_TASK(work_offset1=90*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s106", work_offset2=0*)
 48: 0x0187 [0x01] GOTO 0x01B7

SUBROUTINE_018A:
 49: 0x018A [0x02] IF !(Work_Zone[9] == 6*) GOTO 0x01A6
 50: 0x0192 [0x45] LOAD_SCHEDULED_TASK(work_offset1=90*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s106", work_offset2=0*)
 51: 0x01A3 [0x01] GOTO 0x01B7

SUBROUTINE_01A6:
 52: 0x01A6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s022", work_offset2=0*)
 ...
 59: 0x01D0 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 60: 0x01DF [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s021", work_offset2=0*)
...
SUBROUTINE_0248:
 80: 0x0248 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 81: 0x0259 [0x1C] WAIT(60* ticks)
 82: 0x025C [0x46] CAMERA_CONTROL: Restore default settings
 83: 0x025E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
