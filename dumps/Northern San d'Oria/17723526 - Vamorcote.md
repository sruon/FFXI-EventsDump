...
| [651](#event-651)          | 0x0120       |     33 |             12 |
| [65535.20](#event-6553520) | 0x0141       |     14 |              4 |
| [654](#event-654)          | 0x014F       |     93 |             20 |
| [65535.21](#event-6553521) | 0x01AC       |     23 |              7 |
| [65535.22](#event-6553522) | 0x01C3       |     19 |              5 |
| [65535.23](#event-6553523) | 0x01D6       |     19 |              5 |
| [65535.24](#event-6553524) | 0x01E9       |      9 |              5 |
| [65535.25](#event-6553525) | 0x01F2       |      5 |              3 |
| [65535.26](#event-6553526) | 0x01F7       |     19 |              5 |
| [655](#event-655)          | 0x020A       |     19 |             10 |
| [658](#event-658)          | 0x021D       |     92 |             16 |
| [65535.27](#event-6553527) | 0x0279       |     19 |              5 |
| [65535.28](#event-6553528) | 0x028C       |      5 |              3 |
| [65535.29](#event-6553529) | 0x0291       |     37 |              9 |
| [659](#event-659)          | 0x02B6       |     43 |             12 |
...
- **7248**: We have a Blacksmiths' Guild and a Carpenters' Guild here in Northern San d'Oria.
- **7249**: Their halls are open to the public, but do not interfere with their work.
- **7252**: Hrmm... Have you heard about $1?
- **7253**: Seems the royal family and the church all think I gave up my copy of the floor plans. But I've kept mine safe, I swear it!
- **7254**: Still, these rumors do have me worried. The guild elders have always kept the plans locked away. But we do not possess the key!
- **7255**: Hrrm... You seem a trustworthy adventurer. Might I ask you a favor?
- **7256**: There is a small island to the south of Batallia Downs, surrounded by steep cliffs. I've heard that $2 is buried there.
- **7257**: I would be most grateful if you could bring me that key.
- **7258**: Accept his request? [Of course./Not now.]
- **7259**: It's on the island south of Batallia Downs. Don't ask me how to get there, for I do not know.
- **7260**: What a world! I had little faith in our youth before, but now...
- **7261**: The floor plans should be here, locked inside. We need that $2 to open it and ensure the plans are safe!
- **7262**: Search for the key on the island south of Batallia Downs. I've no idea how to get there, so ask me not!
- **7265**: I wonder if this really is the key to that old box, eh?
- **7266**: Ah! It opened! And inside...?
- **7267**: There it is! Our section of the plans, safe and sound. I smell a rat in the clergy...or perhaps the royal household?
- **7268**: No, forget what I just said. Here is your reward; may it serve you well in your adventures.
- **7269**: Our piece of the plans was safe. I smell a rat in the clergy...or perhaps the royal household?
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0140:    32 05 80 1F 00 06 80  07 80 08 80 1F 01 00      2............. 
```
...
```
  ...
  1: 0x0144 [0x1F] MOVE_ENTITY: EventEntity moves to X=-137.109*, Z=159.264*, Y=11.999*
...
```
  ...
  7: 0x0172 [0x24] CREATE_DIALOG(message_id=7258*, default_option=0*, option_flags=0*)
...
```
  ...
  1: 0x01B3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7252*)
    → "Hrmm... Have you heard about $1?"
  2: 0x01B6 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x01B7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7253*)
...
```
  ...
  1: 0x01CA [0x1D] PRINT_EVENT_MESSAGE(message_id=7254*)
...
```
  ...
  1: 0x01DD [0x1D] PRINT_EVENT_MESSAGE(message_id=7255*)
...
```
  0: 0x01E9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7256*)
  ...
  2: 0x01ED [0x1D] PRINT_EVENT_MESSAGE(message_id=7257*)
...
```
  0: 0x01F2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7259*)
...
```
  ...
  1: 0x01FE [0x1D] PRINT_EVENT_MESSAGE(message_id=7260*)
...
```
  ...
  3: 0x0211 [0x1D] PRINT_EVENT_MESSAGE(message_id=7261*)
  ...
  5: 0x0215 [0x1D] PRINT_EVENT_MESSAGE(message_id=7262*)
...
```
  ...
  3: 0x0227 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
  ...
  9: 0x0249 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi1" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
 ...
 12: 0x0264 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "qstc" with entities [LocalPlayer, LocalPlayer], work=[201*, 0*]
...
```
  ...
  1: 0x0280 [0x1D] PRINT_EVENT_MESSAGE(message_id=7265*)
...
```
  0: 0x028C [0x1D] PRINT_EVENT_MESSAGE(message_id=7266*)
...
```
  ...
  1: 0x0298 [0x1D] PRINT_EVENT_MESSAGE(message_id=7267*)
  ...
  5: 0x02AA [0x1D] PRINT_EVENT_MESSAGE(message_id=7268*)
...
```
  ...
  4: 0x02C4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7269*)
