...
```
  ...
  3: 0x0188 [0x5B] LOAD_EXT_SCHEDULER(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  4: 0x0197 [0x1D] PRINT_EVENT_MESSAGE(message_id=11353*)
    → "I await your offering.\u007F1\u0000\u0007"
  5: 0x019A [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x019B [0x5B] LOAD_EXT_SCHEDULER(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
  7: 0x01AA [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
  8: 0x01B7 [0x1C] WAIT(60* ticks)
  9: 0x01BA [0x5B] LOAD_EXT_SCHEDULER(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="ino0")
 ...
 12: 0x01CD [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="ino0")
