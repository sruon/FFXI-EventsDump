...
```
  0: 0x00F3 [0x5B] LOAD_EXT_SCHEDULER(work_offset=96*, entity1=EventEntity, entity2=EventEntity, action="tlb0")
  ...
  3: 0x0106 [0x5B] LOAD_EXT_SCHEDULER(work_offset=96*, entity1=EventEntity, entity2=EventEntity, action="tlb1")
  4: 0x0115 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlb1")
