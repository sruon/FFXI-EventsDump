...
- **18348**: <Glare>... There is no denying your skill and experience. I deem you worthy.
- **18349**: The adversaries that once vexed you and your companions are now but specks of settled dust on your trail of conquest. However, I can make them worth battling once more.
- **18350**: <Glare>... In exchange, I require a vessel containing your memories and something you adventurers refer to as "merit points."
- **18351**: Life is finite and fleeting. How will you spend the rest of what remains to you?
- **18352**: What will you do? [Let time pass by idly./Exchange merit points./View accomplishments 1./View accomplishments 2.]
- **18353**: Exchange for what? ($0 point[/s]) [Nothing./$3. ($17)/$3. ($18)/$3. ($19)/$3. ($20)/$3. ($21)/$3. ($22)/$3. ($23)/$3. ($24)/$3. ($25)/$3. ($26)/$3. ($27)/$3. ($28)/$3. ($29)/$3. ($30)/$3. ($31)/$3. ($ )/Previous page./Next page.]
- **18354**: Truly relinquish $0 merit point[/s]? [Yes./No.]
- **18356**: <Glare>... If all you covet is peace, then I have nothing further to discuss with you.
- **18358**: Make for the territory to which your phantom gem belongs.
- **18359**: It is there that your desires shall be fulfilled.
- **18360**: Be not so cavalier to think that your success is assured, however. Those with no heart show no mercy. Challenge them without just resolve, and your bout will surely end in failure.
- **18361**: Contained within are the annals of your encounters with the world's most vicious foes.
- **18362**: Current accomplishments: [My business here is finished./$26Ark Angel 1. ([Unfinished/Conquered/Honors])/$26Ark Angel 2. ([Unfinished/Conquered/Honors])/$26Ark Angel 3. ([Unfinished/Conquered/Honors])/$26Ark Angel 4. ([Unfinished/Conquered/Honors])/$26Ark Angel 5. ([Unfinished/Conquered/Honors])/$26Divine Might. ([Unfinished/Conquered/Honors])/$26R. to Delkfutt's Tower. ([Unfinished/Conquered/Honors])/$26Celestial Nexus. ([Unfinished/Conquered/Honors])/$26The Savage. ([Unfinished/Conquered/Honors])/$26The Warrior's Path. ([Unfinished/Conquered/Honors])/$26Puppet in Peril. ([Unfinished/Conquered/Honors])/$26Legacy of the Lost. ([Unfinished/Conquered/Honors])/$26The Shadow Lord Battle. ([Unfinished/Conquered/Honors])/$26Head Wind. ([Unfinished/Conquered/Honors])/$26Trial by Fire. ([Unfinished/Conquered/Honors])/$26Trial by Ice. ([Unfinished/Conquered/Honors])/$26Trial by Wind. ([Unfinished/Conquered/Honors])/$26Trial by Earth. ([Unfinished/Conquered/Honors])/$26Trial by Lightning. ([Unfinished/Conquered/Honors])/$26Trial by Water. ([Unfinished/Conquered/Honors])/$26The Moonlit Path. ([Unfinished/Conquered/Honors])/$26Waking the Beast. ([Unfinished/Conquered/Honors])/$26Waking Dreams. ([Unfinished/Conquered/Honors])/$26One to Be Feared. ([Unfinished/Conquered/Honors])/$26Dawn. ([Unfinished/Conquered/Honors])]
- **18363**: Current accomplishments: [My business here is finished./$26A Stygian Pact. ([Unfinished/Conquered/Honors])/$26Champion of the Dawn. ([Unfinished/Conquered/Honors])/$26Divine Interference. ([Unfinished/Conquered/Honors])/$26Maiden of the Dusk. ([Unfinished/Conquered/Honors])/$26The Wyrm God. ([Unfinished/Conquered/Honors])/$26The Orb's Radiance. ([Unfinished/Conquered/Honors])]
- **18364**: Hmph. It seems you [are hardly fit to be disemboweled by these fiends, so superior are they to you/can hold your own against these colossi of combat/have transcended even these ferocities and reign over all with an iron fist].
...
```
 ...
 19: 0x0048 [0x1D] PRINT_EVENT_MESSAGE(message_id=18351*)
...
SUBROUTINE_004C:
 ...
 26: 0x0057 [0x1D] PRINT_EVENT_MESSAGE(message_id=18350*)
...
SUBROUTINE_0091:
 ...
 39: 0x0099 [0x24] CREATE_DIALOG(message_id=18352*, default_option=0*, option_flags=ExtData[1]->WorkLocal[1])
...
SUBROUTINE_00F0:
 ...
 61: 0x00F6 [0x1D] PRINT_EVENT_MESSAGE(message_id=18361*)
 ...
 65: 0x0105 [0x24] CREATE_DIALOG(message_id=18362*, default_option=ExtData[1]->WorkLocal[5], option_flags=0*)
...
SUBROUTINE_011B:
 ...
 76: 0x013D [0x1D] PRINT_EVENT_MESSAGE(message_id=18364*)
...
SUBROUTINE_0142:
 ...
 81: 0x0148 [0x1D] PRINT_EVENT_MESSAGE(message_id=18361*)
    → "Contained within are the annals of your encounters with the world's most vicious foes."
 ...
 85: 0x0157 [0x24] CREATE_DIALOG(message_id=18363*, default_option=ExtData[1]->WorkLocal[5], option_flags=0*)
...
SUBROUTINE_016D:
 ...
 96: 0x0191 [0x1D] PRINT_EVENT_MESSAGE(message_id=18364*)
    → "Hmph. It seems you [are hardly fit to be disemboweled by these fiends, so superior are they to you/can hold your own against these colossi of combat/have transcended even these ferocities and reign over all with an iron fist]."
...
120: 0x01F6 [0x24] CREATE_DIALOG(message_id=18353*, default_option=ExtData[1]->WorkLocal[5], option_flags=ExtData[1]->WorkLocal[3])
...
148: 0x0283 [0x24] CREATE_DIALOG(message_id=18354*, default_option=1*, option_flags=0*)
...
157: 0x02B6 [0x1D] PRINT_EVENT_MESSAGE(message_id=18356*)
