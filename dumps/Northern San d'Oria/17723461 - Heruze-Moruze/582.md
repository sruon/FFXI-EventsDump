...
```
  ...
  8: 0x001A [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s080", work_offset2=0*)
  9: 0x002B [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 ...
 12: 0x004A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 13: 0x005B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 14: 0x006A [0x1D] PRINT_EVENT_MESSAGE(message_id=11461*)
    → "You've come on orders from the homeland, have you? You should speak with Consul Kasaroro.\u007F1\u0000\u0007"
 ...
 18: 0x0076 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s081", work_offset2=0*)
 ...
 26: 0x00B5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s082", work_offset2=0*)
 ...
 29: 0x00D3 [0x55] WAIT_LOAD_SCHEDULER(work_offset=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s082")
 30: 0x00E2 [0x1C] WAIT(30* ticks)
 31: 0x00E5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s083", work_offset2=0*)
 ...
 38: 0x0116 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s084", work_offset2=0*)
 ...
 42: 0x0137 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s085", work_offset2=0*)
 ...
 49: 0x0168 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s086", work_offset2=0*)
 ...
 61: 0x01B3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=131*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s087", work_offset2=0*)
 ...
 74: 0x0207 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 ...
 79: 0x0223 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 ...
 88: 0x03F7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=762*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s064", work_offset2=0*)
 ...
 93: 0x041C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 94: 0x042D [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
...
103: 0x0478 [0x45] LOAD_SCHEDULED_TASK(work_offset1=762*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s065", work_offset2=0*)
104: 0x0489 [0x1C] WAIT(15* ticks)
105: 0x048C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
106: 0x049D [0x5B] LOAD_EXT_SCHEDULER(work_offset=99*, entity1=Lion (ID: 17723463/0x010E7047), entity2=Lion (ID: 17723463/0x010E7047), action="yes0")
...
109: 0x04B4 [0x5B] LOAD_EXT_SCHEDULER(work_offset=538*, entity1=Lion (ID: 17723463/0x010E7047), entity2=Lion (ID: 17723463/0x010E7047), action="tl40")
...
113: 0x04DA [0x45] LOAD_SCHEDULED_TASK(work_offset1=762*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s066", work_offset2=0*)
...
119: 0x050A [0x45] LOAD_SCHEDULED_TASK(work_offset1=762*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s067", work_offset2=0*)
120: 0x051B [0x5B] LOAD_EXT_SCHEDULER(work_offset=538*, entity1=Lion (ID: 17723463/0x010E7047), entity2=Lion (ID: 17723463/0x010E7047), action="tl41")
...
127: 0x0550 [0x45] LOAD_SCHEDULED_TASK(work_offset1=762*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s068", work_offset2=0*)
...
```
# Data Section: 0x0236 (406 bytes)
     0x0236: 27 05 40 70 0E 01 11 6E F0 FF FF 7F 0A 80 99 F0
     0x0246: FF FF 7F 1C 0B 80 2A 05 40 70 0E 01 52 03 80 F0
     0x0256: FF FF 7F F0 FF FF 7F 73 30 33 32 45 0C 80 F8 FF
     0x0266: FF 7F F8 FF FF 7F 73 30 35 39 04 80 4A 40 70 0E
     0x0276: 01 F0 FF FF 7F 1C 08 80 2B 40 70 0E 01 0D 80 23
     0x0286: 45 05 80 F0 FF FF 7F F0 FF FF 7F 66 64 6F 31 04
     0x0296: 80 55 05 80 F0 FF FF 7F F0 FF FF 7F 66 64 6F 31
     0x02A6: 52 0C 80 F8 FF FF 7F F8 FF FF 7F 73 30 35 39 BA
     0x02B6: F0 FF FF 7F 0E 80 0F 80 10 80 11 80 80 F0 FF FF
     0x02C6: 7F 4A F0 FF FF 7F 40 70 0E 01 4A 40 70 0E 01 F0
     0x02D6: FF FF 7F 1C 02 80 48 12 80 1C 13 80 45 0C 80 F8
     0x02E6: FF FF 7F F8 FF FF 7F 73 30 36 30 04 80 1C 14 80
     0x02F6: 45 05 80 F0 FF FF 7F F0 FF FF 7F 66 64 69 31 04
     0x0306: 80 5B 15 80 40 70 0E 01 40 70 0E 01 79 65 73 30
     0x0316: 2B 40 70 0E 01 16 80 23 5B 17 80 40 70 0E 01 40
     0x0326: 70 0E 01 74 6C 34 30 2B 40 70 0E 01 18 80 23 52
     0x0336: 0C 80 F8 FF FF 7F F8 FF FF 7F 73 30 36 30 45 0C
     0x0346: 80 F8 FF FF 7F F8 FF FF 7F 73 30 36 31 04 80 2B
     0x0356: 40 70 0E 01 19 80 23 2B 40 70 0E 01 1A 80 23 52
     0x0366: 0C 80 F8 FF FF 7F F8 FF FF 7F 73 30 36 31 45 0C
     0x0376: 80 F8 FF FF 7F F8 FF FF 7F 73 30 36 32 04 80 5B
     0x0386: 17 80 40 70 0E 01 40 70 0E 01 74 6C 34 31 2B 40
     0x0396: 70 0E 01 1B 80 23 6E F0 FF FF 7F 1C 80 99 F0 FF
     0x03A6: FF 7F 1C 0B 80 52 0C 80 F8 FF FF 7F F8 FF FF 7F
     0x03B6: 73 30 36 32 45 0C 80 F8 FF FF 7F F8 FF FF 7F 73
     0x03C6: 30 36 33 04 80 1B
```