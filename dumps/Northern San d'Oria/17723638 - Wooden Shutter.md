...
- **13307**: Head for Carpenters' Landing? [Yes./No.]
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=13307*, default_option=1*, option_flags=0*)
    → "Head for Carpenters' Landing? [Yes./No.]"
