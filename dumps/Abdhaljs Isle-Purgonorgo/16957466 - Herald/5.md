...
```
 ...
 11: 0x0578 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x01, bit_index_work_offset=0x8000, condition_work_offset=0x8000)

SUBROUTINE_057F:
 12: 0x057F [0x3E] IF !(ExtData[1]->WorkLocal[32] bit 1*) GOTO 0x0589
 13: 0x0586 [0x01] GOTO 0x0590
 14: 0x0589 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x01, bit_index_work_offset=0x8001, condition_work_offset=0x8000)

SUBROUTINE_0590:
 15: 0x0590 [0x02] IF !(ExtData[1]->WorkLocal[31] < 1*) GOTO 0x05E0
 16: 0x0598 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x01, bit_index_work_offset=0x8000, condition_work_offset=0x8000)
...
SUBROUTINE_05CD:
 ...
 28: 0x05D9 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x01, bit_index_work_offset=0x800E, condition_work_offset=0x8000)
 29: 0x05E0 [0x02] IF !(ExtData[1]->WorkLocal[44] < 5*) GOTO 0x05EF
 30: 0x05E8 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x01, bit_index_work_offset=0x800E, condition_work_offset=0x8000)
 31: 0x05EF [0x02] IF !(ExtData[1]->WorkLocal[1] == 14*) GOTO 0x0673
 32: 0x05F7 [0x24] CREATE_DIALOG(message_id=7352*, default_option=0*, option_flags=0x01)
