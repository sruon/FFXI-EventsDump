...
- **7336**: Teleport to [Upper Jeuno/Aht Urhgan Whitegate/Northern San d'Oria/3/Port Bastok/5/Windurst Waters]? [Yes./No.]
...
```
  ...
  4: 0x000A [0x24] CREATE_DIALOG(message_id=7336*, default_option=1*, option_flags=0*)
