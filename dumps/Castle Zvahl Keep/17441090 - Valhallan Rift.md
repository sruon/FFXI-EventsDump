...
- **7327**: [Apply to proceed/Proceed]? [Definitely!/Not yet.]
- **7338**: You will be able to call forth up to $4 alter ego[/s] given the current number of players in your party.
- **7345**: Prepare yourselves! The battlefield is almost ready!
- **7346**: Your number: $3. (Auto-transport: [off/on]) [Remove your name./Toggle auto-transport./Close dialogue.]
- **7358**: Debug menu. [Check information./View applicants./Applicant parameters./Change maximum limit./Clear applications./Automatically create./Close dialogue.]
- **7367**: Designate a value between $0 and $1.
- **7378**: $)$P13.$P106$P10, $P13.$lF$0 [1"/%<$P15{/$~_i/$m$P14F/$3$43308646i]
- **7390**: Enter which? (Auto-transport: [Off/On].) [Never mind./Duke Alloces's Decision./The Voracious Beast (G-H)./The Voracious Beast (Chaos)./Wings of War././././././././././././Toggle Auto-transport.]
- **7391**: Only party members present with you in this area will be transported to [/Duke Alloces's Decision/The Voracious Beast (Garazu-Horeizu)/The Voracious Beast (Chaos)/Wings of War][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
...
- **7393**: You have chosen not to [apply to/enter] [/Duke Alloces's Decision/The Voracious Beast (Garazu-Horeizu)/The Voracious Beast (Chaos)/Wings of War][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **7396**: Applying to enter [/Duke Alloces's Decision/The Voracious Beast (Garazu-Horeizu)/The Voracious Beast (Chaos)/Wings of War][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy]. You will be unable to participate if you add any more party members. Are you sure?
- **7397**: You are currently applying to enter [/Duke Alloces's Decision/The Voracious Beast (Garazu-Horeizu)/The Voracious Beast (Chaos)/Wings of War][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **7399**: Your registration number for entering this nightmare is $3.
- **7400**: You feel immense pressure coming from the vicinity. IDs up through $3 have been registered, and ID $2 is currently ready.
...
```
 ...
 13: 0x003F [0x24] CREATE_DIALOG(message_id=7390*, default_option=0*, option_flags=ExtData[1]->WorkLocal[7])
...
SUBROUTINE_00D3:
 ...
 46: 0x00E6 [0x24] CREATE_DIALOG(message_id=7327*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0157:
 ...
 16: 0x0178 [0x24] CREATE_DIALOG(message_id=7346*, default_option=1*, option_flags=0*)
...
```
  ...
  6: 0x01BB [0x24] CREATE_DIALOG(message_id=7327*, default_option=0*, option_flags=0*)
    → "[Apply to proceed/Proceed]? [Definitely!/Not yet.]"
...
```
  ...
  3: 0x0214 [0x24] CREATE_DIALOG(message_id=7358*, default_option=0*, option_flags=0*)
 ...
 44: 0x02CD [0x24] CREATE_DIALOG(message_id=7378*, default_option=0*, option_flags=0*)
