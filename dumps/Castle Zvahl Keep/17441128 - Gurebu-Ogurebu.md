...
| [65535.99](#event-6553599)   | 0x0625       |     16 |              2 |
| [65535.100](#event-65535100) | 0x0635       |     14 |              2 |
| [65535.101](#event-65535101) | 0x0643       |     16 |              2 |
| [65535.102](#event-65535102) | 0x0653       |     14 |              2 |
| [126](#event-126)            | 0x0661       |      7 |              2 |
| [127](#event-127)            | 0x0668       |      7 |              2 |
| [65535.103](#event-65535103) | 0x066F       |     21 |              2 |
| [65535.104](#event-65535104) | 0x0684       |     21 |              2 |
| [65535.105](#event-65535105) | 0x0699       |      7 |              3 |
| [65535.106](#event-65535106) | 0x06A0       |      7 |              3 |
| [65535.107](#event-65535107) | 0x06A7       |     15 |              5 |
| [65535.108](#event-65535108) | 0x06B6       |     29 |              3 |
| [65535.109](#event-65535109) | 0x06D3       |     22 |              8 |
| [65535.110](#event-65535110) | 0x06E9       |     10 |              2 |
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0650:          53 F8 FF FF 7F  F8 FF FF 7F 73 72 64 31     S........srd1
0660: 00                                                .               
```
...
```
  0: 0x0653 [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "srd1" with entities [EventEntity, EventEntity]
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0690:                             AB 03 AC 01 04 80 00           .......
```

#### Opcodes

```
  0: 0x0699 [0xAB] EventEntity->Render.Flags0 ^= 0x20000 // Toggle bit 17
  1: 0x069B [0xAC] EventEntity->StatusEvent = 1*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
06D0:          32 00 80 1F 00  1F 80 20 80 21 80 1F 01     2...... .!...
06E0: 6F 1E F0 FF FF 7F 6F 70  00                       o.....op.       
```
...
```
  ...
  1: 0x06D6 [0x1F] MOVE_ENTITY: EventEntity moves to X=7.377*, Z=3.160*, Y=-7.199*
  2: 0x06DE [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x06E0 [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
  4: 0x06E1 [0x1E] EventEntity looks at LocalPlayer and starts talking
  5: 0x06E6 [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
  6: 0x06E7 [0x70] WAIT_ENTITY_RENDER_FLAG: Wait while EventEntity->Render.Flags3 bit 2 is set (cancel turn if not)
  7: 0x06E8 [0x00] END_REQSTACK()
```
