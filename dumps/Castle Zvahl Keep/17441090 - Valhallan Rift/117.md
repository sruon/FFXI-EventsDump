...
SUBROUTINE_00C1:
 32: 0x00C1 [0x3E] IF !(ExtData[1]->WorkLocal[12] bit ExtData[1]->WorkLocal[1]) GOTO 0x00CB
 33: 0x00C8 [0x01] GOTO 0x00D3
 34: 0x00CB [0x03] Work_Zone[6] = ExtData[1]->WorkLocal[11]
 35: 0x00D0 [0x48] [System] [7335*]:
    → "You will be able to call forth up to 
\u0004 alter ego\u007F\u0012\u0004[/s] given the current number of players in your party.\u007F1\u0000\u0007"
 36: 0x00D3 [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[1]
 37: 0x00D8 [0x03] Work_Zone[4] = ExtData[1]->WorkLocal[3]
 38: 0x00DD [0x48] [System] [7393*]:
 ...
 40: 0x00E1 [0x03] Work_Zone[3] = 0*
 41: 0x00E6 [0x24] CREATE_DIALOG(message_id=7324*, default_option=0*, option_flags=0*)
    → "\u000C\u0001[Apply to proceed/Proceed]?\u0007\u000BDefinitely!\u0007Not yet.\u007F1\u0000\u0007"
 42: 0x00ED [0x25] WAIT_DIALOG_SELECT()
 43: 0x00EE [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x011F
 44: 0x00F6 [0x03] Work_Zone[1] = 0*
 45: 0x00FB [0x40] SET_BIT_WORK_RANGE(start_bit=0*, end_bit=11*, target=Work_Zone[1], source=ExtData[1]->WorkLocal[1])
 46: 0x0104 [0x40] SET_BIT_WORK_RANGE(start_bit=14*, end_bit=16*, target=Work_Zone[1], source=ExtData[1]->WorkLocal[3])
 47: 0x010D [0x43] SEND_EVENT_UPDATE: Send pending tag to server (packet 0x005B)
 48: 0x010F [0x43] SEND_EVENT_UPDATE: Check pending flag (skip if not pending)
 49: 0x0111 [0x02] IF !(Work_Zone[9] == 0*) GOTO 0x011C
 50: 0x0119 [0x01] GOTO 0x00C1
 51: 0x011C [0x01] GOTO 0x0138
 52: 0x011F [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[1]
 53: 0x0124 [0x03] Work_Zone[3] = 0*
 54: 0x0129 [0x03] Work_Zone[4] = ExtData[1]->WorkLocal[3]
 55: 0x012E [0x48] [System] [7390*]:
 ...
 56: 0x0131 [0x03] Work_Zone[1] = 1073741824*
 57: 0x0136 [0x21] END_EVENT
 58: 0x0137 [0x00] END_REQSTACK()
