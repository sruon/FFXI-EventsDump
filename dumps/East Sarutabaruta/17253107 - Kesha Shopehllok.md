...
- **7532**: $0 point[/s]'ll get ya some fan-dangled fans. There are two types, "festive" and "summer."
...
- **7545**: You have $0 point[/s]. [$1: $2./A bag o' fireworks: $3./Large fans: $6./A colored drop: $4./1 $11: $12./The mystery box: $5./A stellar surprise: $9./The other mystery box: $7./Yet another mystery box: $8./Mystery box part four: $10./Nothing.]
...
- **7567**: 3gI1jb$6423146A=g$4457013H\`B
...
```
  ...
  5: 0x001B [0x24] CREATE_DIALOG(message_id=7516*, default_option=0*, option_flags=0*)
  ...
  8: 0x002B [0x1D] PRINT_EVENT_MESSAGE(message_id=7517*)
...
SUBROUTINE_0063:
 ...
 27: 0x007B [0x1D] PRINT_EVENT_MESSAGE(message_id=7537*)
 ...
 32: 0x008C [0x1D] PRINT_EVENT_MESSAGE(message_id=7538*)
    → "Ya lost your $0!?"
 33: 0x008F [0x23] WAIT_FOR_DIALOG_INTERACTION
 34: 0x0090 [0x1D] PRINT_EVENT_MESSAGE(message_id=7539*)
 ...
 36: 0x0094 [0x24] CREATE_DIALOG(message_id=7540*, default_option=0*, option_flags=0*)
    → "Start over from the top? [No way!/You bet!]"
 37: 0x009B [0x25] WAIT_DIALOG_SELECT()
 38: 0x009C [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x00AB
 39: 0x00A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7541*)
 ...
 43: 0x00B3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7542*)
...
SUBROUTINE_00BF:
 ...
 49: 0x00C7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7543*)
...
SUBROUTINE_00F7:
 ...
 64: 0x00FA [0x24] CREATE_DIALOG(message_id=7520*, default_option=0*, option_flags=0*)
 ...
 69: 0x0114 [0x1D] PRINT_EVENT_MESSAGE(message_id=7521*)
 ...
 71: 0x0118 [0x1D] PRINT_EVENT_MESSAGE(message_id=7522*)
...
SUBROUTINE_01D1:
 ...
 90: 0x0218 [0x24] CREATE_DIALOG(message_id=7545*, default_option=0*, option_flags=ExtData[1]->WorkLocal[1])
...
124: 0x02CD [0x1D] PRINT_EVENT_MESSAGE(message_id=7550*)
...
131: 0x02E5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7547*)
    → "Are ya sure that's what ya want?"
132: 0x02E8 [0x23] WAIT_FOR_DIALOG_INTERACTION
133: 0x02E9 [0x24] CREATE_DIALOG(message_id=7548*, default_option=0*, option_flags=0*)
...
138: 0x031A [0x1D] PRINT_EVENT_MESSAGE(message_id=7546*)
...
```
 ...
 10: 0x0344 [0x1D] PRINT_EVENT_MESSAGE(message_id=7553*)
    → "Wow... I'll give ya $0 point[/s] for all of these."
 11: 0x0347 [0x23] WAIT_FOR_DIALOG_INTERACTION
 12: 0x0348 [0x1D] PRINT_EVENT_MESSAGE(message_id=7556*)
 ...
 15: 0x034F [0x1D] PRINT_EVENT_MESSAGE(message_id=7554*)
 ...
 17: 0x0353 [0x1D] PRINT_EVENT_MESSAGE(message_id=7557*)
