...
- **7465**: <Player> dipped the $3 in the curious waters of Lake Tepokalipuka...
- **7466**: The $3 now shimmers a brilliant shade of green!
...
```
  ...
  4: 0x0018 [0x03] Work_Zone[2] = 1166*
  5: 0x001D [0x48] [System] [7465*]:
    → "<Player> dipped the $3 in the curious waters of Lake Tepokalipuka..."
  6: 0x0020 [0x1C] WAIT(180* ticks)
  7: 0x0023 [0x48] [System] [7466*]:
    → "The $3 now shimmers a brilliant shade of green!"
