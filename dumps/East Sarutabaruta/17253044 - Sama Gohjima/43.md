...
```
  ...
  3: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=7409*)
    → "This is the east magic towerrr. Beneath here lies the Horutoto Ruins that have existed here in Sarutabaruta long beforrre Windurst even came into existence.\u007F1\u0000\u0007"
