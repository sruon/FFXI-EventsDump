...
| [9](#event-9)              | 0x01BE       |      1 |              1 |
| [65535.30](#event-6553530) | 0x01BF       |     22 |              8 |
| [65535.31](#event-6553531) | 0x01D5       |     22 |              8 |
| [65535.32](#event-6553532) | 0x01EB       |     25 |              7 |
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
01B0:                                               32                 2
01C0: 04 80 1F 00 05 80 06 80  07 80 1F 01 6F 1E 1D B0  ............o...
01D0: 11 01 6F 70 00                                    ..op.           
```
...
```
  ...
  1: 0x01C2 [0x1F] MOVE_ENTITY: EventEntity moves to X=-38.350*, Z=32.739*, Y=1.349*
  2: 0x01CA [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x01CC [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
  4: 0x01CD [0x1E] EventEntity looks at Dazbog (ID: 17936413/0x0111B01D) and starts talking
  5: 0x01D2 [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
  6: 0x01D3 [0x70] WAIT_ENTITY_RENDER_FLAG: Wait while EventEntity->Render.Flags3 bit 2 is set (cancel turn if not)
  7: 0x01D4 [0x00] END_REQSTACK()
```
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
01D0:                32 08 80  1F 00 09 80 0A 80 07 80       2..........
01E0: 1F 01 6F 1E F0 FF FF 7F  6F 70 00                 ..o.....op.     
```
...
```
  ...
  1: 0x01D8 [0x1F] MOVE_ENTITY: EventEntity moves to X=-38.783*, Z=32.171*, Y=1.349*
  2: 0x01E0 [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x01E2 [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
  4: 0x01E3 [0x1E] EventEntity looks at LocalPlayer and starts talking
  5: 0x01E8 [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
  6: 0x01E9 [0x70] WAIT_ENTITY_RENDER_FLAG: Wait while EventEntity->Render.Flags3 bit 2 is set (cancel turn if not)
