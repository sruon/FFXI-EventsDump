...
- **7246**: The minstrel of melodies is my name, For a mere $6 gil I'll recall your past. Your stories of love, anger, triumph, and shame, The river of memories runs deep and vast.
- **7247**: The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last.
- **7249**: Which memory will you have recalled? [None./Additional scenarios.]
- **7250**: Which memory will you have recalled? [None./Skokkr Undrborn's Temptation(pt.1)./Skokkr Undrborn's Temptation(pt.2)./Skokkr Undrborn's Temptation(pt.3).]
- **7251**: Which memory will you have recalled? [None./]
- **7252**: Which memory will you have recalled? [None./]
- **7253**: Which memory will you have recalled? [None./]
- **7254**: Which memory will you have recalled? [None./]
- **7255**: Which memory will you have recalled? [None./]
...
```
  ...
  3: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=7247*)
 ...
 21: 0x0088 [0x1D] PRINT_EVENT_MESSAGE(message_id=7247*)
    → "The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last."
 22: 0x008B [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x008C [0x21] END_EVENT
 24: 0x008D [0x00] END_REQSTACK()
 25: 0x008E [0x1D] PRINT_EVENT_MESSAGE(message_id=7246*)
 ...
 39: 0x00D4 [0x24] CREATE_DIALOG(message_id=7249*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
    → "Which memory will you have recalled? [None./Additional scenarios.]"
 40: 0x00DB [0x25] WAIT_DIALOG_SELECT()
 41: 0x00DC [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x010B

SUBROUTINE_00E4:
 42: 0x00E4 [0x24] CREATE_DIALOG(message_id=7250*, default_option=0*, option_flags=Work_Zone[2])
    → "Which memory will you have recalled? [None./Skokkr Undrborn's Temptation(pt.1)./Skokkr Undrborn's Temptation(pt.2)./Skokkr Undrborn's Temptation(pt.3).]"
...
SUBROUTINE_0113:
 50: 0x0113 [0x24] CREATE_DIALOG(message_id=7251*, default_option=0*, option_flags=Work_Zone[3])
...
SUBROUTINE_0142:
 58: 0x0142 [0x24] CREATE_DIALOG(message_id=7252*, default_option=0*, option_flags=Work_Zone[4])
    → "Which memory will you have recalled? [None./]"
...
SUBROUTINE_0171:
 66: 0x0171 [0x24] CREATE_DIALOG(message_id=7253*, default_option=0*, option_flags=Work_Zone[5])
    → "Which memory will you have recalled? [None./]"
...
SUBROUTINE_01A0:
 74: 0x01A0 [0x24] CREATE_DIALOG(message_id=7254*, default_option=0*, option_flags=Work_Zone[6])
    → "Which memory will you have recalled? [None./]"
...
SUBROUTINE_01CF:
 82: 0x01CF [0x24] CREATE_DIALOG(message_id=7255*, default_option=0*, option_flags=Work_Zone[7])
    → "Which memory will you have recalled? [None./]"
