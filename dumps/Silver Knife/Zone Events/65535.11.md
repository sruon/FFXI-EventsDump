...
```
  ...
  1: 0x0151 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=149*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  2: 0x0160 [0x01] GOTO 0x0219

SUBROUTINE_0163:
  3: 0x0163 [0x02] IF !(Entity->Race == 2*) GOTO 0x017D
  4: 0x016B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=159*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  5: 0x017A [0x01] GOTO 0x0219

SUBROUTINE_017D:
  6: 0x017D [0x02] IF !(Entity->Race == 3*) GOTO 0x0197
  7: 0x0185 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=169*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  8: 0x0194 [0x01] GOTO 0x0219

SUBROUTINE_0197:
  9: 0x0197 [0x02] IF !(Entity->Race == 4*) GOTO 0x01B1
 10: 0x019F [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=179*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 11: 0x01AE [0x01] GOTO 0x0219

SUBROUTINE_01B1:
 12: 0x01B1 [0x02] IF !(Entity->Race == 5*) GOTO 0x01CB
 13: 0x01B9 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=189*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 14: 0x01C8 [0x01] GOTO 0x0219

SUBROUTINE_01CB:
 15: 0x01CB [0x02] IF !(Entity->Race == 6*) GOTO 0x01E5
 16: 0x01D3 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=189*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 17: 0x01E2 [0x01] GOTO 0x0219

SUBROUTINE_01E5:
 18: 0x01E5 [0x02] IF !(Entity->Race == 7*) GOTO 0x01FF
 19: 0x01ED [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=199*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 20: 0x01FC [0x01] GOTO 0x0219

SUBROUTINE_01FF:
 21: 0x01FF [0x02] IF !(Entity->Race == 8*) GOTO 0x0219
 22: 0x0207 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=209*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 23: 0x0216 [0x01] GOTO 0x0219

SUBROUTINE_0219:
 24: 0x0219 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
