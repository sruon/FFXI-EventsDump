...
```
  ...
  1: 0x022F [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=149*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
  2: 0x023E [0x01] GOTO 0x02F7

SUBROUTINE_0241:
  3: 0x0241 [0x02] IF !(Entity->Race == 2*) GOTO 0x025B
  4: 0x0249 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=159*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
  5: 0x0258 [0x01] GOTO 0x02F7

SUBROUTINE_025B:
  6: 0x025B [0x02] IF !(Entity->Race == 3*) GOTO 0x0275
  7: 0x0263 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=169*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
  8: 0x0272 [0x01] GOTO 0x02F7

SUBROUTINE_0275:
  9: 0x0275 [0x02] IF !(Entity->Race == 4*) GOTO 0x028F
 10: 0x027D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=179*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 11: 0x028C [0x01] GOTO 0x02F7

SUBROUTINE_028F:
 12: 0x028F [0x02] IF !(Entity->Race == 5*) GOTO 0x02A9
 13: 0x0297 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=189*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 14: 0x02A6 [0x01] GOTO 0x02F7

SUBROUTINE_02A9:
 15: 0x02A9 [0x02] IF !(Entity->Race == 6*) GOTO 0x02C3
 16: 0x02B1 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=189*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 17: 0x02C0 [0x01] GOTO 0x02F7

SUBROUTINE_02C3:
 18: 0x02C3 [0x02] IF !(Entity->Race == 7*) GOTO 0x02DD
 19: 0x02CB [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=199*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 20: 0x02DA [0x01] GOTO 0x02F7

SUBROUTINE_02DD:
 21: 0x02DD [0x02] IF !(Entity->Race == 8*) GOTO 0x02F7
 22: 0x02E5 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=209*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 23: 0x02F4 [0x01] GOTO 0x02F7

SUBROUTINE_02F7:
 24: 0x02F7 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
