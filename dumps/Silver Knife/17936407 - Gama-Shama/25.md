...
```
  ...
  4: 0x0099 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x06, bit_index_work_offset=0x800A, condition_work_offset=0x800A)
  5: 0x00A0 [0x3E] IF !(ExtData[1]->WorkLocal[5] bit 6*) GOTO 0x00AE
  6: 0x00A7 [0x3D] CLEAR_BIT_FLAG_CONDITIONAL(target_work_offset=0x06, bit_index_work_offset=0x800A, condition_work_offset=0x800A)
 ...
 10: 0x00B5 [0x24] CREATE_DIALOG(message_id=7273*, default_option=0*, option_flags=0x06)
...
```
# Data Section: 0x01CB (78 bytes)
     0x01CB: 27 10 17 B0 11 01 58 03 02 10 03 00 03 07 00 09
     0x01DB: 80 02 07 00 15 80 05 07 02 9D 0A 22 09 08 00 07
     0x01EB: 00 0E 80 0B 08 00 02 02 10 08 00 00 01 02 0C 02
     0x01FB: 10 03 07 00 10 80 0B 07 00 01 DC 01 1D 16 80 23
     0x020B: 27 10 17 B0 11 01 5A 29 10 17 B0 11 01 5B
```