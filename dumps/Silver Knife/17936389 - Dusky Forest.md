...
- **7246**: Are you finished with your business?
- **7247**: Leave? [Yes./No.]
...
```
  ...
  4: 0x01CA [0x1D] PRINT_EVENT_MESSAGE(message_id=7246*)
    → "Are you finished with your business?"
  5: 0x01CD [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x01CE [0x24] CREATE_DIALOG(message_id=7247*, default_option=0*, option_flags=0*)
    → "Leave? [Yes./No.]"
