...
| [9](#event-9)              | 0x0481       |      7 |              2 |
| [11](#event-11)            | 0x0488       |      7 |              2 |
| [12](#event-12)            | 0x048F       |      7 |              2 |
| [65535.71](#event-6553571) | 0x0496       |     15 |              5 |
| [65535.72](#event-6553572) | 0x04A5       |     22 |              8 |
| [65535.73](#event-6553573) | 0x04BB       |     15 |              5 |
| [65535.74](#event-6553574) | 0x04CA       |     15 |              5 |
| [65535.75](#event-6553575) | 0x04D9       |     15 |              5 |
| [65535.76](#event-6553576) | 0x04E8       |     15 |              5 |
| [65535.77](#event-6553577) | 0x04F7       |     15 |              5 |
| [65535.78](#event-6553578) | 0x0506       |     37 |             11 |
...
|      11 | 0x01AF      |         431 |
|      12 | 0x002E      |          46 |
|      13 | 0xFFFF6952  |  4294928722 |
|      14 | 0x7512      |       29970 |
|      15 | 0x053A      |        1338 |
|      16 | 0xFFFF638E  |  4294927246 |
|      17 | 0x7736      |       30518 |
|      18 | 0x0545      |        1349 |
|      19 | 0xFFFF685E  |  4294928478 |
|      20 | 0x7230      |       29232 |
|      21 | 0xFFFF6827  |  4294928423 |
|      22 | 0x7A6D      |       31341 |
|      23 | 0xFFFF5B07  |  4294925063 |
|      24 | 0x7362      |       29538 |
|      25 | 0xFFFF4F34  |  4294922036 |
|      26 | 0x6694      |       26260 |
|      27 | 0xFFFFF774  |  4294965108 |
|      28 | 0xFFFFFEB6  |  4294966966 |
|      29 | 0x0000      |           0 |
|      30 | 0xFFFF63A6  |  4294927270 |
|      31 | 0x96BF      |       38591 |
|      32 | 0xFFFF6430  |  4294927408 |
|      33 | 0xB071      |       45169 |
|      34 | 0xFFFFFD77  |  4294966647 |
|      35 | 0xFFFF527C  |  4294922876 |
|      36 | 0xB58D      |       46477 |
|      37 | 0xFFFFFD6B  |  4294966635 |
...
```
  0: 0x0488 [0x92] EventEntity->Render.Flags3 ^= 0x01
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0480:                                               92                 .
0490: 01 F8 FF FF 7F 00                                 ......          
```

#### Opcodes

```
  0: 0x048F [0x92] EventEntity->Render.Flags3 ^= 0x01
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0490:                   32 08  80 1F 00 0D 80 0E 80 0F        2.........
...
```
  ...
  1: 0x0499 [0x1F] MOVE_ENTITY: EventEntity moves to X=-38.574*, Z=29.970*, Y=1.338*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
04C0:                                32 08 80 1F 00 15            2.....
04D0: 80 16 80 12 80 1F 01 6F  00                       .......o.       
```
...
```
  ...
  1: 0x04CD [0x1F] MOVE_ENTITY: EventEntity moves to X=-38.873*, Z=31.341*, Y=1.349*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
04E0:                          32 08 80 1F 00 19 80 1A          2.......
04F0: 80 12 80 1F 01 6F 00                              .....o.         
```
...
```
  ...
  1: 0x04EB [0x1F] MOVE_ENTITY: EventEntity moves to X=-45.260*, Z=26.260*, Y=1.349*
