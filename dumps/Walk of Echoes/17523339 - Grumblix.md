...
```
 ...
 30: 0x00A7 [0x24] CREATE_DIALOG(message_id=7805*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00B7:
 33: 0x00B7 [0x24] CREATE_DIALOG(message_id=7806*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_00FB:
 44: 0x00FB [0x24] CREATE_DIALOG(message_id=7807*, default_option=0*, option_flags=Work_Zone[3])
...
SUBROUTINE_013F:
 55: 0x013F [0x24] CREATE_DIALOG(message_id=7808*, default_option=0*, option_flags=Work_Zone[4])
    → ""
...
SUBROUTINE_0183:
 66: 0x0183 [0x24] CREATE_DIALOG(message_id=7809*, default_option=0*, option_flags=Work_Zone[5])
    → ""
