...
| [9206](#event-9206)   | 0x0001       |   1186 |            180 |
...
- **7833**: Proffer which item? [None of these./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./Previous page./Next page.]
- **7834**: Commence battle? [Yes./No.]
...
```
 ...
 10: 0x0028 [0x24] CREATE_DIALOG(message_id=7833*, default_option=ExtData[1]->WorkLocal[2], option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00A4:
 ...
 47: 0x00E5 [0x24] CREATE_DIALOG(message_id=7834*, default_option=1*, option_flags=0*)
...
# Dead code (unreachable instructions):
     ...
     0x0415 [0x4B] UPDATE_ENTITY_YAW(entity=Unknown NPC (ID: 1249921664/0x4A804A80), yaw=0x4A80)
     0x041C [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 2152366154/0x804A804A))
     0x0421 [0x4B] UPDATE_ENTITY_YAW(entity=Unknown NPC (ID: 1300253824/0x4D804C80), yaw=0x4E80)
