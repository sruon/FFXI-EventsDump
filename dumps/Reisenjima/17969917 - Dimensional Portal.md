...
- **7394**: You should be able to teleport to the Crag of [Holla/Dem/Mea] from here.
- **7395**: Ready to teleport? [Yes./No.]
...
```
  0: 0x0001 [0x48] [System] [7394*]:
    → "You should be able to teleport to the Crag of [Holla/Dem/Mea] from here."
  1: 0x0004 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=7395*, default_option=1*, option_flags=0*)
