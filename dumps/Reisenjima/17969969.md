...
| [9204](#event-9204)   | 0x0001       |   1186 |            180 |
...
- **7832**: Proffer which item? [None of these./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./Previous page./Next page.]
- **7833**: Commence battle? [Yes./No.]
...
```
 ...
 10: 0x0028 [0x24] CREATE_DIALOG(message_id=7832*, default_option=ExtData[1]->WorkLocal[2], option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00A4:
 ...
 47: 0x00E5 [0x24] CREATE_DIALOG(message_id=7833*, default_option=1*, option_flags=0*)
