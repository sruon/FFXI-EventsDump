...
- **7827**: Proffer which item? [None of these./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./$3./Previous page./Next page.]
- **7828**: Commence battle? [Yes./No.]
...
```
 ...
 10: 0x0028 [0x24] CREATE_DIALOG(message_id=7827*, default_option=ExtData[1]->WorkLocal[2], option_flags=ExtData[1]->WorkLocal[0])
