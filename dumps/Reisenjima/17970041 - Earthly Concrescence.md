...
- **8062**: Attempt which? (Auto-transport: [off/on]) [None./Omen. (Content level: $1)/Nii's Last Stand./Dance of the Tengu (Zhuu Buxu)./Dance of the Tengu (Reikuu)./Toggle auto-transport.]
- **8064**: Only party members present with you in this area will be transported to [/Omen/Nii's Last Stand/Dance of the Tengu (Zhuu Buxu)/Dance of the Tengu (Reikuu)].
- **8065**: You have selected to enter [/Omen/Nii's Last Stand/Dance of the Tengu (Zhuu Buxu)/Dance of the Tengu (Reikuu)].
- **8066**: [Apply to proceed/Proceed]? [Most certainly!/Not yet.]
- **8067**: Entering [/Omen/Nii's Last Stand/Dance of the Tengu (Zhuu Buxu)/Dance of the Tengu (Reikuu)].
- **8068**: You have chosen not to [apply to/enter] [/Omen/Nii's Last Stand/Dance of the Tengu (Zhuu Buxu)/Dance of the Tengu (Reikuu)].
- **8079**: You will be able to call forth up to $4 alter ego[/s] given the current number of players in your party.
- **8084**: Applying to enter [/Omen/Nii's Last Stand/Dance of the Tengu (Zhuu Buxu)/Dance of the Tengu (Reikuu)]. You will be unable to participate if you add any more party members. Are you sure?
- **8085**: Applying to enter [/Omen/Nii's Last Stand/Dance of the Tengu (Zhuu Buxu)/Dance of the Tengu (Reikuu)].
- **8088**: You are currently number $3 in line for the [earthly concrescence/aspirants' grounds/babbling brook].
- **8089**: You are currently number $3 in line, with $2 in front of you.
- **8090**: Prepare yourselves! The battlefield is almost ready!
- **8091**: You are currently applying to enter [/Omen/Nii's Last Stand/Dance of the Tengu (Zhuu Buxu)/Dance of the Tengu (Reikuu)].
- **8092**: Your number: $3. (Auto-transport: [off/on]) [Remove your name./Toggle auto-transport./Close dialogue.]
- **8103**: Debug menu. [Check information./View applicants./Applicant parameters./Change maximum limit./Clear applications./Close dialogue.]
- **8112**: Designate a value between $0 and $1.
...
```
 ...
 10: 0x0035 [0x24] CREATE_DIALOG(message_id=8062*, default_option=0*, option_flags=ExtData[1]->WorkLocal[7])
...
SUBROUTINE_0116:
 ...
 57: 0x011B [0x24] CREATE_DIALOG(message_id=8066*, default_option=0*, option_flags=0*)
...
SUBROUTINE_017E:
 ...
 15: 0x019A [0x24] CREATE_DIALOG(message_id=8092*, default_option=1*, option_flags=0*)
...
SUBROUTINE_01E7:
 ...
 10: 0x01EC [0x24] CREATE_DIALOG(message_id=8066*, default_option=0*, option_flags=0*)
    → "[Apply to proceed/Proceed]? [Most certainly!/Not yet.]"
...
```
  ...
  2: 0x023B [0x24] CREATE_DIALOG(message_id=8103*, default_option=0*, option_flags=0*)
