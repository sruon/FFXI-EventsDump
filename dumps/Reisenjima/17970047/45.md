...
```
 ...
 28: 0x96F0 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "wpon" for entities [Nii Aquu (ID: 17970051/0x01123383), Nii Aquu (ID: 17970051/0x01123383)]
 ...
 36: 0x972E [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s110", work_offset2=0*)
 37: 0x973F [0x1A] CALL_SUBROUTINE(address=0x0043)
 38: 0x9742 [0x4E] SET_ENTITY_HIDE_FLAG: Show LocalPlayer
 39: 0x9748 [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "main" with entities [Nii Aquu (ID: 17970051/0x01123383), Nii Aquu (ID: 17970051/0x01123383)], work=[2*, 0*]
 40: 0x9759 [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "main" with entities [LocalPlayer, LocalPlayer], work=[2*, 0*]
 ...
 49: 0x9798 [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s111", work_offset2=0*)
 50: 0x97A9 [0x02] IF !(ExtData[1]->WorkLocal[0] == 404*) GOTO 0x98D2
 51: 0x97B1 [0x1C] WAIT(40* ticks)
 52: 0x97B4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="4006", work_offset2=0*)
 ...
 57: 0x97E4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s114", work_offset2=0*)
 58: 0x97F5 [0x01] GOTO 0x9825

SUBROUTINE_97F8:
 59: 0x97F8 [0x02] IF !(Work_Zone[9] == 6*) GOTO 0x9814
 60: 0x9800 [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s114", work_offset2=0*)
 61: 0x9811 [0x01] GOTO 0x9825

SUBROUTINE_9814:
 62: 0x9814 [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s112", work_offset2=0*)
 ...
 67: 0x983B [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="4007", work_offset2=0*)
...
SUBROUTINE_988F:
 ...
 78: 0x989E [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s113", work_offset2=0*)
 79: 0x98AF [0x29] REQ_SET_WAIT(priority=0x0F, entity_id=Nii Aquu (ID: 17970051/0x01123383), tag_num=0x2E)
 80: 0x98B6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="4005", work_offset2=0*)
...
SUBROUTINE_98D2:
 ...
 85: 0x98D5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="4006", work_offset2=0*)
 ...
 90: 0x9905 [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s114", work_offset2=0*)
 91: 0x9916 [0x01] GOTO 0x9946

SUBROUTINE_9919:
 92: 0x9919 [0x02] IF !(Work_Zone[9] == 6*) GOTO 0x9935
 93: 0x9921 [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s114", work_offset2=0*)
 94: 0x9932 [0x01] GOTO 0x9946

SUBROUTINE_9935:
 95: 0x9935 [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s112", work_offset2=0*)
...
100: 0x995C [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="4007", work_offset2=0*)
...
111: 0x99BF [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s113", work_offset2=0*)
112: 0x99D0 [0x29] REQ_SET_WAIT(priority=0x0F, entity_id=Nii Aquu (ID: 17970051/0x01123383), tag_num=0x2E)
113: 0x99D7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=886*, entity1=EventEntity, entity2=EventEntity, scheduler_id="4005", work_offset2=0*)
...
125: 0x9A19 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi2", work_offset2=0*)
