...
| [65535.10](#event-6553510) | 0x0066       |     15 |              5 |
| [65535.11](#event-6553511) | 0x0075       |     15 |              5 |
| [65535.12](#event-6553512) | 0x0084       |     15 |              5 |
...
```
  ...
  1: 0x004B [0x1F] MOVE_ENTITY: EventEntity moves to X=233.161*, Z=302.134*, Y=-91.398*
...
```
  ...
  1: 0x005A [0x1F] MOVE_ENTITY: EventEntity moves to X=258.781*, Z=257.678*, Y=-86.133*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0060:                   32 0A  80 1F 00 0B 80 0C 80 06        2.........
...
```
  ...
  1: 0x0069 [0x1F] MOVE_ENTITY: EventEntity moves to X=183.008*, Z=346.694*, Y=-91.398*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0070:                32 0A 80  1F 00 0D 80 0E 80 0F 80       2..........
0080: 1F 01 6F 00                                       ..o.            
```
...
```
  ...
  1: 0x0078 [0x1F] MOVE_ENTITY: EventEntity moves to X=167.422*, Z=337.367*, Y=-88.127*
