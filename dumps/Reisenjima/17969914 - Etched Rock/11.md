...
```
 ...
 13: 0x0052 [0x45] LOAD_SCHEDULED_TASK(work_offset1=769*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s081", work_offset2=0*)
 14: 0x0063 [0x1C] WAIT(15* ticks)
 15: 0x0066 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 ...
 18: 0x0089 [0x45] LOAD_SCHEDULED_TASK(work_offset1=769*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s082", work_offset2=0*)
 19: 0x009A [0xD0] LOAD_SCHEDULED_TASK_ALT5(work_offset=173*, entity1=LocalPlayer, entity2=LocalPlayer, action="s000", work_offset2=0*)
 20: 0x00AB [0x1C] WAIT(70* ticks)
 21: 0x00AE [0x92] LocalPlayer->Render.Flags3 ^= 0x01
 22: 0x00B4 [0x1C] WAIT(20* ticks)
 23: 0x00B7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 24: 0x00C8 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
