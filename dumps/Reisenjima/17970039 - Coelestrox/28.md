...
```
 ...
 20: 0x0863 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x02, bit_index_work_offset=0x8004, condition_work_offset=0x8000)
 21: 0x086A [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[8]
 22: 0x086F [0x03] Work_Zone[3] = ExtData[1]->WorkLocal[9]
 23: 0x0874 [0x24] CREATE_DIALOG(message_id=7983*, default_option=0*, option_flags=0x02)
    → "What now? (
