...
- **7381**: Oh my Gob! You're one of those adventurerurers, aren't ya? You got nothin' on me, [man./lady.] I was just mindin' my own businesesess, lookin' for junk an' stuff.
- **7382**: Hey, watch out. You don't wanna fight me. I'll turn you into meat jerky! Wait, how about you and me be friends instead? Sound good?
- **7383**: I travel all over the world and hear lots of differererent stories. I even hear your stories. I can tell you one, if you want.
- **7384**: Now, listen close...
- **7385**: Oh... Well, if that's the case, I'm outta here.
- **7391**: Do you want to hear a story? [No, thank you./Let's hear one.]
- **7392**: What story would you like to be told? [On second thought, maybe later./Darkness Beckons./The Brewing Storm./The River Runs Red./Penance./From West to East./Tackling the Problem./An Unending Song./A Rhapsody for the Ages./Sky, Moon, Incantrix(pt.1)./Sky, Moon, Incantrix(pt.2)./Sky, Moon, Incantrix(pt.3)./Sky, Moon, Incantrix(pt.4)./Sky, Moon, Incantrix(pt.5)./Nii's Last Stand(pt.1)./Nii's Last Stand(pt.2)./Nii's Last Stand(pt.3)./Nii's Last Stand(pt.4)./Nii's Last Stand(pt.5)./Nii's Last Stand(pt.6)./Nii's Last Stand(pt.7)./Dance of the Tengu(pt.1)./Dance of the Tengu(pt.2)./Dance of the Tengu(pt.3)./Dance of the Tengu(pt.4)./Dance of the Tengu(pt.5).]
- **7393**: 
- **7394**: 
- **7395**: 
...
0010: F8 32 12 01 03 00 00 00  80 02 02 10 01 80 01 28  .2.............(
...
```
  ...
  4: 0x000B [0x4A] LocalPlayer looks at Ramblix (ID: 17969912/0x011232F8)
 ...
 15: 0x005A [0x1D] PRINT_EVENT_MESSAGE(message_id=7381*)
 ...
 17: 0x005E [0x1D] PRINT_EVENT_MESSAGE(message_id=7382*)
 ...
 19: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=7383*)
 ...
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=7391*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7392*, default_option=0*, option_flags=Work_Zone[2])
    → "What story would you like to be told? [On second thought, maybe later./Darkness Beckons./The Brewing Storm./The River Runs Red./Penance./From West to East./Tackling the Problem./An Unending Song./A Rhapsody for the Ages./Sky, Moon, Incantrix(pt.1)./Sky, Moon, Incantrix(pt.2)./Sky, Moon, Incantrix(pt.3)./Sky, Moon, Incantrix(pt.4)./Sky, Moon, Incantrix(pt.5)./Nii's Last Stand(pt.1)./Nii's Last Stand(pt.2)./Nii's Last Stand(pt.3)./Nii's Last Stand(pt.4)./Nii's Last Stand(pt.5)./Nii's Last Stand(pt.6)./Nii's Last Stand(pt.7)./Dance of the Tengu(pt.1)./Dance of the Tengu(pt.2)./Dance of the Tengu(pt.3)./Dance of the Tengu(pt.4)./Dance of the Tengu(pt.5).]"
 ...
 37: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7385*)
...
SUBROUTINE_00E6:
 43: 0x00E6 [0x24] CREATE_DIALOG(message_id=7393*, default_option=0*, option_flags=Work_Zone[3])
    → ""
 ...
 48: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7385*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_012A:
 54: 0x012A [0x24] CREATE_DIALOG(message_id=7394*, default_option=0*, option_flags=Work_Zone[4])
    → ""
 ...
 59: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=7385*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_016E:
 65: 0x016E [0x24] CREATE_DIALOG(message_id=7395*, default_option=0*, option_flags=Work_Zone[5])
    → ""
 ...
 70: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=7385*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01A7:
 ...
 77: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7385*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01C6:
 81: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7384*)
    → "Now, listen close..."
