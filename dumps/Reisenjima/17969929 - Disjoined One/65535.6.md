...
```
  ...
  1: 0x021B [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=1*, hair=4099, head=0*, body=330*, hands=185*, legs=230*, feet=230*, main=0*, sub=0*)
  2: 0x022F [0x01] GOTO 0x030B
  3: 0x0232 [0x02] IF !(Work_Zone[2] == 2*) GOTO 0x0251
  4: 0x023A [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=2*, hair=4099, head=0*, body=330*, hands=185*, legs=230*, feet=230*, main=0*, sub=0*)
  5: 0x024E [0x01] GOTO 0x030B
  6: 0x0251 [0x02] IF !(Work_Zone[2] == 3*) GOTO 0x0270
  7: 0x0259 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=3*, hair=4099, head=0*, body=330*, hands=185*, legs=230*, feet=230*, main=0*, sub=0*)
  8: 0x026D [0x01] GOTO 0x030B
  9: 0x0270 [0x02] IF !(Work_Zone[2] == 4*) GOTO 0x028F
 10: 0x0278 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=4*, hair=4099, head=0*, body=330*, hands=185*, legs=230*, feet=230*, main=0*, sub=0*)
 11: 0x028C [0x01] GOTO 0x030B
 12: 0x028F [0x02] IF !(Work_Zone[2] == 5*) GOTO 0x02AE
 13: 0x0297 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=5*, hair=4099, head=0*, body=330*, hands=185*, legs=230*, feet=230*, main=0*, sub=0*)
 14: 0x02AB [0x01] GOTO 0x030B
 15: 0x02AE [0x02] IF !(Work_Zone[2] == 6*) GOTO 0x02CD
 16: 0x02B6 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=6*, hair=4099, head=0*, body=330*, hands=185*, legs=230*, feet=230*, main=0*, sub=0*)
 17: 0x02CA [0x01] GOTO 0x030B
 18: 0x02CD [0x02] IF !(Work_Zone[2] == 7*) GOTO 0x02EC
 19: 0x02D5 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=7*, hair=4099, head=0*, body=330*, hands=185*, legs=230*, feet=230*, main=0*, sub=0*)
 20: 0x02E9 [0x01] GOTO 0x030B
 21: 0x02EC [0x02] IF !(Work_Zone[2] == 8*) GOTO 0x030B
 22: 0x02F4 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=8*, hair=4099, head=0*, body=330*, hands=185*, legs=230*, feet=230*, main=0*, sub=0*)
