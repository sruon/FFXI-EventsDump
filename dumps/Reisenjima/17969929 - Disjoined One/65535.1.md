...
```
  ...
  2: 0x0011 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=1*, hair=4099, head=4100, body=4101, hands=4102, legs=4103, feet=4104, main=0*, sub=0*)
  3: 0x0025 [0x01] GOTO 0x0101
  4: 0x0028 [0x02] IF !(Work_Zone[2] == 2*) GOTO 0x0047
  5: 0x0030 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=2*, hair=4099, head=4100, body=4101, hands=4102, legs=4103, feet=4104, main=0*, sub=0*)
  6: 0x0044 [0x01] GOTO 0x0101
  7: 0x0047 [0x02] IF !(Work_Zone[2] == 3*) GOTO 0x0066
  8: 0x004F [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=3*, hair=4099, head=4100, body=4101, hands=4102, legs=4103, feet=4104, main=0*, sub=0*)
  9: 0x0063 [0x01] GOTO 0x0101
 10: 0x0066 [0x02] IF !(Work_Zone[2] == 4*) GOTO 0x0085
 11: 0x006E [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=4*, hair=4099, head=4100, body=4101, hands=4102, legs=4103, feet=4104, main=0*, sub=0*)
 12: 0x0082 [0x01] GOTO 0x0101
 13: 0x0085 [0x02] IF !(Work_Zone[2] == 5*) GOTO 0x00A4
 14: 0x008D [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=5*, hair=4099, head=4100, body=4101, hands=4102, legs=4103, feet=4104, main=0*, sub=0*)
 15: 0x00A1 [0x01] GOTO 0x0101
 16: 0x00A4 [0x02] IF !(Work_Zone[2] == 6*) GOTO 0x00C3
 17: 0x00AC [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=6*, hair=4099, head=4100, body=4101, hands=4102, legs=4103, feet=4104, main=0*, sub=0*)
 18: 0x00C0 [0x01] GOTO 0x0101
 19: 0x00C3 [0x02] IF !(Work_Zone[2] == 7*) GOTO 0x00E2
 20: 0x00CB [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=7*, hair=4099, head=4100, body=4101, hands=4102, legs=4103, feet=4104, main=0*, sub=0*)
 21: 0x00DF [0x01] GOTO 0x0101
 22: 0x00E2 [0x02] IF !(Work_Zone[2] == 8*) GOTO 0x0101
 23: 0x00EA [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=8*, hair=4099, head=4100, body=4101, hands=4102, legs=4103, feet=4104, main=0*, sub=0*)
