...
- **8292**: <Player> gently lays the $3 to rest in the earth...
...
0020: 2F 00 5B 72 07 01 4E 00  5B 72 07 01 92 01 5B 72  /.[r..N.[r....[r
0030: 07 01 94 01 5B 72 07 01  94 01 F0 FF FF 7F 80 5B  ....[r.........[
0040: 72 07 01 80 F0 FF FF 7F  BA F0 FF FF 7F 04 80 05  r...............
0050: 80 06 80 07 80 02 00 00  08 80 00 8A 00 2F 00 9A  ............./..
0060: 72 07 01 4E 00 9A 72 07  01 92 01 9A 72 07 01 94  r..N..r.....r...
0070: 01 9A 72 07 01 80 9A 72  07 01 BA 9A 72 07 01 09  ..r....r....r...
0080: 80 0A 80 0B 80 07 80 01  9E 00 59 05 9A 72 07 01  ..........Y..r..
0090: 01 BA 9A 72 07 01 01 80  01 80 01 80 01 80 45 0C  ...r..........E.
...
00D0: 27 10 9A 72 07 01 02 52  0C 80 F8 FF FF 7F F8 FF  '..r...R........
...
0140: 1C 12 80 27 10 5B 72 07  01 02 1C 13 80 02 00 00  ...'.[r.........
...
```
  ...
  6: 0x0020 [0x2F] ??? (ID: 17265243/0x0107725B)->Render.Flags0 &= ~0x80000 // Bit 19
  7: 0x0026 [0x4E] SET_ENTITY_HIDE_FLAG: Show ??? (ID: 17265243/0x0107725B)
  8: 0x002C [0x92] ??? (ID: 17265243/0x0107725B)->Render.Flags3 ^= 0x01
  9: 0x0032 [0x94] ??? (ID: 17265243/0x0107725B)->Render.Flags3 ^= 0x01
 10: 0x0038 [0x94] LocalPlayer->Render.Flags3 ^= 0x01
 11: 0x003E [0x80] LOAD_WAIT(entity=??? (ID: 17265243/0x0107725B))
 ...
 15: 0x005D [0x2F] Unnamed NPC (ID: 17265306/0x0107729A)->Render.Flags0 &= ~0x80000 // Bit 19
 16: 0x0063 [0x4E] SET_ENTITY_HIDE_FLAG: Show Unnamed NPC (ID: 17265306/0x0107729A)
 17: 0x0069 [0x92] Unnamed NPC (ID: 17265306/0x0107729A)->Render.Flags3 ^= 0x01
 18: 0x006F [0x94] Unnamed NPC (ID: 17265306/0x0107729A)->Render.Flags3 ^= 0x01
 19: 0x0075 [0x80] LOAD_WAIT(entity=Unnamed NPC (ID: 17265306/0x0107729A))
 20: 0x007A [0xBA] SET_ENTITY_POSITION(entity_id=Unnamed NPC (ID: 17265306/0x0107729A), pos_x=638.852*, pos_z=7.262*, pos_y=-15.838*, direction=261.4°*)
 21: 0x0087 [0x01] GOTO 0x009E
 22: 0x008A [0x59] UPDATE_ENTITY_DATA: Unnamed NPC (ID: 17265306/0x0107729A)->Render.Flags0 |= 0x200000
 23: 0x0091 [0xBA] SET_ENTITY_POSITION(entity_id=Unnamed NPC (ID: 17265306/0x0107729A), pos_x=0.000*, pos_z=0.000*, pos_y=0.000*, direction=0.0°*)
...
SUBROUTINE_009E:
 ...
 29: 0x00D0 [0x27] REQ_SET(priority=0x10, entity_id=Unnamed NPC (ID: 17265306/0x0107729A), tag_num=0x02)
 ...
 42: 0x0143 [0x27] REQ_SET(priority=0x10, entity_id=??? (ID: 17265243/0x0107725B), tag_num=0x02)
