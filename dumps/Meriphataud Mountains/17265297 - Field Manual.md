...
- **8551**: A field manual has been placed here by the Adventurers' Mutual Aid Network (A.M.A.N.). Useful information pertaining to various topics on field operations fills its pages.
- **8552**: What will you do? [Nothing./Read about individual training./Review current training regime./Cancel current training regime./Read about elite training./Read about field support.]
- **8553**: Which page? [I've changed my mind./Page 1./Page 2./Page 3./Page 4./Page 5.]
- **8554**: The information on this page instructs you to defeat the following:
- **10603**: Target level range: $5\`$6.
- **10604**: Undertake this training regime? [Bring it on!/No, wait...]
- **11632**: (End of list.)
- **11633**: The tabs you acquire can be spent on field support.
- **11634**: Which one? (You have $8 [tab/tabs]). [Nothing for now./Repatriation ($9)./White magic: Reraise ($10)./White magic: Regen ($11)./White magic: Refresh ($12)./White magic: Protect ($13)./White magic: Shell ($14)./Field recipe: Dried Meat ($15)./Field recipe: Salted Fish ($16)./Field recipe: Hard Cookie ($17)./Field recipe: Instant Noodles ($18)./Receive alter ego: Sakura. ($19)./Receive alter ego: Koru-Moru. ($20).]
- **11635**: Are you certain? [Yes./No.]
- **11637**: You do not have enough tabs.
- **11640**: Which one? (You have $8 [tab/tabs]). [Nothing for now./Read instructions./$3($27)./$3($28)./$3($29)./$3($30)./$3($31)./$3($ )./$3($!)./$3($").]
- **11641**: "Elite training" is a section of the Field Manual which caters to dauntless adventurers who wish to engage in a more grueling test of their mettle.
- **11642**: To participate in elite training regimes, you must acquire chapter transcripts, for which tabs are required.
- **11643**: Trading $35, gil, or a piece of equipment at designated locations (while in possession of a chapter transcript) will trigger the commencement of your training.
- **11644**: Traded items will not be returned to you. You will, however, be furnished with rewards of correlating value upon the successful completion of each elite training regime.
- **11645**: Even within elite training, there are regimes of varying difficulty. The trade limit for each succeeding chapter will be greater than the last, and the training objective more challenging. For safety reasons, all participants are recommended to be well prepared.
- **11646**: Lastly, we at the A.M.A.N. recognize the importance of rest and recuperation as part of a healthy adventuring lifestyle. Therefore, a mandatory cool-down period will be imposed upon all adventurers following the completion of an elite training regime. Until this time has elapsed, you will be unable to undertake further training, even if a chapter transcript is in your possession.
- **11648**: You cannot undertake a training regime while a hunt is active.
- **11649**: Cancel hunt? [Yes./No.]
- **11651**: The requisite time has not yet elapsed since undertaking your last regime. You may be ineligible to receive gil and tab rewards.
- **11652**: Set training regime to automatically repeat upon completion?
- **11653**: Set training regime to repeat? [Yes./No.]
...
SUBROUTINE_00CC:
 ...
 38: 0x00D4 [0x24] CREATE_DIALOG(message_id=8552*, default_option=0*, option_flags=ExtData[1]->WorkLocal[1])
 ...
 45: 0x00FA [0x48] [System] [11648*]:
    → "You cannot undertake a training regime while a hunt is active."
 46: 0x00FD [0x23] WAIT_FOR_DIALOG_INTERACTION
 47: 0x00FE [0x24] CREATE_DIALOG(message_id=11649*, default_option=1*, option_flags=0*)
    → "Cancel hunt? [Yes./No.]"
 48: 0x0105 [0x25] WAIT_DIALOG_SELECT()
 49: 0x0106 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x013C
 50: 0x010E [0x24] CREATE_DIALOG(message_id=11635*, default_option=1*, option_flags=0*)
...
SUBROUTINE_014D:
 ...
 67: 0x015F [0x24] CREATE_DIALOG(message_id=8553*, default_option=0*, option_flags=ExtData[1]->WorkLocal[3])
...
SUBROUTINE_0175:
 ...
 83: 0x01A5 [0x48] [System] [10603*]:
    → "Target level range: $5`$6."
 84: 0x01A8 [0x23] WAIT_FOR_DIALOG_INTERACTION
 85: 0x01A9 [0x03] ExtData[1]->WorkLocal[7] = 10608*
 ...
 89: 0x01B7 [0x24] CREATE_DIALOG(message_id=10604*, default_option=1*, option_flags=0*)
 ...
 92: 0x01C7 [0x48] [System] [11652*]:
    → "Set training regime to automatically repeat upon completion?"
 93: 0x01CA [0x23] WAIT_FOR_DIALOG_INTERACTION
 94: 0x01CB [0x24] CREATE_DIALOG(message_id=11653*, default_option=0*, option_flags=0*)
...
119: 0x023B [0x03] ExtData[1]->WorkLocal[7] = 9579*
...
127: 0x025E [0x48] [System] [10603*]:
    → "Target level range: $5`$6."
128: 0x0261 [0x23] WAIT_FOR_DIALOG_INTERACTION
129: 0x0262 [0x03] ExtData[1]->WorkLocal[7] = 10608*
...
143: 0x02A5 [0x24] CREATE_DIALOG(message_id=11635*, default_option=1*, option_flags=0*)
    → "Are you certain? [Yes./No.]"
...
175: 0x0345 [0x24] CREATE_DIALOG(message_id=11640*, default_option=0*, option_flags=0*)
...
221: 0x0414 [0x24] CREATE_DIALOG(message_id=10604*, default_option=1*, option_flags=0*)
    → "Undertake this training regime? [Bring it on!/No, wait...]"
...
257: 0x04B8 [0x24] CREATE_DIALOG(message_id=11634*, default_option=0*, option_flags=ExtData[1]->WorkLocal[2])
...
312: 0x05D2 [0x24] CREATE_DIALOG(message_id=11634*, default_option=0*, option_flags=ExtData[1]->WorkLocal[2])
    → "Which one? (You have $8 [tab/tabs]). [Nothing for now./Repatriation ($9)./White magic: Reraise ($10)./White magic: Regen ($11)./White magic: Refresh ($12)./White magic: Protect ($13)./White magic: Shell ($14)./Field recipe: Dried Meat ($15)./Field recipe: Salted Fish ($16)./Field recipe: Hard Cookie ($17)./Field recipe: Instant Noodles ($18)./Receive alter ego: Sakura. ($19)./Receive alter ego: Koru-Moru. ($20).]"
...
355: 0x06B8 [0x03] ExtData[1]->WorkLocal[0] = 11636*
356: 0x06BD [0x01] GOTO 0x06C5
357: 0x06C0 [0x03] ExtData[1]->WorkLocal[0] = 11635*
