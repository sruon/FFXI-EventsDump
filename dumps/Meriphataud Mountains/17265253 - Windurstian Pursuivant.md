# 17265253 - Windurstian Pursuivant
...
- **7568**: This is our force's camp. Returning to the camp after falling in battle will allow for a quicker return to the battlefield. It can also help you escape an enemy that may be waiting for your recovery.
- **7569**: This is the camp of the [San d'Orian/Bastokan/Windurstian] forces. There is no rule preventing members of the opposition from entering this area. However, such actions may reflect on the sportsmanship of the adventurers that do so.
- **7570**: I am the assigned Pursuivant of the [San d'Orian/Bastokan/Windurstian] forces. It is my duty to remain at this camp and aid players when necessary.
- **7571**: If the rules still seem a bit difficult, I could provide you with $6. This will give you useful advice while participating, as well as provide you with information on upcoming matches.
- **7572**: Would you like one? [Yes./No.]
- **7573**: This device works like a linkshell and will allow you to hear my advice during the course of the match. All you have to do is follow what I say, and you'll have no problems.
- **7574**: Well, if you ever change your mind, please let me know.
- **7575**: Are you still using the $3? If not, I ask that you return it. There are many novice adventurers that could use one, and we are in short supply.
- **7576**: Would you like to return it? [Yes./No.]
- **7577**: Ha ha! Now that you think you've got what it takes, get out there on the battlefield and create some havoc!
- **7578**: I see. Well, I can't force you to return it... Good luck, citizen!
...
```
  ...
  9: 0x002F [0x1D] PRINT_EVENT_MESSAGE(message_id=7568*)
 ...
 13: 0x0040 [0x1D] PRINT_EVENT_MESSAGE(message_id=7571*)
 ...
 15: 0x0044 [0x24] CREATE_DIALOG(message_id=7572*, default_option=1*, option_flags=0*)
    → "Would you like one? [Yes./No.]"
 16: 0x004B [0x25] WAIT_DIALOG_SELECT()
 17: 0x004C [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0060
 18: 0x0054 [0x1D] PRINT_EVENT_MESSAGE(message_id=7573*)
 ...
 23: 0x0068 [0x1D] PRINT_EVENT_MESSAGE(message_id=7574*)
...
SUBROUTINE_006F:
 ...
 27: 0x0072 [0x1D] PRINT_EVENT_MESSAGE(message_id=7575*)
 ...
 29: 0x0076 [0x24] CREATE_DIALOG(message_id=7576*, default_option=1*, option_flags=0*)
    → "Would you like to return it? [Yes./No.]"
 30: 0x007D [0x25] WAIT_DIALOG_SELECT()
 31: 0x007E [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0092
 32: 0x0086 [0x1D] PRINT_EVENT_MESSAGE(message_id=7577*)
 ...
 37: 0x009A [0x1D] PRINT_EVENT_MESSAGE(message_id=7578*)
...
SUBROUTINE_00A1:
 ...
 47: 0x00C7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7569*)
 ...
 51: 0x00D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7570*)
