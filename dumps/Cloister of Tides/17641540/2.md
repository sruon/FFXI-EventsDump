...
```
 ...
 24: 0x00AD [0x4B] UPDATE_ENTITY_YAW(entity=??? (ID: 17641541/0x010D3045), yaw=0.01°)
...
SUBROUTINE_0108:
 ...
 45: 0x0110 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
 46: 0x0121 [0x21] END_EVENT
 47: 0x0122 [0x00] END_REQSTACK()

 48: 0x0130 [0x02] IF !(ExtData[1]->WorkLocal[0] == 1*) GOTO 0x017E
 49: 0x0138 [0x45] LOAD_SCHEDULED_TASK(work_offset1=473*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="502a", work_offset2=0*)
 ...
 56: 0x016C [0x55] WAIT_LOAD_SCHEDULER(work_offset=473*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="502a")
 57: 0x017B [0x01] GOTO 0x017E

SUBROUTINE_017E:
 58: 0x017E [0x1B] RETURN

 59: 0x01C1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 60: 0x01D2 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 61: 0x01E1 [0x1B] RETURN

SUBROUTINE_01E2:
 62: 0x01E2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 63: 0x01F3 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
...
# Data Section: 0x0123 (13 bytes)
     0x0123: 02 0F 80 0D 80 00 2F 01 48 12 80 23 1B
# Data Section: 0x017F (66 bytes)
     0x017F: 45 11 80 F0 FF FF 7F F0 FF FF 7F 66 64 69 30 0F
     0x018F: 80 55 11 80 F0 FF FF 7F F0 FF FF 7F 66 64 69 30
     0x019F: 1B 45 11 80 F0 FF FF 7F F0 FF FF 7F 66 64 6F 30
     0x01AF: 0F 80 55 11 80 F0 FF FF 7F F0 FF FF 7F 66 64 6F
     0x01BF: 30 1B
# Data Section: 0x0203 (165 bytes)
     0x0203: 45 15 80 F0 FF FF 7F F0 FF FF 7F 77 68 69 31 0F
     0x0213: 80 55 15 80 F0 FF FF 7F F0 FF FF 7F 77 68 69 31
     0x0223: 1B 45 15 80 F0 FF FF 7F F0 FF FF 7F 77 68 6F 31
     0x0233: 0F 80 55 15 80 F0 FF FF 7F F0 FF FF 7F 77 68 6F
     0x0243: 31 1B 45 15 80 F0 FF FF 7F F0 FF FF 7F 77 68 69
     0x0253: 30 0F 80 55 15 80 F0 FF FF 7F F0 FF FF 7F 77 68
     0x0263: 69 30 1B 45 15 80 F0 FF FF 7F F0 FF FF 7F 77 68
     0x0273: 6F 30 0F 80 55 15 80 F0 FF FF 7F F0 FF FF 7F 77
     0x0283: 68 6F 30 1B 45 16 80 F0 FF FF 7F F0 FF FF 7F 65
     0x0293: 66 6F 6E 0F 80 55 16 80 F0 FF FF 7F F0 FF FF 7F
