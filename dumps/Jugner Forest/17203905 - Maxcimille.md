...
0050: 80 1F 01 6F 1E BF 82 06  01 7B C1 82 06 01 00     ...o.....{..... 
```
...
```
  ...
  4: 0x0054 [0x1E] EventEntity looks at Excenmille (ID: 17203903/0x010682BF) and starts talking
  5: 0x0059 [0x7B] Maxcimille (ID: 17203905/0x010682C1) stops talking
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0050:                                               6C                 l
0060: C1 82 06 01 00 80 07 80  00                       .........       
```

#### Opcodes

```
  0: 0x005F [0x6C] FADE_ENTITY_COLOR(entity_id=Maxcimille (ID: 17203905/0x010682C1), end_alpha=0*, fade_time=60*)
...
```
  0: 0x0069 [0x6C] FADE_ENTITY_COLOR(entity_id=Maxcimille (ID: 17203905/0x010682C1), end_alpha=0*, fade_time=1*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0070:          6C C1 82 06 01  02 80 07 80 00              l.........   
```

#### Opcodes

```
  0: 0x0073 [0x6C] FADE_ENTITY_COLOR(entity_id=Maxcimille (ID: 17203905/0x010682C1), end_alpha=128*, fade_time=60*)
