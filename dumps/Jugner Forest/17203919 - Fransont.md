...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0050:                                            B4 13                ..
0060: 00 00 46 72 61 6E 73 6F  6E 74 00 00 00 00 00 00  ..Fransont......
...
```
  0: 0x005E [0xB4] UI_WINDOW_STRING_HANDLER(case=0x13 - Copy string and replace @ with space, work_offset=ExtData[1]->WorkLocal[0], string="Fransont")
