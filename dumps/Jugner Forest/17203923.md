...
| [65535.9](#event-655359) | 0x004A       |     15 |              5 |
...
```
  0: 0x0045 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Model size, value=120*)
...
```
  ...
  1: 0x004D [0x1F] MOVE_ENTITY: EventEntity moves to X=-196.318*, Z=63.788*, Y=-2.199*
