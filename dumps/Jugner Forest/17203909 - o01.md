...
|       2 | 0x0080      |         128 |
|       3 | 0x0028      |          40 |
|       4 | 0xFFFD778F  |  4294801295 |
|       5 | 0x5E30      |       24112 |
|       6 | 0xFFFFFC18  |  4294966296 |
|       7 | 0x000D      |          13 |
|       8 | 0xFFFDE4BB  |  4294829243 |
|       9 | 0x4630      |       17968 |
|      10 | 0xFFFFF831  |  4294965297 |
|      11 | 0xFFFDDEC6  |  4294827718 |
|      12 | 0x4850      |       18512 |
...
```
  ...
  1: 0x0049 [0x1F] MOVE_ENTITY: EventEntity moves to X=-166.001*, Z=24.112*, Y=-1.000*
...
0060: 1F 01 6F 1E BF 82 06 01  00                       ..o......       
```
...
```
  ...
  4: 0x0063 [0x1E] EventEntity looks at Excenmille (ID: 17203903/0x010682BF) and starts talking
...
```
  ...
  1: 0x006C [0x1F] MOVE_ENTITY: EventEntity moves to X=-139.578*, Z=18.512*, Y=-2.000*
