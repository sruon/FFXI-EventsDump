...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0040:                B4 13 00  00 3F 3F 3F 00 00 00 00       ....???....
...
```
  0: 0x0045 [0xB4] UI_WINDOW_STRING_HANDLER(case=0x13 - Copy string and replace @ with space, work_offset=ExtData[1]->WorkLocal[0], string="???")
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0050:                                            B4 13                ..
0060: 00 00 50 69 67 6E 6F 69  74 00 00 00 00 00 00 00  ..Pignoit.......
...
```
  0: 0x005E [0xB4] UI_WINDOW_STRING_HANDLER(case=0x13 - Copy string and replace @ with space, work_offset=ExtData[1]->WorkLocal[0], string="Pignoit")
