...
```
  ...
  1: 0x0049 [0x1F] MOVE_ENTITY: EventEntity moves to X=-169.319*, Z=25.677*, Y=-1.000*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0050:                32 07 80  1F 00 08 80 09 80 00 80       2..........
0060: 1F 01 6F 00                                       ..o.            
```
...
```
  ...
  1: 0x0058 [0x1F] MOVE_ENTITY: EventEntity moves to X=17.309*, Z=43.158*, Y=0.000*
