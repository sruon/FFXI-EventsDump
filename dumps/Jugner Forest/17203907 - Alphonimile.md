...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
00A0:                6C C3 82  06 01 00 80 01 80 00          l......... 
```

#### Opcodes

```
  0: 0x00A5 [0x6C] FADE_ENTITY_COLOR(entity_id=Alphonimile (ID: 17203907/0x010682C3), end_alpha=0*, fade_time=1*)
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
00A0:                                               6C                 l
00B0: C3 82 06 01 00 80 08 80  00                       .........       
```

#### Opcodes

```
  0: 0x00AF [0x6C] FADE_ENTITY_COLOR(entity_id=Alphonimile (ID: 17203907/0x010682C3), end_alpha=0*, fade_time=60*)
...
```
  0: 0x00B9 [0x6C] FADE_ENTITY_COLOR(entity_id=Alphonimile (ID: 17203907/0x010682C3), end_alpha=128*, fade_time=60*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
00C0:          6C C3 82 06 01  0C 80 08 80 00              l.........   
```

#### Opcodes

```
  0: 0x00C3 [0x6C] FADE_ENTITY_COLOR(entity_id=Alphonimile (ID: 17203907/0x010682C3), end_alpha=64*, fade_time=60*)
