...
- **7970**: Perhaps it means she wishes to exchange your earring for herrrs?
- **7972**: Semih Lafihna, Sibyl Guard of Heavens Tower in Windurst. That is your title, correct?
- **7974**: I am a Mithran Tracker. Have you not heard of us? I have trrraveled from the Mithran homeland that lies across the seas.
- **7975**: I learned that a sinner was taking rrrefuge with a tribe that lived in Windurst.
- **7977**: Twenty years ago, in the time of the Great War, the tribal chieftainness of a certain region perpetrated a grrrave offense.
- **7978**: That chieftainness escaped to this land, but was hunted down by Perih Vashai.
- **7979**: We received word that the daughter of the chieftainness perrrished along with her mother. The Mithran Tracker who traveled here twenty years ago confirmed the report.
- **7980**: However, before the light of life left her, she confessed to her own sin: "The daughter still lives."
- **7981**: And so I have come. I will seek out the daughter of the chieftainness and make her atone for the sins of her mother.
- **7984**: Although all the other orphans of the war were sent to their rrrespective homelands, only you few were taken in by a different people. Was this done to evade the Mithran Trackers, perrrhaps?
- **7985**: And out of those orphans who went to live in Heavens Tower, you were the only one to have no rrrecord of her parents...
- **7986**: A sin is a sin, even if you have no memory of the fact. The child must pay for the sins of the mother when the mother can no longer make amends.
- **7987**: Trying to switch the earring will do you no good. That is not how I will know you as the child of the sinner.
- **7988**: Let me tell you a secret. A sinner carries the scent of sin. It is a scent that only these king's tear moths can detect. A scent that will not fade and that you cannot escape. A scent that will stay with you forrrever.
- **7990**: ...!? You don't carry the scent...?
- **7991**: ...... I must apologize. I seem to have been mistaken.
- **7993**: That is no longer my concern. Farewell, Semih Lafihna.
...
```
  0: 0x0087 [0x1D] PRINT_EVENT_MESSAGE(message_id=7970*)
...
```
  0: 0x008C [0x1D] PRINT_EVENT_MESSAGE(message_id=7972*)
...
```
  0: 0x0091 [0x1D] PRINT_EVENT_MESSAGE(message_id=7974*)
...
```
  0: 0x0096 [0x1D] PRINT_EVENT_MESSAGE(message_id=7975*)
...
```
  ...
  1: 0x00A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7977*)
...
```
  0: 0x00A7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7978*)
...
```
  0: 0x00AC [0x1D] PRINT_EVENT_MESSAGE(message_id=7979*)
...
```
  0: 0x00B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7980*)
...
```
  0: 0x00BD [0x1D] PRINT_EVENT_MESSAGE(message_id=7981*)
...
```
  0: 0x00C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7984*)
...
```
  ...
  1: 0x00CE [0x1D] PRINT_EVENT_MESSAGE(message_id=7985*)
...
```
  0: 0x00DA [0x1D] PRINT_EVENT_MESSAGE(message_id=7986*)
  ...
  4: 0x00EA [0x1D] PRINT_EVENT_MESSAGE(message_id=7987*)
...
```
  0: 0x00EF [0x1D] PRINT_EVENT_MESSAGE(message_id=7988*)
...
```
  0: 0x00F4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7990*)
...
```
  0: 0x00F9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7991*)
...
```
  0: 0x00FE [0x1D] PRINT_EVENT_MESSAGE(message_id=7993*)
