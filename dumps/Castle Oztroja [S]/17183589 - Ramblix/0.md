...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=8191*, default_option=0*, option_flags=Work_Zone[2])
    → "What story would you like to be told?\u0007\u000BOn second thought, maybe later.\u0007A Manifest Problem.\u0007The Forbidden Path(pt.1).\u0007The Forbidden Path(pt.2).\u0007The Forbidden Path(pt.3).\u0007Manifest Destiny(pt.1).\u0007Manifest Destiny(pt.2).\u0007Manifest Destiny(pt.3).\u0007Manifest Destiny(pt.4).\u0007Manifest Destiny(pt.5).\u0007Manifest Destiny(pt.6).\u0007At Journey's End(pt.1).\u0007At Journey's End(pt.2).\u007F1\u0000\u0007"
