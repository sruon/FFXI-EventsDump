...
- **8180**: Oh my Gob! You're one of those adventurerurers, aren't ya? You got nothin' on me, [man./lady.] I was just mindin' my own businesesess, lookin' for junk an' stuff.
- **8181**: Hey, watch out. You don't wanna fight me. I'll turn you into meat jerky! Wait, how about you and me be friends instead? Sound good?
- **8182**: I travel all over the world and hear lots of differererent stories. I even hear your stories. I can tell you one, if you want.
- **8183**: Now, listen close...
- **8184**: Oh... Well, if that's the case, I'm outta here.
- **8190**: Do you want to hear a story? [No, thank you./Let's hear one.]
- **8191**: What story would you like to be told? [On second thought, maybe later./A Manifest Problem./The Forbidden Path(pt.1)./The Forbidden Path(pt.2)./The Forbidden Path(pt.3)./Manifest Destiny(pt.1)./Manifest Destiny(pt.2)./Manifest Destiny(pt.3)./Manifest Destiny(pt.4)./Manifest Destiny(pt.5)./Manifest Destiny(pt.6)./At Journey's End(pt.1)./At Journey's End(pt.2).]
- **8192**: 
- **8193**: 
- **8194**: 
...
0010: 65 33 06 01 03 00 00 00  80 02 02 10 01 80 01 28  e3.............(
...
```
  ...
  4: 0x000B [0x4A] LocalPlayer looks at Ramblix (ID: 17183589/0x01063365)
 ...
 15: 0x005A [0x1D] PRINT_EVENT_MESSAGE(message_id=8180*)
 ...
 17: 0x005E [0x1D] PRINT_EVENT_MESSAGE(message_id=8181*)
 ...
 19: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=8182*)
 ...
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=8190*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=8191*, default_option=0*, option_flags=Work_Zone[2])
    → "What story would you like to be told? [On second thought, maybe later./A Manifest Problem./The Forbidden Path(pt.1)./The Forbidden Path(pt.2)./The Forbidden Path(pt.3)./Manifest Destiny(pt.1)./Manifest Destiny(pt.2)./Manifest Destiny(pt.3)./Manifest Destiny(pt.4)./Manifest Destiny(pt.5)./Manifest Destiny(pt.6)./At Journey's End(pt.1)./At Journey's End(pt.2).]"
 ...
 37: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=8184*)
...
SUBROUTINE_00E6:
 43: 0x00E6 [0x24] CREATE_DIALOG(message_id=8192*, default_option=0*, option_flags=Work_Zone[3])
    → ""
 ...
 48: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=8184*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_012A:
 54: 0x012A [0x24] CREATE_DIALOG(message_id=8193*, default_option=0*, option_flags=Work_Zone[4])
    → ""
 ...
 59: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=8184*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_016E:
 65: 0x016E [0x24] CREATE_DIALOG(message_id=8194*, default_option=0*, option_flags=Work_Zone[5])
    → ""
 ...
 70: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=8184*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01A7:
 ...
 77: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8184*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01C6:
 81: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=8183*)
    → "Now, listen close..."
