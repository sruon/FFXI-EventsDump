...
```
 ...
 10: 0x0054 [0x5B] LOAD_EXT_SCHEDULER(work_offset=2161*, entity1=EventEntity, entity2=EventEntity, action="wht1")
...
SUBROUTINE_0077:
 ...
 20: 0x007F [0x5B] LOAD_EXT_SCHEDULER(work_offset=2161*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 32: 0x00AE [0x5B] LOAD_EXT_SCHEDULER(work_offset=2161*, entity1=EventEntity, entity2=EventEntity, action="bik0")
 ...
 35: 0x00C1 [0x5B] LOAD_EXT_SCHEDULER(work_offset=2161*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
...
SUBROUTINE_0113:
 61: 0x0113 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x0127
 62: 0x011B [0x1D] PRINT_EVENT_MESSAGE(message_id=10576*)
 ...
 64: 0x011F [0x03] Work_Zone[1] = 10*
 65: 0x0124 [0x01] GOTO 0x0127

SUBROUTINE_0127:
 66: 0x0127 [0x01] GOTO 0x013E

SUBROUTINE_012A:
 67: 0x012A [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x013E
 68: 0x0132 [0x1D] PRINT_EVENT_MESSAGE(message_id=10564*)
    → "Aww...\u0007Hopefully you'll change your mind. I'll be waiting here!\u007F1\u0000\u0007"
 69: 0x0135 [0x23] WAIT_FOR_DIALOG_INTERACTION
 70: 0x0136 [0x03] Work_Zone[1] = 11*
 71: 0x013B [0x01] GOTO 0x013E

SUBROUTINE_013E:
 72: 0x013E [0x21] END_EVENT
 73: 0x013F [0x00] END_REQSTACK()
```
