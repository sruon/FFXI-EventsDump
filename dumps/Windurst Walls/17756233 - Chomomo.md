...
| [325](#event-325)        | 0x0021       |     33 |             12 |
| [499](#event-499)        | 0x0042       |      1 |              1 |
...
- **7944**: I'm looking for baddie-waddies. When I catch 'em, I throw 'em in a scary-wary jail.
- **7945**: You're not doing anything bad, are you? If you are, you have to tell me, you know!
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0020:    1E F0 FF FF 7F 6F 70  29 0B 49 F0 0E 01 01 1D   .....op).I.....
0030: 02 80 23 1D 03 80 23 29  0B 49 F0 0E 01 02 20 00  ..#...#).I.... .
0040: 21 00                                             !.              
```
...
```
  ...
  3: 0x0028 [0x29] REQ_SET_WAIT(priority=0x0B, entity_id=Chomomo (ID: 17756233/0x010EF049), tag_num=0x01)
  4: 0x002F [0x1D] PRINT_EVENT_MESSAGE(message_id=7944*)
    → "I'm looking for baddie-waddies. When I catch 'em, I throw 'em in a scary-wary jail."
  5: 0x0032 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0033 [0x1D] PRINT_EVENT_MESSAGE(message_id=7945*)
    → "You're not doing anything bad, are you? If you are, you have to tell me, you know!"
  7: 0x0036 [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x0037 [0x29] REQ_SET_WAIT(priority=0x0B, entity_id=Chomomo (ID: 17756233/0x010EF049), tag_num=0x02)
