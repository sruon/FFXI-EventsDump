...
```
 ...
 12: 0x017E [0x1D] PRINT_EVENT_MESSAGE(message_id=10578*)
    → "Why, hello!"
...
SUBROUTINE_01AF:
 ...
 24: 0x01B7 [0x24] CREATE_DIALOG(message_id=10579*, default_option=ExtData[1]->WorkLocal[8], option_flags=ExtData[1]->WorkLocal[14])
 ...
 29: 0x01D4 [0x1D] PRINT_EVENT_MESSAGE(message_id=10574*)
    → "I can fly you right to the starting point. Just say the word!"
 ...
 39: 0x01F6 [0x1D] PRINT_EVENT_MESSAGE(message_id=10582*)
    → "Wow! I'll bet you're ready for the championship round!"
 40: 0x01F9 [0x23] WAIT_FOR_DIALOG_INTERACTION
 41: 0x01FA [0x1D] PRINT_EVENT_MESSAGE(message_id=10583*)
...
SUBROUTINE_0201:
 44: 0x0201 [0x24] CREATE_DIALOG(message_id=10575*, default_option=1*, option_flags=0*)
    → "Ready for mischief? [The sun will bow before me!/The light...it burns us!]"
 ...
 50: 0x021C [0x1D] PRINT_EVENT_MESSAGE(message_id=10577*)
    → "Good luck! Collect as many as you can and bring them back to me!"
...
SUBROUTINE_023D:
 ...
 73: 0x02A0 [0x1D] PRINT_EVENT_MESSAGE(message_id=10586*)
...
SUBROUTINE_02C2:
 ...
 97: 0x0305 [0x1D] PRINT_EVENT_MESSAGE(message_id=10601*)
...
107: 0x0331 [0x1D] PRINT_EVENT_MESSAGE(message_id=10600*)
...
114: 0x034D [0x1D] PRINT_EVENT_MESSAGE(message_id=10602*)
    → "The goal of sunshine seeker is to collect shards of sunlight!"
115: 0x0350 [0x23] WAIT_FOR_DIALOG_INTERACTION
116: 0x0351 [0x1D] PRINT_EVENT_MESSAGE(message_id=10566*)
    → "I'll give you some small seeds in exchange for the shards of sunlight you bring back."
117: 0x0354 [0x23] WAIT_FOR_DIALOG_INTERACTION
118: 0x0355 [0x1D] PRINT_EVENT_MESSAGE(message_id=10567*)
    → "Even better! I've got some special things available for you to buy with your seeds!"
119: 0x0358 [0x23] WAIT_FOR_DIALOG_INTERACTION
120: 0x0359 [0x1D] PRINT_EVENT_MESSAGE(message_id=10568*)
    → "But here's the best part--If you try your luck with my grab bag enough times, you might win something really super!"
121: 0x035C [0x23] WAIT_FOR_DIALOG_INTERACTION
122: 0x035D [0x1D] PRINT_EVENT_MESSAGE(message_id=10569*)
    → "One of the rules of the game is that you must be a mandragora, like me, or else you won't be able to collect any shards."
123: 0x0360 [0x23] WAIT_FOR_DIALOG_INTERACTION
124: 0x0361 [0x1D] PRINT_EVENT_MESSAGE(message_id=10570*)
    → "They can be found all around here. But if you don't hurry, someone else might gobble them up."
125: 0x0364 [0x23] WAIT_FOR_DIALOG_INTERACTION
126: 0x0365 [0x1D] PRINT_EVENT_MESSAGE(message_id=10571*)
    → "But once you've taken them from one place, you can't get any more from there by searching it repeatedly!"
127: 0x0368 [0x23] WAIT_FOR_DIALOG_INTERACTION
128: 0x0369 [0x1D] PRINT_EVENT_MESSAGE(message_id=10572*)
    → "Shards of sunlight are really delicate, so they'll disappear if you leave this area or take too much time getting them back to me."
129: 0x036C [0x23] WAIT_FOR_DIALOG_INTERACTION
130: 0x036D [0x1D] PRINT_EVENT_MESSAGE(message_id=10573*)
    → "My friends'll also try to get in your way, so be sure not to get noticed!"
...
SUBROUTINE_0629:
217: 0x0629 [0x24] CREATE_DIALOG(message_id=10593*, default_option=ExtData[1]->WorkLocal[9], option_flags=ExtData[1]->WorkLocal[15])
...
SUBROUTINE_06A9:
246: 0x06A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10594*)
    → "That grab bag contains prizes like $0, $1, and $2."
247: 0x06AC [0x23] WAIT_FOR_DIALOG_INTERACTION
248: 0x06AD [0x24] CREATE_DIALOG(message_id=10595*, default_option=1*, option_flags=0*)
...
276: 0x072E [0x1D] PRINT_EVENT_MESSAGE(message_id=10596*)
...
283: 0x0760 [0x1D] PRINT_EVENT_MESSAGE(message_id=10596*)
    → "You won $0! Congratulations!"
...
286: 0x0773 [0x1D] PRINT_EVENT_MESSAGE(message_id=10597*)
    → "...But your bags are full! What do you want me to do with it?"
287: 0x0776 [0x23] WAIT_FOR_DIALOG_INTERACTION
288: 0x0777 [0x24] CREATE_DIALOG(message_id=10598*, default_option=0*, option_flags=0*)
...
291: 0x0787 [0x1D] PRINT_EVENT_MESSAGE(message_id=10599*)
