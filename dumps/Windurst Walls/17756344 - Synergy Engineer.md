...
- **9759**: Greetings, friend! I am a synergy engineer, dispatched from the Institute to maintain the furnaces you see beside me. I also have knowledge and services to share with fellow synergists, if that is what you desire.
...
- **9790**: ...Hm? Why, your tank is already full to bursting. Come back again if you need a refill.
...
- **9832**: As a general rule, the more complex the recipe, the more fewell it will require. Take care to check your stock before you fire up the furnace, lest you find its flames guttering out at a crucial moment.
...
- **9857**: You'll also want to mind the laws of elemental ascendancy and opposition. Increasing the concentration of a particular element will cause its counterpart to decrease.
...
- **9883**: The difficulty of the synergy process when embedding evolith is decided by a number of factors.
...
- **9911**: ...Suitable for evolith of the following size and elemental affinity: Maximum size: $1 / [/oo /o!/o"/o#/o$/o%/o&].
...
```
  ...
  7: 0x0026 [0x1D] PRINT_EVENT_MESSAGE(message_id=9925*)
 ...
 10: 0x002F [0x24] CREATE_DIALOG(message_id=9926*, default_option=0*, option_flags=ExtData[1]->WorkLocal[79])
 ...
 13: 0x003F [0x1D] PRINT_EVENT_MESSAGE(message_id=9927*)
 ...
 18: 0x0057 [0x1D] PRINT_EVENT_MESSAGE(message_id=9928*)
 ...
 21: 0x0060 [0x1D] PRINT_EVENT_MESSAGE(message_id=9929*)
 ...
 23: 0x0064 [0x1D] PRINT_EVENT_MESSAGE(message_id=9930*)
 ...
 25: 0x0068 [0x1D] PRINT_EVENT_MESSAGE(message_id=9931*)
 ...
 27: 0x006C [0x1D] PRINT_EVENT_MESSAGE(message_id=9932*)
 ...
 33: 0x0078 [0x1D] PRINT_EVENT_MESSAGE(message_id=9935*)
 ...
 35: 0x007C [0x1D] PRINT_EVENT_MESSAGE(message_id=9936*)
 ...
 37: 0x0080 [0x1D] PRINT_EVENT_MESSAGE(message_id=9937*)
 ...
 39: 0x0084 [0x1D] PRINT_EVENT_MESSAGE(message_id=9938*)
...
SUBROUTINE_0106:
 ...
 48: 0x0111 [0x1D] PRINT_EVENT_MESSAGE(message_id=9759*)
...
SUBROUTINE_0118:
 ...
 52: 0x0120 [0x24] CREATE_DIALOG(message_id=9762*, default_option=0*, option_flags=0*)
 ...
 60: 0x0148 [0x1D] PRINT_EVENT_MESSAGE(message_id=9763*)
 ...
 71: 0x0182 [0x1D] PRINT_EVENT_MESSAGE(message_id=9764*)
 ...
 86: 0x01E5 [0x1D] PRINT_EVENT_MESSAGE(message_id=9765*)
...
SUBROUTINE_03DF:
186: 0x03DF [0x1D] PRINT_EVENT_MESSAGE(message_id=9771*)
...
385: 0x08AA [0x1D] PRINT_EVENT_MESSAGE(message_id=9776*)
...
389: 0x08B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=9777*)
...
393: 0x08C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=9778*)
...
397: 0x08D7 [0x1D] PRINT_EVENT_MESSAGE(message_id=9779*)
...
401: 0x08E6 [0x1D] PRINT_EVENT_MESSAGE(message_id=9780*)
...
405: 0x08F5 [0x1D] PRINT_EVENT_MESSAGE(message_id=9781*)
...
409: 0x0904 [0x1D] PRINT_EVENT_MESSAGE(message_id=9782*)
...
413: 0x0913 [0x1D] PRINT_EVENT_MESSAGE(message_id=9783*)
...
SUBROUTINE_091A:
416: 0x091A [0x1D] PRINT_EVENT_MESSAGE(message_id=9784*)
...
423: 0x0930 [0x1D] PRINT_EVENT_MESSAGE(message_id=9785*)
...
445: 0x09B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=9786*)
...
456: 0x09ED [0x1D] PRINT_EVENT_MESSAGE(message_id=9787*)
    → "Running low? We can fill you up for a nominal fee."
457: 0x09F0 [0x23] WAIT_FOR_DIALOG_INTERACTION
458: 0x09F1 [0x24] CREATE_DIALOG(message_id=9788*, default_option=1*, option_flags=0*)
...
465: 0x0A1B [0x1D] PRINT_EVENT_MESSAGE(message_id=9799*)
...
471: 0x0A30 [0x1D] PRINT_EVENT_MESSAGE(message_id=9789*)
...
481: 0x0A60 [0x1D] PRINT_EVENT_MESSAGE(message_id=9791*)
...
484: 0x0A69 [0x24] CREATE_DIALOG(message_id=9792*, default_option=1*, option_flags=0*)
...
489: 0x0A86 [0x1D] PRINT_EVENT_MESSAGE(message_id=9795*)
...
495: 0x0ACA [0x1D] PRINT_EVENT_MESSAGE(message_id=9796*)
...
500: 0x0ADD [0x1D] PRINT_EVENT_MESSAGE(message_id=9794*)
...
504: 0x0AEC [0x1D] PRINT_EVENT_MESSAGE(message_id=9793*)
...
508: 0x0AF6 [0x1D] PRINT_EVENT_MESSAGE(message_id=9790*)
...
512: 0x0B02 [0x1D] PRINT_EVENT_MESSAGE(message_id=9799*)
    → "How do you expect me to do that when your $3 is sitting inside a furnace, friend? You'll have to come back after you've finished synergizing."
...
516: 0x0B11 [0x1D] PRINT_EVENT_MESSAGE(message_id=9800*)
...
528: 0x0B48 [0x24] CREATE_DIALOG(message_id=9801*, default_option=0*, option_flags=0*)
...
555: 0x0BD6 [0x1D] PRINT_EVENT_MESSAGE(message_id=9802*)
...
559: 0x0BE2 [0x24] CREATE_DIALOG(message_id=9792*, default_option=1*, option_flags=0*)
    → "Pay $0 gil? [Deal!/No thanks.]"
...
568: 0x0C15 [0x1D] PRINT_EVENT_MESSAGE(message_id=9822*)
...
575: 0x0C34 [0x1D] PRINT_EVENT_MESSAGE(message_id=9794*)
    → "I'm afraid you haven't the requisite gil, friend. Perhaps another time."
...
584: 0x0C57 [0x1D] PRINT_EVENT_MESSAGE(message_id=9803*)
...
597: 0x0CAB [0x1D] PRINT_EVENT_MESSAGE(message_id=9805*)
...
608: 0x0CDD [0x24] CREATE_DIALOG(message_id=9806*, default_option=0*, option_flags=0*)
...
653: 0x0DCD [0x1D] PRINT_EVENT_MESSAGE(message_id=9807*)
...
655: 0x0DD1 [0x24] CREATE_DIALOG(message_id=9809*, default_option=1*, option_flags=0*)
    → "Train in this technique? [Yes./No.]"
656: 0x0DD8 [0x25] WAIT_DIALOG_SELECT()
657: 0x0DD9 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0E85
658: 0x0DE1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9810*)
...
664: 0x0E12 [0x1D] PRINT_EVENT_MESSAGE(message_id=9811*)
...
668: 0x0E21 [0x1D] PRINT_EVENT_MESSAGE(message_id=9812*)
...
672: 0x0E30 [0x1D] PRINT_EVENT_MESSAGE(message_id=9813*)
...
676: 0x0E3F [0x1D] PRINT_EVENT_MESSAGE(message_id=9814*)
...
681: 0x0E66 [0x1D] PRINT_EVENT_MESSAGE(message_id=9815*)
...
692: 0x0E98 [0x1D] PRINT_EVENT_MESSAGE(message_id=9808*)
...
697: 0x0EA7 [0x1D] PRINT_EVENT_MESSAGE(message_id=9804*)
...
701: 0x0EB6 [0x1D] PRINT_EVENT_MESSAGE(message_id=9817*)
...
730: 0x0F44 [0x24] CREATE_DIALOG(message_id=9818*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
777: 0x1038 [0x1D] PRINT_EVENT_MESSAGE(message_id=9819*)
    → "This is what you want, correct?"
778: 0x103B [0x23] WAIT_FOR_DIALOG_INTERACTION
779: 0x103C [0x93] DISPLAY_ITEM_INFO(item_id=0*)
780: 0x103F [0x24] CREATE_DIALOG(message_id=9820*, default_option=1*, option_flags=0*)
...
784: 0x1057 [0x1D] PRINT_EVENT_MESSAGE(message_id=9822*)
    → "Excellent! And this is yours. May it serve you well!"
...
791: 0x1076 [0x1D] PRINT_EVENT_MESSAGE(message_id=9821*)
...
803: 0x10A5 [0x24] CREATE_DIALOG(message_id=9824*, default_option=0*, option_flags=0*)
...
809: 0x10C3 [0x1D] PRINT_EVENT_MESSAGE(message_id=9825*)
...
812: 0x10CC [0x1D] PRINT_EVENT_MESSAGE(message_id=9943*)
...
820: 0x10E3 [0x1D] PRINT_EVENT_MESSAGE(message_id=9829*)
...
822: 0x10E7 [0x1D] PRINT_EVENT_MESSAGE(message_id=9830*)
...
824: 0x10EB [0x1D] PRINT_EVENT_MESSAGE(message_id=9831*)
...
826: 0x10EF [0x1D] PRINT_EVENT_MESSAGE(message_id=9832*)
...
828: 0x10F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=9833*)
...
830: 0x10F7 [0x1D] PRINT_EVENT_MESSAGE(message_id=9834*)
...
832: 0x10FB [0x1D] PRINT_EVENT_MESSAGE(message_id=9835*)
...
834: 0x10FF [0x1D] PRINT_EVENT_MESSAGE(message_id=9836*)
...
837: 0x1108 [0x1D] PRINT_EVENT_MESSAGE(message_id=9837*)
...
839: 0x110C [0x1D] PRINT_EVENT_MESSAGE(message_id=9838*)
...
841: 0x1110 [0x1D] PRINT_EVENT_MESSAGE(message_id=9839*)
...
843: 0x1114 [0x1D] PRINT_EVENT_MESSAGE(message_id=9840*)
    → "Should too much debris be allowed to accumulate, the contents of the furnace will become unstable, potentially leading to unpleasant explosions and eruptions. Such accidents pose considerable risk to the synergy attempt in progress, as well as the physical well-being of the synergist, so be sure to exercise due caution!"
844: 0x1117 [0x23] WAIT_FOR_DIALOG_INTERACTION
845: 0x1118 [0x1D] PRINT_EVENT_MESSAGE(message_id=9841*)
...
847: 0x111C [0x1D] PRINT_EVENT_MESSAGE(message_id=9842*)
...
849: 0x1120 [0x1D] PRINT_EVENT_MESSAGE(message_id=9843*)
...
852: 0x1129 [0x1D] PRINT_EVENT_MESSAGE(message_id=9844*)
...
855: 0x1132 [0x1D] PRINT_EVENT_MESSAGE(message_id=9845*)
...
858: 0x113B [0x1D] PRINT_EVENT_MESSAGE(message_id=9846*)
...
860: 0x113F [0x1D] PRINT_EVENT_MESSAGE(message_id=9847*)
...
865: 0x1153 [0x1D] PRINT_EVENT_MESSAGE(message_id=9848*)
...
867: 0x1157 [0x1D] PRINT_EVENT_MESSAGE(message_id=9849*)
...
869: 0x115B [0x1D] PRINT_EVENT_MESSAGE(message_id=9850*)
...
871: 0x115F [0x1D] PRINT_EVENT_MESSAGE(message_id=9851*)
...
873: 0x1163 [0x1D] PRINT_EVENT_MESSAGE(message_id=9852*)
...
875: 0x1167 [0x1D] PRINT_EVENT_MESSAGE(message_id=9853*)
...
877: 0x116B [0x1D] PRINT_EVENT_MESSAGE(message_id=9854*)
...
879: 0x116F [0x1D] PRINT_EVENT_MESSAGE(message_id=9855*)
...
881: 0x1173 [0x1D] PRINT_EVENT_MESSAGE(message_id=9856*)
...
883: 0x1177 [0x1D] PRINT_EVENT_MESSAGE(message_id=9857*)
...
885: 0x117B [0x1D] PRINT_EVENT_MESSAGE(message_id=9858*)
...
887: 0x117F [0x1D] PRINT_EVENT_MESSAGE(message_id=9859*)
...
889: 0x1183 [0x1D] PRINT_EVENT_MESSAGE(message_id=9860*)
...
891: 0x1187 [0x1D] PRINT_EVENT_MESSAGE(message_id=9861*)
...
893: 0x118B [0x1D] PRINT_EVENT_MESSAGE(message_id=9862*)
...
895: 0x118F [0x1D] PRINT_EVENT_MESSAGE(message_id=9863*)
...
897: 0x1193 [0x1D] PRINT_EVENT_MESSAGE(message_id=9864*)
...
899: 0x1197 [0x1D] PRINT_EVENT_MESSAGE(message_id=9865*)
...
901: 0x119B [0x1D] PRINT_EVENT_MESSAGE(message_id=9866*)
...
903: 0x119F [0x1D] PRINT_EVENT_MESSAGE(message_id=9867*)
...
905: 0x11A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=9868*)
...
907: 0x11A7 [0x1D] PRINT_EVENT_MESSAGE(message_id=9869*)
...
909: 0x11AB [0x1D] PRINT_EVENT_MESSAGE(message_id=9870*)
...
913: 0x11BA [0x1D] PRINT_EVENT_MESSAGE(message_id=9871*)
...
915: 0x11BE [0x1D] PRINT_EVENT_MESSAGE(message_id=9872*)
...
917: 0x11C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=9873*)
...
919: 0x11C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=9874*)
...
922: 0x11CF [0x1D] PRINT_EVENT_MESSAGE(message_id=9875*)
...
925: 0x11D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=9876*)
...
927: 0x11DC [0x1D] PRINT_EVENT_MESSAGE(message_id=9877*)
...
929: 0x11E0 [0x1D] PRINT_EVENT_MESSAGE(message_id=9878*)
...
931: 0x11E4 [0x1D] PRINT_EVENT_MESSAGE(message_id=9879*)
...
933: 0x11E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=9880*)
...
936: 0x11F1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9881*)
...
939: 0x11FA [0x1D] PRINT_EVENT_MESSAGE(message_id=9882*)
...
942: 0x1203 [0x1D] PRINT_EVENT_MESSAGE(message_id=9883*)
...
945: 0x120C [0x1D] PRINT_EVENT_MESSAGE(message_id=9884*)
...
948: 0x1215 [0x1D] PRINT_EVENT_MESSAGE(message_id=9885*)
...
950: 0x1219 [0x1D] PRINT_EVENT_MESSAGE(message_id=9886*)
...
954: 0x1227 [0x1D] PRINT_EVENT_MESSAGE(message_id=9887*)
...
956: 0x122B [0x1D] PRINT_EVENT_MESSAGE(message_id=9888*)
...
960: 0x123A [0x1D] PRINT_EVENT_MESSAGE(message_id=9889*)
...
963: 0x1243 [0x1D] PRINT_EVENT_MESSAGE(message_id=9890*)
...
966: 0x124C [0x1D] PRINT_EVENT_MESSAGE(message_id=9891*)
...
968: 0x1250 [0x1D] PRINT_EVENT_MESSAGE(message_id=9892*)
...
971: 0x1259 [0x1D] PRINT_EVENT_MESSAGE(message_id=9893*)
...
977: 0x1272 [0x1D] PRINT_EVENT_MESSAGE(message_id=9894*)
...
980: 0x127B [0x1D] PRINT_EVENT_MESSAGE(message_id=9895*)
...
983: 0x1284 [0x1D] PRINT_EVENT_MESSAGE(message_id=9896*)
...
987: 0x1292 [0x1D] PRINT_EVENT_MESSAGE(message_id=9897*)
...
991: 0x12A1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9898*)
...
993: 0x12A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=9899*)
...
995: 0x12A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=9900*)
...
997: 0x12AD [0x1D] PRINT_EVENT_MESSAGE(message_id=9901*)
...
999: 0x12B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9902*)
...
1001: 0x12B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=9903*)
...
1005: 0x12C4 [0x1D] PRINT_EVENT_MESSAGE(message_id=9904*)
...
1007: 0x12C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=9905*)
...
1009: 0x12CC [0x1D] PRINT_EVENT_MESSAGE(message_id=9906*)
...
1011: 0x12D0 [0x1D] PRINT_EVENT_MESSAGE(message_id=9907*)
...
1022: 0x12F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=9908*)
...
1024: 0x12F7 [0x1D] PRINT_EVENT_MESSAGE(message_id=9909*)
...
SUBROUTINE_1435:
1083: 0x1435 [0x1D] PRINT_EVENT_MESSAGE(message_id=9910*)
...
1169: 0x15D1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9915*)
...
1173: 0x15DD [0x1D] PRINT_EVENT_MESSAGE(message_id=9916*)
...
1178: 0x15F1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9918*)
...
1183: 0x1605 [0x1D] PRINT_EVENT_MESSAGE(message_id=9917*)
