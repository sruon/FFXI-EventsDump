...
- **10357**: Why, hello there! My tremendous task is to tabulate your precious points for the [/January/February/March/April/May/June/July/August/September/October/November/December] $0 login campaign and exchange them for pleasing prizes, kupo!
- **10358**: What can I assist you with? ($1 pt[/s].) [Check/Exchange points./Learn about the campaign./Nothing.]
- **10359**: In this login campaign, we provide you with points just for logging in once each day (Earth time), kupo!
- **10360**: You can trade them for incredible items to assist you with your adventures!
- **10362**: You can trade in these tokens for our gratuitous gifts any time during this campaign!
- **10363**: Even when the point-proffering period has passed, you can still acquire these amazing items for a limited time, so don't forget about me, kupo!
- **10364**: Up to 700 points from the current campaign can be carried over to the next one starting with the October 2025 login campaign!
- **10365**: Any additional points will be summarily seized, kupo!
- **10366**: View which item? ($1 pts.) [$2-point items./$3-pt. items./$4-pt. items./$5-pt. items./$6-pt. items./$7-pt. items./$8-pt. items./$9-pt. items./Back.]
- **10368**: $23 costs $22 point[/s]. [You don't have enough points, kupo./Purchase this prize, kupo?/]
- **10369**: How many would you like, kupo?
- **10370**: Altana above! You do not possess the prerequisite number of points!
- **10371**: Proceed with exchange? ($1 pt[/s].) [Yes./No.]
- **10372**: Wait one short second while I get your goods!
...
```
 ...
 14: 0x006F [0x1D] PRINT_EVENT_MESSAGE(message_id=10357*)
 ...
 17: 0x0078 [0x24] CREATE_DIALOG(message_id=10358*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00D0:
 ...
 32: 0x00FD [0x24] CREATE_DIALOG(message_id=10366*, default_option=ExtData[1]->WorkLocal[9], option_flags=ExtData[1]->WorkLocal[3])
...
107: 0x0338 [0x1D] PRINT_EVENT_MESSAGE(message_id=10368*)
...
121: 0x03BC [0x1D] PRINT_EVENT_MESSAGE(message_id=10370*)
...
127: 0x03CC [0x1D] PRINT_EVENT_MESSAGE(message_id=10372*)
