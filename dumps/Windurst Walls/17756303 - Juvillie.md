...
- **9100**: The minstrel of melodies is my name, For a mere $6 gil I'll recall your past. Your stories of love, anger, triumph, and shame, The river of memories runs deep and vast.
- **9101**: The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last.
- **9103**: Which memory will you have recalled? [Nothing./Windurst Missions./Windurst Quests 1./Windurst Quests 2./Other Quests./Promathia Missions./Add-on Scenarios.]
- **9104**: Which memory will you have recalled? [Nothing./Lost for Words./The Jester Who'd Be King./Moon Reading]
- **9105**: Which memory will you have recalled? [Nothing./Curses, Foiled A-Golem!?/Nothing Matters(pt.1)./Nothing Matters(pt.2)./Nothing Matters(pt.3)./Know One's Onions./Onion Rings./Wild Card(pt.1)./Wild Card(pt.2)./Wild Card(pt.3)./Wild Card(pt.4)./I Can Hear a Rainbow(pt.1)./I Can Hear a Rainbow(pt.2)./The Puppet Master(pt.1)./The Puppet Master(pt.2)./Class Reunion(pt.1)./Class Reunion(pt.2)./Class Reunion(pt.3)./Class Reunion(pt.4).]
- **9106**: Which memory will you have recalled? [Nothing./Carbuncle Debacle(pt.1)./Carbuncle Debacle(pt.2)./Blood and Glory(pt.1)./Blood and Glory(pt.2)./Blood and Glory(pt.3).]
- **9107**: Which memory will you have recalled? [Nothing./Dynamis - The Shrouded Land(pt.1)./Dynamis - The Shrouded Land(pt.2)./Dynamis Interloper./Trust (Shantotto)./Trust (Mumor)./Trust (Mumor II).]
- **9108**: Which memory will you have recalled? [Nothing./Comedy of Errors, Act I./Comedy of Errors, Act II(pt.1)./Comedy of Errors, Act II(pt.2)./Exit Stage Left./Head Wind.]
- **9109**: Which memory will you have recalled? [Nothing./Drenched! It Began with a Raindrop./Hasten! In a Jam in Jeuno?/An Errand! The Professor's Price(pt.1)./An Errand! The Professor's Price(pt.2)./Burgeoning Dread(pt.1)./Burgeoning Dread(pt.2)./A Shantotto Ascension (Fin)./Cacophonous Discord./Kupipi's Dilemma./The Cardians' Duty./Koru-Moru's Hypothesis(pt.1)./Koru-Moru's Hypothesis(pt.2)./Koru-Moru's Hypothesis(pt.3)./Moglesse Oblige./Your Decision.]
...
```
  ...
  3: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=9101*)
 ...
 21: 0x0088 [0x1D] PRINT_EVENT_MESSAGE(message_id=9101*)
    → "The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last."
 22: 0x008B [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x008C [0x21] END_EVENT
 24: 0x008D [0x00] END_REQSTACK()
 25: 0x008E [0x1D] PRINT_EVENT_MESSAGE(message_id=9100*)
 ...
 39: 0x00D4 [0x24] CREATE_DIALOG(message_id=9103*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00E4:
 42: 0x00E4 [0x24] CREATE_DIALOG(message_id=9104*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_0113:
 50: 0x0113 [0x24] CREATE_DIALOG(message_id=9105*, default_option=0*, option_flags=Work_Zone[3])
...
SUBROUTINE_0142:
 58: 0x0142 [0x24] CREATE_DIALOG(message_id=9106*, default_option=0*, option_flags=Work_Zone[4])
...
SUBROUTINE_0171:
 66: 0x0171 [0x24] CREATE_DIALOG(message_id=9107*, default_option=0*, option_flags=Work_Zone[5])
...
SUBROUTINE_01A0:
 74: 0x01A0 [0x24] CREATE_DIALOG(message_id=9108*, default_option=0*, option_flags=Work_Zone[6])
...
SUBROUTINE_01CF:
 82: 0x01CF [0x24] CREATE_DIALOG(message_id=9109*, default_option=0*, option_flags=Work_Zone[7])
