...
```
  ...
  4: 0x002F [0x1D] PRINT_EVENT_MESSAGE(message_id=7908*)
    → "Why are there so many hot-blooded Mithra? They shouldn't worry so much about winning or losing-wosing.\u007F1\u0000\u0007"
  5: 0x0032 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0033 [0x1D] PRINT_EVENT_MESSAGE(message_id=7909*)
    → "What's done is done.\u0007Don't you think-wink that it's better to forget the past and concentrate on improving your relationships with others now?\u007F1\u0000\u0007"
