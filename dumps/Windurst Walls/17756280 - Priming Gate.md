...
- **8845**: Pass through the gate? [Yes./No.]
- **8846**: Enter the gate? [Yes./No.]
...
```
  ...
  2: 0x0004 [0x24] CREATE_DIALOG(message_id=8845*, default_option=1*, option_flags=0*)
...
```
  ...
  2: 0x00BE [0x24] CREATE_DIALOG(message_id=8846*, default_option=1*, option_flags=0*)
