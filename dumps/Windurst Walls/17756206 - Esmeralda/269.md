...
```
  ...
  4: 0x005F [0x1D] PRINT_EVENT_MESSAGE(message_id=7710*)
    → "Our main function is to render assistance to citizens of Jeuno who encounter trouble in foreign lands. So, most of the people who visit here are from Jeuno.\u007F1\u0000\u0007"
  5: 0x0062 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0063 [0x1D] PRINT_EVENT_MESSAGE(message_id=7711*)
    → "As you are not a citizen of Jeuno, I assume this facility is of no immediate consequence to you.\u007F1\u0000\u0007"
