...
- **11200**: This is an explanation of the Assist Channel feature, which allows new and returning players to seek help from veteran adventurers.
- **11201**: You must take on the "$0" Records of Eminence objective before receiving the explanation.
- **11202**: You must complete "$1" before taking on the "$0" Records of Eminence objective.
- **11203**: What do you want to learn about? [What is the Assist Channel?/How can I post a message?/What are the requirements?/Where can I access it?/Tell me about mentor messages./Where can I find mentors?/What are Thumbs Up and Warnings?/What happens if I am muted?/When do my posting rights expire?/Nothing for now.]
- **11204**: The Assist Channel is a special chat channel that allows adventurers to ask questions and receive advice from veteran players known as mentors.
- **11205**: Press the space bar to bring up the text window at the bottom of the screen and type "/assistj (your message)" or "/assiste (your message)" to post your message.
- **11206**: You can also use "/aj" for "/assistj", and "/ae" for "/assiste".
- **11207**: Additionally, pressing CTRL+Q will display "/assistj" or "/assiste" in the text window for you.
- **11208**: You can change the CTRL+Q shortcut command...
- **11209**: ...by going to Main Menu > Config > Misc. 2 > Key Assignment > Commands > Chat: /AssistE or /AssistJ.
- **11210**: It is recommended that you use "/assistj (/aj)" when posting in Japanese, and "/assiste (/ae)" when posting in English.
- **11211**: You must meet one of the following conditions in order to post to the Assist Channel.
- **11212**: 1. You are a new player You may post messages from the moment you first set foot in Vana'diel.
- **11213**: 2. You are a returnee As a returning player, you may post messages upon logging in with a character that has not logged in for at least 48 days.
- **11214**: 3. You are a mentor You may post messages as long as you remain a mentor to other players.
- **11215**: New players and returnees may post messages until they have been logged in for a total of 48 hours since first receiving their posting rights.
- **11216**: If you wish to check how long you can continue to post for, speak to an % and choose "When do my posting rights expire?" to see how much time you have left.
- **11217**: The Assist Channel can only be used in the following areas.
- **11218**: Available areas: $7, $7, $7, $7, $7, $7...
- **11219**: ...$7, $7, $7, $7, $7, $7, $7, $7...
- **11220**: ...$7, $7, $7, $7, $7, $7, $7, $7...
- **11221**: ...$7, $7, $7, and your Mog House (Rent-a-Room).
- **11222**: You cannot post or read messages outside of the areas listed above.
- **11223**: Even in areas where messages are allowed, you cannot post consecutive messages. Please wait a while after posting a message.
- **11224**: Mentor messages are accompanied by a flag (o/) marker. This marker indicates the mentor's reliability (Mentor Class) and experience as an adventurer (Mastery Rank).
- **11225**: As a mentor's Mentor Class increases, the color and shape of the marker will change: o/ > o9 > oC
- **11226**: A oC marker is a sign that the mentor has earned the highest levels of trust from other adventurers.
- **11227**: The number affixed to the marker is the mentor's Mastery Rank, and indicates how experienced the mentor is as an adventurer.
- **11228**: The higher the number, the more experienced the mentor is.
- **11229**: You can check your own Mastery Rank even if you do not serve as a mentor, so feel free to take a look every now and then if you are curious.
- **11230**: You can check your Mastery Rank by going to Main Menu > Status > Profile.
- **11231**: If you wish to speak directly to a mentor, you can search for mentors by going to Main Menu > Help Desk > Mentor Search.
- **11232**: The "Thumbs Up" feature enables you to let mentors know when their comments proved to be especially helpful.
- **11233**: Mentors who earn lots of "Thumbs Up" replies from other adventurers will see their Mentor Class increase.
- **11234**: Remember to give a "Thumbs Up" to any mentor you feel helped you out or taught you something useful.
- **11235**: A "Warning" is a feature that can only be used by mentors.
- **11236**: Please use this feature when a post's contents are insufficient or otherwise may be construed as harassment.
- **11237**: To send a "Thumbs Up" or "Warning" to another player, open the Chat Log Window and move the cursor over the relevant message and press the confirm button (Enter key) to bring up the evaluation menu.
- **11238**: Evaluations can be made for 10 minutes following the designated player's latest post to the Assist Channel.
- **11239**: You may send up to one "Thumbs Up" and one "Warning" per day (Earth time).
- **11240**: The "Mute" feature places restrictions on your ability to post, meaning that other players will be unable to see the messages you post to the Assist Channel.
- **11241**: Please refrain from posting unsuitable content so that the veteran adventurers are not forced to mute you.
- **11242**: Mute status can be removed by players that have the necessary Mute List access rights, or it will be removed automatically 24 hours (Earth time) after the mute status was enabled.
- **11243**: You are free to post messages to the Assist Channel until you decide to stop serving as a mentor.
- **11244**: You may post messages to the Assist Channel until : on //. (Time remaining: Approx. $1 [sec./min./hr.])
- **11245**: If you log out while you still have time available, your remaining time will be carried over to the next time you log in.
- **11246**: You are about to lose the ability to post messages to the Assist Channel.
- **11247**: You are unable to post messages to the Assist Channel.
...
```
  ...
  3: 0x000B [0x1D] PRINT_EVENT_MESSAGE(message_id=11200*)
  ...
  7: 0x001A [0x24] CREATE_DIALOG(message_id=11203*, default_option=ExtData[1]->WorkLocal[4], option_flags=0*)
...
```
  ...
  4: 0x00E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=11200*)
    → "This is an explanation of the Assist Channel feature, which allows new and returning players to seek help from veteran adventurers."
  ...
  9: 0x00FC [0x24] CREATE_DIALOG(message_id=11203*, default_option=ExtData[1]->WorkLocal[4], option_flags=ExtData[1]->WorkLocal[3])
    → "What do you want to learn about? [What is the Assist Channel?/How can I post a message?/What are the requirements?/Where can I access it?/Tell me about mentor messages./Where can I find mentors?/What are Thumbs Up and Warnings?/What happens if I am muted?/When do my posting rights expire?/Nothing for now.]"
...
SUBROUTINE_0201:
 ...
 63: 0x0210 [0x1D] PRINT_EVENT_MESSAGE(message_id=11204*)
...
SUBROUTINE_0231:
 ...
 69: 0x0240 [0x1D] PRINT_EVENT_MESSAGE(message_id=11205*)
 ...
 71: 0x0244 [0x1D] PRINT_EVENT_MESSAGE(message_id=11206*)
    → "You can also use "/aj" for "/assistj", and "/ae" for "/assiste"."
 72: 0x0247 [0x23] WAIT_FOR_DIALOG_INTERACTION
 73: 0x0248 [0x1D] PRINT_EVENT_MESSAGE(message_id=11207*)
 ...
 75: 0x024C [0x1D] PRINT_EVENT_MESSAGE(message_id=11208*)
    → "You can change the CTRL+Q shortcut command..."
 76: 0x024F [0x23] WAIT_FOR_DIALOG_INTERACTION
 77: 0x0250 [0x1D] PRINT_EVENT_MESSAGE(message_id=11209*)
 ...
 79: 0x0254 [0x1D] PRINT_EVENT_MESSAGE(message_id=11210*)
...
SUBROUTINE_0275:
 ...
 85: 0x0284 [0x1D] PRINT_EVENT_MESSAGE(message_id=11211*)
 ...
 87: 0x0288 [0x1D] PRINT_EVENT_MESSAGE(message_id=11212*)
 ...
 89: 0x028C [0x1D] PRINT_EVENT_MESSAGE(message_id=11213*)
 ...
 91: 0x0290 [0x1D] PRINT_EVENT_MESSAGE(message_id=11214*)
 ...
 93: 0x0294 [0x1D] PRINT_EVENT_MESSAGE(message_id=11215*)
 ...
 95: 0x0298 [0x1D] PRINT_EVENT_MESSAGE(message_id=11216*)
...
119: 0x0310 [0x1D] PRINT_EVENT_MESSAGE(message_id=11224*)
...
121: 0x0314 [0x1D] PRINT_EVENT_MESSAGE(message_id=11225*)
...
123: 0x0318 [0x1D] PRINT_EVENT_MESSAGE(message_id=11226*)
...
125: 0x031C [0x1D] PRINT_EVENT_MESSAGE(message_id=11227*)
...
127: 0x0320 [0x1D] PRINT_EVENT_MESSAGE(message_id=11228*)
    → "The higher the number, the more experienced the mentor is."
128: 0x0323 [0x23] WAIT_FOR_DIALOG_INTERACTION
129: 0x0324 [0x1D] PRINT_EVENT_MESSAGE(message_id=11229*)
...
131: 0x0328 [0x1D] PRINT_EVENT_MESSAGE(message_id=11230*)
...
137: 0x0358 [0x1D] PRINT_EVENT_MESSAGE(message_id=11231*)
...
143: 0x0388 [0x1D] PRINT_EVENT_MESSAGE(message_id=11232*)
...
145: 0x038C [0x1D] PRINT_EVENT_MESSAGE(message_id=11233*)
...
147: 0x0390 [0x1D] PRINT_EVENT_MESSAGE(message_id=11234*)
...
149: 0x0394 [0x1D] PRINT_EVENT_MESSAGE(message_id=11235*)
    → "A "Warning" is a feature that can only be used by mentors."
150: 0x0397 [0x23] WAIT_FOR_DIALOG_INTERACTION
151: 0x0398 [0x1D] PRINT_EVENT_MESSAGE(message_id=11236*)
...
153: 0x039C [0x1D] PRINT_EVENT_MESSAGE(message_id=11237*)
...
155: 0x03A0 [0x1D] PRINT_EVENT_MESSAGE(message_id=11238*)
...
157: 0x03A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=11239*)
...
163: 0x03D4 [0x1D] PRINT_EVENT_MESSAGE(message_id=11240*)
...
165: 0x03D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=11241*)
...
167: 0x03DC [0x1D] PRINT_EVENT_MESSAGE(message_id=11242*)
...
190: 0x045B [0x1D] PRINT_EVENT_MESSAGE(message_id=11244*)
...
192: 0x045F [0x1D] PRINT_EVENT_MESSAGE(message_id=11245*)
...
195: 0x0466 [0x1D] PRINT_EVENT_MESSAGE(message_id=11246*)
...
199: 0x0475 [0x1D] PRINT_EVENT_MESSAGE(message_id=11243*)
...
202: 0x047C [0x1D] PRINT_EVENT_MESSAGE(message_id=11247*)
...
```
  ...
  6: 0x0497 [0x1D] PRINT_EVENT_MESSAGE(message_id=11200*)
    → "This is an explanation of the Assist Channel feature, which allows new and returning players to seek help from veteran adventurers."
  7: 0x049A [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x049B [0x48] [System] [11201*]:
