...
| [534](#event-534)        | 0x01D8       |    733 |            155 |
| [522](#event-522)        | 0x04B5       |    147 |             29 |
| [523](#event-523)        | 0x0548       |     30 |             10 |
| [524](#event-524)        | 0x0566       |     28 |              8 |
| [525](#event-525)        | 0x0582       |     28 |              8 |
| [65535.1](#event-655351) | 0x059E       |     28 |              8 |
| [536](#event-536)        | 0x05BA       |     93 |             23 |
| [537](#event-537)        | 0x0617       |     33 |             11 |
| [538](#event-538)        | 0x0638       |     28 |              8 |
| [539](#event-539)        | 0x0654       |     28 |              8 |
| [540](#event-540)        | 0x0670       |     33 |             11 |
...
- **9995**: Oy, would ya get a look at yer $0! I guess I can let ya open [/Dial 1/Dial 2/Dial 3/Dial 4/Dial 5/the special dial///the abjuration dial/the fortune dial/the furnishings dial//the Vana'versary dial] whenever ya want fer not a single onz o' daily tally!
- **9996**: Dun think that I's be a gil-grubbin' good-fer-nuthin'. If'n ya dun wanna open any dial, then I gives ya back yer $0.
- **9997**: Yer eyes be bigger'n yer stomach. If'n ya wanna open [/Dial 1/Dial 2/Dial 3/Dial 4/Dial 5/the Special Dial///the abjuration dial/the fortune dial/the furnishings dial//the Vana'versary dial] usin' yer $0, then ya gotta make room in yer bags!
...
0400: 80 B4 04 1E C0 F0 0E 01  6F 70 5B 2B 80 F8 FF FF  ........op[+....
0410: 7F F8 FF FF 7F 68 61 70  30 1D 2C 80 23 02 04 00  .....hap0.,.#...
0420: 03 80 00 34 04 03 03 10  02 00 29 80 C0 F0 0E 01  ...4......).....
0430: 01 1C 2D 80 2C C0 F0 0E  01 C0 F0 0E 01 6F 70 65  ..-.,........ope
0440: 6E 1C 2D 80 50 C0 F0 0E  01 C0 F0 0E 01 6F 70 65  n.-.P........ope
0450: 6E 5B 2B 80 F8 FF FF 7F  F8 FF FF 7F 68 61 70 31  n[+.........hap1
0460: 2C C0 F0 0E 01 C0 F0 0E  01 63 6C 6F 73 1E F0 FF  ,........clos...
...
# Dead code (unreachable instructions):
    ...
    → "So ya be wantin' the [special/Adoulin/pictlogica/Wanted] dial? Whoawhoawhoa! Get yer grubby hands offa that! I's already opened one fer ya today! Haul that keister outta here and come back t'morrow."
     ...
     0x0403 [0x1E] EventEntity looks at Treasure Coffer (ID: 17756352/0x010EF0C0) and starts talking
    ...
    → "Dis box is full o' myst'ries,t Dat span da realm's his'try,t So whatcha gonna get from da chest...o'...uh, fortunery?t"
     ...
     0x042A [0x29] REQ_SET_WAIT(priority=0x80, entity_id=Treasure Coffer (ID: 17756352/0x010EF0C0), tag_num=0x01)
     0x0431 [0x1C] WAIT(90* ticks)
     0x0434 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "open" with entities [Treasure Coffer (ID: 17756352/0x010EF0C0), Treasure Coffer (ID: 17756352/0x010EF0C0)]
     0x0441 [0x1C] WAIT(90* ticks)
     0x0444 [0x50] END_SCHEDULER_TASK: End scheduler "op" with entities [0xF0C0, 0xF0C0], work=[270, 270]
     0x0451 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "hap1" with entities [EventEntity, EventEntity], work=216*
     0x0460 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "clos" with entities [Treasure Coffer (ID: 17756352/0x010EF0C0), Treasure Coffer (ID: 17756352/0x010EF0C0)]
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0540:                          42 1E C0 F0 0E 01 6F 70          B.....op
...
```
  ...
  1: 0x0549 [0x1E] EventEntity looks at Treasure Coffer (ID: 17756352/0x010EF0C0) and starts talking
  ...
  6: 0x0560 [0x1D] PRINT_EVENT_MESSAGE(message_id=9986*)
...
```
  ...
  4: 0x057C [0x1D] PRINT_EVENT_MESSAGE(message_id=9987*)
...
```
  ...
  1: 0x05BB [0x7A] VM_CONTROL: Copy data from Unknown NPC (ID: 250658944/0x0EF0C080) (params=1, 2)
...
```
  ...
  5: 0x062E [0x1D] PRINT_EVENT_MESSAGE(message_id=9996*)
