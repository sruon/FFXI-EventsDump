...
02C0: 7F 6F 70 29 08 25 F0 0E  01 01 1D 23 80 23 29 08  .op).%.....#.#).
02D0: 25 F0 0E 01 07 45 1A 80  F0 FF FF 7F F0 FF FF 7F  %....E..........
02E0: 71 73 74 63 0E 80 48 1B  80 2E 20 00 21 00        qstc..H... .!.  
```
...
```
  ...
  9: 0x02D5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
 10: 0x02E6 [0x48] [System] [6552*]:
    → "Obtained 
\u0000 gil.\u0000\u0007"
 11: 0x02E9 [0x2E] SET_CLI_EVENT_CANCEL_FLAGS()
 12: 0x02EA [0x20] SET_CLI_EVENT_UC_FLAG: Unlock player control
 13: 0x02EC [0x21] END_EVENT
 14: 0x02ED [0x00] END_REQSTACK()
```
