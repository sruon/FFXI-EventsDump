...
- **7952**: I'm sure you've seen the automaton guards positioned all around Windurrrst. You had better take carrre when dealing with those Cardians.
- **7953**: This is just between you and me, but those machines go crrrazy sometimes. I've even heard that there have been Tarutaru kidnapped by the malfunctioning Carrrdians!
- **9614**: <Player>'s badge flashes brightly.
- **9626**: You had better take carrre when dealing with the Cardians. This is just between you and me, but those machines go crrrazy sometimes.
- **9627**: I've heard that there are similar creations in the Near East. I wonder if they have the same prrroblems...
...
```
  ...
  5: 0x0035 [0x1D] PRINT_EVENT_MESSAGE(message_id=7952*)
  ...
  7: 0x0039 [0x1D] PRINT_EVENT_MESSAGE(message_id=7953*)
...
```
  ...
  7: 0x0060 [0x1D] PRINT_EVENT_MESSAGE(message_id=9626*)
  ...
  9: 0x0064 [0x1D] PRINT_EVENT_MESSAGE(message_id=9627*)
