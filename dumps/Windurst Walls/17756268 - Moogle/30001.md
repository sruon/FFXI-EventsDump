...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
08A0:                   1E F0  FF FF 7F 6F 70 29 0B 6C        .....op).l
08B0: F0 0E 01 30 29 0B 6C F0  0E 01 31 20 00 21 00     ...0).l...1 .!. 
```
...
```
  ...
  3: 0x08AD [0x29] REQ_SET_WAIT(priority=0x0B, entity_id=Moogle (ID: 17756268/0x010EF06C), tag_num=0x30)
  4: 0x08B4 [0x29] REQ_SET_WAIT(priority=0x0B, entity_id=Moogle (ID: 17756268/0x010EF06C), tag_num=0x31)
