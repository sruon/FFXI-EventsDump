...
- **6514**: The shared memories of generations of mooglekind flood into your mind, granting you the ability to decipher the cryptic glyphs of your $3...
- **6515**: Review which trial? [Trial $0./Trial $1./Trial $2./Trial $3./Trial $4./Trial $5./Trial $6./Trial $7./Trial $8./Trial $9./Moogle's Almanack./Return.]
- **6520**: You open the tome to the "Moogle's Almanack" chapter and peruse its weather prognostication pages.
- **6521**: Close observation of the sky reveals that the weather in this area today will be $0 with occasional $1. There is also a slight chance of $2, so caution is in order.
- **6522**: Predicting ahead, tomorrow's weather looks to be $0 with occasional $1. There is also a slight chance of $2, so caution is in order.
- **6523**: Finally, the forecast for the day after tomorrow calls for $0 with occasional $1. There is also a slight chance of $2, so caution is in order.
- **6524**: Close observation of the sky reveals that the weather in this area today will be $0 with a chance of $1.
- **6525**: Predicting ahead, tomorrow's weather looks to be $0 with a chance of $1.
- **6526**: Finally, the forecast for the day after tomorrow calls for $0 with a chance of $1.
- **6527**: Close observation of the sky reveals that the weather in this area today will be $0. There is also the possibility of $2, so caution is in order.
- **6528**: Predicting ahead, tomorrow's weather looks to be $0. There is also the possibility of $2, so caution is in order.
- **6529**: Finally, the forecast for the day after tomorrow calls for $0. There is also the possibility of $2, so caution is advised.
- **6530**: Close observation of the sky reveals that the weather in this area today will be $0.
- **6531**: Predicting ahead, tomorrow's weather looks to be $0.
- **6532**: Finally, the forecast for the day after tomorrow calls for $0.
...
```
 ...
 46: 0x013E [0x24] CREATE_DIALOG(message_id=6515*, default_option=0*, option_flags=ExtData[1]->WorkLocal[11])
 ...
 63: 0x0198 [0x07] ExtData[1]->WorkLocal[13] += 370*
 64: 0x019D [0x03] ExtData[1]->WorkLocal[14] = Work_Zone[2]
 65: 0x01A2 [0x07] ExtData[1]->WorkLocal[14] += 2418*
 66: 0x01A7 [0x03] ExtData[1]->WorkLocal[15] = Work_Zone[2]
 67: 0x01AC [0x07] ExtData[1]->WorkLocal[15] += 4466*
