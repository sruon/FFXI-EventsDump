...
- **12922**: In Bibiki Bay there be a place known as Purgonorgo Isle. On this island lives a mighty strange character that won't listen to a word we has to say.
- **12924**: We've tried talking it out all civil-like, but things have gotten out o' hand. We've even been settin' monsters on each other in place of talking... Who knows what we'll be facing next!
- **12928**: The next "debate" is set to take place in the middle o' Purgonorgo Isle. Don't ye be losing now, matey!
- **12938**: Get yerself to Attohwa Chasm an' find that Mithran Tracker. She should be able to tell us if it's the real deal.
- **12939**: That paper smells kinda fishy. I'm telling ye, it's a fake!
- **12950**: Arrgh! If Windurst wasn't in cahoots with the Mithran pirates, we'd be able to get on with our battle!
- **12951**: I had me next strategy all worked out fer kickin that warmachine right off the island!
- **12952**: ...Now, just a second there, matey. Who was inside that warmachine, anyhow?
- **12953**: Arrgh! A name shoulda been written right there on the deed! I just can't remember...!
...
```
  ...
  4: 0x04DC [0x1D] PRINT_EVENT_MESSAGE(message_id=12922*)
  ...
  8: 0x04EE [0x1D] PRINT_EVENT_MESSAGE(message_id=12924*)
 ...
 12: 0x0500 [0x1D] PRINT_EVENT_MESSAGE(message_id=12928*)
...
```
  ...
  4: 0x051D [0x1D] PRINT_EVENT_MESSAGE(message_id=12938*)
  ...
  8: 0x052F [0x1D] PRINT_EVENT_MESSAGE(message_id=12939*)
...
```
  ...
  4: 0x054D [0x1D] PRINT_EVENT_MESSAGE(message_id=12950*)
  ...
  8: 0x055F [0x1D] PRINT_EVENT_MESSAGE(message_id=12951*)
 ...
 12: 0x0571 [0x1D] PRINT_EVENT_MESSAGE(message_id=12952*)
 ...
 18: 0x0591 [0x1D] PRINT_EVENT_MESSAGE(message_id=12953*)
...
```
 ...
 20: 0x062C [0x2B] Chipmy-Popmy (ID: 17760309/0x010F0035) [13009*]:
 ...
 22: 0x0634 [0x2B] Chipmy-Popmy (ID: 17760309/0x010F0035) [13010*]:
 ...
 26: 0x065C [0x2B] Chipmy-Popmy (ID: 17760309/0x010F0035) [13011*]:
 ...
 32: 0x0681 [0x2B] Chipmy-Popmy (ID: 17760309/0x010F0035) [13012*]:
 ...
 35: 0x068C [0x2B] Chipmy-Popmy (ID: 17760309/0x010F0035) [13013*]:
...
SUBROUTINE_0694:
 ...
 41: 0x06C2 [0x2B] Chipmy-Popmy (ID: 17760309/0x010F0035) [13014*]:
...
```
  ...
  6: 0x0737 [0x2B] Chipmy-Popmy (ID: 17760309/0x010F0035) [13009*]:
    → "A little while back, the Fishermen's Guild's ship party was crashed by a trio of wandering comedians."
  7: 0x073E [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x073F [0x2B] Chipmy-Popmy (ID: 17760309/0x010F0035) [13010*]:
    → "But they were so boring, me mates preferred to pitch themselves over the side than listen to another joyless joke!"
  9: 0x0746 [0x23] WAIT_FOR_DIALOG_INTERACTION
 10: 0x0747 [0x2B] Chipmy-Popmy (ID: 17760309/0x010F0035) [13011*]:
    → "We figured we'd be doin' Vana'diel a favor if we just marooned those jesters on an island."
 ...
 16: 0x076C [0x2B] Chipmy-Popmy (ID: 17760309/0x010F0035) [13012*]:
    → "This was no deserted island, ye understand. This was Purgonorgo Island in Bibiki Bay. There's a mighty strange character living there who don't take orders from no one."
 17: 0x0773 [0x23] WAIT_FOR_DIALOG_INTERACTION
 18: 0x0774 [0x01] GOTO 0x077F
 19: 0x0777 [0x2B] Chipmy-Popmy (ID: 17760309/0x010F0035) [13013*]:
    → "This was no deserted island, ye understand. This was Purgonorgo Island in Bibiki Bay. Those humorless hucksters can earn a livin' entertainin' the sole inhabitant."
...
SUBROUTINE_077F:
 ...
 23: 0x078D [0x2B] Chipmy-Popmy (ID: 17760309/0x010F0035) [13014*]:
    → "That stubborn seadog should be sufferin' their puerile puns as we speak! Gwahahahaha!"
