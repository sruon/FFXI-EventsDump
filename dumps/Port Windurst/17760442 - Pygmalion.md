...
- **12800**: Excuse me, [sir/madam]. If you are boarding the airship, might I ask you a favor?
- **12801**: A passenger who intended to board the next flight dropped this...
- **12802**: I cannot leave my post, so I was wondering if you could return it to its rightful owner in my stead?
- **12803**: Return the dropped item? [Gladly./Sorry, I'm a busy [man/woman].]
- **12804**: Thank you! The passenger who dropped the item looked like this.
- **12805**: Have you memorized the image?
- **12806**: Have you got it? [I got it./Not yet.]
- **12807**: The passenger who dropped the item should be on the next flight.
- **12808**: I leave the rest in your capable hands.
- **12809**: I see... I'm sorry to have bothered you with such a trivial request.
- **12810**: Oh, the airship has already left... I guess we'll just have to leave this with the airship authorities.
- **12811**: You were unable to meet with the rightful owner of the item? Well, thank you for your help, in any case. I will hand the item over to the airship authorities.
- **12812**: What, you've forgotten already?
- **12813**: Have you forgotten? [Yes./No.]
- **12814**: The passenger looked like this.
- **12815**: It's my job to look out for suspicious characters coming in on the airships.
...
```
  ...
  6: 0x001C [0x1D] PRINT_EVENT_MESSAGE(message_id=12811*)
 ...
 10: 0x002B [0x1D] PRINT_EVENT_MESSAGE(message_id=12812*)
    → "What, you've forgotten already?"
 11: 0x002E [0x23] WAIT_FOR_DIALOG_INTERACTION
 12: 0x002F [0x24] CREATE_DIALOG(message_id=12813*, default_option=1*, option_flags=0*)
    → "Have you forgotten? [Yes./No.]"
 13: 0x0036 [0x25] WAIT_DIALOG_SELECT()
 14: 0x0037 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x004A
 15: 0x003F [0x1D] PRINT_EVENT_MESSAGE(message_id=12814*)
...
SUBROUTINE_0052:
 ...
 26: 0x005D [0x1D] PRINT_EVENT_MESSAGE(message_id=12815*)
 ...
 35: 0x0070 [0x24] CREATE_DIALOG(message_id=12803*, default_option=0*, option_flags=0*)
 ...
 39: 0x0081 [0x1D] PRINT_EVENT_MESSAGE(message_id=12804*)
 ...
 44: 0x0093 [0x1D] PRINT_EVENT_MESSAGE(message_id=12809*)
...
SUBROUTINE_021C:
 ...
 92: 0x021D [0x1D] PRINT_EVENT_MESSAGE(message_id=12805*)
    → "Have you memorized the image?"
 93: 0x0220 [0x23] WAIT_FOR_DIALOG_INTERACTION
 94: 0x0221 [0x24] CREATE_DIALOG(message_id=12806*, default_option=1*, option_flags=0*)
...
109: 0x025E [0x1D] PRINT_EVENT_MESSAGE(message_id=12810*)
...
112: 0x0265 [0x1D] PRINT_EVENT_MESSAGE(message_id=12807*)
    → "The passenger who dropped the item should be on the next flight."
113: 0x0268 [0x23] WAIT_FOR_DIALOG_INTERACTION
114: 0x0269 [0x1D] PRINT_EVENT_MESSAGE(message_id=12808*)
    → "I leave the rest in your capable hands."
...
119: 0x0279 [0x1D] PRINT_EVENT_MESSAGE(message_id=12810*)
    → "Oh, the airship has already left... I guess we'll just have to leave this with the airship authorities."
