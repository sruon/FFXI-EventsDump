...
```
 ...
 12: 0x0041 [0x1D] PRINT_EVENT_MESSAGE(message_id=15579*)
    → "This is the gateway to Windurst's residential area. Inside, there are Mog Houses and Rent-a-Rooms available for your use.\u007F1\u0000\u0007"
 13: 0x0044 [0x23] WAIT_FOR_DIALOG_INTERACTION
 14: 0x0045 [0x02] IF !(ExtData[1]->WorkLocal[2] == 6*) GOTO 0x00CF
 15: 0x004D [0x24] CREATE_DIALOG(message_id=15587*, default_option=0*, option_flags=0x02)
 ...
 18: 0x005D [0x1D] PRINT_EVENT_MESSAGE(message_id=15583*)
    → "Well then, bye-bye and ta-taru!\u007F1\u0000\u0007"
 ...
 34: 0x009A [0x24] CREATE_DIALOG(message_id=15588*, default_option=0*, option_flags=0x01)
