...
SUBROUTINE_009C:
 ...
 59: 0x00C7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="swsd", work_offset2=0*)
 60: 0x00D8 [0x55] WAIT_LOAD_SCHEDULER(work_offset=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="swsd")
 61: 0x00E7 [0x01] GOTO 0x016B

SUBROUTINE_00EA:
 62: 0x00EA [0x02] IF !(ExtData[1]->WorkLocal[1] == 2*) GOTO 0x0115
 63: 0x00F2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="swbs", work_offset2=0*)
 64: 0x0103 [0x55] WAIT_LOAD_SCHEDULER(work_offset=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="swbs")
 65: 0x0112 [0x01] GOTO 0x016B

SUBROUTINE_0115:
 66: 0x0115 [0x02] IF !(ExtData[1]->WorkLocal[1] == 3*) GOTO 0x0140
 67: 0x011D [0x45] LOAD_SCHEDULED_TASK(work_offset1=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="swws", work_offset2=0*)
 68: 0x012E [0x55] WAIT_LOAD_SCHEDULER(work_offset=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="swws")
 69: 0x013D [0x01] GOTO 0x016B

SUBROUTINE_0140:
 70: 0x0140 [0x02] IF !(ExtData[1]->WorkLocal[1] == 4*) GOTO 0x016B
 71: 0x0148 [0x45] LOAD_SCHEDULED_TASK(work_offset1=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="swkz", work_offset2=0*)
 72: 0x0159 [0x55] WAIT_LOAD_SCHEDULER(work_offset=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="swkz")
...
SUBROUTINE_016B:
 ...
 76: 0x0178 [0x45] LOAD_SCHEDULED_TASK(work_offset1=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s232", work_offset2=0*)
 77: 0x0189 [0x55] WAIT_LOAD_SCHEDULER(work_offset=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s232")
 78: 0x0198 [0x01] GOTO 0x021C

SUBROUTINE_019B:
 79: 0x019B [0x02] IF !(ExtData[1]->WorkLocal[1] == 2*) GOTO 0x01C6
 80: 0x01A3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s236", work_offset2=0*)
 81: 0x01B4 [0x55] WAIT_LOAD_SCHEDULER(work_offset=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s236")
 82: 0x01C3 [0x01] GOTO 0x021C

SUBROUTINE_01C6:
 83: 0x01C6 [0x02] IF !(ExtData[1]->WorkLocal[1] == 3*) GOTO 0x01F1
 84: 0x01CE [0x45] LOAD_SCHEDULED_TASK(work_offset1=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s240", work_offset2=0*)
 85: 0x01DF [0x55] WAIT_LOAD_SCHEDULER(work_offset=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s240")
 86: 0x01EE [0x01] GOTO 0x021C

SUBROUTINE_01F1:
 87: 0x01F1 [0x02] IF !(ExtData[1]->WorkLocal[1] == 4*) GOTO 0x021C
 88: 0x01F9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s250", work_offset2=0*)
 89: 0x020A [0x55] WAIT_LOAD_SCHEDULER(work_offset=3*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s250")
...
SUBROUTINE_0297:
127: 0x0297 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo0", work_offset2=0*)
128: 0x02A8 [0x1C] WAIT(30* ticks)
129: 0x02AB [0x1B] RETURN

130: 0x02CD [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
131: 0x02DE [0x1B] RETURN

SUBROUTINE_02DF:
132: 0x02DF [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi0", work_offset2=0*)
