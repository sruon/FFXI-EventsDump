...
- **3668**: Do the words "elemental resistance" mean anything to you? As in, the stronger your resistance to fire is, the less damage you will receive from fire magic, and so on...?
- **3669**: Well, don't go getting it wrong, now. Just 'cause your fire resistance is strong doesn'taru mean the fire magic you cast is strong as well. You get whataru I mean?
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0010:                                            5F 00                _.
0020: 4B 1D 00 0F 01 00 80 00                           K.......        
```
...
```
  ...
  1: 0x0020 [0x4B] UPDATE_ENTITY_YAW(entity=Noragu-Meragu (ID: 17760285/0x010F001D), yaw=7.5°*)
...
```
  ...
  4: 0x0036 [0x1D] PRINT_EVENT_MESSAGE(message_id=3668*)
    → "Do the words "elemental resistance" mean anything to you? As in, the stronger your resistance to fire is, the less damage you will receive from fire magic, and so on...?"
  5: 0x0039 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x003A [0x1D] PRINT_EVENT_MESSAGE(message_id=3669*)
    → "Well, don't go getting it wrong, now. Just 'cause your fire resistance is strong doesn'taru mean the fire magic you cast is strong as well. You get whataru I mean?"
