...
- **3574**: For the arrival time of the next airship, you will need to speak with Kameel at the landing dock. We hope you have a pleasant flight.
...
0020: 70 29 08 47 00 0F 01 01  1D 02 80 23 29 08 47 00  p).G.......#).G.
...
```
  ...
  3: 0x0021 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Aigneis (ID: 17760327/0x010F0047), tag_num=0x01)
  4: 0x0028 [0x1D] PRINT_EVENT_MESSAGE(message_id=3574*)
    → "For the arrival time of the next airship, you will need to speak with Kameel at the landing dock. We hope you have a pleasant flight."
  5: 0x002B [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x002C [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Aigneis (ID: 17760327/0x010F0047), tag_num=0x02)
