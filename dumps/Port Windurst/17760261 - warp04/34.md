...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0000:    2C 05 00 0F 01 05 00  0F 01 63 61 62 6B 24 00   ,........cabk$.
...
```
  0: 0x0001 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "cabk" with entities [warp04 (ID: 17760261/0x010F0005), warp04 (ID: 17760261/0x010F0005)]
