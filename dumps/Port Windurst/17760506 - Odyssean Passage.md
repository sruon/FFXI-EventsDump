...
| [881](#event-881)     | 0x0001       |      7 |              2 |
| [883](#event-883)     | 0x0008       |    260 |             40 |
...
- **16122**: Vague images of worlds beyond coalesce and diffuse within.
- **16123**: Enter the light? [Take me now!/Absolutely not!]
- **16124**: Enter the light? [Take me now!/I'll dive in head first!/Absolutely not!]
...
```
  ...
  6: 0x001F [0x24] CREATE_DIALOG(message_id=16123*, default_option=0*, option_flags=0*)
...
SUBROUTINE_006F:
 ...
 18: 0x0072 [0x24] CREATE_DIALOG(message_id=16124*, default_option=0*, option_flags=0*)
