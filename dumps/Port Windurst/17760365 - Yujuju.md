...
| [340](#event-340)          | 0x0481       |     33 |             12 |
| [621](#event-621)          | 0x04A2       |     56 |             14 |
| [314](#event-314)          | 0x04DA       |     65 |             18 |
| [315](#event-315)          | 0x051B       |     29 |             10 |
| [592](#event-592)          | 0x0538       |      1 |              1 |
| [593](#event-593)          | 0x0539       |     54 |             14 |
...
- **3933**: Extra! Extra! Hear all about it!t "Magic Paradise Weekly" is chock-a-block full of the latest news in Windu\`rst!t Our chief editor, Naiko-Paneiko, is...
- **3934**: Huh!? What's up? Yeah, I said Naiko-Paneiko... What's it to you? He wants us to hand in our news articles? Oh, zooks! It's our deadline already?
- **3935**: Darn. I needed more time to come up with a better story so I could win the Pulitzer-Bulitzer Prize for unexpected journalistic ability. Anyway, here... Take it, you scoundrel.
- **3936**: I needed more time to come up with a better story so I could win the Pulitzer-Bulitzer Prize for unexpected journalistic ability. Anyway, take it to him, you scoundrel.
- **4096**: Extra! Extra! Hear all about it!t "Magic Paradise Weekly" is chock-a-block full of the latest news in Windu\`rst!t Get your copy at the Tarutaru Times office in Windurst Waters today!t
- **4097**: Our next special feature is...(What the heck was it again?)...well, you'll just have to buy the next issue of "Magic Paradise Weekly" to find out! Extra! Extra! Hear all about it!t
- **13095**: <Player>'s badge flashes brightly.
- **13096**: Extra! Extra! Hear all about it!t "Magic Paradise Weekly" is chock-a-block full of the latest news in Windu\`rst!t Our next issue contains a special feature on the latest talk of the town--the "Salaheem's Sentinels"!
- **13097**: The buzz is that the head of the company is a woman who'll knock your socks off!
- **13098**: Extra! Extra! Hear all about it!t This international news bulletin has been brought to you by "Magic Paradise Weekly"!
...
```
  ...
  4: 0x048F [0x1D] PRINT_EVENT_MESSAGE(message_id=4096*)
    → "Extra! Extra! Hear all about it!t "Magic Paradise Weekly" is chock-a-block full of the latest news in Windu`rst!t Get your copy at the Tarutaru Times office in Windurst Waters today!t"
  5: 0x0492 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0493 [0x1D] PRINT_EVENT_MESSAGE(message_id=4097*)
    → "Our next special feature is...(What the heck was it again?)...well, you'll just have to buy the next issue of "Magic Paradise Weekly" to find out! Extra! Extra! Hear all about it!t"
...
```
  ...
  5: 0x04BD [0x1D] PRINT_EVENT_MESSAGE(message_id=13096*)
    → "Extra! Extra! Hear all about it!t "Magic Paradise Weekly" is chock-a-block full of the latest news in Windu`rst!t Our next issue contains a special feature on the latest talk of the town--the "Salaheem's Sentinels"!"
  6: 0x04C0 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x04C1 [0x1D] PRINT_EVENT_MESSAGE(message_id=13097*)
    → "The buzz is that the head of the company is a woman who'll knock your socks off!"
 ...
 10: 0x04D4 [0x1D] PRINT_EVENT_MESSAGE(message_id=13098*)
    → "Extra! Extra! Hear all about it!t This international news bulletin has been brought to you by "Magic Paradise Weekly"!"
...
```
  ...
  1: 0x04E1 [0x1D] PRINT_EVENT_MESSAGE(message_id=3933*)
    → "Extra! Extra! Hear all about it!t "Magic Paradise Weekly" is chock-a-block full of the latest news in Windu`rst!t Our chief editor, Naiko-Paneiko, is..."
  ...
  8: 0x04FA [0x1D] PRINT_EVENT_MESSAGE(message_id=3934*)
    → "Huh!? What's up? Yeah, I said Naiko-Paneiko... What's it to you? He wants us to hand in our news articles? Oh, zooks! It's our deadline already?"
 ...
 12: 0x050C [0x1D] PRINT_EVENT_MESSAGE(message_id=3935*)
    → "Darn. I needed more time to come up with a better story so I could win the Pulitzer-Bulitzer Prize for unexpected journalistic ability. Anyway, here... Take it, you scoundrel."
...
```
  ...
  4: 0x0529 [0x1D] PRINT_EVENT_MESSAGE(message_id=3936*)
    → "I needed more time to come up with a better story so I could win the Pulitzer-Bulitzer Prize for unexpected journalistic ability. Anyway, take it to him, you scoundrel."
...
```
  ...
  4: 0x0547 [0x2B] Yujuju (ID: 17760365/0x010F006D) [12916*]:
    → "...And then they wentaru looking for a super-duper, double-whammy, extra-wizzy wizard somewhere in Windurst Waters."
  ...
  8: 0x055D [0x2B] Yujuju (ID: 17760365/0x010F006D) [12917*]:
    → "Extra! Extra! Hear all about it!t This has been a Windurst news update from your friendly "Magic Paradise Weekly" journalist!t"
