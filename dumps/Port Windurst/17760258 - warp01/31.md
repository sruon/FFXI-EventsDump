...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0000:    2C 02 00 0F 01 02 00  0F 01 63 61 62 6B 24 00   ,........cabk$.
...
```
  0: 0x0001 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "cabk" with entities [warp01 (ID: 17760258/0x010F0002), warp01 (ID: 17760258/0x010F0002)]
