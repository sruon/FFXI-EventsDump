...
SUBROUTINE_014E:
 45: 0x014E [0x24] CREATE_DIALOG(message_id=11739*, default_option=ExtData[1]->WorkLocal[17], option_flags=0*)
...
# Dead code (unreachable instructions):
    ...
    → "Two!\u007F4\u0002\u0000\u0007"
     ...
     0x0C2A [0x24] CREATE_DIALOG(message_id=11755*, default_option=ExtData[1]->WorkLocal[19], option_flags=ExtData[1]->WorkLocal[5])
