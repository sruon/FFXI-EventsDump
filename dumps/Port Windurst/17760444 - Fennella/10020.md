...
SUBROUTINE_00FC:
 24: 0x00FC [0x24] CREATE_DIALOG(message_id=11727*, default_option=1*, option_flags=0*)
...
SUBROUTINE_011D:
 ...
 36: 0x012F [0x1D] PRINT_EVENT_MESSAGE(message_id=11738*)
...
\u0000 guild points accumulated.\u007F1\u0000\u0007"
 ...
 39: 0x0136 [0x1D] PRINT_EVENT_MESSAGE(message_id=11737*)
...
SUBROUTINE_014E:
 45: 0x014E [0x24] CREATE_DIALOG(message_id=11739*, default_option=0x0011, option_flags=0*)
...
SUBROUTINE_0170:
 ...
 61: 0x01A3 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x801C, condition_work_offset=0x800F)
...
185: 0x0D9B [0x1D] PRINT_EVENT_MESSAGE(message_id=11743*)
...
191: 0x0DB4 [0x1D] PRINT_EVENT_MESSAGE(message_id=11742*)
...
194: 0x0DBB [0x1D] PRINT_EVENT_MESSAGE(message_id=11743*)
    → "You are not eligible to receive guild points at this time.\u007F1\u0000\u0007"
...
# Dead code (unreachable instructions):
    ...
    → "Two!\u007F4\u0002\u0000\u0007"
     ...
     0x04A7 [0x1C] WAIT(0x0F80 ticks)
     0x04AA [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 3842/0x00000F02))
     ...
     0x04D2 [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 50651392/0x0304E100))
     0x04D7 [0x12] ExtData[1]->WorkLocal[0] = rand()
     0x04DA [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 16862721/0x01014E01))
     0x04DF [0x55] WAIT_LOAD_SCHEDULER: Wait for scheduler 0x800F0012 with entities [Unknown NPC (ID: 2148470784/0x800F1000), Unknown NPC (ID: 50761472/0x03068F00)], work=0x020D
     ...
     0x051B [0xD4] MAP_QUERY_WINDOW: Prepare buffer configuration A (buffer=[0F 80 02 10 D4 03 1C 80...])
     ...
     0x06C9 [0xD4] MAP_QUERY_WINDOW: Prepare buffer configuration A (buffer=[0F 80 02 10 D4 03 1C 80...])
     0x06E7 [0xD4] MAP_QUERY_WINDOW: Prepare buffer configuration A (buffer=[51 80 07 10 D4 03 5A 80...])
     0x0705 [0x00] END_REQSTACK()
     0x0706 [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 50795776/0x03071500))
     0x070B [0x13] ExtData[1]->WorkLocal[0] = rand() % 0x0180
     0x0710 [0x70] WAIT_ENTITY_RENDER_FLAG: Wait while EventEntity->Render.Flags3 bit 2 is set (cancel turn if not)
     0x0711 [0x01] GOTO 0x2C01
     0x0714 [0x08] ExtData[1]->WorkLocal[2] -= 0x0F10
     0x0719 [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 50804480/0x03073700))
     0x071E [0x06] 0x0200 = 0
     0x0721 [0x10] 0x0803 <<= References[2304]
     0x0726 [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 469767171/0x1C001403))
     0x072B [0x80] LOAD_WAIT(entity=Unknown NPC (ID: 4867/0x00001303))
     0x0730 [0x10] 0x0B05 <<= 0x0100
     0x0735 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler 0x00060307 with entities [Unknown NPC (ID: 268435976/0x10000208), Unknown NPC (ID: 1493205020/0x5900801C)]
     0x0742 [0x03] 0x0310 = ExtData[1]->WorkLocal[8]
     0x0747 [0x89] OPEN_MAP(map_id=0x00000380)
     0x074A [0x14] 0x1C00 *= 0x0380
     0x074F [0x13] ExtData[1]->WorkLocal[0] = rand() % 0x0510
     0x0754 [0x0B] 0x0100++
     0x0757 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler 0x00060307 with entities [Unknown NPC (ID: 268435976/0x10000208), Unknown NPC (ID: 2063630374/0x7B008026)]
     0x0764 [0x04] DEPRECATED_NOP(unused=0x0310)
     0x0767 [0x08] References[2304] -= 0x0380
     0x076C [0x14] 0x1C00 *= 0x0380
     0x0771 [0x13] ExtData[1]->WorkLocal[0] = rand() % 0x0510
     0x0776 [0x0B] 0x0100++
     0x0779 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler 0x00060307 with entities [Unknown NPC (ID: 268435976/0x10000208), Unknown NPC (ID: 2634055743/0x9D00803F)]
     0x0786 [0x05] 0x0310 = 1
     0x0789 [0x08] References[2304] -= 0x0380
     0x078E [0x14] 0x1C00 *= 0x0380
     0x0793 [0x13] ExtData[1]->WorkLocal[0] = rand() % 0x0510
     0x0798 [0x0B] 0x0100++
     0x079B [0x2C] CREATE_SCHEDULER_TASK: Create scheduler 0x00060307 with entities [Unknown NPC (ID: 268435976/0x10000208), Unknown NPC (ID: 3204481096/0xBF008048)]
     0x07A8 [0x06] 0x0310 = 0
     0x07AB [0x08] References[2304] -= 0x0380
     0x07B0 [0x14] 0x1C00 *= 0x0380
     0x07B5 [0x13] ExtData[1]->WorkLocal[0] = rand() % 0x0510
     0x07BA [0x0B] 0x0100++
     0x07BD [0x2C] CREATE_SCHEDULER_TASK: Create scheduler 0x00060307 with entities [Unknown NPC (ID: 268435976/0x10000208), Unknown NPC (ID: 3774906449/0xE1008051)]
     0x07CA [0x07] 0x0310 += ExtData[1]->WorkLocal[8]
     0x07CF [0x89] OPEN_MAP(map_id=0x00000380)
     0x07D2 [0x14] 0x1C00 *= 0x0380
     0x07D7 [0x13] ExtData[1]->WorkLocal[0] = rand() % 0x0510
     0x07DC [0x0B] 0x0100++
     0x07DF [0x2C] CREATE_SCHEDULER_TASK: Create scheduler 0x00060308 with entities [Unknown NPC (ID: 268435976/0x10000208), Unknown NPC (ID: 50364506/0x0300805A)]
     0x07EC [0x08] 0x0310 -= ExtData[1]->WorkLocal[8]
     0x07F1 [0x89] OPEN_MAP(map_id=0x00000380)
     0x07F4 [0x14] 0x1C00 *= 0x0380
     0x07F9 [0x13] ExtData[1]->WorkLocal[0] = rand() % 0x0510
     0x07FE [0x0B] 0x0100++
     0x0801 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler 0x00060308 with entities [Unknown NPC (ID: 268435976/0x10000208), Unknown NPC (ID: 620789859/0x25008063)]
     0x080E [0x09] 0x0310 |= (1 << ExtData[1]->WorkLocal[8])
     0x0813 [0x89] OPEN_MAP(map_id=0x00000380)
     0x0816 [0x14] 0x1C00 *= 0x0380
     0x081B [0x13] ExtData[1]->WorkLocal[0] = rand() % 0x0510
     0x0820 [0x0B] 0x0100++
     0x0823 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler 0x13001503 with entities [Unknown NPC (ID: 268501768/0x10010308), Unknown NPC (ID: 2195463/0x00218007)]
     0x0830 [0x00] END_REQSTACK()
     ...
     0x0C2A [0x24] CREATE_DIALOG(message_id=11755*, default_option=0x0013, option_flags=0x05)
...
\u000B).\u0007\u007F\u0000\u0001\u0001\u00053\u0002\u000C\u0000\u0000(
     ...
     0x0D0B [0x1D] PRINT_EVENT_MESSAGE(message_id=11756*)
    → "Trade 
\u0001 guild points for \u0001\u00053\u0002\u0000\u0000\u0000?\u007F1\u0000\u0007"
     0x0D0E [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0D0F [0x24] CREATE_DIALOG(message_id=11753*, default_option=1*, option_flags=0*)
...
# Dead code (unreachable instructions):
     ...
     0x0E03 [0x1D] PRINT_EVENT_MESSAGE(message_id=11751*)
    → "How many do you wish to trade for?\u007F1\u0000\u0007"
     ...
     0x0E38 [0x1D] PRINT_EVENT_MESSAGE(message_id=11750*)
    → "Trade 
\u0001 guild points for \u0001\u0005%\u0002\u0000\u0000\u0000?\u007F1\u0000\u0007"
     0x0E3B [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0E3C [0x01] GOTO 0x0E43
     0x0E3F [0x1D] PRINT_EVENT_MESSAGE(message_id=11752*)
    → "Trade 
\u0001 guild points for 
\u0002 \u0001	)\u0002\u0002\u0000\u0000\u0002\u0000\u0000\u0000?\u007F1\u0000\u0007"
     ...
     0x0E4B [0x24] CREATE_DIALOG(message_id=11753*, default_option=1*, option_flags=0*)
    → "Proceed with the transaction? (GP: 
 )\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
     ...
     0x0E8C [0x1B] RETURN
     0x0E8D [0x02] IF !(Work_Zone[2] == 1976*) GOTO 0x0E9C
     0x0E95 [0x1D] PRINT_EVENT_MESSAGE(message_id=11835*)
    → "\u007F\u0000\u0001\u0001\u00053\u0002\u0000\u0000\u0000 is a special technique that requires the use of a live fly on one's line. It is perfect for catching amphibious prey such as frogs and newts.\u007F1\u0000\u0007"
     0x0E98 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0E99 [0x01] GOTO 0x0EBE
     0x0E9C [0x02] IF !(Work_Zone[2] == 1977*) GOTO 0x0EAF
     0x0EA4 [0x1D] PRINT_EVENT_MESSAGE(message_id=11836*)
    → "Lately, there have been an increasing number of sightings of some strange beast roaming the waters of Vana'diel. This compilation of \u0001\u00053\u0002\u0000\u0000\u0000 further details those encounters.\u007F1\u0000\u0007"
     0x0EA7 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0EA8 [0x1D] PRINT_EVENT_MESSAGE(message_id=11837*)
    → "From the times and weather conditions in which it appears, all the way to swimming patterns and eating habits--everything you need to know about the \u00072serpent\u00073 is here.\u007F1\u0000\u0007"
     0x0EAB [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0EAC [0x01] GOTO 0x0EBE
     0x0EAF [0x02] IF !(Work_Zone[2] == 1978*) GOTO 0x0EBE
     0x0EB7 [0x1D] PRINT_EVENT_MESSAGE(message_id=11838*)
    → "\u007F\u0000\u0001\u0001\u00053\u0002\u0000\u0000\u0000 is a legendary technique used by anglers across Vana'diel. It involves using live fish as bait to attract those more \u00072finicky\u00073 big targets.\u007F1\u0000\u0007"
