...
```
  ...
  4: 0x0036 [0x1D] PRINT_EVENT_MESSAGE(message_id=3652*)
    → "This is hopeless-a-wopeless!\u0007It's just the same old wow-kapow and kaboom-a-boom-boom on the same old dummy Cardian target, over and over, day in and day out...\u007F1\u0000\u0007"
  5: 0x0039 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x003A [0x1D] PRINT_EVENT_MESSAGE(message_id=3653*)
    → "It doesn't matter how fantastic-a-wastic the magic is! If I can only use it in here, then it is no more than a boring old fireworks display-a-way. Oh, how I want to try my spells out on real monsters!\u007F1\u0000\u0007"
