...
```
  ...
  4: 0x03D5 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [EventEntity, EventEntity], work=[200*, 0*]
 ...
 17: 0x0421 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s103" with entities [LocalPlayer, LocalPlayer], work=[140*, 0*]
 18: 0x0432 [0x01] GOTO 0x0446
 19: 0x0435 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s064" with entities [LocalPlayer, LocalPlayer], work=[140*, 0*]
 20: 0x0446 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Hakkuru-Rinkuru (ID: 17760273/0x010F0011), tag_num=0x1A)
 21: 0x044D [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi1" with entities [EventEntity, EventEntity], work=[200*, 0*]
 ...
 32: 0x0493 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s095" with entities [LocalPlayer, LocalPlayer], work=[140*, 0*]
 ...
 49: 0x050B [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s085" with entities [EventEntity, EventEntity], work=[140*, 0*]
 ...
 61: 0x055D [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [EventEntity, EventEntity], work=[200*, 0*]
 ...
 74: 0x05A4 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi1" with entities [EventEntity, EventEntity], work=[200*, 0*]
