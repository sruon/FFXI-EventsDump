...
|       4 | 0xFFFFE849  |  4294961225 |
|       5 | 0x0D6F      |        3439 |
|       6 | 0xFFFFD06A  |  4294955114 |
|       7 | 0x1B3D      |        6973 |
...
```
  ...
  1: 0x0005 [0x1F] MOVE_ENTITY: EventEntity moves to X=-3.594*, Z=2.067*, Y=-1.624*
...
```
  ...
  1: 0x0013 [0x1F] MOVE_ENTITY: EventEntity moves to X=-6.071*, Z=3.439*, Y=-1.624*
...
```
  ...
  1: 0x0021 [0x1F] MOVE_ENTITY: EventEntity moves to X=-12.182*, Z=6.973*, Y=-1.624*
