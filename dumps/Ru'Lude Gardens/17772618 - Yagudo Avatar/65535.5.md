...
```
  0: 0x0061 [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "main" with entities [Ajido-Marujido (ID: 17772625/0x010F3051), Ajido-Marujido (ID: 17772625/0x010F3051)], work=[7*, 0*]
  ...
  4: 0x0091 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "damg" for entities [Yagudo High Priest (ID: 17772621/0x010F304D), Yagudo High Priest (ID: 17772621/0x010F304D)]
