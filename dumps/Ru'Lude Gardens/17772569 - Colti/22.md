...
```
  ...
  3: 0x0044 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=39*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  4: 0x0053 [0x1D] PRINT_EVENT_MESSAGE(message_id=11091*)
    → "Lady Esha'ntarl is supposedly leading the mission against Bahamut. With such a skilled commander at the armada's helm, there isn't anything in Vana'diel that can stop the Duchy!\u007F1\u0000\u0007"
  5: 0x0056 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0057 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=39*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
