...
```
  ...
  2: 0x0085 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=EventEntity, entity2=EventEntity, action="thk1")
  ...
  5: 0x009C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=39*, entity1=Adolie (ID: 17772561/0x010F3011), entity2=Adolie (ID: 17772561/0x010F3011), action="tlk0")
  ...
  8: 0x00B3 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=39*, entity1=Adolie (ID: 17772561/0x010F3011), entity2=Adolie (ID: 17772561/0x010F3011), action="tlk1")
  9: 0x00C2 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=EventEntity, entity2=EventEntity, action="thk2")
