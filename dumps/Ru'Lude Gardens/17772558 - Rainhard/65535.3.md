...
```
  0: 0x0079 [0x45] LOAD_SCHEDULED_TASK(work_offset1=173*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s044", work_offset2=0*)
  ...
  3: 0x009C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
  4: 0x00AD [0x45] LOAD_SCHEDULED_TASK(work_offset1=173*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s045", work_offset2=0*)
