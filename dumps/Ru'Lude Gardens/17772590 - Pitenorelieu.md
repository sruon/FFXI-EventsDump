...
- **10292**: I get the creeps looking down from the edge. It really hits you how high up we are.
- **10293**: I wonder how they managed to build this place? Jeuno's full of mysteries, like the airships! But the biggest one of all is the archduke. Nobody knows who he is or where he's from.
...
```
  ...
  3: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=10292*)
  ...
  6: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=10293*)
