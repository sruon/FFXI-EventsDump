...
SUBROUTINE_0035:
 ...
 18: 0x005B [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=0*, source=ExtData[1]->WorkLocal[1], result=Work_Zone[2])
 19: 0x0064 [0x41] GET_BIT_WORK_RANGE(start_bit=1*, end_bit=1*, source=ExtData[1]->WorkLocal[1], result=Work_Zone[3])
 20: 0x006D [0x41] GET_BIT_WORK_RANGE(start_bit=2*, end_bit=2*, source=ExtData[1]->WorkLocal[1], result=Work_Zone[4])
 21: 0x0076 [0x41] GET_BIT_WORK_RANGE(start_bit=3*, end_bit=3*, source=ExtData[1]->WorkLocal[1], result=Work_Zone[5])
 22: 0x007F [0x41] GET_BIT_WORK_RANGE(start_bit=4*, end_bit=4*, source=ExtData[1]->WorkLocal[1], result=Work_Zone[6])
 23: 0x0088 [0x41] GET_BIT_WORK_RANGE(start_bit=5*, end_bit=5*, source=ExtData[1]->WorkLocal[1], result=Work_Zone[7])
 24: 0x0091 [0x41] GET_BIT_WORK_RANGE(start_bit=6*, end_bit=6*, source=ExtData[1]->WorkLocal[1], result=Work_Zone[8])
 25: 0x009A [0x41] GET_BIT_WORK_RANGE(start_bit=7*, end_bit=7*, source=ExtData[1]->WorkLocal[1], result=Work_Zone[9])
 26: 0x00A3 [0x41] GET_BIT_WORK_RANGE(start_bit=8*, end_bit=8*, source=ExtData[1]->WorkLocal[1], result=Work_Zone_1700[0])
 27: 0x00AC [0x41] GET_BIT_WORK_RANGE(start_bit=9*, end_bit=9*, source=ExtData[1]->WorkLocal[1], result=Work_Zone_1700[1])
 28: 0x00B5 [0x41] GET_BIT_WORK_RANGE(start_bit=10*, end_bit=10*, source=ExtData[1]->WorkLocal[1], result=Work_Zone_1700[2])
 29: 0x00BE [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=0*, source=ExtData[1]->WorkLocal[0], result=Work_Zone_1700[3])
...
SUBROUTINE_0112:
 46: 0x0112 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x0120
 47: 0x011A [0x01] GOTO 0x0001

SUBROUTINE_0120:
 48: 0x0120 [0x01] GOTO 0x0123

SUBROUTINE_0123:
 49: 0x0123 [0x03] Work_Zone[1] = Work_Zone[0]
 50: 0x0128 [0x21] END_EVENT
 51: 0x0129 [0x00] END_REQSTACK()
```
