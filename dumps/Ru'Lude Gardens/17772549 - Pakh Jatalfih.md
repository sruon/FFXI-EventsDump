...
| [103](#event-103)        | 0x0004       |     11 |              5 |
| [52](#event-52)          | 0x000F       |     11 |              5 |
| [51](#event-51)          | 0x001A       |     11 |              5 |
| [43](#event-43)          | 0x0025       |      1 |              1 |
| [68](#event-68)          | 0x0026       |     41 |             11 |
| [141](#event-141)        | 0x004F       |     37 |              9 |
| [54](#event-54)          | 0x0074       |     37 |              9 |
| [53](#event-53)          | 0x0099       |     37 |              9 |
| [50](#event-50)          | 0x00BE       |     37 |              9 |
| [131](#event-131)        | 0x00E3       |      1 |              1 |
| [134](#event-134)        | 0x00E4       |     37 |              9 |
| [137](#event-137)        | 0x0109       |     41 |             11 |
| [37](#event-37)          | 0x0132       |    125 |             22 |
| [57](#event-57)          | 0x01AF       |     37 |              9 |
| [107](#event-107)        | 0x01D4       |     37 |              9 |
| [65535.1](#event-655351) | 0x01F9       |     34 |              9 |
| [65535.2](#event-655352) | 0x021B       |     19 |              3 |
| [65535.3](#event-655353) | 0x022E       |     29 |              3 |
| [65535.4](#event-655354) | 0x024B       |     19 |              3 |
| [65535.5](#event-655355) | 0x025E       |     29 |              3 |
| [65535.6](#event-655356) | 0x027B       |     29 |              3 |
| [65535.7](#event-655357) | 0x0298       |      9 |              3 |
| [65535.8](#event-655358) | 0x02A1       |      1 |              1 |
...
- **10002**: Welcome to the Embassy of Windurst. If you ever need help during your stay, be sure to stop by.
- **10007**: Welcome to the Embassy of Windurst. Oh, but you're San d'Orian, I see. The Embassy of San d'Oria is out on the other side.
- **10008**: Welcome to the Embassy of Windurst. But, ah, you're from Bastok... The Embassy of Bastok is outside to the left.
- **10057**: Delkfutt's Tower is on the island of Qufim. Don't forget to shop for upgrades. And get some help to tag along... You'll need it!
- **10058**: You'll surely run into some nasty company there, so be extra, extra careful.
- **10061**: Welcome back! The ambassador has returned, and wants to see you. He's in his office.
- **10082**: For now, we need your help in the conquest. We want to bring all of Jeuno's outlying regions under Windurst's umbrella.
- **10085**: Good day, <Player>. His Excellency needs your help. Do us a favor and come back once you've completed your current mission, okay?
- **10088**: His Excellency seeks your help in something important. Best head into the rear chamber.
- **10122**: Go, and the winds of fortune will follow you. You mustn't keep the archduke waiting!
- **10149**: So, you saw the archduke... Well, how did it go?
- **10150**: He wants you to gather magicite? I can't offer any advice on those. Maybe you can try learning about Davoi, Beadeaux, and Castle Oztroja...
- **10190**: There you are! Great work, <Player>!
- **10191**: I'm sorry, but you've got no time to rest! Our beloved Windurst is in grave danger!
- **10192**: With the ambassador away, I want you to take this back to the motherland. Take the airship; it's faster. I'll find out what I can here.
- **10193**: Hurry-scurry! Take the airship back to Windurst! I'll find out what I can here.
- **10194**: As long as the Star Sibyl is safe, then all is well. We don't have any tasks for you here, so continue your service to your country.
...
```
  ...
  1: 0x0009 [0x1D] PRINT_EVENT_MESSAGE(message_id=10002*)
...
```
  ...
  1: 0x0014 [0x1D] PRINT_EVENT_MESSAGE(message_id=10007*)
...
```
  ...
  1: 0x001F [0x1D] PRINT_EVENT_MESSAGE(message_id=10008*)
...
```
  ...
  5: 0x0045 [0x1D] PRINT_EVENT_MESSAGE(message_id=10057*)
  ...
  7: 0x0049 [0x1D] PRINT_EVENT_MESSAGE(message_id=10058*)
...
```
  ...
  5: 0x006E [0x1D] PRINT_EVENT_MESSAGE(message_id=10061*)
...
```
  ...
  5: 0x0093 [0x1D] PRINT_EVENT_MESSAGE(message_id=10082*)
...
```
  ...
  5: 0x00B8 [0x1D] PRINT_EVENT_MESSAGE(message_id=10085*)
...
```
  ...
  5: 0x00DD [0x1D] PRINT_EVENT_MESSAGE(message_id=10088*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
00E0:             4A F0 FF FF  7F F8 FF FF 7F 1E F0 FF      J...........
00F0: FF 7F 6F 70 66 04 80 F8  FF FF 7F F8 FF FF 7F 74  ..opf..........t
0100: 6C 6B 30 1D 0B 80 23 21  00                       lk0...#!.       
```

#### Opcodes

```
  0: 0x00E4 [0x4A] LocalPlayer looks at EventEntity
  1: 0x00ED [0x1E] EventEntity looks at LocalPlayer and starts talking
  ...
  5: 0x0103 [0x1D] PRINT_EVENT_MESSAGE(message_id=10122*)
...
```
  ...
  5: 0x0128 [0x1D] PRINT_EVENT_MESSAGE(message_id=10149*)
    → "So, you saw the archduke... Well, how did it go?"
  6: 0x012B [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x012C [0x1D] PRINT_EVENT_MESSAGE(message_id=10150*)
...
```
  ...
  5: 0x0140 [0x1D] PRINT_EVENT_MESSAGE(message_id=10190*)
 ...
 14: 0x0189 [0x1D] PRINT_EVENT_MESSAGE(message_id=10191*)
 ...
 18: 0x01A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10192*)
...
```
  ...
  5: 0x01CE [0x1D] PRINT_EVENT_MESSAGE(message_id=10193*)
...
```
  ...
  5: 0x01F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10194*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0210:                                   66 04 80 F8 FF             f....
0220: FF 7F F8 FF FF 7F 74 6C  6B 30 1C 20 80 00        ......tlk0. ..  
```

#### Opcodes

```
  0: 0x021B [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk0" with entities [EventEntity, EventEntity], work=50*
  1: 0x022A [0x1C] WAIT(60* ticks)
...
```
  0: 0x024B [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "thk1" with entities [EventEntity, EventEntity], work=50*
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0250:                                            66 04                f.
0260: 80 F8 FF FF 7F F8 FF FF  7F 74 68 6B 32 53 F8 FF  .........thk2S..
0270: FF 7F F8 FF FF 7F 74 68  6B 32 00                 ......thk2.     
```

#### Opcodes

```
  0: 0x025E [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "thk2" with entities [EventEntity, EventEntity], work=50*
  1: 0x026D [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "thk2" with entities [EventEntity, EventEntity]
...
```
  0: 0x027B [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "pas0" with entities [EventEntity, EventEntity], work=50*
  1: 0x028A [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "pas0" with entities [EventEntity, EventEntity]
