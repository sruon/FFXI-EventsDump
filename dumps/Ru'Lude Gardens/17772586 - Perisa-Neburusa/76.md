...
```
  ...
  5: 0x0015 [0x1D] PRINT_EVENT_MESSAGE(message_id=9988*)
    → "This is the entrance to Jeuno's Rent-a-Rooms. Press the button near the central pillar to go inside.\u007F1\u0000\u0007"
  6: 0x0018 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0019 [0x01] GOTO 0x0051
  8: 0x001C [0x1D] PRINT_EVENT_MESSAGE(message_id=9989*)
    → "This is the entrance to Jeuno's residential area. Do you want to move your belongings to a Rent-a-Room here?\u007F1\u0000\u0007"
  9: 0x001F [0x23] WAIT_FOR_DIALOG_INTERACTION
 10: 0x0020 [0x24] CREATE_DIALOG(message_id=9990*, default_option=0*, option_flags=0*)
    → "Do you want to move to Jeuno?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
 ...
 14: 0x0031 [0x1D] PRINT_EVENT_MESSAGE(message_id=9991*)
    → "Very well. I've completed the necessary procedures. You'll find a button near the central pillar. Press it to enter.\u007F1\u0000\u0007"
 ...
 19: 0x0045 [0x1D] PRINT_EVENT_MESSAGE(message_id=9992*)
    → "If you ever feel like moving, just ask me.\u007F1\u0000\u0007"
