...
- **10216**: These grounds are the domain of Lords Kam'lanaut and Eald'narche. Please conduct yourself properly.
- **11074**: I've heard rumors that a bright light shot out of the sea somewhere to the north of Delkfutt's Tower.
- **11075**: An investigatory party is scheduled to search the area for clues, but they'll have their work cut out for them. The currents in the Sea of Shu'Meyo are unpredictable and violent. Many a captain has lost his ship in those waters.
...
```
  ...
  4: 0x0057 [0x1D] PRINT_EVENT_MESSAGE(message_id=10216*)
