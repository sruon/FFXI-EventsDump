...
```
  0: 0x004B [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1021, bit_index_work_offset=0x8006, condition_work_offset=0x8007)
...
SUBROUTINE_00D8:
 25: 0x00D8 [0x3D] CLEAR_BIT_FLAG_CONDITIONAL(target_work_offset=0x1021, bit_index_work_offset=0x8006, condition_work_offset=0x8007)
