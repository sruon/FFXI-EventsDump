...
```
  0: 0x00E0 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1021, bit_index_work_offset=0x8006, condition_work_offset=0x8007)
...
SUBROUTINE_0156:
 21: 0x0156 [0x3D] CLEAR_BIT_FLAG_CONDITIONAL(target_work_offset=0x1021, bit_index_work_offset=0x8006, condition_work_offset=0x8007)
