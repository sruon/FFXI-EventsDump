...
```
  ...
  3: 0x01F4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  4: 0x0205 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 18: 0x0255 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 19: 0x0266 [0x45] LOAD_SCHEDULED_TASK(work_offset1=143*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cm30", work_offset2=0*)
 20: 0x0277 [0x27] REQ_SET(priority=0x03, entity_id=LocalPlayer, tag_num=0x12)
 21: 0x027E [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 ...
 25: 0x02AA [0x45] LOAD_SCHEDULED_TASK(work_offset1=143*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cm31", work_offset2=0*)
 26: 0x02BB [0x55] WAIT_LOAD_SCHEDULER(work_offset=143*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cm31")
 ...
 40: 0x030B [0x45] LOAD_SCHEDULED_TASK(work_offset1=143*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cm32", work_offset2=0*)
 41: 0x031C [0x55] WAIT_LOAD_SCHEDULER(work_offset=143*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cm32")
...
SUBROUTINE_03BE:
 ...
 79: 0x03F3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=143*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cm31", work_offset2=0*)
 80: 0x0404 [0x55] WAIT_LOAD_SCHEDULER(work_offset=143*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cm31")
 81: 0x0413 [0x4C] EventEntity->StatusEvent = 8 // Open door
 82: 0x0414 [0x1C] WAIT(60* ticks)
 83: 0x0417 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2", work_offset2=0*)
 84: 0x0428 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2")
 ...
 96: 0x046D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
