...
```
  ...
  3: 0x0082 [0x1F] MOVE_ENTITY: EventEntity moves to X=0.001, Z=0.002, Y=0.003
...
```
# Data Section: 0x00B8 (25 bytes)
     0x00B8: 17 05 00 04 00 00 00 16 06 00 04 00 00 00 07 01
     0x00C8: 00 05 00 07 02 00 06 00 1B
```