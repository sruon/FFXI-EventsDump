...
SUBROUTINE_00FC:
 35: 0x00FC [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[2], result=ExtData[1]->WorkLocal[4])
 36: 0x0105 [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[2], result=ExtData[1]->WorkLocal[14])
 37: 0x010E [0x3E] IF !(ExtData[1]->WorkLocal[24] bit 1*) GOTO 0x0118
 38: 0x0115 [0x01] GOTO 0x012A

SUBROUTINE_0118:
 39: 0x0118 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[3], result=ExtData[1]->WorkLocal[5])
 40: 0x0121 [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[3], result=ExtData[1]->WorkLocal[15])
 41: 0x012A [0x3E] IF !(ExtData[1]->WorkLocal[24] bit 2*) GOTO 0x0134
 42: 0x0131 [0x01] GOTO 0x0146

SUBROUTINE_0134:
 43: 0x0134 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[4], result=ExtData[1]->WorkLocal[6])
 44: 0x013D [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[4], result=ExtData[1]->WorkLocal[16])
 45: 0x0146 [0x3E] IF !(ExtData[1]->WorkLocal[24] bit 3*) GOTO 0x0150
 46: 0x014D [0x01] GOTO 0x0162

SUBROUTINE_0150:
 47: 0x0150 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[5], result=ExtData[1]->WorkLocal[7])
 48: 0x0159 [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[5], result=ExtData[1]->WorkLocal[17])
 49: 0x0162 [0x3E] IF !(ExtData[1]->WorkLocal[24] bit 4*) GOTO 0x016C
 50: 0x0169 [0x01] GOTO 0x017E

SUBROUTINE_016C:
 51: 0x016C [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[6], result=ExtData[1]->WorkLocal[8])
 52: 0x0175 [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[6], result=ExtData[1]->WorkLocal[18])
...
SUBROUTINE_01A9:
 63: 0x01A9 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[2], result=ExtData[1]->WorkLocal[9])
 64: 0x01B2 [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[2], result=ExtData[1]->WorkLocal[19])
 65: 0x01BB [0x3E] IF !(ExtData[1]->WorkLocal[24] bit 6*) GOTO 0x01C5
 66: 0x01C2 [0x01] GOTO 0x01D7

SUBROUTINE_01C5:
 67: 0x01C5 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[3], result=ExtData[1]->WorkLocal[10])
 68: 0x01CE [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[3], result=ExtData[1]->WorkLocal[20])
 69: 0x01D7 [0x3E] IF !(ExtData[1]->WorkLocal[24] bit 7*) GOTO 0x01E1
 70: 0x01DE [0x01] GOTO 0x01F3

SUBROUTINE_01E1:
 71: 0x01E1 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[4], result=ExtData[1]->WorkLocal[11])
 72: 0x01EA [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[4], result=ExtData[1]->WorkLocal[21])
 73: 0x01F3 [0x3E] IF !(ExtData[1]->WorkLocal[24] bit 8*) GOTO 0x01FD
 74: 0x01FA [0x01] GOTO 0x020F

SUBROUTINE_01FD:
 75: 0x01FD [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[5], result=ExtData[1]->WorkLocal[12])
 76: 0x0206 [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[5], result=ExtData[1]->WorkLocal[22])
 77: 0x020F [0x3E] IF !(ExtData[1]->WorkLocal[24] bit 9*) GOTO 0x0219
 78: 0x0216 [0x01] GOTO 0x022B

SUBROUTINE_0219:
 79: 0x0219 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[6], result=ExtData[1]->WorkLocal[13])
 80: 0x0222 [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[6], result=ExtData[1]->WorkLocal[23])
