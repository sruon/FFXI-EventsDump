...
- **12780**: ...Emptiness...... ......Possible weaknesses... Hmmm......
- **12781**: Greetings, adventurer. I am Harith, alchemist and member of a certain prestigious society here in Jeuno.
- **12782**: Perchance you have heard of creatures known as the Empty? Currently, other alchemists in the society are working feverishly on methods to manipulate these mysterious beasts.
- **12783**: Would you like me to continue?
- **12784**: Well...? [Please, go on./I'm busy at the moment.]
- **12785**: I apologize for taking up your valuable time. May fortune smile upon you in your journey.
- **12786**: The Empty are a cold and hollow species--their very existence a void of nothingness. They possess no feeling, no will, no purpose... It is this lack of characteristics that makes them powerful, as they have no known weaknesses.
- **12787**: However, deep within their dark shells we have discovered that something does exist--that "something" being a fragment of a memory lost in the pages of time.
- **12788**: If you happen to have the fortune of coming across one of these incomplete memories on your journeys, bring it to me and I shall purify it into a form known as "anima" using the methods discovered by the society.
- **12789**: By studying the various types of memories left by the Empty, we may be able to discover their strengths and weaknesses.
- **12790**: If you happen to have the fortune of coming across one of these incomplete memories on your journeys, bring it to me and I shall purify it into a form known as "anima" using the methods discovered by the society.
- **12791**: In addition to these memory fragments, we are also collecting $0, $1, and $2 to help us better understand how these creatures evolved. Worry not, as you will be duly rewarded for any and all contributions.
- **12792**: Yes... This is definitely the memory of one of the Empty--and in quite excellent condition, I must say.
- **12793**: I can synthesize it into a concentrated form of anima; however, I will require a small fee of $0 gil.
- **12795**: What a remarkable specimen! This $0 may be the key to unlocking the secrets of the Empty!
- **12796**: Here, please accept this as a token of my gratitude.
- **12797**: I will begin the synthesis right away. Please wait a few moments.
- **12798**: Ah, what a heavenly glow!
- **12799**: By throwing this anima back at the Empty, they will temporarily regain a splinter of consciousness. It is during this time that you may be able to find their weaknesses.
...
```
  ...
  1: 0x0010 [0x1D] PRINT_EVENT_MESSAGE(message_id=12780*)
...
```
  ...
  5: 0x0041 [0x1D] PRINT_EVENT_MESSAGE(message_id=12781*)
  ...
  7: 0x0045 [0x1D] PRINT_EVENT_MESSAGE(message_id=12782*)
 ...
 10: 0x0058 [0x1D] PRINT_EVENT_MESSAGE(message_id=12783*)
    → "Would you like me to continue?"
 11: 0x005B [0x23] WAIT_FOR_DIALOG_INTERACTION
 12: 0x005C [0x24] CREATE_DIALOG(message_id=12784*, default_option=1*, option_flags=0*)
 ...
 17: 0x007C [0x1D] PRINT_EVENT_MESSAGE(message_id=12786*)
 ...
 20: 0x008F [0x1D] PRINT_EVENT_MESSAGE(message_id=12787*)
 ...
 23: 0x00A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=12788*)
 ...
 29: 0x00C5 [0x1D] PRINT_EVENT_MESSAGE(message_id=12785*)
...
```
  ...
  4: 0x00E4 [0x1D] PRINT_EVENT_MESSAGE(message_id=12789*)
  ...
  6: 0x00E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=12790*)
    → "If you happen to have the fortune of coming across one of these incomplete memories on your journeys, bring it to me and I shall purify it into a form known as "anima" using the methods discovered by the society."
 ...
 11: 0x00FB [0x1D] PRINT_EVENT_MESSAGE(message_id=12791*)
...
```
  ...
  5: 0x011C [0x1D] PRINT_EVENT_MESSAGE(message_id=12792*)
  ...
  8: 0x0125 [0x1D] PRINT_EVENT_MESSAGE(message_id=12793*)
...
```
  ...
  6: 0x0144 [0x1D] PRINT_EVENT_MESSAGE(message_id=12797*)
 ...
 20: 0x01B6 [0x1D] PRINT_EVENT_MESSAGE(message_id=12798*)
    → "Ah, what a heavenly glow!"
 21: 0x01B9 [0x23] WAIT_FOR_DIALOG_INTERACTION
 22: 0x01BA [0x1D] PRINT_EVENT_MESSAGE(message_id=12799*)
...
```
  ...
  4: 0x01E7 [0x1D] PRINT_EVENT_MESSAGE(message_id=12799*)
    → "By throwing this anima back at the Empty, they will temporarily regain a splinter of consciousness. It is during this time that you may be able to find their weaknesses."
...
```
  ...
  6: 0x0206 [0x1D] PRINT_EVENT_MESSAGE(message_id=12795*)
  ...
  8: 0x020A [0x1D] PRINT_EVENT_MESSAGE(message_id=12796*)
