...
- **14017**: Well met! I'm a Merry Map Marker, and I'd love to make marks all over your merry $3, but it appears you are missing the markable map I mention.
- **14018**: Good day! I'm a Merry Map Marker, and I'd be emphatically ecstatic if you'd allow me to mark your magical map!
- **14019**: A markless $3 is like a motherless maiden, meandering through a miasmatic mire of misery.
- **14020**: Embark on a map-marking mission? [Mark me up!/Keep your mitts off my map!]
- **14021**: Marvelous! Now allow me a minute to make all my marks.
- **14022**: Methinks I have marked your map with as many marks as I might manage.
- **14023**: Monitoring and managing your marks is as simple as merely opening your map and selecting Markers from the main menu.
- **14024**: If the marks on your map might vanish, mope not like a melancholy milksop. Make another meeting with me and I shall make it my mission to mark the map once more.
- **14025**: Good day, [milord/milady]. May your marches across meadow and mountain be markedly memorable!
- **14028**: And mayhap you are immeasurably motivated to compete in the medieval mayhem of Conflict? Might I suggest you mingle with the modest Pursuivant located here?
- **14029**: Our local minstrel of melodies can be found here. His mirthful musicalities may help you recall misplaced memories.
- **14032**: Need to know the local weather? Our local meteorologist will be making his paramount presumptions here.
- **14034**: Those men and women wondering how their deeds are mirrored in the minds of the locals should meander over to this gossip-meister to muster up important material on their respective reputations.
- **14049**: I shall begin by marking the important locations on your map of the Ru'Lude Gardens.
- **14050**: Next, let me mark your map of Upper Jeuno. Did you know that I often frequent the Marble Bridge whenever I have a free moment? There's just something about the name of that model establishment...
- **14051**: Now let me mark your map of Lower Jeuno.
- **14052**: And finally, I shall mark your map of Port Jeuno.
...
```
  ...
  2: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=14018*)
  ...
  5: 0x0011 [0x1D] PRINT_EVENT_MESSAGE(message_id=14019*)
  ...
  7: 0x0015 [0x24] CREATE_DIALOG(message_id=14020*, default_option=1*, option_flags=0*)
 ...
 11: 0x002A [0x1D] PRINT_EVENT_MESSAGE(message_id=14021*)
 ...
 37: 0x00B8 [0x1D] PRINT_EVENT_MESSAGE(message_id=14049*)
 ...
 46: 0x00DE [0x1D] PRINT_EVENT_MESSAGE(message_id=14029*)
...
# Dead code (unreachable instructions):
     ...
     0x00FE [0x1D] PRINT_EVENT_MESSAGE(message_id=14028*)
    → "And mayhap you are immeasurably motivated to compete in the medieval mayhem of Conflict? Might I suggest you mingle with the modest Pursuivant located here?"
     ...
     0x0105 [0x1D] PRINT_EVENT_MESSAGE(message_id=14050*)
    → "Next, let me mark your map of Upper Jeuno. Did you know that I often frequent the Marble Bridge whenever I have a free moment? There's just something about the name of that model establishment..."
     ...
     0x012B [0x1D] PRINT_EVENT_MESSAGE(message_id=14029*)
    → "Our local minstrel of melodies can be found here. His mirthful musicalities may help you recall misplaced memories."
     ...
     0x014B [0x1D] PRINT_EVENT_MESSAGE(message_id=14032*)
    → "Need to know the local weather? Our local meteorologist will be making his paramount presumptions here."
     ...
     0x0156 [0x1D] PRINT_EVENT_MESSAGE(message_id=14051*)
    → "Now let me mark your map of Lower Jeuno."
     ...
     0x01BC [0x1D] PRINT_EVENT_MESSAGE(message_id=14034*)
    → "Those men and women wondering how their deeds are mirrored in the minds of the locals should meander over to this gossip-meister to muster up important material on their respective reputations."
     ...
     0x01DC [0x1D] PRINT_EVENT_MESSAGE(message_id=14029*)
    → "Our local minstrel of melodies can be found here. His mirthful musicalities may help you recall misplaced memories."
    ...
    → "And finally, I shall mark your map of Port Jeuno."
     ...
     0x022D [0x1D] PRINT_EVENT_MESSAGE(message_id=14029*)
    → "Our local minstrel of melodies can be found here. His mirthful musicalities may help you recall misplaced memories."
     ...
     0x026D [0x1D] PRINT_EVENT_MESSAGE(message_id=14032*)
    → "Need to know the local weather? Our local meteorologist will be making his paramount presumptions here."
    ...
    → "Monitoring and managing your marks is as simple as merely opening your map and selecting Markers from the main menu."
     ...
     0x0285 [0x1D] PRINT_EVENT_MESSAGE(message_id=14024*)
    → "If the marks on your map might vanish, mope not like a melancholy milksop. Make another meeting with me and I shall make it my mission to mark the map once more."
     ...
     0x0289 [0x1D] PRINT_EVENT_MESSAGE(message_id=14025*)
...
```
  ...
  2: 0x0299 [0x1D] PRINT_EVENT_MESSAGE(message_id=14018*)
    → "Good day! I'm a Merry Map Marker, and I'd be emphatically ecstatic if you'd allow me to mark your magical map!"
  3: 0x029C [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x029D [0x03] Work_Zone[2] = 388*
  5: 0x02A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=14017*)
