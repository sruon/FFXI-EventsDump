...
```
  ...
  3: 0x01F6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  4: 0x0207 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 17: 0x0252 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 18: 0x0263 [0x45] LOAD_SCHEDULED_TASK(work_offset1=143*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cmb0", work_offset2=0*)
 19: 0x0274 [0x27] REQ_SET(priority=0x03, entity_id=LocalPlayer, tag_num=0x04)
 20: 0x027B [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 ...
 24: 0x02A7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=143*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cmb1", work_offset2=0*)
 25: 0x02B8 [0x55] WAIT_LOAD_SCHEDULER(work_offset=143*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cmb1")
 ...
 40: 0x030B [0x45] LOAD_SCHEDULED_TASK(work_offset1=143*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cmb2", work_offset2=0*)
 41: 0x031C [0x55] WAIT_LOAD_SCHEDULER(work_offset=143*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cmb2")
...
SUBROUTINE_03BE:
 ...
 79: 0x03F3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=143*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cmb1", work_offset2=0*)
 80: 0x0404 [0x55] WAIT_LOAD_SCHEDULER(work_offset=143*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cmb1")
 ...
 95: 0x045E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
