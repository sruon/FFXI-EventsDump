...
```
  ...
  4: 0x004F [0x5B] LOAD_EXT_SCHEDULER(work_offset=10*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  ...
  9: 0x0066 [0x5B] LOAD_EXT_SCHEDULER(work_offset=10*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
