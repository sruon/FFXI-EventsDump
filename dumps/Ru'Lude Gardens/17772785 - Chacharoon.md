...
- **16014**: Happy Happy New Year!
- **16015**: Chacharoon wishing you very best in New Year the Qiqirn way--by giving you things for $5 jingly!
- **16017**: @Buy $6 for $5 gil? [Yes./No.]
- **16018**: Ooooh, $6! What is inside? Maybe you get something special!
- **16019**: Not enough jingly? Then you go out, get more jingly, and bring back. Deal?
- **16020**: In homeland, people put jingly in pouches and give to other people they like!
- **16021**: You give me jingly, I put in pouch. Then I give you pouch for you to give to friends. Okay?
- **16022**: But you cannot open pouch yourself. Only friend can. Must be Mysterious Moogle Magic.
- **16023**: Pouch with jingly! Can use to see how much is inside!
- **16025**: Oooh, listen to the happy sound of jingly! But is too much jingly for one pouch. Only up to $0 jingly.
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=16014*)
    → "Happy Happy New Year!"
  5: 0x001A [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=16020*)
    → "In homeland, people put jingly in pouches and give to other people they like!"
  7: 0x001E [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x001F [0x1D] PRINT_EVENT_MESSAGE(message_id=16021*)
 ...
 10: 0x0023 [0x1D] PRINT_EVENT_MESSAGE(message_id=16022*)
...
```
  ...
  5: 0x004F [0x1D] PRINT_EVENT_MESSAGE(message_id=16023*)
...
```
  ...
  5: 0x0080 [0x1D] PRINT_EVENT_MESSAGE(message_id=16025*)
...
```
  ...
  5: 0x009F [0x1D] PRINT_EVENT_MESSAGE(message_id=16014*)
    → "Happy Happy New Year!"
  6: 0x00A2 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x00A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=16015*)
...
SUBROUTINE_00FF:
 ...
 28: 0x012A [0x24] CREATE_DIALOG(message_id=16017*, default_option=0*, option_flags=0*)
 ...
 33: 0x0151 [0x1D] PRINT_EVENT_MESSAGE(message_id=16018*)
 ...
 41: 0x017A [0x1D] PRINT_EVENT_MESSAGE(message_id=16019*)
...
# Dead code (unreachable instructions):
     ...
     0x01A0 [0x24] CREATE_DIALOG(message_id=16017*, default_option=0*, option_flags=0*)
    → "@Buy $6 for $5 gil? [Yes./No.]"
     ...
     0x01C7 [0x1D] PRINT_EVENT_MESSAGE(message_id=16018*)
    → "Ooooh, $6! What is inside? Maybe you get something special!"
     ...
     0x01F0 [0x1D] PRINT_EVENT_MESSAGE(message_id=16019*)
    → "Not enough jingly? Then you go out, get more jingly, and bring back. Deal?"
     ...
     0x0217 [0x1D] PRINT_EVENT_MESSAGE(message_id=16020*)
    → "In homeland, people put jingly in pouches and give to other people they like!"
     0x021A [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x021B [0x1D] PRINT_EVENT_MESSAGE(message_id=16021*)
    → "You give me jingly, I put in pouch. Then I give you pouch for you to give to friends. Okay?"
     0x021E [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x021F [0x1D] PRINT_EVENT_MESSAGE(message_id=16022*)
    → "But you cannot open pouch yourself. Only friend can. Must be Mysterious Moogle Magic."
