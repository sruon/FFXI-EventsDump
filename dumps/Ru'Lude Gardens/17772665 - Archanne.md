...
- **10916**: The minstrel of melodies is my name, For a mere $6 gil I'll recall your past. Your stories of love, anger, triumph, and shame, The river of memories runs deep and vast.
- **10917**: The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last.
- **12934**: Which memory will you have recalled? [Nothing./Missions./Jeuno Quests./Other Quests./Promathia Missions./Aht Urhgan Missions./Rhapsodies of Vana'diel.]
- **12935**: Which memory will you have recalled? [Nothing./Appointment to Jeuno(pt.1)./Appointment to Jeuno(pt.2)./Jeuno(pt.1)./Jeuno(pt.2)./A New Journey(pt.1)./A New Journey(pt.2)./Magicite/San d'Orian Embassy./Magicite/Bastokan Embassy./Magicite/Windurstian Embassy./Magicite/Grand Duke Palace(pt.1)./Magicite/Davoi./Magicite/Beadeaux./Magicite/Castle Oztroja./Magicite/Grand Duke Palace(pt.2).]
- **12936**: Which memory will you have recalled? [Nothing./Shattering Stars(pt.1)./Shattering Stars(pt.2)./Shattering Stars(pt.3)./Beat Around the Bushin./Ducal Dupe(pt.1)./Ducal Dupe(pt.2)./Beyond the Sun./Chameleon Capers./Storms of Fate(pt.1)./Storms of Fate(pt.2)./Shadows of the Departed(pt.1)./Shadows of the Departed(pt.2)./Apocalypse Nigh./Expanding Horizons./Beyond the Stars(pt.1)./Beyond the Stars(pt.2)./A Trial in Tandem(pt.1)./A Trial in Tandem(pt.2)./A Trial in Tandem, Redux./Dormant Powers Dislodged(pt.1)./Dormant Powers Dislodged(pt.2)./Dormant Powers Dislodged(pt.3)./Prelude to Puissance./Beyond Infinity(pt.1)./Beyond Infinity(pt.2)./Martial Mastery(pt.1)./Martial Mastery(pt.2).]
...
- **12938**: Which memory will you have recalled? [Nothing./Below the Arks./A Vessel Without a Captain./Branded./For Whom the Verse Is Sung(pt.1)./For Whom the Verse Is Sung(pt.2)./A Place to Return./More Questions Than Answers(pt.1)./More Questions Than Answers(pt.2)./Flames in the Darkness./The Chains Fall Free.]
- **12939**: Which memory will you have recalled? [Nothing./Easterly Winds./Unraveling Reason./Light of Judgment(pt.1)./Light of Judgment(pt.2).]
- **12940**: Which memory will you have recalled? [Nothing./Call to Serve(pt.1)./Call to Serve(pt.2)./Call to Serve(pt.3)./Call to Serve(pt.4)./Call to Serve(pt.5)./Call to Serve(pt.6)./Call to Serve(pt.7)./Call to Serve(pt.8)./Call to Serve(pt.9)./Maat on the Rampage(pt.1)./Maat on the Rampage(pt.2).]
...
```
  ...
  3: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=10917*)
 ...
 21: 0x0088 [0x1D] PRINT_EVENT_MESSAGE(message_id=10917*)
    → "The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last."
 22: 0x008B [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x008C [0x21] END_EVENT
 24: 0x008D [0x00] END_REQSTACK()
 25: 0x008E [0x1D] PRINT_EVENT_MESSAGE(message_id=10916*)
 ...
 39: 0x00D4 [0x24] CREATE_DIALOG(message_id=12934*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00E4:
 42: 0x00E4 [0x24] CREATE_DIALOG(message_id=12935*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_0113:
 50: 0x0113 [0x24] CREATE_DIALOG(message_id=12936*, default_option=0*, option_flags=Work_Zone[3])
...
SUBROUTINE_0142:
 58: 0x0142 [0x24] CREATE_DIALOG(message_id=12937*, default_option=0*, option_flags=Work_Zone[4])
    → "Which memory will you have recalled? [Nothing./Dynamis - The Shrouded Land(pt.1)./Dynamis - The Shrouded Land(pt.2)./Dynamis Interloper./Bravura./Fellow Points./Waking the Colossus(pt.1)./Waking the Colossus(pt.2)./Battle on a New Front(pt.1)./Battle on a New Front(pt.2)./VW Op. #126: Qufim Incursion(pt.1)./VW Op. #126: Qufim Incursion(pt.2)./A Cait Calls(pt.1)./A Cait Calls(pt.2)./A New Menace(pt.1)./A New Menace(pt.2)./No Rest for the Weary(pt.1)./No Rest for the Weary(pt.2)./Glimmer of Hope./Trust (Cherukiki)./Trust (Maat).]"
...
SUBROUTINE_0171:
 66: 0x0171 [0x24] CREATE_DIALOG(message_id=12938*, default_option=0*, option_flags=Work_Zone[5])
...
SUBROUTINE_01A0:
 74: 0x01A0 [0x24] CREATE_DIALOG(message_id=12939*, default_option=0*, option_flags=Work_Zone[6])
...
SUBROUTINE_01CF:
 82: 0x01CF [0x24] CREATE_DIALOG(message_id=12940*, default_option=0*, option_flags=Work_Zone[7])
