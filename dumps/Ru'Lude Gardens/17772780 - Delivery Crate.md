...
- **14566**: Deposit $2 $0$0 for Trial $0?
- **14567**: Deposit $2 $0 for which of the following trials?
- **14568**: Which trial? [Trial $0 ($10 remaining)./Trial $1 ($11 remaining)./Trial $2 ($12 remaining)./Trial $3 ($13 remaining)./Trial $4 ($14 remaining)./Trial $5 ($15 remaining)./Trial $6 ($16 remaining)./Trial $7 ($17 remaining)./Trial $8 ($18 remaining)./Trial $9 ($19 remaining)./Cancel.]
- **14569**: Deposit $2 $0$0 ? [Yes./No.]
...
SUBROUTINE_008D:
 ...
 14: 0x009C [0x48] [System] [14566*]:
    → "Deposit $2 $0$0 for Trial $0?"
 15: 0x009F [0x23] WAIT_FOR_DIALOG_INTERACTION
 16: 0x00A0 [0x24] CREATE_DIALOG(message_id=14569*, default_option=1*, option_flags=0*)
...
107: 0x02A8 [0x24] CREATE_DIALOG(message_id=14568*, default_option=0*, option_flags=ExtData[1]->WorkLocal[24])
...
144: 0x0365 [0x24] CREATE_DIALOG(message_id=14569*, default_option=1*, option_flags=0*)
    → "Deposit $2 $0$0 ? [Yes./No.]"
