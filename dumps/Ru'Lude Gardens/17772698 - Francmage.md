...
- **6821**: You called for me, Your Majesty?
- **6825**: Oh, yes, that. Those Bastoker Humes are causing no end of trouble--saying they want to investigate here, there, and the other place...
- **6831**: As you command, my lord. I would give the very blood that runs in my veins if it were to further the cause of our kingdom. You can rely on me.
- **6835**: I understand, Your Grace.
- **6837**: Yes, sire! My life for the Kingdom!
...
```
  ...
  1: 0x012C [0x1D] PRINT_EVENT_MESSAGE(message_id=6821*)
...
```
  0: 0x0138 [0x1D] PRINT_EVENT_MESSAGE(message_id=6825*)
...
```
  0: 0x013D [0x1D] PRINT_EVENT_MESSAGE(message_id=6831*)
...
```
  0: 0x0142 [0x1D] PRINT_EVENT_MESSAGE(message_id=6835*)
...
```
  ...
  1: 0x014E [0x1D] PRINT_EVENT_MESSAGE(message_id=6837*)
