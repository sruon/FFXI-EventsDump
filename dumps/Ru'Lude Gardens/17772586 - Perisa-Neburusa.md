...
- **9993**: This is the entrance to Jeuno's Rent-a-Rooms. Press the button near the central pillar to go inside.
- **9994**: This is the entrance to Jeuno's residential area. Do you want to move your belongings to a Rent-a-Room here?
- **9995**: Do you want to move to Jeuno? [Yes./No.]
- **9996**: Very well. I've completed the necessary procedures. You'll find a button near the central pillar. Press it to enter.
- **9997**: If you ever feel like moving, just ask me.
...
```
  ...
  5: 0x0015 [0x1D] PRINT_EVENT_MESSAGE(message_id=9993*)
  ...
  8: 0x001C [0x1D] PRINT_EVENT_MESSAGE(message_id=9994*)
 ...
 10: 0x0020 [0x24] CREATE_DIALOG(message_id=9995*, default_option=0*, option_flags=0*)
 ...
 14: 0x0031 [0x1D] PRINT_EVENT_MESSAGE(message_id=9996*)
 ...
 19: 0x0045 [0x1D] PRINT_EVENT_MESSAGE(message_id=9997*)
