...
| [8](#event-8)            | 0x0001       |     60 |             12 |
| [6](#event-6)            | 0x003D       |     60 |             12 |
| [9](#event-9)            | 0x0079       |     56 |             10 |
| [7](#event-7)            | 0x00B1       |     60 |             12 |
| [10](#event-10)          | 0x00ED       |     56 |             10 |
| [145](#event-145)        | 0x0125       |     60 |             10 |
| [10048](#event-10048)    | 0x0161       |      7 |              2 |
| [65535.1](#event-655351) | 0x0168       |     10 |              2 |
| [65535.2](#event-655352) | 0x0172       |     32 |              9 |
| [10055](#event-10055)    | 0x0192       |     62 |             13 |
| [10054](#event-10054)    | 0x01D0       |     62 |             13 |
| [10051](#event-10051)    | 0x020E       |     13 |              3 |
| [10056](#event-10056)    | 0x021B       |     62 |             13 |
| [122](#event-122)        | 0x0259       |      1 |              1 |
| [65535.3](#event-655353) | 0x025A       |     10 |              2 |
| [65535.4](#event-655354) | 0x0264       |     43 |              9 |
...
- **10203**: Welcome. This is the home of the archduke, so please conduct yourself accordingly.
- **11081**: You're an adventurer, right? So you've probably already heard about the humongous dragon that flew over the western skies.
- **11082**: At first everybody thought it might be a stray wyvern, but there are rumors that it was actually one of those ancient "wyrms"!
- **11089**: The Jeuno Armada is readying for an attack on the Wyrmking, Bahamut. However, there is nothing to worry about. Our forces are the strongest, most advanced in all Vana'diel.
- **11101**: The latest reports state the recent armada mission was a success. However, it did not completely stop the Wyrmking and his minions. It is rumored that the fleet will launch its second attack once the current repairs on the warships are completed.
- **11161**: I have heard news that the criminal accused of destroying the Telepoints was captured and taken into custody.
- **11162**: However, when questioned, [he/she] said she had nothing to do with the incidents. To prove [his/her] innocence, the Duchy has ordered the scoundrel to travel to the nations of Bastok, Windurst, and San d'Oria and gather information that will clear [his/her] name.
- **11232**: Not but a few moments ago, Sir Nag'molada passed by this station. However, he did not seem himself. I wonder if something is wrong...
- **11233**: Even Captain Wolfgang has been looking disturbed since he received that envelope. What ever could be going on?
- **12639**: Where could this "fated land" be? I wouldn't even know where to start looking.
- **12640**: But now that I think of it, I could have sworn I heard that name somewhere before... Where was it...?
- **12740**: What? Is there a girl in Selbina with a serious case of amnesia?
- **12741**: How would I know? I'm always confined to my post here in Jeuno. You're the adventurer. Why don't you know these things?
- **12750**: Captain Wolfgang has asked me to remind you that you are to hurry to the Marble Bridge in Upper Jeuno.
- **12751**: It sounded as if it was urgent. You had best be on your way!
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=11081*)
  ...
  6: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=11082*)
...
```
  ...
  4: 0x0053 [0x1D] PRINT_EVENT_MESSAGE(message_id=11161*)
  ...
  6: 0x0057 [0x1D] PRINT_EVENT_MESSAGE(message_id=11162*)
  ...
  9: 0x006A [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "tlk1" with entities [EventEntity, EventEntity]
...
```
  ...
  4: 0x008F [0x1D] PRINT_EVENT_MESSAGE(message_id=11089*)
  ...
  7: 0x00A2 [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "tlk1" with entities [EventEntity, EventEntity]
...
```
  ...
  4: 0x00C7 [0x1D] PRINT_EVENT_MESSAGE(message_id=11232*)
  ...
  6: 0x00CB [0x1D] PRINT_EVENT_MESSAGE(message_id=11233*)
  ...
  9: 0x00DE [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "tlk1" with entities [EventEntity, EventEntity]
...
```
  ...
  4: 0x0103 [0x1D] PRINT_EVENT_MESSAGE(message_id=11101*)
...
```
  ...
  4: 0x013F [0x1D] PRINT_EVENT_MESSAGE(message_id=10203*)
...
```
  0: 0x0161 [0x92] EventEntity->Render.Flags3 ^= 0x01
...
```
  ...
  9: 0x01BF [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "tlk1" with entities [EventEntity, EventEntity]
...
```
  ...
  4: 0x0231 [0x1D] PRINT_EVENT_MESSAGE(message_id=12750*)
  ...
  6: 0x0235 [0x1D] PRINT_EVENT_MESSAGE(message_id=12751*)
