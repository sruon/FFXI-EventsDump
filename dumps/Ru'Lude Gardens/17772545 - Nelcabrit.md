...
| [102](#event-102)        | 0x0004       |     20 |              6 |
| [46](#event-46)          | 0x0018       |     20 |              6 |
| [47](#event-47)          | 0x002C       |     20 |              6 |
| [42](#event-42)          | 0x0040       |      1 |              1 |
| [67](#event-67)          | 0x0041       |     41 |             11 |
| [140](#event-140)        | 0x006A       |     37 |              9 |
| [49](#event-49)          | 0x008F       |     37 |              9 |
| [48](#event-48)          | 0x00B4       |     37 |              9 |
| [45](#event-45)          | 0x00D9       |     37 |              9 |
| [130](#event-130)        | 0x00FE       |      1 |              1 |
| [133](#event-133)        | 0x00FF       |     37 |              9 |
| [136](#event-136)        | 0x0124       |     56 |             12 |
| [36](#event-36)          | 0x015C       |    106 |             21 |
| [56](#event-56)          | 0x01C6       |     28 |              8 |
| [106](#event-106)        | 0x01E2       |     28 |              8 |
| [65535.1](#event-655351) | 0x01FE       |     31 |              8 |
| [65535.2](#event-655352) | 0x021D       |     19 |              3 |
| [65535.3](#event-655353) | 0x0230       |      9 |              3 |
| [65535.4](#event-655354) | 0x0239       |     19 |              3 |
| [65535.5](#event-655355) | 0x024C       |     29 |              3 |
| [65535.6](#event-655356) | 0x0269       |     29 |              3 |
| [65535.7](#event-655357) | 0x0286       |      9 |              3 |
| [65535.8](#event-655358) | 0x028F       |      1 |              1 |
...
- **10000**: Welcome to the Embassy of San d'Oria. If you ever need help during your stay, do not hesitate to contact us.
- **10003**: Welcome to the Embassy of San d'Oria. Ah, I can see you're a Bastoker... The Embassy of Bastok is outside to the right.
- **10004**: Welcome to the Embassy of San d'Oria. But you're a Windurstian, are you not? The Embassy of Windurst is out on the other side.
- **10053**: Delkfutt's Tower is on the island of Qufim. Avail yourself of the merchants in town, and assemble a party of fellow adventurers.
- **10054**: Foul beasts lurk around every corner. Be on your guard.
- **10059**: Welcome back. Her Excellency has returned and is waiting for you. Come, proceed into her office.
- **10080**: For the time being, apply your efforts to our righteous conquest of the regions adjacent to Jeuno.
- **10083**: Well met, <Player>. Her Excellency requires your service. Once you have completed your current mission, return and seek an audience with her.
- **10086**: Her Excellency requires help in an important matter. Proceed, and listen well.
- **10120**: Our prayers are with you. Now, make haste to the archduke's palace!
- **10145**: Excellent work. How fares the archduke?
- **10146**: He wants you to gather the magicite? I know nothing about objects of lore, but perhaps you should try learning more about Davoi, Beadeaux, and Castle Oztroja.
- **10180**: <Player>! At long last you return! Congratulations on your success!
- **10181**: I regret you have no time for reprieve. Our beloved San d'Oria is in danger!
- **10182**: Her Excellency is away, so please take this to the court in her stead. Take the airship! I will remain and do what I can.
- **10183**: Make haste to San d'Oria! You can board the airship now, can you not? I will remain here and find out what I can.
- **10184**: Well, I am relieved there was no danger. Our embassy is safe as well. For now, obey the court's commands.
...
```
  ...
  2: 0x0012 [0x1D] PRINT_EVENT_MESSAGE(message_id=10000*)
...
```
  ...
  2: 0x0026 [0x1D] PRINT_EVENT_MESSAGE(message_id=10003*)
...
```
  ...
  2: 0x003A [0x1D] PRINT_EVENT_MESSAGE(message_id=10004*)
...
```
  ...
  5: 0x0060 [0x1D] PRINT_EVENT_MESSAGE(message_id=10053*)
  ...
  7: 0x0064 [0x1D] PRINT_EVENT_MESSAGE(message_id=10054*)
...
```
  ...
  5: 0x0089 [0x1D] PRINT_EVENT_MESSAGE(message_id=10059*)
...
```
  ...
  5: 0x00AE [0x1D] PRINT_EVENT_MESSAGE(message_id=10080*)
...
```
  ...
  5: 0x00D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10083*)
...
```
  ...
  5: 0x00F8 [0x1D] PRINT_EVENT_MESSAGE(message_id=10086*)
...
```
  ...
  5: 0x011E [0x1D] PRINT_EVENT_MESSAGE(message_id=10120*)
...
```
  ...
  5: 0x0143 [0x1D] PRINT_EVENT_MESSAGE(message_id=10145*)
  ...
  8: 0x0156 [0x1D] PRINT_EVENT_MESSAGE(message_id=10146*)
...
```
  ...
  5: 0x0166 [0x1D] PRINT_EVENT_MESSAGE(message_id=10180*)
 ...
 13: 0x01A0 [0x1D] PRINT_EVENT_MESSAGE(message_id=10181*)
 ...
 17: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=10182*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
01C0:                   1E F0  FF FF 7F 6F 70 66 04 80        .....opf..
01D0: F8 FF FF 7F F8 FF FF 7F  74 6C 6B 30 1D 17 80 23  ........tlk0...#
01E0: 21 00                                             !.              
```
...
```
  ...
  4: 0x01DC [0x1D] PRINT_EVENT_MESSAGE(message_id=10183*)
...
```
  ...
  4: 0x01F8 [0x1D] PRINT_EVENT_MESSAGE(message_id=10184*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0280:                   5E 69  64 6C 30 1C 20 80 00           ^idl0. .. 
```

#### Opcodes

```
  0: 0x0286 [0x5E] EventEntity goes idle (kills current action) (animation: "idl0")
