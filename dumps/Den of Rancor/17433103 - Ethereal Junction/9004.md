...
```
  ...
  6: 0x0110 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x02, bit_index_work_offset=0x8007, condition_work_offset=0x8002)
  7: 0x0117 [0x02] IF !(Work_Zone[4] == 0*) GOTO 0x0126
  8: 0x011F [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x02, bit_index_work_offset=0x8008, condition_work_offset=0x8002)
  9: 0x0126 [0x02] IF !(Work_Zone[5] == 0*) GOTO 0x0135
 10: 0x012E [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x02, bit_index_work_offset=0x8009, condition_work_offset=0x8002)
 11: 0x0135 [0x02] IF !(Work_Zone[6] == 0*) GOTO 0x0144
 12: 0x013D [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x02, bit_index_work_offset=0x800A, condition_work_offset=0x8002)
 13: 0x0144 [0x02] IF !(Work_Zone[7] == 0*) GOTO 0x0153
 14: 0x014C [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x02, bit_index_work_offset=0x800B, condition_work_offset=0x8002)
 15: 0x0153 [0x02] IF !(Work_Zone[8] == 0*) GOTO 0x0162
 16: 0x015B [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x02, bit_index_work_offset=0x800C, condition_work_offset=0x8002)
 ...
 21: 0x0175 [0x24] CREATE_DIALOG(message_id=10633*, default_option=0*, option_flags=0x02)
...
\u0002.\u0007\u000C\u0003[Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]\u007F1\u0000\u0007"
 ...
 34: 0x01B0 [0x24] CREATE_DIALOG(message_id=10615*, default_option=1*, option_flags=0*)
...
SUBROUTINE_01F2:
 ...
 54: 0x0211 [0x48] [System] [10614*]:
    → "Those who have accepted \u0001\u0005@\u0002\u0000\u0000\u0000 must pay 
\u0001 Unity accolades to participate.\u0007The content for this Wanted battle is 
\u0002.\u0007\u000C\u0003[Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]\u007F1\u0000\u0007"
 55: 0x0214 [0x23] WAIT_FOR_DIALOG_INTERACTION
 56: 0x0215 [0x03] Work_Zone[3] = ExtData[1]->WorkLocal[0]
 57: 0x021A [0x24] CREATE_DIALOG(message_id=10615*, default_option=1*, option_flags=0*)
    → "Commence the Wanted battle? (
\u0001 acc.)\u0007\u000BLet's go!\u0007Not yet.\u007F1\u0000\u0007"
...
SUBROUTINE_025C:
 ...
 77: 0x027B [0x48] [System] [10614*]:
    → "Those who have accepted \u0001\u0005@\u0002\u0000\u0000\u0000 must pay 
\u0001 Unity accolades to participate.\u0007The content for this Wanted battle is 
\u0002.\u0007\u000C\u0003[Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]\u007F1\u0000\u0007"
 78: 0x027E [0x23] WAIT_FOR_DIALOG_INTERACTION
 79: 0x027F [0x03] Work_Zone[3] = ExtData[1]->WorkLocal[0]
 80: 0x0284 [0x24] CREATE_DIALOG(message_id=10615*, default_option=1*, option_flags=0*)
    → "Commence the Wanted battle? (
\u0001 acc.)\u0007\u000BLet's go!\u0007Not yet.\u007F1\u0000\u0007"
...
100: 0x02E5 [0x48] [System] [10614*]:
    → "Those who have accepted \u0001\u0005@\u0002\u0000\u0000\u0000 must pay 
\u0001 Unity accolades to participate.\u0007The content for this Wanted battle is 
\u0002.\u0007\u000C\u0003[Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]\u007F1\u0000\u0007"
101: 0x02E8 [0x23] WAIT_FOR_DIALOG_INTERACTION
102: 0x02E9 [0x03] Work_Zone[3] = ExtData[1]->WorkLocal[0]
103: 0x02EE [0x24] CREATE_DIALOG(message_id=10615*, default_option=1*, option_flags=0*)
    → "Commence the Wanted battle? (
\u0001 acc.)\u0007\u000BLet's go!\u0007Not yet.\u007F1\u0000\u0007"
...
123: 0x034F [0x48] [System] [10614*]:
    → "Those who have accepted \u0001\u0005@\u0002\u0000\u0000\u0000 must pay 
\u0001 Unity accolades to participate.\u0007The content for this Wanted battle is 
\u0002.\u0007\u000C\u0003[Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]\u007F1\u0000\u0007"
124: 0x0352 [0x23] WAIT_FOR_DIALOG_INTERACTION
125: 0x0353 [0x03] Work_Zone[3] = ExtData[1]->WorkLocal[0]
126: 0x0358 [0x24] CREATE_DIALOG(message_id=10615*, default_option=1*, option_flags=0*)
    → "Commence the Wanted battle? (
\u0001 acc.)\u0007\u000BLet's go!\u0007Not yet.\u007F1\u0000\u0007"
...
146: 0x03B9 [0x48] [System] [10614*]:
    → "Those who have accepted \u0001\u0005@\u0002\u0000\u0000\u0000 must pay 
\u0001 Unity accolades to participate.\u0007The content for this Wanted battle is 
\u0002.\u0007\u000C\u0003[Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]\u007F1\u0000\u0007"
147: 0x03BC [0x23] WAIT_FOR_DIALOG_INTERACTION
148: 0x03BD [0x03] Work_Zone[3] = ExtData[1]->WorkLocal[0]
149: 0x03C2 [0x24] CREATE_DIALOG(message_id=10615*, default_option=1*, option_flags=0*)
    → "Commence the Wanted battle? (
\u0001 acc.)\u0007\u000BLet's go!\u0007Not yet.\u007F1\u0000\u0007"
...
169: 0x0423 [0x48] [System] [10614*]:
    → "Those who have accepted \u0001\u0005@\u0002\u0000\u0000\u0000 must pay 
\u0001 Unity accolades to participate.\u0007The content for this Wanted battle is 
\u0002.\u0007\u000C\u0003[Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]\u007F1\u0000\u0007"
170: 0x0426 [0x23] WAIT_FOR_DIALOG_INTERACTION
171: 0x0427 [0x03] Work_Zone[3] = ExtData[1]->WorkLocal[0]
172: 0x042C [0x24] CREATE_DIALOG(message_id=10615*, default_option=1*, option_flags=0*)
    → "Commence the Wanted battle? (
\u0001 acc.)\u0007\u000BLet's go!\u0007Not yet.\u007F1\u0000\u0007"
...
192: 0x048D [0x48] [System] [10614*]:
    → "Those who have accepted \u0001\u0005@\u0002\u0000\u0000\u0000 must pay 
\u0001 Unity accolades to participate.\u0007The content for this Wanted battle is 
\u0002.\u0007\u000C\u0003[Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]\u007F1\u0000\u0007"
193: 0x0490 [0x23] WAIT_FOR_DIALOG_INTERACTION
194: 0x0491 [0x03] Work_Zone[3] = ExtData[1]->WorkLocal[0]
195: 0x0496 [0x24] CREATE_DIALOG(message_id=10615*, default_option=1*, option_flags=0*)
    → "Commence the Wanted battle? (
\u0001 acc.)\u0007\u000BLet's go!\u0007Not yet.\u007F1\u0000\u0007"
...
# Data Section: 0x0009 (235 bytes)
     ...
     0x0049: 03 80 80 5A 00 40 05 80 06 80 01 10 02 80 01 D2
     0x0059: 00 02 01 00 03 80 80 6E 00 40 05 80 06 80 01 10
     0x0069: 07 80 01 D2 00 02 01 00 03 80 80 82 00 40 05 80
     0x0079: 06 80 01 10 08 80 01 D2 00 02 01 00 03 80 80 96
     0x0089: 00 40 05 80 06 80 01 10 09 80 01 D2 00 02 01 00
     0x0099: 03 80 80 AA 00 40 05 80 06 80 01 10 0A 80 01 D2
     0x00A9: 00 02 01 00 03 80 80 BE 00 40 05 80 06 80 01 10
     0x00B9: 0B 80 01 D2 00 02 01 00 03 80 80 D2 00 40 05 80
     0x00C9: 06 80 01 10 0C 80 01 D2 00 40 03 80 0C 80 01 10
     0x00D9: 0D 80 43 00 43 01 03 01 10 02 10 01 F2 00 02 00
