...
```
 ...
 12: 0x0034 [0x45] LOAD_SCHEDULED_TASK(work_offset1=94*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="sin1", work_offset2=0*)
 ...
 15: 0x0053 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 16: 0x0064 [0x1C] WAIT(120* ticks)
 17: 0x0067 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="s148")
 18: 0x0074 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="cryh")
 19: 0x0081 [0x54] WAIT_MAP_SCHEDULER(entity1=EventEntity, entity2=EventEntity, action_id="cryh")
 20: 0x008E [0x1C] WAIT(60* ticks)
 21: 0x0091 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="senh")
 22: 0x009E [0x54] WAIT_MAP_SCHEDULER(entity1=EventEntity, entity2=EventEntity, action_id="senh")
 ...
 29: 0x00BD [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 30: 0x00CE [0x1C] WAIT(60* ticks)
 31: 0x00D1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="whi1", work_offset2=0*)
 32: 0x00E2 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="door")
 33: 0x00EF [0x46] CAMERA_CONTROL: Restore default settings
 34: 0x00F1 [0x1C] WAIT(240* ticks)
 35: 0x00F4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
