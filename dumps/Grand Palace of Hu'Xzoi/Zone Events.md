...
- **7258**: Use the device? [Yes./No.]
- **7259**: This device appears to be connected to the level below.
- **7260**: This device appears to be connected to the level above.
- **7274**: Can you hear it? [Loud and clear./Hear what?]
...
```
 ...
 18: 0x008F [0x2B] Makki-Chebukki (ID: 16916918/0x010221B6) [7268*]:
 ...
 22: 0x00B5 [0x2B] Kukki-Chebukki (ID: 16916919/0x010221B7) [7269*]:
 ...
 26: 0x00DB [0x2B] Cherukiki (ID: 16916920/0x010221B8) [7270*]:
 ...
 44: 0x0194 [0x2B] Louverance (ID: 16916916/0x010221B4) [7271*]:
 ...
 58: 0x0205 [0x2B] Ulmia (ID: 16916912/0x010221B0) [7272*]:
 ...
 68: 0x0261 [0x2B] Shikaree Z (ID: 16916915/0x010221B3) [7273*]:
    → "I can hear it clearly now. The source must be beyond this gate."
 69: 0x0268 [0x23] WAIT_FOR_DIALOG_INTERACTION
 70: 0x0269 [0x24] CREATE_DIALOG(message_id=7274*, default_option=0*, option_flags=0*)
 ...
 75: 0x0292 [0x2B] Shikaree Z (ID: 16916915/0x010221B3) [7275*]:
 ...
 81: 0x02BE [0x2B] Shikaree Z (ID: 16916915/0x010221B3) [7276*]:
...
SUBROUTINE_02C9:
 ...
 89: 0x0300 [0x2B] Jabbos (ID: 16916914/0x010221B2) [7277*]:
 ...
 95: 0x0340 [0x2B] Louverance (ID: 16916916/0x010221B4) [7278*]:
...
103: 0x0390 [0x2B] Ulmia (ID: 16916912/0x010221B0) [7279*]:
...
106: 0x03A7 [0x2B] Ulmia (ID: 16916912/0x010221B0) [7280*]:
...
111: 0x03D8 [0x2B] Ulmia (ID: 16916912/0x010221B0) [7281*]:
...
114: 0x03EF [0x2B] Ulmia (ID: 16916912/0x010221B0) [7282*]:
...
119: 0x0426 [0x2B] Ulmia (ID: 16916912/0x010221B0) [7283*]:
...
```
  ...
  1: 0x0555 [0x48] [System] [7259*]:
    → "This device appears to be connected to the level below."
  2: 0x0558 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0559 [0x24] CREATE_DIALOG(message_id=7258*, default_option=1*, option_flags=0*)
...
```
  ...
  1: 0x05A1 [0x48] [System] [7259*]:
    → "This device appears to be connected to the level below."
  2: 0x05A4 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x05A5 [0x24] CREATE_DIALOG(message_id=7258*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x05ED [0x48] [System] [7259*]:
    → "This device appears to be connected to the level below."
  2: 0x05F0 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x05F1 [0x24] CREATE_DIALOG(message_id=7258*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0639 [0x48] [System] [7259*]:
    → "This device appears to be connected to the level below."
  2: 0x063C [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x063D [0x24] CREATE_DIALOG(message_id=7258*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0685 [0x48] [System] [7259*]:
    → "This device appears to be connected to the level below."
  2: 0x0688 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0689 [0x24] CREATE_DIALOG(message_id=7258*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x06D1 [0x48] [System] [7260*]:
    → "This device appears to be connected to the level above."
  2: 0x06D4 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x06D5 [0x24] CREATE_DIALOG(message_id=7258*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x071D [0x48] [System] [7260*]:
    → "This device appears to be connected to the level above."
  2: 0x0720 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0721 [0x24] CREATE_DIALOG(message_id=7258*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0769 [0x48] [System] [7260*]:
    → "This device appears to be connected to the level above."
  2: 0x076C [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x076D [0x24] CREATE_DIALOG(message_id=7258*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x07B5 [0x48] [System] [7260*]:
    → "This device appears to be connected to the level above."
  2: 0x07B8 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x07B9 [0x24] CREATE_DIALOG(message_id=7258*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0801 [0x48] [System] [7260*]:
    → "This device appears to be connected to the level above."
  2: 0x0804 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0805 [0x24] CREATE_DIALOG(message_id=7258*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
