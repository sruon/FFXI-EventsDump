...
- **7244**: You see a way out of the shrouded land... [/Furthermore, you feel as if you could regain abilities that have been lost to you.]
- **7245**: What will you do? [Leave Dynamis./Unlock support jobs./Nothing.]
- **7246**: Proceed out of Dynamis? [Yes, leave./No, remain.]
- **7247**: Proceed in unlocking support jobs? [Yes, unlock./No, retain.]
...
```
  ...
  5: 0x0014 [0x24] CREATE_DIALOG(message_id=7245*, default_option=2*, option_flags=ExtData[1]->WorkLocal[2])
  ...
  8: 0x0024 [0x24] CREATE_DIALOG(message_id=7246*, default_option=1*, option_flags=0*)
...
SUBROUTINE_004C:
 ...
 20: 0x0057 [0x24] CREATE_DIALOG(message_id=7247*, default_option=1*, option_flags=0*)
