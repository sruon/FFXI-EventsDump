...
- **7784**: Debug what? [Nothing./Clone ward./Resistance soldiers./Martello core./Verge 1./Verge 2./Verge 3./Resistance Credits.]
- **7785**: Barrier debug. (average HP value: $0) [Return./Pulse martello HP/Clone ward 1 HP/Clone ward 2 HP/Clone ward 3 HP/Clone ward 4 HP/Clone ward 5 HP/Clone ward 6 HP/Clone ward 7 HP/Clone ward durability: $1]
- **7786**: Resistance soldier debug. [Return./Attack: $0/Delay: $1/Skill: $2/Recovery: $3]
- **7787**: Martello core debug. [Return./3: $1/$3: $3/$3: $5/$3: $7/$3: $9/$3: $11/$3: $13]
- **7788**: Enemy pop location $0 debug. [Return./Next attack value: $1/Fore Trap attack reduction: $2/Fore Trap delay extension: $3/Rear Trap paralysis duration: $4/Rear Trap paralysis success rate: $5]
- **7789**: Value adjuster (Current: $0) [Cancel./+1/+2/+3/+5/+10/+20/+30/+50/+100/+200/+300/+500/+1000/-1/-2/-3/-5/-10/-20/-30/-50/-100/-200/-300/-500/-1000]
...
```
 ...
 79: 0x01C9 [0x24] CREATE_DIALOG(message_id=7784*, default_option=0*, option_flags=0*)
...
100: 0x0241 [0x24] CREATE_DIALOG(message_id=7785*, default_option=0*, option_flags=ExtData[1]->WorkLocal[37])
...
SUBROUTINE_0304:
137: 0x0304 [0x24] CREATE_DIALOG(message_id=7789*, default_option=0*, option_flags=0*)
...
159: 0x037A [0x24] CREATE_DIALOG(message_id=7786*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0418:
189: 0x0418 [0x24] CREATE_DIALOG(message_id=7789*, default_option=0*, option_flags=0*)
    → "Value adjuster (Current: $0) [Cancel./+1/+2/+3/+5/+10/+20/+30/+50/+100/+200/+300/+500/+1000/-1/-2/-3/-5/-10/-20/-30/-50/-100/-200/-300/-500/-1000]"
...
221: 0x04C0 [0x24] CREATE_DIALOG(message_id=7787*, default_option=0*, option_flags=0*)
...
SUBROUTINE_05BE:
269: 0x05BE [0x24] CREATE_DIALOG(message_id=7789*, default_option=0*, option_flags=0*)
    → "Value adjuster (Current: $0) [Cancel./+1/+2/+3/+5/+10/+20/+30/+50/+100/+200/+300/+500/+1000/-1/-2/-3/-5/-10/-20/-30/-50/-100/-200/-300/-500/-1000]"
...
293: 0x063E [0x24] CREATE_DIALOG(message_id=7788*, default_option=0*, option_flags=0*)
...
SUBROUTINE_06FC:
329: 0x06FC [0x24] CREATE_DIALOG(message_id=7789*, default_option=0*, option_flags=0*)
    → "Value adjuster (Current: $0) [Cancel./+1/+2/+3/+5/+10/+20/+30/+50/+100/+200/+300/+500/+1000/-1/-2/-3/-5/-10/-20/-30/-50/-100/-200/-300/-500/-1000]"
...
353: 0x077C [0x24] CREATE_DIALOG(message_id=7788*, default_option=0*, option_flags=0*)
    → "Enemy pop location $0 debug. [Return./Next attack value: $1/Fore Trap attack reduction: $2/Fore Trap delay extension: $3/Rear Trap paralysis duration: $4/Rear Trap paralysis success rate: $5]"
...
SUBROUTINE_083A:
389: 0x083A [0x24] CREATE_DIALOG(message_id=7789*, default_option=0*, option_flags=0*)
    → "Value adjuster (Current: $0) [Cancel./+1/+2/+3/+5/+10/+20/+30/+50/+100/+200/+300/+500/+1000/-1/-2/-3/-5/-10/-20/-30/-50/-100/-200/-300/-500/-1000]"
...
413: 0x08BA [0x24] CREATE_DIALOG(message_id=7788*, default_option=0*, option_flags=0*)
    → "Enemy pop location $0 debug. [Return./Next attack value: $1/Fore Trap attack reduction: $2/Fore Trap delay extension: $3/Rear Trap paralysis duration: $4/Rear Trap paralysis success rate: $5]"
...
SUBROUTINE_0978:
449: 0x0978 [0x24] CREATE_DIALOG(message_id=7789*, default_option=0*, option_flags=0*)
    → "Value adjuster (Current: $0) [Cancel./+1/+2/+3/+5/+10/+20/+30/+50/+100/+200/+300/+500/+1000/-1/-2/-3/-5/-10/-20/-30/-50/-100/-200/-300/-500/-1000]"
...
468: 0x09DF [0x24] CREATE_DIALOG(message_id=7789*, default_option=0*, option_flags=0*)
    → "Value adjuster (Current: $0) [Cancel./+1/+2/+3/+5/+10/+20/+30/+50/+100/+200/+300/+500/+1000/-1/-2/-3/-5/-10/-20/-30/-50/-100/-200/-300/-500/-1000]"
