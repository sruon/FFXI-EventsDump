...
```
  ...
  1: 0x0006 [0x1D] PRINT_EVENT_MESSAGE(message_id=8072*)
    → "Well, this here's a sight.\u0007Don't get many travelers out this way, y'see.\u007F1\u0000\u0007"
  2: 0x0009 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x000A [0x1D] PRINT_EVENT_MESSAGE(message_id=8073*)
    → "This is Parradamo Tor. You'd best watch your step around here.\u0007It's quite a ways down, as surely ye can see.\u007F1\u0000\u0007"
