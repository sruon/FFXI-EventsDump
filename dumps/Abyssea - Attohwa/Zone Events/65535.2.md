...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0010:       BB 04 80 F0 FF FF  7F 8B 72 0D 01 6D 61 69    ........r..mai
...
```
  0: 0x0012 [0xBB] LOAD_EVENT_SCHEDULER_ALT: Load scheduler "main" with entities [LocalPlayer, Cavernous Maw (ID: 17658507/0x010D728B)], work=[148*, 0*]
