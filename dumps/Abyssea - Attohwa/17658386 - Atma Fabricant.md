...
- **7312**: You do not have enough cruor.
- **7374**: Greetings. I am an atma fabricant--or, to the layman, one who fabricates atma. I can synthesize atma from the memories of adventure stored deep within your body and soul. If you have need of my services, you need only speak the word.
- **7375**: Ask for something? [No thanks./Synthetic atma?/My memories?/Show me the atma.]
- **7376**: As you are no doubt aware, the substance we call atma is a crystalline agglomeration of soul energy that can be harvested from the bodies of fallen Abyssean fiends.
- **7377**: The abundant power that it imbues when infused into our bodies is not in question. The perilous means by which it must be acquired, however, leaves something to be desired.
- **7378**: After all, bolstering the strength of one man means little if ten others must lose their lives in the process. Thus was the impetus behind our research: to discover a means for extracting atma from resources at our immediate disposal.
- **7379**: We experimented with nearly every substance in sight--be it animal, vegetable, or mineral. Yet each time, the atma produced was small, fragile, and entirely absent of the power we sought.
- **7380**: Then, one day, we hit upon the obvious answer that we had so long overlooked...ourselves. Yes, the atma extracted from our own bodies--particularly those richly possessed of experiences and memories--these housed a power rivalling that harvested from the most vicious of fiends.
- **7381**: If you possess such memories, then I can bring forth the latent power that resides within you as well.
- **7382**: Fear not, for there is everything to gain and nothing to lose. Save for some cruor, that is...
- **7383**: Curious, is it not? That potent physical energy can be extracted from such a tenuous, intangible thing...
- **7384**: But the strength our memories and experiences give us is real, if all too easily overlooked. Once isolated, it is simply a matter of recalling it, solidifying it, and bringing it to the fore.
- **7385**: Surely you understand of what it is I speak, yes? Your greatest accomplishments--those that make others stand in wonderment and admiration when you they hear your name.
- **7386**: We summon forth the energies from the deepest recesses of your psyche, and infuse it into the cruor you carry. The resultant agglomeration of organic mineral and soul energy is synthetic atma.
- **7387**: Mind you, the deeper and more puissant your energies, the more cruor will be necessary to contain it all. If you wish to have me assay the powers that lie dormant within you, simply speak the word.
- **7388**: Very well. We shall see what latent powers you possess. Stand still and clear your mind...
- **7389**: Yes...it is as I thought... Long and far have you traveled...many a battle have you fought...
- **7390**: Yes, I see within you $0 [memory/memories] that I could process into atma. Which shall I extract?
- **7391**: ...And yet, I see nothing tangible enough for me to process. I am sorry.
- **7392**: Synthesize atma? (Cruor balance: $0) [None for now./$6: $2./$6: $4./$6: $6./$6: $8./$6: $10./$6: $12./$6: $14./$6: $16./$6: $18./$6: $20./$6: $22./$6: $24./$6: $26./$6: $28./$6: $30./$6: $ ./$6: $"./$6: $$./Previous page./Next page.]
- **7393**: Expend $0 cruor? [Yes./No.]
- **7394**: Very well. Let us begin the extraction.
- **7395**: Still your heart, and empty your mind...
- **7396**: The power is strong within you... Slowly, but surely, it stirs to the fore... Yes... Yes, it is come!
- **7397**: Behold, the physical manifestation of the innermost power of your soul!
...
```
 ...
 52: 0x00EE [0x1D] PRINT_EVENT_MESSAGE(message_id=7374*)
 ...
 56: 0x00FD [0x24] CREATE_DIALOG(message_id=7375*, default_option=0*, option_flags=0*)
 ...
 63: 0x0120 [0x1D] PRINT_EVENT_MESSAGE(message_id=7376*)
 ...
 65: 0x0124 [0x1D] PRINT_EVENT_MESSAGE(message_id=7377*)
 ...
 67: 0x0128 [0x1D] PRINT_EVENT_MESSAGE(message_id=7378*)
 ...
 69: 0x012C [0x1D] PRINT_EVENT_MESSAGE(message_id=7379*)
 ...
 71: 0x0130 [0x1D] PRINT_EVENT_MESSAGE(message_id=7380*)
 ...
 73: 0x0134 [0x1D] PRINT_EVENT_MESSAGE(message_id=7381*)
 ...
 75: 0x0138 [0x1D] PRINT_EVENT_MESSAGE(message_id=7382*)
 ...
 79: 0x0147 [0x1D] PRINT_EVENT_MESSAGE(message_id=7383*)
 ...
 81: 0x014B [0x1D] PRINT_EVENT_MESSAGE(message_id=7384*)
 ...
 83: 0x014F [0x1D] PRINT_EVENT_MESSAGE(message_id=7385*)
 ...
 85: 0x0153 [0x1D] PRINT_EVENT_MESSAGE(message_id=7386*)
 ...
 87: 0x0157 [0x1D] PRINT_EVENT_MESSAGE(message_id=7387*)
 ...
 91: 0x0166 [0x1D] PRINT_EVENT_MESSAGE(message_id=7388*)
 ...
 93: 0x016A [0x1D] PRINT_EVENT_MESSAGE(message_id=7389*)
 ...
 97: 0x017B [0x1D] PRINT_EVENT_MESSAGE(message_id=7390*)
...
195: 0x0388 [0x24] CREATE_DIALOG(message_id=7392*, default_option=0*, option_flags=ExtData[1]->WorkLocal[42])
...
262: 0x04EE [0x24] CREATE_DIALOG(message_id=7393*, default_option=1*, option_flags=0*)
...
272: 0x0512 [0x1D] PRINT_EVENT_MESSAGE(message_id=7397*)
...
279: 0x0531 [0x1D] PRINT_EVENT_MESSAGE(message_id=7312*)
...
286: 0x0549 [0x1D] PRINT_EVENT_MESSAGE(message_id=7391*)
