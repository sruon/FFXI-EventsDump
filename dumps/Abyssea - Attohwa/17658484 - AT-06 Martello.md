...
- **7478**: What will you do? (Energy level: $0) [Nothing for now./Recover HP: $1./Recover MP: $2./Recover from status ailments: $3./Prepare to replenish martello./Prepare to upgrade martello./Replenish from the [east/southeast/south/southwest/west/northwest/north/northeast]./Upgrade from the [east/southeast/south/southwest/west/northwest/north/northeast]./Cease replenishing this martello./Cease upgrading this martello./Cease replenishing other martello./Cease upgrading other martello.]
- **7479**: [Recover HP/Recover MP/Recover from status ailments]? [Yes./No.]
- **7480**: The martello does not have enough energy.
- **7482**: Prepare to [replenish/upgrade] this martello? [Yes./No.]
- **7483**: This martello does not need to be [replenished/upgraded].
- **7485**: [Replenish/Upgrade] from this direction? [Yes./No.]
- **7487**: Please note that martello recast time is $0 [minute/minutes].
- **7490**: Cease [replenishing/upgrading] this martello? [Yes./No.]
...
```
 ...
 24: 0x0077 [0x24] CREATE_DIALOG(message_id=7478*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
 ...
 42: 0x00CB [0x24] CREATE_DIALOG(message_id=7479*, default_option=1*, option_flags=0*)
...
SUBROUTINE_0100:
 ...
 64: 0x0133 [0x48] [System] [7487*]:
    → "Please note that martello recast time is $0 [minute/minutes]."
 65: 0x0136 [0x23] WAIT_FOR_DIALOG_INTERACTION
 66: 0x0137 [0x03] Work_Zone[2] = 1*
 67: 0x013C [0x24] CREATE_DIALOG(message_id=7479*, default_option=1*, option_flags=0*)
    → "[Recover HP/Recover MP/Recover from status ailments]? [Yes./No.]"
...
SUBROUTINE_0171:
 ...
 89: 0x01A4 [0x48] [System] [7487*]:
    → "Please note that martello recast time is $0 [minute/minutes]."
 90: 0x01A7 [0x23] WAIT_FOR_DIALOG_INTERACTION
 91: 0x01A8 [0x03] Work_Zone[2] = 2*
 92: 0x01AD [0x24] CREATE_DIALOG(message_id=7479*, default_option=1*, option_flags=0*)
    → "[Recover HP/Recover MP/Recover from status ailments]? [Yes./No.]"
...
107: 0x01F2 [0x24] CREATE_DIALOG(message_id=7482*, default_option=1*, option_flags=0*)
...
122: 0x023B [0x24] CREATE_DIALOG(message_id=7482*, default_option=1*, option_flags=0*)
    → "Prepare to [replenish/upgrade] this martello? [Yes./No.]"
...
138: 0x0285 [0x24] CREATE_DIALOG(message_id=7485*, default_option=1*, option_flags=0*)
...
149: 0x02BB [0x24] CREATE_DIALOG(message_id=7485*, default_option=1*, option_flags=0*)
    → "[Replenish/Upgrade] from this direction? [Yes./No.]"
...
161: 0x02F6 [0x24] CREATE_DIALOG(message_id=7490*, default_option=1*, option_flags=0*)
...
173: 0x0331 [0x24] CREATE_DIALOG(message_id=7490*, default_option=1*, option_flags=0*)
    → "Cease [replenishing/upgrading] this martello? [Yes./No.]"
...
185: 0x036C [0x24] CREATE_DIALOG(message_id=7490*, default_option=1*, option_flags=0*)
    → "Cease [replenishing/upgrading] this martello? [Yes./No.]"
...
197: 0x03A7 [0x24] CREATE_DIALOG(message_id=7490*, default_option=1*, option_flags=0*)
    → "Cease [replenishing/upgrading] this martello? [Yes./No.]"
