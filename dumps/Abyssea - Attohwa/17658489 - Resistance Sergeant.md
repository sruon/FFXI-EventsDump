...
- **7774**: Greetings, friend. I am the resistance sergeant for this area. I can apprise you of the current situation, if you wish.
...
```
 ...
 78: 0x01C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7774*)
 ...
 85: 0x01E0 [0x24] CREATE_DIALOG(message_id=7721*, default_option=0*, option_flags=0*)
 ...
 91: 0x01FE [0x1D] PRINT_EVENT_MESSAGE(message_id=7722*)
...
107: 0x0237 [0x1D] PRINT_EVENT_MESSAGE(message_id=7726*)
...
125: 0x028C [0x24] CREATE_DIALOG(message_id=7727*, default_option=0*, option_flags=0*)
...
133: 0x02B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7728*)
...
136: 0x02BD [0x1D] PRINT_EVENT_MESSAGE(message_id=7729*)
...
142: 0x02D6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7728*)
    → "Let's see... The energy output level for the $3 is currently $1."
143: 0x02D9 [0x23] WAIT_FOR_DIALOG_INTERACTION
144: 0x02DA [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[10]
145: 0x02DF [0x1D] PRINT_EVENT_MESSAGE(message_id=7730*)
...
151: 0x02F8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7728*)
    → "Let's see... The energy output level for the $3 is currently $1."
152: 0x02FB [0x23] WAIT_FOR_DIALOG_INTERACTION
153: 0x02FC [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[11]
154: 0x0301 [0x1D] PRINT_EVENT_MESSAGE(message_id=7731*)
...
160: 0x031A [0x1D] PRINT_EVENT_MESSAGE(message_id=7728*)
    → "Let's see... The energy output level for the $3 is currently $1."
161: 0x031D [0x23] WAIT_FOR_DIALOG_INTERACTION
162: 0x031E [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[12]
163: 0x0323 [0x1D] PRINT_EVENT_MESSAGE(message_id=7732*)
...
169: 0x033C [0x1D] PRINT_EVENT_MESSAGE(message_id=7728*)
    → "Let's see... The energy output level for the $3 is currently $1."
170: 0x033F [0x23] WAIT_FOR_DIALOG_INTERACTION
171: 0x0340 [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[13]
172: 0x0345 [0x1D] PRINT_EVENT_MESSAGE(message_id=7733*)
...
178: 0x035E [0x1D] PRINT_EVENT_MESSAGE(message_id=7728*)
    → "Let's see... The energy output level for the $3 is currently $1."
179: 0x0361 [0x23] WAIT_FOR_DIALOG_INTERACTION
180: 0x0362 [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[14]
181: 0x0367 [0x1D] PRINT_EVENT_MESSAGE(message_id=7734*)
...
187: 0x0380 [0x1D] PRINT_EVENT_MESSAGE(message_id=7728*)
    → "Let's see... The energy output level for the $3 is currently $1."
188: 0x0383 [0x23] WAIT_FOR_DIALOG_INTERACTION
189: 0x0384 [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[15]
190: 0x0389 [0x1D] PRINT_EVENT_MESSAGE(message_id=7735*)
...
199: 0x03AD [0x1D] PRINT_EVENT_MESSAGE(message_id=7736*)
...
203: 0x03BB [0x1D] PRINT_EVENT_MESSAGE(message_id=7737*)
...
207: 0x03C9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7738*)
...
214: 0x03E7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7736*)
    → "Intel estimates a $1 percent chance that the enemy will attack from the [eastern/southeastern/southern/southern/western/northwestern/northern/northeastern] verge. [There is time still to shore up our defenses./We had best step up our preparations./I pray that the traps will have the desired effect./They will be upon us at any moment now./They come even as we speak!]"
...
218: 0x03F5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7737*)
    → "The fore trap's current energy store is [paltry/low/moderate/high/brimming]. We expect that it will weaken the enemy's attack [only very slightly/only slightly/moderately/considerably/drastically]."
...
222: 0x0403 [0x1D] PRINT_EVENT_MESSAGE(message_id=7738*)
    → "The rear trap's current energy store is [paltry/low/moderate/high/brimming]. We expect that it will afflict the enemy with [only a very brief/only a brief/a moderate/an extended/a greatly extended] duration of paralysis."
...
229: 0x0421 [0x1D] PRINT_EVENT_MESSAGE(message_id=7736*)
    → "Intel estimates a $1 percent chance that the enemy will attack from the [eastern/southeastern/southern/southern/western/northwestern/northern/northeastern] verge. [There is time still to shore up our defenses./We had best step up our preparations./I pray that the traps will have the desired effect./They will be upon us at any moment now./They come even as we speak!]"
...
233: 0x042F [0x1D] PRINT_EVENT_MESSAGE(message_id=7737*)
    → "The fore trap's current energy store is [paltry/low/moderate/high/brimming]. We expect that it will weaken the enemy's attack [only very slightly/only slightly/moderately/considerably/drastically]."
...
237: 0x043D [0x1D] PRINT_EVENT_MESSAGE(message_id=7738*)
    → "The rear trap's current energy store is [paltry/low/moderate/high/brimming]. We expect that it will afflict the enemy with [only a very brief/only a brief/a moderate/an extended/a greatly extended] duration of paralysis."
