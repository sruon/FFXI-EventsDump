...
- **9125**: The Abyssea and Atma Axtravaganza is in full swing! Just open this chest to claim your prize.
- **9126**: You can claim it anytime you want during the campaign, but don't wait too long. You can't claim squat after the campaign ends.
- **9127**: Anyway, do you want your Abyssea and Atma Axtravaganza gifts or not?
- **9128**: Receive the gifts? [Of course!/No thanks.]
- **9129**: Gift 1: Eleven different types of atma. *Characters who already possess the specified atma will not receive all eleven.
- **9130**: Gift 2: One $3! *Characters who already possess all three will be given 100,000 cruor.
- **9131**: Gift 3: 100,000 cruor!
- **9132**: Gift 4: The ability to store 100 more traverser stones! *You may check your stock of stones by speaking with Joachim or other applicable Abyssean personages.
- **9134**: Now that you have all the gifts, it's time to put them to use in Abyssea!
- **9135**: You're able to claim these amazing Abyssean gifts, so go talk to Joachim in Port Jeuno (H-8) before it's too late.
...
```
  ...
  5: 0x000E [0x1D] PRINT_EVENT_MESSAGE(message_id=9127*)
    → "Anyway, do you want your Abyssea and Atma Axtravaganza gifts or not?"
  6: 0x0011 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0012 [0x24] CREATE_DIALOG(message_id=9128*, default_option=0*, option_flags=0*)
 ...
 15: 0x003D [0x1D] PRINT_EVENT_MESSAGE(message_id=9129*)
...
SUBROUTINE_004A:
 ...
 23: 0x0059 [0x1D] PRINT_EVENT_MESSAGE(message_id=9130*)
...
SUBROUTINE_0066:
 ...
 30: 0x0070 [0x1D] PRINT_EVENT_MESSAGE(message_id=9131*)
...
SUBROUTINE_007D:
 ...
 37: 0x0087 [0x1D] PRINT_EVENT_MESSAGE(message_id=9132*)
...
SUBROUTINE_0094:
 ...
 44: 0x00A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=9134*)
...
```
  0: 0x00AD [0x1D] PRINT_EVENT_MESSAGE(message_id=9125*)
    → "The Abyssea and Atma Axtravaganza is in full swing! Just open this chest to claim your prize."
  1: 0x00B0 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x00B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9134*)
    → "Now that you have all the gifts, it's time to put them to use in Abyssea!"
...
```
  0: 0x00B7 [0x1D] PRINT_EVENT_MESSAGE(message_id=9125*)
    → "The Abyssea and Atma Axtravaganza is in full swing! Just open this chest to claim your prize."
  1: 0x00BA [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x00BB [0x1D] PRINT_EVENT_MESSAGE(message_id=9135*)
