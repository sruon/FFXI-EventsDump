...
- **9098**: Pick your poins. [Campaign No. $1/Count: $2./Points: $3./Save data.]
- **9099**: Flag turned [off/on].
- **9100**: Campaign number set to $1.
- **9101**: Count set to $2.
- **9102**: Points set to $3.
...
```
  ...
  9: 0x003B [0x24] CREATE_DIALOG(message_id=9098*, default_option=0*, option_flags=0*)
