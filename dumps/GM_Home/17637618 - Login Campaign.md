...
- **9096**: Pick your poins. [Campaign No. $1/Count: $2./Points: $3./Save data.]
- **9097**: Flag turned [off/on].
- **9098**: Campaign number set to $1.
- **9099**: Count set to $2.
- **9100**: Points set to $3.
...
```
  ...
  9: 0x003B [0x24] CREATE_DIALOG(message_id=9096*, default_option=0*, option_flags=0*)
