...
| [202](#event-202)     | 0x0001       |     24 |             10 |
| [203](#event-203)     | 0x0019       |     21 |              9 |
| [204](#event-204)     | 0x002E       |     16 |              6 |
...
- **9254**: Good day, adventurer! I am able to repair any broken item data related to $0.
- **9255**: If you are unable to deliver $0, it's possible that the item data has been corrupted.
- **9256**: Please trade your $0 to me so that I may fix it.
- **9257**: I have confirmed that the item data for your $0 has been corrupted. We apologize for the inconvenience.
- **9258**: I have restored it to its intended functionality. Here you are!
- **9259**: It appears that your item is working as intended.
...
```
  ...
  6: 0x0013 [0x1D] PRINT_EVENT_MESSAGE(message_id=9256*)
...
```
  ...
  3: 0x0024 [0x1D] PRINT_EVENT_MESSAGE(message_id=9257*)
  ...
  5: 0x0028 [0x1D] PRINT_EVENT_MESSAGE(message_id=9258*)
...
```
  ...
  2: 0x0038 [0x1D] PRINT_EVENT_MESSAGE(message_id=9259*)
