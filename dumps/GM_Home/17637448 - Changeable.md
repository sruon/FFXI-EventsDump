...
- **9021**: The inn is just up ahead.
- **9022**: The inn? Nowhere around here, I'm afraid.
...
```
  ...
  3: 0x000A [0x1D] PRINT_EVENT_MESSAGE(message_id=9021*)
...
```
  ...
  3: 0x0019 [0x1D] PRINT_EVENT_MESSAGE(message_id=9022*)
