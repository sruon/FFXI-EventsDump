...
- **9045**: I'm too tired to play games now.
- **9046**: For $0 gil, you can challenge me to a thrilling game of rock, paper, scissors. What do you say?
- **9047**: Take the challenge? [Of course!/Not today.]
- **9048**: You're short on cash, [buddy/lady].
- **9049**: Hah! You're just afraid to lose, I bet.
- **9050**: $0 gil. Here we go!
- **9051**: Rock...paper...
- **9052**: What's your move? [Rock./Scissors./Paper.]
- **9053**: <Player> shows rock!
- **9054**: <Player> shows scissors!
- **9055**: <Player> shows paper!
- **9056**: The gamesmaster shows rock!
- **9057**: The gamesmaster shows scissors!
- **9058**: The gamesmaster shows paper!
- **9059**: We're even.
- **9060**: I win, as expected!
- **9061**: You win...for today. Here's your prize.
...
```
  ...
  2: 0x0009 [0x1D] PRINT_EVENT_MESSAGE(message_id=9045*)
...
```
  ...
  6: 0x002A [0x1D] PRINT_EVENT_MESSAGE(message_id=9046*)
  ...
  8: 0x002E [0x24] CREATE_DIALOG(message_id=9047*, default_option=1*, option_flags=0*)
 ...
 15: 0x004F [0x1D] PRINT_EVENT_MESSAGE(message_id=9048*)
 ...
 21: 0x0060 [0x1D] PRINT_EVENT_MESSAGE(message_id=9049*)
...
SUBROUTINE_0069:
 ...
 27: 0x0073 [0x1D] PRINT_EVENT_MESSAGE(message_id=9050*)
    → "$0 gil. Here we go!"
 28: 0x0076 [0x23] WAIT_FOR_DIALOG_INTERACTION
 29: 0x0077 [0x1D] PRINT_EVENT_MESSAGE(message_id=9051*)
    → "Rock...paper..."
 30: 0x007A [0x23] WAIT_FOR_DIALOG_INTERACTION
 31: 0x007B [0x24] CREATE_DIALOG(message_id=9052*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00BF:
 ...
 53: 0x00D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=9059*)
    → "We're even."
 ...
 57: 0x00E7 [0x1D] PRINT_EVENT_MESSAGE(message_id=9060*)
    → "I win, as expected!"
 ...
 65: 0x0106 [0x1D] PRINT_EVENT_MESSAGE(message_id=9061*)
...
SUBROUTINE_010D:
 ...
 77: 0x0134 [0x1D] PRINT_EVENT_MESSAGE(message_id=9061*)
    → "You win...for today. Here's your prize."
 ...
 81: 0x0143 [0x1D] PRINT_EVENT_MESSAGE(message_id=9059*)
    → "We're even."
 ...
 85: 0x0152 [0x1D] PRINT_EVENT_MESSAGE(message_id=9060*)
    → "I win, as expected!"
...
SUBROUTINE_0159:
 ...
 93: 0x0170 [0x1D] PRINT_EVENT_MESSAGE(message_id=9060*)
    → "I win, as expected!"
...
101: 0x018F [0x1D] PRINT_EVENT_MESSAGE(message_id=9061*)
    → "You win...for today. Here's your prize."
...
105: 0x019E [0x1D] PRINT_EVENT_MESSAGE(message_id=9059*)
    → "We're even."
