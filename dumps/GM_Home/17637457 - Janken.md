...
- **9041**: I'm too tired to play games now.
- **9042**: For $0 gil, you can challenge me to a thrilling game of rock, paper, scissors. What do you say?
- **9043**: Take the challenge? [Of course!/Not today.]
- **9044**: You're short on cash, [buddy/lady].
- **9045**: Hah! You're just afraid to lose, I bet.
- **9046**: $0 gil. Here we go!
- **9047**: Rock...paper...
- **9048**: What's your move? [Rock./Scissors./Paper.]
- **9049**: <Player> shows rock!
- **9050**: <Player> shows scissors!
- **9051**: <Player> shows paper!
- **9052**: The gamesmaster shows rock!
- **9053**: The gamesmaster shows scissors!
- **9054**: The gamesmaster shows paper!
- **9055**: We're even.
- **9056**: I win, as expected!
- **9057**: You win...for today. Here's your prize.
...
```
  ...
  2: 0x0009 [0x1D] PRINT_EVENT_MESSAGE(message_id=9041*)
...
```
  ...
  6: 0x002A [0x1D] PRINT_EVENT_MESSAGE(message_id=9042*)
  ...
  8: 0x002E [0x24] CREATE_DIALOG(message_id=9043*, default_option=1*, option_flags=0*)
 ...
 15: 0x004F [0x1D] PRINT_EVENT_MESSAGE(message_id=9044*)
 ...
 21: 0x0060 [0x1D] PRINT_EVENT_MESSAGE(message_id=9045*)
...
SUBROUTINE_0069:
 ...
 27: 0x0073 [0x1D] PRINT_EVENT_MESSAGE(message_id=9046*)
    → "$0 gil. Here we go!"
 28: 0x0076 [0x23] WAIT_FOR_DIALOG_INTERACTION
 29: 0x0077 [0x1D] PRINT_EVENT_MESSAGE(message_id=9047*)
    → "Rock...paper..."
 30: 0x007A [0x23] WAIT_FOR_DIALOG_INTERACTION
 31: 0x007B [0x24] CREATE_DIALOG(message_id=9048*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00BF:
 ...
 53: 0x00D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=9055*)
    → "We're even."
 ...
 57: 0x00E7 [0x1D] PRINT_EVENT_MESSAGE(message_id=9056*)
    → "I win, as expected!"
 ...
 65: 0x0106 [0x1D] PRINT_EVENT_MESSAGE(message_id=9057*)
...
SUBROUTINE_010D:
 ...
 77: 0x0134 [0x1D] PRINT_EVENT_MESSAGE(message_id=9057*)
    → "You win...for today. Here's your prize."
 ...
 81: 0x0143 [0x1D] PRINT_EVENT_MESSAGE(message_id=9055*)
    → "We're even."
 ...
 85: 0x0152 [0x1D] PRINT_EVENT_MESSAGE(message_id=9056*)
    → "I win, as expected!"
...
SUBROUTINE_0159:
 ...
 93: 0x0170 [0x1D] PRINT_EVENT_MESSAGE(message_id=9056*)
    → "I win, as expected!"
...
101: 0x018F [0x1D] PRINT_EVENT_MESSAGE(message_id=9057*)
    → "You win...for today. Here's your prize."
...
105: 0x019E [0x1D] PRINT_EVENT_MESSAGE(message_id=9055*)
    → "We're even."
