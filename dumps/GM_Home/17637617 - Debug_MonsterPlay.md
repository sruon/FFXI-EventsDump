...
- **9086**: Vague images of worlds beyond coalesce and diffuse within.
- **9087**: Where to, intrepid pioneer? [$8./$8./$8./$8./$8./$8./Away from Monstrosity./Away from this menu!]
- **9088**: You dare trek to $8?
- **9089**: Well, do you? [Oh, I do./Nope. Cold feet.]
- **9090**: You truly wish to end your relationsip with this content, despite all the fun times you've had together?
- **9091**: Truly end it all? [Yes, I must!/No, not yet!]
- **9092**: Where in $8? [Point 1./Point 2./Point 3./Point 4./Point 5./Nowhere.]
...
```
 ...
 12: 0x0038 [0x24] CREATE_DIALOG(message_id=9087*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00BE:
 ...
 41: 0x00D3 [0x48] [System] [9088*]:
    → "You dare trek to $8?"
 42: 0x00D6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 43: 0x00D7 [0x24] CREATE_DIALOG(message_id=9089*, default_option=0*, option_flags=0*)
 ...
 49: 0x00F9 [0x24] CREATE_DIALOG(message_id=9092*, default_option=0*, option_flags=0*)
...
SUBROUTINE_01B3:
 ...
 80: 0x01BA [0x24] CREATE_DIALOG(message_id=9091*, default_option=0*, option_flags=0*)
