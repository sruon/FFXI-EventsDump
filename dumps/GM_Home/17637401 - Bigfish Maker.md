...
- **7445**: Size? [Random (default)./Largest./Smallest.]
- **7446**: Weight? [Adjusted random (default)./Adjusted largest (with respect to size)./Adjusted smallest (with respect to size)./Completely random./Largest (regardless of size)./Smallest (regardless of size).]
- **7447**: Is it ranking registerable? [Yes (default)./No.]
- **7448**: What d'ya want? [A big fish!/An effect test!(1)./An effect test!(2)./An effect test!(3)./An effect test!(4)./Nothing!]
- **7449**: Check it out...
- **7450**: Server or client? [Server./Client.]
...
```
  0: 0x0001 [0x24] CREATE_DIALOG(message_id=7448*, default_option=0*, option_flags=0*)
  ...
  5: 0x001C [0x24] CREATE_DIALOG(message_id=7450*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0043:
 13: 0x0043 [0x1D] PRINT_EVENT_MESSAGE(message_id=7449*)
    → "Check it out..."
...
SUBROUTINE_0080:
 18: 0x0080 [0x1D] PRINT_EVENT_MESSAGE(message_id=7449*)
    → "Check it out..."
...
SUBROUTINE_00BD:
 23: 0x00BD [0x1D] PRINT_EVENT_MESSAGE(message_id=7449*)
    → "Check it out..."
...
SUBROUTINE_00FA:
 28: 0x00FA [0x1D] PRINT_EVENT_MESSAGE(message_id=7449*)
    → "Check it out..."
...
SUBROUTINE_010F:
 ...
 35: 0x0117 [0x24] CREATE_DIALOG(message_id=7445*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0164:
 47: 0x0164 [0x24] CREATE_DIALOG(message_id=7446*, default_option=0*, option_flags=0*)
...
SUBROUTINE_01E4:
 67: 0x01E4 [0x24] CREATE_DIALOG(message_id=7447*, default_option=0*, option_flags=0*)
