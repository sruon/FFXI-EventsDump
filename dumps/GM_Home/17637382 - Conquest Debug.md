...
- **7078**: Vat do you vant? [Conquest points!/1 day gone (Vana'diel time)/1 day gone (earth time)/1 week gone (earth time)/Supplies for supply quest!/Not much at the moment.]
...
```
  0: 0x0001 [0x24] CREATE_DIALOG(message_id=7078*, default_option=0*, option_flags=0*)
