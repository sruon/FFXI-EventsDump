...
- **9061**: Change to what map? [Inside Adoulin Castle./Event-only Room./z210/Don't change!]
...
```
  0: 0x0001 [0x24] CREATE_DIALOG(message_id=9061*, default_option=0*, option_flags=0*)
