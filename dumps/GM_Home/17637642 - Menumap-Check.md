...
- **9258**: Check which map number? [True value./False value.]
- **9259**: Do not include hyphens in the False value.
...
```
  ...
  1: 0x0006 [0x24] CREATE_DIALOG(message_id=9258*, default_option=0*, option_flags=0*)
