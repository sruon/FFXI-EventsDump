...
- **7170**: Select the race and sex of the mannequin that you want...
- **7171**: Well... [Hume male./Hume female./Elvaan male./Elvaan female./Tarutaru male./Tarutaru female./Mithra./Galka.]
...
```
  0: 0x0001 [0x1D] PRINT_EVENT_MESSAGE(message_id=7170*)
    → "Select the race and sex of the mannequin that you want..."
  1: 0x0004 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=7171*, default_option=0*, option_flags=0*)
