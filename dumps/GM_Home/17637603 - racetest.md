...
- **9233**: Now what? )STEP:$0 speed:$1 lane:$2) [Go right./Go left./Accelerate. /Decelerate./Use an item./Use an ability./Wait and see.]
...
```
 ...
 20: 0x0077 [0x24] CREATE_DIALOG(message_id=9233*, default_option=0*, option_flags=0*)
