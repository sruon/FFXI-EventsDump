...
- **6394**: Obtained $0 gil.
- **9168**: Rod test. [Get $0./Get $1./Set $0 serial./Set $1 serial./Patch creation test.]
- **9169**: $15^$3$1[$3 [$3h$P14T$6(0E;$]L$3$1[$3 [$3h)/;$]L$3$1[$3 [$3hF$2 /
- **9170**: $15^$3V$3$3A$3 [$P14T$6(0E$3V$3X$3e$3 $P14-$s)/$P14-$s3ji%\\$P12hL$3V$3$3A$3 [F$3 /
...
```
  ...
  2: 0x000B [0x24] CREATE_DIALOG(message_id=9168*, default_option=0*, option_flags=0*)
