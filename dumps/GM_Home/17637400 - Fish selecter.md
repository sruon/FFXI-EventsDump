...
- **7283**: Select Fish Type: [Saltwater./Freshwater./Item./Flag./Treasure Chest./Monster.]
- **7284**: Select one [$0i$0j./$1i$1j./$2$3041793/$3i$3j./$4i$4j./$5i$5j./$6i$6j./$7i$7j./Next.]
- **7295**: Select. [Set./$3: [ON/OFF]./$3: [ON/OFF]./$3: [ON/OFF]./$3: [ON/OFF].]
...
```
  ...
  1: 0x0006 [0x24] CREATE_DIALOG(message_id=7283*, default_option=0*, option_flags=0*)
...
127: 0x02C2 [0x24] CREATE_DIALOG(message_id=7284*, default_option=0*, option_flags=0*)
...
SUBROUTINE_03AA:
176: 0x03AA [0x24] CREATE_DIALOG(message_id=7295*, default_option=0*, option_flags=0*)
