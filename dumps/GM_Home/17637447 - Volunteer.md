...
- **9017**: Make a donation? [Yes./No.]
- **9018**: Thank you! All proceeds will benefit the Orphaned Goobbues of Vana'diel.
- **9019**: That's a shame.
...
```
  ...
  4: 0x000F [0x24] CREATE_DIALOG(message_id=9017*, default_option=1*, option_flags=0*)
    → "Make a donation? [Yes./No.]"
  5: 0x0016 [0x25] WAIT_DIALOG_SELECT()
  6: 0x0017 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x002B
  7: 0x001F [0x1D] PRINT_EVENT_MESSAGE(message_id=9018*)
 ...
 12: 0x0033 [0x1D] PRINT_EVENT_MESSAGE(message_id=9019*)
    → "That's a shame."
