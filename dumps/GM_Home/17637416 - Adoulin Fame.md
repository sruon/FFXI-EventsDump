...
- **9088**: Raise fame for what? [I shall remain anonymous./Quests. ($1)/Pioneers' Coalition. ($2)/Peacekeepers' Coalition. ($3)/Coureiers' Coalition. ($4)/Scouts' Coalition. ($5)/Inventoers' Coalition. ($6)/Mummers' Coalition. ($7)]
- **9089**: Fiddle with what? [Nuthin'./Fame!/Bayld. ($1)/Mummers' Medals. ($2)]
...
```
  ...
  3: 0x000E [0x24] CREATE_DIALOG(message_id=9089*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0063:
 ...
 15: 0x0070 [0x24] CREATE_DIALOG(message_id=9088*, default_option=0*, option_flags=0*)
