...
- **9143**: Visit whose Mog Garden? [No one's./%1's./%2's./%3's./%4's./%5's./%6's./%7's./%8's./%9's./%10's./%11's./%12's./%13's./%14's./%15's./%16's./%17's.]
- **9144**: You decided you have better things to do.
- **9145**: Commencing transportation to the selected individual's Mog Garden.
...
```
  ...
  6: 0x0022 [0x24] CREATE_DIALOG(message_id=9143*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
  ...
  9: 0x0032 [0x1D] PRINT_EVENT_MESSAGE(message_id=9144*)
 ...
 14: 0x003F [0x1D] PRINT_EVENT_MESSAGE(message_id=9145*)
