...
- **7530**: What number would you like?
- **7578**: What will you have issued? [#./Quit.]
...
```
  ...
  1: 0x0007 [0x24] CREATE_DIALOG(message_id=7578*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0022:
  9: 0x0022 [0x1D] PRINT_EVENT_MESSAGE(message_id=7530*)
