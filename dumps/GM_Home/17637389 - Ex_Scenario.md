...
- **7133**: Zilarrrt! [Never mind.../Start up the airship to Kazham!/I've been t'Norg, mommy!/I've met Gilgamesh, daddy!/I got the key from that cat-woman!/I m'et Gravi'ton!/I've gathered all the fragments!/I beat that Altepa Boss, I did!/I met with those dawnmaidens!!/Tu'Lia is ready to go!]
- **7143**: Zilarrrt! [So what.../\`the end of the Delkfutt battle./\`the Stellar Nexus battle!/\`LIMBO!]
- **7144**: Zilarrrt! [Whatever.../Heard abot Ro'Maeve./Saw that door in the Hall of the Gods./Talked to that Mithra./Got the Hall Key./Spoke to the gatekeeper./Tu'Lia!/Crystal Warriors eliminated./To Ru'Avitau!/Celestial Nexus./Awakening.]
- **7160**: How low can you go? [No limbo for me./Dynamis Event./DEBUG ON!/DEBUG OFF!]
- **7165**: Dynamis Event Menu! [I'm not hungry./Start me from the top./4 nations conquered!/Beaucedine busted!/New Dynamis defeated!]
...
```
  0: 0x0001 [0x24] CREATE_DIALOG(message_id=7143*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0045:
 16: 0x0045 [0x24] CREATE_DIALOG(message_id=7133*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00EE:
 49: 0x00EE [0x24] CREATE_DIALOG(message_id=7144*, default_option=0*, option_flags=0*)
...
SUBROUTINE_01A7:
 85: 0x01A7 [0x24] CREATE_DIALOG(message_id=7160*, default_option=0*, option_flags=0*)
 ...
 91: 0x01C7 [0x24] CREATE_DIALOG(message_id=7165*, default_option=0*, option_flags=0*)
