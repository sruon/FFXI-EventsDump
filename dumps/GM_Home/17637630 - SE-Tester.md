...
- **9233**: Type select [BSE/ESE/PlayCount/None.]
- **9234**: $0SEFNo.$0
- **9235**: $0eventSEFNo.$0
- **9236**: Select number to play. [12./13./14./15./16./17./18./19."0./?./??./Back.]
- **9237**: $1:$0 $0
...
```
  0: 0x0001 [0x24] CREATE_DIALOG(message_id=9233*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0040:
 ...
 18: 0x0060 [0x1D] PRINT_EVENT_MESSAGE(message_id=9234*)
    → "$0SEFNo.$0"
 19: 0x0063 [0x23] WAIT_FOR_DIALOG_INTERACTION
 20: 0x0064 [0x01] GOTO 0x006B
 21: 0x0067 [0x1D] PRINT_EVENT_MESSAGE(message_id=9235*)
    → "$0eventSEFNo.$0"
...
SUBROUTINE_0079:
 ...
 30: 0x0081 [0x24] CREATE_DIALOG(message_id=9236*, default_option=ExtData[1]->WorkLocal[3], option_flags=0*)
