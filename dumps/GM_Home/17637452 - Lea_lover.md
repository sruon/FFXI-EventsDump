...
- **9033**: I'm a collector of rare items. Have anything for me?
- **9034**: Splendid!
...
```
  ...
  2: 0x0009 [0x1D] PRINT_EVENT_MESSAGE(message_id=9033*)
...
```
  ...
  3: 0x0018 [0x1D] PRINT_EVENT_MESSAGE(message_id=9034*)
    → "Splendid!"
