...
0030: 80 47 00 D5 03 80 F0 FF  FF 7F F0 FF FF 7F 6D 61  .G............ma
...
```
  ...
  5: 0x0033 [0xD5] LOAD_EVENT_SCHEDULER_ALT8: Load scheduler "ma" with entities [LocalPlayer, LocalPlayer], work=ExtData[1]->WorkLocal[1]
