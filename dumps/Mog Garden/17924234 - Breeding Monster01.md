...
- **8704**: What will you do? [Nothing./See how the critter's doing./Interact with the beast./Give the creature a name./Collect items.]
- **8707**: %0's practically bursting with joy!
- **8708**: %0's in an obviously good mood.
- **8709**: %0 looks calm and collected.
- **8710**: %0 seems to be pouting slightly.
- **8711**: %0 looks like it wants absolutely nothing to do with anyone.
- **8712**: [However,/However,/Moreover,/Moreover,/Moreover,] it couldn't be more content with its life.
- **8713**: [However,/However,/Moreover,/Moreover,/Moreover,] it seems to be duly satisfied with its lot in life.
- **8714**: [Moreover,/Moreover,/However,/However,/However,] it exudes a slight aura of discontent.
- **8715**: [Moreover,/Moreover,/However,/However,/However,] it is clearly unhappy with the way things are.
- **8716**: [Moreover,/Moreover,/However,/However,/However,] it seems thoroughly depressed about the abysmal conditions under which it lives.
- **8718**: Current growth level: [EEE/$25EE/$26EE/$26$25E/$26$26E/$26$26$25/$26$26$26/$26$26$26].
- **8719**: How will you interact? [Do nothing./Pet it./Poke it./Slap it./Yell loudly at it./Get angry at it.]
- **8720**: %0 stares off into the distance as if you're not even there.
- **8721**: %0 is visibly angry with what you just did.
- **8722**: That didn't go over too well with %0.
- **8723**: That was surprisingly not worthless in the eyes of %0!
- **8724**: That strongly resonated with %0!
- **8725**: Please bestow a name of 15 letters or fewer upon your creature. Taking no action will annul the process.
- **8726**: Is %0 fine? [Yes./No, I'll pick a new one./No, I quit.]
- **8729**: Try to collect items from your beloved beastie?
- **8730**: Proceed? [Yes, that sounds wonderful./No, I won't take any chances.]
- **8732**: %0's heart is shrouded in darkness, turning the creature against you! Leaving %0 in this state could spell doom for your garden.
- **8733**: Whatever will you do!? [Not a thing./Hope moogle magic does the trick./Put the creature down.]
- **8734**: This entails having the Green Thumb Moogle employ the power of shining stars to cast an incantation on the creature, thus calming it.
- **8735**: Use moogle magic? (On hand: $26 x $0) [Yes.i$26 x $1)/No.]
- **8737**: The darkness no longer dwells within %0's heart.
- **8739**: %0's face beams with the light of pure contentment! There is nothing that can foul %0's mood right now, including gathering items from it.
- **8740**: You gave %0 $1.
- **8741**: Perhaps it would be best to give %0 $1.
- **8745**: %0 squirms uncontrollably.
- **8746**: %0 shudders violently.
...
# Dead code (unreachable instructions):
     ...
     0x0306 [0x2B] Green Thumb Moogle (ID: 17924125/0x0111801D) [8731*]:
    ...
    → "%0's heart is shrouded in darkness, turning the creature against you! Leaving %0 in this state could spell doom for your garden."
     ...
     0x040B [0x24] CREATE_DIALOG(message_id=8733*, default_option=0*, option_flags=0*)
    ...
    → "This entails having the Green Thumb Moogle employ the power of shining stars to cast an incantation on the creature, thus calming it."
     ...
     0x04B1 [0x24] CREATE_DIALOG(message_id=8735*, default_option=1*, option_flags=0*)
    → "Use moogle magic? (On hand: $26 x $0) [Yes.i$26 x $1)/No.]"
     ...
     0x0514 [0x2B] Green Thumb Moogle (ID: 17924125/0x0111801D) [8736*]:
    ...
    → "The darkness no longer dwells within %0's heart."
     ...
     0x05E8 [0x2B] Green Thumb Moogle (ID: 17924125/0x0111801D) [7459*]:
    ...
    → "By putting %0 down, you will personally end its life. While there will be no physical repercussion for doing such, are you willing to have that on your conscience?"
     ...
     0x060D [0x24] CREATE_DIALOG(message_id=8680*, default_option=1*, option_flags=0*)
    → "Put the creature down? [Yes, I have no reservations./No, not yet!]"
     ...
     0x0694 [0x2B] Chacharoon (ID: 17924187/0x0111805B) [8681*]:
    ...
    → "%0's face beams with the light of pure contentment! There is nothing that can foul %0's mood right now, including gathering items from it."
     ...
     0x080D [0x24] CREATE_DIALOG(message_id=8704*, default_option=0*, option_flags=ExtData[1]->WorkLocal[17])
    ...
    → "Current growth level: [EEE/$25EE/$26EE/$26$25E/$26$26E/$26$26$25/$26$26$26/$26$26$26]."
     ...
     0x09EF [0x24] CREATE_DIALOG(message_id=8719*, default_option=0*, option_flags=0*)
    ...
    → "%0 stares off into the distance as if you're not even there."
     ...
     0x0B1C [0x48] [System] [8729*]:
    → "Try to collect items from your beloved beastie?"
     0x0B1F [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0B20 [0x24] CREATE_DIALOG(message_id=8730*, default_option=0*, option_flags=0*)
    ...
    → "Please bestow a name of 15 letters or fewer upon your creature. Taking no action will annul the process."
     ...
     0x0C1A [0x24] CREATE_DIALOG(message_id=8726*, default_option=0*, option_flags=0*)
    → "Is %0 fine? [Yes./No, I'll pick a new one./No, I quit.]"
     ...
     0x0C52 [0x2B] Chacharoon (ID: 17924231/0x01118087) [8728*]:
    → "Oooh, %0 is name of much preeetty! Is sign that many times of good be coming."
     ...
     0x0C60 [0x2B] Chacharoon (ID: 17924231/0x01118087) [8727*]:
    → "Hmmm... This name too haaard for Chacharoon. Sorry, but giving new name is best."
     ...
     0x0C71 [0x2B] Chacharoon (ID: 17924231/0x01118087) [8727*]:
    → "Hmmm... This name too haaard for Chacharoon. Sorry, but giving new name is best."
...
```
 ...
 14: 0x0E87 [0x1D] PRINT_EVENT_MESSAGE(message_id=7605*)
