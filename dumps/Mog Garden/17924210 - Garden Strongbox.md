...
- **7522**: A repository rests before you, likely containing $0 gil.
- **7523**: What shall you do? [Check its contents./Deposit gil./Withdraw gil./Nothing.]
- **7524**: You peer through the opening to see how high your treasures are piled.
- **7525**: It turns out that you have $0 gil stored safely inside.
- **7526**: You can deposit $1 more gil until the repository can hold no more.
- **7529**: How much gil will you deposit?
- **7530**: Truly deposit $2 gil? [Yes./No.]
- **7531**: The satisfying clink of money finding a snug nook within its safehouse soothes your soul.
- **7532**: You cannot add any more gil!
- **7533**: You cannot hold any more gil!
- **7534**: How much gil will you withdraw?
- **7535**: Truly withdraw $2 gil? [Yes./No.]
- **7536**: Not a single gil rests inside the repository anymore.
...
```
  ...
  2: 0x0017 [0x24] CREATE_DIALOG(message_id=7530*, default_option=0*, option_flags=0*)
...
```
  ...
  5: 0x00AB [0x24] CREATE_DIALOG(message_id=7523*, default_option=0*, option_flags=0*)
 ...
 25: 0x00FA [0x24] CREATE_DIALOG(message_id=7530*, default_option=0*, option_flags=0*)
    → "Truly deposit $2 gil? [Yes./No.]"
...
SUBROUTINE_017B:
 ...
 62: 0x019F [0x24] CREATE_DIALOG(message_id=7535*, default_option=0*, option_flags=0*)
