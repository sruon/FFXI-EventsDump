...
\u0007\u007F1\u0000\u0007"
    ...
    → "Is that \u0001\u0001\u0001 \u0001\u0005$\u0002\u0003\u0000\u0000 I see, kupo?\u007F1\u0000\u0007"
     ...
     0x011A [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x0A, bit_index_work_offset=0x8003, condition_work_offset=0x8001)
     0x0121 [0x24] CREATE_DIALOG(message_id=8579*, default_option=0*, option_flags=0x0A)
...
\u0013 gil.\u007F1\u0000\u0007"
    ...
    → "And that's all there is to it.\u0007This humble moogle can hardly wait to serve you!\u007F1\u0000\u0007"
     ...
     0x0244 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x0A, bit_index_work_offset=0x8003, condition_work_offset=0x8001)
     0x024B [0x03] ExtData[1]->WorkLocal[3] = 16*
     0x0250 [0x01] GOTO 0x0262
     0x0253 [0x02] IF !(Work_Zone_1700[8] == Work_Zone_1700[9]) GOTO 0x0262
     0x025B [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x0A, bit_index_work_offset=0x802A, condition_work_offset=0x8001)
     ...
     0x029C [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x0A, bit_index_work_offset=0x00, condition_work_offset=0x8001)
...
\u0012).\u0007\u000BCheck storable items.\u0007Deal.\u0007No deal.\u007F1\u0000\u0007"
     ...
     0x0589 [0x3D] CLEAR_BIT_FLAG_CONDITIONAL(target_work_offset=0x0A, bit_index_work_offset=0x2D, condition_work_offset=0x8001)
