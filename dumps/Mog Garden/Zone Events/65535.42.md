...
```
  ...
  1: 0x02E5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=668*, entity1=EventEntity, entity2=EventEntity, scheduler_id="se02", work_offset2=0*)
  ...
  4: 0x030A [0x45] LOAD_SCHEDULED_TASK(work_offset1=668*, entity1=EventEntity, entity2=EventEntity, scheduler_id="sek2", work_offset2=0*)
  5: 0x031B [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "dead" for entities [EventEntity, EventEntity]
  6: 0x0328 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="dead")
  7: 0x0335 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "corp" for entities [EventEntity, EventEntity]
  8: 0x0342 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="corp")
