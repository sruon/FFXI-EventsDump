...
SUBROUTINE_0333:
 ...
 16: 0x0354 [0x1A] CALL_SUBROUTINE(address=0x4B54)
 ...
 25: 0x0373 [0x1A] CALL_SUBROUTINE(address=0x4B54)
 26: 0x0376 [0x2E] SET_CLI_EVENT_CANCEL_FLAGS()

SUBROUTINE_0377:
 27: 0x0377 [0x48] [System] [8804*]:
...
SUBROUTINE_03CF:
 ...
 42: 0x03D4 [0x24] CREATE_DIALOG(message_id=8805*, default_option=ExtData[1]->WorkLocal[5], option_flags=0*)
    → "Do which? (
...
SUBROUTINE_0423:
 57: 0x0423 [0x24] CREATE_DIALOG(message_id=8806*, default_option=ExtData[1]->WorkLocal[6], option_flags=0*)
...
SUBROUTINE_051A:
 ...
 89: 0x051F [0x9D] IF (0x622D) 0* = Work_Zone[4] // extra=0x8008
 90: 0x0529 [0x9D] IF (0x623D) 0* = Work_Zone[5] // extra=0x8008
...
SUBROUTINE_0547:
 95: 0x0547 [0x9D] IF (0x622D) 1* = Work_Zone[7] // extra=0x8008
 96: 0x0551 [0x9D] IF (0x623D) 1* = Work_Zone[8] // extra=0x8008
...
SUBROUTINE_056F:
101: 0x056F [0x9D] IF (0x622D) 2* = Work_Zone_1700[0] // extra=0x8008
102: 0x0579 [0x9D] IF (0x623D) 2* = Work_Zone_1700[1] // extra=0x8008
...
SUBROUTINE_0597:
107: 0x0597 [0x9D] IF (0x622D) 3* = Work_Zone_1700[3] // extra=0x8008
108: 0x05A1 [0x9D] IF (0x623D) 3* = Work_Zone_1700[4] // extra=0x8008
...
SUBROUTINE_05BF:
113: 0x05BF [0x9D] IF (0x622D) 4* = Work_Zone_1700[6] // extra=0x8008
114: 0x05C9 [0x9D] IF (0x623D) 4* = Work_Zone_1700[7] // extra=0x8008
...
143: 0x0679 [0x24] CREATE_DIALOG(message_id=8810*, default_option=1*, option_flags=0*)
    → "Reset rewards? (
' gil).\u0007\u000BYes (
& gil).\u0007No.\u007F1\u0000\u0007"
...
160: 0x06D5 [0x1A] CALL_SUBROUTINE(address=0x4B54)
...
204: 0x0828 [0x9D] IF (0x622D) ExtData[1]->WorkLocal[0] = Work_Zone[4] // extra=0x8008
205: 0x0832 [0x9D] IF (0x623D) ExtData[1]->WorkLocal[0] = Work_Zone[5] // extra=0x8008
...
SUBROUTINE_092B:
235: 0x092B [0x24] CREATE_DIALOG(message_id=8817*, default_option=ExtData[1]->WorkLocal[6], option_flags=0*)
...
SUBROUTINE_09D6:
265: 0x09D6 [0x24] CREATE_DIALOG(message_id=8819*, default_option=ExtData[1]->WorkLocal[6], option_flags=0*)
