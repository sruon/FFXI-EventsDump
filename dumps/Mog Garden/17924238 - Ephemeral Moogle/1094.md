...
# Dead code (unreachable instructions):
    ...
    → "What would you like?\u0007\u000BCrystals returned to me.\u0007A bit of an explanation.\u0007Nothing for now.\u007F1\u0000\u0007"
     ...
     0x0185 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x09, bit_index_work_offset=0x8020, condition_work_offset=0x8020)
     0x018C [0x03] Work_Zone[3] = ExtData[1]->WorkLocal[1]
     0x0191 [0x02] IF !(ExtData[1]->WorkLocal[1] > 0*) GOTO 0x01A0
     0x0199 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x09, bit_index_work_offset=0x8021, condition_work_offset=0x8020)
     0x01A0 [0x03] Work_Zone[4] = ExtData[1]->WorkLocal[2]
     0x01A5 [0x02] IF !(ExtData[1]->WorkLocal[2] > 0*) GOTO 0x01B4
     0x01AD [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x09, bit_index_work_offset=0x8022, condition_work_offset=0x8020)
     0x01B4 [0x03] Work_Zone[5] = ExtData[1]->WorkLocal[3]
     0x01B9 [0x02] IF !(ExtData[1]->WorkLocal[3] > 0*) GOTO 0x01C8
     0x01C1 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x09, bit_index_work_offset=0x8023, condition_work_offset=0x8020)
     0x01C8 [0x03] Work_Zone[6] = ExtData[1]->WorkLocal[4]
     0x01CD [0x02] IF !(ExtData[1]->WorkLocal[4] > 0*) GOTO 0x01DC
     0x01D5 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x09, bit_index_work_offset=0x8024, condition_work_offset=0x8020)
     0x01DC [0x03] Work_Zone[7] = ExtData[1]->WorkLocal[5]
     0x01E1 [0x02] IF !(ExtData[1]->WorkLocal[5] > 0*) GOTO 0x01F0
     0x01E9 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x09, bit_index_work_offset=0x8025, condition_work_offset=0x8020)
     0x01F0 [0x03] Work_Zone[8] = ExtData[1]->WorkLocal[6]
     0x01F5 [0x02] IF !(ExtData[1]->WorkLocal[6] > 0*) GOTO 0x0204
     0x01FD [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x09, bit_index_work_offset=0x8026, condition_work_offset=0x8020)
     0x0204 [0x03] Work_Zone[9] = ExtData[1]->WorkLocal[7]
     0x0209 [0x02] IF !(ExtData[1]->WorkLocal[7] > 0*) GOTO 0x0218
     0x0211 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x09, bit_index_work_offset=0x8027, condition_work_offset=0x8020)
     0x0218 [0x24] CREATE_DIALOG(message_id=8778*, default_option=0*, option_flags=0x09)
...
\u0004.\u0000\u0007"
     ...
     0x0843 [0x34] LOAD_UNLOAD_ZONE(zone_id=13952)
     ...
     0x087F [0x24] CREATE_DIALOG(message_id=0x00002500, default_option=0x2600, option_flags=0x2700)
