...
```
  ...
  6: 0x001E [0x48] [System] [7400*]:
    → "You have already baited the net with $1. Use $0 instead?"
  7: 0x0021 [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x0022 [0x24] CREATE_DIALOG(message_id=7401*, default_option=0*, option_flags=0*)
    → "Use $0? [Yes./No.]"
