...
- **8550**: Welcome to the MHMU's porter service, kupo! Which of your burdensome belongings shall I take off your hands today?
- **8551**: Do something, kupo? [Porter service?/Buy a storage slip./No, thank you.]
- **8552**: Is your gobbiebag splitting at the seams? Mog Safe spilling over? Why, an accomplished adventurer like yourself surely has more stuff than you know what to do with.
- **8553**: That's where I come in, kupo. I'll gladly hold onto your prized possessions, freeing you space to gather up even grander goodies.
- **8554**: To make use of my services, first you'll need to buy one of these storage slips for the low, low fee of $19 gil.
- **8555**: Storage slips come in numerous varieties, kupo, each corresponding to a different type of item.
- **8556**: You'll want to peruse the fine print closely, so you don't end up paying good gil for a scrap of parchment useless for the particular item you wish to store.
- **8557**: Not that we moogles would object to that sort of donation, kupo.
- **8558**: Choose the item you wish to entrust, then trade it to me along with a single storage slip. I will take the item and return the slip to you, marked with an invisible seal.
- **8559**: Invisible to you, at least. It's plain as day to us moogles, so don't even think of trying to pull one over on us, kupo.
- **8560**: When it comes time to retrieve your item, just trade to me a single storage slip--any slip--once again.
- **8561**: I will present you with a list of all the items currently in my care, and you may choose the one you wish to withdraw. Simple as that, kupo!
- **8562**: What's more, no additional transaction fees will be incurred! Pretty generous of us for a change, no?
- **8563**: Now I bet you're wondering what the catch is, kupo. So as not to disappoint you, there are a few!
- **8564**: For one, any signed items will lose their signatures if you store them with me.
- **8565**: Why, you say? Hey, even we moogles aren't perfect! It's better for both of us if you keep your most precious possessions close at hand, kupo.
- **8566**: Now listen up, because there's another catch, and it's a doozy.
- **8567**: If you lose your storage slip, I won't be able to return your item. Ever. No ifs, ands, or buts! No "I'm sorry, Mister Porter Moogle, it'll never happen again!" Rules are rules, kupo, and someone has to keep them.
- **8568**: Last, but not least, I can't accept equipment bearing Magian trial insignia.
- **8569**: If you have such an item that you're simply dying to entrust to me, you'll have to abandon your trial first, kupo.
- **8570**: And that's all there is to it. This humble moogle can hardly wait to serve you!
- **8572**: $32 will cost you $19 gil. Do we have a deal, kupo?
- **8573**: Deal, kupo? (Current gil: $18). [Check storable items./Deal./No deal.]
- **8580**: Is that $3 I see, kupo?
- **8581**: What will you do? [Retrieve an item./Confirm storable items./Nothing.]
- **8585**: Kupo? I'm already taking care of that item for you.
- **8586**: $0, yes? Very well! Your precious property is safe with me, kupo!
- **8587**: $0 [variety/varieties] of item, is it? Very well! Your precious property is safe with me, kupo!
- **8588**: Is that a Magian insignia I see on that $0? You'll have to abandon your trial before I can take it off your hands, kupo.
- **8590**: Curious as to whether I can accept that item? Let me check my annals.
- **8591**: Why, yes I can! % can be stored with $1.
- **8592**: Why, it looks as if you have $1 located in your [inventory/Mog Safe/Mog Safe 2/Mog House storage/Mog Locker/Mog Satchel/Mog Sack/Mog Case/Mog Wardrobe/Mog Wardrobe 2/Mog Wardrobe 3/Mog Wardrobe 4/Mog Wardrobe 5/Mog Wardrobe 6/Mog Wardrobe 7/Mog Wardrobe 8/Recycle Bin]!
- **8595**: 0: $0 1: $1 2: $2 3: $3
- **8596**: 4: $4 5: $5 6: $6 7: $7
...
SUBROUTINE_0170:
  ...
  4: 0x0175 [0x1D] PRINT_EVENT_MESSAGE(message_id=8590*)
...
# Dead code (unreachable instructions):
     ...
     0x0039 [0x1D] PRINT_EVENT_MESSAGE(message_id=8550*)
    → "Welcome to the MHMU's porter service, kupo! Which of your burdensome belongings shall I take off your hands today?"
     ...
     0x0048 [0x24] CREATE_DIALOG(message_id=8551*, default_option=0*, option_flags=0*)
    → "Do something, kupo? [Porter service?/Buy a storage slip./No, thank you.]"
     ...
     0x0091 [0x1D] PRINT_EVENT_MESSAGE(message_id=8587*)
    → "$0 [variety/varieties] of item, is it? Very well! Your precious property is safe with me, kupo!"
     ...
     0x0098 [0x1D] PRINT_EVENT_MESSAGE(message_id=8586*)
    → "$0, yes? Very well! Your precious property is safe with me, kupo!"
     ...
     0x00E9 [0x48] [System] [8595*]:
    → "0: $0 1: $1 2: $2 3: $3"
     0x00EC [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x00ED [0x48] [System] [8596*]:
    → "4: $4 5: $5 6: $6 7: $7"
     ...
     0x00FB [0x1D] PRINT_EVENT_MESSAGE(message_id=8580*)
    → "Is that $3 I see, kupo?"
     ...
     0x0121 [0x24] CREATE_DIALOG(message_id=8581*, default_option=0*, option_flags=ExtData[1]->WorkLocal[10])
    → "What will you do? [Retrieve an item./Confirm storable items./Nothing.]"
     ...
     0x0161 [0x1D] PRINT_EVENT_MESSAGE(message_id=8585*)
    → "Kupo? I'm already taking care of that item for you."
     ...
     0x016B [0x1D] PRINT_EVENT_MESSAGE(message_id=8588*)
    → "Is that a Magian insignia I see on that $0? You'll have to abandon your trial before I can take it off your hands, kupo."
     ...
     0x016F [0x1B] RETURN
# Dead code (unreachable instructions):
     0x018D [0x1D] PRINT_EVENT_MESSAGE(message_id=8552*)
    → "Is your gobbiebag splitting at the seams? Mog Safe spilling over? Why, an accomplished adventurer like yourself surely has more stuff than you know what to do with."
     ...
     0x0191 [0x1D] PRINT_EVENT_MESSAGE(message_id=8553*)
    → "That's where I come in, kupo. I'll gladly hold onto your prized possessions, freeing you space to gather up even grander goodies."
     ...
     0x019F [0x1D] PRINT_EVENT_MESSAGE(message_id=8554*)
    → "To make use of my services, first you'll need to buy one of these storage slips for the low, low fee of $19 gil."
     ...
     0x01B0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8555*)
    → "Storage slips come in numerous varieties, kupo, each corresponding to a different type of item."
     ...
     0x01C1 [0x1D] PRINT_EVENT_MESSAGE(message_id=8556*)
    ...
    → "Choose the item you wish to entrust, then trade it to me along with a single storage slip. I will take the item and return the slip to you, marked with an invisible seal."
     ...
     0x01D0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8559*)
    → "Invisible to you, at least. It's plain as day to us moogles, so don't even think of trying to pull one over on us, kupo."
     ...
     0x01D4 [0x1D] PRINT_EVENT_MESSAGE(message_id=8560*)
    → "When it comes time to retrieve your item, just trade to me a single storage slip--any slip--once again."
     ...
     0x01D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=8561*)
    → "I will present you with a list of all the items currently in my care, and you may choose the one you wish to withdraw. Simple as that, kupo!"
     ...
     0x01DC [0x1D] PRINT_EVENT_MESSAGE(message_id=8562*)
    → "What's more, no additional transaction fees will be incurred! Pretty generous of us for a change, no?"
     ...
     0x01E0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8563*)
    ...
    → "If you have such an item that you're simply dying to entrust to me, you'll have to abandon your trial first, kupo."
     ...
     0x01FC [0x1D] PRINT_EVENT_MESSAGE(message_id=8570*)
    → "And that's all there is to it. This humble moogle can hardly wait to serve you!"
     ...
     0x033D [0x1D] PRINT_EVENT_MESSAGE(message_id=8572*)
    → "$32 will cost you $19 gil. Do we have a deal, kupo?"
     ...
     0x0344 [0x24] CREATE_DIALOG(message_id=8573*, default_option=0*, option_flags=0*)
    → "Deal, kupo? (Current gil: $18). [Check storable items./Deal./No deal.]"
     ...
     0x0636 [0x48] [System] [8595*]:
    → "0: $0 1: $1 2: $2 3: $3"
     0x0639 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x063A [0x48] [System] [8596*]:
    → "4: $4 5: $5 6: $6 7: $7"
