...
- **7394**: The net that sits in the middle of this pond is rank $0.
- **7395**: Raise the net? [Yes./No.]
- **7398**: You have already baited the net with $1. Use $0 instead?
- **7399**: Use $0? [Yes./No.]
- **7400**: You baited the net with $0.
- **7401**: You cannot use that here.
- **7404**: $1 is being used as bait.
...
```
  ...
  4: 0x006D [0x48] [System] [7404*]:
    → "$1 is being used as bait."
  5: 0x0070 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0071 [0x24] CREATE_DIALOG(message_id=7395*, default_option=0*, option_flags=0*)
