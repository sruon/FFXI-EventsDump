...
- **7393**: The net that sits in the middle of this pond is rank $0.
- **7394**: Raise the net? [Yes./No.]
- **7397**: You have already baited the net with $1. Use $0 instead?
- **7398**: Use $0? [Yes./No.]
- **7399**: You baited the net with $0.
- **7400**: You cannot use that here.
- **7403**: $1 is being used as bait.
...
```
  ...
  4: 0x006D [0x48] [System] [7403*]:
    → "$1 is being used as bait."
  5: 0x0070 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0071 [0x24] CREATE_DIALOG(message_id=7394*, default_option=0*, option_flags=0*)
