...
- **7396**: The net that sits in the middle of this pond is rank $0.
- **7397**: Raise the net? [Yes./No.]
- **7400**: You have already baited the net with $1. Use $0 instead?
- **7401**: Use $0? [Yes./No.]
- **7402**: You baited the net with $0.
- **7403**: You cannot use that here.
- **7406**: $1 is being used as bait.
...
```
  ...
  4: 0x006D [0x48] [System] [7406*]:
    → "$1 is being used as bait."
  5: 0x0070 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0071 [0x24] CREATE_DIALOG(message_id=7397*, default_option=0*, option_flags=0*)
