...
|       1 | 0x0001      |           1 |
|       2 | 0x0080      |         128 |
|       3 | 0xFFFB0FDA  |  4294643674 |
|       4 | 0xFFFFCE21  |  4294954529 |
|       5 | 0x9150      |       37200 |
|       6 | 0x0C00      |        3072 |
|       7 | 0x000D      |          13 |
|       8 | 0xFFFB0F74  |  4294643572 |
|       9 | 0xFFFFE527  |  4294960423 |
|      10 | 0x8FC7      |       36807 |
...
```
  0: 0x0045 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-323.622*, z=-12.767*, y=37.200*, direction=270.0°*
...
```
  ...
  1: 0x0052 [0x1F] MOVE_ENTITY: EventEntity moves to X=-323.724*, Z=-6.873*, Y=36.807*
