...
- **8173**: Who goes there...?
- **8174**: Ah, so you are <Player>. Welcome.
- **8175**: The $3 you seek is indeed here. But I fear it will not be hatching now...nor ever.
- **8176**: <Player>. This $3 must be returned to its rightful home--the place where it was meant to begin its life. Will you do this for me?
- **8177**: Return the egg? [I shall./I shall not.]
- **8178**: ...
- **8179**: Excellent... Now go.
- **8180**: That $3 must be returned to its rightful home. The place where it was meant to begin life...
- **8181**: You have done well. Take this. I have need for it no more.
- **8182**: Now be off, and forget all that has transpired here. Shine your light upon the future, and let the past rest in darkness.
- **8183**: I...thank you...<Player>.
...
```
  0: 0x0001 [0x1D] PRINT_EVENT_MESSAGE(message_id=8178*)
    → "..."
...
```
  ...
  2: 0x000F [0x1D] PRINT_EVENT_MESSAGE(message_id=8173*)
    → "Who goes there...?"
  3: 0x0012 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0013 [0x1D] PRINT_EVENT_MESSAGE(message_id=8174*)
    → "Ah, so you are <Player>. Welcome."
  5: 0x0016 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0017 [0x03] Work_Zone[2] = 1762*
  7: 0x001C [0x1D] PRINT_EVENT_MESSAGE(message_id=8175*)
 ...
 10: 0x0025 [0x1D] PRINT_EVENT_MESSAGE(message_id=8176*)
 ...
 12: 0x0029 [0x24] CREATE_DIALOG(message_id=8177*, default_option=0*, option_flags=0*)
    → "Return the egg? [I shall./I shall not.]"
 13: 0x0030 [0x25] WAIT_DIALOG_SELECT()
 14: 0x0031 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0045
 15: 0x0039 [0x1D] PRINT_EVENT_MESSAGE(message_id=8179*)
    → "Excellent... Now go."
 ...
 20: 0x004D [0x1D] PRINT_EVENT_MESSAGE(message_id=8178*)
    → "..."
...
```
  ...
  1: 0x0060 [0x1D] PRINT_EVENT_MESSAGE(message_id=8180*)
...
```
  ...
  3: 0x0071 [0x1D] PRINT_EVENT_MESSAGE(message_id=8181*)
    → "You have done well. Take this. I have need for it no more."
  4: 0x0074 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0075 [0x1D] PRINT_EVENT_MESSAGE(message_id=8182*)
  ...
  7: 0x0079 [0x1D] PRINT_EVENT_MESSAGE(message_id=8183*)
    → "I...thank you...<Player>."
