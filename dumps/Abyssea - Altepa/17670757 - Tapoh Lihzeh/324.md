...
```
  ...
  2: 0x0009 [0x1D] PRINT_EVENT_MESSAGE(message_id=8094*)
    → "Before the cataclysm, I was just a humble apothecary--now I'm serrrvin' on the front lines, fightin' for my life.\u0007I should be proud of myself, but deep down, it just doesn't feel right...\u007F1\u0000\u0007"
