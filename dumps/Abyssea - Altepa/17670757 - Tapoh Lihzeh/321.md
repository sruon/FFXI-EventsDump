...
```
  ...
  7: 0x0029 [0x1D] PRINT_EVENT_MESSAGE(message_id=8087*)
    → "My report? Why, yes, it should be rrright--\u0007Well, that's strange. It seems a fiend has devoured it. I suppose you'll just have to pass along my findings for me.\u007F1\u0000\u0007"
 ...
 10: 0x0032 [0x1D] PRINT_EVENT_MESSAGE(message_id=8088*)
    → "I spoke with a recuperating soldier who was complaining of terrrible \u000C\u0000[chest pains/dizziness/headaches/ringing in the ears].\u007F1\u0000\u0007"
...
SUBROUTINE_004A:
 ...
 18: 0x0052 [0x1D] PRINT_EVENT_MESSAGE(message_id=8091*)
    → "He fought back as best he could, but \u000C\u0000[was disarrrmed by a swipe of the fiend's jagged horns/his blade bounced harrrmlessly off the fiend's round shell/the fiend danced clear out of rrrange on its four bony legs/his blade shattered in pieces against the fiend's flat, sturrrdy jaw].\u007F1\u0000\u0007"
...
SUBROUTINE_0059:
 ...
 22: 0x0061 [0x1D] PRINT_EVENT_MESSAGE(message_id=8089*)
    → "It would seem that the fiend \u000C\u0000[swooped down from the sky to attack him/ambushed him when he was resting his legs at an oasis/jumped out from behind a shadowy rock when he was on patrol/burst forth from an odd hollow in the ground].\u007F1\u0000\u0007"
 23: 0x0064 [0x23] WAIT_FOR_DIALOG_INTERACTION
 24: 0x0065 [0x01] GOTO 0x0068

SUBROUTINE_0068:
 25: 0x0068 [0x1D] PRINT_EVENT_MESSAGE(message_id=8092*)
    → "That's all I've got for ya.\u0007Need to hear it again?\u007F1\u0000\u0007"
...
SUBROUTINE_008D:
 33: 0x008D [0x1D] PRINT_EVENT_MESSAGE(message_id=8093*)
    → "Wonderful! You're a rrreal lifesaver.\u0007Tell Chumimi not to work too hard, 'kay?\u007F1\u0000\u0007"
