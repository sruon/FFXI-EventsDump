...
SUBROUTINE_004B:
 ...
 12: 0x0053 [0x24] CREATE_DIALOG(message_id=7921*, default_option=0*, option_flags=ExtData[1]->WorkLocal[2])
...
SUBROUTINE_009E:
 ...
 33: 0x00B0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7922*)
 ...
 42: 0x00CC [0x1D] PRINT_EVENT_MESSAGE(message_id=7925*)
...
SUBROUTINE_00E8:
 ...
 52: 0x00F8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7926*)
 ...
 57: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7927*)
 ...
 60: 0x0115 [0x24] CREATE_DIALOG(message_id=7924*, default_option=0*, option_flags=0*)
    → "Take along the \u0001\u00053\u0002\u0000\u0000\u0000?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
 61: 0x011C [0x25] WAIT_DIALOG_SELECT()
 62: 0x011D [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0132
 63: 0x0125 [0x42] SET_CLI_EVENT_CANCEL_DATA()
 64: 0x0126 [0x1D] PRINT_EVENT_MESSAGE(message_id=7925*)
    → "We would be particularly indebted to you for efficient replenishment of martellos in remote locations.\u0007Best of luck in your efforts!\u007F1\u0000\u0007"
...
SUBROUTINE_0146:
 ...
 76: 0x0158 [0x1D] PRINT_EVENT_MESSAGE(message_id=7929*)
 ...
 78: 0x015C [0x1D] PRINT_EVENT_MESSAGE(message_id=7930*)
 ...
 80: 0x0160 [0x48] [System] [7951*]:
    → "\u001FyWarning:\u0007Changing areas, logging out, or becoming disconnected will cause all data pertinent to this quest to be reset.\u0000\u0007"
 81: 0x0163 [0x24] CREATE_DIALOG(message_id=7924*, default_option=0*, option_flags=0*)
    → "Take along the \u0001\u00053\u0002\u0000\u0000\u0000?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
 82: 0x016A [0x25] WAIT_DIALOG_SELECT()
 83: 0x016B [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0180
 84: 0x0173 [0x42] SET_CLI_EVENT_CANCEL_DATA()
 85: 0x0174 [0x1D] PRINT_EVENT_MESSAGE(message_id=7925*)
    → "We would be particularly indebted to you for efficient replenishment of martellos in remote locations.\u0007Best of luck in your efforts!\u007F1\u0000\u0007"
...
SUBROUTINE_0190:
 ...
 95: 0x01A0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7932*)
...
101: 0x01B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7933*)
...
104: 0x01C2 [0x24] CREATE_DIALOG(message_id=7924*, default_option=0*, option_flags=0*)
    → "Take along the \u0001\u00053\u0002\u0000\u0000\u0000?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
105: 0x01C9 [0x25] WAIT_DIALOG_SELECT()
106: 0x01CA [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x01DF
107: 0x01D2 [0x42] SET_CLI_EVENT_CANCEL_DATA()
108: 0x01D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7925*)
    → "We would be particularly indebted to you for efficient replenishment of martellos in remote locations.\u0007Best of luck in your efforts!\u007F1\u0000\u0007"
...
119: 0x01FE [0x1D] PRINT_EVENT_MESSAGE(message_id=7937*)
...
121: 0x0202 [0x24] CREATE_DIALOG(message_id=7938*, default_option=0*, option_flags=0*)
...
124: 0x0212 [0x1D] PRINT_EVENT_MESSAGE(message_id=7939*)
...
126: 0x0216 [0x1D] PRINT_EVENT_MESSAGE(message_id=7940*)
...
131: 0x022A [0x1D] PRINT_EVENT_MESSAGE(message_id=7941*)
...
133: 0x022E [0x1D] PRINT_EVENT_MESSAGE(message_id=7942*)
...
135: 0x0232 [0x1D] PRINT_EVENT_MESSAGE(message_id=7943*)
...
137: 0x0236 [0x1D] PRINT_EVENT_MESSAGE(message_id=7944*)
...
143: 0x024F [0x1D] PRINT_EVENT_MESSAGE(message_id=7945*)
...
145: 0x0253 [0x1D] PRINT_EVENT_MESSAGE(message_id=7946*)
...
147: 0x0257 [0x1D] PRINT_EVENT_MESSAGE(message_id=7947*)
...
153: 0x0270 [0x1D] PRINT_EVENT_MESSAGE(message_id=7948*)
...
155: 0x0274 [0x1D] PRINT_EVENT_MESSAGE(message_id=7949*)
...
157: 0x0278 [0x1D] PRINT_EVENT_MESSAGE(message_id=7950*)
