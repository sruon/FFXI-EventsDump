...
- **8256**: Current progress: [Ancient abyssite obtained: $0/$1/Atma obtained: $2/$3/Quests completed: $4/$5/Return.]
- **8257**: [Requirement/Objective completed]: Obtain all ancient abyssite found in this area.
- **8258**: [Requirement/Objective completed]: Obtain all atma found in this area.
- **8259**: [Requirement/Objective completed]: Complete all quests issued in this area.
- **8282**: I have taken up the task of putting to parchment the deeds of those who have done battle in these parts. This is what I have recorded under your name.
- **8283**: It would seem you've accomplished this task.
- **8284**: Why, I can hardly believe my eyes. You have accomplished anything and everything that could have been expected of you!
- **8285**: You deserve far more than this humble reward, but I fear it is all I have to give. I pray you are not offended.
- **8286**: Our battle for survival is never-ending. Pray do not let down your guard.
...
# Dead code (unreachable instructions):
     ...
     0x0035 [0x24] CREATE_DIALOG(message_id=8256*, default_option=0*, option_flags=0*)
...
```
  ...
  3: 0x00D0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8282*)
  ...
  6: 0x00D7 [0x1D] PRINT_EVENT_MESSAGE(message_id=8286*)
...
```
  ...
  6: 0x00EC [0x1D] PRINT_EVENT_MESSAGE(message_id=8282*)
    → "I have taken up the task of putting to parchment the deeds of those who have done battle in these parts. This is what I have recorded under your name."
  7: 0x00EF [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x00F0 [0x02] IF !(ExtData[1]->WorkLocal[7] == 1*) GOTO 0x00FF
  9: 0x00F8 [0x1D] PRINT_EVENT_MESSAGE(message_id=8283*)
 ...
 13: 0x0107 [0x1D] PRINT_EVENT_MESSAGE(message_id=8284*)
...
SUBROUTINE_010E:
 16: 0x010E [0x1D] PRINT_EVENT_MESSAGE(message_id=8285*)
 ...
 18: 0x0112 [0x1D] PRINT_EVENT_MESSAGE(message_id=8286*)
    → "Our battle for survival is never-ending. Pray do not let down your guard."
