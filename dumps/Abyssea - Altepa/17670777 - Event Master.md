...
- **8355**: Select your progress. [Set fame. (Current: $0)/Quest #1./Quest #2./Quest #3./Quest #4./Quest #5./Quest #6./Quest #7./Quest #8./Quest #9./Quest #10./Cancel.]
- **8356**: Set status for Quest #1: [Haven't started it./Cleared it!/Cancel.]
- **8357**: Set status for Quest #2: [Haven't started it./Cleared it!/Cancel.]
- **8358**: Set status for Quest #3: [Haven't started it./Get item./Cleared it!/Disable time flag./Cancel.]
- **8359**: Set status for Quest #4: [Haven't started it./Cleared it!/Cancel.]
- **8360**: Set status for Quest #5: [Haven't started it./Cleared it!/Cancel.]
- **8361**: Set status for Quest #6: [Haven't started it./Get key item./Cleared it!/Cancel.]
- **8362**: Set status for Quest #7: [Haven't started it./Cleared it!/Cancel.]
- **8363**: Set status for Quest #8: [Haven't started it./Viewed event at Meriphataud./Cleared it!/Cancel.]
- **8364**: Set status for Quest #9: [Haven't started it./Get key item./Cleared it!/Cancel.]
- **8365**: Set status for Quest #10: [Haven't started it./Cleared it!/Cancel.]
...
```
  ...
  1: 0x0006 [0x24] CREATE_DIALOG(message_id=8355*, default_option=0*, option_flags=0*)
 ...
 10: 0x0037 [0x24] CREATE_DIALOG(message_id=8356*, default_option=0*, option_flags=0*)
...
SUBROUTINE_004A:
 ...
 18: 0x0063 [0x24] CREATE_DIALOG(message_id=8357*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0076:
 ...
 26: 0x008F [0x24] CREATE_DIALOG(message_id=8358*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00A2:
 ...
 34: 0x00BB [0x24] CREATE_DIALOG(message_id=8359*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00CE:
 ...
 42: 0x00E7 [0x24] CREATE_DIALOG(message_id=8360*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00FA:
 ...
 50: 0x0113 [0x24] CREATE_DIALOG(message_id=8361*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0126:
 ...
 58: 0x013F [0x24] CREATE_DIALOG(message_id=8362*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0152:
 ...
 66: 0x016B [0x24] CREATE_DIALOG(message_id=8363*, default_option=0*, option_flags=0*)
...
SUBROUTINE_017E:
 ...
 74: 0x0197 [0x24] CREATE_DIALOG(message_id=8364*, default_option=0*, option_flags=0*)
...
SUBROUTINE_01AA:
 ...
 82: 0x01C3 [0x24] CREATE_DIALOG(message_id=8365*, default_option=0*, option_flags=0*)
