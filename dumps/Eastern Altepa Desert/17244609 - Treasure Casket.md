...
- **7776**: Which item will you obtain? [None of them./$0./$1./$2./$3./$4./$5./$6./$7.]
- **7777**: Which temporary item will you obtain? [None of them./$0./$1./$2./$3./$4./$5./$6./$7.]
- **7778**: Obtain this item? [Yes./No.]
- **7779**: Obtain this temporary item? [Yes./No.]
- **7784**: The chest is locked.
- **7785**: What will you do? [Leave it be./Attempt to unlock it.]
- **7786**: What will you do? ($0 chances remaining.) [Give up./Enter a combination./Examine the lock.]
- **7787**: It appears that you can enter a two-digit combination between 10 and 99.
- **7802**: Obtain this item?
...
```
 ...
 40: 0x00ED [0x24] CREATE_DIALOG(message_id=7776*, default_option=0*, option_flags=ExtData[1]->WorkLocal[8])
...
SUBROUTINE_01B2:
 ...
 81: 0x01C5 [0x48] [System] [7802*]:
    → "Obtain this item?"
 82: 0x01C8 [0x23] WAIT_FOR_DIALOG_INTERACTION
 83: 0x01C9 [0x93] DISPLAY_ITEM_INFO(item_id=0*)
 84: 0x01CC [0x24] CREATE_DIALOG(message_id=7778*, default_option=1*, option_flags=0*)
...
```
 ...
 40: 0x02F6 [0x24] CREATE_DIALOG(message_id=7777*, default_option=0*, option_flags=ExtData[1]->WorkLocal[8])
...
SUBROUTINE_03BB:
 ...
 81: 0x03CE [0x48] [System] [7802*]:
    → "Obtain this item?"
 82: 0x03D1 [0x23] WAIT_FOR_DIALOG_INTERACTION
 83: 0x03D2 [0x93] DISPLAY_ITEM_INFO(item_id=0*)
 84: 0x03D5 [0x24] CREATE_DIALOG(message_id=7779*, default_option=1*, option_flags=0*)
...
```
  ...
  6: 0x042B [0x48] [System] [7784*]:
    → "The chest is locked."
  7: 0x042E [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x042F [0x24] CREATE_DIALOG(message_id=7785*, default_option=0*, option_flags=0*)
 ...
 16: 0x0459 [0x24] CREATE_DIALOG(message_id=7786*, default_option=0*, option_flags=0*)
...
SUBROUTINE_058A:
 ...
 40: 0x059E [0x24] CREATE_DIALOG(message_id=7776*, default_option=0*, option_flags=ExtData[1]->WorkLocal[8])
    → "Which item will you obtain? [None of them./$0./$1./$2./$3./$4./$5./$6./$7.]"
...
SUBROUTINE_0623:
 ...
 72: 0x064B [0x24] CREATE_DIALOG(message_id=7778*, default_option=1*, option_flags=0*)
    → "Obtain this item? [Yes./No.]"
