...
- **7454**: Choose your path... [Leave Promyvion./Return to the spire entrance./Nothing.]
- **7455**: Return to the Beaucedine Glacier? [Yes./No.]
- **7456**: Return to the web of recollections? [Yes./No.]
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=7454*, default_option=0*, option_flags=0*)
  ...
  4: 0x0013 [0x24] CREATE_DIALOG(message_id=7455*, default_option=1*, option_flags=0*)
    → "Return to the Beaucedine Glacier? [Yes./No.]"
...
SUBROUTINE_0068:
 ...
 21: 0x0073 [0x24] CREATE_DIALOG(message_id=7456*, default_option=1*, option_flags=0*)
