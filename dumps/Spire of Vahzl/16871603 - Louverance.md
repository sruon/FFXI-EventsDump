...
```
  0: 0x0048 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-238.893*, z=37.279*, y=57.999*, direction=90.4°*
...
```
  ...
  1: 0x0055 [0x1F] MOVE_ENTITY: EventEntity moves to X=-238.893*, Z=26.279*, Y=57.999*
...
```
  0: 0x0070 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=2.531*, z=-350.955*, y=-119.250*, direction=110.5°*
