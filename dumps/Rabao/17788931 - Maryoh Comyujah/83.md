...
```
  ...
  7: 0x00A6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=233*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ze01", work_offset2=0*)
  8: 0x00B7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
 ...
 15: 0x00E0 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 20: 0x00F7 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="tlk2")
 21: 0x0106 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk2")
 22: 0x0113 [0x52] END_LOAD_SCHEDULER: End scheduler "ze01" with entities [LocalPlayer, LocalPlayer], work=233*
 23: 0x0122 [0x45] LOAD_SCHEDULED_TASK(work_offset1=233*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ze02", work_offset2=0*)
 24: 0x0133 [0x81] SET_ENTITY_BLINKING(blink_flag=0x00, entity=Maryoh Comyujah (ID: 17788931/0x010F7003))
 25: 0x0139 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 35: 0x015E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 36: 0x016D [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="thk2")
 37: 0x017A [0x52] END_LOAD_SCHEDULER: End scheduler "ze02" with entities [LocalPlayer, LocalPlayer], work=233*
 38: 0x0189 [0x45] LOAD_SCHEDULED_TASK(work_offset1=233*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ze03", work_offset2=0*)
 39: 0x019A [0x03] Work_Zone[2] = 452*
 40: 0x019F [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="pas0")
 ...
 43: 0x01B2 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="pas0")
 44: 0x01BF [0x52] END_LOAD_SCHEDULER: End scheduler "ze03" with entities [LocalPlayer, LocalPlayer], work=233*
 45: 0x01CE [0x45] LOAD_SCHEDULED_TASK(work_offset1=233*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ze04", work_offset2=0*)
 46: 0x01DF [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 49: 0x01F2 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="tlk2")
 50: 0x0201 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk2")
 ...
 55: 0x0225 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
