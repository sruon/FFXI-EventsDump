...
- **6419**: Obtained $0 gil.
- **10330**: Hey, [mister/lady]. You look like you could use some extra cash, and what easier way to get gil than by making a date with Lady Luck?
- **10331**: Give "Lucky Roll" a try? [Luck be a lady tonight!/I'm not throwing my money away!/Fill me in on the details.]
- **10332**: Let me explain to you how it works. One game of Lucky Roll is played each Vana'diel day.
- **10333**: One play is 100 gil, but as long as you keep paying, you can keep playing.
- **10334**: For each 100 gil, you get one roll of our six-sided die. The number that appears is added to the running total for that day.
- **10335**: The lucky adventurer who rolls the die that gets the running total over 400 wins...get this...a whopping 10000 gil!
- **10336**: And that's not all! You'll receive extra prizes if the total comes to 401 or 402, and a super bonus prize if your roll brings the total to exactly 400!
- **10337**: But be careful; the only time you can find out the running total is after you have rolled.
- **10338**: And that's it! Pretty simple, huh? You can attack from the get go, or you can sit back while other people roll, and then come in for the final kill. We provide you with the die, you choose the strategy.
- **10339**: Alright, enough talk, let's get rolling!
- **10340**: You rolled a...$1! The running total is now $3!
- **10341**: Congratulations! Lady Luck has smiled on you today! Here's your 10000 gil!
- **10342**: And because your roll put the running total at exactly 400, you receive a bonus prize!
- **10343**: And for bringing the total so close to 400, here is your extra prize!
- **10344**: I'm sorry, but that's it for today's game of Lucky Roll. Come by tomorrow, and maybe Lady Luck will be waiting for you!
...
```
  ...
  2: 0x000E [0x1D] PRINT_EVENT_MESSAGE(message_id=10330*)
  ...
  6: 0x0022 [0x1D] PRINT_EVENT_MESSAGE(message_id=10333*)
...
SUBROUTINE_0029:
  9: 0x0029 [0x24] CREATE_DIALOG(message_id=10331*, default_option=1*, option_flags=0*)
 ...
 13: 0x003A [0x1D] PRINT_EVENT_MESSAGE(message_id=10339*)
 ...
 20: 0x006A [0x1D] PRINT_EVENT_MESSAGE(message_id=10340*)
 ...
 23: 0x007D [0x1D] PRINT_EVENT_MESSAGE(message_id=10341*)
 ...
 26: 0x0086 [0x48] [System] [6419*]:
    → "Obtained $0 gil."
 27: 0x0089 [0x1C] WAIT(1* ticks)
 28: 0x008C [0x02] IF !(Work_Zone[5] == 1000*) GOTO 0x009B
 29: 0x0094 [0x1D] PRINT_EVENT_MESSAGE(message_id=10342*)
 ...
 33: 0x00A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10343*)
 ...
 37: 0x00B2 [0x1D] PRINT_EVENT_MESSAGE(message_id=10343*)
    → "And for bringing the total so close to 400, here is your extra prize!"
...
SUBROUTINE_00D8:
 ...
 53: 0x0102 [0x1D] PRINT_EVENT_MESSAGE(message_id=10332*)
 ...
 55: 0x0106 [0x1D] PRINT_EVENT_MESSAGE(message_id=10333*)
    → "One play is 100 gil, but as long as you keep paying, you can keep playing."
 56: 0x0109 [0x23] WAIT_FOR_DIALOG_INTERACTION
 57: 0x010A [0x1D] PRINT_EVENT_MESSAGE(message_id=10334*)
 ...
 59: 0x010E [0x1D] PRINT_EVENT_MESSAGE(message_id=10335*)
 ...
 61: 0x0112 [0x1D] PRINT_EVENT_MESSAGE(message_id=10336*)
 ...
 63: 0x0116 [0x1D] PRINT_EVENT_MESSAGE(message_id=10337*)
 ...
 66: 0x011F [0x1D] PRINT_EVENT_MESSAGE(message_id=10338*)
...
SUBROUTINE_0129:
 ...
 70: 0x012C [0x1D] PRINT_EVENT_MESSAGE(message_id=10332*)
    → "Let me explain to you how it works. One game of Lucky Roll is played each Vana'diel day."
...
SUBROUTINE_0130:
 ...
 76: 0x014B [0x1D] PRINT_EVENT_MESSAGE(message_id=10342*)
    → "And because your roll put the running total at exactly 400, you receive a bonus prize!"
 ...
 81: 0x0162 [0x1D] PRINT_EVENT_MESSAGE(message_id=10343*)
    → "And for bringing the total so close to 400, here is your extra prize!"
