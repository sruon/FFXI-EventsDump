...
```
  ...
  1: 0x1010 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  2: 0x1021 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 25: 0x10B8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=644*, entity1=EventEntity, entity2=EventEntity, scheduler_id="st17", work_offset2=0*)
 26: 0x10C9 [0x01] GOTO 0x1115

SUBROUTINE_10CC:
 27: 0x10CC [0x02] IF !(LocalPlayer->Race == 6*) GOTO 0x10E8
 28: 0x10D4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=644*, entity1=EventEntity, entity2=EventEntity, scheduler_id="st17", work_offset2=0*)
 29: 0x10E5 [0x01] GOTO 0x1115

SUBROUTINE_10E8:
 30: 0x10E8 [0x02] IF !(LocalPlayer->Race == 8*) GOTO 0x1104
 31: 0x10F0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=644*, entity1=EventEntity, entity2=EventEntity, scheduler_id="sg17", work_offset2=0*)
 32: 0x1101 [0x01] GOTO 0x1115

SUBROUTINE_1104:
 33: 0x1104 [0x45] LOAD_SCHEDULED_TASK(work_offset1=644*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s017", work_offset2=0*)
 34: 0x1115 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 ...
 44: 0x1152 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=Unnamed NPC (ID: 17789024/0x010F7060), entity2=Unnamed NPC (ID: 17789024/0x010F7060), action="tlk0")
 ...
 50: 0x117E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=Unnamed NPC (ID: 17789024/0x010F7060), entity2=Unnamed NPC (ID: 17789024/0x010F7060), action="tlk1")
...
\u0000\u000C\u0002[./ (complete.)]\u007F1\u0000\u0007"
 ...
 57: 0x11A7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=644*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s013", work_offset2=0*)
 58: 0x11B8 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=169*, entity1=Unnamed NPC (ID: 17789024/0x010F7060), entity2=Unnamed NPC (ID: 17789024/0x010F7060), action="tlk0")
 ...
 63: 0x11DC [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=169*, entity1=Unnamed NPC (ID: 17789024/0x010F7060), entity2=Unnamed NPC (ID: 17789024/0x010F7060), action="tlk1")
 64: 0x11EB [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 65: 0x11FC [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 73: 0x122E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
