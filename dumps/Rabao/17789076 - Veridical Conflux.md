...
- **12072**: [Apply to proceed/Proceed]? [Definitely!/Not yet.]
- **12083**: You will be able to call forth up to $4 alter ego[/s] given the current number of players in your party.
- **12091**: You are currently number $3 in line to be drawn into this nightmare.
- **12092**: You are currently number $3 in line, with $2 in front of you.
- **12093**: Prepare yourselves! The battlefield is almost ready!
- **12094**: Your number: $3. (Auto-transport: [off/on]) [Remove your name./Toggle auto-transport./Close dialogue.]
- **12106**: Attempt which? (Auto-transport: [off/on]) [None./Sheol A. (Level 119+)/Sheol B. (Level 124+)/Sheol C. (Level 129+)/Sheol: Gaol. (Level 124+)/./././././././././././Toggle auto-transport.]
- **12107**: Only party members present with you in this area will be transported to [/Sheol A/Sheol B/Sheol C/Sheol: Gaol][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **12108**: Entering [/Sheol A/Sheol B/Sheol C/Sheol: Gaol][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **12109**: You have chosen not to [apply to/enter] [/Sheol A/Sheol B/Sheol C/Sheol: Gaol][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **12112**: Applying to enter [/Sheol A/Sheol B/Sheol C/Sheol: Gaol][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy]. You will be unable to participate if you add any more party members. Are you sure?
- **12113**: You are currently applying to enter [/Sheol A/Sheol B/Sheol C/Sheol: Gaol][/: Very Difficult/: Difficult/: Normal/: Easy/: Very Easy].
- **12114**: Debug menu. [Check information./View applicants./Applicant parameters./Change maximum limit./Clear applications./Automatically create./Close dialogue.]
- **12123**: Designate a value between $0 and $1.
- **12134**: $)$P13.$P106$P10, $P13.$lF$0 [1"/%<$P15{/$~_i/$m$P14F/$3$43308646i]
...
```
 ...
 12: 0x003A [0x24] CREATE_DIALOG(message_id=12106*, default_option=0*, option_flags=ExtData[1]->WorkLocal[7])
...
SUBROUTINE_00BC:
 ...
 43: 0x00D7 [0x24] CREATE_DIALOG(message_id=12072*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0148:
 ...
 16: 0x0169 [0x24] CREATE_DIALOG(message_id=12094*, default_option=1*, option_flags=0*)
...
```
  ...
  6: 0x01AC [0x24] CREATE_DIALOG(message_id=12072*, default_option=0*, option_flags=0*)
    → "[Apply to proceed/Proceed]? [Definitely!/Not yet.]"
...
```
  ...
  3: 0x0205 [0x24] CREATE_DIALOG(message_id=12114*, default_option=0*, option_flags=0*)
 ...
 44: 0x02BE [0x24] CREATE_DIALOG(message_id=12134*, default_option=0*, option_flags=0*)
