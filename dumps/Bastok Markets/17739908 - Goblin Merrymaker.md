...
- **14085**: This for me? In-doo-bid-ably! Could be gooder, but it not bad.
- **14086**: Waaah! It you! You give yum-yums for me tum-tum. Good [guy/girl]!
- **14087**: Not for us, not for me? I give it back. Now you happy? Happy toy, happy toy, where be me happy toy?t
- **14088**: No no no no no! Go away! Nose holes busy sniff for happy toy!
- **14090**: You have friend, you do? We Gobbies have friend too.
- **14091**: Yum-yums for me? Gobbies remember...till our tummies go rumble-rumble again.
- **14092**: For me!? Why give so nice thing to me!? Me so happy head go boom! So boom! But first, me need give happy toy to you too.
- **14093**: Happy toy? For me? Why you give so good thing to me? But no can take. Me have no happy toy for you.
- **14094**: Blech. What this yucky thing? It make me want upgut food. Take it away.
...
SUBROUTINE_00BB:
  ...
  6: 0x00C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=14086*)
...
# Dead code (unreachable instructions):
     ...
     0x0036 [0x1D] PRINT_EVENT_MESSAGE(message_id=14085*)
    → "This for me? In-doo-bid-ably! Could be gooder, but it not bad."
     ...
     0x0043 [0x1D] PRINT_EVENT_MESSAGE(message_id=14087*)
    → "Not for us, not for me? I give it back. Now you happy? Happy toy, happy toy, where be me happy toy?t"
     ...
     0x0050 [0x1D] PRINT_EVENT_MESSAGE(message_id=14088*)
    → "No no no no no! Go away! Nose holes busy sniff for happy toy!"
     ...
     0x0085 [0x1D] PRINT_EVENT_MESSAGE(message_id=14090*)
    → "You have friend, you do? We Gobbies have friend too."
     ...
     0x0092 [0x1D] PRINT_EVENT_MESSAGE(message_id=14092*)
    → "For me!? Why give so nice thing to me!? Me so happy head go boom! So boom! But first, me need give happy toy to you too."
     ...
     0x009E [0x1D] PRINT_EVENT_MESSAGE(message_id=14093*)
    → "Happy toy? For me? Why you give so good thing to me? But no can take. Me have no happy toy for you."
     ...
     0x00AA [0x1D] PRINT_EVENT_MESSAGE(message_id=14091*)
    → "Yum-yums for me? Gobbies remember...till our tummies go rumble-rumble again."
     ...
     0x00B6 [0x1D] PRINT_EVENT_MESSAGE(message_id=14094*)
