...
```
  ...
  1: 0x001E [0x1D] PRINT_EVENT_MESSAGE(message_id=7510*)
    → "Here in the Markets, they sell instruments, jewelry, weapons, armor, goods... Anything anyone could ever want!\u007F1\u0000\u0007"
  2: 0x0021 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0022 [0x5B] LOAD_EXT_SCHEDULER(work_offset=80*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  4: 0x0031 [0x1D] PRINT_EVENT_MESSAGE(message_id=7511*)
    → "The future of this city is as bright as mine!\u007F1\u0000\u0007"
