...
```
  ...
  1: 0x0010 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  2: 0x0021 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 13: 0x006A [0x5B] LOAD_EXT_SCHEDULER(work_offset=850*, entity1=Valkeng (ID: 17739927/0x010EB097), entity2=Valkeng (ID: 17739927/0x010EB097), action="dan0")
 14: 0x0079 [0x53] WAIT_SCHEDULER_TASK(entity1=Valkeng (ID: 17739927/0x010EB097), entity2=Valkeng (ID: 17739927/0x010EB097), action_id="dan0")
 ...
 18: 0x0097 [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k000", work_offset2=0*)
 19: 0x00A8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 ...
 27: 0x00E2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k002", work_offset2=0*)
 28: 0x00F3 [0x7B] Shamarhaan (ID: 17739926/0x010EB096) stops talking
 29: 0x00F8 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 30: 0x0107 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
 ...
 35: 0x011C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 36: 0x012B [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk1")
 37: 0x0138 [0x52] END_LOAD_SCHEDULER: End scheduler "k002" with entities [LocalPlayer, LocalPlayer], work=267*
 38: 0x0147 [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k003", work_offset2=0*)
 ...
 43: 0x016A [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 46: 0x017D [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tlk0")
 47: 0x018A [0x52] END_LOAD_SCHEDULER: End scheduler "k003" with entities [LocalPlayer, LocalPlayer], work=267*
 48: 0x0199 [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k004", work_offset2=0*)
 ...
 56: 0x01C1 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 57: 0x01D0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="ovl2", work_offset2=0*)
 58: 0x01E1 [0x52] END_LOAD_SCHEDULER: End scheduler "k004" with entities [LocalPlayer, LocalPlayer], work=267*
 59: 0x01F0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k005", work_offset2=0*)
 60: 0x0201 [0x1C] WAIT(30* ticks)
 61: 0x0204 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=EventEntity, entity2=EventEntity, action="twa0")
 ...
 69: 0x0222 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=EventEntity, entity2=EventEntity, action="twa1")
 70: 0x0231 [0x52] END_LOAD_SCHEDULER: End scheduler "k005" with entities [LocalPlayer, LocalPlayer], work=267*
 71: 0x0240 [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k009", work_offset2=0*)
 72: 0x0251 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 78: 0x026B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 79: 0x027A [0x1C] WAIT(60* ticks)
 80: 0x027D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=Shamarhaan (ID: 17739926/0x010EB096), entity2=Shamarhaan (ID: 17739926/0x010EB096), action="thk1")
 ...
 85: 0x02A2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k006", work_offset2=0*)
 86: 0x02B3 [0x1C] WAIT(60* ticks)
 87: 0x02B6 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=Shamarhaan (ID: 17739926/0x010EB096), entity2=Shamarhaan (ID: 17739926/0x010EB096), action="thk2")
 ...
 93: 0x02DC [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k008", work_offset2=0*)
 94: 0x02ED [0x1C] WAIT(60* ticks)
 95: 0x02F0 [0x27] REQ_SET(priority=0x0A, entity_id=Valkeng (ID: 17739927/0x010EB097), tag_num=0x03)
 96: 0x02F7 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=EventEntity, entity2=EventEntity, action="twb0")
...
103: 0x031C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
104: 0x032D [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
...
110: 0x035A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
