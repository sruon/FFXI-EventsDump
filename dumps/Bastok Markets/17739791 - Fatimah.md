...
| [302](#event-302)     | 0x0001       |    450 |            109 |
| [402](#event-402)     | 0x01C3       |      1 |              1 |
...
- **7115**: Request...? [[Advanced synthesis/Synthesis/Synthesis] image support./Information on synthesis materials./Nothing.]
- **7116**: Image support: $0 gil. [Accept./Decline.]
- **7120**: Necessary skills: [Fishing/Woodworking/Smithing/Goldsmithing/Clothcraft/Leatherworking/Bonecraft/Alchemy/Cooking][ /, Woodworking/, Smithing/, Goldsmithing/, Clothcraft/, Leatherworking/, Bonecraft/, Alchemy/, Cooking][ /, Woodworking/, Smithing/, Goldsmithing/, Clothcraft/, Leatherworking/, Bonecraft/, Alchemy/, Cooking][ /, & Woodworking/, & Smithing/, & Goldsmithing/, & Clothcraft/, & Leatherworking/, & Bonecraft/, & Alchemy/, & Cooking] Necessary crystal: $4 Necessary items:
- **7121**: $4 x $0 $5 x $0$0 $6 x $0 $7 x $0$3
- **7122**: $4 x $0 $5 x $0$0 $6 x $0
- **7123**: $4 x $0 $5 x $0$0
- **7124**: $4 x $0
- **7158**: Necessary skills: [Fishing/Woodworking/Smithing/Goldsmithing/Clothcraft/Leatherworking/Bonecraft/Alchemy/Cooking][ /, Woodworking/, Smithing/, Goldsmithing/, Clothcraft/, Leatherworking/, Bonecraft/, Alchemy/, Cooking][ /, Woodworking/, Smithing/, Goldsmithing/, Clothcraft/, Leatherworking/, Bonecraft/, Alchemy/, Cooking][ /, & Woodworking/, & Smithing/, & Goldsmithing/, & Clothcraft/, & Leatherworking/, & Bonecraft/, & Alchemy/, & Cooking] Necessary crystal: $4 Necessary key item: $3 Necessary items:
- **7186**: Hey! Watch it! Do you want me to like, miss a flaw?
- **7187**: Come on! I just helped you out!
- **7188**: Are you like, trying to rip me off or something? I'm a respected goldsmith, you know.
- **7189**: Okay, I'll help you out. Shut your eyes...
- **7190**: Why don't you, like, make $0? You're gonna need these, though...
- **7191**: And that's it! If you don't think you've got what it takes, I'd be happy to help you out...for a price, of course.
- **7223**: Let's see now... This shaft's connected to...this gear. This gear's connected to my...belt buckle? Could you, like, not talk to me right now?
- **7224**: We're really busy researching the application of our cutting-edge clockmaking techniques in the field of automaton augmentation. Whoa, I sound really professional, don't I?
...
```
  ...
  3: 0x0012 [0x1D] PRINT_EVENT_MESSAGE(message_id=7223*)
    → "Let's see now... This shaft's connected to...this gear. This gear's connected to my...belt buckle? Could you, like, not talk to me right now?"
  4: 0x0015 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0016 [0x1D] PRINT_EVENT_MESSAGE(message_id=7224*)
    → "We're really busy researching the application of our cutting-edge clockmaking techniques in the field of automaton augmentation. Whoa, I sound really professional, don't I?"
...
SUBROUTINE_0021:
 10: 0x0021 [0x24] CREATE_DIALOG(message_id=7115*, default_option=2*, option_flags=0*)
 ...
 14: 0x0039 [0x1D] PRINT_EVENT_MESSAGE(message_id=7187*)
    → "Come on! I just helped you out!"
 15: 0x003C [0x23] WAIT_FOR_DIALOG_INTERACTION
 16: 0x003D [0x01] GOTO 0x009C
 17: 0x0040 [0x24] CREATE_DIALOG(message_id=7116*, default_option=1*, option_flags=0*)
 ...
 21: 0x0058 [0x1D] PRINT_EVENT_MESSAGE(message_id=7189*)
    → "Okay, I'll help you out. Shut your eyes..."
 ...
 29: 0x008A [0x1D] PRINT_EVENT_MESSAGE(message_id=7188*)
    → "Are you like, trying to rip me off or something? I'm a respected goldsmith, you know."
...
SUBROUTINE_009C:
 ...
 40: 0x00BB [0x1D] PRINT_EVENT_MESSAGE(message_id=7190*)
    → "Why don't you, like, make $0? You're gonna need these, though..."
...
105: 0x01BD [0x1D] PRINT_EVENT_MESSAGE(message_id=7186*)
    → "Hey! Watch it! Do you want me to like, miss a flaw?"
