...
- **7188**: Nope... Can't stop to chat with you right now.
- **7189**: Hey, don't you remember someone helping you five seconds ago?
- **7191**: Okay. Eyes closed, now.
- **7192**: You? You'd be best off trying your luck with $0. Get your notepad ready...
- **7193**: That's all. Collecting materials yourself is a cheap way to practice your goldsmithing...unless you've got gil to burn.
...
```
  0: 0x0001 [0x3E] IF !(Work_Zone[5] bit 3*) GOTO 0x0177
  1: 0x0008 [0x24] CREATE_DIALOG(message_id=7111*, default_option=2*, option_flags=0*)
  ...
  5: 0x0020 [0x1D] PRINT_EVENT_MESSAGE(message_id=7189*)
    → "Hey, don't you remember someone helping you five seconds ago?"
  6: 0x0023 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0024 [0x01] GOTO 0x0056
  8: 0x0027 [0x1D] PRINT_EVENT_MESSAGE(message_id=7191*)
    → "Okay. Eyes closed, now."
...
SUBROUTINE_0056:
 ...
 21: 0x0075 [0x1D] PRINT_EVENT_MESSAGE(message_id=7192*)
    → "You? You'd be best off trying your luck with $0. Get your notepad ready..."
...
SUBROUTINE_0174:
 ...
 86: 0x0177 [0x1D] PRINT_EVENT_MESSAGE(message_id=7188*)
    → "Nope... Can't stop to chat with you right now."
