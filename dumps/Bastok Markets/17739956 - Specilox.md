...
- **14396**: Oy, would ya get a look at yer $0! I guess I can let ya open [/Dial 1/Dial 2/Dial 3/Dial 4/Dial 5/the special dial///the abjuration dial/the fortune dial/the furnishings dial//the Vana'versary dial] whenever ya want fer not a single onz o' daily tally!
- **14397**: Dun think that I's be a gil-grubbin' good-fer-nuthin'. If'n ya dun wanna open any dial, then I gives ya back yer $0.
- **14398**: Yer eyes be bigger'n yer stomach. If'n ya wanna open [/Dial 1/Dial 2/Dial 3/Dial 4/Dial 5/the Special Dial///the abjuration dial/the fortune dial/the furnishings dial//the Vana'versary dial] usin' yer $0, then ya gotta make room in yer bags!
...
# Dead code (unreachable instructions):
    ...
    → "So ya be wantin' the [special/Adoulin/pictlogica/Wanted] dial? Whoawhoawhoa! Get yer grubby hands offa that! I's already opened one fer ya today! Haul that keister outta here and come back t'morrow."
     ...
     0x0419 [0x1D] PRINT_EVENT_MESSAGE(message_id=14374*)
    → "Dis box is full o' myst'ries,t Dat span da realm's his'try,t So whatcha gonna get from da chest...o'...uh, fortunery?t"
     ...
     0x0483 [0x1D] PRINT_EVENT_MESSAGE(message_id=14375*)
    → "Oooh, looks at what popped out! I hopes it makes yer adventures dat much more adventumarous!"
...
```
 ...
 16: 0x0526 [0x1D] PRINT_EVENT_MESSAGE(message_id=14384*)
 ...
 20: 0x0535 [0x1D] PRINT_EVENT_MESSAGE(message_id=14385*)
...
```
  ...
  6: 0x0560 [0x1D] PRINT_EVENT_MESSAGE(message_id=14387*)
...
```
  ...
  4: 0x057C [0x1D] PRINT_EVENT_MESSAGE(message_id=14388*)
...
```
  ...
  4: 0x0598 [0x1D] PRINT_EVENT_MESSAGE(message_id=14389*)
...
```
  ...
  4: 0x05B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=14392*)
...
```
  ...
  6: 0x05D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=14396*)
...
```
  ...
  5: 0x062E [0x1D] PRINT_EVENT_MESSAGE(message_id=14397*)
...
```
  ...
  4: 0x064E [0x1D] PRINT_EVENT_MESSAGE(message_id=14398*)
...
```
  ...
  4: 0x066A [0x1D] PRINT_EVENT_MESSAGE(message_id=14399*)
...
```
  ...
  5: 0x0687 [0x1D] PRINT_EVENT_MESSAGE(message_id=14376*)
    → "Ya's thought I threw yer prize away?! Prepostamarous! I's just tucked it away for safekeepin' is all."
