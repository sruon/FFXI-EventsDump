...
- **15324**: Good day, adventurer! I am able to repair any broken item data related to $0.
- **15325**: If you are unable to deliver $0, it's possible that the item data has been corrupted.
- **15326**: Please trade your $0 to me so that I may fix it.
- **15327**: I have confirmed that the item data for your $0 has been corrupted. We apologize for the inconvenience.
- **15328**: I have restored it to its intended functionality. Here you are!
- **15329**: It appears that your item is working as intended.
...
```
  ...
  6: 0x0013 [0x1D] PRINT_EVENT_MESSAGE(message_id=15326*)
