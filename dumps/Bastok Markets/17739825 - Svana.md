...
- **6799**: That area's forecast for today is for $0 with occasional $1. There is also a slight chance of $2, so caution is advised.
- **6800**: The forecast for tomorrow is for $0 with occasional $1. There is also a slight chance of $2, so caution is advised.
- **6801**: And, the forecast for the day after tomorrow is for $0 with occasional $1. There is also a slight chance of $2, so caution is advised.
- **6802**: Today, that area's weather will be $0 with a chance of $1.
- **6803**: Tomorrow, the weather will be $0 with a chance of $1.
- **6804**: And, the day after tomorrow, the weather will be $0 with a chance of $1.
- **6805**: Today, the weather in that area will be $0. There is also the possibility of $2, so caution is advised.
- **6806**: Tomorrow, the weather will be $0. There is also the possibility of $2, so caution is advised.
- **6807**: And, the day after tomorrow, the weather will be $0. There is also the possibility of $2, so caution is advised.
- **6808**: The weather in that area today will be $0.
- **6809**: The weather tomorrow will be $0.
- **6810**: The weather the day after tomorrow will be $0.
...
```
  ...
  1: 0x000B [0x1D] PRINT_EVENT_MESSAGE(message_id=6797*)
  ...
  3: 0x000F [0x24] CREATE_DIALOG(message_id=6798*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_021A:
 ...
 23: 0x0225 [0x1D] PRINT_EVENT_MESSAGE(message_id=6802*)
 ...
 26: 0x022C [0x1D] PRINT_EVENT_MESSAGE(message_id=6799*)
...
SUBROUTINE_0230:
 ...
 32: 0x024D [0x1D] PRINT_EVENT_MESSAGE(message_id=6809*)
    → "The weather tomorrow will be $0."
 33: 0x0250 [0x23] WAIT_FOR_DIALOG_INTERACTION
 34: 0x0251 [0x01] GOTO 0x0258
 35: 0x0254 [0x1D] PRINT_EVENT_MESSAGE(message_id=6806*)
...
SUBROUTINE_0296:
 ...
 55: 0x02A1 [0x1D] PRINT_EVENT_MESSAGE(message_id=6804*)
 ...
 58: 0x02A8 [0x1D] PRINT_EVENT_MESSAGE(message_id=6801*)
...
SUBROUTINE_02AC:
 60: 0x02AC [0x1D] PRINT_EVENT_MESSAGE(message_id=6811*)
