...
| [6001](#event-6001)      | 0x0070       |      6 |              2 |
| [6010](#event-6010)      | 0x0076       |      6 |              2 |
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0040:                                      7A 05 B5 B0              z...
0050: 0E 01 02 00 00 01 80 01  6F 00 B6 00 01 80 62 06  ........o.....b.
...
```
  0: 0x004C [0x7A] VM_CONTROL: Reset copy state for Treasure Coffer (ID: 17739957/0x010EB0B5)
