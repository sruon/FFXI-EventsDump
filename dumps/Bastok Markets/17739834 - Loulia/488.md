...
```
  ...
  5: 0x01AB [0x3D] CLEAR_BIT_FLAG_CONDITIONAL(target_work_offset=0x03, bit_index_work_offset=0x800C, condition_work_offset=0x8001)
  6: 0x01B2 [0x0F] ExtData[1]->WorkLocal[2] ^= 4294967295*
  7: 0x01B7 [0x3D] CLEAR_BIT_FLAG_CONDITIONAL(target_work_offset=0x02, bit_index_work_offset=0x8000, condition_work_offset=0x8001)
 ...
 12: 0x01CF [0x3D] CLEAR_BIT_FLAG_CONDITIONAL(target_work_offset=0x03, bit_index_work_offset=0x8001, condition_work_offset=0x8001)
...
SUBROUTINE_01D9:
 ...
 17: 0x01E5 [0x24] CREATE_DIALOG(message_id=6597*, default_option=0*, option_flags=0x03)
...
SUBROUTINE_01FC:
 ...
 30: 0x0210 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1001, bit_index_work_offset=0x801A, condition_work_offset=0x8001)
 31: 0x0217 [0x01] GOTO 0x0257

SUBROUTINE_021A:
 32: 0x021A [0x02] IF !(Work_Zone[0] == 2*) GOTO 0x0257
 33: 0x0222 [0x24] CREATE_DIALOG(message_id=6598*, default_option=0*, option_flags=0x02)
