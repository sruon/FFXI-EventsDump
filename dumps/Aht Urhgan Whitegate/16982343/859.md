...
```
  ...
  3: 0x3711 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  4: 0x3722 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 22: 0x37AF [0x45] LOAD_SCHEDULED_TASK(work_offset1=191*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s217", work_offset2=0*)
 23: 0x37C0 [0x1C] WAIT(15* ticks)
 24: 0x37C3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 25: 0x37D4 [0x1C] WAIT(60* ticks)
 26: 0x37D7 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=Zyfhil (ID: 16982124/0x0103206C), entity2=Zyfhil (ID: 16982124/0x0103206C), action="tlk0")
 ...
 29: 0x37EE [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0*, entity1=Zyfhil (ID: 16982124/0x0103206C), entity2=Zyfhil (ID: 16982124/0x0103206C), action="ten0")
 ...
 53: 0x3878 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 54: 0x3889 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
...
SUBROUTINE_3946:
 ...
 84: 0x394B [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
...
SUBROUTINE_3961:
 ...
 89: 0x3969 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 90: 0x397A [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 94: 0x399D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
...
101: 0x39CC [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
102: 0x39DD [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
...
106: 0x3A00 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
