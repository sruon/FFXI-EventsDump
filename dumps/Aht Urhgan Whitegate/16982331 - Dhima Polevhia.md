...
- **5987**: There's been a sudden incrrrease in the number of puppetmasters lately. There are way too many for my liking now.
- **5988**: That's why I'm picky about who I do business with. People say, "The customer is always right," don't they? But I say, the customer better be rrright, or I'm not sellin'!
- **5996**: What do you want me to make? [Nothing./#/$1/$2]
- **5999**: You're rrreally sure? [Yes, I'm sure!/Maybe not...]
- **6004**: How many times do I have to tell you? I need $4, $5, $6, and $7!
- **6005**: Oh yeah, and don't forget to throw in $8. Hop to it, now!
- **6006**: Oh yeah, and don't forget to throw in $9 $0%0 . Hop to it, now!
- **6007**: Excellent work.
- **6008**: Leave everything to me, now. Just wait until you see how beautiful and strong the final product will be!
- **6009**: I won't be able to finish it today, so you should find something else to keep you busy and leave me to work in peace.
- **6010**: What do you want? Patience is a virtue, you know.
- **6011**: Your order is ready!
- **6012**: Just let me know if you want anything else. You won't find products like this anywhere else on Urhguum, believe me.
- **6013**: Did you want anything else?
...
```
  ...
  7: 0x0037 [0x1D] PRINT_EVENT_MESSAGE(message_id=6004*)
    → "How many times do I have to tell you? I need $4, $5, $6, and $7!"
  8: 0x003A [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x003B [0x1D] PRINT_EVENT_MESSAGE(message_id=6005*)
 ...
 18: 0x0063 [0x1D] PRINT_EVENT_MESSAGE(message_id=6004*)
    → "How many times do I have to tell you? I need $4, $5, $6, and $7!"
 19: 0x0066 [0x23] WAIT_FOR_DIALOG_INTERACTION
 20: 0x0067 [0x1D] PRINT_EVENT_MESSAGE(message_id=6005*)
    → "Oh yeah, and don't forget to throw in $8. Hop to it, now!"
 ...
 30: 0x0094 [0x1D] PRINT_EVENT_MESSAGE(message_id=6004*)
    → "How many times do I have to tell you? I need $4, $5, $6, and $7!"
 31: 0x0097 [0x23] WAIT_FOR_DIALOG_INTERACTION
 32: 0x0098 [0x1D] PRINT_EVENT_MESSAGE(message_id=6006*)
...
```
  ...
  2: 0x00A7 [0x1D] PRINT_EVENT_MESSAGE(message_id=6007*)
    → "Excellent work."
  3: 0x00AA [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x00AB [0x1D] PRINT_EVENT_MESSAGE(message_id=6008*)
  ...
  6: 0x00AF [0x1D] PRINT_EVENT_MESSAGE(message_id=6009*)
...
```
  ...
  1: 0x00BA [0x1D] PRINT_EVENT_MESSAGE(message_id=6010*)
...
```
  ...
  2: 0x00CA [0x1D] PRINT_EVENT_MESSAGE(message_id=6013*)
  ...
  8: 0x00E2 [0x24] CREATE_DIALOG(message_id=5996*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
    → "What do you want me to make? [Nothing./#/$1/$2]"
  9: 0x00E9 [0x25] WAIT_DIALOG_SELECT()
 10: 0x00EA [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x00FD
 11: 0x00F2 [0x2B] Dhima Polevhia (ID: 16982331/0x0103213B) [5997*]:
 ...
 16: 0x0108 [0x2B] Dhima Polevhia (ID: 16982331/0x0103213B) [5998*]:
    → "You surrre?"
 17: 0x010F [0x23] WAIT_FOR_DIALOG_INTERACTION
 18: 0x0110 [0x93] DISPLAY_ITEM_INFO(item_id=0*)
 19: 0x0113 [0x24] CREATE_DIALOG(message_id=5999*, default_option=1*, option_flags=0*)
 ...
 27: 0x013C [0x2B] Dhima Polevhia (ID: 16982331/0x0103213B) [6001*]:
    → "All rrright! You'll need to bring me $4, $5, $6, and $7, then!"
 28: 0x0143 [0x23] WAIT_FOR_DIALOG_INTERACTION
 29: 0x0144 [0x2B] Dhima Polevhia (ID: 16982331/0x0103213B) [6002*]:
 ...
 34: 0x015C [0x2B] Dhima Polevhia (ID: 16982331/0x0103213B) [6000*]:
...
SUBROUTINE_016A:
 ...
 40: 0x0178 [0x2B] Dhima Polevhia (ID: 16982331/0x0103213B) [5998*]:
    → "You surrre?"
 41: 0x017F [0x23] WAIT_FOR_DIALOG_INTERACTION
 42: 0x0180 [0x93] DISPLAY_ITEM_INFO(item_id=0*)
 43: 0x0183 [0x24] CREATE_DIALOG(message_id=5999*, default_option=1*, option_flags=0*)
    → "You're rrreally sure? [Yes, I'm sure!/Maybe not...]"
 ...
 51: 0x01AC [0x2B] Dhima Polevhia (ID: 16982331/0x0103213B) [6001*]:
    → "All rrright! You'll need to bring me $4, $5, $6, and $7, then!"
 52: 0x01B3 [0x23] WAIT_FOR_DIALOG_INTERACTION
 53: 0x01B4 [0x2B] Dhima Polevhia (ID: 16982331/0x0103213B) [6002*]:
    → "I'll also need $8 to show your appreciation for my hard work! Good luck!"
 ...
 58: 0x01CC [0x2B] Dhima Polevhia (ID: 16982331/0x0103213B) [6000*]:
    → "Well then, what do ya want?"
...
SUBROUTINE_01DA:
 ...
 64: 0x01E8 [0x2B] Dhima Polevhia (ID: 16982331/0x0103213B) [5998*]:
    → "You surrre?"
 65: 0x01EF [0x23] WAIT_FOR_DIALOG_INTERACTION
 66: 0x01F0 [0x93] DISPLAY_ITEM_INFO(item_id=0*)
 67: 0x01F3 [0x24] CREATE_DIALOG(message_id=5999*, default_option=1*, option_flags=0*)
    → "You're rrreally sure? [Yes, I'm sure!/Maybe not...]"
 ...
 76: 0x0221 [0x2B] Dhima Polevhia (ID: 16982331/0x0103213B) [6001*]:
    → "All rrright! You'll need to bring me $4, $5, $6, and $7, then!"
 77: 0x0228 [0x23] WAIT_FOR_DIALOG_INTERACTION
 78: 0x0229 [0x2B] Dhima Polevhia (ID: 16982331/0x0103213B) [6003*]:
 ...
 83: 0x0241 [0x2B] Dhima Polevhia (ID: 16982331/0x0103213B) [6000*]:
    → "Well then, what do ya want?"
...
```
  ...
  1: 0x0259 [0x1D] PRINT_EVENT_MESSAGE(message_id=6011*)
    → "Your order is ready!"
  2: 0x025C [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x025D [0x1D] PRINT_EVENT_MESSAGE(message_id=6012*)
