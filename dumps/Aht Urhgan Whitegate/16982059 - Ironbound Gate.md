...
0030: F0 FF FF 7F F0 FF FF 7F  64 6F 6F 72 02 80 1C 06  ........door....
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=4601*, default_option=1*, option_flags=0*)
    → "Go to Bhaflau Thickets?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
  ...
  8: 0x002D [0x45] LOAD_SCHEDULED_TASK: Load scheduler "door" with entities [LocalPlayer, LocalPlayer], work=[268*, 0*]
