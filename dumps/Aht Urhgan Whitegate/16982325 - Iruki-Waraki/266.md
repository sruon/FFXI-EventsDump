...
```
  ...
  2: 0x0346 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  3: 0x0357 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 20: 0x03BB [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k200", work_offset2=0*)
 21: 0x03CC [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 22: 0x03DD [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1")
 ...
 27: 0x0402 [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k201", work_offset2=0*)
 ...
 41: 0x044B [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k202", work_offset2=0*)
 ...
 54: 0x048F [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k203", work_offset2=0*)
 ...
 66: 0x04CF [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k204", work_offset2=0*)
 ...
 70: 0x04E7 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=Iruki-Waraki (ID: 16982325/0x01032135), entity2=Iruki-Waraki (ID: 16982325/0x01032135), action="tlk0")
 ...
 74: 0x0509 [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k203", work_offset2=0*)
 75: 0x051A [0x1D] PRINT_EVENT_MESSAGE(message_id=5834*)
    → "You see, about that...\u007F1\u0000\u0007"
 76: 0x051D [0x23] WAIT_FOR_DIALOG_INTERACTION
 77: 0x051E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=Iruki-Waraki (ID: 16982325/0x01032135), entity2=Iruki-Waraki (ID: 16982325/0x01032135), action="tlk1")
 ...
 81: 0x0540 [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k205", work_offset2=0*)
 ...
 94: 0x0573 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="ovl2", work_offset2=0*)
 95: 0x0584 [0x52] END_LOAD_SCHEDULER: End scheduler "k205" with entities [LocalPlayer, LocalPlayer], work=267*
 96: 0x0593 [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k206", work_offset2=0*)
...
100: 0x05AB [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=Iruki-Waraki (ID: 16982325/0x01032135), entity2=Iruki-Waraki (ID: 16982325/0x01032135), action="thk1")
...
104: 0x05C1 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=Iruki-Waraki (ID: 16982325/0x01032135), entity2=Iruki-Waraki (ID: 16982325/0x01032135), action="thk2")
...
108: 0x05E3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k207", work_offset2=0*)
...
111: 0x05FE [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=Iruki-Waraki (ID: 16982325/0x01032135), entity2=Iruki-Waraki (ID: 16982325/0x01032135), action="sha0")
112: 0x060D [0x1C] WAIT(110* ticks)
113: 0x0610 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
114: 0x0621 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
115: 0x0630 [0x52] END_LOAD_SCHEDULER: End scheduler "k207" with entities [LocalPlayer, LocalPlayer], work=267*
116: 0x063F [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=Iruki-Waraki (ID: 16982325/0x01032135), entity2=Iruki-Waraki (ID: 16982325/0x01032135), action="sha1")
...
125: 0x066A [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k208", work_offset2=0*)
126: 0x067B [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi0", work_offset2=0*)
127: 0x068C [0x4A] LocalPlayer looks at Automaton (ID: 16982166/0x01032096)
128: 0x0695 [0x1C] WAIT(120* ticks)
129: 0x0698 [0x5B] LOAD_EXT_SCHEDULER(work_offset=850*, entity1=Automaton (ID: 16982166/0x01032096), entity2=Automaton (ID: 16982166/0x01032096), action="pa02")
130: 0x06A7 [0x53] WAIT_SCHEDULER_TASK(entity1=Automaton (ID: 16982166/0x01032096), entity2=Automaton (ID: 16982166/0x01032096), action_id="pa02")
131: 0x06B4 [0x52] END_LOAD_SCHEDULER: End scheduler "k208" with entities [LocalPlayer, LocalPlayer], work=267*
132: 0x06C3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k210", work_offset2=0*)
...
144: 0x0703 [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s059", work_offset2=0*)
...
159: 0x0760 [0x45] LOAD_SCHEDULED_TASK(work_offset1=267*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="k209", work_offset2=0*)
...
165: 0x0784 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
...
174: 0x07BE [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
175: 0x07CF [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="qstc", work_offset2=0*)
