...
```
 ...
 33: 0x0068 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=2*, source=ExtData[1]->WorkLocal[1], result=ExtData[1]->WorkLocal[5])
 34: 0x0071 [0x41] GET_BIT_WORK_RANGE(start_bit=4*, end_bit=13*, source=ExtData[1]->WorkLocal[1], result=ExtData[1]->WorkLocal[6])
 35: 0x007A [0x41] GET_BIT_WORK_RANGE(start_bit=3*, end_bit=3*, source=ExtData[1]->WorkLocal[1], result=ExtData[1]->WorkLocal[20])
 36: 0x0083 [0x41] GET_BIT_WORK_RANGE(start_bit=14*, end_bit=23*, source=ExtData[1]->WorkLocal[1], result=ExtData[1]->WorkLocal[21])
 37: 0x008C [0x41] GET_BIT_WORK_RANGE(start_bit=24*, end_bit=24*, source=ExtData[1]->WorkLocal[1], result=ExtData[1]->WorkLocal[22])
 38: 0x0095 [0x41] GET_BIT_WORK_RANGE(start_bit=25*, end_bit=25*, source=ExtData[1]->WorkLocal[1], result=ExtData[1]->WorkLocal[23])
 39: 0x009E [0x03] ExtData[1]->WorkLocal[28] = Work_Zone[3]
 40: 0x00A3 [0x02] IF !(ExtData[1]->WorkLocal[5] == 0*) GOTO 0x00C3
 41: 0x00AB [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8005, condition_work_offset=0x800A)
 42: 0x00B2 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8003, condition_work_offset=0x800A)
 43: 0x00B9 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x800B, condition_work_offset=0x800A)
 44: 0x00C0 [0x01] GOTO 0x013D

SUBROUTINE_00C3:
 45: 0x00C3 [0x02] IF !(ExtData[1]->WorkLocal[5] == 1*) GOTO 0x00E3
 46: 0x00CB [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8005, condition_work_offset=0x800A)
 47: 0x00D2 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8003, condition_work_offset=0x800A)
 48: 0x00D9 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x800B, condition_work_offset=0x800A)
...
SUBROUTINE_00E3:
 ...
 52: 0x00F3 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8005, condition_work_offset=0x800A)
 53: 0x00FA [0x01] GOTO 0x010F

SUBROUTINE_00FD:
 54: 0x00FD [0x02] IF !(ExtData[1]->WorkLocal[20] == 1*) GOTO 0x010F
 55: 0x0105 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8003, condition_work_offset=0x800A)
...
SUBROUTINE_011D:
 ...
 61: 0x0125 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8005, condition_work_offset=0x800A)
 62: 0x012C [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x8003, condition_work_offset=0x800A)
 63: 0x0133 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x1B, bit_index_work_offset=0x800B, condition_work_offset=0x800A)
...
111: 0x0226 [0x24] CREATE_DIALOG(message_id=1481*, default_option=0*, option_flags=0x1B)
...
122: 0x0268 [0x24] CREATE_DIALOG(message_id=0x00000019, default_option=0*, option_flags=0x1C)
...
136: 0x02B1 [0x24] CREATE_DIALOG(message_id=1500*, default_option=0*, option_flags=0x1D)
...
148: 0x02F3 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=9*, source=ExtData[1]->WorkLocal[2], result=ExtData[1]->WorkLocal[6])
149: 0x02FC [0x41] GET_BIT_WORK_RANGE(start_bit=10*, end_bit=13*, source=ExtData[1]->WorkLocal[2], result=ExtData[1]->WorkLocal[7])
150: 0x0305 [0x41] GET_BIT_WORK_RANGE(start_bit=14*, end_bit=17*, source=ExtData[1]->WorkLocal[2], result=ExtData[1]->WorkLocal[8])
151: 0x030E [0x03] ExtData[1]->WorkLocal[3] = Work_Zone[8]
152: 0x0313 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=9*, source=ExtData[1]->WorkLocal[3], result=ExtData[1]->WorkLocal[9])
153: 0x031C [0x41] GET_BIT_WORK_RANGE(start_bit=10*, end_bit=19*, source=ExtData[1]->WorkLocal[3], result=ExtData[1]->WorkLocal[10])
154: 0x0325 [0x03] ExtData[1]->WorkLocal[4] = Work_Zone[9]
155: 0x032A [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=7*, source=ExtData[1]->WorkLocal[4], result=ExtData[1]->WorkLocal[11])
156: 0x0333 [0x41] GET_BIT_WORK_RANGE(start_bit=8*, end_bit=15*, source=ExtData[1]->WorkLocal[4], result=ExtData[1]->WorkLocal[12])
157: 0x033C [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=23*, source=ExtData[1]->WorkLocal[4], result=ExtData[1]->WorkLocal[13])
158: 0x0345 [0x41] GET_BIT_WORK_RANGE(start_bit=24*, end_bit=31*, source=ExtData[1]->WorkLocal[4], result=ExtData[1]->WorkLocal[14])
...
```
# Data Section: 0x05D3 (176 bytes)
     0x05D3: 03 18 00 00 80 03 01 00 02 10 41 01 80 02 80 01
     0x05E3: 00 05 00 41 03 80 04 80 01 00 06 00 41 05 80 05
     0x05F3: 80 01 00 14 00 41 06 80 07 80 01 00 15 00 41 08
     0x0603: 80 08 80 01 00 16 00 41 09 80 09 80 01 00 17 00
     0x0613: 03 1C 00 03 10 03 1D 00 04 10 03 13 00 06 10 03
     0x0623: 02 00 07 10 41 01 80 18 80 02 00 06 00 41 1A 80
     0x0633: 04 80 02 00 07 00 41 06 80 22 80 02 00 08 00 03
     0x0643: 03 00 08 10 41 01 80 18 80 03 00 09 00 41 1A 80
     0x0653: 23 80 03 00 0A 00 03 04 00 09 10 41 01 80 15 80
     0x0663: 04 00 0B 00 41 00 80 24 80 04 00 0C 00 41 25 80
     0x0673: 07 80 04 00 0D 00 41 08 80 26 80 04 00 0E 00 1B
```