...
- **4955**: <Sigh>... Fernan doesn't seem nearly as drrreamy as he did in his older work...
- **4956**: ...What? You just want a scrap of paper?
- **4957**: Well, I guess I'm finished rrreading this anyway. I don't think it would hurt to tear one letter out of it, so do your worst.
- **4958**: <Player> rips a letter "A" out of Ekhu Pesshyadha's book!
- **5021**: I can't stop thinking about that handsome Elvaan in his brilliantly embroidered clothing... I wish I could find out more about him...
- **5027**: To think I'd become more obsessed with Zabahf than Fernan... What's gotten into me?
- **5114**: <Sigh>... I wish I could meet a guy like Fernan...
- **5115**: Yeah, go ahead and laugh. I thought maybe Zabahf and I had something there, but...nah. Fernan is the only guy for me!
...
```
  ...
  1: 0x0002 [0x1D] PRINT_EVENT_MESSAGE(message_id=4955*)
  ...
  5: 0x000E [0x1D] PRINT_EVENT_MESSAGE(message_id=4956*)
  ...
  8: 0x0021 [0x1D] PRINT_EVENT_MESSAGE(message_id=4957*)
...
```
  0: 0x003B [0x1D] PRINT_EVENT_MESSAGE(message_id=5021*)
...
```
  0: 0x0050 [0x1D] PRINT_EVENT_MESSAGE(message_id=5027*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
00C0:                      32  07 80 1F 00 1F 80 20 80         2...... .
00D0: 0E 80 1F 01 00                                    .....           
```
...
```
  ...
  1: 0x00CA [0x1F] MOVE_ENTITY: EventEntity moves to X=-88.115*, Z=-3.431*, Y=0.000*
...
```
  ...
  2: 0x00DD [0x1D] PRINT_EVENT_MESSAGE(message_id=5115*)
...
```
  0: 0x0132 [0x1D] PRINT_EVENT_MESSAGE(message_id=5114*)
