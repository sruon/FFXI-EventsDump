...
- **9777**: This is the center for Mog Locker administration and expan--wait, you're not a mercenary, are you? Good day to you, [sir/madame].
- **9778**: This is the center for Mog Locker administration and expansion. How may I help you?
- **9779**: How may I help you? [Wait, this isn't the auction house.../Mog Locker administration./Mog Locker expansion./Mog Locker accessibility.]
- **9780**: It appears your Mog Locker lease is currently expired.
- **9781**: Your current Mog Locker lease is valid until // :: (Earth time).
- **9782**: If you wish to extend your lease, please pay the fee of 1 $8.
- **9783**: Lease extensions are valid for a period of $9 [day/days] ($2 [Earth day/Earth days]).
- **9784**: If you allow your lease to expire, you will lose access to the items stored within your Mog Locker. Please be assured that these items will not be permanently lost or confiscated.
- **9785**: Regaining access to the items in your Mog Locker simply requires you to pay the fee of 1 $8. It is also possible to pay this fee to the moogle in your Mog House.
- **9786**: Your Mog Locker can currently hold $3 [item/items].
- **9787**: Due to limited resources, this service is unavailable to customers who have recently requested a Mog Locker expansion.
- **9788**: Your Mog Locker can be expanded to hold $11 [item/items] for a fee of $4 $0$0 .
- **9789**: Your lease extension has been approved.
- **9790**: Your Mog Locker lease is now valid until // :: (Earth time).
- **9791**: Your Mog Locker expansion has been approved.
- **9792**: Your Mog locker can now hold $3 [item/items].
- **9793**: Your Mog Locker is currently available for use in Al Zahbi only.
- **9794**: It is possible to extend the availability of your Mog Locker to include the nations of San d'Oria, Bastok, Windurst, and Jeuno.
- **9795**: If you choose this option, however, the lease extension granted for the fee of 1 $8 will be reduced from $9 [day/days] (Earth time: $2 [day/days]) to $12 [day/days] (Earth time: $7 [day/days]).
- **9796**: Furthermore, the remaining time on your current lease will be reduced to $7/$2.
- **9797**: It is possible to once again restrict the availability of your Mog Locker to Al Zahbi, however the remaining time on your current lease will not be extended. The lease period will revert to the usual length starting from the following lease payment.
- **9798**: Increase Mog Locker availability? [Yes, please!/No thanks!]
- **9801**: You Mog Locker is currently accessible from the following nations: Al Zahbi, San d'Oria, Bastok, Windurst, and Jeuno
- **9802**: It is possible to once again restrict the availability of your Mog Locker to Al Zahbi.
- **9803**: If you choose this option, the lease extension granted for the fee of 1 $8 will be increased from $12 [day/days] (Earth time: $7 [day/days]) to $9 [day/days] (Earth time: $2 [day/days]).
- **9804**: Furthermore, the remaining time on your current lease will be increased to $2/$7.
- **9805**: Restrict access to Al Zahbi? [Yes./No.]
- **9807**: It is not possible to expand your Mog Locker any further, I'm afraid. A thousand pardons.
...
```
  ...
  9: 0x0031 [0x1D] PRINT_EVENT_MESSAGE(message_id=9777*)
 ...
 13: 0x0037 [0x1D] PRINT_EVENT_MESSAGE(message_id=9778*)
 ...
 15: 0x003B [0x24] CREATE_DIALOG(message_id=9779*, default_option=0*, option_flags=0*)
...
SUBROUTINE_007D:
 ...
 26: 0x0089 [0x1D] PRINT_EVENT_MESSAGE(message_id=9785*)
 ...
 30: 0x0098 [0x1D] PRINT_EVENT_MESSAGE(message_id=9786*)
 ...
 33: 0x00A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=9807*)
 ...
 37: 0x00B3 [0x1D] PRINT_EVENT_MESSAGE(message_id=9787*)
 ...
 42: 0x00C7 [0x1D] PRINT_EVENT_MESSAGE(message_id=9788*)
 ...
 47: 0x00DB [0x1D] PRINT_EVENT_MESSAGE(message_id=9788*)
    → "Your Mog Locker can be expanded to hold $11 [item/items] for a fee of $4 $0$0 ."
 ...
 52: 0x00EF [0x1D] PRINT_EVENT_MESSAGE(message_id=9788*)
    → "Your Mog Locker can be expanded to hold $11 [item/items] for a fee of $4 $0$0 ."
 ...
 57: 0x0103 [0x1D] PRINT_EVENT_MESSAGE(message_id=9788*)
    → "Your Mog Locker can be expanded to hold $11 [item/items] for a fee of $4 $0$0 ."
 ...
 62: 0x0117 [0x1D] PRINT_EVENT_MESSAGE(message_id=9788*)
    → "Your Mog Locker can be expanded to hold $11 [item/items] for a fee of $4 $0$0 ."
...
SUBROUTINE_011E:
 ...
 72: 0x0139 [0x1D] PRINT_EVENT_MESSAGE(message_id=9795*)
 ...
 78: 0x0145 [0x24] CREATE_DIALOG(message_id=9798*, default_option=1*, option_flags=0*)
...
SUBROUTINE_016D:
 ...
 87: 0x0170 [0x1D] PRINT_EVENT_MESSAGE(message_id=9801*)
 ...
 89: 0x0174 [0x1D] PRINT_EVENT_MESSAGE(message_id=9802*)
 ...
 91: 0x0178 [0x1D] PRINT_EVENT_MESSAGE(message_id=9803*)
 ...
 93: 0x017C [0x1D] PRINT_EVENT_MESSAGE(message_id=9804*)
    → "Furthermore, the remaining time on your current lease will be increased to $2/$7."
 94: 0x017F [0x23] WAIT_FOR_DIALOG_INTERACTION
 95: 0x0180 [0x24] CREATE_DIALOG(message_id=9805*, default_option=1*, option_flags=0*)
...
```
  ...
  2: 0x01BA [0x1D] PRINT_EVENT_MESSAGE(message_id=9787*)
    → "Due to limited resources, this service is unavailable to customers who have recently requested a Mog Locker expansion."
  ...
  7: 0x01C1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9791*)
    → "Your Mog Locker expansion has been approved."
  8: 0x01C4 [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x01C5 [0x1D] PRINT_EVENT_MESSAGE(message_id=9792*)
...
```
  ...
  2: 0x01D1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9789*)
    → "Your lease extension has been approved."
  3: 0x01D4 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x01D5 [0x1D] PRINT_EVENT_MESSAGE(message_id=9790*)
