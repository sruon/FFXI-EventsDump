...
- **9377**: You are a mercenary from Salaheem's Sentinels, aren't you?
- **9378**: This is just between me and you, but there are certain jobs that they don't even trust the Commissions Agency with. Would you be interested?
- **9379**: What you will be doing is extremely straightforward.
- **9380**: Go to a designated area and annihilate the enemy.
- **9381**: I don't know what the Imperial Army seeks to gain from this, and I don't ask. I'm just a middleman, nothing more.
- **9382**: I can determine whether or not you are suitable for a job based on your Imperial Standing...
- **9383**: Well, well... $0 [Imperial Standing credit/Imperial Standing credits], I see...
- **9384**: Um... Let's just pretend you never met me, all right? Fate permitting, we'll meet again someday when you're ready.
- **9385**: If you think you can handle it and you're willing to sacrifice some of your Imperial Standing, I have a number of jobs for you to attempt.
- **9386**: Which would you like to accept? [None./$2 credit[/s]: Level 60 offer/$3 credit[/s]: Level 75 offer]
- **9387**: Is that so? Too bad... Well then, please forget you ever met me.
- **9388**: Okay. Your Imperial Standing has decreased some, just like I told you it would.
- **9389**: Here, you'll need this $3.
- **9390**: This will get you through to the Jade Sepulcher, Navukgo Execution Chamber, and Talacca Cove.
- **9391**: There is no need to inform me whether you succeed or fail. You will receive your reward on site.
- **9392**: Safe travels!
- **9393**: Hey, hey... What are you doing, running off from a job? Get back out there!
- **9394**: You might be interested in me, but I'm not interested in you. Sorry.
- **9395**: I can't give you a job like that with your Imperial Standing. Forget about it, all right?
- **9396**: I don't have any offers for you at the moment, but I'll let you know when something comes up.
...
```
  ...
  4: 0x000A [0x1D] PRINT_EVENT_MESSAGE(message_id=9377*)
    → "You are a mercenary from Salaheem's Sentinels, aren't you?"
  5: 0x000D [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x000E [0x1D] PRINT_EVENT_MESSAGE(message_id=9378*)
  ...
  9: 0x0021 [0x1D] PRINT_EVENT_MESSAGE(message_id=9379*)
    → "What you will be doing is extremely straightforward."
 10: 0x0024 [0x23] WAIT_FOR_DIALOG_INTERACTION
 11: 0x0025 [0x1D] PRINT_EVENT_MESSAGE(message_id=9380*)
 ...
 15: 0x0035 [0x1D] PRINT_EVENT_MESSAGE(message_id=9381*)
 ...
 20: 0x004A [0x1D] PRINT_EVENT_MESSAGE(message_id=9382*)
 ...
 24: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=9383*)
 ...
 30: 0x0089 [0x1D] PRINT_EVENT_MESSAGE(message_id=9384*)
 ...
 35: 0x00A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=9385*)
 ...
 39: 0x00B2 [0x24] CREATE_DIALOG(message_id=9386*, default_option=0*, option_flags=0*)
 ...
 45: 0x00CF [0x1D] PRINT_EVENT_MESSAGE(message_id=9387*)
 ...
 54: 0x00F8 [0x1D] PRINT_EVENT_MESSAGE(message_id=9395*)
 ...
 58: 0x0104 [0x1D] PRINT_EVENT_MESSAGE(message_id=9388*)
 ...
 62: 0x011C [0x1D] PRINT_EVENT_MESSAGE(message_id=9389*)
 ...
 66: 0x013C [0x1D] PRINT_EVENT_MESSAGE(message_id=9390*)
 ...
 68: 0x0140 [0x1D] PRINT_EVENT_MESSAGE(message_id=9391*)
 ...
 73: 0x015F [0x1D] PRINT_EVENT_MESSAGE(message_id=9392*)
    → "Safe travels!"
...
SUBROUTINE_016D:
 ...
 83: 0x018D [0x1D] PRINT_EVENT_MESSAGE(message_id=9395*)
    → "I can't give you a job like that with your Imperial Standing. Forget about it, all right?"
 ...
 87: 0x0199 [0x1D] PRINT_EVENT_MESSAGE(message_id=9388*)
    → "Okay. Your Imperial Standing has decreased some, just like I told you it would."
 ...
 91: 0x01B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9389*)
    → "Here, you'll need this $3."
 ...
 95: 0x01D1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9390*)
    → "This will get you through to the Jade Sepulcher, Navukgo Execution Chamber, and Talacca Cove."
 96: 0x01D4 [0x23] WAIT_FOR_DIALOG_INTERACTION
 97: 0x01D5 [0x1D] PRINT_EVENT_MESSAGE(message_id=9391*)
    → "There is no need to inform me whether you succeed or fail. You will receive your reward on site."
...
102: 0x01F4 [0x1D] PRINT_EVENT_MESSAGE(message_id=9392*)
    → "Safe travels!"
...
```
  ...
  6: 0x021E [0x1D] PRINT_EVENT_MESSAGE(message_id=9393*)
...
```
  ...
  6: 0x0240 [0x1D] PRINT_EVENT_MESSAGE(message_id=9394*)
...
```
  ...
  6: 0x0262 [0x1D] PRINT_EVENT_MESSAGE(message_id=9396*)
