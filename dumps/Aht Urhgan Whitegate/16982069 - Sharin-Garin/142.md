...
SUBROUTINE_0220:
 33: 0x0220 [0x01] GOTO 0x03F2
 34: 0x0223 [0x02] IF !(Work_Zone[0] == 2*) GOTO 0x025C
 35: 0x022B [0x42] SET_CLI_EVENT_CANCEL_DATA()
 36: 0x022C [0x79] Sharin-Garin (ID: 16982069/0x01032035) looks at LocalPlayer (Basic look)
 37: 0x0236 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlb0" with entities [Sharin-Garin (ID: 16982069/0x01032035), Sharin-Garin (ID: 16982069/0x01032035)], work=34*
 38: 0x0245 [0x1D] PRINT_EVENT_MESSAGE(message_id=4644*)
    → "This Chamber of Passage was built so the Empire could send soldiers to Assault areas at a moment's notice.\u007F1\u0000\u0007"
 39: 0x0248 [0x23] WAIT_FOR_DIALOG_INTERACTION
 40: 0x0249 [0x1D] PRINT_EVENT_MESSAGE(message_id=4645*)
    → "You can use the runic portals inside to travel to a staging point in the blink of an eye.\u007F1\u0000\u0007"
 41: 0x024C [0x23] WAIT_FOR_DIALOG_INTERACTION
 42: 0x024D [0x1D] PRINT_EVENT_MESSAGE(message_id=4646*)
    → "You've got to open the way first by activating the portal at the staging point, though.\u007F1\u0000\u0007"
 43: 0x0250 [0x23] WAIT_FOR_DIALOG_INTERACTION
 44: 0x0251 [0x27] REQ_SET(priority=0x01, entity_id=Sharin-Garin (ID: 16982069/0x01032035), tag_num=0x02)
 45: 0x0258 [0x00] END_REQSTACK()

SUBROUTINE_03BE:
 46: 0x03BE [0x01] GOTO 0x03F2
 47: 0x03C1 [0x02] IF !(Work_Zone[0] == 4*) GOTO 0x03F2
 48: 0x03C9 [0x42] SET_CLI_EVENT_CANCEL_DATA()
 49: 0x03CA [0x79] Sharin-Garin (ID: 16982069/0x01032035) looks at LocalPlayer (Basic look)
 50: 0x03D4 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlb0" with entities [Sharin-Garin (ID: 16982069/0x01032035), Sharin-Garin (ID: 16982069/0x01032035)], work=34*
 51: 0x03E3 [0x1D] PRINT_EVENT_MESSAGE(message_id=4654*)
    → "If you would like information on Assault, please visit the Commissions Agency, right across the way from this building.\u007F1\u0000\u0007"
 52: 0x03E6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 53: 0x03E7 [0x27] REQ_SET(priority=0x01, entity_id=Sharin-Garin (ID: 16982069/0x01032035), tag_num=0x02)
 54: 0x03EE [0x00] END_REQSTACK()

SUBROUTINE_03F2:
 55: 0x03F2 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlb1" with entities [Sharin-Garin (ID: 16982069/0x01032035), Sharin-Garin (ID: 16982069/0x01032035)], work=34*
 56: 0x0401 [0x20] SET_CLI_EVENT_UC_FLAG: Unlock player control
 57: 0x0403 [0x21] END_EVENT
 58: 0x0404 [0x00] END_REQSTACK()
```
