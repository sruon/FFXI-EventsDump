...
- **5858**: You're a puppetmaster, right? Come on, anyone can tell!
- **5859**: What's your automaton's name?
- **5860**: If you'd rather name it something different, just pay me $1 gil and I'll help you out!
- **5861**: Rename your automaton? [I would love to./No thanks.]
- **5862**: Hmmm... How about one of these?
- **5863**: Choose your automaton's name. [ more./Cancel.]
- **5864**: Choose your automaton's name. [Nadeshiko/E100/Koume/X-32/Poppo/Asuka/Sakura/Tao/Mao/Gadget/Marion/Widget/Quirk/Sprocket/Cogette/Lecter/Coppelia/Sparky/Clank/Calcobrena/Crackle/Ricochet/Josette/Fritz/Skippy/Pino/Mandarin/Jackstraw/Guignol/Moppet/Nutcracker/Erwin/View previous./View more./Cancel.]
- **5865**: Choose your automaton's name. [Otto/Gustav/Muffin/Xaver/Toni/Ina/Gerda/Petra/Verena/Rosi/Schatzi/Warashi/Klingel/Clochette/Campanello/Kaiserin/Principessa/Butler/Graf/Caro/Cara/Mademoiselle/Herzog/Tramp/V-1000/Hikozaemon/Nine/Acht/Quattro/Zero/Dreizehn/Seize/View previous./View more./Cancel.]
- **5866**: Choose your automaton's name. [Fukusuke/Mataemon/Kansuke/Polichinelle/Tobisuke/Sasuke/Shijimi/Chobi/Aurelie/Magalie/Aurore/Caroline/Andrea/Machinette/Clarine/Armelle/Reinette/Dorlote/Turlupin/Klaxon/Bambino/Potiron/Fustige/Amidon/Machin/Bidulon/Tandem/Prestidige/Purute-Porute/Bito-Rabito/Cocoa/Totomo/View previous./View more./Cancel.]
- **5867**: Choose your automaton's name. [Centurion/A7V/Scipio/Sentinel/Pioneer/Seneschal/Ginjin/Amagatsu/Dolly/Fantoccini/Joe/Kikizaru/Whippet/Punchinello/Charlie/Midge/Petrouchka/Schneider/Ushabti/Noel/Yajirobe/Hina/Nora/Shoki/Kobina/Kokeshi/Mame/Bishop/Marvin/Dora/Data/Robin/View previous./View more./Cancel.]
- **5868**: Choose your automaton's name. [Robby/Porlo-Moperlo/Paroko-Puronko/Pipima/Gagaja/Mobil/Donzel/Archer/Shooter/Stephen/Mk.IV/Conjurer/Footman/Tokotoko/Sancho/Sarumaro/Picket/Mushroom/View previous./Cancel.]
- **5869**: You don't have enough gil! Get lost!
- **5870**: Oh, nice choice! Congratulations on your new name!
- **5872**: Are you sure this name is okay? [Yes, this is it./On second thought.../Cancel.]
- **9575**: Welcome to the Automaton Workshop! We're working busily-fizzily on automaton research! Well, Ghatsad is, anyway...
...
```
  ...
  3: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=9575*)
...
```
 ...
 11: 0x003E [0x24] CREATE_DIALOG(message_id=5861*, default_option=1*, option_flags=0*)
...
SUBROUTINE_0061:
 ...
 21: 0x006A [0x24] CREATE_DIALOG(message_id=5863*, default_option=0*, option_flags=0*)
...
SUBROUTINE_007A:
 ...
 25: 0x0083 [0x24] CREATE_DIALOG(message_id=5864*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00A1:
 ...
 30: 0x00AA [0x24] CREATE_DIALOG(message_id=5865*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00C8:
 ...
 35: 0x00D1 [0x24] CREATE_DIALOG(message_id=5866*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00EF:
 ...
 40: 0x00F8 [0x24] CREATE_DIALOG(message_id=5867*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0145:
 ...
 50: 0x0168 [0x24] CREATE_DIALOG(message_id=5872*, default_option=1*, option_flags=0*)
...
SUBROUTINE_01A1:
 58: 0x01A1 [0x1D] PRINT_EVENT_MESSAGE(message_id=5870*)
...
SUBROUTINE_01B3:
 ...
 69: 0x01D6 [0x24] CREATE_DIALOG(message_id=5872*, default_option=1*, option_flags=0*)
    → "Are you sure this name is okay? [Yes, this is it./On second thought.../Cancel.]"
...
SUBROUTINE_020F:
 77: 0x020F [0x1D] PRINT_EVENT_MESSAGE(message_id=5870*)
    → "Oh, nice choice! Congratulations on your new name!"
...
SUBROUTINE_0221:
 ...
 88: 0x0244 [0x24] CREATE_DIALOG(message_id=5872*, default_option=1*, option_flags=0*)
    → "Are you sure this name is okay? [Yes, this is it./On second thought.../Cancel.]"
...
SUBROUTINE_027D:
 96: 0x027D [0x1D] PRINT_EVENT_MESSAGE(message_id=5870*)
    → "Oh, nice choice! Congratulations on your new name!"
...
107: 0x02B2 [0x24] CREATE_DIALOG(message_id=5872*, default_option=1*, option_flags=0*)
    → "Are you sure this name is okay? [Yes, this is it./On second thought.../Cancel.]"
...
SUBROUTINE_02EB:
115: 0x02EB [0x1D] PRINT_EVENT_MESSAGE(message_id=5870*)
    → "Oh, nice choice! Congratulations on your new name!"
...
126: 0x0320 [0x24] CREATE_DIALOG(message_id=5872*, default_option=1*, option_flags=0*)
    → "Are you sure this name is okay? [Yes, this is it./On second thought.../Cancel.]"
...
SUBROUTINE_0359:
134: 0x0359 [0x1D] PRINT_EVENT_MESSAGE(message_id=5870*)
    → "Oh, nice choice! Congratulations on your new name!"
...
144: 0x038D [0x24] CREATE_DIALOG(message_id=5872*, default_option=1*, option_flags=0*)
    → "Are you sure this name is okay? [Yes, this is it./On second thought.../Cancel.]"
...
SUBROUTINE_03C6:
152: 0x03C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=5870*)
    → "Oh, nice choice! Congratulations on your new name!"
