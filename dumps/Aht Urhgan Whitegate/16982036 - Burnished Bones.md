...
- **4676**: Speak to the man at the counter if you would like to enter town.
- **4679**: This is the exit for arriving passengers.
...
```
  ...
  4: 0x0034 [0x1D] PRINT_EVENT_MESSAGE(message_id=4679*)
