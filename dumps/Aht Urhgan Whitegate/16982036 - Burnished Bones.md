...
- **4678**: Speak to the man at the counter if you would like to enter town.
- **4681**: This is the exit for arriving passengers.
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=4678*)
...
```
  ...
  1: 0x003D [0x1F] MOVE_ENTITY: EventEntity moves to X=-20.000*, Z=-93.917*, Y=0.000*
  2: 0x0045 [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x0047 [0x1F] MOVE_ENTITY: EventEntity moves to X=-17.655*, Z=-93.917*, Y=0.000*
