...
```
  ...
  5: 0x001C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="thk2")
  ...
  9: 0x003B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=34*, entity1=EventEntity, entity2=EventEntity, action="syu0")
 ...
 12: 0x004E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=34*, entity1=EventEntity, entity2=EventEntity, action="syu1")
 13: 0x005D [0x01] GOTO 0x011C

SUBROUTINE_0060:
 14: 0x0060 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x011C
 15: 0x0068 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=34*, entity1=EventEntity, entity2=EventEntity, action="tlb0")
 ...
 18: 0x007B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=34*, entity1=EventEntity, entity2=EventEntity, action="tlb1")
 ...
 22: 0x009A [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 25: 0x00AD [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 26: 0x00BC [0x01] GOTO 0x0119

SUBROUTINE_00BF:
 27: 0x00BF [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x00EC
 28: 0x00C7 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 31: 0x00DA [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 32: 0x00E9 [0x01] GOTO 0x0119

SUBROUTINE_00EC:
 33: 0x00EC [0x02] IF !(Work_Zone[0] == 2*) GOTO 0x0119
 34: 0x00F4 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 37: 0x0107 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="thk2")
