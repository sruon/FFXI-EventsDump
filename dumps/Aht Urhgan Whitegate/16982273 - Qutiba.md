...
- **4970**: No matter how many times I come here, the tea always has such an exquisite flavor. This cup is also adorable. I wonder where it was created...
- **4971**: Hm? There's something stuck on it...
- **4972**: <Player> finds a scrap of paper inscribed with the letter "A" on the bottom of Qutiba's cup!
- **6863**: You should be able to gather $0 from the beehives of the Wajaom Woodlands.
- **6886**: First, you need $0... Then mix together $1, $2, $3, and $4...
- **6889**: You can't expect me to give out the recipe for $0 every time you happen to forget it.
- **6890**: If you want to hear it again, you must bring me $0.
- **6891**: You already forgot how to make $0?
- **7292**: Just between you and me, do you feel that there may be something lacking from our fine establishment's cuisine?
- **7293**: I say the culprit is our limited selection of titillating ingredients from Aradjiah and beyond.
- **7294**: I say the culprit is our chef's refusal to step from the boundaries of traditional Aht Urhganian spices.
- **7295**: I hear the customers whisper, but I just cannot see the problem. We use only the finest ingredients....
- **9073**: Don't tell me he's done it again... When it comes to food, the boss just loses his head.
- **9123**: Well, the boss is a master culinarian after all, so I'm sure you'll find him somewhere where there's food.
- **9215**: A hearty welcome into the Epicureans...
- **9234**: We'd like to show our appreciation for your help by teaching you one of our special recipes.
- **9235**: The list of recipes we have created is quite long, but Ulamaal would like to keep them secret, so I will have to give them out bits at a time.
- **9236**: Not much time has passed since I told you the last recipe... I'm sorry, but please wait a bit longer.
- **9237**: Learn a secret recipe? [Yes, please!/Not now.]
- **9238**: A shame... I thought this would be the perfect opportunity to repay you for your kindness. Just ask anytime you would like a recipe!
- **9239**: Listen closely, now. I'm going to teach you the recipe for...oh yes, this is a good one...$0!
- **9241**: All right, got your ink and parchment ready? Here goes... Use $0 on $1, and voila! You're finished!
- **9243**: All right, got your ink and parchment ready? Here goes... First, you will need $0.
- **9245**: Then, just mix together $0 and $1, and voila! Simple as melon pie, right?
- **9247**: All right, got your ink and parchment ready? Here goes... First, you will need $0. Then, just mix together $1, $2, and $3.
- **9249**: You'll have to use four ingredients for this one--$0, $1, $2, and $3.
- **9251**: Ah, you'll also need $0, $1, and $2!
- **9253**: Ah, you'll also need $0, $1, $2, and $3!
- **9255**: I'm sorry, I nearly forgot the last ingredient...$0! That should be all. It's quite a lot, but it should be worth it just to see the look on the person's face who takes the first bite!
- **9257**: It's all up to you now! Give it your best shot!
- **9261**: Unfortunately, you don't seem to have enough skill to make it...
- **9262**: Do you have any friends who can cook? Perhaps you can ask them to help.
- **9263**: Ulamaal wants to keep the recipes a secret, but I personally would like as many people as possible to enjoy Near Eastern cuisine.
- **9265**: This recipe is quite difficult if you have no experience making confections.
- **9269**: Ah, you'll also need $0, $1, and 2 $2!
...
```
  ...
  3: 0x000C [0x1D] PRINT_EVENT_MESSAGE(message_id=4970*)
  ...
  7: 0x001C [0x1D] PRINT_EVENT_MESSAGE(message_id=4971*)
    → "Hm? There's something stuck on it..."
  8: 0x001F [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x0020 [0x48] [System] [4972*]:
...
```
  ...
  2: 0x004C [0x2B] Qutiba (ID: 16982273/0x01032101) [9059*]:
  ...
  6: 0x0066 [0x2B] Qutiba (ID: 16982273/0x01032101) [9060*]:
 ...
 10: 0x008C [0x2B] Ulamaal (ID: 16982274/0x01032102) [9061*]:
 ...
 15: 0x00AF [0x2B] Qutiba (ID: 16982273/0x01032101) [9062*]:
...
```
  ...
  7: 0x00D4 [0x1D] PRINT_EVENT_MESSAGE(message_id=9073*)
...
```
  ...
  4: 0x00F0 [0x1D] PRINT_EVENT_MESSAGE(message_id=9123*)
 ...
 10: 0x011E [0x2B] Ulamaal (ID: 16982274/0x01032102) [9124*]:
...
```
  ...
  3: 0x0141 [0x1D] PRINT_EVENT_MESSAGE(message_id=9215*)
...
```
  ...
  4: 0x014F [0x1D] PRINT_EVENT_MESSAGE(message_id=9234*)
  ...
  6: 0x0153 [0x1D] PRINT_EVENT_MESSAGE(message_id=9235*)
  ...
  9: 0x015F [0x1D] PRINT_EVENT_MESSAGE(message_id=9236*)
 ...
 12: 0x0166 [0x24] CREATE_DIALOG(message_id=9237*, default_option=0*, option_flags=0*)
    → "Learn a secret recipe? [Yes, please!/Not now.]"
 13: 0x016D [0x25] WAIT_DIALOG_SELECT()
 14: 0x016E [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x0180
 15: 0x0176 [0x1D] PRINT_EVENT_MESSAGE(message_id=9238*)
...
SUBROUTINE_0180:
 ...
 22: 0x018C [0x1D] PRINT_EVENT_MESSAGE(message_id=9239*)
 ...
 29: 0x01A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=9243*)
 ...
 35: 0x01B6 [0x1D] PRINT_EVENT_MESSAGE(message_id=9245*)
 ...
 39: 0x01C5 [0x1D] PRINT_EVENT_MESSAGE(message_id=9243*)
    → "All right, got your ink and parchment ready? Here goes... First, you will need $0."
 ...
 44: 0x01D2 [0x1D] PRINT_EVENT_MESSAGE(message_id=9249*)
 ...
 53: 0x01F4 [0x1D] PRINT_EVENT_MESSAGE(message_id=9241*)
 ...
 57: 0x0203 [0x1D] PRINT_EVENT_MESSAGE(message_id=9247*)
 ...
 62: 0x0210 [0x1D] PRINT_EVENT_MESSAGE(message_id=9253*)
 ...
 70: 0x022D [0x1D] PRINT_EVENT_MESSAGE(message_id=9247*)
    → "All right, got your ink and parchment ready? Here goes... First, you will need $0. Then, just mix together $1, $2, and $3."
 ...
 75: 0x023A [0x1D] PRINT_EVENT_MESSAGE(message_id=9253*)
    → "Ah, you'll also need $0, $1, $2, and $3!"
 ...
 81: 0x024C [0x1D] PRINT_EVENT_MESSAGE(message_id=9255*)
 ...
 85: 0x025B [0x1D] PRINT_EVENT_MESSAGE(message_id=9247*)
    → "All right, got your ink and parchment ready? Here goes... First, you will need $0. Then, just mix together $1, $2, and $3."
 ...
 91: 0x026D [0x1D] PRINT_EVENT_MESSAGE(message_id=9251*)
 ...
 95: 0x027C [0x1D] PRINT_EVENT_MESSAGE(message_id=9247*)
    → "All right, got your ink and parchment ready? Here goes... First, you will need $0. Then, just mix together $1, $2, and $3."
...
100: 0x0289 [0x1D] PRINT_EVENT_MESSAGE(message_id=9269*)
...
128: 0x02E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=9247*)
    → "All right, got your ink and parchment ready? Here goes... First, you will need $0. Then, just mix together $1, $2, and $3."
...
133: 0x02F5 [0x1D] PRINT_EVENT_MESSAGE(message_id=9253*)
    → "Ah, you'll also need $0, $1, $2, and $3!"
...
158: 0x0344 [0x1D] PRINT_EVENT_MESSAGE(message_id=9269*)
    → "Ah, you'll also need $0, $1, and 2 $2!"
...
173: 0x0372 [0x1D] PRINT_EVENT_MESSAGE(message_id=9253*)
    → "Ah, you'll also need $0, $1, $2, and $3!"
...
179: 0x0384 [0x1D] PRINT_EVENT_MESSAGE(message_id=9255*)
    → "I'm sorry, I nearly forgot the last ingredient...$0! That should be all. It's quite a lot, but it should be worth it just to see the look on the person's face who takes the first bite!"
...
196: 0x03C4 [0x1D] PRINT_EVENT_MESSAGE(message_id=9247*)
    → "All right, got your ink and parchment ready? Here goes... First, you will need $0. Then, just mix together $1, $2, and $3."
...
201: 0x03D1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9253*)
    → "Ah, you'll also need $0, $1, $2, and $3!"
...
216: 0x03FF [0x1D] PRINT_EVENT_MESSAGE(message_id=9253*)
    → "Ah, you'll also need $0, $1, $2, and $3!"
...
231: 0x042D [0x1D] PRINT_EVENT_MESSAGE(message_id=9253*)
    → "Ah, you'll also need $0, $1, $2, and $3!"
...
237: 0x043F [0x1D] PRINT_EVENT_MESSAGE(message_id=9255*)
    → "I'm sorry, I nearly forgot the last ingredient...$0! That should be all. It's quite a lot, but it should be worth it just to see the look on the person's face who takes the first bite!"
...
249: 0x0465 [0x1D] PRINT_EVENT_MESSAGE(message_id=9257*)
...
253: 0x0474 [0x1D] PRINT_EVENT_MESSAGE(message_id=9265*)
...
```
  ...
  5: 0x04CA [0x1D] PRINT_EVENT_MESSAGE(message_id=6889*)
  ...
  8: 0x04D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=6890*)
 ...
 12: 0x04DF [0x1D] PRINT_EVENT_MESSAGE(message_id=6863*)
...
```
  ...
  2: 0x04EF [0x1D] PRINT_EVENT_MESSAGE(message_id=6891*)
 ...
 16: 0x053B [0x2B] Qutiba (ID: 16982273/0x01032101) [6888*]:
...
```
  ...
  2: 0x057B [0x1D] PRINT_EVENT_MESSAGE(message_id=7292*)
  ...
  6: 0x0596 [0x1D] PRINT_EVENT_MESSAGE(message_id=7293*)
 ...
 11: 0x05B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7294*)
 ...
 16: 0x05D2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7295*)
