...
```
  ...
  4: 0x03E1 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  ...
  7: 0x03F4 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
  8: 0x0403 [0x01] GOTO 0x0428

SUBROUTINE_0406:
  9: 0x0406 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 12: 0x0419 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 ...
 19: 0x0445 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
...
SUBROUTINE_0484:
 35: 0x0484 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x04AB
 36: 0x048C [0x6E] EventEntity uses emote 19*
 37: 0x0493 [0x99] Wait for EventEntity animation to complete
 38: 0x0498 [0x1D] PRINT_EVENT_MESSAGE(message_id=14242*)
    → "Did I rrrub you the wrong way? Oh well, come back when you set your fur straight.\u007F1\u0000\u0007"
 39: 0x049B [0x23] WAIT_FOR_DIALOG_INTERACTION
 40: 0x049C [0x99] Wait for EventEntity animation to complete
 41: 0x04A1 [0x03] Work_Zone[1] = 4*
 42: 0x04A6 [0x21] END_EVENT
 43: 0x04A7 [0x00] END_REQSTACK()

SUBROUTINE_04AB:
 44: 0x04AB [0x21] END_EVENT
 45: 0x04AC [0x00] END_REQSTACK()
```
