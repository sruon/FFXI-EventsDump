...
- **4609**: Enter "The Pit"? [Let the games begin!/Not right now.]
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=4609*, default_option=1*, option_flags=0*)
