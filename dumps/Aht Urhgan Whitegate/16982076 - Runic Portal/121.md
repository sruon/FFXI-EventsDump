...
```
  ...
  9: 0x092C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 ...
 13: 0x094A [0x45] LOAD_SCHEDULED_TASK(work_offset1=217*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z50a", work_offset2=0*)
 14: 0x095B [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="1pb2")
 15: 0x0968 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 ...
 19: 0x098A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blon", work_offset2=0*)
 20: 0x099B [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blon", work_offset2=0*)
 21: 0x09AC [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
 22: 0x09BD [0x45] LOAD_SCHEDULED_TASK(work_offset1=217*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z50b", work_offset2=0*)
 23: 0x09CE [0x27] REQ_SET(priority=0x01, entity_id=LocalPlayer, tag_num=0x04)
 24: 0x09D5 [0x1C] WAIT(150* ticks)
 25: 0x09D8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who1", work_offset2=0*)
 26: 0x09E9 [0x55] WAIT_LOAD_SCHEDULER(work_offset=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who1")
 27: 0x09F8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo0", work_offset2=0*)
 28: 0x0A09 [0x1C] WAIT(30* ticks)
 29: 0x0A0C [0x30] SET_UCOFF_CONTINUE_ZERO()
 30: 0x0A0D [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="whi1", work_offset2=0*)
 31: 0x0A1E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blof", work_offset2=0*)
