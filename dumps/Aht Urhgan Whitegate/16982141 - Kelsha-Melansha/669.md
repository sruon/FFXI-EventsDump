...
```
  ...
  4: 0x0016 [0x5B] LOAD_EXT_SCHEDULER(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="wai0")
  ...
  9: 0x002D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=34*, entity1=EventEntity, entity2=EventEntity, action="tlb0")
 ...
 16: 0x0048 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=34*, entity1=EventEntity, entity2=EventEntity, action="tlb1")
 17: 0x0057 [0x01] GOTO 0x00A6

SUBROUTINE_005A:
 18: 0x005A [0x02] IF !(ExtData[1]->WorkLocal[0] == 1*) GOTO 0x00A6
 19: 0x0062 [0x5B] LOAD_EXT_SCHEDULER(work_offset=40*, entity1=EventEntity, entity2=EventEntity, action="wai0")
 ...
 24: 0x0079 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=34*, entity1=EventEntity, entity2=EventEntity, action="tlb0")
 ...
 31: 0x0094 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=34*, entity1=EventEntity, entity2=EventEntity, action="tlb1")
