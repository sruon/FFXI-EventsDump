...
SUBROUTINE_0104:
 40: 0x0104 [0x03] ExtData[1]->WorkLocal[7] = Work_Zone[0]
 41: 0x0109 [0x03] Work_Zone_1700[22] = Work_Zone[0]
 42: 0x010E [0x2B] Ohsi Shomahl (ID: 16982454/0x010321B6) [9764*]:
 ...
 43: 0x0115 [0x23] WAIT_FOR_DIALOG_INTERACTION
 44: 0x0116 [0x24] CREATE_DIALOG(message_id=9769*, default_option=0*, option_flags=0*)
    → "This is the song you request?\u0007\u000BThat's the one!\u0007Let me see the list again...\u007F1\u0000\u0007"
 45: 0x011D [0x25] WAIT_DIALOG_SELECT()
 46: 0x011E [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x012C
 47: 0x0126 [0x01] GOTO 0x00EE

SUBROUTINE_0158:
 48: 0x0158 [0x03] ExtData[1]->WorkLocal[8] = Work_Zone[0]
 49: 0x015D [0x03] Work_Zone_1700[22] = Work_Zone[0]
 50: 0x0162 [0x2B] Ohsi Shomahl (ID: 16982454/0x010321B6) [9766*]:
 ...
 51: 0x0169 [0x23] WAIT_FOR_DIALOG_INTERACTION
 52: 0x016A [0x24] CREATE_DIALOG(message_id=9769*, default_option=0*, option_flags=0*)
    → "This is the song you request?\u0007\u000BThat's the one!\u0007Let me see the list again...\u007F1\u0000\u0007"
 53: 0x0171 [0x25] WAIT_DIALOG_SELECT()
 54: 0x0172 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x0180
 55: 0x017A [0x01] GOTO 0x0142

SUBROUTINE_01AC:
 56: 0x01AC [0x03] ExtData[1]->WorkLocal[9] = Work_Zone[0]
 57: 0x01B1 [0x03] Work_Zone_1700[22] = Work_Zone[0]
 58: 0x01B6 [0x2B] Ohsi Shomahl (ID: 16982454/0x010321B6) [9768*]:
 ...
 60: 0x01BE [0x24] CREATE_DIALOG(message_id=9769*, default_option=0*, option_flags=0*)
    → "This is the song you request?\u0007\u000BThat's the one!\u0007Let me see the list again...\u007F1\u0000\u0007"
 61: 0x01C5 [0x25] WAIT_DIALOG_SELECT()
 62: 0x01C6 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x01D4
 63: 0x01CE [0x01] GOTO 0x0196
```
