...
```
  ...
  2: 0xE241 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  3: 0xE252 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 20: 0xE2BA [0x45] LOAD_SCHEDULED_TASK(work_offset1=255*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s055", work_offset2=0*)
 21: 0xE2CB [0x01] GOTO 0xE2FB

SUBROUTINE_E2CE:
 22: 0xE2CE [0x02] IF !(LocalPlayer->Race == 6*) GOTO 0xE2EA
 23: 0xE2D6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=255*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s055", work_offset2=0*)
 24: 0xE2E7 [0x01] GOTO 0xE2FB

SUBROUTINE_E2EA:
 25: 0xE2EA [0x45] LOAD_SCHEDULED_TASK(work_offset1=255*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s054", work_offset2=0*)
 26: 0xE2FB [0x01] GOTO 0xE30F

SUBROUTINE_E2FE:
 27: 0xE2FE [0x45] LOAD_SCHEDULED_TASK(work_offset1=255*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s057", work_offset2=0*)
 ...
 31: 0xE322 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 ...
 39: 0xE357 [0x45] LOAD_SCHEDULED_TASK(work_offset1=255*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s057", work_offset2=0*)
