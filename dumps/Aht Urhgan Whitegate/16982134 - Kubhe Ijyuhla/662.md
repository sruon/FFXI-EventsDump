...
```
  ...
  2: 0x0009 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=55*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  ...
  5: 0x001C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=55*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
  6: 0x002B [0x1C] WAIT(30* ticks)
  7: 0x002E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=54*, entity1=EventEntity, entity2=EventEntity, action="ang0")
