...
```
  0: 0x00F7 [0x5F] MULTI_HANDLER_COMPLEX(mode=0x06 - Load ext scheduler with flag (OpCode 0x5B mode 1, flag 1), ref=References[8], entity1=EventEntity, entity2=EventEntity, string="tlk1", extra=References[10])
