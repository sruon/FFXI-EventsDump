...
```
 ...
 21: 0x0067 [0x24] CREATE_DIALOG(message_id=8062*, default_option=ExtData[1]->WorkLocal[7], option_flags=0*)
    → "Proceed?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
 22: 0x006E [0x25] WAIT_DIALOG_SELECT()
 23: 0x006F [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0083
 24: 0x0077 [0x06] ExtData[1]->WorkLocal[7] = 0
 25: 0x007A [0x48] [System] [8069*]:
