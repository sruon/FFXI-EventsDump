...
SUBROUTINE_0113:
 50: 0x0113 [0x24] CREATE_DIALOG(message_id=7925*, default_option=0*, option_flags=0x1003)
...
SUBROUTINE_0142:
 58: 0x0142 [0x24] CREATE_DIALOG(message_id=7926*, default_option=0*, option_flags=0x1004)
...
SUBROUTINE_0171:
 66: 0x0171 [0x24] CREATE_DIALOG(message_id=7927*, default_option=0*, option_flags=0x1005)
...
SUBROUTINE_01A0:
 74: 0x01A0 [0x24] CREATE_DIALOG(message_id=7928*, default_option=0*, option_flags=0x1006)
    → "Which memory do you wish to have recalled?\u0007\u000BNone.\u007F1\u0000\u0007"
...
SUBROUTINE_01CF:
 82: 0x01CF [0x24] CREATE_DIALOG(message_id=7929*, default_option=0*, option_flags=0x1007)
    → "Which memory do you wish to have recalled?\u0007\u000BNone.\u007F1\u0000\u0007"
