...
```
 ...
 15: 0x4477 [0x45] LOAD_SCHEDULED_TASK(work_offset1=622*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s106", work_offset2=0*)
 16: 0x4488 [0x1A] CALL_SUBROUTINE(address=0x0043)
 17: 0x448B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Chalvava (ID: 17834304/0x01102140), entity2=Chalvava (ID: 17834304/0x01102140), action="tlk0")
 ...
 21: 0x44A7 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Chalvava (ID: 17834304/0x01102140), entity2=Chalvava (ID: 17834304/0x01102140), action="tlk1")
 ...
 25: 0x44D2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=622*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s117", work_offset2=0*)
 26: 0x44E3 [0x01] GOTO 0x4513

SUBROUTINE_44E6:
 27: 0x44E6 [0x02] IF !(LocalPlayer->Race == 6*) GOTO 0x4502
 28: 0x44EE [0x45] LOAD_SCHEDULED_TASK(work_offset1=622*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s117", work_offset2=0*)
 29: 0x44FF [0x01] GOTO 0x4513

SUBROUTINE_4502:
 30: 0x4502 [0x45] LOAD_SCHEDULED_TASK(work_offset1=622*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s116", work_offset2=0*)
 ...
 36: 0x4541 [0x45] LOAD_SCHEDULED_TASK(work_offset1=622*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s118", work_offset2=0*)
 ...
 54: 0x45C3 [0x5B] LOAD_EXT_SCHEDULER(work_offset=2878*, entity1=Chalvava (ID: 17834304/0x01102140), entity2=Chalvava (ID: 17834304/0x01102140), action="tma1")
 55: 0x45D2 [0x5B] LOAD_EXT_SCHEDULER(work_offset=3245*, entity1=Unnamed NPC (ID: 17834355/0x01102173), entity2=Unnamed NPC (ID: 17834355/0x01102173), action="tar1")
 56: 0x45E1 [0x01] GOTO 0x462B

SUBROUTINE_45E4:
 57: 0x45E4 [0x02] IF !(LocalPlayer->Race == 6*) GOTO 0x460D
 58: 0x45EC [0x5B] LOAD_EXT_SCHEDULER(work_offset=2878*, entity1=Chalvava (ID: 17834304/0x01102140), entity2=Chalvava (ID: 17834304/0x01102140), action="tma1")
 59: 0x45FB [0x5B] LOAD_EXT_SCHEDULER(work_offset=3245*, entity1=Unnamed NPC (ID: 17834355/0x01102173), entity2=Unnamed NPC (ID: 17834355/0x01102173), action="tar1")
 60: 0x460A [0x01] GOTO 0x462B

SUBROUTINE_460D:
 61: 0x460D [0x5B] LOAD_EXT_SCHEDULER(work_offset=2878*, entity1=Chalvava (ID: 17834304/0x01102140), entity2=Chalvava (ID: 17834304/0x01102140), action="tma0")
 62: 0x461C [0x5B] LOAD_EXT_SCHEDULER(work_offset=3245*, entity1=Unnamed NPC (ID: 17834355/0x01102173), entity2=Unnamed NPC (ID: 17834355/0x01102173), action="tar0")
 63: 0x462B [0x48] [System] [7897*]:
    → "\u007F4\u0001\u0000\u0007"
 64: 0x462E [0x23] WAIT_FOR_DIALOG_INTERACTION
 65: 0x462F [0x45] LOAD_SCHEDULED_TASK(work_offset1=622*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s119", work_offset2=0*)
 ...
 70: 0x465D [0x45] LOAD_SCHEDULED_TASK(work_offset1=622*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s193", work_offset2=0*)
 71: 0x466E [0x01] GOTO 0x469E

SUBROUTINE_4671:
 72: 0x4671 [0x02] IF !(LocalPlayer->Race == 6*) GOTO 0x468D
 73: 0x4679 [0x45] LOAD_SCHEDULED_TASK(work_offset1=622*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s193", work_offset2=0*)
 74: 0x468A [0x01] GOTO 0x469E

SUBROUTINE_468D:
 75: 0x468D [0x45] LOAD_SCHEDULED_TASK(work_offset1=622*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s192", work_offset2=0*)
...
SUBROUTINE_46AC:
 ...
 83: 0x46D2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=622*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s118", work_offset2=0*)
 84: 0x46E3 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Chalvava (ID: 17834304/0x01102140), entity2=Chalvava (ID: 17834304/0x01102140), action="dis0")
...
SUBROUTINE_4700:
 ...
 98: 0x4732 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
