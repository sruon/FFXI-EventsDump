...
| [321](#event-321)        | 0x0001       |    345 |             41 |
| [327](#event-327)        | 0x015A       |      5 |              2 |
| [65535.1](#event-655351) | 0x015F       |      5 |              2 |
...
```
 ...
 10: 0x0051 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s047" with entities [LocalPlayer, LocalPlayer], work=[558*, 0*]
 ...
 17: 0x0082 [0x24] CREATE_DIALOG(message_id=7935*, default_option=0*, option_flags=0*)
 ...
 25: 0x00C5 [0x2B] Chalvava (ID: 17834304/0x01102140) [7936*]:
 ...
 30: 0x00FC [0x2B] Chalvava (ID: 17834304/0x01102140) [7937*]:
...
```
  0: 0x015A [0xB6] ENTITY_APPEARANCE_HANDLER(case=Hair style, value=102*)
...
```
  0: 0x015F [0xB6] ENTITY_APPEARANCE_HANDLER(case=Hair style, value=50*)
