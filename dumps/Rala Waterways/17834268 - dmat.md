...
- **7554**: Main Menu [Quest flags./Key items.]
- **7555**: Quest flags [Back./All (operation unverified).]
- **7556**: Quest flag operation [Back./Zero clear.]
- **7557**: Key items [Back./All (operation unverified).]
- **7559**: Key items operation [Back./Delete all.]
...
SUBROUTINE_002C:
  7: 0x002C [0x24] CREATE_DIALOG(message_id=7555*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0052:
 13: 0x0052 [0x24] CREATE_DIALOG(message_id=7556*, default_option=0*, option_flags=0*)
...
SUBROUTINE_008C:
 19: 0x008C [0x24] CREATE_DIALOG(message_id=7557*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00C2:
 27: 0x00C2 [0x24] CREATE_DIALOG(message_id=7559*, default_option=0*, option_flags=0*)
