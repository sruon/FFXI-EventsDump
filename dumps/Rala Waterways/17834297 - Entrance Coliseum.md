...
```
 ...
 21: 0x0067 [0x24] CREATE_DIALOG(message_id=8063*, default_option=ExtData[1]->WorkLocal[7], option_flags=0*)
    → "Proceed? [Yes./No.]"
 22: 0x006E [0x25] WAIT_DIALOG_SELECT()
 23: 0x006F [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0083
 24: 0x0077 [0x06] ExtData[1]->WorkLocal[7] = 0
 25: 0x007A [0x48] [System] [8070*]:
...
```
 ...
 11: 0x00D8 [0x24] CREATE_DIALOG(message_id=8082*, default_option=0*, option_flags=ExtData[1]->WorkLocal[15])
