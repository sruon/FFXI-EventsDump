...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0010:    6E AF 32 03 01 04 80  99 AF 32 03 01 00         n.2......2...  
```

#### Opcodes

```
  0: 0x0011 [0x6E] Sajalda (ID: 16986799/0x010332AF) uses emote 43*
  1: 0x0018 [0x99] Wait for Sajalda (ID: 16986799/0x010332AF) animation to complete
