...
0040: 01 82 32 03 01 92 01 80  32 03 01 94 01 F0 FF FF  ..2.....2.......
0050: 7F BA F0 FF FF 7F 05 80  06 80 07 80 08 80 27 10  ..............'.
0060: 82 32 03 01 01 27 10 80  32 03 01 01 80 82 32 03  .2...'..2.....2.
0070: 01 80 80 32 03 01 27 10  83 32 03 01 01 80 F0 FF  ...2..'..2......
0080: FF 7F BA F0 FF FF 7F 09  80 0A 80 0B 80 0C 80 4B  ...............K
0090: F0 FF FF 7F 0D 80 BA 83  32 03 01 0E 80 0F 80 10  ........2.......
00A0: 80 11 80 80 83 32 03 01  94 01 83 32 03 01 73 12  .....2.....2..s.
00B0: 80 83 32 03 01 F0 FF FF  7F 1C 13 80 29 10 F0 FF  ..2.........)...
00C0: FF 7F 25 02 02 10 00 80  80 05 01 45 14 80 F0 FF  ..%........E....
00D0: FF 7F F0 FF FF 7F 68 75  6D 35 02 80 1A F2 13 27  ......hum5.....'
00E0: 10 F0 FF FF 7F 38 2B 80  32 03 01 15 80 2A 10 F0  .....8+.2....*..
...
0120: 13 27 10 F0 FF FF 7F 38  2B 80 32 03 01 15 80 2A  .'.....8+.2....*
...
0160: 1A F2 13 27 10 F0 FF FF  7F 38 2B 80 32 03 01 15  ...'.....8+.2...
...
01A0: 02 80 1A F2 13 27 10 F0  FF FF 7F 38 2B 80 32 03  .....'.....8+.2.
...
01E0: 72 35 02 80 1A F2 13 27  10 F0 FF FF 7F 38 2B 80  r5.....'.....8+.
...
0230: 2B 80 32 03 01 15 80 2A  10 F0 FF FF 7F 55 14 80  +.2....*.....U..
...
0270: 7F 38 2B 80 32 03 01 15  80 2A 10 F0 FF FF 7F 55  .8+.2....*.....U
...
02B0: FF FF 7F 38 2B 80 32 03  01 15 80 2A 10 F0 FF FF  ...8+.2....*....
...
```
  ...
  5: 0x0013 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 ...
 15: 0x003F [0x92] Clavauert (ID: 16986754/0x01033282)->Render.Flags3 ^= 0x01
 16: 0x0045 [0x92] Salwa-Molwa (ID: 16986752/0x01033280)->Render.Flags3 ^= 0x01
 ...
 19: 0x005E [0x27] REQ_SET(priority=0x10, entity_id=Clavauert (ID: 16986754/0x01033282), tag_num=0x01)
 20: 0x0065 [0x27] REQ_SET(priority=0x10, entity_id=Salwa-Molwa (ID: 16986752/0x01033280), tag_num=0x01)
 21: 0x006C [0x80] LOAD_WAIT(entity=Clavauert (ID: 16986754/0x01033282))
 22: 0x0071 [0x80] LOAD_WAIT(entity=Salwa-Molwa (ID: 16986752/0x01033280))
 23: 0x0076 [0x27] REQ_SET(priority=0x10, entity_id=Unnamed NPC (ID: 16986755/0x01033283), tag_num=0x01)
 ...
 26: 0x008F [0x4B] UPDATE_ENTITY_YAW(entity=LocalPlayer, yaw=5.62°*)
 27: 0x0096 [0xBA] SET_ENTITY_POSITION(entity_id=Unnamed NPC (ID: 16986755/0x01033283), pos_x=686.444*, pos_z=206.921*, pos_y=-15.749*, direction=176.9°*)
 28: 0x00A3 [0x80] LOAD_WAIT(entity=Unnamed NPC (ID: 16986755/0x01033283))
 29: 0x00A8 [0x94] Unnamed NPC (ID: 16986755/0x01033283)->Render.Flags3 ^= 0x01
 30: 0x00AE [0x73] Unnamed NPC (ID: 16986755/0x01033283) casts magic 253* on LocalPlayer
 ...
 34: 0x00CB [0x45] LOAD_SCHEDULED_TASK(work_offset1=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="hum5", work_offset2=0*)
 35: 0x00DC [0x1A] CALL_SUBROUTINE(address=0x13F2)
 36: 0x00DF [0x27] REQ_SET(priority=0x10, entity_id=LocalPlayer, tag_num=0x38)
 37: 0x00E6 [0x2B] Salwa-Molwa (ID: 16986752/0x01033280) [8225*]:
 ...
 39: 0x00F3 [0x55] WAIT_LOAD_SCHEDULER(work_offset=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="hum5")
 40: 0x0102 [0x01] GOTO 0x02D3

SUBROUTINE_0105:
 41: 0x0105 [0x02] IF !(Work_Zone[2] == 2*) GOTO 0x0147
 42: 0x010D [0x45] LOAD_SCHEDULED_TASK(work_offset1=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="hmf5", work_offset2=0*)
 43: 0x011E [0x1A] CALL_SUBROUTINE(address=0x13F2)
 44: 0x0121 [0x27] REQ_SET(priority=0x10, entity_id=LocalPlayer, tag_num=0x38)
 45: 0x0128 [0x2B] Salwa-Molwa (ID: 16986752/0x01033280) [8225*]:
    → "And I'd bet my grandma's subligar that it was the same one that put us to sleep!\u0000\u0007"
 46: 0x012F [0x2A] GET_REQ_LEVEL(level=16, entity_id=LocalPlayer)
 47: 0x0135 [0x55] WAIT_LOAD_SCHEDULER(work_offset=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="hmf5")
 48: 0x0144 [0x01] GOTO 0x02D3

SUBROUTINE_0147:
 49: 0x0147 [0x02] IF !(Work_Zone[2] == 3*) GOTO 0x0189
 50: 0x014F [0x45] LOAD_SCHEDULED_TASK(work_offset1=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="elm5", work_offset2=0*)
 51: 0x0160 [0x1A] CALL_SUBROUTINE(address=0x13F2)
 52: 0x0163 [0x27] REQ_SET(priority=0x10, entity_id=LocalPlayer, tag_num=0x38)
 53: 0x016A [0x2B] Salwa-Molwa (ID: 16986752/0x01033280) [8225*]:
    → "And I'd bet my grandma's subligar that it was the same one that put us to sleep!\u0000\u0007"
 54: 0x0171 [0x2A] GET_REQ_LEVEL(level=16, entity_id=LocalPlayer)
 55: 0x0177 [0x55] WAIT_LOAD_SCHEDULER(work_offset=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="elm5")
 56: 0x0186 [0x01] GOTO 0x02D3

SUBROUTINE_0189:
 57: 0x0189 [0x02] IF !(Work_Zone[2] == 4*) GOTO 0x01CB
 58: 0x0191 [0x45] LOAD_SCHEDULED_TASK(work_offset1=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="elf5", work_offset2=0*)
 59: 0x01A2 [0x1A] CALL_SUBROUTINE(address=0x13F2)
 60: 0x01A5 [0x27] REQ_SET(priority=0x10, entity_id=LocalPlayer, tag_num=0x38)
 61: 0x01AC [0x2B] Salwa-Molwa (ID: 16986752/0x01033280) [8225*]:
    → "And I'd bet my grandma's subligar that it was the same one that put us to sleep!\u0000\u0007"
 62: 0x01B3 [0x2A] GET_REQ_LEVEL(level=16, entity_id=LocalPlayer)
 63: 0x01B9 [0x55] WAIT_LOAD_SCHEDULER(work_offset=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="elf5")
 64: 0x01C8 [0x01] GOTO 0x02D3

SUBROUTINE_01CB:
 65: 0x01CB [0x02] IF !(Work_Zone[2] == 5*) GOTO 0x020D
 66: 0x01D3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="tar5", work_offset2=0*)
 67: 0x01E4 [0x1A] CALL_SUBROUTINE(address=0x13F2)
 68: 0x01E7 [0x27] REQ_SET(priority=0x10, entity_id=LocalPlayer, tag_num=0x38)
 69: 0x01EE [0x2B] Salwa-Molwa (ID: 16986752/0x01033280) [8225*]:
    → "And I'd bet my grandma's subligar that it was the same one that put us to sleep!\u0000\u0007"
 70: 0x01F5 [0x2A] GET_REQ_LEVEL(level=16, entity_id=LocalPlayer)
 71: 0x01FB [0x55] WAIT_LOAD_SCHEDULER(work_offset=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="tar5")
 72: 0x020A [0x01] GOTO 0x02D3

SUBROUTINE_020D:
 73: 0x020D [0x02] IF !(Work_Zone[2] == 6*) GOTO 0x024F
 74: 0x0215 [0x45] LOAD_SCHEDULED_TASK(work_offset1=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="tar5", work_offset2=0*)
 75: 0x0226 [0x1A] CALL_SUBROUTINE(address=0x13F2)
 76: 0x0229 [0x27] REQ_SET(priority=0x10, entity_id=LocalPlayer, tag_num=0x38)
 77: 0x0230 [0x2B] Salwa-Molwa (ID: 16986752/0x01033280) [8225*]:
    → "And I'd bet my grandma's subligar that it was the same one that put us to sleep!\u0000\u0007"
 78: 0x0237 [0x2A] GET_REQ_LEVEL(level=16, entity_id=LocalPlayer)
 79: 0x023D [0x55] WAIT_LOAD_SCHEDULER(work_offset=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="tar5")
 80: 0x024C [0x01] GOTO 0x02D3

SUBROUTINE_024F:
 81: 0x024F [0x02] IF !(Work_Zone[2] == 7*) GOTO 0x0291
 82: 0x0257 [0x45] LOAD_SCHEDULED_TASK(work_offset1=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="mit5", work_offset2=0*)
 83: 0x0268 [0x1A] CALL_SUBROUTINE(address=0x13F2)
 84: 0x026B [0x27] REQ_SET(priority=0x10, entity_id=LocalPlayer, tag_num=0x38)
 85: 0x0272 [0x2B] Salwa-Molwa (ID: 16986752/0x01033280) [8225*]:
    → "And I'd bet my grandma's subligar that it was the same one that put us to sleep!\u0000\u0007"
 86: 0x0279 [0x2A] GET_REQ_LEVEL(level=16, entity_id=LocalPlayer)
 87: 0x027F [0x55] WAIT_LOAD_SCHEDULER(work_offset=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="mit5")
 88: 0x028E [0x01] GOTO 0x02D3

SUBROUTINE_0291:
 89: 0x0291 [0x02] IF !(Work_Zone[2] == 8*) GOTO 0x02D3
 90: 0x0299 [0x45] LOAD_SCHEDULED_TASK(work_offset1=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="gal5", work_offset2=0*)
 91: 0x02AA [0x1A] CALL_SUBROUTINE(address=0x13F2)
 92: 0x02AD [0x27] REQ_SET(priority=0x10, entity_id=LocalPlayer, tag_num=0x38)
 93: 0x02B4 [0x2B] Salwa-Molwa (ID: 16986752/0x01033280) [8225*]:
    → "And I'd bet my grandma's subligar that it was the same one that put us to sleep!\u0000\u0007"
 94: 0x02BB [0x2A] GET_REQ_LEVEL(level=16, entity_id=LocalPlayer)
 95: 0x02C1 [0x55] WAIT_LOAD_SCHEDULER(work_offset=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="gal5")
 96: 0x02D0 [0x01] GOTO 0x02D3

SUBROUTINE_02D3:
 97: 0x02D3 [0x1A] CALL_SUBROUTINE(address=0x1413)
 98: 0x02D6 [0x1C] WAIT(30* ticks)
 99: 0x02D9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=282*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="0blf", work_offset2=0*)
...
115: 0x0318 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
