...
- **7326**: Sprinkle some salt on the tablet? [Yes./No.]
- **7327**: The stone tablet quickly absorbs the salt and begins giving off a metallic grating sound...
- **7328**: The salt grains patter against the stone tablet and scatter all over the ground. You could have sworn hearing the tinkling sound of a bell...
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=7326*, default_option=1*, option_flags=0*)
