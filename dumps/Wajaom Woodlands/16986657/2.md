...
SUBROUTINE_0039:
 ...
 29: 0x0083 [0x45] LOAD_SCHEDULED_TASK(work_offset1=258*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="od00", work_offset2=0*)
 30: 0x0094 [0x1A] CALL_SUBROUTINE(address=0x02E6)
 31: 0x0097 [0x1C] WAIT(150* ticks)
 32: 0x009A [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "ssit" for entities [LocalPlayer, LocalPlayer]
 33: 0x00A7 [0x52] END_LOAD_SCHEDULER: End scheduler "od00" with entities [LocalPlayer, LocalPlayer], work=258*
 34: 0x00B6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=258*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="od02", work_offset2=0*)
 ...
 38: 0x00E0 [0x55] WAIT_LOAD_SCHEDULER(work_offset=258*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="od02")
 39: 0x00EF [0x45] LOAD_SCHEDULED_TASK(work_offset1=258*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="od03", work_offset2=0*)
 40: 0x0100 [0x55] WAIT_LOAD_SCHEDULER(work_offset=258*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="od03")
 41: 0x010F [0x45] LOAD_SCHEDULED_TASK(work_offset1=258*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="od01", work_offset2=0*)
 ...
 49: 0x0143 [0x45] LOAD_SCHEDULED_TASK(work_offset1=258*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="0blf", work_offset2=0*)
 ...
 54: 0x015F [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
