...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
01E0:                   32 0B  80 1F 00 33 80 34 80 35        2....3.4.5
...
```
  0: 0x01E6 [0x32] ExtData[1]->MainSpeed = 40* * 0.1
  1: 0x01E9 [0x1F] MOVE_ENTITY: EventEntity moves to X=-106.147*, Z=34.166*, Y=-5.999*
