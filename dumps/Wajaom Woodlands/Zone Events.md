...
- **7333**: Choose a picture to take.
- **7334**: First scene.
- **7335**: Second scene.
- **7336**: Third scene.
- **7337**: Which picture will you take? [Show me again./First scene./Second scene./Third scene.]
- **7338**: <Player> records the first scene.
- **7339**: <Player> records the second scene.
- **7340**: <Player> records the third scene.
- **7341**: <Player> takes in the surrounding scenery. ...The view is breathtaking.
- **7342**: <Player> thinks back on Balakaf's words. ...Perhaps this is not the best time to record a picture.
- **7361**: The $0 is gone!
- **7368**: Did you? [Yes, I told him./How should I remember?]
- **7391**: Return to headquarters? [It's time to go./No, I can't leave you!]
- **7421**: Nothing happens. Could the power of the ruins have been drained...?
...
```
 ...
 32: 0x018A [0x48] [System] [7336*]:
    → "Third scene."
 33: 0x018D [0x23] WAIT_FOR_DIALOG_INTERACTION
 34: 0x018E [0x24] CREATE_DIALOG(message_id=7337*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0D05:
189: 0x0D05 [0x24] CREATE_DIALOG(message_id=7391*, default_option=0*, option_flags=0*)
