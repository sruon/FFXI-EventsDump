...
- **7758**: 6... A single fragment of light. The way in which it shines suggests that it is resonating with something...
- **7759**: Do you remove the $3? [Yes./No.]
- **7777**: The $3 begins to glow.
...
```
  ...
  3: 0x000E [0x24] CREATE_DIALOG(message_id=7759*, default_option=0*, option_flags=0*)
...
```
  ...
  1: 0x0031 [0x48] [System] [7758*]:
    → "6... A single fragment of light. The way in which it shines suggests that it is resonating with something..."
  2: 0x0034 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0035 [0x24] CREATE_DIALOG(message_id=7759*, default_option=0*, option_flags=0*)
    → "Do you remove the $3? [Yes./No.]"
...
0080: 66 64 69 32 02 80 27 10  2F 92 07 01 02 1C 07 80  fdi2..'./.......
0090: 62 08 80 31 92 07 01 31  92 07 01 6D 61 69 6E 02  b..1...1...main.
00A0: 80 03 02 10 09 80 48 0A  80 23 62 08 80 31 92 07  ......H..#b..1..
00B0: 01 31 92 07 01 6D 61 69  31 02 80 1C 0B 80 2C 2F  .1...mai1.....,/
00C0: 92 07 01 2F 92 07 01 64  65 61 64 29 10 2F 92 07  .../...dead)./..
00D0: 01 03 1C 0C 80 62 0D 80  30 92 07 01 30 92 07 01  .....b..0...0...
00E0: 6D 61 69 6E 02 80 1C 0E  80 79 00 F0 FF FF 7F 30  main.....y.....0
...
```
  ...
  8: 0x0086 [0x27] REQ_SET(priority=0x10, entity_id=ScenarioBoss (ID: 17273391/0x0107922F), tag_num=0x02)
 ...
 16: 0x00BE [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "dead" with entities [ScenarioBoss (ID: 17273391/0x0107922F), ScenarioBoss (ID: 17273391/0x0107922F)]
 17: 0x00CB [0x29] REQ_SET_WAIT(priority=0x10, entity_id=ScenarioBoss (ID: 17273391/0x0107922F), tag_num=0x03)
 18: 0x00D2 [0x1C] WAIT(90* ticks)
 19: 0x00D5 [0x62] LOAD_EVENT_SCHEDULER: Load scheduler "main" with entities [Unnamed NPC (ID: 17273392/0x01079230), Unnamed NPC (ID: 17273392/0x01079230)], work=[3*, 0*]
 20: 0x00E6 [0x1C] WAIT(30* ticks)
 21: 0x00E9 [0x79] LocalPlayer looks at Unnamed NPC (ID: 17273392/0x01079230) (Basic look)
