...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=7756*, default_option=1*, option_flags=0*)
 ...
 10: 0x0031 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
