...
```
  ...
  5: 0x0020 [0x1D] PRINT_EVENT_MESSAGE(message_id=6888*)
    → "Hah hah! I'm flattered, but I don't thinky-wink you need me now.\u007F1\u0000\u0007"
  6: 0x0023 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0024 [0x01] GOTO 0x0056

SUBROUTINE_0027:
  8: 0x0027 [0x1D] PRINT_EVENT_MESSAGE(message_id=6890*)
    → "Okey-dokey! Now, if you'd close your eyes and come a little closer...\u007F1\u0000\u0007"
...
SUBROUTINE_0059:
 ...
 21: 0x0075 [0x1D] PRINT_EVENT_MESSAGE(message_id=6891*)
    → "For you? Hmm... How aboutaru \u0001\u0001\u0001 \u0001\u0005$\u0002\u0000\u0000\u0000? You'll need...\u007F1\u0000\u0007"
...
\u0007 x \u0001	)\u0002\u0007\u0000\u0000\u0002\u0003\u0000\u0000\u007F1\u0000\u0007"
 ...
 80: 0x0162 [0x1D] PRINT_EVENT_MESSAGE(message_id=6892*)
    → "Did you get that?\u0007If you can't findy-wind all the goodies you need, you could try the auction house.\u007F1\u0000\u0007"
...
SUBROUTINE_0177:
 86: 0x0177 [0x1D] PRINT_EVENT_MESSAGE(message_id=6887*)
    → "Splish splosh I was takin' a bath.\u0001t\u0007All upon a Thundersday night.\u0001t\u007F1\u0000\u0007"
