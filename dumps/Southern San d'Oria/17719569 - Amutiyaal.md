...
- **10382**: You there! Yes, you! You are one of those "adventurers"?
- **10383**: Are you an "adventurer"? [I guess I am./Not today.]
- **10384**: I knew it to be so! This badge was made for one such as you! Allow me...!
- **10385**: No!? A thousand pardons! And yet, you shall make the perfect bearer for this badge! Allow me...!
- **10386**: 6 is suddenly pinned to <Player>!
- **10387**: This is the symbol of the illustrious leader of Salaheem's Sentinels--a snarling wildcat.
- **10388**: Under the authorization of Her Imperial Majesty, Salaheem's Sentinels is a well-respected company that specializes in training and dispatching mercenaries for the defense of the Aht Urhgan Empire. We have a myriad of well-paying missions ready for any able-bodied adventurer.
- **10389**: But my speech grows overlong! My dauntless commander has bid me take ship to this bountiful kingdom and dazzle the citizenry with the Sentinels' splendor, and so I shall!
- **10390**: Oho! It is you! It would appear that more and more people are taking an interest in our humble organization. Praise be to the winds of fortune!
- **10391**: The $3 was created through the advanced alchemical techniques of my country. The wildcat's eyes are designed to flash in the presence of any who entertain thoughts of Aht Urhgan.
- **10392**: Aha! My splendid friend! You have spread the fire of fascination through the entire city! Salaheem's Sentinels is the talk of the town!
- **10393**: Hm? It appears the eyes of the $3 have lost their luster. The crystal power source must have been drained after dazzling so many people. Allow me to remove this spent trinket...
- **10394**: The $3 is taken from <Player>!
- **10395**: In return, I shall award you this bauble. It will come in handy for when you join the ranks of the Aht Urhgan mercenaries!
- **10397**: Your name will shine down through the ages as one of our finest public relations officers. Should you ever brave the seas and find yourself in the Imperial City of Al Zahbi, you simply must visit the offices of Salaheem's Sentinels. I insist!
- **13309**: Ah, if it isn't <Player>! Perchance you have come to question the authenticity of my testimony regarding the Sentinels. I do not deny that I may have possibly added a bit of color to the facts surrounding the true nature of our fine leader, but all's well that ends well, no?
- **13310**: Ah, yet you need not fret any longer, my fine friend. Our prodigal president and provider once again has proffered forth her ever-giving hands in a selfless gesture of heartwarming charity.
- **13311**: From this day forth, all employees of Salaheem's Sentinels can now teleport freely from San d'Oria to Aht Urhgan Whitegate!
- **13312**: And by freely, I mean in the sense of "free as a bird" as I will require a fee of $0 gil from those who wish to partake in my services.
- **13313**: Thank you very much, [sir/ma'am].
- **13314**: Now let us be on our merry way!
...
```
  ...
  3: 0x000A [0x1D] PRINT_EVENT_MESSAGE(message_id=10382*)
    → "You there! Yes, you! You are one of those "adventurers"?"
  4: 0x000D [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x000E [0x24] CREATE_DIALOG(message_id=10383*, default_option=0*, option_flags=0*)
 ...
 11: 0x002D [0x1D] PRINT_EVENT_MESSAGE(message_id=10384*)
 ...
 18: 0x004B [0x1D] PRINT_EVENT_MESSAGE(message_id=10385*)
...
SUBROUTINE_0052:
 ...
 22: 0x0057 [0x48] [System] [10386*]:
    → "6 is suddenly pinned to <Player>!"
 23: 0x005A [0x1C] WAIT(60* ticks)
 24: 0x005D [0x1D] PRINT_EVENT_MESSAGE(message_id=10387*)
 ...
 27: 0x0070 [0x1D] PRINT_EVENT_MESSAGE(message_id=10388*)
 ...
 30: 0x0083 [0x1D] PRINT_EVENT_MESSAGE(message_id=10389*)
...
```
  ...
  4: 0x009D [0x1D] PRINT_EVENT_MESSAGE(message_id=10390*)
...
```
  ...
  4: 0x00BF [0x1D] PRINT_EVENT_MESSAGE(message_id=10391*)
...
```
  ...
  5: 0x00E9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10392*)
  ...
  8: 0x00F2 [0x1D] PRINT_EVENT_MESSAGE(message_id=10393*)
 ...
 13: 0x010B [0x1D] PRINT_EVENT_MESSAGE(message_id=10395*)
...
```
  ...
  3: 0x014B [0x1D] PRINT_EVENT_MESSAGE(message_id=10397*)
...
```
  ...
  3: 0x0177 [0x1D] PRINT_EVENT_MESSAGE(message_id=13309*)
  ...
  8: 0x0196 [0x1D] PRINT_EVENT_MESSAGE(message_id=13310*)
 ...
 12: 0x01AE [0x1D] PRINT_EVENT_MESSAGE(message_id=13311*)
 ...
 19: 0x01DF [0x1D] PRINT_EVENT_MESSAGE(message_id=13312*)
...
```
  ...
  5: 0x0204 [0x1D] PRINT_EVENT_MESSAGE(message_id=13313*)
  ...
  9: 0x0224 [0x1D] PRINT_EVENT_MESSAGE(message_id=13314*)
