...
```
  ...
  3: 0x0676 [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s067", work_offset2=300*)
  4: 0x0687 [0x27] REQ_SET(priority=0x64, entity_id=LocalPlayer, tag_num=0x2C)
  5: 0x068E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
  6: 0x069F [0x55] WAIT_LOAD_SCHEDULER(work_offset=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s067")
  7: 0x06AE [0x5B] LOAD_EXT_SCHEDULER(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 12: 0x06C9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s068", work_offset2=0*)
 13: 0x06DA [0x5B] LOAD_EXT_SCHEDULER(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 20: 0x0702 [0x5B] LOAD_EXT_SCHEDULER(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="pas0")
...
SUBROUTINE_072C:
 ...
 31: 0x0734 [0x5B] LOAD_EXT_SCHEDULER(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 36: 0x074F [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s073", work_offset2=0*)
 37: 0x0760 [0x5B] LOAD_EXT_SCHEDULER(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 40: 0x0773 [0x55] WAIT_LOAD_SCHEDULER(work_offset=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s073")
 41: 0x0782 [0x5E] EventEntity goes idle (kills current action) (animation: "idl0")
 42: 0x0787 [0x1C] WAIT(60* ticks)
 43: 0x078A [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s074", work_offset2=0*)
 44: 0x079B [0x5B] LOAD_EXT_SCHEDULER(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 49: 0x07B6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s069", work_offset2=0*)
 50: 0x07C7 [0x5B] LOAD_EXT_SCHEDULER(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 55: 0x07E2 [0x5B] LOAD_EXT_SCHEDULER(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
