...
```
  ...
  9: 0x0026 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z000", work_offset2=0*)
 10: 0x0037 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z000")
 ...
 22: 0x0092 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 ...
 31: 0x00CA [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z001", work_offset2=0*)
 32: 0x00DB [0x2A] GET_REQ_LEVEL(level=3, entity_id=Claidie (ID: 17719369/0x010E6049))
 33: 0x00E1 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z001")
 34: 0x00F0 [0x27] REQ_SET(priority=0x03, entity_id=Claidie (ID: 17719369/0x010E6049), tag_num=0x04)
 35: 0x00F7 [0x1C] WAIT(90* ticks)
 36: 0x00FA [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z002", work_offset2=0*)
 37: 0x010B [0x2A] GET_REQ_LEVEL(level=3, entity_id=Claidie (ID: 17719369/0x010E6049))
 38: 0x0111 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z002")
 ...
 47: 0x013E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=21*, entity1=EventEntity, entity2=EventEntity, action="sl00")
 ...
 51: 0x0154 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="sl00")
 ...
 58: 0x017D [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z003", work_offset2=0*)
 ...
 62: 0x019D [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z003")
 63: 0x01AC [0x29] REQ_SET_WAIT(priority=0x03, entity_id=Claidie (ID: 17719369/0x010E6049), tag_num=0x05)
 64: 0x01B3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z004", work_offset2=0*)
 65: 0x01C4 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z004")
 ...
 68: 0x01DD [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z006", work_offset2=0*)
 ...
 71: 0x01F8 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z006")
 72: 0x0207 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z007", work_offset2=0*)
 73: 0x0218 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z007")
 ...
 80: 0x024B [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z008", work_offset2=0*)
 ...
 84: 0x0268 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z008")
 ...
 96: 0x02AE [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z00b", work_offset2=0*)
 97: 0x02BF [0x01] GOTO 0x030B

SUBROUTINE_02C2:
 98: 0x02C2 [0x02] IF !(LocalPlayer->Race == 6*) GOTO 0x02DE
 99: 0x02CA [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z00b", work_offset2=0*)
100: 0x02DB [0x01] GOTO 0x030B

SUBROUTINE_02DE:
101: 0x02DE [0x02] IF !(LocalPlayer->Race == 8*) GOTO 0x02FA
102: 0x02E6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z00c", work_offset2=0*)
103: 0x02F7 [0x01] GOTO 0x030B

SUBROUTINE_02FA:
104: 0x02FA [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z009", work_offset2=0*)
...
113: 0x0332 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z010", work_offset2=0*)
114: 0x0343 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z010")
...
121: 0x0373 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z00a", work_offset2=0*)
122: 0x0384 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z00a")
...
131: 0x03B5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z011", work_offset2=0*)
...
136: 0x03D4 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z011")
137: 0x03E3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=Claidie (ID: 17719369/0x010E6049), entity2=Claidie (ID: 17719369/0x010E6049), scheduler_id="ovl1", work_offset2=0*)
138: 0x03F4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z012", work_offset2=0*)
...
145: 0x0413 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z012")
146: 0x0422 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=Trion (ID: 17719365/0x010E6045), entity2=Trion (ID: 17719365/0x010E6045), scheduler_id="ovl1", work_offset2=0*)
147: 0x0433 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z013", work_offset2=0*)
...
152: 0x0452 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z013")
153: 0x0461 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=Trion (ID: 17719365/0x010E6045), entity2=Trion (ID: 17719365/0x010E6045), scheduler_id="ovl1", work_offset2=0*)
154: 0x0472 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z014", work_offset2=0*)
...
163: 0x0499 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z014")
164: 0x04A8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
165: 0x04B9 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
...
184: 0x0517 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y000", work_offset2=0*)
185: 0x0528 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y000")
186: 0x0537 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
187: 0x0548 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
...
193: 0x0572 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y001", work_offset2=0*)
...
202: 0x059D [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y001")
...
206: 0x05B9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y002", work_offset2=0*)
...
215: 0x05EE [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
216: 0x05FF [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
217: 0x060E [0x23] WAIT_FOR_DIALOG_INTERACTION
218: 0x060F [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y002")
...
225: 0x0634 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z015", work_offset2=0*)
226: 0x0645 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z015")
227: 0x0654 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
228: 0x0665 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
229: 0x0674 [0x1C] WAIT(300* ticks)
230: 0x0677 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z016", work_offset2=0*)
231: 0x0688 [0x55] WAIT_LOAD_SCHEDULER(work_offset=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z016")
...
235: 0x06A0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=19*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="z017", work_offset2=0*)
236: 0x06B1 [0x1C] WAIT(360* ticks)
237: 0x06B4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=Trion (ID: 17719365/0x010E6045), entity2=Trion (ID: 17719365/0x010E6045), scheduler_id="who1", work_offset2=0*)
238: 0x06C5 [0x55] WAIT_LOAD_SCHEDULER(work_offset=201*, entity1=Trion (ID: 17719365/0x010E6045), entity2=Trion (ID: 17719365/0x010E6045), scheduler_id="who1")
...
253: 0x0705 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
254: 0x0716 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="whi1", work_offset2=0*)
