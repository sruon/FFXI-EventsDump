...
- **6814**: Image support: $0 gil. [Accept./Decline.]
...
- **6884**: Are you blind, [boy/girl]? Can you not see that I am busy with an important order? Now off with you!
- **6885**: Can't help you.
- **6886**: Pay up or get out.
- **6887**: ... Eyes... Close them.
- **6888**: For $0, you'll need...
- **6889**: I have other tasks that need my tending. If you have finished, depart promptly.
...
```
  ...
  5: 0x0020 [0x1D] PRINT_EVENT_MESSAGE(message_id=6885*)
    → "Can't help you."
  6: 0x0023 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0024 [0x01] GOTO 0x0083
  8: 0x0027 [0x24] CREATE_DIALOG(message_id=6814*, default_option=1*, option_flags=0*)
 ...
 12: 0x003F [0x1D] PRINT_EVENT_MESSAGE(message_id=6887*)
    → "... Eyes... Close them."
 ...
 20: 0x0071 [0x1D] PRINT_EVENT_MESSAGE(message_id=6886*)
    → "Pay up or get out."
...
SUBROUTINE_0083:
 ...
 31: 0x00A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=6888*)
    → "For $0, you'll need..."
...
SUBROUTINE_01A1:
 ...
 96: 0x01A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=6884*)
