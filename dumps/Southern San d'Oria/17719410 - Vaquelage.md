...
- **8450**: Send an item? [Send something./No, thanks.]
- **8451**: Parcels delivered to rooms anywhere in Vana'diel!
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=8451*)
  ...
  7: 0x0020 [0x24] CREATE_DIALOG(message_id=8450*, default_option=0*, option_flags=0*)
