...
- **13902**: Which memory will you have recalled? [Nothing./Add-on Scenarios.]
- **13903**: Which memory will you have recalled? [Nothing./Drenched! It Began with a Raindrop./Hasten! In a Jam in Jeuno?/Moglesse Oblige.]
- **13904**: Which memory will you have recalled? [Nothing./Fellow Points.]
- **13905**: Which memory will you have recalled? [Nothing.]
- **13906**: Which memory will you have recalled? [Nothing.]
- **13907**: Which memory will you have recalled? [Nothing.]
...
```
 ...
 39: 0x00D4 [0x24] CREATE_DIALOG(message_id=13902*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00E4:
 42: 0x00E4 [0x24] CREATE_DIALOG(message_id=13903*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_0113:
 50: 0x0113 [0x24] CREATE_DIALOG(message_id=13904*, default_option=0*, option_flags=Work_Zone[3])
...
SUBROUTINE_0142:
 58: 0x0142 [0x24] CREATE_DIALOG(message_id=13905*, default_option=0*, option_flags=Work_Zone[4])
...
SUBROUTINE_0171:
 66: 0x0171 [0x24] CREATE_DIALOG(message_id=13906*, default_option=0*, option_flags=Work_Zone[5])
    → "Which memory will you have recalled? [Nothing.]"
...
SUBROUTINE_01A0:
 74: 0x01A0 [0x24] CREATE_DIALOG(message_id=13907*, default_option=0*, option_flags=Work_Zone[6])
    → "Which memory will you have recalled? [Nothing.]"
...
SUBROUTINE_01CF:
 82: 0x01CF [0x24] CREATE_DIALOG(message_id=13908*, default_option=0*, option_flags=Work_Zone[7])
    → "Which memory will you have recalled? [Nothing.]"
