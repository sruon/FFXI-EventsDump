...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=7878*)
    → "Heh-heh! Like to know something truly stellar? The honey from those bees out on La Theine Plateau is the best!\u007F1\u0000\u0007"
  5: 0x001A [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x001B [0x1C] WAIT(30* ticks)
  7: 0x001E [0x1D] PRINT_EVENT_MESSAGE(message_id=7879*)
    → "They call me the honey king of San d'Oria, so you know I can't be wrong! Yep, that's some of the best there is! One taste and you'll be buzzing for more!\u007F1\u0000\u0007"
  8: 0x0021 [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x0022 [0x1C] WAIT(30* ticks)
 10: 0x0025 [0x1D] PRINT_EVENT_MESSAGE(message_id=7880*)
    → "But you gotta watch out for those bees. They've got poison stingers and they tend to swarm, so be careful!\u007F1\u0000\u0007"
