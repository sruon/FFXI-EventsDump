...
```
  ...
  5: 0x000D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 13: 0x002F [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 18: 0x004A [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s007", work_offset2=0*)
 19: 0x005B [0x1C] WAIT(60* ticks)
 20: 0x005E [0x27] REQ_SET(priority=0x64, entity_id=Exoroche (ID: 17719356/0x010E603C), tag_num=0x0B)
 21: 0x0065 [0x55] WAIT_LOAD_SCHEDULER(work_offset=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s007")
 22: 0x0074 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 29: 0x00A2 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
