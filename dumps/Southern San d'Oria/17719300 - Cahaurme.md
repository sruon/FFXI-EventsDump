...
- **8044**: Have you the $3? Great. Here, have this. Figure the rest out by yourself.
- **11995**: Ask if this person is the chick's owner? [Yes./No.]
- **12017**: Red alert! My chocobo has gone missing!
- **12018**: What's this? You've got him? What a relief! I am supposed to be looking out for any threats to our nation here, but in truth all I have had my eyes out for is that poor little chocobo...
- **12019**: You are raising a chocobo as well, are you not? Let me show you my thanks by teaching you a story you can tell your animal...
- **12040**: You have my chocobo, you say?
- **12041**: That is not a joking matter. I could never stand here so calmly if my chocobo was lost.
...
```
  ...
  6: 0x001D [0x1D] PRINT_EVENT_MESSAGE(message_id=8044*)
...
```
  ...
  2: 0x0050 [0x24] CREATE_DIALOG(message_id=11995*, default_option=1*, option_flags=0*)
 ...
 11: 0x0079 [0x1D] PRINT_EVENT_MESSAGE(message_id=12040*)
 ...
 14: 0x008C [0x1D] PRINT_EVENT_MESSAGE(message_id=12041*)
 ...
 18: 0x00A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=12017*)
 ...
 21: 0x00B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=12018*)
 ...
 24: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=12019*)
