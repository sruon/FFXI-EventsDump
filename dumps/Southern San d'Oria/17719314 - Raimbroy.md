...
- **6436**: Obtained $0 gil.
- **7863**: Greetings.
- **7866**: Ah, Katharina! How are things at the Lion Springs?
- **7868**: A cask of mulsum, eh? All right, let me go check for one.
- **7869**: Dear, dear... It looks like the one I gave you folks yesterday was the last of my stock! I'm fresh out, I am.
- **7871**: Well, that's a shame. I'll just have to find another, more willing adventurer.
- **7872**: A cask of mulsum... I'm fresh out of honey, and my errand boy's home recovering from wounds he got at Ghelsba.
- **7873**: Hrmm... Eh? An adventurer! Think you could bring me some honey? I'm short on help, you see.
- **7874**: Well, thanks be to you! I'll need five $0, if you think you can handle it.
- **7875**: Just what I needed! Here's your payment, then.
- **7876**: Hrmm... Still not enough, eh? Sorry to keep yanking you around like this, but do you think you could go bring me some more?
- **7877**: I'll take five $0 and no less, any time you can bring them. Good luck!
- **7878**: Ah, so you'll hunt down some $0 for me, then?
- **7882**: What's that? Still no $0? If I just had five, I could get to work...
...
```
 ...
 16: 0x0081 [0x1D] PRINT_EVENT_MESSAGE(message_id=7863*)
    → "Greetings."
 ...
 23: 0x00AC [0x2B] Katharina (ID: 17719315/0x010E6013) [7865*]:
    → "Hello there!"
 ...
 35: 0x00F7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7866*)
 ...
 41: 0x0128 [0x1D] PRINT_EVENT_MESSAGE(message_id=7868*)
 ...
 46: 0x0141 [0x1D] PRINT_EVENT_MESSAGE(message_id=7869*)
...
```
  ...
  2: 0x01B6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7872*)
 ...
 12: 0x01F4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7873*)
 ...
 15: 0x01FD [0x24] CREATE_DIALOG(message_id=8145*, default_option=0*, option_flags=0*)
 ...
 20: 0x0221 [0x1D] PRINT_EVENT_MESSAGE(message_id=7874*)
 ...
 27: 0x023D [0x1D] PRINT_EVENT_MESSAGE(message_id=7871*)
...
```
  ...
  5: 0x0266 [0x1D] PRINT_EVENT_MESSAGE(message_id=7878*)
  ...
  8: 0x026F [0x24] CREATE_DIALOG(message_id=8145*, default_option=0*, option_flags=0*)
    → "Accept? [Yes./I'm sorry.]"
 ...
 12: 0x028E [0x1D] PRINT_EVENT_MESSAGE(message_id=7874*)
    → "Well, thanks be to you! I'll need five $0, if you think you can handle it."
 ...
 19: 0x02AA [0x1D] PRINT_EVENT_MESSAGE(message_id=7871*)
    → "Well, that's a shame. I'll just have to find another, more willing adventurer."
...
```
  ...
  5: 0x02D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7882*)
...
```
  ...
  5: 0x02FC [0x1D] PRINT_EVENT_MESSAGE(message_id=7882*)
    → "What's that? Still no $0? If I just had five, I could get to work..."
...
```
  ...
  6: 0x0323 [0x1D] PRINT_EVENT_MESSAGE(message_id=7875*)
 ...
 15: 0x035E [0x1D] PRINT_EVENT_MESSAGE(message_id=7876*)
 ...
 22: 0x0389 [0x1D] PRINT_EVENT_MESSAGE(message_id=7877*)
...
```
  ...
  4: 0x03A7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7876*)
    → "Hrmm... Still not enough, eh? Sorry to keep yanking you around like this, but do you think you could go bring me some more?"
 ...
 11: 0x03DE [0x1D] PRINT_EVENT_MESSAGE(message_id=7877*)
    → "I'll take five $0 and no less, any time you can bring them. Good luck!"
