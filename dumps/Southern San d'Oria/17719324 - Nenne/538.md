...
```
  ...
  5: 0x000D [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s030", work_offset2=0*)
  6: 0x001E [0x27] REQ_SET(priority=0x65, entity_id=LocalPlayer, tag_num=0x23)
  7: 0x0025 [0x55] WAIT_LOAD_SCHEDULER(work_offset=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s030")
  8: 0x0034 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
  9: 0x0045 [0x5B] LOAD_EXT_SCHEDULER(work_offset=35*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 10: 0x0054 [0x1D] PRINT_EVENT_MESSAGE(message_id=8088*)
    → "<cough>...<cough!>\u007F1\u0000\u0007"
 11: 0x0057 [0x23] WAIT_FOR_DIALOG_INTERACTION
 12: 0x0058 [0x5B] LOAD_EXT_SCHEDULER(work_offset=35*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 13: 0x0067 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="thk2")
 ...
 18: 0x007E [0x5B] LOAD_EXT_SCHEDULER(work_offset=35*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 28: 0x00B7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s032", work_offset2=0*)
 ...
 39: 0x00FF [0x5B] LOAD_EXT_SCHEDULER(work_offset=35*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 43: 0x0119 [0x5B] LOAD_EXT_SCHEDULER(work_offset=35*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 44: 0x0128 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="thk2")
 45: 0x0135 [0x1C] WAIT(30* ticks)
 46: 0x0138 [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s033", work_offset2=0*)
 47: 0x0149 [0x5B] LOAD_EXT_SCHEDULER(work_offset=75*, entity1=Raminel (ID: 17719325/0x010E601D), entity2=Raminel (ID: 17719325/0x010E601D), action="tlk0")
 ...
 50: 0x0160 [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s034", work_offset2=0*)
 51: 0x0171 [0x5B] LOAD_EXT_SCHEDULER(work_offset=35*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 55: 0x018B [0x5B] LOAD_EXT_SCHEDULER(work_offset=35*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 56: 0x019A [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="thk2")
 57: 0x01A7 [0x5B] LOAD_EXT_SCHEDULER(work_offset=75*, entity1=Raminel (ID: 17719325/0x010E601D), entity2=Raminel (ID: 17719325/0x010E601D), action="tlk0")
 ...
 60: 0x01BE [0x5B] LOAD_EXT_SCHEDULER(work_offset=35*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 63: 0x01D1 [0x5B] LOAD_EXT_SCHEDULER(work_offset=35*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 64: 0x01E0 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="thk2")
 65: 0x01ED [0x1C] WAIT(30* ticks)
 66: 0x01F0 [0x5B] LOAD_EXT_SCHEDULER(work_offset=75*, entity1=Raminel (ID: 17719325/0x010E601D), entity2=Raminel (ID: 17719325/0x010E601D), action="tlk0")
 ...
 69: 0x0207 [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s035", work_offset2=0*)
 ...
 77: 0x0240 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 82: 0x0267 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
