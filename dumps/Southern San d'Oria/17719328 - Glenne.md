...
- **7768**: Oh, what to do? My husband is on patrol in West Ronfaure, but he forgot his salve when he went out this morning!
- **7769**: It's a dangerous job he does, and you never know when a good ointment could save your life! Perhaps you could take it to him?
- **7770**: I'd take it myself, to be sure, but I cannot leave the city.
- **7771**: Deliver the ointment? [Of course I will./Not right now.]
- **7772**: I thank you! His name is Aaveleon.
- **7773**: He patrols the wilderness outside, but not too far from Westgate.
- **7774**: I see...
- **7775**: I cannot accept this. Take it back.
- **7776**: Could you not find my husband?
- **7777**: His name is Aaveleon. Please, deliver the ointment to him. I fear he may need it.
- **7781**: So you lost the ointment! I suppose I can give you another. Please, deliver it as you said you would!
- **7782**: Thank you so much. With more fiends in the woods, always my husband returns with scrapes and scratches. These are troubling days for us all.
- **7783**: Here. It's not much, but please accept this as a token of my gratitude.
- **7784**: Thank you again for your help!
...
```
  ...
  5: 0x001D [0x1D] PRINT_EVENT_MESSAGE(message_id=7768*)
  ...
  8: 0x0024 [0x1D] PRINT_EVENT_MESSAGE(message_id=7769*)
 ...
 11: 0x002B [0x1D] PRINT_EVENT_MESSAGE(message_id=7770*)
 ...
 14: 0x0034 [0x24] CREATE_DIALOG(message_id=7771*, default_option=0*, option_flags=0*)
 ...
 29: 0x0085 [0x1D] PRINT_EVENT_MESSAGE(message_id=7774*)
    → "I see..."
...
```
  ...
  5: 0x00B7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7776*)
    → "Could you not find my husband?"
  6: 0x00BA [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x00BB [0x1C] WAIT(30* ticks)
  8: 0x00BE [0x1D] PRINT_EVENT_MESSAGE(message_id=7777*)
...
```
  ...
  7: 0x00EB [0x1D] PRINT_EVENT_MESSAGE(message_id=7782*)
 ...
 10: 0x00F2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7783*)
...
```
  ...
  5: 0x012F [0x1D] PRINT_EVENT_MESSAGE(message_id=7781*)
...
```
  ...
  7: 0x0169 [0x1D] PRINT_EVENT_MESSAGE(message_id=7775*)
...
```
  ...
  5: 0x0195 [0x1D] PRINT_EVENT_MESSAGE(message_id=7784*)
