...
- **7404**: The Troupe Valeriano, at your service! Well, I'm more of a behind-the-scenes kinda gal, not an entertainer.
- **7405**: People call me "Nokky the Tree-shaker"! While the other guys are doing their thing, I work on the sidelines as a quiver-maker. Basically, I can make it easier for you to lug around those bundles of ninety-nine arrows or bolts or whatever.
- **7406**: I've been doing this for a while now, so I've learned to bundle all sorts of stuff...
- **7407**: %, $1, $2, $3, $4, and $5 I've always been able to do...
- **7408**: But now I can also bundle $0, $1, $2, $3, $4, and $5.
- **7409**: Not to mention $0, $1, $2, $3, $4, $5, and $6.
- **7410**: %, $2, and plain old $1!
- **7411**: And of course, $0, $1, $2, $3, and $4!
- **7412**: Then there's everyone's favorite $0, $1, and $2.
- **7413**: Finally, new to my bundling repertoire, we have $0, $1, $2, and $3!
- **7414**: I can even bundle those elemental cards that corsairs use!
- **7415**: Aren't you imprrressed? Keeping up with all these new types of ammunition is hard work!
- **7416**: Oh, and for the rrrecord, anything else is too much trrrouble to deal with. Not my thing.
- **7417**: This ain't no charity, though. I'm not really interested in gil, but... Let's see here... Flowers...? Yeah, you bring me $0 for every ninety-nine arrows, bolts, or whatever you want organized, and we got a deal.
- **7418**: I can make a quiver or pouch for up to seven sets of the same kind of ammunition. So you could bring me, say, one hundred ninety-eight $1 and two of those $0, for example. I like to do things real efficient-like, you see, so make sure they're in multiples of ninety-nine.
- **7419**: % smiles slyly at you.
...
```
  ...
  1: 0x000B [0x1D] PRINT_EVENT_MESSAGE(message_id=7404*)
  ...
  3: 0x000F [0x1D] PRINT_EVENT_MESSAGE(message_id=7405*)
  ...
  5: 0x0013 [0x1D] PRINT_EVENT_MESSAGE(message_id=7406*)
 ...
 13: 0x0035 [0x1D] PRINT_EVENT_MESSAGE(message_id=7407*)
 ...
 21: 0x0057 [0x1D] PRINT_EVENT_MESSAGE(message_id=7408*)
 ...
 30: 0x007E [0x1D] PRINT_EVENT_MESSAGE(message_id=7409*)
 ...
 35: 0x0091 [0x1D] PRINT_EVENT_MESSAGE(message_id=7410*)
    → "%, $2, and plain old $1!"
 ...
 42: 0x00AE [0x1D] PRINT_EVENT_MESSAGE(message_id=7411*)
 ...
 47: 0x00C1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7412*)
 ...
 59: 0x00E5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7416*)
 ...
 63: 0x00F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7417*)
 ...
 65: 0x00F7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7418*)
