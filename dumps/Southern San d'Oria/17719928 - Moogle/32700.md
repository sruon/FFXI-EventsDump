...
```
  ...
  1: 0x0106 [0x1D] PRINT_EVENT_MESSAGE(message_id=13788*)
    → "You want to help us again? That's very kind of you, but we need more time to put together a new set of presents, kupo. Would you mind coming back tomorrow?\u007F1\u0000\u0007"
