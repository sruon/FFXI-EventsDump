...
- **9153**: What do you want? I'm waiting for someone. Each time the door opens, I turn to look! Begone!
- **9154**: This is no concern of yours. Leave at once!
- **9155**: What are you here for? You ask about my son? Please, just go!
- **9156**: I know all about the intrigue of the knights! I heard that something was amiss right when my son disappeared. I know they had something to do with it!
- **9166**: Why, you would offer this to me!? It's the paintbrush Chusarlaud always wanted. How did you know?
- **9167**: In youth he wanted to be a painter. But, when his mother fell ill we lost the means, and he decided to become a knight. All on his own...
- **9168**: I just couldn't ask him to quit, even though I wanted him to. He was our pride. How could such a thing happen to him?
- **9169**: He has gone missing for nearly a year, but there is still a chance he lives. We've kept his room upstairs the way it's always been. Go see for yourself if you want to.
- **9170**: Come to think of it, often he would read a letter from his commanding officer. Once I snatched it while he was away, but the paper was blank.
- **9195**: It broke my heart to learn about him, but now I know the truth. You'll always have my gratitude.
...
```
  ...
  3: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=9153*)
    → "What do you want? I'm waiting for someone. Each time the door opens, I turn to look! Begone!"
  4: 0x000B [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x000C [0x1D] PRINT_EVENT_MESSAGE(message_id=9154*)
...
```
  ...
  3: 0x0019 [0x1D] PRINT_EVENT_MESSAGE(message_id=9155*)
    → "What are you here for? You ask about my son? Please, just go!"
  4: 0x001C [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x001D [0x1D] PRINT_EVENT_MESSAGE(message_id=9156*)
...
```
  ...
  5: 0x003A [0x1D] PRINT_EVENT_MESSAGE(message_id=9166*)
  ...
  8: 0x004D [0x1D] PRINT_EVENT_MESSAGE(message_id=9167*)
 ...
 10: 0x0051 [0x1D] PRINT_EVENT_MESSAGE(message_id=9168*)
 ...
 13: 0x0064 [0x1D] PRINT_EVENT_MESSAGE(message_id=9169*)
...
```
  ...
  3: 0x007E [0x1D] PRINT_EVENT_MESSAGE(message_id=9169*)
    → "He has gone missing for nearly a year, but there is still a chance he lives. We've kept his room upstairs the way it's always been. Go see for yourself if you want to."
...
```
  ...
  3: 0x008B [0x1D] PRINT_EVENT_MESSAGE(message_id=9170*)
...
```
  ...
  3: 0x0099 [0x1D] PRINT_EVENT_MESSAGE(message_id=9195*)
