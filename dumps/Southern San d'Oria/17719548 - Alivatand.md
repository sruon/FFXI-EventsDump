...
- **6825**: Hello, [sir/ma'am]. I have been appointed by the Guildworkers' Union to manage the trading of manufactured crafts and the exchange of guild points.
- **6826**: However, to assure product quality, I cannot carry out any business with those who rank lower than novice.
- **6827**: I see that you currently have a trading contract with the [Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild. I'm sorry, but I cannot do any business with you.
- **6828**: You do have the option to terminate your contract with the [Fishermen's/Carpenters'/Blacksmiths'/Goldsmiths'/Weavers'/Tanners'/Boneworkers'/Alchemists'/Culinarians'] Guild and form one with us.
- **6829**: After signing a new contract, you will have to wait until the next delivery phase to trade Guildworkers' Union requested items.
- **6830**: Create a new contract with us? [Immediately./Not today.]
- **6831**: Are you certain? [I said, "Immediately."/On second thought...]
- **6833**: Our system works like this. We will ask you to provide us with a certain item depending on your craft skill rank. There is a set time limit (one day, Earth time) in which you may bring as many of the item as you can synthesize.
- **6834**: If you happen to create a high quality version of the requested item, we will be more than delighted to accept that as well.
- **6835**: Trading us these items will earn you "guild points" which can be later exchanged for other specialty goods--some of which are found exclusively at this guild.
- **6836**: The amount of guild points you will receive varies with the item requested, and there is a limit to how many points you can accumulate during the designated time frame. Trading items after you have reached the limit will result in no points gained.
- **6837**: When the time limit has expired, the item requested by the guild will change. It will also change in the event your craft skill rises.
- **6838**: I see that you have not formed a trading contract with any of the other guilds.
- **6841**: The current requested item is $2. You have $0 guild points accumulated.
- **6842**: Currently, no items are being requested by the guild. You have $0 guild points accumulated.
- **6843**: Is there something you need? [I'm just passing through./I would like to use my points./What are the current limits?/How does the trade system work?]
- **6844**: You have $0 more days (Vana'diel time) to provide us with the requested item.
- **6845**: Today (Vana'diel time) is the final day we will accept the requested item.
- **6846**: You can still receive up to $3 guild points by trading us the item before the time limit is up.
- **6847**: You are not eligible to receive guild points at this time.
- **6851**: Yes, this is what we are asking for. Good work, <Player>!
- **6854**: Trade $1 guild points for $0?
- **6855**: How many do you wish to trade for?
- **6856**: Trade $1 guild points for $2 $0 ?
- **6857**: Proceed with the transaction? (GP: $ ) [Yes./No.]
- **6859**: Exchange points for... [None of these./3($1)./$3($3)./$3($5)./$3($7)./$3($9)./$3($11)./$3($13).]
- **6860**: Trade $1 guild points for $3?
- **6911**: 3 is a wonderful new method of tanning that allows you to enchant hides with the mysterious energy of black magic and anima.
- **6912**: 3 is a wonderful new method of tanning that allows you to enchant hides with the mysterious energy of white magic and anima.
- **6979**: 3 is a wonderful new method of leathercraft that allows you to soak skins in a tanning vat, making it easier to process more leather with one crystal.
...
```
  ...
  2: 0x000C [0x1D] PRINT_EVENT_MESSAGE(message_id=6851*)
...
```
  ...
  9: 0x0042 [0x1D] PRINT_EVENT_MESSAGE(message_id=6825*)
 ...
 16: 0x0065 [0x1D] PRINT_EVENT_MESSAGE(message_id=6826*)
...
SUBROUTINE_00FC:
 24: 0x00FC [0x24] CREATE_DIALOG(message_id=6831*, default_option=1*, option_flags=0*)
...
SUBROUTINE_011D:
 ...
 36: 0x012F [0x1D] PRINT_EVENT_MESSAGE(message_id=6842*)
 ...
 39: 0x0136 [0x1D] PRINT_EVENT_MESSAGE(message_id=6841*)
...
SUBROUTINE_014E:
 45: 0x014E [0x24] CREATE_DIALOG(message_id=6843*, default_option=ExtData[1]->WorkLocal[17], option_flags=0*)
...
185: 0x0D9B [0x1D] PRINT_EVENT_MESSAGE(message_id=6847*)
...
191: 0x0DB4 [0x1D] PRINT_EVENT_MESSAGE(message_id=6846*)
...
194: 0x0DBB [0x1D] PRINT_EVENT_MESSAGE(message_id=6847*)
    → "You are not eligible to receive guild points at this time."
...
# Dead code (unreachable instructions):
     ...
     0x0C2A [0x24] CREATE_DIALOG(message_id=6859*, default_option=ExtData[1]->WorkLocal[19], option_flags=ExtData[1]->WorkLocal[5])
    → "Exchange points for... [None of these./3($1)./$3($3)./$3($5)./$3($7)./$3($9)./$3($11)./$3($13).]"
     ...
     0x0D0B [0x1D] PRINT_EVENT_MESSAGE(message_id=6860*)
    → "Trade $1 guild points for $3?"
     0x0D0E [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0D0F [0x24] CREATE_DIALOG(message_id=6857*, default_option=1*, option_flags=0*)
...
# Dead code (unreachable instructions):
     ...
     0x0E03 [0x1D] PRINT_EVENT_MESSAGE(message_id=6855*)
    → "How many do you wish to trade for?"
     ...
     0x0E38 [0x1D] PRINT_EVENT_MESSAGE(message_id=6854*)
    → "Trade $1 guild points for $0?"
     0x0E3B [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0E3C [0x01] GOTO 0x0E43
     0x0E3F [0x1D] PRINT_EVENT_MESSAGE(message_id=6856*)
    → "Trade $1 guild points for $2 $0 ?"
     ...
     0x0E4B [0x24] CREATE_DIALOG(message_id=6857*, default_option=1*, option_flags=0*)
    → "Proceed with the transaction? (GP: $ ) [Yes./No.]"
     ...
     0x0E95 [0x1D] PRINT_EVENT_MESSAGE(message_id=6911*)
    → "3 is a wonderful new method of tanning that allows you to enchant hides with the mysterious energy of black magic and anima."
     0x0E98 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0E99 [0x01] GOTO 0x0EBA
     0x0E9C [0x02] IF !(Work_Zone[2] == 2016*) GOTO 0x0EAB
     0x0EA4 [0x1D] PRINT_EVENT_MESSAGE(message_id=6912*)
    → "3 is a wonderful new method of tanning that allows you to enchant hides with the mysterious energy of white magic and anima."
     0x0EA7 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0EA8 [0x01] GOTO 0x0EBA
     0x0EAB [0x02] IF !(Work_Zone[2] == 2018*) GOTO 0x0EBA
     0x0EB3 [0x1D] PRINT_EVENT_MESSAGE(message_id=6979*)
    → "3 is a wonderful new method of leathercraft that allows you to soak skins in a tanning vat, making it easier to process more leather with one crystal."
