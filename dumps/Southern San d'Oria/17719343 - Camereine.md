...
- **6545**: If you wish to ride a chocobo, you must possess $6 and have a high enough job level.
- **6546**: You can rent a chocobo for $0 gil. I see you currently have $1 gil.
- **6547**: You can rent a chocobo, but because your level is so low, you won't be able to ride for very long. Also, equipment that extends your riding time will have no effect.
- **6548**: If you still want one, it will cost you $0 gil. I see you currently have $1 gil.
- **6549**: Do you wish to rent a chocobo? [Yes, I do./No, thank you.]
- **6550**: You don't have enough gil.
- **6551**: I realize that you are in a hurry, [sir/ma'am]. However, might I make a simple request? One of our associate's chocobos has lost her way and cannot return home.
- **6552**: Would you be so kind as to deliver her to [the Kingdom/the Republic/the Federation/the Duchy/the Duchy/the Duchy/the hidden] stables in [Southern San d'Oria/the Bastok Mines/Windurst Woods/Upper Jeuno/Lower Jeuno/Port Jeuno/Norg]?
- **6553**: Lend a helping hand? [I have better things to do./Of course!]
- **6554**: Oh, thank you so very much! You shall be rewarded by our associates upon delivery of the chocobo.
...
```
  ...
  2: 0x000E [0x1D] PRINT_EVENT_MESSAGE(message_id=6551*)
  ...
  4: 0x0012 [0x1D] PRINT_EVENT_MESSAGE(message_id=6552*)
  ...
  6: 0x0016 [0x24] CREATE_DIALOG(message_id=6553*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0042:
 ...
 20: 0x0077 [0x1D] PRINT_EVENT_MESSAGE(message_id=6546*)
 ...
 23: 0x007E [0x1D] PRINT_EVENT_MESSAGE(message_id=6547*)
 ...
 25: 0x0082 [0x1D] PRINT_EVENT_MESSAGE(message_id=6548*)
    → "If you still want one, it will cost you $0 gil. I see you currently have $1 gil."
 26: 0x0085 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_0086:
 27: 0x0086 [0x24] CREATE_DIALOG(message_id=6549*, default_option=1*, option_flags=0*)
...
SUBROUTINE_009E:
 ...
 54: 0x013C [0x1D] PRINT_EVENT_MESSAGE(message_id=6550*)
...
```
  ...
  2: 0x015B [0x1D] PRINT_EVENT_MESSAGE(message_id=6545*)
