...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0090:                      03  05 00 06 80 27 80 71 61         .....'.qa
00A0: 0E 01 02 32 09 80 59 00  0A 80 03 02 17 0B 80 02  ...2..Y.........
00B0: 05 17 05 80 80 D2 00 03  02 00 0C 80 03 03 00 0D  ................
00C0: 80 27 80 6F 61 0E 01 0B  27 80 6F 61 0E 01 0C 01  .'.oa...'.oa....
00D0: 18 01 02 05 17 06 80 80  F5 00 03 02 00 0C 80 03  ................
00E0: 03 00 0E 80 27 80 6F 61  0E 01 0B 27 80 6F 61 0E  ....'.oa...'.oa.
00F0: 01 12 01 18 01 02 05 17  04 80 80 18 01 03 02 00  ................
0100: 0C 80 03 03 00 0F 80 27  80 6F 61 0E 01 0B 27 80  .......'.oa...'.
0110: 6F 61 0E 01 18 01 18 01  00                       oa.......       
```
...
```
  ...
  1: 0x009C [0x27] REQ_SET(priority=0x80, entity_id=Unnamed NPC (ID: 17719665/0x010E6171), tag_num=0x02)
  2: 0x00A3 [0x32] ExtData[1]->MainSpeed = 20* * 0.1
  3: 0x00A6 [0x59] UPDATE_ENTITY_DATA: Set EventEntity target turn speed = 50*
  4: 0x00AA [0x03] Work_Zone_1700[2] = 4294963696*
  5: 0x00AF [0x02] IF !(Work_Zone_1700[5] == 0*) GOTO 0x00D2
  6: 0x00B7 [0x03] ExtData[1]->WorkLocal[2] = 4294708296*
  7: 0x00BC [0x03] ExtData[1]->WorkLocal[3] = 80500*
  8: 0x00C1 [0x27] REQ_SET(priority=0x80, entity_id=Chocobo (ID: 17719663/0x010E616F), tag_num=0x0B)
  9: 0x00C8 [0x27] REQ_SET(priority=0x80, entity_id=Chocobo (ID: 17719663/0x010E616F), tag_num=0x0C)
 10: 0x00CF [0x01] GOTO 0x0118
 11: 0x00D2 [0x02] IF !(Work_Zone_1700[5] == 1*) GOTO 0x00F5
 12: 0x00DA [0x03] ExtData[1]->WorkLocal[2] = 4294708296*
 13: 0x00DF [0x03] ExtData[1]->WorkLocal[3] = 83000*
 14: 0x00E4 [0x27] REQ_SET(priority=0x80, entity_id=Chocobo (ID: 17719663/0x010E616F), tag_num=0x0B)
 15: 0x00EB [0x27] REQ_SET(priority=0x80, entity_id=Chocobo (ID: 17719663/0x010E616F), tag_num=0x12)
 16: 0x00F2 [0x01] GOTO 0x0118
 17: 0x00F5 [0x02] IF !(Work_Zone_1700[5] == 2*) GOTO 0x0118
 18: 0x00FD [0x03] ExtData[1]->WorkLocal[2] = 4294708296*
 19: 0x0102 [0x03] ExtData[1]->WorkLocal[3] = 85500*
 20: 0x0107 [0x27] REQ_SET(priority=0x80, entity_id=Chocobo (ID: 17719663/0x010E616F), tag_num=0x0B)
 21: 0x010E [0x27] REQ_SET(priority=0x80, entity_id=Chocobo (ID: 17719663/0x010E616F), tag_num=0x18)
...
```
  ...
  2: 0x0204 [0x03] ExtData[1]->WorkLocal[2] = 4294705296*
  ...
  9: 0x022A [0x03] ExtData[1]->WorkLocal[3] = 83000*
 ...
 15: 0x0248 [0x03] ExtData[1]->WorkLocal[2] = 4294705296*
...
```
  ...
  3: 0x03E8 [0x03] ExtData[1]->WorkLocal[3] = 85500*
  ...
  9: 0x0406 [0x03] ExtData[1]->WorkLocal[2] = 4294707296*
...
SUBROUTINE_041C:
 ...
 16: 0x042C [0x03] ExtData[1]->WorkLocal[3] = 80500*
 ...
 22: 0x044A [0x03] ExtData[1]->WorkLocal[2] = 4294707296*
...
```
  ...
  3: 0x058F [0x03] ExtData[1]->WorkLocal[3] = 80500*
  ...
  9: 0x05AD [0x03] ExtData[1]->WorkLocal[2] = 4294704296*
...
SUBROUTINE_05C3:
 ...
 16: 0x05D3 [0x03] ExtData[1]->WorkLocal[3] = 85500*
 ...
 22: 0x05F1 [0x03] ExtData[1]->WorkLocal[2] = 4294704296*
...
```
  ...
  3: 0x06A9 [0x03] ExtData[1]->WorkLocal[3] = 80500*
  ...
  9: 0x06C7 [0x03] ExtData[1]->WorkLocal[2] = 4294702296*
...
SUBROUTINE_06FD:
 ...
 22: 0x070D [0x03] ExtData[1]->WorkLocal[3] = 85500*
 ...
 28: 0x072B [0x03] ExtData[1]->WorkLocal[2] = 4294702296*
...
```
  ...
  2: 0x07D5 [0x03] ExtData[1]->WorkLocal[2] = 4294706296*
  ...
  9: 0x07FB [0x03] ExtData[1]->WorkLocal[3] = 83000*
 ...
 15: 0x0819 [0x03] ExtData[1]->WorkLocal[2] = 4294706296*
...
```
  ...
  2: 0x08A3 [0x03] ExtData[1]->WorkLocal[2] = 4294704296*
  ...
  9: 0x08C9 [0x03] ExtData[1]->WorkLocal[3] = 83000*
 ...
 15: 0x08E7 [0x03] ExtData[1]->WorkLocal[2] = 4294704296*
