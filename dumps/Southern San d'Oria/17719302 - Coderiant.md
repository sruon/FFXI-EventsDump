...
- **8213**: Are you lost? I know this neighborhood well.
- **8214**: Which way are you going? [Left./Right.]
- **8215**: There on Pikeman's Way you can find a grocer, sundries and the Tanners' Guild. At the end lies the mansion of Count Caffaule.
- **8216**: Go up those stairs for Watchdog Alley. Homes of townsfolk line the street.
- **11994**: Ask if this person is the chick's owner? [Yes./No.]
- **12013**: You have my chocobo?
- **12014**: My family was opposed to having a chocobo as a pet, so I raised her in secret. But one day, they found her... I...I had to let her go...
- **12015**: There must be a way for chocobos and people to live together in peace! Here, let me teach you a story I often tell my chocobo...
- **12037**: You say you have my chocobo?
- **12038**: Although I have always granted my chocobo a measure of independence, I do give her proper care. You must be mistaken.
...
```
  ...
  5: 0x001A [0x1D] PRINT_EVENT_MESSAGE(message_id=8213*)
  ...
  8: 0x0023 [0x24] CREATE_DIALOG(message_id=8214*, default_option=0*, option_flags=0*)
 ...
 15: 0x0047 [0x1D] PRINT_EVENT_MESSAGE(message_id=8215*)
 ...
 26: 0x0089 [0x1D] PRINT_EVENT_MESSAGE(message_id=8216*)
...
SUBROUTINE_00AF:
 ...
 39: 0x00C9 [0x24] CREATE_DIALOG(message_id=11994*, default_option=1*, option_flags=0*)
 ...
 48: 0x00F2 [0x1D] PRINT_EVENT_MESSAGE(message_id=12013*)
    → "You have my chocobo?"
 ...
 51: 0x0105 [0x1D] PRINT_EVENT_MESSAGE(message_id=12014*)
 ...
 54: 0x0118 [0x1D] PRINT_EVENT_MESSAGE(message_id=12015*)
 ...
 57: 0x011F [0x1D] PRINT_EVENT_MESSAGE(message_id=12037*)
 ...
 60: 0x0132 [0x1D] PRINT_EVENT_MESSAGE(message_id=12038*)
