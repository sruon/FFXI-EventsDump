...
```
  ...
  5: 0x001A [0x1D] PRINT_EVENT_MESSAGE(message_id=8209*)
    → "Are you lost? I know this neighborhood well.\u007F1\u0000\u0007"
  ...
  8: 0x0023 [0x24] CREATE_DIALOG(message_id=8210*, default_option=0*, option_flags=0*)
    → "Which way are you going?\u0007\u000BLeft.\u0007Right.\u007F1\u0000\u0007"
 ...
 14: 0x0038 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="poi1")
 15: 0x0047 [0x1D] PRINT_EVENT_MESSAGE(message_id=8211*)
    → "There on Pikeman's Way you can find a grocer, sundries and the Tanners' Guild. At the end lies the mansion of Count Caffaule.\u007F1\u0000\u0007"
 16: 0x004A [0x23] WAIT_FOR_DIALOG_INTERACTION
 17: 0x004B [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="poi2")
 18: 0x005A [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="poi2")
...
SUBROUTINE_006D:
 ...
 25: 0x007A [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="poi1")
 26: 0x0089 [0x1D] PRINT_EVENT_MESSAGE(message_id=8212*)
    → "Go up those stairs for Watchdog Alley. Homes of townsfolk line the street.\u007F1\u0000\u0007"
 27: 0x008C [0x23] WAIT_FOR_DIALOG_INTERACTION
 28: 0x008D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="poi2")
 29: 0x009C [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="poi2")
...
SUBROUTINE_00C8:
 ...
 48: 0x00F2 [0x1D] PRINT_EVENT_MESSAGE(message_id=11997*)
    → "You have my chocobo?\u007F1\u0000\u0007"
 49: 0x00F5 [0x23] WAIT_FOR_DIALOG_INTERACTION
 50: 0x00F6 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=21*, entity1=EventEntity, entity2=EventEntity, action="dis0")
 51: 0x0105 [0x1D] PRINT_EVENT_MESSAGE(message_id=11998*)
    → "My family was opposed to having a chocobo as a pet, so I raised her in secret. But one day, they found her... I...I had to let her go...\u007F1\u0000\u0007"
 52: 0x0108 [0x23] WAIT_FOR_DIALOG_INTERACTION
 53: 0x0109 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 54: 0x0118 [0x1D] PRINT_EVENT_MESSAGE(message_id=11999*)
    → "There must be a way for chocobos and people to live together in peace! Here, let me teach you a story I often tell my chocobo...\u007F1\u0000\u0007"
...
SUBROUTINE_011F:
 ...
 59: 0x0123 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 60: 0x0132 [0x1D] PRINT_EVENT_MESSAGE(message_id=12022*)
    → "Although I have always granted my chocobo a measure of independence, I do give her proper care. You must be mistaken.\u007F1\u0000\u0007"
