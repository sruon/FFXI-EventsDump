...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0100:             1E F0 FF FF  7F 6F 70 1D 12 80 23 21      .....op...#!
0110: 00                                                .               
```
...
```
  ...
  3: 0x010B [0x1D] PRINT_EVENT_MESSAGE(message_id=9123*)
    → "So, that whole church uproar was Rainemard's doing... Well, I am glad his spirit found rest, and you made it out safely.\u007F1\u0000\u0007"
  4: 0x010E [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x010F [0x21] END_EVENT
  6: 0x0110 [0x00] END_REQSTACK()
```
