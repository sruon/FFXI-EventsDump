...
SUBROUTINE_223D:
  2: 0x223D [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk0" with entities [EventEntity, EventEntity], work=20*
  3: 0x224C [0x1B] RETURN

SUBROUTINE_224D:
  4: 0x224D [0x5E] EventEntity goes idle (kills current action) (animation: "idl0")
  5: 0x2252 [0x1B] RETURN
```
