...
```
  ...
  2: 0x0071 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  ...
  7: 0x0096 [0x45] LOAD_SCHEDULED_TASK(work_offset1=90*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s042", work_offset2=0*)
  8: 0x00A7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
  9: 0x00B8 [0x55] WAIT_LOAD_SCHEDULER(work_offset=90*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s042")
 ...
 16: 0x00E0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s014", work_offset2=0*)
 17: 0x00F1 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 21: 0x0107 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 22: 0x0116 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="thk2")
 23: 0x0123 [0x1C] WAIT(30* ticks)
 24: 0x0126 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 25: 0x0135 [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s016", work_offset2=0*)
 ...
 35: 0x0166 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 36: 0x0175 [0x45] LOAD_SCHEDULED_TASK(work_offset1=90*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s090", work_offset2=0*)
 ...
 46: 0x01B0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=90*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s091", work_offset2=0*)
 47: 0x01C1 [0x01] GOTO 0x01F1

SUBROUTINE_01C4:
 48: 0x01C4 [0x02] IF !(Work_Zone[9] == 6*) GOTO 0x01E0
 49: 0x01CC [0x45] LOAD_SCHEDULED_TASK(work_offset1=90*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s091", work_offset2=0*)
 50: 0x01DD [0x01] GOTO 0x01F1

SUBROUTINE_01E0:
 51: 0x01E0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s017", work_offset2=0*)
 ...
 58: 0x020A [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 59: 0x0219 [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s016", work_offset2=0*)
...
SUBROUTINE_0282:
 79: 0x0282 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 80: 0x0293 [0x1C] WAIT(60* ticks)
 81: 0x0296 [0x46] CAMERA_CONTROL: Restore default settings
 82: 0x0298 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
