...
```
  ...
  1: 0x0004 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-107.208*, z=-49.740*, y=0.000*, direction=314.2°*
...
```
  ...
  1: 0x0010 [0x5A] UPDATE_EVENT_POSITION: Set EventEntity MovePosition to X=-106.130*, Z=-47.569*, Y=0.999*
  ...
  4: 0x001C [0x1F] MOVE_ENTITY: EventEntity moves to X=-101.061*, Z=-43.874*, Y=0.999*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0030:             66 0D 80 F8  FF FF 7F F8 FF FF 7F 74      f..........t
0040: 6C 6B 30 1C 0E 80 00                              lk0....         
```
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0040:                      66  0D 80 F8 FF FF 7F F8 FF         f........
