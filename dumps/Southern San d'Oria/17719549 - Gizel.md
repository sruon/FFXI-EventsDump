...
- **9901**: Which memory will you have recalled? [Nothing./San d'Oria Missions./San d'Oria Quests 1./San d'Oria Quests 2./Other Quests./Promathia Missions./Wings of the Goddess Missions.]
- **9902**: Which memory will you have recalled? [Nothing./Smash the Orcish Scouts./The Heir to the Light.]
- **9903**: Which memory will you have recalled? [Nothing./Rosel the Armorer./The Sweetest Things./A Squire's Test(pt.1)./A Squire's Test(pt.2)./A Squire's Test II(pt.1)./A Squire's Test II(pt.2)./A Knight's Test(pt.1)./A Knight's Test(pt.2)./To Cure a Cough./Distant Loyalties(pt.1)./Distant Loyalties(pt.2)./The Crimson Trial(pt.1)./The Crimson Trial(pt.2)./Peace for the Spirit./A Boy's Dream./Under Oath(pt.1)./Under Oath(pt.2)./Knight Stalker./Dueling Brothers./Methods Create Madness(pt.1)./Methods Create Madness(pt.2)./Methods Create Madness(pt.3)./A Timely Visit(pt.1)./A Timely Visit(pt.2)./A Timely Visit(pt.3)./A Timely Visit(pt.4)./A Timely Visit(pt.5)./A Timely Visit(pt.6)./A Timely Visit(pt.7).]
- **9904**: Which memory will you have recalled? [Nothing./Signed in Blood(pt.1)./Signed in Blood(pt.2)./Signed in Blood(pt.3)./Tea with a Tonberry?(pt.1)./Tea with a Tonberry?(pt.2)./Spice Gals(pt.1)./Spice Gals(pt.2)./Son and Father.]
- **9905**: Which memory will you have recalled? [Nothing./Dynamis - The Shrouded Land(pt.1)./Dynamis - The Shrouded Land(pt.2)./Dynamis Interloper./Elderly Pursuits(pt.1)./Elderly Pursuits(pt.2)./An Understanding Overlord?(pt.1)./An Understanding Overlord?(pt.2)./A Generous General?(pt.1)./A Generous General?(pt.2)./Mixed Signals./Chocobo on the Loose!(pt.1)./Chocobo on the Loose!(pt.2)./Lakeside Minuet./Say It with a Handbag(pt.1)./Say It with a Handbag(pt.2)./Say It with a Handbag(pt.3)./Say It with a Handbag(pt.4)./Her Memories: Homecoming Queen./Her Memories: Old Bean./Her Memories: Of Malign Maladies./Drafted by the Duchy./Battle on a New Front./VW Op. #126: Qufim Incursion./Records of Eminence./Unity Concord(pt.1)./Unity Concord(pt.2)./Trust (AAHM)./Trust (AAEV)./Trust (AAMR)./Trust (AATT)./Trust (AAGK).]
- **9906**: Which memory will you have recalled? [Nothing./Louverance./Where Messengers Gather./A Name for the Ages(pt.1)./A Name for the Ages(pt.2).]
- **9907**: Which memory will you have recalled? [Nothing./Daughter of a Knight(pt.1)./Daughter of a Knight(pt.2)./Daughter of a Knight(pt.3)./A Spoonful of Sugar./Another World.]
...
```
 ...
 39: 0x00D4 [0x24] CREATE_DIALOG(message_id=9901*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00E4:
 42: 0x00E4 [0x24] CREATE_DIALOG(message_id=9902*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_0113:
 50: 0x0113 [0x24] CREATE_DIALOG(message_id=9903*, default_option=0*, option_flags=Work_Zone[3])
...
SUBROUTINE_0142:
 58: 0x0142 [0x24] CREATE_DIALOG(message_id=9904*, default_option=0*, option_flags=Work_Zone[4])
...
SUBROUTINE_0171:
 66: 0x0171 [0x24] CREATE_DIALOG(message_id=9905*, default_option=0*, option_flags=Work_Zone[5])
...
SUBROUTINE_01A0:
 74: 0x01A0 [0x24] CREATE_DIALOG(message_id=9906*, default_option=0*, option_flags=Work_Zone[6])
...
SUBROUTINE_01CF:
 82: 0x01CF [0x24] CREATE_DIALOG(message_id=9907*, default_option=0*, option_flags=Work_Zone[7])
