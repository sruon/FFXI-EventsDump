...
- **7867**: Maybe it's the weather, but we've been selling mulsum so fast, we can't keep up! We need another cask as soon as possible!
- **7870**: Oh... Well, I have to get back now, but could you bring another one extra quick? Thanks!
...
```
  ...
  1: 0x002D [0x1D] PRINT_EVENT_MESSAGE(message_id=7867*)
...
```
  ...
  1: 0x0046 [0x1D] PRINT_EVENT_MESSAGE(message_id=7870*)
