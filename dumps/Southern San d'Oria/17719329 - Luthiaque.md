...
- **8336**: Hmm... Now where did I put it?
- **8337**: Oh, I'm sorry. I'm looking for something. Come back later.
- **8338**: I'm sorry, but that's all for today. Someone stole my dagger.
- **8339**: I'm Luthiaque. I travel hither and thither, bringing entertainment everywhere!
- **8340**: Juggling is my specialty, but not mere balls or dishes... No, I juggle daggers!
- **8341**: Did you bring me my dagger?
- **8342**: Well, did you? [Yes, I did./No, not yet.]
- **8343**: This is just the one! Thank you so much!
- **8344**: Oh...
- **8438**: Finding your way around Southern San d'Oria? You can look at my map if you'd like.
- **8439**: Look at the map? [Yes./No.]
- **8440**: Here in the center lies Victory Square. West is Pikeman's Way and Watchdog Alley, where you'll find the Tanners' Guild and Taumila's Sundries.
- **8441**: East is Cavalry Way and Squire Alley, with armor and weapons shops, and a tavern. The gate at the end leads to the housing area.
- **8442**: Is that so? Pity.
- **11993**: Ask if this person is the chick's owner? [Yes./No.]
- **12024**: You...you have my chocobo?
- **12025**: May Altana's blessings be upon you! I was teaching the little one to find his way home when I lost the poor creature.
- **12026**: You are raising a chocobo yourself, are you not? In that case, let me teach you a story I often tell my chocobo...
- **12043**: You say you have my chocobo?
- **12044**: My chocobo would never get lost. I trained him to find his way home all by himself!
...
```
  ...
  5: 0x001A [0x1D] PRINT_EVENT_MESSAGE(message_id=8438*)
  ...
  8: 0x0023 [0x24] CREATE_DIALOG(message_id=8439*, default_option=0*, option_flags=0*)
 ...
 12: 0x0038 [0x1D] PRINT_EVENT_MESSAGE(message_id=8440*)
 ...
 15: 0x003F [0x1D] PRINT_EVENT_MESSAGE(message_id=8441*)
 ...
 23: 0x0064 [0x1D] PRINT_EVENT_MESSAGE(message_id=8442*)
    → "Is that so? Pity."
...
SUBROUTINE_0073:
 ...
 35: 0x008D [0x24] CREATE_DIALOG(message_id=11993*, default_option=1*, option_flags=0*)
 ...
 42: 0x00AE [0x1D] PRINT_EVENT_MESSAGE(message_id=12024*)
 ...
 45: 0x00C1 [0x1D] PRINT_EVENT_MESSAGE(message_id=12025*)
 ...
 48: 0x00D4 [0x1D] PRINT_EVENT_MESSAGE(message_id=12026*)
 ...
 51: 0x00DB [0x1D] PRINT_EVENT_MESSAGE(message_id=12043*)
 ...
 54: 0x00EE [0x1D] PRINT_EVENT_MESSAGE(message_id=12044*)
...
```
  ...
  3: 0x0123 [0x1D] PRINT_EVENT_MESSAGE(message_id=8336*)
  ...
  7: 0x0139 [0x1D] PRINT_EVENT_MESSAGE(message_id=8337*)
...
```
  ...
  2: 0x0153 [0x1D] PRINT_EVENT_MESSAGE(message_id=8338*)
...
```
 ...
 12: 0x01B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=8344*)
    → "Oh..."
