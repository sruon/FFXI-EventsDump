...
```
 ...
 16: 0x006D [0x1D] PRINT_EVENT_MESSAGE(message_id=12031*)
    → "You have my chocobo? I must say, this is a surprise!\u007F1\u0000\u0007"
 ...
 19: 0x0080 [0x1D] PRINT_EVENT_MESSAGE(message_id=12032*)
    → "Especially since my chocobo becomes lonely so easily... He would never leave my side! I am afraid you are mistaken, \u007F\u0005[sir/ma'am].\u007F1\u0000\u0007"
 ...
 25: 0x009A [0x1D] PRINT_EVENT_MESSAGE(message_id=12016*)
    → "My chocobo easily becomes lonely... His crying must have kept you awake at night. I am sure I will have to tell him his favorite story several times before he calms down again.\u007F1\u0000\u0007"
 ...
 28: 0x00AD [0x1D] PRINT_EVENT_MESSAGE(message_id=12017*)
    → "As thanks for saving him, let me tell you the story, too...\u007F1\u0000\u0007"
...
SUBROUTINE_00D6:
 ...
 43: 0x00EA [0x24] CREATE_DIALOG(message_id=6574*, default_option=0x0002, option_flags=0x05)
...
179: 0x0376 [0x3D] CLEAR_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8013, condition_work_offset=0x8003)
180: 0x037D [0x01] GOTO 0x0387
181: 0x0380 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8013, condition_work_offset=0x8003)
182: 0x0387 [0x02] IF !(ExtData[1]->WorkLocal[3] >= ExtData[1]->WorkLocal[16]) GOTO 0x0399
183: 0x038F [0x3D] CLEAR_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8014, condition_work_offset=0x8003)
184: 0x0396 [0x01] GOTO 0x03A0
185: 0x0399 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8014, condition_work_offset=0x8003)
186: 0x03A0 [0x02] IF !(ExtData[1]->WorkLocal[3] <= 0*) GOTO 0x03B2
187: 0x03A8 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8003, condition_work_offset=0x8003)
188: 0x03AF [0x01] GOTO 0x03B9
189: 0x03B2 [0x3D] CLEAR_BIT_FLAG_CONDITIONAL(target_work_offset=0x05, bit_index_work_offset=0x8003, condition_work_offset=0x8003)
