...
- **9283**: I'm glad they've run out of mulsum--it would completely ruin my diet!
- **9284**: May I speak with you for a moment? Oh...it seems you have other matters to attend to. Perhaps another time.
- **9286**: May I speak with you for a moment about the ecology of Vana'diel?
- **9287**: Are you interested? [Of course!/Sounds fascinating, but...]
- **9288**: Have you heard of Ordelle's Caves?
- **9289**: Yes, those beautiful natural formations that wind their way under the La Theine Plateau.
- **9290**: Are you aware that right now, a limestone-eating fiend is destroying the splendor of the caves with its voracious appetite?
- **9291**: We need the assistance of upstanding, environmentally conscious adventurers such as yourself in ridding the caves of this monster. Can we count on your cooperation?
- **9292**: Take on the task? [You can count on me!/I have to clean my Mog House...]
- **9293**: I knew you'd come through for us! Bring me proof that you've defeated the creature, and I'll pay you a reward from the Vana'diel Environmental Resource Management Initiative Network fund.
- **9294**: Rojaireaut, our V.E.R.M.I.N. agent in the field, will be waiting for you in the caves. Come back safe, now!
- **9295**: I see... Well, I suppose I must ask another citizen for help.
- **9296**: Rojaireaut, our V.E.R.M.I.N. agent in the field, will be waiting with further instructions in the caves.
- **9297**: You've brought me $6 from the vanquished fiend? Wonderful! I knew you could do it! Here's your reward, as promised.
...
```
  ...
  5: 0x0018 [0x1D] PRINT_EVENT_MESSAGE(message_id=9286*)
    → "May I speak with you for a moment about the ecology of Vana'diel?"
  6: 0x001B [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x001C [0x24] CREATE_DIALOG(message_id=9287*, default_option=1*, option_flags=0*)
 ...
 10: 0x002C [0x1D] PRINT_EVENT_MESSAGE(message_id=9288*)
    → "Have you heard of Ordelle's Caves?"
 11: 0x002F [0x23] WAIT_FOR_DIALOG_INTERACTION
 12: 0x0030 [0x1D] PRINT_EVENT_MESSAGE(message_id=9289*)
 ...
 14: 0x0034 [0x1D] PRINT_EVENT_MESSAGE(message_id=9290*)
 ...
 16: 0x0038 [0x1D] PRINT_EVENT_MESSAGE(message_id=9291*)
 ...
 19: 0x004B [0x24] CREATE_DIALOG(message_id=9292*, default_option=1*, option_flags=0*)
 ...
 24: 0x006B [0x1D] PRINT_EVENT_MESSAGE(message_id=9293*)
 ...
 28: 0x0083 [0x1D] PRINT_EVENT_MESSAGE(message_id=9294*)
 ...
 38: 0x00C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=9295*)
...
SUBROUTINE_00F1:
 ...
 49: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=9295*)
    → "I see... Well, I suppose I must ask another citizen for help."
...
```
  ...
  5: 0x0152 [0x1D] PRINT_EVENT_MESSAGE(message_id=9283*)
...
```
  ...
  5: 0x0180 [0x1D] PRINT_EVENT_MESSAGE(message_id=9296*)
...
```
  ...
  5: 0x01AE [0x1D] PRINT_EVENT_MESSAGE(message_id=9283*)
    → "I'm glad they've run out of mulsum--it would completely ruin my diet!"
...
```
  ...
  6: 0x01E1 [0x1D] PRINT_EVENT_MESSAGE(message_id=9297*)
...
```
  ...
  5: 0x0247 [0x1D] PRINT_EVENT_MESSAGE(message_id=9284*)
