...
```
  ...
  3: 0x04BB [0x5B] LOAD_EXT_SCHEDULER(work_offset=872*, entity1=Unnamed NPC (ID: 17719571/0x010E6113), entity2=Unnamed NPC (ID: 17719571/0x010E6113), action="hi03")
  4: 0x04CA [0x45] LOAD_SCHEDULED_TASK(work_offset1=198*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s174", work_offset2=0*)
  5: 0x04DB [0x1C] WAIT(60* ticks)
  6: 0x04DE [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 ...
 15: 0x051B [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 16: 0x052C [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
