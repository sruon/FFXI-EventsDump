...
- **12299**: Well met! I'm a Merry Map Marker, and I'd love to make marks all over your merry $3, but it appears you are missing the markable map I mention.
- **12300**: Good day! I'm a Merry Map Marker, and I'd be emphatically ecstatic if you'd allow me to mark your magical map!
- **12301**: A markless $3 is like a motherless maiden, meandering through a miasmatic mire of misery.
- **12302**: Embark on a map-marking mission? [Mark me up!/Keep your mitts off my map!]
- **12303**: Marvelous! Now allow me a minute to make all my marks.
- **12304**: Methinks I have marked your map with as many marks as I might manage.
- **12305**: Monitoring and managing your marks is as simple as merely opening your map and selecting Markers from the main menu.
- **12306**: If the marks on your map might vanish, mope not like a melancholy milksop. Make another meeting with me and I shall make it my mission to mark the map once more.
- **12307**: Good day, [milord/milady]. May your marches across meadow and mountain be markedly memorable!
- **12310**: And mayhap you are immeasurably motivated to compete in the medieval mayhem of Conflict? Might I suggest you mingle with the modest Pursuivant located here?
- **12311**: Our local minstrel of melodies can be found here. His mirthful musicalities may help you recall misplaced memories.
- **12313**: Here, you may meet with a member of the Specialty Goods Trade Union. And, if you are a citizen of this mighty dominion, he'll teleport you all across Vana'diel (for a menial amount of monetary remuneration).
- **12314**: Need to know the local weather? Our local meteorologist will be making his paramount presumptions here.
- **12316**: Those men and women wondering how their deeds are mirrored in the minds of the locals should meander over to this gossip-meister to muster up important material on their respective reputations.
- **12319**: Let me begin with Southern San d'Oria.
- **12320**: Now I shall move to Northern San d'Oria.
- **12321**: And last, but not least, let me mark your map for Port San d'Oria.
...
```
  ...
  2: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=12300*)
  ...
  5: 0x0011 [0x1D] PRINT_EVENT_MESSAGE(message_id=12301*)
  ...
  7: 0x0015 [0x24] CREATE_DIALOG(message_id=12302*, default_option=1*, option_flags=0*)
 ...
 11: 0x002A [0x1D] PRINT_EVENT_MESSAGE(message_id=12303*)
 ...
 36: 0x00B2 [0x1D] PRINT_EVENT_MESSAGE(message_id=12319*)
 ...
 51: 0x00F8 [0x1D] PRINT_EVENT_MESSAGE(message_id=12311*)
 ...
 58: 0x0118 [0x1D] PRINT_EVENT_MESSAGE(message_id=12314*)
...
# Dead code (unreachable instructions):
     ...
     0x0158 [0x1D] PRINT_EVENT_MESSAGE(message_id=12316*)
    → "Those men and women wondering how their deeds are mirrored in the minds of the locals should meander over to this gossip-meister to muster up important material on their respective reputations."
     ...
     0x0163 [0x1D] PRINT_EVENT_MESSAGE(message_id=12320*)
    → "Now I shall move to Northern San d'Oria."
     ...
     0x01A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=12313*)
    → "Here, you may meet with a member of the Specialty Goods Trade Union. And, if you are a citizen of this mighty dominion, he'll teleport you all across Vana'diel (for a menial amount of monetary remuneration)."
     ...
     0x01E9 [0x1D] PRINT_EVENT_MESSAGE(message_id=12311*)
    → "Our local minstrel of melodies can be found here. His mirthful musicalities may help you recall misplaced memories."
     ...
     0x0209 [0x1D] PRINT_EVENT_MESSAGE(message_id=12310*)
    → "And mayhap you are immeasurably motivated to compete in the medieval mayhem of Conflict? Might I suggest you mingle with the modest Pursuivant located here?"
     ...
     0x0214 [0x1D] PRINT_EVENT_MESSAGE(message_id=12321*)
    ...
    → "Monitoring and managing your marks is as simple as merely opening your map and selecting Markers from the main menu."
     ...
     0x0272 [0x1D] PRINT_EVENT_MESSAGE(message_id=12306*)
    → "If the marks on your map might vanish, mope not like a melancholy milksop. Make another meeting with me and I shall make it my mission to mark the map once more."
     ...
     0x0276 [0x1D] PRINT_EVENT_MESSAGE(message_id=12307*)
...
```
  ...
  2: 0x0286 [0x1D] PRINT_EVENT_MESSAGE(message_id=12300*)
    → "Good day! I'm a Merry Map Marker, and I'd be emphatically ecstatic if you'd allow me to mark your magical map!"
  3: 0x0289 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x028A [0x03] Work_Zone[2] = 385*
  5: 0x028F [0x1D] PRINT_EVENT_MESSAGE(message_id=12299*)
