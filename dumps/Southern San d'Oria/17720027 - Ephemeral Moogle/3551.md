...
SUBROUTINE_077D:
  ...
  2: 0x0782 [0x1D] PRINT_EVENT_MESSAGE(message_id=16366*)
...
# Dead code (unreachable instructions):
    ...
    → "To think you can perceive me in my true form, kupo! The trials of time take a toll on us all.\u007F1\u0000\u0007"
     ...
     0x002C [0x1D] PRINT_EVENT_MESSAGE(message_id=16322*)
    → "I command and control crystal-related incantations. Their ephemeral essence helps hold Vana'diel together.\u007F1\u0000\u0007"
     ...
     0x0030 [0x1D] PRINT_EVENT_MESSAGE(message_id=16323*)
    → "Surely you have studied synthesis? Then you are doubtlessly versed in their myriad uses, kupo.\u007F1\u0000\u0007"
     ...
     0x0034 [0x1D] PRINT_EVENT_MESSAGE(message_id=16324*)
    → "Promise you will not speak a syllable to others of my existence here.\u007F1\u0000\u0007"
     ...
     0x0045 [0x24] CREATE_DIALOG(message_id=16325*, default_option=0*, option_flags=0*)
    → "Will you stay mum?\u0007\u000BMum's the word.\u0007I don't think so.\u007F1\u0000\u0007"
     ...
     0x0058 [0x1D] PRINT_EVENT_MESSAGE(message_id=16326*)
    → "...\u007F1\u0000\u0007"
     ...
     0x0069 [0x1D] PRINT_EVENT_MESSAGE(message_id=16327*)
    → "I scarce have the stamina to stop you, but I doubt others would believe this tale anyway.\u007F1\u0000\u0007"
     ...
     0x006D [0x1D] PRINT_EVENT_MESSAGE(message_id=16328*)
    → "Still, I shan't assist you if you don't promise.\u007F1\u0000\u0007"
     ...
     0x008F [0x1D] PRINT_EVENT_MESSAGE(message_id=16329*)
    → "Then the deed is done! In exchange, I shall proudly proffer my services in making your crystals ephemeral, too, kupo.\u007F1\u0000\u0007"
     ...
     0x0093 [0x1D] PRINT_EVENT_MESSAGE(message_id=16330*)
    → "Ahhh, mayhap I have moved too quickly. Allow me to apprise you of the particulars--of this \u00072crystal storage,\u00073 if you will.\u007F1\u0000\u0007"
     ...
     0x00B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=16331*)
    ...
    → "This service is available to you free from the fetters of funding. As long as you keep this hush-hush, I'll always assist you with no recompense required.\u007F1\u0000\u0007"
     ...
     0x00D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=16339*)
    → "If you can find me here, then you'll surely see me in other locations too, kupo. Moogle magic, you know.\u007F1\u0000\u0007"
     ...
     0x00DC [0x1D] PRINT_EVENT_MESSAGE(message_id=16340*)
    → "Of course, I do not actually exist in Vana'diel. Only a part of me projects into your world.\u007F1\u0000\u0007"
     ...
     0x00E0 [0x1D] PRINT_EVENT_MESSAGE(message_id=16341*)
    → "It's rather similar to summoning magic, kupo.\u007F1\u0000\u0007"
     0x00E3 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x00E4 [0x1D] PRINT_EVENT_MESSAGE(message_id=16342*)
    ...
    → "You are now able to store crystals!\u0000\u0007"
     ...
     0x014A [0x1D] PRINT_EVENT_MESSAGE(message_id=16344*)
    → "Come for crystal-related concerns, hmm?\u007F1\u0000\u0007"
     ...
     0x0159 [0x24] CREATE_DIALOG(message_id=16345*, default_option=0*, option_flags=0*)
    → "What would you like?\u0007\u000BCrystals returned to me.\u0007A bit of an explanation.\u0007Nothing for now.\u007F1\u0000\u0007"
     ...
     0x0217 [0x24] CREATE_DIALOG(message_id=16346*, default_option=0*, option_flags=ExtData[1]->WorkLocal[9])
...
\u0007\u007F1\u0000\u0007"
     ...
     0x035F [0x24] CREATE_DIALOG(message_id=16347*, default_option=0*, option_flags=0*)
    → "How many would you like?\u0007\u000BNone, actually.\u0007A specific number.\u0007As many you can fit.\u007F1\u0000\u0007"
     ...
     0x0382 [0x1D] PRINT_EVENT_MESSAGE(message_id=16348*)
    → "How many? (
\u0008 stored)\u0000\u0007"
     ...
     0x0395 [0x1D] PRINT_EVENT_MESSAGE(message_id=16356*)
    → "There are limits to what my mysterious moogle magic can make up.\u007F1\u0000\u0007"
     ...
     0x03A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=16356*)
    → "There are limits to what my mysterious moogle magic can make up.\u007F1\u0000\u0007"
     ...
     0x03C3 [0x1D] PRINT_EVENT_MESSAGE(message_id=16349*)
    → "
\u0001 \u000C\u0000[/fire/ice/wind/earth/lightning/water/light/darkness] crystal\u007F\u0012\u0001[/s], correct? Then that will mean a total of...\u007F1\u0000\u0007"
     ...
     0x03FC [0x1D] PRINT_EVENT_MESSAGE(message_id=16351*)
    → "
\u0001 \u0001	)\u0002\u0001\u0000\u0000\u0002\u0000\u0000\u0000 and 
\u0003 \u0001	)\u0002\u0003\u0000\u0000\u0002\u0002\u0000\u0000.\u007F1\u0000\u0007"
     ...
     0x040D [0x1D] PRINT_EVENT_MESSAGE(message_id=16350*)
    → "
\u0001 \u0001	)\u0002\u0001\u0000\u0000\u0002\u0000\u0000\u0000.\u007F1\u0000\u0007"
     ...
     0x0426 [0x1D] PRINT_EVENT_MESSAGE(message_id=16350*)
    → "
\u0001 \u0001	)\u0002\u0001\u0000\u0000\u0002\u0000\u0000\u0000.\u007F1\u0000\u0007"
     0x0429 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x042A [0x01] GOTO 0x042D
     0x042D [0x1D] PRINT_EVENT_MESSAGE(message_id=16352*)
    → "Are you sure?\u0000\u0007"
     0x0430 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0431 [0x24] CREATE_DIALOG(message_id=16353*, default_option=0*, option_flags=0*)
    → "Is this what you desire?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
     ...
     0x0442 [0x1D] PRINT_EVENT_MESSAGE(message_id=16355*)
    → "Okay...\u0007Moogle Magic, ahoy!\u007F1\u0000\u0007"
     ...
     0x04AE [0x1D] PRINT_EVENT_MESSAGE(message_id=16354*)
    → "\u00072As many as you can fit!?\u00073\u0007I-if you say so...\u007F1\u0000\u0007"
     ...
     0x04BF [0x1D] PRINT_EVENT_MESSAGE(message_id=16352*)
    → "Are you sure?\u0000\u0007"
     0x04C2 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x04C3 [0x24] CREATE_DIALOG(message_id=16353*, default_option=0*, option_flags=0*)
    → "Is this what you desire?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
     0x04CA [0x25] WAIT_DIALOG_SELECT()
     0x04CB [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x050B
     0x04D3 [0x42] SET_CLI_EVENT_CANCEL_DATA()
     0x04D4 [0x1D] PRINT_EVENT_MESSAGE(message_id=16355*)
    → "Okay...\u0007Moogle Magic, ahoy!\u007F1\u0000\u0007"
     ...
     0x0541 [0x24] CREATE_DIALOG(message_id=16357*, default_option=0*, option_flags=0*)
    → "Inquire about what?\u0007\u000BYour purpose.\u0007Storing crystals.\u0007Retrieving crystals.\u0007Who are you?\u0007Nothing in particular.\u007F1\u0000\u0007"
     ...
     0x055E [0x1D] PRINT_EVENT_MESSAGE(message_id=16358*)
    → "I'm in charge of crystal chants. Crystals, of course, are the very lifeblood of Vana'diel, kupo.\u007F1\u0000\u0007"
     ...
     0x0562 [0x1D] PRINT_EVENT_MESSAGE(message_id=16359*)
    → "Surely your sacks are spilling over with them! I can perhaps assist you with your problem.\u007F1\u0000\u0007"
     ...
     0x058B [0x1D] PRINT_EVENT_MESSAGE(message_id=16331*)
    → "It's strikingly simple. Trade me your crystals and I shall safely store them for you. You need only glance at your currencies list to see the amount I'm holding for you.\u007F1\u0000\u0007"
     0x058E [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x058F [0x03] Work_Zone[2] = 4104*
     0x0594 [0x1D] PRINT_EVENT_MESSAGE(message_id=16332*)
    → "But I can store more than crystals alone. \u007F\u0000\u0001\u0001\u0005%\u0002\u0000\u0000\u0000 and the like are also acceptable.\u007F1\u0000\u0007"
     0x0597 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0598 [0x1D] PRINT_EVENT_MESSAGE(message_id=16333*)
    → "My mysterious moogle magic has limits, kupo, so I can only hold up to 5000 of a particular element.\u007F1\u0000\u0007"
     0x059B [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x059C [0x1D] PRINT_EVENT_MESSAGE(message_id=16334*)
    → "You never know what secrets are in store unless you try!\u007F1\u0000\u0007"
     ...
     0x05C5 [0x1D] PRINT_EVENT_MESSAGE(message_id=16335*)
    → "You can wistfully withdraw them at any time by speaking to me.\u007F1\u0000\u0007"
     0x05C8 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x05C9 [0x1D] PRINT_EVENT_MESSAGE(message_id=16336*)
    → "Any number over 12 will be returned as clusters, kupo.\u007F1\u0000\u0007"
     0x05CC [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x05CD [0x48] [System] [16337*]:
    → "\u001F\u000FThe 	 gives a sly smile.\u0000\u0007"
     0x05D0 [0x1C] WAIT(60* ticks)
     0x05D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=16338*)
    → "This service is available to you free from the fetters of funding. As long as you keep this hush-hush, I'll always assist you with no recompense required.\u007F1\u0000\u0007"
     ...
     0x05FC [0x1D] PRINT_EVENT_MESSAGE(message_id=16339*)
    → "If you can find me here, then you'll surely see me in other locations too, kupo. Moogle magic, you know.\u007F1\u0000\u0007"
     0x05FF [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0600 [0x1D] PRINT_EVENT_MESSAGE(message_id=16340*)
    → "Of course, I do not actually exist in Vana'diel. Only a part of me projects into your world.\u007F1\u0000\u0007"
     0x0603 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0604 [0x1D] PRINT_EVENT_MESSAGE(message_id=16341*)
    → "It's rather similar to summoning magic, kupo.\u007F1\u0000\u0007"
     0x0607 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0608 [0x1D] PRINT_EVENT_MESSAGE(message_id=16342*)
    → "I promise not to bore you with the particulars. Just come chat if you need me, kupo.\u007F1\u0000\u0007"
     ...
     0x072F [0x1D] PRINT_EVENT_MESSAGE(message_id=16369*)
    → "You want me to hold onto these, kupo?\u0007Then let the magic begin!\u007F1\u0000\u0007"
     ...
     0x075C [0x1D] PRINT_EVENT_MESSAGE(message_id=16365*)
...
# Dead code (unreachable instructions):
     ...
     0x082C [0x48] [System] [16370*]:
    → "You have stored 
\u0001 \u0001	)\u0002\u0001\u0000\u0000\u0002\u0000\u0000\u0000 for a total of 
\u0004.\u0000\u0007"
     0x082F [0x01] GOTO 0x0835
     0x0832 [0x48] [System] [16371*]:
    → "You have stored 
\u0001 \u0001	)\u0002\u0001\u0000\u0000\u0002\u0000\u0000\u0000 and 
\u0003 \u0001	)\u0002\u0003\u0000\u0000\u0002\u0002\u0000\u0000 for a total of 
\u0004.\u0000\u0007"
