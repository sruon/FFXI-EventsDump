...
```
  ...
  3: 0x0156 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="dis0")
  4: 0x0165 [0x03] Work_Zone[2] = 567*
  5: 0x016A [0x1D] PRINT_EVENT_MESSAGE(message_id=7911*)
    → "You've lost the \u0001\u0005#\u0002\u0000\u0000\u0000\u0001H\u007F1\u0000\u0007"
  6: 0x016D [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x016E [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="dis0")
  8: 0x017B [0x1C] WAIT(30* ticks)
  9: 0x017E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 15: 0x019E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 19: 0x01B4 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 20: 0x01C3 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="thk2")
 21: 0x01D0 [0x1C] WAIT(30* ticks)
 22: 0x01D3 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
