...
- **8002**: Welcome, welcome! Either of my attendants will be happy to help you!
- **8007**: How about you? You look like the adventuring type. We need help filling an order. Of course, we would compensate you accordingly.
- **8008**: A customer has ordered a large amount of weaponry, but we're without the stock to fill it. We need someone to procure the remainder from a free trader.
- **8009**: Then you'll do it? Much obliged! Listen well, and I'll explain what you're to do.
- **8010**: A free trader named Alexius often passes through Jugner Forest. He's one of our suppliers of weapons.
- **8011**: Take this $3 to Alexius, and he'll give you $6 in exchange. Bring that back here.
- **8013**: Eh? You won't do it? That's a shame. Well, come back if you change your mind.
- **8015**: You've returned, and with the receipt! Splendid. Thanks to you, we can make the consortium happy!
- **8016**: Here's a payment for your services. Mind you use it well!
- **8018**: He's back again...
- **8019**: Comes in every day to look, but never to buy! Word is he's a Royal Knight, and that he's quite a weapons enthusiast.
- **8020**: They say whenever he's off duty he just leaves his kid and scours the weapon shops... Even I would tire of them before long!
...
```
  ...
  6: 0x001C [0x1D] PRINT_EVENT_MESSAGE(message_id=8002*)
 ...
 14: 0x003E [0x1D] PRINT_EVENT_MESSAGE(message_id=8018*)
    → "He's back again..."
 ...
 23: 0x0083 [0x1D] PRINT_EVENT_MESSAGE(message_id=8019*)
 ...
 30: 0x00B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=8020*)
...
```
  ...
  4: 0x00DD [0x1D] PRINT_EVENT_MESSAGE(message_id=8007*)
  ...
  7: 0x00E4 [0x1D] PRINT_EVENT_MESSAGE(message_id=8008*)
 ...
 10: 0x00ED [0x24] CREATE_DIALOG(message_id=8145*, default_option=0*, option_flags=0*)
 ...
 14: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=8009*)
 ...
 17: 0x0113 [0x1D] PRINT_EVENT_MESSAGE(message_id=8010*)
 ...
 22: 0x0130 [0x1D] PRINT_EVENT_MESSAGE(message_id=8011*)
 ...
 30: 0x0163 [0x1D] PRINT_EVENT_MESSAGE(message_id=8013*)
...
```
  ...
  5: 0x0190 [0x1D] PRINT_EVENT_MESSAGE(message_id=8015*)
 ...
 10: 0x01AB [0x1D] PRINT_EVENT_MESSAGE(message_id=8016*)
