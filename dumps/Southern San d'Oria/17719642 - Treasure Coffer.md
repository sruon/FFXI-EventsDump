...
| [4001](#event-4001)      | 0x0070       |      6 |              2 |
| [4010](#event-4010)      | 0x0076       |      6 |              2 |
...
```
  0: 0x004C [0x7A] VM_CONTROL: Reset copy state for Treasure Coffer (ID: 17719642/0x010E615A)
