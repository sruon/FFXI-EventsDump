...
SUBROUTINE_00BA:
 ...
 22: 0x00CA [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s051", work_offset2=0*)
 23: 0x00DB [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 29: 0x00F5 [0x55] WAIT_LOAD_SCHEDULER(work_offset=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s051")
 30: 0x0104 [0x1C] WAIT(60* ticks)
 31: 0x0107 [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s052", work_offset2=0*)
 32: 0x0118 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 35: 0x012B [0x55] WAIT_LOAD_SCHEDULER(work_offset=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s052")
 36: 0x013A [0x1C] WAIT(60* ticks)
 37: 0x013D [0x45] LOAD_SCHEDULED_TASK(work_offset1=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s053", work_offset2=0*)
 38: 0x014E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 42: 0x0166 [0x55] WAIT_LOAD_SCHEDULER(work_offset=130*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s053")
