...
- **7811**: Begging your pardon, but I'm busy. I must make a cloak for Prince [Trion/Pieuje], and within the day!
- **7813**: What is it? I said I'm busy, and I meant it!
- **7815**: Ahh...ah! Prince [Pieuje/Trion] sent you? I beg your pardon!
- **7817**: Prince [Pieuje/Trion] is too kind. His words do this shop great honor.
- **7819**: Now, where was I? Oh, no! This will not do! I took payment for the cloak but forgot to give him a receipt!
- **7820**: And with this second one to finish, I've no time to carry a receipt over now!
- **7821**: Perhaps you could help me! Would you take this receipt to Prince [Pieuje/Trion], in Chateau d'Oraguille?
- **7822**: Normally I'd do it myself, but if I don't finish this other cloak for Prince [Trion/Pieuje], my reputation is mud!
- **7823**: How about it? Will you help?
- **7824**: I thank you. Remember, it's for Prince [Pieuje/Trion]! The guards at the gate will take it for you, I should think.
- **7827**: I...see.
- **7828**: Oh, it's you again. Changed your mind? Will you run to the chateau for me?
- **7838**: Ah, thanks for your help. It's not much, but please accept this as payment.
- **7840**: Wh-what? You gave it to the wrong prince?
- **7841**: That's what I get for sending a recruit... This is for your time. Take it and leave.
- **7842**: What? They complained about your attire?
- **7843**: Well, you really can't blame them... Listen, I know someone in the Tanners' Guild on the west side. She can help you.
- **7844**: She's a Mithra by the name of Hanaa Punaa. Go talk to her, she'll fix you up.
...
```
 ...
 15: 0x0067 [0x1D] PRINT_EVENT_MESSAGE(message_id=7811*)
 ...
 19: 0x0074 [0x2B] Michilca (ID: 17719390/0x010E605E) [7812*]:
    → "Is the master in?"
 ...
 27: 0x00B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7813*)
 ...
 34: 0x00CE [0x2B] Michilca (ID: 17719390/0x010E605E) [7814*]:
 ...
 38: 0x00E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7815*)
 ...
 43: 0x0105 [0x2B] Michilca (ID: 17719390/0x010E605E) [7816*]:
 ...
 48: 0x0125 [0x1D] PRINT_EVENT_MESSAGE(message_id=7817*)
 ...
 53: 0x0140 [0x2B] Michilca (ID: 17719390/0x010E605E) [7818*]:
 ...
 64: 0x017E [0x1D] PRINT_EVENT_MESSAGE(message_id=7819*)
 ...
 69: 0x0197 [0x1D] PRINT_EVENT_MESSAGE(message_id=7820*)
 ...
 76: 0x01B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7821*)
 ...
 79: 0x01BB [0x1D] PRINT_EVENT_MESSAGE(message_id=7822*)
 ...
 82: 0x01C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7823*)
 ...
 85: 0x01CB [0x24] CREATE_DIALOG(message_id=8149*, default_option=0*, option_flags=0*)
 ...
 89: 0x01EA [0x1D] PRINT_EVENT_MESSAGE(message_id=7824*)
 ...
 97: 0x0215 [0x1D] PRINT_EVENT_MESSAGE(message_id=7827*)
    → "I...see."
...
```
  ...
  5: 0x0248 [0x1D] PRINT_EVENT_MESSAGE(message_id=7828*)
  ...
  8: 0x0251 [0x24] CREATE_DIALOG(message_id=8149*, default_option=0*, option_flags=0*)
    → "Accept? [Yes./I'm sorry.]"
 ...
 12: 0x0270 [0x1D] PRINT_EVENT_MESSAGE(message_id=7824*)
    → "I thank you. Remember, it's for Prince [Pieuje/Trion]! The guards at the gate will take it for you, I should think."
 ...
 20: 0x029B [0x1D] PRINT_EVENT_MESSAGE(message_id=7827*)
    → "I...see."
...
```
  ...
  6: 0x02D0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7838*)
...
SUBROUTINE_0308:
 ...
 28: 0x0316 [0x1D] PRINT_EVENT_MESSAGE(message_id=7844*)
