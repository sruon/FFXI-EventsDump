...
| [694](#event-694)        | 0x001D       |      1 |              1 |
| [697](#event-697)        | 0x001E       |      1 |              1 |
| [700](#event-700)        | 0x001F       |      1 |              1 |
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0000:             22 00 2F 00  F8 FF FF 7F 92 01 F3 60      "./........`
0010: 0E 01 00                                          ...             
```
...
```
  ...
  2: 0x000C [0x92] Iru-Kuiru (ID: 17719539/0x010E60F3)->Render.Flags3 ^= 0x01
