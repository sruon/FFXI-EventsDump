...
- **9058**: Welcome to the Lion Springs! Enjoy our selection of fine food and beverages.
- **9125**: Adventurers must know when opportunity knocks! Though there is a fine line between bravery and foolishness!
- **9126**: I love a good ghost story. The best part about running a tavern is listening to all the tales that adventurers bring from afar.
- **9127**: In Fei'Yin there is an old fountain run dry. They say that you can call a spirit of the dead by simply casting $0 into it. At any rate, that place is a decrepit ruin, so there's no end to the hogwash rumors.
- **9128**: So, the rumor was true? Huzzah! No, I need no thanks. I am happy to just hear your tale.
- **9129**: But what could he mean by a "small dark tight place"? You'd best ask the other patrons or members of your own party for their insight.
- **9130**: Yes, perhaps his corpse was interred in the Garlaige Citadel. What a cruel thing to do!
- **9131**: All's well that ends well, as they say. I've had a ball hearing all about it! Please, stop by if you're ever in the neighborhood.
- **11982**: Ask if this person is the chick's owner? [Yes./No.]
- **12022**: Eh? You have my chocobo, do you?
- **12023**: Well done! He must have been difficult to please when it comes to feeding. Sorry about that. That little bird just loves Lion Springs' cooking.
- **12024**: You are raising a chocobo too, am I correct? Let me teach you a story I often tell my chocobo...
- **12037**: Eh? You say you have my chocobo?
- **12038**: That little bird loves the cooking here. He would never leave this place, not for anything. You must be mistaken.
- **13451**: Your dancing style was...quite unique...
...
```
  ...
  2: 0x0009 [0x1D] PRINT_EVENT_MESSAGE(message_id=9058*)
...
```
  ...
  2: 0x001D [0x1D] PRINT_EVENT_MESSAGE(message_id=9125*)
...
```
  ...
  2: 0x002E [0x1D] PRINT_EVENT_MESSAGE(message_id=9126*)
...
```
  ...
  3: 0x0044 [0x1D] PRINT_EVENT_MESSAGE(message_id=9127*)
...
```
  ...
  2: 0x0055 [0x1D] PRINT_EVENT_MESSAGE(message_id=9128*)
  ...
  5: 0x0068 [0x1D] PRINT_EVENT_MESSAGE(message_id=9129*)
...
```
  ...
  2: 0x0095 [0x1D] PRINT_EVENT_MESSAGE(message_id=9130*)
...
```
  ...
  2: 0x00A6 [0x1D] PRINT_EVENT_MESSAGE(message_id=9131*)
...
```
  ...
  2: 0x0152 [0x1D] PRINT_EVENT_MESSAGE(message_id=13451*)
...
# Dead code (unreachable instructions):
     ...
     0x0172 [0x24] CREATE_DIALOG(message_id=11982*, default_option=1*, option_flags=0*)
    → "Ask if this person is the chick's owner? [Yes./No.]"
     ...
     0x0193 [0x1D] PRINT_EVENT_MESSAGE(message_id=12022*)
    → "Eh? You have my chocobo, do you?"
     ...
     0x01A6 [0x1D] PRINT_EVENT_MESSAGE(message_id=12023*)
    → "Well done! He must have been difficult to please when it comes to feeding. Sorry about that. That little bird just loves Lion Springs' cooking."
     ...
     0x01B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=12024*)
    → "You are raising a chocobo too, am I correct? Let me teach you a story I often tell my chocobo..."
     ...
     0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=12037*)
    → "Eh? You say you have my chocobo?"
     ...
     0x01D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=12038*)
