...
- **12241**: Which battlefield will you choose? [Hall of An./Hall of Ki./Hall of Im./Hall of Muru./Hall of Mul./None.]
- **12242**: Select battlefield capacity. [18 combatants."6 combatants./Cancel.]
- **12243**: Very well. I will issue you $3 $0 .
- **12244**: % are valid for five minutes (Earth time) from time of issuance.
- **12245**: You wish to challenge the Hall of [An/Ki/Im/Muru/Mul] with a maximum of [eighteen/thirty-six] combatants. Is that correct?
- **12246**: Hall of [An/Ki/Im/Muru/Mul] (Capacity: [18/36]). [Confirm./Cancel.]
- **12247**: Excellentaru! Here [is/are] [one/two] Legion [pass/passes], which [is/are] valid for five minutes (Earth time). Prepare yourselves and trade [it/them] to the tome when you are ready.
- **12251**: Very well, then. When you've finished your preparations, just say the word.
- **12262**: The hands of darkness have impeded your progress into the next area.
- **12263**: You cannot enter at this time. Please wait a moment and try again.
- **12266**: Your request for entry is being considered...
...
```
 ...
 16: 0x0047 [0x03] ExtData[1]->WorkLocal[5] = 12239*
 17: 0x004C [0x01] GOTO 0x005B
 18: 0x004F [0x03] ExtData[1]->WorkLocal[5] = 12238*
...
SUBROUTINE_008D:
 ...
 33: 0x0095 [0x24] CREATE_DIALOG(message_id=12241*, default_option=ExtData[1]->WorkLocal[17], option_flags=ExtData[1]->WorkLocal[23])
 ...
 37: 0x00AA [0x1D] PRINT_EVENT_MESSAGE(message_id=12251*)
...
SUBROUTINE_00E1:
 ...
 57: 0x0111 [0x24] CREATE_DIALOG(message_id=12242*, default_option=ExtData[1]->WorkLocal[18], option_flags=ExtData[1]->WorkLocal[12])
...
SUBROUTINE_0147:
 ...
 77: 0x017B [0x1D] PRINT_EVENT_MESSAGE(message_id=12243*)
    → "Very well. I will issue you $3 $0 ."
 78: 0x017E [0x48] [System] [12244*]:
...
SUBROUTINE_0184:
 ...
 85: 0x019C [0x1D] PRINT_EVENT_MESSAGE(message_id=12245*)
 ...
 87: 0x01A0 [0x24] CREATE_DIALOG(message_id=12246*, default_option=ExtData[1]->WorkLocal[19], option_flags=0*)
...
166: 0x02F6 [0x1D] PRINT_EVENT_MESSAGE(message_id=12247*)
