...
- **12244**: Which battlefield will you choose? [Hall of An./Hall of Ki./Hall of Im./Hall of Muru./Hall of Mul./None.]
- **12245**: Select battlefield capacity. [18 combatants."6 combatants./Cancel.]
- **12246**: Very well. I will issue you $3 $0 .
- **12247**: % are valid for five minutes (Earth time) from time of issuance.
- **12248**: You wish to challenge the Hall of [An/Ki/Im/Muru/Mul] with a maximum of [eighteen/thirty-six] combatants. Is that correct?
- **12249**: Hall of [An/Ki/Im/Muru/Mul] (Capacity: [18/36]). [Confirm./Cancel.]
- **12250**: Excellentaru! Here [is/are] [one/two] Legion [pass/passes], which [is/are] valid for five minutes (Earth time). Prepare yourselves and trade [it/them] to the tome when you are ready.
- **12254**: Very well, then. When you've finished your preparations, just say the word.
- **12265**: The hands of darkness have impeded your progress into the next area.
- **12266**: You cannot enter at this time. Please wait a moment and try again.
- **12269**: Your request for entry is being considered...
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0000:    4A F0 FF FF 7F 70 E2  06 01 4A 70 E2 06 01 F0   J....p...Jp....
0010: FF FF 7F 6F 76 70 E2 06  01 06 00 00 06 01 10 06  ...ovp..........
...
```
  0: 0x0001 [0x4A] LocalPlayer looks at Mayuyu (ID: 17228400/0x0106E270)
  1: 0x000A [0x4A] Mayuyu (ID: 17228400/0x0106E270) looks at LocalPlayer
  2: 0x0013 [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
  3: 0x0014 [0x76] CHECK_ENTITY_RENDER_FLAGS: Wait until Mayuyu (ID: 17228400/0x0106E270) Render.Flags0 and Render.Flags3 conditions are met
 ...
 16: 0x0047 [0x03] ExtData[1]->WorkLocal[5] = 12242*
 17: 0x004C [0x01] GOTO 0x005B
 18: 0x004F [0x03] ExtData[1]->WorkLocal[5] = 12241*
...
SUBROUTINE_008D:
 ...
 33: 0x0095 [0x24] CREATE_DIALOG(message_id=12244*, default_option=ExtData[1]->WorkLocal[17], option_flags=ExtData[1]->WorkLocal[23])
 ...
 37: 0x00AA [0x1D] PRINT_EVENT_MESSAGE(message_id=12254*)
...
SUBROUTINE_00E1:
 ...
 57: 0x0111 [0x24] CREATE_DIALOG(message_id=12245*, default_option=ExtData[1]->WorkLocal[18], option_flags=ExtData[1]->WorkLocal[12])
...
SUBROUTINE_0147:
 ...
 77: 0x017B [0x1D] PRINT_EVENT_MESSAGE(message_id=12246*)
    → "Very well. I will issue you $3 $0 ."
 78: 0x017E [0x48] [System] [12247*]:
...
SUBROUTINE_0184:
 ...
 85: 0x019C [0x1D] PRINT_EVENT_MESSAGE(message_id=12248*)
 ...
 87: 0x01A0 [0x24] CREATE_DIALOG(message_id=12249*, default_option=ExtData[1]->WorkLocal[19], option_flags=0*)
...
166: 0x02F6 [0x1D] PRINT_EVENT_MESSAGE(message_id=12250*)
