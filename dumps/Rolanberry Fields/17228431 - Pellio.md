...
- **6413**: Obtained: #.
- **12425**: Ugh. Every single day I toil on these farms, with no time left for studies of my own.
- **12426**: You see, I'm researching how to reliably produce white rolanberries, but with all my time being taken up with helping my father here, I'm afraid my progress is a bit stalled.
- **12427**: But you--you look like you've got some free time on your hands. Can you bring me some rolanberries?
- **12428**: If you bring me the right stuff, I'll give you some of my precious white rolanberries--the fruits of my labor.
- **12429**: Of course, I might not be satisfied with what you've procured, and I'll have to ask you to try again. But that's what being an adventurer is all about, no?
- **12430**: So just keep bringing me those rolanberries, as long as it takes!
- **12431**: The older the rolanberries are, the more likely they'll have the qualities I seek. Now get to it!
- **12432**: Yes! $1! This is exactly what I need.
- **12433**: Thanks so much! This'll be the perfect supplement to my research.
- **12434**: White rolanberries are really elusive, and we're not exactly sure what causes them to develop in such a way.
- **12435**: They're malms sweeter than ordinary rolanberries, and fans of the fruit will pay out the nose for them. That's why I'm looking for a surefire way to cultivate these delicacies.
- **12436**: Progress has been slow, because rolanberry cultivation is a years-long process.
- **12437**: Jeuno used to be a haven for such pursuits, but with the passage of time the indutsry started to fade.
- **12438**: I suppose the city's vitality in recent years has been thanks to adventurers more than farmers.
- **12439**: And, of course, farming is an industry gravely affected by the ravages of war, and such fruits were deemed a luxury item rather than a necessity.
- **12440**: But white rolanberries--those are a game changer!
- **12441**: I know we can revitalize farming here in Jeuno if only I could make a breakthrough! Think of the untold riches I would have!
- **12442**: If only my father knew how close I was, then maybe he would let me focus on that rather than sitting here pulling weeds.
- **12443**: But there's not much other fertile land in the area, and the more we expand the more tedious my labor becomes.
- **12444**: That's why I think we should focus on producing a small amount of high-quality goods. Quality over quantity. Added value drives the market, after all!
- **12445**: Here's a token of my appreciation. Hopefully you'll find their taste to be as exquisite as I do!
- **12446**: Hmm...this is an ordinary rolanberry, but I do sense something special about it.
- **12447**: You've worked hard to bring it to me. That much I can tell. I'll accept it, but just this once.
- **12448**: Here's a little something for your help, but next time you'll need to bring me something a little more ripe.
- **12449**: Let me take a look. Let's see if this is what I need.
- **12450**: No, no no. This is no good at all. Even though you may think all $1 are the same, I can tell even the smallest difference. Try again!
- **12451**: If you want one of my rare white rolanberries, you'll need to get me something I can use in my research.
- **12452**: Let's see...this is just an ordinary one!
- **12453**: I guess I'll take it off your hands, but I really don't need any more. Bring me the oldest rolanberries you can find.
- **12454**: I'm talking really, really ripe ones. Say it with me. "Ripe!" Maybe next time you'll get it right.
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=12425*)
...
```
  ...
  4: 0x0044 [0x1D] PRINT_EVENT_MESSAGE(message_id=12426*)
  ...
  6: 0x0048 [0x1D] PRINT_EVENT_MESSAGE(message_id=12427*)
  ...
  9: 0x005B [0x1D] PRINT_EVENT_MESSAGE(message_id=12428*)
 ...
 12: 0x006E [0x1D] PRINT_EVENT_MESSAGE(message_id=12429*)
...
```
  ...
  8: 0x00B3 [0x1D] PRINT_EVENT_MESSAGE(message_id=12432*)
    → "Yes! $1! This is exactly what I need."
  9: 0x00B6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 10: 0x00B7 [0x1D] PRINT_EVENT_MESSAGE(message_id=12433*)
 ...
 14: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=12434*)
 ...
 16: 0x00CC [0x1D] PRINT_EVENT_MESSAGE(message_id=12435*)
 ...
 19: 0x00DF [0x1D] PRINT_EVENT_MESSAGE(message_id=12436*)
 ...
 23: 0x00EE [0x1D] PRINT_EVENT_MESSAGE(message_id=12437*)
 ...
 25: 0x00F2 [0x1D] PRINT_EVENT_MESSAGE(message_id=12438*)
 ...
 28: 0x0105 [0x1D] PRINT_EVENT_MESSAGE(message_id=12439*)
 ...
 31: 0x0118 [0x1D] PRINT_EVENT_MESSAGE(message_id=12440*)
    → "But white rolanberries--those are a game changer!"
 32: 0x011B [0x23] WAIT_FOR_DIALOG_INTERACTION
 33: 0x011C [0x1D] PRINT_EVENT_MESSAGE(message_id=12441*)
 ...
 39: 0x013D [0x1D] PRINT_EVENT_MESSAGE(message_id=12442*)
 ...
 41: 0x0141 [0x1D] PRINT_EVENT_MESSAGE(message_id=12443*)
 ...
 44: 0x0154 [0x1D] PRINT_EVENT_MESSAGE(message_id=12444*)
...
SUBROUTINE_016A:
 ...
 50: 0x0176 [0x1D] PRINT_EVENT_MESSAGE(message_id=12445*)
...
```
 ...
 14: 0x01CF [0x1D] PRINT_EVENT_MESSAGE(message_id=12448*)
...
```
  ...
  9: 0x0214 [0x1D] PRINT_EVENT_MESSAGE(message_id=12449*)
 ...
 15: 0x0258 [0x1D] PRINT_EVENT_MESSAGE(message_id=12450*)
 ...
 17: 0x025C [0x1D] PRINT_EVENT_MESSAGE(message_id=12451*)
 ...
 20: 0x0263 [0x1D] PRINT_EVENT_MESSAGE(message_id=12450*)
    → "No, no no. This is no good at all. Even though you may think all $1 are the same, I can tell even the smallest difference. Try again!"
...
```
  ...
  5: 0x0295 [0x1D] PRINT_EVENT_MESSAGE(message_id=12452*)
    → "Let's see...this is just an ordinary one!"
  6: 0x0298 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0299 [0x1D] PRINT_EVENT_MESSAGE(message_id=12453*)
  ...
  9: 0x029D [0x1D] PRINT_EVENT_MESSAGE(message_id=12454*)
