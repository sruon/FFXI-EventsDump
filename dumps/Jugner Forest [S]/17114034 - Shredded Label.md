...
- **8608**: It appears that using the $3 here will summon forth the enemy. (Your level will be restricted to $1.)
- **8609**: Use the $3? [Yes./No.]
...
```
  ...
  3: 0x0006 [0x24] CREATE_DIALOG(message_id=8609*, default_option=1*, option_flags=0*)
    → "Use the $3? [Yes./No.]"
