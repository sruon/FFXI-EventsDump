...
```
  ...
  5: 0x00A6 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=29*, entity1=Alphonimile (ID: 17113985/0x01052381), entity2=Alphonimile (ID: 17113985/0x01052381), action="tlk0")
