...
```
  ...
  1: 0x0025 [0x1F] MOVE_ENTITY: EventEntity moves to X=71.718*, Z=308.339*, Y=-0.667*
...
```
  ...
  1: 0x0043 [0x1F] MOVE_ENTITY: EventEntity moves to X=64.800*, Z=308.043*, Y=0.238*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
00B0:                                B6 0B 0E 80 0F 80            ......
00C0: 10 80 10 80 10 80 10 80  10 80 11 80 12 80 00     ............... 
```

#### Opcodes

```
  0: 0x00BA [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=3*, hair=9*, head=12*, body=12*, hands=12*, legs=12*, feet=12*, main=210*, sub=0*)
