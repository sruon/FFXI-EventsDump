...
| [65535.8](#event-655358) | 0x0045       |     18 |              6 |
| [7](#event-7)            | 0x0057       |      1 |              1 |
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0040:                1C 01 80  32 03 80 1F 00 04 80 05       ...2.......
...
```
  0: 0x0045 [0x1C] WAIT(1* ticks)
  1: 0x0048 [0x32] ExtData[1]->MainSpeed = 11* * 0.1
  2: 0x004B [0x1F] MOVE_ENTITY: EventEntity moves to X=48.913*, Z=318.994*, Y=0.243*
