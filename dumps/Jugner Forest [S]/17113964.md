...
```
  ...
  2: 0x0050 [0x5A] UPDATE_EVENT_POSITION: Set EventEntity MovePosition to X=-448.449*, Z=-461.165*, Y=0.684*
  3: 0x0058 [0x5A] UPDATE_EVENT_POSITION: Move EventEntity incrementally towards MovePosition
  4: 0x005A [0x4B] UPDATE_ENTITY_YAW(entity=EventEntity, yaw=5.0°*)
...
```
  ...
  1: 0x0068 [0x5A] UPDATE_EVENT_POSITION: Set EventEntity MovePosition to X=-443.479*, Z=-471.343*, Y=0.231*
  2: 0x0070 [0x5A] UPDATE_EVENT_POSITION: Move EventEntity incrementally towards MovePosition
  3: 0x0072 [0x5A] UPDATE_EVENT_POSITION: Set EventEntity MovePosition to X=-441.892*, Z=-465.916*, Y=0.604*
