...
0030: 80 45 06 80 F0 FF FF 7F  F0 FF FF 7F 7A 38 32 61  .E..........z82a
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=7736*, default_option=1*, option_flags=0*)
    → "Enter La Vaule? [Yes./No.]"
 ...
 11: 0x0031 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "z82a" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
