...
```
  ...
  1: 0x0008 [0x1F] MOVE_ENTITY: EventEntity moves to X=-320.614*, Z=437.027*, Y=0.000*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0010:             32 00 80 1F  00 04 80 05 80 03 80 1F      2...........
0020: 01 6F 00                                          .o.             
```
...
```
  ...
  1: 0x0017 [0x1F] MOVE_ENTITY: EventEntity moves to X=-321.721*, Z=436.578*, Y=0.000*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0020:          32 00 80 1F 00  06 80 07 80 08 80 1F 01     2............
0030: 6F 22 01 00                                       o"..            
```
