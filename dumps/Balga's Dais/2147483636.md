...
```
  0: 0x0002 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=18.500*, z=18.100*, y=-2.902*, direction=102.1°*
...
```
  ...
  1: 0x000F [0x1F] MOVE_ENTITY: EventEntity moves to X=19.000*, Z=2.100*, Y=-4.217*
