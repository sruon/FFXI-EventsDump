...
```
  0: 0x0113 [0x45] LOAD_SCHEDULED_TASK(work_offset1=211*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s064", work_offset2=0*)
  ...
  3: 0x0136 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
  4: 0x0147 [0x02] IF !(Work_Zone[9] == 3*) GOTO 0x0163
  5: 0x014F [0x45] LOAD_SCHEDULED_TASK(work_offset1=211*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s072", work_offset2=0*)
  6: 0x0160 [0x01] GOTO 0x01E4

SUBROUTINE_0163:
  7: 0x0163 [0x02] IF !(Work_Zone[9] == 4*) GOTO 0x017F
  8: 0x016B [0x45] LOAD_SCHEDULED_TASK(work_offset1=211*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s073", work_offset2=0*)
  9: 0x017C [0x01] GOTO 0x01E4

SUBROUTINE_017F:
 10: 0x017F [0x02] IF !(Work_Zone[9] == 5*) GOTO 0x019B
 11: 0x0187 [0x45] LOAD_SCHEDULED_TASK(work_offset1=211*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s070", work_offset2=0*)
 12: 0x0198 [0x01] GOTO 0x01E4

SUBROUTINE_019B:
 13: 0x019B [0x02] IF !(Work_Zone[9] == 6*) GOTO 0x01B7
 14: 0x01A3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=211*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s070", work_offset2=0*)
 15: 0x01B4 [0x01] GOTO 0x01E4

SUBROUTINE_01B7:
 16: 0x01B7 [0x02] IF !(Work_Zone[9] == 8*) GOTO 0x01D3
 17: 0x01BF [0x45] LOAD_SCHEDULED_TASK(work_offset1=211*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s071", work_offset2=0*)
 18: 0x01D0 [0x01] GOTO 0x01E4

SUBROUTINE_01D3:
 19: 0x01D3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=211*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s069", work_offset2=0*)
