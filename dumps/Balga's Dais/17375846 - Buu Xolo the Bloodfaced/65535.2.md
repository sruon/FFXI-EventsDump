...
```
  0: 0x00B0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=211*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s063", work_offset2=0*)
  1: 0x00C1 [0x1C] WAIT(60* ticks)
  2: 0x00C4 [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "main" with entities [Buu Xolo the Bloodfaced (ID: 17375846/0x01092266), Buu Xolo the Bloodfaced (ID: 17375846/0x01092266)], work=[2*, 0*]
  ...
  6: 0x00ED [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
  7: 0x00FE [0x45] LOAD_SCHEDULED_TASK(work_offset1=211*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s068", work_offset2=0*)
