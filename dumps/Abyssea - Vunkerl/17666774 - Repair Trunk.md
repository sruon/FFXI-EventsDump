...
- **8065**: The trunk is filled to the brim with ensorceled provisions.
- **8066**: Begin cramming the provisions into your $3?
- **8067**: Proceed? [Let the cramming commence!/Not yet.]
- **8068**: Select an action. [Examine the sack./Cram an elongated flask./Cram a triangular flask./Cram an oil cloth./Finish cramming.]
- **8069**: The $3 appears to be in perfectly sound condition.
- **8070**: The $3 feels a little bit taut.
- **8071**: The $3 is showing signs of stretching.
- **8072**: The fabric of the $3 is squeaking under the tension.
- **8073**: The fabric of the $3 is squeaking with extreme urgency.
- **8074**: A massive rent in the $3 smiles up at you, as if mocking your failure.
- **8075**: You cram an elongated flask into the $3.
- **8076**: You cram a triangular flask into the $3.
- **8077**: You cram an oil cloth into the $3.
...
```
  ...
  1: 0x000D [0x48] [System] [8065*]:
    → "The trunk is filled to the brim with ensorceled provisions."
  2: 0x0010 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0011 [0x48] [System] [8074*]:
...
```
 ...
 10: 0x003F [0x24] CREATE_DIALOG(message_id=8068*, default_option=0*, option_flags=0*)
