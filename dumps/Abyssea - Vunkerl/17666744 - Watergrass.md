...
| [1038](#event-1038)   | 0x0001       |     21 |              7 |
| [1039](#event-1039)   | 0x0016       |     62 |             17 |
...
- **8173**: You pluck a handful of watergrass from the ground.
- **8197**: The massive footprints of an unidentified beast adorn the soil...
- **8198**: The leaves are slimy to the touch...
- **8199**: A curious yellowish powder clings to the leaves...
...
```
  ...
  3: 0x0026 [0x48] [System] [8197*]:
    → "The massive footprints of an unidentified beast adorn the soil..."
  4: 0x0029 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x002A [0x01] GOTO 0x004B
  6: 0x002D [0x02] IF !(Work_Zone[2] == 1*) GOTO 0x003C
  7: 0x0035 [0x48] [System] [8198*]:
