...
- **8046**: The trunk is filled to the brim with repair materials.
- **8047**: Begin cramming the materials into your $3?
- **8048**: Proceed? [Let the cramming commence!/Not yet.]
- **8049**: Select an action. [Examine the sack./Cram something pointy./Cram something jagged./Cram something round./Finish cramming.]
- **8050**: The $3 appears to be in perfectly sound condition.
- **8051**: The $3 feels a little bit taut.
- **8052**: The $3 is showing signs of stretching.
- **8053**: The fabric of the $3 is squeaking under the tension.
- **8054**: The fabric of the $3 is squeaking with extreme urgency.
- **8055**: A massive rent in the $3 smiles up at you, as if mocking your failure.
- **8056**: You cram a pointy object into the $3.
- **8057**: You cram a jagged object into the $3.
- **8058**: You cram a round object into the $3.
...
```
  ...
  1: 0x000D [0x48] [System] [8046*]:
    → "The trunk is filled to the brim with repair materials."
  2: 0x0010 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0011 [0x48] [System] [8055*]:
...
```
 ...
 10: 0x003F [0x24] CREATE_DIALOG(message_id=8049*, default_option=0*, option_flags=0*)
