...
# Dead code (unreachable instructions):
     ...
     0x084F [0x8B] SET_EVENT_MARK: Add/update map marker on map 217* at (-246.4*, -42.0*), index=5*, name=(no name)
     ...
     0x0868 [0x8B] SET_EVENT_MARK: Add/update map marker on map 217* at (-452.7*, -448.8*), index=6*, name=(no name)
