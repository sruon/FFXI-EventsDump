...
- **7815**: Only party members present with you in this area will be transported to [/this skirmish in ////this alluvion skirmish in /]$8.
- **7816**: Proceed? [Yes./No.]
- **7817**: Now entering [/a skirmish in ////an alluvion skirmish in /]$8.
- **7818**: You have chosen not to enter [/this skirmish in ////this alluvion skirmish in /]$8.
- **7820**: You cannot enter at this time. Please wait a moment and try again.
- **7823**: Your request for entry is being considered...
...
```
 ...
 21: 0x0067 [0x24] CREATE_DIALOG(message_id=7816*, default_option=ExtData[1]->WorkLocal[7], option_flags=0*)
    → "Proceed? [Yes./No.]"
 22: 0x006E [0x25] WAIT_DIALOG_SELECT()
 23: 0x006F [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0083
 24: 0x0077 [0x06] ExtData[1]->WorkLocal[7] = 0
 25: 0x007A [0x48] [System] [7823*]:
...
```
 ...
 11: 0x00D8 [0x24] CREATE_DIALOG(message_id=7835*, default_option=0*, option_flags=ExtData[1]->WorkLocal[15])
