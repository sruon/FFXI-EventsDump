...
- **7818**: Only party members present with you in this area will be transported to [/this skirmish in ////this alluvion skirmish in /]$8.
- **7819**: Proceed? [Yes./No.]
- **7820**: Now entering [/a skirmish in ////an alluvion skirmish in /]$8.
- **7821**: You have chosen not to enter [/this skirmish in ////this alluvion skirmish in /]$8.
- **7823**: You cannot enter at this time. Please wait a moment and try again.
- **7826**: Your request for entry is being considered...
...
```
 ...
 21: 0x0067 [0x24] CREATE_DIALOG(message_id=7819*, default_option=ExtData[1]->WorkLocal[7], option_flags=0*)
    → "Proceed? [Yes./No.]"
 22: 0x006E [0x25] WAIT_DIALOG_SELECT()
 23: 0x006F [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0083
 24: 0x0077 [0x06] ExtData[1]->WorkLocal[7] = 0
 25: 0x007A [0x48] [System] [7826*]:
...
```
 ...
 11: 0x00D8 [0x24] CREATE_DIALOG(message_id=7838*, default_option=0*, option_flags=ExtData[1]->WorkLocal[15])
    → "Enter which battlefield? [None./Endeavoring to Awaken./Endeavoring to Awaken./ /Behind the Sluices./Stonewalled./The Gates./Saved by the Bell./Quiescence./The Charlatan./Yggdrasil Beckons./Yggdrasil Beckons./Watery Grave./Mistress of Ceremonies./A Barrel of Laughs./Sinister Reign./The Ygnas Directive 6./Skirmishes./[Fractures/Obscured Domains]./Alluvion skirmishes./The Silent Forest./Wind of Eternity./Phantasmic Heroes.]"
