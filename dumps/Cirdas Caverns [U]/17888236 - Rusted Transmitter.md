...
- **7522**: The device makes a small humming noise. Teleportation is now active.
- **7523**: Select a location. [None, thanks./Hall of the Reckless./Ymmr-Ulvid's Chamber./Ignor-Mnt's Chamber./Durs-Vike's Chamber./Tryl-Wuj's Chamber./Liij-Vok's Chamber./Gramk-Droog's Hall.]
...
```
  ...
  3: 0x0010 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=ExtData[1]->WorkLocal[0], bit_index_work_offset=2*, condition_work_offset=1*)

SUBROUTINE_0017:
  4: 0x0017 [0x3E] IF !(Work_Zone[2] bit 1*) GOTO 0x0021
  5: 0x001E [0x01] GOTO 0x0028
  6: 0x0021 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=ExtData[1]->WorkLocal[0], bit_index_work_offset=3*, condition_work_offset=1*)

SUBROUTINE_0028:
  7: 0x0028 [0x3E] IF !(Work_Zone[2] bit 2*) GOTO 0x0032
  8: 0x002F [0x01] GOTO 0x0039
  9: 0x0032 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=ExtData[1]->WorkLocal[0], bit_index_work_offset=4*, condition_work_offset=1*)

SUBROUTINE_0039:
 10: 0x0039 [0x3E] IF !(Work_Zone[2] bit 3*) GOTO 0x0043
 11: 0x0040 [0x01] GOTO 0x004A
 12: 0x0043 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=ExtData[1]->WorkLocal[0], bit_index_work_offset=5*, condition_work_offset=1*)

SUBROUTINE_004A:
 13: 0x004A [0x3E] IF !(Work_Zone[2] bit 4*) GOTO 0x0054
 14: 0x0051 [0x01] GOTO 0x005B
 15: 0x0054 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=ExtData[1]->WorkLocal[0], bit_index_work_offset=6*, condition_work_offset=1*)

SUBROUTINE_005B:
 16: 0x005B [0x3E] IF !(Work_Zone[2] bit 5*) GOTO 0x0065
 17: 0x0062 [0x01] GOTO 0x006C
 18: 0x0065 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=ExtData[1]->WorkLocal[0], bit_index_work_offset=7*, condition_work_offset=1*)

SUBROUTINE_006C:
 19: 0x006C [0x3E] IF !(Work_Zone[2] bit 6*) GOTO 0x007A
 20: 0x0073 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=ExtData[1]->WorkLocal[0], bit_index_work_offset=1*, condition_work_offset=1*)
 21: 0x007A [0x3E] IF !(Work_Zone[2] bit 7*) GOTO 0x0088
 22: 0x0081 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=ExtData[1]->WorkLocal[0], bit_index_work_offset=2*, condition_work_offset=1*)
 23: 0x0088 [0x3E] IF !(Work_Zone[2] bit 8*) GOTO 0x0096
 24: 0x008F [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=ExtData[1]->WorkLocal[0], bit_index_work_offset=3*, condition_work_offset=1*)
 25: 0x0096 [0x3E] IF !(Work_Zone[2] bit 9*) GOTO 0x00A4
 26: 0x009D [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=ExtData[1]->WorkLocal[0], bit_index_work_offset=4*, condition_work_offset=1*)
 27: 0x00A4 [0x3E] IF !(Work_Zone[2] bit 10*) GOTO 0x00B2
 28: 0x00AB [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=ExtData[1]->WorkLocal[0], bit_index_work_offset=5*, condition_work_offset=1*)
 ...
 33: 0x00CE [0x48] [System] [7522*]:
    → "The device makes a small humming noise. Teleportation is now active."
 34: 0x00D1 [0x23] WAIT_FOR_DIALOG_INTERACTION
 35: 0x00D2 [0x24] CREATE_DIALOG(message_id=7523*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
