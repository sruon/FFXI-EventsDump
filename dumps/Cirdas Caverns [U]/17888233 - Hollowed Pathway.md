...
| [12000](#event-12000) | 0x0001       |     42 |             10 |
...
```
  0: 0x0001 [0x24] CREATE_DIALOG(message_id=7339*, default_option=1*, option_flags=0*)
