...
- **7344**: An offering from Windurst sits here. [Retrieve the offering./Leave it alone.]
- **7346**: There is an offering bag with the seal of Windurst on it.
...
```
  ...
  1: 0x0008 [0x24] CREATE_DIALOG(message_id=7344*, default_option=1*, option_flags=0*)
