...
- **10205**: Well met! I'm a Merry Map Marker, and I'd love to make marks all over your merry $3, but it appears you are missing the markable map I mention.
- **10206**: Good day! I'm a Merry Map Marker, and I'd be emphatically ecstatic if you'd allow me to mark your magical map!
- **10207**: A markless $3 is like a motherless maiden, meandering through a miasmatic mire of misery.
- **10208**: Embark on a map-marking mission? [Mark me up!/Keep your mitts off my map!]
- **10209**: Marvelous! Now allow me a minute to make all my marks.
- **10211**: Monitoring and managing your marks is as simple as merely opening your map and selecting Markers from the main menu.
- **10212**: If the marks on your map might vanish, mope not like a melancholy milksop. Make another meeting with me and I shall make it my mission to mark the map once more.
- **10213**: Good day, [milord/milady]. May your marches across meadow and mountain be markedly memorable!
- **10216**: And mayhap you are immeasurably motivated to compete in the medieval mayhem of Conflict? Might I suggest you mingle with the modest Pursuivant located here?
- **10217**: Our local minstrel of melodies can be found here. His mirthful musicalities may help you recall misplaced memories.
- **10218**: Ah, and in the case you might wish to mask a meritorious moniker and replace it with one a mite more merited, a traveling bard strums upon his mellifluous harp here.
- **10219**: Here, you may meet with a member of the Specialty Goods Trade Union. And, if you are a citizen of this mighty dominion, he'll teleport you all across Vana'diel (for a menial amount of monetary remuneration).
- **10220**: Need to know the local weather? Our local meteorologist will be making his paramount presumptions here.
- **10222**: Those men and women wondering how their deeds are mirrored in the minds of the locals should meander over to this gossip-meister to muster up important material on their respective reputations.
- **10228**: I shall start with Port Bastok and its magnificent drawbridge.
- **10229**: Now let me move on to the mercantile metropolis known as the Bastok Markets.
- **10230**: And after the markets, come the massive Bastok Mines.
- **10231**: And finally, who could forget the marveled Bastok Metalworks, where masterful minds from across the Republic meet to mull over the mysteries of man-made mechanical marvels.
...
```
  ...
  2: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=10206*)
  ...
  5: 0x0011 [0x1D] PRINT_EVENT_MESSAGE(message_id=10207*)
  ...
  7: 0x0015 [0x24] CREATE_DIALOG(message_id=10208*, default_option=1*, option_flags=0*)
 ...
 11: 0x002A [0x1D] PRINT_EVENT_MESSAGE(message_id=10209*)
 ...
 38: 0x00BE [0x1D] PRINT_EVENT_MESSAGE(message_id=10228*)
 ...
 47: 0x00E4 [0x1D] PRINT_EVENT_MESSAGE(message_id=10217*)
...
# Dead code (unreachable instructions):
     0x0104 [0x1D] PRINT_EVENT_MESSAGE(message_id=10222*)
    → "Those men and women wondering how their deeds are mirrored in the minds of the locals should meander over to this gossip-meister to muster up important material on their respective reputations."
     ...
     0x0144 [0x1D] PRINT_EVENT_MESSAGE(message_id=10218*)
    → "Ah, and in the case you might wish to mask a meritorious moniker and replace it with one a mite more merited, a traveling bard strums upon his mellifluous harp here."
     ...
     0x0184 [0x1D] PRINT_EVENT_MESSAGE(message_id=10220*)
    → "Need to know the local weather? Our local meteorologist will be making his paramount presumptions here."
     ...
     0x01A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=10216*)
    → "And mayhap you are immeasurably motivated to compete in the medieval mayhem of Conflict? Might I suggest you mingle with the modest Pursuivant located here?"
     ...
     0x01AF [0x1D] PRINT_EVENT_MESSAGE(message_id=10229*)
    → "Now let me move on to the mercantile metropolis known as the Bastok Markets."
     ...
     0x01F5 [0x1D] PRINT_EVENT_MESSAGE(message_id=10220*)
    → "Need to know the local weather? Our local meteorologist will be making his paramount presumptions here."
    ...
    → "And after the markets, come the massive Bastok Mines."
     ...
     0x0246 [0x1D] PRINT_EVENT_MESSAGE(message_id=10219*)
    → "Here, you may meet with a member of the Specialty Goods Trade Union. And, if you are a citizen of this mighty dominion, he'll teleport you all across Vana'diel (for a menial amount of monetary remuneration)."
     ...
     0x0266 [0x1D] PRINT_EVENT_MESSAGE(message_id=10217*)
    → "Our local minstrel of melodies can be found here. His mirthful musicalities may help you recall misplaced memories."
    ...
    → "And finally, who could forget the marveled Bastok Metalworks, where masterful minds from across the Republic meet to mull over the mysteries of man-made mechanical marvels."
     ...
     0x02B7 [0x1D] PRINT_EVENT_MESSAGE(message_id=10217*)
    → "Our local minstrel of melodies can be found here. His mirthful musicalities may help you recall misplaced memories."
     ...
     0x02EB [0x1D] PRINT_EVENT_MESSAGE(message_id=10211*)
    → "Monitoring and managing your marks is as simple as merely opening your map and selecting Markers from the main menu."
     ...
     0x02EF [0x1D] PRINT_EVENT_MESSAGE(message_id=10212*)
    → "If the marks on your map might vanish, mope not like a melancholy milksop. Make another meeting with me and I shall make it my mission to mark the map once more."
     ...
     0x02F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10213*)
...
```
  ...
  2: 0x0303 [0x1D] PRINT_EVENT_MESSAGE(message_id=10206*)
    → "Good day! I'm a Merry Map Marker, and I'd be emphatically ecstatic if you'd allow me to mark your magical map!"
  3: 0x0306 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0307 [0x03] Work_Zone[2] = 386*
  5: 0x030C [0x1D] PRINT_EVENT_MESSAGE(message_id=10205*)
