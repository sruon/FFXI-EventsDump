...
```
  ...
  4: 0x0171 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=19*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  5: 0x0180 [0x1D] PRINT_EVENT_MESSAGE(message_id=8813*)
    → "You can get the details of your assignment from Degga, our V.E.R.M.I.N. field agent in the mines.\u007F1\u0000\u0007"
  6: 0x0183 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0184 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=19*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
