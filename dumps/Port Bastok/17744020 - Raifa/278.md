...
```
  ...
  4: 0x0009 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=19*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  5: 0x0018 [0x1D] PRINT_EVENT_MESSAGE(message_id=8803*)
    → "Can I have a moment of your time?\u0007Are you interested in the protection of Vana'diel's environment?\u007F1\u0000\u0007"
  6: 0x001B [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x001C [0x24] CREATE_DIALOG(message_id=8804*, default_option=1*, option_flags=0*)
    → "Listen to what she has to say?\u0007\u000BLend her an ear.\u0007Uh, I have a thing to go to...\u007F1\u0000\u0007"
 ...
 10: 0x002C [0x1D] PRINT_EVENT_MESSAGE(message_id=8805*)
    → "Do you know of the Gusgen Mines?\u007F1\u0000\u0007"
 11: 0x002F [0x23] WAIT_FOR_DIALOG_INTERACTION
 12: 0x0030 [0x1D] PRINT_EVENT_MESSAGE(message_id=8806*)
    → "Yes, the abandoned mines in the east of the Konschtat Highlands. A frightening place in the midst of an ecological crisis.\u007F1\u0000\u0007"
 13: 0x0033 [0x23] WAIT_FOR_DIALOG_INTERACTION
 14: 0x0034 [0x1D] PRINT_EVENT_MESSAGE(message_id=8807*)
    → "We've heard reports about the scrap materials that have been dumped there. Evidently, they've become the breeding ground for fearsome monsters!\u007F1\u0000\u0007"
 15: 0x0037 [0x23] WAIT_FOR_DIALOG_INTERACTION
 16: 0x0038 [0x1D] PRINT_EVENT_MESSAGE(message_id=8808*)
    → "We are asking environmentally conscious adventurers like yourself to help by exterminating these hazardous creatures. Can we count on your cooperation?\u007F1\u0000\u0007"
 17: 0x003B [0x23] WAIT_FOR_DIALOG_INTERACTION
 18: 0x003C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=19*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 ...
 23: 0x005C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=19*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 24: 0x006B [0x1D] PRINT_EVENT_MESSAGE(message_id=8810*)
    → "I knew you would help!\u0007Bring me evidence that you've defeated these creatures, and I'll pay you a reward from the Vana'diel Environmental Resource Management Initiative Network fund.\u007F1\u0000\u0007"
 25: 0x006E [0x23] WAIT_FOR_DIALOG_INTERACTION
 26: 0x006F [0x03] Work_Zone[1] = 1*
 27: 0x0074 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=19*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 28: 0x0083 [0x1D] PRINT_EVENT_MESSAGE(message_id=8811*)
    → "Just head to the mines, and Degga, one of our V.E.R.M.I.N. field agents, will give you further instructions. Take care, now!\u007F1\u0000\u0007"
 29: 0x0086 [0x23] WAIT_FOR_DIALOG_INTERACTION
 30: 0x0087 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=11*, entity1=EventEntity, entity2=EventEntity, action="kas0")
 31: 0x0096 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="kas0")
...
SUBROUTINE_00AE:
 ...
 37: 0x00B7 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=19*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 38: 0x00C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=8812*)
    → "Well, that is a disappointment...I guess I'll just have to ask another concerned citizen.\u007F1\u0000\u0007"
 39: 0x00C9 [0x23] WAIT_FOR_DIALOG_INTERACTION
 40: 0x00CA [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=19*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 41: 0x00D9 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="thk2")
...
SUBROUTINE_00F4:
 ...
 48: 0x00FD [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=19*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 49: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=8812*)
    → "Well, that is a disappointment...I guess I'll just have to ask another concerned citizen.\u007F1\u0000\u0007"
 50: 0x010F [0x23] WAIT_FOR_DIALOG_INTERACTION
 51: 0x0110 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=19*, entity1=EventEntity, entity2=EventEntity, action="thk2")
 52: 0x011F [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="thk2")
