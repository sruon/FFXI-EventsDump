...
- **8577**: Hey, Juroro!
- **8579**: It's been some time since you made that tuning fork. Are you still researching those giant-viant crystals?
- **8582**: Vhat's wrong vith you? Pull yourself together, man. I don't think the food in this country agrees with you. Or maybe you haven't been getting enough snoozy-vooze time lately?
- **8601**: Vhen you get back to Vindurst, could you report this to the principal?
- **8602**: I don't know if Principal Koru-Moru vill remember Uran-Mafran, but it's vorth a shot.
...
```
  0: 0x023A [0x1D] PRINT_EVENT_MESSAGE(message_id=8577*)
    → "Hey, Juroro!"
...
```
  0: 0x023F [0x1D] PRINT_EVENT_MESSAGE(message_id=8579*)
...
```
  0: 0x0244 [0x1D] PRINT_EVENT_MESSAGE(message_id=8582*)
