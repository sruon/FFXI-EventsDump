...
- **13358**: Why, hello there! My tremendous task is to tabulate your precious points for the [/January/February/March/April/May/June/July/August/September/October/November/December] $0 login campaign and exchange them for pleasing prizes, kupo!
- **13359**: What can I assist you with? ($1 pt[/s].) [Check/Exchange points./Learn about the campaign./Nothing.]
- **13360**: In this login campaign, we provide you with points just for logging in once each day (Earth time), kupo!
- **13361**: You can trade them for incredible items to assist you with your adventures!
- **13363**: You can trade in these tokens for our gratuitous gifts any time during this campaign!
- **13364**: Even when the point-proffering period has passed, you can still acquire these amazing items for a limited time, so don't forget about me, kupo!
- **13365**: Up to 700 points from the current campaign can be carried over to the next one starting with the October 2025 login campaign!
- **13366**: Any additional points will be summarily seized, kupo!
- **13367**: View which item? ($1 pts.) [$2-point items./$3-pt. items./$4-pt. items./$5-pt. items./$6-pt. items./$7-pt. items./$8-pt. items./$9-pt. items./Back.]
- **13369**: $23 costs $22 point[/s]. [You don't have enough points, kupo./Purchase this prize, kupo?/]
- **13370**: How many would you like, kupo?
- **13371**: Altana above! You do not possess the prerequisite number of points!
- **13372**: Proceed with exchange? ($1 pt[/s].) [Yes./No.]
- **13373**: Wait one short second while I get your goods!
...
```
 ...
 14: 0x006F [0x1D] PRINT_EVENT_MESSAGE(message_id=13358*)
 ...
 17: 0x0078 [0x24] CREATE_DIALOG(message_id=13359*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00D0:
 ...
 32: 0x00FD [0x24] CREATE_DIALOG(message_id=13367*, default_option=ExtData[1]->WorkLocal[9], option_flags=ExtData[1]->WorkLocal[3])
...
107: 0x0338 [0x1D] PRINT_EVENT_MESSAGE(message_id=13369*)
...
121: 0x03BC [0x1D] PRINT_EVENT_MESSAGE(message_id=13371*)
...
127: 0x03CC [0x1D] PRINT_EVENT_MESSAGE(message_id=13373*)
