...
- **14061**: This is an explanation of the Assist Channel feature, which allows new and returning players to seek help from veteran adventurers.
- **14062**: You must take on the "$0" Records of Eminence objective before receiving the explanation.
- **14063**: You must complete "$1" before taking on the "$0" Records of Eminence objective.
- **14064**: What do you want to learn about? [What is the Assist Channel?/How can I post a message?/What are the requirements?/Where can I access it?/Tell me about mentor messages./Where can I find mentors?/What are Thumbs Up and Warnings?/What happens if I am muted?/When do my posting rights expire?/Nothing for now.]
- **14065**: The Assist Channel is a special chat channel that allows adventurers to ask questions and receive advice from veteran players known as mentors.
- **14066**: Press the space bar to bring up the text window at the bottom of the screen and type "/assistj (your message)" or "/assiste (your message)" to post your message.
- **14067**: You can also use "/aj" for "/assistj", and "/ae" for "/assiste".
- **14068**: Additionally, pressing CTRL+Q will display "/assistj" or "/assiste" in the text window for you.
- **14069**: You can change the CTRL+Q shortcut command...
- **14070**: ...by going to Main Menu > Config > Misc. 2 > Key Assignment > Commands > Chat: /AssistE or /AssistJ.
- **14071**: It is recommended that you use "/assistj (/aj)" when posting in Japanese, and "/assiste (/ae)" when posting in English.
- **14072**: You must meet one of the following conditions in order to post to the Assist Channel.
- **14073**: 1. You are a new player You may post messages from the moment you first set foot in Vana'diel.
- **14074**: 2. You are a returnee As a returning player, you may post messages upon logging in with a character that has not logged in for at least 48 days.
- **14075**: 3. You are a mentor You may post messages as long as you remain a mentor to other players.
- **14076**: New players and returnees may post messages until they have been logged in for a total of 48 hours since first receiving their posting rights.
- **14077**: If you wish to check how long you can continue to post for, speak to an % and choose "When do my posting rights expire?" to see how much time you have left.
- **14078**: The Assist Channel can only be used in the following areas.
- **14079**: Available areas: $7, $7, $7, $7, $7, $7...
- **14080**: ...$7, $7, $7, $7, $7, $7, $7, $7...
- **14081**: ...$7, $7, $7, $7, $7, $7, $7, $7...
- **14082**: ...$7, $7, $7, and your Mog House (Rent-a-Room).
- **14083**: You cannot post or read messages outside of the areas listed above.
- **14084**: Even in areas where messages are allowed, you cannot post consecutive messages. Please wait a while after posting a message.
- **14085**: Mentor messages are accompanied by a flag (o/) marker. This marker indicates the mentor's reliability (Mentor Class) and experience as an adventurer (Mastery Rank).
- **14086**: As a mentor's Mentor Class increases, the color and shape of the marker will change: o/ > o9 > oC
- **14087**: A oC marker is a sign that the mentor has earned the highest levels of trust from other adventurers.
- **14088**: The number affixed to the marker is the mentor's Mastery Rank, and indicates how experienced the mentor is as an adventurer.
- **14089**: The higher the number, the more experienced the mentor is.
- **14090**: You can check your own Mastery Rank even if you do not serve as a mentor, so feel free to take a look every now and then if you are curious.
- **14091**: You can check your Mastery Rank by going to Main Menu > Status > Profile.
- **14092**: If you wish to speak directly to a mentor, you can search for mentors by going to Main Menu > Help Desk > Mentor Search.
- **14093**: The "Thumbs Up" feature enables you to let mentors know when their comments proved to be especially helpful.
- **14094**: Mentors who earn lots of "Thumbs Up" replies from other adventurers will see their Mentor Class increase.
- **14095**: Remember to give a "Thumbs Up" to any mentor you feel helped you out or taught you something useful.
- **14096**: A "Warning" is a feature that can only be used by mentors.
- **14097**: Please use this feature when a post's contents are insufficient or otherwise may be construed as harassment.
- **14098**: To send a "Thumbs Up" or "Warning" to another player, open the Chat Log Window and move the cursor over the relevant message and press the confirm button (Enter key) to bring up the evaluation menu.
- **14099**: Evaluations can be made for 10 minutes following the designated player's latest post to the Assist Channel.
- **14100**: You may send up to one "Thumbs Up" and one "Warning" per day (Earth time).
- **14101**: The "Mute" feature places restrictions on your ability to post, meaning that other players will be unable to see the messages you post to the Assist Channel.
- **14102**: Please refrain from posting unsuitable content so that the veteran adventurers are not forced to mute you.
- **14103**: Mute status can be removed by players that have the necessary Mute List access rights, or it will be removed automatically 24 hours (Earth time) after the mute status was enabled.
- **14104**: You are free to post messages to the Assist Channel until you decide to stop serving as a mentor.
- **14105**: You may post messages to the Assist Channel until : on //. (Time remaining: Approx. $1 [sec./min./hr.])
- **14106**: If you log out while you still have time available, your remaining time will be carried over to the next time you log in.
- **14107**: You are about to lose the ability to post messages to the Assist Channel.
- **14108**: You are unable to post messages to the Assist Channel.
...
```
  ...
  7: 0x001A [0x24] CREATE_DIALOG(message_id=14064*, default_option=ExtData[1]->WorkLocal[4], option_flags=0*)
