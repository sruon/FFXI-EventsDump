...
```
  ...
  1: 0x000B [0x1F] MOVE_ENTITY: EventEntity moves to X=-147.500*, Z=0.250*, Y=-6.000*
...
```
  ...
  1: 0x0019 [0x1F] MOVE_ENTITY: EventEntity moves to X=-148.250*, Z=-3.880*, Y=-6.000*
  2: 0x0021 [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x0023 [0x1F] MOVE_ENTITY: EventEntity moves to X=-149.150*, Z=-7.690*, Y=-6.000*
