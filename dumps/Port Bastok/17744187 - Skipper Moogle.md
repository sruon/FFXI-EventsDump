...
- **13618**: Heigh-ho, kupo! I'm the boatswain for this darned-good dinghy, and it's my duty to divulge all the discursive details about Mog Gardens. So, what kind of cognition are you craving?
- **13619**: What do you want to know? [Nothing./What Mog Gardens are./How to get to one./What Mog Garden books are available.]
- **13620**: We've got staggering stores of the following scholarly scripts and tantalizing tomes, kupo!
- **13621**: Which book will you buy? [None./3./$3./$3./$3./$3./$3.]
- **13622**: $3, is it, kupo? Interestingly enough, that one is reported to raise the rank of your [furrows/arboreal grove/mineral vein/pond dredger/coastal fishing net/monster rearing skills] to ridiculous reaches...for the small sum of $7 gil.
- **13623**: Buy the book? [Yes./No.]
- **13624**: Trading tender for treasures...isn't shopping sublime, kupo?
- **13625**: Disappointingly, I doubt you've the discernment to descry the details of these documents. Exit then, and expand the extent of your experience.
- **13626**: Sorry, but our stocks of such sundries are so scarce we can't sell them.
- **13627**: Mog Gardens are lovely locales that lie latent in the west, on the Adoulin Islands. They're true treasure troves of taintless resources, frothing with fish, bursting with birds, and filled with forests, kupo!
- **13628**: Think of it as your Mog House away from home! Just like that fantastic facility, there's a wealth of wonders just waiting to well up for your disposal.
- **13629**: Spread your wings as wide as you wish without worrying about the consequences, kupo. The Green Thumb Moogle will handle the husbandry of this homestead while you're out hacking at hordes of hellions and cavorting across continents.
- **13630**: If you're shivering to shove off, then shuffle aboard the Mog Dinghy over there! It may seem small and slightly slipshod, but the mysterious moogle magic we manifest upon it is magnificent enough to move you malms and malms in mere minutes.
- **13631**: Once you adjust to your Adoulinian asylum, I'll even proffer printed publications that will make your Mog Garden more majestic. Grab your gil and get ready, kupo!
- **13632**: While it'd be wickedly wonderful to whisk away everyone to Mog Gardens, only "Certified Adventurers" and "pioneers" are allowed entry to these excellent expanses of escape, kupo.
- **13633**: "Certified Adventurers" are those who have applied themselves assiduously, attaining the third mission rank in any nation.
- **13634**: It doesn't have to be here as long as you were once appropriately accredited in times antecedent.
- **13635**: If Adoulin's body politic has properly permitted you to perform pioneering duties, however, your so-called "rank" can be lower than a leech's legs and you'll still be let in, kupo.
...
```
  ...
  4: 0x0015 [0x1D] PRINT_EVENT_MESSAGE(message_id=13618*)
  ...
  8: 0x0026 [0x24] CREATE_DIALOG(message_id=13619*, default_option=0*, option_flags=0*)
 ...
 11: 0x0036 [0x1D] PRINT_EVENT_MESSAGE(message_id=13627*)
 ...
 13: 0x003A [0x1D] PRINT_EVENT_MESSAGE(message_id=13628*)
 ...
 15: 0x003E [0x1D] PRINT_EVENT_MESSAGE(message_id=13629*)
 ...
 17: 0x0042 [0x1D] PRINT_EVENT_MESSAGE(message_id=13630*)
 ...
 19: 0x0046 [0x1D] PRINT_EVENT_MESSAGE(message_id=13631*)
 ...
 23: 0x0055 [0x1D] PRINT_EVENT_MESSAGE(message_id=13632*)
 ...
 25: 0x0059 [0x1D] PRINT_EVENT_MESSAGE(message_id=13633*)
 ...
 27: 0x005D [0x1D] PRINT_EVENT_MESSAGE(message_id=13634*)
 ...
 29: 0x0061 [0x1D] PRINT_EVENT_MESSAGE(message_id=13635*)
...
SUBROUTINE_014D:
 ...
 68: 0x0152 [0x1D] PRINT_EVENT_MESSAGE(message_id=13620*)
 ...
 70: 0x0156 [0x24] CREATE_DIALOG(message_id=13621*, default_option=0*, option_flags=Work_Zone_1700[22])
...
112: 0x0249 [0x1D] PRINT_EVENT_MESSAGE(message_id=13626*)
...
117: 0x0258 [0x1D] PRINT_EVENT_MESSAGE(message_id=13625*)
...
128: 0x0280 [0x1D] PRINT_EVENT_MESSAGE(message_id=13622*)
...
130: 0x0284 [0x24] CREATE_DIALOG(message_id=13623*, default_option=0*, option_flags=0*)
    → "Buy the book? [Yes./No.]"
...
140: 0x02B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=13624*)
