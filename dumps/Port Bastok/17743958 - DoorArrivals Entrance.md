...
```
  ...
  4: 0x0028 [0x2B] Bartolomeo (ID: 17743891/0x010EC013) [7611*]:
  ...
  8: 0x003C [0x2B] Aishah (ID: 17743939/0x010EC043) [7612*]:
 ...
 10: 0x0044 [0x24] CREATE_DIALOG(message_id=7613*, default_option=1*, option_flags=0*)
    → "Go in? [Yes./No.]"
