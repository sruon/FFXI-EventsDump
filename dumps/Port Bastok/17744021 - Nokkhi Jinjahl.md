...
- **8819**: The Troupe Valeriano, at your service! Well, I'm more of a behind-the-scenes kinda gal, not an entertainer.
- **8820**: People call me "Nokky the Tree-shaker"! While the other guys are doing their thing, I work on the sidelines as a quiver-maker. Basically, I can make it easier for you to lug around those bundles of ninety-nine arrows or bolts or whatever.
- **8821**: I've been doing this for a while now, so I've learned to bundle all sorts of stuff...
- **8822**: %, $1, $2, $3, $4, and $5 I've always been able to do...
- **8823**: But now I can also bundle $0, $1, $2, $3, $4, and $5.
- **8824**: Not to mention $0, $1, $2, $3, $4, $5, and $6.
- **8825**: %, $2, and plain old $1!
- **8826**: And of course, $0, $1, $2, $3, and $4!
- **8827**: Then there's everyone's favorite $0, $1, and $2.
- **8828**: Finally, new to my bundling repertoire, we have $0, $1, $2, and $3!
- **8829**: I can even bundle those elemental cards that corsairs use!
- **8830**: Aren't you imprrressed? Keeping up with all these new types of ammunition is hard work!
- **8831**: Oh, and for the rrrecord, anything else is too much trrrouble to deal with. Not my thing.
- **8832**: This ain't no charity, though. I'm not really interested in gil, but... Let's see here... Flowers...? Yeah, you bring me $0 for every ninety-nine arrows, bolts, or whatever you want organized, and we got a deal.
- **8833**: I can make a quiver or pouch for up to seven sets of the same kind of ammunition. So you could bring me, say, one hundred ninety-eight $1 and two of those $0, for example. I like to do things real efficient-like, you see, so make sure they're in multiples of ninety-nine.
- **8834**: % smiles slyly at you.
...
```
  ...
  1: 0x000B [0x1D] PRINT_EVENT_MESSAGE(message_id=8819*)
  ...
  3: 0x000F [0x1D] PRINT_EVENT_MESSAGE(message_id=8820*)
  ...
  5: 0x0013 [0x1D] PRINT_EVENT_MESSAGE(message_id=8821*)
 ...
 13: 0x0035 [0x1D] PRINT_EVENT_MESSAGE(message_id=8822*)
 ...
 21: 0x0057 [0x1D] PRINT_EVENT_MESSAGE(message_id=8823*)
 ...
 30: 0x007E [0x1D] PRINT_EVENT_MESSAGE(message_id=8824*)
 ...
 35: 0x0091 [0x1D] PRINT_EVENT_MESSAGE(message_id=8825*)
    → "%, $2, and plain old $1!"
 ...
 42: 0x00AE [0x1D] PRINT_EVENT_MESSAGE(message_id=8826*)
 ...
 47: 0x00C1 [0x1D] PRINT_EVENT_MESSAGE(message_id=8827*)
 ...
 59: 0x00E5 [0x1D] PRINT_EVENT_MESSAGE(message_id=8831*)
 ...
 63: 0x00F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=8832*)
 ...
 65: 0x00F7 [0x1D] PRINT_EVENT_MESSAGE(message_id=8833*)
