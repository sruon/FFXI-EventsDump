...
- **8531**: Try though you may, there will come a time when failure is inevitable.
- **8532**: Channel that agony and bitterness into creating a new plan.
- **8549**: If you don't prepare yourself for battle, you'll get beaten to a pulp, like we did!
- **8550**: As soon as we gather our companions, we'll be jumping into the fray again. I just hope this little researcher doesn't get in our way...
- **8639**: Hmmm... Hrmmm... So it's time to use...no...
- **8640**: Hello? You're an adventurer, right? Maybe you can help us out.
- **8641**: Let me introduce myself and my companion. We're from the Rhinostery in Windurst.
- **8642**: I was hired by the ministry to accompany this researcher to [Ifrit's Cauldron/the Quicksand Caves/the Den of Rancor/Cape Teriggan/Fei'Yin/the Boyahda Tree] and assist her in her study of a series of giant crystals.
- **8643**: But what was waiting for us inside those crystals was more than I could deal with...
- **8644**: We tried countless times, but I could not defeat that beast. Another researcher at the Rhinostery sympathized with our plight and developed an improved tuning fork.
- **8647**: Do you see what I have to deal with? I don't know how much longer I can work with such a pessimist.
- **8648**: That's where you come in. I was thinking of letting one of you adventurers test out the new fork and prove to my colleague that it is able to return data valuable to her research.
- **8652**: ... Yes, but ma'am... The Rhinostery has been pressing us to produce results. If we do not take some sort of action quickly...
- **8654**: No, one round could not hurt.
- **8656**: Are you really-dilly sure? [Fork me!/On second thought...]
- **8659**: The researcher who made the $1 warned that "the door home would only open to those who defeated the prime avatar."
- **8660**: I'm not quite sure what that is supposed to mean, but I suggest that you prepare well before taking on this journey. Remember, you have to be at least a level $3 summoner.
- **8661**: Are you and Carbuncle ready to fight the prime avatar as a level $3 summoner?
- **8662**: Also, regardless of whether you defeat the avatar or not, you will be unable to re-enter the protocrystal again for a number of days.
- **8663**: Are you sure you are ready? [Off to [Ifrit's Cauldron/the Quicksand Caves/the Den of Rancor/Cape Teriggan/Fei'Yin/the Boyahda Tree]!/My dog ate my mini tuning fork./Not just yet...]
- **8664**: Ma'am, our adventurer has completed [his/her] preparations and requests a warp.
- **8667**: Don't use that excuse on me, [young man/young lady]. If you want another $1, all you have to do ask.
- **8668**: If you do not bring the $1 we gave you, my companion cannot warp you to [Ifrit's Cauldron/the Quicksand Caves/the Den of Rancor/Cape Teriggan/Fei'Yin/the Boyahda Tree].
- **8669**: Did you remember to bring the $1?
- **8670**: What!? You defeated the prime avatar!?
- **8671**: Ma'am!
- **8673**: ... Ma'am...
- **8674**: ... (Now if I could only find me some real work so I could do some real adventuring...)
- **8676**: Remember that you must fight the prime avatar as a level $3 summoner. As you already know, this will not be an easy task. Prepare well for the battle.
- **8677**: Do you want another mini tuning fork? [Fork me baby, one more time./Stick a fork in me, I'm done.]
- **8685**: Ah, you are back. How was your battle with the avatar?
- **8686**: Remember, the protocrystals will only resonate with the tuning forks ever so often. Use this time to rest before taking upon another challenge.
...
```
  ...
  3: 0x0026 [0x1D] PRINT_EVENT_MESSAGE(message_id=8549*)
  ...
  5: 0x002A [0x1D] PRINT_EVENT_MESSAGE(message_id=8550*)
 ...
 11: 0x0044 [0x2B] Juroro (ID: 17744008/0x010EC088) [8551*]:
...
```
  0: 0x01A0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8639*)
  ...
  3: 0x01AD [0x1D] PRINT_EVENT_MESSAGE(message_id=8640*)
  ...
  7: 0x01C4 [0x1D] PRINT_EVENT_MESSAGE(message_id=8641*)
 ...
 12: 0x01DE [0x1D] PRINT_EVENT_MESSAGE(message_id=8642*)
 ...
 14: 0x01E2 [0x1D] PRINT_EVENT_MESSAGE(message_id=8643*)
 ...
 18: 0x01EC [0x1D] PRINT_EVENT_MESSAGE(message_id=8644*)
 ...
 30: 0x022F [0x1D] PRINT_EVENT_MESSAGE(message_id=8647*)
 ...
 34: 0x0243 [0x1D] PRINT_EVENT_MESSAGE(message_id=8648*)
 ...
 44: 0x026F [0x1D] PRINT_EVENT_MESSAGE(message_id=8652*)
 ...
 54: 0x02A0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8654*)
 ...
 62: 0x02C9 [0x2B] Juroro (ID: 17744008/0x010EC088) [8655*]:
 ...
 66: 0x02E2 [0x24] CREATE_DIALOG(message_id=8656*, default_option=0*, option_flags=0*)
 ...
 78: 0x032B [0x1D] PRINT_EVENT_MESSAGE(message_id=8659*)
 ...
 80: 0x032F [0x1D] PRINT_EVENT_MESSAGE(message_id=8660*)
...
```
  ...
  8: 0x0362 [0x24] CREATE_DIALOG(message_id=8663*, default_option=0*, option_flags=Work_Zone[6])
 ...
 18: 0x0393 [0x1D] PRINT_EVENT_MESSAGE(message_id=8664*)
 ...
 24: 0x03A9 [0x2B] Juroro (ID: 17744008/0x010EC088) [8665*]:
 ...
 28: 0x03BF [0x2B] Juroro (ID: 17744008/0x010EC088) [8666*]:
    → "Sha-mone!"
...
```
  ...
  6: 0x041A [0x1D] PRINT_EVENT_MESSAGE(message_id=8668*)
 ...
 11: 0x0422 [0x1D] PRINT_EVENT_MESSAGE(message_id=8661*)
    → "Are you and Carbuncle ready to fight the prime avatar as a level $3 summoner?"
 12: 0x0425 [0x23] WAIT_FOR_DIALOG_INTERACTION
 13: 0x0426 [0x1D] PRINT_EVENT_MESSAGE(message_id=8662*)
    → "Also, regardless of whether you defeat the avatar or not, you will be unable to re-enter the protocrystal again for a number of days."
 14: 0x0429 [0x23] WAIT_FOR_DIALOG_INTERACTION
 15: 0x042A [0x24] CREATE_DIALOG(message_id=8663*, default_option=0*, option_flags=Work_Zone[6])
    → "Are you sure you are ready? [Off to [Ifrit's Cauldron/the Quicksand Caves/the Den of Rancor/Cape Teriggan/Fei'Yin/the Boyahda Tree]!/My dog ate my mini tuning fork./Not just yet...]"
 ...
 20: 0x0440 [0x1D] PRINT_EVENT_MESSAGE(message_id=8669*)
 ...
 26: 0x0455 [0x1D] PRINT_EVENT_MESSAGE(message_id=8667*)
...
```
  ...
  3: 0x0477 [0x1D] PRINT_EVENT_MESSAGE(message_id=8661*)
    → "Are you and Carbuncle ready to fight the prime avatar as a level $3 summoner?"
...
```
  ...
  3: 0x0486 [0x1D] PRINT_EVENT_MESSAGE(message_id=8685*)
    → "Ah, you are back. How was your battle with the avatar?"
  4: 0x0489 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x048A [0x1D] PRINT_EVENT_MESSAGE(message_id=8686*)
...
```
  ...
  4: 0x04A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=8670*)
  ...
  8: 0x04B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=8671*)
    → "Ma'am!"
 ...
 13: 0x04C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=8673*)
    → "... Ma'am..."
 14: 0x04C5 [0x23] WAIT_FOR_DIALOG_INTERACTION
 15: 0x04C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=8674*)
...
```
  ...
  9: 0x0506 [0x1D] PRINT_EVENT_MESSAGE(message_id=8676*)
 ...
 12: 0x0512 [0x24] CREATE_DIALOG(message_id=8677*, default_option=0*, option_flags=0*)
