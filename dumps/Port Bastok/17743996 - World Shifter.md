...
- **7790**: The WES (World Emigration Service) is currently taking applications for those who wish to immigrate to another World.
- **7791**: When applying, please note the following:
- **7792**: You can always cancel your emigration during the application period by talking to any of the WES agents located conveniently about Vana'diel. However, once the period is over, you will no longer be able to cancel.
- **7793**: After immigrating to another World, you will not be allowed to return to your previous World. Also, emigration is only allowed during periods when the WES is accepting applications.
- **7794**: You will be unable to choose the World to which you wish to emigrate. For more information on Worlds that we are accepting emigration applications for, please check the current PlayOnline news.
- **7795**: If your character happens to have the same name as another player in the World to which you emigrate, you will have to change your name before entering that World.
- **7796**: Emigration of characters is done one at a time.
- **7797**: If you request emigration for any of your other characters, please conduct all applications separately.
- **7798**: All items up for auction and in your Delivery Box will be lost when you emigrate. Please collect these items before moving.
- **7799**: Any items in your Mog Safe will be transported with you to the new World.
- **7800**: Any linkshells, linkpearls, and pearl sacks will be destroyed at the time of emigration. However, linkshell owners will be presented with a new, unopened linkshell.
- **7801**: Finally, all markers placed on your maps will be erased.
- **7802**: Do you wish to apply for emigration? [Yes./No.]
- **7804**: You have already submitted an application for emigration.
- **7805**: Do you wish to cancel your application? [Yes./No.]
- **7809**: Which world will you emigrate to? [I've changed my mind./Bahamut/Shiva/Titan/Ramuh/Phoenix/Carbuncle/Fenrir/Sylph/Valefor/Alexander/Leviathan/Odin/Ifrit/Diabolos/Caitsith/Quetzalcoatl/Siren/Unicorn/Gilgamesh/Ragnarok/Next page.]
- **7810**: Which world will you emigrate to? [I've changed my mind./Pandemonium/Garuda/Cerberus/Kujata/Bismarck/Seraph/Lakshmi/Asura/Midgardsormr/Fairy/Remora/Hades/Previous page.]
- **7811**: You have already submitted an application for emigration to [].
...
```
  ...
  2: 0x000B [0x1D] PRINT_EVENT_MESSAGE(message_id=7790*)
  ...
  4: 0x000F [0x1D] PRINT_EVENT_MESSAGE(message_id=7791*)
    → "When applying, please note the following:"
  5: 0x0012 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0013 [0x1D] PRINT_EVENT_MESSAGE(message_id=7792*)
  ...
  8: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=7793*)
 ...
 11: 0x0023 [0x1D] PRINT_EVENT_MESSAGE(message_id=7794*)
 ...
 13: 0x0027 [0x1D] PRINT_EVENT_MESSAGE(message_id=7795*)
 ...
 15: 0x002B [0x1D] PRINT_EVENT_MESSAGE(message_id=7796*)
    → "Emigration of characters is done one at a time."
 16: 0x002E [0x23] WAIT_FOR_DIALOG_INTERACTION
 17: 0x002F [0x1D] PRINT_EVENT_MESSAGE(message_id=7797*)
 ...
 19: 0x0033 [0x1D] PRINT_EVENT_MESSAGE(message_id=7798*)
 ...
 25: 0x003F [0x1D] PRINT_EVENT_MESSAGE(message_id=7801*)
    → "Finally, all markers placed on your maps will be erased."
 26: 0x0042 [0x23] WAIT_FOR_DIALOG_INTERACTION
 27: 0x0043 [0x24] CREATE_DIALOG(message_id=7802*, default_option=1*, option_flags=0*)
...
SUBROUTINE_00C5:
 50: 0x00C5 [0x24] CREATE_DIALOG(message_id=7809*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00E7:
 56: 0x00E7 [0x24] CREATE_DIALOG(message_id=7810*, default_option=0*, option_flags=ExtData[1]->WorkLocal[1])
...
```
  ...
  3: 0x013C [0x1D] PRINT_EVENT_MESSAGE(message_id=7811*)
  ...
  6: 0x0143 [0x1D] PRINT_EVENT_MESSAGE(message_id=7804*)
    → "You have already submitted an application for emigration."
  7: 0x0146 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_0147:
  8: 0x0147 [0x24] CREATE_DIALOG(message_id=7805*, default_option=1*, option_flags=0*)
