...
- **13733**: I've set up shop at this site in search of souls to sell sundries to, kupo! Come back later for some glorious goodies!
- **13734**: Come hither, able adventurer! From precipitously perilous peaks to completely creepy caves, I've gathered glorious goodies to sell to one such as yourself!
- **13735**: Y-you don't seriously suspect I stole this sumptuous stash through some surreptitious scheme!? I assure you I acquired them on the up-and-up!
- **13736**: You won't find frivolous frauds here, only absolutely authentic articles, kupo!
- **13737**: Back to buy, kupo?
- **13738**: Tremendous timing! I've imported an incredible inventory of immaculate items!
- **13739**: What would you like? [Nothing for now./Medicine./Ammunition./Ninjutsu tools./Foodstuffs./Scrolls/materials./Keys./Equipment./Various key items.]
- **13740**: Get your hands on what? [None of these./$3: $17 gil./$3: $18 gil./$3: $19 gil./$3: $20 gil./$3: $21 gil./$3: $22 gil./$3: $23 gil./$3: $24 gil./$3: $25 gil./$3: $26 gil./$3: $27 gil./$3: $28 gil./$3: $29 gil./$3: $30 gil./$3: $31 gil./$3: $ gil./Previous page./Next page.]
- **13741**: $6 will run you $2 gil, kupo.
- **13742**: Purchase that item? ($0 gil) [Yes, please./No, thank you.]
- **13743**: Always a pleasure!
...
SUBROUTINE_001C:
 ...
 14: 0x0050 [0x1D] PRINT_EVENT_MESSAGE(message_id=13734*)
 ...
 16: 0x0054 [0x1D] PRINT_EVENT_MESSAGE(message_id=13735*)
 ...
 18: 0x0058 [0x1D] PRINT_EVENT_MESSAGE(message_id=13736*)
 ...
 21: 0x005F [0x1D] PRINT_EVENT_MESSAGE(message_id=13738*)
...
SUBROUTINE_0063:
 ...
 24: 0x0066 [0x1D] PRINT_EVENT_MESSAGE(message_id=13737*)
    → "Back to buy, kupo?"
...
SUBROUTINE_006A:
 ...
 29: 0x0071 [0x24] CREATE_DIALOG(message_id=13739*, default_option=ExtData[1]->WorkLocal[5], option_flags=ExtData[1]->WorkLocal[4])
...
SUBROUTINE_00C0:
 ...
 47: 0x00CB [0x24] CREATE_DIALOG(message_id=13740*, default_option=ExtData[1]->WorkLocal[7], option_flags=ExtData[1]->WorkLocal[6])
...
SUBROUTINE_0125:
 ...
 75: 0x0159 [0x1D] PRINT_EVENT_MESSAGE(message_id=13741*)
    → "$6 will run you $2 gil, kupo."
 76: 0x015C [0x23] WAIT_FOR_DIALOG_INTERACTION
 77: 0x015D [0x24] CREATE_DIALOG(message_id=13742*, default_option=1*, option_flags=0*)
 ...
 90: 0x019D [0x1D] PRINT_EVENT_MESSAGE(message_id=13743*)
    → "Always a pleasure!"
...
# Dead code (unreachable instructions):
     ...
     0x0012 [0x1D] PRINT_EVENT_MESSAGE(message_id=13733*)
