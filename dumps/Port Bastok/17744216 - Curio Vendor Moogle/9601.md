...
```
 ...
 14: 0x0050 [0x1D] PRINT_EVENT_MESSAGE(message_id=13733*)
    → "Come hither, able adventurer! From precipitously perilous peaks to completely creepy caves, I've gathered glorious goodies to sell to one such as yourself!\u007F1\u0000\u0007"
 15: 0x0053 [0x23] WAIT_FOR_DIALOG_INTERACTION
 16: 0x0054 [0x1D] PRINT_EVENT_MESSAGE(message_id=13734*)
    → "Y-you don't seriously suspect I stole this sumptuous stash through some surreptitious scheme!? I assure you I acquired them on the up-and-up!\u007F1\u0000\u0007"
 17: 0x0057 [0x23] WAIT_FOR_DIALOG_INTERACTION
 18: 0x0058 [0x1D] PRINT_EVENT_MESSAGE(message_id=13735*)
    → "You won't find frivolous frauds here, only absolutely authentic articles, kupo!\u007F1\u0000\u0007"
 19: 0x005B [0x23] WAIT_FOR_DIALOG_INTERACTION
 20: 0x005C [0x01] GOTO 0x0063

SUBROUTINE_005F:
 21: 0x005F [0x1D] PRINT_EVENT_MESSAGE(message_id=13737*)
    → "Tremendous timing! I've imported an incredible inventory of immaculate items!\u007F1\u0000\u0007"
...
SUBROUTINE_0066:
 ...
 29: 0x0071 [0x24] CREATE_DIALOG(message_id=13738*, default_option=0x0005, option_flags=0x04)
    → "What would you like?\u0007\u000BNothing for now.\u0007Medicine.\u0007Ammunition.\u0007Ninjutsu tools.\u0007Foodstuffs.\u0007Scrolls/materials.\u0007Keys.\u0007Equipment.\u0007Various key items.\u007F1\u0000\u0007"
...
SUBROUTINE_00B7:
 ...
 47: 0x00CB [0x24] CREATE_DIALOG(message_id=13739*, default_option=0x0007, option_flags=0x06)
    → "Get your hands on what?\u0007\u000BNone of these.\u0007\u007F\u0000\u0001\u0001\u00053\u0002\u0001\u0000\u0000: 
\u0011 gil.\u0007\u007F\u0000\u0001\u0001\u00053\u0002\u0002\u0000\u0000: 
\u0012 gil.\u0007\u007F\u0000\u0001\u0001\u00053\u0002\u0003\u0000\u0000: 
\u0013 gil.\u0007\u007F\u0000\u0001\u0001\u00053\u0002\u0004\u0000\u0000: 
\u0014 gil.\u0007\u007F\u0000\u0001\u0001\u00053\u0002\u0005\u0000\u0000: 
...
132: 0x0264 [0x41] GET_BIT_WORK_RANGE(start_bit=0x0C, end_bit=0x0D, source=ExtData[1]->WorkLocal[2], result=ExtData[1]->WorkLocal[6])
...
137: 0x0288 [0x3D] CLEAR_BIT_FLAG_CONDITIONAL(target_work_offset=0x06, bit_index_work_offset=0x800E, condition_work_offset=0x8013)
138: 0x028F [0x01] GOTO 0x0299

SUBROUTINE_0292:
139: 0x0292 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x06, bit_index_work_offset=0x800E, condition_work_offset=0x8013)
...
144: 0x02AE [0x3D] CLEAR_BIT_FLAG_CONDITIONAL(target_work_offset=0x06, bit_index_work_offset=0x800F, condition_work_offset=0x8013)
145: 0x02B5 [0x01] GOTO 0x02BF

SUBROUTINE_02B8:
146: 0x02B8 [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x06, bit_index_work_offset=0x800F, condition_work_offset=0x8013)
...
```
# Data Section: 0x000B (17 bytes)
     0x000B: 1E F0 FF FF 7F 6F 70 1D 00 80 23 03 01 10 01 80
     0x001B: 1B
