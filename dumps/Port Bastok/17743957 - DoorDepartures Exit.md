...
```
  ...
  5: 0x002D [0x2B] Rajesh (ID: 17743937/0x010EC041) [7611*]:
  ...
  7: 0x0035 [0x24] CREATE_DIALOG(message_id=7612*, default_option=1*, option_flags=0*)
    → "Pay $7 gil? [Yes./No.]"
...
SUBROUTINE_0099:
 ...
 23: 0x00A5 [0x2B] Varden (ID: 17743938/0x010EC042) [7610*]:
...
```
  ...
  6: 0x00E0 [0x2B] Rajesh (ID: 17743937/0x010EC041) [7609*]:
 ...
 10: 0x00F4 [0x2B] Varden (ID: 17743938/0x010EC042) [7610*]:
    → "Only departing passengers may pass through these doors. Please go around to the entrance on the south side."
