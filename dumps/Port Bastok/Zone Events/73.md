...
```
  ...
  2: 0x0A1E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
  3: 0x0A2F [0x46] CAMERA_CONTROL: Disable user control
  4: 0x0A31 [0x45] LOAD_SCHEDULED_TASK(work_offset1=136*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="sscb", work_offset2=600*)
  5: 0x0A42 [0x1C] WAIT(540* ticks)
  6: 0x0A45 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  7: 0x0A56 [0x1C] WAIT(60* ticks)
  8: 0x0A59 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
