...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0000:       02 60 10 00 80 00  7D 02 13 00 00 01 80 02    .`....}.......
0010: 61 10 00 80 00 41 00 02  00 00 00 80 80 22 00 01  a....A......."..
...
```
  0: 0x0002 [0x02] IF !(0x1060 == 0*) GOTO 0x027D
  1: 0x000A [0x13] ExtData[1]->WorkLocal[0] = rand() % 2*
  2: 0x000F [0x02] IF !(0x1061 == 0*) GOTO 0x0041
