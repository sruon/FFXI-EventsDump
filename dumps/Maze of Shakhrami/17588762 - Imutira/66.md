...
```
 ...
 25: 0x0093 [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y000", work_offset2=0*)
 26: 0x00A4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 ...
 31: 0x00D4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y001", work_offset2=0*)
 ...
 40: 0x0115 [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y002", work_offset2=0*)
 41: 0x0126 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=19*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 42: 0x0135 [0x2B] Imutira (ID: 17588762/0x010C621A) [7324*]:
    → "I couldn't keep my eyes off the fight. You were incredible!\u007F1\u0000\u0007"
 43: 0x013C [0x23] WAIT_FOR_DIALOG_INTERACTION
 44: 0x013D [0x1C] WAIT(60* ticks)
 45: 0x0140 [0x2B] Imutira (ID: 17588762/0x010C621A) [7325*]:
    → "That monster was keeping me from going home, but you solved that problem for me.\u007F1\u0000\u0007"
 46: 0x0147 [0x23] WAIT_FOR_DIALOG_INTERACTION
 47: 0x0148 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=19*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 ...
 50: 0x0169 [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y003", work_offset2=0*)
 51: 0x017A [0x2B] Imutira (ID: 17588762/0x010C621A) [7326*]:
    → "Anyway, what are you here for?\u007F1\u0000\u0007"
 52: 0x0181 [0x23] WAIT_FOR_DIALOG_INTERACTION
 53: 0x0182 [0x1C] WAIT(60* ticks)
 54: 0x0185 [0x2B] Imutira (ID: 17588762/0x010C621A) [7327*]:
    → "You're searching for \u0001\u00056\u0002\u0001\u0000\u0000?\u007F1\u0000\u0007"
 ...
 57: 0x019C [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y004", work_offset2=0*)
 ...
 62: 0x01BB [0x2B] Imutira (ID: 17588762/0x010C621A) [7329*]:
    → "But wait... That's odd. To be looking for such an item, you must be...\u007F1\u0000\u0007"
 63: 0x01C2 [0x23] WAIT_FOR_DIALOG_INTERACTION
 64: 0x01C3 [0x24] CREATE_DIALOG(message_id=7330*, default_option=0*, option_flags=0*)
    → "Tell her you're a...\u0007\u000BMember of the Seagull Phratrie.\u0007Regular adventurer.\u007F1\u0000\u0007"
...
SUBROUTINE_01D9:
 ...
 70: 0x01E1 [0x2B] Imutira (ID: 17588762/0x010C621A) [7331*]:
    → "Oh really?\u0007Nice try, but you can't fool me that easily.\u007F1\u0000\u0007"
 71: 0x01E8 [0x23] WAIT_FOR_DIALOG_INTERACTION
 72: 0x01E9 [0x01] GOTO 0x01C3

SUBROUTINE_01EF:
 73: 0x01EF [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="ovl2", work_offset2=0*)
 74: 0x0200 [0x52] END_LOAD_SCHEDULER: End scheduler "y004" with entities [LocalPlayer, LocalPlayer], work=283*
 75: 0x020F [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y005", work_offset2=0*)
 ...
 81: 0x0235 [0x2B] Imutira (ID: 17588762/0x010C621A) [7333*]:
    → "For you to come all this way for such a thing, you'd have to either be part of the Seagull Phratrie or more adventurous than anyone I've ever met.\u007F1\u0000\u0007"
 82: 0x023C [0x23] WAIT_FOR_DIALOG_INTERACTION
 83: 0x023D [0x2B] Imutira (ID: 17588762/0x010C621A) [7334*]:
    → "Actually... I've been hiding something myself.\u007F1\u0000\u0007"
 84: 0x0244 [0x23] WAIT_FOR_DIALOG_INTERACTION
 85: 0x0245 [0x1C] WAIT(45* ticks)
 86: 0x0248 [0x2B] Imutira (ID: 17588762/0x010C621A) [7335*]:
    → "I never imagined I would meet a member of the Seagull Phratrie here in the West...\u007F1\u0000\u0007"
 ...
 90: 0x0262 [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y006", work_offset2=0*)
 91: 0x0273 [0x1C] WAIT(30* ticks)
 92: 0x0276 [0x2B] Imutira (ID: 17588762/0x010C621A) [7336*]:
    → "How is everyone doing...Captain Qultada, Zweeha, and the rest of the crew?\u007F1\u0000\u0007"
 ...
 96: 0x0288 [0x2B] Imutira (ID: 17588762/0x010C621A) [7337*]:
    → "You want to know why I know so much about the Phratrie, do you? Heh, I have my ways.\u007F1\u0000\u0007"
 97: 0x028F [0x23] WAIT_FOR_DIALOG_INTERACTION
 98: 0x0290 [0x2B] Imutira (ID: 17588762/0x010C621A) [7338*]:
    → "Anyway, this must mean that they've resumed activities...\u007F1\u0000\u0007"
...
102: 0x02A4 [0x2B] Imutira (ID: 17588762/0x010C621A) [7339*]:
    → "Oh yes... I went through a lot to find this \u0001\u00053\u0002\u0001\u0000\u0000, but I'll give it to you as thanks for helping me get out of here. Besides, the Seagull Phratrie and I go back quite a ways...\u007F1\u0000\u0007"
...
105: 0x02BB [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y007", work_offset2=0*)
106: 0x02CC [0x4A] LocalPlayer looks at Imutira (ID: 17588762/0x010C621A)
107: 0x02D5 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=19*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
108: 0x02E4 [0x2B] Imutira (ID: 17588762/0x010C621A) [7340*]:
    → "When you go back, could you tell Captain Qultada that his friend Imutira said hi?\u007F1\u0000\u0007"
109: 0x02EB [0x23] WAIT_FOR_DIALOG_INTERACTION
110: 0x02EC [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=19*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
111: 0x02FB [0x24] CREATE_DIALOG(message_id=7341*, default_option=0*, option_flags=0*)
    → "Agree to tell Qultada?\u0007\u000BI promise to tell him.\u0007What a pain...\u007F1\u0000\u0007"
...
115: 0x031A [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y008", work_offset2=0*)
116: 0x032B [0x1C] WAIT(60* ticks)
117: 0x032E [0x2B] Imutira (ID: 17588762/0x010C621A) [7343*]:
    → "Thank you. Perhaps the tides of fate will bring us together again...so until then.\u007F1\u0000\u0007"
...
121: 0x0340 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
122: 0x0351 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
...
126: 0x037A [0x2B] Imutira (ID: 17588762/0x010C621A) [7342*]:
    → "Don't say that... I'm just asking a small favor!\u007F1\u0000\u0007"
...
131: 0x0394 [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y009", work_offset2=0*)
132: 0x03A5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
...
137: 0x03C8 [0x2B] Imutira (ID: 17588762/0x010C621A) [7345*]:
    → "Spare me.\u0007I may have a decent lead, though.\u007F1\u0000\u0007"
...
144: 0x03F1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y010", work_offset2=0*)
145: 0x0402 [0x1C] WAIT(60* ticks)
146: 0x0405 [0x2B] Imutira (ID: 17588762/0x010C621A) [7347*]:
    → "Follow one of the workers, and eventually you'll end up at the queen bee. After that...it should be child's play.\u007F1\u0000\u0007"
...
149: 0x0410 [0x2B] Yazquhl (ID: 17588763/0x010C621B) [7348*]:
    → "You think so, do you? Only the most callous of women could betray her old friends... In that, you fit the bill.\u007F1\u0000\u0007"
...
156: 0x0435 [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y011", work_offset2=0*)
157: 0x0446 [0x1C] WAIT(60* ticks)
158: 0x0449 [0x2B] Yazquhl (ID: 17588763/0x010C621B) [7350*]:
    → "I've seen that \u007F\u0005[man/woman] somewhere before... Could \u007F\u0005[he/she] be the one who was at Talacca Cove?\u007F1\u0000\u0007"
...
161: 0x0460 [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y012", work_offset2=0*)
162: 0x0471 [0x2B] Imutira (ID: 17588762/0x010C621A) [7351*]:
    → "You've met \u007F\u0005[him/her] before?\u007F1\u0000\u0007"
163: 0x0478 [0x23] WAIT_FOR_DIALOG_INTERACTION
164: 0x0479 [0x2B] Yazquhl (ID: 17588763/0x010C621B) [7352*]:
    → "Maybe... You remember, right, Gowam?\u007F1\u0000\u0007"
...
168: 0x048D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="ovl2", work_offset2=0*)
169: 0x049E [0x52] END_LOAD_SCHEDULER: End scheduler "y012" with entities [LocalPlayer, LocalPlayer], work=283*
170: 0x04AD [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y014", work_offset2=0*)
...
173: 0x04D0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="y013", work_offset2=0*)
...
182: 0x0505 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
183: 0x0516 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
...
191: 0x0547 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
