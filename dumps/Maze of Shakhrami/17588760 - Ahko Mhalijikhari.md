...
- **7308**: Ah, you're here at last! Rrready and rrraring to perform your V.E.R.M.I.N. assignment?
- **7309**: Okay, here's the deal. Find and defeat the creatures that've been rrrunning amok down here, and then take the proof of their demise to Lumomo in Windurst.
- **7310**: We've prrrepared this special ointment to rub on your skin that will lure the creatures out of hiding.
- **7311**: Those buggerrrs have been spotted mostly around I-10. Shouldn't be too hard for you to get to.
- **7312**: The effect of the ointment lasts for about a day. If it wears off, or you want the effect rrremoved, just come back here and talk with me.
- **7313**: The ointment may have some interrresting...side effects. Rrready, tiger?
- **7314**: Apply the ointment? [Slap it on./Not rrright now...]
- **7315**: Oh? Lost your nerrrve? Talk to me if you change your mind.
- **7316**: Move along, adventurrrer.
- **7317**: Rrright, here we go! Close your eyes...
- **7318**: You want the effect rrremoved? Okay, just close your eyes...
- **7319**: How...lovely. A chunk of $3. Well, take it back to Lumomo. I'm sure she'll apprrreciate your efforts.
- **7320**: What do you want?
- **7321**: What do you desire? [Nothing./To have the ointment removed./To reconfirm where I'm going.]
...
```
  ...
  5: 0x0018 [0x1D] PRINT_EVENT_MESSAGE(message_id=7316*)
...
```
  ...
  4: 0x0045 [0x1D] PRINT_EVENT_MESSAGE(message_id=7308*)
  ...
  6: 0x0049 [0x1D] PRINT_EVENT_MESSAGE(message_id=7309*)
  ...
  8: 0x004D [0x1D] PRINT_EVENT_MESSAGE(message_id=7310*)
 ...
 10: 0x0051 [0x1D] PRINT_EVENT_MESSAGE(message_id=7311*)
 ...
 12: 0x0055 [0x1D] PRINT_EVENT_MESSAGE(message_id=7312*)
 ...
 14: 0x0059 [0x1D] PRINT_EVENT_MESSAGE(message_id=7313*)
    → "The ointment may have some interrresting...side effects. Rrready, tiger?"
 15: 0x005C [0x23] WAIT_FOR_DIALOG_INTERACTION
 16: 0x005D [0x24] CREATE_DIALOG(message_id=7314*, default_option=1*, option_flags=0*)
 ...
 22: 0x0072 [0x1D] PRINT_EVENT_MESSAGE(message_id=7317*)
 ...
 37: 0x00DC [0x1D] PRINT_EVENT_MESSAGE(message_id=7315*)
...
```
  ...
  7: 0x0117 [0x1D] PRINT_EVENT_MESSAGE(message_id=7317*)
    → "Rrright, here we go! Close your eyes..."
 ...
 16: 0x016C [0x1D] PRINT_EVENT_MESSAGE(message_id=7311*)
    → "Those buggerrrs have been spotted mostly around I-10. Shouldn't be too hard for you to get to."
 17: 0x016F [0x23] WAIT_FOR_DIALOG_INTERACTION
 18: 0x0170 [0x1D] PRINT_EVENT_MESSAGE(message_id=7312*)
    → "The effect of the ointment lasts for about a day. If it wears off, or you want the effect rrremoved, just come back here and talk with me."
...
```
  ...
  7: 0x01A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7320*)
    → "What do you want?"
  8: 0x01A5 [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x01A6 [0x24] CREATE_DIALOG(message_id=7321*, default_option=0*, option_flags=0*)
 ...
 16: 0x01D5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7318*)
 ...
 27: 0x022B [0x1D] PRINT_EVENT_MESSAGE(message_id=7311*)
    → "Those buggerrrs have been spotted mostly around I-10. Shouldn't be too hard for you to get to."
...
```
  ...
  6: 0x0266 [0x1D] PRINT_EVENT_MESSAGE(message_id=7319*)
