...
- **7309**: Ah, you're here at last! Rrready and rrraring to perform your V.E.R.M.I.N. assignment?
- **7310**: Okay, here's the deal. Find and defeat the creatures that've been rrrunning amok down here, and then take the proof of their demise to Lumomo in Windurst.
- **7311**: We've prrrepared this special ointment to rub on your skin that will lure the creatures out of hiding.
- **7312**: Those buggerrrs have been spotted mostly around I-10. Shouldn't be too hard for you to get to.
- **7313**: The effect of the ointment lasts for about a day. If it wears off, or you want the effect rrremoved, just come back here and talk with me.
- **7314**: The ointment may have some interrresting...side effects. Rrready, tiger?
- **7315**: Apply the ointment? [Slap it on./Not rrright now...]
- **7316**: Oh? Lost your nerrrve? Talk to me if you change your mind.
- **7317**: Move along, adventurrrer.
- **7318**: Rrright, here we go! Close your eyes...
- **7319**: You want the effect rrremoved? Okay, just close your eyes...
- **7320**: How...lovely. A chunk of $3. Well, take it back to Lumomo. I'm sure she'll apprrreciate your efforts.
- **7321**: What do you want?
- **7322**: What do you desire? [Nothing./To have the ointment removed./To reconfirm where I'm going.]
...
```
  ...
  5: 0x0018 [0x1D] PRINT_EVENT_MESSAGE(message_id=7317*)
...
```
  ...
  4: 0x0045 [0x1D] PRINT_EVENT_MESSAGE(message_id=7309*)
  ...
  6: 0x0049 [0x1D] PRINT_EVENT_MESSAGE(message_id=7310*)
  ...
  8: 0x004D [0x1D] PRINT_EVENT_MESSAGE(message_id=7311*)
 ...
 10: 0x0051 [0x1D] PRINT_EVENT_MESSAGE(message_id=7312*)
 ...
 12: 0x0055 [0x1D] PRINT_EVENT_MESSAGE(message_id=7313*)
 ...
 14: 0x0059 [0x1D] PRINT_EVENT_MESSAGE(message_id=7314*)
    → "The ointment may have some interrresting...side effects. Rrready, tiger?"
 15: 0x005C [0x23] WAIT_FOR_DIALOG_INTERACTION
 16: 0x005D [0x24] CREATE_DIALOG(message_id=7315*, default_option=1*, option_flags=0*)
 ...
 22: 0x0072 [0x1D] PRINT_EVENT_MESSAGE(message_id=7318*)
 ...
 37: 0x00DC [0x1D] PRINT_EVENT_MESSAGE(message_id=7316*)
...
```
  ...
  7: 0x0117 [0x1D] PRINT_EVENT_MESSAGE(message_id=7318*)
    → "Rrright, here we go! Close your eyes..."
 ...
 16: 0x016C [0x1D] PRINT_EVENT_MESSAGE(message_id=7312*)
    → "Those buggerrrs have been spotted mostly around I-10. Shouldn't be too hard for you to get to."
 17: 0x016F [0x23] WAIT_FOR_DIALOG_INTERACTION
 18: 0x0170 [0x1D] PRINT_EVENT_MESSAGE(message_id=7313*)
    → "The effect of the ointment lasts for about a day. If it wears off, or you want the effect rrremoved, just come back here and talk with me."
...
```
  ...
  7: 0x01A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7321*)
    → "What do you want?"
  8: 0x01A5 [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x01A6 [0x24] CREATE_DIALOG(message_id=7322*, default_option=0*, option_flags=0*)
 ...
 16: 0x01D5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7319*)
 ...
 27: 0x022B [0x1D] PRINT_EVENT_MESSAGE(message_id=7312*)
    → "Those buggerrrs have been spotted mostly around I-10. Shouldn't be too hard for you to get to."
...
```
  ...
  6: 0x0266 [0x1D] PRINT_EVENT_MESSAGE(message_id=7320*)
