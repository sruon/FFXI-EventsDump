...
```
  ...
  5: 0x0026 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=69*, entity1=Werei (ID: 17490295/0x010AE177), entity2=Werei (ID: 17490295/0x010AE177), action="sha0")
  6: 0x0035 [0x46] CAMERA_CONTROL: Disable user control
  7: 0x0037 [0x38] SET_CLIENT_EVENT_MODE(mode=19*)
  8: 0x003A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
  9: 0x004B [0x45] LOAD_SCHEDULED_TASK(work_offset1=218*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s003", work_offset2=0*)
...
SUBROUTINE_00DC:
 34: 0x00DC [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0x0000, entity1=LocalPlayer, entity2=LocalPlayer, action="sha0")
 35: 0x00EB [0x53] WAIT_SCHEDULER_TASK(entity1=LocalPlayer, entity2=LocalPlayer, action_id="sha0")
 36: 0x00F8 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0x0000, entity1=LocalPlayer, entity2=LocalPlayer, action="sir0")
 ...
 43: 0x0117 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who1", work_offset2=0*)
 44: 0x0128 [0x55] WAIT_LOAD_SCHEDULER(work_offset=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who1")
 45: 0x0137 [0x52] END_LOAD_SCHEDULER: End scheduler "s003" with entities [EventEntity, EventEntity], work=218*
 46: 0x0146 [0x45] LOAD_SCHEDULED_TASK(work_offset1=218*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s004", work_offset2=0*)
 47: 0x0157 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="whi1", work_offset2=0*)
 ...
 53: 0x017B [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who0", work_offset2=0*)
 54: 0x018C [0x55] WAIT_LOAD_SCHEDULER(work_offset=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who0")
 55: 0x019B [0x52] END_LOAD_SCHEDULER: End scheduler "s004" with entities [EventEntity, EventEntity], work=218*
 56: 0x01AA [0x45] LOAD_SCHEDULED_TASK(work_offset1=218*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s007", work_offset2=0*)
 ...
 66: 0x01F6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="whi1", work_offset2=0*)
 ...
 69: 0x0213 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who0", work_offset2=0*)
 70: 0x0224 [0x55] WAIT_LOAD_SCHEDULER(work_offset=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who0")
 71: 0x0233 [0x52] END_LOAD_SCHEDULER: End scheduler "s007" with entities [EventEntity, EventEntity], work=218*
 72: 0x0242 [0x45] LOAD_SCHEDULED_TASK(work_offset1=218*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s005", work_offset2=0*)
 73: 0x0253 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="whi1", work_offset2=0*)
 ...
 80: 0x027C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="ovl1", work_offset2=0*)
 81: 0x028D [0x52] END_LOAD_SCHEDULER: End scheduler "s005" with entities [EventEntity, EventEntity], work=218*
 82: 0x029C [0x45] LOAD_SCHEDULED_TASK(work_offset1=218*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s006", work_offset2=0*)
 ...
 88: 0x02C4 [0x55] WAIT_LOAD_SCHEDULER(work_offset=218*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s006")
 89: 0x02D3 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0x0000, entity1=LocalPlayer, entity2=LocalPlayer, action="sha1")
 90: 0x02E2 [0x5D] SET_MUSIC_VOLUME(volume=0*, fade_time=60*)
 91: 0x02E7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 96: 0x0305 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
