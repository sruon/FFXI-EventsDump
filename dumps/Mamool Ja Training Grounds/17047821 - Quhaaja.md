...
- **7558**: Do you want to give up?
- **7559**: End the mission? [Give up./Not yet.]
...
```
  ...
  1: 0x000E [0x1D] PRINT_EVENT_MESSAGE(message_id=7558*)
    → "Do you want to give up?"
  2: 0x0011 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0012 [0x24] CREATE_DIALOG(message_id=7559*, default_option=1*, option_flags=0*)
