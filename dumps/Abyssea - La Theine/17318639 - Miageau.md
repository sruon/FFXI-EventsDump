...
- **7997**: Welcome, friend, to the southeastern encampment. Stay a while and rest your travel-weary body and mind at this enclave of survivors.
- **7998**: Welcome, friend, to the southeastern encampment. I would proffer you drink to slake your thirst, but our water source--the four ponds of La Theine--has become contaminated ever since the Abyssean creatures appeared.
- **7999**: I have endeavored long to cleanse the ponds that the folk might have access to potable water, but this undertaking has proven far too onerous to be borne by a single man.
- **8000**: Might I entreat your cooperation in this endeavor, friend?
- **8001**: Offer Miageau your cooperation? [I surely will./Potable water is overrated.]
- **8002**: It grieves me to see that there are still those who choose not to part ways with their selfishness.
- **8003**: A noble soul such as yours is seldom seen in these dark times. Blessings be upon you.
- **8004**: I entrust to you these four vials of chemicals. Take them and empty the contents of one into each of the four ponds.
- **8005**: Having accomplished that, I ask you to draw water samples using the selfsame vials and thence bring them back to me. Go with blessed speed, friend.
- **8006**: I have awaited your return. I shall take the water samples off your hands.
- **8007**: Ah, 'twould appear that water quality has improved noticeably. You have done the surviving folk a great service, friend.
- **8008**: The coming of this cataclysm has shaken the people's faith. Many are those who believe that the world has been forsaken, but nothing could be further from the truth.
- **8009**: This is but a trial sent from the heavens that we must together overcome.
- **8010**: May Paradise open its gates to you.
- **8011**: Thank you for your assistance the day past, friend. Yet with the Abyssean creatures still running rampant, the ponds do not remain cleansed for long. Might I entreat your aid once more?
...
```
  ...
  3: 0x0015 [0x1D] PRINT_EVENT_MESSAGE(message_id=8004*)
  ...
  5: 0x0019 [0x1D] PRINT_EVENT_MESSAGE(message_id=8005*)
...
```
  ...
  5: 0x0029 [0x1D] PRINT_EVENT_MESSAGE(message_id=8006*)
 ...
 11: 0x0055 [0x1D] PRINT_EVENT_MESSAGE(message_id=8007*)
 ...
 13: 0x0059 [0x1D] PRINT_EVENT_MESSAGE(message_id=8008*)
 ...
 15: 0x005D [0x1D] PRINT_EVENT_MESSAGE(message_id=8009*)
 ...
 18: 0x0070 [0x1D] PRINT_EVENT_MESSAGE(message_id=8010*)
...
```
  ...
  9: 0x00B0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7998*)
 ...
 11: 0x00B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7999*)
 ...
 13: 0x00B8 [0x1D] PRINT_EVENT_MESSAGE(message_id=8000*)
    → "Might I entreat your cooperation in this endeavor, friend?"
 14: 0x00BB [0x23] WAIT_FOR_DIALOG_INTERACTION
 15: 0x00BC [0x24] CREATE_DIALOG(message_id=8001*, default_option=1*, option_flags=0*)
 ...
 19: 0x00CD [0x1D] PRINT_EVENT_MESSAGE(message_id=8003*)
 ...
 25: 0x00F9 [0x1D] PRINT_EVENT_MESSAGE(message_id=8004*)
    → "I entrust to you these four vials of chemicals. Take them and empty the contents of one into each of the four ponds."
 26: 0x00FC [0x23] WAIT_FOR_DIALOG_INTERACTION
 27: 0x00FD [0x1D] PRINT_EVENT_MESSAGE(message_id=8005*)
    → "Having accomplished that, I ask you to draw water samples using the selfsame vials and thence bring them back to me. Go with blessed speed, friend."
 ...
 32: 0x0111 [0x1D] PRINT_EVENT_MESSAGE(message_id=8002*)
 ...
 38: 0x0143 [0x1D] PRINT_EVENT_MESSAGE(message_id=8010*)
    → "May Paradise open its gates to you."
...
SUBROUTINE_015A:
 ...
 44: 0x015D [0x1D] PRINT_EVENT_MESSAGE(message_id=8011*)
 ...
 46: 0x0161 [0x24] CREATE_DIALOG(message_id=8001*, default_option=1*, option_flags=0*)
    → "Offer Miageau your cooperation? [I surely will./Potable water is overrated.]"
 47: 0x0168 [0x25] WAIT_DIALOG_SELECT()
 48: 0x0169 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x01AE
 49: 0x0171 [0x42] SET_CLI_EVENT_CANCEL_DATA()
 50: 0x0172 [0x1D] PRINT_EVENT_MESSAGE(message_id=8003*)
    → "A noble soul such as yours is seldom seen in these dark times. Blessings be upon you."
 ...
 56: 0x019E [0x1D] PRINT_EVENT_MESSAGE(message_id=8004*)
    → "I entrust to you these four vials of chemicals. Take them and empty the contents of one into each of the four ponds."
 57: 0x01A1 [0x23] WAIT_FOR_DIALOG_INTERACTION
 58: 0x01A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=8005*)
    → "Having accomplished that, I ask you to draw water samples using the selfsame vials and thence bring them back to me. Go with blessed speed, friend."
 ...
 63: 0x01B6 [0x1D] PRINT_EVENT_MESSAGE(message_id=8002*)
    → "It grieves me to see that there are still those who choose not to part ways with their selfishness."
 ...
 69: 0x01E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=8010*)
    → "May Paradise open its gates to you."
...
```
  ...
  4: 0x0217 [0x1D] PRINT_EVENT_MESSAGE(message_id=8008*)
    → "The coming of this cataclysm has shaken the people's faith. Many are those who believe that the world has been forsaken, but nothing could be further from the truth."
  5: 0x021A [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x021B [0x1D] PRINT_EVENT_MESSAGE(message_id=8009*)
    → "This is but a trial sent from the heavens that we must together overcome."
 ...
 12: 0x024D [0x1D] PRINT_EVENT_MESSAGE(message_id=8010*)
    → "May Paradise open its gates to you."
