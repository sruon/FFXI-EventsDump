...
- **7963**: Hm? An outsider, are we? I've no time to waste on one who's yet to earn my trust. Begone with you.
- **7964**: Ah, you must be the newcomer folk've been bending my ears about. I am Fontoumant. Before this evil engulfed us, I had a respected post overseeing the Consortium's warehouses.
- **7965**: But that and more were taken away from me, and I have those Abyssean fiends to thank for it.
- **7966**: My smoldering desire to exact revenge upon the vile creatures is all that drives me now. I spend my days devising ways to exterminate them, and painfully. Such is my joy.
- **7967**: I had a suspicion that the creatures' appearance was connected to the increase in seismic activity, and the research I subsequently conducted lent credence to this theory.
- **7968**: The fiends surge out from fissures--wounds on the earth's surface--that have opened up in ravines after tremors, I'm sure of it. I've a mind to delve deeper into this, but I require the assistance of one with a stout heart and a strong back.
- **7969**: Assist with the research? [I'm at your disposal!/I've prior, less dangerous engagements.]
- **7970**: Ach, just like the yearlings I get every day, you are. Away with you until you're willing to assist my research!
- **7971**: That's the spirit! There may be some hope for your generation yet. Now, let us dispense with the pleasantries as every moment spent in idleness could mean another score of demons being spawned into our midst.
- **7972**: I have created anti-Abyssean grenades, and I would have you test them out at three newly opened fissures. The first is a stone's throw away from this encampment, and the second and third are located in the ravine west of here.
- **7973**: In short, you are to take the grenades and cast one into each fissure. Remarkably straightforward, wouldn't you say so?
- **7974**: The findings will avail us only if the experiment is conducted periodically, however, so I would thank you for your continued assistance. Now, off you go then!
- **7975**: Hm? Forgotten the fissure locations, have you? The first is a stone's throw away from this encampment, and the second and third are located in the ravine west of here.
- **7976**: Ah, you're back. I trust the task posed no difficulties. Take this as recompense for your troubles, and seek me here whenever you wish to assist further in my research.
- **7977**: Ah, it's you again. Very kind of you to show, but I've yet to finish readying another set of grenades. Return here in a while, if you would.
- **7978**: Ah, it's you again. The research continues to yield useful data, in no small part thanks to you. I've just finished readying a new set of grenades. Might I prevail upon you to assist me again?
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=7963*)
...
```
  ...
  4: 0x0033 [0x1D] PRINT_EVENT_MESSAGE(message_id=7975*)
  ...
  6: 0x0037 [0x1D] PRINT_EVENT_MESSAGE(message_id=7972*)
  ...
  8: 0x003B [0x1D] PRINT_EVENT_MESSAGE(message_id=7974*)
...
```
  ...
  5: 0x004B [0x1D] PRINT_EVENT_MESSAGE(message_id=7976*)
...
```
  ...
  9: 0x009D [0x1D] PRINT_EVENT_MESSAGE(message_id=7964*)
 ...
 11: 0x00A1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7965*)
 ...
 13: 0x00A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7966*)
 ...
 15: 0x00A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7967*)
 ...
 17: 0x00AD [0x1D] PRINT_EVENT_MESSAGE(message_id=7968*)
 ...
 19: 0x00B1 [0x24] CREATE_DIALOG(message_id=7969*, default_option=1*, option_flags=0*)
 ...
 23: 0x00C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7971*)
 ...
 26: 0x00CB [0x1D] PRINT_EVENT_MESSAGE(message_id=7972*)
    → "I have created anti-Abyssean grenades, and I would have you test them out at three newly opened fissures. The first is a stone's throw away from this encampment, and the second and third are located in the ravine west of here."
 27: 0x00CE [0x23] WAIT_FOR_DIALOG_INTERACTION
 28: 0x00CF [0x1D] PRINT_EVENT_MESSAGE(message_id=7973*)
 ...
 30: 0x00D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7974*)
    → "The findings will avail us only if the experiment is conducted periodically, however, so I would thank you for your continued assistance. Now, off you go then!"
 ...
 35: 0x00E7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7970*)
...
SUBROUTINE_00EE:
 ...
 39: 0x00F1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7978*)
 ...
 41: 0x00F5 [0x24] CREATE_DIALOG(message_id=7969*, default_option=1*, option_flags=0*)
    → "Assist with the research? [I'm at your disposal!/I've prior, less dangerous engagements.]"
 42: 0x00FC [0x25] WAIT_DIALOG_SELECT()
 43: 0x00FD [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0123
 44: 0x0105 [0x42] SET_CLI_EVENT_CANCEL_DATA()
 45: 0x0106 [0x1D] PRINT_EVENT_MESSAGE(message_id=7971*)
    → "That's the spirit! There may be some hope for your generation yet. Now, let us dispense with the pleasantries as every moment spent in idleness could mean another score of demons being spawned into our midst."
 46: 0x0109 [0x23] WAIT_FOR_DIALOG_INTERACTION
 47: 0x010A [0x03] Work_Zone[2] = 2608*
 48: 0x010F [0x1D] PRINT_EVENT_MESSAGE(message_id=7972*)
    → "I have created anti-Abyssean grenades, and I would have you test them out at three newly opened fissures. The first is a stone's throw away from this encampment, and the second and third are located in the ravine west of here."
 49: 0x0112 [0x23] WAIT_FOR_DIALOG_INTERACTION
 50: 0x0113 [0x1D] PRINT_EVENT_MESSAGE(message_id=7973*)
    → "In short, you are to take the grenades and cast one into each fissure. Remarkably straightforward, wouldn't you say so?"
 51: 0x0116 [0x23] WAIT_FOR_DIALOG_INTERACTION
 52: 0x0117 [0x1D] PRINT_EVENT_MESSAGE(message_id=7974*)
    → "The findings will avail us only if the experiment is conducted periodically, however, so I would thank you for your continued assistance. Now, off you go then!"
 ...
 57: 0x012B [0x1D] PRINT_EVENT_MESSAGE(message_id=7970*)
    → "Ach, just like the yearlings I get every day, you are. Away with you until you're willing to assist my research!"
...
```
  ...
  4: 0x014A [0x1D] PRINT_EVENT_MESSAGE(message_id=7977*)
