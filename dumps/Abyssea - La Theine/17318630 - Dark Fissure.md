...
- **7980**: You see an ominous fissure on the ravine floor...
- **7981**: Cast $3 into it? [Attack the darkness!/Not just yet.]
- **7982**: <Player> casts $3 into the fissure.
...
SUBROUTINE_0036:
 ...
 12: 0x0039 [0x48] [System] [7980*]:
    → "You see an ominous fissure on the ravine floor..."
 13: 0x003C [0x23] WAIT_FOR_DIALOG_INTERACTION
 14: 0x003D [0x24] CREATE_DIALOG(message_id=7981*, default_option=1*, option_flags=0*)
