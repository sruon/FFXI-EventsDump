...
SUBROUTINE_0067:
 23: 0x0067 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x0075
 24: 0x006F [0x01] GOTO 0x00EC

SUBROUTINE_0075:
 25: 0x0075 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 26: 0x0086 [0x1C] WAIT(60* ticks)
 27: 0x0089 [0x02] IF !(ExtData[1]->WorkLocal[0] == 1*) GOTO 0x009C
 28: 0x0091 [0x48] [System] [8013*]:
    → "\u001F\u000F\u0008 empties \u0001\u00056\u0002\u0000\u0000\u0000 into the pond.\u0000\u0007"
 29: 0x0094 [0x03] Work_Zone[1] = 1*
 30: 0x0099 [0x01] GOTO 0x00D5

SUBROUTINE_009C:
 31: 0x009C [0x02] IF !(ExtData[1]->WorkLocal[0] == 2*) GOTO 0x00AF
 32: 0x00A4 [0x48] [System] [8013*]:
    → "\u001F\u000F\u0008 empties \u0001\u00056\u0002\u0000\u0000\u0000 into the pond.\u0000\u0007"
 33: 0x00A7 [0x03] Work_Zone[1] = 2*
 34: 0x00AC [0x01] GOTO 0x00D5

SUBROUTINE_00AF:
 35: 0x00AF [0x02] IF !(ExtData[1]->WorkLocal[0] == 3*) GOTO 0x00C2
 36: 0x00B7 [0x48] [System] [8013*]:
    → "\u001F\u000F\u0008 empties \u0001\u00056\u0002\u0000\u0000\u0000 into the pond.\u0000\u0007"
 37: 0x00BA [0x03] Work_Zone[1] = 3*
 38: 0x00BF [0x01] GOTO 0x00D5

SUBROUTINE_00C2:
 39: 0x00C2 [0x02] IF !(ExtData[1]->WorkLocal[0] == 4*) GOTO 0x00D5
 40: 0x00CA [0x48] [System] [8013*]:
    → "\u001F\u000F\u0008 empties \u0001\u00056\u0002\u0000\u0000\u0000 into the pond.\u0000\u0007"
 41: 0x00CD [0x03] Work_Zone[1] = 4*
 42: 0x00D2 [0x01] GOTO 0x00D5

SUBROUTINE_00D5:
 43: 0x00D5 [0x1C] WAIT(120* ticks)
 44: 0x00D8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 45: 0x00E9 [0x1C] WAIT(90* ticks)
 46: 0x00EC [0x20] SET_CLI_EVENT_UC_FLAG: Unlock player control
 47: 0x00EE [0x21] END_EVENT
 48: 0x00EF [0x00] END_REQSTACK()
```
