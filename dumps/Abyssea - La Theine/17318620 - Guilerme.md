...
- **7806**: Current progress: [Ancient abyssite obtained: $0/$1/Atma obtained: $2/$3/Quests completed: $4/$5/Return.]
- **7807**: [Requirement/Objective completed]: Obtain all ancient abyssite found in this area.
- **7808**: [Requirement/Objective completed]: Obtain all atma found in this area.
- **7809**: [Requirement/Objective completed]: Complete all quests issued in this area.
- **7846**: Behold the meticulously maintained record of your exploits! Your progress for this area's objectives is thus:
- **7847**: 'Tis my pleasure to confirm the completion of this objective! Huzzah!
- **7848**: My word! You've completed all the objectives in this area! Truly exceptional!
- **7849**: 'Tis my utmost pleasure to proffer you this as a small gesture of our appreciation for your efforts.
- **7850**: Fare you well on your journeys upon this wasteland of death.
...
# Dead code (unreachable instructions):
     ...
     0x0035 [0x24] CREATE_DIALOG(message_id=7806*, default_option=0*, option_flags=0*)
...
```
  ...
  3: 0x00D0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7846*)
  ...
  6: 0x00D7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7850*)
...
```
  ...
  6: 0x00EC [0x1D] PRINT_EVENT_MESSAGE(message_id=7846*)
    → "Behold the meticulously maintained record of your exploits! Your progress for this area's objectives is thus:"
  7: 0x00EF [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x00F0 [0x02] IF !(ExtData[1]->WorkLocal[7] == 1*) GOTO 0x00FF
  9: 0x00F8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7847*)
 ...
 13: 0x0107 [0x1D] PRINT_EVENT_MESSAGE(message_id=7848*)
...
SUBROUTINE_010E:
 16: 0x010E [0x1D] PRINT_EVENT_MESSAGE(message_id=7849*)
 ...
 18: 0x0112 [0x1D] PRINT_EVENT_MESSAGE(message_id=7850*)
    → "Fare you well on your journeys upon this wasteland of death."
