...
- **7116**: Select Fish Type: [Saltwater./Freshwater./Item./Flag./Treasure Chest./Monster.]
- **7117**: Select one [$0i$0j./$1i$1j./$2$3041793/$3i$3j./$4i$4j./$5i$5j./$6i$6j./$7i$7j./Next.]
- **7128**: Select. [Set./$3: [ON/OFF]./$3: [ON/OFF]./$3: [ON/OFF]./$3: [ON/OFF].]
...
```
  ...
  1: 0x0004 [0x24] CREATE_DIALOG(message_id=7116*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00A4:
 ...
 42: 0x00A7 [0x24] CREATE_DIALOG(message_id=7117*, default_option=0*, option_flags=0*)
...
100: 0x01BD [0x24] CREATE_DIALOG(message_id=7128*, default_option=0*, option_flags=0*)
