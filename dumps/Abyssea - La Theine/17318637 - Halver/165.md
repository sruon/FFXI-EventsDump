...
```
  ...
  9: 0x0039 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=20*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
...
SUBROUTINE_006E:
 19: 0x006E [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x0080
 20: 0x0076 [0x1D] PRINT_EVENT_MESSAGE(message_id=8051*)
    → "Hmph. It appears the tales of your valor were unfounded.\u007F1\u0000\u0007"
 21: 0x0079 [0x23] WAIT_FOR_DIALOG_INTERACTION
 22: 0x007A [0x01] GOTO 0x00D4

SUBROUTINE_0080:
 23: 0x0080 [0x24] CREATE_DIALOG(message_id=8053*, default_option=1*, option_flags=0*)
    → "Do you know Curilla?\u0007\u000BI surely do.\u0007Cura...who?\u007F1\u0000\u0007"
 24: 0x0087 [0x25] WAIT_DIALOG_SELECT()
 25: 0x0088 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0096
 26: 0x0090 [0x01] GOTO 0x00A4

SUBROUTINE_0096:
 27: 0x0096 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x00A4
 28: 0x009E [0x01] GOTO 0x00A4

SUBROUTINE_00A4:
 29: 0x00A4 [0x03] Work_Zone[1] = 1*
 30: 0x00A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=8054*)
    → "To call her the stone upon which San d'Oria's proud order of Temple Knights is built would be no exaggeration.\u007F1\u0000\u0007"
 31: 0x00AC [0x23] WAIT_FOR_DIALOG_INTERACTION
 32: 0x00AD [0x1D] PRINT_EVENT_MESSAGE(message_id=8055*)
 ...
 34: 0x00B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=8056*)
 ...
 36: 0x00B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=8057*)
 ...
 37: 0x00B8 [0x23] WAIT_FOR_DIALOG_INTERACTION
 38: 0x00B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=8058*)
 ...
 40: 0x00BD [0x1D] PRINT_EVENT_MESSAGE(message_id=8059*)
 ...
 42: 0x00C1 [0x1D] PRINT_EVENT_MESSAGE(message_id=8060*)
...
\u0001 \u0001	)\u0002\u0001\u0000\u0000\u0002\u0000\u0000\u0000 are required to concoct the medicine.\u007F1\u0000\u0007"
 ...
 48: 0x00CD [0x01] GOTO 0x00D4

SUBROUTINE_00D0:
 49: 0x00D0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8066*)
 ...
 50: 0x00D3 [0x23] WAIT_FOR_DIALOG_INTERACTION
