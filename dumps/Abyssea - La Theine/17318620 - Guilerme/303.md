...
```
  ...
  9: 0x00F8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7843*)
    → "'Tis my pleasure to confirm the completion of this objective! Huzzah!\u007F1\u0000\u0007"
...
SUBROUTINE_00FF:
 ...
 13: 0x0107 [0x1D] PRINT_EVENT_MESSAGE(message_id=7844*)
    → "My word! You've completed all the objectives in this area! Truly exceptional!\u007F1\u0000\u0007"
 14: 0x010A [0x23] WAIT_FOR_DIALOG_INTERACTION
 15: 0x010B [0x01] GOTO 0x010E

SUBROUTINE_010E:
 16: 0x010E [0x1D] PRINT_EVENT_MESSAGE(message_id=7845*)
    → "'Tis my utmost pleasure to proffer you this as a small gesture of our appreciation for your efforts.\u007F1\u0000\u0007"
