...
```
  ...
  1: 0x0006 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=7*, source=Work_Zone[3], result=ExtData[1]->WorkLocal[1])
  2: 0x000F [0x41] GET_BIT_WORK_RANGE(start_bit=8*, end_bit=23*, source=Work_Zone[3], result=ExtData[1]->WorkLocal[2])
  3: 0x0018 [0x41] GET_BIT_WORK_RANGE(start_bit=24*, end_bit=31*, source=Work_Zone[3], result=ExtData[1]->WorkLocal[3])
