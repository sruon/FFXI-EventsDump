...
- **11542**: 
- **11543**: You are assaulted by an uncanny sensation.
- **11544**: The arcane energies begin to course within your veins.
- **11545**: You feel a mystical warmth welling up inside you!
...
```
 ...
 30: 0x0086 [0xAD] DUAL_ENTITY_SCHEDULER_HANDLER: Execute sub-case 0 with entities [Geomantic Reservoir (ID: 17236372/0x01070194), LocalPlayer], work=ExtData[1]->WorkLocal[2]
