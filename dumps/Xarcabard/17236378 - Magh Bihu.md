...
| [62](#event-62)            | 0x010D       |      7 |              2 |
| [65535.19](#event-6553519) | 0x0114       |     15 |              5 |
| [65535.20](#event-6553520) | 0x0123       |     15 |              5 |
| [63](#event-63)            | 0x0132       |      7 |              2 |
| [65535.21](#event-6553521) | 0x0139       |     22 |              8 |
| [65535.22](#event-6553522) | 0x014F       |     32 |             10 |
| [65](#event-65)            | 0x016F       |      7 |              2 |
| [65535.23](#event-6553523) | 0x0176       |      5 |              2 |
| [65535.24](#event-6553524) | 0x017B       |      5 |              2 |
| [66](#event-66)            | 0x0180       |      7 |              2 |
| [65535.25](#event-6553525) | 0x0187       |     15 |              5 |
| [67](#event-67)            | 0x0196       |      7 |              2 |
| [65535.26](#event-6553526) | 0x019D       |     15 |              5 |
| [65535.27](#event-6553527) | 0x01AC       |     22 |              8 |
| [65535.28](#event-6553528) | 0x01C2       |     15 |              5 |
| [65535.29](#event-6553529) | 0x01D1       |     15 |              5 |
...
```
  ...
  1: 0x0117 [0x1F] MOVE_ENTITY: EventEntity moves to X=562.724*, Z=-281.001*, Y=0.000*
...
0140: 09 80 04 80 1F 01 6F 1E  F0 FF FF 7F 6F 70 00     ......o.....op. 
```
...
```
  ...
  1: 0x013C [0x1F] MOVE_ENTITY: EventEntity moves to X=557.140*, Z=-282.633*, Y=0.000*
  2: 0x0144 [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x0146 [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
  4: 0x0147 [0x1E] EventEntity looks at LocalPlayer and starts talking
  5: 0x014C [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
  6: 0x014D [0x70] WAIT_ENTITY_RENDER_FLAG: Wait while EventEntity->Render.Flags3 bit 2 is set (cancel turn if not)
...
0160: 0E 80 04 80 1F 01 6F 1E  9C 01 07 01 6F 70 00     ......o.....op. 
```
...
```
  ...
  6: 0x0167 [0x1E] EventEntity looks at Duke Alloces (ID: 17236380/0x0107019C) and starts talking
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0160:                                               92                 .
0170: 01 F8 FF FF 7F 00                                 ......          
```

#### Opcodes

```
  0: 0x016F [0x92] EventEntity->Render.Flags3 ^= 0x01
...
```
  0: 0x0176 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Hair style, value=2808*)
...
```
  0: 0x017B [0xB6] ENTITY_APPEARANCE_HANDLER(case=Hair style, value=3158*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0180:                      32  01 80 1F 00 02 80 03 80         2........
0190: 04 80 1F 01 6F 00                                 ....o.          
```
...
```
  ...
  1: 0x018A [0x1F] MOVE_ENTITY: EventEntity moves to X=562.724*, Z=-281.001*, Y=0.000*
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
01A0:                                      32 01 80 1F              2...
01B0: 00 14 80 15 80 04 80 1F  01 6F 1E 9C 01 07 01 6F  .........o.....o
01C0: 70 00                                             p.              
```
...
```
  ...
  4: 0x01BA [0x1E] EventEntity looks at Duke Alloces (ID: 17236380/0x0107019C) and starts talking
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
01D0:    32 01 80 1F 00 18 80  19 80 04 80 1F 01 6F 00   2............o.
```
...
```
  ...
  1: 0x01D4 [0x1F] MOVE_ENTITY: EventEntity moves to X=575.252*, Z=-265.407*, Y=0.000*
