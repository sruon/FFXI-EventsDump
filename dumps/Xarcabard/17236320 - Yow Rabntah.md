...
|---------|-------------|-------------|
|       0 | 0x000D      |          13 |
|       1 | 0xFFFC19BD  |  4294711741 |
|       2 | 0xE03C      |       57404 |
|       3 | 0x03C8      |         968 |
|       4 | 0xFFFC1521  |  4294710561 |
|       5 | 0xE5F3      |       58867 |
|       6 | 0x03B4      |         948 |
...
```
  ...
  1: 0x000B [0x1F] MOVE_ENTITY: EventEntity moves to X=-255.555*, Z=57.404*, Y=0.968*
  2: 0x0013 [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x0015 [0x1F] MOVE_ENTITY: EventEntity moves to X=-256.735*, Z=58.867*, Y=0.948*
