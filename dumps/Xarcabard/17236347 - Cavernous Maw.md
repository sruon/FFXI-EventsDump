...
- **7263**: An unseen force is drawing you towards the maw.
- **7264**: Warp to Abyssea - [Dummy/La Theine/Konschtat/Tahrongi/Attohwa/Misareaux/Vunkerl/Altepa/Grauberg/Uleguerand]? [Proceed./Not yet.]
...
```
  ...
  4: 0x000C [0x24] CREATE_DIALOG(message_id=7264*, default_option=1*, option_flags=0*)
