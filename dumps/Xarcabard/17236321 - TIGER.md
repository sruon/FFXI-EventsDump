...
|---------|-------------|-------------|
|       0 | 0x0030      |          48 |
|       1 | 0xFFFB80B7  |  4294672567 |
|       2 | 0x23872     |      145522 |
|       3 | 0xFFFFA679  |  4294944377 |
...
```
  0: 0x0008 [0x32] ExtData[1]->MainSpeed = 48* * 0.1
  1: 0x000B [0x1F] MOVE_ENTITY: EventEntity moves to X=-294.729*, Z=145.522*, Y=-22.919*
