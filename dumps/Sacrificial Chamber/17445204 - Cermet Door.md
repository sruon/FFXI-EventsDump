...
| [7](#event-7)            | 0x0044       |     15 |              4 |
| [65535.7](#event-655357) | 0x0053       |      2 |              2 |
| [65535.8](#event-655358) | 0x0055       |      2 |              2 |
...
```
  0: 0x0053 [0x4C] EventEntity->StatusEvent = 8 // Open door
...
```
  0: 0x0055 [0x4D] EventEntity->StatusEvent = 9 // Close door
