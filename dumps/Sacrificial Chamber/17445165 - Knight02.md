...
| [65535.8](#event-655358) | 0x005E       |     19 |              3 |
...
|       2 | 0x0080      |         128 |
|       3 | 0x007F      |         127 |
|       4 | 0xFFFA3857  |  4294588503 |
|       5 | 0x1E21      |        7713 |
|       6 | 0xFFFDCDF2  |  4294823410 |
|       7 | 0x0687      |        1671 |
|       8 | 0x1018      |        4120 |
|       9 | 0x9C0C      |       39948 |
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0040:             92 01 2D 31  0A 01 00                     ..-1...     
```

#### Opcodes

```
  0: 0x0044 [0x92] Knight02 (ID: 17445165/0x010A312D)->Render.Flags3 ^= 0x01
...
```
  ...
  1: 0x0054 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-378.793*, z=7.713*, y=-143.886*, direction=146.9°*
