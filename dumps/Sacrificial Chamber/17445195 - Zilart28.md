...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0040:             92 01 4B 31  0A 01 00                     ..K1...     
```

#### Opcodes

```
  0: 0x0044 [0x92] Zilart28 (ID: 17445195/0x010A314B)->Render.Flags3 ^= 0x01
...
```
  0: 0x004B [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=157.460*, z=-115.443*, y=16.092*, direction=214.2°*
...
```
  0: 0x0055 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=157.460*, z=-115.443*, y=16.092*, direction=214.2°*
