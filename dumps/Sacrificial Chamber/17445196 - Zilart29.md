...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0040:             92 01 4C 31  0A 01 00                     ..L1...     
```

#### Opcodes

```
  0: 0x0044 [0x92] Zilart29 (ID: 17445196/0x010A314C)->Render.Flags3 ^= 0x01
...
```
  0: 0x004B [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=169.871*, z=-115.889*, y=16.228*, direction=185.4°*
...
```
  0: 0x0055 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=169.871*, z=-115.889*, y=16.228*, direction=185.4°*
