...
- **7270**: The tome contains the symphonic scores for a veritable host of rousing battle fanfares.
- **7271**: Select a new battle fanfare? [Not now./Belief./Fighters of the Crystal./Conflict: March of the Hero./The Colosseum./Run Maggot, Run!/Iron Colossus./Ragnarok./Feast of the Ladies./Random selection./Restore default./@]
- **7272**: Fight to this fanfare? [Yes./No, select another.]
...
```
  ...
  6: 0x001A [0x24] CREATE_DIALOG(message_id=7271*, default_option=ExtData[1]->WorkLocal[0], option_flags=ExtData[1]->WorkLocal[3])
...
SUBROUTINE_006B:
 ...
 28: 0x0084 [0x24] CREATE_DIALOG(message_id=7272*, default_option=0*, option_flags=0*)
