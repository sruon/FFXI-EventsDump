...
| [44](#event-44)       | 0x0001       |     54 |             11 |
| [36](#event-36)       | 0x0037       |    154 |             27 |
| [40](#event-40)       | 0x00D1       |     62 |             13 |
...
```
  ...
  5: 0x0027 [0x2B] Zedduva (ID: 17784853/0x010F6015) [7092*]:
...
0050: 15 60 0F 01 F0 FF FF 7F  2B 15 60 0F 01 04 80 23  .`......+.`....#
0060: 24 05 80 06 80 07 80 25  02 00 10 07 80 00 C9 00  $......%........
0070: 42 27 0A F0 FF FF 7F 15  46 01 4C 45 08 80 F0 FF  B'......F.LE....
0080: FF 7F F0 FF FF 7F 63 6D  35 32 07 80 2A 0A F0 FF  ......cm52..*...
...
```
  ...
  4: 0x0058 [0x2B] Zedduva (ID: 17784853/0x010F6015) [7094*]:
 ...
 10: 0x0071 [0x27] REQ_SET(priority=0x0A, entity_id=LocalPlayer, tag_num=0x15)
 11: 0x0078 [0x46] CAMERA_CONTROL: Disable user control
 12: 0x007A [0x4C] EventEntity->StatusEvent = 8 // Open door
 13: 0x007B [0x45] LOAD_SCHEDULED_TASK: Load scheduler "cm52" with entities [LocalPlayer, LocalPlayer], work=[146*, 0*]
 ...
 18: 0x00A7 [0x47] UPDATE_PLAYER_POS(-61.059*, -59.272*, 8.001*, yaw=98.2°*)
...
00E0: 80 02 F8 00 4A 15 60 0F  01 F0 FF FF 7F 2B 15 60  ....J.`......+.`
00F0: 0F 01 0E 80 23 01 FB 00  1A FD 00 21 00 4A 14 60  ....#......!.J.`
0100: 0F 01 F0 FF FF 7F 2B 14  60 0F 01 0F 80 23 1B     ......+.`....#. 
```
...
```
  ...
  3: 0x00ED [0x2B] Zedduva (ID: 17784853/0x010F6015) [7112*]:
...
SUBROUTINE_00FD:
 ...
 10: 0x0106 [0x2B] Gatita (ID: 17784852/0x010F6014) [7093*]:
