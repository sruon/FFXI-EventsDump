...
- **9488**: Welcome to the ammunition retrieval service.
- **9489**: I'm pleased to announce that we've come up with a way for you to retrieve specific ammunition storage items that you may have previously lost--but one time only!
- **9490**: If you want to retrieve one of said items, all you need to do is trade me the corresponding weapon.
- **9491**: Please keep in mind that this is a one-time-only service per weapon. There will be no second retrieval process available.
- **9492**: Please note that this system is specific to the ammunition storage items, and you will not be able to retrieve a discarded weapon itself.
- **9493**: Any questions? [Tell me about the service./What weapons are applicable?/What do I do if I've lost it?/Back.]
- **9494**: I have compiled all applicable weapons into one list. If it's not on the list, I cannot help you.
- **9496**: The $8 is related to the $9.
- **9497**: If you wish to retrieve your $8, trade me your $9.
- **9498**: Before I forget, I would like to remind you that you have the Recycle Bin feature.
- **9499**: Do you know this feature? [The one in the Items menu?/The one on my desktop?/No clue.]
- **9500**: That's right. Make sure to check there if you accidentally discard something you didn't mean to.
- **9501**: I suppose an explanation is in order.
- **9502**: If you accidentally discard something you didn't mean to, stay calm and open up the Items submenu from the main menu.
- **9503**: At the top right is an entry for the Recycle Bin. You can retrieve your accidentally discarded item from there.
- **9504**: Up to ten items you have discarded while in your current area are stored in the bin.
- **9505**: If you throw away 11 or more items, the oldest ones are deleted first. The bin is also emptied when you log out or change areas.
- **9506**: If you make a mistake, don't panic. Check the bin first!
- **9507**: Hopefully this will help you avoid any accidents in the future!
- **9508**: You want to retrieve the item associated with this weapon? Let me take a look.
- **9509**: Hmm. The item associated with this weapon is the $0.
- **9510**: But you've already retrieved the item once before, so I cannot help you again.
- **9511**: Hang on...I think you've got that item located in a storage system somewhere. Take a good look.
- **9512**: I'm sorry. My services don't apply to that item.
- **9513**: This will be your one and only retrieval of your $0. Are you sure?
- **9514**: Retrieve your $0? [Yes./No.]
- **9515**: Here you are. Make sure not to lose it again!
- **9516**: Understood. Let me know if you change your mind.
...
```
 ...
 12: 0x0037 [0x1D] PRINT_EVENT_MESSAGE(message_id=9488*)
 ...
 16: 0x0048 [0x24] CREATE_DIALOG(message_id=9493*, default_option=ExtData[1]->WorkLocal[11], option_flags=0*)
 ...
 20: 0x005D [0x1D] PRINT_EVENT_MESSAGE(message_id=9489*)
 ...
 22: 0x0061 [0x1D] PRINT_EVENT_MESSAGE(message_id=9490*)
 ...
 24: 0x0065 [0x1D] PRINT_EVENT_MESSAGE(message_id=9491*)
 ...
 26: 0x0069 [0x1D] PRINT_EVENT_MESSAGE(message_id=9492*)
 ...
 31: 0x007D [0x1D] PRINT_EVENT_MESSAGE(message_id=9494*)
...
SUBROUTINE_0084:
 ...
 41: 0x00AD [0x1D] PRINT_EVENT_MESSAGE(message_id=9496*)
 ...
 44: 0x00B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=9497*)
 ...
 52: 0x00D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=9496*)
    → "The $8 is related to the $9."
 53: 0x00D6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 54: 0x00D7 [0x93] DISPLAY_ITEM_INFO(item_id=Work_Zone_1700[1])
 55: 0x00DA [0x1D] PRINT_EVENT_MESSAGE(message_id=9497*)
    → "If you wish to retrieve your $8, trade me your $9."
 ...
 63: 0x00F9 [0x1D] PRINT_EVENT_MESSAGE(message_id=9496*)
    → "The $8 is related to the $9."
 64: 0x00FC [0x23] WAIT_FOR_DIALOG_INTERACTION
 65: 0x00FD [0x93] DISPLAY_ITEM_INFO(item_id=Work_Zone_1700[1])
 66: 0x0100 [0x1D] PRINT_EVENT_MESSAGE(message_id=9497*)
    → "If you wish to retrieve your $8, trade me your $9."
 ...
 74: 0x011F [0x1D] PRINT_EVENT_MESSAGE(message_id=9496*)
    → "The $8 is related to the $9."
 75: 0x0122 [0x23] WAIT_FOR_DIALOG_INTERACTION
 76: 0x0123 [0x93] DISPLAY_ITEM_INFO(item_id=Work_Zone_1700[1])
 77: 0x0126 [0x1D] PRINT_EVENT_MESSAGE(message_id=9497*)
    → "If you wish to retrieve your $8, trade me your $9."
 ...
 85: 0x0145 [0x1D] PRINT_EVENT_MESSAGE(message_id=9496*)
    → "The $8 is related to the $9."
 86: 0x0148 [0x23] WAIT_FOR_DIALOG_INTERACTION
 87: 0x0149 [0x93] DISPLAY_ITEM_INFO(item_id=Work_Zone_1700[1])
 88: 0x014C [0x1D] PRINT_EVENT_MESSAGE(message_id=9497*)
    → "If you wish to retrieve your $8, trade me your $9."
 ...
 96: 0x016B [0x1D] PRINT_EVENT_MESSAGE(message_id=9496*)
    → "The $8 is related to the $9."
 97: 0x016E [0x23] WAIT_FOR_DIALOG_INTERACTION
 98: 0x016F [0x93] DISPLAY_ITEM_INFO(item_id=Work_Zone_1700[1])
 99: 0x0172 [0x1D] PRINT_EVENT_MESSAGE(message_id=9497*)
    → "If you wish to retrieve your $8, trade me your $9."
...
107: 0x0191 [0x1D] PRINT_EVENT_MESSAGE(message_id=9496*)
    → "The $8 is related to the $9."
108: 0x0194 [0x23] WAIT_FOR_DIALOG_INTERACTION
109: 0x0195 [0x93] DISPLAY_ITEM_INFO(item_id=Work_Zone_1700[1])
110: 0x0198 [0x1D] PRINT_EVENT_MESSAGE(message_id=9497*)
    → "If you wish to retrieve your $8, trade me your $9."
...
118: 0x01B7 [0x1D] PRINT_EVENT_MESSAGE(message_id=9496*)
    → "The $8 is related to the $9."
119: 0x01BA [0x23] WAIT_FOR_DIALOG_INTERACTION
120: 0x01BB [0x93] DISPLAY_ITEM_INFO(item_id=Work_Zone_1700[1])
121: 0x01BE [0x1D] PRINT_EVENT_MESSAGE(message_id=9497*)
    → "If you wish to retrieve your $8, trade me your $9."
...
130: 0x01DE [0x1D] PRINT_EVENT_MESSAGE(message_id=9498*)
...
132: 0x01E2 [0x24] CREATE_DIALOG(message_id=9499*, default_option=0*, option_flags=0*)
...
135: 0x01F2 [0x1D] PRINT_EVENT_MESSAGE(message_id=9500*)
...
138: 0x01F9 [0x1D] PRINT_EVENT_MESSAGE(message_id=9501*)
    → "I suppose an explanation is in order."
139: 0x01FC [0x23] WAIT_FOR_DIALOG_INTERACTION
140: 0x01FD [0x1D] PRINT_EVENT_MESSAGE(message_id=9502*)
...
142: 0x0201 [0x1D] PRINT_EVENT_MESSAGE(message_id=9503*)
...
144: 0x0205 [0x1D] PRINT_EVENT_MESSAGE(message_id=9504*)
...
146: 0x0209 [0x1D] PRINT_EVENT_MESSAGE(message_id=9505*)
...
148: 0x020D [0x1D] PRINT_EVENT_MESSAGE(message_id=9506*)
...
153: 0x021C [0x1D] PRINT_EVENT_MESSAGE(message_id=9507*)
...
```
 ...
 22: 0x030F [0x1D] PRINT_EVENT_MESSAGE(message_id=9516*)
...
```
  ...
  7: 0x0346 [0x1D] PRINT_EVENT_MESSAGE(message_id=9512*)
 ...
 12: 0x035A [0x1D] PRINT_EVENT_MESSAGE(message_id=9508*)
    → "You want to retrieve the item associated with this weapon? Let me take a look."
 13: 0x035D [0x23] WAIT_FOR_DIALOG_INTERACTION
 14: 0x035E [0x1D] PRINT_EVENT_MESSAGE(message_id=9509*)
    → "Hmm. The item associated with this weapon is the $0."
 15: 0x0361 [0x23] WAIT_FOR_DIALOG_INTERACTION
 16: 0x0362 [0x1D] PRINT_EVENT_MESSAGE(message_id=9510*)
 ...
 21: 0x0376 [0x1D] PRINT_EVENT_MESSAGE(message_id=9508*)
    → "You want to retrieve the item associated with this weapon? Let me take a look."
 22: 0x0379 [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x037A [0x1D] PRINT_EVENT_MESSAGE(message_id=9509*)
    → "Hmm. The item associated with this weapon is the $0."
 24: 0x037D [0x23] WAIT_FOR_DIALOG_INTERACTION
 25: 0x037E [0x1D] PRINT_EVENT_MESSAGE(message_id=9511*)
