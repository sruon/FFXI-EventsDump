...
```
 ...
 11: 0x0023 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "open" for entities [EventEntity, EventEntity]
...
SUBROUTINE_0087:
 ...
 42: 0x0094 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "clos" for entities [EventEntity, EventEntity]
