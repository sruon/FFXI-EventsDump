...
- **7316**: Consign an order? [Yes./No, thanks.]
...
```
 ...
 30: 0x00FA [0x2B] Borghertz (ID: 17784904/0x010F6048) [7315*]:
 ...
 34: 0x0106 [0x24] CREATE_DIALOG(message_id=7316*, default_option=0*, option_flags=0*)
 ...
 39: 0x011C [0x2B] Borghertz (ID: 17784904/0x010F6048) [7317*]:
...
```
 ...
 30: 0x029F [0x2B] Borghertz (ID: 17784904/0x010F6048) [7318*]:
    → "My work is finished."
