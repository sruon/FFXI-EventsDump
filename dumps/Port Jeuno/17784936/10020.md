...
```
  ...
  1: 0x0209 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
  2: 0x021A [0x45] LOAD_SCHEDULED_TASK(work_offset1=190*, entity1=EventEntity, entity2=EventEntity, scheduler_id="sjcb", work_offset2=600*)
  3: 0x022B [0x1C] WAIT(540* ticks)
  4: 0x022E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  5: 0x023F [0x1C] WAIT(60* ticks)
  6: 0x0242 [0x46] CAMERA_CONTROL: Restore default settings
  7: 0x0244 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
