...
- **7390**: This is the counter for the Outlands air route. How may I be of assistance today?
- **7391**: What is your business here? [Just passing by./I want $6 issued./Tell me about the "adventurers' deal."]
- **7392**: Yes, with $6 you can travel freely between Jeuno and Kazham. The price is a mere $7 gil, and there is no expiration date.
- **7393**: If you cannot afford our already low price, we are offering, for a limited time, the "adventurers' deal." Would you like to hear more on this offer?
- **7394**: Listen to the explanation? [Yes./No. Buy $6.]
- **7395**: Yes, the "adventurers' deal." All you have to do is find these three keys: $1, $2, and $3.
- **7396**: The "adventurers' deal" consists of finding the following three keys: $1, $2, and $3.
- **7397**: Once you have gathered them all, give them to me and I will check to see if they are authentic.
- **7398**: $1...$2...and $3. Yes, they seem to be authentic.
- **7399**: I have issued $6 under the name of <Player>. It has been approved for immediate use.
- **7400**: I am sorry, but this is not one of the items in the deal.
- **7401**: You must bring $1, $2, and $3.
- **7402**: Yes [sir/ma'am]. If you need any information on the air routes to the Outlands, feel free to inquire at any time.
- **7403**: We hope you enjoy flying with us!
- **7404**: I am sorry, but you do not have enough gil.
- **7405**: Buy $6? [Not today./Yes.]
...
```
  ...
  6: 0x0019 [0x1D] PRINT_EVENT_MESSAGE(message_id=7390*)
    → "This is the counter for the Outlands air route. How may I be of assistance today?"
  7: 0x001C [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x001D [0x24] CREATE_DIALOG(message_id=7391*, default_option=0*, option_flags=Work_Zone[7])
 ...
 11: 0x002D [0x1D] PRINT_EVENT_MESSAGE(message_id=7402*)
...
SUBROUTINE_0057:
 ...
 26: 0x005C [0x1D] PRINT_EVENT_MESSAGE(message_id=7392*)
 ...
 28: 0x0060 [0x1D] PRINT_EVENT_MESSAGE(message_id=7393*)
 ...
 30: 0x0064 [0x24] CREATE_DIALOG(message_id=7394*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0093:
 43: 0x0093 [0x24] CREATE_DIALOG(message_id=7405*, default_option=0*, option_flags=0*)
    → "Buy $6? [Not today./Yes.]"
 44: 0x009A [0x25] WAIT_DIALOG_SELECT()
 45: 0x009B [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x00AB
 46: 0x00A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7402*)
    → "Yes [sir/ma'am]. If you need any information on the air routes to the Outlands, feel free to inquire at any time."
...
SUBROUTINE_00AB:
 ...
 54: 0x00C1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7403*)
    → "We hope you enjoy flying with us!"
 55: 0x00C4 [0x23] WAIT_FOR_DIALOG_INTERACTION
 56: 0x00C5 [0x01] GOTO 0x00CC
 57: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7404*)
