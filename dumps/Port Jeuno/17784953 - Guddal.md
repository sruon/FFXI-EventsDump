...
- **7386**: This is the counter for the Outlands air route. How may I be of assistance today?
- **7387**: What is your business here? [Just passing by./I want $6 issued./Tell me about the "adventurers' deal."]
- **7388**: Yes, with $6 you can travel freely between Jeuno and Kazham. The price is a mere $7 gil, and there is no expiration date.
- **7389**: If you cannot afford our already low price, we are offering, for a limited time, the "adventurers' deal." Would you like to hear more on this offer?
- **7390**: Listen to the explanation? [Yes./No. Buy $6.]
- **7391**: Yes, the "adventurers' deal." All you have to do is find these three keys: $1, $2, and $3.
- **7392**: The "adventurers' deal" consists of finding the following three keys: $1, $2, and $3.
- **7393**: Once you have gathered them all, give them to me and I will check to see if they are authentic.
- **7394**: $1...$2...and $3. Yes, they seem to be authentic.
- **7395**: I have issued $6 under the name of <Player>. It has been approved for immediate use.
- **7396**: I am sorry, but this is not one of the items in the deal.
- **7397**: You must bring $1, $2, and $3.
- **7398**: Yes [sir/ma'am]. If you need any information on the air routes to the Outlands, feel free to inquire at any time.
- **7399**: We hope you enjoy flying with us!
- **7400**: I am sorry, but you do not have enough gil.
- **7401**: Buy $6? [Not today./Yes.]
...
```
  ...
  6: 0x0019 [0x1D] PRINT_EVENT_MESSAGE(message_id=7386*)
    → "This is the counter for the Outlands air route. How may I be of assistance today?"
  7: 0x001C [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x001D [0x24] CREATE_DIALOG(message_id=7387*, default_option=0*, option_flags=Work_Zone[7])
 ...
 11: 0x002D [0x1D] PRINT_EVENT_MESSAGE(message_id=7398*)
...
SUBROUTINE_0057:
 ...
 26: 0x005C [0x1D] PRINT_EVENT_MESSAGE(message_id=7388*)
 ...
 28: 0x0060 [0x1D] PRINT_EVENT_MESSAGE(message_id=7389*)
 ...
 30: 0x0064 [0x24] CREATE_DIALOG(message_id=7390*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0093:
 43: 0x0093 [0x24] CREATE_DIALOG(message_id=7401*, default_option=0*, option_flags=0*)
    → "Buy $6? [Not today./Yes.]"
 44: 0x009A [0x25] WAIT_DIALOG_SELECT()
 45: 0x009B [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x00AB
 46: 0x00A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7398*)
    → "Yes [sir/ma'am]. If you need any information on the air routes to the Outlands, feel free to inquire at any time."
...
SUBROUTINE_00AB:
 ...
 54: 0x00C1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7399*)
    → "We hope you enjoy flying with us!"
 55: 0x00C4 [0x23] WAIT_FOR_DIALOG_INTERACTION
 56: 0x00C5 [0x01] GOTO 0x00CC
 57: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7400*)
