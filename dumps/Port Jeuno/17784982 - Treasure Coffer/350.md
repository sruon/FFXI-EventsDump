...
```
 ...
 20: 0x005F [0x24] CREATE_DIALOG(message_id=8673*, default_option=0*, option_flags=0x00)
...
SUBROUTINE_019E:
 ...
 97: 0x01BD [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x02, bit_index_work_offset=0x8003, condition_work_offset=0x8003)
...
SUBROUTINE_01D8:
103: 0x01D8 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "open" for entities [EventEntity, EventEntity]
...
108: 0x01F6 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "clos" for entities [EventEntity, EventEntity]
