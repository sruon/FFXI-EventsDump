...
- **8126**: Visit the Chocobo Circuit? [Off to the races!/Not right now.]
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=8126*, default_option=1*, option_flags=0*)
