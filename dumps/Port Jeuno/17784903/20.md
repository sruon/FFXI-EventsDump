...
```
  ...
  9: 0x0039 [0x45] LOAD_SCHEDULED_TASK(work_offset1=207*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u001", work_offset2=0*)
 10: 0x004A [0x55] WAIT_LOAD_SCHEDULER(work_offset=207*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u001")
 ...
 17: 0x0078 [0x45] LOAD_SCHEDULED_TASK(work_offset1=207*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u002", work_offset2=0*)
 18: 0x0089 [0x55] WAIT_LOAD_SCHEDULER(work_offset=207*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u002")
 19: 0x0098 [0x2A] GET_REQ_LEVEL(level=3, entity_id=Borghertz (ID: 17784904/0x010F6048))
 20: 0x009E [0x1C] WAIT(30* ticks)
 21: 0x00A1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=207*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u005", work_offset2=0*)
 22: 0x00B2 [0x55] WAIT_LOAD_SCHEDULER(work_offset=207*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u005")
 ...
 25: 0x00D1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=207*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u003", work_offset2=0*)
 26: 0x00E2 [0x55] WAIT_LOAD_SCHEDULER(work_offset=207*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u003")
...
SUBROUTINE_0144:
 ...
 49: 0x0153 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2", work_offset2=0*)
 50: 0x0164 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2")
 ...
 55: 0x017E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
 56: 0x018F [0x21] END_EVENT
 57: 0x0190 [0x00] END_REQSTACK()

SUBROUTINE_0191:
 58: 0x0191 [0x45] LOAD_SCHEDULED_TASK(work_offset1=207*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u004", work_offset2=0*)
 59: 0x01A2 [0x55] WAIT_LOAD_SCHEDULER(work_offset=207*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u004")
