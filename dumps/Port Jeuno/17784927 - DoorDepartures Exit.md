...
| [47](#event-47)       | 0x0001       |     54 |             11 |
| [39](#event-39)       | 0x0037       |    154 |             27 |
| [43](#event-43)       | 0x00D1       |     62 |             13 |
...
0010: 80 02 32 00 03 02 10 01  80 03 03 10 02 80 4A 1F  ..2...........J.
0020: 60 0F 01 F0 FF FF 7F 2B  1F 60 0F 01 03 80 23 01  `......+.`....#.
...
```
  ...
  1: 0x000C [0x02] IF !(ExtData[1]->WorkLocal[2] <= 4294909483*) GOTO 0x0032
  2: 0x0014 [0x03] Work_Zone[2] = 200*
  3: 0x0019 [0x03] Work_Zone[3] = 8*
  4: 0x001E [0x4A] Omiro-Zamiro (ID: 17784863/0x010F601F) looks at LocalPlayer
  5: 0x0027 [0x2B] Omiro-Zamiro (ID: 17784863/0x010F601F) [7091*]:
...
0040: 03 00 02 02 00 00 80 02  CC 00 03 09 10 01 80 4A  ...............J
0050: 1F 60 0F 01 F0 FF FF 7F  2B 1F 60 0F 01 04 80 23  .`......+.`....#
0060: 24 05 80 06 80 07 80 25  02 00 10 07 80 00 C9 00  $......%........
0070: 42 27 0A F0 FF FF 7F 17  46 01 4C 45 08 80 F0 FF  B'......F.LE....
0080: FF 7F F0 FF FF 7F 63 6D  35 34 07 80 2A 0A F0 FF  ......cm54..*...
...
```
  ...
  3: 0x004F [0x4A] Omiro-Zamiro (ID: 17784863/0x010F601F) looks at LocalPlayer
  4: 0x0058 [0x2B] Omiro-Zamiro (ID: 17784863/0x010F601F) [7093*]:
    → "This leads to departures. You'll need $7 gil to board a flight."
  5: 0x005F [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0060 [0x24] CREATE_DIALOG(message_id=7094*, default_option=1*, option_flags=0*)
 ...
 10: 0x0071 [0x27] REQ_SET(priority=0x0A, entity_id=LocalPlayer, tag_num=0x17)
 11: 0x0078 [0x46] CAMERA_CONTROL: Disable user control
 12: 0x007A [0x4C] EventEntity->StatusEvent = 8 // Open door
 13: 0x007B [0x45] LOAD_SCHEDULED_TASK: Load scheduler "cm54" with entities [LocalPlayer, LocalPlayer], work=[146*, 0*]
 ...
 18: 0x00A7 [0x47] UPDATE_PLAYER_POS(3.064*, -59.250*, 8.001*, yaw=90.0°*)
...
```
  ...
  3: 0x00ED [0x2B] Omiro-Zamiro (ID: 17784863/0x010F601F) [7111*]:
...
SUBROUTINE_00FD:
 ...
 10: 0x0106 [0x2B] Rachocho (ID: 17784862/0x010F601E) [7092*]:
