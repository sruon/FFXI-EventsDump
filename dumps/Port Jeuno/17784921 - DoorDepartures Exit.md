...
- **7095**: Pay $7 gil and head through? [Yes./No.]
...
```
  ...
  5: 0x0027 [0x2B] Illauvolahaut (ID: 17784878/0x010F602E) [7092*]:
...
```
  ...
  3: 0x0053 [0x2B] Illauvolahaut (ID: 17784878/0x010F602E) [7406*]:
...
```
  ...
  4: 0x0084 [0x2B] Illauvolahaut (ID: 17784878/0x010F602E) [7094*]:
    → "This leads to departures. You'll need $7 gil to board a flight."
  5: 0x008B [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x008C [0x24] CREATE_DIALOG(message_id=7095*, default_option=1*, option_flags=0*)
...
```
  ...
  3: 0x0119 [0x2B] Illauvolahaut (ID: 17784878/0x010F602E) [7112*]:
...
SUBROUTINE_0129:
 ...
 10: 0x0132 [0x2B] Tautorie (ID: 17784877/0x010F602D) [7093*]:
