...
```
  ...
  5: 0x0027 [0x2B] Illauvolahaut (ID: 17784878/0x010F602E) [7088*]:
...
```
  ...
  3: 0x0053 [0x2B] Illauvolahaut (ID: 17784878/0x010F602E) [7402*]:
...
```
  ...
  4: 0x0084 [0x2B] Illauvolahaut (ID: 17784878/0x010F602E) [7090*]:
    → "This leads to departures. You'll need $7 gil to board a flight."
  5: 0x008B [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x008C [0x24] CREATE_DIALOG(message_id=7091*, default_option=1*, option_flags=0*)
...
```
  ...
  3: 0x0119 [0x2B] Illauvolahaut (ID: 17784878/0x010F602E) [7108*]:
...
SUBROUTINE_0129:
 ...
 10: 0x0132 [0x2B] Tautorie (ID: 17784877/0x010F602D) [7089*]:
