...
- **6680**: If you wish to ride a chocobo, you must possess $6 and have a high enough job level.
- **6681**: You can rent a chocobo for $0 gil. I see you currently have $1 gil.
- **6682**: You can rent a chocobo, but because your level is so low, you won't be able to ride for very long. Also, equipment that extends your riding time will have no effect.
- **6683**: If you still want one, it will cost you $0 gil. I see you currently have $1 gil.
- **6684**: Do you wish to rent a chocobo? [Yes, I do./No, thank you.]
- **6685**: You don't have enough gil.
...
0020: 00 01 6A 00 03 09 10 03  80 1E F0 FF FF 7F 2C 34  ..j...........,4
0030: 60 0F 01 34 60 0F 01 6B  75 65 30 02 04 10 04 80  `..4`..kue0.....
...
0070: FF FF 7F 04 53 34 60 0F  01 34 60 0F 01 6B 75 65  ....S4`..4`..kue
0080: 30 2C 34 60 0F 01 34 60  0F 01 73 69 74 30 5D 0A  0,4`..4`..sit0].
0090: 80 0B 80 1C 0C 80 2A 0A  F0 FF FF 7F 45 0D 80 F8  ......*.....E...
00A0: FF FF 7F F8 FF FF 7F 63  68 63 6F 04 80 27 0A F0  .......chco..'..
00B0: FF FF 7F 05 45 0E 80 F8  FF FF 7F F8 FF FF 7F 66  ....E..........f
00C0: 64 6F 30 04 80 1C 0F 80  4E 01 34 60 0F 01 7E 01  do0.....N.4`..~.
...
```
  ...
  8: 0x002E [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "kue0" with entities [Chocobo (ID: 17784884/0x010F6034), Chocobo (ID: 17784884/0x010F6034)]
  9: 0x003B [0x02] IF !(Work_Zone[4] == 0*) GOTO 0x004A
 10: 0x0043 [0x1D] PRINT_EVENT_MESSAGE(message_id=6681*)
 ...
 13: 0x004A [0x1D] PRINT_EVENT_MESSAGE(message_id=6682*)
 ...
 15: 0x004E [0x1D] PRINT_EVENT_MESSAGE(message_id=6683*)
    → "If you still want one, it will cost you $0 gil. I see you currently have $1 gil."
 16: 0x0051 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_0052:
 17: 0x0052 [0x24] CREATE_DIALOG(message_id=6684*, default_option=1*, option_flags=0*)
...
SUBROUTINE_006A:
 ...
 23: 0x006D [0x27] REQ_SET(priority=0x0A, entity_id=LocalPlayer, tag_num=0x04)
 24: 0x0074 [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "kue0" with entities [Chocobo (ID: 17784884/0x010F6034), Chocobo (ID: 17784884/0x010F6034)]
 25: 0x0081 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "sit0" with entities [Chocobo (ID: 17784884/0x010F6034), Chocobo (ID: 17784884/0x010F6034)]
 ...
 30: 0x00AD [0x27] REQ_SET(priority=0x0A, entity_id=LocalPlayer, tag_num=0x05)
 ...
 33: 0x00C8 [0x4E] SET_ENTITY_HIDE_FLAG: Hide Chocobo (ID: 17784884/0x010F6034)
 ...
 44: 0x0108 [0x1D] PRINT_EVENT_MESSAGE(message_id=6685*)
...
```
  ...
  2: 0x0127 [0x1D] PRINT_EVENT_MESSAGE(message_id=6680*)
