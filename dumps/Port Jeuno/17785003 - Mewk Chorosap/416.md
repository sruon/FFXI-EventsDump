...
```
  ...
  7: 0x01BD [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=7*, source=Work_Zone[7], result=ExtData[1]->WorkLocal[27])
  8: 0x01C6 [0x41] GET_BIT_WORK_RANGE(start_bit=8*, end_bit=15*, source=Work_Zone[7], result=ExtData[1]->WorkLocal[28])
  9: 0x01CF [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=23*, source=Work_Zone[7], result=ExtData[1]->WorkLocal[29])
 ...
 19: 0x0207 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 22: 0x021A [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="thk2")
...
\u0005 \u0001	)\u0002\u0005\u0000\u0000\u0002\u0001\u0000\u0000\u007F1\u0000\u0007"
 ...
 47: 0x028D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=59*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 50: 0x02A0 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=59*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
...
128: 0x03EB [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=59*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
...
131: 0x03FE [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=59*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
...
149: 0x0453 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=51*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
...
163: 0x0486 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=50*, entity1=EventEntity, entity2=EventEntity, action="thk1")
...
171: 0x04AD [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=51*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
...
186: 0x04F1 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=51*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
...
196: 0x0521 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=52*, entity1=EventEntity, entity2=EventEntity, action="dis0")
...
SUBROUTINE_0546:
205: 0x0546 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=51*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
...
SUBROUTINE_0578:
214: 0x0578 [0x02] IF !(ExtData[1]->WorkLocal[33] == 5*) GOTO 0x058E
215: 0x0580 [0x1D] PRINT_EVENT_MESSAGE(message_id=9358*)
    → "I'd like to check the materials before you begin the synthesis, so would you mind showing them to me firrrst?\u007F1\u0000\u0007"
216: 0x0583 [0x23] WAIT_FOR_DIALOG_INTERACTION
217: 0x0584 [0x03] Work_Zone[1] = 1073741824*
218: 0x0589 [0x21] END_EVENT
219: 0x058A [0x00] END_REQSTACK()

SUBROUTINE_058E:
220: 0x058E [0x02] IF !(ExtData[1]->WorkLocal[33] == 6*) GOTO 0x05A5
221: 0x0596 [0x1D] PRINT_EVENT_MESSAGE(message_id=9369*)
    → "I'm sorry. There's one more thing you rrrequire. It should be with your guildmaster.\u007F1\u0000\u0007"
222: 0x0599 [0x23] WAIT_FOR_DIALOG_INTERACTION
223: 0x059A [0x1D] PRINT_EVENT_MESSAGE(message_id=9370*)
    → "Do you think you could bring it here for me?\u007F1\u0000\u0007"
224: 0x059D [0x23] WAIT_FOR_DIALOG_INTERACTION
225: 0x059E [0x03] Work_Zone[1] = 1073741824*
226: 0x05A3 [0x21] END_EVENT
227: 0x05A4 [0x00] END_REQSTACK()

SUBROUTINE_05A5:
228: 0x05A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=9275*)
    → "Well, good luck to you out there. I'll be anxiously awaiting your rrreturn.\u007F1\u0000\u0007"
229: 0x05A8 [0x23] WAIT_FOR_DIALOG_INTERACTION
230: 0x05A9 [0x01] GOTO 0x05B0

SUBROUTINE_05AC:
231: 0x05AC [0x1D] PRINT_EVENT_MESSAGE(message_id=9173*)
    → "Mwahahaha. In that case, good luck to you, my frrriend.\u007F1\u0000\u0007"
232: 0x05AF [0x23] WAIT_FOR_DIALOG_INTERACTION
233: 0x05B0 [0x03] Work_Zone[1] = 1073741824*
234: 0x05B5 [0x21] END_EVENT
235: 0x05B6 [0x00] END_REQSTACK()
```
