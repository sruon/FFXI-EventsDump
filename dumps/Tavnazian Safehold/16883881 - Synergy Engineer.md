...
- **12047**: Greetings, friend! I am a synergy engineer, dispatched from the Institute to maintain the furnaces you see beside me. I also have knowledge and services to share with fellow synergists, if that is what you desire.
...
- **12077**: Looking for a fewell fill-up, you say? Then you've come to the right place!
...
- **12119**: This balance is achieved through skillful infusion of combustible elemental crystals that we synergists call "fewell." To begin the synergy process, you'll have to feed the furnace with fewell and get those flames burning!
...
- **12144**: If you sense that the furnace is on the verge of elemental overload, you'll want to employ the safety lever and pressure handle to prevent an unfortunate accident from occurring.
...
- **12170**: My colleagues and I have a stock of mordant available for sale. The best way to learn is to practice, so if you're curious, we encourage you to purchase some and begin experimenting!
...
- **12198**: Congratulations! Your $0 can indeed hold [an/another] evolith aperture. A $2-shaped aperture, to be exact...
...
```
  ...
  7: 0x0026 [0x1D] PRINT_EVENT_MESSAGE(message_id=12213*)
 ...
 10: 0x002F [0x24] CREATE_DIALOG(message_id=12214*, default_option=0*, option_flags=ExtData[1]->WorkLocal[79])
 ...
 13: 0x003F [0x1D] PRINT_EVENT_MESSAGE(message_id=12215*)
 ...
 18: 0x0057 [0x1D] PRINT_EVENT_MESSAGE(message_id=12216*)
 ...
 21: 0x0060 [0x1D] PRINT_EVENT_MESSAGE(message_id=12217*)
 ...
 23: 0x0064 [0x1D] PRINT_EVENT_MESSAGE(message_id=12218*)
 ...
 25: 0x0068 [0x1D] PRINT_EVENT_MESSAGE(message_id=12219*)
 ...
 27: 0x006C [0x1D] PRINT_EVENT_MESSAGE(message_id=12220*)
 ...
 33: 0x0078 [0x1D] PRINT_EVENT_MESSAGE(message_id=12223*)
 ...
 35: 0x007C [0x1D] PRINT_EVENT_MESSAGE(message_id=12224*)
 ...
 37: 0x0080 [0x1D] PRINT_EVENT_MESSAGE(message_id=12225*)
 ...
 39: 0x0084 [0x1D] PRINT_EVENT_MESSAGE(message_id=12226*)
...
SUBROUTINE_0106:
 ...
 48: 0x0111 [0x1D] PRINT_EVENT_MESSAGE(message_id=12047*)
...
SUBROUTINE_0118:
 ...
 52: 0x0120 [0x24] CREATE_DIALOG(message_id=12050*, default_option=0*, option_flags=0*)
 ...
 60: 0x0148 [0x1D] PRINT_EVENT_MESSAGE(message_id=12051*)
 ...
 71: 0x0182 [0x1D] PRINT_EVENT_MESSAGE(message_id=12052*)
 ...
 86: 0x01E5 [0x1D] PRINT_EVENT_MESSAGE(message_id=12053*)
...
SUBROUTINE_03DF:
186: 0x03DF [0x1D] PRINT_EVENT_MESSAGE(message_id=12059*)
...
385: 0x08AA [0x1D] PRINT_EVENT_MESSAGE(message_id=12064*)
...
389: 0x08B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=12065*)
...
393: 0x08C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=12066*)
...
397: 0x08D7 [0x1D] PRINT_EVENT_MESSAGE(message_id=12067*)
...
401: 0x08E6 [0x1D] PRINT_EVENT_MESSAGE(message_id=12068*)
...
405: 0x08F5 [0x1D] PRINT_EVENT_MESSAGE(message_id=12069*)
...
409: 0x0904 [0x1D] PRINT_EVENT_MESSAGE(message_id=12070*)
...
413: 0x0913 [0x1D] PRINT_EVENT_MESSAGE(message_id=12071*)
...
SUBROUTINE_091A:
416: 0x091A [0x1D] PRINT_EVENT_MESSAGE(message_id=12072*)
...
423: 0x0930 [0x1D] PRINT_EVENT_MESSAGE(message_id=12073*)
...
445: 0x09B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=12074*)
...
456: 0x09ED [0x1D] PRINT_EVENT_MESSAGE(message_id=12075*)
    → "Running low? We can fill you up for a nominal fee."
457: 0x09F0 [0x23] WAIT_FOR_DIALOG_INTERACTION
458: 0x09F1 [0x24] CREATE_DIALOG(message_id=12076*, default_option=1*, option_flags=0*)
...
465: 0x0A1B [0x1D] PRINT_EVENT_MESSAGE(message_id=12087*)
...
471: 0x0A30 [0x1D] PRINT_EVENT_MESSAGE(message_id=12077*)
...
481: 0x0A60 [0x1D] PRINT_EVENT_MESSAGE(message_id=12079*)
...
484: 0x0A69 [0x24] CREATE_DIALOG(message_id=12080*, default_option=1*, option_flags=0*)
...
489: 0x0A86 [0x1D] PRINT_EVENT_MESSAGE(message_id=12083*)
...
495: 0x0ACA [0x1D] PRINT_EVENT_MESSAGE(message_id=12084*)
...
500: 0x0ADD [0x1D] PRINT_EVENT_MESSAGE(message_id=12082*)
...
504: 0x0AEC [0x1D] PRINT_EVENT_MESSAGE(message_id=12081*)
...
508: 0x0AF6 [0x1D] PRINT_EVENT_MESSAGE(message_id=12078*)
...
512: 0x0B02 [0x1D] PRINT_EVENT_MESSAGE(message_id=12087*)
    → "How do you expect me to do that when your $3 is sitting inside a furnace, friend? You'll have to come back after you've finished synergizing."
...
516: 0x0B11 [0x1D] PRINT_EVENT_MESSAGE(message_id=12088*)
...
528: 0x0B48 [0x24] CREATE_DIALOG(message_id=12089*, default_option=0*, option_flags=0*)
...
555: 0x0BD6 [0x1D] PRINT_EVENT_MESSAGE(message_id=12090*)
...
559: 0x0BE2 [0x24] CREATE_DIALOG(message_id=12080*, default_option=1*, option_flags=0*)
    → "Pay $0 gil? [Deal!/No thanks.]"
...
568: 0x0C15 [0x1D] PRINT_EVENT_MESSAGE(message_id=12110*)
...
575: 0x0C34 [0x1D] PRINT_EVENT_MESSAGE(message_id=12082*)
    → "I'm afraid you haven't the requisite gil, friend. Perhaps another time."
...
584: 0x0C57 [0x1D] PRINT_EVENT_MESSAGE(message_id=12091*)
...
597: 0x0CAB [0x1D] PRINT_EVENT_MESSAGE(message_id=12093*)
...
608: 0x0CDD [0x24] CREATE_DIALOG(message_id=12094*, default_option=0*, option_flags=0*)
...
653: 0x0DCD [0x1D] PRINT_EVENT_MESSAGE(message_id=12095*)
...
655: 0x0DD1 [0x24] CREATE_DIALOG(message_id=12097*, default_option=1*, option_flags=0*)
    → "Train in this technique? [Yes./No.]"
656: 0x0DD8 [0x25] WAIT_DIALOG_SELECT()
657: 0x0DD9 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0E85
658: 0x0DE1 [0x1D] PRINT_EVENT_MESSAGE(message_id=12098*)
...
664: 0x0E12 [0x1D] PRINT_EVENT_MESSAGE(message_id=12099*)
...
668: 0x0E21 [0x1D] PRINT_EVENT_MESSAGE(message_id=12100*)
...
672: 0x0E30 [0x1D] PRINT_EVENT_MESSAGE(message_id=12101*)
...
676: 0x0E3F [0x1D] PRINT_EVENT_MESSAGE(message_id=12102*)
...
681: 0x0E66 [0x1D] PRINT_EVENT_MESSAGE(message_id=12103*)
...
692: 0x0E98 [0x1D] PRINT_EVENT_MESSAGE(message_id=12096*)
...
697: 0x0EA7 [0x1D] PRINT_EVENT_MESSAGE(message_id=12092*)
...
701: 0x0EB6 [0x1D] PRINT_EVENT_MESSAGE(message_id=12105*)
...
730: 0x0F44 [0x24] CREATE_DIALOG(message_id=12106*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
777: 0x1038 [0x1D] PRINT_EVENT_MESSAGE(message_id=12107*)
    → "This is what you want, correct?"
778: 0x103B [0x23] WAIT_FOR_DIALOG_INTERACTION
779: 0x103C [0x93] DISPLAY_ITEM_INFO(item_id=0*)
780: 0x103F [0x24] CREATE_DIALOG(message_id=12108*, default_option=1*, option_flags=0*)
...
784: 0x1057 [0x1D] PRINT_EVENT_MESSAGE(message_id=12110*)
    → "Excellent! And this is yours. May it serve you well!"
...
791: 0x1076 [0x1D] PRINT_EVENT_MESSAGE(message_id=12109*)
...
803: 0x10A5 [0x24] CREATE_DIALOG(message_id=12112*, default_option=0*, option_flags=0*)
...
809: 0x10C3 [0x1D] PRINT_EVENT_MESSAGE(message_id=12113*)
...
812: 0x10CC [0x1D] PRINT_EVENT_MESSAGE(message_id=12231*)
...
820: 0x10E3 [0x1D] PRINT_EVENT_MESSAGE(message_id=12117*)
...
822: 0x10E7 [0x1D] PRINT_EVENT_MESSAGE(message_id=12118*)
...
824: 0x10EB [0x1D] PRINT_EVENT_MESSAGE(message_id=12119*)
...
826: 0x10EF [0x1D] PRINT_EVENT_MESSAGE(message_id=12120*)
...
828: 0x10F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=12121*)
...
830: 0x10F7 [0x1D] PRINT_EVENT_MESSAGE(message_id=12122*)
...
832: 0x10FB [0x1D] PRINT_EVENT_MESSAGE(message_id=12123*)
...
834: 0x10FF [0x1D] PRINT_EVENT_MESSAGE(message_id=12124*)
...
837: 0x1108 [0x1D] PRINT_EVENT_MESSAGE(message_id=12125*)
...
839: 0x110C [0x1D] PRINT_EVENT_MESSAGE(message_id=12126*)
...
841: 0x1110 [0x1D] PRINT_EVENT_MESSAGE(message_id=12127*)
...
843: 0x1114 [0x1D] PRINT_EVENT_MESSAGE(message_id=12128*)
    → "Should too much debris be allowed to accumulate, the contents of the furnace will become unstable, potentially leading to unpleasant explosions and eruptions. Such accidents pose considerable risk to the synergy attempt in progress, as well as the physical well-being of the synergist, so be sure to exercise due caution!"
844: 0x1117 [0x23] WAIT_FOR_DIALOG_INTERACTION
845: 0x1118 [0x1D] PRINT_EVENT_MESSAGE(message_id=12129*)
...
847: 0x111C [0x1D] PRINT_EVENT_MESSAGE(message_id=12130*)
...
849: 0x1120 [0x1D] PRINT_EVENT_MESSAGE(message_id=12131*)
...
852: 0x1129 [0x1D] PRINT_EVENT_MESSAGE(message_id=12132*)
...
855: 0x1132 [0x1D] PRINT_EVENT_MESSAGE(message_id=12133*)
...
858: 0x113B [0x1D] PRINT_EVENT_MESSAGE(message_id=12134*)
...
860: 0x113F [0x1D] PRINT_EVENT_MESSAGE(message_id=12135*)
...
865: 0x1153 [0x1D] PRINT_EVENT_MESSAGE(message_id=12136*)
...
867: 0x1157 [0x1D] PRINT_EVENT_MESSAGE(message_id=12137*)
...
869: 0x115B [0x1D] PRINT_EVENT_MESSAGE(message_id=12138*)
...
871: 0x115F [0x1D] PRINT_EVENT_MESSAGE(message_id=12139*)
...
873: 0x1163 [0x1D] PRINT_EVENT_MESSAGE(message_id=12140*)
...
875: 0x1167 [0x1D] PRINT_EVENT_MESSAGE(message_id=12141*)
...
877: 0x116B [0x1D] PRINT_EVENT_MESSAGE(message_id=12142*)
...
879: 0x116F [0x1D] PRINT_EVENT_MESSAGE(message_id=12143*)
...
881: 0x1173 [0x1D] PRINT_EVENT_MESSAGE(message_id=12144*)
...
883: 0x1177 [0x1D] PRINT_EVENT_MESSAGE(message_id=12145*)
...
885: 0x117B [0x1D] PRINT_EVENT_MESSAGE(message_id=12146*)
...
887: 0x117F [0x1D] PRINT_EVENT_MESSAGE(message_id=12147*)
...
889: 0x1183 [0x1D] PRINT_EVENT_MESSAGE(message_id=12148*)
...
891: 0x1187 [0x1D] PRINT_EVENT_MESSAGE(message_id=12149*)
...
893: 0x118B [0x1D] PRINT_EVENT_MESSAGE(message_id=12150*)
...
895: 0x118F [0x1D] PRINT_EVENT_MESSAGE(message_id=12151*)
...
897: 0x1193 [0x1D] PRINT_EVENT_MESSAGE(message_id=12152*)
...
899: 0x1197 [0x1D] PRINT_EVENT_MESSAGE(message_id=12153*)
...
901: 0x119B [0x1D] PRINT_EVENT_MESSAGE(message_id=12154*)
...
903: 0x119F [0x1D] PRINT_EVENT_MESSAGE(message_id=12155*)
...
905: 0x11A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=12156*)
...
907: 0x11A7 [0x1D] PRINT_EVENT_MESSAGE(message_id=12157*)
...
909: 0x11AB [0x1D] PRINT_EVENT_MESSAGE(message_id=12158*)
...
913: 0x11BA [0x1D] PRINT_EVENT_MESSAGE(message_id=12159*)
...
915: 0x11BE [0x1D] PRINT_EVENT_MESSAGE(message_id=12160*)
...
917: 0x11C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=12161*)
...
919: 0x11C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=12162*)
...
922: 0x11CF [0x1D] PRINT_EVENT_MESSAGE(message_id=12163*)
...
925: 0x11D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=12164*)
...
927: 0x11DC [0x1D] PRINT_EVENT_MESSAGE(message_id=12165*)
...
929: 0x11E0 [0x1D] PRINT_EVENT_MESSAGE(message_id=12166*)
...
931: 0x11E4 [0x1D] PRINT_EVENT_MESSAGE(message_id=12167*)
...
933: 0x11E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=12168*)
...
936: 0x11F1 [0x1D] PRINT_EVENT_MESSAGE(message_id=12169*)
...
939: 0x11FA [0x1D] PRINT_EVENT_MESSAGE(message_id=12170*)
...
942: 0x1203 [0x1D] PRINT_EVENT_MESSAGE(message_id=12171*)
...
945: 0x120C [0x1D] PRINT_EVENT_MESSAGE(message_id=12172*)
...
948: 0x1215 [0x1D] PRINT_EVENT_MESSAGE(message_id=12173*)
...
950: 0x1219 [0x1D] PRINT_EVENT_MESSAGE(message_id=12174*)
...
954: 0x1227 [0x1D] PRINT_EVENT_MESSAGE(message_id=12175*)
...
956: 0x122B [0x1D] PRINT_EVENT_MESSAGE(message_id=12176*)
...
960: 0x123A [0x1D] PRINT_EVENT_MESSAGE(message_id=12177*)
...
963: 0x1243 [0x1D] PRINT_EVENT_MESSAGE(message_id=12178*)
...
966: 0x124C [0x1D] PRINT_EVENT_MESSAGE(message_id=12179*)
...
968: 0x1250 [0x1D] PRINT_EVENT_MESSAGE(message_id=12180*)
...
971: 0x1259 [0x1D] PRINT_EVENT_MESSAGE(message_id=12181*)
...
977: 0x1272 [0x1D] PRINT_EVENT_MESSAGE(message_id=12182*)
...
980: 0x127B [0x1D] PRINT_EVENT_MESSAGE(message_id=12183*)
...
983: 0x1284 [0x1D] PRINT_EVENT_MESSAGE(message_id=12184*)
...
987: 0x1292 [0x1D] PRINT_EVENT_MESSAGE(message_id=12185*)
...
991: 0x12A1 [0x1D] PRINT_EVENT_MESSAGE(message_id=12186*)
...
993: 0x12A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=12187*)
...
995: 0x12A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=12188*)
...
997: 0x12AD [0x1D] PRINT_EVENT_MESSAGE(message_id=12189*)
...
999: 0x12B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=12190*)
...
1001: 0x12B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=12191*)
...
1005: 0x12C4 [0x1D] PRINT_EVENT_MESSAGE(message_id=12192*)
...
1007: 0x12C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=12193*)
...
1009: 0x12CC [0x1D] PRINT_EVENT_MESSAGE(message_id=12194*)
...
1011: 0x12D0 [0x1D] PRINT_EVENT_MESSAGE(message_id=12195*)
...
1022: 0x12F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=12196*)
...
1024: 0x12F7 [0x1D] PRINT_EVENT_MESSAGE(message_id=12197*)
...
SUBROUTINE_1435:
1083: 0x1435 [0x1D] PRINT_EVENT_MESSAGE(message_id=12198*)
...
1169: 0x15D1 [0x1D] PRINT_EVENT_MESSAGE(message_id=12203*)
...
1173: 0x15DD [0x1D] PRINT_EVENT_MESSAGE(message_id=12204*)
...
1178: 0x15F1 [0x1D] PRINT_EVENT_MESSAGE(message_id=12206*)
...
1183: 0x1605 [0x1D] PRINT_EVENT_MESSAGE(message_id=12205*)
