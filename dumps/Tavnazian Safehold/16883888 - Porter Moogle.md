...
- **12242**: Welcome to the MHMU's porter service, kupo! Which of your burdensome belongings shall I take off your hands today?
- **12243**: Do something, kupo? [Porter service?/Buy a storage slip./No, thank you.]
- **12244**: Is your gobbiebag splitting at the seams? Mog Safe spilling over? Why, an accomplished adventurer like yourself surely has more stuff than you know what to do with.
- **12245**: That's where I come in, kupo. I'll gladly hold onto your prized possessions, freeing you space to gather up even grander goodies.
- **12246**: To make use of my services, first you'll need to buy one of these storage slips for the low, low fee of $19 gil.
- **12247**: Storage slips come in numerous varieties, kupo, each corresponding to a different type of item.
- **12248**: You'll want to peruse the fine print closely, so you don't end up paying good gil for a scrap of parchment useless for the particular item you wish to store.
- **12249**: Not that we moogles would object to that sort of donation, kupo.
- **12250**: Choose the item you wish to entrust, then trade it to me along with a single storage slip. I will take the item and return the slip to you, marked with an invisible seal.
- **12251**: Invisible to you, at least. It's plain as day to us moogles, so don't even think of trying to pull one over on us, kupo.
- **12252**: When it comes time to retrieve your item, just trade to me a single storage slip--any slip--once again.
- **12253**: I will present you with a list of all the items currently in my care, and you may choose the one you wish to withdraw. Simple as that, kupo!
- **12254**: What's more, no additional transaction fees will be incurred! Pretty generous of us for a change, no?
- **12255**: Now I bet you're wondering what the catch is, kupo. So as not to disappoint you, there are a few!
- **12256**: For one, any signed items will lose their signatures if you store them with me.
- **12257**: Why, you say? Hey, even we moogles aren't perfect! It's better for both of us if you keep your most precious possessions close at hand, kupo.
- **12258**: Now listen up, because there's another catch, and it's a doozy.
- **12259**: If you lose your storage slip, I won't be able to return your item. Ever. No ifs, ands, or buts! No "I'm sorry, Mister Porter Moogle, it'll never happen again!" Rules are rules, kupo, and someone has to keep them.
- **12260**: Last, but not least, I can't accept equipment bearing Magian trial insignia.
- **12261**: If you have such an item that you're simply dying to entrust to me, you'll have to abandon your trial first, kupo.
- **12262**: And that's all there is to it. This humble moogle can hardly wait to serve you!
- **12264**: $32 will cost you $19 gil. Do we have a deal, kupo?
- **12265**: Deal, kupo? (Current gil: $18). [Check storable items./Deal./No deal.]
- **12272**: Is that $3 I see, kupo?
- **12273**: What will you do? [Retrieve an item./Confirm storable items./Nothing.]
- **12277**: Kupo? I'm already taking care of that item for you.
- **12278**: $0, yes? Very well! Your precious property is safe with me, kupo!
- **12279**: $0 [variety/varieties] of item, is it? Very well! Your precious property is safe with me, kupo!
- **12280**: Is that a Magian insignia I see on that $0? You'll have to abandon your trial before I can take it off your hands, kupo.
- **12282**: Curious as to whether I can accept that item? Let me check my annals.
- **12283**: Why, yes I can! % can be stored with $1.
- **12284**: Why, it looks as if you have $1 located in your [inventory/Mog Safe/Mog Safe 2/Mog House storage/Mog Locker/Mog Satchel/Mog Sack/Mog Case/Mog Wardrobe/Mog Wardrobe 2/Mog Wardrobe 3/Mog Wardrobe 4/Mog Wardrobe 5/Mog Wardrobe 6/Mog Wardrobe 7/Mog Wardrobe 8/Recycle Bin]!
- **12287**: 0: $0 1: $1 2: $2 3: $3
- **12288**: 4: $4 5: $5 6: $6 7: $7
...
SUBROUTINE_016F:
  ...
  4: 0x0174 [0x1D] PRINT_EVENT_MESSAGE(message_id=12282*)
...
# Dead code (unreachable instructions):
     ...
     0x0038 [0x1D] PRINT_EVENT_MESSAGE(message_id=12242*)
    → "Welcome to the MHMU's porter service, kupo! Which of your burdensome belongings shall I take off your hands today?"
     ...
     0x0047 [0x24] CREATE_DIALOG(message_id=12243*, default_option=0*, option_flags=0*)
    → "Do something, kupo? [Porter service?/Buy a storage slip./No, thank you.]"
     ...
     0x0090 [0x1D] PRINT_EVENT_MESSAGE(message_id=12279*)
    → "$0 [variety/varieties] of item, is it? Very well! Your precious property is safe with me, kupo!"
     ...
     0x0097 [0x1D] PRINT_EVENT_MESSAGE(message_id=12278*)
    → "$0, yes? Very well! Your precious property is safe with me, kupo!"
     ...
     0x00E8 [0x48] [System] [12287*]:
    → "0: $0 1: $1 2: $2 3: $3"
     0x00EB [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x00EC [0x48] [System] [12288*]:
    → "4: $4 5: $5 6: $6 7: $7"
     ...
     0x00FA [0x1D] PRINT_EVENT_MESSAGE(message_id=12272*)
    → "Is that $3 I see, kupo?"
     ...
     0x0120 [0x24] CREATE_DIALOG(message_id=12273*, default_option=0*, option_flags=ExtData[1]->WorkLocal[10])
    → "What will you do? [Retrieve an item./Confirm storable items./Nothing.]"
     ...
     0x0160 [0x1D] PRINT_EVENT_MESSAGE(message_id=12277*)
    → "Kupo? I'm already taking care of that item for you."
     ...
     0x016A [0x1D] PRINT_EVENT_MESSAGE(message_id=12280*)
    → "Is that a Magian insignia I see on that $0? You'll have to abandon your trial before I can take it off your hands, kupo."
     ...
     0x016E [0x1B] RETURN
# Dead code (unreachable instructions):
     0x018C [0x1D] PRINT_EVENT_MESSAGE(message_id=12244*)
    → "Is your gobbiebag splitting at the seams? Mog Safe spilling over? Why, an accomplished adventurer like yourself surely has more stuff than you know what to do with."
     ...
     0x0190 [0x1D] PRINT_EVENT_MESSAGE(message_id=12245*)
    → "That's where I come in, kupo. I'll gladly hold onto your prized possessions, freeing you space to gather up even grander goodies."
     ...
     0x019E [0x1D] PRINT_EVENT_MESSAGE(message_id=12246*)
    → "To make use of my services, first you'll need to buy one of these storage slips for the low, low fee of $19 gil."
     ...
     0x01AF [0x1D] PRINT_EVENT_MESSAGE(message_id=12247*)
    → "Storage slips come in numerous varieties, kupo, each corresponding to a different type of item."
     ...
     0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=12248*)
    ...
    → "Choose the item you wish to entrust, then trade it to me along with a single storage slip. I will take the item and return the slip to you, marked with an invisible seal."
     ...
     0x01CF [0x1D] PRINT_EVENT_MESSAGE(message_id=12251*)
    → "Invisible to you, at least. It's plain as day to us moogles, so don't even think of trying to pull one over on us, kupo."
     ...
     0x01D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=12252*)
    → "When it comes time to retrieve your item, just trade to me a single storage slip--any slip--once again."
     ...
     0x01D7 [0x1D] PRINT_EVENT_MESSAGE(message_id=12253*)
    → "I will present you with a list of all the items currently in my care, and you may choose the one you wish to withdraw. Simple as that, kupo!"
     ...
     0x01DB [0x1D] PRINT_EVENT_MESSAGE(message_id=12254*)
    → "What's more, no additional transaction fees will be incurred! Pretty generous of us for a change, no?"
     ...
     0x01DF [0x1D] PRINT_EVENT_MESSAGE(message_id=12255*)
    ...
    → "If you have such an item that you're simply dying to entrust to me, you'll have to abandon your trial first, kupo."
     ...
     0x01FB [0x1D] PRINT_EVENT_MESSAGE(message_id=12262*)
    → "And that's all there is to it. This humble moogle can hardly wait to serve you!"
     ...
     0x033C [0x1D] PRINT_EVENT_MESSAGE(message_id=12264*)
    → "$32 will cost you $19 gil. Do we have a deal, kupo?"
     ...
     0x0343 [0x24] CREATE_DIALOG(message_id=12265*, default_option=0*, option_flags=0*)
    → "Deal, kupo? (Current gil: $18). [Check storable items./Deal./No deal.]"
     ...
     0x0635 [0x48] [System] [12287*]:
    → "0: $0 1: $1 2: $2 3: $3"
     0x0638 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0639 [0x48] [System] [12288*]:
    → "4: $4 5: $5 6: $6 7: $7"
