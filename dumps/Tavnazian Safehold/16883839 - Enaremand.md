...
- **11143**: Only in a p-place like this c-can a m-m-m-man like m-m-m-me hide from the ridicule of the w-world.
- **11144**: Hm? Oh...um... Yes... Pay n-no heed t-to m-m-m-y ramblings...
- **11145**: I thought that in a p-place like this, I m-m-m-might be able to hide from the r-ridicule of the w-world. However, n-now that Tavnazia has reopened its doors to the outside...
- **11146**: B-but... You understand...r-right? No?
- **11147**: I never really needed a mannequin to remind me how beautiful my Alsha was...is.
- **11148**: That's right. From now on, she'll be here, right by my side...
- **11149**: Are you trying to tell me you have lost...?
- **11150**: Here. You must learn to cherish them with all you heart.
...
```
  ...
  2: 0x005F [0x1D] PRINT_EVENT_MESSAGE(message_id=11143*)
  ...
  5: 0x0072 [0x1D] PRINT_EVENT_MESSAGE(message_id=11144*)
...
```
  ...
  3: 0x0092 [0x1D] PRINT_EVENT_MESSAGE(message_id=11145*)
  ...
  5: 0x0096 [0x1D] PRINT_EVENT_MESSAGE(message_id=11144*)
    → "Hm? Oh...um... Yes... Pay n-no heed t-to m-m-m-y ramblings..."
...
```
  ...
  1: 0x00E6 [0x1D] PRINT_EVENT_MESSAGE(message_id=11143*)
    → "Only in a p-place like this c-can a m-m-m-man like m-m-m-me hide from the ridicule of the w-world."
  ...
  4: 0x00F9 [0x1D] PRINT_EVENT_MESSAGE(message_id=11146*)
...
```
  ...
  2: 0x0116 [0x1D] PRINT_EVENT_MESSAGE(message_id=11145*)
    → "I thought that in a p-place like this, I m-m-m-might be able to hide from the r-ridicule of the w-world. However, n-now that Tavnazia has reopened its doors to the outside..."
  3: 0x0119 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x011A [0x1D] PRINT_EVENT_MESSAGE(message_id=11146*)
    → "B-but... You understand...r-right? No?"
...
```
  ...
  1: 0x018D [0x1D] PRINT_EVENT_MESSAGE(message_id=11149*)
    → "Are you trying to tell me you have lost...?"
  2: 0x0190 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0191 [0x1D] PRINT_EVENT_MESSAGE(message_id=11150*)
