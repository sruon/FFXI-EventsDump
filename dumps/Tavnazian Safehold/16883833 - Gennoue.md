...
- **11179**: Your fate rides on the changing winds of Vana'diel. I can give you insight on the local weather.
- **11180**: What area's weather do you wish to know? [Nowhere./Ronfaure./La Theine Plateau./Valkurm Dunes./Jugner Forest./Batallia Downs./Gustaberg./Konschtat Highlands./Pashhow Marshlands./Rolanberry Fields./Beaucedine Glacier./Xarcabard./Cape Teriggan./Altepa Desert./Sarutabaruta./Tahrongi Canyon./Buburimu Peninsula./Meriphataud Mountains./Sauromugue Champaign./The Sanctuary of Zi'Tah./Yuhtunga & Yhoator Jungles./Qufim Island./Tu'Lia./Ferry./Airship./Jeuno./Uleguerand Range./Tavnazian Archipelago./Riverne - Sites #A01 & #B01.]
- **11181**: That area's forecast for today is for $0 with occasional $1. There is also a slight chance of $2, so caution is advised.
- **11182**: The forecast for tomorrow is for $0 with occasional $1. There is also a slight chance of $2, so caution is advised.
- **11183**: And, the forecast for the day after tomorrow is for $0 with occasional $1. There is also a slight chance of $2, so caution is advised.
- **11184**: Today, that area's weather will be $0 with a chance of $1.
- **11185**: Tomorrow, the weather will be $0 with a chance of $1.
- **11186**: And, the day after tomorrow, the weather will be $0 with a chance of $1.
- **11187**: Today, the weather in that area will be $0. There is also the possibility of $2, so caution is advised.
- **11188**: Tomorrow, the weather will be $0. There is also the possibility of $2, so caution is advised.
- **11189**: And, the day after tomorrow, the weather will be $0. There is also the possibility of $2, so caution is advised.
- **11190**: The weather in that area today will be $0.
- **11191**: The weather tomorrow will be $0.
- **11192**: The weather the day after tomorrow will be $0.
- **11193**: And that's the report, straight from Vana'diel's official weather linkshell.
...
```
  ...
  1: 0x000B [0x1D] PRINT_EVENT_MESSAGE(message_id=11179*)
  ...
  5: 0x001E [0x24] CREATE_DIALOG(message_id=11180*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_0229:
 ...
 25: 0x0234 [0x1D] PRINT_EVENT_MESSAGE(message_id=11184*)
 ...
 28: 0x023B [0x1D] PRINT_EVENT_MESSAGE(message_id=11181*)
...
SUBROUTINE_023F:
 ...
 34: 0x025C [0x1D] PRINT_EVENT_MESSAGE(message_id=11191*)
    → "The weather tomorrow will be $0."
 35: 0x025F [0x23] WAIT_FOR_DIALOG_INTERACTION
 36: 0x0260 [0x01] GOTO 0x0267
 37: 0x0263 [0x1D] PRINT_EVENT_MESSAGE(message_id=11188*)
...
SUBROUTINE_02A5:
 ...
 57: 0x02B0 [0x1D] PRINT_EVENT_MESSAGE(message_id=11186*)
 ...
 60: 0x02B7 [0x1D] PRINT_EVENT_MESSAGE(message_id=11183*)
...
SUBROUTINE_02BB:
 62: 0x02BB [0x1D] PRINT_EVENT_MESSAGE(message_id=11193*)
