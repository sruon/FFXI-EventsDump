...
- **10750**: This safehold we all live in now was once part of the Tavnazian Cathedral, as were the Sealion's Den and the Sacrarium.
- **10751**: Aid from Jeuno has begun arriving in our city. While these items may improve our ways of life at the moment, many of us still worry about the future of the safehold.
- **10752**: Have you ever journeyed to the Sacrarium?
- **10753**: Since I was a child, it has been my dream to become an architect. I often walk alone to the Sacrarium's libraries to study the books on ancient architecture.
- **10754**: One day, while reading a volume on Tavnazian masonry, I discovered a tattered old set of floorplans.
- **10755**: However, due to its condition, there were many sections of it that were difficult to make out. If we could find another copy, I might be able to construct a new map of the Sacrarium based on the combined sets of plans.
- **10756**: If you happen to come across even a fragment of a document that may be of use, bring it back to me and I will do my best to piece together the puzzle.
- **10757**: $6!
- **10758**: Yes, this looks similar to the set of plans I found before... But it, too, is damaged terribly. I cannot tell exactly which part of the Sacrarium it describes.
- **10759**: Hm? You say you found this document in a treasure chest?
- **10760**: Do you happen to remember in what area of the Sacrarium the chest was located?
- **10761**: There is a good chance that the plans describe the same area.
- **10762**: Where did you find the chest? [Think a little longer./Around <F-5>./Around <G-5>./Around <H-5>./Around <F-11>./Around <G-11>./Around <H-11>.]
- **10763**: Where did you find the chest? [Think a little longer./Around <F-7>./Around <G-7>./Around <H-7>./Around <F-9>./Around <G-9>./Around <H-9>.]
- **10764**: Where did you find the chest? [Think a little longer./Around <I-6>./Around <J-6>./Around <K-7>./Around <K-9>./Around <I-10>./Around <J-10>.]
- **10765**: Where did you find the chest? [Think a little longer./Around <J-7>./Around <K-7>./Around <I-8>./Around <L-8>./Around <J-9>./Around <K-9>.]
- **10766**: I see... I will use that information to attempt to reconstruct a precise map of the area. It will take me about a day to complete my work. Please come back tomorrow.
- **10767**: It will take me about a day to complete my work on the map of the Sacrarium. Please come back tomorrow.
- **10768**: I apologize. The information you provided was not precise enough for me to finish the map.
- **10769**: If you happen to come across any more pieces of the Sacrarium floorplans, please bring them to me. I will not give up until I've created a perfect map!
- **10770**: <Player>! I succeeded in completing the $3!
- **10771**: I never imagined that the area could be so simple, yet complicated...
- **10772**: This has been a wonderful experience for me. I have learned so much about the architecture of the cathedral.
- **10773**: Feel free to take the map with you. I have already made myself a copy. It is the least I can do.
- **10774**: I shall make sure to preserve it with the care due the most precious of research materials.
- **11117**: My late brother was once a member of the Tavnazian choir. I remember him once telling me that there existed a lost hymn that not a single member of the Tavnazian Cathedral was able to sing.
- **11118**: He said it was the words from that hymn that would save the children of Altana from their lives of suffering.
...
```
  ...
  1: 0x0006 [0x1D] PRINT_EVENT_MESSAGE(message_id=10750*)
...
```
  ...
  1: 0x0011 [0x1D] PRINT_EVENT_MESSAGE(message_id=10751*)
...
```
  ...
  1: 0x001C [0x1D] PRINT_EVENT_MESSAGE(message_id=10752*)
  ...
  4: 0x002F [0x1D] PRINT_EVENT_MESSAGE(message_id=10753*)
  ...
  7: 0x0042 [0x1D] PRINT_EVENT_MESSAGE(message_id=10754*)
 ...
 10: 0x0055 [0x1D] PRINT_EVENT_MESSAGE(message_id=10755*)
 ...
 13: 0x0068 [0x1D] PRINT_EVENT_MESSAGE(message_id=10756*)
...
```
  ...
  1: 0x0073 [0x1D] PRINT_EVENT_MESSAGE(message_id=10755*)
    → "However, due to its condition, there were many sections of it that were difficult to make out. If we could find another copy, I might be able to construct a new map of the Sacrarium based on the combined sets of plans."
  ...
  4: 0x0086 [0x1D] PRINT_EVENT_MESSAGE(message_id=10756*)
    → "If you happen to come across even a fragment of a document that may be of use, bring it back to me and I will do my best to piece together the puzzle."
...
```
  ...
  2: 0x0096 [0x1D] PRINT_EVENT_MESSAGE(message_id=10757*)
    → "$6!"
  ...
  5: 0x00A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10758*)
  ...
  8: 0x00BC [0x1D] PRINT_EVENT_MESSAGE(message_id=10759*)
 ...
 11: 0x00CF [0x1D] PRINT_EVENT_MESSAGE(message_id=10760*)
 ...
 16: 0x00E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=10761*)
 ...
 21: 0x00F8 [0x24] CREATE_DIALOG(message_id=10762*, default_option=0*, option_flags=0*)
...
SUBROUTINE_011C:
 ...
 27: 0x0127 [0x24] CREATE_DIALOG(message_id=10762*, default_option=0*, option_flags=0*)
    → "Where did you find the chest? [Think a little longer./Around <F-5>./Around <G-5>./Around <H-5>./Around <F-11>./Around <G-11>./Around <H-11>.]"
...
SUBROUTINE_014B:
 ...
 33: 0x0156 [0x24] CREATE_DIALOG(message_id=10763*, default_option=0*, option_flags=0*)
...
SUBROUTINE_017A:
 ...
 39: 0x0185 [0x24] CREATE_DIALOG(message_id=10764*, default_option=0*, option_flags=0*)
...
SUBROUTINE_01A9:
 ...
 45: 0x01B4 [0x24] CREATE_DIALOG(message_id=10764*, default_option=0*, option_flags=0*)
    → "Where did you find the chest? [Think a little longer./Around <I-6>./Around <J-6>./Around <K-7>./Around <K-9>./Around <I-10>./Around <J-10>.]"
...
SUBROUTINE_01D8:
 ...
 51: 0x01E3 [0x24] CREATE_DIALOG(message_id=10765*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0207:
 ...
 57: 0x0212 [0x24] CREATE_DIALOG(message_id=10762*, default_option=0*, option_flags=0*)
    → "Where did you find the chest? [Think a little longer./Around <F-5>./Around <G-5>./Around <H-5>./Around <F-11>./Around <G-11>./Around <H-11>.]"
...
SUBROUTINE_0236:
 ...
 63: 0x0241 [0x24] CREATE_DIALOG(message_id=10762*, default_option=0*, option_flags=0*)
    → "Where did you find the chest? [Think a little longer./Around <F-5>./Around <G-5>./Around <H-5>./Around <F-11>./Around <G-11>./Around <H-11>.]"
...
SUBROUTINE_0268:
 ...
 69: 0x0277 [0x1D] PRINT_EVENT_MESSAGE(message_id=10766*)
...
```
  ...
  1: 0x0282 [0x1D] PRINT_EVENT_MESSAGE(message_id=10767*)
...
```
  ...
  3: 0x0293 [0x1D] PRINT_EVENT_MESSAGE(message_id=10770*)
  ...
  6: 0x02A6 [0x1D] PRINT_EVENT_MESSAGE(message_id=10771*)
  ...
  9: 0x02B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10772*)
 ...
 13: 0x02D4 [0x1D] PRINT_EVENT_MESSAGE(message_id=10773*)
 ...
 16: 0x02DB [0x1D] PRINT_EVENT_MESSAGE(message_id=10774*)
...
```
  ...
  2: 0x0305 [0x1D] PRINT_EVENT_MESSAGE(message_id=10768*)
  ...
  5: 0x0318 [0x1D] PRINT_EVENT_MESSAGE(message_id=10769*)
...
```
  ...
  1: 0x0323 [0x1D] PRINT_EVENT_MESSAGE(message_id=11117*)
  ...
  4: 0x0336 [0x1D] PRINT_EVENT_MESSAGE(message_id=11118*)
