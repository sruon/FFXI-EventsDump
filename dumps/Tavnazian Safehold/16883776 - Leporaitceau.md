...
- **10723**: I will not rest until the Marquisate has become as grand and as powerful as it was before the Great War!
- **10724**: With the arrival of the airships, the situation in Tavnazia has begun to take a turn for the better.
- **10725**: Once again Vana'diel will hear the roar of the mighty sealion!
...
```
  ...
  1: 0x0034 [0x1D] PRINT_EVENT_MESSAGE(message_id=10723*)
...
```
  ...
  1: 0x003F [0x1D] PRINT_EVENT_MESSAGE(message_id=10724*)
  ...
  3: 0x0043 [0x1D] PRINT_EVENT_MESSAGE(message_id=10725*)
