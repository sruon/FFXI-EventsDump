...
- **7901**: An unseen force is drawing you towards the maw.
- **7903**: Warp to [Dummy/the La Theine Plateau/the Konschtat Highlands/the Tahrongi Canyon/the Buburimu Peninsula/the Valkurm Dunes/the Jugner Forest/South Gustaberg/North Gustaberg/Xarcabard/Qufim Island]? [Proceed./Not yet.]
...
0050: 7F 61 62 30 35 04 80 45  05 80 F0 FF FF 7F F0 FF  .ab05..E........
...
```
  ...
  1: 0x0003 [0x48] [System] [7901*]:
    → "An unseen force is drawing you towards the maw."
  2: 0x0006 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0007 [0x03] Work_Zone[2] = 5*
  4: 0x000C [0x24] CREATE_DIALOG(message_id=7903*, default_option=1*, option_flags=0*)
 ...
 16: 0x0046 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "ab05" with entities [LocalPlayer, LocalPlayer], work=[499*, 0*]
