...
```
 ...
 17: 0x00BE [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x03, bit_index_work_offset=0x00, condition_work_offset=0x8001)
 18: 0x00C5 [0x02] IF !(ExtData[1]->WorkLocal[6] == ExtData[1]->WorkLocal[1]) GOTO 0x00D4
 19: 0x00CD [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x03, bit_index_work_offset=0x00, condition_work_offset=0x8001)
 20: 0x00D4 [0x02] IF !(ExtData[1]->WorkLocal[7] == ExtData[1]->WorkLocal[1]) GOTO 0x00E3
 21: 0x00DC [0x3C] SET_BIT_FLAG_CONDITIONAL(target_work_offset=0x03, bit_index_work_offset=0x00, condition_work_offset=0x8001)
 22: 0x00E3 [0x01] GOTO 0x009B

SUBROUTINE_00E6:
 23: 0x00E6 [0x24] CREATE_DIALOG(message_id=8132*, default_option=0*, option_flags=0x03)
...
SUBROUTINE_013D:
 43: 0x013D [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x0148
 44: 0x0145 [0x01] GOTO 0x0148

SUBROUTINE_0148:
 45: 0x0148 [0x01] GOTO 0x0155

SUBROUTINE_014B:
 46: 0x014B [0x03] ExtData[1]->WorkLocal[2] = 1*
 47: 0x0150 [0x03] Work_Zone[1] = 4294967286*
 48: 0x0155 [0x01] GOTO 0x0093

SUBROUTINE_0158:
 49: 0x0158 [0x21] END_EVENT
 50: 0x0159 [0x00] END_REQSTACK()
```
