...
- **7964**: Hmm... You've obviously erred on the side of caution, but the $3 can endure more punishment than this. As the saying goes, "No guts, no glory."
...
- **8000**: As we require a sizeable shipment of provisions to be delivered, you will need to employ a pack chocobo.
...
- **8038**: Ah, you've returned. Without any ado, brief me on the outcome of your mission.
...
```
  ...
  3: 0x0735 [0x02] IF !(ExtData[1]->WorkLocal[1] == 125*) GOTO 0x074F
  ...
  7: 0x0746 [0xA8] MAP_MARKER_CONTROL: Reset/unlock markers (no map display), zone=216*, marker=0*
  8: 0x074C [0x01] GOTO 0x07C5
  9: 0x074F [0x02] IF !(ExtData[1]->WorkLocal[1] == 128*) GOTO 0x0763
 ...
 14: 0x0763 [0x02] IF !(ExtData[1]->WorkLocal[1] == 131*) GOTO 0x077D
 ...
 18: 0x0774 [0xA8] MAP_MARKER_CONTROL: Reset/unlock markers (no map display), zone=216*, marker=0*
 19: 0x077A [0x01] GOTO 0x07C5
 20: 0x077D [0x02] IF !(ExtData[1]->WorkLocal[1] == 134*) GOTO 0x0797
 ...
 24: 0x078E [0xA8] MAP_MARKER_CONTROL: Reset/unlock markers (no map display), zone=216*, marker=0*
 25: 0x0794 [0x01] GOTO 0x07C5
 26: 0x0797 [0x02] IF !(ExtData[1]->WorkLocal[1] == 137*) GOTO 0x07B1
 ...
 30: 0x07A8 [0xA8] MAP_MARKER_CONTROL: Reset/unlock markers (no map display), zone=216*, marker=0*
 31: 0x07AE [0x01] GOTO 0x07C5
 32: 0x07B1 [0x02] IF !(ExtData[1]->WorkLocal[1] == 140*) GOTO 0x07C5
