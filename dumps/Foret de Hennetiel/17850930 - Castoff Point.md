...
- **7953**: You should be able to head [to the other side/over there] if you have the $3 and $3.
- **7955**: This river is not suitable for swimming.
- **7956**: Head [for the other side/over there]? [Yes./No./Dive right in.]
- **7957**: Gah! You lost control of your boat, sending you spiralling downstream!
- **7958**: Head in which direction? [Upstream./Downstream.]
- **7959**: You cannot proceed any farther [upstream/downstream].
...
SUBROUTINE_002E:
 10: 0x002E [0x24] CREATE_DIALOG(message_id=7956*, default_option=0*, option_flags=Work_Zone[3])
 ...
 15: 0x004B [0x24] CREATE_DIALOG(message_id=7958*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0081:
 ...
 26: 0x0091 [0x24] CREATE_DIALOG(message_id=7958*, default_option=0*, option_flags=0*)
    → "Head in which direction? [Upstream./Downstream.]"
...
SUBROUTINE_00C7:
 ...
 49: 0x00EF [0x24] CREATE_DIALOG(message_id=7958*, default_option=0*, option_flags=0*)
    → "Head in which direction? [Upstream./Downstream.]"
...
```
  ...
  9: 0x02A1 [0x24] CREATE_DIALOG(message_id=7956*, default_option=0*, option_flags=Work_Zone[3])
    → "Head [for the other side/over there]? [Yes./No./Dive right in.]"
...
SUBROUTINE_0368:
 10: 0x0368 [0x24] CREATE_DIALOG(message_id=7956*, default_option=0*, option_flags=Work_Zone[3])
    → "Head [for the other side/over there]? [Yes./No./Dive right in.]"
