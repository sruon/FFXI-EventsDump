...
- **7524**: You think I would have some work to do for one of your ilk? Bah. I only deal with those who have $6 from the Pioneers' Coalition in Western Adoulin.
- **7525**: You are a pioneer, are you not? Surely you must have laid eyes on the noxious fumes rising up from the Zoldeff River while on duty!
- **7526**: They pose an obstacle, though not an unsurmountable one, for pioneer expeditions in the area. In fact, the Inventors' Coalition has devised portable boats to aid in crossing the river.
- **7527**: Yet all things come with a price. In this case, you will have to procure the materials yourself. Do that, and I will create such a device to assist you in traversing the toxic tributary.
- **7528**: Three $0 and one $1 and $2 each should be sufficient.
- **7529**: Do this for me, and I will construct a boat the likes of which you have never seen!
- **7530**: Finished already? That was quicker than I had anticipated. Hold on one moment, and I shall craft your reward.
- **7531**: It is done. Yet do not think a boat alone is sufficient for transport--you must first learn how to use it properly if you are to keep yourself safe.
- **7532**: Of course, practice makes perfect. Take your boat, cross the river once, and come back to me.
- **7533**: Boats are merely vessels for navigating the water. You must feel the currents, understand the eddies, and master the waves if you are to brave the river.
- **7534**: Cast off from the bank here, make your way to the other side, and return.
- **7537**: Boating is not merely about paddling, but also about controlling your center of gravity so as not to capsize. Have you learned this in your nautical jaunt?
- **7538**: ...Well done! From here, it is but a simple task to find where to set sail and lay anchor.
- **7539**: I am duly impressed with your skill and tenacity. Few are able to cross such venomous waters.
- **7540**: It is difficult to express with words the wondrous feeling of becoming one with your watercraft. The dangerous poisons in this river should pose no more of a threat than if you were sailing on a stream of afternoon tea.
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
00C0:                                            6E 32                n2
00D0: 62 10 01 05 80 99 32 62  10 01 1C 04 80 00        b.....2b......  
```

#### Opcodes

```
  0: 0x00CE [0x6E] Choubollet (ID: 17850930/0x01106232) uses emote 7*
  1: 0x00D5 [0x99] Wait for Choubollet (ID: 17850930/0x01106232) animation to complete
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
00D0:                                            6E 32                n2
00E0: 62 10 01 06 80 99 32 62  10 01 1C 04 80 00        b.....2b......  
```

#### Opcodes

```
  0: 0x00DE [0x6E] Choubollet (ID: 17850930/0x01106232) uses emote 14*
  1: 0x00E5 [0x99] Wait for Choubollet (ID: 17850930/0x01106232) animation to complete
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
00E0:                                            1E F0                ..
00F0: FF FF 7F 6F 70 27 08 32  62 10 01 01 03 02 10 07  ...op'.2b.......
0100: 80 1D 08 80 23 2A 08 32  62 10 01 21 00           ....#*.2b..!.   
```
...
```
  ...
  3: 0x00F5 [0x27] REQ_SET(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x01)
  4: 0x00FC [0x03] Work_Zone[2] = 2157*
  5: 0x0101 [0x1D] PRINT_EVENT_MESSAGE(message_id=7524*)
  ...
  7: 0x0105 [0x2A] GET_REQ_LEVEL(level=8, entity_id=Choubollet (ID: 17850930/0x01106232))
...
0120: 04 10 0B 80 29 08 32 62  10 01 02 1D 0C 80 23 29  ....).2b......#)
0130: 08 32 62 10 01 03 29 08  32 62 10 01 04 1D 0D 80  .2b...).2b......
0140: 23 29 08 32 62 10 01 05  29 08 32 62 10 01 06 1D  #).2b...).2b....
0150: 0E 80 23 1D 0F 80 23 29  08 32 62 10 01 07 29 08  ..#...#).2b...).
0160: 32 62 10 01 08 1D 10 80  23 29 08 32 62 10 01 09  2b......#).2b...
0170: 21 00                                             !.              
```
...
```
  ...
  7: 0x0124 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x02)
  8: 0x012B [0x1D] PRINT_EVENT_MESSAGE(message_id=7525*)
 ...
 10: 0x012F [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x03)
 11: 0x0136 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x04)
 12: 0x013D [0x1D] PRINT_EVENT_MESSAGE(message_id=7526*)
 ...
 14: 0x0141 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x05)
 15: 0x0148 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x06)
 16: 0x014F [0x1D] PRINT_EVENT_MESSAGE(message_id=7527*)
 ...
 18: 0x0153 [0x1D] PRINT_EVENT_MESSAGE(message_id=7528*)
    → "Three $0 and one $1 and $2 each should be sufficient."
 19: 0x0156 [0x23] WAIT_FOR_DIALOG_INTERACTION
 20: 0x0157 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x07)
 21: 0x015E [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x08)
 22: 0x0165 [0x1D] PRINT_EVENT_MESSAGE(message_id=7529*)
 ...
 24: 0x0169 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x09)
...
0180: 10 0A 80 03 04 10 0B 80  27 08 32 62 10 01 01 1D  ........'.2b....
0190: 0F 80 23 1D 10 80 23 2A  08 32 62 10 01 21 00     ..#...#*.2b..!. 
```
...
```
  ...
  6: 0x0188 [0x27] REQ_SET(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x01)
  7: 0x018F [0x1D] PRINT_EVENT_MESSAGE(message_id=7528*)
    → "Three $0 and one $1 and $2 each should be sufficient."
  8: 0x0192 [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x0193 [0x1D] PRINT_EVENT_MESSAGE(message_id=7529*)
    → "Do this for me, and I will construct a boat the likes of which you have never seen!"
 10: 0x0196 [0x23] WAIT_FOR_DIALOG_INTERACTION
 11: 0x0197 [0x2A] GET_REQ_LEVEL(level=8, entity_id=Choubollet (ID: 17850930/0x01106232))
...
```
  ...
  4: 0x01A7 [0x27] REQ_SET(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x0D)
  5: 0x01AE [0x1D] PRINT_EVENT_MESSAGE(message_id=7530*)
 ...
 10: 0x01D5 [0x2A] GET_REQ_LEVEL(level=8, entity_id=Choubollet (ID: 17850930/0x01106232))
 ...
 13: 0x01FB [0x1D] PRINT_EVENT_MESSAGE(message_id=7531*)
 ...
 15: 0x01FF [0x27] REQ_SET(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x0A)
 16: 0x0206 [0x1D] PRINT_EVENT_MESSAGE(message_id=7532*)
 ...
 18: 0x020A [0x2A] GET_REQ_LEVEL(level=8, entity_id=Choubollet (ID: 17850930/0x01106232))
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0210:       1E F0 FF FF 7F 6F  70 27 08 32 62 10 01 01    .....op'.2b...
0220: 1D 17 80 23 1D 18 80 23  2A 08 32 62 10 01 21 00  ...#...#*.2b..!.
```
...
```
  ...
  3: 0x0219 [0x27] REQ_SET(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x01)
  4: 0x0220 [0x1D] PRINT_EVENT_MESSAGE(message_id=7533*)
  ...
  6: 0x0224 [0x1D] PRINT_EVENT_MESSAGE(message_id=7534*)
    → "Cast off from the bank here, make your way to the other side, and return."
  7: 0x0227 [0x23] WAIT_FOR_DIALOG_INTERACTION
  8: 0x0228 [0x2A] GET_REQ_LEVEL(level=8, entity_id=Choubollet (ID: 17850930/0x01106232))
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0230: 42 1E F0 FF FF 7F 6F 70  29 08 32 62 10 01 06 1D  B.....op).2b....
0240: 19 80 23 1D 1A 80 23 29  08 32 62 10 01 07 29 08  ..#...#).2b...).
0250: 32 62 10 01 08 1D 1B 80  23 29 08 32 62 10 01 09  2b......#).2b...
...
```
  ...
  4: 0x0238 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x06)
  5: 0x023F [0x1D] PRINT_EVENT_MESSAGE(message_id=7537*)
  ...
  7: 0x0243 [0x1D] PRINT_EVENT_MESSAGE(message_id=7538*)
  ...
  9: 0x0247 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x07)
 10: 0x024E [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x08)
 11: 0x0255 [0x1D] PRINT_EVENT_MESSAGE(message_id=7539*)
 ...
 13: 0x0259 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x09)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0270:          1E F0 FF FF 7F  6F 70 27 08 32 62 10 01     .....op'.2b..
0280: 01 1D 1D 80 23 2A 08 32  62 10 01 21 00           ....#*.2b..!.   
```
...
```
  ...
  3: 0x027A [0x27] REQ_SET(priority=0x08, entity_id=Choubollet (ID: 17850930/0x01106232), tag_num=0x01)
  4: 0x0281 [0x1D] PRINT_EVENT_MESSAGE(message_id=7540*)
  ...
  6: 0x0285 [0x2A] GET_REQ_LEVEL(level=8, entity_id=Choubollet (ID: 17850930/0x01106232))
