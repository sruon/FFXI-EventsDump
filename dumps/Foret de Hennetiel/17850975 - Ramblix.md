...
- **7966**: Oh my Gob! You're one of those adventurerurers, aren't ya? You got nothin' on me, [man./lady.] I was just mindin' my own businesesess, lookin' for junk an' stuff.
- **7967**: Hey, watch out. You don't wanna fight me. I'll turn you into meat jerky! Wait, how about you and me be friends instead? Sound good?
- **7968**: I travel all over the world and hear lots of differererent stories. I even hear your stories. I can tell you one, if you want.
- **7969**: Now, listen close...
- **7970**: Oh... Well, if that's the case, I'm outta here.
- **7976**: Do you want to hear a story? [No, thank you./Let's hear one.]
- **7977**: What story would you like to be told? [On second thought, maybe later./Destiny's Device(pt.1)./Destiny's Device(pt.2)./Destiny's Device(pt.3)./Shared Consciousness./Quiescence./Sick and Tired(pt.1)./Sick and Tired(pt.2)./Not-So-Clean Bill(pt.1)./Not-So-Clean Bill(pt.2)./Not-So-Clean Bill(pt.3)./Not-So-Clean Bill(pt.4).]
- **7978**: 
- **7979**: 
- **7980**: 
...
0010: 5F 62 10 01 03 00 00 00  80 02 02 10 01 80 01 28  _b.............(
...
```
  ...
  4: 0x000B [0x4A] LocalPlayer looks at Ramblix (ID: 17850975/0x0110625F)
 ...
 15: 0x005A [0x1D] PRINT_EVENT_MESSAGE(message_id=7966*)
 ...
 17: 0x005E [0x1D] PRINT_EVENT_MESSAGE(message_id=7967*)
 ...
 19: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=7968*)
 ...
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=7976*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7977*, default_option=0*, option_flags=Work_Zone[2])
 ...
 37: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7970*)
...
SUBROUTINE_00E6:
 43: 0x00E6 [0x24] CREATE_DIALOG(message_id=7978*, default_option=0*, option_flags=Work_Zone[3])
    → ""
 ...
 48: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7970*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_012A:
 54: 0x012A [0x24] CREATE_DIALOG(message_id=7979*, default_option=0*, option_flags=Work_Zone[4])
    → ""
 ...
 59: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=7970*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_016E:
 65: 0x016E [0x24] CREATE_DIALOG(message_id=7980*, default_option=0*, option_flags=Work_Zone[5])
    → ""
 ...
 70: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=7970*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01A7:
 ...
 77: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7970*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01C6:
 81: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7969*)
    → "Now, listen close..."
