...
- **7957**: You should be able to head [to the other side/over there] if you have the $3 and $3.
- **7959**: This river is not suitable for swimming.
- **7960**: Head [for the other side/over there]? [Yes./No./Dive right in.]
- **7961**: Gah! You lost control of your boat, sending you spiralling downstream!
- **7962**: Head in which direction? [Upstream./Downstream.]
- **7963**: You cannot proceed any farther [upstream/downstream].
...
SUBROUTINE_002E:
 10: 0x002E [0x24] CREATE_DIALOG(message_id=7960*, default_option=0*, option_flags=Work_Zone[3])
 ...
 15: 0x004B [0x24] CREATE_DIALOG(message_id=7962*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0081:
 ...
 26: 0x0091 [0x24] CREATE_DIALOG(message_id=7962*, default_option=0*, option_flags=0*)
    → "Head in which direction? [Upstream./Downstream.]"
...
SUBROUTINE_00C7:
 ...
 49: 0x00EF [0x24] CREATE_DIALOG(message_id=7962*, default_option=0*, option_flags=0*)
    → "Head in which direction? [Upstream./Downstream.]"
...
```
  ...
  9: 0x02A1 [0x24] CREATE_DIALOG(message_id=7960*, default_option=0*, option_flags=Work_Zone[3])
    → "Head [for the other side/over there]? [Yes./No./Dive right in.]"
...
04B0: 7F 73 30 30 31 00 80 BA  36 62 10 01 0D 80 3A 80  .s001...6b....:.
04C0: 3B 80 26 80 01 19 05 02  02 10 15 80 80 F0 04 45  ;.&............E
04D0: 39 80 F0 FF FF 7F F0 FF  FF 7F 73 31 30 31 00 80  9.........s101..
04E0: BA 36 62 10 01 3C 80 17  80 3B 80 26 80 01 19 05  .6b..<...;.&....
04F0: 02 02 10 04 80 80 19 05  45 39 80 F0 FF FF 7F F0  ........E9......
0500: FF FF 7F 73 32 30 31 00  80 BA 36 62 10 01 1E 80  ...s201...6b....
...
0730: FF 7F 66 64 6F 31 2A 10  F0 FF FF 7F 29 10 3D 62  ..fdo1*.....).=b
...
07B0: FF 7F 73 30 30 34 29 10  3D 62 10 01 03 02 06 10  ..s004).=b......
...
SUBROUTINE_0368:
 10: 0x0368 [0x24] CREATE_DIALOG(message_id=7960*, default_option=0*, option_flags=Work_Zone[3])
    → "Head [for the other side/over there]? [Yes./No./Dive right in.]"
...
SUBROUTINE_0473:
 ...
 64: 0x04B7 [0xBA] SET_ENTITY_POSITION(entity_id=Castoff Point (ID: 17850934/0x01106236), pos_x=-220.000*, pos_z=225.000*, pos_y=0.800*, direction=265.6°*)
 ...
 68: 0x04E0 [0xBA] SET_ENTITY_POSITION(entity_id=Castoff Point (ID: 17850934/0x01106236), pos_x=-14.000*, pos_z=60.000*, pos_y=0.800*, direction=265.6°*)
 ...
 72: 0x0509 [0xBA] SET_ENTITY_POSITION(entity_id=Castoff Point (ID: 17850934/0x01106236), pos_x=220.000*, pos_z=146.000*, pos_y=0.800*, direction=265.6°*)
...
# Dead code (unreachable instructions):
     ...
     0x073C [0x29] REQ_SET_WAIT(priority=0x10, entity_id=Unnamed NPC (ID: 17850941/0x0110623D), tag_num=0x02)
     ...
     0x07B6 [0x29] REQ_SET_WAIT(priority=0x10, entity_id=Unnamed NPC (ID: 17850941/0x0110623D), tag_num=0x03)
