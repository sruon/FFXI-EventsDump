...
- **7523**: You think I would have some work to do for one of your ilk? Bah. I only deal with those who have $6 from the Pioneers' Coalition in Western Adoulin.
- **7524**: You are a pioneer, are you not? Surely you must have laid eyes on the noxious fumes rising up from the Zoldeff River while on duty!
- **7525**: They pose an obstacle, though not an unsurmountable one, for pioneer expeditions in the area. In fact, the Inventors' Coalition has devised portable boats to aid in crossing the river.
- **7526**: Yet all things come with a price. In this case, you will have to procure the materials yourself. Do that, and I will create such a device to assist you in traversing the toxic tributary.
- **7527**: Three $0 and one $1 and $2 each should be sufficient.
- **7528**: Do this for me, and I will construct a boat the likes of which you have never seen!
- **7529**: Finished already? That was quicker than I had anticipated. Hold on one moment, and I shall craft your reward.
- **7530**: It is done. Yet do not think a boat alone is sufficient for transport--you must first learn how to use it properly if you are to keep yourself safe.
- **7531**: Of course, practice makes perfect. Take your boat, cross the river once, and come back to me.
- **7532**: Boats are merely vessels for navigating the water. You must feel the currents, understand the eddies, and master the waves if you are to brave the river.
- **7533**: Cast off from the bank here, make your way to the other side, and return.
- **7536**: Boating is not merely about paddling, but also about controlling your center of gravity so as not to capsize. Have you learned this in your nautical jaunt?
- **7537**: ...Well done! From here, it is but a simple task to find where to set sail and lay anchor.
- **7538**: I am duly impressed with your skill and tenacity. Few are able to cross such venomous waters.
- **7539**: It is difficult to express with words the wondrous feeling of becoming one with your watercraft. The dangerous poisons in this river should pose no more of a threat than if you were sailing on a stream of afternoon tea.
...
```
  ...
  5: 0x0101 [0x1D] PRINT_EVENT_MESSAGE(message_id=7523*)
...
```
  ...
  8: 0x012B [0x1D] PRINT_EVENT_MESSAGE(message_id=7524*)
 ...
 12: 0x013D [0x1D] PRINT_EVENT_MESSAGE(message_id=7525*)
 ...
 16: 0x014F [0x1D] PRINT_EVENT_MESSAGE(message_id=7526*)
 ...
 18: 0x0153 [0x1D] PRINT_EVENT_MESSAGE(message_id=7527*)
 ...
 22: 0x0165 [0x1D] PRINT_EVENT_MESSAGE(message_id=7528*)
...
```
  ...
  7: 0x018F [0x1D] PRINT_EVENT_MESSAGE(message_id=7527*)
    → "Three $0 and one $1 and $2 each should be sufficient."
  8: 0x0192 [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x0193 [0x1D] PRINT_EVENT_MESSAGE(message_id=7528*)
    → "Do this for me, and I will construct a boat the likes of which you have never seen!"
...
```
  ...
  5: 0x01AE [0x1D] PRINT_EVENT_MESSAGE(message_id=7529*)
 ...
 13: 0x01FB [0x1D] PRINT_EVENT_MESSAGE(message_id=7530*)
 ...
 16: 0x0206 [0x1D] PRINT_EVENT_MESSAGE(message_id=7531*)
...
```
  ...
  4: 0x0220 [0x1D] PRINT_EVENT_MESSAGE(message_id=7532*)
  ...
  6: 0x0224 [0x1D] PRINT_EVENT_MESSAGE(message_id=7533*)
...
```
  ...
  5: 0x023F [0x1D] PRINT_EVENT_MESSAGE(message_id=7536*)
  ...
  7: 0x0243 [0x1D] PRINT_EVENT_MESSAGE(message_id=7537*)
 ...
 11: 0x0255 [0x1D] PRINT_EVENT_MESSAGE(message_id=7538*)
...
```
  ...
  4: 0x0281 [0x1D] PRINT_EVENT_MESSAGE(message_id=7539*)
