...
- **7522**: You think I would have some work to do for one of your ilk? Bah. I only deal with those who have $6 from the Pioneers' Coalition in Western Adoulin.
- **7523**: You are a pioneer, are you not? Surely you must have laid eyes on the noxious fumes rising up from the Zoldeff River while on duty!
- **7524**: They pose an obstacle, though not an unsurmountable one, for pioneer expeditions in the area. In fact, the Inventors' Coalition has devised portable boats to aid in crossing the river.
- **7525**: Yet all things come with a price. In this case, you will have to procure the materials yourself. Do that, and I will create such a device to assist you in traversing the toxic tributary.
- **7526**: Three $0 and one $1 and $2 each should be sufficient.
- **7527**: Do this for me, and I will construct a boat the likes of which you have never seen!
- **7528**: Finished already? That was quicker than I had anticipated. Hold on one moment, and I shall craft your reward.
- **7529**: It is done. Yet do not think a boat alone is sufficient for transport--you must first learn how to use it properly if you are to keep yourself safe.
- **7530**: Of course, practice makes perfect. Take your boat, cross the river once, and come back to me.
- **7531**: Boats are merely vessels for navigating the water. You must feel the currents, understand the eddies, and master the waves if you are to brave the river.
- **7532**: Cast off from the bank here, make your way to the other side, and return.
- **7535**: Boating is not merely about paddling, but also about controlling your center of gravity so as not to capsize. Have you learned this in your nautical jaunt?
- **7536**: ...Well done! From here, it is but a simple task to find where to set sail and lay anchor.
- **7537**: I am duly impressed with your skill and tenacity. Few are able to cross such venomous waters.
- **7538**: It is difficult to express with words the wondrous feeling of becoming one with your watercraft. The dangerous poisons in this river should pose no more of a threat than if you were sailing on a stream of afternoon tea.
...
```
  ...
  5: 0x0101 [0x1D] PRINT_EVENT_MESSAGE(message_id=7522*)
...
```
  ...
  8: 0x012B [0x1D] PRINT_EVENT_MESSAGE(message_id=7523*)
 ...
 12: 0x013D [0x1D] PRINT_EVENT_MESSAGE(message_id=7524*)
 ...
 16: 0x014F [0x1D] PRINT_EVENT_MESSAGE(message_id=7525*)
 ...
 18: 0x0153 [0x1D] PRINT_EVENT_MESSAGE(message_id=7526*)
 ...
 22: 0x0165 [0x1D] PRINT_EVENT_MESSAGE(message_id=7527*)
...
```
  ...
  7: 0x018F [0x1D] PRINT_EVENT_MESSAGE(message_id=7526*)
    → "Three $0 and one $1 and $2 each should be sufficient."
  8: 0x0192 [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x0193 [0x1D] PRINT_EVENT_MESSAGE(message_id=7527*)
    → "Do this for me, and I will construct a boat the likes of which you have never seen!"
...
```
  ...
  5: 0x01AE [0x1D] PRINT_EVENT_MESSAGE(message_id=7528*)
 ...
 13: 0x01FB [0x1D] PRINT_EVENT_MESSAGE(message_id=7529*)
 ...
 16: 0x0206 [0x1D] PRINT_EVENT_MESSAGE(message_id=7530*)
...
```
  ...
  4: 0x0220 [0x1D] PRINT_EVENT_MESSAGE(message_id=7531*)
  ...
  6: 0x0224 [0x1D] PRINT_EVENT_MESSAGE(message_id=7532*)
...
```
  ...
  5: 0x023F [0x1D] PRINT_EVENT_MESSAGE(message_id=7535*)
  ...
  7: 0x0243 [0x1D] PRINT_EVENT_MESSAGE(message_id=7536*)
 ...
 11: 0x0255 [0x1D] PRINT_EVENT_MESSAGE(message_id=7537*)
...
```
  ...
  4: 0x0281 [0x1D] PRINT_EVENT_MESSAGE(message_id=7538*)
