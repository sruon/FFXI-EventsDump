...
SUBROUTINE_0363:
 ...
 10: 0x0368 [0x24] CREATE_DIALOG(message_id=7954*, default_option=0*, option_flags=0x1003)
 ...
 16: 0x037D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 17: 0x038E [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
...
SUBROUTINE_03BD:
 ...
 27: 0x03C9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 28: 0x03DA [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
...
SUBROUTINE_0456:
 ...
 52: 0x0458 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
...
SUBROUTINE_0473:
 57: 0x0473 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 58: 0x0484 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 63: 0x04A6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=23*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s001", work_offset2=0*)
...
SUBROUTINE_04C7:
 ...
 67: 0x04CF [0x45] LOAD_SCHEDULED_TASK(work_offset1=23*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s101", work_offset2=0*)
...
SUBROUTINE_04F0:
 ...
 71: 0x04F8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=23*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s201", work_offset2=0*)
...
SUBROUTINE_0519:
 74: 0x0519 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 75: 0x052A [0x45] LOAD_SCHEDULED_TASK(work_offset1=23*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="dbn0", work_offset2=0*)
 ...
 78: 0x054F [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 79: 0x0560 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
...
SUBROUTINE_060B:
 99: 0x060B [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "corp" for entities [LocalPlayer, LocalPlayer]
100: 0x0618 [0x53] WAIT_SCHEDULER_TASK(entity1=LocalPlayer, entity2=LocalPlayer, action_id="corp")
101: 0x0625 [0x1C] WAIT(30* ticks)
102: 0x0628 [0x02] IF !(Work_Zone[2] == 0*) GOTO 0x0644
103: 0x0630 [0x45] LOAD_SCHEDULED_TASK(work_offset1=23*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s002", work_offset2=0*)
104: 0x0641 [0x01] GOTO 0x067C

SUBROUTINE_0644:
105: 0x0644 [0x02] IF !(Work_Zone[2] == 2*) GOTO 0x0660
106: 0x064C [0x45] LOAD_SCHEDULED_TASK(work_offset1=23*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s102", work_offset2=0*)
107: 0x065D [0x01] GOTO 0x067C

SUBROUTINE_0660:
108: 0x0660 [0x02] IF !(Work_Zone[2] == 4*) GOTO 0x067C
109: 0x0668 [0x45] LOAD_SCHEDULED_TASK(work_offset1=23*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s202", work_offset2=0*)
110: 0x0679 [0x01] GOTO 0x067C

SUBROUTINE_067C:
111: 0x067C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
112: 0x068D [0x1C] WAIT(160* ticks)
113: 0x0690 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
114: 0x06A1 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
...
```
# Data Section: 0x06B5 (415 bytes)
     0x06B5: 45 0C 80 F0 FF FF 7F F0 FF FF 7F 66 64 6F 31 00
     0x06C5: 80 55 0C 80 F0 FF FF 7F F0 FF FF 7F 66 64 6F 31
     0x06D5: 46 01 38 38 80 BA F0 FF FF 7F 16 80 17 80 2D 80
     0x06E5: 43 80 45 39 80 F0 FF FF 7F F0 FF FF 7F 73 30 30
     0x06F5: 33 00 80 45 0C 80 F0 FF FF 7F F0 FF FF 7F 66 64
     0x0705: 69 32 00 80 1C 40 80 27 10 F0 FF FF 7F 12 1C 44
     0x0715: 80 45 0C 80 F0 FF FF 7F F0 FF FF 7F 66 64 6F 31
     0x0725: 00 80 55 0C 80 F0 FF FF 7F F0 FF FF 7F 66 64 6F
     0x0735: 31 2A 10 F0 FF FF 7F 29 10 39 62 10 01 02 52 39
     0x0745: 80 F0 FF FF 7F F0 FF FF 7F 73 30 30 33 45 39 80
     0x0755: F0 FF FF 7F F0 FF FF 7F 73 30 30 34 00 80 45 0C
     0x0765: 80 F0 FF FF 7F F0 FF FF 7F 66 64 69 32 00 80 1C
     0x0775: 40 80 27 10 F0 FF FF 7F 13 1C 44 80 45 0C 80 F0
     0x0785: FF FF 7F F0 FF FF 7F 66 64 6F 31 00 80 55 0C 80
     0x0795: F0 FF FF 7F F0 FF FF 7F 66 64 6F 31 2A 10 F0 FF
     0x07A5: FF 7F 52 39 80 F0 FF FF 7F F0 FF FF 7F 73 30 30
     0x07B5: 34 29 10 39 62 10 01 03 02 06 10 06 80 00 D9 07
     0x07C5: 45 39 80 F0 FF FF 7F F0 FF FF 7F 73 30 30 39 00
     0x07D5: 80 01 EA 07 45 39 80 F0 FF FF 7F F0 FF FF 7F 73
     0x07E5: 30 30 38 00 80 4E 01 F0 FF FF 7F 45 0C 80 F0 FF
     0x07F5: FF 7F F0 FF FF 7F 66 64 69 32 00 80 1C 45 80 45
     0x0805: 0C 80 F0 FF FF 7F F0 FF FF 7F 66 64 6F 31 00 80
     0x0815: 55 0C 80 F0 FF FF 7F F0 FF FF 7F 66 64 6F 31 02
     0x0825: 06 10 06 80 00 3E 08 52 39 80 F0 FF FF 7F F0 FF
     0x0835: FF 7F 73 30 30 39 01 4D 08 52 39 80 F0 FF FF 7F
     0x0845: F0 FF FF 7F 73 30 30 38 4E 00 F0 FF FF 7F 1B
```