...
```
  0: 0x0049 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-459.978*, z=35.383*, y=121.011*, direction=88.7°*
...
```
  0: 0x005D [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-460.000*, z=19.935*, y=122.031*, direction=358.8°*
