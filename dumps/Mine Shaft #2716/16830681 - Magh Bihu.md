...
|       0 | 0x0871      |        2161 |
|       1 | 0x0028      |          40 |
|       2 | 0xFFF8D000  |  4294496256 |
|       3 | 0x608C      |       24716 |
|       4 | 0x1DC80     |      121984 |
|       5 | 0xFFF8EBF0  |  4294503408 |
|       6 | 0x1D8B      |        7563 |
|       7 | 0x1DC8F     |      121999 |
...
```
  ...
  1: 0x0117 [0x1F] MOVE_ENTITY: EventEntity moves to X=-471.040*, Z=24.716*, Y=121.984*
...
```
  ...
  1: 0x012D [0x1F] MOVE_ENTITY: EventEntity moves to X=-463.888*, Z=7.563*, Y=121.999*
