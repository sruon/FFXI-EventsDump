...
| [65535.14](#event-6553514) | 0x00C0       |      7 |              3 |
| [65535.15](#event-6553515) | 0x00C7       |      7 |              3 |
| [8](#event-8)              | 0x00CE       |      7 |              2 |
| [32001](#event-32001)      | 0x00D5       |      7 |              2 |
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
00C0: AB 03 AC 01 03 80 00                              .......         
```

#### Opcodes

```
  0: 0x00C0 [0xAB] EventEntity->Render.Flags0 ^= 0x20000 // Toggle bit 17
  1: 0x00C2 [0xAC] EventEntity->StatusEvent = 1*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
00C0:                      AC  01 04 80 AB 04 00               .......  
```

#### Opcodes

```
  0: 0x00C7 [0xAC] EventEntity->StatusEvent = 0*
  1: 0x00CB [0xAB] EventEntity->Render.Flags0 |= 0x40000 // Set bit 18
