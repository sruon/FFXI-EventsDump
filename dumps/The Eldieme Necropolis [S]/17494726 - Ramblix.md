...
- **7148**: Oh my Gob! You're one of those adventurerurers, aren't ya? You got nothin' on me, [man./lady.] I was just mindin' my own businesesess, lookin' for junk an' stuff.
- **7149**: Hey, watch out. You don't wanna fight me. I'll turn you into meat jerky! Wait, how about you and me be friends instead? Sound good?
- **7150**: I travel all over the world and hear lots of differererent stories. I even hear your stories. I can tell you one, if you want.
- **7151**: Now, listen close...
- **7152**: Oh... Well, if that's the case, I'm outta here.
- **7603**: Do you want to hear a story? [No, thank you./Let's hear one.]
- **7604**: What story would you like to be told? [On second thought, maybe later./Blue recommendation letter./A Little Knowledge(pt.1)./A Little Knowledge(pt.2)./A Little Knowledge(pt.3)./Burden of Suspicion./On Sabbatical(pt.1)./On Sabbatical(pt.2)./Downward Helix(pt.1)./Downward Helix(pt.2)./Downward Helix(pt.3)./Seeing Blood-red(pt.1)./Seeing Blood-red(pt.2)./Seeing Blood-red(pt.3)./Seeing Blood-red(pt.4)./Beneath the Mask(pt.1)./Beneath the Mask(pt.2)./Delkfutt the Great(pt.1)./Delkfutt the Great(pt.2).]
- **7605**: 
- **7606**: 
- **7607**: 
...
```
 ...
 15: 0x005A [0x1D] PRINT_EVENT_MESSAGE(message_id=7148*)
 ...
 17: 0x005E [0x1D] PRINT_EVENT_MESSAGE(message_id=7149*)
 ...
 19: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=7150*)
...
SUBROUTINE_00A2:
 ...
 37: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7152*)
...
SUBROUTINE_00E6:
 ...
 48: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7152*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_012A:
 ...
 59: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=7152*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_016E:
 ...
 70: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=7152*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01A7:
 ...
 77: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7152*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01C6:
 81: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7151*)
    → "Now, listen close..."
