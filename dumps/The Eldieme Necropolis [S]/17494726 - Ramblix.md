...
- **7147**: Oh my Gob! You're one of those adventurerurers, aren't ya? You got nothin' on me, [man./lady.] I was just mindin' my own businesesess, lookin' for junk an' stuff.
- **7148**: Hey, watch out. You don't wanna fight me. I'll turn you into meat jerky! Wait, how about you and me be friends instead? Sound good?
- **7149**: I travel all over the world and hear lots of differererent stories. I even hear your stories. I can tell you one, if you want.
- **7150**: Now, listen close...
- **7151**: Oh... Well, if that's the case, I'm outta here.
- **7602**: Do you want to hear a story? [No, thank you./Let's hear one.]
- **7603**: What story would you like to be told? [On second thought, maybe later./Blue recommendation letter./A Little Knowledge(pt.1)./A Little Knowledge(pt.2)./A Little Knowledge(pt.3)./Burden of Suspicion./On Sabbatical(pt.1)./On Sabbatical(pt.2)./Downward Helix(pt.1)./Downward Helix(pt.2)./Downward Helix(pt.3)./Seeing Blood-red(pt.1)./Seeing Blood-red(pt.2)./Seeing Blood-red(pt.3)./Seeing Blood-red(pt.4)./Beneath the Mask(pt.1)./Beneath the Mask(pt.2)./Delkfutt the Great(pt.1)./Delkfutt the Great(pt.2).]
- **7604**: 
- **7605**: 
- **7606**: 
...
0010: C6 F2 0A 01 03 00 00 00  80 02 02 10 01 80 01 28  ...............(
...
```
  ...
  4: 0x000B [0x4A] LocalPlayer looks at Ramblix (ID: 17494726/0x010AF2C6)
 ...
 15: 0x005A [0x1D] PRINT_EVENT_MESSAGE(message_id=7147*)
 ...
 17: 0x005E [0x1D] PRINT_EVENT_MESSAGE(message_id=7148*)
 ...
 19: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=7149*)
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7603*, default_option=0*, option_flags=Work_Zone[2])
    → "What story would you like to be told? [On second thought, maybe later./Blue recommendation letter./A Little Knowledge(pt.1)./A Little Knowledge(pt.2)./A Little Knowledge(pt.3)./Burden of Suspicion./On Sabbatical(pt.1)./On Sabbatical(pt.2)./Downward Helix(pt.1)./Downward Helix(pt.2)./Downward Helix(pt.3)./Seeing Blood-red(pt.1)./Seeing Blood-red(pt.2)./Seeing Blood-red(pt.3)./Seeing Blood-red(pt.4)./Beneath the Mask(pt.1)./Beneath the Mask(pt.2)./Delkfutt the Great(pt.1)./Delkfutt the Great(pt.2).]"
 ...
 37: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7151*)
...
SUBROUTINE_00E6:
 ...
 48: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7151*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_012A:
 ...
 59: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=7151*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_016E:
 ...
 70: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=7151*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01A7:
 ...
 77: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7151*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01C6:
 81: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7150*)
    → "Now, listen close..."
