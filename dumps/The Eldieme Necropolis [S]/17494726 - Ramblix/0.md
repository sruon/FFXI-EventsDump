...
SUBROUTINE_00DE:
 ...
 50: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7151*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_0122:
 ...
 63: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=7151*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_0166:
 ...
 76: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=7151*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_01AA:
 ...
 85: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7151*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_01C6:
 89: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7150*)
    → "Now, listen close...\u007F1\u0000\u0007"
