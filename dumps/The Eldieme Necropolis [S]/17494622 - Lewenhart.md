...
- **7919**: Never-ending is the cycle of torment and death. Ruthless is its grasp on even those poor souls whose only wish is for eternal rest.
- **7920**: The lives and dreams that are shattered on the battlefield... And the burden of sorrow that is inherited by loved ones left behind... It is of this that we bards sing, lest the lessons they teach us be forgotten for all time.
- **7921**: $0...! Thank you kindly, friend. With this offering, those who have been laid to rest here may finally know true peace.
...
```
  ...
  9: 0x0023 [0x1D] PRINT_EVENT_MESSAGE(message_id=7919*)
 ...
 13: 0x0032 [0x1D] PRINT_EVENT_MESSAGE(message_id=7919*)
    → "Never-ending is the cycle of torment and death. Ruthless is its grasp on even those poor souls whose only wish is for eternal rest."
 ...
 18: 0x0049 [0x1D] PRINT_EVENT_MESSAGE(message_id=7919*)
    → "Never-ending is the cycle of torment and death. Ruthless is its grasp on even those poor souls whose only wish is for eternal rest."
 ...
 23: 0x0060 [0x1D] PRINT_EVENT_MESSAGE(message_id=7920*)
 ...
 26: 0x0067 [0x1D] PRINT_EVENT_MESSAGE(message_id=7919*)
    → "Never-ending is the cycle of torment and death. Ruthless is its grasp on even those poor souls whose only wish is for eternal rest."
...
SUBROUTINE_006B:
 ...
 31: 0x007E [0x1D] PRINT_EVENT_MESSAGE(message_id=7920*)
    → "The lives and dreams that are shattered on the battlefield... And the burden of sorrow that is inherited by loved ones left behind... It is of this that we bards sing, lest the lessons they teach us be forgotten for all time."
 32: 0x0081 [0x23] WAIT_FOR_DIALOG_INTERACTION
 33: 0x0082 [0x01] GOTO 0x0089
 34: 0x0085 [0x1D] PRINT_EVENT_MESSAGE(message_id=7919*)
    → "Never-ending is the cycle of torment and death. Ruthless is its grasp on even those poor souls whose only wish is for eternal rest."
...
SUBROUTINE_0089:
 ...
 39: 0x009C [0x1D] PRINT_EVENT_MESSAGE(message_id=7920*)
    → "The lives and dreams that are shattered on the battlefield... And the burden of sorrow that is inherited by loved ones left behind... It is of this that we bards sing, lest the lessons they teach us be forgotten for all time."
 40: 0x009F [0x23] WAIT_FOR_DIALOG_INTERACTION
 41: 0x00A0 [0x01] GOTO 0x00A7
 42: 0x00A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7919*)
    → "Never-ending is the cycle of torment and death. Ruthless is its grasp on even those poor souls whose only wish is for eternal rest."
...
SUBROUTINE_00AA:
 ...
 48: 0x00BD [0x1D] PRINT_EVENT_MESSAGE(message_id=7919*)
    → "Never-ending is the cycle of torment and death. Ruthless is its grasp on even those poor souls whose only wish is for eternal rest."
 ...
 54: 0x00D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7921*)
 ...
 57: 0x00E0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7919*)
    → "Never-ending is the cycle of torment and death. Ruthless is its grasp on even those poor souls whose only wish is for eternal rest."
...
SUBROUTINE_00E4:
 ...
 63: 0x00FC [0x1D] PRINT_EVENT_MESSAGE(message_id=7921*)
    → "$0...! Thank you kindly, friend. With this offering, those who have been laid to rest here may finally know true peace."
 64: 0x00FF [0x23] WAIT_FOR_DIALOG_INTERACTION
 65: 0x0100 [0x01] GOTO 0x0107
 66: 0x0103 [0x1D] PRINT_EVENT_MESSAGE(message_id=7919*)
    → "Never-ending is the cycle of torment and death. Ruthless is its grasp on even those poor souls whose only wish is for eternal rest."
...
SUBROUTINE_0107:
 ...
 72: 0x011F [0x1D] PRINT_EVENT_MESSAGE(message_id=7921*)
    → "$0...! Thank you kindly, friend. With this offering, those who have been laid to rest here may finally know true peace."
 73: 0x0122 [0x23] WAIT_FOR_DIALOG_INTERACTION
 74: 0x0123 [0x01] GOTO 0x012A
 75: 0x0126 [0x1D] PRINT_EVENT_MESSAGE(message_id=7919*)
    → "Never-ending is the cycle of torment and death. Ruthless is its grasp on even those poor souls whose only wish is for eternal rest."
