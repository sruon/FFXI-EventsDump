...
- **7450**: Those who have accepted $0 must pay $1 Unity accolades to participate. The content for this Wanted battle is $2. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
- **7451**: Commence the Wanted battle? ($1 acc.) [Let's go!/Not yet.]
- **7468**: You currently have multiple Wanted battle objectives set. Select which one you would like to undertake.
- **7469**: Which objective would you like to undertake? [None for now./$0./$1./$2./$3./$4./$5./$6./$7.]
