...
| [122](#event-122)     | 0x0001       |    344 |             52 |
| [302](#event-302)     | 0x0159       |    300 |             42 |
...
```
  ...
  2: 0x0008 [0x48] [System] [7648*]:
    → "The $3 is humming in response to the device..."
  3: 0x000B [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x000C [0x24] CREATE_DIALOG(message_id=7650*, default_option=1*, option_flags=0*)
