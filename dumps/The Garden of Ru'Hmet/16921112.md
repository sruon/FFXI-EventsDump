...
| [32000](#event-32000)    | 0x004F       |      1 |              1 |
| [65535.8](#event-655358) | 0x0050       |     27 |              3 |
...
```
  0: 0x0045 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=411.121*, z=427.016*, y=-1.000*, direction=359.6°*
...
```
  0: 0x0050 [0x62] LOAD_EVENT_SCHEDULER: Load scheduler "main" with entities [EventEntity, EventEntity], work=[43*, 0*]
