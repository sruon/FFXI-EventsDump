...
```
 ...
 11: 0x0023 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 12: 0x0034 [0x1C] WAIT(60* ticks)
 13: 0x0037 [0x38] SET_CLIENT_EVENT_MODE(mode=19*)
 14: 0x003A [0x45] LOAD_SCHEDULED_TASK(work_offset1=94*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="tow3", work_offset2=0*)
 ...
 18: 0x005C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 19: 0x006D [0x1C] WAIT(120* ticks)
 20: 0x0070 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="s157")
 21: 0x007D [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="1con")
 ...
 25: 0x0097 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="3miz")
 ...
 31: 0x00D1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=94*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="tow4", work_offset2=0*)
 32: 0x00E2 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=??? (ID: 16921079/0x010231F7), tag_num=0x02)
 33: 0x00E9 [0x1C] WAIT(180* ticks)
 34: 0x00EC [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="who1", work_offset2=0*)
 ...
 44: 0x0131 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="whi1", work_offset2=0*)
