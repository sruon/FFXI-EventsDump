...
- **7645**: Hold up the $3? [Yes./No.]
- **7646**: This portal only allows passage in one direction.
- **7647**: This portal has been badly damaged...
- **7648**: The $3 is humming in response to the device...
...
```
  ...
  1: 0x00D4 [0x48] [System] [7647*]:
    → "This portal has been badly damaged..."
  2: 0x00D7 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x00D8 [0x24] CREATE_DIALOG(message_id=7641*, default_option=1*, option_flags=0*)
...
```
  ...
  1: 0x019C [0x48] [System] [7647*]:
    → "This portal has been badly damaged..."
  2: 0x019F [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x01A0 [0x24] CREATE_DIALOG(message_id=7641*, default_option=1*, option_flags=0*)
    → "Investigate the portal? [Yes./No.]"
