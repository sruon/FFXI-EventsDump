...
SUBROUTINE_0140:
 ...
 15: 0x014A [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=5*, source=Work_Zone[5], result=ExtData[1]->WorkLocal[9])
 16: 0x0153 [0x41] GET_BIT_WORK_RANGE(start_bit=6*, end_bit=11*, source=Work_Zone[5], result=ExtData[1]->WorkLocal[10])
 17: 0x015C [0x07] ExtData[1]->WorkLocal[10] += 64*
 18: 0x0161 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[6], result=ExtData[1]->WorkLocal[13])
 19: 0x016A [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=31*, source=Work_Zone[6], result=ExtData[1]->WorkLocal[18])
 20: 0x0173 [0x03] ExtData[1]->WorkLocal[33] = Work_Zone[7]
 21: 0x0178 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=5*, source=Work_Zone[8], result=ExtData[1]->WorkLocal[11])
 22: 0x0181 [0x41] GET_BIT_WORK_RANGE(start_bit=6*, end_bit=11*, source=Work_Zone[8], result=ExtData[1]->WorkLocal[12])
