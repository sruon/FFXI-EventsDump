...
SUBROUTINE_019B:
 ...
 29: 0x01A3 [0x24] CREATE_DIALOG(message_id=11539*, default_option=0*, option_flags=0*)
 ...
 34: 0x01BD [0x1D] PRINT_EVENT_MESSAGE(message_id=11543*)
 ...
 36: 0x01C1 [0x24] CREATE_DIALOG(message_id=11544*, default_option=1*, option_flags=0*)
    → "Final answer... [Yes./No.]"
...
SUBROUTINE_01E8:
 ...
 48: 0x01FA [0x1D] PRINT_EVENT_MESSAGE(message_id=11550*)
 ...
 56: 0x021C [0x1D] PRINT_EVENT_MESSAGE(message_id=11551*)
 ...
 59: 0x0223 [0x1D] PRINT_EVENT_MESSAGE(message_id=11548*)
...
SUBROUTINE_0227:
 ...
 64: 0x0237 [0x1D] PRINT_EVENT_MESSAGE(message_id=11552*)
 ...
 68: 0x0246 [0x1D] PRINT_EVENT_MESSAGE(message_id=11529*)
    → "Pankration (pan-krat-ee-on) is a battle venue in which you can "pit" your very own monsters against the monsters of others."
 69: 0x0249 [0x23] WAIT_FOR_DIALOG_INTERACTION
 70: 0x024A [0x1D] PRINT_EVENT_MESSAGE(message_id=11530*)
    → "By participating in these battles, your monster will gain experience points and become stronger, just as you do when fighting fiends."
 71: 0x024D [0x23] WAIT_FOR_DIALOG_INTERACTION
 72: 0x024E [0x03] Work_Zone[4] = ExtData[1]->WorkLocal[3]
 73: 0x0253 [0x1D] PRINT_EVENT_MESSAGE(message_id=11531*)
    → "After each battle, you must speak with a registration official in order to reflect the results of the previous match. Battle results will only be saved for $2 [day/days] (Earth time), after which they will become void, so it is recommended that you complete this task immediately after a match has ended."
 ...
 78: 0x026A [0x1D] PRINT_EVENT_MESSAGE(message_id=11532*)
    → "Currently, we are holding a Pankration tournament."
 79: 0x026D [0x23] WAIT_FOR_DIALOG_INTERACTION
 80: 0x026E [0x1D] PRINT_EVENT_MESSAGE(message_id=11533*)
    → "The rules are simple--only the winners of their respective battles advance to the next fight, with the final monster standing declared the victor."
 ...
 84: 0x027D [0x1D] PRINT_EVENT_MESSAGE(message_id=11534*)
    → "Currently, we are conducting versus battles."
 85: 0x0280 [0x23] WAIT_FOR_DIALOG_INTERACTION
 86: 0x0281 [0x1D] PRINT_EVENT_MESSAGE(message_id=11535*)
    → "These are basic matches pitting one monster against another, with the winner taking all."
 87: 0x0284 [0x23] WAIT_FOR_DIALOG_INTERACTION
 88: 0x0285 [0x1D] PRINT_EVENT_MESSAGE(message_id=11536*)
    → "If you apply as a two-person party, you will be able to reserve a registration slot for him or her, ensuring that your monster will be pit against that of your party member."
 ...
 92: 0x0294 [0x1D] PRINT_EVENT_MESSAGE(message_id=11537*)
    → "Currently, we are conducting group battles."
 93: 0x0297 [0x23] WAIT_FOR_DIALOG_INTERACTION
 94: 0x0298 [0x1D] PRINT_EVENT_MESSAGE(message_id=11538*)
    → "Group battles are three-on-three melees which require adventurers to register small parties of monsters to fight in the Pit."
...
SUBROUTINE_02F5:
 ...
 22: 0x0335 [0x1D] PRINT_EVENT_MESSAGE(message_id=11525*)
    → "Welcome to the Pit. If you have any questions regarding Pankration, I'm the one to ask."
 23: 0x0338 [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_0339:
 24: 0x0339 [0x02] IF !(ExtData[1]->WorkLocal[4] == 0*) GOTO 0x040C
 25: 0x0341 [0x24] CREATE_DIALOG(message_id=11540*, default_option=0*, option_flags=0*)
 ...
 28: 0x0351 [0x1D] PRINT_EVENT_MESSAGE(message_id=11542*)
 ...
 33: 0x0367 [0x1D] PRINT_EVENT_MESSAGE(message_id=11550*)
    → "I'm sorry. It seems your opponent has yet to complete the registration process."
 ...
 41: 0x0389 [0x1D] PRINT_EVENT_MESSAGE(message_id=11551*)
    → "`Opponent Data` Name: $0$0 Family: $2 Level: Approximately $3"
 42: 0x038C [0x23] WAIT_FOR_DIALOG_INTERACTION
 43: 0x038D [0x01] GOTO 0x0394
 44: 0x0390 [0x1D] PRINT_EVENT_MESSAGE(message_id=11548*)
    → "`Opponent Data` Name: $0$0 Family: $2 Level: $3"
...
SUBROUTINE_0394:
 ...
 48: 0x039F [0x1D] PRINT_EVENT_MESSAGE(message_id=11529*)
    → "Pankration (pan-krat-ee-on) is a battle venue in which you can "pit" your very own monsters against the monsters of others."
 49: 0x03A2 [0x23] WAIT_FOR_DIALOG_INTERACTION
 50: 0x03A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=11530*)
    → "By participating in these battles, your monster will gain experience points and become stronger, just as you do when fighting fiends."
 51: 0x03A6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 52: 0x03A7 [0x03] Work_Zone[4] = ExtData[1]->WorkLocal[3]
 53: 0x03AC [0x1D] PRINT_EVENT_MESSAGE(message_id=11531*)
    → "After each battle, you must speak with a registration official in order to reflect the results of the previous match. Battle results will only be saved for $2 [day/days] (Earth time), after which they will become void, so it is recommended that you complete this task immediately after a match has ended."
 ...
 58: 0x03C3 [0x1D] PRINT_EVENT_MESSAGE(message_id=11532*)
    → "Currently, we are holding a Pankration tournament."
 59: 0x03C6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 60: 0x03C7 [0x1D] PRINT_EVENT_MESSAGE(message_id=11533*)
    → "The rules are simple--only the winners of their respective battles advance to the next fight, with the final monster standing declared the victor."
 ...
 64: 0x03D6 [0x1D] PRINT_EVENT_MESSAGE(message_id=11534*)
    → "Currently, we are conducting versus battles."
 65: 0x03D9 [0x23] WAIT_FOR_DIALOG_INTERACTION
 66: 0x03DA [0x1D] PRINT_EVENT_MESSAGE(message_id=11535*)
    → "These are basic matches pitting one monster against another, with the winner taking all."
 67: 0x03DD [0x23] WAIT_FOR_DIALOG_INTERACTION
 68: 0x03DE [0x1D] PRINT_EVENT_MESSAGE(message_id=11536*)
    → "If you apply as a two-person party, you will be able to reserve a registration slot for him or her, ensuring that your monster will be pit against that of your party member."
 ...
 72: 0x03ED [0x1D] PRINT_EVENT_MESSAGE(message_id=11537*)
    → "Currently, we are conducting group battles."
 73: 0x03F0 [0x23] WAIT_FOR_DIALOG_INTERACTION
 74: 0x03F1 [0x1D] PRINT_EVENT_MESSAGE(message_id=11538*)
    → "Group battles are three-on-three melees which require adventurers to register small parties of monsters to fight in the Pit."
...
SUBROUTINE_0468:
 ...
 21: 0x047A [0x1D] PRINT_EVENT_MESSAGE(message_id=11525*)
    → "Welcome to the Pit. If you have any questions regarding Pankration, I'm the one to ask."
...
SUBROUTINE_047E:
 ...
 25: 0x048B [0x24] CREATE_DIALOG(message_id=11541*, default_option=0*, option_flags=Work_Zone[5])
 ...
 28: 0x049B [0x1D] PRINT_EVENT_MESSAGE(message_id=11553*)
 ...
 32: 0x04AA [0x1D] PRINT_EVENT_MESSAGE(message_id=11554*)
 ...
 34: 0x04AE [0x1D] PRINT_EVENT_MESSAGE(message_id=11555*)
 ...
 40: 0x04C5 [0x1D] PRINT_EVENT_MESSAGE(message_id=11529*)
    → "Pankration (pan-krat-ee-on) is a battle venue in which you can "pit" your very own monsters against the monsters of others."
 41: 0x04C8 [0x23] WAIT_FOR_DIALOG_INTERACTION
 42: 0x04C9 [0x1D] PRINT_EVENT_MESSAGE(message_id=11530*)
    → "By participating in these battles, your monster will gain experience points and become stronger, just as you do when fighting fiends."
 43: 0x04CC [0x23] WAIT_FOR_DIALOG_INTERACTION
 44: 0x04CD [0x03] Work_Zone[4] = ExtData[1]->WorkLocal[3]
 45: 0x04D2 [0x1D] PRINT_EVENT_MESSAGE(message_id=11531*)
    → "After each battle, you must speak with a registration official in order to reflect the results of the previous match. Battle results will only be saved for $2 [day/days] (Earth time), after which they will become void, so it is recommended that you complete this task immediately after a match has ended."
 ...
 50: 0x04E9 [0x1D] PRINT_EVENT_MESSAGE(message_id=11532*)
    → "Currently, we are holding a Pankration tournament."
 51: 0x04EC [0x23] WAIT_FOR_DIALOG_INTERACTION
 52: 0x04ED [0x1D] PRINT_EVENT_MESSAGE(message_id=11533*)
    → "The rules are simple--only the winners of their respective battles advance to the next fight, with the final monster standing declared the victor."
 ...
 56: 0x04FC [0x1D] PRINT_EVENT_MESSAGE(message_id=11534*)
    → "Currently, we are conducting versus battles."
 57: 0x04FF [0x23] WAIT_FOR_DIALOG_INTERACTION
 58: 0x0500 [0x1D] PRINT_EVENT_MESSAGE(message_id=11535*)
    → "These are basic matches pitting one monster against another, with the winner taking all."
 59: 0x0503 [0x23] WAIT_FOR_DIALOG_INTERACTION
 60: 0x0504 [0x1D] PRINT_EVENT_MESSAGE(message_id=11536*)
    → "If you apply as a two-person party, you will be able to reserve a registration slot for him or her, ensuring that your monster will be pit against that of your party member."
 ...
 64: 0x0513 [0x1D] PRINT_EVENT_MESSAGE(message_id=11537*)
    → "Currently, we are conducting group battles."
 65: 0x0516 [0x23] WAIT_FOR_DIALOG_INTERACTION
 66: 0x0517 [0x1D] PRINT_EVENT_MESSAGE(message_id=11538*)
    → "Group battles are three-on-three melees which require adventurers to register small parties of monsters to fight in the Pit."
...
```
 ...
 11: 0x0567 [0x1D] PRINT_EVENT_MESSAGE(message_id=11567*)
    → "`Registration Application` Name: $0$0 Family: $2 Level: $3"
 12: 0x056A [0x23] WAIT_FOR_DIALOG_INTERACTION
 13: 0x056B [0x1D] PRINT_EVENT_MESSAGE(message_id=11568*)
 ...
 16: 0x0574 [0x24] CREATE_DIALOG(message_id=11569*, default_option=1*, option_flags=0*)
...
```
  ...
  9: 0x05CD [0x1D] PRINT_EVENT_MESSAGE(message_id=11556*)
...
```
  ...
  2: 0x06F7 [0x1D] PRINT_EVENT_MESSAGE(message_id=11561*)
  ...
  4: 0x06FB [0x1D] PRINT_EVENT_MESSAGE(message_id=11562*)
  ...
  6: 0x06FF [0x24] CREATE_DIALOG(message_id=11563*, default_option=1*, option_flags=0*)
 ...
 11: 0x0715 [0x1D] PRINT_EVENT_MESSAGE(message_id=11564*)
 ...
 16: 0x0729 [0x1D] PRINT_EVENT_MESSAGE(message_id=11565*)
...
```
 ...
 11: 0x0765 [0x1D] PRINT_EVENT_MESSAGE(message_id=11567*)
    → "`Registration Application` Name: $0$0 Family: $2 Level: $3"
 12: 0x0768 [0x23] WAIT_FOR_DIALOG_INTERACTION
 13: 0x0769 [0x1D] PRINT_EVENT_MESSAGE(message_id=11575*)
 ...
 16: 0x0772 [0x24] CREATE_DIALOG(message_id=11576*, default_option=0*, option_flags=0*)
...
```
 ...
 11: 0x07DA [0x1D] PRINT_EVENT_MESSAGE(message_id=11567*)
    → "`Registration Application` Name: $0$0 Family: $2 Level: $3"
 12: 0x07DD [0x23] WAIT_FOR_DIALOG_INTERACTION
 13: 0x07DE [0x1D] PRINT_EVENT_MESSAGE(message_id=11579*)
 ...
 16: 0x07E7 [0x24] CREATE_DIALOG(message_id=11580*, default_option=1*, option_flags=0*)
