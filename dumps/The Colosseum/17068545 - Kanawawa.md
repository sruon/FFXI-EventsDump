...
- **11701**: Do you wish to move to another cage?
- **11702**: Move to where? [Quit./Battle Cage "Annihilation"./Battle Cage "Bloodlust"./Battle Cage "Carnage"./Battle Cage "Diablo".]
...
```
  ...
  4: 0x0015 [0x1D] PRINT_EVENT_MESSAGE(message_id=11701*)
    → "Do you wish to move to another cage?"
  5: 0x0018 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0019 [0x24] CREATE_DIALOG(message_id=11702*, default_option=0*, option_flags=ExtData[1]->WorkLocal[1])
