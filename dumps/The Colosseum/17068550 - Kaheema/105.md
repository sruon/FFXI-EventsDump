...
```
  ...
  2: 0x05A4 [0x41] GET_BIT_WORK_RANGE(start_bit=30*, end_bit=31*, source=Work_Zone[2], result=ExtData[1]->WorkLocal[6])
  3: 0x05AD [0x03] ExtData[1]->WorkLocal[7] = Work_Zone[9]
  4: 0x05B2 [0x41] GET_BIT_WORK_RANGE(start_bit=23*, end_bit=29*, source=Work_Zone[2], result=ExtData[1]->WorkLocal[8])
