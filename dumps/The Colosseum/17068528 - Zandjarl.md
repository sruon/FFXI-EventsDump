...
- **11506**: Welcome to the Pit Stop! If you're thinking of doing anything other than just watching, you'll need jettons...and lots of them!
- **11507**: What can I do you for? [I'd like to browse your wares./I need jettons...and lots of them!/What in Altana's name is a jetton?/Absolutely nothing.]
- **11508**: "Jetton" is just some fancy Elvaan word for token, which is just some fancy Tarutaru word for money that can't be used anywhere but here in the Pit. And I don't care how big your wallet is, Pankration participants are only allowed to carry up to $0. Period.
- **11509**: Anyway, with jettons you can forge $1, buy items like $0, and probably do lots of other keen things such as...ah, but I've said too much already.
- **11510**: "But how do I get my hands on this magic cash," [he/she] asks. Well, that's an easy question--you purchase it from me, but I only take Imperial currency.
- **11512**: The current exchange rate is: 1 $0 = $2 [jetton/jettons] 1 $1 = $3 [jetton/jettons]
- **11513**: 1 $0 = $2 [jetton/jettons] 1 $1 = $3 [jetton/jettons]
- **11514**: Browse which items? [$0-jetton items./$1-jetton items./$2-jetton items./Quit.]
- **11515**: Purchase which item? [$0./$1./$2./$3./Quit./Return.]
- **11516**: Purchase which item? [$0./12 $1./$2./$3./Quit./Return.]
- **11517**: Do you really wish to purchase this $0?
- **11518**: Do you really wish to purchase this set of $0?
- **11519**: You can still back out... [No. Give me my item!/I didn't need anything anyway!/Wait! I'm still looking!]
- **11520**: Let's see... It says here that you currently have $0 [jetton/jettons].
- **11521**: Whoa there. You don't have enough jettons to purchase that.
- **11522**: Thanks for stopping by. I'll be seeing you around, <Player>!
...
```
  ...
  4: 0x0015 [0x1D] PRINT_EVENT_MESSAGE(message_id=11506*)
  ...
  7: 0x0021 [0x24] CREATE_DIALOG(message_id=11507*, default_option=0*, option_flags=0*)
 ...
 11: 0x0036 [0x1D] PRINT_EVENT_MESSAGE(message_id=11520*)
 ...
 19: 0x0059 [0x24] CREATE_DIALOG(message_id=11514*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00C9:
 ...
 49: 0x00EB [0x1D] PRINT_EVENT_MESSAGE(message_id=11512*)
 ...
 55: 0x0103 [0x1D] PRINT_EVENT_MESSAGE(message_id=11513*)
 ...
 60: 0x0117 [0x1D] PRINT_EVENT_MESSAGE(message_id=11508*)
 ...
 64: 0x0125 [0x1D] PRINT_EVENT_MESSAGE(message_id=11509*)
 ...
 66: 0x0129 [0x1D] PRINT_EVENT_MESSAGE(message_id=11510*)
...
SUBROUTINE_01AF:
 94: 0x01AF [0x24] CREATE_DIALOG(message_id=11515*, default_option=0*, option_flags=ExtData[1]->WorkLocal[4])
...
SUBROUTINE_0292:
137: 0x0292 [0x24] CREATE_DIALOG(message_id=11516*, default_option=0*, option_flags=ExtData[1]->WorkLocal[4])
...
206: 0x03F0 [0x24] CREATE_DIALOG(message_id=11519*, default_option=1*, option_flags=0*)
...
211: 0x0409 [0x1D] PRINT_EVENT_MESSAGE(message_id=11522*)
