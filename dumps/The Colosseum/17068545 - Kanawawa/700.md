...
SUBROUTINE_002C:
 ...
 12: 0x0035 [0xAD] DUAL_ENTITY_SCHEDULER: Execute sub-case 0 with entities [EventEntity, LocalPlayer], param=25*
 13: 0x0041 [0x1C] WAIT(200* ticks)
 14: 0x0044 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 26: 0x008C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 27: 0x009D [0x01] GOTO 0x01FC

SUBROUTINE_00A0:
 28: 0x00A0 [0x02] IF !(Work_Zone[0] == 2*) GOTO 0x0114
 29: 0x00A8 [0x42] SET_CLI_EVENT_CANCEL_DATA()
 30: 0x00A9 [0xAD] DUAL_ENTITY_SCHEDULER: Execute sub-case 0 with entities [EventEntity, LocalPlayer], param=25*
 31: 0x00B5 [0x1C] WAIT(200* ticks)
 32: 0x00B8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 44: 0x0100 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 45: 0x0111 [0x01] GOTO 0x01FC

SUBROUTINE_0114:
 46: 0x0114 [0x02] IF !(Work_Zone[0] == 3*) GOTO 0x0188
 47: 0x011C [0x42] SET_CLI_EVENT_CANCEL_DATA()
 48: 0x011D [0xAD] DUAL_ENTITY_SCHEDULER: Execute sub-case 0 with entities [EventEntity, LocalPlayer], param=25*
 49: 0x0129 [0x1C] WAIT(200* ticks)
 50: 0x012C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 62: 0x0174 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 63: 0x0185 [0x01] GOTO 0x01FC

SUBROUTINE_0188:
 64: 0x0188 [0x02] IF !(Work_Zone[0] == 4*) GOTO 0x01FC
 65: 0x0190 [0x42] SET_CLI_EVENT_CANCEL_DATA()
 66: 0x0191 [0xAD] DUAL_ENTITY_SCHEDULER: Execute sub-case 0 with entities [EventEntity, LocalPlayer], param=25*
 67: 0x019D [0x1C] WAIT(200* ticks)
 68: 0x01A0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 80: 0x01E8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
