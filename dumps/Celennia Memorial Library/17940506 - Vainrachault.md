...
- **7695**: This particular tome describes a certain type of vegetation labeled by scholars as the "Ulbukan Greatwood."
- **7696**: Supposedly there existed a certain tree of stupendous height some-odd centuries ago. At least that is what leading researchers in the field propose.
- **7697**: They cite the myriad roots of abnormal size scattered across the continent as proof, but I would personally like to see some more evidence before forming my own conclusions...
...
```
  ...
  4: 0x0009 [0x1D] PRINT_EVENT_MESSAGE(message_id=7697*)
