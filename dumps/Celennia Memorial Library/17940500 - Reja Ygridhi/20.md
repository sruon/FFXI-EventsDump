...
```
  ...
  5: 0x01BD [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=68*, entity1=EventEntity, entity2=EventEntity, action="tlb0")
...
SUBROUTINE_0225:
 ...
 27: 0x022D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=54*, entity1=EventEntity, entity2=EventEntity, action="pas0")
 28: 0x023C [0x1C] WAIT(120* ticks)
 29: 0x023F [0x03] Work_Zone[1] = ExtData[1]->WorkLocal[0]
 30: 0x0244 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="qstc", work_offset2=0*)
