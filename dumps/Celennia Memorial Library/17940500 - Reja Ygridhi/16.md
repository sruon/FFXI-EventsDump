...
```
  ...
  4: 0x03EC [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=68*, entity1=EventEntity, entity2=EventEntity, action="tlb0")
  ...
  7: 0x03FF [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=68*, entity1=EventEntity, entity2=EventEntity, action="tlb1")
...
SUBROUTINE_043D:
 ...
 20: 0x044C [0x24] CREATE_DIALOG(message_id=7672*, default_option=0*, option_flags=0x06)
...
SUBROUTINE_045F:
 ...
 37: 0x049B [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="qstc", work_offset2=0*)
 38: 0x04AC [0x21] END_EVENT
 39: 0x04AD [0x00] END_REQSTACK()

SUBROUTINE_04B1:
 40: 0x04B1 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x04BC
 41: 0x04B9 [0x01] GOTO 0x04BC

SUBROUTINE_04BC:
 42: 0x04BC [0x02] IF !(ExtData[1]->WorkLocal[4] == 13*) GOTO 0x050B
 43: 0x04C4 [0x03] ExtData[1]->WorkLocal[4] = Work_Zone[0]
 44: 0x04C9 [0x03] Work_Zone[2] = 1*
 45: 0x04CE [0x1D] PRINT_EVENT_MESSAGE(message_id=7674*)
    → "Hmph.\u0007You really want \u000C\u0000[that/bayld/kinetic units]? Now's your last chance to rrreconsider.\u007F1\u0000\u0007"
 46: 0x04D1 [0x23] WAIT_FOR_DIALOG_INTERACTION
 47: 0x04D2 [0x24] CREATE_DIALOG(message_id=7675*, default_option=1*, option_flags=0*)
    → "Keep what you chose?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
 48: 0x04D9 [0x25] WAIT_DIALOG_SELECT()
 49: 0x04DA [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x0500
 50: 0x04E2 [0x0B] ExtData[1]->WorkLocal[4]++
 51: 0x04E5 [0x03] Work_Zone[1] = ExtData[1]->WorkLocal[4]
 52: 0x04EA [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="qstc", work_offset2=0*)
 53: 0x04FB [0x21] END_EVENT
 54: 0x04FC [0x00] END_REQSTACK()

SUBROUTINE_0500:
 55: 0x0500 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x050B
 56: 0x0508 [0x01] GOTO 0x050B

SUBROUTINE_050B:
 57: 0x050B [0x02] IF !(ExtData[1]->WorkLocal[4] == 14*) GOTO 0x055A
 58: 0x0513 [0x03] ExtData[1]->WorkLocal[4] = Work_Zone[0]
 59: 0x0518 [0x03] Work_Zone[2] = 2*
 60: 0x051D [0x1D] PRINT_EVENT_MESSAGE(message_id=7674*)
    → "Hmph.\u0007You really want \u000C\u0000[that/bayld/kinetic units]? Now's your last chance to rrreconsider.\u007F1\u0000\u0007"
 61: 0x0520 [0x23] WAIT_FOR_DIALOG_INTERACTION
 62: 0x0521 [0x24] CREATE_DIALOG(message_id=7675*, default_option=1*, option_flags=0*)
    → "Keep what you chose?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
 63: 0x0528 [0x25] WAIT_DIALOG_SELECT()
 64: 0x0529 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x054F
 65: 0x0531 [0x0B] ExtData[1]->WorkLocal[4]++
 66: 0x0534 [0x03] Work_Zone[1] = ExtData[1]->WorkLocal[4]
 67: 0x0539 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="qstc", work_offset2=0*)
 68: 0x054A [0x21] END_EVENT
 69: 0x054B [0x00] END_REQSTACK()

SUBROUTINE_054F:
 70: 0x054F [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x055A
 71: 0x0557 [0x01] GOTO 0x055A

SUBROUTINE_055A:
 72: 0x055A [0x02] IF !(ExtData[1]->WorkLocal[4] == 15*) GOTO 0x0571
 73: 0x0562 [0x1D] PRINT_EVENT_MESSAGE(message_id=7676*)
    → "I knew you'd pussyfoot around in the end.\u0007Just tell me what you want when you finally get arrround to deciding.\u007F1\u0000\u0007"
 74: 0x0565 [0x23] WAIT_FOR_DIALOG_INTERACTION
 75: 0x0566 [0x05] ExtData[1]->WorkLocal[5] = 1
 76: 0x0569 [0x0B] ExtData[1]->WorkLocal[4]++
 77: 0x056C [0x03] Work_Zone[1] = ExtData[1]->WorkLocal[4]
 78: 0x0571 [0x01] GOTO 0x0417

SUBROUTINE_0574:
 79: 0x0574 [0x21] END_EVENT
 80: 0x0575 [0x00] END_REQSTACK()
```
