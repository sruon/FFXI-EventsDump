...
| [65535.73](#event-6553573) | 0x049F       |     35 |              4 |
| [46](#event-46)            | 0x04C2       |      7 |              2 |
| [65535.74](#event-6553574) | 0x04C9       |     22 |              8 |
...
|      12 | 0x002E      |          46 |
|      13 | 0x0808      |        2056 |
|      14 | 0xFFFF1716  |  4294907670 |
|      15 | 0xFFFFE42E  |  4294960174 |
|      16 | 0x2F57      |       12119 |
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0480:    5B 0D 80 F8 FF FF 7F  F8 FF FF 7F 6B 72 61 31   [..........kra1
0490: 00                                                .               
```
...
```
  0: 0x0481 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "kra1" with entities [EventEntity, EventEntity], work=2056*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0490:    53 F8 FF FF 7F F8 FF  FF 7F 6B 72 61 31 00      S........kra1. 
```

#### Opcodes

```
  0: 0x0491 [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "kra1" with entities [EventEntity, EventEntity]
...
```
  0: 0x049F [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "mdq2" with entities [EventEntity, EventEntity], work=46*
  1: 0x04AE [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "mdq2" with entities [EventEntity, EventEntity]
...
```
  0: 0x04C2 [0x92] EventEntity->Render.Flags3 ^= 0x01
