...
| [202](#event-202)     | 0x00DB       |      1 |              1 |
| [203](#event-203)     | 0x00DC       |      1 |              1 |
| [204](#event-204)     | 0x00DD       |      1 |              1 |
| [205](#event-205)     | 0x00DE       |      1 |              1 |
| [206](#event-206)     | 0x00DF       |      1 |              1 |
| [207](#event-207)     | 0x00E0       |      1 |              1 |
...
- **7696**: An unseen force is drawing you towards the maw.
- **7698**: Warp to [Dummy/the La Theine Plateau/the Konschtat Highlands/the Tahrongi Canyon/the Buburimu Peninsula/the Valkurm Dunes/the Jugner Forest/South Gustaberg/North Gustaberg/Xarcabard/Qufim Island]? [Proceed./Not yet.]
...
0040: 01 F0 FF FF 7F 0E 45 08  80 F0 FF FF 7F F0 FF FF  ......E.........
0050: 7F 6F 75 74 30 04 80 45  05 80 F0 FF FF 7F F0 FF  .out0..E........
...
00B0: 01 F0 FF FF 7F 0F 45 05  80 F0 FF FF 7F F0 FF FF  ......E.........
...
```
  ...
  1: 0x0003 [0x48] [System] [7696*]:
    → "An unseen force is drawing you towards the maw."
  2: 0x0006 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0007 [0x03] Work_Zone[2] = 10*
  4: 0x000C [0x24] CREATE_DIALOG(message_id=7698*, default_option=1*, option_flags=0*)
 ...
 15: 0x003F [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x0E)
 16: 0x0046 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "out0" with entities [LocalPlayer, LocalPlayer], work=[560*, 0*]
 ...
 23: 0x00AF [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x0F)
