...
- **7717**: .........listen......
- **7718**: Oh...... ...outta here.........
- **8098**: Do you want to hear a story? [No, thank you./Let's hear one.]
- **8099**: What story would you like to be told? [On second thought, maybe later./The Wyrm God(pt.1)./The Wyrm God(pt.2)./The Wyrm God(pt.3)./Meanwhile, Back on Abyssea./A Moonlight Requite.]
- **8100**: 
- **8101**: 
- **8102**: 
...
```
 ...
 30: 0x00A7 [0x24] CREATE_DIALOG(message_id=8098*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00B7:
 33: 0x00B7 [0x24] CREATE_DIALOG(message_id=8099*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_00FB:
 44: 0x00FB [0x24] CREATE_DIALOG(message_id=8100*, default_option=0*, option_flags=Work_Zone[3])
    → ""
...
SUBROUTINE_013F:
 55: 0x013F [0x24] CREATE_DIALOG(message_id=8101*, default_option=0*, option_flags=Work_Zone[4])
    → ""
...
SUBROUTINE_0183:
 66: 0x0183 [0x24] CREATE_DIALOG(message_id=8102*, default_option=0*, option_flags=Work_Zone[5])
    → ""
