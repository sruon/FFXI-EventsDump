...
```
 ...
 30: 0x00A7 [0x24] CREATE_DIALOG(message_id=8093*, default_option=0*, option_flags=0x00)
...
SUBROUTINE_00B7:
 33: 0x00B7 [0x24] CREATE_DIALOG(message_id=8094*, default_option=0*, option_flags=0x1002)
...
SUBROUTINE_00FB:
 44: 0x00FB [0x24] CREATE_DIALOG(message_id=8095*, default_option=0*, option_flags=0x1003)
    → "\u007F1\u0000\u0007"
...
SUBROUTINE_013F:
 55: 0x013F [0x24] CREATE_DIALOG(message_id=8096*, default_option=0*, option_flags=0x1004)
    → "\u007F1\u0000\u0007"
...
SUBROUTINE_0183:
 66: 0x0183 [0x24] CREATE_DIALOG(message_id=8097*, default_option=0*, option_flags=0x1005)
    → "\u007F1\u0000\u0007"
