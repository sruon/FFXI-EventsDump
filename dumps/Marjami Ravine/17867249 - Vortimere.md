...
| [65535.1](#event-655351) | 0x0004       |     19 |              5 |
...
```
  ...
  1: 0x0007 [0x1F] MOVE_ENTITY: EventEntity moves to X=65.571*, Z=-100.167*, Y=21.110*
  2: 0x000F [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x0011 [0x1E] EventEntity looks at Nashu (ID: 17867237/0x0110A1E5) and starts talking
