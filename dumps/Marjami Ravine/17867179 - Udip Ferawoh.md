...
- **7777**: Isn't this just wonderrrful? First the Velkk get in my way, and now thorn-covered ivy. The thought of those two together makes my fur stand on end.
- **7778**: Speaking of those beasts, keep your claws sharrrp. They've been known to wander up to the station from time to time.
- **7779**: Those cursed Velkk, always showing up to rrruin a good time.
- **7780**: If only you had $6, you might be able to lend a girrrl a hand...
- **7781**: You there, pioneer! You may have your paws full with some colonization prrroject or other, but I've got a small task for you.
- **7782**: No doubt you're familiar with the brrrutishness of the Velkk--but the ones here are a bit smarter than the rest.
- **7783**: Not only do they assault us with weapons and spells, but these annoyances even plant spinescent protuberances to impede our prrrogress!
- **7784**: One of the things damn near tore my tail to shrrreds! We've got to do something about it!
- **7785**: I rrresearched as much as I could, but there's a limit to how much can be done by myself.
- **7786**: My team suggested that since pioneers make a living going against the forces of nature, maybe we could hire one to deal with this prrrickly issue.
- **7787**: I know this idea must sound like claws scrrratching against metal, but I want you to suffer an amnesic attack from one of those things.
- **7788**: Did I say "an" amnesic attack? Because I meant five. That should do the trrrick.
- **7789**: Pioneers are grrreat for doing my dirty...I mean helping out those in need. In this case, what I need is for you to learn more about spinescent protuberances.
- **7790**: Suffer five amnesic attacks from those things and then come back here. Come on--what's the worrrst that could happen?
...
```
  ...
  4: 0x0157 [0x1D] PRINT_EVENT_MESSAGE(message_id=7777*)
...
```
  ...
  4: 0x0184 [0x1D] PRINT_EVENT_MESSAGE(message_id=7778*)
...
```
  ...
  4: 0x01B1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7779*)
  ...
  7: 0x01BA [0x1D] PRINT_EVENT_MESSAGE(message_id=7780*)
...
```
  ...
  5: 0x01E0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7781*)
  ...
  7: 0x01E4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7782*)
 ...
 11: 0x01F6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7783*)
 ...
 15: 0x0208 [0x1D] PRINT_EVENT_MESSAGE(message_id=7784*)
 ...
 19: 0x021A [0x1D] PRINT_EVENT_MESSAGE(message_id=7785*)
 ...
 23: 0x022C [0x1D] PRINT_EVENT_MESSAGE(message_id=7786*)
 ...
 25: 0x0230 [0x1D] PRINT_EVENT_MESSAGE(message_id=7787*)
 ...
 29: 0x0242 [0x1D] PRINT_EVENT_MESSAGE(message_id=7788*)
...
```
  ...
  4: 0x0267 [0x1D] PRINT_EVENT_MESSAGE(message_id=7789*)
  ...
  6: 0x026B [0x1D] PRINT_EVENT_MESSAGE(message_id=7790*)
...
```
  ...
  4: 0x0290 [0x2B] Udip Ferawoh (ID: 17867179/0x0110A1AB) [7815*]:
  ...
  6: 0x0298 [0x2B] Udip Ferawoh (ID: 17867179/0x0110A1AB) [7816*]:
