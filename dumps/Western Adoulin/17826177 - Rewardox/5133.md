...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0540:                          42 1E 82 01 10 01 6F 70          B.....op
...
```
  ...
  1: 0x0549 [0x1E] EventEntity looks at Treasure Coffer (ID: 17826178/0x01100182) and starts talking
  ...
  6: 0x0560 [0x1D] PRINT_EVENT_MESSAGE(message_id=12817*)
