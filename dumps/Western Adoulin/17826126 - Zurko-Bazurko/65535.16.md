...
```
  ...
  3: 0x0232 [0x5F] MULTI_HANDLER_COMPLEX(mode=0x05 - Load ext scheduler with flag (OpCode 0x5B mode 0, flag 1), ref=References[34], entity1=EventEntity, entity2=EventEntity, string="gah2", extra=References[35])
