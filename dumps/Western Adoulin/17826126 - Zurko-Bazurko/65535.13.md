...
```
  0: 0x019C [0x5F] MULTI_HANDLER_COMPLEX(mode=0x06 - Load ext scheduler with flag (OpCode 0x5B mode 1, flag 1), ref=References[28], entity1=EventEntity, entity2=EventEntity, string="tlb1", extra=References[27])
