...
```
  0: 0x0073 [0x5F] MULTI_HANDLER_COMPLEX(mode=0x06 - Load ext scheduler with flag (OpCode 0x5B mode 1, flag 1), ref=References[21], entity1=EventEntity, entity2=EventEntity, string="pas0", extra=References[22])
