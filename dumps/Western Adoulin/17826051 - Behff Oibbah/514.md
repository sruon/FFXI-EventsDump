...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=9853*)
    → "You ever hear about rrrune fencers?\u007F1\u0000\u0007"
  5: 0x001A [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=9854*)
    → "They're accomplished sworrrdsmen who make use of runes to snuff out their enemies and empower their friends.\u0007Their techniques may have been passed down through the Order of Orvail for generrrations, but even I could use them if I stopped catting around for once.\u007F1\u0000\u0007"
