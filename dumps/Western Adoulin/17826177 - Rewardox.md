...
| [5138](#event-5138)      | 0x01D8       |    733 |            155 |
| [5132](#event-5132)      | 0x04B5       |    147 |             29 |
| [5133](#event-5133)      | 0x0548       |     30 |             10 |
| [5134](#event-5134)      | 0x0566       |     28 |              8 |
| [5135](#event-5135)      | 0x0582       |     28 |              8 |
| [65535.1](#event-655351) | 0x059E       |     28 |              8 |
| [5139](#event-5139)      | 0x05BA       |     93 |             23 |
| [5140](#event-5140)      | 0x0617       |     33 |             11 |
| [5141](#event-5141)      | 0x0638       |     28 |              8 |
| [5142](#event-5142)      | 0x0654       |     28 |              8 |
| [5143](#event-5143)      | 0x0670       |     33 |             11 |
...
- **12826**: Oy, would ya get a look at yer $0! I guess I can let ya open [/Dial 1/Dial 2/Dial 3/Dial 4/Dial 5/the special dial///the abjuration dial/the fortune dial/the furnishings dial//the Vana'versary dial] whenever ya want fer not a single onz o' daily tally!
- **12827**: Dun think that I's be a gil-grubbin' good-fer-nuthin'. If'n ya dun wanna open any dial, then I gives ya back yer $0.
- **12828**: Yer eyes be bigger'n yer stomach. If'n ya wanna open [/Dial 1/Dial 2/Dial 3/Dial 4/Dial 5/the Special Dial///the abjuration dial/the fortune dial/the furnishings dial//the Vana'versary dial] usin' yer $0, then ya gotta make room in yer bags!
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
04B0:                03 00 00  08 10 42 1E 82 01 10 01       .....B.....
04C0: 6F 70 2C 82 01 10 01 82  01 10 01 6F 70 65 32 5B  op,........ope2[
04D0: 00 80 F8 FF FF 7F F8 FF  FF 7F 70 61 73 30 53 F8  ..........pas0S.
04E0: FF FF 7F F8 FF FF 7F 70  61 73 30 2C 82 01 10 01  .......pas0,....
04F0: 82 01 10 01 63 6C 6F 73  53 82 01 10 01 82 01 10  ....closS.......
...
```
  ...
  2: 0x04BB [0x1E] EventEntity looks at Treasure Coffer (ID: 17826178/0x01100182) and starts talking
  ...
  5: 0x04C2 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "ope2" with entities [Treasure Coffer (ID: 17826178/0x01100182), Treasure Coffer (ID: 17826178/0x01100182)]
  ...
  8: 0x04EB [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "clos" with entities [Treasure Coffer (ID: 17826178/0x01100182), Treasure Coffer (ID: 17826178/0x01100182)]
  9: 0x04F8 [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "clos" with entities [Treasure Coffer (ID: 17826178/0x01100182), Treasure Coffer (ID: 17826178/0x01100182)]
 ...
 16: 0x0526 [0x1D] PRINT_EVENT_MESSAGE(message_id=12814*)
 ...
 20: 0x0535 [0x1D] PRINT_EVENT_MESSAGE(message_id=12815*)
...
```
  ...
  4: 0x057C [0x1D] PRINT_EVENT_MESSAGE(message_id=12818*)
...
```
  ...
  4: 0x0598 [0x1D] PRINT_EVENT_MESSAGE(message_id=12819*)
...
```
  ...
  4: 0x05B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=12822*)
...
```
  ...
  1: 0x05BB [0x7A] VM_CONTROL: Copy data from Unknown NPC (ID: 268534400/0x10018280) (params=1, 2)
  ...
  6: 0x05D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=12826*)
...
```
  ...
  5: 0x062E [0x1D] PRINT_EVENT_MESSAGE(message_id=12827*)
