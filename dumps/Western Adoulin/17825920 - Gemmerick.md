...
- **7170**: Welcome to the auction house. Do you have any questions about our establishment?
- **7171**: What do you want to know? [What is the auction house?/How are auctions run?/Are there any fees?/Are there any limits?/How do you check up on merchandise?/How do you remove an item?/My "Sales Status" list is full!/Nothing right now.]
- **7172**: Auction houses can be found in all of Vana'diel's major cities. Here adventurers gather to bid on battle spoils, unwanted items, old armor...almost anything.
- **7174**: Adventurers may use any auction house regardless of nationality.
- **7175**: The first adventurer to bid at or above the asking price will automatically purchase the product.
- **7176**: Once put up for auction, merchandise will remain there for a maximum of thirty weeks Vana'diel time (nine-and-a-half days Earth time).
- **7177**: If merchandise does not sell within this time limit, it will be returned to the seller's current residence.
- **7178**: Transaction fees are proportional to the amount for which an item is put up on auction. The method of calculating this fee is different for single items and stackable items.
- **7179**: A transaction fee is collected when any merchandise is put up for auction. This fee is nonrefundable.
- **7180**: The International Auction House Committee, or IAHC, has declared that a maximum of seven items may be put up for auction at one time.
- **7181**: However, the IAHC has recently removed the limit to how many items one may purchase.
- **7182**: A small amount of time is required before new merchandise appears on our bid list.
- **7183**: Once an item appears on your "Sales Status" list, it may not immediately appear on the bid list. If you do not see your item on the bid list, try looking again at a later time.
- **7184**: If you would like to withdraw an item from an auction, you must travel to the auction house, and select "Stop Sale" from the "Sales Status" menu.
- **7185**: To remove an item from your "Sales Status" list, you must visit an auction counter to acknowledge the sale or return of your merchandise.
- **7186**: Otherwise, previously sold or returned items will fill up your list and prevent you from selling any more merchandise.
- **7187**: At any auction counter, open the "Sales Status" menu and acknowledge the transaction to clear it from the list.
- **7188**: Press the confirm button to remove any transaction colored yellow (sold) or red (returned).
- **7189**: Is there anything else you would like to know?
- **7190**: In the past, many have amassed great wealth through the auction house. I hope you find fortune, too!
...
```
  ...
  2: 0x000A [0x1D] PRINT_EVENT_MESSAGE(message_id=7170*)
    → "Welcome to the auction house. Do you have any questions about our establishment?"
  3: 0x000D [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x000E [0x24] CREATE_DIALOG(message_id=7171*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
  ...
  7: 0x001E [0x1D] PRINT_EVENT_MESSAGE(message_id=7172*)
  ...
  9: 0x0022 [0x1D] PRINT_EVENT_MESSAGE(message_id=7174*)
 ...
 14: 0x0038 [0x1D] PRINT_EVENT_MESSAGE(message_id=7175*)
 ...
 16: 0x003C [0x1D] PRINT_EVENT_MESSAGE(message_id=7176*)
 ...
 18: 0x0040 [0x1D] PRINT_EVENT_MESSAGE(message_id=7177*)
 ...
 23: 0x0056 [0x1D] PRINT_EVENT_MESSAGE(message_id=7178*)
 ...
 25: 0x005A [0x1D] PRINT_EVENT_MESSAGE(message_id=7179*)
 ...
 30: 0x0070 [0x1D] PRINT_EVENT_MESSAGE(message_id=7180*)
 ...
 32: 0x0074 [0x1D] PRINT_EVENT_MESSAGE(message_id=7181*)
 ...
 37: 0x008A [0x1D] PRINT_EVENT_MESSAGE(message_id=7182*)
 ...
 39: 0x008E [0x1D] PRINT_EVENT_MESSAGE(message_id=7183*)
 ...
 44: 0x00A4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7184*)
 ...
 49: 0x00BA [0x1D] PRINT_EVENT_MESSAGE(message_id=7185*)
 ...
 51: 0x00BE [0x1D] PRINT_EVENT_MESSAGE(message_id=7186*)
 ...
 53: 0x00C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7187*)
 ...
 55: 0x00C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7188*)
 ...
 60: 0x00DC [0x1D] PRINT_EVENT_MESSAGE(message_id=7190*)
...
SUBROUTINE_00E4:
 63: 0x00E4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7189*)
