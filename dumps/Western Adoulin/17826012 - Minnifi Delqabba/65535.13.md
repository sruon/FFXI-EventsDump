...
```
  0: 0x0110 [0x5B] LOAD_EXT_SCHEDULER(work_offset=868*, entity1=EventEntity, entity2=EventEntity, action="yad0")
  1: 0x011F [0x1C] WAIT(180* ticks)
  2: 0x0122 [0x5B] LOAD_EXT_SCHEDULER(work_offset=1328*, entity1=EventEntity, entity2=EventEntity, action="iro1")
