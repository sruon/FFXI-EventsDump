...
| [531](#event-531)        | 0x0001       |     43 |              9 |
| [588](#event-588)        | 0x002C       |     43 |              9 |
| [5054](#event-5054)      | 0x0057       |      1 |              1 |
| [65535.1](#event-655351) | 0x0058       |     18 |              6 |
| [5062](#event-5062)      | 0x006A       |      1 |              1 |
| [65535.2](#event-655352) | 0x006B       |     27 |              7 |
| [65535.3](#event-655353) | 0x0086       |      4 |              2 |
| [65535.4](#event-655354) | 0x008A       |      2 |              2 |
| [5087](#event-5087)      | 0x008C       |      7 |              2 |
| [5088](#event-5088)      | 0x0093       |     51 |             15 |
| [5089](#event-5089)      | 0x00C6       |     68 |             19 |
| [5211](#event-5211)      | 0x010A       |      7 |              2 |
| [65535.5](#event-655355) | 0x0111       |     34 |              4 |
| [65535.6](#event-655356) | 0x0133       |     66 |             16 |
| [5098](#event-5098)      | 0x0175       |      1 |              1 |
| [209](#event-209)        | 0x0176       |      1 |              1 |
| [65535.7](#event-655357) | 0x0177       |     13 |              3 |
| [5223](#event-5223)      | 0x0184       |      7 |              2 |
| [5076](#event-5076)      | 0x018B       |      7 |              2 |
| [65535.8](#event-655358) | 0x0192       |     34 |              8 |
| [5077](#event-5077)      | 0x01B4       |     33 |              9 |
...
- **9517**: There is one undeniable truth about construction: that which is made can always be broken. However, I am confident in the durability of this piece.
- **9518**: As long as the boy makes sure to treat it with the proper care and respect, it should serve him well for many years to come.
- **9880**: ...It would behoove an outsider like you to register as a pioneer before entering our premises, but I will not force you to leave. Take a look around our facilities, but do not interfere with anyone's work.
- **9881**: It is imperative that you be able to properly use the tools with which we, the Inventors' Coalition, supply you. Otherwise, the colonization effort is doomed to fail.
- **10942**: Ah, <Player>. Amchuchu informed me that you would be assisting in her repair efforts. She requires $0, $1...
- **10943**: ...And $0. One of each, no more and no less.
- **10944**: Kindly trade them to me when you return.
- **10945**: Ah, most excellent. This should suffice.
- **10946**: I shall see that they are delivered to the appropriate personnel.
- **10947**: I know our maester asserted that she would have the letter done by the time you returned, but she has a slight penchant for hyperbole. I apologize for the delay, but I must request that you wait a little longer.
- **10948**: Amchuchu has likely finished composing her missive. A slight knock on the door should get her attention.
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=9880*)
...
0040: 6B 30 1D 02 80 23 66 00  80 F8 FF FF 7F F8 FF FF  k0...#f.........
0050: 7F 74 6C 6B 31 21 00                              .tlk1!.         
```
...
```
  ...
  4: 0x0042 [0x1D] PRINT_EVENT_MESSAGE(message_id=9881*)
...
0070: 08 80 09 80 06 80 1F 01  1F 00 0A 80 0B 80 06 80  ................
0080: 1F 01 39 0C 80 00                                 ..9...          
```
...
```
  ...
  1: 0x006E [0x1F] MOVE_ENTITY: EventEntity moves to X=91.900*, Z=-77.623*, Y=-0.651*
  2: 0x0076 [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x0078 [0x1F] MOVE_ENTITY: EventEntity moves to X=96.445*, Z=-82.430*, Y=-0.651*
  4: 0x0080 [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  5: 0x0082 [0x39] SET_ENTITY_DIRECTION(direction=2.8°*)
...
```
  0: 0x0086 [0x95] SETUP_EVENT_NPC: Prepare NPC for event (Render.Flags3 = 0*)
...
```
  ...
  6: 0x00B3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10942*)
  ...
  9: 0x00BC [0x1D] PRINT_EVENT_MESSAGE(message_id=10943*)
    → "...And $0. One of each, no more and no less."
 10: 0x00BF [0x23] WAIT_FOR_DIALOG_INTERACTION
 11: 0x00C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=10944*)
...
```
  ...
  7: 0x00ED [0x1D] PRINT_EVENT_MESSAGE(message_id=10945*)
    → "Ah, most excellent. This should suffice."
  8: 0x00F0 [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x00F1 [0x1D] PRINT_EVENT_MESSAGE(message_id=10946*)
 ...
 12: 0x00FD [0x1D] PRINT_EVENT_MESSAGE(message_id=10947*)
 ...
 15: 0x0104 [0x1D] PRINT_EVENT_MESSAGE(message_id=10948*)
...
```
  ...
  3: 0x01CB [0x1D] PRINT_EVENT_MESSAGE(message_id=9517*)
  ...
  5: 0x01CF [0x1D] PRINT_EVENT_MESSAGE(message_id=9518*)
