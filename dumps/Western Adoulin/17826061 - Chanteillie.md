...
- **9516**: There is one undeniable truth about construction: that which is made can always be broken. However, I am confident in the durability of this piece.
- **9517**: As long as the boy makes sure to treat it with the proper care and respect, it should serve him well for many years to come.
- **9879**: ...It would behoove an outsider like you to register as a pioneer before entering our premises, but I will not force you to leave. Take a look around our facilities, but do not interfere with anyone's work.
- **9880**: It is imperative that you be able to properly use the tools with which we, the Inventors' Coalition, supply you. Otherwise, the colonization effort is doomed to fail.
- **10941**: Ah, <Player>. Amchuchu informed me that you would be assisting in her repair efforts. She requires $0, $1...
- **10942**: ...And $0. One of each, no more and no less.
- **10943**: Kindly trade them to me when you return.
- **10944**: Ah, most excellent. This should suffice.
- **10945**: I shall see that they are delivered to the appropriate personnel.
- **10946**: I know our maester asserted that she would have the letter done by the time you returned, but she has a slight penchant for hyperbole. I apologize for the delay, but I must request that you wait a little longer.
- **10947**: Amchuchu has likely finished composing her missive. A slight knock on the door should get her attention.
...
```
  ...
  4: 0x0042 [0x1D] PRINT_EVENT_MESSAGE(message_id=9880*)
...
```
  ...
  6: 0x00B3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10941*)
  ...
  9: 0x00BC [0x1D] PRINT_EVENT_MESSAGE(message_id=10942*)
    → "...And $0. One of each, no more and no less."
 10: 0x00BF [0x23] WAIT_FOR_DIALOG_INTERACTION
 11: 0x00C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=10943*)
...
```
  ...
  7: 0x00ED [0x1D] PRINT_EVENT_MESSAGE(message_id=10944*)
    → "Ah, most excellent. This should suffice."
  8: 0x00F0 [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x00F1 [0x1D] PRINT_EVENT_MESSAGE(message_id=10945*)
 ...
 12: 0x00FD [0x1D] PRINT_EVENT_MESSAGE(message_id=10946*)
 ...
 15: 0x0104 [0x1D] PRINT_EVENT_MESSAGE(message_id=10947*)
...
```
  ...
  3: 0x01CB [0x1D] PRINT_EVENT_MESSAGE(message_id=9516*)
  ...
  5: 0x01CF [0x1D] PRINT_EVENT_MESSAGE(message_id=9517*)
