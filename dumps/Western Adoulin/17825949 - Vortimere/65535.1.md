...
0020: 05 80 03 80 1F 01 1F 00  06 80 07 80 08 80 1F 01  ................
0030: 00                                                .               
```
...
```
  ...
  1: 0x0012 [0x1F] MOVE_ENTITY: EventEntity moves to X=-158.235*, Z=-26.990*, Y=2.699*
  2: 0x001A [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x001C [0x1F] MOVE_ENTITY: EventEntity moves to X=-162.729*, Z=-26.996*, Y=2.699*
  4: 0x0024 [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  5: 0x0026 [0x1F] MOVE_ENTITY: EventEntity moves to X=-167.073*, Z=-27.037*, Y=3.580*
