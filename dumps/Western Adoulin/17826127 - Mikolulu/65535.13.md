...
```
  ...
  2: 0x01C5 [0x5F] MULTI_HANDLER_COMPLEX(mode=0x05 - Load ext scheduler with flag (OpCode 0x5B mode 0, flag 1), ref=References[25], entity1=EventEntity, entity2=EventEntity, string="ygo0", extra=References[26])
