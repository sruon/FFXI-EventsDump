...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=9835*)
    → "Most of the people around here work for the Couriers' Coalition, and I'm no exception.\u007F1\u0000\u0007"
  5: 0x001A [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=9836*)
    → "We import and export goods, make intercontinental deliveries, and provide supplies to pioneer facilities. I'm not a man of many words, so I'll leave it at that.\u007F1\u0000\u0007"
