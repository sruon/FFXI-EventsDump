...
```
  ...
  1: 0xB62C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  2: 0xB63D [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 14: 0xB694 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 15: 0xB6A5 [0x02] IF !(LocalPlayer->Race == 5*) GOTO 0xB6C1
 16: 0xB6AD [0x45] LOAD_SCHEDULED_TASK(work_offset1=782*, entity1=EventEntity, entity2=EventEntity, scheduler_id="st20", work_offset2=0*)
 17: 0xB6BE [0x01] GOTO 0xB6EE

SUBROUTINE_B6C1:
 18: 0xB6C1 [0x02] IF !(LocalPlayer->Race == 6*) GOTO 0xB6DD
 19: 0xB6C9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=782*, entity1=EventEntity, entity2=EventEntity, scheduler_id="st20", work_offset2=0*)
 20: 0xB6DA [0x01] GOTO 0xB6EE

SUBROUTINE_B6DD:
 21: 0xB6DD [0x45] LOAD_SCHEDULED_TASK(work_offset1=782*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s020", work_offset2=0*)
 ...
 28: 0xB70D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Midras (ID: 17826030/0x011000EE), entity2=Midras (ID: 17826030/0x011000EE), action="tlk0")
 ...
 32: 0xB727 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=9*, entity1=Midras (ID: 17826030/0x011000EE), entity2=Midras (ID: 17826030/0x011000EE), action="tlk1")
 33: 0xB736 [0x1C] WAIT(30* ticks)
 34: 0xB739 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=71*, entity1=Midras (ID: 17826030/0x011000EE), entity2=Midras (ID: 17826030/0x011000EE), action="pas0")
 ...
 38: 0xB753 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 39: 0xB764 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 46: 0xB79D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
