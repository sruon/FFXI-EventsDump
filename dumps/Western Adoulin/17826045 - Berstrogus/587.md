...
```
  ...
  4: 0x0046 [0x1D] PRINT_EVENT_MESSAGE(message_id=9776*)
    → "Pioneers have certainly made a lot of headway recently. Your role in the colonization movement has expanded, and you're more trusted than ever. I don't know exactly how that affects you personally, but I'm sure someone at the various coalitions would.\u007F1\u0000\u0007"
