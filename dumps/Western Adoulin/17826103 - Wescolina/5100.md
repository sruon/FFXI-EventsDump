...
SUBROUTINE_05B5:
 69: 0x05B5 [0x02] IF !(ExtData[1]->WorkLocal[6] == 1*) GOTO 0x05C0
 70: 0x05BD [0x01] GOTO 0x05C3
 71: 0x05C0 [0x05] Work_Zone[1] = 1
 72: 0x05C3 [0x20] SET_CLI_EVENT_UC_FLAG: Unlock player control
 73: 0x05C5 [0x21] END_EVENT
 74: 0x05C6 [0x00] END_REQSTACK()

SUBROUTINE_05C7:
 75: 0x05C7 [0x02] IF !(ExtData[1]->WorkLocal[0] == 0*) GOTO 0x05F0
 76: 0x05CF [0x03] ExtData[1]->WorkLocal[11] = 26664*
 77: 0x05D4 [0x03] ExtData[1]->WorkLocal[12] = 1459*
 78: 0x05D9 [0x03] ExtData[1]->WorkLocal[13] = 4030*
 79: 0x05DE [0x03] ExtData[1]->WorkLocal[14] = 8708*
 80: 0x05E3 [0x03] ExtData[1]->WorkLocal[15] = 5944*
 81: 0x05E8 [0x03] ExtData[1]->WorkLocal[10] = 97000*
 82: 0x05ED [0x01] GOTO 0x0694
 83: 0x05F0 [0x02] IF !(ExtData[1]->WorkLocal[0] == 1*) GOTO 0x0619
 84: 0x05F8 [0x03] ExtData[1]->WorkLocal[11] = 26840*
 85: 0x05FD [0x03] ExtData[1]->WorkLocal[12] = 1459*
 86: 0x0602 [0x03] ExtData[1]->WorkLocal[13] = 1993*
 87: 0x0607 [0x03] ExtData[1]->WorkLocal[14] = 4028*
 88: 0x060C [0x03] ExtData[1]->WorkLocal[15] = 5775*
 89: 0x0611 [0x03] ExtData[1]->WorkLocal[10] = 97000*
 90: 0x0616 [0x01] GOTO 0x0694
 91: 0x0619 [0x02] IF !(ExtData[1]->WorkLocal[0] == 2*) GOTO 0x0642
 92: 0x0621 [0x03] ExtData[1]->WorkLocal[11] = 27016*
 93: 0x0626 [0x03] ExtData[1]->WorkLocal[12] = 1459*
 94: 0x062B [0x03] ExtData[1]->WorkLocal[13] = 4095*
 95: 0x0630 [0x03] ExtData[1]->WorkLocal[14] = 4027*
 96: 0x0635 [0x03] ExtData[1]->WorkLocal[15] = 5941*
 97: 0x063A [0x03] ExtData[1]->WorkLocal[10] = 97000*
 98: 0x063F [0x01] GOTO 0x0694
 99: 0x0642 [0x02] IF !(ExtData[1]->WorkLocal[0] == 3*) GOTO 0x066B
100: 0x064A [0x03] ExtData[1]->WorkLocal[11] = 27192*
101: 0x064F [0x03] ExtData[1]->WorkLocal[12] = 1459*
102: 0x0654 [0x03] ExtData[1]->WorkLocal[13] = 1994*
103: 0x0659 [0x03] ExtData[1]->WorkLocal[14] = 4028*
104: 0x065E [0x03] ExtData[1]->WorkLocal[15] = 5942*
105: 0x0663 [0x03] ExtData[1]->WorkLocal[10] = 97000*
106: 0x0668 [0x01] GOTO 0x0694
107: 0x066B [0x02] IF !(ExtData[1]->WorkLocal[0] == 4*) GOTO 0x0694
108: 0x0673 [0x03] ExtData[1]->WorkLocal[11] = 27368*
109: 0x0678 [0x03] ExtData[1]->WorkLocal[12] = 1459*
110: 0x067D [0x03] ExtData[1]->WorkLocal[13] = 1994*
111: 0x0682 [0x03] ExtData[1]->WorkLocal[14] = 2199*
112: 0x0687 [0x03] ExtData[1]->WorkLocal[15] = 5940*
113: 0x068C [0x03] ExtData[1]->WorkLocal[10] = 97000*
114: 0x0691 [0x01] GOTO 0x0694

SUBROUTINE_0694:
115: 0x0694 [0x93] DISPLAY_ITEM_INFO(item_id=ExtData[1]->WorkLocal[11])
116: 0x0697 [0x03] Work_Zone[2] = ExtData[1]->WorkLocal[11]
117: 0x069C [0x1D] PRINT_EVENT_MESSAGE(message_id=11523*)
    → "Hoo boy, \u0001\u0001\u0001 \u0001\u0005$\u0002\u0000\u0000\u0000?\u007F1\u0000\u0007"
118: 0x069F [0x23] WAIT_FOR_DIALOG_INTERACTION
119: 0x06A0 [0x93] DISPLAY_ITEM_INFO(item_id=0*)
120: 0x06A3 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Wescolina (ID: 17826103/0x01100137), tag_num=0x03)
121: 0x06AA [0x03] Work_Zone[3] = ExtData[1]->WorkLocal[12]
122: 0x06AF [0x03] Work_Zone[4] = ExtData[1]->WorkLocal[13]
123: 0x06B4 [0x03] Work_Zone[5] = ExtData[1]->WorkLocal[14]
124: 0x06B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=11524*)
...
126: 0x06BD [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Wescolina (ID: 17826103/0x01100137), tag_num=0x04)
127: 0x06C4 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Wescolina (ID: 17826103/0x01100137), tag_num=0x05)
128: 0x06CB [0x1D] PRINT_EVENT_MESSAGE(message_id=11525*)
...
130: 0x06CF [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Wescolina (ID: 17826103/0x01100137), tag_num=0x06)
131: 0x06D6 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Wescolina (ID: 17826103/0x01100137), tag_num=0x07)
132: 0x06DD [0x03] Work_Zone[3] = ExtData[1]->WorkLocal[12]
133: 0x06E2 [0x03] Work_Zone[6] = ExtData[1]->WorkLocal[15]
134: 0x06E7 [0x03] Work_Zone[7] = ExtData[1]->WorkLocal[10]
135: 0x06EC [0x1D] PRINT_EVENT_MESSAGE(message_id=11526*)
    → "So if'n you just gimme the most important parts--\u0001\u0001\u0001 \u0001\u0005$\u0002\u0001\u0000\u0000 and \u0001\u0001\u0001 \u0001\u0005$\u0002\u0004\u0000\u0000--together with 
\u0005 bayld, I should be able to handle things from theah.\u007F1\u0000\u0007"
136: 0x06EF [0x23] WAIT_FOR_DIALOG_INTERACTION
137: 0x06F0 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Wescolina (ID: 17826103/0x01100137), tag_num=0x08)
138: 0x06F7 [0x1B] RETURN
```
