...
| [5227](#event-5227)   | 0x0001       |     24 |             10 |
| [5228](#event-5228)   | 0x0019       |     21 |              9 |
| [5229](#event-5229)   | 0x002E       |     16 |              6 |
...
- **13189**: Good day, adventurer! I am able to repair any broken item data related to $0.
- **13190**: If you are unable to deliver $0, it's possible that the item data has been corrupted.
- **13191**: Please trade your $0 to me so that I may fix it.
- **13192**: I have confirmed that the item data for your $0 has been corrupted. We apologize for the inconvenience.
- **13193**: I have restored it to its intended functionality. Here you are!
- **13194**: It appears that your item is working as intended.
...
```
  ...
  6: 0x0013 [0x1D] PRINT_EVENT_MESSAGE(message_id=13191*)
...
```
  ...
  3: 0x0024 [0x1D] PRINT_EVENT_MESSAGE(message_id=13192*)
  ...
  5: 0x0028 [0x1D] PRINT_EVENT_MESSAGE(message_id=13193*)
...
```
  ...
  2: 0x0038 [0x1D] PRINT_EVENT_MESSAGE(message_id=13194*)
