...
```
  ...
  1: 0x0011 [0x1D] PRINT_EVENT_MESSAGE(message_id=8049*)
    → "Good day to you, adventurer! Have you registered with the Pioneers' Coalition yet? If not, I strongly recommend you take the time to do so at your earliest convenience!\u007F1\u0000\u0007"
