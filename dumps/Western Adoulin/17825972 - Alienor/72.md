...
```
 ...
 17: 0x01DA [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=EventEntity, entity2=EventEntity, action="pas0")
...
SUBROUTINE_01F4:
 22: 0x01F4 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x020A
 23: 0x01FC [0x1D] PRINT_EVENT_MESSAGE(message_id=8110*)
 ...
 25: 0x0200 [0x03] Work_Zone[1] = 0*
 26: 0x0205 [0x21] END_EVENT
 27: 0x0206 [0x00] END_REQSTACK()

SUBROUTINE_020A:
 28: 0x020A [0x00] END_REQSTACK()
```
