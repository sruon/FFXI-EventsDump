...
```
  ...
  1: 0x07E0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  2: 0x07F1 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 23: 0x086D [0x45] LOAD_SCHEDULED_TASK(work_offset1=635*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s048", work_offset2=0*)
 24: 0x087E [0x01] GOTO 0x08AE

SUBROUTINE_0881:
 25: 0x0881 [0x02] IF !(ExtData[1]->WorkLocal[1] == 6*) GOTO 0x089D
 26: 0x0889 [0x45] LOAD_SCHEDULED_TASK(work_offset1=635*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s048", work_offset2=0*)
 27: 0x089A [0x01] GOTO 0x08AE

SUBROUTINE_089D:
 28: 0x089D [0x45] LOAD_SCHEDULED_TASK(work_offset1=635*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s045", work_offset2=0*)
 29: 0x08AE [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 30: 0x08BF [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=59*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 34: 0x08D5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 35: 0x08E6 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
...
SUBROUTINE_0929:
 ...
 44: 0x093A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
