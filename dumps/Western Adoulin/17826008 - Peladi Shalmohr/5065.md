...
```
  ...
  1: 0x13A7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  2: 0x13B8 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 34: 0x146F [0x5B] LOAD_EXT_SCHEDULER(work_offset=767*, entity1=EventEntity, entity2=EventEntity, action="ed00")
 35: 0x147E [0x1C] WAIT(30* ticks)
 36: 0x1481 [0x45] LOAD_SCHEDULED_TASK(work_offset1=635*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s220", work_offset2=0*)
 37: 0x1492 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 ...
 52: 0x14EA [0x45] LOAD_SCHEDULED_TASK(work_offset1=635*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s221", work_offset2=0*)
 53: 0x14FB [0x81] SET_ENTITY_BLINKING(blink_flag=0x00, entity=EventEntity)
 54: 0x1501 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=199*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 64: 0x154D [0x45] LOAD_SCHEDULED_TASK(work_offset1=635*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s20c", work_offset2=0*)
 65: 0x155E [0x01] GOTO 0x158E

SUBROUTINE_1561:
 66: 0x1561 [0x02] IF !(ExtData[1]->WorkLocal[1] == 6*) GOTO 0x157D
 67: 0x1569 [0x45] LOAD_SCHEDULED_TASK(work_offset1=635*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s20c", work_offset2=0*)
 68: 0x157A [0x01] GOTO 0x158E

SUBROUTINE_157D:
 69: 0x157D [0x45] LOAD_SCHEDULED_TASK(work_offset1=635*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s222", work_offset2=0*)
 70: 0x158E [0x5B] LOAD_EXT_SCHEDULER(work_offset=2965*, entity1=EventEntity, entity2=EventEntity, action="yre0")
 ...
 76: 0x15AE [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 77: 0x15BF [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
...
SUBROUTINE_1602:
 ...
 86: 0x1613 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
