...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
02B0:                      42  4A F0 FF FF 7F CA 81 0C         BJ.......
...
0380: 23 48 15 80 23 29 10 F0  FF FF 7F 02 29 10 C7 81  #H..#)......)...
0390: 0C 01 09 2B C7 81 0C 01  16 80 23 2B C7 81 0C 01  ...+......#+....
03A0: 17 80 23 2B C7 81 0C 01  18 80 23 2B C7 81 0C 01  ..#+......#+....
03B0: 19 80 23 2B C7 81 0C 01  1A 80 23 2B C7 81 0C 01  ..#+......#+....
03C0: 1B 80 23 2B C7 81 0C 01  1C 80 23 1C 1D 80 48 1E  ..#+......#...H.
...
```
  ...
  1: 0x02B8 [0x4A] LocalPlayer looks at Hazy Rune (ID: 17596874/0x010C81CA)
 ...
 15: 0x02F5 [0x48] [System] [11553*]:
    → "\u00072\u000C\u0000[./Ig.../Ge...s/...bra/Te/...por/U.../Lu.../...ebrae]...\u00073\u007F1\u0000\u0007"
 16: 0x02F8 [0x23] WAIT_FOR_DIALOG_INTERACTION
 17: 0x02F9 [0x02] IF !(ExtData[1]->WorkLocal[2] == 8*) GOTO 0x0304
 ...
 22: 0x0314 [0x48] [System] [11553*]:
    → "\u00072\u000C\u0000[./Ig.../Ge...s/...bra/Te/...por/U.../Lu.../...ebrae]...\u00073\u007F1\u0000\u0007"
 23: 0x0317 [0x23] WAIT_FOR_DIALOG_INTERACTION
 24: 0x0318 [0x02] IF !(ExtData[1]->WorkLocal[3] == 8*) GOTO 0x0323
 ...
 29: 0x0333 [0x48] [System] [11553*]:
    → "\u00072\u000C\u0000[./Ig.../Ge...s/...bra/Te/...por/U.../Lu.../...ebrae]...\u00073\u007F1\u0000\u0007"
 30: 0x0336 [0x23] WAIT_FOR_DIALOG_INTERACTION
 31: 0x0337 [0x02] IF !(ExtData[1]->WorkLocal[4] == 8*) GOTO 0x0342
...
\u0002.\u00073\u007F1\u0000\u0007"
 ...
 54: 0x038C [0x29] REQ_SET_WAIT(priority=0x10, entity_id=Unnamed NPC (ID: 17596871/0x010C81C7), tag_num=0x09)
 55: 0x0393 [0x2B] Unnamed NPC (ID: 17596871/0x010C81C7) [11568*]:
 ...
 57: 0x039B [0x2B] Unnamed NPC (ID: 17596871/0x010C81C7) [11569*]:
    → "The first sight I bore witness to after crossing the Sea of Shumeyo and stepping upon this new continent was a windswept, desolate plain that stretched past the horizon.\u007F1\u0000\u0007"
 58: 0x03A2 [0x23] WAIT_FOR_DIALOG_INTERACTION
 59: 0x03A3 [0x2B] Unnamed NPC (ID: 17596871/0x010C81C7) [11570*]:
    → "Unperturbed, I trekked onward, climbing mountains that scraped the skies and scaling cliffs sheerer than panes of glass. Nestled inside this hollow that greeted me upon reaching the top of one cliff was this machination.\u007F1\u0000\u0007"
 60: 0x03AA [0x23] WAIT_FOR_DIALOG_INTERACTION
 61: 0x03AB [0x2B] Unnamed NPC (ID: 17596871/0x010C81C7) [11571*]:
    → "Having been thoroughly inculcated with the pattern by now, it did not take long for me to ascertain that Tenebrae would resonate with this recorder.\u007F1\u0000\u0007"
 62: 0x03B2 [0x23] WAIT_FOR_DIALOG_INTERACTION
 63: 0x03B3 [0x2B] Unnamed NPC (ID: 17596871/0x010C81C7) [11572*]:
    → "Mark my words, unknown interlocutor.\u007F1\u0000\u0007"
 64: 0x03BA [0x23] WAIT_FOR_DIALOG_INTERACTION
 65: 0x03BB [0x2B] Unnamed NPC (ID: 17596871/0x010C81C7) [11573*]:
    → "Darkness devours the light, envelops us in its achromatic veil and never relinquishes its grip.\u007F1\u0000\u0007"
 66: 0x03C2 [0x23] WAIT_FOR_DIALOG_INTERACTION
 67: 0x03C3 [0x2B] Unnamed NPC (ID: 17596871/0x010C81C7) [11574*]:
    → "There exists a blinding caliginosity that will never dissipate no matter the luminosity of the light we shine upon it, and it will not let us forget.\u007F1\u0000\u0007"
 68: 0x03CA [0x23] WAIT_FOR_DIALOG_INTERACTION
 69: 0x03CB [0x1C] WAIT(90* ticks)
 70: 0x03CE [0x48] [System] [11566*]:
