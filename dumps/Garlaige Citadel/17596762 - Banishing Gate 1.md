...
| [65535.1](#event-655351) | 0x002B       |     42 |             10 |
...
- **7337**: Lower the switch? [Yes./No.]
- **7339**: Raise the switch? [Yes./No.]
...
```
  0: 0x0001 [0x24] CREATE_DIALOG(message_id=7337*, default_option=0*, option_flags=0*)
...
```
  0: 0x002B [0x24] CREATE_DIALOG(message_id=7339*, default_option=0*, option_flags=0*)
