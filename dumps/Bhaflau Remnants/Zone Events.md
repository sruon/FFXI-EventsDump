...
```
  ...
  1: 0x01C9 [0x24] CREATE_DIALOG(message_id=7443*, default_option=1*, option_flags=0*)
...
```
  ...
  1: 0x0211 [0x24] CREATE_DIALOG(message_id=7443*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0259 [0x24] CREATE_DIALOG(message_id=7443*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x02A1 [0x24] CREATE_DIALOG(message_id=7443*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x02E9 [0x24] CREATE_DIALOG(message_id=7443*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0331 [0x24] CREATE_DIALOG(message_id=7443*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0379 [0x24] CREATE_DIALOG(message_id=7443*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x03C1 [0x24] CREATE_DIALOG(message_id=7443*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x0410 [0x24] CREATE_DIALOG(message_id=7443*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x043E [0x24] CREATE_DIALOG(message_id=7443*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
...
```
  ...
  1: 0x048D [0x24] CREATE_DIALOG(message_id=7445*, default_option=1*, option_flags=0*)
...
```
 ...
 54: 0x061D [0x24] CREATE_DIALOG(message_id=7250*, default_option=0*, option_flags=ExtData[1]->WorkLocal[1])
...
```
  ...
  1: 0x06BA [0x24] CREATE_DIALOG(message_id=7447*, default_option=1*, option_flags=0*)
