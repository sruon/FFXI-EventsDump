...
00F0: 24 12 02 01 1C 1F 80 5B  09 80 1F 12 02 01 1F 12  $......[........
...
```
  ...
  1: 0x00CE [0x5A] UPDATE_EVENT_POSITION: Set EventEntity MovePosition to X=-1.047*, Z=-520.574*, Y=-3.942*
  2: 0x00D6 [0x5A] UPDATE_EVENT_POSITION: Move EventEntity incrementally towards MovePosition
  3: 0x00D8 [0x1C] WAIT(30* ticks)
  4: 0x00DB [0x4B] UPDATE_ENTITY_YAW(entity=EventEntity, yaw=16.48°*)
  5: 0x00E2 [0x1C] WAIT(60* ticks)
  6: 0x00E5 [0x4B] UPDATE_ENTITY_YAW(entity=EventEntity, yaw=8.24°*)
 ...
 10: 0x00F7 [0x5B] LOAD_EXT_SCHEDULER(work_offset=336*, entity1=Kukki-Chebukki (ID: 16912927/0x0102121F), entity2=Kukki-Chebukki (ID: 16912927/0x0102121F), action="wai0")
