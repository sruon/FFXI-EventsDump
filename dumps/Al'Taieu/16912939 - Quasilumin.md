...
| [165](#event-165)        | 0x0044       |      9 |              3 |
| [166](#event-166)        | 0x004D       |      9 |              3 |
| [167](#event-167)        | 0x0056       |      9 |              3 |
| [65535.7](#event-655357) | 0x005F       |     10 |              2 |
...
```
  ...
  1: 0x0058 [0x2F] EventEntity->Render.Flags0 &= ~0x80000 // Bit 19
...
```
  0: 0x005F [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=0.169*, z=-575.679*, y=0.000*, direction=276.1°*
...
```
  0: 0x0069 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=0.033*, z=-732.215*, y=-3.757*, direction=271.2°*
