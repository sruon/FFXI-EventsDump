...
- **7337**: Return to the Crag of Holla? [Yes./No.]
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=7337*, default_option=1*, option_flags=0*)
    → "Return to the Crag of Holla? [Yes./No.]"
