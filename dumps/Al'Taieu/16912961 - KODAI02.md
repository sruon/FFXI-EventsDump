...
```
  0: 0x0010 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-441.928*, z=399.400*, y=-19.099*, direction=0.0°*
...
```
  0: 0x001A [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-5.679*, z=-87.726*, y=-34.059*, direction=226.8°*
