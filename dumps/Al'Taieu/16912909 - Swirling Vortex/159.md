...
0020: FF FF 7F 0B 01 32 00 02  00 10 01 80 00 32 00 01  .....2.......2..
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=7328*, default_option=1*, option_flags=0*)
    → "Enter the bottomless void?\u0007\u000BYes.\u0007No.\u007F1\u0000\u0007"
  ...
  8: 0x001D [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x0B)
