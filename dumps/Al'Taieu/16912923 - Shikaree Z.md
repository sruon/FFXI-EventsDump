...
```
  0: 0x0045 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=401.641*, z=-463.480*, y=-19.099*, direction=269.0°*
...
```
  0: 0x0059 [0x39] SET_ENTITY_DIRECTION(direction=17.3°*)
