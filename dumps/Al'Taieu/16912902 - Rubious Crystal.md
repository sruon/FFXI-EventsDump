...
```
  ...
  8: 0x0024 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "etw1" with entities [LocalPlayer, LocalPlayer], work=[160*, 0*]
 ...
 12: 0x0050 [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "2tow" with entities [EventEntity, EventEntity]
