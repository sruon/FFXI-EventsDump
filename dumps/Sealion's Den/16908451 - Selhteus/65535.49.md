...
```
  0: 0x0305 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
  1: 0x0316 [0x45] LOAD_SCHEDULED_TASK(work_offset1=171*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s049", work_offset2=0*)
  2: 0x0327 [0x1C] WAIT(90* ticks)
  3: 0x032A [0x55] WAIT_LOAD_SCHEDULER(work_offset=171*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s049")
  ...
  5: 0x034A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
  6: 0x035B [0x45] LOAD_SCHEDULED_TASK(work_offset1=171*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s050", work_offset2=0*)
