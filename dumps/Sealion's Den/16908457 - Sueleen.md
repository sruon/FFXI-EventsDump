...
- **7645**: The airship carrying Prishe and Ulmia just left for San d'Oria.
- **7646**: Someday maybe I'll be lucky enough to ride an airship off the island... Someday...
- **7647**: The Sealion's Den once served as a private port for the Tavnazian Cathedral.
- **7648**: However, not a single ship has visited this place in over twenty years. I'm only stationed here to make sure no beastmen try to sneak their way into the safehold.
- **7649**: I never believed the day would come when I saw a ship docked in the Sealion's Den.
- **7650**: I have a feeling my job is about to become real interesting!
- **7651**: The Chebukki brothers arrived a while back on an airship that was unlike any that had visited our port before.
- **7652**: There were enough weapons on the contraption to blow up an island...
- **7653**: If you're looking for the Chebukki brothers, they headed back to Jeuno a few days ago. Now that you mention it, they looked like they were in quite a hurry.
- **7654**: I guess once you've had a taste of city life, it's hard to come back to the country...
- **7655**: Cid? No one going by that name has passed through here.
- **7689**: Ulmia told me that we may never see Prishe again...
- **7690**: ...That Prishe is ready to sacrifice herself to the Wyrmking to save the world...
- **7691**: But you won't let that happen, will you, <Player>? You'll find a way to save Prishe, Ulmia, and everybody, right?
- **7859**: Over the past few months, hundreds of ships have brought thousands of people to our town.
- **7860**: It's like a clock that hasn't run for twenty years has suddenly started ticking again.
- **7876**: Please, adventurer. Keep Prishe and Ulmia safe from harm.
- **7877**: I want to laugh as I hand back the letters they wrote in case they didn't make it...
- **7923**: That ship of yours made its way back here of its own accord. Must be that "autopilot" thing that Prishe was talking about.
- **7924**: I've resupplied the airship, so you can take off at any time. Let me know when you're ready to board.
- **7925**: I've resupplied the airship, so you can take off at any time. Are you ready to go?
- **7926**: Take the airship to Al'Taieu? [Let's go!/Not just yet.]
...
```
 ...
 18: 0x008A [0x1D] PRINT_EVENT_MESSAGE(message_id=7923*)
 ...
 22: 0x00AE [0x1D] PRINT_EVENT_MESSAGE(message_id=7924*)
...
```
  ...
  7: 0x0112 [0x1D] PRINT_EVENT_MESSAGE(message_id=7923*)
    → "That ship of yours made its way back here of its own accord. Must be that "autopilot" thing that Prishe was talking about."
  8: 0x0115 [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x0116 [0x1D] PRINT_EVENT_MESSAGE(message_id=7925*)
 ...
 12: 0x011D [0x24] CREATE_DIALOG(message_id=7926*, default_option=1*, option_flags=0*)
...
```
  ...
  1: 0x037F [0x1D] PRINT_EVENT_MESSAGE(message_id=7647*)
  ...
  4: 0x0392 [0x1D] PRINT_EVENT_MESSAGE(message_id=7648*)
...
```
  ...
  1: 0x039D [0x1D] PRINT_EVENT_MESSAGE(message_id=7649*)
  ...
  4: 0x03B0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7650*)
...
```
  ...
  1: 0x03BB [0x1D] PRINT_EVENT_MESSAGE(message_id=7645*)
  ...
  4: 0x03CE [0x1D] PRINT_EVENT_MESSAGE(message_id=7646*)
...
```
  ...
  1: 0x03D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7655*)
...
```
  ...
  1: 0x03E4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7689*)
  ...
  4: 0x03F7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7690*)
  ...
  7: 0x040A [0x1D] PRINT_EVENT_MESSAGE(message_id=7691*)
...
```
  ...
  1: 0x0415 [0x1D] PRINT_EVENT_MESSAGE(message_id=7859*)
  ...
  4: 0x0428 [0x1D] PRINT_EVENT_MESSAGE(message_id=7860*)
...
```
  ...
  1: 0x0433 [0x1D] PRINT_EVENT_MESSAGE(message_id=7651*)
  ...
  4: 0x0446 [0x1D] PRINT_EVENT_MESSAGE(message_id=7652*)
...
```
  ...
  1: 0x0451 [0x1D] PRINT_EVENT_MESSAGE(message_id=7653*)
  ...
  4: 0x0464 [0x1D] PRINT_EVENT_MESSAGE(message_id=7654*)
...
```
  ...
  1: 0x0470 [0x1D] PRINT_EVENT_MESSAGE(message_id=7876*)
  ...
  4: 0x0483 [0x1D] PRINT_EVENT_MESSAGE(message_id=7877*)
