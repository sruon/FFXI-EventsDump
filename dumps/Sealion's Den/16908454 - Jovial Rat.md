...
- **7928**: The minstrel of melodies is my name, For a mere $6 gil I'll recall your past. Your stories of love, anger, triumph, and shame, The river of memories runs deep and vast.
- **7929**: The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last.
- **7931**: Which memory will you have recalled? [Nothing./Promathia Missions./Other Quests.]
- **7932**: Which memory will you have recalled? [Nothing./Slanderous Utterings./One to Be Feared(pt.1)./One to Be Feared(pt.2)./One to Be Feared(pt.3)./One to Be Feared(pt.4)./One to Be Feared(pt.5)./One to Be Feared(pt.6)./Chains and Bonds./Flames in the Darkness./Calm Before the Storm./The Warrior's Path(pt.1)./The Warrior's Path(pt.2)./On to Al'Taieu(pt.1).]
- **7933**: Which memory will you have recalled? [Nothing./Apocalypse Nigh.]
- **7934**: 
- **7935**: 
...
```
  ...
  3: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=7929*)
 ...
 17: 0x006A [0x1D] PRINT_EVENT_MESSAGE(message_id=7929*)
    → "The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last."
 18: 0x006D [0x23] WAIT_FOR_DIALOG_INTERACTION
 19: 0x006E [0x21] END_EVENT
 20: 0x006F [0x00] END_REQSTACK()
 21: 0x0070 [0x1D] PRINT_EVENT_MESSAGE(message_id=7928*)
 ...
 31: 0x00A0 [0x24] CREATE_DIALOG(message_id=7931*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00B0:
 34: 0x00B0 [0x24] CREATE_DIALOG(message_id=7932*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_00DF:
 42: 0x00DF [0x24] CREATE_DIALOG(message_id=7933*, default_option=0*, option_flags=Work_Zone[3])
...
SUBROUTINE_010E:
 50: 0x010E [0x24] CREATE_DIALOG(message_id=7934*, default_option=0*, option_flags=Work_Zone[4])
    → ""
...
SUBROUTINE_013D:
 58: 0x013D [0x24] CREATE_DIALOG(message_id=7935*, default_option=0*, option_flags=Work_Zone[5])
    → ""
