...
```
  0: 0x000D [0x5B] LOAD_EXT_SCHEDULER(work_offset=631*, entity1=EventEntity, entity2=EventEntity, action="h201")
  1: 0x001C [0x02] IF !(Work_Zone[36] == 1*) GOTO 0x0064
  2: 0x0024 [0x02] IF !(Work_Zone[36] == 2*) GOTO 0x0040
  3: 0x002C [0x5B] LOAD_EXT_SCHEDULER(work_offset=631*, entity1=EventEntity, entity2=EventEntity, action="h202")
