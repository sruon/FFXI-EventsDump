...
```
  ...
  9: 0x1E0A [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "main" with entities [LocalPlayer, LocalPlayer], work=[1*, 0*]
 10: 0x1E1B [0x1C] WAIT(120* ticks)
 11: 0x1E1E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2", work_offset2=0*)
 12: 0x1E2F [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2")
 13: 0x1E3E [0x02] IF !(ExtData[1]->WorkLocal[43] == 1*) GOTO 0x1E7C
 14: 0x1E46 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="01on")
 15: 0x1E53 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2end")
 16: 0x1E60 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="3end")
...
SUBROUTINE_1E7C:
 ...
 21: 0x1E84 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="1end")
 22: 0x1E91 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="02on")
 23: 0x1E9E [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="3end")
...
SUBROUTINE_1EBA:
 ...
 28: 0x1EC2 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="1end")
 29: 0x1ECF [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="2end")
 30: 0x1EDC [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="03on")
...
SUBROUTINE_1EF8:
 34: 0x1EF8 [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "main" with entities [LocalPlayer, LocalPlayer], work=[2*, 0*]
 35: 0x1F09 [0x46] CAMERA_CONTROL: Restore default settings
 36: 0x1F0B [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
...
```
# Data Section: 0x1D72 (132 bytes)
     0x1D72: 45 0E 80 F0 FF FF 7F F0 FF FF 7F 66 64 69 30 00
     0x1D82: 80 55 0E 80 F0 FF FF 7F F0 FF FF 7F 66 64 69 30
     0x1D92: 1B 45 0E 80 F0 FF FF 7F F0 FF FF 7F 66 64 6F 30
     0x1DA2: 00 80 55 0E 80 F0 FF FF 7F F0 FF FF 7F 66 64 6F
     0x1DB2: 30 1B 45 0E 80 F0 FF FF 7F F0 FF FF 7F 66 64 69
     0x1DC2: 31 00 80 55 0E 80 F0 FF FF 7F F0 FF FF 7F 66 64
     0x1DD2: 69 31 1B 45 0E 80 F0 FF FF 7F F0 FF FF 7F 66 64
     0x1DE2: 6F 31 00 80 55 0E 80 F0 FF FF 7F F0 FF FF 7F 66
     0x1DF2: 64 6F 31 1B
# Data Section: 0x1F1D (68 bytes)
     0x1F1D: 3B F8 FF FF 7F 2D 00 2E 00 2F 00 3A F8 FF FF 7F
     0x1F2D: 30 00 17 31 00 30 00 2C 00 16 32 00 30 00 2C 00
     0x1F3D: 07 2D 00 31 00 07 2E 00 32 00 1B 17 31 00 30 00
     0x1F4D: 2C 00 16 32 00 30 00 2C 00 07 2D 00 31 00 07 2E
     0x1F5D: 00 32 00 1B
```