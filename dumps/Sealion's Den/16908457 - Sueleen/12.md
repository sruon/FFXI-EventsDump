...
SUBROUTINE_010B:
 ...
 19: 0x0138 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 20: 0x0149 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 30: 0x0188 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="04on")
 31: 0x0195 [0x45] LOAD_SCHEDULED_TASK(work_offset1=72*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r000", work_offset2=0*)
 32: 0x01A6 [0x1C] WAIT(60* ticks)
 33: 0x01A9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 34: 0x01BA [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 35: 0x01C9 [0x1C] WAIT(600* ticks)
 36: 0x01CC [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 37: 0x01DD [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 40: 0x01FE [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="lwon")
 41: 0x020B [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="loop")
 42: 0x0218 [0x45] LOAD_SCHEDULED_TASK(work_offset1=171*, entity1=EventEntity, entity2=EventEntity, scheduler_id="se38", work_offset2=0*)
 43: 0x0229 [0x45] LOAD_SCHEDULED_TASK(work_offset1=72*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r002", work_offset2=0*)
 44: 0x023A [0x1C] WAIT(10* ticks)
 45: 0x023D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 46: 0x024E [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 47: 0x025D [0x1C] WAIT(30* ticks)
 48: 0x0260 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blon", work_offset2=0*)
 49: 0x0271 [0x55] WAIT_LOAD_SCHEDULER(work_offset=72*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r002")
 50: 0x0280 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=Sueleen (ID: 16908457/0x010200A9), entity2=Sueleen (ID: 16908457/0x010200A9), scheduler_id="ovl1", work_offset2=0*)
 51: 0x0291 [0x45] LOAD_SCHEDULED_TASK(work_offset1=72*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="r001", work_offset2=0*)
 52: 0x02A2 [0x1C] WAIT(220* ticks)
 53: 0x02A5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=108*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="who3", work_offset2=0*)
 54: 0x02B6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=108*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="bash", work_offset2=0*)
 55: 0x02C7 [0x55] WAIT_LOAD_SCHEDULER(work_offset=108*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="who3")
 56: 0x02D6 [0x52] END_LOAD_SCHEDULER: End scheduler "r001" with entities [LocalPlayer, LocalPlayer], work=72*
 57: 0x02E5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blof", work_offset2=0*)
 58: 0x02F6 [0x2D] CREATE_ZONE_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, zone_action="4end")
 59: 0x0303 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 60: 0x0314 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 66: 0x033C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
 67: 0x034D [0x01] GOTO 0x0356

SUBROUTINE_0350:
 68: 0x0350 [0x03] Work_Zone[1] = 1*
 69: 0x0355 [0x30] SET_UCOFF_CONTINUE_ZERO()
 70: 0x0356 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="whi1", work_offset2=0*)
