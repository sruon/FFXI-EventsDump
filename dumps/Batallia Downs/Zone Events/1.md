...
```
  ...
  7: 0x0014 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0x0001, entity1=LocalPlayer, entity2=LocalPlayer, action="sha0")
  8: 0x0023 [0x53] WAIT_SCHEDULER_TASK(entity1=LocalPlayer, entity2=LocalPlayer, action_id="sha0")
 ...
 12: 0x0037 [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "main" with entities [??? (ID: 17207827/0x01069213), ??? (ID: 17207827/0x01069213)], work=[3*, 0*]
 ...
 19: 0x005A [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0x0001, entity1=LocalPlayer, entity2=LocalPlayer, action="sha1")
 20: 0x0069 [0x53] WAIT_SCHEDULER_TASK(entity1=LocalPlayer, entity2=LocalPlayer, action_id="sha1")
