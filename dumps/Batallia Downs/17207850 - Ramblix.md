...
- **7545**: Oh my Gob! You're one of those adventurerurers, aren't ya? You got nothin' on me, [man./lady.] I was just mindin' my own businesesess, lookin' for junk an' stuff.
- **7546**: Hey, watch out. You don't wanna fight me. I'll turn you into meat jerky! Wait, how about you and me be friends instead? Sound good?
- **7547**: I travel all over the world and hear lots of differererent stories. I even hear your stories. I can tell you one, if you want.
- **7548**: Now, listen close...
- **7549**: Oh... Well, if that's the case, I'm outta here.
- **7555**: Do you want to hear a story? [No, thank you./Let's hear one.]
- **7556**: What story would you like to be told? [On second thought, maybe later./Breaking Barriers./Branded./Cavernous Maws./Cait Sith(pt.1)./Cait Sith(pt.2)./A Hawk in Repose./The Battle of Xarcabard./Face of the Future(pt.1)./Face of the Future(pt.2)./Face of the Future(pt.3)./Face of the Future(pt.4)./Her Memories./Her Memories: Grave Resolve./Pillar of Hope./Battle on a New Front./VW Op. #126: Qufim Incursion./Ganged Up On(pt.1)./Ganged Up On(pt.2)./Ganged Up On(pt.3)./Sacrifice(pt.1)./Sacrifice(pt.2)./Maat on the Rampage(pt.1)./Maat on the Rampage(pt.2).]
- **7557**: 
- **7558**: 
- **7559**: 
...
```
 ...
 15: 0x005A [0x1D] PRINT_EVENT_MESSAGE(message_id=7545*)
 ...
 17: 0x005E [0x1D] PRINT_EVENT_MESSAGE(message_id=7546*)
 ...
 19: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=7547*)
 ...
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=7555*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7556*, default_option=0*, option_flags=Work_Zone[2])
 ...
 37: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7549*)
...
SUBROUTINE_00E6:
 43: 0x00E6 [0x24] CREATE_DIALOG(message_id=7557*, default_option=0*, option_flags=Work_Zone[3])
    → ""
 ...
 48: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7549*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_012A:
 54: 0x012A [0x24] CREATE_DIALOG(message_id=7558*, default_option=0*, option_flags=Work_Zone[4])
    → ""
 ...
 59: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=7549*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_016E:
 65: 0x016E [0x24] CREATE_DIALOG(message_id=7559*, default_option=0*, option_flags=Work_Zone[5])
    → ""
 ...
 70: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=7549*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01A7:
 ...
 77: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7549*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01C6:
 81: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7548*)
    → "Now, listen close..."
