...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
00A0:                             66 14 80 68 92 06 01           f..h...
00B0: 68 92 06 01 73 69 74 31  1C 15 80 4A 68 92 06 01  h...sit1...Jh...
00C0: 5C 92 06 01 7B 68 92 06  01 00                    \...{h....      
```

#### Opcodes

```
  0: 0x00A9 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "sit1" with entities [Alexance (ID: 17207912/0x01069268), Alexance (ID: 17207912/0x01069268)], work=29*
  1: 0x00B8 [0x1C] WAIT(60* ticks)
  2: 0x00BB [0x4A] Alexance (ID: 17207912/0x01069268) looks at Excenmille (ID: 17207900/0x0106925C)
  3: 0x00C4 [0x7B] Alexance (ID: 17207912/0x01069268) stops talking
