...
```
  ...
  2: 0x00EE [0x5B] LOAD_EXT_SCHEDULER(work_offset=14*, entity1=EventEntity, entity2=EventEntity, action="fal0")
  3: 0x00FD [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="fal0")
