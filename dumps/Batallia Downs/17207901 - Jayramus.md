...
| [65535.8](#event-655358)   | 0x0049       |     25 |              7 |
| [65535.9](#event-655359)   | 0x0062       |     13 |              3 |
...
0050: 05 80 06 80 1F 01 6F 1E  5C 92 06 01 7B 5D 92 06  ......o.\...{]..
0060: 01 00                                             ..              
```
...
```
  ...
  4: 0x0057 [0x1E] EventEntity looks at Excenmille (ID: 17207900/0x0106925C) and starts talking
  5: 0x005C [0x7B] Jayramus (ID: 17207901/0x0106925D) stops talking
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0060:                                               32                 2
0070: 08 80 1F 00 09 80 0A 80  0B 80 1F 01 00           .............   
```
...
```
  ...
  1: 0x0072 [0x1F] MOVE_ENTITY: EventEntity moves to X=336.708*, Z=-213.537*, Y=7.390*
...
```
  0: 0x007D [0x32] ExtData[1]->MainSpeed = 80* * 0.1
  1: 0x0080 [0x1F] MOVE_ENTITY: EventEntity moves to X=354.811*, Z=-209.313*, Y=6.812*
