...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0070:                                               B6                 .
0080: 0B 0D 80 04 80 0E 80 0F  80 10 80 10 80 10 80 11  ................
0090: 80 00 80 00                                       ....            
```
...
```
  0: 0x007F [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=3*, hair=2*, head=56*, body=221*, hands=12*, legs=12*, feet=12*, main=251*, sub=0*)
