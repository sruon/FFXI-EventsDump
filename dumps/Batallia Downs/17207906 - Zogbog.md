...
```
  ...
  1: 0x0048 [0x1F] MOVE_ENTITY: EventEntity moves to X=-53.915*, Z=439.758*, Y=0.587*
...
```
  ...
  1: 0x0056 [0x1F] MOVE_ENTITY: EventEntity moves to X=-88.452*, Z=438.138*, Y=0.220*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0060:    32 0A 80 1F 00 0B 80  0C 80 00 80 1F 01 00      2............. 
```
...
```
  ...
  1: 0x0064 [0x1F] MOVE_ENTITY: EventEntity moves to X=-77.464*, Z=437.965*, Y=0.000*
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0060:                                               32                 2
0070: 0A 80 1F 00 0D 80 0E 80  0F 80 1F 01 00           .............   
```
...
```
  ...
  1: 0x0072 [0x1F] MOVE_ENTITY: EventEntity moves to X=-52.691*, Z=437.963*, Y=0.464*
