...
| [65535.14](#event-6553514) | 0x00A9       |     15 |              5 |
...
|       5 | 0x000D      |          13 |
|       6 | 0x51D7E     |      335230 |
|       7 | 0xFFFCD86A  |  4294760554 |
|       8 | 0x1FEA      |        8170 |
|       9 | 0x0050      |          80 |
|      10 | 0x56D3A     |      355642 |
|      11 | 0xFFFCEB17  |  4294765335 |
|      12 | 0x1F40      |        8000 |
|      13 | 0x0003      |           3 |
|      14 | 0x0038      |          56 |
|      15 | 0x00DD      |         221 |
...
```
  ...
  1: 0x0066 [0x1F] MOVE_ENTITY: EventEntity moves to X=335.230*, Z=-206.742*, Y=8.170*
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0070:                                               B6                 .
0080: 0B 0D 80 01 80 0E 80 0F  80 10 80 10 80 10 80 11  ................
0090: 80 00 80 00                                       ....            
```
...
```
  0: 0x007F [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=3*, hair=1*, head=56*, body=221*, hands=12*, legs=12*, feet=12*, main=251*, sub=0*)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0090:             B6 0B 0D 80  12 80 10 80 10 80 10 80      ............
...
```
  0: 0x0094 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=3*, hair=6*, head=12*, body=12*, hands=12*, legs=12*, feet=12*, main=210*, sub=0*)
