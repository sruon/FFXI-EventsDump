...
- **7737**: Do you want to hear a story? [No, thank you./Let's hear one.]
- **7738**: What story would you like to be told? [On second thought, maybe later./The Rank 5 Mission(pt.1)./The Rank 5 Mission(pt.2)./The Rank 5 Mission(pt.3)./The Rank 5 Mission(pt.4)./Where Two Paths Converge(pt.1)./Where Two Paths Converge(pt.2)./Where Two Paths Converge(pt.3)./Survival of the Wisest(pt.1)./Survival of the Wisest(pt.2)./Survival of the Wisest(pt.3)./Smash! A Malevolent Menace(pt.1)./Smash! A Malevolent Menace(pt.2)./Kipdrix the Faithful(pt.1)./Kipdrix the Faithful(pt.2).]
- **7739**: 
- **7740**: 
- **7741**: 
