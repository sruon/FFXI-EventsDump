...
- **7446**: Thank you, [sir/madame]. Enjoy your trip.
- **7448**: I'm sorry, [sir/madame]. You don't have enough gil to purchase a ticket.
- **7453**: Welcome to Carpenters' Landing.
- **7454**: Barge tickets can be purchased for $2 gil. Multi-tickets, which allow you to ride ten times, are available for a discounted price of $3 gil. Will you be sailing with us today?
- **7455**: Purchase... [6 ($2 gil)./$6 ($3 gil)./Nothing today.]
- **7456**: Thank you, [sir/madam]. I hope you enjoy sailing with us.
- **7457**: You cannot buy more than one $3. Use the one you currently have to ride the next ship.
- **7458**: Your $3 is valid for $4 more [trip/trips]. You do not need to purchase a new ticket at this time.
- **7459**: Your $3 is valid for $4 more [trip/trips]. If you wish, you can purchase a new one for $3 gil.
- **7460**: Purchase a new multi-ticket? [Yes ($3 gil)./No.]
...
```
  ...
  1: 0x0006 [0x1D] PRINT_EVENT_MESSAGE(message_id=7453*)
    → "Welcome to Carpenters' Landing."
  2: 0x0009 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x000A [0x1D] PRINT_EVENT_MESSAGE(message_id=7454*)
  ...
  5: 0x000E [0x24] CREATE_DIALOG(message_id=7455*, default_option=2*, option_flags=0*)
  ...
  9: 0x0025 [0x1D] PRINT_EVENT_MESSAGE(message_id=7457*)
 ...
 17: 0x003C [0x1D] PRINT_EVENT_MESSAGE(message_id=7448*)
 ...
 20: 0x0043 [0x1D] PRINT_EVENT_MESSAGE(message_id=7456*)
...
SUBROUTINE_004C:
 ...
 27: 0x0066 [0x1D] PRINT_EVENT_MESSAGE(message_id=7458*)
 ...
 31: 0x0070 [0x1D] PRINT_EVENT_MESSAGE(message_id=7459*)
 ...
 33: 0x0074 [0x24] CREATE_DIALOG(message_id=7460*, default_option=1*, option_flags=0*)
 ...
 40: 0x0091 [0x1D] PRINT_EVENT_MESSAGE(message_id=7448*)
    → "I'm sorry, [sir/madame]. You don't have enough gil to purchase a ticket."
 41: 0x0094 [0x23] WAIT_FOR_DIALOG_INTERACTION
 42: 0x0095 [0x01] GOTO 0x00A1
 43: 0x0098 [0x1D] PRINT_EVENT_MESSAGE(message_id=7446*)
...
SUBROUTINE_00A4:
 ...
 52: 0x00B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7448*)
    → "I'm sorry, [sir/madame]. You don't have enough gil to purchase a ticket."
 53: 0x00B7 [0x23] WAIT_FOR_DIALOG_INTERACTION
 54: 0x00B8 [0x01] GOTO 0x00C4
 55: 0x00BB [0x1D] PRINT_EVENT_MESSAGE(message_id=7456*)
    → "Thank you, [sir/madam]. I hope you enjoy sailing with us."
