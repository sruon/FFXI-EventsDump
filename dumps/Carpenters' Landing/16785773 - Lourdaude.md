...
```
  0: 0x0001 [0x1D] PRINT_EVENT_MESSAGE(message_id=7443*)
    → "..."
...
```
  0: 0x0009 [0x1D] PRINT_EVENT_MESSAGE(message_id=7441*)
    → "<Sniff...sniff...> $2...gil..."
...
```
  ...
  4: 0x0019 [0x1D] PRINT_EVENT_MESSAGE(message_id=7441*)
    → "<Sniff...sniff...> $2...gil..."
...
```
  ...
  7: 0x004E [0x1D] PRINT_EVENT_MESSAGE(message_id=7442*)
    → "...Done..."
