...
```
  0: 0x0053 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-509.991*, z=536.360*, y=-120.000*, direction=100.8°*
...
```
  0: 0x005D [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-513.547*, z=541.046*, y=-119.999*, direction=110.3°*
