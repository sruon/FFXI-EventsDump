...
0020: 1C 04 80 1E F0 FF FF 7F  4A F0 FF FF 7F 4E 40 02  ........J....N@.
...
```
  ...
  9: 0x0028 [0x4A] LocalPlayer looks at Trailmix (ID: 16924750/0x0102404E)
 ...
 20: 0x0077 [0x1D] PRINT_EVENT_MESSAGE(message_id=7615*)
 ...
 30: 0x00A7 [0x24] CREATE_DIALOG(message_id=7618*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00B7:
 33: 0x00B7 [0x24] CREATE_DIALOG(message_id=7619*, default_option=0*, option_flags=Work_Zone[2])
    → "What story would you like to be told?\u0007\u000BOn second thought, maybe later.\u0007Dawn(pt.1).\u0007Dawn(pt.2).\u0007Dawn(pt.3).\u0007Dawn(pt.4).\u0007Dawn(pt.5).\u0007Apocalypse Nigh(pt.1).\u0007Apocalypse Nigh(pt.2).\u0007Apocalypse Nigh(pt.3).\u0007Apocalypse Nigh(pt.4).\u0007Both Paths Taken(pt.1).\u0007Both Paths Taken(pt.2).\u0007The Man Behind the Mask.\u0007Rhapsodies of Vana'diel.\u0007The Winds of Time(pt.1).\u0007The Winds of Time(pt.2).\u0007The Winds of Time(pt.3).\u0007Calm After the Storm.\u007F1\u0000\u0007"
 ...
 38: 0x00DD [0x1D] PRINT_EVENT_MESSAGE(message_id=7617*)
    → "Oh......\u0007...outta here.........\u007F1\u0000\u0007"
...
SUBROUTINE_00FB:
 44: 0x00FB [0x24] CREATE_DIALOG(message_id=7620*, default_option=0*, option_flags=Work_Zone[3])
    → "\u007F1\u0000\u0007"
 ...
 49: 0x0121 [0x1D] PRINT_EVENT_MESSAGE(message_id=7617*)
    → "Oh......\u0007...outta here.........\u007F1\u0000\u0007"
...
SUBROUTINE_013F:
 55: 0x013F [0x24] CREATE_DIALOG(message_id=7621*, default_option=0*, option_flags=Work_Zone[4])
    → "\u007F1\u0000\u0007"
 ...
 60: 0x0165 [0x1D] PRINT_EVENT_MESSAGE(message_id=7617*)
    → "Oh......\u0007...outta here.........\u007F1\u0000\u0007"
...
SUBROUTINE_0183:
 66: 0x0183 [0x24] CREATE_DIALOG(message_id=7622*, default_option=0*, option_flags=Work_Zone[5])
    → "\u007F1\u0000\u0007"
 ...
 71: 0x01A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7617*)
    → "Oh......\u0007...outta here.........\u007F1\u0000\u0007"
...
SUBROUTINE_01BC:
 ...
 78: 0x01D5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7617*)
    → "Oh......\u0007...outta here.........\u007F1\u0000\u0007"
...
SUBROUTINE_01DB:
 82: 0x01DB [0x1D] PRINT_EVENT_MESSAGE(message_id=7616*)
    → ".........listen......\u007F1\u0000\u0007"
