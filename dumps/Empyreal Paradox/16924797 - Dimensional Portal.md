...
- **7826**: This device allows teleportation to [Holla/Dem/Mea].
- **7827**: Would you like to teleport? [Ready, willing, and able./No thanks.]
- **7903**: Teleport to where? [Crag of Holla./Crag of Dem./Crag of Mea./Reisenjima Sanctorium./None of the above.]
...
```
  0: 0x0001 [0x48] [System] [7826*]:
    → "This device allows teleportation to [Holla/Dem/Mea]."
  1: 0x0004 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=7827*, default_option=1*, option_flags=0*)
...
```
  0: 0x0085 [0x24] CREATE_DIALOG(message_id=7903*, default_option=4*, option_flags=0*)
