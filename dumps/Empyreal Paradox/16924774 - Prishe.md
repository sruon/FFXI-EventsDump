...
| [65535.8](#event-655358) | 0x004F       |      3 |              2 |
| [65535.9](#event-655359) | 0x0052       |      3 |              2 |
...
```
  0: 0x0045 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-514.818*, z=515.228*, y=-120.000*, direction=211.2°*
...
```
  0: 0x004F [0xAB] EventEntity->Render.Flags2 |= 0x02 // Set bit 1
