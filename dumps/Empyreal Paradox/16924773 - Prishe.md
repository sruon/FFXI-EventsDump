...
| [65535.9](#event-655359)   | 0x0059       |      4 |              2 |
| [3](#event-3)              | 0x005D       |      1 |              1 |
...
```
  0: 0x0045 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-514.241*, z=528.336*, y=-119.999*, direction=39.6°*
...
```
  0: 0x004F [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-517.925*, z=516.144*, y=-120.000*, direction=256.0°*
...
```
  0: 0x0059 [0x39] SET_ENTITY_DIRECTION(direction=1.6°*)
...
```
  0: 0x0061 [0xA4] EventEntity->Flags3.unknown_3_2 = 0
