...
```
  ...
  2: 0x02DD [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=1*, hair=4099, head=0*, body=230*, hands=230*, legs=230*, feet=230*, main=0*, sub=0*)
  3: 0x02F1 [0x01] GOTO 0x03CD

SUBROUTINE_02F4:
  4: 0x02F4 [0x02] IF !(Work_Zone[2] == 2*) GOTO 0x0313
  5: 0x02FC [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=2*, hair=4099, head=0*, body=230*, hands=230*, legs=230*, feet=230*, main=0*, sub=0*)
  6: 0x0310 [0x01] GOTO 0x03CD

SUBROUTINE_0313:
  7: 0x0313 [0x02] IF !(Work_Zone[2] == 3*) GOTO 0x0332
  8: 0x031B [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=3*, hair=4099, head=0*, body=230*, hands=230*, legs=230*, feet=230*, main=0*, sub=0*)
  9: 0x032F [0x01] GOTO 0x03CD

SUBROUTINE_0332:
 10: 0x0332 [0x02] IF !(Work_Zone[2] == 4*) GOTO 0x0351
 11: 0x033A [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=4*, hair=4099, head=0*, body=230*, hands=230*, legs=230*, feet=230*, main=0*, sub=0*)
 12: 0x034E [0x01] GOTO 0x03CD

SUBROUTINE_0351:
 13: 0x0351 [0x02] IF !(Work_Zone[2] == 5*) GOTO 0x0370
 14: 0x0359 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=5*, hair=4099, head=0*, body=230*, hands=230*, legs=230*, feet=230*, main=0*, sub=0*)
 15: 0x036D [0x01] GOTO 0x03CD

SUBROUTINE_0370:
 16: 0x0370 [0x02] IF !(Work_Zone[2] == 6*) GOTO 0x038F
 17: 0x0378 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=6*, hair=4099, head=0*, body=230*, hands=230*, legs=230*, feet=230*, main=0*, sub=0*)
 18: 0x038C [0x01] GOTO 0x03CD

SUBROUTINE_038F:
 19: 0x038F [0x02] IF !(Work_Zone[2] == 7*) GOTO 0x03AE
 20: 0x0397 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=7*, hair=4099, head=0*, body=230*, hands=230*, legs=230*, feet=230*, main=0*, sub=0*)
 21: 0x03AB [0x01] GOTO 0x03CD

SUBROUTINE_03AE:
 22: 0x03AE [0x02] IF !(Work_Zone[2] == 8*) GOTO 0x03CD
 23: 0x03B6 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=8*, hair=4099, head=0*, body=230*, hands=230*, legs=230*, feet=230*, main=0*, sub=0*)
