...
```
  ...
  2: 0x0047 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=1*, hair=4099, head=388*, body=4100, hands=4101, legs=4102, feet=4103, main=0*, sub=0*)
  3: 0x005B [0x01] GOTO 0x0137

SUBROUTINE_005E:
  4: 0x005E [0x02] IF !(Work_Zone[2] == 2*) GOTO 0x007D
  5: 0x0066 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=2*, hair=4099, head=388*, body=4100, hands=4101, legs=4102, feet=4103, main=0*, sub=0*)
  6: 0x007A [0x01] GOTO 0x0137

SUBROUTINE_007D:
  7: 0x007D [0x02] IF !(Work_Zone[2] == 3*) GOTO 0x009C
  8: 0x0085 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=3*, hair=4099, head=388*, body=4100, hands=4101, legs=4102, feet=4103, main=0*, sub=0*)
  9: 0x0099 [0x01] GOTO 0x0137

SUBROUTINE_009C:
 10: 0x009C [0x02] IF !(Work_Zone[2] == 4*) GOTO 0x00BB
 11: 0x00A4 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=4*, hair=4099, head=388*, body=4100, hands=4101, legs=4102, feet=4103, main=0*, sub=0*)
 12: 0x00B8 [0x01] GOTO 0x0137

SUBROUTINE_00BB:
 13: 0x00BB [0x02] IF !(Work_Zone[2] == 5*) GOTO 0x00DA
 14: 0x00C3 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=5*, hair=4099, head=388*, body=4100, hands=4101, legs=4102, feet=4103, main=0*, sub=0*)
 15: 0x00D7 [0x01] GOTO 0x0137

SUBROUTINE_00DA:
 16: 0x00DA [0x02] IF !(Work_Zone[2] == 6*) GOTO 0x00F9
 17: 0x00E2 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=6*, hair=4099, head=388*, body=4100, hands=4101, legs=4102, feet=4103, main=0*, sub=0*)
 18: 0x00F6 [0x01] GOTO 0x0137

SUBROUTINE_00F9:
 19: 0x00F9 [0x02] IF !(Work_Zone[2] == 7*) GOTO 0x0118
 20: 0x0101 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=7*, hair=4099, head=388*, body=4100, hands=4101, legs=4102, feet=4103, main=0*, sub=0*)
 21: 0x0115 [0x01] GOTO 0x0137

SUBROUTINE_0118:
 22: 0x0118 [0x02] IF !(Work_Zone[2] == 8*) GOTO 0x0137
 23: 0x0120 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Full entity look, race=8*, hair=4099, head=388*, body=4100, hands=4101, legs=4102, feet=4103, main=0*, sub=0*)
