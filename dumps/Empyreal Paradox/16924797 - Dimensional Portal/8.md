...
```
  0: 0x0001 [0x48] [System] [7821*]:
    → "This device allows teleportation to \u000C\u0000[Holla/Dem/Mea].\u007F1\u0000\u0007"
  1: 0x0004 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=7822*, default_option=1*, option_flags=0*)
    → "Would you like to teleport?\u0007\u000BReady, willing, and able.\u0007No thanks.\u007F1\u0000\u0007"
...
SUBROUTINE_001F:
 ...
 14: 0x003D [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who1", work_offset2=0*)
 15: 0x004E [0x55] WAIT_LOAD_SCHEDULER(work_offset=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who1")
 16: 0x005D [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo0", work_offset2=0*)
 17: 0x006E [0x1C] WAIT(30* ticks)
 18: 0x0071 [0x30] SET_UCOFF_CONTINUE_ZERO()
 19: 0x0072 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="whi1", work_offset2=0*)
