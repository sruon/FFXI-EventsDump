...
```
  ...
  6: 0x00AE [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who1", work_offset2=0*)
  7: 0x00BF [0x55] WAIT_LOAD_SCHEDULER(work_offset=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who1")
  8: 0x00CE [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo0", work_offset2=0*)
  9: 0x00DF [0x1C] WAIT(30* ticks)
 10: 0x00E2 [0x30] SET_UCOFF_CONTINUE_ZERO()
 11: 0x00E3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="whi1", work_offset2=0*)
...
SUBROUTINE_00F7:
 ...
 17: 0x0118 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who1", work_offset2=0*)
 18: 0x0129 [0x55] WAIT_LOAD_SCHEDULER(work_offset=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who1")
 19: 0x0138 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo0", work_offset2=0*)
 20: 0x0149 [0x1C] WAIT(30* ticks)
 21: 0x014C [0x30] SET_UCOFF_CONTINUE_ZERO()
 22: 0x014D [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="whi1", work_offset2=0*)
...
SUBROUTINE_0161:
 ...
 28: 0x0182 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who1", work_offset2=0*)
 29: 0x0193 [0x55] WAIT_LOAD_SCHEDULER(work_offset=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who1")
 30: 0x01A2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo0", work_offset2=0*)
 31: 0x01B3 [0x1C] WAIT(30* ticks)
 32: 0x01B6 [0x30] SET_UCOFF_CONTINUE_ZERO()
 33: 0x01B7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="whi1", work_offset2=0*)
...
SUBROUTINE_01CB:
 ...
 39: 0x01EC [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who1", work_offset2=0*)
 40: 0x01FD [0x55] WAIT_LOAD_SCHEDULER(work_offset=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="who1")
 41: 0x020C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo0", work_offset2=0*)
 42: 0x021D [0x1C] WAIT(30* ticks)
 43: 0x0220 [0x30] SET_UCOFF_CONTINUE_ZERO()
 44: 0x0221 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="whi1", work_offset2=0*)
