...
|       1 | 0x0001      |           1 |
|       2 | 0x0080      |         128 |
|       3 | 0xFFF83ADA  |  4294458074 |
|       4 | 0x83034     |      536628 |
|       5 | 0xFFFE2B41  |  4294847297 |
|       6 | 0x0487      |        1159 |
|       7 | 0xFFF82E02  |  4294454786 |
|       8 | 0x8452E     |      541998 |
|       9 | 0x04DB      |        1243 |
|      10 | 0x01AF      |         431 |
...
```
  0: 0x0053 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-509.222*, z=536.628*, y=-119.999*, direction=101.9°*
...
```
  0: 0x005D [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-512.510*, z=541.998*, y=-119.999*, direction=109.2°*
...
```
  0: 0x0080 [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "fuk1" with entities [EventEntity, EventEntity], work=431*
