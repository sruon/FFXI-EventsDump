...
```
  0: 0x0012 [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "main" with entities [Ajido-Marujido (ID: 17399838/0x0109801E), Ajido-Marujido (ID: 17399838/0x0109801E)], work=[7*, 0*]
  ...
  4: 0x0042 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "damg" for entities [Yagudo High Priest (ID: 17399836/0x0109801C), Yagudo High Priest (ID: 17399836/0x0109801C)]
