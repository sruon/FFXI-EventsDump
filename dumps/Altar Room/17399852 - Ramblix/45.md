...
0010: 2C 80 09 01 03 00 00 00  80 02 02 10 01 80 01 28  ,..............(
...
```
  ...
  4: 0x000B [0x4A] LocalPlayer looks at Ramblix (ID: 17399852/0x0109802C)
 ...
 15: 0x005A [0x1D] PRINT_EVENT_MESSAGE(message_id=7322*)
 ...
 17: 0x005E [0x1D] PRINT_EVENT_MESSAGE(message_id=7323*)
 ...
 19: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=7324*)
 ...
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=7332*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7333*, default_option=0*, option_flags=Work_Zone[2])
    → "What story would you like to be told?\u0007\u000BOn second thought, maybe later.\u0007Magicite(pt.1).\u0007Magicite(pt.2).\u0007Magicite(pt.3).\u0007A Moral Manifest?(pt.1).\u0007A Moral Manifest?(pt.2).\u0007A Moral Manifest?(pt.3).\u0007A Moral Manifest?(pt.4).\u0007A Moral Manifest?(pt.5).\u0007A Moral Manifest?(pt.6).\u007F1\u0000\u0007"
 ...
 37: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7326*)
...
SUBROUTINE_00E6:
 43: 0x00E6 [0x24] CREATE_DIALOG(message_id=7334*, default_option=0*, option_flags=Work_Zone[3])
    → "\u007F1\u0000\u0007"
 ...
 48: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7326*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_012A:
 54: 0x012A [0x24] CREATE_DIALOG(message_id=7335*, default_option=0*, option_flags=Work_Zone[4])
    → "\u007F1\u0000\u0007"
 ...
 59: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=7326*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_016E:
 65: 0x016E [0x24] CREATE_DIALOG(message_id=7336*, default_option=0*, option_flags=Work_Zone[5])
    → "\u007F1\u0000\u0007"
 ...
 70: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=7326*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_01A7:
 ...
 77: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7326*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_01C6:
 81: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7325*)
    → "Now, listen close...\u007F1\u0000\u0007"
