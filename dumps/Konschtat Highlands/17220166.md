...
```
  ...
  1: 0x000A [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=109.817*, z=206.793*, y=24.059*, direction=300.5°*
...
```
  ...
  1: 0x0017 [0x1F] MOVE_ENTITY: EventEntity moves to X=113.890*, Z=219.257*, Y=24.855*
