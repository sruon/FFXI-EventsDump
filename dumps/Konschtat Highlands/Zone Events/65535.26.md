...
```
  ...
  1: 0x0F17 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=149*, entity1=EventEntity, entity2=EventEntity, action="thk0")
  2: 0x0F26 [0x01] GOTO 0x0F40

SUBROUTINE_0F29:
  3: 0x0F29 [0x03] ExtData[1]->WorkLocal[1] = Entity->Race
  4: 0x0F2E [0x1A] CALL_SUBROUTINE(address=0x09A5)
  5: 0x0F31 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0x0002, entity1=EventEntity, entity2=EventEntity, action="thk1")
