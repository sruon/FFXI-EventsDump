...
```
  ...
  1: 0x003D [0x1F] MOVE_ENTITY: EventEntity moves to X=0.349*, Z=-66.591*, Y=0.000*
  2: 0x0045 [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x0047 [0x1F] MOVE_ENTITY: EventEntity moves to X=-1.445*, Z=-66.591*, Y=0.000*
  4: 0x004F [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  5: 0x0051 [0x4B] UPDATE_ENTITY_YAW(entity=EventEntity, yaw=0.00°*)
