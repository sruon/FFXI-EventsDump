...
- **10475**: Talk to Abihaal at the counter if you would like to board the ship.
- **10476**: This is the entrance for boarding passengers.
...
```
  ...
  1: 0x005C [0x1F] MOVE_ENTITY: EventEntity moves to X=0.349*, Z=-66.591*, Y=0.000*
  2: 0x0064 [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x0066 [0x1F] MOVE_ENTITY: EventEntity moves to X=0.349*, Z=-64.815*, Y=0.000*
