...
```
  ...
  7: 0x018E [0x5B] LOAD_EXT_SCHEDULER(work_offset=881*, entity1=Pyopyoroon (ID: 16994372/0x01035044), entity2=Pyopyoroon (ID: 16994372/0x01035044), action="ura0")
  8: 0x019D [0x1C] WAIT(120* ticks)
  9: 0x01A0 [0x5B] LOAD_EXT_SCHEDULER(work_offset=881*, entity1=Pyopyoroon (ID: 16994372/0x01035044), entity2=Pyopyoroon (ID: 16994372/0x01035044), action="ura1")
