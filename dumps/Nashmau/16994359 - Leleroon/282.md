...
```
  ...
  1: 0x0036 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  2: 0x0047 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 12: 0x007F [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=EventEntity, entity2=EventEntity, scheduler_id="v000", work_offset2=0*)
 13: 0x0090 [0x1C] WAIT(60* ticks)
 14: 0x0093 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 15: 0x00A4 [0x03] Work_Zone[1] = 0*
 16: 0x00A9 [0x02] IF !(Work_Zone[3] == 0*) GOTO 0x0198
 17: 0x00B1 [0x1C] WAIT(30* ticks)
 18: 0x00B4 [0x5B] LOAD_EXT_SCHEDULER(work_offset=842*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 21: 0x00C7 [0x5B] LOAD_EXT_SCHEDULER(work_offset=842*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 ...
 24: 0x00E8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=EventEntity, entity2=EventEntity, scheduler_id="v001", work_offset2=0*)
 25: 0x00F9 [0x1C] WAIT(30* ticks)
 26: 0x00FC [0x29] REQ_SET_WAIT(priority=0x10, entity_id=LocalPlayer, tag_num=0x16)
 27: 0x0103 [0x5B] LOAD_EXT_SCHEDULER(work_offset=843*, entity1=EventEntity, entity2=EventEntity, action="tlb0")
 ...
 35: 0x0121 [0x5B] LOAD_EXT_SCHEDULER(work_offset=843*, entity1=EventEntity, entity2=EventEntity, action="tlb1")
 ...
 38: 0x0142 [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=EventEntity, entity2=EventEntity, scheduler_id="v002", work_offset2=0*)
 39: 0x0153 [0x1C] WAIT(60* ticks)
 40: 0x0156 [0x5B] LOAD_EXT_SCHEDULER(work_offset=842*, entity1=EventEntity, entity2=EventEntity, action="thk0")
 ...
 46: 0x0176 [0x5B] LOAD_EXT_SCHEDULER(work_offset=842*, entity1=EventEntity, entity2=EventEntity, action="thk1")
 ...
 50: 0x0198 [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=EventEntity, entity2=EventEntity, scheduler_id="v003", work_offset2=0*)
 51: 0x01A9 [0x5B] LOAD_EXT_SCHEDULER(work_offset=842*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 59: 0x01CB [0x5B] LOAD_EXT_SCHEDULER(work_offset=842*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 ...
 62: 0x01EC [0x45] LOAD_SCHEDULED_TASK(work_offset1=283*, entity1=EventEntity, entity2=EventEntity, scheduler_id="v004", work_offset2=0*)
 ...
 69: 0x021A [0x5B] LOAD_EXT_SCHEDULER(work_offset=881*, entity1=EventEntity, entity2=EventEntity, action="wht0")
...
SUBROUTINE_0230:
 ...
 76: 0x0240 [0x5B] LOAD_EXT_SCHEDULER(work_offset=842*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 79: 0x0253 [0x5B] LOAD_EXT_SCHEDULER(work_offset=842*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
 ...
 86: 0x027D [0x5B] LOAD_EXT_SCHEDULER(work_offset=843*, entity1=EventEntity, entity2=EventEntity, action="hap0")
...
SUBROUTINE_02A4:
 ...
 96: 0x02B4 [0x5B] LOAD_EXT_SCHEDULER(work_offset=842*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
 ...
 99: 0x02C7 [0x5B] LOAD_EXT_SCHEDULER(work_offset=842*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
...
106: 0x02F1 [0x5B] LOAD_EXT_SCHEDULER(work_offset=843*, entity1=EventEntity, entity2=EventEntity, action="hap0")
...
116: 0x0328 [0x5B] LOAD_EXT_SCHEDULER(work_offset=842*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
...
119: 0x033B [0x5B] LOAD_EXT_SCHEDULER(work_offset=842*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
...
126: 0x0365 [0x5B] LOAD_EXT_SCHEDULER(work_offset=843*, entity1=EventEntity, entity2=EventEntity, action="hap0")
...
134: 0x038F [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
135: 0x03A0 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
...
139: 0x03C3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
