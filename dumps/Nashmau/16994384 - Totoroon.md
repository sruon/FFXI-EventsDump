...
```
  ...
  1: 0x0009 [0x1D] PRINT_EVENT_MESSAGE(message_id=10679*)
...
```
  ...
  1: 0x0014 [0x1D] PRINT_EVENT_MESSAGE(message_id=10680*)
...
```
  ...
  1: 0x001F [0x1D] PRINT_EVENT_MESSAGE(message_id=10672*)
...
```
  ...
  1: 0x002A [0x1D] PRINT_EVENT_MESSAGE(message_id=10676*)
