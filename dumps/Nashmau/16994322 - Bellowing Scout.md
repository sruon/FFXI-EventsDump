...
- **10475**: Talk to Sajhra at the counter if you would like to enter town.
- **10478**: This is the exit for arriving passengers.
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=10475*)
