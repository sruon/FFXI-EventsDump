...
- **10476**: Talk to Sajhra at the counter if you would like to enter town.
- **10479**: This is the exit for arriving passengers.
...
```
  ...
  4: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=10476*)
...
```
  ...
  4: 0x0034 [0x1D] PRINT_EVENT_MESSAGE(message_id=10479*)
