...
- **10716**: The minstrel of melodies is my name, For a mere $6 gil I'll recall your past. Your stories of love, anger, triumph, and shame, The river of memories runs deep and vast.
- **10717**: The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last.
- **10719**: Which memory will you have recalled? [Nothing./Aht Urhgan Missions./Aht Urhgan Quests./Other Quests.]
- **10720**: Which memory will you have recalled? [Nothing./Royal Puppeteer./Lost Kingdom./Ghosts of the Past.]
- **10721**: Which memory will you have recalled? [Nothing./Cook-a-roon?(pt.1)./Cook-a-roon?(pt.2)./Totoroon's Treasure Hunt(pt.1)./Totoroon's Treasure Hunt(pt.2)./Totoroon's Treasure Hunt(pt.3)./The Die Is Cast(pt.1)./What Friends Are For(pt.1)./What Friends Are For(pt.2)./What Friends Are For(pt.3)./Navigating the Unfriendly Seas./The Wayward Automaton./Operation Teatime./Puppetmaster Blues./Not Meant to Be(pt.1)./Not Meant to Be(pt.2)./Promotion: Sergeant(pt.1)./Promotion: Sergeant(pt.2)./Led Astray./Rat Race(pt.1)./Rat Race(pt.2)./Rat Race(pt.3)./Rat Race(pt.4)./Rat Race(pt.5)./Duties, Tasks, and Deeds(pt.1)./Duties, Tasks, and Deeds(pt.2)./The Rider Cometh(pt.1)./The Rider Cometh(pt.2)./The Rider Cometh(pt.3)./Unwavering Resolve(pt.1)./Unwavering Resolve(pt.2)./Unwavering Resolve(pt.3).]
- **10722**: Which memory will you have recalled? [Nothing./Corsair Attire./Einherjar./Peach Power.]
- **10723**: Which memory will you have recalled? [Nothing.]
...
```
  ...
  3: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=10717*)
 ...
 21: 0x0088 [0x1D] PRINT_EVENT_MESSAGE(message_id=10717*)
    → "The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last."
 22: 0x008B [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x008C [0x21] END_EVENT
 24: 0x008D [0x00] END_REQSTACK()
 25: 0x008E [0x1D] PRINT_EVENT_MESSAGE(message_id=10716*)
 ...
 39: 0x00D4 [0x24] CREATE_DIALOG(message_id=10719*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00E4:
 42: 0x00E4 [0x24] CREATE_DIALOG(message_id=10720*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_0113:
 50: 0x0113 [0x24] CREATE_DIALOG(message_id=10721*, default_option=0*, option_flags=Work_Zone[3])
...
SUBROUTINE_0142:
 58: 0x0142 [0x24] CREATE_DIALOG(message_id=10722*, default_option=0*, option_flags=Work_Zone[4])
...
SUBROUTINE_0171:
 66: 0x0171 [0x24] CREATE_DIALOG(message_id=10723*, default_option=0*, option_flags=Work_Zone[5])
...
SUBROUTINE_01A0:
 74: 0x01A0 [0x24] CREATE_DIALOG(message_id=10724*, default_option=0*, option_flags=Work_Zone[6])
    → "Which memory will you have recalled? [Nothing.]"
...
SUBROUTINE_01CF:
 82: 0x01CF [0x24] CREATE_DIALOG(message_id=10725*, default_option=0*, option_flags=Work_Zone[7])
    → "Which memory will you have recalled? [Nothing.]"
