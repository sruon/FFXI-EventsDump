...
```
  ...
  2: 0x0137 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi2" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
  3: 0x0148 [0x46] CAMERA_CONTROL: Disable user control
  4: 0x014A [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s064" with entities [LocalPlayer, LocalPlayer], work=[199*, 0*]
  5: 0x015B [0x55] WAIT_LOAD_SCHEDULER: Wait for scheduler "s064" with entities [LocalPlayer, LocalPlayer], work=199*
