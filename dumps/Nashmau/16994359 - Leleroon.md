x01C7 [0x1D] PRINT_EVENT_MESSAGE(message_id=10689*)
 ...
 64: 0x0202 [0x24] CREATE_DIALOG(message_id=10690*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
 ...
 70: 0x0229 [0x1D] PRINT_EVENT_MESSAGE(message_id=10691*)
    → "Oookay, bye bye now!"
 ...
 77: 0x024F [0x1D] PRINT_EVENT_MESSAGE(message_id=10696*)
 ...
 81: 0x0265 [0x24] CREATE_DIALOG(message_id=10695*, default_option=0*, option_flags=0*)
 ...
 87: 0x028C [0x1D] PRINT_EVENT_MESSAGE(message_id=10699*)
...
SUBROUTINE_02A1:
 ...
 97: 0x02C3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10697*)
...
101: 0x02D9 [0x24] CREATE_DIALOG(message_id=10695*, default_option=0*, option_flags=0*)
    → "Yooo really, really have want? [Yes, I really, really want!/When you put it that way...]"
...
107: 0x0300 [0x1D] PRINT_EVENT_MESSAGE(message_id=10699*)
    → "I give this yooo. Now yooo visit friend to make clothings, okay? Yooo will have so happiness."
...
117: 0x0337 [0x1D] PRINT_EVENT_MESSAGE(message_id=10698*)
...
121: 0x034D [0x24] CREATE_DIALOG(message_id=10695*, default_option=0*, option_flags=0*)
    → "Yooo really, really have want? [Yes, I really, really want!/When you put it that way...]"
...
127: 0x0374 [0x1D] PRINT_EVENT_MESSAGE(message_id=10699*)
    → "I give this yooo. Now yooo visit friend to make clothings, okay? Yooo will have so happiness."
...
```
  ...
  2: 0x03EA [0x1D] PRINT_EVENT_MESSAGE(message_id=10696*)
    → "Nation where Leleroon have friend.t Place with big, hoooge trees, lots and many, yooo know?"
...
```
  ...
  2: 0x0416 [0x1D] PRINT_EVENT_MESSAGE(message_id=10697*)
    → "Nation where Leleroon have friend.t Place where muscle peoples take rocks from inside of mountains, yooo know?"
...
```
  ...
  2: 0x0442 [0x1D] PRINT_EVENT_MESSAGE(message_id=10698*)
    → "Nation where Leleroon have friend.t Place with castle inside of fooorest, yooo know?"
...
```
 ...
 14: 0x04CE [0x1D] PRINT_EVENT_MESSAGE(message_id=10700*)
 ...
 23: 0x0519 [0x1D] PRINT_EVENT_MESSAGE(message_id=10701*)
 ...
 30: 0x0552 [0x1D] PRINT_EVENT_MESSAGE(message_id=10702*)
    → "Oh...ohhh? What can be...?"
 31: 0x0555 [0x23] WAIT_FOR_DIALOG_INTERACTION
 32: 0x0556 [0x1D] PRINT_EVENT_MESSAGE(message_id=10703*)
 ...
 38: 0x0580 [0x1D] PRINT_EVENT_MESSAGE(message_id=10704*)
 ...
 43: 0x0599 [0x1D] PRINT_EVENT_MESSAGE(message_id=10705*)
 ...
 46: 0x05AC [0x1D] PRINT_EVENT_MESSAGE(message_id=10706*)
 ...
 53: 0x05F1 [0x1D] PRINT_EVENT_MESSAGE(message_id=10707*)
 ...
 55: 0x05F5 [0x1D] PRINT_EVENT_MESSAGE(message_id=10708*)
 ...
 57: 0x05F9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10709*)
...
```
  ...
  2: 0x066A [0x1D] PRINT_EVENT_MESSAGE(message_id=10710*)
  ...
  4: 0x066E [0x1D] PRINT_EVENT_MESSAGE(message_id=10711*)
  ...
  6: 0x0672 [0x1D] PRINT_EVENT_MESSAGE(message_id=10712*)
