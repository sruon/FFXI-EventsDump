...
- **11990**: Eep! Pay me no heed.
- **11991**: I seek...the power of the peach...so that I can stop the transformation...and remain human evermore.
- **11992**: The peach thing I require...you have it...?
- **12006**: You...you found the peach thing I seek?
- **12007**: Then I give this to you in return. Perhaps...it will serve you better than me.
- **12008**: And my journey...to prevent the transformation...continues.
...
```
  ...
  1: 0x0719 [0x1D] PRINT_EVENT_MESSAGE(message_id=11990*)
    → "Eep! Pay me no heed."
  2: 0x071C [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x071D [0x1D] PRINT_EVENT_MESSAGE(message_id=11991*)
...
```
  ...
  4: 0x073F [0x1D] PRINT_EVENT_MESSAGE(message_id=11992*)
