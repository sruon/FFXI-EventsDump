...
- **7475**: What am I doing here? Oh, just business. Nothing you should worry about.
- **7476**: You've talked to my partner, I assume? Ah, but you don't meet the requirements. You must come here with a party of two or more members level fifteen and below.
- **7477**: You've talked to my partner, I assume? Stand in a line--let me see you all.
- **7478**: Okay, you check out. So, how was your trip here? Was it fun, or was it rough?
- **7479**: How was your trip here? [Fun!/Rough.]
- **7480**: I see...that means people would not care to pay money to come here, then.
- **7481**: I see...so that means no one would want to come here, however good the sights may be.
- **7482**: Well, some details have to be smoothed out--something my partner isn't too good at--but it isn't a bad business idea. Here, take this, and thanks for coming.
- **7483**: There must be some money to be made with the sights here. It really isn't a bad idea...
...
```
  ...
  1: 0x0011 [0x1D] PRINT_EVENT_MESSAGE(message_id=7476*)
...
```
 ...
 15: 0x0096 [0x1D] PRINT_EVENT_MESSAGE(message_id=7477*)
 ...
 23: 0x00EE [0x1D] PRINT_EVENT_MESSAGE(message_id=7478*)
 ...
 26: 0x00F7 [0x24] CREATE_DIALOG(message_id=7479*, default_option=0*, option_flags=0*)
 ...
 30: 0x0116 [0x1D] PRINT_EVENT_MESSAGE(message_id=7480*)
 ...
 35: 0x0134 [0x1D] PRINT_EVENT_MESSAGE(message_id=7481*)
...
SUBROUTINE_013B:
 ...
 41: 0x0166 [0x1D] PRINT_EVENT_MESSAGE(message_id=7482*)
...
```
  ...
  1: 0x01C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7483*)
