...
- **7473**: What am I doing here? Oh, just business. Nothing you should worry about.
- **7474**: You've talked to my partner, I assume? Ah, but you don't meet the requirements. You must come here with a party of two or more members level fifteen and below.
- **7475**: You've talked to my partner, I assume? Stand in a line--let me see you all.
- **7476**: Okay, you check out. So, how was your trip here? Was it fun, or was it rough?
- **7477**: How was your trip here? [Fun!/Rough.]
- **7478**: I see...that means people would not care to pay money to come here, then.
- **7479**: I see...so that means no one would want to come here, however good the sights may be.
- **7480**: Well, some details have to be smoothed out--something my partner isn't too good at--but it isn't a bad business idea. Here, take this, and thanks for coming.
- **7481**: There must be some money to be made with the sights here. It really isn't a bad idea...
...
```
 ...
 15: 0x0096 [0x1D] PRINT_EVENT_MESSAGE(message_id=7475*)
 ...
 23: 0x00EE [0x1D] PRINT_EVENT_MESSAGE(message_id=7476*)
 ...
 26: 0x00F7 [0x24] CREATE_DIALOG(message_id=7477*, default_option=0*, option_flags=0*)
 ...
 30: 0x0116 [0x1D] PRINT_EVENT_MESSAGE(message_id=7478*)
 ...
 35: 0x0134 [0x1D] PRINT_EVENT_MESSAGE(message_id=7479*)
...
SUBROUTINE_013B:
 ...
 41: 0x0166 [0x1D] PRINT_EVENT_MESSAGE(message_id=7480*)
...
```
  ...
  1: 0x01C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7481*)
