...
```
  ...
  1: 0x0011 [0x1D] PRINT_EVENT_MESSAGE(message_id=7472*)
    → "You've talked to my partner, I assume?\u0007Ah, but you don't meet the requirements.\u0007You must come here with a party of two or more members level fifteen and below.\u007F1\u0000\u0007"
