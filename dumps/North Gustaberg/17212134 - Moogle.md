...
- **8293**: Trade in for a prize? [Not now./$0 ($1 brands)./$2 ($3 brands)./$4 ($5 brands)./$6 ($7 brands)./$8 ($9 brands)./$10 ($11 brands)./$12 ($13 brands)./$14 ($15 brands).]
...
```
  ...
  1: 0x0387 [0x1D] PRINT_EVENT_MESSAGE(message_id=8292*)
 ...
 19: 0x03DB [0x24] CREATE_DIALOG(message_id=8293*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0432:
 ...
 26: 0x0440 [0x1D] PRINT_EVENT_MESSAGE(message_id=8297*)
 ...
 31: 0x0451 [0x24] CREATE_DIALOG(message_id=8294*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0478:
 ...
 39: 0x048B [0x1D] PRINT_EVENT_MESSAGE(message_id=8299*)
 ...
 44: 0x049C [0x24] CREATE_DIALOG(message_id=8294*, default_option=0*, option_flags=0*)
    → "Trade $1 brands for $0? [No thanks./Giddy-up!]"
...
SUBROUTINE_04C3:
 ...
 52: 0x04D6 [0x1D] PRINT_EVENT_MESSAGE(message_id=8296*)
 ...
 57: 0x04E7 [0x24] CREATE_DIALOG(message_id=8294*, default_option=0*, option_flags=0*)
    → "Trade $1 brands for $0? [No thanks./Giddy-up!]"
...
SUBROUTINE_050E:
 ...
 65: 0x0521 [0x1D] PRINT_EVENT_MESSAGE(message_id=8300*)
 ...
 70: 0x0532 [0x24] CREATE_DIALOG(message_id=8294*, default_option=0*, option_flags=0*)
    → "Trade $1 brands for $0? [No thanks./Giddy-up!]"
...
SUBROUTINE_0559:
 ...
 77: 0x0567 [0x1D] PRINT_EVENT_MESSAGE(message_id=8298*)
 ...
 82: 0x0578 [0x24] CREATE_DIALOG(message_id=8294*, default_option=0*, option_flags=0*)
    → "Trade $1 brands for $0? [No thanks./Giddy-up!]"
...
SUBROUTINE_059F:
 ...
 89: 0x05AD [0x1D] PRINT_EVENT_MESSAGE(message_id=8301*)
 ...
 94: 0x05BE [0x24] CREATE_DIALOG(message_id=8294*, default_option=0*, option_flags=0*)
    → "Trade $1 brands for $0? [No thanks./Giddy-up!]"
...
101: 0x05F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=8302*)
...
106: 0x0604 [0x24] CREATE_DIALOG(message_id=8294*, default_option=0*, option_flags=0*)
    → "Trade $1 brands for $0? [No thanks./Giddy-up!]"
...
```
  ...
  1: 0x0635 [0x24] CREATE_DIALOG(message_id=8290*, default_option=0*, option_flags=0*)
    → "How goes it, pardner? [Keep on herdin'./Ask about the buffalo./Get the mother's scent./Mosey on home.]"
...
```
  0: 0x064A [0x1D] PRINT_EVENT_MESSAGE(message_id=8288*)
...
# Dead code (unreachable instructions):
     ...
     0x0655 [0x1D] PRINT_EVENT_MESSAGE(message_id=8263*)
    → "The big beastly ones are the bulls, the bosses o' the herds. The midsized ones are the mother cows, and the li'l-bittiest ones are the baby calves."
     ...
     0x0659 [0x1D] PRINT_EVENT_MESSAGE(message_id=8264*)
    → "The calves are sweet little thangs. Don't even have to hypnotize 'em; they'll follow their mother's scent just 'bout anywhere."
     ...
     0x065D [0x1D] PRINT_EVENT_MESSAGE(message_id=8265*)
    → "By the by, we got ourselves a bottle o' Eau de Buffalo here. We moogle cowpokes use it to disguise ourselves with the mother buffalo's scent. It's only got $3 [dose/doses] left, but they're all yours, pardner."
     ...
     0x0661 [0x1D] PRINT_EVENT_MESSAGE(message_id=8266*)
    → "'Course, there ain't no need to fret if it runs out. Just brush yerself up against one of the mama cows and you'll get a natural shot of Eau de Buffalo just like that."
     ...
     0x0665 [0x1D] PRINT_EVENT_MESSAGE(message_id=8267*)
    → "But you'd best be careful, 'cause they be some hot-tempered heifers, y'hear? You'll be wantin' to sneak up on them from behind, all careful-like, to avoid their charge."
     ...
     0x0669 [0x1D] PRINT_EVENT_MESSAGE(message_id=8268*)
    → "As for the bulls, I'm quakin' in my boots just thinkin' 'bout 'em. They're the nastiest, most foul-tempered beasts this ol' cowhand's ever laid eyes upon. You'll be wantin' to steer clear of 'em and stick to roundin' up the cows and calves, kupo."
     ...
     0x066D [0x1D] PRINT_EVENT_MESSAGE(message_id=8269*)
    → "And don't you be forgettin' that these buffaloes, they always act as a herd, y'hear? So don't go mixin' the herds, or we'll have a right ruckus on our hands."
     ...
     0x0671 [0x1D] PRINT_EVENT_MESSAGE(message_id=8270*)
