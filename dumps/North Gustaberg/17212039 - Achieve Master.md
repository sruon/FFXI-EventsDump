...
- **12541**: Top o' the menu to ya. [Autopilot (Currently: [ON/OFF])/Cutscene...change! (Currently: No. $1)/Cutscene Status Modification./Group: $3./Get me outta here.]
- **12542**: Status No. $1: [Closed/Open/Spare] [Closed./Open./Spare./Return to top.]
...
SUBROUTINE_0027:
  8: 0x0027 [0x24] CREATE_DIALOG(message_id=12541*, default_option=ExtData[1]->WorkLocal[3], option_flags=ExtData[1]->WorkLocal[8])
...
SUBROUTINE_00D0:
 ...
 45: 0x00DB [0x24] CREATE_DIALOG(message_id=12542*, default_option=ExtData[1]->WorkLocal[4], option_flags=0*)
