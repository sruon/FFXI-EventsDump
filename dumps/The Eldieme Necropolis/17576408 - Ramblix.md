...
- **7492**: Do you want to hear a story? [No, thank you./Let's hear one.]
- **7493**: What story would you like to be told? [On second thought, maybe later./Escort for Hire (San d'Oria)./Fire and Brimstone(pt.1)./Fire and Brimstone(pt.2)./A New Dawn./The Requiem./Girl in the Looking Glass.]
- **7494**: 
- **7495**: 
- **7496**: 
...
```
 ...
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=7492*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7493*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_00E6:
 43: 0x00E6 [0x24] CREATE_DIALOG(message_id=7494*, default_option=0*, option_flags=Work_Zone[3])
    → ""
...
SUBROUTINE_012A:
 54: 0x012A [0x24] CREATE_DIALOG(message_id=7495*, default_option=0*, option_flags=Work_Zone[4])
    → ""
...
SUBROUTINE_016E:
 65: 0x016E [0x24] CREATE_DIALOG(message_id=7496*, default_option=0*, option_flags=Work_Zone[5])
    → ""
