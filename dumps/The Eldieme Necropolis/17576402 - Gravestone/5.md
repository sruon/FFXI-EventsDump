...
```
  ...
  7: 0x0011 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 17: 0x004E [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s046", work_offset2=0*)
 18: 0x005F [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 ...
 25: 0x009D [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s052", work_offset2=0*)
 ...
 28: 0x00BF [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 ...
 35: 0x00FE [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s047", work_offset2=0*)
 36: 0x010F [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 ...
 39: 0x012A [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "main" with entities [EventEntity, EventEntity], work=[30*, 0*]
 ...
 43: 0x0154 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
 44: 0x0165 [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s049", work_offset2=0*)
 45: 0x0176 [0x55] WAIT_LOAD_SCHEDULER(work_offset=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s049")
 46: 0x0185 [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s048", work_offset2=0*)
 ...
 52: 0x01BA [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s050", work_offset2=0*)
 ...
 60: 0x0200 [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s131", work_offset2=0*)
 61: 0x0211 [0x01] GOTO 0x0241

SUBROUTINE_0214:
 62: 0x0214 [0x02] IF !(Work_Zone[9] == 8*) GOTO 0x0230
 63: 0x021C [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s131", work_offset2=0*)
 64: 0x022D [0x01] GOTO 0x0241

SUBROUTINE_0230:
 65: 0x0230 [0x45] LOAD_SCHEDULED_TASK(work_offset1=16*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s051", work_offset2=0*)
 ...
 71: 0x025B [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
...
SUBROUTINE_02B0:
 ...
 85: 0x02C4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
