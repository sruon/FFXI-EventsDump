...
```
  ...
  5: 0x001D [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 13: 0x0060 [0x45] LOAD_SCHEDULED_TASK(work_offset1=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u002", work_offset2=0*)
 14: 0x0071 [0x55] WAIT_LOAD_SCHEDULER(work_offset=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u002")
 15: 0x0080 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 16: 0x0091 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 17: 0x00A0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u000", work_offset2=0*)
 18: 0x00B1 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "lc00" for entities [LocalPlayer, LocalPlayer]
 19: 0x00BE [0x1C] WAIT(800* ticks)
 20: 0x00C1 [0x55] WAIT_LOAD_SCHEDULER(work_offset=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u000")
 ...
 23: 0x00DC [0x48] [System] [7452*]:
    → "You play the requiem for the soul that sleeps in this sarcophagus.\u007F1\u0000\u0007"
 24: 0x00DF [0x23] WAIT_FOR_DIALOG_INTERACTION
 25: 0x00E0 [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "main" with entities [EventEntity, EventEntity], work=[3*, 0*]
 ...
 32: 0x0111 [0x45] LOAD_SCHEDULED_TASK(work_offset1=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u001", work_offset2=0*)
 33: 0x0122 [0x55] WAIT_LOAD_SCHEDULER(work_offset=208*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="u001")
 ...
 37: 0x0142 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2", work_offset2=0*)
 38: 0x0153 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2")
 39: 0x0162 [0x46] CAMERA_CONTROL: Restore default settings
 40: 0x0164 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
