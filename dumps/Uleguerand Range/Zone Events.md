...
```
  0: 0x0002 [0x24] CREATE_DIALOG(message_id=7341*, default_option=1*, option_flags=0*)
    → "Use the $3? [Yes./No.]"
...
```
  0: 0x00A7 [0x24] CREATE_DIALOG(message_id=7341*, default_option=1*, option_flags=0*)
    → "Use the $3? [Yes./No.]"
...
```
  0: 0x014C [0x24] CREATE_DIALOG(message_id=7341*, default_option=1*, option_flags=0*)
    → "Use the $3? [Yes./No.]"
