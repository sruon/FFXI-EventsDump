...
SUBROUTINE_00B7:
 ...
 18: 0x00C4 [0x4B] UPDATE_ENTITY_YAW(entity=EventEntity, yaw=19.23°*)
 19: 0x00CB [0xCD] LOAD_SCHEDULED_TASK_ALT4(work_offset=237*, entity1=EventEntity, entity2=EventEntity, action="onmy", work_offset2=0*)
 20: 0x00DC [0x1C] WAIT(30* ticks)
 21: 0x00DF [0x01] GOTO 0x00F4

SUBROUTINE_00E2:
 22: 0x00E2 [0x4B] UPDATE_ENTITY_YAW(entity=EventEntity, yaw=5.28°*)
...
SUBROUTINE_0123:
 ...
 37: 0x0132 [0xCD] LOAD_SCHEDULED_TASK_ALT4(work_offset=237*, entity1=EventEntity, entity2=EventEntity, action="ofmy", work_offset2=0*)
 38: 0x0143 [0xCE] WAIT_LOAD_SCHEDULER_ALT4: Wait for scheduler "ofmy" with entities [EventEntity, EventEntity], work=237*
 39: 0x0152 [0x4B] UPDATE_ENTITY_YAW(entity=EventEntity, yaw=16.79°*)
