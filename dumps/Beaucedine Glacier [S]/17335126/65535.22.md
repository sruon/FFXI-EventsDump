...
```
  ...
  4: 0x01C4 [0x5B] LOAD_EXT_SCHEDULER(work_offset=2474*, entity1=Unnamed NPC (ID: 17335126/0x01088356), entity2=Unnamed NPC (ID: 17335126/0x01088356), action="pas0")
  5: 0x01D3 [0x52] END_LOAD_SCHEDULER: End scheduler "0018" with entities [LocalPlayer, LocalPlayer], work=395*
  6: 0x01E2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=395*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="0019", work_offset2=0*)
