...
- **7706**: Do you want to hear a story? [No, thank you./Let's hear one.]
- **7707**: Do you want to hear a story? [No, thank you./Traitor in the Midst(pt.1)./Traitor in the Midst(pt.2)./Traitor in the Midst(pt.3)./Traitor in the Midst(pt.4)./Traitor in the Midst(pt.5)./Traitor in the Midst(pt.6)./Betrayal at Beaucedine(pt.1)./Betrayal at Beaucedine(pt.2)./On Thin Ice(pt.1)./On Thin Ice(pt.2)./Dungeons and Dancers(pt.1)./Dungeons and Dancers(pt.2)./Dungeons and Dancers(pt.3)./Dungeons and Dancers(pt.4)./Distorter of Time(pt.1)./Distorter of Time(pt.2)./The Will of the World./Songbirds in a Snowstorm(pt.1)./Songbirds in a Snowstorm(pt.2)./Songbirds in a Snowstorm(pt.3)./Songbirds in a Snowstorm(pt.4)./Songbirds in a Snowstorm(pt.5)./Songbirds in a Snowstorm(pt.6)./Songbirds in a Snowstorm(pt.7)./Beneath the Mask./Fork in the Road.]
- **7708**: What story would you like to be told? [On second thought, maybe later.]
- **7709**: What story would you like to be told? [On second thought, maybe later.]
- **7710**: What story would you like to be told? [On second thought, maybe later.]
...
```
 ...
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=7706*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7707*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_00E6:
 43: 0x00E6 [0x24] CREATE_DIALOG(message_id=7708*, default_option=0*, option_flags=Work_Zone[3])
...
SUBROUTINE_012A:
 54: 0x012A [0x24] CREATE_DIALOG(message_id=7709*, default_option=0*, option_flags=Work_Zone[4])
    → "What story would you like to be told? [On second thought, maybe later.]"
...
SUBROUTINE_016E:
 65: 0x016E [0x24] CREATE_DIALOG(message_id=7710*, default_option=0*, option_flags=Work_Zone[5])
    → "What story would you like to be told? [On second thought, maybe later.]"
