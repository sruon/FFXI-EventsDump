...
|---------|-------------|-------------|
|       0 | 0x0028      |          40 |
|       1 | 0xFFFBD443  |  4294693955 |
|       2 | 0xFFFB3CEA  |  4294655210 |
|       3 | 0xFFFF6482  |  4294927490 |
|       4 | 0x000D      |          13 |
|       5 | 0xFFFBCA35  |  4294691381 |
|       6 | 0xFFFB4B6A  |  4294658922 |
|       7 | 0xFFFF653B  |  4294927675 |
...
```
  ...
  1: 0x000B [0x1F] MOVE_ENTITY: EventEntity moves to X=-273.341*, Z=-312.086*, Y=-39.806*
...
```
  ...
  1: 0x0019 [0x1F] MOVE_ENTITY: EventEntity moves to X=-275.915*, Z=-308.374*, Y=-39.621*
