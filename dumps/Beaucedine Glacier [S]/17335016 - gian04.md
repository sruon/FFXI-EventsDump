...
```
  0: 0x0046 [0x1F] MOVE_ENTITY: EventEntity moves to X=123.958*, Z=104.380*, Y=-19.254*
...
```
  0: 0x0052 [0x1F] MOVE_ENTITY: EventEntity moves to X=135.800*, Z=-192.834*, Y=-19.735*
...
```
  0: 0x005D [0x1F] MOVE_ENTITY: EventEntity moves to X=146.111*, Z=-218.392*, Y=-20.127*
