...
- **8011**: These are the supplies you are to deliver to the stronghold in this area.
- **8012**: The supply unit carrying rations and munitions to our stronghold in this area was attacked en route, and forced to abandon the cargo. You are to locate the supplies and deliver them to their final destination.
- **8013**: Some of the items are raw and will spoil if not delivered immediately. You must hurry.
- **8014**: Some of the items are very delicate and will be destroyed if you are not careful. Avoid all confrontation with the enemy.
- **8015**: Now move out.
- **8016**: What are you waiting for, <Player>!? Move out!
- **8017**: This is an Allied Checkpoint Garrison.
- **8021**: Alright, <Player>. The reinforcements are ready to be escorted to the stronghold in this area.
- **8022**: Welcome, <Player>. The troops you are to guide to the stronghold haven't arrived yet. Please wait a little longer.
- **8041**: About time you showed up, soldier. This here's the shipment of materials you'll be transporting.
- **8042**: I suspect you've already been briefed, but this is some volatile, dangerous stuff. But you signed up for this mission, so we're counting on you to deliver it to the stronghold before its power dissipates.
- **8043**: You'd best deliver that to the stronghold while it still packs some oomph.
...
```
  ...
  2: 0x0004 [0x1D] PRINT_EVENT_MESSAGE(message_id=8012*)
...
```
  ...
  9: 0x002D [0x1D] PRINT_EVENT_MESSAGE(message_id=8017*)
 ...
 17: 0x0046 [0x1D] PRINT_EVENT_MESSAGE(message_id=8016*)
 ...
 25: 0x005F [0x1D] PRINT_EVENT_MESSAGE(message_id=8022*)
 ...
 34: 0x007F [0x1D] PRINT_EVENT_MESSAGE(message_id=8012*)
    → "The supply unit carrying rations and munitions to our stronghold in this area was attacked en route, and forced to abandon the cargo. You are to locate the supplies and deliver them to their final destination."
 35: 0x0082 [0x23] WAIT_FOR_DIALOG_INTERACTION
 36: 0x0083 [0x01] GOTO 0x008A
 37: 0x0086 [0x1D] PRINT_EVENT_MESSAGE(message_id=8011*)
...
SUBROUTINE_008A:
 ...
 40: 0x0091 [0x1D] PRINT_EVENT_MESSAGE(message_id=8013*)
 ...
 43: 0x009C [0x1D] PRINT_EVENT_MESSAGE(message_id=8014*)
 ...
 45: 0x00A0 [0x1D] PRINT_EVENT_MESSAGE(message_id=8015*)
    → "Now move out."
 ...
 53: 0x00BB [0x1D] PRINT_EVENT_MESSAGE(message_id=8021*)
 ...
 62: 0x00D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=8041*)
 ...
 64: 0x00DD [0x1D] PRINT_EVENT_MESSAGE(message_id=8042*)
 ...
 66: 0x00E1 [0x1D] PRINT_EVENT_MESSAGE(message_id=8015*)
    → "Now move out."
 ...
 75: 0x00FF [0x1D] PRINT_EVENT_MESSAGE(message_id=8043*)
...
```
  ...
  2: 0x011B [0x1D] PRINT_EVENT_MESSAGE(message_id=8013*)
    → "Some of the items are raw and will spoil if not delivered immediately. You must hurry."
...
```
  ...
  2: 0x0126 [0x1D] PRINT_EVENT_MESSAGE(message_id=8015*)
    → "Now move out."
