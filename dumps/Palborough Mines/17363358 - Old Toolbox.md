...
- **7396**: You see tools and boxes lying around. They look very old.
- **7397**: You see an old iron box.
- **7398**: Examine the iron box? [Yes./No.]
- **7399**: You decide to leave it alone.
- **7400**: You look inside the box. You see several toolboxes, still filled with tools.
- **7401**: You find one with a name engraved on the cover. The name reads, "Vigilant Owl."
- **7402**: Take the toolbox with you? [Yes./No.]
