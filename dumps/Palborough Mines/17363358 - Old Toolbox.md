...
- **7400**: You see tools and boxes lying around. They look very old.
- **7401**: You see an old iron box.
- **7402**: Examine the iron box? [Yes./No.]
- **7403**: You decide to leave it alone.
- **7404**: You look inside the box. You see several toolboxes, still filled with tools.
- **7405**: You find one with a name engraved on the cover. The name reads, "Vigilant Owl."
- **7406**: Take the toolbox with you? [Yes./No.]
