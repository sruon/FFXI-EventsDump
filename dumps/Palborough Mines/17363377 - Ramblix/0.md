...
```
 ...
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=7452*, default_option=0*, option_flags=0x00)
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7453*, default_option=0*, option_flags=0x1002)
...
SUBROUTINE_00E6:
 43: 0x00E6 [0x24] CREATE_DIALOG(message_id=7454*, default_option=0*, option_flags=0x1003)
    → "\u007F1\u0000\u0007"
...
SUBROUTINE_012A:
 54: 0x012A [0x24] CREATE_DIALOG(message_id=7455*, default_option=0*, option_flags=0x1004)
    → "\u007F1\u0000\u0007"
...
SUBROUTINE_016E:
 65: 0x016E [0x24] CREATE_DIALOG(message_id=7456*, default_option=0*, option_flags=0x1005)
    → "\u007F1\u0000\u0007"
