...
- **7362**: Welcome to the Palborough Mines. You may teleport to different sections of the mines from here.
- **7363**: Teleport where? [Raft docks./Mythril Refiner./Elevator./Old toolboxes./Cancel.]
- **7366**: Canceled.
...
```
  0: 0x0001 [0x1D] PRINT_EVENT_MESSAGE(message_id=7362*)
    → "Welcome to the Palborough Mines. You may teleport to different sections of the mines from here."
  1: 0x0004 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=7363*, default_option=0*, option_flags=0*)
 ...
 16: 0x0055 [0x1D] PRINT_EVENT_MESSAGE(message_id=7366*)
    → "Canceled."
