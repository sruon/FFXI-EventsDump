...
- **7358**: Welcome to the Palborough Mines. You may teleport to different sections of the mines from here.
- **7359**: Teleport where? [Raft docks./Mythril Refiner./Elevator./Old toolboxes./Cancel.]
- **7362**: Canceled.
...
```
  ...
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=7359*, default_option=0*, option_flags=0*)
 ...
 16: 0x0055 [0x1D] PRINT_EVENT_MESSAGE(message_id=7362*)
    → "Canceled."
