...
- **7388**: Pull the lever? [Yes./No.]
- **7389**: You've activated the machine.
- **7390**: You hear the sounds of metal hitting metal down below. Did the things you put in come out there?
- **7391**: It might be best to go look downstairs.
- **7392**: The machine seems to be working, but you cannot discern its purpose.
...
```
  ...
  1: 0x0002 [0x24] CREATE_DIALOG(message_id=7388*, default_option=0*, option_flags=0*)
