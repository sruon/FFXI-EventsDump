...
- **7391**: Pull the lever? [Yes./No.]
- **7392**: Something falls out of the machine!
- **7393**: Nothing happens.
- **7394**: You obtain $1 $0 !
- **7395**: There seems to be more left in the machine, but you can't carry any more items.
...
```
  ...
  2: 0x000B [0x24] CREATE_DIALOG(message_id=7391*, default_option=0*, option_flags=0*)
