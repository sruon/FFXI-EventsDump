...
- **7393**: Pull the lever? [Yes./No.]
- **7394**: Something falls out of the machine!
- **7395**: Nothing happens.
- **7396**: You obtain $1 $0 !
- **7397**: There seems to be more left in the machine, but you can't carry any more items.
...
```
  ...
  2: 0x000B [0x24] CREATE_DIALOG(message_id=7393*, default_option=0*, option_flags=0*)
