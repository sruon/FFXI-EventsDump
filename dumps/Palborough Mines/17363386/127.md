...
```
  ...
  1: 0x05F2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  2: 0x0603 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 13: 0x0647 [0xBA] SET_ENTITY_POSITION(entity_id=References[17330620], pos_x=21.310*, pos_z=66.630*, pos_y=-31.920*, direction=377476129.3°*)
 14: 0x0654 [0xBA] SET_ENTITY_POSITION(entity_id=References[17330621], pos_x=20.210*, pos_z=66.450*, pos_y=-31.960*, direction=377476129.3°*)
 15: 0x0661 [0xBA] SET_ENTITY_POSITION(entity_id=References[17330622], pos_x=21.670*, pos_z=83.200*, pos_y=-32.730*, direction=134.9°*)
 ...
 23: 0x06A2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 24: 0x06B3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=784*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s010", work_offset2=0*)
 ...
 36: 0x0701 [0x45] LOAD_SCHEDULED_TASK(work_offset1=784*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s011", work_offset2=0*)
 ...
 41: 0x072E [0x45] LOAD_SCHEDULED_TASK(work_offset1=784*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s015", work_offset2=0*)
 ...
 57: 0x07AF [0x45] LOAD_SCHEDULED_TASK(work_offset1=784*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s014", work_offset2=0*)
 ...
 60: 0x07D2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=784*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s012", work_offset2=0*)
 ...
 73: 0x083B [0x45] LOAD_SCHEDULED_TASK(work_offset1=784*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s013", work_offset2=0*)
 ...
 76: 0x0859 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="who1", work_offset2=0*)
 77: 0x086A [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="who1")
 78: 0x0879 [0x1C] WAIT(180* ticks)
 79: 0x087C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 80: 0x088D [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 81: 0x089C [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="whi1", work_offset2=0*)
 82: 0x08AD [0x52] END_LOAD_SCHEDULER: End scheduler "s013" with entities [EventEntity, EventEntity], work=784*
 83: 0x08BC [0x45] LOAD_SCHEDULED_TASK(work_offset1=784*, entity1=EventEntity, entity2=EventEntity, scheduler_id="boff", work_offset2=0*)
 84: 0x08CD [0x55] WAIT_LOAD_SCHEDULER(work_offset=784*, entity1=EventEntity, entity2=EventEntity, scheduler_id="boff")
 ...
 98: 0x0918 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
