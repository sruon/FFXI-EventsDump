...
```
  0: 0x0001 [0x1D] PRINT_EVENT_MESSAGE(message_id=7357*)
    → "Welcome to the Palborough Mines.\u0007You may teleport to different sections of the mines from here.\u007F1\u0000\u0007"
  1: 0x0004 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=7358*, default_option=0*, option_flags=0*)
    → "Teleport where?\u0007\u000BRaft docks.\u0007Mythril Refiner.\u0007Elevator.\u0007Old toolboxes.\u0007Cancel.\u007F1\u0000\u0007"
