...
```
  ...
  6: 0x0020 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "md12" with entities [LocalPlayer, LocalPlayer], work=[94*, 0*]
 ...
 11: 0x004D [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "ptc3" with entities [EventEntity, EventEntity]
 12: 0x005A [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "omc3" with entities [EventEntity, EventEntity]
 13: 0x0067 [0x1C] WAIT(60* ticks)
 14: 0x006A [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "koc3" with entities [EventEntity, EventEntity]
 ...
 18: 0x008E [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "kpc3" with entities [EventEntity, EventEntity]
 19: 0x009B [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "mg12" with entities [EventEntity, EventEntity]
