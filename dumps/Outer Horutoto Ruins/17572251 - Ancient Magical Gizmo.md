...
| [47](#event-47)       | 0x0001       |    197 |             28 |
| [59](#event-59)       | 0x00C6       |    142 |             23 |
...
00F0: 6D 73 31 32 01 80 27 0B  F0 FF FF 7F 0C 45 00 80  ms12..'......E..
...
0130: FF 7F 6D 73 31 32 1C 06  80 4D 1C 02 80 46 00 45  ..ms12...M...F.E
...
```
  ...
  6: 0x00E5 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "ms12" with entities [LocalPlayer, LocalPlayer], work=[94*, 0*]
  7: 0x00F6 [0x27] REQ_SET(priority=0x0B, entity_id=LocalPlayer, tag_num=0x0C)
 ...
 14: 0x0129 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "ms12" with entities [EventEntity, EventEntity]
