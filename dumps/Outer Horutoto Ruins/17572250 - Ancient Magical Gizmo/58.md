...
```
  ...
  6: 0x00E5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=94*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ms11", work_offset2=0*)
 ...
 14: 0x0129 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "ms11" for entities [EventEntity, EventEntity]
