...
- **7361**: Enter the battlefield for "An Errand! The Professor's Price"?
- **7362**: Enter the battlefield? [Yes./No.]
...
```
  0: 0x0001 [0x48] [System] [7361*]:
    → "Enter the battlefield for "An Errand! The Professor's Price"?"
  1: 0x0004 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=7362*, default_option=1*, option_flags=0*)
