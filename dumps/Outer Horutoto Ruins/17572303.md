...
- **7359**: Enter the battlefield for "An Errand! The Professor's Price"?
- **7360**: Enter the battlefield? [Yes./No.]
...
```
  0: 0x0001 [0x48] [System] [7359*]:
    → "Enter the battlefield for "An Errand! The Professor's Price"?"
  1: 0x0004 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=7360*, default_option=1*, option_flags=0*)
