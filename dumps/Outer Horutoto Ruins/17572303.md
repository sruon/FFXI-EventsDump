...
- **7358**: Enter the battlefield for "An Errand! The Professor's Price"?
- **7359**: Enter the battlefield? [Yes./No.]
...
```
  0: 0x0001 [0x48] [System] [7358*]:
    → "Enter the battlefield for "An Errand! The Professor's Price"?"
