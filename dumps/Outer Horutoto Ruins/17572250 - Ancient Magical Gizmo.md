# 17572250 - Ancient Magical Gizmo
...
| [46](#event-46)       | 0x0001       |    197 |             28 |
| [58](#event-58)       | 0x00C6       |    142 |             23 |
...
0020: 45 04 80 F0 FF FF 7F F0  FF FF 7F 6D 64 31 31 01  E..........md11.
0030: 80 27 0B F0 FF FF 7F 0B  45 00 80 F0 FF FF 7F F0  .'......E.......
0040: FF FF 7F 66 64 69 31 01  80 1C 05 80 4C 2D F8 FF  ...fdi1.....L-..
0050: FF 7F F8 FF FF 7F 70 74  63 35 2C F8 FF FF 7F F8  ......ptc5,.....
0060: FF FF 7F 6F 6D 63 35 1C  02 80 2C F8 FF FF 7F F8  ...omc5...,.....
0070: FF FF 7F 6B 6F 63 35 1C  02 80 45 00 80 F0 FF FF  ...koc5...E.....
0080: 7F F0 FF FF 7F 66 64 6F  31 01 80 1C 02 80 2D F8  .....fdo1.....-.
0090: FF FF 7F F8 FF FF 7F 6B  70 63 35 2C F8 FF FF 7F  .......kpc5,....
00A0: F8 FF FF 7F 6D 67 31 31  1C 06 80 4D 1C 02 80 46  ....mg11...M...F
...
```
  ...
  6: 0x0020 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "md11" with entities [LocalPlayer, LocalPlayer], work=[94*, 0*]
  7: 0x0031 [0x27] REQ_SET(priority=0x0B, entity_id=LocalPlayer, tag_num=0x0B)
 ...
 11: 0x004D [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "ptc5" with entities [EventEntity, EventEntity]
 12: 0x005A [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "omc5" with entities [EventEntity, EventEntity]
 13: 0x0067 [0x1C] WAIT(60* ticks)
 14: 0x006A [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "koc5" with entities [EventEntity, EventEntity]
 ...
 18: 0x008E [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "kpc5" with entities [EventEntity, EventEntity]
 19: 0x009B [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "mg11" with entities [EventEntity, EventEntity]
...
00F0: 6D 73 31 31 01 80 27 0B  F0 FF FF 7F 0B 45 00 80  ms11..'......E..
...
0130: FF 7F 6D 73 31 31 1C 06  80 4D 1C 02 80 46 00 45  ..ms11...M...F.E
...
```
  ...
  6: 0x00E5 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "ms11" with entities [LocalPlayer, LocalPlayer], work=[94*, 0*]
  7: 0x00F6 [0x27] REQ_SET(priority=0x0B, entity_id=LocalPlayer, tag_num=0x0B)
 ...
 14: 0x0129 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "ms11" with entities [EventEntity, EventEntity]
