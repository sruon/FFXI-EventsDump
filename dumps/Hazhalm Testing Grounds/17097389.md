...
- **8049**: A booming voice resonates from the depths of your skull...
- **8050**: The $0 in thy possession is testament to thy worth. Speak unto me my name, that thou might claimest thy reward.
- **8051**: My name... [I do not know./Rossweisse./Grimgerde./Siegrune./Helmwige./Schwertleite./Waltraute./Ortlinde./Gerhilde./Brunhilde.]
...
```
  ...
  6: 0x0019 [0x1D] PRINT_EVENT_MESSAGE(message_id=8050*)
  ...
  8: 0x001D [0x24] CREATE_DIALOG(message_id=8051*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
