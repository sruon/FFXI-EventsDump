...
0020: FF FF 7F 02 29 0B F0 FF  FF 7F 03 45 04 80 F0 FF  ....)......E....
0030: FF 7F F0 FF FF 7F 6E 67  30 31 01 80 45 00 80 F0  ......ng01..E...
0040: FF FF 7F F0 FF FF 7F 66  64 69 31 01 80 4C 1C 05  .......fdi1..L..
0050: 80 27 0B F0 FF FF 7F 04  1C 06 80 4D 45 00 80 F0  .'.........ME...
...
```
  ...
  6: 0x001D [0x29] REQ_SET_WAIT(priority=0x0B, entity_id=LocalPlayer, tag_num=0x02)
  7: 0x0024 [0x29] REQ_SET_WAIT(priority=0x0B, entity_id=LocalPlayer, tag_num=0x03)
  8: 0x002B [0x45] LOAD_SCHEDULED_TASK: Load scheduler "ng01" with entities [LocalPlayer, LocalPlayer], work=[234*, 0*]
 ...
 12: 0x0051 [0x27] REQ_SET(priority=0x0B, entity_id=LocalPlayer, tag_num=0x04)
