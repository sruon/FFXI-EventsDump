...
- **7334**: Shipments of mythril used to be ferried to this dock from the Palborough Mines, but it's been closed off since the Quadav took Palborough.
- **7390**: If you happen to find $6, take it to Tall Mountain, a guard in the off-limits area in the Mines District.
- **7401**: When you find proof of Werei's journey, bring it here. I'll be waiting for you.
...
```
  ...
  1: 0x0006 [0x1D] PRINT_EVENT_MESSAGE(message_id=7334*)
...
```
  ...
  2: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=7390*)
...
```
  ...
  1: 0x0023 [0x1D] PRINT_EVENT_MESSAGE(message_id=7401*)
