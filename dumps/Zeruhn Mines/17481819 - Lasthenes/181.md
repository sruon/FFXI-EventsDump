...
```
  ...
  9: 0x00E3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 10: 0x00F4 [0x1C] WAIT(60* ticks)
 11: 0x00F7 [0x38] SET_CLIENT_EVENT_MODE(mode=18*)
 12: 0x00FA [0x45] LOAD_SCHEDULED_TASK(work_offset1=217*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="c3ou", work_offset2=0*)
 ...
 15: 0x0119 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 ...
 22: 0x0148 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 23: 0x0159 [0x1C] WAIT(60* ticks)
 24: 0x015C [0x46] CAMERA_CONTROL: Restore default settings
 25: 0x015E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
