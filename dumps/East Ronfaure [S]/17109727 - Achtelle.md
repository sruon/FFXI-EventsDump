...
- **7748**: It is said the tomb of King Ranperre lies beyond here. The legend himself, said to have broken the mighty Vrtra. I wished to pay my respects.
- **7749**: Are you...a dragoon!? That is a most welcome relief. I had to come and ascertain for myself whether or not there are still those to carry on the ways of our kind.
- **7750**: Also, I have heard rumors of a wyrm which inhabits Grauberg. A wyrm which can take on the form of a person...
- **7751**: But this is indeed a most pleasant surprise! I can see that the future of the dragoons is in safe hands. It warms my heart to know that such a capable wyvern-caller such as yourself commands our legacy.
- **7752**: $2862!? But surely this is among your most prized possessions!
- **7753**: I was but a young child when I first read this and came to know of the Kingdom of San d'Oria. It was then that I resolved to someday come to the continent of Quon.
...
```
 ...
 10: 0x0032 [0x1D] PRINT_EVENT_MESSAGE(message_id=7748*)
 ...
 14: 0x0041 [0x1D] PRINT_EVENT_MESSAGE(message_id=7748*)
    → "It is said the tomb of King Ranperre lies beyond here. The legend himself, said to have broken the mighty Vrtra. I wished to pay my respects."
 ...
 20: 0x0060 [0x1D] PRINT_EVENT_MESSAGE(message_id=7751*)
 ...
 23: 0x0067 [0x1D] PRINT_EVENT_MESSAGE(message_id=7749*)
...
SUBROUTINE_006B:
 ...
 27: 0x0076 [0x1D] PRINT_EVENT_MESSAGE(message_id=7750*)
 ...
 30: 0x007D [0x1D] PRINT_EVENT_MESSAGE(message_id=7748*)
    → "It is said the tomb of King Ranperre lies beyond here. The legend himself, said to have broken the mighty Vrtra. I wished to pay my respects."
...
SUBROUTINE_0081:
 ...
 36: 0x009C [0x1D] PRINT_EVENT_MESSAGE(message_id=7751*)
    → "But this is indeed a most pleasant surprise! I can see that the future of the dragoons is in safe hands. It warms my heart to know that such a capable wyvern-caller such as yourself commands our legacy."
 37: 0x009F [0x23] WAIT_FOR_DIALOG_INTERACTION
 38: 0x00A0 [0x01] GOTO 0x00A7
 39: 0x00A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7749*)
    → "Are you...a dragoon!? That is a most welcome relief. I had to come and ascertain for myself whether or not there are still those to carry on the ways of our kind."
...
SUBROUTINE_00A7:
 ...
 43: 0x00B2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7750*)
    → "Also, I have heard rumors of a wyrm which inhabits Grauberg. A wyrm which can take on the form of a person..."
 44: 0x00B5 [0x23] WAIT_FOR_DIALOG_INTERACTION
 45: 0x00B6 [0x01] GOTO 0x00BD
 46: 0x00B9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7748*)
    → "It is said the tomb of King Ranperre lies beyond here. The legend himself, said to have broken the mighty Vrtra. I wished to pay my respects."
...
SUBROUTINE_00BD:
 ...
 52: 0x00D8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7751*)
    → "But this is indeed a most pleasant surprise! I can see that the future of the dragoons is in safe hands. It warms my heart to know that such a capable wyvern-caller such as yourself commands our legacy."
 53: 0x00DB [0x23] WAIT_FOR_DIALOG_INTERACTION
 54: 0x00DC [0x01] GOTO 0x00E3
 55: 0x00DF [0x1D] PRINT_EVENT_MESSAGE(message_id=7749*)
    → "Are you...a dragoon!? That is a most welcome relief. I had to come and ascertain for myself whether or not there are still those to carry on the ways of our kind."
...
SUBROUTINE_00E3:
 ...
 59: 0x00EE [0x1D] PRINT_EVENT_MESSAGE(message_id=7750*)
    → "Also, I have heard rumors of a wyrm which inhabits Grauberg. A wyrm which can take on the form of a person..."
 60: 0x00F1 [0x23] WAIT_FOR_DIALOG_INTERACTION
 61: 0x00F2 [0x01] GOTO 0x00F9
 62: 0x00F5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7748*)
    → "It is said the tomb of King Ranperre lies beyond here. The legend himself, said to have broken the mighty Vrtra. I wished to pay my respects."
...
SUBROUTINE_00FC:
 ...
 69: 0x0114 [0x1D] PRINT_EVENT_MESSAGE(message_id=7752*)
 ...
 74: 0x0128 [0x1D] PRINT_EVENT_MESSAGE(message_id=7753*)
