...
```
  ...
  5: 0x0062 [0x5B] LOAD_EXT_SCHEDULER(work_offset=571*, entity1=EventEntity, entity2=EventEntity, action="tng1")
  6: 0x0071 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="tng1")
