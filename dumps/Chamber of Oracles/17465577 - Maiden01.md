...
|       2 | 0x0080      |         128 |
|       3 | 0x01F5      |         501 |
|       4 | 0xFFFF85CA  |  4294936010 |
|       5 | 0xFFFFD508  |  4294956296 |
|       6 | 0x0C22      |        3106 |
|       7 | 0x0009      |           9 |
|       8 | 0x027D      |         637 |
|       9 | 0xFFFF95B7  |  4294940087 |
...
```
  0: 0x004F [0x32] ExtData[1]->MainSpeed = 9* * 0.1
  1: 0x0052 [0x1F] MOVE_ENTITY: EventEntity moves to X=0.637*, Z=-27.209*, Y=-11.000*
