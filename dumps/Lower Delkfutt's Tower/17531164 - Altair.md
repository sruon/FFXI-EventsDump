...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0020:                                      66 0B 80 F8              f...
0030: FF FF 7F F8 FF FF 7F 74  6C 6B 30 1C 0C 80 00     .......tlk0.... 
```

#### Opcodes

```
  0: 0x002C [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk0" with entities [EventEntity, EventEntity], work=9*
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0030:                                               66                 f
0040: 0B 80 F8 FF FF 7F F8 FF  FF 7F 74 68 6B 31 1C 0C  ..........thk1..
0050: 80 00                                             ..              
```
...
```
  0: 0x003F [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "thk1" with entities [EventEntity, EventEntity], work=9*
...
```
  0: 0x0052 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "thk2" with entities [EventEntity, EventEntity], work=9*
