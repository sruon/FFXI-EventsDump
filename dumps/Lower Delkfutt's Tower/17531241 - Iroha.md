...
|       0 | 0x000D      |          13 |
|       1 | 0x709B4     |      461236 |
|       2 | 0xFFFF00AD  |  4294901933 |
|       3 | 0x0000      |           0 |
|       4 | 0x7090D     |      461069 |
|       5 | 0xFFFEDB68  |  4294892392 |
...
```
  ...
  1: 0x0005 [0x1F] MOVE_ENTITY: EventEntity moves to X=461.236*, Z=-65.363*, Y=0.000*
...
```
  ...
  1: 0x0013 [0x1F] MOVE_ENTITY: EventEntity moves to X=461.069*, Z=-74.904*, Y=0.000*
