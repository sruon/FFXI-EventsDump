...
```
  ...
  3: 0x0017 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
  4: 0x0028 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
  5: 0x0037 [0x38] SET_CLIENT_EVENT_MODE(mode=19*)
  6: 0x003A [0x29] REQ_SET_WAIT(priority=0x03, entity_id=LocalPlayer, tag_num=0x17)
  7: 0x0041 [0x45] LOAD_SCHEDULED_TASK(work_offset1=146*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cm44", work_offset2=0*)
  8: 0x0052 [0x55] WAIT_LOAD_SCHEDULER(work_offset=146*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cm44")
  9: 0x0061 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 10: 0x0072 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 ...
 14: 0x008B [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "corp" for entities [Heimji-Keimji (ID: 17531166/0x010B811E), Heimji-Keimji (ID: 17531166/0x010B811E)]
 15: 0x0098 [0x53] WAIT_SCHEDULER_TASK(entity1=Heimji-Keimji (ID: 17531166/0x010B811E), entity2=Heimji-Keimji (ID: 17531166/0x010B811E), action_id="corp")
 ...
 19: 0x00B8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=146*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cm45", work_offset2=0*)
 20: 0x00C9 [0x55] WAIT_LOAD_SCHEDULER(work_offset=146*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cm45")
 ...
 25: 0x00E8 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "res0" for entities [LocalPlayer, LocalPlayer]
 26: 0x00F5 [0x1C] WAIT(60* ticks)
 27: 0x00F8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 28: 0x0109 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 29: 0x0118 [0x45] LOAD_SCHEDULED_TASK(work_offset1=146*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cm4c", work_offset2=0*)
 30: 0x0129 [0x55] WAIT_LOAD_SCHEDULER(work_offset=146*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cm4c")
 31: 0x0138 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "res2" for entities [LocalPlayer, LocalPlayer]
 ...
 37: 0x015E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
 38: 0x016F [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2")
 39: 0x017E [0x2B] Heimji-Keimji (ID: 17531166/0x010B811E) [175*]:
    → "Oooh...\u007F1\u0000\u0007"
 40: 0x0185 [0x23] WAIT_FOR_DIALOG_INTERACTION
 41: 0x0186 [0x45] LOAD_SCHEDULED_TASK(work_offset1=146*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cm48", work_offset2=0*)
 ...
 43: 0x019E [0x2B] Heimji-Keimji (ID: 17531166/0x010B811E) [176*]:
    → "Who...? Oh, I'm so glad you're not one of the baddies.\u0007Thank you for saving me! I'm the Windurstian ambassador to Jeuno, Heimji-Keimji.\u007F1\u0000\u0007"
 ...
 46: 0x01AD [0x2B] Heimji-Keimji (ID: 17531166/0x010B811E) [177*]:
    → "They sent you on a mission to the embassy?\u0007Oh... I'm sorry-worry you had to come to such a dangerous place because of me.\u007F1\u0000\u0007"
 ...
 49: 0x01BC [0x2B] Heimji-Keimji (ID: 17531166/0x010B811E) [178*]:
    → "I should have been more careful... Someone bonky-wonked me on the head from behind, and I woke up in this hairy-scary place. If you hadn't come... It makes me shudder-budder to think what would've happened to me!\u007F1\u0000\u0007"
 ...
 52: 0x01CB [0x2B] Heimji-Keimji (ID: 17531166/0x010B811E) [179*]:
    → "This place is dangerous! Aside from all the monsters, I feel something nasty-wasty in the air.\u007F1\u0000\u0007"
 53: 0x01D2 [0x23] WAIT_FOR_DIALOG_INTERACTION
 54: 0x01D3 [0x2B] Heimji-Keimji (ID: 17531166/0x010B811E) [180*]:
    → "We should go back as soon as possible!\u0007Don't worry about me, as I can run super-duper fast! I'll meet you back at the embassy!\u007F1\u0000\u0007"
 ...
 58: 0x01E9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=146*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="cm4f", work_offset2=0*)
 59: 0x01FA [0x1C] WAIT(60* ticks)
 60: 0x01FD [0x27] REQ_SET(priority=0x05, entity_id=LocalPlayer, tag_num=0x1A)
 61: 0x0204 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2", work_offset2=0*)
 62: 0x0215 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2")
 ...
 67: 0x0230 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
