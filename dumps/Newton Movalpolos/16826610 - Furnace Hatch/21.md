...
```
  ...
  2: 0x0017 [0x45] LOAD_SCHEDULED_TASK(work_offset1=31*, entity1=EventEntity, entity2=EventEntity, scheduler_id="vbon", work_offset2=0*)
  3: 0x0028 [0x45] LOAD_SCHEDULED_TASK(work_offset1=160*, entity1=EventEntity, entity2=EventEntity, scheduler_id="12bm", work_offset2=0*)
  4: 0x0039 [0x1C] WAIT(90* ticks)
  5: 0x003C [0x45] LOAD_SCHEDULED_TASK(work_offset1=31*, entity1=EventEntity, entity2=EventEntity, scheduler_id="vbof", work_offset2=0*)
