...
- **7245**: Travel where? [Return to North Gustaberg./Return to the mine shaft entrance.]
- **7249**: H0000! C0mE hErE crAZy ZdvEnTurEr! LET'S mAkE A dEAL!
- **7250**: H0000! GivE mE $0 GiL, I hELp y0u EScApE!
- **7251**: H0000! ThAnkS, crAZy AdvEnTurEr!
...
```
  ...
  2: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=7249*)
...
```
  ...
  3: 0x001C [0x1D] PRINT_EVENT_MESSAGE(message_id=7250*)
...
```
  ...
  3: 0x002C [0x24] CREATE_DIALOG(message_id=7245*, default_option=0*, option_flags=0*)
  ...
  6: 0x003C [0x1D] PRINT_EVENT_MESSAGE(message_id=7251*)
 ...
 16: 0x0074 [0x1D] PRINT_EVENT_MESSAGE(message_id=7251*)
    → "H0000! ThAnkS, crAZy AdvEnTurEr!"
