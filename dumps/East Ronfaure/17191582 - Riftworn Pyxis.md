...
- **11194**: Obtain this item?
- **11200**: Relinquish all reward items? [Yes, relinquish./On second thought...]
- **11228**: Which item will you obtain? [None of them./[/$0./$1./$2./$3./$4./$5./$6./$7./Relinquish all./Obtain all.]
- **11229**: Obtain the $0? [Yes./No./Obtain as pulse cell.]
- **11230**: One or more of the items you are about to obtain can be converted into pulse cells.
...
SUBROUTINE_01E3:
 82: 0x01E3 [0x24] CREATE_DIALOG(message_id=11228*, default_option=0*, option_flags=ExtData[1]->WorkLocal[5])
...
SUBROUTINE_0325:
143: 0x0325 [0x24] CREATE_DIALOG(message_id=11229*, default_option=1*, option_flags=ExtData[1]->WorkLocal[14])
...
171: 0x03A7 [0x24] CREATE_DIALOG(message_id=11229*, default_option=1*, option_flags=0*)
    → "Obtain the $0? [Yes./No./Obtain as pulse cell.]"
...
186: 0x03F8 [0x24] CREATE_DIALOG(message_id=11200*, default_option=1*, option_flags=0*)
