...
| [24](#event-24)            | 0x01C7       |      1 |              1 |
| [65535.27](#event-6553527) | 0x01C8       |     14 |              4 |
| [65535.28](#event-6553528) | 0x01D6       |     14 |              4 |
| [34](#event-34)            | 0x01E4       |     13 |              7 |
| [25](#event-25)            | 0x01F1       |     41 |             13 |
| [35](#event-35)            | 0x021A       |    222 |             50 |
| [37](#event-37)            | 0x02F8       |     33 |             11 |
| [39](#event-39)            | 0x0319       |     28 |              8 |
| [27](#event-27)            | 0x0335       |     95 |             23 |
| [36](#event-36)            | 0x0394       |     32 |             10 |
| [38](#event-38)            | 0x03B4       |    266 |             60 |
...
- **7886**: This pioneering stuff is tough on the back. What I wouldn't give to be home in Adoulin with my family!
- **7906**: Yes, I overheard what Hostenn was telling you. "Head to the open area in the northeast where you reach a dead end."
- **7907**: Something about placing the $3 near the ergon locus and summoning an elemental.
- **7908**: His challenge was for you to defeat it within ten minutes (Earth time), right? Should be simple enough. If you fail, come see me and we'll start the process over.
- **7912**: You need another $3? I suppose I might have one lying around, but it'll take me some time to find one...
- **7913**: Though if you really want to pass Hostenn's test, I can be persuaded to search extra hard for gil, bayld, or $3.
- **7914**: Of course, if you'd rather wait, I'll be able to come across one eventually. What do you say?
- **7915**: Purchase another one? [Purchase for 50000 gil./Purchase for 5000 bayld./Purchase for ten beastmen's seals./No purchasing for me.]
- **7916**: Purchase the item for [50,000 gil/5000 bayld]? (Gil: $1). [Yes./No.]
- **7917**: Purchase the item for [50,000 gil/5000 bayld]? (Bayld: $1). [Yes./No.]
- **7919**: Trade me ten beastmen's seals if you really want the item.
- **7920**: Well, well, so you're here for another $3. Don't screw it up this time, okay?
- **7937**: Hostenn gave you one hell of a test, and you managed to clear it. Not bad. Not bad at all.
- **7938**: If you want to give that elemental another go, just say the word and I'll give you another $3.
- **7939**: Do you want another $3? [Sure!/No thanks.]
- **7940**: You know how this works. Head to the northeast until you can't go any farther and place it down to lure in the creature. You've got ten minutes (Earth time) to succeed.
...
```
  ...
  3: 0x01EB [0x1D] PRINT_EVENT_MESSAGE(message_id=7886*)
...
```
  ...
  4: 0x0207 [0x1D] PRINT_EVENT_MESSAGE(message_id=7906*)
...
```
  ...
  7: 0x023F [0x1D] PRINT_EVENT_MESSAGE(message_id=7912*)
 ...
 10: 0x0248 [0x1D] PRINT_EVENT_MESSAGE(message_id=7913*)
 ...
 12: 0x024C [0x1D] PRINT_EVENT_MESSAGE(message_id=7914*)
 ...
 14: 0x0250 [0x24] CREATE_DIALOG(message_id=7915*, default_option=0*, option_flags=0*)
 ...
 19: 0x026A [0x24] CREATE_DIALOG(message_id=7916*, default_option=1*, option_flags=0*)
...
SUBROUTINE_0292:
 ...
 31: 0x02A7 [0x24] CREATE_DIALOG(message_id=7917*, default_option=1*, option_flags=0*)
...
SUBROUTINE_02CF:
 ...
 41: 0x02DA [0x1D] PRINT_EVENT_MESSAGE(message_id=7919*)
...
```
  ...
  6: 0x030C [0x1D] PRINT_EVENT_MESSAGE(message_id=7920*)
...
```
  ...
  4: 0x032F [0x1D] PRINT_EVENT_MESSAGE(message_id=7937*)
...
```
  ...
  5: 0x0350 [0x1D] PRINT_EVENT_MESSAGE(message_id=7937*)
    → "Hostenn gave you one hell of a test, and you managed to clear it. Not bad. Not bad at all."
  6: 0x0353 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0354 [0x1D] PRINT_EVENT_MESSAGE(message_id=7938*)
  ...
  9: 0x0358 [0x24] CREATE_DIALOG(message_id=7939*, default_option=0*, option_flags=0*)
 ...
 14: 0x0374 [0x1D] PRINT_EVENT_MESSAGE(message_id=7940*)
...
```
  ...
  4: 0x03AA [0x1D] PRINT_EVENT_MESSAGE(message_id=7937*)
    → "Hostenn gave you one hell of a test, and you managed to clear it. Not bad. Not bad at all."
  5: 0x03AD [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x03AE [0x1D] PRINT_EVENT_MESSAGE(message_id=7940*)
    → "You know how this works. Head to the northeast until you can't go any farther and place it down to lure in the creature. You've got ten minutes (Earth time) to succeed."
...
```
  ...
  8: 0x03DE [0x1D] PRINT_EVENT_MESSAGE(message_id=7937*)
    → "Hostenn gave you one hell of a test, and you managed to clear it. Not bad. Not bad at all."
  9: 0x03E1 [0x23] WAIT_FOR_DIALOG_INTERACTION
 10: 0x03E2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7938*)
    → "If you want to give that elemental another go, just say the word and I'll give you another $3."
 11: 0x03E5 [0x23] WAIT_FOR_DIALOG_INTERACTION
 12: 0x03E6 [0x03] Work_Zone[3] = 2373*
 13: 0x03EB [0x24] CREATE_DIALOG(message_id=7939*, default_option=0*, option_flags=0*)
    → "Do you want another $3? [Sure!/No thanks.]"
 14: 0x03F2 [0x25] WAIT_DIALOG_SELECT()
 15: 0x03F3 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x04AC
 16: 0x03FB [0x1D] PRINT_EVENT_MESSAGE(message_id=7913*)
    → "Though if you really want to pass Hostenn's test, I can be persuaded to search extra hard for gil, bayld, or $3."
 17: 0x03FE [0x23] WAIT_FOR_DIALOG_INTERACTION
 18: 0x03FF [0x1D] PRINT_EVENT_MESSAGE(message_id=7914*)
    → "Of course, if you'd rather wait, I'll be able to come across one eventually. What do you say?"
 19: 0x0402 [0x23] WAIT_FOR_DIALOG_INTERACTION
 20: 0x0403 [0x24] CREATE_DIALOG(message_id=7915*, default_option=0*, option_flags=0*)
    → "Purchase another one? [Purchase for 50000 gil./Purchase for 5000 bayld./Purchase for ten beastmen's seals./No purchasing for me.]"
 ...
 25: 0x041D [0x24] CREATE_DIALOG(message_id=7916*, default_option=1*, option_flags=0*)
    → "Purchase the item for [50,000 gil/5000 bayld]? (Gil: $1). [Yes./No.]"
...
SUBROUTINE_0445:
 ...
 37: 0x045A [0x24] CREATE_DIALOG(message_id=7917*, default_option=1*, option_flags=0*)
    → "Purchase the item for [50,000 gil/5000 bayld]? (Bayld: $1). [Yes./No.]"
...
SUBROUTINE_0482:
 ...
 47: 0x048D [0x1D] PRINT_EVENT_MESSAGE(message_id=7919*)
    → "Trade me ten beastmen's seals if you really want the item."
