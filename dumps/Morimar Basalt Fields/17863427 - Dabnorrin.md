...
- **7890**: This pioneering stuff is tough on the back. What I wouldn't give to be home in Adoulin with my family!
- **7910**: Yes, I overheard what Hostenn was telling you. "Head to the open area in the northeast where you reach a dead end."
- **7911**: Something about placing the $3 near the ergon locus and summoning an elemental.
- **7912**: His challenge was for you to defeat it within ten minutes (Earth time), right? Should be simple enough. If you fail, come see me and we'll start the process over.
- **7916**: You need another $3? I suppose I might have one lying around, but it'll take me some time to find one...
- **7917**: Though if you really want to pass Hostenn's test, I can be persuaded to search extra hard for gil, bayld, or $3.
- **7918**: Of course, if you'd rather wait, I'll be able to come across one eventually. What do you say?
- **7919**: Purchase another one? [Purchase for 50000 gil./Purchase for 5000 bayld./Purchase for ten beastmen's seals./No purchasing for me.]
- **7920**: Purchase the item for [50,000 gil/5000 bayld]? (Gil: $1). [Yes./No.]
- **7921**: Purchase the item for [50,000 gil/5000 bayld]? (Bayld: $1). [Yes./No.]
- **7923**: Trade me ten beastmen's seals if you really want the item.
- **7924**: Well, well, so you're here for another $3. Don't screw it up this time, okay?
- **7941**: Hostenn gave you one hell of a test, and you managed to clear it. Not bad. Not bad at all.
- **7942**: If you want to give that elemental another go, just say the word and I'll give you another $3.
- **7943**: Do you want another $3? [Sure!/No thanks.]
- **7944**: You know how this works. Head to the northeast until you can't go any farther and place it down to lure in the creature. You've got ten minutes (Earth time) to succeed.
...
```
  ...
  3: 0x01EB [0x1D] PRINT_EVENT_MESSAGE(message_id=7890*)
...
```
  ...
  4: 0x0207 [0x1D] PRINT_EVENT_MESSAGE(message_id=7910*)
...
```
  ...
  7: 0x023F [0x1D] PRINT_EVENT_MESSAGE(message_id=7916*)
 ...
 10: 0x0248 [0x1D] PRINT_EVENT_MESSAGE(message_id=7917*)
 ...
 12: 0x024C [0x1D] PRINT_EVENT_MESSAGE(message_id=7918*)
 ...
 14: 0x0250 [0x24] CREATE_DIALOG(message_id=7919*, default_option=0*, option_flags=0*)
 ...
 19: 0x026A [0x24] CREATE_DIALOG(message_id=7920*, default_option=1*, option_flags=0*)
...
SUBROUTINE_0292:
 ...
 31: 0x02A7 [0x24] CREATE_DIALOG(message_id=7921*, default_option=1*, option_flags=0*)
...
SUBROUTINE_02CF:
 ...
 41: 0x02DA [0x1D] PRINT_EVENT_MESSAGE(message_id=7923*)
...
```
  ...
  6: 0x030C [0x1D] PRINT_EVENT_MESSAGE(message_id=7924*)
...
```
  ...
  4: 0x032F [0x1D] PRINT_EVENT_MESSAGE(message_id=7941*)
...
```
  ...
  5: 0x0350 [0x1D] PRINT_EVENT_MESSAGE(message_id=7941*)
    → "Hostenn gave you one hell of a test, and you managed to clear it. Not bad. Not bad at all."
  6: 0x0353 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0354 [0x1D] PRINT_EVENT_MESSAGE(message_id=7942*)
  ...
  9: 0x0358 [0x24] CREATE_DIALOG(message_id=7943*, default_option=0*, option_flags=0*)
 ...
 14: 0x0374 [0x1D] PRINT_EVENT_MESSAGE(message_id=7944*)
...
```
  ...
  4: 0x03AA [0x1D] PRINT_EVENT_MESSAGE(message_id=7941*)
    → "Hostenn gave you one hell of a test, and you managed to clear it. Not bad. Not bad at all."
  5: 0x03AD [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x03AE [0x1D] PRINT_EVENT_MESSAGE(message_id=7944*)
    → "You know how this works. Head to the northeast until you can't go any farther and place it down to lure in the creature. You've got ten minutes (Earth time) to succeed."
...
```
  ...
  8: 0x03DE [0x1D] PRINT_EVENT_MESSAGE(message_id=7941*)
    → "Hostenn gave you one hell of a test, and you managed to clear it. Not bad. Not bad at all."
  9: 0x03E1 [0x23] WAIT_FOR_DIALOG_INTERACTION
 10: 0x03E2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7942*)
    → "If you want to give that elemental another go, just say the word and I'll give you another $3."
 11: 0x03E5 [0x23] WAIT_FOR_DIALOG_INTERACTION
 12: 0x03E6 [0x03] Work_Zone[3] = 2373*
 13: 0x03EB [0x24] CREATE_DIALOG(message_id=7943*, default_option=0*, option_flags=0*)
    → "Do you want another $3? [Sure!/No thanks.]"
 14: 0x03F2 [0x25] WAIT_DIALOG_SELECT()
 15: 0x03F3 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x04AC
 16: 0x03FB [0x1D] PRINT_EVENT_MESSAGE(message_id=7917*)
    → "Though if you really want to pass Hostenn's test, I can be persuaded to search extra hard for gil, bayld, or $3."
 17: 0x03FE [0x23] WAIT_FOR_DIALOG_INTERACTION
 18: 0x03FF [0x1D] PRINT_EVENT_MESSAGE(message_id=7918*)
    → "Of course, if you'd rather wait, I'll be able to come across one eventually. What do you say?"
 19: 0x0402 [0x23] WAIT_FOR_DIALOG_INTERACTION
 20: 0x0403 [0x24] CREATE_DIALOG(message_id=7919*, default_option=0*, option_flags=0*)
    → "Purchase another one? [Purchase for 50000 gil./Purchase for 5000 bayld./Purchase for ten beastmen's seals./No purchasing for me.]"
 ...
 25: 0x041D [0x24] CREATE_DIALOG(message_id=7920*, default_option=1*, option_flags=0*)
    → "Purchase the item for [50,000 gil/5000 bayld]? (Gil: $1). [Yes./No.]"
...
SUBROUTINE_0445:
 ...
 37: 0x045A [0x24] CREATE_DIALOG(message_id=7921*, default_option=1*, option_flags=0*)
    → "Purchase the item for [50,000 gil/5000 bayld]? (Bayld: $1). [Yes./No.]"
...
SUBROUTINE_0482:
 ...
 47: 0x048D [0x1D] PRINT_EVENT_MESSAGE(message_id=7923*)
    → "Trade me ten beastmen's seals if you really want the item."
