...
- **7813**: Are you ready to face the primal forces of Morimar Basalt Fields?
- **7814**: Are you ready? [Ready as ever!/No. Hold on.]
...
```
  0: 0x0001 [0x48] [System] [7813*]:
    → "Are you ready to face the primal forces of Morimar Basalt Fields?"
  1: 0x0004 [0x23] WAIT_FOR_DIALOG_INTERACTION
  2: 0x0005 [0x24] CREATE_DIALOG(message_id=7814*, default_option=1*, option_flags=0*)
