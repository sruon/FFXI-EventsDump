...
- **7876**: 
- **7877**: You are assaulted by an uncanny sensation.
- **7878**: The arcane energies begin to course within your veins.
- **7879**: You feel a mystical warmth welling up inside you!
...
0040: 04 80 23 1C 05 80 03 02  10 03 00 28 10 2F 93 10  ..#........(./..
0050: 01 02 28 10 30 93 10 01  02 48 06 80 23 7A 00 2F  ..(.0....H..#z./
0060: 93 10 01 7A 00 30 93 10  01 28 10 30 93 10 01 03  ...z.0...(.0....
0070: 03 05 00 03 10 02 05 00  07 80 04 82 00 03 05 00  ................
0080: 07 80 48 08 80 23 AD 00  02 00 2E 93 10 01 F0 FF  ..H..#..........
...
```
 ...
 18: 0x004B [0x28] REQ_SET_WITH_CONDITIONS(priority=0x10, target_entity=Unknown NPC (ID: 17863471/0x0110932F), tag_num=0x02)
 19: 0x0052 [0x28] REQ_SET_WITH_CONDITIONS(priority=0x10, target_entity=Unknown NPC (ID: 17863472/0x01109330), tag_num=0x02)
 20: 0x0059 [0x48] [System] [7876*]:
    → ""
 21: 0x005C [0x23] WAIT_FOR_DIALOG_INTERACTION
 22: 0x005D [0x7A] VM_CONTROL: Reset VM for Unknown NPC (ID: 17863471/0x0110932F)
 23: 0x0063 [0x7A] VM_CONTROL: Reset VM for Unknown NPC (ID: 17863472/0x01109330)
 24: 0x0069 [0x28] REQ_SET_WITH_CONDITIONS(priority=0x10, target_entity=Unknown NPC (ID: 17863472/0x01109330), tag_num=0x03)
 ...
 30: 0x0086 [0xAD] DUAL_ENTITY_SCHEDULER_HANDLER: Execute sub-case 0 with entities [Geomantic Reservoir (ID: 17863470/0x0110932E), LocalPlayer], work=ExtData[1]->WorkLocal[2]
