...
- **7583**: Main Menu [Quest flags./Key items.]
- **7584**: Quest flags [Back./All (operation unverified).]
- **7585**: Quest flag operation [Back./Zero clear.]
- **7586**: Key items [Back./All (operation unverified).]
- **7588**: Key items operation [Back./Delete all.]
...
```
  ...
  1: 0x0006 [0x24] CREATE_DIALOG(message_id=7583*, default_option=0*, option_flags=0*)
...
SUBROUTINE_002C:
  7: 0x002C [0x24] CREATE_DIALOG(message_id=7584*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0052:
 13: 0x0052 [0x24] CREATE_DIALOG(message_id=7585*, default_option=0*, option_flags=0*)
...
SUBROUTINE_008C:
 19: 0x008C [0x24] CREATE_DIALOG(message_id=7586*, default_option=0*, option_flags=0*)
...
SUBROUTINE_00C2:
 27: 0x00C2 [0x24] CREATE_DIALOG(message_id=7588*, default_option=0*, option_flags=0*)
