...
```
  ...
  3: 0x0014 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo0", work_offset2=0*)
  4: 0x0025 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo0")
 ...
 16: 0x0076 [0x45] LOAD_SCHEDULED_TASK(work_offset1=5*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s000", work_offset2=0*)
 ...
 21: 0x00A9 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=Azette (ID: 17216185/0x0106B2B9), entity2=Azette (ID: 17216185/0x0106B2B9), action="tlk0")
...
\u0005 \u007F\u0012\u0005[second/seconds] Earth time)!\u007F1\u0000\u0007"
 ...
 25: 0x00C8 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=Azette (ID: 17216185/0x0106B2B9), entity2=Azette (ID: 17216185/0x0106B2B9), action="tlk1")
...
\u0005 \u007F\u0012\u0005[second/seconds] Earth time) still stands strong!\u007F1\u0000\u0007"
 ...
 38: 0x0112 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=30*, entity1=Azette (ID: 17216185/0x0106B2B9), entity2=Azette (ID: 17216185/0x0106B2B9), action="pas0")
 ...
 42: 0x0138 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 43: 0x0149 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 44: 0x0158 [0x46] CAMERA_CONTROL: Restore default settings
 45: 0x015A [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
 46: 0x016B [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi2", work_offset2=0*)
