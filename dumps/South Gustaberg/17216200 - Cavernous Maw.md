...
| [914](#event-914)     | 0x0001       |    237 |             36 |
| [0](#event-0)         | 0x00EE       |      1 |              1 |
| [1](#event-1)         | 0x00EF       |      1 |              1 |
...
- **7363**: An unseen force is drawing you towards the maw.
- **7364**: Warp to Abyssea - [Dummy/La Theine/Konschtat/Tahrongi/Attohwa/Misareaux/Vunkerl/Altepa/Grauberg/Uleguerand]? [Proceed./Not yet.]
...
0050: 07 80 29 01 F0 FF FF 7F  04 45 08 80 F0 FF FF 7F  ..)......E......
0060: F0 FF FF 7F 37 36 69 6E  04 80 45 05 80 F0 FF FF  ....76in..E.....
...
00C0: 04 80 29 01 F0 FF FF 7F  05 45 05 80 F0 FF FF 7F  ..)......E......
...
```
  ...
  1: 0x0003 [0x48] [System] [7363*]:
    → "An unseen force is drawing you towards the maw."
  2: 0x0006 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0007 [0x03] Work_Zone[2] = 7*
  4: 0x000C [0x24] CREATE_DIALOG(message_id=7364*, default_option=1*, option_flags=0*)
...
SUBROUTINE_0038:
 ...
 19: 0x0052 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x04)
 20: 0x0059 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "76in" with entities [LocalPlayer, LocalPlayer], work=[560*, 0*]
 ...
 27: 0x00C2 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x05)
