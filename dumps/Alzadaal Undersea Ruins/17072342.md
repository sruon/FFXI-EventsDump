...
```
  0: 0x0046 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-531.543*, z=652.137*, y=0.000*, direction=57.1°*
...
```
  0: 0x0050 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-526.437*, z=647.032*, y=0.050*, direction=162.1°*
