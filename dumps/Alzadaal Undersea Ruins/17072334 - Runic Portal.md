...
| [117](#event-117)     | 0x0001       |    295 |             37 |
| [121](#event-121)     | 0x0128       |    305 |             41 |
...
- **7243**: Use the device? [Yes./No.]
- **7245**: Attuning yourself to this runic portal will open a path to the Chamber of Passage.
- **7251**: <Player> has attuned [himself/herself] to the runic portal, and opened a path from the Nyzul Isle staging point to the Chamber of Passage.
...
0030: 1C 04 80 38 05 80 29 01  F0 FF FF 7F 2B 45 06 80  ...8..).....+E..
0040: F0 FF FF 7F F0 FF FF 7F  7A 37 32 65 02 80 45 03  ........z72e..E.
0050: 80 F0 FF FF 7F F0 FF FF  7F 66 64 69 31 02 80 2D  .........fdi1..-
0060: F8 FF FF 7F F8 FF FF 7F  31 70 61 32 1C 07 80 45  ........1pa2...E
...
00B0: 66 02 80 29 01 F0 FF FF  7F 03 1C 09 80 45 08 80  f..).........E..
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=7243*, default_option=1*, option_flags=0*)
 ...
 12: 0x0036 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x2B)
 13: 0x003D [0x45] LOAD_SCHEDULED_TASK: Load scheduler "z72e" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
 14: 0x004E [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi1" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
 15: 0x005F [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "1pa2" with entities [EventEntity, EventEntity]
 ...
 20: 0x00A2 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "z72f" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
...
```
  ...
  3: 0x012E [0x24] CREATE_DIALOG(message_id=7243*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
