...
- **7241**: Attuning yourself to this runic portal will open a path to the Chamber of Passage.
- **7247**: <Player> has attuned [himself/herself] to the runic portal, and opened a path from the Nyzul Isle staging point to the Chamber of Passage.
...
```
  ...
  3: 0x012E [0x24] CREATE_DIALOG(message_id=7239*, default_option=1*, option_flags=0*)
    → "Use the device? [Yes./No.]"
