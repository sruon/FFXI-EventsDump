...
- **7486**: Greetings, mercenary. I am % of the Immortals.
- **7487**: You are here on an Assault mission? Then you'll be wanting command verification.
- **7488**: Do you want command verification? [Yes./No./I want to ask you some questions.]
- **7489**: What do you ask about? [Command verification./Nyzul Isle Assault missions./Nyzul Isle Uncharted Region.]
- **7490**: If you have $0 [credit/credits] available from your Imperial Standing, I will recognize your ability to lead this Assault mission.
- **7491**: Receive command verification? [Yes. ($0 [credit/credits])/No.]
- **7492**: Very well. Consider your command of this mission verified.
- **7493**: With this in your possession, you will be able to pass through the runic seal and enter the Assault area. Good luck.
- **7494**: I cannot entrust leadership of a mission to a mercenary with such an unimpressive standing. Return to me when you are worthy.
- **7495**: You refuse to assume leadership? Perhaps you should make that decision before you speak to me.
- **7496**: No? Then I suggest you complete your preparations and await your leader's orders!
- **7497**: Receiving command verification will authorize you to begin an Assault mission.
- **7498**: You will also be responsible for confirming that all members are prepared to begin the mission.
- **7499**: Shouldering this responsibility, and leading your party to victory are all part of being a truly outstanding mercenary.
- **7500**: The Nyzul Isle remnants are divided into numerous separate floors. It it not possible to travel between these floors by normal means.
- **7501**: The only way to pass from one floor to another is by using Nyzul "tokens" at a device known as the "Rune of Transfer."
- **7502**: You currently possess $1 [Nyzul token/Nyzul tokens], and can travel to any floor up to and including Floor $2.
- **7503**: The only way to pass from one floor to another is by using Nyzul "tokens" at a device known as the "Rune of Transfer."
- **7504**: You currently possess $1 Nyzul [token/tokens], and have explored as far as Floor $4.
- **7505**: This is the Nyzul Isle staging point. If you have no official business here, it's time for you to leave.
...
```
  ...
  9: 0x0023 [0x1D] PRINT_EVENT_MESSAGE(message_id=7490*)
 ...
 11: 0x0027 [0x24] CREATE_DIALOG(message_id=7491*, default_option=1*, option_flags=0*)
 ...
 15: 0x003F [0x1D] PRINT_EVENT_MESSAGE(message_id=7494*)
 ...
 19: 0x0047 [0x1D] PRINT_EVENT_MESSAGE(message_id=7492*)
    → "Very well. Consider your command of this mission verified."
 20: 0x004A [0x23] WAIT_FOR_DIALOG_INTERACTION
 21: 0x004B [0x1D] PRINT_EVENT_MESSAGE(message_id=7493*)
...
SUBROUTINE_0054:
 ...
 26: 0x005F [0x1D] PRINT_EVENT_MESSAGE(message_id=7495*)
...
SUBROUTINE_0066:
 ...
 31: 0x0071 [0x1D] PRINT_EVENT_MESSAGE(message_id=7496*)
 ...
 35: 0x0080 [0x24] CREATE_DIALOG(message_id=7489*, default_option=0*, option_flags=0*)
 ...
 42: 0x0098 [0x1D] PRINT_EVENT_MESSAGE(message_id=7499*)
 ...
 46: 0x00A7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7500*)
 ...
 48: 0x00AB [0x1D] PRINT_EVENT_MESSAGE(message_id=7501*)
 ...
 50: 0x00AF [0x1D] PRINT_EVENT_MESSAGE(message_id=7502*)
 ...
 54: 0x00BE [0x1D] PRINT_EVENT_MESSAGE(message_id=7500*)
    → "The Nyzul Isle remnants are divided into numerous separate floors. It it not possible to travel between these floors by normal means."
 55: 0x00C1 [0x23] WAIT_FOR_DIALOG_INTERACTION
 56: 0x00C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7503*)
    → "The only way to pass from one floor to another is by using Nyzul "tokens" at a device known as the "Rune of Transfer.""
 57: 0x00C5 [0x23] WAIT_FOR_DIALOG_INTERACTION
 58: 0x00C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7504*)
...
```
  ...
  1: 0x00D7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7505*)
