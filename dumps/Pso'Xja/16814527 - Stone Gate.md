...
- **7276**: Hold the $3 up to the door? [Yes./Not yet.]
- **7278**: Exit through the door? [Yes./No.]
...
```
  ...
  2: 0x0008 [0x24] CREATE_DIALOG(message_id=7276*, default_option=1*, option_flags=0*)
...
```
  ...
  1: 0x00E2 [0x24] CREATE_DIALOG(message_id=7278*, default_option=1*, option_flags=0*)
