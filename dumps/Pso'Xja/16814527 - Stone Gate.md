...
- **7275**: Hold the $3 up to the door? [Yes./Not yet.]
- **7277**: Exit through the door? [Yes./No.]
...
```
  ...
  2: 0x0008 [0x24] CREATE_DIALOG(message_id=7275*, default_option=1*, option_flags=0*)
...
```
  ...
  1: 0x00E2 [0x24] CREATE_DIALOG(message_id=7277*, default_option=1*, option_flags=0*)
