...
|       1 | 0x0001      |           1 |
|       2 | 0x0080      |         128 |
|       3 | 0xFFFB19D9  |  4294646233 |
|       4 | 0xFFF9ED5B  |  4294569307 |
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0040:                6C F8 FF  FF 7F 00 80 01 80 37 03       l........7.
0050: 80 04 80 05 80 00 80 00                           ........        
```
...
```
  ...
  1: 0x004E [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-321.063*, z=-397.989*, y=-22.860*, direction=0.0°*
