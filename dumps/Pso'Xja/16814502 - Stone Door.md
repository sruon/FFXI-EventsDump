...
- **7258**: The $3 is responding to the glow from the arch!
...
```
  ...
  2: 0x0008 [0x48] [System] [7258*]:
    → "The $3 is responding to the glow from the arch!"
  3: 0x000B [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x000C [0x24] CREATE_DIALOG(message_id=7277*, default_option=1*, option_flags=0*)
