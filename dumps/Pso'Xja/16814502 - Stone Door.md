...
- **7256**: The $3 is responding to the glow from the arch!
...
0040: 08 80 F0 FF FF 7F F0 FF  FF 7F 39 62 6C 64 04 80  ..........9bld..
0050: 29 01 F0 FF FF 7F 2B 29  01 F0 FF FF 7F 2A 45 05  ).....+).....*E.
0060: 80 F0 FF FF 7F F0 FF FF  7F 77 68 69 31 04 80 1C  .........whi1...
0070: 06 80 1C 06 80 4C 1C 09  80 27 01 F0 FF FF 7F 2C  .....L...'.....,
0080: 1C 0A 80 4D 1C 09 80 45  0B 80 F0 FF FF 7F F0 FF  ...M...E........
0090: FF 7F 66 64 6F 31 04 80  1C 06 80 52 08 80 F0 FF  ..fdo1.....R....
00A0: FF 7F F0 FF FF 7F 39 62  6C 64 45 0B 80 F0 FF FF  ......9bldE.....
...
```
  ...
  2: 0x0008 [0x48] [System] [7256*]:
    → "The $3 is responding to the glow from the arch!"
  3: 0x000B [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x000C [0x24] CREATE_DIALOG(message_id=7275*, default_option=1*, option_flags=0*)
 ...
 15: 0x003F [0x45] LOAD_SCHEDULED_TASK: Load scheduler "9bld" with entities [LocalPlayer, LocalPlayer], work=[160*, 0*]
 16: 0x0050 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x2B)
 17: 0x0057 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x2A)
 ...
 23: 0x0079 [0x27] REQ_SET(priority=0x01, entity_id=LocalPlayer, tag_num=0x2C)
 ...
 29: 0x009B [0x52] END_LOAD_SCHEDULER: End scheduler "9bld" with entities [LocalPlayer, LocalPlayer], work=160*
