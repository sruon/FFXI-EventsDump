...
- **7269**: The trap on the door is broken.
- **7275**: Enter through the door? [Yes./No.]
...
```
  ...
  1: 0x0003 [0x48] [System] [7269*]:
    → "The trap on the door is broken."
  2: 0x0006 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0007 [0x24] CREATE_DIALOG(message_id=7275*, default_option=1*, option_flags=0*)
...
```
  ...
  1: 0x00C4 [0x24] CREATE_DIALOG(message_id=7276*, default_option=1*, option_flags=0*)
