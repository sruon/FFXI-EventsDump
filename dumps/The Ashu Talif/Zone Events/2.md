...
```
  ...
  1: 0x0104 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  2: 0x0115 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
  ...
  7: 0x0134 [0x45] LOAD_SCHEDULED_TASK(work_offset1=194*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s000", work_offset2=0*)
  8: 0x0145 [0x1C] WAIT(60* ticks)
  9: 0x0148 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi2", work_offset2=0*)
 10: 0x0159 [0x1C] WAIT(1300* ticks)
 11: 0x015C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="ovl1", work_offset2=0*)
 12: 0x016D [0x52] END_LOAD_SCHEDULER: End scheduler "s000" with entities [EventEntity, EventEntity], work=194*
 13: 0x017C [0x45] LOAD_SCHEDULED_TASK(work_offset1=194*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s001", work_offset2=0*)
 14: 0x018D [0x1C] WAIT(650* ticks)
 15: 0x0190 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 16: 0x01A1 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 22: 0x01CB [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
