...
- **7802**: Do you want to hear a story? [No, thank you./Let's hear one.]
- **7803**: What story would you like to be told? [On second thought, maybe later./To Each His Own Right./Spharai./Picture Perfect(pt.1)./Picture Perfect(pt.2)./Picture Perfect(pt.3)./Picture Perfect(pt.4)./Picture Perfect(pt.5)./To Kill Mocking Birds.]
- **7804**: 
- **7805**: 
- **7806**: 
