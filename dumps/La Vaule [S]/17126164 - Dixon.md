...
| [65535.11](#event-6553511) | 0x0062       |      2 |              2 |
| [65535.12](#event-6553512) | 0x0064       |     15 |              5 |
| [65535.13](#event-6553513) | 0x0073       |     15 |              5 |
...
```
  0: 0x0045 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=280.173*, z=-236.205*, y=3.999*, direction=268.1°*
...
```
  ...
  1: 0x0052 [0x1F] MOVE_ENTITY: EventEntity moves to X=279.485*, Z=-216.254*, Y=3.999*
...
```
  0: 0x0062 [0x96] UNSET_EVENT_NPC: Restore NPC after event (removes event NPC status)
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0060:             32 07 80 1F  00 0B 80 0C 80 0D 80 1F      2...........
0070: 01 6F 00                                          .o.             
```
...
```
  ...
  1: 0x0067 [0x1F] MOVE_ENTITY: EventEntity moves to X=271.452*, Z=-191.615*, Y=3.886*
