...
```
  ...
  2: 0x00A8 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0x0001, entity1=EventEntity, entity2=EventEntity, action="sha1")
  3: 0x00B7 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="sha1")
...
```
# Data Section: 0x00EA (111 bytes)
     0x00EA: 03 01 00 00 00 02 01 00 11 80 05 FF 00 08 01 00
     0x00FA: 01 80 01 04 01 08 01 00 12 80 14 01 00 0D 80 07
     0x010A: 01 00 14 80 1B 03 01 00 00 00 02 01 00 11 80 05
     0x011A: 24 01 08 01 00 01 80 01 29 01 08 01 00 12 80 14
     0x012A: 01 00 0D 80 07 01 00 15 80 1B 03 01 00 00 00 02
     0x013A: 01 00 11 80 05 49 01 08 01 00 01 80 01 4E 01 08
     0x014A: 01 00 12 80 14 01 00 0D 80 07 01 00 16 80 1B
```