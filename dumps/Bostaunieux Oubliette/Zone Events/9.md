...
```
 ...
 15: 0x0765 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 16: 0x0776 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 ...
 23: 0x07AC [0x45] LOAD_SCHEDULED_TASK(work_offset1=67*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="q000", work_offset2=0*)
 24: 0x07BD [0x55] WAIT_LOAD_SCHEDULER(work_offset=67*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="q000")
 25: 0x07CC [0x03] ExtData[1]->WorkLocal[0] = LocalPlayer->Race
 26: 0x07D1 [0x1A] CALL_SUBROUTINE(address=0x08EC)
 27: 0x07D4 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0x0001, entity1=LocalPlayer, entity2=LocalPlayer, action=0xFEFEFE00)
 28: 0x07E3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 29: 0x07F4 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1")
 ...
 37: 0x0820 [0x45] LOAD_SCHEDULED_TASK(work_offset1=67*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="q001", work_offset2=0*)
 38: 0x0831 [0x55] WAIT_LOAD_SCHEDULER(work_offset=67*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="q001")
 39: 0x0840 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0x0001, entity1=LocalPlayer, entity2=LocalPlayer, action="sha0")
 40: 0x084F [0x1C] WAIT(5* ticks)
 41: 0x0852 [0x45] LOAD_SCHEDULED_TASK(work_offset1=67*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="q002", work_offset2=0*)
 42: 0x0863 [0x55] WAIT_LOAD_SCHEDULER(work_offset=67*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="q002")
 43: 0x0872 [0x1C] WAIT(5* ticks)
 44: 0x0875 [0x45] LOAD_SCHEDULED_TASK(work_offset1=67*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="q003", work_offset2=0*)
 45: 0x0886 [0x55] WAIT_LOAD_SCHEDULER(work_offset=67*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="q003")
 46: 0x0895 [0x1C] WAIT(60* ticks)
 47: 0x0898 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=0x0001, entity1=LocalPlayer, entity2=LocalPlayer, action="sha1")
 48: 0x08A7 [0x53] WAIT_SCHEDULER_TASK(entity1=LocalPlayer, entity2=LocalPlayer, action_id="sha1")
 49: 0x08B4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2", work_offset2=0*)
 50: 0x08C5 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo2")
 51: 0x08D4 [0x46] CAMERA_CONTROL: Restore default settings
 52: 0x08D6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
...
```
# Data Section: 0x0911 (111 bytes)
     0x0911: 03 01 00 00 00 02 01 00 56 80 05 26 09 08 01 00
     0x0921: 08 80 01 2B 09 08 01 00 1D 80 14 01 00 27 80 07
     0x0931: 01 00 58 80 1B 03 01 00 00 00 02 01 00 56 80 05
     0x0941: 4B 09 08 01 00 08 80 01 50 09 08 01 00 1D 80 14
     0x0951: 01 00 27 80 07 01 00 59 80 1B 03 01 00 00 00 02
     0x0961: 01 00 56 80 05 70 09 08 01 00 08 80 01 75 09 08
     0x0971: 01 00 1D 80 14 01 00 27 80 07 01 00 5A 80 1B
```