...
- **7693**: Oh my Gob! You're one of those adventurerurers, aren't ya? You got nothin' on me, [man./lady.] I was just mindin' my own businesesess, lookin' for junk an' stuff.
- **7694**: Hey, watch out. You don't wanna fight me. I'll turn you into meat jerky! Wait, how about you and me be friends instead? Sound good?
- **7695**: I travel all over the world and hear lots of differererent stories. I even hear your stories. I can tell you one, if you want.
- **7696**: Now, listen close...
- **7697**: Oh... Well, if that's the case, I'm outta here.
- **7704**: Do you want to hear a story? [No, thank you./Let's hear one./Let's here some more!]
- **7705**: Do you want to hear a story? [No, thank you./The Battle of Xarcabard./Prelude to a Storm(pt.1)./Prelude to a Storm(pt.2)./Prelude to a Storm(pt.3)./Storm's Crescendo(pt.1)./Storm's Crescendo(pt.2)./Storm's Crescendo(pt.3)./Storm's Crescendo(pt.4)./Into the Beast's Maw(pt.1)./Into the Beast's Maw(pt.2)./Flight of the Lion./Edge of Existence./Fork in the Road.]
- **7706**: Do you want to hear a story? [No, thank you./Blood of Heroes(pt.1)./Blood of Heroes(pt.2)./Blood of Heroes(pt.3)./Blood of Heroes(pt.4)./Blood of Heroes(pt.5)./Blood of Heroes(pt.6)./Blood of Heroes(pt.7)./Blood of Heroes(pt.8)./Blood of Heroes(pt.9)./Blood of Heroes(pt.10)./What Price Loyalty(pt.1)./What Price Loyalty(pt.2)./What Price Loyalty(pt.3)./Chasing Shadows(pt.1)./Chasing Shadows(pt.2)./Chasing Shadows(pt.3)./Chasing Shadows(pt.4)./Chasing Shadows(pt.5)./Walk of Echoes(pt.1)./Walk of Echoes(pt.2).]
- **7707**: 
- **7708**: 
...
```
 ...
 15: 0x005A [0x1D] PRINT_EVENT_MESSAGE(message_id=7693*)
 ...
 17: 0x005E [0x1D] PRINT_EVENT_MESSAGE(message_id=7694*)
 ...
 19: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=7695*)
 ...
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=7704*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7705*, default_option=0*, option_flags=Work_Zone[2])
 ...
 37: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7697*)
...
SUBROUTINE_00E6:
 43: 0x00E6 [0x24] CREATE_DIALOG(message_id=7706*, default_option=0*, option_flags=Work_Zone[3])
 ...
 48: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7697*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_012A:
 54: 0x012A [0x24] CREATE_DIALOG(message_id=7707*, default_option=0*, option_flags=Work_Zone[4])
    → ""
 ...
 59: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=7697*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_016E:
 65: 0x016E [0x24] CREATE_DIALOG(message_id=7708*, default_option=0*, option_flags=Work_Zone[5])
    → ""
 ...
 70: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=7697*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01A7:
 ...
 77: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7697*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01C6:
 81: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7696*)
    → "Now, listen close..."
