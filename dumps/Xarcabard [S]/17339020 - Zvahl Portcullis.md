...
- **7702**: Enter Castle Zvahl? [Yes./No.]
...
0030: 80 45 06 80 F0 FF FF 7F  F0 FF FF 7F 7A 31 33 37  .E..........z137
0040: 02 80 29 01 F0 FF FF 7F  02 45 03 80 F0 FF FF 7F  ..)......E......
0050: F0 FF FF 7F 66 64 69 31  02 80 1C 04 80 4C 1C 04  ....fdi1.....L..
0060: 80 27 01 F0 FF FF 7F 03  1C 07 80 45 03 80 F0 FF  .'.........E....
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=7702*, default_option=1*, option_flags=0*)
    → "Enter Castle Zvahl? [Yes./No.]"
 ...
 11: 0x0031 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "z137" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
 12: 0x0042 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=LocalPlayer, tag_num=0x02)
 ...
 17: 0x0061 [0x27] REQ_SET(priority=0x01, entity_id=LocalPlayer, tag_num=0x03)
 18: 0x0068 [0x1C] WAIT(180* ticks)
