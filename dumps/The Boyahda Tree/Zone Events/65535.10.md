...
```
  0: 0x01B3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=251*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s078", work_offset2=0*)
  1: 0x01C4 [0x1C] WAIT(60* ticks)
  2: 0x01C7 [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "mai1" with entities [Spare Two (ID: 17404400/0x010991F0), Spare Two (ID: 17404400/0x010991F0)], work=[13*, 0*]
  3: 0x01D8 [0x62] LOAD_EVENT_SCHEDULER (arg=5012): Load scheduler "mai1" with entities [Spare Zero (ID: 17404399/0x010991EF), Spare Zero (ID: 17404399/0x010991EF)], work=[13*, 0*]
  4: 0x01E9 [0x1C] WAIT(180* ticks)
  5: 0x01EC [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
