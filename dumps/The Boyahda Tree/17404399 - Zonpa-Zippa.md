...
0190: 15 80 1F 01 6F 29 08 EF  91 09 01 0D 29 08 EF 91  ....o)......)...
01A0: 09 01 0E 00                                       ....            
```
...
```
  ...
  4: 0x0195 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Zonpa-Zippa (ID: 17404399/0x010991EF), tag_num=0x0D)
  5: 0x019C [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Zonpa-Zippa (ID: 17404399/0x010991EF), tag_num=0x0E)
