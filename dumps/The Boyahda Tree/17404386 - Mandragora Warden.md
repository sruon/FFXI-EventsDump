...
```
  ...
  1: 0x0112 [0x1D] PRINT_EVENT_MESSAGE(message_id=7192*)
    → "Ya...pahpah, pakyah!"
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0150:                                            32 04                2.
0160: 80 1F 00 05 80 06 80 07  80 1F 01 6F 1E 0F 92 09  ...........o....
0170: 01 6F 70 00                                       .op.            
```
...
```
  ...
  4: 0x016C [0x1E] EventEntity looks at Magh Bihu (ID: 17404431/0x0109920F) and starts talking
