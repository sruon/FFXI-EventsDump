...
```
  ...
  1: 0x012E [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-57.256*, z=23.758*, y=9.656*, direction=270.0°*
...
0170: 00 00 00 02 00 01 00 1F  01 6F 29 08 AE A0 0A 01  .........o).....
0180: 06 00                                             ..              
```
...
```
  ...
  7: 0x017A [0x29] REQ_SET_WAIT(priority=0x08, entity_id=King of Swords (ID: 17473710/0x010AA0AE), tag_num=0x06)
