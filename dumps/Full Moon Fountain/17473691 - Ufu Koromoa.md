...
|      11 | 0x4E20      |       20000 |
|      12 | 0x0000      |           0 |
|      13 | 0xFFFFADF6  |  4294946294 |
|      14 | 0xFFFFB233  |  4294947379 |
|      15 | 0x251C      |        9500 |
|      16 | 0x0FF8      |        4088 |
...
```
  ...
  1: 0x015E [0x1F] MOVE_ENTITY: EventEntity moves to X=-59.996*, Z=55.106*, Y=9.672*
...
```
  ...
  1: 0x016C [0x1F] MOVE_ENTITY: EventEntity moves to X=-59.500*, Z=20.000*, Y=0.000*
...
```
  0: 0x017C [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-21.002*, z=-19.917*, y=9.500*, direction=359.3°*
