...
| [65535.12](#event-6553512) | 0x00F6       |     10 |              2 |
| [65535.13](#event-6553513) | 0x0100       |     43 |              7 |
| [32000](#event-32000)      | 0x012B       |      1 |              1 |
| [32004](#event-32004)      | 0x012C       |      1 |              1 |
| [32001](#event-32001)      | 0x012D       |      1 |              1 |
...
00C0: 80 29 08 BF A0 0A 01 07  1E F0 FF FF 7F 1C 02 80  .)..............
...
```
  ...
  4: 0x00C1 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=12 (ID: 17473727/0x010AA0BF), tag_num=0x07)
...
```
  0: 0x00F6 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-49.483*, z=32.822*, y=9.991*, direction=175.6°*
...
```
  ...
  4: 0x010E [0x5B] LOAD_EXT_SCHEDULER: Load scheduler "ded0" with entities [EventEntity, EventEntity], work=181*
  5: 0x011D [0x53] WAIT_SCHEDULER_TASK: Wait for scheduler "ded0" with entities [EventEntity, EventEntity]
