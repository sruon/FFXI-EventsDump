...
```
  ...
  1: 0x012E [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-59.737*, z=23.758*, y=9.712*, direction=270.0°*
...
0170: 00 00 00 02 00 01 00 1F  01 6F 29 08 AD A0 0A 01  .........o).....
0180: 06 00                                             ..              
```
...
```
  ...
  7: 0x017A [0x29] REQ_SET_WAIT(priority=0x08, entity_id=King of Wands (ID: 17473709/0x010AA0AD), tag_num=0x06)
