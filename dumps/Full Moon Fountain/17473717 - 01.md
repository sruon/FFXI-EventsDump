...
```
  ...
  1: 0x00B6 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-58.151*, z=12.000*, y=10.955*, direction=269.4°*
...
```
  ...
  1: 0x0140 [0x1F] MOVE_ENTITY: EventEntity moves to X=-47.689*, Z=57.811*, Y=10.176*
