...
- **8062**: On our last field patrol, we came across a conflux to the southeast of here. You'd do well to go imprint with it if you haven't already.
...
```
  ...
  3: 0x000A [0x1D] PRINT_EVENT_MESSAGE(message_id=8062*)
