...
- **7982**: Yes? I've not seen your face before.
- **7983**: I'm afraid we've got our hands full taking care of our own men. For your own safety and ours, you'd best get along on your way.
- **7984**: So you're the one Captain Helga spoke of. The camp's been abuzz with talk of your exploits of late.
- **7985**: I'm glad you've come, for we could use your services as well. If you haven't exhausted your generosity, that is.
- **7986**: We specialize in reconnaissance here. By identifying the movement patterns of our foes before they strike, we can guard against potential ambushes. Heaven knows our regiment can't afford to suffer any more crippling blows.
- **7987**: This is the prized tool of our trade: a pretty little thing we call the $0. Go ahead, hold 'er. She's lighter than she looks, no?
- **7988**: Set 'er up and point her at a target, and you'll get a right fearsome shot of the life energies swirling around in the belly of your beast. It's all quite surreal, really.
- **7989**: These soulprints may not mean much to the layman, but to us, they contain data on our foes that could mean the difference between life and death. Bring me $0, and we'll gladly repay you for your efforts.
- **7990**: Mind you, it's not the rank and file we're investigating here. Only the most powerful foes concern us--those whose strength is impossible to judge with the naked eye.
- **7991**: If you're up to the task, you'll find a spare $0 and $1 in that casket over there. Be careful out there, and good hunting!
- **7992**: Ho there! How go your recon efforts? If you've got any soulprints for us, just hand them over.
- **7993**: There's the [man/woman] I was waiting for! Let's see what you've got for us here...
- **7994**: Such focus! Such clarity! Hm...? The intensity of these soulstrands...! Captain Ayame doesn't know it, but she's got a whopper on her tail...
- **7995**: I must send word at once. My friend, you've no idea how much you've done for us today. Take this. You've more than earned it.
- **7996**: Hmm... The soulstrands are a tad blurred... Just a bit closer, with a head-on angle and we'd be in business. Still, we should be able to glean something from this with a bit of effort.
- **7997**: All in all, not a bad showing for a beginner. Take this for your troubles.
- **7998**: No...I'm afraid this won't do at all. See how dim these soulstrands are? I couldn't tell a ghost from a goobbue with this! You have to get in closer, see...
- **7999**: Sorry, but we'll be needing another sample.
- **8000**: Hm? Is this your idea of a joke? Why, this plate's completely blank!
- **8001**: Our foe is ever adapting. Yesterday's information will serve you as well as the grime on your bootstraps. Bring us fresh recon data, and you shall be rewarded for your efforts.
- **8002**: I'm afraid that we're still in the process of analyzing the last print you brought us. Come back in a bit, won't you?
- **8105**: Hmm... These soulstrands are too faint. I'm afraid this is just a run-of-the-mill fiend. We've no need for intelligence on the rank and file.
...
```
  ...
  8: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=7987*)
 ...
 11: 0x0020 [0x1D] PRINT_EVENT_MESSAGE(message_id=7988*)
 ...
 14: 0x0029 [0x1D] PRINT_EVENT_MESSAGE(message_id=7989*)
 ...
 16: 0x002D [0x1D] PRINT_EVENT_MESSAGE(message_id=7990*)
 ...
 20: 0x003B [0x1D] PRINT_EVENT_MESSAGE(message_id=7991*)
...
```
  ...
  1: 0x0046 [0x1D] PRINT_EVENT_MESSAGE(message_id=7992*)
...
```
  ...
  2: 0x0064 [0x1D] PRINT_EVENT_MESSAGE(message_id=7993*)
  ...
  6: 0x0075 [0x1D] PRINT_EVENT_MESSAGE(message_id=7994*)
  ...
  8: 0x0079 [0x1D] PRINT_EVENT_MESSAGE(message_id=7995*)
 ...
 13: 0x008D [0x1D] PRINT_EVENT_MESSAGE(message_id=7996*)
 ...
 15: 0x0091 [0x1D] PRINT_EVENT_MESSAGE(message_id=7997*)
 ...
 20: 0x00A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7998*)
 ...
 22: 0x00A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7999*)
 ...
 34: 0x00D5 [0x1D] PRINT_EVENT_MESSAGE(message_id=8000*)
    → "Hm? Is this your idea of a joke? Why, this plate's completely blank!"
 35: 0x00D8 [0x23] WAIT_FOR_DIALOG_INTERACTION
 36: 0x00D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7999*)
    → "Sorry, but we'll be needing another sample."
 ...
 41: 0x00ED [0x1D] PRINT_EVENT_MESSAGE(message_id=8105*)
 ...
 43: 0x00F1 [0x1D] PRINT_EVENT_MESSAGE(message_id=7999*)
    → "Sorry, but we'll be needing another sample."
 ...
 48: 0x0105 [0x1D] PRINT_EVENT_MESSAGE(message_id=8105*)
    → "Hmm... These soulstrands are too faint. I'm afraid this is just a run-of-the-mill fiend. We've no need for intelligence on the rank and file."
 49: 0x0108 [0x23] WAIT_FOR_DIALOG_INTERACTION
 50: 0x0109 [0x1D] PRINT_EVENT_MESSAGE(message_id=7999*)
    → "Sorry, but we'll be needing another sample."
...
SUBROUTINE_0115:
 54: 0x0115 [0x1D] PRINT_EVENT_MESSAGE(message_id=8001*)
...
```
 ...
 13: 0x0163 [0x1D] PRINT_EVENT_MESSAGE(message_id=7996*)
    → "Hmm... The soulstrands are a tad blurred... Just a bit closer, with a head-on angle and we'd be in business. Still, we should be able to glean something from this with a bit of effort."
 14: 0x0166 [0x23] WAIT_FOR_DIALOG_INTERACTION
 15: 0x0167 [0x1D] PRINT_EVENT_MESSAGE(message_id=7997*)
    → "All in all, not a bad showing for a beginner. Take this for your troubles."
 ...
 20: 0x017B [0x1D] PRINT_EVENT_MESSAGE(message_id=7998*)
    → "No...I'm afraid this won't do at all. See how dim these soulstrands are? I couldn't tell a ghost from a goobbue with this! You have to get in closer, see..."
 21: 0x017E [0x23] WAIT_FOR_DIALOG_INTERACTION
 22: 0x017F [0x1D] PRINT_EVENT_MESSAGE(message_id=7999*)
    → "Sorry, but we'll be needing another sample."
 ...
 27: 0x0193 [0x1D] PRINT_EVENT_MESSAGE(message_id=8000*)
    → "Hm? Is this your idea of a joke? Why, this plate's completely blank!"
 28: 0x0196 [0x23] WAIT_FOR_DIALOG_INTERACTION
 29: 0x0197 [0x1D] PRINT_EVENT_MESSAGE(message_id=7999*)
    → "Sorry, but we'll be needing another sample."
 ...
 34: 0x01AB [0x1D] PRINT_EVENT_MESSAGE(message_id=8000*)
    → "Hm? Is this your idea of a joke? Why, this plate's completely blank!"
 35: 0x01AE [0x23] WAIT_FOR_DIALOG_INTERACTION
 36: 0x01AF [0x1D] PRINT_EVENT_MESSAGE(message_id=7999*)
    → "Sorry, but we'll be needing another sample."
 ...
 41: 0x01C3 [0x1D] PRINT_EVENT_MESSAGE(message_id=8105*)
    → "Hmm... These soulstrands are too faint. I'm afraid this is just a run-of-the-mill fiend. We've no need for intelligence on the rank and file."
 42: 0x01C6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 43: 0x01C7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7999*)
    → "Sorry, but we'll be needing another sample."
 ...
 48: 0x01DB [0x1D] PRINT_EVENT_MESSAGE(message_id=8105*)
    → "Hmm... These soulstrands are too faint. I'm afraid this is just a run-of-the-mill fiend. We've no need for intelligence on the rank and file."
 49: 0x01DE [0x23] WAIT_FOR_DIALOG_INTERACTION
 50: 0x01DF [0x1D] PRINT_EVENT_MESSAGE(message_id=7999*)
    → "Sorry, but we'll be needing another sample."
...
SUBROUTINE_01EB:
 54: 0x01EB [0x1D] PRINT_EVENT_MESSAGE(message_id=8001*)
    → "Our foe is ever adapting. Yesterday's information will serve you as well as the grime on your bootstraps. Bring us fresh recon data, and you shall be rewarded for your efforts."
...
```
  ...
  1: 0x020F [0x1D] PRINT_EVENT_MESSAGE(message_id=7982*)
    → "Yes? I've not seen your face before."
  2: 0x0212 [0x23] WAIT_FOR_DIALOG_INTERACTION
  3: 0x0213 [0x1D] PRINT_EVENT_MESSAGE(message_id=7983*)
...
```
  ...
  1: 0x021E [0x1D] PRINT_EVENT_MESSAGE(message_id=8002*)
...
```
  ...
  3: 0x0234 [0x1D] PRINT_EVENT_MESSAGE(message_id=7982*)
    → "Yes? I've not seen your face before."
  4: 0x0237 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0238 [0x1D] PRINT_EVENT_MESSAGE(message_id=7983*)
    → "I'm afraid we've got our hands full taking care of our own men. For your own safety and ours, you'd best get along on your way."
  6: 0x023B [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x023C [0x1D] PRINT_EVENT_MESSAGE(message_id=7984*)
    → "So you're the one Captain Helga spoke of. The camp's been abuzz with talk of your exploits of late."
  8: 0x023F [0x23] WAIT_FOR_DIALOG_INTERACTION
  9: 0x0240 [0x1D] PRINT_EVENT_MESSAGE(message_id=7985*)
    → "I'm glad you've come, for we could use your services as well. If you haven't exhausted your generosity, that is."
 10: 0x0243 [0x23] WAIT_FOR_DIALOG_INTERACTION
 11: 0x0244 [0x1D] PRINT_EVENT_MESSAGE(message_id=7986*)
    → "We specialize in reconnaissance here. By identifying the movement patterns of our foes before they strike, we can guard against potential ambushes. Heaven knows our regiment can't afford to suffer any more crippling blows."
 12: 0x0247 [0x23] WAIT_FOR_DIALOG_INTERACTION
 13: 0x0248 [0x1D] PRINT_EVENT_MESSAGE(message_id=7987*)
    → "This is the prized tool of our trade: a pretty little thing we call the $0. Go ahead, hold 'er. She's lighter than she looks, no?"
 14: 0x024B [0x23] WAIT_FOR_DIALOG_INTERACTION
 15: 0x024C [0x1D] PRINT_EVENT_MESSAGE(message_id=7988*)
    → "Set 'er up and point her at a target, and you'll get a right fearsome shot of the life energies swirling around in the belly of your beast. It's all quite surreal, really."
 16: 0x024F [0x23] WAIT_FOR_DIALOG_INTERACTION
 17: 0x0250 [0x1D] PRINT_EVENT_MESSAGE(message_id=7989*)
    → "These soulprints may not mean much to the layman, but to us, they contain data on our foes that could mean the difference between life and death. Bring me $0, and we'll gladly repay you for your efforts."
 18: 0x0253 [0x23] WAIT_FOR_DIALOG_INTERACTION
 19: 0x0254 [0x1D] PRINT_EVENT_MESSAGE(message_id=7990*)
    → "Mind you, it's not the rank and file we're investigating here. Only the most powerful foes concern us--those whose strength is impossible to judge with the naked eye."
 20: 0x0257 [0x23] WAIT_FOR_DIALOG_INTERACTION
 21: 0x0258 [0x1D] PRINT_EVENT_MESSAGE(message_id=7991*)
    → "If you're up to the task, you'll find a spare $0 and $1 in that casket over there. Be careful out there, and good hunting!"
 22: 0x025B [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x025C [0x1D] PRINT_EVENT_MESSAGE(message_id=7992*)
    → "Ho there! How go your recon efforts? If you've got any soulprints for us, just hand them over."
 24: 0x025F [0x23] WAIT_FOR_DIALOG_INTERACTION
 25: 0x0260 [0x1D] PRINT_EVENT_MESSAGE(message_id=7993*)
    → "There's the [man/woman] I was waiting for! Let's see what you've got for us here..."
 26: 0x0263 [0x23] WAIT_FOR_DIALOG_INTERACTION
 27: 0x0264 [0x1D] PRINT_EVENT_MESSAGE(message_id=7994*)
    → "Such focus! Such clarity! Hm...? The intensity of these soulstrands...! Captain Ayame doesn't know it, but she's got a whopper on her tail..."
 28: 0x0267 [0x23] WAIT_FOR_DIALOG_INTERACTION
 29: 0x0268 [0x1D] PRINT_EVENT_MESSAGE(message_id=7995*)
    → "I must send word at once. My friend, you've no idea how much you've done for us today. Take this. You've more than earned it."
 30: 0x026B [0x23] WAIT_FOR_DIALOG_INTERACTION
 31: 0x026C [0x1D] PRINT_EVENT_MESSAGE(message_id=7996*)
    → "Hmm... The soulstrands are a tad blurred... Just a bit closer, with a head-on angle and we'd be in business. Still, we should be able to glean something from this with a bit of effort."
 32: 0x026F [0x23] WAIT_FOR_DIALOG_INTERACTION
 33: 0x0270 [0x1D] PRINT_EVENT_MESSAGE(message_id=7997*)
    → "All in all, not a bad showing for a beginner. Take this for your troubles."
 34: 0x0273 [0x23] WAIT_FOR_DIALOG_INTERACTION
 35: 0x0274 [0x1D] PRINT_EVENT_MESSAGE(message_id=7998*)
    → "No...I'm afraid this won't do at all. See how dim these soulstrands are? I couldn't tell a ghost from a goobbue with this! You have to get in closer, see..."
 36: 0x0277 [0x23] WAIT_FOR_DIALOG_INTERACTION
 37: 0x0278 [0x1D] PRINT_EVENT_MESSAGE(message_id=7999*)
    → "Sorry, but we'll be needing another sample."
 38: 0x027B [0x23] WAIT_FOR_DIALOG_INTERACTION
 39: 0x027C [0x1D] PRINT_EVENT_MESSAGE(message_id=8000*)
    → "Hm? Is this your idea of a joke? Why, this plate's completely blank!"
 40: 0x027F [0x23] WAIT_FOR_DIALOG_INTERACTION
 41: 0x0280 [0x1D] PRINT_EVENT_MESSAGE(message_id=8001*)
    → "Our foe is ever adapting. Yesterday's information will serve you as well as the grime on your bootstraps. Bring us fresh recon data, and you shall be rewarded for your efforts."
