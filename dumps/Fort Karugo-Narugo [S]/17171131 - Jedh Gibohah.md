...
```
  ...
  3: 0x0018 [0x2B] EventEntity [8192*]:
    → "The only rrreason we call ourselves mercenaries is because we oppose being assimilated into the Federation."
  4: 0x001F [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0020 [0x2B] EventEntity [8193*]:
    → "We belong to no nation, and we answer to no master. We obey only the natural order."
