...
```
  ...
  3: 0x0018 [0x2B] EventEntity [8173*]:
    → "Our path is lit by yon brilliant star,\u0007Many on the long journey embark.\u0007Guided true by that celestial spark,\u0007To find a timeless green that can know no dark.\u007F1\u0000\u0007"
  4: 0x001F [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0020 [0x2B] EventEntity [8174*]:
    → "Oh, the six points of yon shining star,\u0007even the raging of beasts shall slake.\u0007In the south heavens glows a pearly lake,\u0007traverses the sky and leaves an azure wake.\u007F1\u0000\u0007"
  6: 0x0027 [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x0028 [0x2B] EventEntity [8175*]:
    → "Hm? Oh, that's just an old song my grandmother taught me.\u0007It's supposed to be about the Horutoto Ruins, if I remember.\u007F1\u0000\u0007"
