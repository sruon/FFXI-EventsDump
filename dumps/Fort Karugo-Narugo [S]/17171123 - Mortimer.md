...
```
  ...
  2: 0x0009 [0x2B] EventEntity [8146*]:
    → "Did you escape from the Yagudo forces? They nearly captured one of our caravans."
  3: 0x0010 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0011 [0x6E] EventEntity uses emote 26*
  5: 0x0018 [0x99] Wait for EventEntity animation to complete
  6: 0x001D [0x2B] EventEntity [8147*]:
    → "The crystals in transport were defended to the very last."
