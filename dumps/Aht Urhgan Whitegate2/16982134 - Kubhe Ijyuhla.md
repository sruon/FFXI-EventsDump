...
0040: 6F 4A 76 20 03 01 C6 21  03 01 00                 oJv ...!...     
```
...
```
  ...
  2: 0x0036 [0x1F] MOVE_ENTITY: EventEntity moves to X=-570.306*, Z=36.814*, Y=1.999*
  3: 0x003E [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  4: 0x0040 [0x6F] WAIT_FRAME_DELAY: Yield until WaitTime reaches zero
  5: 0x0041 [0x4A] Kubhe Ijyuhla (ID: 16982134/0x01032076) looks at Rongelouts (ID: 16982470/0x010321C6)
...
```
  ...
  1: 0x007B [0x1F] MOVE_ENTITY: EventEntity moves to X=-565.039*, Z=37.633*, Y=1.999*
