...
| [65535.1](#event-65535-1) | 0x0008       |     16 |              2 |
| [65535.2](#event-65535-2) | 0x0018       |     22 |              4 |
| [65535.3](#event-65535-3) | 0x002E       |     10 |              2 |
...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0020:                                            6C F8                l.
0030: FF FF 7F 02 80 03 80 00                           ........        
```

#### Opcodes

```
  0: 0x002E [0x6C] FADE_ENTITY_COLOR(entity_id=EventEntity, end_alpha=128*, fade_time=120*)
