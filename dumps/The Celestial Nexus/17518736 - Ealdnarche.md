...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0040:                   A4 01  37 03 80 04 80 05 80 06        ..7.......
0050: 80 00                                             ..              
```
...
```
  0: 0x0046 [0xA4] EventEntity->Flags3.unknown_3_2 = 1
  1: 0x0048 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-48.753*, z=-25.065*, y=-19.099*, direction=179.9°*
