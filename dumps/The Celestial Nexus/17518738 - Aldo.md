...
```
  0: 0x0051 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=-0.727*, z=-360.071*, y=-40.000*, direction=89.1°*
...
```
  ...
  1: 0x006D [0x1F] MOVE_ENTITY: EventEntity moves to X=-2.110*, Z=-380.298*, Y=-39.999*
