...
SUBROUTINE_00B0:
 23: 0x00B0 [0x1A] CALL_SUBROUTINE(address=0x322A)
...
SUBROUTINE_01A4:
 ...
 76: 0x01DD [0x1A] CALL_SUBROUTINE(address=0x34EB)
...
114: 0x04EA [0x48] [System] [7604*]:
    → "The current battlefield clear time record for \u00072\u000C\u0001[The Celestial Nexus/\u0001\u001AThe Celestial Nexus/Crystal Paradise]\u00073 is 
\u0003 minute\u007F\u0012\u0003[/s] 
\u0002 second\u007F\u0012\u0002[/s].\u0000\u0007"
...
238: 0x075F [0x5C] MUSIC_CONTROL: Set Idle (Day) music to song 198*
239: 0x0763 [0x5C] MUSIC_CONTROL: Set Idle (Night) music to song 198*
240: 0x0767 [0x5C] MUSIC_CONTROL: Set Combat (Solo) music to song 198*
241: 0x076B [0x5C] MUSIC_CONTROL: Set Combat (Party) music to song 198*
242: 0x076F [0x02] IF !(ExtData[1]->WorkLocal[4] == 2*) GOTO 0x078A
243: 0x0777 [0x5C] MUSIC_CONTROL: Set Idle (Day) music to song 196*
244: 0x077B [0x5C] MUSIC_CONTROL: Set Idle (Night) music to song 196*
245: 0x077F [0x5C] MUSIC_CONTROL: Set Combat (Solo) music to song 196*
246: 0x0783 [0x5C] MUSIC_CONTROL: Set Combat (Party) music to song 196*
247: 0x0787 [0x01] GOTO 0x078A

SUBROUTINE_078A:
248: 0x078A [0x01] GOTO 0x07A5
249: 0x078D [0x02] IF !(ExtData[1]->WorkLocal[21] == 0*) GOTO 0x07A5
250: 0x0795 [0x5C] MUSIC_CONTROL: Set Idle (Day) music to song 198*
251: 0x0799 [0x5C] MUSIC_CONTROL: Set Idle (Night) music to song 198*
252: 0x079D [0x5C] MUSIC_CONTROL: Set Combat (Solo) music to song 198*
253: 0x07A1 [0x5C] MUSIC_CONTROL: Set Combat (Party) music to song 198*

SUBROUTINE_07A5:
254: 0x07A5 [0x02] IF !(ExtData[1]->WorkLocal[2] == 0*) GOTO 0x07B3
255: 0x07AD [0x1A] CALL_SUBROUTINE(address=0x11DC)
...
280: 0x0856 [0x5C] MUSIC_CONTROL: Set Combat (Solo) music to song 198*
281: 0x085A [0x5C] MUSIC_CONTROL: Set Combat (Party) music to song 198*
