...
```
  ...
  2: 0x04DA [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  3: 0x04EB [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 16: 0x0539 [0x45] LOAD_SCHEDULED_TASK(work_offset1=315*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="n006", work_offset2=0*)
 17: 0x054A [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 ...
 27: 0x058E [0x45] LOAD_SCHEDULED_TASK(work_offset1=315*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="n007", work_offset2=0*)
 28: 0x059F [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=Naiko-Paneiko (ID: 17478341/0x010AB2C5), entity2=Naiko-Paneiko (ID: 17478341/0x010AB2C5), action="tlk0")
...
SUBROUTINE_05C1:
 ...
 37: 0x05D1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 38: 0x05E2 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 44: 0x060B [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=EventEntity, entity2=EventEntity, scheduler_id="qstc", work_offset2=0*)
 45: 0x061C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi2", work_offset2=0*)
