...
- **7692**: Wheheheheheheh...
- **7693**: Wheheheh... Cavern's filled with lots of tasty eats for my babies.
- **7694**: Whahahahah! He's a plump one, eh? Had 'is fill bitin' the ankles of all the pretty soldiers now, did he?
- **7695**: The chigoe jumps into Choh Moui's satchel.
- **7696**: Oooh! With these I can make me and my babies some tasty fixins, ya!
- **7697**: Wha-wha? Moui don't know nothing 'bout no pet food. Why this smell like my breakfast?
...
```
  ...
  8: 0x0022 [0x1D] PRINT_EVENT_MESSAGE(message_id=7692*)
    → "Wheheheheheheh..."
 ...
 12: 0x0036 [0x1D] PRINT_EVENT_MESSAGE(message_id=7693*)
    → "Wheheheh... Cavern's filled with lots of tasty eats for my babies."
 ...
 18: 0x0055 [0x1D] PRINT_EVENT_MESSAGE(message_id=7693*)
    → "Wheheheh... Cavern's filled with lots of tasty eats for my babies."
 ...
 23: 0x0069 [0x1D] PRINT_EVENT_MESSAGE(message_id=7694*)
    → "Whahahahah! He's a plump one, eh? Had 'is fill bitin' the ankles of all the pretty soldiers now, did he?"
 24: 0x006C [0x23] WAIT_FOR_DIALOG_INTERACTION
 25: 0x006D [0x48] [System] [7695*]:
 ...
 30: 0x0081 [0x1D] PRINT_EVENT_MESSAGE(message_id=7694*)
    → "Whahahahah! He's a plump one, eh? Had 'is fill bitin' the ankles of all the pretty soldiers now, did he?"
 31: 0x0084 [0x23] WAIT_FOR_DIALOG_INTERACTION
 32: 0x0085 [0x48] [System] [7695*]:
    → "The chigoe jumps into Choh Moui's satchel."
 ...
 37: 0x0099 [0x1D] PRINT_EVENT_MESSAGE(message_id=7694*)
    → "Whahahahah! He's a plump one, eh? Had 'is fill bitin' the ankles of all the pretty soldiers now, did he?"
 38: 0x009C [0x23] WAIT_FOR_DIALOG_INTERACTION
 39: 0x009D [0x48] [System] [7695*]:
    → "The chigoe jumps into Choh Moui's satchel."
...
SUBROUTINE_00A4:
 ...
 43: 0x00A7 [0x1D] PRINT_EVENT_MESSAGE(message_id=7693*)
    → "Wheheheh... Cavern's filled with lots of tasty eats for my babies."
...
SUBROUTINE_00AB:
 ...
 48: 0x00BE [0x1D] PRINT_EVENT_MESSAGE(message_id=7693*)
    → "Wheheheh... Cavern's filled with lots of tasty eats for my babies."
 ...
 53: 0x00D2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7696*)
 ...
 56: 0x00DE [0x1D] PRINT_EVENT_MESSAGE(message_id=7694*)
    → "Whahahahah! He's a plump one, eh? Had 'is fill bitin' the ankles of all the pretty soldiers now, did he?"
 ...
 61: 0x00F2 [0x1D] PRINT_EVENT_MESSAGE(message_id=7696*)
    → "Oooh! With these I can make me and my babies some tasty fixins, ya!"
 62: 0x00F5 [0x23] WAIT_FOR_DIALOG_INTERACTION
 63: 0x00F6 [0x02] IF !(ExtData[1]->WorkLocal[2] == 1*) GOTO 0x0102
 64: 0x00FE [0x1D] PRINT_EVENT_MESSAGE(message_id=7694*)
    → "Whahahahah! He's a plump one, eh? Had 'is fill bitin' the ankles of all the pretty soldiers now, did he?"
 ...
 69: 0x0112 [0x1D] PRINT_EVENT_MESSAGE(message_id=7696*)
    → "Oooh! With these I can make me and my babies some tasty fixins, ya!"
 70: 0x0115 [0x23] WAIT_FOR_DIALOG_INTERACTION
 71: 0x0116 [0x02] IF !(ExtData[1]->WorkLocal[2] == 1*) GOTO 0x0122
 72: 0x011E [0x1D] PRINT_EVENT_MESSAGE(message_id=7694*)
    → "Whahahahah! He's a plump one, eh? Had 'is fill bitin' the ankles of all the pretty soldiers now, did he?"
...
SUBROUTINE_0125:
 ...
 77: 0x0130 [0x1D] PRINT_EVENT_MESSAGE(message_id=7697*)
...
SUBROUTINE_0137:
 ...
 81: 0x013A [0x1D] PRINT_EVENT_MESSAGE(message_id=7693*)
    → "Wheheheh... Cavern's filled with lots of tasty eats for my babies."
 82: 0x013D [0x23] WAIT_FOR_DIALOG_INTERACTION

SUBROUTINE_013E:
 83: 0x013E [0x1D] PRINT_EVENT_MESSAGE(message_id=7692*)
    → "Wheheheheheheh..."
