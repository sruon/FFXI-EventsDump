...
SUBROUTINE_00DE:
 ...
 45: 0x00E6 [0x24] CREATE_DIALOG(message_id=7363*, default_option=0*, option_flags=0x1003)
    → "\u007F1\u0000\u0007"
 ...
 50: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7355*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_0122:
 ...
 58: 0x012A [0x24] CREATE_DIALOG(message_id=7364*, default_option=0*, option_flags=0x1004)
    → "\u007F1\u0000\u0007"
 ...
 63: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=7355*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_0166:
 ...
 71: 0x016E [0x24] CREATE_DIALOG(message_id=7365*, default_option=0*, option_flags=0x1005)
    → "\u007F1\u0000\u0007"
 ...
 76: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=7355*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_01AA:
 ...
 85: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7355*)
    → "Oh...\u0007Well, if that's the case, I'm outta here.\u007F1\u0000\u0007"
...
SUBROUTINE_01C6:
 89: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7354*)
    → "Now, listen close...\u007F1\u0000\u0007"
