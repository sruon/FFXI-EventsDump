...
```
  ...
  3: 0x2497 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
  4: 0x24A8 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 16: 0x24F2 [0xBA] SET_ENTITY_POSITION(entity_id=References[16847234], pos_x=-44.918*, pos_z=571.312*, pos_y=-23.537*, direction=264.7°*)
 17: 0x24FF [0xBA] SET_ENTITY_POSITION(entity_id=References[16847235], pos_x=-45.548*, pos_z=573.520*, pos_y=-23.503*, direction=51.5°*)
 ...
 26: 0x253F [0x5B] LOAD_EXT_SCHEDULER(work_offset=3364*, entity1=Kagero (ID: 16880003/0x01019183), entity2=Kagero (ID: 16880003/0x01019183), action="ninl")
 ...
 32: 0x2561 [0x45] LOAD_SCHEDULED_TASK(work_offset1=766*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s069", work_offset2=0*)
 33: 0x2572 [0x1C] WAIT(15* ticks)
 34: 0x2575 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
 ...
 39: 0x25A4 [0x45] LOAD_SCHEDULED_TASK(work_offset1=766*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s070", work_offset2=0*)
 40: 0x25B5 [0x5B] LOAD_EXT_SCHEDULER(work_offset=425*, entity1=Tenzen (ID: 16880002/0x01019182), entity2=Tenzen (ID: 16880002/0x01019182), action="tlb0")
...
SUBROUTINE_25D7:
 ...
 51: 0x25EF [0x5B] LOAD_EXT_SCHEDULER(work_offset=425*, entity1=Tenzen (ID: 16880002/0x01019182), entity2=Tenzen (ID: 16880002/0x01019182), action="tlb1")
 52: 0x25FE [0x5B] LOAD_EXT_SCHEDULER(work_offset=3364*, entity1=Kagero (ID: 16880003/0x01019183), entity2=Kagero (ID: 16880003/0x01019183), action="nin2")
 ...
 55: 0x261F [0x45] LOAD_SCHEDULED_TASK(work_offset1=766*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s071", work_offset2=0*)
 ...
 61: 0x264F [0x45] LOAD_SCHEDULED_TASK(work_offset1=766*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s072", work_offset2=0*)
 62: 0x2660 [0x5B] LOAD_EXT_SCHEDULER(work_offset=425*, entity1=Tenzen (ID: 16880002/0x01019182), entity2=Tenzen (ID: 16880002/0x01019182), action="thk0")
 ...
 67: 0x267F [0x5B] LOAD_EXT_SCHEDULER(work_offset=425*, entity1=Tenzen (ID: 16880002/0x01019182), entity2=Tenzen (ID: 16880002/0x01019182), action="thk1")
 ...
 70: 0x26A0 [0x45] LOAD_SCHEDULED_TASK(work_offset1=766*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s073", work_offset2=0*)
 ...
 77: 0x26D9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=766*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s074", work_offset2=0*)
 ...
 83: 0x270D [0x45] LOAD_SCHEDULED_TASK(work_offset1=766*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s075", work_offset2=0*)
 ...
 87: 0x2732 [0xD0] LOAD_SCHEDULED_TASK_ALT5(work_offset=123*, entity1=Tenzen (ID: 16880002/0x01019182), entity2=Tenzen (ID: 16880002/0x01019182), action="main", work_offset2=0*)
 88: 0x2743 [0x1C] WAIT(120* ticks)
 89: 0x2746 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 90: 0x2757 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 ...
 96: 0x2780 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi2", work_offset2=0*)
