...
- **7076**: Proceed onward? [Yes./No.]
- **7081**: Proceed to which area? [Riverne - Site #A01./Riverne - Site #B01./Turn back.]
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=7076*, default_option=1*, option_flags=0*)
...
```
  ...
  1: 0x009B [0x24] CREATE_DIALOG(message_id=7081*, default_option=2*, option_flags=0*)
