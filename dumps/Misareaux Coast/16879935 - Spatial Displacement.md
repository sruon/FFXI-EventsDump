...
- **7082**: Proceed to which area? [Riverne - Site #A01./Riverne - Site #B01./Turn back.]
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=7077*, default_option=1*, option_flags=0*)
...
```
  ...
  1: 0x009B [0x24] CREATE_DIALOG(message_id=7082*, default_option=2*, option_flags=0*)
