...
```
  0: 0x006C [0x3B] GET_ENTITY_POSITION(entity=Zeid (ID: 17510708/0x010B3134), x_destination=ExtData[1]->WorkLocal[0], y_destination=ExtData[1]->WorkLocal[1], z_destination=ExtData[1]->WorkLocal[2])
