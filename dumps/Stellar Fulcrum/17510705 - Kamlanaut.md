...
0220: FF 7F 64 6C 31 34 62 0F  80 31 31 0B 01 31 31 0B  ..dl14b..11..11.
...
```
  ...
  1: 0x0226 [0x62] LOAD_EVENT_SCHEDULER: Load scheduler "main" with entities [Kam'lanaut (ID: 17510705/0x010B3131), Kam'lanaut (ID: 17510705/0x010B3131)], work=[56*, 0*]
...
0260: 6C 31 31 0B 01 15 80 0D  80 55 16 80 F0 FF FF 7F  l11......U......
...
```
  ...
  2: 0x0260 [0x6C] FADE_ENTITY_COLOR(entity_id=Kam'lanaut (ID: 17510705/0x010B3131), end_alpha=128*, fade_time=180*)
...
```
  0: 0x0279 [0x6C] FADE_ENTITY_COLOR(entity_id=Kam'lanaut (ID: 17510705/0x010B3131), end_alpha=0*, fade_time=0*)
...
0360: 7F 64 6C 32 31 62 1B 80  31 31 0B 01 31 31 0B 01  .dl21b..11..11..
0370: 6D 61 69 6E 00 80 55 16  80 F0 FF FF 7F F0 FF FF  main..U.........
0380: 7F 78 30 32 31 45 16 80  F0 FF FF 7F F0 FF FF 7F  .x021E..........
0390: 78 30 32 32 00 80 27 03  36 31 0B 01 0E 1C 1C 80  x022..'.61......
03A0: 55 1B 80 31 31 0B 01 31  31 0B 01 6D 61 69 6E 55  U..11..11..mainU
...
```
  ...
  8: 0x0365 [0x62] LOAD_EVENT_SCHEDULER: Load scheduler "main" with entities [Kam'lanaut (ID: 17510705/0x010B3131), Kam'lanaut (ID: 17510705/0x010B3131)], work=[57*, 0*]
 ...
 11: 0x0396 [0x27] REQ_SET(priority=0x03, entity_id=Eald'narche (ID: 17510710/0x010B3136), tag_num=0x0E)
 12: 0x039D [0x1C] WAIT(500* ticks)
 13: 0x03A0 [0x55] WAIT_LOAD_SCHEDULER: Wait for scheduler "main" with entities [Kam'lanaut (ID: 17510705/0x010B3131), Kam'lanaut (ID: 17510705/0x010B3131)], work=57*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
03C0:       6C F8 FF FF 7F 00  80 1E 80 22 00 3B 36 31    l........".;61
...
```
  ...
  2: 0x03CD [0x3B] GET_ENTITY_POSITION(entity=Eald'narche (ID: 17510710/0x010B3136), x_destination=ExtData[1]->WorkLocal[0], y_destination=ExtData[1]->WorkLocal[1], z_destination=ExtData[1]->WorkLocal[2])
