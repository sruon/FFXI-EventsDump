...
- **7712**: Do you want to hear a story? [No, thank you./Let's hear one.]
- **7713**: What story would you like to be told? [On second thought, maybe later./Return to Delkfutt's Tower(pt.1)./Return to Delkfutt's Tower(pt.2)./Return to Delkfutt's Tower(pt.3)./Mercenary Camp(pt.1)./Mercenary Camp(pt.2)./Ode of Life Bestowing(pt.1)./Ode of Life Bestowing(pt.2)./Ode of Life Bestowing(pt.3)./Ode of Life Bestowing(pt.4).]
- **7714**: 
- **7715**: 
- **7716**: 
