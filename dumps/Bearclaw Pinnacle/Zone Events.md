...
- **7603**: You have broken the clear time record for "[Flames for the Dead/Follow the White Rabbit/When Hell Freezes Over/Brothers/Holy Cow/Taurassic Park]"!
- **7604**: The current battlefield clear time record for "[Flames for the Dead/Follow the White Rabbit/When Hell Freezes Over/Brothers/Holy Cow/Taurassic Park]" is $3 second[/s].
- **7605**: The current battlefield clear time record for "[Flames for the Dead/Follow the White Rabbit/When Hell Freezes Over/Brothers/Holy Cow/Taurassic Park]" is $3 minute[/s] $2 second[/s].
- **7607**: Which battlefield will you enter? [None./Flames for the Dead./Follow the White Rabbit./When Hell Freezes Over./Brothers./Holy Cow./Taurassic Park./././././././././././././././././././././././././]
...
SUBROUTINE_0C7D:
 ...
 87: 0x0C96 [0x24] CREATE_DIALOG(message_id=7408*, default_option=1*, option_flags=0*)
    → "Skip the event? [Yes./No.]"
...
```
# Dead code (unreachable instructions):
     0x103A [0x24] CREATE_DIALOG(message_id=7069*, default_option=1*, option_flags=0*)
    → "Enter the battlefield? [Enter./Decline.]"
     ...
     0x1245 [0x1B] RETURN
     0x1246 [0x24] CREATE_DIALOG(message_id=7070*, default_option=1*, option_flags=0*)
