...
- **7755**: What's the torso's size? [Never mind./Rank I./Rank II./Rank III./Rank IV./Rank V.]
- **7756**: What's the visage's obtainment rate? [Never mind./Rank I./Rank II./Rank III./Rank IV./Rank V.]
- **7757**: What rank are the legs' benefits? [Never mind./Rank I./Rank II./Rank III./Rank IV./Rank V.]
- **7758**: Ready for an alluvion skirmish? [No./Alluvion A./Alluvion B./Alluvion C./Alluvion D./Alluvion E./Just a regular skirmish, please.]
...
SUBROUTINE_005A:
 ...
 26: 0x0073 [0x24] CREATE_DIALOG(message_id=7762*, default_option=0*, option_flags=ExtData[1]->WorkLocal[15])
...
SUBROUTINE_01BD:
 ...
 95: 0x01D1 [0x24] CREATE_DIALOG(message_id=7743*, default_option=ExtData[1]->WorkLocal[8], option_flags=0*)
    → "Proceed? [Yes./No.]"
 96: 0x01D8 [0x25] WAIT_DIALOG_SELECT()
 97: 0x01D9 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x01ED
 98: 0x01E1 [0x06] ExtData[1]->WorkLocal[8] = 0
 99: 0x01E4 [0x48] [System] [7750*]:
...
```
  ...
  6: 0x0244 [0x24] CREATE_DIALOG(message_id=7756*, default_option=0*, option_flags=0*)
...
SUBROUTINE_025E:
 ...
 13: 0x0263 [0x24] CREATE_DIALOG(message_id=7755*, default_option=0*, option_flags=0*)
...
SUBROUTINE_027D:
 ...
 26: 0x029E [0x24] CREATE_DIALOG(message_id=7757*, default_option=0*, option_flags=0*)
...
SUBROUTINE_02B8:
 ...
 34: 0x02C0 [0x24] CREATE_DIALOG(message_id=7758*, default_option=0*, option_flags=0*)
