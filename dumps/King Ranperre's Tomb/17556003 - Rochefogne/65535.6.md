...
```
  ...
  3: 0x007E [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "res0" for entities [EventEntity, EventEntity]
  4: 0x008B [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="res0")
