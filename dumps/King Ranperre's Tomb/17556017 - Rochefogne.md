...
| [65535.27](#event-6553527) | 0x018A       |     10 |              2 |
| [65535.28](#event-6553528) | 0x0194       |     14 |              4 |
| [65535.29](#event-6553529) | 0x01A2       |     23 |              5 |
| [65535.30](#event-6553530) | 0x01B9       |     39 |              7 |
| [65535.31](#event-6553531) | 0x01E0       |     17 |              5 |
| [65535.32](#event-6553532) | 0x01F1       |     15 |              3 |
| [65535.33](#event-6553533) | 0x0200       |     27 |              3 |
| [65535.34](#event-6553534) | 0x021B       |     30 |              6 |
| [65535.35](#event-6553535) | 0x0239       |     15 |              3 |
| [4](#event-4)              | 0x0248       |      1 |              1 |
| [65535.36](#event-6553536) | 0x0249       |      5 |              3 |
| [65535.37](#event-6553537) | 0x024E       |      5 |              3 |
| [65535.38](#event-6553538) | 0x0253       |      5 |              3 |
| [65535.39](#event-6553539) | 0x0258       |      5 |              3 |
| [65535.40](#event-6553540) | 0x025D       |      5 |              3 |
| [65535.41](#event-6553541) | 0x0262       |      5 |              3 |
| [65535.42](#event-6553542) | 0x0267       |     17 |              5 |
| [65535.43](#event-6553543) | 0x0278       |      5 |              3 |
| [65535.44](#event-6553544) | 0x027D       |      5 |              3 |
| [65535.45](#event-6553545) | 0x0282       |      5 |              3 |
| [65535.46](#event-6553546) | 0x0287       |      5 |              3 |
| [65535.47](#event-6553547) | 0x028C       |      5 |              3 |
| [65535.48](#event-6553548) | 0x0291       |      5 |              3 |
...
- **7309**: Hm...
- **7310**: King Ranperre... It is I, Rochefogne. Does Your Majesty not remember me?
- **7311**: Often in youth did I hear stories of Your Majesty's glorious reign. I longed to grow into a man like the great Dragon King, Ranperre.
- **7312**: Try though I did, I have failed. I have lost everything, even the most sacred of possessions.
- **7313**: I...
- **7314**: Your Majesty, please tell me. Whence has the sword disappeared? Did you dismiss it?
- **7315**: Hmm...
- **7316**: Who is there!?
- **7317**: Who are you!? What are you doing there?
- **7318**: Just an adventurer, are you? In search of tomb-robbers?
- **7319**: Well...
- **7320**: Wait, we have met before! You decided to serve San d'Oria, and now you are in search of tomb-robbers?
- **7321**: Yes, of late many of the cairns are missing.
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0190:             32 07 80 1F  00 08 80 09 80 0A 80 1F      2...........
01A0: 01 00                                             ..              
```
...
```
  ...
  1: 0x0197 [0x1F] MOVE_ENTITY: EventEntity moves to X=-4.175*, Z=-74.725*, Y=0.072*
...
```
  0: 0x0249 [0x1D] PRINT_EVENT_MESSAGE(message_id=7309*)
    → "Hm..."
...
```
  0: 0x024E [0x1D] PRINT_EVENT_MESSAGE(message_id=7310*)
...
```
  0: 0x0253 [0x1D] PRINT_EVENT_MESSAGE(message_id=7311*)
...
```
  0: 0x0258 [0x1D] PRINT_EVENT_MESSAGE(message_id=7312*)
...
```
  0: 0x025D [0x1D] PRINT_EVENT_MESSAGE(message_id=7313*)
    → "I..."
...
```
  0: 0x0262 [0x1D] PRINT_EVENT_MESSAGE(message_id=7314*)
...
```
  ...
  1: 0x026D [0x1D] PRINT_EVENT_MESSAGE(message_id=7315*)
    → "Hmm..."
...
```
  0: 0x0278 [0x1D] PRINT_EVENT_MESSAGE(message_id=7316*)
    → "Who is there!?"
...
```
  0: 0x027D [0x1D] PRINT_EVENT_MESSAGE(message_id=7317*)
...
```
  0: 0x0282 [0x1D] PRINT_EVENT_MESSAGE(message_id=7318*)
...
```
  0: 0x0287 [0x1D] PRINT_EVENT_MESSAGE(message_id=7319*)
    → "Well..."
...
```
  0: 0x028C [0x1D] PRINT_EVENT_MESSAGE(message_id=7320*)
...
```
  0: 0x0291 [0x1D] PRINT_EVENT_MESSAGE(message_id=7321*)
