...
```
  ...
  4: 0x000F [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
  5: 0x0020 [0x45] LOAD_SCHEDULED_TASK(work_offset1=47*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s000", work_offset2=0*)
  6: 0x0031 [0x1C] WAIT(210* ticks)
  7: 0x0034 [0x27] REQ_SET(priority=0x0A, entity_id=Naji (ID: 17379796/0x010931D4), tag_num=0x02)
  8: 0x003B [0x55] WAIT_LOAD_SCHEDULER(work_offset=47*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s000")
 ...
 16: 0x006D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=19*, entity1=Ayame (ID: 17379797/0x010931D5), entity2=Ayame (ID: 17379797/0x010931D5), action="tlk0")
 ...
 42: 0x010F [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 43: 0x0120 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1")
 44: 0x012F [0x46] CAMERA_CONTROL: Restore default settings
 45: 0x0131 [0x1C] WAIT(30* ticks)
 46: 0x0134 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
