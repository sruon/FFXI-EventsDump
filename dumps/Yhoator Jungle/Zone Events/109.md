...
```
  ...
  3: 0x0073 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo0", work_offset2=0*)
  4: 0x0084 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo0")
 ...
 17: 0x00DE [0x45] LOAD_SCHEDULED_TASK(work_offset1=5*, entity1=EventEntity, entity2=EventEntity, scheduler_id="s104", work_offset2=0*)
 18: 0x00EF [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi1", work_offset2=0*)
...
\u0005 \u007F\u0012\u0005[second/seconds] Earth time) still stands strong!\u007F1\u0000\u0007"
 ...
 37: 0x0162 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 38: 0x0173 [0x55] WAIT_LOAD_SCHEDULER(work_offset=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1")
 39: 0x0182 [0x46] CAMERA_CONTROL: Restore default settings
 40: 0x0184 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="qstc", work_offset2=0*)
 41: 0x0195 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdi2", work_offset2=0*)
