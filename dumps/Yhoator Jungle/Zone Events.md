...
- **7748**: You dig up a strange wooden casket!
...
```
 ...
 13: 0x0052 [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Casket (ID: 17285687/0x0107C237), tag_num=0x03)
 14: 0x0059 [0x1C] WAIT(200* ticks)
 15: 0x005C [0x29] REQ_SET_WAIT(priority=0x01, entity_id=Casket (ID: 17285687/0x0107C237), tag_num=0x04)
...
0090: 64 6F 30 4E 00 42 C2 07  01 4E 00 43 C2 07 01 38  do0N.B...N.C...8
00A0: 09 80 79 00 F0 FF FF 7F  42 C2 07 01 03 05 10 02  ..y.....B.......
00B0: 10 03 06 10 02 10 03 07  10 02 10 15 05 10 0A 80  ................
00C0: 15 06 10 03 80 3F 07 10  07 10 03 80 37 0B 80 0C  .....?......7...
00D0: 80 0D 80 0E 80 4A 42 C2  07 01 F0 FF FF 7F 45 0F  .....JB.......E.
00E0: 80 F8 FF FF 7F F8 FF FF  7F 73 31 30 34 02 80 45  .........s104..E
00F0: 07 80 F8 FF FF 7F F8 FF  FF 7F 66 64 69 31 02 80  ..........fdi1..
0100: 2B 42 C2 07 01 10 80 23  2B 42 C2 07 01 11 80 23  +B.....#+B.....#
...
0140: 2B 42 C2 07 01 12 80 23  01 53 01 2B 42 C2 07 01  +B.....#.S.+B...
...
01A0: 66 64 69 32 02 80 21 00  4A 42 C2 07 01 F0 FF FF  fdi2..!.JB......
01B0: 7F 45 07 80 F8 FF FF 7F  F8 FF FF 7F 66 64 69 31  .E..........fdi1
01C0: 02 80 2B 42 C2 07 01 10  80 23 66 04 80 42 C2 07  ..+B.....#f..B..
01D0: 01 42 C2 07 01 74 6C 6B  30 2B 42 C2 07 01 11 80  .B...tlk0+B.....
01E0: 23 02 04 10 02 80 01 33  02 66 04 80 42 C2 07 01  #......3.f..B...
01F0: 42 C2 07 01 74 6C 6B 31  03 05 10 04 10 03 06 10  B...tlk1........
0200: 04 10 03 07 10 04 10 15  05 10 0A 80 15 06 10 03  ................
0210: 80 3F 07 10 07 10 03 80  02 00 00 02 80 00 2B 02  .?............+.
0220: 2B 42 C2 07 01 12 80 23  01 33 02 2B 42 C2 07 01  +B.....#.3.+B...
0230: 13 80 23 66 04 80 42 C2  07 01 42 C2 07 01 70 61  ..#f..B...B...pa
0240: 73 30 2B 42 C2 07 01 14  80 23 45 07 80 F8 FF FF  s0+B.....#E.....
...
```
  ...
  5: 0x0093 [0x4E] SET_ENTITY_HIDE_FLAG: Show Kiteh Nanjyea (ID: 17285698/0x0107C242)
  6: 0x0099 [0x4E] SET_ENTITY_HIDE_FLAG: Show Unnamed NPC (ID: 17285699/0x0107C243)
  7: 0x009F [0x38] SET_CLIENT_EVENT_MODE(mode=19*)
  8: 0x00A2 [0x79] LocalPlayer looks at Kiteh Nanjyea (ID: 17285698/0x0107C242) (Basic look)
 ...
 31: 0x0140 [0x2B] Kiteh Nanjyea (ID: 17285698/0x0107C242) [7802*]:
 ...
 34: 0x014B [0x2B] Kiteh Nanjyea (ID: 17285698/0x0107C242) [7805*]:
...
# Dead code (unreachable instructions):
     ...
     0x01C2 [0x2B] Kiteh Nanjyea (ID: 17285698/0x0107C242) [7800*]:
    → "You've helped our poor girl find her way home! I don't know how to thank you!"
     ...
     0x01D9 [0x2B] Kiteh Nanjyea (ID: 17285698/0x0107C242) [7801*]:
    → "And to think you made it here in a mere $3 [hour/hours] ($4 [minute/minutes] and $5 [second/seconds] Earth time)!"
     0x01E0 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x01E1 [0x02] IF !(Work_Zone[4] == 0*) GOTO 0x0233
     0x01E9 [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk1" with entities [Kiteh Nanjyea (ID: 17285698/0x0107C242), Kiteh Nanjyea (ID: 17285698/0x0107C242)], work=30*
     ...
     0x0220 [0x2B] Kiteh Nanjyea (ID: 17285698/0x0107C242) [7802*]:
    → "Oh, and by the way, the fastest adventurer to date has been %0. That talented rider traversed the same course as you in $3 [hour/hours] ($4 [minute/minutes] and $5 [second/seconds] Earth time)!"
     0x0227 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0228 [0x01] GOTO 0x0233
     0x022B [0x2B] Kiteh Nanjyea (ID: 17285698/0x0107C242) [7805*]:
    → "Oh, and by the way, the fastest adventurer to date has been...you! Your remarkable record of $3 [hour/hours] ($4 [minute/minutes] and $5 [second/seconds] Earth time) still stands strong!"
     ...
     0x0242 [0x2B] Kiteh Nanjyea (ID: 17285698/0x0107C242) [7803*]:
