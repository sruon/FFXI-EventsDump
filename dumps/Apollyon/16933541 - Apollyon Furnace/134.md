...
SUBROUTINE_00F4:
 13: 0x00F4 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "ids2" for entities [EventEntity, EventEntity]
 14: 0x0101 [0x1C] WAIT(60* ticks)
 15: 0x0104 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "ids3" for entities [EventEntity, EventEntity]
 16: 0x0111 [0x1C] WAIT(60* ticks)
 17: 0x0114 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "ids4" for entities [EventEntity, EventEntity]
 18: 0x0121 [0x1C] WAIT(60* ticks)
 19: 0x0124 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "sp21" for entities [EventEntity, EventEntity]
 20: 0x0131 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="sp21")
...
SUBROUTINE_0168:
 31: 0x0168 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "ids2" for entities [EventEntity, EventEntity]
 32: 0x0175 [0x1C] WAIT(60* ticks)
 33: 0x0178 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "ids3" for entities [EventEntity, EventEntity]
 34: 0x0185 [0x1C] WAIT(60* ticks)
 35: 0x0188 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "ids4" for entities [EventEntity, EventEntity]
 36: 0x0195 [0x1C] WAIT(60* ticks)
 37: 0x0198 [0x2C] CREATE_SCHEDULER_TASK: Create scheduler "sp21" for entities [EventEntity, EventEntity]
 38: 0x01A5 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="sp21")
