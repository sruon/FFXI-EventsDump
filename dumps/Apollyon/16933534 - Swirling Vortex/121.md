...
0140: 47 00 1A 80 1B 80 00 80  16 80 47 01 01 66 01 02  G.........G..f..
0150: 01 10 09 80 80 66 01 47  00 1C 80 1D 80 00 80 19  .....f.G........
0160: 80 47 01 01 66 01 29 01  F0 FF FF 7F 03 20 00 21  .G..f.)...... .!
0170: 00 9F 1E 80 F0 FF FF 7F  F0 FF FF 7F 6D 61 69 6E  ............main
0180: 00 80 03 02 00 01 10 03  01 10 0F 80 43 00 43 01  ............C.C.
0190: 03 01 10 02 00 1C 1F 80  45 20 80 F0 FF FF 7F F0  ........E ......
01A0: FF FF 7F 66 64 6F 31 00  80 1C 21 80 46 01 1B 45  ...fdo1...!.F..E
01B0: 20 80 F0 FF FF 7F F0 FF  FF 7F 66 64 69 31 00 80   .........fdi1..
01C0: 9F 22 80 F0 FF FF 7F F0  FF FF 7F 6D 61 69 6E 00  .".........main.
01D0: 80 1C 23 80 46 00 1B                              ..#.F..         
```
...
SUBROUTINE_010A:
 52: 0x010A [0x02] IF !(Work_Zone[1] == 41*) GOTO 0x0121
 53: 0x0112 [0x47] UPDATE_PLAYER_POS(468.000*, -625.000*, 0.000*, yaw=225.0°*)
 54: 0x011C [0x47] WAIT_PLAYER_POS_UPDATE
 55: 0x011E [0x01] GOTO 0x0166

SUBROUTINE_0121:
 56: 0x0121 [0x02] IF !(Work_Zone[1] == 42*) GOTO 0x0138
 57: 0x0129 [0x47] UPDATE_PLAYER_POS(576.000*, -428.000*, 0.000*, yaw=315.0°*)
 58: 0x0133 [0x47] WAIT_PLAYER_POS_UPDATE
 59: 0x0135 [0x01] GOTO 0x0166

SUBROUTINE_0138:
 60: 0x0138 [0x02] IF !(Work_Zone[1] == 43*) GOTO 0x014F
 61: 0x0140 [0x47] UPDATE_PLAYER_POS(428.000*, -385.000*, 0.000*, yaw=225.0°*)
 62: 0x014A [0x47] WAIT_PLAYER_POS_UPDATE
 63: 0x014C [0x01] GOTO 0x0166

SUBROUTINE_014F:
 64: 0x014F [0x02] IF !(Work_Zone[1] == 44*) GOTO 0x0166
 65: 0x0157 [0x47] UPDATE_PLAYER_POS(176.000*, -628.000*, 0.000*, yaw=315.0°*)
...
```
# Data Section: 0x0171 (102 bytes)
     0x0171: 9F 1E 80 F0 FF FF 7F F0 FF FF 7F 6D 61 69 6E 00
     0x0181: 80 03 02 00 01 10 03 01 10 0F 80 43 00 43 01 03
     0x0191: 01 10 02 00 1C 1F 80 45 20 80 F0 FF FF 7F F0 FF
     0x01A1: FF 7F 66 64 6F 31 00 80 1C 21 80 46 01 1B 45 20
     0x01B1: 80 F0 FF FF 7F F0 FF FF 7F 66 64 69 31 00 80 9F
     0x01C1: 22 80 F0 FF FF 7F F0 FF FF 7F 6D 61 69 6E 00 80
     0x01D1: 1C 23 80 46 00 1B
```