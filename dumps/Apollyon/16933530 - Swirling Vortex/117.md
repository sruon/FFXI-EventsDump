...
SUBROUTINE_0103:
 51: 0x0103 [0x02] IF !(Work_Zone[1] == 31*) GOTO 0x011A
...
SUBROUTINE_011A:
 55: 0x011A [0x02] IF !(Work_Zone[1] == 32*) GOTO 0x0131
 56: 0x0122 [0x47] UPDATE_PLAYER_POS(534.000*, 171.000*, 0.000*, yaw=315.0°*)
 57: 0x012C [0x47] WAIT_PLAYER_POS_UPDATE
 58: 0x012E [0x01] GOTO 0x0176

SUBROUTINE_0131:
 59: 0x0131 [0x02] IF !(Work_Zone[1] == 33*) GOTO 0x0148
 60: 0x0139 [0x47] UPDATE_PLAYER_POS(294.000*, 171.000*, 0.000*, yaw=315.0°*)
 61: 0x0143 [0x47] WAIT_PLAYER_POS_UPDATE
 62: 0x0145 [0x01] GOTO 0x0176

SUBROUTINE_0148:
 63: 0x0148 [0x02] IF !(Work_Zone[1] == 34*) GOTO 0x015F
 64: 0x0150 [0x47] UPDATE_PLAYER_POS(628.000*, 497.000*, 0.000*, yaw=225.0°*)
 65: 0x015A [0x47] WAIT_PLAYER_POS_UPDATE
 66: 0x015C [0x01] GOTO 0x0176

SUBROUTINE_015F:
 67: 0x015F [0x02] IF !(Work_Zone[1] == 35*) GOTO 0x0176
 68: 0x0167 [0x47] UPDATE_PLAYER_POS(388.000*, 498.000*, 0.000*, yaw=225.0°*)
...
```
# Data Section: 0x0181 (102 bytes)
     0x0181: 9F 20 80 F0 FF FF 7F F0 FF FF 7F 6D 61 69 6E 00
     0x0191: 80 03 02 00 01 10 03 01 10 0F 80 43 00 43 01 03
     0x01A1: 01 10 02 00 1C 21 80 45 22 80 F0 FF FF 7F F0 FF
     0x01B1: FF 7F 66 64 6F 31 00 80 1C 23 80 46 01 1B 45 22
     0x01C1: 80 F0 FF FF 7F F0 FF FF 7F 66 64 69 31 00 80 9F
     0x01D1: 24 80 F0 FF FF 7F F0 FF FF 7F 6D 61 69 6E 00 80
     0x01E1: 1C 25 80 46 00 1B
```