...
- **7695**: Oh my Gob! You're one of those adventurerurers, aren't ya? You got nothin' on me, [man./lady.] I was just mindin' my own businesesess, lookin' for junk an' stuff.
- **7696**: Hey, watch out. You don't wanna fight me. I'll turn you into meat jerky! Wait, how about you and me be friends instead? Sound good?
- **7697**: I travel all over the world and hear lots of differererent stories. I even hear your stories. I can tell you one, if you want.
- **7698**: Now, listen close...
- **7699**: Oh... Well, if that's the case, I'm outta here.
- **7705**: Would you like to hear a story? [No, thank you./Let's hear one.]
- **7706**: What story would you like to be told? [None, thank you./(1)./(2)./(3)./(4)./(5)./11(1)/11(2)/11(3)]
- **7707**: 
- **7708**: 
- **7709**: 
...
```
 ...
 15: 0x005A [0x1D] PRINT_EVENT_MESSAGE(message_id=7695*)
 ...
 17: 0x005E [0x1D] PRINT_EVENT_MESSAGE(message_id=7696*)
 ...
 19: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=7697*)
...
SUBROUTINE_00A2:
 32: 0x00A2 [0x24] CREATE_DIALOG(message_id=7706*, default_option=0*, option_flags=Work_Zone[2])
    → "What story would you like to be told? [None, thank you./(1)./(2)./(3)./(4)./(5)./11(1)/11(2)/11(3)]"
 ...
 37: 0x00C8 [0x1D] PRINT_EVENT_MESSAGE(message_id=7699*)
...
SUBROUTINE_00E6:
 ...
 48: 0x010C [0x1D] PRINT_EVENT_MESSAGE(message_id=7699*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_012A:
 ...
 59: 0x0150 [0x1D] PRINT_EVENT_MESSAGE(message_id=7699*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_016E:
 ...
 70: 0x0194 [0x1D] PRINT_EVENT_MESSAGE(message_id=7699*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01A7:
 ...
 77: 0x01C0 [0x1D] PRINT_EVENT_MESSAGE(message_id=7699*)
    → "Oh... Well, if that's the case, I'm outta here."
...
SUBROUTINE_01C6:
 81: 0x01C6 [0x1D] PRINT_EVENT_MESSAGE(message_id=7698*)
    → "Now, listen close..."
