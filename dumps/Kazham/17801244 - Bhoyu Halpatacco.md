...
- **9991**: This counter is for departurrres only. The arrivals counter is on the otherrr side.
- **9992**: The prrrice for an airship ride to Jeuno is $1 gil.
- **9993**: Board the airship? [Yes./Not yet.]
...
```
  ...
  4: 0x0045 [0x1D] PRINT_EVENT_MESSAGE(message_id=9992*)
  ...
  7: 0x0050 [0x24] CREATE_DIALOG(message_id=9993*, default_option=1*, option_flags=0*)
