...
```
  ...
  4: 0x0028 [0x1D] PRINT_EVENT_MESSAGE(message_id=9986*)
    → "A while back, therrre was talk about sending a party to the Temple of Uggalepih to fight the Tonberries. That place is theirrr stronghold, you know.\u007F1\u0000\u0007"
  5: 0x002B [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x002C [0x1D] PRINT_EVENT_MESSAGE(message_id=9987*)
    → "However, the chieftainness wouldn't let them use herrr temple key, and that was the end of that.\u007F1\u0000\u0007"
