...
```
  ...
  4: 0x0028 [0x1D] PRINT_EVENT_MESSAGE(message_id=9980*)
    → "So what is all this talk about anotherrr Great Warrr over in the continents?\u007F1\u0000\u0007"
  5: 0x002B [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x002C [0x1D] PRINT_EVENT_MESSAGE(message_id=9981*)
    → "You just watch. When the flames of battle start raging, it will be the Mithra who save everyone's tails.\u007F1\u0000\u0007"
