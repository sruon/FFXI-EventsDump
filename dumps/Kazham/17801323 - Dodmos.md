...
- **10496**: Try though you may, there will come a time when failure is inevitable.
- **10497**: Channel that agony and bitterness into creating a new plan.
- **10514**: If you don't prepare yourself for battle, you'll get beaten to a pulp, like we did!
- **10515**: As soon as we gather our companions, we'll be jumping into the fray again. I just hope this little researcher doesn't get in our way...
- **10567**: Hmmm... Hrmmm... So it's time to use...no...
- **10568**: Hello? You're an adventurer, right? Maybe you can help us out.
- **10569**: Let me introduce myself and my companion. We're from the Rhinostery in Windurst.
- **10570**: I was hired by the ministry to accompany this researcher to [Ifrit's Cauldron/the Quicksand Caves/the Den of Rancor/Cape Teriggan/Fei'Yin/the Boyahda Tree] and assist him in his study of a series of giant crystals.
- **10571**: But what was waiting for us inside those crystals was more than I could deal with...
- **10572**: We tried countless times, but I could not defeat that beast. Another researcher at the Rhinostery sympathized with our plight and developed an improved tuning fork.
- **10575**: Do you see what I have to deal with? I don't know how much longer I can work with such a pessimist.
- **10576**: That's where you come in. I was thinking of letting one of you adventurers test out the new fork and prove to my colleague that it is able to return data valuable to his research.
- **10580**: ... Yes, but sir... The Rhinostery has been pressing us to produce results. If we do not take some sort of action quickly...
- **10582**: No, one round could not hurt.
- **10584**: Are you really-dilly sure? [Fork me!/On second thought...]
- **10587**: The researcher who made the $1 warned that "the door home would only open to those who defeated the prime avatar."
- **10588**: I'm not quite sure what that is supposed to mean, but I suggest that you prepare well before taking on this journey. Remember, you have to be at least a level $3 summoner.
- **10589**: Are you and Carbuncle ready to fight the prime avatar as a level $3 summoner?
- **10590**: Also, regardless of whether you defeat the avatar or not, you will be unable to re-enter the protocrystal again for a number of days.
- **10591**: Are you sure you are ready? [Off to [Ifrit's Cauldron/the Quicksand Caves/the Den of Rancor/Cape Teriggan/Fei'Yin/the Boyahda Tree]!/My dog ate my mini tuning fork./Not just yet...]
- **10592**: Sir, our adventurer has completed [his/her] preparations and requests a warp.
- **10595**: Don't use that excuse on me, [young man/young lady]. If you want another $1, all you have to do ask.
- **10596**: If you do not bring the $1 we gave you, my companion cannot warp you to [Ifrit's Cauldron/the Quicksand Caves/the Den of Rancor/Cape Teriggan/Fei'Yin/the Boyahda Tree].
- **10597**: Did you remember to bring the $1?
- **10598**: What!? You defeated the prime avatar!?
- **10599**: Sir!
- **10601**: ... Sir...
- **10602**: ... (Now if I could only find me some real work so I could do some real adventuring...)
- **10604**: Remember that you must fight the prime avatar as a level $3 summoner. As you already know, this will not be an easy task. Prepare well for the battle.
- **10605**: Do you want another mini tuning fork? [Fork me baby, one more time./Stick a fork in me, I'm done.]
- **10614**: Ah, you are back. How was your battle with the avatar?
- **10615**: Remember, the protocrystals will only resonate with the tuning forks ever so often. Use this time to rest before taking upon another challenge.
...
```
  ...
  3: 0x0026 [0x1D] PRINT_EVENT_MESSAGE(message_id=10514*)
  ...
  5: 0x002A [0x1D] PRINT_EVENT_MESSAGE(message_id=10515*)
 ...
 11: 0x0044 [0x2B] Ronta-Onta (ID: 17801322/0x010FA06A) [10516*]:
...
```
  0: 0x0161 [0x1D] PRINT_EVENT_MESSAGE(message_id=10567*)
  ...
  3: 0x016E [0x1D] PRINT_EVENT_MESSAGE(message_id=10568*)
  ...
  7: 0x0185 [0x1D] PRINT_EVENT_MESSAGE(message_id=10569*)
 ...
 12: 0x019F [0x1D] PRINT_EVENT_MESSAGE(message_id=10570*)
 ...
 14: 0x01A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10571*)
 ...
 18: 0x01AD [0x1D] PRINT_EVENT_MESSAGE(message_id=10572*)
 ...
 30: 0x01F0 [0x1D] PRINT_EVENT_MESSAGE(message_id=10575*)
 ...
 34: 0x0204 [0x1D] PRINT_EVENT_MESSAGE(message_id=10576*)
 ...
 44: 0x0230 [0x1D] PRINT_EVENT_MESSAGE(message_id=10580*)
 ...
 54: 0x0261 [0x1D] PRINT_EVENT_MESSAGE(message_id=10582*)
 ...
 62: 0x028A [0x2B] Ronta-Onta (ID: 17801322/0x010FA06A) [10583*]:
 ...
 66: 0x02A3 [0x24] CREATE_DIALOG(message_id=10584*, default_option=0*, option_flags=0*)
 ...
 78: 0x02EC [0x1D] PRINT_EVENT_MESSAGE(message_id=10587*)
 ...
 80: 0x02F0 [0x1D] PRINT_EVENT_MESSAGE(message_id=10588*)
...
```
  ...
  8: 0x0323 [0x24] CREATE_DIALOG(message_id=10591*, default_option=0*, option_flags=Work_Zone[6])
 ...
 18: 0x0354 [0x1D] PRINT_EVENT_MESSAGE(message_id=10592*)
 ...
 24: 0x036A [0x2B] Ronta-Onta (ID: 17801322/0x010FA06A) [10593*]:
 ...
 28: 0x0380 [0x2B] Ronta-Onta (ID: 17801322/0x010FA06A) [10594*]:
    → "Sha-mone!"
...
```
  ...
  6: 0x03DB [0x1D] PRINT_EVENT_MESSAGE(message_id=10596*)
 ...
 11: 0x03E3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10589*)
    → "Are you and Carbuncle ready to fight the prime avatar as a level $3 summoner?"
 12: 0x03E6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 13: 0x03E7 [0x1D] PRINT_EVENT_MESSAGE(message_id=10590*)
    → "Also, regardless of whether you defeat the avatar or not, you will be unable to re-enter the protocrystal again for a number of days."
 14: 0x03EA [0x23] WAIT_FOR_DIALOG_INTERACTION
 15: 0x03EB [0x24] CREATE_DIALOG(message_id=10591*, default_option=0*, option_flags=Work_Zone[6])
    → "Are you sure you are ready? [Off to [Ifrit's Cauldron/the Quicksand Caves/the Den of Rancor/Cape Teriggan/Fei'Yin/the Boyahda Tree]!/My dog ate my mini tuning fork./Not just yet...]"
 ...
 20: 0x0401 [0x1D] PRINT_EVENT_MESSAGE(message_id=10597*)
 ...
 26: 0x0416 [0x1D] PRINT_EVENT_MESSAGE(message_id=10595*)
...
```
  ...
  3: 0x0438 [0x1D] PRINT_EVENT_MESSAGE(message_id=10589*)
    → "Are you and Carbuncle ready to fight the prime avatar as a level $3 summoner?"
...
```
  ...
  3: 0x0447 [0x1D] PRINT_EVENT_MESSAGE(message_id=10614*)
    → "Ah, you are back. How was your battle with the avatar?"
  4: 0x044A [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x044B [0x1D] PRINT_EVENT_MESSAGE(message_id=10615*)
...
```
  ...
  4: 0x0464 [0x1D] PRINT_EVENT_MESSAGE(message_id=10598*)
  ...
  8: 0x0476 [0x1D] PRINT_EVENT_MESSAGE(message_id=10599*)
    → "Sir!"
 ...
 13: 0x0483 [0x1D] PRINT_EVENT_MESSAGE(message_id=10601*)
    → "... Sir..."
 14: 0x0486 [0x23] WAIT_FOR_DIALOG_INTERACTION
 15: 0x0487 [0x1D] PRINT_EVENT_MESSAGE(message_id=10602*)
...
```
  ...
  9: 0x04C7 [0x1D] PRINT_EVENT_MESSAGE(message_id=10604*)
 ...
 12: 0x04D3 [0x24] CREATE_DIALOG(message_id=10605*, default_option=0*, option_flags=0*)
