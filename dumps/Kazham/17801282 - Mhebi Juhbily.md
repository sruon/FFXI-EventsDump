...
| [125](#event-125)          | 0x017A       |     33 |             12 |
| [126](#event-126)          | 0x019B       |     47 |             14 |
| [127](#event-127)          | 0x01CA       |    124 |             31 |
| [318](#event-318)          | 0x0246       |     20 |              6 |
| [65535.22](#event-6553522) | 0x025A       |     10 |              2 |
| [65535.23](#event-6553523) | 0x0264       |     14 |              4 |
| [128](#event-128)          | 0x0272       |      1 |              1 |
| [65535.24](#event-6553524) | 0x0273       |     26 |              8 |
| [65535.25](#event-6553525) | 0x028D       |     19 |              5 |
| [65535.26](#event-6553526) | 0x02A0       |     19 |              5 |
| [65535.27](#event-6553527) | 0x02B3       |     19 |              5 |
| [65535.28](#event-6553528) | 0x02C6       |     19 |              5 |
| [65535.29](#event-6553529) | 0x02D9       |      5 |              3 |
| [129](#event-129)          | 0x02DE       |     54 |             15 |
| [133](#event-133)          | 0x0314       |    511 |             68 |
| [65535.30](#event-6553530) | 0x0513       |      5 |              3 |
| [65535.31](#event-6553531) | 0x0518       |      5 |              3 |
| [134](#event-134)          | 0x051D       |     29 |             10 |
| [135](#event-135)          | 0x053A       |     47 |             14 |
...
- **10182**: ...
- **10183**: You still herrre? Why don't you just get out of my face and let me sulk in peace!?
- **10184**: Quit it!
- **10185**: You shouldn't be snooping around in other people's prrroperty!
- **10186**: No way...
- **10187**: $1! I love these things! Look at how the scales shine!
- **10188**: Give her the $1? [Forthwith./Nope.]
- **10189**: Forrr me? Oh, this is absolutely lovely!
- **10190**: Why, this is purrrfect!
- **10191**: Damn! You've found him!
- **10193**: My buddy's name is Tonberri<Player>qo. Sounds sophisticated, huh? I gave it to him myself.
- **10195**: But because his knife got wet, it rusted, and now he can't use it for hunting his food.
- **10196**: I've been trying to help by bringing him meat and letting him sleep herrre, but...
- **10197**: Well, now that you've seen him, you're in this with me.
- **10200**: Thanks. What I want to do is get this guy's knife back in chip-chop shape so I can take him back to the jungle.
- **10207**: I want to take Tonberri<Player>qo back to the jungle, but we have to do something about his knife.
- **10208**: You don't happen to have any good ideas, do you?
- **10217**: Whoa! Where did you get that knife?
- **10218**: Tonberri<Player>qo begins to steam with happiness...(?)
- **10219**: He likes it! Hey, <Player>! Tonberri<Player>qo likes it!
- **10220**: I had my doubts about you, but you rrreally came through for me and my buddy.
- **10221**: Now it's my turn to take Tonberri<Player>qo back to the jungle where he belongs. I'll miss the little green guy, though.
- **10222**: I had my doubts about you, but you rrreally came through for me and my buddy. Now I just have to take Tonberri<Player>qo back to the jungle where he belongs.
- **10223**: If you want to see Tonberri<Player>qo, he's still living in that shed.
- **10224**: He won't move an inch! Do you think that maybe he likes it better herrre in the village?
...
```
  0: 0x017A [0x1D] PRINT_EVENT_MESSAGE(message_id=10182*)
    → "..."
  ...
  6: 0x018C [0x1D] PRINT_EVENT_MESSAGE(message_id=10183*)
...
```
  ...
  4: 0x01A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10184*)
    → "Quit it!"
  ...
  8: 0x01BB [0x1D] PRINT_EVENT_MESSAGE(message_id=10185*)
...
```
  ...
  5: 0x01D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10186*)
    → "No way..."
  ...
  9: 0x01EB [0x1D] PRINT_EVENT_MESSAGE(message_id=10187*)
 ...
 12: 0x01F6 [0x24] CREATE_DIALOG(message_id=10188*, default_option=0*, option_flags=0*)
 ...
 16: 0x020D [0x1D] PRINT_EVENT_MESSAGE(message_id=10189*)
 ...
 20: 0x021F [0x1D] PRINT_EVENT_MESSAGE(message_id=10190*)
...
```
  ...
  1: 0x024D [0x1D] PRINT_EVENT_MESSAGE(message_id=10190*)
    → "Why, this is purrrfect!"
...
```
  ...
  4: 0x0281 [0x1D] PRINT_EVENT_MESSAGE(message_id=10191*)
...
```
  ...
  1: 0x0294 [0x1D] PRINT_EVENT_MESSAGE(message_id=10193*)
...
```
  ...
  1: 0x02A7 [0x1D] PRINT_EVENT_MESSAGE(message_id=10195*)
...
```
  ...
  1: 0x02BA [0x1D] PRINT_EVENT_MESSAGE(message_id=10196*)
...
```
  ...
  1: 0x02CD [0x1D] PRINT_EVENT_MESSAGE(message_id=10197*)
...
```
  0: 0x02D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10200*)
...
```
  ...
  5: 0x02F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10207*)
  ...
  9: 0x0305 [0x1D] PRINT_EVENT_MESSAGE(message_id=10208*)
...
SUBROUTINE_042A:
 ...
 43: 0x044A [0x1D] PRINT_EVENT_MESSAGE(message_id=10220*)
...
SUBROUTINE_0498:
 ...
 55: 0x04BA [0x1D] PRINT_EVENT_MESSAGE(message_id=10221*)
...
```
  0: 0x0513 [0x1D] PRINT_EVENT_MESSAGE(message_id=10217*)
...
```
  0: 0x0518 [0x1D] PRINT_EVENT_MESSAGE(message_id=10219*)
...
```
  ...
  4: 0x052B [0x1D] PRINT_EVENT_MESSAGE(message_id=10222*)
...
```
  ...
  4: 0x0548 [0x1D] PRINT_EVENT_MESSAGE(message_id=10223*)
  ...
  8: 0x055A [0x1D] PRINT_EVENT_MESSAGE(message_id=10224*)
