...
- **10183**: ...
- **10184**: You still herrre? Why don't you just get out of my face and let me sulk in peace!?
- **10185**: Quit it!
- **10186**: You shouldn't be snooping around in other people's prrroperty!
- **10187**: No way...
- **10188**: $1! I love these things! Look at how the scales shine!
- **10189**: Give her the $1? [Forthwith./Nope.]
- **10190**: Forrr me? Oh, this is absolutely lovely!
- **10191**: Why, this is purrrfect!
- **10192**: Damn! You've found him!
- **10194**: My buddy's name is Tonberri<Player>qo. Sounds sophisticated, huh? I gave it to him myself.
- **10196**: But because his knife got wet, it rusted, and now he can't use it for hunting his food.
- **10197**: I've been trying to help by bringing him meat and letting him sleep herrre, but...
- **10198**: Well, now that you've seen him, you're in this with me.
- **10201**: Thanks. What I want to do is get this guy's knife back in chip-chop shape so I can take him back to the jungle.
- **10208**: I want to take Tonberri<Player>qo back to the jungle, but we have to do something about his knife.
- **10209**: You don't happen to have any good ideas, do you?
- **10218**: Whoa! Where did you get that knife?
- **10219**: Tonberri<Player>qo begins to steam with happiness...(?)
- **10220**: He likes it! Hey, <Player>! Tonberri<Player>qo likes it!
- **10221**: I had my doubts about you, but you rrreally came through for me and my buddy.
- **10222**: Now it's my turn to take Tonberri<Player>qo back to the jungle where he belongs. I'll miss the little green guy, though.
- **10223**: I had my doubts about you, but you rrreally came through for me and my buddy. Now I just have to take Tonberri<Player>qo back to the jungle where he belongs.
- **10224**: If you want to see Tonberri<Player>qo, he's still living in that shed.
- **10225**: He won't move an inch! Do you think that maybe he likes it better herrre in the village?
...
```
  0: 0x017A [0x1D] PRINT_EVENT_MESSAGE(message_id=10183*)
    → "..."
  ...
  6: 0x018C [0x1D] PRINT_EVENT_MESSAGE(message_id=10184*)
...
```
  ...
  4: 0x01A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10185*)
    → "Quit it!"
  ...
  8: 0x01BB [0x1D] PRINT_EVENT_MESSAGE(message_id=10186*)
...
```
  ...
  5: 0x01D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10187*)
    → "No way..."
  ...
  9: 0x01EB [0x1D] PRINT_EVENT_MESSAGE(message_id=10188*)
 ...
 12: 0x01F6 [0x24] CREATE_DIALOG(message_id=10189*, default_option=0*, option_flags=0*)
 ...
 16: 0x020D [0x1D] PRINT_EVENT_MESSAGE(message_id=10190*)
 ...
 20: 0x021F [0x1D] PRINT_EVENT_MESSAGE(message_id=10191*)
...
```
  ...
  1: 0x024D [0x1D] PRINT_EVENT_MESSAGE(message_id=10191*)
    → "Why, this is purrrfect!"
...
```
  ...
  4: 0x0281 [0x1D] PRINT_EVENT_MESSAGE(message_id=10192*)
...
```
  ...
  1: 0x0294 [0x1D] PRINT_EVENT_MESSAGE(message_id=10194*)
...
```
  ...
  1: 0x02A7 [0x1D] PRINT_EVENT_MESSAGE(message_id=10196*)
...
```
  ...
  1: 0x02BA [0x1D] PRINT_EVENT_MESSAGE(message_id=10197*)
...
```
  ...
  1: 0x02CD [0x1D] PRINT_EVENT_MESSAGE(message_id=10198*)
...
```
  0: 0x02D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10201*)
...
```
  ...
  5: 0x02F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10208*)
  ...
  9: 0x0305 [0x1D] PRINT_EVENT_MESSAGE(message_id=10209*)
...
SUBROUTINE_042A:
 ...
 43: 0x044A [0x1D] PRINT_EVENT_MESSAGE(message_id=10221*)
...
SUBROUTINE_0498:
 ...
 55: 0x04BA [0x1D] PRINT_EVENT_MESSAGE(message_id=10222*)
...
```
  0: 0x0513 [0x1D] PRINT_EVENT_MESSAGE(message_id=10218*)
...
```
  0: 0x0518 [0x1D] PRINT_EVENT_MESSAGE(message_id=10220*)
...
```
  ...
  4: 0x052B [0x1D] PRINT_EVENT_MESSAGE(message_id=10223*)
...
```
  ...
  4: 0x0548 [0x1D] PRINT_EVENT_MESSAGE(message_id=10224*)
  ...
  8: 0x055A [0x1D] PRINT_EVENT_MESSAGE(message_id=10225*)
