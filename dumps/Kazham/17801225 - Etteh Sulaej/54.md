...
```
  ...
  4: 0x1355 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 ...
 23: 0x13BB [0x45] LOAD_SCHEDULED_TASK(work_offset1=150*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s106", work_offset2=0*)
 24: 0x13CC [0x01] GOTO 0x13FC

SUBROUTINE_13CF:
 25: 0x13CF [0x02] IF !(Work_Zone[9] == 6*) GOTO 0x13EB
 26: 0x13D7 [0x45] LOAD_SCHEDULED_TASK(work_offset1=150*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s106", work_offset2=0*)
 27: 0x13E8 [0x01] GOTO 0x13FC

SUBROUTINE_13EB:
 28: 0x13EB [0x45] LOAD_SCHEDULED_TASK(work_offset1=150*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s000", work_offset2=0*)
 29: 0x13FC [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
...
SUBROUTINE_1469:
 ...
 46: 0x1478 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
 47: 0x1489 [0x02] IF !(Work_Zone[9] == 3*) GOTO 0x14A5
 48: 0x1491 [0x45] LOAD_SCHEDULED_TASK(work_offset1=150*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s107", work_offset2=0*)
 49: 0x14A2 [0x01] GOTO 0x150A

SUBROUTINE_14A5:
 50: 0x14A5 [0x02] IF !(Work_Zone[9] == 5*) GOTO 0x14C1
 51: 0x14AD [0x45] LOAD_SCHEDULED_TASK(work_offset1=150*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s108", work_offset2=0*)
 52: 0x14BE [0x01] GOTO 0x150A

SUBROUTINE_14C1:
 53: 0x14C1 [0x02] IF !(Work_Zone[9] == 6*) GOTO 0x14DD
 54: 0x14C9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=150*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s108", work_offset2=0*)
 55: 0x14DA [0x01] GOTO 0x150A

SUBROUTINE_14DD:
 56: 0x14DD [0x02] IF !(Work_Zone[9] == 8*) GOTO 0x14F9
 57: 0x14E5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=150*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s107", work_offset2=0*)
 58: 0x14F6 [0x01] GOTO 0x150A

SUBROUTINE_14F9:
 59: 0x14F9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=150*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="s101", work_offset2=0*)
...
SUBROUTINE_1544:
 70: 0x1544 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
...
SUBROUTINE_1603:
 ...
 93: 0x1614 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
