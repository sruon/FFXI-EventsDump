...
```
  ...
  4: 0x0028 [0x1D] PRINT_EVENT_MESSAGE(message_id=9988*)
    → "You won't find me heading to any new lands or bowing to any new chieftainness.\u007F1\u0000\u0007"
  5: 0x002B [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x002C [0x1D] PRINT_EVENT_MESSAGE(message_id=9989*)
    → "What good is a chieftainness that won't fight? Mithra should only follow a leader who won't back down frrrom a fight.\u007F1\u0000\u0007"
