...
- **10681**: Excuse me, [sir/madam]. If you are boarding the airship, might I ask you a favor?
- **10682**: A passenger who intended to board the next flight dropped this...
- **10683**: I cannot leave my post, so I was wondering if you could return it to its rightful owner in my stead?
- **10684**: Return the dropped item? [Gladly./Sorry, I'm a busy [man/woman].]
- **10685**: Thank you! The passenger who dropped the item looked like this.
- **10686**: Have you memorized the image?
- **10687**: Have you got it? [I got it./Not yet.]
- **10688**: The passenger who dropped the item should be on the next flight.
- **10689**: I leave the rest in your capable hands.
- **10690**: I see... I'm sorry to have bothered you with such a trivial request.
- **10691**: Oh, the airship has already left... I guess we'll just have to leave this with the airship authorities.
- **10692**: You were unable to meet with the rightful owner of the item? Well, thank you for your help, in any case. I will hand the item over to the airship authorities.
- **10693**: What, you've forgotten already?
- **10694**: Have you forgotten? [Yes./No.]
- **10695**: The passenger looked like this.
- **10696**: It's my job to look out for suspicious characters coming in on the airships.
...
```
  ...
  6: 0x001C [0x1D] PRINT_EVENT_MESSAGE(message_id=10692*)
 ...
 10: 0x002B [0x1D] PRINT_EVENT_MESSAGE(message_id=10693*)
    → "What, you've forgotten already?"
 11: 0x002E [0x23] WAIT_FOR_DIALOG_INTERACTION
 12: 0x002F [0x24] CREATE_DIALOG(message_id=10694*, default_option=1*, option_flags=0*)
    → "Have you forgotten? [Yes./No.]"
 13: 0x0036 [0x25] WAIT_DIALOG_SELECT()
 14: 0x0037 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x004A
 15: 0x003F [0x1D] PRINT_EVENT_MESSAGE(message_id=10695*)
...
SUBROUTINE_0052:
 ...
 26: 0x005D [0x1D] PRINT_EVENT_MESSAGE(message_id=10696*)
 ...
 35: 0x0070 [0x24] CREATE_DIALOG(message_id=10684*, default_option=0*, option_flags=0*)
 ...
 39: 0x0081 [0x1D] PRINT_EVENT_MESSAGE(message_id=10685*)
 ...
 44: 0x0093 [0x1D] PRINT_EVENT_MESSAGE(message_id=10690*)
...
SUBROUTINE_021C:
 ...
 92: 0x021D [0x1D] PRINT_EVENT_MESSAGE(message_id=10686*)
    → "Have you memorized the image?"
 93: 0x0220 [0x23] WAIT_FOR_DIALOG_INTERACTION
 94: 0x0221 [0x24] CREATE_DIALOG(message_id=10687*, default_option=1*, option_flags=0*)
...
109: 0x025E [0x1D] PRINT_EVENT_MESSAGE(message_id=10691*)
...
112: 0x0265 [0x1D] PRINT_EVENT_MESSAGE(message_id=10688*)
    → "The passenger who dropped the item should be on the next flight."
113: 0x0268 [0x23] WAIT_FOR_DIALOG_INTERACTION
114: 0x0269 [0x1D] PRINT_EVENT_MESSAGE(message_id=10689*)
    → "I leave the rest in your capable hands."
...
119: 0x0279 [0x1D] PRINT_EVENT_MESSAGE(message_id=10691*)
    → "Oh, the airship has already left... I guess we'll just have to leave this with the airship authorities."
