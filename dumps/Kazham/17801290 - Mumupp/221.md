...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0050:                                               42                 B
0060: 1E F0 FF FF 7F 6F 70 29  08 4A A0 0F 01 01 1D 06  .....op).J......
0070: 80 23 29 08 4A A0 0F 01  02 20 00 21 00           .#).J.... .!.   
```
...
```
  ...
  4: 0x0067 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Mumupp (ID: 17801290/0x010FA04A), tag_num=0x01)
  ...
  7: 0x0072 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Mumupp (ID: 17801290/0x010FA04A), tag_num=0x02)
