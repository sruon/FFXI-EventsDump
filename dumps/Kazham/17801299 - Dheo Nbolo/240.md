...
```
  ...
  4: 0x0166 [0x1D] PRINT_EVENT_MESSAGE(message_id=10440*)
    → "There are ten Opo-opos living in this village.\u007F1\u0000\u0007"
  5: 0x0169 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x016A [0x1D] PRINT_EVENT_MESSAGE(message_id=10441*)
    → "Vuih Stecoppah brrrought all them to Kazham when they were still babies. That's why they are so friendly around people.\u007F1\u0000\u0007"
