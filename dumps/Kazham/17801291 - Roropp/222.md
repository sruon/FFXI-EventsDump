...
```
      ...
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0050:                                               42                 B
0060: 1E F0 FF FF 7F 6F 70 29  08 4B A0 0F 01 01 1D 06  .....op).K......
0070: 80 23 29 08 4B A0 0F 01  02 20 00 21 00           .#).K.... .!.   
```
...
```
  ...
  4: 0x0067 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Roropp (ID: 17801291/0x010FA04B), tag_num=0x01)
  ...
  7: 0x0072 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Roropp (ID: 17801291/0x010FA04B), tag_num=0x02)
