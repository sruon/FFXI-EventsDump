...
- **10007**: Hey! Don't take one more step. You're not going anywhere until you get checked by Dakha Topsalwan.
- **10008**: You can't come in here! This is the airship arrivals gate.
- **10009**: If you are ready to depart Kazham, pay the boarding fee at the counter on the other side.
...
```
  ...
  3: 0x0008 [0x1D] PRINT_EVENT_MESSAGE(message_id=10007*)
...
```
  ...
  3: 0x0017 [0x1D] PRINT_EVENT_MESSAGE(message_id=10008*)
    → "You can't come in here! This is the airship arrivals gate."
  4: 0x001A [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=10009*)
