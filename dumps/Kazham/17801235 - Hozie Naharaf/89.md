...
```
  ...
  4: 0x0028 [0x1D] PRINT_EVENT_MESSAGE(message_id=10024*)
    → "We Mithra are bound to this land. We listen to its cries, protect it, and rrrespect it.\u007F1\u0000\u0007"
  5: 0x002B [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x002C [0x1D] PRINT_EVENT_MESSAGE(message_id=10025*)
    → "When a group changes where it lives, the lives of that group change with it, but the ties with the land do not.\u007F1\u0000\u0007"
