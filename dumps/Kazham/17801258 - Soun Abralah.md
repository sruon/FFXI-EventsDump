...
- **10071**: When we Mithra establish a new settlement, we call forth the powerrr of the guardian of that land, and craft a special bow.
- **10072**: That bow is kept by the chieftainness as a symbol of the bond between us and the land we have chosen. The Thalassa Bow that Jakoh Wahcondalo carries is Kazham's bond with Elshimo.
- **10075**: Wait a minute. You wouldn't happen to be one of those adventurerrrs from the mainlands, would you?
- **10076**: I heard that if the prrrice was right, your type would go anywhere, do anything. So, [Mister/Miss] Adventurerrr, are your serrrvices for hire?
- **10077**: Listen to her offer? [Yes./No.]
- **10078**: I guess my eyes deceived me. I was sure you were an adventurerrr.
- **10079**: Wonderful. My eyes didn't deceive me. Now, have you ever heard of $3? This rare wood does not even burn when thrown into the inferrrno of Ifrit's Cauldron.
- **10080**: Deep in the hearrrt of the Yuhtunga Jungle, there is a giant tree known by the natives as the Firebloom Tree. It is protected day and night by mighty flames, though it never burns.
- **10081**: The wood taken from the most heavily protected arrrea of the Firebloom Tree is called $3.
- **10082**: To find out which arrrea of the trrree is the most heavily protected, you must first retrieve four vines from its four sides. Then you must take those four vines to a place in Ifrit's Cauldron where firrre spits up from the rrrocks.
- **10083**: Throw the four vines into the flames. The one that remains unburned is from the most heavily protected side of the Firebloom Tree. Finally, return to the jungle, cut off $6, and bring it back here to me.
- **10084**: Travel to the hearrrt of the Yuhtunga Jungle and cut four vines from the Firebloom Tree.
- **10085**: Take those four vines to Ifrit's Cauldron and throw them into the walls of fire that rise from the rocks.
- **10086**: When you have learned the most heavily protected side of the Firebloom Tree, return to it and cut off $6. Bring that wood back here to me.
- **10087**: Look at it! Isn't it beautiful?
- **10088**: Only a bow made from this wood can stand the blazing heat of "Purgatory Arrows."
- **10089**: By the way, have your trrravels ever taken you to Windurst?
- **10090**: The chieftainness of that trrribe, Perih Vashai, carries with her a weapon known as the Azure Bow.
- **10091**: There are many a song that tell of her ability to wield Purgatory Arrows. However, I have heard that her skills have faded since the Great War.
- **10092**: Wait, [sir/ma'am]. Would you have the time to retrieve another piece of $3?
- **10093**: If you're busy...
- **10374**: Leave my worrrkshop. I cannot concentrate with that stench in my house.
...
```
  ...
  4: 0x010F [0x1D] PRINT_EVENT_MESSAGE(message_id=10071*)
  ...
  6: 0x0113 [0x1D] PRINT_EVENT_MESSAGE(message_id=10072*)
...
```
  0: 0x0122 [0x1D] PRINT_EVENT_MESSAGE(message_id=10374*)
...
```
  ...
  4: 0x0138 [0x24] CREATE_DIALOG(message_id=10077*, default_option=0*, option_flags=0*)
...
```
  ...
  1: 0x0188 [0x1D] PRINT_EVENT_MESSAGE(message_id=10075*)
  ...
  5: 0x019A [0x1D] PRINT_EVENT_MESSAGE(message_id=10076*)
...
```
  ...
  2: 0x01B2 [0x1D] PRINT_EVENT_MESSAGE(message_id=10078*)
...
```
  ...
  1: 0x01BE [0x1D] PRINT_EVENT_MESSAGE(message_id=10079*)
  ...
  3: 0x01C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=10080*)
...
```
  0: 0x01CE [0x1D] PRINT_EVENT_MESSAGE(message_id=10081*)
...
```
  0: 0x01D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10082*)
  ...
  4: 0x01E3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10083*)
...
```
  ...
  4: 0x01F6 [0x1D] PRINT_EVENT_MESSAGE(message_id=10084*)
  ...
  6: 0x01FA [0x1D] PRINT_EVENT_MESSAGE(message_id=10085*)
  ...
  8: 0x01FE [0x1D] PRINT_EVENT_MESSAGE(message_id=10086*)
...
```
  ...
  2: 0x023D [0x1D] PRINT_EVENT_MESSAGE(message_id=10087*)
    → "Look at it! Isn't it beautiful?"
  3: 0x0240 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0241 [0x1D] PRINT_EVENT_MESSAGE(message_id=10088*)
...
```
  ...
  4: 0x0254 [0x1D] PRINT_EVENT_MESSAGE(message_id=10089*)
    → "By the way, have your trrravels ever taken you to Windurst?"
  5: 0x0257 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0258 [0x1D] PRINT_EVENT_MESSAGE(message_id=10090*)
 ...
 10: 0x026A [0x1D] PRINT_EVENT_MESSAGE(message_id=10091*)
...
```
  ...
  4: 0x0287 [0x24] CREATE_DIALOG(message_id=10077*, default_option=0*, option_flags=0*)
    → "Listen to her offer? [Yes./No.]"
  ...
  9: 0x029D [0x1D] PRINT_EVENT_MESSAGE(message_id=10080*)
    → "Deep in the hearrrt of the Yuhtunga Jungle, there is a giant tree known by the natives as the Firebloom Tree. It is protected day and night by mighty flames, though it never burns."
 ...
 16: 0x02BF [0x1D] PRINT_EVENT_MESSAGE(message_id=10093*)
    → "If you're busy..."
...
```
  ...
  1: 0x02D1 [0x1D] PRINT_EVENT_MESSAGE(message_id=10092*)
