...
- **9972**: Move along. Move along. I don't care if you are an adventurerrr. We don't give special trrreatment to anyone.
- **10337**: Get out of here! We don't want to make the chieftainness any more uptight than she alrrready is!
...
```
  ...
  3: 0x0021 [0x1D] PRINT_EVENT_MESSAGE(message_id=9972*)
...
```
  ...
  3: 0x0030 [0x1D] PRINT_EVENT_MESSAGE(message_id=10337*)
