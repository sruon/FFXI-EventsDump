...
- **10077**: Ah, I love how my blades shine when wielded in the moonlight.
- **10078**: And not just shine...my daggerrrs cut so well that even the chieftainness asked me forrr one...no, two!
- **10209**: You say you want a Tonberry knife?
- **10210**: Hah-hah! I get it! You want to be a chef, and hearrrd that Tonberry knives are the best in Vana'diel, rrright?
- **10211**: But there's no way even the finest chef could use one of those. They're way too dangerrrous!
- **10212**: But if you still want one anyway, you're going to have to go to the Temple of Uggalepih. They say that there's a kitchen there where an evil chef spends his days and nights sharrrpening his knives.
- **10213**: If you still want a Tonberry knife, you're going to have to go to the Temple of Uggalepih.
- **10214**: You'll find plenty of knives in the kitchen, but keep a "sharrrp" lookout for the chef! Nya-ha-ha!
- **10215**: Wow, you rrreally got one! You're the only person I know who would want to get within twenty feet of one of those.
- **10216**: Hey, you're not going to trrry using that thing, are you?
- **10379**: Ah, I love how my blades shine when wielded in the moonlight.
- **10380**: But if you do not get your rrreeking tail out of my sight, I won't wait until the moon's out to show you how sharp they are.
...
```
  ...
  4: 0x014E [0x1D] PRINT_EVENT_MESSAGE(message_id=10077*)
    → "Ah, I love how my blades shine when wielded in the moonlight."
  5: 0x0151 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0152 [0x1D] PRINT_EVENT_MESSAGE(message_id=10078*)
...
```
  ...
  4: 0x016F [0x1D] PRINT_EVENT_MESSAGE(message_id=10379*)
    → "Ah, I love how my blades shine when wielded in the moonlight."
  5: 0x0172 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0173 [0x1D] PRINT_EVENT_MESSAGE(message_id=10380*)
...
```
  ...
  1: 0x01A2 [0x1D] PRINT_EVENT_MESSAGE(message_id=10209*)
  ...
  5: 0x01B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=10210*)
...
```
  ...
  1: 0x01C7 [0x1D] PRINT_EVENT_MESSAGE(message_id=10211*)
  ...
  5: 0x01D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=10212*)
...
```
  ...
  4: 0x01F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10213*)
  ...
  8: 0x0205 [0x1D] PRINT_EVENT_MESSAGE(message_id=10214*)
...
```
  ...
  4: 0x0222 [0x1D] PRINT_EVENT_MESSAGE(message_id=10215*)
  ...
  8: 0x0234 [0x1D] PRINT_EVENT_MESSAGE(message_id=10216*)
