...
- **10620**: If you wish to ride a chocobo, you must possess $6 and have a high enough job level.
- **10621**: You can rent a chocobo for $0 gil. I see you currently have $1 gil.
- **10624**: Do you wish to rent a chocobo? [Yes, I do./No, thank you.]
- **10625**: You don't have enough gil.
- **10626**: I realize that you are in a hurry, [sir/ma'am]. However, might I make a simple request? One of our associate's chocobos has lost her way and cannot return home.
- **10627**: Would you be so kind as to deliver her to [the Kingdom/the Republic/the Federation/the Duchy/the Duchy/the Duchy/the hidden] stables in [Southern San d'Oria/the Bastok Mines/Windurst Woods/Upper Jeuno/Lower Jeuno/Port Jeuno/Norg]?
- **10628**: Lend a helping hand? [I have better things to do./Of course!]
- **10629**: Oh, thank you so very much! You shall be rewarded by our associates upon delivery of the chocobo.
- **10631**: Would you be so kind as to deliver her to [the entrance to the Gustav Tunnel (B-8)/Bibiki Bay (G-10)/the entrance of Uggalepih Temple (J-11)]?
...
```
  ...
  2: 0x000A [0x1D] PRINT_EVENT_MESSAGE(message_id=10631*)
 ...
 10: 0x002A [0x1D] PRINT_EVENT_MESSAGE(message_id=10626*)
 ...
 12: 0x002E [0x1D] PRINT_EVENT_MESSAGE(message_id=10627*)
 ...
 14: 0x0032 [0x24] CREATE_DIALOG(message_id=10628*, default_option=0*, option_flags=0*)
...
SUBROUTINE_0066:
 ...
 31: 0x00A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=10621*)
    → "You can rent a chocobo for $0 gil. I see you currently have $1 gil."
 32: 0x00A8 [0x23] WAIT_FOR_DIALOG_INTERACTION
 33: 0x00A9 [0x24] CREATE_DIALOG(message_id=10624*, default_option=1*, option_flags=0*)
 ...
 42: 0x00EF [0x1D] PRINT_EVENT_MESSAGE(message_id=10625*)
...
```
  ...
  2: 0x010E [0x1D] PRINT_EVENT_MESSAGE(message_id=10620*)
