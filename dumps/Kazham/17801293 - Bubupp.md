...
| [202](#event-202)        | 0x001F       |     15 |              8 |
| [212](#event-212)        | 0x002E       |     49 |             16 |
| [224](#event-224)        | 0x005F       |     30 |             11 |
| [234](#event-234)        | 0x007D       |     24 |             13 |
| [247](#event-247)        | 0x0095       |     29 |             10 |
...
```
  ...
  8: 0x0049 [0x1D] PRINT_EVENT_MESSAGE(message_id=10403*)
    → "Popo-o popo-o!"
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0090:                1E F0 FF  FF 7F 6F 70 29 08 4D A0       .....op).M.
00A0: 0F 01 01 1D 0A 80 23 29  08 4D A0 0F 01 02 20 00  ......#).M.... .
00B0: 21 00                                             !.              
```
...
```
  ...
  3: 0x009C [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Bubupp (ID: 17801293/0x010FA04D), tag_num=0x01)
  4: 0x00A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=10454*)
    → "Opo-opo! Ohppo-opo!"
  5: 0x00A6 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x00A7 [0x29] REQ_SET_WAIT(priority=0x08, entity_id=Bubupp (ID: 17801293/0x010FA04D), tag_num=0x02)
...
```
  ...
  1: 0x00B4 [0x37] UPDATE_EVENT_POSITION_AND_DIR: x=39.941*, z=-176.809*, y=-11.000*, direction=72.5°*
