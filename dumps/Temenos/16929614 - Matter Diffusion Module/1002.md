...
0170: 80 1F 80 19 80 47 01 01  A8 01 02 01 10 0C 80 80  .....G..........
0180: 91 01 47 00 20 80 17 80  1B 80 19 80 47 01 01 A8  ..G. .......G...
0190: 01 02 01 10 0E 80 80 A8  01 47 00 21 80 17 80 1F  .........G.!....
01A0: 80 19 80 47 01 01 A8 01  29 01 F0 FF FF 7F 03 20  ...G....)...... 
01B0: 00 21 00 9F 22 80 F0 FF  FF 7F F0 FF FF 7F 6D 61  .!..".........ma
01C0: 69 6E 00 80 1C 12 80 03  02 00 01 10 03 01 10 12  in..............
01D0: 80 43 00 43 01 03 01 10  02 00 1C 23 80 45 24 80  .C.C.......#.E$.
01E0: F0 FF FF 7F F0 FF FF 7F  66 64 6F 31 00 80 1C 25  ........fdo1...%
01F0: 80 1B 45 24 80 F0 FF FF  7F F0 FF FF 7F 66 64 69  ..E$.........fdi
0200: 31 00 80 9F 26 80 F0 FF  FF 7F F0 FF FF 7F 6D 61  1...&.........ma
0210: 69 6E 00 80 1C 27 80 1B                           in...'..        
```
...
```
  ...
  5: 0x0017 [0x24] CREATE_DIALOG(message_id=7233*, default_option=0x0000, option_flags=0x01)
...
SUBROUTINE_00AF:
 ...
 52: 0x0107 [0x02] IF !(Work_Zone[1] == 11*) GOTO 0x011E
 53: 0x010F [0x47] UPDATE_PLAYER_POS(380.000*, 376.000*, 71.620*, yaw=270.0°*)
 54: 0x0119 [0x47] WAIT_PLAYER_POS_UPDATE
 55: 0x011B [0x01] GOTO 0x01A8
 56: 0x011E [0x02] IF !(Work_Zone[1] == 12*) GOTO 0x0135
 57: 0x0126 [0x47] UPDATE_PLAYER_POS(180.000*, 376.000*, -82.380*, yaw=270.0°*)
 58: 0x0130 [0x47] WAIT_PLAYER_POS_UPDATE
 59: 0x0132 [0x01] GOTO 0x01A8
 60: 0x0135 [0x02] IF !(Work_Zone[1] == 13*) GOTO 0x014C
 61: 0x013D [0x47] UPDATE_PLAYER_POS(60.000*, 376.000*, 71.620*, yaw=270.0°*)
 62: 0x0147 [0x47] WAIT_PLAYER_POS_UPDATE
 63: 0x0149 [0x01] GOTO 0x01A8
 64: 0x014C [0x02] IF !(Work_Zone[1] == 14*) GOTO 0x0163
 65: 0x0154 [0x47] UPDATE_PLAYER_POS(-140.000*, 376.000*, -82.380*, yaw=270.0°*)
 66: 0x015E [0x47] WAIT_PLAYER_POS_UPDATE
 67: 0x0160 [0x01] GOTO 0x01A8
 68: 0x0163 [0x02] IF !(Work_Zone[1] == 15*) GOTO 0x017A
 69: 0x016B [0x47] UPDATE_PLAYER_POS(-260.000*, 376.000*, 77.620*, yaw=270.0°*)
 70: 0x0175 [0x47] WAIT_PLAYER_POS_UPDATE
 71: 0x0177 [0x01] GOTO 0x01A8
 72: 0x017A [0x02] IF !(Work_Zone[1] == 16*) GOTO 0x0191
 73: 0x0182 [0x47] UPDATE_PLAYER_POS(-460.000*, 376.000*, -82.380*, yaw=270.0°*)
 74: 0x018C [0x47] WAIT_PLAYER_POS_UPDATE
 75: 0x018E [0x01] GOTO 0x01A8
 76: 0x0191 [0x02] IF !(Work_Zone[1] == 17*) GOTO 0x01A8
 77: 0x0199 [0x47] UPDATE_PLAYER_POS(-580.000*, 376.000*, 77.620*, yaw=270.0°*)
...
# Dead code (unreachable instructions):
     0x01B3 [0x9F] LOAD_SCHEDULED_TASK_ALT: Load scheduler "main" with entities [LocalPlayer, LocalPlayer], work=[75*, 0*]
     0x01C4 [0x1C] WAIT(100* ticks)
     0x01C7 [0x03] ExtData[1]->WorkLocal[2] = Work_Zone[1]
     0x01CC [0x03] Work_Zone[1] = 100*
     0x01D1 [0x43] SEND_EVENT_UPDATE: Send pending tag to server (packet 0x005B)
     0x01D3 [0x43] SEND_EVENT_UPDATE: Check pending flag (skip if not pending)
     0x01D5 [0x03] Work_Zone[1] = ExtData[1]->WorkLocal[2]
     0x01DA [0x1C] WAIT(40* ticks)
     0x01DD [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
     0x01EE [0x1C] WAIT(60* ticks)
     0x01F1 [0x1B] RETURN
     0x01F2 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi1" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
     0x0203 [0x9F] LOAD_SCHEDULED_TASK_ALT: Load scheduler "main" with entities [LocalPlayer, LocalPlayer], work=[76*, 0*]
     0x0214 [0x1C] WAIT(170* ticks)
     0x0217 [0x1B] RETURN
```