# 16929575 - Matter Diffusion Module
...
```
  ...
  4: 0x0012 [0x24] CREATE_DIALOG(message_id=7235*, default_option=ExtData[1]->WorkLocal[2], option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_008F:
 ...
 33: 0x00AD [0x24] CREATE_DIALOG(message_id=7236*, default_option=0*, option_flags=ExtData[1]->WorkLocal[1])
