# 16929642 - Matter Diffusion Module
...
```
  ...
  7: 0x001F [0x24] CREATE_DIALOG(message_id=7234*, default_option=ExtData[1]->WorkLocal[0], option_flags=ExtData[1]->WorkLocal[1])
