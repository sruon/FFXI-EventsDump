# 16929658 - Matter Diffusion Module
...
- **7238**: Return to the entrance? [Sure./No thanks.]
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=7238*, default_option=0*, option_flags=0*)
    → "Return to the entrance? [Sure./No thanks.]"
