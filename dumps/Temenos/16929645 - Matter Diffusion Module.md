# 16929645 - Matter Diffusion Module
...
```
  ...
  7: 0x001F [0x24] CREATE_DIALOG(message_id=7236*, default_option=ExtData[1]->WorkLocal[0], option_flags=ExtData[1]->WorkLocal[1])
...
SUBROUTINE_00B7:
 ...
 54: 0x010F [0x02] IF !(Work_Zone[1] == 31*) GOTO 0x0126
 55: 0x0117 [0x47] UPDATE_PLAYER_POS(380.000*, -184.000*, 71.620*, yaw=270.0°*)
 56: 0x0121 [0x47] WAIT_PLAYER_POS_UPDATE
 57: 0x0123 [0x01] GOTO 0x01B0
 58: 0x0126 [0x02] IF !(Work_Zone[1] == 32*) GOTO 0x013D
 59: 0x012E [0x47] UPDATE_PLAYER_POS(180.000*, -184.000*, -82.380*, yaw=270.0°*)
 60: 0x0138 [0x47] WAIT_PLAYER_POS_UPDATE
 61: 0x013A [0x01] GOTO 0x01B0
 62: 0x013D [0x02] IF !(Work_Zone[1] == 33*) GOTO 0x0154
 63: 0x0145 [0x47] UPDATE_PLAYER_POS(60.000*, -184.000*, 71.620*, yaw=270.0°*)
 64: 0x014F [0x47] WAIT_PLAYER_POS_UPDATE
 65: 0x0151 [0x01] GOTO 0x01B0
 66: 0x0154 [0x02] IF !(Work_Zone[1] == 34*) GOTO 0x016B
 67: 0x015C [0x47] UPDATE_PLAYER_POS(-140.000*, -184.000*, -82.380*, yaw=270.0°*)
 68: 0x0166 [0x47] WAIT_PLAYER_POS_UPDATE
 69: 0x0168 [0x01] GOTO 0x01B0
 70: 0x016B [0x02] IF !(Work_Zone[1] == 35*) GOTO 0x0182
 71: 0x0173 [0x47] UPDATE_PLAYER_POS(-260.000*, -184.000*, 77.620*, yaw=270.0°*)
 72: 0x017D [0x47] WAIT_PLAYER_POS_UPDATE
 73: 0x017F [0x01] GOTO 0x01B0
 74: 0x0182 [0x02] IF !(Work_Zone[1] == 36*) GOTO 0x0199
 75: 0x018A [0x47] UPDATE_PLAYER_POS(-460.000*, -184.000*, -82.380*, yaw=270.0°*)
 76: 0x0194 [0x47] WAIT_PLAYER_POS_UPDATE
 77: 0x0196 [0x01] GOTO 0x01B0
 78: 0x0199 [0x02] IF !(Work_Zone[1] == 37*) GOTO 0x01B0
 79: 0x01A1 [0x47] UPDATE_PLAYER_POS(-580.000*, -184.000*, 77.620*, yaw=270.0°*)
