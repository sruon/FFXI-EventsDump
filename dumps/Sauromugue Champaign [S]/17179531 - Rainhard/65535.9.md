...
```
  0: 0x0078 [0x5B] LOAD_EXT_SCHEDULER(work_offset=863*, entity1=EventEntity, entity2=EventEntity, action="ast1")
  1: 0x0087 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="ast1")
  ...
  6: 0x00A2 [0x4B] UPDATE_ENTITY_YAW(entity=EventEntity, yaw=5.62°*)
