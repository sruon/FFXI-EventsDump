...
```
 ...
 29: 0x0092 [0x24] CREATE_DIALOG(message_id=7747*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
    → "Do you want to hear a story? [No, thank you./Pleasant Memories 1./Pleasant Memories 2.]"
...
SUBROUTINE_00E6:
 43: 0x00E6 [0x24] CREATE_DIALOG(message_id=7749*, default_option=0*, option_flags=Work_Zone[3])
    → "What story would you like to be told? [On second thought, maybe later./Ganged Up On(pt.1)./Ganged Up On(pt.2)./Ganged Up On(pt.3)./Sacrifice(pt.1)./Sacrifice(pt.2).]"
