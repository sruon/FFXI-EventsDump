...
```
  ...
  6: 0x008A [0x5B] LOAD_EXT_SCHEDULER(work_offset=1443*, entity1=Lehko Habhoka (ID: 17179391/0x010622FF), entity2=Lehko Habhoka (ID: 17179391/0x010622FF), action="tla0")
  7: 0x0099 [0x1C] WAIT(200* ticks)
  8: 0x009C [0x5B] LOAD_EXT_SCHEDULER(work_offset=1443*, entity1=Lehko Habhoka (ID: 17179391/0x010622FF), entity2=Lehko Habhoka (ID: 17179391/0x010622FF), action="tla1")
