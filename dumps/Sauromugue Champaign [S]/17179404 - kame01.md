...
```
  ...
  1: 0x004A [0x1F] MOVE_ENTITY: EventEntity moves to X=203.695*, Z=-163.952*, Y=7.957*
...
```
  ...
  1: 0x0059 [0x1F] MOVE_ENTITY: EventEntity moves to X=214.191*, Z=-164.085*, Y=10.269*
...
```
  0: 0x0066 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Hair style, value=2168*)
...
```
  0: 0x006B [0xB6] ENTITY_APPEARANCE_HANDLER(case=Hair style, value=2126*)
