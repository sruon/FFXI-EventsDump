...
```
  0: 0x0076 [0x5B] LOAD_EXT_SCHEDULER(work_offset=2412*, entity1=EventEntity, entity2=EventEntity, action="rbt1")
  1: 0x0085 [0x53] WAIT_SCHEDULER_TASK(entity1=EventEntity, entity2=EventEntity, action_id="rbt1")
