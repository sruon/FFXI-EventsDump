...
- **7738**: Enter Garlaige Citadel? [Yes./No.]
...
```
  ...
  1: 0x0003 [0x24] CREATE_DIALOG(message_id=7738*, default_option=1*, option_flags=0*)
    → "Enter Garlaige Citadel? [Yes./No.]"
 ...
 11: 0x0031 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "z98a" with entities [LocalPlayer, LocalPlayer], work=[217*, 0*]
