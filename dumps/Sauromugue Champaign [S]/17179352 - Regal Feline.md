...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0070:          32 03 80 1F 00  08 80 09 80 06 80 1F 01     2............
0080: 6F 00                                             o.              
```
...
```
  0: 0x0073 [0x32] ExtData[1]->MainSpeed = 11* * 0.1
  1: 0x0076 [0x1F] MOVE_ENTITY: EventEntity moves to X=-419.879*, Z=-207.635*, Y=19.999*
...
```
      00 01 02 03 04 05 06 07  08 09 0A 0B 0C 0D 0E 0F
      -- -- -- -- -- -- -- --  -- -- -- -- -- -- -- --
0080:       32 0A 80 1F 00 0B  80 0C 80 06 80 1F 01 6F    2............o
0090: 00                                                .               
```
...
```
  ...
  1: 0x0085 [0x1F] MOVE_ENTITY: EventEntity moves to X=-418.623*, Z=-211.439*, Y=19.999*
