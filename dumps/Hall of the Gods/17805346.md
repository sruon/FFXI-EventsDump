...
```
  0: 0x0044 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Hair style, value=2397*)
...
```
  0: 0x0054 [0x6C] FADE_ENTITY_COLOR(entity_id=EventEntity, end_alpha=0*, fade_time=60*)
