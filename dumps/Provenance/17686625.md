...
| [13](#event-13)            | 0x0052       |      1 |              1 |
| [65535.10](#event-6553510) | 0x0053       |     15 |              5 |
...
```
  0: 0x0048 [0xB6] ENTITY_APPEARANCE_HANDLER(case=Hair style, value=2058*)
...
```
  ...
  1: 0x0056 [0x1F] MOVE_ENTITY: EventEntity moves to X=-571.826*, Z=522.182*, Y=-227.999*
