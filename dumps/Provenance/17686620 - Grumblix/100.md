...
0020: 1C 04 80 1E F0 FF FF 7F  4A F0 FF FF 7F 5C E0 0D  ........J....\..
...
```
  ...
  9: 0x0028 [0x4A] LocalPlayer looks at Grumblix (ID: 17686620/0x010DE05C)
 ...
 20: 0x0077 [0x1D] PRINT_EVENT_MESSAGE(message_id=7521*)
...
SUBROUTINE_00A7:
 30: 0x00A7 [0x24] CREATE_DIALOG(message_id=7524*, default_option=0*, option_flags=0x00)
    → "Would you like to hear a story?\u0007\u000BNo, thank you.\u0007Let's hear one.\u007F1\u0000\u0007"
 31: 0x00AE [0x25] WAIT_DIALOG_SELECT()
 32: 0x00AF [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x00F3
 33: 0x00B7 [0x24] CREATE_DIALOG(message_id=7525*, default_option=0*, option_flags=0x1002)
    → "Which story would you like to be told?\u0007\u000BOn second thought, maybe later.\u0007Provenance(pt.1).\u0007Provenance(pt.2).\u0007Provenance(pt.3).\u0007Provenance(pt.4).\u0007Crystal Guardian(pt.1).\u0007Crystal Guardian(pt.2).\u0007Crystal Guardian(pt.3).\u0007Endings and Beginnings.\u007F1\u0000\u0007"
 ...
 38: 0x00DD [0x1D] PRINT_EVENT_MESSAGE(message_id=7523*)
    → "Oh......\u0007...outta here.........\u007F1\u0000\u0007"
...
SUBROUTINE_00E6:
 42: 0x00E6 [0x03] Work_Zone[1] = 0*
 43: 0x00EB [0x0E] Work_Zone[1] |= Work_Zone[0]
 44: 0x00F0 [0x01] GOTO 0x01DB

SUBROUTINE_00F3:
 45: 0x00F3 [0x02] IF !(Work_Zone[0] == 2*) GOTO 0x0137
 46: 0x00FB [0x24] CREATE_DIALOG(message_id=7526*, default_option=0*, option_flags=0x1003)
    → "\u007F1\u0000\u0007"
 47: 0x0102 [0x25] WAIT_DIALOG_SELECT()
 48: 0x0103 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x012A
 49: 0x010B [0x03] Work_Zone[1] = 1073741824*
 50: 0x0110 [0x9F] LOAD_SCHEDULED_TASK_ALT: Load scheduler "main" with entities [EventEntity, EventEntity], work=[230*, 0*]
 51: 0x0121 [0x1D] PRINT_EVENT_MESSAGE(message_id=7523*)
    → "Oh......\u0007...outta here.........\u007F1\u0000\u0007"
 52: 0x0124 [0x23] WAIT_FOR_DIALOG_INTERACTION
 53: 0x0125 [0x21] END_EVENT
 54: 0x0126 [0x00] END_REQSTACK()

SUBROUTINE_012A:
 55: 0x012A [0x03] Work_Zone[1] = 32*
 56: 0x012F [0x0E] Work_Zone[1] |= Work_Zone[0]
 57: 0x0134 [0x01] GOTO 0x01DB

SUBROUTINE_0137:
 58: 0x0137 [0x02] IF !(Work_Zone[0] == 3*) GOTO 0x017B
 59: 0x013F [0x24] CREATE_DIALOG(message_id=7527*, default_option=0*, option_flags=0x1004)
    → "\u007F1\u0000\u0007"
 60: 0x0146 [0x25] WAIT_DIALOG_SELECT()
 61: 0x0147 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x016E
 62: 0x014F [0x03] Work_Zone[1] = 1073741824*
 63: 0x0154 [0x9F] LOAD_SCHEDULED_TASK_ALT: Load scheduler "main" with entities [EventEntity, EventEntity], work=[230*, 0*]
 64: 0x0165 [0x1D] PRINT_EVENT_MESSAGE(message_id=7523*)
    → "Oh......\u0007...outta here.........\u007F1\u0000\u0007"
 65: 0x0168 [0x23] WAIT_FOR_DIALOG_INTERACTION
 66: 0x0169 [0x21] END_EVENT
 67: 0x016A [0x00] END_REQSTACK()

SUBROUTINE_016E:
 68: 0x016E [0x03] Work_Zone[1] = 64*
 69: 0x0173 [0x0E] Work_Zone[1] |= Work_Zone[0]
 70: 0x0178 [0x01] GOTO 0x01DB

SUBROUTINE_017B:
 71: 0x017B [0x02] IF !(Work_Zone[0] == 4*) GOTO 0x01BF
 72: 0x0183 [0x24] CREATE_DIALOG(message_id=7528*, default_option=0*, option_flags=0x1005)
    → "\u007F1\u0000\u0007"
 73: 0x018A [0x25] WAIT_DIALOG_SELECT()
 74: 0x018B [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x01B2
 75: 0x0193 [0x03] Work_Zone[1] = 1073741824*
 76: 0x0198 [0x9F] LOAD_SCHEDULED_TASK_ALT: Load scheduler "main" with entities [EventEntity, EventEntity], work=[230*, 0*]
 77: 0x01A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7523*)
    → "Oh......\u0007...outta here.........\u007F1\u0000\u0007"
 78: 0x01AC [0x23] WAIT_FOR_DIALOG_INTERACTION
 79: 0x01AD [0x21] END_EVENT
 80: 0x01AE [0x00] END_REQSTACK()

SUBROUTINE_01B2:
 81: 0x01B2 [0x03] Work_Zone[1] = 96*
 82: 0x01B7 [0x0E] Work_Zone[1] |= Work_Zone[0]
 83: 0x01BC [0x01] GOTO 0x01DB

SUBROUTINE_01BF:
 84: 0x01BF [0x03] Work_Zone[1] = 1073741824*
 85: 0x01C4 [0x9F] LOAD_SCHEDULED_TASK_ALT: Load scheduler "main" with entities [EventEntity, EventEntity], work=[230*, 0*]
 86: 0x01D5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7523*)
    → "Oh......\u0007...outta here.........\u007F1\u0000\u0007"
 87: 0x01D8 [0x23] WAIT_FOR_DIALOG_INTERACTION
 88: 0x01D9 [0x21] END_EVENT
 89: 0x01DA [0x00] END_REQSTACK()

SUBROUTINE_01DB:
 90: 0x01DB [0x1D] PRINT_EVENT_MESSAGE(message_id=7522*)
    → ".........listen......\u007F1\u0000\u0007"
 91: 0x01DE [0x23] WAIT_FOR_DIALOG_INTERACTION
 92: 0x01DF [0x43] SEND_EVENT_UPDATE: Send pending tag to server (packet 0x005B)
 93: 0x01E1 [0x43] SEND_EVENT_UPDATE: Check pending flag (skip if not pending)
 94: 0x01E3 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=EventEntity, entity2=EventEntity, scheduler_id="fdo1", work_offset2=0*)
 95: 0x01F4 [0x1C] WAIT(60* ticks)
 96: 0x01F7 [0x30] SET_UCOFF_CONTINUE_ZERO()
 97: 0x01F8 [0x21] END_EVENT
 98: 0x01F9 [0x00] END_REQSTACK()
```
