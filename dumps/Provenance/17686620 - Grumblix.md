...
- **7521**: I travel......hear lots... Hear...stories... Can tell...if...
- **7522**: .........listen......
- **7523**: Oh...... ...outta here.........
- **7524**: Would you like to hear a story? [No, thank you./Let's hear one.]
- **7525**: Which story would you like to be told? [On second thought, maybe later./Provenance(pt.1)./Provenance(pt.2)./Provenance(pt.3)./Provenance(pt.4)./Crystal Guardian(pt.1)./Crystal Guardian(pt.2)./Crystal Guardian(pt.3)./Endings and Beginnings.]
- **7526**: 
- **7527**: 
- **7528**: 
...
```
 ...
 30: 0x00A7 [0x24] CREATE_DIALOG(message_id=7524*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00B7:
 33: 0x00B7 [0x24] CREATE_DIALOG(message_id=7525*, default_option=0*, option_flags=Work_Zone[2])
    → "Which story would you like to be told? [On second thought, maybe later./Provenance(pt.1)./Provenance(pt.2)./Provenance(pt.3)./Provenance(pt.4)./Crystal Guardian(pt.1)./Crystal Guardian(pt.2)./Crystal Guardian(pt.3)./Endings and Beginnings.]"
...
SUBROUTINE_00FB:
 44: 0x00FB [0x24] CREATE_DIALOG(message_id=7526*, default_option=0*, option_flags=Work_Zone[3])
    → ""
 ...
 49: 0x0121 [0x1D] PRINT_EVENT_MESSAGE(message_id=7523*)
    → "Oh...... ...outta here........."
...
SUBROUTINE_013F:
 55: 0x013F [0x24] CREATE_DIALOG(message_id=7527*, default_option=0*, option_flags=Work_Zone[4])
    → ""
 ...
 60: 0x0165 [0x1D] PRINT_EVENT_MESSAGE(message_id=7523*)
    → "Oh...... ...outta here........."
...
SUBROUTINE_0183:
 66: 0x0183 [0x24] CREATE_DIALOG(message_id=7528*, default_option=0*, option_flags=Work_Zone[5])
    → ""
 ...
 71: 0x01A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=7523*)
    → "Oh...... ...outta here........."
...
SUBROUTINE_01BC:
 ...
 78: 0x01D5 [0x1D] PRINT_EVENT_MESSAGE(message_id=7523*)
    → "Oh...... ...outta here........."
...
SUBROUTINE_01DB:
 82: 0x01DB [0x1D] PRINT_EVENT_MESSAGE(message_id=7522*)
    → ".........listen......"
