...
```
  ...
  1: 0x0002 [0x45] LOAD_SCHEDULED_TASK(work_offset1=294*, entity1=racetest (ID: 17637603/0x010D20E3), entity2=LocalPlayer, scheduler_id="rm00", work_offset2=0*)
  2: 0x0013 [0x34] LOAD_UNLOAD_ZONE(zone_id=70*)
  3: 0x0016 [0xAE] MULTI_PURPOSE_ENTITY_HANDLER(case_type=0x00 - Weather, param1=References[3], param2=References[1])
...
SUBROUTINE_01C5:
 ...
 80: 0x01C8 [0xAE] MULTI_PURPOSE_ENTITY_HANDLER(case_type=0x00 - Weather, param1=References[3], param2=References[1])
