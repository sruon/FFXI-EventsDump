...
SUBROUTINE_0255:
 27: 0x0255 [0x01] GOTO 0x0258

SUBROUTINE_0258:
 28: 0x0258 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
 29: 0x0269 [0x55] WAIT_LOAD_SCHEDULER: Wait for scheduler "fdo1" with entities [LocalPlayer, LocalPlayer], work=200*
 30: 0x0278 [0x52] END_LOAD_SCHEDULER: End scheduler "s056" with entities [EventEntity, EventEntity], work=703*
 31: 0x0287 [0x1C] WAIT(15* ticks)
 32: 0x028A [0xAB] EventEntity->DespawnValue = 0* // Set despawn value
 33: 0x028E [0x1C] WAIT(1* ticks)
 34: 0x0291 [0x78] ENABLE_GAME_TIMER_RESET_WEATHER()
 35: 0x0292 [0x4E] SET_ENTITY_HIDE_FLAG: Hide Scheck (ID: 17637461/0x010D2055)
 36: 0x0298 [0xAB] EventEntity->UnknownFlag = 0 // Disable unknown flag
 37: 0x029A [0x46] CAMERA_CONTROL: Restore default settings
 38: 0x029C [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi2" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
 39: 0x02AD [0x21] END_EVENT
 40: 0x02AE [0x00] END_REQSTACK()
```
