...
SUBROUTINE_00EF:
 ...
 29: 0x0106 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "0ovt" with entities [EventEntity, EventEntity], work=[703*, 0*]
 ...
 33: 0x012A [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s056" with entities [EventEntity, EventEntity], work=[703*, 0*]
...
SUBROUTINE_0141:
 ...
 37: 0x0158 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "0sct" with entities [EventEntity, EventEntity], work=[703*, 0*]
 ...
 41: 0x017C [0x45] LOAD_SCHEDULED_TASK: Load scheduler "0scf" with entities [EventEntity, EventEntity], work=[703*, 0*]
 42: 0x018D [0x45] LOAD_SCHEDULED_TASK: Load scheduler "s056" with entities [EventEntity, EventEntity], work=[703*, 0*]
...
SUBROUTINE_0258:
 82: 0x0258 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
 83: 0x0269 [0x55] WAIT_LOAD_SCHEDULER: Wait for scheduler "fdo1" with entities [LocalPlayer, LocalPlayer], work=200*
 ...
 92: 0x029C [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi2" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
