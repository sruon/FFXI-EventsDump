...
```
  0: 0x0001 [0x41] GET_BIT_WORK_RANGE(start_bit=24*, end_bit=31*, source=Work_Zone[2], result=ExtData[1]->WorkLocal[1])
  1: 0x000A [0x41] GET_BIT_WORK_RANGE(start_bit=16*, end_bit=23*, source=Work_Zone[2], result=ExtData[1]->WorkLocal[2])
  2: 0x0013 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=15*, source=Work_Zone[2], result=ExtData[1]->WorkLocal[3])
