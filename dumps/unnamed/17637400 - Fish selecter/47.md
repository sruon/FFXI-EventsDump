...
SUBROUTINE_03CA:
184: 0x03CA [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x03DA
185: 0x03D2 [0x0F] ExtData[1]->WorkLocal[2] ^= 1*
186: 0x03D7 [0x01] GOTO 0x040A

SUBROUTINE_03DA:
187: 0x03DA [0x02] IF !(Work_Zone[0] == 2*) GOTO 0x03EA
188: 0x03E2 [0x0F] ExtData[1]->WorkLocal[2] ^= 2*
189: 0x03E7 [0x01] GOTO 0x040A

SUBROUTINE_03EA:
190: 0x03EA [0x02] IF !(Work_Zone[0] == 3*) GOTO 0x03FA
191: 0x03F2 [0x0F] ExtData[1]->WorkLocal[2] ^= 4*
192: 0x03F7 [0x01] GOTO 0x040A

SUBROUTINE_03FA:
193: 0x03FA [0x02] IF !(Work_Zone[0] == 4*) GOTO 0x040A
194: 0x0402 [0x0F] ExtData[1]->WorkLocal[2] ^= 8*
195: 0x0407 [0x01] GOTO 0x040A

SUBROUTINE_040A:
196: 0x040A [0x01] GOTO 0x0362

SUBROUTINE_040D:
197: 0x040D [0x1B] RETURN

SUBROUTINE_040E:
198: 0x040E [0x03] Work_Zone[1] = 4*
199: 0x0413 [0x1B] RETURN
```
