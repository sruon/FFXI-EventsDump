...
SUBROUTINE_00D0:
 ...
 32: 0x00FD [0x24] CREATE_DIALOG(message_id=9108*, default_option=0x0009, option_flags=0x03)
    → "View which item? (
\u0001 pts.)\u0007\u000B
\u0002-point items.\u0007
\u0003-pt. items.\u0007
...
SUBROUTINE_0415:
112: 0x0415 [0x01] GOTO 0x0426
113: 0x0418 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x0426
114: 0x0420 [0x01] GOTO 0x0211

SUBROUTINE_0426:
115: 0x0426 [0x01] GOTO 0x0429

SUBROUTINE_0429:
116: 0x0429 [0x21] END_EVENT
117: 0x042A [0x00] END_REQSTACK()
```
