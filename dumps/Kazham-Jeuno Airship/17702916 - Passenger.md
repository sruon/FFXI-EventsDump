...
| [101](#event-101)     | 0x0001       |      5 |              3 |
| [111](#event-111)     | 0x0006       |    275 |             75 |
...
- **7079**: Return the dropped item? [Yes./No.]
- **7080**: Can I help you?
- **7081**: Oh, thanks... I'm not sure that this belongs to me, though...
- **7082**: Wow, thanks... I don't really remember dropping anything, though...
- **7083**: Thank you! I've been looking all over the place for this!
- **7084**: Thank you! I don't know what I would've done if I had lost this!
- **7085**: Please take this as a token of my gratitude.
- **7086**: I wonder if I could see my house from up here...
- **7087**: There seem to be a lot of disreputable characters riding the airships these days...
- **7088**: It's hard to tell people apart these days, don't you agree? For some reason, that thought occurs to me whenever I ride an airship...
- **7089**: These flights to Jeuno are always so crowded, aren't they?
...
SUBROUTINE_00D2:
  ...
  6: 0x00E4 [0x1D] PRINT_EVENT_MESSAGE(message_id=7086*)
 ...
 10: 0x00F3 [0x1D] PRINT_EVENT_MESSAGE(message_id=7087*)
 ...
 14: 0x0102 [0x1D] PRINT_EVENT_MESSAGE(message_id=7088*)
 ...
 18: 0x0111 [0x1D] PRINT_EVENT_MESSAGE(message_id=7089*)
...
# Dead code (unreachable instructions):
     ...
     0x0010 [0x1D] PRINT_EVENT_MESSAGE(message_id=7080*)
    → "Can I help you?"
     0x0013 [0x23] WAIT_FOR_DIALOG_INTERACTION
     0x0014 [0x24] CREATE_DIALOG(message_id=7079*, default_option=1*, option_flags=0*)
    → "Return the dropped item? [Yes./No.]"
     ...
     0x0039 [0x1D] PRINT_EVENT_MESSAGE(message_id=7083*)
    ...
    → "Please take this as a token of my gratitude."
     ...
     0x0091 [0x1D] PRINT_EVENT_MESSAGE(message_id=7081*)
