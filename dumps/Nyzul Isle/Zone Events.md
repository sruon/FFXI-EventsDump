...
- **7359**: What do you take? [Nothing./$1 ($2 remaining)/$3 ($4 remaining)/$5 ($6 remaining)/$7 ($8 remaining)/$9 ($10 remaining)/$11 ($12 remaining)/$13 ($14 remaining)/$15 ($16 remaining)]
- **7365**: Activate the lamp? [Yes./Yes./No.]
...
```
 ...
 54: 0x0399 [0x24] CREATE_DIALOG(message_id=7359*, default_option=0*, option_flags=ExtData[1]->WorkLocal[1])
...
```
  ...
  4: 0x0445 [0x24] CREATE_DIALOG(message_id=7365*, default_option=2*, option_flags=ExtData[1]->WorkLocal[19])
