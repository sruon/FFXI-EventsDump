...
- **7588**: Warp to the heroines' chamber? [Yes./No.]
...
```
  0: 0x0001 [0x24] CREATE_DIALOG(message_id=7588*, default_option=1*, option_flags=0*)
    → "Warp to the heroines' chamber? [Yes./No.]"
