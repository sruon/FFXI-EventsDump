...
```
 ...
 11: 0x001F [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 ...
 18: 0x004E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blon", work_offset2=0*)
 19: 0x005F [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blon", work_offset2=0*)
 20: 0x0070 [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9404", work_offset2=0*)
 21: 0x0081 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
 ...
 28: 0x00A6 [0x48] [System] [7633*]:
    → "Someone appears to be inside!\u007F1\u0000\u0007"
 ...
 31: 0x00B9 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blof", work_offset2=0*)
 32: 0x00CA [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9405", work_offset2=0*)
 ...
 40: 0x0105 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blon", work_offset2=0*)
 41: 0x0116 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blon", work_offset2=0*)
 42: 0x0127 [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9404", work_offset2=0*)
 43: 0x0138 [0x2B] ??? (ID: 17162753/0x0105E201) [7634*]:
    → "Ain't nobody herrre, so go away!\u007F1\u0000\u0007"
 ...
 46: 0x014F [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blof", work_offset2=0*)
 47: 0x0160 [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9406", work_offset2=0*)
 48: 0x0171 [0x2B] ??? (ID: 17162753/0x0105E201) [7635*]:
    → "(Shhh! Keep it down, Tek!)\u007F1\u0000\u0007"
 49: 0x0178 [0x23] WAIT_FOR_DIALOG_INTERACTION
 50: 0x0179 [0x2B] Tek Lengyon (ID: 17162687/0x0105E1BF) [7636*]:
    → "Um, oops. Sorry, Kipopo...\u007F1\u0000\u0007"
 51: 0x0180 [0x23] WAIT_FOR_DIALOG_INTERACTION
 52: 0x0181 [0x4E] SET_ENTITY_HIDE_FLAG: Show Hampu-Kampu (ID: 17162684/0x0105E1BC)
 53: 0x0187 [0xBA] SET_ENTITY_POSITION(entity_id=References[17129916], pos_x=150.072*, pos_z=247.298*, pos_y=-7.874*, direction=82.4°*)
 ...
 59: 0x01B6 [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9405", work_offset2=0*)
 ...
 71: 0x0203 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Hampu-Kampu (ID: 17162684/0x0105E1BC), entity2=Hampu-Kampu (ID: 17162684/0x0105E1BC), action="tlk0")
 72: 0x0212 [0x2B] Hampu-Kampu (ID: 17162684/0x0105E1BC) [7638*]:
    → "...So this is where my daughtaru's been hiding.\u007F1\u0000\u0007"
 73: 0x0219 [0x23] WAIT_FOR_DIALOG_INTERACTION
 74: 0x021A [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Hampu-Kampu (ID: 17162684/0x0105E1BC), entity2=Hampu-Kampu (ID: 17162684/0x0105E1BC), action="tlk1")
 75: 0x0229 [0x52] END_LOAD_SCHEDULER: End scheduler "9405" with entities [LocalPlayer, LocalPlayer], work=341*
 76: 0x0238 [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9407", work_offset2=0*)
 ...
 84: 0x0266 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Hampu-Kampu (ID: 17162684/0x0105E1BC), entity2=Hampu-Kampu (ID: 17162684/0x0105E1BC), action="tlk0")
 ...
 89: 0x0285 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Hampu-Kampu (ID: 17162684/0x0105E1BC), entity2=Hampu-Kampu (ID: 17162684/0x0105E1BC), action="tlk1")
 90: 0x0294 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
 91: 0x02A5 [0x1C] WAIT(60* ticks)
 92: 0x02A8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="dopn", work_offset2=0*)
 ...
 96: 0x02D4 [0xBA] SET_ENTITY_POSITION(entity_id=References[17129918], pos_x=147.949*, pos_z=243.441*, pos_y=-7.875*, direction=358.3°*)
...
101: 0x02F8 [0xBA] SET_ENTITY_POSITION(entity_id=References[17129919], pos_x=148.047*, pos_z=242.453*, pos_y=-7.875*, direction=358.3°*)
...
104: 0x0310 [0xBA] SET_ENTITY_POSITION(entity_id=References[17129916], pos_x=149.073*, pos_z=242.950*, pos_y=-7.875*, direction=186.7°*)
...
107: 0x032D [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="dcls", work_offset2=0*)
...
112: 0x034A [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9408", work_offset2=0*)
113: 0x035B [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
...
117: 0x0381 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
118: 0x0392 [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9416", work_offset2=0*)
119: 0x03A3 [0x4B] UPDATE_ENTITY_YAW(entity=Kipopo (ID: 17162686/0x0105E1BE), yaw=13.65°*)
...
123: 0x03B6 [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=Kipopo (ID: 17162686/0x0105E1BE), entity2=Kipopo (ID: 17162686/0x0105E1BE), action="tlk0")
...
126: 0x03CD [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=Kipopo (ID: 17162686/0x0105E1BE), entity2=Kipopo (ID: 17162686/0x0105E1BE), action="tlke")
...
129: 0x03EE [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9417", work_offset2=0*)
...
133: 0x0415 [0x5B] LOAD_EXT_SCHEDULER(work_offset=81*, entity1=Tek Lengyon (ID: 17162687/0x0105E1BF), entity2=Tek Lengyon (ID: 17162687/0x0105E1BF), action="hai0")
...
136: 0x042C [0x53] WAIT_SCHEDULER_TASK(entity1=Tek Lengyon (ID: 17162687/0x0105E1BF), entity2=Tek Lengyon (ID: 17162687/0x0105E1BF), action_id="hai0")
137: 0x0439 [0x52] END_LOAD_SCHEDULER: End scheduler "9417" with entities [LocalPlayer, LocalPlayer], work=341*
138: 0x0448 [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9404", work_offset2=0*)
...
152: 0x049E [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
153: 0x04AF [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9409", work_offset2=0*)
...
157: 0x04DD [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=Kipopo (ID: 17162686/0x0105E1BE), entity2=Kipopo (ID: 17162686/0x0105E1BE), action="tlk0")
...
161: 0x04FE [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=Kipopo (ID: 17162686/0x0105E1BE), entity2=Kipopo (ID: 17162686/0x0105E1BE), action="tlke")
162: 0x050D [0x1C] WAIT(30* ticks)
163: 0x0510 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Hampu-Kampu (ID: 17162684/0x0105E1BC), entity2=Hampu-Kampu (ID: 17162684/0x0105E1BC), action="tlk0")
164: 0x051F [0x2B] Hampu-Kampu (ID: 17162684/0x0105E1BC) [7646*]:
    → "I...I'm sorry...\u007F1\u0000\u0007"
165: 0x0526 [0x23] WAIT_FOR_DIALOG_INTERACTION
166: 0x0527 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Hampu-Kampu (ID: 17162684/0x0105E1BC), entity2=Hampu-Kampu (ID: 17162684/0x0105E1BC), action="tlk1")
167: 0x0536 [0x52] END_LOAD_SCHEDULER: End scheduler "9409" with entities [LocalPlayer, LocalPlayer], work=341*
168: 0x0545 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
169: 0x0556 [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9410", work_offset2=0*)
170: 0x0567 [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=Kipopo (ID: 17162686/0x0105E1BE), entity2=Kipopo (ID: 17162686/0x0105E1BE), action="ang0")
...
174: 0x058D [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9411", work_offset2=0*)
...
178: 0x05B5 [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9412", work_offset2=0*)
...
182: 0x05DD [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=Kipopo (ID: 17162686/0x0105E1BE), entity2=Kipopo (ID: 17162686/0x0105E1BE), action="tlke")
183: 0x05EC [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9409", work_offset2=0*)
...
190: 0x0625 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blon", work_offset2=0*)
191: 0x0636 [0x45] LOAD_SCHEDULED_TASK(work_offset1=201*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blon", work_offset2=0*)
192: 0x0647 [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9418", work_offset2=0*)
193: 0x0658 [0x1C] WAIT(30* ticks)
194: 0x065B [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="blof", work_offset2=0*)
195: 0x066C [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=Kipopo (ID: 17162686/0x0105E1BE), entity2=Kipopo (ID: 17162686/0x0105E1BE), action="ang0")
...
202: 0x069D [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9419", work_offset2=0*)
203: 0x06AE [0x5B] LOAD_EXT_SCHEDULER(work_offset=81*, entity1=Tek Lengyon (ID: 17162687/0x0105E1BF), entity2=Tek Lengyon (ID: 17162687/0x0105E1BF), action="bik0")
...
206: 0x06C5 [0x53] WAIT_SCHEDULER_TASK(entity1=Tek Lengyon (ID: 17162687/0x0105E1BF), entity2=Tek Lengyon (ID: 17162687/0x0105E1BF), action_id="bik0")
207: 0x06D2 [0x52] END_LOAD_SCHEDULER: End scheduler "9419" with entities [LocalPlayer, LocalPlayer], work=341*
208: 0x06E1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="ovl1", work_offset2=0*)
209: 0x06F2 [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9425", work_offset2=0*)
...
224: 0x0751 [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9413", work_offset2=0*)
...
230: 0x0779 [0x5B] LOAD_EXT_SCHEDULER(work_offset=85*, entity1=Kipopo (ID: 17162686/0x0105E1BE), entity2=Kipopo (ID: 17162686/0x0105E1BE), action="ang0")
231: 0x0788 [0x2B] Kipopo (ID: 17162686/0x0105E1BE) [7653*]:
    → "I hate you, I hate you!\u0007Daddy can go and chokey-woke on a rabbit mantle!\u007F1\u0000\u0007"
232: 0x078F [0x23] WAIT_FOR_DIALOG_INTERACTION
233: 0x0790 [0x5B] LOAD_EXT_SCHEDULER(work_offset=81*, entity1=Tek Lengyon (ID: 17162687/0x0105E1BF), entity2=Tek Lengyon (ID: 17162687/0x0105E1BF), action="hai0")
234: 0x079F [0x2B] Tek Lengyon (ID: 17162687/0x0105E1BF) [7654*]:
    → "Nyahaha.\u0001t\u0007And that's all for today's episode of \u00072Tek the Tannerrr\u00073! Till next time, folks!\u007F1\u0000\u0007"
235: 0x07A6 [0x23] WAIT_FOR_DIALOG_INTERACTION
236: 0x07A7 [0x53] WAIT_SCHEDULER_TASK(entity1=Tek Lengyon (ID: 17162687/0x0105E1BF), entity2=Tek Lengyon (ID: 17162687/0x0105E1BF), action_id="hai0")
...
241: 0x07C8 [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Hampu-Kampu (ID: 17162684/0x0105E1BC), entity2=Hampu-Kampu (ID: 17162684/0x0105E1BC), action="tlk0")
242: 0x07D7 [0x2B] Hampu-Kampu (ID: 17162684/0x0105E1BC) [7655*]:
    → "K-Kipopo...\u007F1\u0000\u0007"
243: 0x07DE [0x23] WAIT_FOR_DIALOG_INTERACTION
244: 0x07DF [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=40*, entity1=Hampu-Kampu (ID: 17162684/0x0105E1BC), entity2=Hampu-Kampu (ID: 17162684/0x0105E1BC), action="tlk1")
...
247: 0x0800 [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9414", work_offset2=0*)
248: 0x0811 [0x1C] WAIT(30* ticks)
249: 0x0814 [0x4B] UPDATE_ENTITY_YAW(entity=Hampu-Kampu (ID: 17162684/0x0105E1BC), yaw=11.66°*)
...
252: 0x081D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=Hampu-Kampu (ID: 17162684/0x0105E1BC), entity2=Hampu-Kampu (ID: 17162684/0x0105E1BC), action="sha0")
...
257: 0x0846 [0x45] LOAD_SCHEDULED_TASK(work_offset1=341*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="9415", work_offset2=0*)
...
259: 0x085E [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=49*, entity1=Hampu-Kampu (ID: 17162684/0x0105E1BC), entity2=Hampu-Kampu (ID: 17162684/0x0105E1BC), action="sha1")
260: 0x086D [0x1C] WAIT(60* ticks)
261: 0x0870 [0x4B] UPDATE_ENTITY_YAW(entity=Hampu-Kampu (ID: 17162684/0x0105E1BC), yaw=17.08°*)
...
266: 0x0883 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
...
273: 0x08B1 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
274: 0x08C2 [0x01] GOTO 0x08FC

SUBROUTINE_08C5:
275: 0x08C5 [0x02] IF !(Work_Zone[0] == 1*) GOTO 0x08FC
276: 0x08CD [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdo1", work_offset2=0*)
277: 0x08DE [0x1C] WAIT(60* ticks)
278: 0x08E1 [0x03] Work_Zone[1] = 0*
279: 0x08E6 [0x46] CAMERA_CONTROL: Restore default settings
280: 0x08E8 [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
...
285: 0x090C [0x45] LOAD_SCHEDULED_TASK(work_offset1=200*, entity1=LocalPlayer, entity2=LocalPlayer, scheduler_id="fdi1", work_offset2=0*)
