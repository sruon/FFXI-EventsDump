...
```
  ...
  3: 0x001C [0x2B] EventEntity [10971*]:
    → "Capricornian Master Caster Zonpa-Zippa developed the Cardians as a way to compensate for the Federation's lack of hardened, crack frontline troops."
  4: 0x0023 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0024 [0x2B] EventEntity [10972*]:
    → "They still aren't entirely ready for all the applications that we'd like, but they may become capable of handling some simple tasks soon enough."
