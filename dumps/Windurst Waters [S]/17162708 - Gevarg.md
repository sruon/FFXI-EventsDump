...
- **10874**: The minstrel of melodies is my name, For a mere $6 gil I'll recall your past. Your stories of love, anger, triumph, and shame, The river of memories runs deep and vast.
- **10875**: The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last.
- **10877**: Which memory will you have recalled? [Nothing./Wings of the Goddess Missions./Windurst Quests 1./Windurst Quests 2./Other Quests.]
- **10878**: Which memory will you have recalled? [Nothing./Affairs of State./Borne by the Wind.]
...
- **10880**: Which memory will you have recalled? [Nothing./When One Man Is Not Enough(pt.1)./When One Man Is Not Enough(pt.2)./A Feast for Gnats(pt.1)./A Feast for Gnats(pt.2)./Say It with a Handbag(pt.1)./Say It with a Handbag(pt.2)./Say It with a Handbag(pt.3)./Say It with a Handbag(pt.4)./The Long March North./The Forbidden Path(pt.1)./The Forbidden Path(pt.2)./The Forbidden Path(pt.3)./The Forbidden Path(pt.4)./The Forbidden Path(pt.5)./The Forbidden Path(pt.6)./The Young and the Threadless(pt.1)./The Young and the Threadless(pt.2)./The Young and the Threadless(pt.3)./Sins of the Mothers(pt.1)./Sins of the Mothers(pt.2)./Howl from the Heavens(pt.1)./Howl from the Heavens(pt.2)./Howl from the Heavens(pt.3)./Manifest Destiny./At Journey's End(pt.1)./At Journey's End(pt.2).]
- **10881**: Which memory will you have recalled? [Nothing./Her Memories: Verdure Footfalls(pt.1)./Her Memories: Verdure Footfalls(pt.2)./Her Memories: Verdure Footfalls(pt.3)./Drafted by the Duchy./Battle on a New Front./Trust (Romaa Mihgo).]
- **10882**: Which memory will you have recalled? [Nothing.]
...
```
  ...
  3: 0x001B [0x1D] PRINT_EVENT_MESSAGE(message_id=10875*)
 ...
 21: 0x0088 [0x1D] PRINT_EVENT_MESSAGE(message_id=10875*)
    → "The minstrel of melodies is my name, For a mere $6 gil I'd recall your past. But I find that you're lacking in cash or in fame, So until that time, my kind offer will last."
 22: 0x008B [0x23] WAIT_FOR_DIALOG_INTERACTION
 23: 0x008C [0x21] END_EVENT
 24: 0x008D [0x00] END_REQSTACK()
 25: 0x008E [0x1D] PRINT_EVENT_MESSAGE(message_id=10874*)
 ...
 39: 0x00D4 [0x24] CREATE_DIALOG(message_id=10877*, default_option=0*, option_flags=ExtData[1]->WorkLocal[0])
...
SUBROUTINE_00E4:
 42: 0x00E4 [0x24] CREATE_DIALOG(message_id=10878*, default_option=0*, option_flags=Work_Zone[2])
...
SUBROUTINE_0113:
 50: 0x0113 [0x24] CREATE_DIALOG(message_id=10879*, default_option=0*, option_flags=Work_Zone[3])
    → "Which memory will you have recalled? [Nothing./Healing Herbs(pt.1)./Healing Herbs(pt.2)./Healing Herbs(pt.3)./Healing Herbs(pt.4)./Healing Herbs(pt.5)./Healing Herbs(pt.6)./Redeeming Rocks(pt.1)./Redeeming Rocks(pt.2)./Redeeming Rocks(pt.3)./Redeeming Rocks(pt.4)./Redeeming Rocks(pt.5)./The Dawn of Delectability(pt.1)./The Dawn of Delectability(pt.2)./Snake on the Plains(pt.1)./Snake on the Plains(pt.2)./The Tigress Stirs(pt.1)./The Tigress Stirs(pt.2)./The Tigress Stirs(pt.3)./The Tigress Strikes(pt.1)./The Tigress Strikes(pt.2)./Knot Quite There./A Manifest Problem(pt.1)./A Manifest Problem(pt.2)./A Manifest Problem(pt.3)./A Manifest Problem(pt.4)./The Lost Book(pt.1)./The Lost Book(pt.2)./The Lost Book(pt.3)./The Lost Book(pt.4)./The Lost Book(pt.5).]"
...
SUBROUTINE_0142:
 58: 0x0142 [0x24] CREATE_DIALOG(message_id=10880*, default_option=0*, option_flags=Work_Zone[4])
...
SUBROUTINE_0171:
 66: 0x0171 [0x24] CREATE_DIALOG(message_id=10881*, default_option=0*, option_flags=Work_Zone[5])
...
SUBROUTINE_01A0:
 74: 0x01A0 [0x24] CREATE_DIALOG(message_id=10882*, default_option=0*, option_flags=Work_Zone[6])
...
SUBROUTINE_01CF:
 82: 0x01CF [0x24] CREATE_DIALOG(message_id=10883*, default_option=0*, option_flags=Work_Zone[7])
    → "Which memory will you have recalled? [Nothing.]"
