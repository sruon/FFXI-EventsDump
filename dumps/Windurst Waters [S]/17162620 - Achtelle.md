...
- **11819**: I go by the name Achtelle. I hail from Adoulin Isle. Word has reached there that the dragoons and their wyverns have long since disappeared from these eastern lands. Tell me, is it true?
- **11820**: Are you...a dragoon!? That is a most welcome relief. I had to come and ascertain for myself whether or not there are still those to carry on the ways of our kind.
- **11821**: Also, I have heard rumors of a wyrm which inhabits Grauberg. A wyrm which can take on the form of a man...
- **11822**: A pleasant surprise! I see that the future of the dragoons is in safe hands. It warms my heart to know that such a capable wyvern-caller such as yourself commands our legacy.
- **11823**: $2862!? But surely this is among your most prized possessions!
- **11824**: I was but a young child when I first read this and came to know of the Kingdom of San d'Oria. This book is the sole reason I swore to someday come to continent of Quon.
...
```
  ...
  9: 0x002D [0x1D] PRINT_EVENT_MESSAGE(message_id=11819*)
 ...
 13: 0x003C [0x1D] PRINT_EVENT_MESSAGE(message_id=11819*)
    → "I go by the name Achtelle. I hail from Adoulin Isle. Word has reached there that the dragoons and their wyverns have long since disappeared from these eastern lands. Tell me, is it true?"
 ...
 19: 0x005B [0x1D] PRINT_EVENT_MESSAGE(message_id=11822*)
 ...
 22: 0x0062 [0x1D] PRINT_EVENT_MESSAGE(message_id=11820*)
...
SUBROUTINE_0066:
 ...
 26: 0x0071 [0x1D] PRINT_EVENT_MESSAGE(message_id=11821*)
 ...
 29: 0x0078 [0x1D] PRINT_EVENT_MESSAGE(message_id=11819*)
    → "I go by the name Achtelle. I hail from Adoulin Isle. Word has reached there that the dragoons and their wyverns have long since disappeared from these eastern lands. Tell me, is it true?"
...
SUBROUTINE_007C:
 ...
 35: 0x0097 [0x1D] PRINT_EVENT_MESSAGE(message_id=11822*)
    → "A pleasant surprise! I see that the future of the dragoons is in safe hands. It warms my heart to know that such a capable wyvern-caller such as yourself commands our legacy."
 36: 0x009A [0x23] WAIT_FOR_DIALOG_INTERACTION
 37: 0x009B [0x01] GOTO 0x00A2
 38: 0x009E [0x1D] PRINT_EVENT_MESSAGE(message_id=11820*)
    → "Are you...a dragoon!? That is a most welcome relief. I had to come and ascertain for myself whether or not there are still those to carry on the ways of our kind."
...
SUBROUTINE_00A2:
 ...
 42: 0x00AD [0x1D] PRINT_EVENT_MESSAGE(message_id=11821*)
    → "Also, I have heard rumors of a wyrm which inhabits Grauberg. A wyrm which can take on the form of a man..."
 43: 0x00B0 [0x23] WAIT_FOR_DIALOG_INTERACTION
 44: 0x00B1 [0x01] GOTO 0x00B8
 45: 0x00B4 [0x1D] PRINT_EVENT_MESSAGE(message_id=11819*)
    → "I go by the name Achtelle. I hail from Adoulin Isle. Word has reached there that the dragoons and their wyverns have long since disappeared from these eastern lands. Tell me, is it true?"
...
SUBROUTINE_00B8:
 ...
 51: 0x00D3 [0x1D] PRINT_EVENT_MESSAGE(message_id=11822*)
    → "A pleasant surprise! I see that the future of the dragoons is in safe hands. It warms my heart to know that such a capable wyvern-caller such as yourself commands our legacy."
 52: 0x00D6 [0x23] WAIT_FOR_DIALOG_INTERACTION
 53: 0x00D7 [0x01] GOTO 0x00DE
 54: 0x00DA [0x1D] PRINT_EVENT_MESSAGE(message_id=11820*)
    → "Are you...a dragoon!? That is a most welcome relief. I had to come and ascertain for myself whether or not there are still those to carry on the ways of our kind."
...
SUBROUTINE_00DE:
 ...
 58: 0x00E9 [0x1D] PRINT_EVENT_MESSAGE(message_id=11821*)
    → "Also, I have heard rumors of a wyrm which inhabits Grauberg. A wyrm which can take on the form of a man..."
 59: 0x00EC [0x23] WAIT_FOR_DIALOG_INTERACTION
 60: 0x00ED [0x01] GOTO 0x00F4
 61: 0x00F0 [0x1D] PRINT_EVENT_MESSAGE(message_id=11819*)
    → "I go by the name Achtelle. I hail from Adoulin Isle. Word has reached there that the dragoons and their wyverns have long since disappeared from these eastern lands. Tell me, is it true?"
...
SUBROUTINE_00F7:
 ...
 68: 0x010F [0x1D] PRINT_EVENT_MESSAGE(message_id=11823*)
 ...
 73: 0x0123 [0x1D] PRINT_EVENT_MESSAGE(message_id=11824*)
