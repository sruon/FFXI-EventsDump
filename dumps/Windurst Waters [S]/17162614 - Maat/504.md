...
```
  ...
  9: 0x002D [0x1D] PRINT_EVENT_MESSAGE(message_id=11788*)
    → "Heh heh heh. Listen! You can hear it, right? It's the sound of my blood-a-boiling!\u007F1\u0000\u0007"
...
SUBROUTINE_0034:
 ...
 14: 0x0044 [0x1D] PRINT_EVENT_MESSAGE(message_id=11788*)
    → "Heh heh heh. Listen! You can hear it, right? It's the sound of my blood-a-boiling!\u007F1\u0000\u0007"
...
SUBROUTINE_004B:
 ...
 19: 0x005B [0x1D] PRINT_EVENT_MESSAGE(message_id=11789*)
...
SUBROUTINE_0062:
 ...
 23: 0x006A [0x1D] PRINT_EVENT_MESSAGE(message_id=11790*)
    → "Well, I'll be! You look a little young to have gone through so much training. Must've had a good teacher, heh heh heh!\u007F1\u0000\u0007"
 24: 0x006D [0x23] WAIT_FOR_DIALOG_INTERACTION
 25: 0x006E [0x01] GOTO 0x0075

SUBROUTINE_0071:
 26: 0x0071 [0x1D] PRINT_EVENT_MESSAGE(message_id=11788*)
    → "Heh heh heh. Listen! You can hear it, right? It's the sound of my blood-a-boiling!\u007F1\u0000\u0007"
...
SUBROUTINE_0078:
 ...
 31: 0x0088 [0x1D] PRINT_EVENT_MESSAGE(message_id=11789*)
    → "I bet a young whippersnapper like yourself thinks \u007F\u0005[he/she]'s got what it takes to rough up a beastman or two, eh? From what I see, you still have a few more mountains to climb, \u007F\u0005[sonny/missy]!\u007F1\u0000\u0007"
...
SUBROUTINE_008F:
 ...
 35: 0x0097 [0x1D] PRINT_EVENT_MESSAGE(message_id=11790*)
    → "Well, I'll be! You look a little young to have gone through so much training. Must've had a good teacher, heh heh heh!\u007F1\u0000\u0007"
 36: 0x009A [0x23] WAIT_FOR_DIALOG_INTERACTION
 37: 0x009B [0x01] GOTO 0x00A2

SUBROUTINE_009E:
 38: 0x009E [0x1D] PRINT_EVENT_MESSAGE(message_id=11788*)
    → "Heh heh heh. Listen! You can hear it, right? It's the sound of my blood-a-boiling!\u007F1\u0000\u0007"
...
SUBROUTINE_00A5:
 ...
 43: 0x00B5 [0x1D] PRINT_EVENT_MESSAGE(message_id=11789*)
    → "I bet a young whippersnapper like yourself thinks \u007F\u0005[he/she]'s got what it takes to rough up a beastman or two, eh? From what I see, you still have a few more mountains to climb, \u007F\u0005[sonny/missy]!\u007F1\u0000\u0007"
...
SUBROUTINE_00BC:
 ...
 47: 0x00C4 [0x1D] PRINT_EVENT_MESSAGE(message_id=11790*)
    → "Well, I'll be! You look a little young to have gone through so much training. Must've had a good teacher, heh heh heh!\u007F1\u0000\u0007"
 48: 0x00C7 [0x23] WAIT_FOR_DIALOG_INTERACTION
 49: 0x00C8 [0x01] GOTO 0x00CF

SUBROUTINE_00CB:
 50: 0x00CB [0x1D] PRINT_EVENT_MESSAGE(message_id=11788*)
    → "Heh heh heh. Listen! You can hear it, right? It's the sound of my blood-a-boiling!\u007F1\u0000\u0007"
...
SUBROUTINE_00D5:
 ...
 55: 0x00DD [0x1D] PRINT_EVENT_MESSAGE(message_id=11791*)
    → "What's this...? Interesting...\u0007No, no. I'm sorry, youngster. I don't have the time for that now. But maybe someday when this war is over we can--\u007F1\u0000\u0007"
...
SUBROUTINE_00E7:
 59: 0x00E7 [0x1D] PRINT_EVENT_MESSAGE(message_id=11788*)
    → "Heh heh heh. Listen! You can hear it, right? It's the sound of my blood-a-boiling!\u007F1\u0000\u0007"
