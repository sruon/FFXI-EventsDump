...
```
  ...
  6: 0x0018 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=4*, source=Work_Zone[5], result=ExtData[1]->WorkLocal[9])
  7: 0x0021 [0x41] GET_BIT_WORK_RANGE(start_bit=5*, end_bit=9*, source=Work_Zone[5], result=ExtData[1]->WorkLocal[10])
  8: 0x002A [0x41] GET_BIT_WORK_RANGE(start_bit=10*, end_bit=14*, source=Work_Zone[5], result=ExtData[1]->WorkLocal[11])
  9: 0x0033 [0x41] GET_BIT_WORK_RANGE(start_bit=0*, end_bit=4*, source=Work_Zone[6], result=ExtData[1]->WorkLocal[12])
 10: 0x003C [0x41] GET_BIT_WORK_RANGE(start_bit=5*, end_bit=9*, source=Work_Zone[6], result=ExtData[1]->WorkLocal[13])
 11: 0x0045 [0x41] GET_BIT_WORK_RANGE(start_bit=10*, end_bit=14*, source=Work_Zone[6], result=ExtData[1]->WorkLocal[14])
 12: 0x004E [0x41] GET_BIT_WORK_RANGE(start_bit=15*, end_bit=19*, source=Work_Zone[6], result=ExtData[1]->WorkLocal[15])
 13: 0x0057 [0x41] GET_BIT_WORK_RANGE(start_bit=20*, end_bit=24*, source=Work_Zone[6], result=ExtData[1]->WorkLocal[16])
 14: 0x0060 [0x41] GET_BIT_WORK_RANGE(start_bit=25*, end_bit=29*, source=Work_Zone[6], result=ExtData[1]->WorkLocal[17])
 ...
 31: 0x00BA [0x1D] PRINT_EVENT_MESSAGE(message_id=12753*)
    → "Oh, hello there!\u0007Word on the street is that there is an adventurer with some novel notions to help our troops in the struggle-wuggle to transport supplies.\u0007That wouldn't happen to be you now, would it?\u007F1\u0000\u0007"
 32: 0x00BD [0x23] WAIT_FOR_DIALOG_INTERACTION
 33: 0x00BE [0x24] CREATE_DIALOG(message_id=12754*, default_option=0*, option_flags=0*)
    → "Do you have any brightaru ideas?\u0007\u000BLeave it to me.\u0007Not a one.\u007F1\u0000\u0007"
...
SUBROUTINE_00E6:
 ...
 45: 0x00F7 [0x1D] PRINT_EVENT_MESSAGE(message_id=12756*)
    → "Most fortuitous! You've come to the right place!\u0007I'll share with you all of the intel we have on pertinentaru topics such as lay of the land and supply routes.\u0007I leave the rest in your very capable-wapable hands!\u007F1\u0000\u0007"
 46: 0x00FA [0x23] WAIT_FOR_DIALOG_INTERACTION
 47: 0x00FB [0x1D] PRINT_EVENT_MESSAGE(message_id=12757*)
    → "The latest intel reports indicate the following.\u007F1\u0000\u0007"
 ...
 52: 0x0114 [0x1D] PRINT_EVENT_MESSAGE(message_id=12759*)
    → "The latest weather reportaru indicates that the weather in \u000C\u0000[Xarcabard/Beaucedine Glacier/The Eldieme Necropolis/Crawlers' Nest/Garlaige Citadel/Batallia Downs/the Rolanberry Fields/Sauromugue Champaign/Jugner Forest/Pashhow Marshlands/the Meriphataud Mountains/Vunkerl Inlet/Grauberg/Fort Karugo-Narugo/East Ronfaure/North Gustaberg/West Sarutabaruta] will not hold up.\u007F1\u0000\u0007"
...
SUBROUTINE_0139:
 ...
 67: 0x0157 [0x1D] PRINT_EVENT_MESSAGE(message_id=12761*)
    → "We have received unconfirmed reportarus that a medium-sized Beastman force is station-wationed in \u000C\u0000[Xarcabard/Beaucedine Glacier/The Eldieme Necropolis/Crawlers' Nest/Garlaige Citadel/Batallia Downs/the Rolanberry Fields/Sauromugue Champaign/Jugner Forest/Pashhow Marshlands/the Meriphataud Mountains/Vunkerl Inlet/Grauberg/Fort Karugo-Narugo/East Ronfaure/North Gustaberg/West Sarutabaruta].\u007F1\u0000\u0007"
 ...
 73: 0x0175 [0x1D] PRINT_EVENT_MESSAGE(message_id=12762*)
    → "We have received unconfirmed reportarus that a small-sized Dark Kindred force is station-wationed in \u000C\u0000[Xarcabard/Beaucedine Glacier/The Eldieme Necropolis/Crawlers' Nest/Garlaige Citadel/Batallia Downs/the Rolanberry Fields/Sauromugue Champaign/Jugner Forest/Pashhow Marshlands/the Meriphataud Mountains/Vunkerl Inlet/Grauberg/Fort Karugo-Narugo/East Ronfaure/North Gustaberg/West Sarutabaruta].\u007F1\u0000\u0007"
...
SUBROUTINE_017C:
 ...
 82: 0x019A [0x1D] PRINT_EVENT_MESSAGE(message_id=12763*)
    → "We have received unconfirmed reportarus that a Beastman supply convoy-wonvoy has been spotted in \u000C\u0000[Xarcabard/Beaucedine Glacier/The Eldieme Necropolis/Crawlers' Nest/Garlaige Citadel/Batallia Downs/the Rolanberry Fields/Sauromugue Champaign/Jugner Forest/Pashhow Marshlands/the Meriphataud Mountains/Vunkerl Inlet/Grauberg/Fort Karugo-Narugo/East Ronfaure/North Gustaberg/West Sarutabaruta].\u007F1\u0000\u0007"
...
113: 0x0219 [0x1D] PRINT_EVENT_MESSAGE(message_id=12758*)
    → "Actually, I have nothing of signifi-wificance to tell you.\u0007Our intel has broughtaru in no new information.\u007F1\u0000\u0007"
114: 0x021C [0x23] WAIT_FOR_DIALOG_INTERACTION
115: 0x021D [0x1D] PRINT_EVENT_MESSAGE(message_id=12764*)
    → "Well, that's all we have for now.\u0007Now comes the part where you hatch a masterful strategy-wategy!\u007F1\u0000\u0007"
...
118: 0x0229 [0x1D] PRINT_EVENT_MESSAGE(message_id=12765*)
    → "To which area do you think we should dispatch the supply convoy?\u007F1\u0000\u0007"
...
123: 0x023C [0x24] CREATE_DIALOG(message_id=12766*, default_option=0*, option_flags=0x14)
...
179: 0x0364 [0x1D] PRINT_EVENT_MESSAGE(message_id=12767*)
    → "Check! And how about cargo-wargo? How much should we load up?\u007F1\u0000\u0007"
180: 0x0367 [0x23] WAIT_FOR_DIALOG_INTERACTION
181: 0x0368 [0x1D] PRINT_EVENT_MESSAGE(message_id=12768*)
    → "I needn't remind you that the more supplies there are, the more elated the receiving unitaru will be.\u007F1\u0000\u0007"
...
191: 0x0396 [0x24] CREATE_DIALOG(message_id=12769*, default_option=0*, option_flags=0x14)
    → "What amount do you reco-wecommend?\u0007\u000BA large amountaru.\u0007A moderate amountaru.\u0007A small amountaru.\u007F1\u0000\u0007"
...
202: 0x03CE [0x1D] PRINT_EVENT_MESSAGE(message_id=12770*)
    → "Consider it done! And which type of route do you think the convoy-wonvoy should take?\u007F1\u0000\u0007"
...
215: 0x040A [0x1D] PRINT_EVENT_MESSAGE(message_id=12772*)
    → "Interesting! That leaves the matter of the convoy's escortaru.\u0007What size escort do you believe most appropriataru?\u007F1\u0000\u0007"
...
228: 0x0446 [0x1D] PRINT_EVENT_MESSAGE(message_id=12774*)
    → "One lastaru question!\u0007In a worst-case scenario-wenario, should our convoy encounter the enemy, what course of action should they take?\u007F1\u0000\u0007"
...
238: 0x0472 [0x1D] PRINT_EVENT_MESSAGE(message_id=12776*)
    → "Alrightaru, I do believe that covers it!\u0007Do you have any amendment-wendments to make before your official submission?\u007F1\u0000\u0007"
...
249: 0x04A1 [0x1D] PRINT_EVENT_MESSAGE(message_id=12778*)
    → "Magnificentaru! You have this Tarutaru's word!\u0007I'll do everything in my power to make sure your suggestions are taken under consider-wideration for tomorrow's operations.\u007F1\u0000\u0007"
250: 0x04A4 [0x23] WAIT_FOR_DIALOG_INTERACTION
251: 0x04A5 [0x1D] PRINT_EVENT_MESSAGE(message_id=12779*)
    → "As the strategistaru, it is considered customary-wustomary for you to be in attendance at said stronghold.\u0007After all, how else could you oversee the execution of your plans?\u007F1\u0000\u0007"
252: 0x04A8 [0x23] WAIT_FOR_DIALOG_INTERACTION
253: 0x04A9 [0x1D] PRINT_EVENT_MESSAGE(message_id=12780*)
    → "I think we're all done here! May the Goddess-woddess go with you.\u007F1\u0000\u0007"
...
284: 0x058E [0x1D] PRINT_EVENT_MESSAGE(message_id=12781*)
    → "Is something wrong?\u0007As planner of the adopted strategy, I strongly urge you to travel to the stronghold in question-westion to observe eventarus.\u007F1\u0000\u0007"
