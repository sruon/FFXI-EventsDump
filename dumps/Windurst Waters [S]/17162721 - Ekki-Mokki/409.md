...
```
  ...
  3: 0x001C [0x2B] EventEntity [10952*]:
    → "They say this detestable Yagudo Theomilitary is led by one named Tzee Xicu the Manifest.\u007F1\u0000\u0007"
  4: 0x0023 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0024 [0x2B] EventEntity [10953*]:
    → "He marshals the throngs of Yagudo from the foul depths of Castle Oztroja.\u0007There are some rumors, however, that he is actually a she.\u007F1\u0000\u0007"
