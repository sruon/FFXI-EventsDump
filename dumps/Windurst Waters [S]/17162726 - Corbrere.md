...
```
  ...
  3: 0x001C [0x2B] EventEntity [10934*]:
    → "A Master Caster is in charge of each War Warlocks unit. There's Kayeel-Payeel of the Aquarian War Warlocks, and Zolku-Azolku of the Libran War Warlocks..."
  4: 0x0023 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0024 [0x2B] EventEntity [10935*]:
    → "A few of them have their peculiarities, but they are all expertarus in magic!"
