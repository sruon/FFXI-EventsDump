...
```
  ...
  2: 0x000D [0x2B] EventEntity [10920*]:
    → "Those traditionally referred to as Wise Wizards in the Federation have been commissioned to lead units in battle and draw up wartime strategies.\u007F1\u0000\u0007"
  3: 0x0014 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0015 [0x2B] EventEntity [10921*]:
    → "We military scholars have also been appointed as staff officers and are serving here in Windurst as well.\u007F1\u0000\u0007"
