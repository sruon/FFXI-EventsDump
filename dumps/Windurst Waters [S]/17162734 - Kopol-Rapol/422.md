...
```
  ...
  2: 0x000D [0x2B] EventEntity [10975*]:
    → "When I grow up, I'm gonna be the biggest Warlock Warlord ever!\u007F1\u0000\u0007"
  3: 0x0014 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0015 [0x2B] EventEntity [10976*]:
    → "Do you know what a warlord is? I'm not quite sure...but it sure sounds really importantaru, right!?\u007F1\u0000\u0007"
