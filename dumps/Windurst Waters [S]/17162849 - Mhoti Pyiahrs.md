...
- **11750**: So you think you have what it takes to be a Cobra? Well, then talk to Miah Riyuh and hope that she's in a good mood!
- **11753**: Shouldn't you be out campaigning? Now get!
- **11756**: Says here you've already gone and joined some other nation's forces.
- **11759**: If you've finally come to your senses and decided on joining the Cobras then talk to Miah Riyuh...and hope that she's in a good mood!
- **11762**: But if you've finally come to your senses and decided to return to the Cobras, I think I can pull a few strings...for a price. You're carrying Allied Notes, right?
- **11763**: Please note that upon changing allegiance, you will be required to return the two most prestigious campaign medals you possess. There is no penalty if you have yet to earn any medals.
- **11765**: Exchange $2 Allied [Note/Notes] to transfer from [/the Knights of the Iron Ram/the Fourth Division/the Cobra Unit] to [/the Knights of the Iron Ram/the Fourth Division/the Cobra Unit]? You currently possess $3 [Allied Note/Allied Notes].
- **11766**: Proceed with the transaction? [Yes./No.]
- **11767**: Are you absolutely sure? [Yes./No.]
...
```
  ...
  3: 0x000C [0x1D] PRINT_EVENT_MESSAGE(message_id=11753*)
...
```
  ...
  3: 0x001D [0x1D] PRINT_EVENT_MESSAGE(message_id=11750*)
...
```
  ...
  4: 0x0044 [0x1D] PRINT_EVENT_MESSAGE(message_id=11756*)
    → "Says here you've already gone and joined some other nation's forces."
  5: 0x0047 [0x23] WAIT_FOR_DIALOG_INTERACTION
  6: 0x0048 [0x1D] PRINT_EVENT_MESSAGE(message_id=11762*)
 ...
 15: 0x005F [0x24] CREATE_DIALOG(message_id=11766*, default_option=1*, option_flags=0*)
...
SUBROUTINE_007A:
 20: 0x007A [0x24] CREATE_DIALOG(message_id=11767*, default_option=1*, option_flags=0*)
