...
```
  ...
  1: 0x7797 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [EventEntity, EventEntity], work=[200*, 0*]
  2: 0x77A8 [0x55] WAIT_LOAD_SCHEDULER: Wait for scheduler "fdo1" with entities [EventEntity, EventEntity], work=200*
 ...
 17: 0x77F3 [0xBA] SET_ENTITY_POSITION(entity_id=Tosuka-Porika (ID: 17162762/0x0105E20A), pos_x=-57.243*, pos_z=97.591*, pos_y=-5.249*, direction=278.5°*)
 18: 0x7800 [0xBA] SET_ENTITY_POSITION(entity_id=Yoran-Oran (ID: 17162763/0x0105E20B), pos_x=-57.609*, pos_z=95.561*, pos_y=-5.000*, direction=309.3°*)
 ...
 26: 0x7842 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "k020" with entities [LocalPlayer, LocalPlayer], work=[369*, 0*]
 27: 0x7853 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi1" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
 ...
 36: 0x7892 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "k021" with entities [LocalPlayer, LocalPlayer], work=[369*, 0*]
 ...
 40: 0x78AE [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk0" with entities [Yoran-Oran (ID: 17162763/0x0105E20B), Yoran-Oran (ID: 17162763/0x0105E20B)], work=49*
 ...
 45: 0x78CD [0x66] LOAD_EXT_SCHEDULER_MAIN: Load scheduler "tlk1" with entities [Yoran-Oran (ID: 17162763/0x0105E20B), Yoran-Oran (ID: 17162763/0x0105E20B)], work=49*
 46: 0x78DC [0x1C] WAIT(60* ticks)
 47: 0x78DF [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdo1" with entities [EventEntity, EventEntity], work=[200*, 0*]
 48: 0x78F0 [0x55] WAIT_LOAD_SCHEDULER: Wait for scheduler "fdo1" with entities [EventEntity, EventEntity], work=200*
 ...
 54: 0x7917 [0x45] LOAD_SCHEDULED_TASK: Load scheduler "nose" with entities [LocalPlayer, LocalPlayer], work=[272*, 0*]
 55: 0x7928 [0x55] WAIT_LOAD_SCHEDULER: Wait for scheduler "nose" with entities [LocalPlayer, LocalPlayer], work=272*
 ...
 58: 0x7940 [0x2D] CREATE_ZONE_SCHEDULER_TASK: Create scheduler "1pb1" with entities [LocalPlayer, LocalPlayer]
 ...
 64: 0x795B [0x45] LOAD_SCHEDULED_TASK: Load scheduler "fdi2" with entities [LocalPlayer, LocalPlayer], work=[200*, 0*]
