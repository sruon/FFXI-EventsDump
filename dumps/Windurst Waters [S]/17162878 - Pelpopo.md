...
- **12740**: You must be the scout I heard would be sent my way, yes? Very well, here you are, then.
- **12742**: Do you know very well about fiendtrappers? [Not very well, no./Very well, yes.]
- **12743**: Well I suppose that's to be expected. Very well, listen up. It's a magical device that is still in the early testing stages. It's capable of capturing images at the press of a button. Very well designed, it is.
- **12744**: Using it will cause the image of whatever you happen to be pointing it at to be very well recorded to a blank fiend plate located within. Isn't that something?
- **12745**: Very well, now. Your mission is to take this and gather some images of those ne'er-do-well Yagudo fiends!
- **12746**: Oh, very well, then. You may already know your mission objective very well then, yes? You are to take this and gather some images of those ne'er-do-well Yagudo fiends!
- **12748**: You can't very well be galavanting about here all day if you hope to complete your mission. Go and sniff out those Yagudo!
- **12749**: I've already perused that data very well. You had best take it directly to Emhi Tchaoryo.
- **12750**: I can't very well have you interrupting me unless it's of the utmost importance. I'm quite busy here.
...
```
 ...
 22: 0x0064 [0x1D] PRINT_EVENT_MESSAGE(message_id=12750*)
...
SUBROUTINE_0078:
 ...
 30: 0x0080 [0x1D] PRINT_EVENT_MESSAGE(message_id=12740*)
 ...
 32: 0x0084 [0x24] CREATE_DIALOG(message_id=12742*, default_option=0*, option_flags=0*)
 ...
 35: 0x0094 [0x1D] PRINT_EVENT_MESSAGE(message_id=12743*)
 ...
 37: 0x0098 [0x1D] PRINT_EVENT_MESSAGE(message_id=12744*)
 ...
 39: 0x009C [0x1D] PRINT_EVENT_MESSAGE(message_id=12745*)
 ...
 43: 0x00AB [0x1D] PRINT_EVENT_MESSAGE(message_id=12746*)
...
SUBROUTINE_00B2:
 ...
 49: 0x00C2 [0x1D] PRINT_EVENT_MESSAGE(message_id=12748*)
 ...
 54: 0x00D6 [0x1D] PRINT_EVENT_MESSAGE(message_id=12749*)
