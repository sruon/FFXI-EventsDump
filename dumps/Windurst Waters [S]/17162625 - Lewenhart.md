...
- **12123**: Oh, how I long for the days of peace when I was free to roam from tavern to tavern and wherever else my heart led me.
- **12124**: Music is your livelihood, too, is it not? There are those who wish glory upon themselves. But for us--we sing of legends, rather than become them.
- **12125**: You would give this $0 to me...? Thank you kindly, friend. I shall offer it with a requiem to the souls of those heroes who have been laid to rest at the Eldieme Necropolis.
...
```
  ...
  9: 0x0023 [0x1D] PRINT_EVENT_MESSAGE(message_id=12123*)
 ...
 13: 0x0032 [0x1D] PRINT_EVENT_MESSAGE(message_id=12123*)
    → "Oh, how I long for the days of peace when I was free to roam from tavern to tavern and wherever else my heart led me."
 ...
 18: 0x0049 [0x1D] PRINT_EVENT_MESSAGE(message_id=12123*)
    → "Oh, how I long for the days of peace when I was free to roam from tavern to tavern and wherever else my heart led me."
 ...
 23: 0x0060 [0x1D] PRINT_EVENT_MESSAGE(message_id=12124*)
 ...
 26: 0x0067 [0x1D] PRINT_EVENT_MESSAGE(message_id=12123*)
    → "Oh, how I long for the days of peace when I was free to roam from tavern to tavern and wherever else my heart led me."
...
SUBROUTINE_006B:
 ...
 31: 0x007E [0x1D] PRINT_EVENT_MESSAGE(message_id=12124*)
    → "Music is your livelihood, too, is it not? There are those who wish glory upon themselves. But for us--we sing of legends, rather than become them."
 32: 0x0081 [0x23] WAIT_FOR_DIALOG_INTERACTION
 33: 0x0082 [0x01] GOTO 0x0089
 34: 0x0085 [0x1D] PRINT_EVENT_MESSAGE(message_id=12123*)
    → "Oh, how I long for the days of peace when I was free to roam from tavern to tavern and wherever else my heart led me."
...
SUBROUTINE_0089:
 ...
 39: 0x009C [0x1D] PRINT_EVENT_MESSAGE(message_id=12124*)
    → "Music is your livelihood, too, is it not? There are those who wish glory upon themselves. But for us--we sing of legends, rather than become them."
 40: 0x009F [0x23] WAIT_FOR_DIALOG_INTERACTION
 41: 0x00A0 [0x01] GOTO 0x00A7
 42: 0x00A3 [0x1D] PRINT_EVENT_MESSAGE(message_id=12123*)
    → "Oh, how I long for the days of peace when I was free to roam from tavern to tavern and wherever else my heart led me."
...
SUBROUTINE_00AA:
 ...
 48: 0x00BD [0x1D] PRINT_EVENT_MESSAGE(message_id=12123*)
    → "Oh, how I long for the days of peace when I was free to roam from tavern to tavern and wherever else my heart led me."
 ...
 54: 0x00D9 [0x1D] PRINT_EVENT_MESSAGE(message_id=12125*)
 ...
 57: 0x00E0 [0x1D] PRINT_EVENT_MESSAGE(message_id=12123*)
    → "Oh, how I long for the days of peace when I was free to roam from tavern to tavern and wherever else my heart led me."
...
SUBROUTINE_00E4:
 ...
 63: 0x00FC [0x1D] PRINT_EVENT_MESSAGE(message_id=12125*)
    → "You would give this $0 to me...? Thank you kindly, friend. I shall offer it with a requiem to the souls of those heroes who have been laid to rest at the Eldieme Necropolis."
 64: 0x00FF [0x23] WAIT_FOR_DIALOG_INTERACTION
 65: 0x0100 [0x01] GOTO 0x0107
 66: 0x0103 [0x1D] PRINT_EVENT_MESSAGE(message_id=12123*)
    → "Oh, how I long for the days of peace when I was free to roam from tavern to tavern and wherever else my heart led me."
...
SUBROUTINE_0107:
 ...
 72: 0x011F [0x1D] PRINT_EVENT_MESSAGE(message_id=12125*)
    → "You would give this $0 to me...? Thank you kindly, friend. I shall offer it with a requiem to the souls of those heroes who have been laid to rest at the Eldieme Necropolis."
 73: 0x0122 [0x23] WAIT_FOR_DIALOG_INTERACTION
 74: 0x0123 [0x01] GOTO 0x012A
 75: 0x0126 [0x1D] PRINT_EVENT_MESSAGE(message_id=12123*)
    → "Oh, how I long for the days of peace when I was free to roam from tavern to tavern and wherever else my heart led me."
