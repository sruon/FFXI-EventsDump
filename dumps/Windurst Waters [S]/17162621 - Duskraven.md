...
- **11785**: I sense something...otherworldly about you, traveler. But appearances can oft be misleading, nay?
- **11786**: It may hap the secrets I seek lie with [the Crimson Lion/the Republic/the Federation]...
- **11787**: Ah, so your nation requests my services... I shall consider your proposal...
- **11788**: I lack the patience to deal with those who do not kneel to the raven...
- **11789**: I have heard rumor that the lord of the beastmen sits upon an hoary throne in the frozen north. Do you believe he would entertain a raven?
...
```
  ...
  9: 0x0023 [0x1D] PRINT_EVENT_MESSAGE(message_id=11785*)
 ...
 13: 0x0032 [0x1D] PRINT_EVENT_MESSAGE(message_id=11785*)
    → "I sense something...otherworldly about you, traveler. But appearances can oft be misleading, nay?"
 ...
 18: 0x0049 [0x1D] PRINT_EVENT_MESSAGE(message_id=11785*)
    → "I sense something...otherworldly about you, traveler. But appearances can oft be misleading, nay?"
 ...
 24: 0x0065 [0x1D] PRINT_EVENT_MESSAGE(message_id=11786*)
 ...
 27: 0x006C [0x1D] PRINT_EVENT_MESSAGE(message_id=11785*)
    → "I sense something...otherworldly about you, traveler. But appearances can oft be misleading, nay?"
...
SUBROUTINE_0070:
 ...
 33: 0x0088 [0x1D] PRINT_EVENT_MESSAGE(message_id=11786*)
    → "It may hap the secrets I seek lie with [the Crimson Lion/the Republic/the Federation]..."
 34: 0x008B [0x23] WAIT_FOR_DIALOG_INTERACTION
 35: 0x008C [0x01] GOTO 0x0093
 36: 0x008F [0x1D] PRINT_EVENT_MESSAGE(message_id=11785*)
    → "I sense something...otherworldly about you, traveler. But appearances can oft be misleading, nay?"
...
SUBROUTINE_0093:
 ...
 42: 0x00AB [0x1D] PRINT_EVENT_MESSAGE(message_id=11786*)
    → "It may hap the secrets I seek lie with [the Crimson Lion/the Republic/the Federation]..."
 43: 0x00AE [0x23] WAIT_FOR_DIALOG_INTERACTION
 44: 0x00AF [0x01] GOTO 0x00B6
 45: 0x00B2 [0x1D] PRINT_EVENT_MESSAGE(message_id=11785*)
    → "I sense something...otherworldly about you, traveler. But appearances can oft be misleading, nay?"
...
SUBROUTINE_00B9:
 ...
 51: 0x00CC [0x1D] PRINT_EVENT_MESSAGE(message_id=11785*)
    → "I sense something...otherworldly about you, traveler. But appearances can oft be misleading, nay?"
 ...
 57: 0x00E8 [0x1D] PRINT_EVENT_MESSAGE(message_id=11789*)
 ...
 60: 0x00EF [0x1D] PRINT_EVENT_MESSAGE(message_id=11787*)
...
SUBROUTINE_00F3:
 ...
 66: 0x010B [0x1D] PRINT_EVENT_MESSAGE(message_id=11789*)
    → "I have heard rumor that the lord of the beastmen sits upon an hoary throne in the frozen north. Do you believe he would entertain a raven?"
 67: 0x010E [0x23] WAIT_FOR_DIALOG_INTERACTION
 68: 0x010F [0x01] GOTO 0x0116
 69: 0x0112 [0x1D] PRINT_EVENT_MESSAGE(message_id=11788*)
...
SUBROUTINE_0116:
 ...
 75: 0x012E [0x1D] PRINT_EVENT_MESSAGE(message_id=11789*)
    → "I have heard rumor that the lord of the beastmen sits upon an hoary throne in the frozen north. Do you believe he would entertain a raven?"
 76: 0x0131 [0x23] WAIT_FOR_DIALOG_INTERACTION
 77: 0x0132 [0x01] GOTO 0x0139
 78: 0x0135 [0x1D] PRINT_EVENT_MESSAGE(message_id=11787*)
    → "Ah, so your nation requests my services... I shall consider your proposal..."
