...
- **7749**: A hunt registry has been placed here by the Adventurers' Mutual Aid Network (A.M.A.N.). Its pages are laden with the names of spine-chilling monsters.
- **7750**: A hunt registry has been placed here by the Servicemen's Mutual Aid Network (S.M.A.N.). Its pages are laden with the names of spine-chilling monsters.
- **7751**: What will you do? [Nothing./Undertake a hunt./Read explanation./Record completion of hunt./View current hunt./Cancel current hunt./View scyld balance.]
- **7752**: You must cancel your current hunt if you wish to undertake another.
- **7753**: Little time has passed since your last hunt. It is recommended that you take some time to recuperate before undertaking another.
- **7754**: You cannot undertake a hunt while a training regime is active.
- **7755**: Cancel your training regime? [Yes./No.]
- **7757**: You must either notify the completion of, or cancel your current hunt in order to undertake another.
- **7770**: Which page? [I've changed my mind./Hunt #1./Hunt #2./Hunt #3./Hunt #4./Hunt #5./Hunt #6./Hunt #7./Hunt #8./Hunt #9./Hunt #10./Hunt #11./Hunt #12./Hunt #13./Hunt #14./Hunt #15./Hunt #16./Hunt #17./Hunt #18./Hunt #19./Hunt #20./Hunt #21./Hunt #22./Hunt #23./Hunt #24./Hunt #25./Hunt #26./Hunt #27./Hunt #28./Hunt #29./Hunt #30.]
- **7771**: The information on this page instructs you to defeat the following:
...
- **7773**: Accept hunt? (Current scylds: $0) [Yes./No.]
- **7776**: You do not have enough scylds.
- **7777**: The hunt registry is a tome through which seasoned adventurers can undertake assignments to eliminate monsters deemed to be impediments to A.M.A.N. activities.
- **7778**: The hunt registry is a tome through which veteran soldiers can undertake assignments to eliminate monsters deemed to be impediments to S.M.A.N. activities.
- **7779**: Assignments, or "hunts," can be undertaken simply by selecting the name of a monster listed in the registry.
- **7780**: Pertinent information such as monster elusiveness and ferocity has been recorded for your reference. As safety cannot be guaranteed, we ask that you hunt within your ability.
- **7781**: Hunts pit you against creatures of extreme ferocity, and are not intended for training. For this reason, you cannot undertake a hunt while a training regime is active.
- **7782**: Should party members undertaking a common hunt defeat the objective, the kill will be considered valid for all.
- **7783**: Upon the completion of a hunt, record your success in a hunt registry. Doing so will earn you rewards corresponding to difficulty as well as "scylds"--tokens of your valor.
- **7784**: More scylds will grant you access to increasingly difficult and rewarding assignments. Be warned, however, that once expended, scylds will not be refunded for any reason.
- **7785**: Lastly, please note that a mandatory cool-down period will be imposed upon all hunters following the completion of a hunt. Until this time has elapsed, you will not be permitted to undertake another hunt.
- **7790**: Cancel hunt? [Yes./No.]
- **7791**: Are you certain? [Yes./No.]
- **7793**: You currently possess $0 [scyld/scylds].
...
111: 0x0226 [0x24] CREATE_DIALOG(message_id=7751*, default_option=0*, option_flags=ExtData[1]->WorkLocal[27])
...
136: 0x02B1 [0x24] CREATE_DIALOG(message_id=7770*, default_option=0*, option_flags=ExtData[1]->WorkLocal[29])
...
165: 0x0366 [0x03] ExtData[1]->WorkLocal[26] = 7794*
...
177: 0x0396 [0x24] CREATE_DIALOG(message_id=7773*, default_option=1*, option_flags=0*)
...
227: 0x0476 [0x48] [System] [7754*]:
    → "You cannot undertake a hunt while a training regime is active."
228: 0x0479 [0x23] WAIT_FOR_DIALOG_INTERACTION
229: 0x047A [0x24] CREATE_DIALOG(message_id=7755*, default_option=1*, option_flags=0*)
    → "Cancel your training regime? [Yes./No.]"
230: 0x0481 [0x25] WAIT_DIALOG_SELECT()
231: 0x0482 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x04B7
232: 0x048A [0x24] CREATE_DIALOG(message_id=7791*, default_option=1*, option_flags=0*)
    → "Are you certain? [Yes./No.]"
...
280: 0x0556 [0x03] ExtData[1]->WorkLocal[26] = 8818*
...
286: 0x056F [0x24] CREATE_DIALOG(message_id=7790*, default_option=1*, option_flags=0*)
    → "Cancel hunt? [Yes./No.]"
287: 0x0576 [0x25] WAIT_DIALOG_SELECT()
288: 0x0577 [0x02] IF !(Work_Zone[0] == 0*) GOTO 0x05AC
289: 0x057F [0x24] CREATE_DIALOG(message_id=7791*, default_option=1*, option_flags=0*)
    → "Are you certain? [Yes./No.]"
