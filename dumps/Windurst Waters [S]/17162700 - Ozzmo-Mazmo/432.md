...
```
  ...
  2: 0x000D [0x2B] EventEntity [10941*]:
    → "When night comes, you can see a biiig star in the sky over there.\u0007Have you seen it yet?\u007F1\u0000\u0007"
  3: 0x0014 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0015 [0x2B] EventEntity [10942*]:
    → "Everyone is saying that it's some sort of omen that something bad is on its way.\u0007But I can't imagine that things could get any worse than they already are.\u007F1\u0000\u0007"
