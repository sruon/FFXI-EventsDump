...
```
  ...
  2: 0x000D [0x2B] EventEntity [10986*]:
    → "Fort Karugo-Narugo is our stronghold to the north. It's absolutely essential for the defense of Windurst.\u007F1\u0000\u0007"
  3: 0x0014 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0015 [0x2B] EventEntity [10987*]:
    → "You might even go so far as to call it the jewel in the crown that is Windurst's magical defense against the Yagudo invasion...I'm sorry, that was a bit much...\u007F1\u0000\u0007"
