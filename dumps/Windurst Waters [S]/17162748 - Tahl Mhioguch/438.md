...
```
  ...
  2: 0x000D [0x2B] EventEntity [10930*]:
    → "It seems those disgusting \u00072maws\u00073 have appeared in several rrregions. Have you seen one yet?\u007F1\u0000\u0007"
  3: 0x0014 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0015 [0x2B] EventEntity [10931*]:
    → "Nyaaa, just thinking about them makes my furrr stand on end.\u007F1\u0000\u0007"
