...
```
  ...
  2: 0x000D [0x2B] EventEntity [10980*]:
    → "People tend to forget, but the real reason that the minister of the Optistery has cooped himself up in the Toraimarai Canal is to save Windurst from the very danger that threatens its existence, not to escape it.\u007F1\u0000\u0007"
  3: 0x0014 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0015 [0x2B] EventEntity [10981*]:
    → "All alone in that creepy-weepy, dark place for days and days...\u0007I can't even imagine what it must be like.\u007F1\u0000\u0007"
