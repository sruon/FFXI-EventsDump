...
```
  ...
  2: 0x000D [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=10*, entity1=EventEntity, entity2=EventEntity, action="tlk0")
  3: 0x001C [0x2B] EventEntity [10911*]:
    → "I've come from Bastok on business, but word had not reached us of the scale of devastation here.\u0007\u007F1\u0000\u0007"
  4: 0x0023 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0024 [0x2B] EventEntity [10912*]:
    → "It must have been a terrible ordeal...\u0007To think of all those little Tarutarus fighting desperately to protect their home.\u007F1\u0000\u0007"
  6: 0x002B [0x23] WAIT_FOR_DIALOG_INTERACTION
  7: 0x002C [0x66] LOAD_EXT_SCHEDULER_MAIN(work_offset=10*, entity1=EventEntity, entity2=EventEntity, action="tlk1")
