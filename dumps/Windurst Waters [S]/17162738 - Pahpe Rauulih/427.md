...
```
  ...
  3: 0x001C [0x2B] EventEntity [10954*]:
    → "The development of various forms of magic has been well underway since the onset of hostilities.\u007F1\u0000\u0007"
  4: 0x0023 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0024 [0x2B] EventEntity [10955*]:
    → "Some are even beginning to dabble again in arts condemned as taboo in former days. Well, that's all just hearsay... \u007F1\u0000\u0007"
