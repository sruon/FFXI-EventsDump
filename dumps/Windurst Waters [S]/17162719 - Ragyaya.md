...
```
  ...
  3: 0x001C [0x2B] EventEntity [10946*]:
    → "They say the reason the beastmen are coming after us is ultimately because they are after crystals."
  4: 0x0023 [0x23] WAIT_FOR_DIALOG_INTERACTION
  5: 0x0024 [0x2B] EventEntity [10947*]:
    → "But I don't see why they have to get so worked up over it. If it's that big a deal to them, let's just give them some crystals. Why do they have to go and wreck our city?"
