...
```
  ...
  2: 0x000D [0x2B] EventEntity [10982*]:
    → "This bridge was nearly obliterated in a recent Yagudo attack.\u0007We just finished rebuilding it to the state that you see now.\u007F1\u0000\u0007"
  3: 0x0014 [0x23] WAIT_FOR_DIALOG_INTERACTION
  4: 0x0015 [0x2B] EventEntity [10983*]:
    → "I just hope we don'taru have to do this again...\u007F1\u0000\u0007"
