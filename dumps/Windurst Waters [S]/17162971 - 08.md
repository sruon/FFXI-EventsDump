...
```
  ...
  1: 0x0005 [0x1F] MOVE_ENTITY: EventEntity moves to X=5.747*, Z=122.806*, Y=-16.000*
  2: 0x000D [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  3: 0x000F [0x1F] MOVE_ENTITY: EventEntity moves to X=0.648*, Z=126.447*, Y=-16.749*
  4: 0x0017 [0x1F] MOVE_ENTITY: Update entity position (mode=1)
  5: 0x0019 [0x1F] MOVE_ENTITY: EventEntity moves to X=-1.042*, Z=147.311*, Y=-16.749*
